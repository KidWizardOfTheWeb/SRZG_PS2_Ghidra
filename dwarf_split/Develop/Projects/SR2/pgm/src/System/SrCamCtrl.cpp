/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\System\SrCamCtrl.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class stcPlayerQuakeFilter asQuakeFilter[6]; // size: 0xA8, address: 0x624860
void (* afFilterFuncs[3])(class stcCamFilter *, class stcCamFilter *, unsigned int, class clsPlayerTask *); // size: 0xC, address: 0x624908
struct /* @anon2 */ {
    // total size: 0x1C
} __vt__13clsSrCamMixer; // size: 0x1C, address: 0x6BBC80
...
public:
    ...
    class NNS_CAMERA_TARGET_UPVECTOR m_sCamera; // offset 0x70, size 0x38
    unsigned int m_u32Counter; // offset 0xA8, size 0x4
    unsigned int m_u32Color; // offset 0xAC, size 0x4
};
class stcPlayerQuakeFilter {
    // total size: 0x1C
public:
    class NNS_VECTOR sMaxRangePosV; // offset 0x0, size 0xC
    class NNS_VECTOR sMaxRangeTgtV; // offset 0xC, size 0xC
    unsigned char u8Speed; // offset 0x18, size 0x1
};
class vector : private __vector_imp {
    // total size: 0xC
};
...
class clsLandDownCamIv : public clsCamIvBase {
    // total size: 0x28
public:
    class NNS_VECTOR m_sBkupEyeTgtWV; // offset 0x4, size 0xC
    float m_f32DownLen1; // offset 0x10, size 0x4
    float m_f32UpLen; // offset 0x14, size 0x4
    float m_f32DownLen2; // offset 0x18, size 0x4
    unsigned int m_u32Frame; // offset 0x1C, size 0x4
    unsigned short m_u16DownFrm1; // offset 0x20, size 0x2
    unsigned short m_u16UpFrm; // offset 0x22, size 0x2
    unsigned short m_u16DownFrm2; // offset 0x24, size 0x2
    unsigned short m_u16TotalFrm; // offset 0x26, size 0x2
};
class clsOOList : public list {
    // total size: 0x14
};
...
// Range: 0x2EB870 -> 0x2EB938
void finishMixing(class clsSrCamMixer * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EB870 -> 0x2EB938
    }
...
// Range: 0x2EB940 -> 0x2EB96C
void mixing(class clsSrCamMixer * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EB940 -> 0x2EB96C
    }
...
// Range: 0x2EB970 -> 0x2ECE6C
void mixingFilter(class clsSrCamMixer * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EB970 -> 0x2ECE6C
        float f32Rate; // r20
        class stcCamFilter asTmpFilter[2]; // r29+0x3B0
        class stcCamFilter sZeroFilter; // r29+0x370
        class stcTargetCam1 sTgtParam; // r29+0x2F0
        class stcVectorCam1 sVecParam; // r29+0x280
        class stcTargetCam1 sTgtParam; // r29+0x200
        class stcTargetCam1 sTgtParam; // r29+0x180
    }
}


// Range: 0x2ECE70 -> 0x2ED0B8
void finishFilter(class clsSrCamMixer * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2ECE70 -> 0x2ED0B8
    }
...
// Range: 0x2ED0C0 -> 0x2ED1D4
void setRegularFilter(class clsSrCamMixer * this /* r2 */, class stcCamFilter * psFilter /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2ED0C0 -> 0x2ED1D4
    }
...
// Range: 0x2ED1E0 -> 0x2EDC7C
void setCamCtrlTbl(class clsSrCamMixer * this /* r21 */, unsigned int u32JmpIdx /* r20 */, unsigned int u32Num /* r30 */, unsigned char u8NextFlg /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2ED1E0 -> 0x2EDC7C
        unsigned int u32SetIdx; // r19
        unsigned int u32CamType; // r18
        unsigned int u32TblIdx; // r2
        class clsCamCtrl * pcCamCtrl; // r16
        class clsPlayerTask * pcPlayerTask; // r2
        class stcTargetCam1 sTgtCam1; // r29+0x1D0
        class stcTargetCam1 * psTgtCam1; // r2
        class stcGctrlCam1 sGctrlCam1; // r29+0x180
        class clsGravityControl * pcGCtrl; // r2
        class stcDomeCam1 sDomeCam1; // r29+0x140
        class stcVectorCam1 sVecCam1; // r29+0xD0
        class stcPathCam1 sPathCam1; // r29+0xA0
    }
}


// Range: 0x2EDC80 -> 0x2EDD04
void nextMixData(class clsSrCamMixer * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EDC80 -> 0x2EDD04
    }
...
// Range: 0x2EDD10 -> 0x2EDDD8
void clearCamFilter(class clsSrCamMixer * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EDD10 -> 0x2EDDD8
        class stcTargetCam1 sTgtParam; // r29+0x30
    }
}


// Range: 0x2EDDE0 -> 0x2EE26C
void setCamFilter(class clsSrCamMixer * this /* r2 */, class stcCamFilter * opsCamFilter /* r2 */, unsigned int u32Idx /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EDDE0 -> 0x2EE26C
    }
...
// Range: 0x2EE270 -> 0x2EE328
void * __ct(class clsSrCamMixer * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EE270 -> 0x2EE328
    }
...
// Range: 0x2EE340 -> 0x2EE5FC
static void QuakeFF(class stcCamFilter * psFilter /* r17 */, unsigned int u32FParamIdx /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EE340 -> 0x2EE5FC
        class stcPlayerQuakeFilter * psQF; // r2
    }
}


// Range: 0x2EE600 -> 0x2EE8E4
static void PlayerQuakeFF(class stcCamFilter * psFilter /* r17 */, unsigned int u32FParamIdx /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EE600 -> 0x2EE8E4
        class stcPlayerQuakeFilter * psQF; // r2
