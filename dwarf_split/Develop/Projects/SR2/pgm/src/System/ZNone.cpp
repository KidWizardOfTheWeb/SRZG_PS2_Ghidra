/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\System\ZNone.cpp
...
// Range: 0x3018F0 -> 0x301BB8
void draw(class clsReInitGraphics_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3018F0 -> 0x301BB8
    }
...
// Range: 0x301C50 -> 0x301C88
void setFogBinData_NearFar(class clsReInitGraphics_Task * this /* r2 */, signed int s32vI /* r2 */, float f32NearI /* r29 */, float f32FarI /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x301C50 -> 0x301C88
    }
...
// Range: 0x301C90 -> 0x301CC8
void setChangeFogNo(class clsReInitGraphics_Task * this /* r2 */, signed int s32vI /* r2 */, signed int s32FogNoI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x301C90 -> 0x301CC8
    }
