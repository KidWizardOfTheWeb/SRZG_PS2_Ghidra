/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\System\PressStart.cpp
...
// Range: 0x4E1100 -> 0x4E134C
void draw(class clsPressStart_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E1100 -> 0x4E134C
        signed int s32a; // r2
        enum enmLanguage eLanguage; // r2
        class stcTexUV osTexUv; // r29+0x50
    }
}


// Range: 0x4E1350 -> 0x4E1428
void execute(class clsPressStart_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E1350 -> 0x4E1428
    }
