/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\System\Movie.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcSubTitleFontDetail osSubTitleFontDetail_Opening_J[23]; // size: 0x114, address: 0x682810
static class stcSubTitleFontDetail osSubTitleFontDetail_Insert_J[11]; // size: 0x84, address: 0x682930
static class stcSubTitleFontDetail osSubTitleFontDetail_Ending_J[31]; // size: 0x174, address: 0x6829C0
static class stcSubTitleFontDetail osSubTitleFontDetail_Opening_E[23]; // size: 0x114, address: 0x682B40
static class stcSubTitleFontDetail osSubTitleFontDetail_Insert_E[11]; // size: 0x84, address: 0x682C60
static class stcSubTitleFontDetail osSubTitleFontDetail_Ending_E[31]; // size: 0x174, address: 0x682CF0
static class stcSubTitleFontDetail * oasSubTitleFontDetail_Opening[2]; // size: 0x8, address: 0x635B28
static class stcSubTitleFontDetail * oasSubTitleFontDetail_Insert[2]; // size: 0x8, address: 0x635B30
static class stcSubTitleFontDetail * oasSubTitleFontDetail_Ending[2]; // size: 0x8, address: 0x635B38
class stcData m_otsData[14]; // size: 0xE0, address: 0x682FD0
signed int SUB_TITLE_POS_Y_60; // size: 0x4, address: 0x0
signed int OFF_WII_Y; // size: 0x4, address: 0x0
struct /* @anon0 */ {
    // total size: 0x5C
} __vt__13clsMovie_Task; // size: 0x5C, address: 0x6C1C30
struct /* @anon1 */ {
    // total size: 0x30
...
class clsMovie_Task : public clsPfMovie, public clsTask {
    // total size: 0x178
public:
    unsigned int m_u32CancelActiveKey; // offset 0x164, size 0x4
    unsigned char * m_pbOutSideFinishFlag; // offset 0x168, size 0x4
    enum enmDeleteType m_eDeleteType; // offset 0x16C, size 0x4
    unsigned char m_bDolbyDigital_Old_PS2; // offset 0x170, size 0x1
    signed char m_s8PadNo; // offset 0x171, size 0x1
};
class _UUID {
    // total size: 0x10
public:
...
class stcSubTitleFontDetail {
    // total size: 0xC
public:
    float f32AppearTime; // offset 0x0, size 0x4
    float f32EndTime; // offset 0x4, size 0x4
    unsigned int u32FontTblNo; // offset 0x8, size 0x4
};
...
// Range: 0x3DF2F0 -> 0x3DF648
void draw(class clsMovie_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DF2F0 -> 0x3DF648
    }
...
// Range: 0x3DF8C0 -> 0x3DF8E4
float getEndTimeSubTitle(class stcSubTitleFontDetail * opsSubTitleFontDetail /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DF8C0 -> 0x3DF8E4
        float f32EndTime; // r29
    }
}


// Range: 0x3DF8F0 -> 0x3DFCF4
void execute(class clsMovie_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DF8F0 -> 0x3DFCF4
        enum MwsfdStat sMovieStat; // r2
    }
}


// Range: 0x3DFD00 -> 0x3DFEEC
void * __ct(class clsMovie_Task * this /* r16 */, enum enmDataNo eDataNoI /* r20 */, signed int s32DrawXI /* r2 */, signed int s32DrawYI /* r2 */, enum enmLoopFlag eLoopI /* r2 */, enum enmSubTitle eSubTitleI /* r2 */, unsigned int u32CancelActiveKeyI /* r19 */, enum enmDeleteType eDeleteTypeI /* r18 */, signed int s32PadNoI /* r29+0x70 */, unsigned char * pbOutSideFinishFlagI /* r29+0x78 */, enum enmAllocate eAllocateI /* r29+0x80 */, signed int s32DrawWI /* r29+0x88 */, signed int s32DrawHI /* r29+0x90 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DFD00 -> 0x3DFEEC
        unsigned int bMultiPrex; // r2
        unsigned char oau8AnalogCh[4]; // @ 0x006830B8
        void * STARS[2]; // @ 0x006830B0
    }
}


// Range: 0x3DFEF0 -> 0x3DFEF8
void @272@draw__13clsMovie_TaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DFEF0 -> 0x3DFEF8
    }
...
// Range: 0x3DFF00 -> 0x3DFF08
void @272@execute__13clsMovie_TaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DFF00 -> 0x3DFF08
    }
...
// Range: 0x3DFF10 -> 0x3DFF18
void @272@__dt__13clsMovie_TaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DFF10 -> 0x3DFF18
    }
