/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Data\RaceLight.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcBinDataDetail otasDefaultDataDetail; // size: 0x54, address: 0x66AA90
struct /* @anon0 */ {
    // total size: 0x30
} __vt__17clsRaceLight_Task; // size: 0x30, address: 0x6BBD20
...
signed int Light(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x1D7BC0
...
// Range: 0x2F5BD0 -> 0x2F5D7C
void * __ct(class clsRaceLight_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F5BD0 -> 0x2F5D7C
        class clsPfLight & rcPfLight; // r2
        class clsBaseStage_Task * pcBaseStage; // r2
        class stcBinDataDetail * psBinDataDetail; // r20
        unsigned int u32SoftWareNum; // r19
        unsigned int u32i; // r18
        char * apc8Name[2]; // r29+0x68
    }
}
