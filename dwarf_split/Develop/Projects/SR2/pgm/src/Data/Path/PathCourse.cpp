/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Data\Path\PathCourse.cpp
...
// Range: 0x32D0C0 -> 0x32D88C
unsigned int calcPlannedGoalTime(class clsPathCourse * this /* r20 */, class clsPlayerTask * pcPlayer /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32D0C0 -> 0x32D88C
        class clsBaseRace_Task * pcBaseRace; // r16
        class NNS_VECTORFAST sPlayerLinePos; // r29+0x90
        class NNS_VECTORFAST sPlayerLineLength; // r29+0x80
        signed int s32RestLapNum; // r2
        float f32PlayerLineLength; // r1
        float f32RestLength; // r21
        float f32RestTime; // r20
        unsigned int u32MSec; // r20
        unsigned int u32i; // r19
        unsigned int u32PlayerNum; // r2
        class clsPlayerTask * pcGoalPlayer; // r2
        unsigned int u32GoalPlayerTime; // r18
        unsigned int u32TotalTime; // r2
    }
}


// Range: 0x32D910 -> 0x32DA6C
signed int checkGoalLine(class clsPathCourse * this /* r19 */, class clsPlayerTask * pcPlayer /* r2 */, float * paf32OldDotProductIO /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32D910 -> 0x32DA6C
        signed char s8Ret; // r17
    }
}


// Range: 0x32DA70 -> 0x32DAD4
unsigned char isStartLineOver(class clsPathCourse * this /* r16 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32DA70 -> 0x32DAD4
        class NNS_VECTORFAST sStart2PosDir; // r29+0x20
        float f32Dot; // r29+0x30
    }
}


// Range: 0x32DAE0 -> 0x32DC28
float calcRankingPointDepth(class clsPathCourse * this /* r19 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32DAE0 -> 0x32DC28
        float f32RankDepth; // r21
        class NNS_VECTORFAST sPlayerLinePos; // r29+0xA0
        class NNS_VECTORFAST sPlayerLineLength; // r29+0x90
        class clsRetPath cRetPathTmp; // r29+0x70
    }
}


// Range: 0x32DC30 -> 0x32DD14
signed int serarchActiveNextLine(class clsPathCourse * this /* r2 */, class clsRetPath * pcRetIO /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32DC30 -> 0x32DD14
        class _LineData * psLine; // r3
...
// Range: 0x32DD20 -> 0x32DE64
void calcOnLinePlayerPos(class clsPathCourse * this /* r2 */, class clsPlayerTask * pcPlayer /* r2 */, class NNS_VECTORFAST & rsDstPos /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32DD20 -> 0x32DE64
        class NNS_VECTORFAST sPathDir; // r29+0xA0
        class NNS_VECTORFAST sPlayerPosDiff; // r29+0x90
        float f32DotSp; // r29+0xB0
        float f32PathDirSp; // r29+0xB0
        float f32PlayerPosDiffSq; // r29+0xB0
        class NNS_VECTORFAST sDirTmp; // r29+0x80
        class NNS_VECTORFAST sPlayerDir; // r29+0x70
        class NNS_VECTORFAST sAnsDir; // r29+0x60
    }
}


// Range: 0x32DE70 -> 0x32E12C
void setBinDataAttribute(class clsPathCourse * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32DE70 -> 0x32E12C
        class _LineData * psStartLine; // r21
        class _LineData * psGoalLine; // r20
        unsigned int u32LineNum; // r2
        unsigned int u32i; // r3
        class NNS_VECTORFAST * psStartLinePos; // r30
        class NNS_VECTORFAST * psStartLineDir; // r22
        class NNS_VECTORFAST * psFirstLineDir; // r19
        class NNS_VECTORFAST * psGoalLinePos; // r29+0xA0
        class NNS_VECTORFAST * psGoalLineDir; // r23
        class NNS_VECTORFAST * psLastLineDir; // r18
        class NNS_VECTORFAST sUpVec; // r29+0xB0
        char __FUNCTION__[20]; // @ 0x006753A0
    }
}
