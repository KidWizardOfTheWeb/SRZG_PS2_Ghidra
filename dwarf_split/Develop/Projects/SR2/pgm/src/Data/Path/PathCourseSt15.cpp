/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Data\Path\PathCourseSt15.cpp
...
class clsPathCourseSt15 : public clsPathCourse {
    // total size: 0xC0
public:
    class NNS_VECTORFAST m_sTmpGoalLinePos; // offset 0x80, size 0x10
    class NNS_VECTORFAST m_sTmpGoalLineDir; // offset 0x90, size 0x10
    class NNS_VECTORFAST m_sTmpLastLineDir; // offset 0xA0, size 0x10
    float m_f32BackTmpGoalLineDepth; // offset 0xB0, size 0x4
    float m_f32FrontTmpGoalLineDepth; // offset 0xB4, size 0x4
};
...
// Range: 0x3FD770 -> 0x3FD978
signed int checkGoalLine(class clsPathCourseSt15 * this /* r21 */, class clsPlayerTask * pcPlayer /* r2 */, float * paf32OldDotProductIO /* r20 */, signed int s32TotalLapCnt /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3FD770 -> 0x3FD978
        float f32Dot2; // r29+0xA0
        class NNS_VECTORFAST sGoal2PosDir; // r29+0x90
        signed int s32Ret; // r18
    }
}


// Range: 0x3FD980 -> 0x3FDC34
void setBinDataAttribute(class clsPathCourseSt15 * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3FD980 -> 0x3FDC34
        ...
        class NNS_VECTORFAST * psGoalLinePos; // r30
        class NNS_VECTORFAST * psGoalLineDir; // r23
        class NNS_VECTORFAST * psLastLineDir; // r22
        class NNS_VECTORFAST sUpVec; // r29+0xA0
        class _LineData * psNextGoalLine; // r18
        unsigned int u32j; // r4
        char __FUNCTION__[20]; // @ 0x00684A30
    }
}
