/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Data\Path\PathPoint.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float COURSEPATH_PLAYER_SIZE; // size: 0x4, address: 0x675490
float COURSE_SEARCH_POINT_POS_RADIUS; // size: 0x4, address: 0x0
...
// Range: 0x32E130 -> 0x32E2A0
void DrawLine_Debug(class clsPathPoint * this /* r21 */, unsigned char bIsDrawSphere /* r20 */, signed int s32NonDrawLineNoI /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32E130 -> 0x32E2A0
        class _LineData * opsLine; // r19
        class NNS_VECTORFAST * psVectorFast; // r2
        signed int i; // r18
        class clsPfDraw3d & rcOODraw3d; // r17
        unsigned int u32Color; // r2
    }
}


// Range: 0x32E2A0 -> 0x32E2D8
void FreeCalculateCapsule(class clsPathPoint * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32E2A0 -> 0x32E2D8
    }
...
// Range: 0x32E2E0 -> 0x32E3DC
void AllocAndCalculateCapsule(class clsPathPoint * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32E2E0 -> 0x32E3DC
        signed int i; // r18
...
// Range: 0x32E3E0 -> 0x32E41C
void getCrossPoint(class clsPathPoint * this /* r2 */, class NNS_VECTORFAST * psDstPos /* r2 */, class NNS_VECTORFAST * psPos /* r6 */, signed int s32LineNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32E3E0 -> 0x32E41C
    }
...
// Range: 0x32E420 -> 0x32E514
float calcDistFromStart(class clsPathPoint * this /* r18 */, unsigned short u16ActiveLineNo /* r2 */, class NNS_VECTORFAST * psPos /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32E420 -> 0x32E514
        class _LineData * psPoint; // r2
    }
}


// Range: 0x32E520 -> 0x32E5AC
void searchNextLineBack(class clsPathPoint * this /* r2 */, class clsRetPath * pcRetIO /* r2 */, signed int s32PointNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32E520 -> 0x32E5AC
        class _stcEndPosList * psEPList; // r9
        signed int s32LineNo; // r8
    }
}


// Range: 0x32E5B0 -> 0x32E634
void searchNextLine(class clsPathPoint * this /* r2 */, class clsRetPath * pcRetIO /* r2 */, signed int s32PointNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32E5B0 -> 0x32E634
        class _LineData * psLine; // r9
        signed int s32LineNo; // r8
    }
}


// Range: 0x32E640 -> 0x32EA50
void searchPoint(class clsPathPoint * this /* r22 */, class clsRetPath * pcRetIO /* r30 */, class NNS_VECTORFAST * psPosition /* r21 */, class NNS_VECTORFAST * psDirNrmVecFast /* r29+0xD0 */, unsigned int u32DisableType /* r29+0xCC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32E640 -> 0x32EA50
        class _LineData * psLine; // r20
        class NNS_VECTORFAST * psVector; // r2
        signed int s32LineNo; // r19
        float f32MinDest; // r20
        unsigned short u16OldLineNo; // r2
        class NNS_VECTORFAST asLine[2]; // r29+0x160
        class NNS_SPHERE sSphere; // r29+0x150
        class NNS_CAPSULE * psCapsule; // r18
        class NNS_VECTORFAST sDirVecFast; // r29+0x140
    }
}
