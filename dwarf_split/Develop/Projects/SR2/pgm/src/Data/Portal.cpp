/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Data\Portal.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float DOT_PRODUCT_BACK_DEG; // size: 0x4, address: 0x66AF48
static class NNS_PRIM3D_PC tasPrim3D_PC_Polygon[10]; // size: 0xA0, address: 0xB0B820
static class NNS_VECTORFAST tsDpPosFast; // size: 0x10, address: 0x6253F0
char * ac8NameBool[2]; // size: 0x8, address: 0x625400
struct /* @anon0 */ {
    // total size: 0x30
} __vt__26clsPortalEditor_Debug_Task; // size: 0x30, address: 0x6BC040
class clsTaskManager * m_tpcSingleton; // size: 0x4, address: 0x6E69D0
signed int compare_Type(class stcPortalDetail *, class stcPortalDetail *); // size: 0x0, address: 0x307AD0
...
signed int ObjPortal(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x1D7210
signed int MapPortal(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x1D74C0
struct /* @anon2 */ {
    // total size: 0x2C
...
class clsPortalEditor_Debug_Task : public clsTask {
    // total size: 0x6C
public:
    class clsPortal * m_opcSrcPortal; // offset 0x54, size 0x4
    class stcPortalBin * m_opsSrcPortalBin; // offset 0x58, size 0x4
    class stcPortalBin * m_psPortalHi; // offset 0x5C, size 0x4
    signed int m_s32ListCursor; // offset 0x60, size 0x4
    unsigned int m_u32DetailOperation; // offset 0x64, size 0x4
    unsigned char m_bEasyDrawFlag; // offset 0x68, size 0x1
    unsigned char m_bChangeFlag; // offset 0x69, size 0x1
};
class __vector_imp : private __vector_deleter {
    // total size: 0xC
};
...
// Range: 0x306C60 -> 0x307AD0
void draw(class clsPortalEditor_Debug_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x306C60 -> 0x307AD0
        class stcPortalDetail * psDetail; // r19
        unsigned int u32i; // r3
        signed short s16Speed; // r2
        unsigned int u32i; // r3
    }
}


// Range: 0x307AD0 -> 0x307B5C
signed int compare_Type(class stcPortalDetail * pA /* r2 */, class stcPortalDetail * pB /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x307AD0 -> 0x307B5C
        unsigned char u8a; // r2
        unsigned char u8b; // r2
    }
}


// Range: 0x307B60 -> 0x3081AC
void savePortalData(class clsPortalEditor_Debug_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x307B60 -> 0x3081AC
        unsigned int u32Num; // r2
        unsigned int u32i; // r21
        class stcPortalDetail * psDetail; // r17
        unsigned char u8BeginType; // r19
        unsigned char u8EndType; // r18
        unsigned int u32Aite; // r24
        class stcPortalDetail * psDetail_Aite; // r21
        unsigned char bOk; // r7
        char * opc8Ex; // r2
        char ac8FileName[64]; // r29+0x80
        unsigned int u32Size; // r2
    }
}


// Range: 0x3081B0 -> 0x308510
void drawPortalDetail(class clsPortalEditor_Debug_Task * this /* r18 */, class stcPortalDetail & orsDetailI /* r17 */, unsigned char bActiveI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3081B0 -> 0x308510
    }
...
// Range: 0x308510 -> 0x309570
void drawLeftList(class clsPortalEditor_Debug_Task * this /* r21 */, unsigned char bActiveI /* r18 */, unsigned char bDraw3dI /* r29+0x14F */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x308510 -> 0x309570
        unsigned int u32i; // r20
        unsigned int u32Num; // r29+0x130
        unsigned int u32s; // r2
        unsigned int u32e; // r2
        class stcPoint2D_s16 sScreen2d; // r29+0x30C
        class stcPortalDetail * psDetail; // r19
        class NNS_VECTORFAST sDpClipFast; // r29+0x2F0
        float f32DpW; // r29
        float f32DpH; // r28
        signed int s32y; // r16
        float aMtx[4][4]; // r29+0x2B0
        signed int s32x; // r18
        signed int s32y; // r23
        float aMtx[4][4]; // r29+0x270
        signed int s32x; // r18
        signed int s32y; // r23
    }
}
...
// Range: 0x309580 -> 0x3096B8
void * __dt(class clsPortalEditor_Debug_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x309580 -> 0x3096B8
    }
...
// Range: 0x3096C0 -> 0x309860
void * __ct(class clsPortalEditor_Debug_Task * this /* r18 */, class clsPortal * opcSrcPortalI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3096C0 -> 0x309860
...
// Range: 0x309860 -> 0x309924
char * getStrEx_Debug(unsigned char u8TypeI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x309860 -> 0x309924
        char * pc8Out; // r2
        unsigned char tu8c; // @ 0x00B0B800
        char tac8Out[4][4]; // @ 0x00B0B810
    }
}


// Range: 0x309930 -> 0x309B50
unsigned char getPortal(class clsPortal * this /* r2 */, class NNS_VECTORFAST & rosPosVecFast /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x309930 -> 0x309B50
        class stcPortalDetail * psDetail; // r21
        unsigned int u32Num; // r2
        unsigned int u32i; // r20
        signed int s32x; // r2
        signed int s32y; // r2
        signed int s32z; // r2
        class stcPortalMtx * psPortalMtx; // r19
        class NNS_VECTORFAST sPos; // r29+0x90
        class stcPortalBelongType sType; // r29+0xAC
    }
}


// Range: 0x309B50 -> 0x309E18
void update(class clsPortal * this /* r22 */, unsigned int u32vI /* r29+0xAC */, class NNS_VECTOR & orsPosI /* r23 */, unsigned char bReverse /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x309B50 -> 0x309E18
        class stcPortalDetail * psDetail; // r21
        ...
        signed int s32z; // r2
        class stcPortalMtx * psPortalMtx; // r19
        class NNS_VECTOR sPos; // r29+0xB0
        class stcPortalBelongType sType; // r29+0xBC
    }
}


// Range: 0x309E20 -> 0x30A088
void setPortal(class clsPortal * this /* r16 */, unsigned char * pu8BinI /* r2 */, enum enmPortalType ePortalTypeI /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x309E20 -> 0x30A088
        unsigned int u32i; // r8
        unsigned int u32RotNum; // r7
        class stcPortalDetail * psDetail; // r6
        signed short s16CenterX; // r2
        signed short s16CenterY; // r2
        signed short s16CenterZ; // r2
        float aMtx[4][4]; // r29+0x90
        float aMtx2[4][4]; // r29+0x50
        class stcPortalMtx * psPortalMtx; // r18
    }
}
