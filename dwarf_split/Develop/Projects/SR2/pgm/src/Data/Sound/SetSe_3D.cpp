/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Data\Sound\SetSe_3D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class stcRequestArray m_oasRequestArray[21]; // size: 0xA8, address: 0x681850
struct /* @anon2 */ {
    // total size: 0x30
} __vt__16clsSetSe_3D_Task; // size: 0x30, address: 0x6C17B0
struct /* @anon0 */ {
    // total size: 0x30
...
public:
    ...
    class stcRequestArray & m_orsRequestArray; // offset 0x70, size 0x4
    float m_af32ReSpawnFrame[4]; // offset 0x74, size 0x10
    float & m_orf32ReSpawnFrame_default; // offset 0x84, size 0x4
    signed short m_as16Id3D[4]; // offset 0x88, size 0x8
    float m_f32DistDownK; // offset 0x90, size 0x4
    unsigned char m_u8ViewPortNum; // offset 0x94, size 0x1
    unsigned char m_u8PortalType; // offset 0x95, size 0x1
};
...
// Range: 0x3BD850 -> 0x3BDCC0
void execute(class clsSetSe_3D_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BD850 -> 0x3BDCC0
        class clsPfCri & rcOOCri; // r20
        class clsPfCameraMgr & rcOOCameraMgr; // r2
        signed short * ps16Id3D; // r19
        float * pf32ReSpawnFrame; // r22
        float f32FrameRateAdd; // r21
        float f32SeDistx2; // r20
        class stcSeView sSePlayView[4]; // r29+0xB0
        unsigned int u32v; // r6
        unsigned int u32i; // r8
        unsigned int u32j; // r7
        unsigned char u8PlayCount; // r22
        class stcSeView sWorkView; // r29+0xD8
