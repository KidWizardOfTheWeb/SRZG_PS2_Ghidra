/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Data\Sound\Cri.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned int oau32StageSeTblSize[16]; // size: 0x40, address: 0x68FD30
unsigned int oau32StageSePcmSize[16]; // size: 0x40, address: 0x68FD70
unsigned int oau32PlayerVoiceTblPcmSize[8]; // size: 0x20, address: 0x68FDB0
class clsPfSystem * m_tpcSingleton; // size: 0x4, address: 0x6E69B8
unsigned int rodir_Image3_000000[]; // size: 0x0, address: 0x654AF0
unsigned int rodir_Image2_000000[]; // size: 0x0, address: 0x64B540
unsigned int rodir_Image1_000000[]; // size: 0x0, address: 0x63AC00
unsigned int rodir_Image3_cvmtim[]; // size: 0x0, address: 0x654AE8
unsigned int rodir_Image2_cvmtim[]; // size: 0x0, address: 0x64B538
unsigned int rodir_Image1_cvmtim[]; // size: 0x0, address: 0x63ABF0
...
class RofsInitPara {
    // total size: 0x10
public:
    signed int max_open; // offset 0x0, size 0x4
    signed int max_volume; // offset 0x4, size 0x4
    signed int max_dirent; // offset 0x8, size 0x4
...
// Range: 0x4CA550 -> 0x4CA800
void setup() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4CA550 -> 0x4CA800
        class RofsInitPara mwrofs_iprm; // r29+0x50
        unsigned int otau32SoundMode[4]; // @ 0x0068FD20
        unsigned char mwrofs_wkbuf[208388]; // @ 0x00BC7730
        unsigned char au8AdxWork_Voice[143844]; // @ 0x00B81120
        unsigned char au8AdxWork_Bgm[3][143844]; // @ 0x00B17B70
        unsigned char au8AdxWork_Jingle[143844]; // @ 0x00BA4310
        unsigned char m_au8AdxAfsPatInfo_Game_Voice[552]; // @ 0x00BC7500
    }
}


// Range: 0x4CA800 -> 0x4CA868
void setSoundMode(enum enmSoundMode eSoundModeI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4CA800 -> 0x4CA868
    }
