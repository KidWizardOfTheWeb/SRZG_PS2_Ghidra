/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Data\Sound\GravityBgm.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static char otac8MaxBgmCode[8]; // size: 0x8, address: 0x66C378
struct /* @anon0 */ {
    // total size: 0x30
...
class clsGravityBgm_Task : public clsTask {
    // total size: 0x78
public:
    char m_ac8Name_BGM[14]; // offset 0x54, size 0xE
    char m_ac8Name_X[14]; // offset 0x62, size 0xE
    char m_c8EndCode_BGM; // offset 0x70, size 0x1
    unsigned char m_u8BgmMode; // offset 0x71, size 0x1
    unsigned char m_bReady_X; // offset 0x72, size 0x1
    unsigned char m_bReady_Bgm; // offset 0x73, size 0x1
    unsigned char m_bMulti; // offset 0x74, size 0x1
    signed char m_s8HangOnPlayerNo_Start; // offset 0x75, size 0x1
    signed char m_s8HangOnPlayerNo_End; // offset 0x76, size 0x1
};
...
// Range: 0x31D380 -> 0x31D834
void execute(class clsGravityBgm_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31D380 -> 0x31D834
        unsigned int u32Stat; // r29+0x7C
        signed int s32p; // r5
    }
}


// Range: 0x31D880 -> 0x31D92C
void playXbox360(class clsGravityBgm_Task * this /* r17 */, unsigned char bReadyI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31D880 -> 0x31D92C
    }
...
// Range: 0x31D930 -> 0x31DA60
void playBgm(class clsGravityBgm_Task * this /* r17 */, unsigned char bReadyI /* r2 */, unsigned char bNextI /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31D930 -> 0x31DA60
    }
...
// Range: 0x31DA60 -> 0x31DC34
void getPlayerGravityInfo(class clsGravityBgm_Task * this /* r23 */, unsigned int & u32StatO /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31DA60 -> 0x31DC34
        unsigned int u32ViewportNum; // r2
        unsigned int u32v; // r20
        class clsPlayerTask & rcPlayer; // r19
    }
}
