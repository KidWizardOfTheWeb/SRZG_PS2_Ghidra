/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Data\Sound\CharaVoice.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class clsPfSystem * m_tpcSingleton; // size: 0x4, address: 0x6E69B8
class stcTask sTask; // size: 0x30, address: 0xB0A900
signed int oas32CharaVoiceCom[][2]; // size: 0x0, address: 0x68BFC0
signed int oas32CharaVoice[][18]; // size: 0x0, address: 0x68BA60
...
enum enmVoiceType {
    VOICE_TRICK_JUMP = 0,
    VOICE_TRICK_FAILED = 1,
    VOICE_TRICK_HIGHRANK = 2,
    VOICE_NORMAL_ATTACK = 3,
    VOICE_DAMAGE = 4,
    VOICE_BEFORE_START = 5,
    VOICE_GOAL_PLACE = 6,
    VOICE_GOAL_NOPLACE = 7,
    VOICE_RUN_PAST = 8,
    VOICE_ATTACK = 9,
    VOICE_NORMAL_JUMP = 10,
    VOICE_GRIND_DIVE = 11,
    VOICE_GEAR_CHANGE = 12,
    VOICE_NORMAL_SHOUT = 13,
    VOICE_FALL = 14,
    VOICE_GRAVITY_DIVE_CHARGE = 15,
    VOICE_GRAVITY_DIVE_RELEASE = 16,
    VOICE_ATTACK_PREP = 17,
    VOICE_TYPE_MAX = 18,
    VOICE_COM_TYPE_MAX = 2,
    VOICE_NULL = 0,
    VOICE_NULL_ADX = -1,
};
class __vector_pod {
...
// Range: 0x4D4580 -> 0x4D45D8
void update(class clsCharaVoice * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D4580 -> 0x4D45D8
    }
...
// Range: 0x4D45E0 -> 0x4D47F0
void playCharaVoice(class clsCharaVoice * this /* r20 */, enum enmVoiceType eVoiceType /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D45E0 -> 0x4D47F0
        signed int s32VoiceId; // r2
    }
}


// Range: 0x4D47F0 -> 0x4D4810
void * __ct(class clsCharaVoice * this /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D47F0 -> 0x4D4810
    }
