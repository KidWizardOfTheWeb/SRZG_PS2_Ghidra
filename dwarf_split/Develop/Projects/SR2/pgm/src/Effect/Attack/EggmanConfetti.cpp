/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Attack\EggmanConfetti.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static unsigned int otau32ColorTbl[4]; // size: 0x10, address: 0x69A620
...
// Range: 0x5884B0 -> 0x5887FC
void draw(class clsEggConfetti * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5884B0 -> 0x5887FC
        class stcEggDetail * psDetail; // r21
        float f32FrameRateAddUnPause; // r20
        class stcTexUV sTexSrc; // r29+0xF0
        class stcPoint2D_s16 * psTextureSize; // r2
        unsigned int u32i; // r20
        unsigned int u32x; // r2
        unsigned int u32y; // r2
        unsigned int u8Size; // r2
        unsigned int u32Color; // r2
        unsigned short u16Alpha; // r2
        float sDrawMtx[4][4]; // r29+0xB0
        float f32HalfWidth; // r29+0x100
    }
}


// Range: 0x588800 -> 0x588AB8
void addDetail(class clsEggConfetti * this /* r21 */, unsigned int u32vI /* r30 */, unsigned int u32NumI /* r20 */, float f32LifeFrameI /* r29+0x110 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x588800 -> 0x588AB8
        ...
        class stcEggDetail * psDetail; // r2
        unsigned int u32Size; // r18
        unsigned int u32s2; // r2
        signed short s16Rot; // r2
    }
}


// Range: 0x588AC0 -> 0x588B4C
void * __ct(class clsEggConfetti * this /* r19 */, unsigned int u32vI /* r18 */, unsigned int u32NumI /* r17 */, unsigned int u32Flg /* r16 */, float f32LifeFrameI /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x588AC0 -> 0x588B4C
    }
