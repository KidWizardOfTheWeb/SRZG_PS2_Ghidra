/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\GravityFin\GravityFin.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon3 */ {
    // total size: 0x30
} __vt__24clsGravityFinEffect_Task; // size: 0x30, address: 0x6BD3F0
struct /* @anon0 */ {
    // total size: 0x30
} __vt__18clsBaseEffect_Task; // size: 0x30, address: 0x6BBD50
...
class clsGravityFinEffect_Task : public clsBaseEffect_Task {
    // total size: 0xF0
public:
    class NNS_VECTORFAST m_sPosVectorFast; // offset 0xD0, size 0x10
    float m_f32AddFrame; // offset 0xE0, size 0x4
    float m_f32EndWaitFrame; // offset 0xE4, size 0x4
};
...
// Range: 0x33E930 -> 0x33E97C
void draw(class clsGravityFinEffect_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x33E930 -> 0x33E97C
    }
...
// Range: 0x33E980 -> 0x33ECAC
void execute(class clsGravityFinEffect_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x33E980 -> 0x33ECAC
        unsigned int u32SetParticleNo; // r2
        class clsPlayerTask * pcPlayer; // r2
        float f32AddFrame; // r3
    }
}


// Range: 0x33ECB0 -> 0x33ED08
void * __ct(class clsGravityFinEffect_Task * this /* r16 */, unsigned int u32TpI /* r2 */, signed int s32TypeI /* r2 */, class clsModelType_OB_TX_MO_MA * pcModelI /* r2 */, unsigned int eFlagI /* r2 */, unsigned int u32ViewNo /* r2 */, enum enmNo eNo /* r2 */, enum enmCalcNodePos eBornNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x33ECB0 -> 0x33ED08
    }
