/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\BackRibbon\BackRibbon.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class _NNS_TEXLIST * psTexList_BackRibbon; // size: 0x4, address: 0xB16D68
static unsigned char su8BackRibbonTextureNo[17]; // size: 0x11, address: 0x6836F0
float tof32AnimSpeed; // size: 0x4, address: 0x0
struct /* @anon0 */ {
    // total size: 0x30
} __vt__24clsBackRibbonEffect_Task; // size: 0x30, address: 0x6C21B0
struct /* @anon1 */ {
    // total size: 0x30
...
class clsBackRibbonEffect_Task : public clsTask {
    // total size: 0x7F0
public:
    class NNS_PRIM3D_PCT m_asPrim3D_PCT[80]; // offset 0x54, size 0x780
    unsigned int m_u32LocalSaveNo; // offset 0x7D4, size 0x4
    unsigned int m_u32MarkTimingCount; // offset 0x7D8, size 0x4
    unsigned int m_u32ViewNo; // offset 0x7DC, size 0x4
    unsigned char m_u8PlayerNo; // offset 0x7E0, size 0x1
    unsigned char m_u8TexType; // offset 0x7E1, size 0x1
    class clsPlayerTask * m_pcPlayer; // offset 0x7E4, size 0x4
    unsigned int m_u32PointNum; // offset 0x7E8, size 0x4
    float m_f32Anim; // offset 0x7EC, size 0x4
};
class hkProperty {
    // total size: 0x10
public:
...
// Range: 0x3EC6C0 -> 0x3EC7EC
void draw(class clsBackRibbonEffect_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EC6C0 -> 0x3EC7EC
    }
...
// Range: 0x3EC7F0 -> 0x3EC9A8
void execute(class clsBackRibbonEffect_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EC7F0 -> 0x3EC9A8
    }
...
// Range: 0x3EC9B0 -> 0x3ECEC8
void settingMarks(class clsBackRibbonEffect_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EC9B0 -> 0x3ECEC8
        float sMtxPal[4][4]; // r29+0xA0
        class NNS_VECTOR sPosVec[2]; // r29+0x80
        class NNS_VECTOR sAddPos; // r29+0xE0
        class NNS_VECTORFAST sVecFast; // r29+0x70
        float f32Speed; // r5
        float f32AlphaMax; // r24
        float f32Alpha; // r23
        float f32AddAlpha; // r22
        float f32SubAlpha; // r21
        signed int s32No; // r2
        signed int s32i; // r19
        float f32Height; // r20
...
// Range: 0x3ECED0 -> 0x3ED2F4
void init(class clsBackRibbonEffect_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3ECED0 -> 0x3ED2F4
        float sMtxPal[4][4]; // r29+0xA0
        ...
        float f32Speed; // r3
        float f32uv; // r24
        float f32AlphaMax; // r23
        float f32Alpha; // r22
        float f32AddAlpha; // r21
        float f32SubAlpha; // r20
        signed int i; // r18
        float f32Height; // r25
    }
}
...
// Range: 0x3ED300 -> 0x3ED3CC
void * __ct(class clsBackRibbonEffect_Task * this /* r18 */, unsigned char u8PlayerNo /* r17 */, unsigned int u32PointNum /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3ED300 -> 0x3ED3CC
    }
