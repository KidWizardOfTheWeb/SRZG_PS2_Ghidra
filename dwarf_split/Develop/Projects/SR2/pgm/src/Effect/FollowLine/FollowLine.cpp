/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\FollowLine\FollowLine.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static unsigned int LineColorTbl[3]; // size: 0xC, address: 0x66C400
static class stcParameter DummySingleData; // size: 0xB0, address: 0x66C410
static class stcParameter DummyGear[7]; // size: 0x4D0, address: 0x66C4C0
static unsigned char chk__DummyGear_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter BlueStar[7]; // size: 0x4D0, address: 0x66C990
static unsigned char chk__BlueStar_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter YellowTail[7]; // size: 0x4D0, address: 0x66CE60
static unsigned char chk__YellowTail_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter RedRock[7]; // size: 0x4D0, address: 0x66D330
static unsigned char chk__RedRock_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter PinkRose[7]; // size: 0x4D0, address: 0x66D800
static unsigned char chk__PinkRose_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter Type_J[7]; // size: 0x4D0, address: 0x66DCD0
static unsigned char chk__Type_J_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter Type_S[7]; // size: 0x4D0, address: 0x66E1A0
static unsigned char chk__Type_S_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter Type_W[7]; // size: 0x4D0, address: 0x66E670
static unsigned char chk__Type_W_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter E_Rider[7]; // size: 0x4D0, address: 0x66EB40
static unsigned char chk__E_Rider_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter Smile[7]; // size: 0x4D0, address: 0x66F010
static unsigned char chk__Smile_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter Temptation[7]; // size: 0x4D0, address: 0x66F4E0
static unsigned char chk__Temptation_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter BlackShot[7]; // size: 0x4D0, address: 0x66F9B0
static unsigned char chk__BlackShot_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter Blaze_Default[7]; // size: 0x4D0, address: 0x66FE80
static unsigned char chk__Blaze_Default_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter Silver_Default[7]; // size: 0x4D0, address: 0x670350
static unsigned char chk__Silver_Default_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter Nights_Default[7]; // size: 0x4D0, address: 0x670820
static unsigned char chk__Nights_Default_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter Samba_Default[7]; // size: 0x4D0, address: 0x670CF0
static unsigned char chk__Samba_Default_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter Billy_Default[7]; // size: 0x4D0, address: 0x6711C0
static unsigned char chk__Billy_Default_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter Faster[7]; // size: 0x4D0, address: 0x671690
static unsigned char chk__Faster_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter Fastest[7]; // size: 0x4D0, address: 0x671B60
static unsigned char chk__Fastest_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter CoverF[7]; // size: 0x4D0, address: 0x672030
static unsigned char chk__CoverF_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter CoverP[7]; // size: 0x4D0, address: 0x672500
static unsigned char chk__CoverP_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter AdvantageS[7]; // size: 0x4D0, address: 0x6729D0
static unsigned char chk__AdvantageS_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter WindStar[7]; // size: 0x4D0, address: 0x672EA0
static unsigned char chk__WindStar_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter AirShip[7]; // size: 0x4D0, address: 0x673370
static unsigned char chk__AirShip_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter WheelCustom[7]; // size: 0x4D0, address: 0x673840
static unsigned char chk__WheelCustom_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter RailLinker[7]; // size: 0x4D0, address: 0x673D10
static unsigned char chk__RailLinker_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter Infuential[7]; // size: 0x4D0, address: 0x6741E0
static unsigned char chk__Infuential_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter Thorttle[7]; // size: 0x4D0, address: 0x6746B0
static unsigned char chk__Thorttle_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParameter Untouchable[7]; // size: 0x4D0, address: 0x674B80
static unsigned char chk__Untouchable_SizeCheck_[1]; // size: 0x1, address: 0x0
class stcParameter * GearLineData[63]; // size: 0xFC, address: 0x6258F0
static unsigned char chk__GearLineData_SizeCheck_[1]; // size: 0x1, address: 0x0
class _NNS_TEXLIST * psTexList_Union; // size: 0x4, address: 0xB0D910
class _NNS_TEXLIST * psTexList_Gimick; // size: 0x4, address: 0xB0D918
static signed int PlayeSkateLineNode[2]; // size: 0x8, address: 0x675050
static unsigned char chk__PlayeSkateLineNode_SizeCheck_[1]; // size: 0x1, address: 0x0
static float tf32GcLineScale; // size: 0x4, address: 0x6259F0
static float tf32GcLineVecScale; // size: 0x4, address: 0x6259F8
static class stcParam oasLineParamTest; // size: 0x40, address: 0x675060
class NNS_VECTORFAST m_asLastViewPosFast[5]; // size: 0x50, address: 0xB0D920
struct /* @anon0 */ {
    // total size: 0x30
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x675190
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x675150
...
struct /* @anon1 */ {
    // total size: 0x30
} __vt__21clsBackLineEffectTask; // size: 0x30, address: 0x6BCF80
struct /* @anon2 */ {
    // total size: 0x30
...
class stcParameter {
    // total size: 0xB0
public:
    signed int s32LineNum; // offset 0x0, size 0x4
    class NNS_VECTORFAST asSizeVec[2]; // offset 0x10, size 0x20
    class NNS_VECTORFAST asOfsVec[4][2]; // offset 0x30, size 0x80
};
...
// Range: 0x321A60 -> 0x321B9C
void draw(class clsBackLineEffectTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x321A60 -> 0x321B9C
    }
...
// Range: 0x321BA0 -> 0x3220E8
void drawGimick(class clsBackLineEffectTask * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x321BA0 -> 0x3220E8
        class stcGimickParam * psGimick; // r2
        float sDrawMtx[4][4]; // r29+0x920
        float (* psDrawMtx)[4][4]; // r22
        unsigned int u32Color; // r20
        class NNS_PRIM3D_PCT asPrimData[82]; // r29+0x170
        class stcFollowLine * psFollowLine; // r19
        class NNS_VECTORFAST sWidthVecFast; // r29+0x160
        class NNS_VECTORFAST sOffVecFast; // r29+0x150
        float sNodeMtx[4][4]; // r29+0x110
        float (* psNodeMtx)[4][4]; // r18
        class NNS_VECTORFAST sPosVecFast; // r29+0x100
        signed short s16NodeNo; // r18
        signed short s16MaxNum; // r16
        class NNS_VECTORFAST sStartFast; // r29+0xF0
        class NNS_VECTORFAST sPowerFast; // r29+0xE0
        float sAxisMtx[4][4]; // r29+0xA0
        class NNS_VECTOR sVec[2]; // r29+0x80
        signed int s32n; // r17
    }
}


// Range: 0x3220F0 -> 0x322638
void drawEvent(class clsBackLineEffectTask * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3220F0 -> 0x322638
        class stcGimickParam * psParam; // r2
        float sDrawMtx[4][4]; // r29+0x920
        float (* psDrawMtx)[4][4]; // r22
        unsigned int u32Color; // r20
        class NNS_PRIM3D_PCT asPrimData[82]; // r29+0x170
        class stcFollowLine * psFollowLine; // r19
        class NNS_VECTORFAST sVectorFast; // r29+0x160
        class NNS_VECTORFAST sOffVecFast; // r29+0x150
        float sNodeMtx[4][4]; // r29+0x110
        float (* psNodeMtx)[4][4]; // r18
        class NNS_VECTORFAST sPosVecFast; // r29+0x100
...
// Range: 0x322650 -> 0x322D40
void drawNoMovePos(class clsBackLineEffectTask * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x322650 -> 0x322D40
        unsigned int u32Color; // r30
        class NNS_PRIM3D_PCT asPrimData[82]; // r29+0x150
        class stcFollowLine * psFollowLine; // r20
        class NNS_VECTORFAST sVectorFast; // r29+0x140
        class NNS_VECTORFAST sOffVecFast; // r29+0x130
        float (* psNodeMtx)[4][4]; // r22
        class NNS_VECTORFAST sPosVecFast; // r29+0x120
        class NNS_VECTORFAST sDiffVecFast; // r29+0x110
        signed short s16MaxNum; // r23
        signed int s32i; // r4
        float sAxisMtx[4][4]; // r29+0xD0
        class NNS_VECTOR sVec[2]; // r29+0xB0
        signed int s32n; // r17
    }
}


// Range: 0x322D40 -> 0x3231AC
void drawPlayerNode(class clsBackLineEffectTask * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x322D40 -> 0x3231AC
        class clsPlayerTask * pcPlayer; // r2
        unsigned int u32Color; // r17
        class NNS_PRIM3D_PCT asPrimData[82]; // r29+0x140
        class stcFollowLine * psFollowLine; // r16
        class NNS_VECTORFAST sVectorFast; // r29+0x130
        class NNS_VECTORFAST sOffVecFast; // r29+0x120
        float (* psNodeMtx)[4][4]; // r21
        class NNS_VECTORFAST sPosVecFast; // r29+0x110
        signed short s16NodeNo; // r6
        signed int s32NodeI; // r2
        float sNodeMtx[4][4]; // r29+0xD0
        signed short s16MaxNum; // r19
        float sAxisMtx[4][4]; // r29+0x90
        class NNS_VECTOR sVec[2]; // r29+0x70
        signed int s32n; // r17
    }
}


// Range: 0x3231B0 -> 0x324168
void drawPlayerGear(class clsBackLineEffectTask * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3231B0 -> 0x324168
        signed int s32i; // r20
        class clsPlayerTask * pcPlayer; // r2
        enum enmGearCtrl eGearNo; // r2
        class stcParameter * psGearDataTbl; // r2
        enum enmGearType eGearType; // r2
        class stcParameter * psGearData; // r22
        unsigned int u32Color; // r29+0x100
        unsigned int u32LineScale; // r29+0xF0
        class NNS_PRIM3D_PCT asPrimData[82]; // r29+0xA70
        class stcFollowLine * psFollowLine; // r30
        class NNS_VECTORFAST sVectorFast; // r29+0xA60
        class NNS_VECTORFAST sOffVecFast; // r29+0xA50
        class NNS_VECTORFAST sTrickOffVecFast; // r29+0xA40
        float (* psNodeMtx)[4][4]; // r23
        class NNS_VECTORFAST sPosVecFast; // r29+0xA30
        float (* opsViewMtx)[4][4]; // r29+0xE0
        signed short s16NodeNo; // r16
        signed int s32NodeI; // r2
        signed short s16MaxNum; // r20
        float f32TrickDiffScale; // r29+0x1220
        class NNS_VECTORFAST sGearSizeFast; // r29+0xA20
        class NNS_VECTORFAST sGearOfsFast; // r29+0xA10
        float sAxisMtx[4][4]; // r29+0x9D0
        class NNS_VECTOR sVec[2]; // r29+0x9B0
        signed int s32n; // r19
    }
}


// Range: 0x3241A0 -> 0x324474
void calcDrawPrim_Trick(class clsBackLineEffectTask * this /* r2 */, class NNS_PRIM3D_PCT * psPrimData /* r2 */, class NNS_VECTORFAST * psPosFast /* r2 */, class NNS_VECTORFAST * psVecFast /* r2 */, class NNS_VECTORFAST * psGearVecFast /* r2 */, class NNS_VECTORFAST * psGearOfsFast /* r2 */, unsigned int u32Color /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3241A0 -> 0x324474
        float f32StTu; // r3
        float f32EdTu; // r29+0x30
        unsigned char u8StAlpha; // r13
        unsigned char u8EdAlpha; // r15
        signed short s16CusNum; // r2
        class stcFollowLine * psFollowLine; // r2
        signed int s32i; // r25
        float f32Tu; // r29+0x30
    }
}


// Range: 0x324480 -> 0x324724
void calcDrawPrim_Skate(class clsBackLineEffectTask * this /* r2 */, class NNS_PRIM3D_PCT * psPrimData /* r2 */, class NNS_VECTORFAST * psPosFast /* r2 */, class NNS_VECTORFAST * psVecFast /* r2 */, class NNS_VECTORFAST * psOfsFast /* r2 */, unsigned int u32Color /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x324480 -> 0x324724
        float f32StTu; // r3
...
// Range: 0x324730 -> 0x324964
void calcDrawPrim_Diff(class clsBackLineEffectTask * this /* r2 */, class NNS_PRIM3D_PCT * psPrimData /* r2 */, class NNS_VECTORFAST * psPosFast /* r2 */, class NNS_VECTORFAST * psVecFast /* r2 */, class NNS_VECTORFAST * psOfsFast /* r2 */, unsigned int u32Color /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x324730 -> 0x324964
        float f32StTu; // r29+0x10
        float f32EdTu; // r4
        unsigned char u8StAlpha; // r14
        unsigned char u8EdAlpha; // r13
        signed short s16CusNum; // r2
        class stcFollowLine * psFollowLine; // r2
        signed int s32i; // r14
        float f32Tu; // r29+0x10
    }
}


// Range: 0x324970 -> 0x324BFC
void calcDrawPrim_GCtrl(class clsBackLineEffectTask * this /* r2 */, class NNS_PRIM3D_PCT * psPrimData /* r2 */, class NNS_VECTORFAST * psPosFast /* r2 */, class NNS_VECTORFAST * psVecFast /* r2 */, class NNS_VECTORFAST * psOfsFast /* r2 */, unsigned int u32Color /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x324970 -> 0x324BFC
        float f32StTu; // r1
        float f32EdTu; // r29+0x10
        unsigned char u8StAlpha; // r13
        unsigned char u8EdAlpha; // r14
        signed short s16CusNum; // r2
        class stcFollowLine * psFollowLine; // r2
        signed int s32i; // r13
        signed int s32SrcNo; // r2
        float f32Tu; // r29+0x10
    }
}


// Range: 0x324C00 -> 0x324DF8
void calcDrawPrim_NoMove(class clsBackLineEffectTask * this /* r2 */, class NNS_PRIM3D_PCT * psPrimData /* r2 */, class NNS_VECTORFAST * psPosFast /* r2 */, class NNS_VECTORFAST * psVecFast /* r2 */, class NNS_VECTORFAST * psOfsFast /* r2 */, unsigned int u32Color /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x324C00 -> 0x324DF8
        float f32StTu; // r29
...
// Range: 0x324E00 -> 0x3250D0
void calcDrawPrim_Move(class clsBackLineEffectTask * this /* r2 */, class NNS_PRIM3D_PCT * psPrimData /* r2 */, class NNS_VECTORFAST * psPosFast /* r2 */, class NNS_VECTORFAST * psVecFast /* r2 */, class NNS_VECTORFAST * psOfsFast /* r2 */, class NNS_VECTORFAST * psGearVecFast /* r2 */, class NNS_VECTORFAST * psGearOfsFast /* r2 */, unsigned int u32Color /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x324E00 -> 0x3250D0
        float f32StTu; // r3
        float f32EdTu; // r29+0x20
        unsigned char u8StAlpha; // r15
        unsigned char u8EdAlpha; // r16
        signed short s16CusNum; // r2
        class stcFollowLine * psFollowLine; // r2
        signed int s32i; // r15
        float f32Tu; // r29+0x20
    }
}


// Range: 0x3250D0 -> 0x32526C
void calcDrawPoint_Power(class clsBackLineEffectTask * this /* r16 */, class NNS_VECTORFAST * psPosFast /* r22 */, class NNS_VECTORFAST * psVecFast /* r30 */, class NNS_VECTORFAST * psOffFast /* r21 */, class NNS_VECTORFAST * psPower0Fast /* r20 */, class NNS_VECTORFAST * psPowerFast /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3250D0 -> 0x32526C
        class NNS_VECTOR * psPointTbl; // r19
        class NNS_VECTORFAST sAddVecFast; // r29+0xC0
        class NNS_VECTORFAST sDiffFast; // r29+0xB0
        float f32Speed; // r20
        signed int s32i; // r18
        signed int s32SrcDataNo; // r2
    }
}


// Range: 0x325270 -> 0x3253AC
void calcDrawPoint_Diff(class clsBackLineEffectTask * this /* r17 */, class NNS_VECTORFAST * psPosFast /* r5 */, class NNS_VECTORFAST * psVecFast /* r21 */, class NNS_VECTORFAST * psOffFast /* r20 */, class NNS_VECTORFAST * psPowerFast /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x325270 -> 0x3253AC
        class NNS_VECTOR * psPointTbl; // r19
        class NNS_VECTORFAST sDiffFast; // r29+0x80
        class NNS_VECTORFAST sAddVecFast; // r29+0x70
        signed int s32i; // r18
        signed int s32SrcDataNo; // r2
    }
}
...
// Range: 0x3253B0 -> 0x325740
void calcDrawPoint_GCtrl(class clsBackLineEffectTask * this /* r17 */, class NNS_VECTORFAST * psPosFast /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3253B0 -> 0x325740
        class NNS_VECTOR * psPointTbl; // r16
        class NNS_VECTORFAST sCalcDiffPosLast; // r29+0xA0
        class NNS_VECTORFAST sCalcDiffPosCur; // r29+0x90
        class NNS_VECTORFAST sDiffVecFast; // r29+0x80
        class NNS_VECTORFAST sDiffPosVecFast; // r29+0x70
        class NNS_VECTORFAST sDiffBaseVecFast; // r29+0x60
        float f32MoveDist; // r29+0xB0
        signed int s32i; // r20
        signed int s32SrcDataNo; // r2
        signed int s32i; // r20
        signed int s32SrcDataNo; // r2
...
// Range: 0x325750 -> 0x325898
void calcDrawPoint_Trick(class clsBackLineEffectTask * this /* r16 */, class NNS_VECTORFAST * psPosFast /* r5 */, class NNS_VECTORFAST * psVecFast /* r20 */, class NNS_VECTORFAST * psOffFast /* r19 */, float f32AddScale /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x325750 -> 0x325898
        class NNS_VECTOR * psPointTbl; // r18
        class NNS_VECTORFAST sDiffVecFast; // r29+0x80
        signed int s32i; // r17
        signed int s32SrcDataNo; // r2
        class NNS_VECTOR * psSrcVec0; // r2
        class NNS_VECTOR * psSrcVec1; // r21
    }
}


// Range: 0x3258A0 -> 0x325DEC
void update(class clsBackLineEffectTask * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3258A0 -> 0x325DEC
...
// Range: 0x325E00 -> 0x325E34
void stepDrawNum(class clsBackLineEffectTask * this /* r2 */, signed short s16MaxNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x325E00 -> 0x325E34
    }
...
// Range: 0x325E40 -> 0x325F0C
void execute(class clsBackLineEffectTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x325E40 -> 0x325F0C
    }
...
// Range: 0x325F10 -> 0x326064
void * __ct(class clsBackLineEffectTask * this /* r19 */, unsigned char u8Type /* r18 */, class stcParam * opsParam /* r17 */, signed int s32SubNo /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x325F10 -> 0x326064
    }
