/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Stage\St15BossCrush2Effect.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon1 */ {
    // total size: 0x30
} __vt__28clsSt15BossCrush2Effect_Task; // size: 0x30, address: 0x6CCB60
struct /* @anon0 */ {
    // total size: 0x30
...
public:
    ...
    float m_f32MatFrame; // offset 0x60, size 0x4
};
...
// Range: 0x506890 -> 0x506A24
void draw(class clsSt15BossCrush2Effect_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x506890 -> 0x506A24
...
// Range: 0x506A30 -> 0x506B9C
void execute(class clsSt15BossCrush2Effect_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x506A30 -> 0x506B9C
    }
...
// Range: 0x506BA0 -> 0x506C18
void * __ct(class clsSt15BossCrush2Effect_Task * this /* r16 */, float (* opsMatrix)[4][4] /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x506BA0 -> 0x506C18
    }
