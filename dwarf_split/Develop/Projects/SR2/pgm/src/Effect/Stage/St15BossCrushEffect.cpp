/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Stage\St15BossCrushEffect.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon3 */ {
    // total size: 0x30
} __vt__27clsSt15BossCrushEffect_Task; // size: 0x30, address: 0x6CCB30
struct /* @anon0 */ {
    // total size: 0x30
...
public:
    ...
    class NNS_VECTORFAST * m_opsPosVecFast; // offset 0x58, size 0x4
    class clsModelType_OB_TX_MO_MA * m_pcModel; // offset 0x5C, size 0x4
    unsigned char m_bWhiteOut; // offset 0x60, size 0x1
    unsigned char m_u8NegaNum; // offset 0x61, size 0x1
    float m_f32MotFrame; // offset 0x64, size 0x4
    float m_f32MatFrame; // offset 0x68, size 0x4
    float m_f32WaitFrame; // offset 0x6C, size 0x4
    float m_f32WhiteWaitFrame; // offset 0x70, size 0x4
    float m_f32NegaWaitFrame; // offset 0x74, size 0x4
};
class compressed_pair : private compressed_pair_imp {
    // total size: 0x8
};
...
// Range: 0x506130 -> 0x5062C4
void draw(class clsSt15BossCrushEffect_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x506130 -> 0x5062C4
        float (* psMtxPal)[4][4]; // r17
        float aNnViewRotInvertMtx[4][4]; // r29+0x90
        float aMtx[4][4]; // r29+0x50
    }
}


// Range: 0x5062D0 -> 0x506774
void execute(class clsSt15BossCrushEffect_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5062D0 -> 0x506774
    }
...
// Range: 0x506780 -> 0x506820
void * __ct(class clsSt15BossCrushEffect_Task * this /* r18 */, float (* opsMatrix)[4][4] /* r17 */, class NNS_VECTORFAST * opsPosVecFast /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x506780 -> 0x506820
    }
