/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Stage\St15DamageExplode.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon1 */ {
    // total size: 0x30
} __vt__25clsSt15DamageExplode_Task; // size: 0x30, address: 0x6C9B10
struct /* @anon0 */ {
    // total size: 0x30
...
class clsSt15DamageExplode_Task : public clsTask {
    // total size: 0xB0
public:
    class NNS_VECTORFAST * m_opsPosFast; // offset 0x54, size 0x4
    float m_sOfsMatrix[4][4]; // offset 0x60, size 0x40
    unsigned int m_u32Count; // offset 0xA0, size 0x4
    float m_f32Frame; // offset 0xA4, size 0x4
    float m_f32HappenFrame; // offset 0xA8, size 0x4
    float m_f32WaitFrame; // offset 0xAC, size 0x4
};
...
// Range: 0x4D61F0 -> 0x4D6500
void execute(class clsSt15DamageExplode_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D61F0 -> 0x4D6500
        class NNS_VECTORFAST sPosFast; // r29+0x30
    }
}


// Range: 0x4D6500 -> 0x4D65D0
void * __ct(class clsSt15DamageExplode_Task * this /* r17 */, float f32MaxFrame /* r20 */, class NNS_VECTORFAST * opsPosFast /* r16 */, class NNS_QUATERNION * opsQuat /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D6500 -> 0x4D65D0
    }
