/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Post\PS2_ColorDrops.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class stcPrimitive tsPrimitive[10]; // size: 0x64, address: 0x653A10
static unsigned int otau32ColorDropTbl[3]; // size: 0xC, address: 0x697C30
...
// Range: 0x5568A0 -> 0x5572D4
void drawGeometry(class clsColorDrops_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5568A0 -> 0x5572D4
        class stcDetail * psDetail; // r20
        unsigned int bDraw; // r23
        signed int s32OldV; // r30
        float f32FrameRateAddUnPause; // r21
        float f32DeleteFrame; // r20
        ...
        signed int s32uv; // r8
        class stcPrimitive * psPrimitive; // r19
        unsigned int u32PrimCnt; // r18
...
// Range: 0x5572E0 -> 0x557548
void addDetail(class clsColorDrops_Task * this /* r21 */, unsigned int u32vI /* r23 */, unsigned int u32NumI /* r20 */, unsigned int u32ScaleI /* r29+0x11C */, float f32LifeFrameI /* r29+0x120 */, unsigned int bSnowI /* r30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5572E0 -> 0x557548
        unsigned int u32Left; // r2
        unsigned int u32Top; // r2
        unsigned int u32Width; // r2
        unsigned int u32Height; // r2
        unsigned int u32wShift; // r2
        signed int s32Snow; // r2
        float f32LifeFrame; // r29+0x120
        float f32DeleteFrame; // r29+0x120
        unsigned int u32i; // r19
        class stcDetail * psDetail; // r2
        unsigned int u32r; // r2
        unsigned int u32r1; // r2
    }
}


// Range: 0x557550 -> 0x557558
void addDetail(class clsColorDrops_Task * this /* r2 */, unsigned int u32vI /* r2 */, unsigned int u32NumI /* r2 */, unsigned int u32ScaleI /* r2 */, float f32LifeFrameI /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x557550 -> 0x557558
    }
...
// Range: 0x557560 -> 0x557598
void reinitView(class clsColorDrops_Task * this /* r2 */, unsigned char u8ViewNoI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x557560 -> 0x557598
        class stcDetail * psDetail; // r6
        unsigned int u32i; // r5
    }
}


// Range: 0x5575A0 -> 0x5575CC
void reinit(class clsColorDrops_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5575A0 -> 0x5575CC
