/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Post\Shimmer\PS2_Shimmer.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static unsigned long long tau64GsPacket_DrawBlur_NTSC[11][2]; // size: 0xB0, address: 0x654DE0
static unsigned long long tau64GsPacket_DrawBlur_PAL[11][2]; // size: 0xB0, address: 0x654E90
struct /* @anon0 */ {
    // total size: 0x34
} __vt__17clsPfShimmer_Task; // size: 0x34, address: 0x6D1970
struct /* @anon3 */ {
    // total size: 0x34
} __vt__19clsBaseShimmer_Task; // size: 0x34, address: 0x6D1930
...
class clsPfShimmer_Task : public clsBaseShimmer_Task {
    // total size: 0xBC
public:
    unsigned long long * m_pu64Packet; // offset 0xB0, size 0x4
    signed int m_s32y; // offset 0xB4, size 0x4
    float m_f32v; // offset 0xB8, size 0x4
};
...
class stcGeometry {
    // total size: 0x4
public:
    signed char s8tx; // offset 0x0, size 0x1
    signed char s8ty; // offset 0x1, size 0x1
    signed char s8bx; // offset 0x2, size 0x1
    signed char s8by; // offset 0x3, size 0x1
};
...
class clsBaseShimmer_Task : public clsTask {
    // total size: 0xB0
public:
    signed int m_dh; // offset 0x54, size 0x4
    unsigned int m_bDraw; // offset 0x58, size 0x4
    class stcGeometry m_asGeometry[21]; // offset 0x5C, size 0x54
};
...
// Range: 0x58DEA0 -> 0x58E360
void drawGeometry(class clsPfShimmer_Task * this /* r21 */, unsigned int u32vI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58DEA0 -> 0x58E360
        signed int s32x0; // r20
        signed int s32y0; // r2
        signed int s32y1; // r2
        class PXS_CONTEXTBUFFER * sCb; // r19
        unsigned long long * u64p; // r16
        unsigned int ou32BLOCK_W_NUM; // r2
        unsigned int u32i; // r18
        class stcGeometry * psGeometry; // r17
        unsigned int u32Cmd; // r23
        signed int s32i; // r16
        unsigned int m_pac_len; // @ 0x0069A860
        signed char @32472; // @ 0x00BFB540
        unsigned int au32BlockWNum[2]; // @ 0x0069A858
    }
}


// Range: 0x58E360 -> 0x58E414
void * __ct(class clsPfShimmer_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58E360 -> 0x58E414
    }
