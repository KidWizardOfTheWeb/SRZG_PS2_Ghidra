/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Post\BurnOut\PS2_BurnOut.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned int tu32FbWidthShiftR6; // size: 0x4, address: 0xB0D9F8
unsigned long long tau64GsPacket_Setting_SpBuf2SpBuf_NTSC[11][2]; // size: 0xB0, address: 0x6273E0
unsigned long long tau64GsPacket_Setting_SpBuf2SpBuf_PAL[11][2]; // size: 0xB0, address: 0x627490
unsigned long long tau64GsPacket_Setting_SpBuf2Fb_NTSC[11][2]; // size: 0xB0, address: 0x627540
unsigned long long tau64GsPacket_Setting_SpBuf2Fb_PAL[11][2]; // size: 0xB0, address: 0x6275F0
struct /* @anon2 */ {
    // total size: 0x30
} __vt__19clsBurnOut_End_Task; // size: 0x30, address: 0x6BE470
struct /* @anon1 */ {
    // total size: 0x30
...
struct /* @anon0 */ {
    // total size: 0x30
} __vt__21clsBurnOut_Begin_Task; // size: 0x30, address: 0x6BE4A0
struct /* @anon3 */ {
    // total size: 0x2C
...
class clsBurnOut_End_Task : public clsTask {
    // total size: 0x68
public:
    unsigned int m_u32WY; // offset 0x54, size 0x4
    unsigned int m_u32FBHx16; // offset 0x58, size 0x4
    unsigned int m_u32WY_FBHx16; // offset 0x5C, size 0x4
    unsigned long long * m_pu64GsPacket_Setting_SpBuf2SpBuf; // offset 0x60, size 0x4
    unsigned long long * m_pu64GsPacket_Setting_SpBuf2Fb; // offset 0x64, size 0x4
};
...
class clsBurnOut_Begin_Task : public clsTask {
    // total size: 0x58
public:
    unsigned int m_u32GsRestPage2; // offset 0x54, size 0x4
};
class hkArray {
    // total size: 0xC
public:
...
// Range: 0x35A2D0 -> 0x35A878
void draw(class clsBurnOut_End_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x35A2D0 -> 0x35A878
    }
...
// Range: 0x35A8E0 -> 0x35A9B4
void * __ct(class clsBurnOut_End_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x35A8E0 -> 0x35A9B4
    }
...
// Range: 0x35A9C0 -> 0x35AA74
void draw(class clsBurnOut_Begin_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x35A9C0 -> 0x35AA74
    }
...
// Range: 0x35AA90 -> 0x35AC30
void * __ct(class clsBurnOut_Begin_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x35AA90 -> 0x35AC30
    }
