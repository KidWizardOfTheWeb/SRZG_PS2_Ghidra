/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Post\PS2_Blur.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned long long tau64GsPacket_Capture_NTSC[12][2]; // size: 0xC0, address: 0x626FB0
unsigned long long tau64GsPacket_Capture_PAL[12][2]; // size: 0xC0, address: 0x627070
unsigned long long tau64GsPacket_DrawBlur_NTSC[11][2]; // size: 0xB0, address: 0x627130
unsigned long long tau64GsPacket_DrawBlur_PAL[11][2]; // size: 0xB0, address: 0x6271E0
struct /* @anon1 */ {
    // total size: 0x30
} __vt__12clsBlur_Task; // size: 0x30, address: 0x6BE440
...
class stcPrimitive {
    // total size: 0xA
public:
    unsigned short u16x; // offset 0x0, size 0x2
    unsigned short u16y; // offset 0x2, size 0x2
    unsigned short u16u; // offset 0x4, size 0x2
    unsigned short u16v; // offset 0x6, size 0x2
    unsigned char u8Alpha; // offset 0x8, size 0x1
    unsigned char u8RegAddr; // offset 0x9, size 0x1
};
...
// Range: 0x357BD0 -> 0x357EA8
void draw(class clsBlur_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x357BD0 -> 0x357EA8
        class clsDebug & rcDebug; // r2
        unsigned int u32v; // r20
        float * pf32GravityFrame; // r19
        unsigned int u32ViewportNum; // r2
        unsigned char au8Alpha[2]; // r29+0x8C
        float f32Speed; // r29+0x88
        class clsPlayerTask * pcPlayer; // r18
        unsigned int u32Stat; // r2
    }
}


// Range: 0x357EB0 -> 0x357F58
void execute(class clsBlur_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x357EB0 -> 0x357F58
        float * pf32GravityFrame; // r10
        class clsTaskManager & rcTaskMgr; // r2
        unsigned int u32v; // r9
    }
}


// Range: 0x357F60 -> 0x3587D0
void drawGravity(class clsBlur_Task * this /* r21 */, unsigned int u32v /* r2 */, unsigned char bCancel /* r29+0xDF */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x357F60 -> 0x3587D0
        unsigned int u32Left; // r2
        unsigned int u32Top; // r2
        unsigned int u32Right; // r2
        unsigned int u32Bottom; // r2
        unsigned int u32CenterX; // r2
        unsigned int u32TopV; // r2
        unsigned int u32BottomV; // r2
        class stcPrimitive sDrawBlurPrimitive_NTSC[6]; // r29+0x120
        class stcPrimitive sDrawBlurPrimitive_PAL[6]; // r29+0xE0
        class stcPrimitive * psDrawBlurPrimitive[2]; // r29+0x160
        unsigned long long * pu64p; // r19
        class stcPrimitive * psPrimitive; // r18
        float * pf32GravityFrame; // r2
        float f32Speed; // r29+0x16C
        unsigned int u32Shift; // r2
        class PXS_CONTEXTBUFFER * sCb; // r17
...
// Range: 0x3587D0 -> 0x359F5C
void drawNormal(class clsBlur_Task * this /* r2 */, unsigned int u32v /* r2 */, unsigned char u8Alpha /* r2 */, float f32Speed /* r29+0x190 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3587D0 -> 0x359F5C
        unsigned int u32Left; // r2
        ...
        unsigned int u32Bottom; // r2
        unsigned int H_X; // r2
        unsigned int B_X0; // r2
        unsigned int B_X1; // r2
        unsigned int B_Y0; // r2
        unsigned int B_Y1; // r2
        class stcPrimitive sDrawBlurPrimitive_NTSC[9]; // r29+0x120
        class stcPrimitive sDrawBlurPrimitive_PAL[9]; // r29+0xC0
        class stcPrimitive * psDrawBlurPrimitive[2]; // r29+0x188
        unsigned long long * pu64p; // r21
        class stcPrimitive * psPrimitive; // r20
        unsigned int u32Shift; // r2
        class PXS_CONTEXTBUFFER * sCb; // r19
...
// Range: 0x359F60 -> 0x35A118
void captureFullScreen(class clsBlur_Task * this /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x359F60 -> 0x35A118
        unsigned long long * pu64p; // r16
        class PXS_CONTEXTBUFFER * sCb; // r21
        unsigned int u32i; // r20
        signed int s32x0; // r19
        signed int s32x1; // r18
    }
}


// Range: 0x35A120 -> 0x35A254
void * __ct(class clsBlur_Task * this /* r16 */, unsigned int u32Tp /* r2 */, signed int s32Flg /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x35A120 -> 0x35A254
        unsigned int u32ViewportNum; // r2
