/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Post\Shimmer\BaseShimmer.cpp
...
// Range: 0x58DAF0 -> 0x58DB8C
void draw(class clsBaseShimmer_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58DAF0 -> 0x58DB8C
        unsigned int u32ViewportNum; // r2
        unsigned char * opb; // r19
        unsigned int u32v; // r16
    }
}


// Range: 0x58DB90 -> 0x58DC68
void execute(class clsBaseShimmer_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58DB90 -> 0x58DC68
    }
...
// Range: 0x58DC70 -> 0x58DDAC
void updateGeometry(class clsBaseShimmer_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58DC70 -> 0x58DDAC
        class stcGeometry * psGeometry; // r18
        signed int s32r; // r2
        signed int s32i; // r17
    }
}
...
// Range: 0x58DDC0 -> 0x58DE14
void * __ct(class clsBaseShimmer_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58DDC0 -> 0x58DE14
    }
