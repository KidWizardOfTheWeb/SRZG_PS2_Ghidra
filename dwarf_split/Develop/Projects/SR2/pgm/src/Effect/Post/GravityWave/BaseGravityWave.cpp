/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Post\GravityWave\BaseGravityWave.cpp
...
// Range: 0x531B00 -> 0x531F78
void draw(class clsBaseGravityWave_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x531B00 -> 0x531F78
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        unsigned int u32v; // r20
        unsigned int u32TmpV; // r29+0xAC
        unsigned int bCap; // r30
        unsigned char * peMode; // r19
        unsigned char * peType; // r18
