/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Post\PS2_RainDrops.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned long long tau64GsPacket_DrawRainDrops_NTSC[10][2]; // size: 0xA0, address: 0x6360B0
unsigned long long tau64GsPacket_DrawRainDrops_PAL[10][2]; // size: 0xA0, address: 0x636150
class stcPrimitive tsPrimitive[10]; // size: 0x64, address: 0x6361F0
unsigned int DRAW_RAINDROPS_PRIMITIVE_N_NUM; // size: 0x4, address: 0x0
unsigned int ALL_GS_PACKET_DRAW_RAINDROPS_NUM; // size: 0x4, address: 0x0
struct /* @anon1 */ {
    // total size: 0x3C
} __vt__17clsRainDrops_Task; // size: 0x3C, address: 0x6C2EC0
...
// Range: 0x40DCE0 -> 0x40E814
void drawGeometry(class clsRainDrops_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40DCE0 -> 0x40E814
        class stcDetail * psDetail; // r16
        unsigned int bDraw; // r23
        signed int s32OldV; // r30
        float f32Speed; // r21
        float f32FrameRateAddUnPause; // r20
        unsigned int u32i; // r22
        unsigned int u32x; // r2
        unsigned int u32y; // r2
        unsigned int u32r2; // r2
        unsigned int u32r4; // r2
        signed int s32uv; // r4
        class stcPrimitive * psPrimitive; // r21
        unsigned int u32PrimCnt; // r20
...
// Range: 0x40E820 -> 0x40E8A0
void draw(class clsRainDrops_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40E820 -> 0x40E8A0
    }
...
// Range: 0x40E8A0 -> 0x40E974
void drawBegin(class clsRainDrops_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40E8A0 -> 0x40E974
        unsigned long long * pu64p; // r17
        class PXS_CONTEXTBUFFER * sCb; // r16
        unsigned int u32i; // r18
    }
}


// Range: 0x40E980 -> 0x40EC60
void addDetail(class clsRainDrops_Task * this /* r21 */, unsigned int u32vI /* r29+0x12C */, unsigned int u32NumI /* r20 */, unsigned int bSnowI /* r2 */, float f32LifeFrameI /* r29+0x150 */, unsigned char u8IsGrowType /* r29+0x12B */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40E980 -> 0x40EC60
        ...
        unsigned int u32wShift; // r2
        signed int s32Snow; // r2
        float f32LifeFrame; // r20
        unsigned int u32i; // r19
        class stcDetail * psDetail; // r2
        unsigned int u32r; // r18
        unsigned int u32r1; // r2
        unsigned int u32r2; // r2
...
// Range: 0x40EC60 -> 0x40EC8C
void reinit(class clsRainDrops_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40EC60 -> 0x40EC8C
        class stcDetail * psDetail; // r4
        unsigned int u32i; // r3
    }
}


// Range: 0x40EC90 -> 0x40ED58
void * __ct(class clsRainDrops_Task * this /* r16 */, unsigned int u32Tp /* r2 */, signed int s32Flg /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40EC90 -> 0x40ED58
    }
