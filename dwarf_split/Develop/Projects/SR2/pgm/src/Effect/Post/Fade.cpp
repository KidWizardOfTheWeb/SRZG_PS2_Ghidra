/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Post\Fade.cpp
...
// Range: 0x34EBD0 -> 0x34EFC0
void draw(class clsFade_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34EBD0 -> 0x34EFC0
        unsigned int u32Rgba; // r17
        unsigned int u32Alpha; // r5
    }
}


// Range: 0x34EFC0 -> 0x34F014
void execute(class clsFade_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34EFC0 -> 0x34F014
    }
