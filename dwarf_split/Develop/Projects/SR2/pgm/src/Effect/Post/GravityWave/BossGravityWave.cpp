/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Post\GravityWave\BossGravityWave.cpp
...
// Range: 0x58D130 -> 0x58D440
void draw(class clsBossGravityWave_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58D130 -> 0x58D440
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        unsigned int u32v; // r19
        unsigned int u32TmpV; // r20
        unsigned int bCap; // r30
        unsigned char * peMode; // r18
...
// Range: 0x58D440 -> 0x58D534
void execute(class clsBossGravityWave_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58D440 -> 0x58D534
        class clsTaskManager & rcTaskMgr; // r2
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        float f32FrameRateAdd; // r4
        unsigned int u32ViewportNum; // r2
