/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\MiniWave\MiniWave.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcMiniWaveParam asMiniWaveParam[4]; // size: 0x90, address: 0x682560
class _NNS_TEXLIST * psTexList_MiniWave; // size: 0x4, address: 0xB163C8
struct /* @anon1 */ {
    // total size: 0x30
...
class NNS_VECTOR tosZVec; // size: 0xC, address: 0x682610
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x682620
...
// Range: 0x3D0510 -> 0x3D0518
void setPosVecFast(class clsMiniWaveEffect_Task * this /* r2 */, class NNS_VECTORFAST & rsPosVecFast /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D0510 -> 0x3D0518
    }
...
// Range: 0x3D0520 -> 0x3D0528
void setPosturalMtxPtr(class clsMiniWaveEffect_Task * this /* r2 */, float (* opaMtx)[4][4] /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D0520 -> 0x3D0528
    }
...
// Range: 0x3D0530 -> 0x3D0538
void setVelocityMtxPtr(class clsMiniWaveEffect_Task * this /* r2 */, float (* opaMtx)[4][4] /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D0530 -> 0x3D0538
    }
...
// Range: 0x3D0540 -> 0x3D0704
void setWavePosition(class clsMiniWaveEffect_Task * this /* r19 */, class NNS_VECTORFAST & rsPosVecFast /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D0540 -> 0x3D0704
        class NNS_VECTORFAST sVecFast; // r29+0x50
        class stcMiniWaveParam * psMiniWaveParam; // r2
        class stcDebugMiniWave * psDebugMiniWave; // r2
    }
}


// Range: 0x3D0710 -> 0x3D072C
void init(class clsMiniWaveEffect_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D0710 -> 0x3D072C
    }
...
// Range: 0x3D0730 -> 0x3D19C0
void draw(class clsMiniWaveEffect_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D0730 -> 0x3D19C0
        float aMtx[4][4]; // r29+0x350
        unsigned int u32TexNoTop; // r16
    }
}


// Range: 0x3D1A60 -> 0x3D1E20
void execute(class clsMiniWaveEffect_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D1A60 -> 0x3D1E20
        class NNS_VECTORFAST sWaveOffsetVec; // r29+0xD0
        float (* psMtxList)[4][4]; // r17
        float aNodeMtx[4][4]; // r29+0x90
        float aMirrorMtx[4][4]; // r29+0x50
        class NNS_VECTORFAST sVecFast; // r29+0x40
        unsigned char u8NodeNo; // r2
    }
}


// Range: 0x3D1E20 -> 0x3D209C
void * __ct(class clsMiniWaveEffect_Task * this /* r20 */, unsigned char u8PlayerNo /* r19 */, unsigned char u8EffectNo /* r18 */, unsigned int u32DataNo /* r17 */, unsigned char u8TexType /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D1E20 -> 0x3D209C
    }
