/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\SunLenz.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class strLensFlareInfo cotsLensFlareInfo[10]; // size: 0xA0, address: 0x6969F0
static float tf32z_Debug; // size: 0x4, address: 0x6538D0
struct /* @anon1 */ {
    // total size: 0x30
...
class strLensFlareInfo {
    // total size: 0x10
public:
    float f32PosOfs; // offset 0x0, size 0x4
    float f32Scale; // offset 0x4, size 0x4
    unsigned int u32RGB; // offset 0x8, size 0x4
    signed int s32TextureNo; // offset 0xC, size 0x4
};
class NNS_RGBA {
    // total size: 0x10
public:
...
// Range: 0x537080 -> 0x537580
void draw(class clsSunLenz_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x537080 -> 0x537580
        class clsPfDraw2d & rcOODraw2d; // r2
        class stcDetail * psDetail; // r20
        class _NNS_TEXLIST * psResidence_TexList; // r30
...
// Range: 0x537580 -> 0x53782C
void execute(class clsSunLenz_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x537580 -> 0x53782C
        unsigned int u32v; // r18
        class stcDetail * psDetail; // r17
        unsigned int bIn; // r16
    }
}


// Range: 0x537830 -> 0x53787C
void setTexture(class clsSunLenz_Task * this /* r2 */, unsigned char u8type /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x537830 -> 0x53787C
    }
