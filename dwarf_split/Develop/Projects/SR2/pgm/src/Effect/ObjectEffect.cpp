/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\ObjectEffect.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x30
} __vt__20clsObjectEffect_Task; // size: 0x30, address: 0x6CD9A0
struct /* @anon1 */ {
    // total size: 0x30
...
// Range: 0x519790 -> 0x519BEC
void draw(class clsObjectEffect_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x519790 -> 0x519BEC
...
// Range: 0x519BF0 -> 0x519C6C
void * __ct(class clsObjectEffect_Task * this /* r18 */, unsigned int u32TpI /* r2 */, signed int s32TypeI /* r2 */, class clsModelType_OB_TX_MO_MA * pcModelI /* r2 */, unsigned int eFlagI /* r2 */, class NNS_VECTORFAST * opsFollowPosFast /* r17 */, float (* opsFollowMtx)[4][4] /* r16 */, unsigned int u32ViewNo /* r2 */, float f32WaitFrame /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x519BF0 -> 0x519C6C
    }
