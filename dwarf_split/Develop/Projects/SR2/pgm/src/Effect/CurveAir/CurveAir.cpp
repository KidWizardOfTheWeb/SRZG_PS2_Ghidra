/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\CurveAir\CurveAir.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned char bCurveAirEffect[8]; // size: 0x8, address: 0xB0D900
struct /* @anon0 */ {
    // total size: 0x30
...
public:
    ...
    float m_f32Cnt; // offset 0xE0, size 0x4
    unsigned int m_u32Type; // offset 0xE4, size 0x4
};
...
// Range: 0x321590 -> 0x321848
void execute(class clsCurveAirEffect_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x321590 -> 0x321848
...
// Range: 0x321880 -> 0x321894
unsigned char getVisible(enum enmNo eNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x321880 -> 0x321894
    }
