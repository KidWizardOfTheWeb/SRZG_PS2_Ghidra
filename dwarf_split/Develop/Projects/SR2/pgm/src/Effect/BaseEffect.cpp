/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\BaseEffect.cpp
...
// Range: 0x2F5E80 -> 0x2F643C
void draw(class clsBaseEffect_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F5E80 -> 0x2F643C
        unsigned int * psNodeStat; // r19
        float (* psMtxPal)[4][4]; // r18
        float aNnViewRotInvertMtx[4][4]; // r29+0x100
        float aMtx[4][4]; // r29+0xC0
        float f32Speed; // r1
        class tagMatAlphaTmp sOldAlpha; // r29+0x90
        class tagMatAlphaTmp sOldAlpha; // r29+0x60
    }
}


// Range: 0x2F6440 -> 0x2F65F4
void execute(class clsBaseEffect_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F6440 -> 0x2F65F4
        unsigned char bEnd; // r17
    }
}


// Range: 0x2F6600 -> 0x2F67AC
void * __ct(class clsBaseEffect_Task * this /* r21 */, unsigned int u32TpI /* r2 */, signed int s32TypeI /* r2 */, class clsModelType_OB_TX_MO_MA * pcModelI /* r20 */, unsigned int eFlagI /* r19 */, unsigned int u32ViewNo /* r18 */, enum enmNo eNo /* r17 */, enum enmCalcNodePos eBornNo /* r16 */, float f32WaitFrame /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F6600 -> 0x2F67AC
    }
