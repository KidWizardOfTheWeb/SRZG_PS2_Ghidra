/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Particle\ParticleSpiralRadiate.cpp
...
// Range: 0x300D90 -> 0x300EA4
void moveCalc(class clsParticleSpiralRadiate * this /* r21 */, class NNS_VECTORFAST * psVecFast /* r20 */, class stcParticleDetail * psDetailHi /* r19 */, class stcParticleExtensionData * psExtension /* r18 */, float f32AddFrame /* r29+0x70 */, float (* opsPositionMtx)[4][4] /* r17 */, unsigned char bFollowPostion /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x300D90 -> 0x300EA4
    }
...
// Range: 0x300EB0 -> 0x300F80
void setCreatedSeparate(class stcParticleExtensionData * psExtension /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x300EB0 -> 0x300F80
    }
