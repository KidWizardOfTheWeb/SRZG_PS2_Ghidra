/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Particle\ParticleSpiralAbsorb.cpp
...
// Range: 0x300AE0 -> 0x300BF4
void moveCalc(class clsParticleSpiralAbsorb * this /* r21 */, class NNS_VECTORFAST * psVecFast /* r20 */, class stcParticleDetail * psDetailHi /* r19 */, class stcParticleExtensionData * psExtension /* r18 */, float f32AddFrame /* r29+0x70 */, float (* opsPositionMtx)[4][4] /* r17 */, unsigned char bFollowPostion /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x300AE0 -> 0x300BF4
    }
...
// Range: 0x300C00 -> 0x300D18
void setCreatedSeparate(class stcParticleDetail * psDetailHi /* r17 */, class stcParticleExtensionData * psExtension /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x300C00 -> 0x300D18
    }
