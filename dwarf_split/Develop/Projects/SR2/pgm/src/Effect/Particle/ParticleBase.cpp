/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Particle\ParticleBase.cpp
...
class NNS_PRIM3D_P tasPrim3D_P_Line[2]; // size: 0x18, address: 0xB0A960
class NNS_PRIM3D_PCT tasPrim3D_PCT_Triangle[3]; // size: 0x48, address: 0x624B40
signed int ts32TryPrim3D_PCT_Num; // size: 0x4, address: 0x624B88
class NNS_PRIM3D_PCT tasPrim3D_PCT_Polygon[4]; // size: 0x60, address: 0x624B90
signed int ts32PolygonNum; // size: 0x4, address: 0x624BF0
class NNS_PRIM3D_PCT tasPrim3D_PCT_Polygon[4]; // size: 0x60, address: 0x624C00
class NNS_PRIM2D_PCT tasPrim2D_PCT_Triangle[3]; // size: 0x3C, address: 0x624C60
signed int ts32Prim2D_PCT_Num; // size: 0x4, address: 0x624CA0
class NNS_PRIM2D_PCT tasPrim2D_PCT_Polygon[4]; // size: 0x50, address: 0x624CB0
class NNS_PRIM3D_PC tasPrim3D_PC_Polygon[4]; // size: 0x40, address: 0x624D00
signed int ts32PolygonNum; // size: 0x4, address: 0x624D40
...
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x66AC20
class clsPfCameraMgr * m_tpcSingleton; // size: 0x4, address: 0x6E69C0
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x66AC60
...
// Range: 0x2F6D10 -> 0x2F6DB8
void draw(class clsParticleBase * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F6D10 -> 0x2F6DB8
    }
...
// Range: 0x2F6DC0 -> 0x2F731C
void execute(class clsParticleBase * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F6DC0 -> 0x2F731C
    }
...
// Range: 0x2F7320 -> 0x2F7338
unsigned char checkBits(unsigned short u16Flg /* r2 */, unsigned short u16CheckFlg /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F7320 -> 0x2F7338
    }
...
// Range: 0x2F7340 -> 0x2F8890
void drawBase(class clsParticleBase * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F7340 -> 0x2F8890
    }
...
// Range: 0x2F8890 -> 0x2F8908
void setTransrateMtx(class clsParticleBase * this /* r18 */, float (* psMtx)[4][4] /* r17 */, class stcParticleDetail * psDetailHi /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F8890 -> 0x2F8908
    }
...
// Range: 0x2F8910 -> 0x2F8A5C
unsigned char checkClip(class clsParticleBase * this /* r17 */, unsigned int u32View /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F8910 -> 0x2F8A5C
        class NNS_VECTORFAST sVecFast0; // r29+0x60
        class NNS_VECTORFAST sVecFast1; // r29+0x50
        class NNS_VECTORFAST sCamPosVecFast; // r29+0x40
        float f32Dist; // r29+0x70
        unsigned char bFollowPostion; // r16
        float f32ClipDist; // r20
    }
}


// Range: 0x2F8A70 -> 0x2F97F0
void moveBase(class clsParticleBase * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F8A70 -> 0x2F97F0
        class stcParticleDetail * psDetailHi; // r20
        class stcParticleExtensionData * psExtension; // r19
        unsigned char bRoll; // r2
        unsigned char bSphere; // r30
        unsigned char bColRet; // r2
        unsigned char bRandSizeX; // r2
        unsigned char bFollowPostion; // r22
        unsigned char bRandPos; // r2
        unsigned char bScaleAnm; // r2
        class NNS_VECTORFAST sVecFast; // r29+0x110
        unsigned int u32n; // r18
        class NNS_VECTORFAST sAddPosVecFast; // r29+0x100
        float f32Dist; // r22
    }
}
