/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Particle\ParticleLayer.cpp
...
float g_f32LastLayerCountModelViewer; // size: 0x4, address: 0xB0AF38
...
// Range: 0x2F9B80 -> 0x2FA188
void execute(class clsParticleLayer * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F9B80 -> 0x2FA188
        unsigned short u16i; // r21
        unsigned short u16Count; // r16
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        unsigned char bPortalIn; // r20
    }
}


// Range: 0x2FA190 -> 0x2FA50C
void checkFlg(class clsParticleLayer * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FA190 -> 0x2FA50C
        unsigned int u32SeNumber; // r16
    }
}


// Range: 0x2FA510 -> 0x2FA528
void stopAllLayer() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FA510 -> 0x2FA528
