/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Particle\ParticleRadiate.cpp
...
// Range: 0x2FA5A0 -> 0x2FA6B0
void moveCalc(class clsParticleRadiate * this /* r21 */, class NNS_VECTORFAST * psVecFast /* r20 */, class stcParticleDetail * psDetailHi /* r19 */, class stcParticleExtensionData * psExtension /* r18 */, float f32AddFrame /* r20 */, float (* opsPositionMtx)[4][4] /* r17 */, unsigned char bFollowPostion /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FA5A0 -> 0x2FA6B0
    }
...
// Range: 0x2FA6B0 -> 0x2FA6C4
void setCreatedSeparate(class stcParticleExtensionData * psExtension /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FA6B0 -> 0x2FA6C4
    }
