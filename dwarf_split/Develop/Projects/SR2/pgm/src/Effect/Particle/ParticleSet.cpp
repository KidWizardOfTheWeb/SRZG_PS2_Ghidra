/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\Particle\ParticleSet.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static unsigned char g_au8ParticleTextureDrawType[8]; // size: 0x8, address: 0x0
static unsigned char g_au8ParticleConfigDrawType[8]; // size: 0x8, address: 0x66AC80
...
unsigned char bParticleConfigBlend[2]; // size: 0x2, address: 0xB0AF50
signed short as16ParticleConfigTaskMatrix[2][2]; // size: 0x8, address: 0xB0AF58
signed short as16ParticleConfigTaskTex[2][2][40]; // size: 0x140, address: 0xB0AF60
unsigned short au16ParticleConfigTaskCheck[2][2][43][5]; // size: 0x6B8, address: 0xB0B0A0
class stcParticleEditParam sParticleFullData; // size: 0xD0, address: 0x0
...
struct /* @anon5 */ {
    // total size: 0x30
} __vt__16clsParticleLayer; // size: 0x30, address: 0x6BBE00
...
unsigned short g_u16ParticleLayerCtrlStopCode; // size: 0x2, address: 0xB0AF28
unsigned int g_u32LayerAdrMask; // size: 0x4, address: 0xB0AF40
struct /* @anon0 */ {
    // total size: 0x38
} __vt__23clsParticleSpiralAbsorb; // size: 0x38, address: 0x6BBEA0
struct /* @anon4 */ {
    // total size: 0x38
} __vt__24clsParticleSpiralRadiate; // size: 0x38, address: 0x6BBEE0
struct /* @anon1 */ {
    // total size: 0x38
} __vt__17clsParticleAbsorb; // size: 0x38, address: 0x6BBD80
struct /* @anon8 */ {
    // total size: 0x38
} __vt__18clsParticleRadiate; // size: 0x38, address: 0x6BBE30
struct /* @anon3 */ {
    // total size: 0x30
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x66AD30
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x0
unsigned short g_u16ParticleLayerStopCode; // size: 0x2, address: 0xB0AF20
...
struct /* @anon6 */ {
    // total size: 0x30
} __vt__18clsParticleTexture; // size: 0x30, address: 0x6BBE70
struct /* @anon7 */ {
    // total size: 0x2C
...
class clsParticleLayer : public clsTask {
    // total size: 0x100
public:
    class stcParticleLayerParam m_sLayer; // offset 0x54, size 0x24
    unsigned char m_u8ViewPort; // offset 0x78, size 0x1
    unsigned char m_u8LayerType; // offset 0x79, size 0x1
    unsigned short m_u16DataNo; // offset 0x7A, size 0x2
    unsigned short m_u16StopCode; // offset 0x7C, size 0x2
    float m_f32CurFrame; // offset 0x80, size 0x4
    unsigned char m_u8PlayFlg; // offset 0x84, size 0x1
    signed int m_s32SelectNo; // offset 0x88, size 0x4
    float m_sMatrix[4][4]; // offset 0x90, size 0x40
    class NNS_VECTORFAST m_sPosVecFast; // offset 0xD0, size 0x10
    float m_SafetyWaitFrame; // offset 0xE0, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0xE4, size 0x4
    class NNS_VECTORFAST * m_opsVelocityVecFast; // offset 0xE8, size 0x4
    class NNS_VECTORFAST * m_opsFollowPosVecFast; // offset 0xEC, size 0x4
    class NNS_VECTORFAST * m_opsRotVecFast; // offset 0xF0, size 0x4
    float (* m_opsFollowMatrix)[4][4]; // offset 0xF4, size 0x4
    class _NNS_TEXLIST * m_opsTexList; // offset 0xF8, size 0x4
};
...
// Range: 0x2FA6D0 -> 0x2FA7A0
unsigned int getModoEffectNo(unsigned int u32EffectNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FA6D0 -> 0x2FA7A0
        unsigned int u32StegeEndNo; // r5
    }
}


// Range: 0x2FA7A0 -> 0x2FA7A8
...
// Range: 0x2FAB10 -> 0x2FADDC
unsigned short registTaskForEvent(unsigned char u8ViewPort /* r21 */, unsigned int u32Code /* r20 */, class NNS_VECTORFAST * opsPosVecFast /* r19 */, float (* opsMatrix)[4][4] /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FAB10 -> 0x2FADDC
        unsigned char * pu8Buf; // r2
        class stcParticleLayerParam * psLayerData; // r17
        unsigned short u16StopCode; // r29+0x8E
    }
}


// Range: 0x2FADE0 -> 0x2FAFC0
void setRemoveThroughColisionParticle(class clsPlayerTask * pcPlayer /* r17 */, unsigned char u8SubNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FADE0 -> 0x2FAFC0
    }
...
// Range: 0x2FAFC0 -> 0x2FB284
void setThroughColisionParticle(class clsPlayerTask * pcPlayer /* r19 */, unsigned char u8SubNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FAFC0 -> 0x2FB284
...
// Range: 0x2FB290 -> 0x2FB38C
void setWaterWalkParticle(class clsPlayerTask * pcPlayer /* r7 */, unsigned char bReverse /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FB290 -> 0x2FB38C
    }
...
// Range: 0x2FB390 -> 0x2FB424
void setWaterLandingParticle(class clsPlayerTask & rcPlayer /* r7 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FB390 -> 0x2FB424
    }
...
// Range: 0x2FB430 -> 0x2FB4FC
void setWaterRunParticle(class clsPlayerTask & rcPlayer /* r7 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FB430 -> 0x2FB4FC
    }
...
// Range: 0x2FB500 -> 0x2FB658
unsigned char setWallParticle(class clsPlayerTask & rcPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FB500 -> 0x2FB658
    }
...
// Range: 0x2FB660 -> 0x2FBC9C
unsigned char setGrindLinkParticle(class clsPlayerTask & rcPlayer /* r20 */, unsigned char * pu8Frame /* r19 */, unsigned int u32Type /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FB660 -> 0x2FBC9C
    }
...
// Range: 0x2FBCA0 -> 0x2FC168
void setBreakLargeObjectParticle(class NNS_VECTORFAST * opsVecFast /* r16 */, unsigned int u32Type /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FBCA0 -> 0x2FC168
    }
...
// Range: 0x2FC170 -> 0x2FCFE4
void setBreakSmallObjectParticle(class NNS_VECTORFAST * opsVecFast /* r16 */, unsigned int u32Type /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FC170 -> 0x2FCFE4
    }
...
// Range: 0x2FCFF0 -> 0x2FD230
void setBadTrackHi(unsigned char u8ViewPort /* r18 */, float (* opsFollowMatrix)[4][4] /* r5 */, class NNS_VECTORFAST * opsVecFast /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FCFF0 -> 0x2FD230
        class clsDivStage_Task * pcDivStage; // r2
    }
}


// Range: 0x2FD230 -> 0x2FD470
void setBadTrackLow(unsigned char u8ViewPort /* r18 */, float (* opsFollowMatrix)[4][4] /* r5 */, class NNS_VECTORFAST * opsVecFast /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FD230 -> 0x2FD470
        class clsDivStage_Task * pcDivStage; // r2
...
// Range: 0x2FD470 -> 0x2FD934
unsigned short registTask(unsigned char u8ViewPort /* r20 */, unsigned int u32Code /* r19 */, float f32PosX /* r25 */, float f32PosY /* r24 */, float f32PosZ /* r23 */, float f32AngX /* r22 */, float f32AngY /* r21 */, float f32AngZ /* r20 */, unsigned char u8DataType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FD470 -> 0x2FD934
        unsigned char * pu8Buf; // r18
        unsigned int u32DataNo; // r2
        class stcParticleLayerParam * psLayerData; // r2
        unsigned short u16StopCode; // r29+0x8E
    }
}


// Range: 0x2FD940 -> 0x2FDD80
class clsTask * registTaskAdr(unsigned char u8ViewPort /* r21 */, unsigned int u32Code /* r20 */, float (* opsFollowMatrix)[4][4] /* r19 */, class NNS_VECTORFAST * opsVecFast /* r18 */, class _NNS_TEXLIST * opsTexList /* r22 */, unsigned char u8LayerType /* r23 */, unsigned char u8DataType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FD940 -> 0x2FDD80
        unsigned char * pu8Buf; // r17
        unsigned int u32DataNo; // r2
        class stcParticleLayerParam * psLayerData; // r2
        unsigned short u16StopCode; // r29+0x9E
    }
}


// Range: 0x2FDD80 -> 0x2FE1A8
class clsTask * registTaskAdr(unsigned char u8ViewPort /* r21 */, unsigned int u32Code /* r20 */, class NNS_VECTORFAST * opsVecFast /* r19 */, unsigned char u8DataType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FDD80 -> 0x2FE1A8
        unsigned char * pu8Buf; // r18
        unsigned int u32DataNo; // r2
        class stcParticleLayerParam * psLayerData; // r2
        unsigned short u16StopCode; // r29+0x7E
    }
}


// Range: 0x2FE1B0 -> 0x2FE1D0
unsigned short registTask(unsigned char u8ViewPort /* r2 */, unsigned int u32Code /* r2 */, class NNS_VECTORFAST * opsVecFast /* r2 */, unsigned char u8DataType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FE1B0 -> 0x2FE1D0
    }
...
// Range: 0x2FE1D0 -> 0x2FE65C
unsigned short registTaskObjData(unsigned char u8ViewPort /* r21 */, unsigned int u32Code /* r20 */, class NNS_VECTORFAST * opsRotVecFast /* r19 */, class NNS_VECTORFAST * opsVecFast /* r18 */, class _NNS_TEXLIST * opsTexList /* r22 */, unsigned char u8DataType /* r2 */, signed int s32SelectNo /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FE1D0 -> 0x2FE65C
        unsigned char * pu8Buf; // r17
...
// Range: 0x2FE660 -> 0x2FEAA0
unsigned short registTask(unsigned char u8ViewPort /* r21 */, unsigned int u32Code /* r20 */, float (* opsFollowMatrix)[4][4] /* r19 */, class NNS_VECTORFAST * opsVecFast /* r18 */, class _NNS_TEXLIST * opsTexList /* r22 */, unsigned char u8Type /* r23 */, unsigned char u8DataType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FE660 -> 0x2FEAA0
        unsigned char * pu8Buf; // r17
...
// Range: 0x2FEAA0 -> 0x2FED58
void registTaskParticleData(unsigned char u8ViewPort /* r20 */, unsigned short * opu16StopCode /* r19 */, unsigned short u16Burn /* r2 */, class stcParticleEditParam * psParam /* r18 */, float (* opsFollowMatrix)[4][4] /* r17 */, class NNS_VECTORFAST * opsVecFast /* r16 */, class _NNS_TEXLIST * opsTexList /* r22 */, unsigned char u8ParticleType /* r23 */, signed int s32EndFrame /* r30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FEAA0 -> 0x2FED58
        signed int s32Size; // r2
    }
}


// Range: 0x2FED60 -> 0x2FEE40
void initSetTask() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FED60 -> 0x2FEE40
        unsigned int u32n; // r24
        unsigned int u32i; // r15
        unsigned int u32j; // r12
        unsigned int u32k; // r14
    }
}


// Range: 0x2FEE40 -> 0x2FF28C
unsigned int checkDeleateParticleTextureTask(unsigned char bBurn /* r2 */, unsigned char u8Blend /* r2 */, unsigned char u8ZMode /* r2 */, unsigned char u8DrawType /* r2 */, unsigned char u8TextureNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FEE40 -> 0x2FF28C
    }
...
// Range: 0x2FF290 -> 0x2FF49C
void subtractParticleTextureTask(class stcParticleData * psDefData /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FF290 -> 0x2FF49C
        unsigned char bBurn; // r2
        unsigned char u8Blend; // r2
        unsigned char u8ZMode; // r2
        unsigned char u8DrawType; // r2
        unsigned char u8TextureNo; // r2
    }
}


// Range: 0x2FF4A0 -> 0x3009F4
static void setParticleTextureTask(unsigned char bBurn /* r17 */, class stcParticleData * psDefData /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2FF4A0 -> 0x3009F4
        unsigned char u8Blend; // r2
        ...
        unsigned char u8DrawType; // r2
        unsigned char u8TextureNo; // r2
        signed int s32TaskPriority; // r21
        unsigned int u32BasePriority; // r16
    }
}
