/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\GravityWaveMotionBlurPlayer.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x30
} __vt__35clsGravityWaveMotionBlurPlayer_Task; // size: 0x30, address: 0x6BBF20
struct /* @anon1 */ {
    // total size: 0x30
...
class clsGravityWaveMotionBlurPlayer_Task : public clsTask {
    // total size: 0x60
public:
    float m_f32Distance; // offset 0x54, size 0x4
    unsigned int m_u32PlayerNo; // offset 0x58, size 0x4
...
// Range: 0x3014E0 -> 0x301738
void draw(class clsGravityWaveMotionBlurPlayer_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3014E0 -> 0x301738
        float sMtx[4][4]; // r29+0xA0
        float sMtx2[4][4]; // r29+0x60
    }
}


// Range: 0x301740 -> 0x301820
void execute(class clsGravityWaveMotionBlurPlayer_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x301740 -> 0x301820
    }
