/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\GearChenge\GearTypeChange.cpp
...
public:
    ...
    float m_f32ScaleX; // offset 0xE8, size 0x4
    float m_f32ScaleY; // offset 0xEC, size 0x4
    float m_f32MaxScaleX; // offset 0xF0, size 0x4
    float m_f32MaxScaleY; // offset 0xF4, size 0x4
    float m_f32InitScaleX; // offset 0xF8, size 0x4
    float m_f32InitScaleY; // offset 0xFC, size 0x4
    float m_f32PosY; // offset 0x100, size 0x4
};
class __vector_imp : private __vector_deleter {
    // total size: 0xC
};
...
// Range: 0x58F150 -> 0x58F788
void draw(class clsGearTypeChengeEffect_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58F150 -> 0x58F788
        ...
        float aNnViewRotInvertMtx[4][4]; // r29+0x110
        float aMtx[4][4]; // r29+0xD0
        float f32Speed; // r1
        class tagMatAlphaTmp sOldAlpha; // r29+0xA0
        class tagMatAlphaTmp sOldAlpha; // r29+0x70
    }
}


// Range: 0x58F790 -> 0x58FAE0
void execute(class clsGearTypeChengeEffect_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58F790 -> 0x58FAE0
        class clsPlayerTask * pcPlayer; // r2
        float f32CharaScale; // r1
        float f32ScaleFrame; // r3
    }
}
