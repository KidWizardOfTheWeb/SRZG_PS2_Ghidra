/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\GearChenge\GearChenge.cpp
...
enum enmParticleUnionName {
    PARTICLE_GEARCHENGE_RETURN = 0,
    PARTICLE_GEARCHENGE_01 = 1,
    PARTICLE_GEARCHENGE_02 = 2,
    PARTICLE_GEARCHENGE_03 = 3,
    PARTICLE_SPARK = 4,
    PARTICLE_GCONTROL_FIN = 5,
    PARTICLE_AGP = 6,
    PARTICLE_GETRING = 7,
    PARTICLE_GETITEM = 8,
    PARTICLE_BRAKE = 9,
    PARTICLE_AIRGLINDING_LINE = 10,
    PARTICLE_AIRGLINDING_CLOUD = 11,
    PARTICLE_DASHLINE = 12,
    PARTICLE_TRICK_LANDING = 13,
    PARTICLE_G_DIVELINE = 14,
    PARTICLE_FIRE_BLAZEDEMO = 15,
    PARTICLE_ATTACK_BLAZE = 16,
    PARTICLE_ATTACK_SILVER = 17,
    PARTICLE_ATTACK_HIT_BLAZE = 18,
    PARTICLE_ATTACK_HIT_SILVER = 19,
    PARTICLE_ATTACK_EGGMAN1 = 20,
    PARTICLE_ATTACK_EGGMAN2 = 21,
    PARTICLE_ATTACK_TAILS0 = 22,
    PARTICLE_ATTACK_HIT_AMY = 23,
    PARTICLE_ATTACK_JET = 24,
    PARTICLE_ATTACK_NIGHTS = 25,
    PARTICLE_ATTACK_HIT_NIGHTS = 26,
    PARTICLE_PARTSLOCK_SPARK = 27,
    PARTICLE_PARTSLOCK_SMOKE = 28,
    PARTICLE_GEAR_ISTSPEED_01 = 29,
    PARTICLE_GEAR_ISTSPEED_02 = 30,
    PARTICLE_GEAR_ISTSPEED_03 = 31,
    PARTICLE_GEAR_GC_SPDUP_01 = 32,
    PARTICLE_GEAR_GC_SPDUP_02 = 33,
    PARTICLE_GEAR_GC_SPDUP_03 = 34,
    PARTICLE_COLORBALL_SPRAY = 35,
    PARTICLE_GEAR_AUTO_WALLWALK = 36,
    PARTICLE_GEAR_SKILL_GPRATE_UP = 37,
    PARTICLE_GEAR_BLOOM_RUN = 38,
    PARTICLE_GEAR_TRICK_UP_1 = 39,
    PARTICLE_GEAR_TRICK_UP_2 = 40,
    PARTICLE_GEAR_ITEM_UP_1 = 41,
    PARTICLE_GEAR_ITEM_UP_2 = 42,
    PARTICLE_GEAR_ITEM_UP_3 = 43,
    PARTICLE_ATKHIT_EGGMAN = 44,
    PARTICLE_FIRE_BLAZEDEMO_2 = 45,
    PARTICLE_ATKHIT_NIGHTS = 46,
    PARTICLE_UNION_END = 47,
};
...
public:
    ...
    unsigned int m_u32Lv; // offset 0xE0, size 0x4
};
...
// Range: 0x321290 -> 0x3212E8
void draw(class clsGearChengeEffect_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x321290 -> 0x3212E8
    }
...
// Range: 0x3212F0 -> 0x32150C
void execute(class clsGearChengeEffect_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3212F0 -> 0x32150C
        class clsPlayerTask * pcPlayer; // r2
        enum enmParticleUnionName eParticleName; // r17
        float f32CharaScale; // r21
        float f32GearScale; // r20
        enum enmLevel eCurLevel; // r2
    }
}
