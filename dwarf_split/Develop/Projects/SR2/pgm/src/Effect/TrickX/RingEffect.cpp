/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\TrickX\RingEffect.cpp
...
public:
    ...
    class NNS_QUATERNION m_sRotQuat; // offset 0xD8, size 0x10
};
enum enmRet {
    RET___UN_USE = 0,
    RET___INIT = 1,
...
// Range: 0x536E00 -> 0x536FF8
void draw(class clsTrickXRingEffect_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x536E00 -> 0x536FF8
...
// Range: 0x537000 -> 0x537008
void execute(class clsTrickXRingEffect_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x537000 -> 0x537008
    }
