/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\TrickX\FlashLine.cpp
...
// Range: 0x536AB0 -> 0x536D1C
void draw(class clsTrickXFlashLineEffect_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x536AB0 -> 0x536D1C
        unsigned int * psNodeStat; // r17
        float (* psMtxPal)[4][4]; // r16
        class NNS_VECTORFAST sViewPosVecFast; // r29+0x50
        float f32ScaleX; // r29+0x60
    }
}


// Range: 0x536D20 -> 0x536D88
void execute(class clsTrickXFlashLineEffect_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x536D20 -> 0x536D88
