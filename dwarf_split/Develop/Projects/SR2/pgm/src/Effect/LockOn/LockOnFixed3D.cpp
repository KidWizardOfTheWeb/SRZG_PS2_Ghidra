/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\LockOn\LockOnFixed3D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class NNS_RGB sCharacterRgb[18]; // size: 0xD8, address: 0x6548F0
class clsModelType_OB_TX_MO t_cModel; // size: 0x10, address: 0xBFB500
...
// Range: 0x585DD0 -> 0x5861BC
void draw(class clsLockOnFixed3D_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x585DD0 -> 0x5861BC
        ...
        unsigned int u32GsTest[2]; // r29+0x168
        class NNS_RGB sColor[2]; // r29+0x100
        class NNS_RGB sColor2[2]; // r29+0xE0
        signed int s32i; // r8
    }
}


// Range: 0x5861C0 -> 0x5862CC
void execute(class clsLockOnFixed3D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5861C0 -> 0x5862CC
