/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Effect\LockOn\LockOnAppoint3D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class NNS_RGB sCharacterRgb[18]; // size: 0xD8, address: 0x6549E0
class clsModelType_OB_TX_MO_MA t_cModel; // size: 0x20, address: 0xBFB520
...
// Range: 0x586390 -> 0x5867A0
void draw(class clsLockOnAppoint3D_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x586390 -> 0x5867A0
        float (* psMtxPal)[4][4]; // r18
        unsigned int * psNodeStat; // r17
        class NNS_OBJECT * psMatMotObject; // r22
        class NNS_MATERIALPTR * psMatPtrList; // r16
        float sMtx[4][4]; // r29+0x130
        class NNS_MATERIAL_SINGLE * psMaterial; // r2
        unsigned int u32GsTest[2]; // r29+0x178
        class NNS_RGB sColor[2]; // r29+0x110
        class NNS_RGB sColor2[2]; // r29+0xF0
        signed int s32i; // r8
    }
}


// Range: 0x5867A0 -> 0x5868D8
void execute(class clsLockOnAppoint3D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5867A0 -> 0x5868D8
    }
...
// Range: 0x5868E0 -> 0x58698C
void registModel(class stcBinInfo & rsBinInfoI /* r4 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5868E0 -> 0x58698C
    }
