/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\CountDown2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x30
} __vt__19clsCountDown2D_Task; // size: 0x30, address: 0x6C1D90
...
class clsCountDown2D_Task : public clsTemporary2D_Task {
    // total size: 0x88
public:
    unsigned char m_bStartCheck; // offset 0x58, size 0x1
    signed short m_s16Left; // offset 0x5A, size 0x2
    signed short m_s16Top; // offset 0x5C, size 0x2
    unsigned char m_u8LastSecond; // offset 0x5E, size 0x1
    unsigned char m_u8IconUserAlpha; // offset 0x5F, size 0x1
    unsigned char m_u8NumWidth; // offset 0x60, size 0x1
    unsigned char m_u8NumHeight; // offset 0x61, size 0x1
    unsigned char m_u8SNumWidth; // offset 0x62, size 0x1
    unsigned char m_u8SNumHeight; // offset 0x63, size 0x1
    unsigned char m_u8MarkWidth; // offset 0x64, size 0x1
    unsigned char m_u8MarkHeight; // offset 0x65, size 0x1
    float m_f32Scale; // offset 0x68, size 0x4
    float m_f32MaxScale; // offset 0x6C, size 0x4
    float m_f32DefScale; // offset 0x70, size 0x4
    float m_f32MarginScale; // offset 0x74, size 0x4
    float m_f32ScaleFrame; // offset 0x78, size 0x4
    signed short m_s16MapLeft; // offset 0x7C, size 0x2
    signed short m_s16MapTop; // offset 0x7E, size 0x2
    signed short m_s16MapWidth; // offset 0x80, size 0x2
    signed short m_s16MapHeight; // offset 0x82, size 0x2
    signed short m_s16MapLineHeight; // offset 0x84, size 0x2
};
...
// Range: 0x3E2560 -> 0x3E29E8
void drawStartMap(class clsCountDown2D_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E2560 -> 0x3E29E8
...
// Range: 0x3E29F0 -> 0x3E3080
void draw(class clsCountDown2D_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E29F0 -> 0x3E3080
        unsigned short u16CountMiliSecond; // r2
        class clsBaseRace_Task * pcBaseRace; // r2
        class stcTexUV * psTexSrc_Main2D; // r2
        class stcTexUV * psTexSrc; // r2
        class stcPoint2D_s16 * psTextureSize; // r2
        unsigned int u32DrawNum; // r2
        float f32DrawX; // r22
        float f32DrawY; // r21
        float f32AddScale; // r20
    }
}


// Range: 0x3E3080 -> 0x3E32D4
void execute(class clsCountDown2D_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E3080 -> 0x3E32D4
        class clsBaseRace_Task * pcBaseRace; // r2
        unsigned char u8CountSecond; // r2
    }
}


// Range: 0x3E32E0 -> 0x3E3340
void * __dt(class clsCountDown2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E32E0 -> 0x3E3340
    }
...
// Range: 0x3E3340 -> 0x3E3688
void * __ct(class clsCountDown2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E3340 -> 0x3E3688
