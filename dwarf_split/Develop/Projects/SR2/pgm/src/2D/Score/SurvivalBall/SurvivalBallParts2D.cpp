/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\SurvivalBall\SurvivalBallParts2D.cpp
...
// Range: 0x4D1160 -> 0x4D1624
void drawComPoint(class clsSurvivalBallParts2D * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D1160 -> 0x4D1624
        ...
        signed char s8CharaID; // r21
        signed int s32Point; // r2
        signed short s16PlayerNo; // r16
...
// Range: 0x4D1630 -> 0x4D17B4
void drawRingWindow(class clsSurvivalBallParts2D * this /* r21 */, signed int s32PlayerNo /* r2 */, signed int s32View /* r2 */, class stcUnionStatus * psUnionSt /* r22 */, signed int s32PosX /* r20 */, signed int s32PosY /* r19 */, signed int s32Dir /* r18 */, unsigned int ou32CharaColor /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D1630 -> 0x4D17B4
        class clsSurvivalBallRace_Task & rcSurvivalBallRace_Task; // r2
        float f32DrawBarWidth; // r20
        signed int s32PointMax; // r16
    }
}
