/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\ResultRanking.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned char MAT_ALPHA_SPEED; // size: 0x1, address: 0x68A048
unsigned char MAX_USER_BG_ALPHA; // size: 0x1, address: 0x0
class stcResultRanking osDrawData; // size: 0x7C, address: 0x68A050
struct /* @anon1 */ {
    // total size: 0x34
} __vt__23clsResultRanking2D_Task; // size: 0x34, address: 0x6C7E60
...
class stcTexUV TexData2D[]; // size: 0x0, address: 0x6959A0
class stcTask sTask; // size: 0x30, address: 0xB0A900
class stcTexUV TexData2D[]; // size: 0x0, address: 0x694810
class stcTexUV TexData2D[]; // size: 0x0, address: 0x695410
class stcTexUV TexData2D[]; // size: 0x0, address: 0x695550
...
public:
    ...
    float m_f32AllWaitFrame; // offset 0x58, size 0x4
    signed int m_s32RingWindowX; // offset 0x5C, size 0x4
    signed int m_s32RingWindowY; // offset 0x60, size 0x4
    float m_f32LineFrameMax; // offset 0x64, size 0x4
    unsigned char m_u8MatAlpha; // offset 0x68, size 0x1
    unsigned int m_u32DrawRingNum; // offset 0x6C, size 0x4
    unsigned int m_u32EndRingNum; // offset 0x70, size 0x4
    class stcRankingLine m_asLine[8]; // offset 0x74, size 0x200
    class stcLinePoint m_asPoint[4]; // offset 0x274, size 0x30
};
...
class stcRankingLine {
    // total size: 0x40
public:
    unsigned int u32Flg; // offset 0x0, size 0x4
    float f32WaitFrame; // offset 0x4, size 0x4
    float f32RankFrame; // offset 0x8, size 0x4
    float f32NameFrame; // offset 0xC, size 0x4
    float f32TimeFrame; // offset 0x10, size 0x4
    float f32PointFrame; // offset 0x14, size 0x4
    float f32TrophyFrame; // offset 0x18, size 0x4
    signed short s16DrawX; // offset 0x1C, size 0x2
    signed short s16DrawY; // offset 0x1E, size 0x2
    unsigned int u32Rank; // offset 0x20, size 0x4
    unsigned short u16CharaId; // offset 0x24, size 0x2
    unsigned char u8Minite; // offset 0x26, size 0x1
    unsigned char u8Second; // offset 0x27, size 0x1
    unsigned short u16MSecond; // offset 0x28, size 0x2
    signed short s16Point; // offset 0x2A, size 0x2
    signed short s16AddPoint; // offset 0x2C, size 0x2
    float f32BaseLineFrame; // offset 0x30, size 0x4
    float f32AddLineFrame; // offset 0x34, size 0x4
    class clsEnergyFlow2D * pcBaseLine; // offset 0x38, size 0x4
    class clsEnergyFlow2D * pcAddLine; // offset 0x3C, size 0x4
};
...
class stcResultRanking {
    // total size: 0x7C
public:
    unsigned short u16RingWindowX; // offset 0x0, size 0x2
    unsigned short u16RingWindowY; // offset 0x2, size 0x2
    unsigned short u16RingWindowW; // offset 0x4, size 0x2
    unsigned short u16RingWindowH; // offset 0x6, size 0x2
    unsigned short u16LineStartY; // offset 0x8, size 0x2
    unsigned short u16LineAreaY; // offset 0xA, size 0x2
    unsigned short u16LineItemYDiff; // offset 0xC, size 0x2
    float f32WaitFrame; // offset 0x10, size 0x4
    float f32RankFrame; // offset 0x14, size 0x4
    float f32NameFrame; // offset 0x18, size 0x4
    float f32TimeFrame; // offset 0x1C, size 0x4
    float f32PointFrame; // offset 0x20, size 0x4
    float f32TrophyFrame; // offset 0x24, size 0x4
    signed short s16RankPosX; // offset 0x28, size 0x2
    signed short s16RankPosY; // offset 0x2A, size 0x2
    signed short s16RankPosXDiff; // offset 0x2C, size 0x2
    float f32RankScale; // offset 0x30, size 0x4
    float f32RankMiddleScale; // offset 0x34, size 0x4
    float f32RankSmallScale; // offset 0x38, size 0x4
    float f32RankSmallMarginScale; // offset 0x3C, size 0x4
    signed short s16NamePosX; // offset 0x40, size 0x2
    signed short s16NamePosXDiff; // offset 0x42, size 0x2
    signed short s16NameCharaX; // offset 0x44, size 0x2
    signed short s16TimePosXDiff; // offset 0x46, size 0x2
    signed short s16TimeRightMargin; // offset 0x48, size 0x2
    float f32TimeMarginScale; // offset 0x4C, size 0x4
    float f32TrophyScale; // offset 0x50, size 0x4
    float f32TrophyStartScale; // offset 0x54, size 0x4
    unsigned char u8RingPosX; // offset 0x58, size 0x1
    unsigned char u8RingNumX; // offset 0x59, size 0x1
    unsigned char u8ConmaPosY; // offset 0x5A, size 0x1
    signed short s16LineStartX; // offset 0x5C, size 0x2
    signed short s16LineMiddleX; // offset 0x5E, size 0x2
    signed short s16LineEndX; // offset 0x60, size 0x2
    signed short s16LineStartY; // offset 0x62, size 0x2
    signed short s16LineEndY; // offset 0x64, size 0x2
    unsigned char u8ELineHeight; // offset 0x66, size 0x1
    float f32LinePointFrame; // offset 0x68, size 0x4
    float f32MarginFrame; // offset 0x6C, size 0x4
    float f32HeadScale; // offset 0x70, size 0x4
    float f32HeadAddFrame; // offset 0x74, size 0x4
    float f32HeadAddScale; // offset 0x78, size 0x4
};
enum enmFlag {
    FLAG_CLEAR = 0,
    FLAG_VIBRATION = 1,
...
// Range: 0x497EA0 -> 0x4980E4
void draw(class clsResultRanking2D_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x497EA0 -> 0x4980E4
        class stcResultRanking * psDrawData; // r2
        unsigned char u8WindowAlpha; // r2
        signed int s32n; // r18
        class stcRankingLine * psLine; // r17
        class stcRankingLine * psLine; // r2
    }
}


// Range: 0x4980F0 -> 0x498474
void drawRing(class clsResultRanking2D_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4980F0 -> 0x498474
        class stcResultRanking * psDrawData; // r2
        ...
        signed int oas32Math[6]; // r29+0xC0
        unsigned char bFastNo; // r23
        signed int s32Ring; // r21
        signed int s32n; // r20
        signed int s32DrawNum; // r2
        signed int s32DrawX; // r19
        signed int s32DrawY; // r2
        float f32Width; // r20
        float f32Height; // r29+0xE0
        unsigned char u8DrawAlpha; // r18
    }
}


// Range: 0x498480 -> 0x4986DC
void drawBackMat(class clsResultRanking2D_Task * this /* r2 */, class stcRankingLine * psLine /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x498480 -> 0x4986DC
        class stcResultRanking * psDrawData; // r2
        ...
        signed int s32DrawY; // r2
        float f32DrawFrame; // r29+0x90
        signed int s32Width; // r21
        unsigned char u8MatAlpha; // r9
        class stcTexUV * psTexSrc; // r20
        class stcTexUV * psTexSrc_Result; // r2
        class stcPoint2D_s16 * psTextureResultSize; // r2
        unsigned int u32Color; // r19
        unsigned int u32ColorSrc; // r2
        unsigned char u8rgb; // r4
        float f32Height; // r20
    }
}


// Range: 0x4986E0 -> 0x49899C
void drawTrophy(class clsResultRanking2D_Task * this /* r2 */, class stcRankingLine * psLine /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4986E0 -> 0x49899C
        class stcResultRanking * psDrawData; // r2
        ...
        class stcTexUV * psTexSrc_Tex; // r2
        class stcPoint2D_s16 * psTextureSize; // r2
        unsigned char u8DrawAlpha; // r20
        signed int s32DrawX; // r2
        signed int s32DrawY; // r2
        float f32DefaultScale; // r5
        float f32DrawScale; // r20
    }
}


// Range: 0x4989A0 -> 0x498EE0
void drawPoint(class clsResultRanking2D_Task * this /* r2 */, class stcRankingLine * psLine /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4989A0 -> 0x498EE0
        class stcResultRanking * psDrawData; // r2
        ...
        class stcTexUV * psTexSrc_Tex; // r2
        class stcPoint2D_s16 * psTextureSize; // r2
        unsigned char u8DrawAlpha; // r23
        signed int s32DrawX; // r21
        signed int s32DrawY; // r2
        float f32Width; // r29+0xA0
        float f32Height; // r29+0xA0
        signed short s16Point; // r2
        signed short s16AddPoint; // r2
        signed int s32DrawNum; // r2
    }
}


// Range: 0x498EE0 -> 0x499630
void drawTime(class clsResultRanking2D_Task * this /* r2 */, class stcRankingLine * psLine /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x498EE0 -> 0x499630
        class stcResultRanking * psDrawData; // r2
        ...
        class stcTexUV * psTexSrc_Tex; // r2
        class stcPoint2D_s16 * psTextureSize; // r2
        unsigned char u8DrawAlpha; // r16
        signed int s32DrawX; // r22
        signed int s32DrawY; // r2
        float f32TimeWidth; // r3
        unsigned char u8Min; // r2
        unsigned char u8Sec; // r2
        unsigned short u16MSec; // r2
        signed int s32DrawNum; // r2
        signed short s16AddPoint; // r2
    }
}
...
// Range: 0x499630 -> 0x499964
void drawName(class clsResultRanking2D_Task * this /* r2 */, class stcRankingLine * psLine /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x499630 -> 0x499964
        class stcResultRanking * psDrawData; // r2
        class stcTexUV * psTexSrc; // r2
        class stcTexUV * psTexSrc_Icon; // r2
...
// Range: 0x499970 -> 0x49A07C
void drawRanking(class clsResultRanking2D_Task * this /* r2 */, class stcRankingLine * psLine /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x499970 -> 0x49A07C
        class stcResultRanking * psDrawData; // r2
        class stcTexUV * psTexSrc; // r16
        class stcTexUV * psTexSrc_Tex; // r2
        class stcPoint2D_s16 * psTextureSize; // r2
        ...
        float f32Width; // r22
        float f32Height; // r21
        unsigned int u32Rank; // r20
        signed int s32DrawNum; // r2
        unsigned char bFastNo; // r19
        signed int s32n; // r18
        signed int oas32Math[6]; // r29+0xE0
    }
}


// Range: 0x49A080 -> 0x49A604
void execute(class clsResultRanking2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49A080 -> 0x49A604
        class clsScore2D_Task * pcScore2D; // r19
        class clsPfSystem * pcOOSystem; // r2
        signed int s32n; // r20
        signed int s32FinishLineNum; // r16
        unsigned char bWait; // r5
        class stcRankingLine * psLine; // r19
        class stcRankingLine * psLine; // r21
    }
}


// Range: 0x49A610 -> 0x49A6DC
unsigned char setOutMode(class clsResultRanking2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49A610 -> 0x49A6DC
        class stcResultRanking * psDrawData; // r2
...
// Range: 0x49A6E0 -> 0x49A738
void execPoint(class clsResultRanking2D_Task * this /* r2 */, class stcRankingLine * psLine /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49A6E0 -> 0x49A738
    }
...
// Range: 0x49A740 -> 0x49A77C
void execTime(class stcRankingLine * psLine /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49A740 -> 0x49A77C
    }
...
// Range: 0x49A780 -> 0x49A7BC
void execName(class stcRankingLine * psLine /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49A780 -> 0x49A7BC
    }
...
// Range: 0x49A7C0 -> 0x49A7FC
void execRanking(class stcRankingLine * psLine /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49A7C0 -> 0x49A7FC
    }
...
// Range: 0x49A800 -> 0x49A8D0
void execEnergyLine(class clsResultRanking2D_Task * this /* r2 */, class stcRankingLine * psLine /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49A800 -> 0x49A8D0
        class stcResultRanking * psDrawData; // r2
...
// Range: 0x49A8D0 -> 0x49A90C
unsigned char checkWait(class stcRankingLine * psLine /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49A8D0 -> 0x49A90C
    }
...
// Range: 0x49A910 -> 0x49AFB4
void init(class clsResultRanking2D_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49A910 -> 0x49AFB4
        class clsScore2D_Task * pcScore2D; // r2
        class stcResultRanking * psDrawData; // r2
        signed int s32LeftX; // r29+0xD0
        signed int s32OutMargin; // r2
        float f32WaitSeed; // r20
        class clsPlayerTask * pcPlayer; // r20
        signed int s32DrawY; // r29+0xC0
        unsigned int u32AddRingNum; // r23
        signed int s32n; // r6
        class stcRankingLine * psLine; // r2
        class stcRankingLine * psLine; // r2
        signed int s32i; // r22
        class stcRecord sTotalTime; // r29+0xEC
    }
}


// Range: 0x49AFC0 -> 0x49B094
void * __dt(class clsResultRanking2D_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49AFC0 -> 0x49B094
        signed int s32n; // r16
...
// Range: 0x49B0A0 -> 0x49B13C
void * __ct(class clsResultRanking2D_Task * this /* r17 */, unsigned int u32Flg /* r16 */, unsigned char bPause /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49B0A0 -> 0x49B13C
    }
