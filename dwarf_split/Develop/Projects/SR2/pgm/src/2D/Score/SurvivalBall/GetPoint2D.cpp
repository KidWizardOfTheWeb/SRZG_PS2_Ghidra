/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\SurvivalBall\GetPoint2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcGetPointData DrawData1v; // size: 0x3C, address: 0x68FF00
static class stcGetPointData DrawData2v; // size: 0x3C, address: 0x68FF40
static class stcGetPointData DrawData4v; // size: 0x3C, address: 0x68FF80
class stcEnergyPoint asEnergyPoint[4]; // size: 0x130, address: 0xBFA540
static float tf32EnergyFrameMax; // size: 0x4, address: 0xBFA670
class stcGetPointData * opsDrawData; // size: 0x4, address: 0xBFA678
struct /* @anon0 */ {
    // total size: 0x30
} __vt__18clsGetPoint2D_Task; // size: 0x30, address: 0x6C9680
...
class stcGetPointData {
    // total size: 0x3C
public:
    signed short s16MoveMax; // offset 0x0, size 0x2
    float f32WaitFrame; // offset 0x4, size 0x4
    float f32NumScale; // offset 0x8, size 0x4
    float f32MarginScale; // offset 0xC, size 0x4
    float f32ShotFrame; // offset 0x10, size 0x4
    float f32ShotScale; // offset 0x14, size 0x4
    float f32CircleX; // offset 0x18, size 0x4
    float f32CircleY; // offset 0x1C, size 0x4
    unsigned char u8LineStartX; // offset 0x20, size 0x1
    unsigned char u8LineMiddleX; // offset 0x21, size 0x1
    unsigned char u8LineEndX; // offset 0x22, size 0x1
    signed char s8LineStartY; // offset 0x23, size 0x1
    signed char s8LineEndY; // offset 0x24, size 0x1
    signed char s8TextY; // offset 0x25, size 0x1
    unsigned char u8ELineHeight; // offset 0x26, size 0x1
    float f32LinePointFrame; // offset 0x28, size 0x4
    float f32MarginFrame; // offset 0x2C, size 0x4
    float f32HeadScale; // offset 0x30, size 0x4
    float f32HeadAddFrame; // offset 0x34, size 0x4
    float f32HeadAddScale; // offset 0x38, size 0x4
};
...
class stcEnergyPoint {
    // total size: 0x4C
public:
    signed int s32BaseX; // offset 0x0, size 0x4
    signed int s32BaseY; // offset 0x4, size 0x4
    signed int s32Dir; // offset 0x8, size 0x4
    signed int s32ShotX; // offset 0xC, size 0x4
    signed int s32ShotY; // offset 0x10, size 0x4
    signed int s32CircleX; // offset 0x14, size 0x4
    signed int s32CircleY; // offset 0x18, size 0x4
    class stcLinePoint asPoint[4]; // offset 0x1C, size 0x30
};
...
class clsGetPoint2D_Task : public clsTemporary2D_Task {
    // total size: 0x84
public:
    unsigned int m_u32View; // offset 0x58, size 0x4
    unsigned int m_u32Flg; // offset 0x5C, size 0x4
    float m_f32BonusAgp; // offset 0x60, size 0x4
    float m_f32WaitFrame; // offset 0x64, size 0x4
    unsigned char m_u8NumAlpha; // offset 0x68, size 0x1
    signed short m_s16TextMove; // offset 0x6A, size 0x2
    signed short m_s16NumMove; // offset 0x6C, size 0x2
    float m_f32ShotFrame; // offset 0x70, size 0x4
    float m_f32EnergyFrame; // offset 0x74, size 0x4
    float m_f32EnergySubFrame; // offset 0x78, size 0x4
    class clsEnergyFlow2D * m_pcBaseLine; // offset 0x7C, size 0x4
    class clsEnergyFlow2D * m_pcAddLine; // offset 0x80, size 0x4
};
...
// Range: 0x4CCA10 -> 0x4CCBD4
void draw(class clsGetPoint2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4CCA10 -> 0x4CCBD4
...
// Range: 0x4CCBE0 -> 0x4CCFB8
void _drawPoint(class clsGetPoint2D_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4CCBE0 -> 0x4CCFB8
        class stcEnergyPoint * opsPoint; // r2
        class stcGetPointData * psDrawData; // r2
        class stcTexUV * psTexSrc_RaceBase2D; // r2
        class stcTexUV * psTexSrc; // r2
        class stcPoint2D_s16 * psTextureSize; // r2
        signed int s32DrawPoint; // r2
        signed int s32DrawNum; // r2
        unsigned char u8NumAlpha; // r2
...
// Range: 0x4CCFC0 -> 0x4CD51C
void execute(class clsGetPoint2D_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4CCFC0 -> 0x4CD51C
        float f32EnergyFrameMax; // r21
        unsigned char bLight; // r17
        float f32LightScale; // r20
        signed int s32AddMode; // r2
        signed int s32AddAlpha; // r2
        class clsSurvivalBallRace_Task & rcSurvivalBallRace_Task; // r2
        float f32LightFrame; // r29+0x60
        float f32LightHalfFrame; // r29+0x60
    }
}


// Range: 0x4CD520 -> 0x4CD59C
void * __dt(class clsGetPoint2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4CD520 -> 0x4CD59C
    }
...
// Range: 0x4CD5A0 -> 0x4CD798
void * __ct(class clsGetPoint2D_Task * this /* r16 */, signed int s32View /* r17 */, float f32BonusAgp /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4CD5A0 -> 0x4CD798
    }
...
// Range: 0x4CD7A0 -> 0x4CDB24
void setupEnergyPoint() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4CD7A0 -> 0x4CDB24
        class stcGetPointData * opsDrawData'192; // r5
        class clsScore2D_Task * pcScore; // r2
        signed int s32OutMargin; // r2
        signed int s32CenterY; // r21
        signed int s32CenterY_b; // r6
        signed int s32MeterX; // r20
        signed int s32MeterY; // r19
        signed int s32MeterWidthDiff; // r18
        signed int s32MeterHeightDiff; // r17
        class stcGetPointData * psDrawData; // r2
        signed int s32WidthDiff; // r2
        signed int s32HeightDiff; // r2
        signed int s32CircleX; // r16
        signed int s32CircleY; // r25
        signed int s32CirDir; // r24
        signed int s32DrawX; // r15
        signed int s32DrawY; // r14
        signed int s32Dir; // r13
        signed int s32n; // r12
    }
}
