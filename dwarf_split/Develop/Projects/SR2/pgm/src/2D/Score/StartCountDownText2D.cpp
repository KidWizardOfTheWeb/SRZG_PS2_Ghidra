/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\StartCountDownText2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x30
} __vt__28clsCountDownStartText2D_Task; // size: 0x30, address: 0x6C8F30
...
class clsCountDownStartText2D_Task : public clsTemporary2D_Task {
    // total size: 0x7C
public:
    signed short m_s16BaseX; // offset 0x58, size 0x2
    signed short m_s16BaseY; // offset 0x5A, size 0x2
    signed short m_s16Move; // offset 0x5C, size 0x2
    signed short m_s16MoveMax; // offset 0x5E, size 0x2
    unsigned char m_au8Alpha[3]; // offset 0x60, size 0x3
    float m_af32Scale[3]; // offset 0x64, size 0xC
    float m_f32InFrame; // offset 0x70, size 0x4
...
// Range: 0x4BCE70 -> 0x4BD1A4
void draw(class clsCountDownStartText2D_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BCE70 -> 0x4BD1A4
        class stcTexUV * psTexSrc; // r2
        class stcTexUV * psTexSrc_RaceEtc; // r2
        class stcPoint2D_s16 * psTextureSize; // r2
        signed int s32DrawX; // r2
        signed int s32DrawLeft; // r2
        signed int s32DrawRight; // r2
...
// Range: 0x4BD1B0 -> 0x4BD5B8
void execute(class clsCountDownStartText2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BD1B0 -> 0x4BD5B8
    }
...
// Range: 0x4BD5C0 -> 0x4BD620
void * __dt(class clsCountDownStartText2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BD5C0 -> 0x4BD620
    }
...
// Range: 0x4BD620 -> 0x4BD724
void * __ct(class clsCountDownStartText2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BD620 -> 0x4BD724
