/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\SurvivalBall\BallHolder2D.cpp
...
unsigned int m_oau32IconRotArrayView2[2]; // size: 0x8, address: 0x68FD00
unsigned int m_oau32IconRotArrayView4[4]; // size: 0x10, address: 0x68FD10
struct /* @anon1 */ {
    // total size: 0x30
} __vt__20clsBallHolder2D_Task; // size: 0x30, address: 0x6C9650
class _NNS_TEXLIST * apsTextureList[2]; // size: 0x8, address: 0xB0B770
class stcTexUV TexData2D[]; // size: 0x0, address: 0x695CC0
...
// Range: 0x4C95D0 -> 0x4C9A08
void draw(class clsBallHolder2D_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C95D0 -> 0x4C9A08
        ...
        signed short s16BallX; // r2
        signed short s16BallY; // r2
        signed char s8CharaID; // r3
        class stcTexUV * psTexSrc; // r2
        signed short s16IconX; // r2
        signed short s16IconY; // r2
        unsigned char u8CharaDrawAlpha; // r2
        signed int s32IconWidth; // r2
        signed int s32IconHeight; // r2
    }
}


// Range: 0x4C9A10 -> 0x4C9C10
void execute(class clsBallHolder2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C9A10 -> 0x4C9C10
        class clsSurvivalBallRace_Task & rcSurvivalBallRace_Task; // r2
        signed int s32BallHalfWidth; // r2
    }
}


// Range: 0x4C9C10 -> 0x4CA284
void moveHolderIcon(class clsBallHolder2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C9C10 -> 0x4CA284
        signed short s16CenterX; // r2
        signed short s16CenterY; // r2
        signed int s32RotTarget; // r2
        float sMtx[4][4]; // r29+0x50
        class NNS_VECTORFAST sVecFast; // r29+0x40
        signed int s32BallCenterOffsetX; // r2
        signed int s32BallCenterOffsetY; // r2
        signed int s32RotDist; // r6
        signed int s32RotDist; // r6
    }
}


// Range: 0x4CA290 -> 0x4CA2E0
void resetHolderChara(class clsBallHolder2D_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4CA290 -> 0x4CA2E0
...
// Range: 0x4CA2E0 -> 0x4CA3C0
void updateHolderChara(class clsBallHolder2D_Task * this /* r2 */, class clsPlayerTask * pcHitPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4CA2E0 -> 0x4CA3C0
        signed char s8HitCharaType; // r7
        unsigned char u8Alpha; // r2
    }
}


// Range: 0x4CA3C0 -> 0x4CA458
void reset(class clsBallHolder2D_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4CA3C0 -> 0x4CA458
    }
...
// Range: 0x4CA460 -> 0x4CA4D0
void * __dt(class clsBallHolder2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4CA460 -> 0x4CA4D0
    }
...
// Range: 0x4CA4D0 -> 0x4CA550
void * __ct(class clsBallHolder2D_Task * this /* r16 */, class clsSurvivalBallBall_Task * pcBall /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4CA4D0 -> 0x4CA550
    }
