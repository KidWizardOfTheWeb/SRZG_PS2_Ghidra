/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\Mission\MissionResult2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcPoint2D_s16 oasUnionTextureSize; // size: 0x4, address: 0x686D20
static class stcTexUV TexData2D[24]; // size: 0x180, address: 0x686D30
static unsigned char chk__TexData2D_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcPoint2D_s16 oasUnionTextureSize; // size: 0x4, address: 0x686EB0
static class stcTexUV TexData2D[7]; // size: 0x70, address: 0x686EC0
static unsigned char chk__TexData2D_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcPoint2D_s16 oasUnionTextureSize[1]; // size: 0x4, address: 0x686F30
static class stcTexUV TexData2D[28]; // size: 0x1C0, address: 0x686F40
static unsigned char chk__TexData2D_SizeCheck_[1]; // size: 0x1, address: 0x0
float SCORE_BOX_RANK_OFFSET_W; // size: 0x4, address: 0x0
float SCORE_BOX_RANK_OFFSET_H; // size: 0x4, address: 0x0
...
struct /* @anon3 */ {
    // total size: 0x30
} __vt__23clsMissionResult2D_Task; // size: 0x30, address: 0x6C3F80
struct /* @anon2 */ {
    // total size: 0x2C
...
public:
    ...
    enum enmMissionInfo m_eModoNo; // offset 0x58, size 0x4
    unsigned int m_u32NowScore; // offset 0x5C, size 0x4
    unsigned int m_u32OldScore; // offset 0x60, size 0x4
    unsigned int m_u32NowRank; // offset 0x64, size 0x4
    unsigned int m_u32OldRank; // offset 0x68, size 0x4
    unsigned int m_u32Count; // offset 0x6C, size 0x4
    unsigned char m_bChangeScore; // offset 0x70, size 0x1
    unsigned char m_bEndFlag2D; // offset 0x71, size 0x1
    signed char * m_ops8RankCount; // offset 0x74, size 0x4
    float m_f32ScaleLankBox; // offset 0x78, size 0x4
    float m_f32ScaleBestBox; // offset 0x7C, size 0x4
    float m_f32ScaleResultBox; // offset 0x80, size 0x4
    float m_f32ScaleMegBox; // offset 0x84, size 0x4
    float m_f32ScaleBestLv; // offset 0x88, size 0x4
    float m_f32AlphaBestLv; // offset 0x8C, size 0x4
    float m_f32RankBoxAnm00Y; // offset 0x90, size 0x4
    float m_f32RankBoxAnm01Y; // offset 0x94, size 0x4
    float m_f32RankBoxAnm02Y; // offset 0x98, size 0x4
    unsigned int m_u32AnmModo; // offset 0x9C, size 0x4
    unsigned int m_u32AnmCount; // offset 0xA0, size 0x4
    float m_f32CardRotY; // offset 0xA4, size 0x4
};
enum enmDraw2DAttr {
...
// Range: 0x430540 -> 0x4309A8
void drawTrickLank(class clsMissionResult2D_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x430540 -> 0x4309A8
        ...
        float f32Y; // r20
        signed int s32i; // r18
        signed int s32Point; // r2
    }
}


// Range: 0x4309B0 -> 0x430D24
void drawMessegeBox(class clsMissionResult2D_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4309B0 -> 0x430D24
        class stcTexUV * psTexSrc_Tex; // r2
        class stcTexUV * psTexSrc; // r2
        class stcPoint2D_s16 * psTextureSize; // r2
        class stcRect sDrawRect; // r29+0xA0
        class clsMissionRace_Task & rcMissionRace_Task; // r2
        class clsScore2D_Task * pcScore; // r2
        signed int s32FontNo; // r20
        float f32BoxH; // r2
        float f32BoxHalfW; // r21
        float f32BoxHalfH; // r22
        float f32cx; // r20
        float f32X; // r29+0xB0
        class stcPoint3d sPos; // @ 0x00636558
        unsigned int u32LevelMsgNo[4]; // @ 0x00687100
    }
}


// Range: 0x430D30 -> 0x4310C8
void drawRankBox(class clsMissionResult2D_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x430D30 -> 0x4310C8
        class stcTexUV * psTexSrc_Tex; // r19
...
// Range: 0x4310D0 -> 0x4316B0
void draw(class clsMissionResult2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4310D0 -> 0x4316B0
    }
...
// Range: 0x4316B0 -> 0x4319C0
void main(class clsMissionResult2D_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4316B0 -> 0x4319C0
        class stcTexUV * psTexSrc_Tex; // r2
        float f32AddFrame; // r29
    }
}


// Range: 0x4319C0 -> 0x431AC4
void execute(class clsMissionResult2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4319C0 -> 0x431AC4
    }
...
// Range: 0x431AD0 -> 0x431BD8
void * __ct(class clsMissionResult2D_Task * this /* r21 */, enum enmMissionInfo eModoNo /* r20 */, unsigned int u32Now /* r19 */, unsigned int u32Best /* r18 */, unsigned int u32NowRank /* r17 */, unsigned int u32OldRank /* r16 */, signed char * ops8RankCount /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x431AD0 -> 0x431BD8
    }
