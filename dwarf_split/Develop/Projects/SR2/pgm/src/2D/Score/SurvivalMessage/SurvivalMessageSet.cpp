/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\SurvivalMessage\SurvivalMessageSet.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float oaf32IconScale[4]; // size: 0x10, address: 0x699FD0
class _NNS_TEXLIST * psTexList_SurvivalMessage2D; // size: 0x4, address: 0xBFB480
...
// Range: 0x57EB40 -> 0x57EDC4
float drawSecondS3d(class NNS_VECTORFAST * copsPosVec /* r21 */, signed int s32ViewNo /* r2 */, unsigned int u32Time /* r17 */, unsigned int u32Color /* r16 */, float f32Scale /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57EB40 -> 0x57EDC4
        class NNS_VECTORFAST sRetVecFast; // r29+0xA0
        class NNS_VECTORFAST sPosVecFast; // r29+0x90
        class stcPoint2D_s16 sRetPoint2D; // r29+0xBC
        float f32Num; // r24
        float f32IcomH; // r23
...
// Range: 0x57EDD0 -> 0x57F170
float drawSecondS(float f32PosX /* r20 */, float f32PosY /* r23 */, unsigned int u32Time /* r22 */, unsigned int u32Color /* r21 */, float f32Scale /* r22 */, float f32Dist /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57EDD0 -> 0x57F170
        class stcTexUV * psTexSrc; // r2
        unsigned int u32MiliSecond; // r2
    }
}


// Range: 0x57F170 -> 0x57F4A4
float drawSecond(float f32PosX /* r24 */, float f32PosY /* r23 */, unsigned int u32Time /* r21 */, unsigned int u32Color /* r20 */, float f32Scale /* r20 */, float f32Dist /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57F170 -> 0x57F4A4
        class stcTexUV * psTexSrc; // r2
...
// Range: 0x57F4B0 -> 0x57F9D8
float drawTimeS(float f32PosX /* r20 */, float f32PosY /* r23 */, unsigned int u32Time /* r23 */, unsigned int u32Color /* r21 */, float f32Scale /* r22 */, float f32Dist /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57F4B0 -> 0x57F9D8
        class stcTexUV * psTexSrc; // r2
...
// Range: 0x57FA20 -> 0x57FE8C
float drawTime(float f32PosX /* r24 */, float f32PosY /* r23 */, unsigned int u32Time /* r18 */, unsigned int u32Color /* r17 */, float f32Scale /* r20 */, float f32Dist /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57FA20 -> 0x57FE8C
        class stcTexUV * psTexSrc; // r2
...
// Range: 0x57FE90 -> 0x580068
float drawNumbarSS(float f32PosX /* r24 */, float f32PosY /* r23 */, unsigned int u32DispNum /* r21 */, signed int s32Digit /* r20 */, unsigned int u32Color /* r19 */, float f32Scale /* r22 */, float f32Dist /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57FE90 -> 0x580068
...
// Range: 0x580070 -> 0x5800B8
float calcNumbarS(signed int s32Digit /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x580070 -> 0x5800B8
        char ac8FileName[64]; // r29+0x10
        signed int s32Num; // r2
    }
}


// Range: 0x5800C0 -> 0x580298
float drawNumbarS(float f32PosX /* r23 */, float f32PosY /* r22 */, unsigned int u32DispNum /* r21 */, signed int s32Digit /* r20 */, unsigned int u32Color /* r19 */, float f32Scale /* r21 */, float f32Dist /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5800C0 -> 0x580298
        class stcTexUV * psTexSrc_Tex; // r2
...
// Range: 0x5802A0 -> 0x5802F4
float calcNumbar(signed int s32Digit /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5802A0 -> 0x5802F4
        char ac8FileName[64]; // r29+0x10
...
// Range: 0x580300 -> 0x5805B4
float drawNumbar(float f32PosX /* r23 */, float f32PosY /* r22 */, unsigned int u32DispNum /* r21 */, signed int s32Digit /* r20 */, unsigned int u32Color /* r19 */, enum enmIconMode eIcomFlag /* r22 */, float f32Scale /* r21 */, float f32Dist /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x580300 -> 0x5805B4
        class stcTexUV * psTexSrc_Tex; // r2
