/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\Mission\MissionBreakMsg2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float oaf32IconScale[4]; // size: 0x10, address: 0x69A890
...
// Range: 0x58EB20 -> 0x58ED98
void draw(class clsMissionBreakMsg2D_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58EB20 -> 0x58ED98
        class NNS_VECTORFAST sPosVecFast; // r29+0x70
        class NNS_VECTORFAST sRetVecFast; // r29+0x60
        class stcPoint2D_s16 sRetPoint2D; // r29+0x8C
        float f32DrawScale; // r20
        signed int s32x; // r2
        signed int s32y; // r2
        float f32NumberScale; // r29+0x90
    }
}


// Range: 0x58EDA0 -> 0x58EF04
void execute(class clsMissionBreakMsg2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58EDA0 -> 0x58EF04
