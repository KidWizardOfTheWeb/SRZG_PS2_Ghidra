/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\SurvivalRelay\SurvivalRelayMap2D.cpp
...
struct /* @anon0 */ {
    // total size: 0x20
} __vt__21clsSurvivalRelayMap2D; // size: 0x20, address: 0x6CF9D0
...
class clsSurvivalRelayMap2D : public clsScoreMap2D {
    // total size: 0x90
public:
    signed short m_s16MapLeft; // offset 0x80, size 0x2
    signed short m_s16MapTop; // offset 0x82, size 0x2
    signed short m_s16MapWidth; // offset 0x84, size 0x2
    signed short m_s16MapHeight; // offset 0x86, size 0x2
    signed short m_s16MapLineHeight; // offset 0x88, size 0x2
};
...
// Range: 0x54B6E0 -> 0x54BBAC
void drawStartMap(class clsSurvivalRelayMap2D * this /* r29+0xFC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54B6E0 -> 0x54BBAC
        class clsSurvivalRelayRace_Task & rcSurvivalRelayRace_Task; // r2
        class stcTexUV * psTexSrc; // r2
        class stcPoint2D_s16 * psTextureNoUserSize; // r2
        ...
        float f32Width; // r29+0x150
        float f32Height; // r29+0x150
        signed int s32n; // r18
        class clsPlayerTask * pcPlayer; // r17
        unsigned char u8CharaID; // r16
        unsigned char u8IconAlpha; // r22
        unsigned int u32PlayerNo; // r2
        unsigned int u32TeamNo; // r21
        class NNS_VECTORFAST sPosVec; // r29+0x140
        float sMtx[4][4]; // r29+0x100
    }
}


// Range: 0x54BBB0 -> 0x54BBFC
void draw(class clsSurvivalRelayMap2D * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54BBB0 -> 0x54BBFC
        class clsSurvivalRelayRace_Task & rcSurvivalRelayRace_Task; // r2
...
// Range: 0x54BC00 -> 0x54BC60
void * __dt(class clsSurvivalRelayMap2D * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54BC00 -> 0x54BC60
    }
...
// Range: 0x54BC60 -> 0x54BD5C
void * __ct(class clsSurvivalRelayMap2D * this /* r17 */, class clsScore2D_Task * pcParent /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54BC60 -> 0x54BD5C
    }
