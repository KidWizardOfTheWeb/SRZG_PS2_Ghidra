/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\ScoreMeter2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcMeterData DrawData1v; // size: 0x34, address: 0x682220
static class stcMeterData DrawData2v; // size: 0x34, address: 0x682260
static class stcMeterData DrawData4v; // size: 0x34, address: 0x6822A0
struct /* @anon0 */ {
    // total size: 0x14
} __vt__15clsScoreMeter2D; // size: 0x14, address: 0x6C18D0
...
// Range: 0x3C5470 -> 0x3C5B7C
void drawMeter(class clsScoreMeter2D * this /* r21 */, unsigned int u32View /* r20 */, unsigned int u32PlayerNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C5470 -> 0x3C5B7C
        class stcUnionStatus * psUnionSt; // r2
        signed int s32DrawX; // r19
        signed int s32DrawY; // r18
        signed int s32Dir; // r17
        class clsPlayerTask * pcPlayer; // r2
        class stcUserStatus * psUserSt; // r16
        signed int s32Speed; // r23
        unsigned int ou32CharaColor; // r30
        float f32AgpPoint; // r23
        float f32AgpDrawPoint; // r22
        float f32AgpMax; // r20
        float f32OldAgpMax; // r21
        float f32MaxAgpWidth; // r20
    }
}


// Range: 0x3C5B80 -> 0x3C5BE4
void draw(class clsScoreMeter2D * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C5B80 -> 0x3C5BE4
        signed int s32i; // r16
...
// Range: 0x3C5BF0 -> 0x3C5CC8
void _drawCloseEffect(class clsScoreMeter2D * this /* r2 */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r2 */, class stcUserStatus * psUserSt /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C5BF0 -> 0x3C5CC8
        class stcMeterData * psDrawData; // r2
        class stcPoint2D_s16 * psTextureSize; // r2
        float f32DrawX; // r3
        float f32DrawY; // r1
        unsigned char u8Alpha; // r9
        float f32HalfSize; // r6
    }
}


// Range: 0x3C5CD0 -> 0x3C5FE4
void _drawDiveEffect(class clsScoreMeter2D * this /* r2 */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r2 */, class stcUserStatus * psUserSt /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C5CD0 -> 0x3C5FE4
        ...
        float f32DrawX; // r21
        float f32DrawY; // r20
        unsigned char u8Alpha; // r4
        float f32HalfWidth; // r29+0x90
        float f32HalfHeight; // r29+0x90
    }
}


// Range: 0x3C5FF0 -> 0x3C61A4
void _drawCircleEffect(class clsScoreMeter2D * this /* r2 */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r2 */, class stcUserStatus * psUserSt /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C5FF0 -> 0x3C61A4
        class stcTexUV * psTexSrc_Tex; // r2
        ...
        float f32DrawX; // r21
        float f32DrawY; // r20
        unsigned char u8Alpha; // r7
        float f32HalfWidth; // r29+0x70
        float f32HalfHeight; // r29+0x70
    }
}


// Range: 0x3C61B0 -> 0x3C62B8
void _drawLight(class clsScoreMeter2D * this /* r2 */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r2 */, float f32Width /* r29 */, unsigned char u8Alpha /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C61B0 -> 0x3C62B8
        class stcTexUV * psTexSrc_Tex; // r2
        ...
        float f32DrawX; // r4
        float f32DrawY; // r2
        signed short s16HalfScale; // r2
    }
}


// Range: 0x3C62C0 -> 0x3C65D0
void _drawMaxUpInfo(class clsScoreMeter2D * this /* r2 */, class stcTempParam * psParam /* r20 */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r2 */, float f32Width /* r29+0x80 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C62C0 -> 0x3C65D0
        class stcTexUV * psTexSrc_Tex; // r2
...
// Range: 0x3C65D0 -> 0x3C6A58
void _drawSpeed(class clsScoreMeter2D * this /* r21 */, signed int s32PosX /* r2 */, signed int s32PosY /* r22 */, signed int s32Dir /* r2 */, signed int s32Speed /* r20 */, float f32Scale /* r24 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C65D0 -> 0x3C6A58
        class stcTexUV * psTexSrc_Tex; // r2
        ...
        class stcPoint2D_s16 * psTextureSize; // r2
        float f32DrawX; // r20
        float f32DrawY; // r29+0xC0
        signed int s32NumDefAllWidth; // r2
        float f32NumWidth; // r23
        float f32NumHeight; // r22
        float f32NumHalfWidth; // r21
        signed int s32DrawNo; // r2
        float f32NumCenterX; // r20
        float f32LeftX; // r26
        float f32RightX; // r25
    }
}
...
// Range: 0x3C6A60 -> 0x3C6D88
void _drawFrame(class clsScoreMeter2D * this /* r21 */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r20 */, float f32Width /* r26 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C6A60 -> 0x3C6D88
        class stcTexUV * psTexSrc_Tex; // r2
        ...
        float f32GaugeY; // r22
        float f32GaugeH; // r21
        float f32GaugeSubH; // r29+0xA0
    }
}


// Range: 0x3C6D90 -> 0x3C6FD8
void _drawGaugeLight(class clsScoreMeter2D * this /* r2 */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r2 */, float f32Width /* r29+0x60 */, unsigned char u8AddAlpha /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C6D90 -> 0x3C6FD8
        class stcTexUV * psTexSrc_Tex; // r2
        ...
        float f32DrawY; // r21
        float f32DrawH; // r20
        float f32GaugeSubH; // r29+0x60
    }
}


// Range: 0x3C6FE0 -> 0x3C7B14
void _drawGauge(class clsScoreMeter2D * this /* r18 */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r2 */, float f32Width /* r29+0x150 */, float f32Gauge /* r29+0x150 */, float f32Back /* r29+0x150 */, float f32Max /* r29+0x150 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C6FE0 -> 0x3C7B14
        class stcTexUV * psTexSrc_Tex; // r2
        ...
        float f32DrawY; // r25
        float f32DrawH; // r1
        float f32CommitWidth; // r20
        float f32CommitP; // r24
        float f32GaugeWidth; // r23
        float f32GaugeP; // r22
        unsigned int oau32GaugeColor[4]; // r29+0x140
        unsigned int oau32CommitColor[4]; // r29+0x130
        float oaf32GaugeChange[6]; // r29+0x110
        float oaf32GaugeChangeWidth[6]; // r29+0xF0
        unsigned char u8BackAlpha; // r4
        float f32LeftX; // r5
        float f32RightX; // r4
        class NNS_PRIM2D_PCT prim2D_PCT[4]; // r29+0xA0
        unsigned int u32GaugeLeftColor; // r21
        signed int s32i; // r20
        float f32Rate; // r3
        float f32RateSrc; // r1
        float f32RateCal; // r29+0x150
        unsigned char u8Lr; // r2
        unsigned char u8Lg; // r2
        unsigned char u8Lb; // r2
        float f32Rate; // r3
        float f32RateSrc; // r2
        float f32RateCal; // r3
        unsigned char u8Lr; // r2
...
// Range: 0x3C7B20 -> 0x3C8270
void executeMeter(class clsScoreMeter2D * this /* r2 */, unsigned int u32View /* r2 */, unsigned int u32PlayerNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C7B20 -> 0x3C8270
        class stcMeterData * psDrawData; // r2
        signed int s32AddAlpha; // r2
        float f32AddScale; // r22
        class clsPlayerTask * pcPlayer; // r2
        class stcUserStatus * psUserSt; // r20
        float f32AgpPoint; // r21
        float f32AgpDrawPoint; // r20
        float f32MaxAgp; // r4
        float f32DiveMaxScale; // r3
    }
}


// Range: 0x3C8270 -> 0x3C8344
void execute(class clsScoreMeter2D * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C8270 -> 0x3C8344
        class stcUnionStatus * psUnionSt; // r2
        unsigned char bWait; // r7
        signed int s32n; // r17
    }
}


// Range: 0x3C8350 -> 0x3C8618
void init(class clsScoreMeter2D * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C8350 -> 0x3C8618
        class stcUnionStatus * psUnionSt; // r2
...
// Range: 0x3C8620 -> 0x3C866C
void * __dt(class clsScoreMeter2D * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C8620 -> 0x3C866C
    }
...
// Range: 0x3C8670 -> 0x3C86B0
void * __ct(class clsScoreMeter2D * this /* r16 */, class clsScore2D_Task * pcParent /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C8670 -> 0x3C86B0
    }
