/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\Mission\MissionParts2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcPoint2D_s16 oasUnionTextureSize; // size: 0x4, address: 0x690278
static class stcTexUV TexData2D[7]; // size: 0x70, address: 0x690280
...
// Range: 0x4D0780 -> 0x4D0970
void drawRingWindow(class clsMissionParts2D * this /* r21 */, signed int s32PlayerNo /* r2 */, signed int s32View /* r2 */, class stcUnionStatus * psUnionSt /* r30 */, signed int s32PosX /* r20 */, signed int s32PosY /* r19 */, signed int s32Dir /* r18 */, unsigned int ou32CharaColor /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D0780 -> 0x4D0970
        class clsMissionRace_Task & rcMissionRace_Task; // r2
        class clsPlayerTask * pcPlayer; // r2
        signed char s8Rank; // r3
        float f32DrawBarWidth; // r20
        unsigned int u32RingMax; // r2
    }
}


// Range: 0x4D0970 -> 0x4D10F4
void drawGearWindow(class clsMissionParts2D * this /* r21 */, signed int s32PlayerNo /* r2 */, signed int s32View /* r2 */, class stcUnionStatus * psUnionSt /* r2 */, signed int s32PosX /* r29+0x11C */, signed int s32PosY /* r29+0x118 */, signed int s32Dir /* r29+0x114 */, unsigned int ou32CharaColor /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D0970 -> 0x4D10F4
        class clsMissionRace_Task & rcMissionRace_Task; // r2
        ...
        class stcPoint2D_s16 * psGearTextureSize; // r2
        float f32DrawX; // r22
        float f32DrawY; // r20
        float f32HalfWidth; // r29+0x170
        float f32HalfHeight; // r9
        unsigned int u32Color; // r2
        float f32RingX; // r8
        float f32RingY; // r7
        class NNS_PRIM2D_PCT prim2D_PCT[4]; // r29+0x120
        signed int s32i; // r20
        signed int s32i; // r20
        ...
        signed int s32PartX; // r2
        float f32Scale; // r22
        unsigned int u32TexType[3]; // @ 0x0063AAB8
    }
}
