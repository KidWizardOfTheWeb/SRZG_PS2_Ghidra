/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\ScoreParts2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcPartsData DrawData1v; // size: 0x68, address: 0x6822E0
static class stcPartsData DrawData2v; // size: 0x68, address: 0x682350
static class stcPartsData DrawData4v; // size: 0x68, address: 0x6823C0
struct /* @anon0 */ {
    // total size: 0x20
} __vt__15clsScoreParts2D; // size: 0x20, address: 0x6C18F0
...
unsigned int oasImageColor[]; // size: 0x0, address: 0x6656B0
class stcTexUV TexDataError; // size: 0x10, address: 0x694A60
class stcTexUV TexData2D[]; // size: 0x0, address: 0x695290
class stcTexUV TexData2D[]; // size: 0x0, address: 0x695170
class stcTexUV TexDataLock; // size: 0x10, address: 0x694A70
...
// Range: 0x3C86C0 -> 0x3C89BC
void drawRingWindow(class clsScoreParts2D * this /* r21 */, signed int s32PlayerNo /* r2 */, signed int s32View /* r2 */, class stcUnionStatus * psUnionSt /* r23 */, signed int s32PosX /* r20 */, signed int s32PosY /* r19 */, signed int s32Dir /* r18 */, unsigned int ou32CharaColor /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C86C0 -> 0x3C89BC
        class stcUserStatus * psUserSt; // r2
        float f32DrawBarWidth; // r20
        signed int s32RingMax; // r30
    }
}


// Range: 0x3C89C0 -> 0x3C8BC4
void drawGearWindow(class clsScoreParts2D * this /* r21 */, signed int s32PlayerNo /* r2 */, signed int s32View /* r2 */, class stcUnionStatus * psUnionSt /* r2 */, signed int s32PosX /* r20 */, signed int s32PosY /* r19 */, signed int s32Dir /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C89C0 -> 0x3C8BC4
        class clsPlayerTask * pcPlayer; // r18
        class stcUserStatus * psUserSt; // r17
        unsigned char u8PartsNum; // r2
        unsigned char bLine; // r30
        unsigned char bName; // r16
    }
}


// Range: 0x3C8BD0 -> 0x3C8D9C
void drawAddEffect(class clsScoreParts2D * this /* r21 */, signed int s32PlayerNo /* r2 */, signed int s32View /* r2 */, class stcUnionStatus * psUnionSt /* r2 */, signed int s32PosX /* r20 */, signed int s32PosY /* r19 */, signed int s32Dir /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C8BD0 -> 0x3C8D9C
        class clsPlayerTask * pcPlayer; // r17
        class stcUserStatus * psUserSt; // r16
        unsigned char u8PartsNum; // r2
        unsigned char bLine; // r22
        unsigned char bName; // r23
    }
}


// Range: 0x3C8DA0 -> 0x3C8F94
void drawParts(class clsScoreParts2D * this /* r21 */, unsigned int u32View /* r20 */, unsigned int u32PlayerNo /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C8DA0 -> 0x3C8F94
        class stcUnionStatus * psUnionSt; // r18
        signed int s32DrawX; // r17
        signed int s32DrawY; // r16
        signed int s32Dir; // r22
        class clsPlayerTask * pcPlayer; // r2
        unsigned int ou32CharaColor; // r23
    }
}


// Range: 0x3C8FA0 -> 0x3C900C
void draw(class clsScoreParts2D * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C8FA0 -> 0x3C900C
        signed int s32i; // r16
...
// Range: 0x3C9010 -> 0x3C9524
void _drawSelectLine(class clsScoreParts2D * this /* r16 */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r2 */, class clsPlayerTask * pcPlayer /* r2 */, class stcUserStatus * psUserSt /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C9010 -> 0x3C9524
        class stcTexUV * psTexSrc_Tex; // r2
        class stcTexUV * psTexSrc; // r2
        class stcPartsData * psDrawData; // r2
        class stcPoint2D_s16 * psTextureSize; // r2
        unsigned int u32Color; // r2
        class NNS_PRIM2D_PCT prim2D_PCT[4]; // r29+0x80
        float f32HeadFrame; // r1
        float f32TailFrame; // r29+0xD0
        float f32CircleX; // r6
        float f32CircleY; // r5
        float f32PartsX; // r22
        float f32PartsY; // r21
        signed int s32PartsLightNo; // r21
        float f32PartsLightFrame; // r20
        signed int s32n; // r5
        float f32HeadX; // r7
        float f32HeadY; // r6
        float f32TailX; // r3
        float f32TailY; // r5
        unsigned char u8PartsAlpha; // r2
        float f32HalfWidth; // r29+0xD0
        float f32HalfHeight; // r29+0xD0
    }
}


// Range: 0x3C9530 -> 0x3C96A4
void _drawPartsLight(class clsScoreParts2D * this /* r2 */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r2 */, class clsPlayerTask * pcPlayer /* r2 */, unsigned char u8AddAlpha /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C9530 -> 0x3C96A4
        class stcTexUV * psTexSrc_Tex; // r2
        ...
        float f32DrawX; // r3
        float f32DrawY; // r5
        float f32HalfWidth; // r29+0x10
        float f32HalfHeight; // r29+0x10
        signed int s32SelectNo; // r2
        signed int s32AddX; // r2
    }
}


// Range: 0x3C96B0 -> 0x3C9A9C
void _drawPartsName(class clsScoreParts2D * this /* r2 */, signed int s32PosX /* r20 */, signed int s32PosY /* r19 */, signed int s32Dir /* r18 */, class clsPlayerTask * pcPlayer /* r29+0xFC */, class stcUserStatus * psUserSt /* r29+0xF8 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C96B0 -> 0x3C9A9C
        class stcPartsData * psDrawData; // r2
        class stcTexUV * psTexSrc; // r29+0xE0
        class stcTexUV * psTexSrc_Tex; // r2
        class stcPoint2D_s16 * psTextureSize; // r17
        class stcTexUV * psTexSrc_Tex02; // r2
        class stcPoint2D_s16 * psTexture02Size; // r23
        signed int s32SelectNo; // r2
        signed int s32OldSelectNo; // r2
        float f32DrawX; // r21
        float f32DrawY; // r20
        signed int s32TexNo; // r2
        class stcPoint2D_s16 * psNameSize; // r21
        unsigned char u8NameAlpha; // r21
    }
}


// Range: 0x3C9AA0 -> 0x3C9F80
void _drawPartsEtc(class clsScoreParts2D * this /* r29+0xEC */, signed int s32PosX /* r30 */, signed int s32PosY /* r29+0xE8 */, signed int s32Dir /* r23 */, class clsPlayerTask * pcPlayer /* r21 */, class stcUserStatus * psUserSt /* r29+0xE4 */, unsigned char bBotton /* r29+0xE3 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C9AA0 -> 0x3C9F80
        class stcTexUV * psTexSrc_Tex; // r2
        ...
        class stcPartsData * psDrawData; // r2
        class stcPoint2D_s16 * psTextureSize; // r2
        class _Draw2DData & orsGear2DData; // r2
        signed int s32SelectNo; // r2
        float f32DrawX; // r22
        float f32DrawY; // r20
        float f32HalfWidth; // r29+0x140
        float f32HalfHeight; // r9
        float f32RingX; // r8
        float f32RingY; // r7
        unsigned int u32Color; // r2
        class NNS_PRIM2D_PCT prim2D_PCT[4]; // r29+0xF0
        signed int s32i; // r19
        unsigned char u8NameAlpha; // r3
    }
}


// Range: 0x3C9F80 -> 0x3CA590
void _drawPartsIcon(class clsScoreParts2D * this /* r29+0x11C */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r2 */, class clsPlayerTask * pcPlayer /* r2 */, class stcUserStatus * psUserSt /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C9F80 -> 0x3CA590
        class stcTexUV * psTexSrc_Parts; // r2
        class stcTexUV * psTexSrc; // r21
        class stcPartsData * psDrawData; // r2
        class stcPoint2D_s16 * psPartsTextureSize; // r2
        class _Draw2DData & orsGear2DData; // r2
        signed int s32SelectNo; // r2
        float f32DrawX; // r23
        float f32DrawY; // r22
        float f32HalfWidth; // r29+0x160
        float f32HalfHeight; // r29+0x160
        signed int s32i; // r20
        signed int s32PartX; // r2
        float f32Scale; // r29+0x160
        signed int s32i; // r20
        signed int s32PartX; // r2
        float f32Scale; // r3
        unsigned int u32Color; // r23
        unsigned char bIconEffect; // r2
        float f32Rate; // r29+0x160
        float sRotMtx[4][4]; // r29+0x120
    }
}


// Range: 0x3CA590 -> 0x3CADEC
void _drawRingNum(class clsScoreParts2D * this /* r2 */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r2 */, signed int s32Ring /* r2 */, signed int s32RingMax /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CA590 -> 0x3CADEC
        class stcTexUV * psTexSrc_Tex; // r2
        ...
        class stcPartsData * psDrawData; // r2
        class stcPoint2D_s16 * psTextureSize; // r2
        float f32NumAllWidth; // r4
        float f32DrawX; // r24
        float f32Bottom; // r23
        float f32DrawY; // r22
        float f32CurMagin; // r20
        float f32MaxMagin; // r21
        signed int s32DrawNum; // r2
    }
}


// Range: 0x3CADF0 -> 0x3CB0FC
void _drawFrame(class clsScoreParts2D * this /* r21 */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r20 */, float f32Width /* r24 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CADF0 -> 0x3CB0FC
        class stcTexUV * psTexSrc_Tex; // r2
        ...
        float f32DrawY; // r22
        float f32BarX; // r21
        float f32BarY; // r29+0xA0
        float f32BarH; // r20
        float f32BarLineH; // r29+0xA0
    }
}


// Range: 0x3CB100 -> 0x3CB1E8
void _drawNumBack(class clsScoreParts2D * this /* r2 */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r2 */, float f32Width /* r29 */, unsigned int u32Color /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CB100 -> 0x3CB1E8
        float f32DrawX; // r1
...
// Range: 0x3CB1F0 -> 0x3CB2B8
void _drawRing(class clsScoreParts2D * this /* r2 */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CB1F0 -> 0x3CB2B8
        class stcPartsData * psDrawData; // r2
...
// Range: 0x3CB2C0 -> 0x3CB70C
void _drawActEffect(class clsScoreParts2D * this /* r2 */, class stcUserStatus * psUserSt /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CB2C0 -> 0x3CB70C
        class stcTexUV * psTexSrc; // r23
        class stcTexUV * psTexSrc_Tex; // r2
        class stcPoint2D_s16 * psTextureSize; // r2
        ...
        float f32Width; // r29+0xE0
        float f32Height; // r29+0xE0
        signed int s32n; // r20
        class stcActEffectParam * psParam; // r2
        unsigned char u8RingAlpha; // r2
        unsigned char u8RingAlpha; // r2
    }
}


// Range: 0x3CB710 -> 0x3CB768
void _setActEffect(class clsScoreParts2D * this /* r2 */, class stcUserStatus * psUserSt /* r2 */, signed int s32No /* r2 */, signed int s32x /* r2 */, signed int s32y /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CB710 -> 0x3CB768
        class stcActEffectParam * psParam; // r2
...
// Range: 0x3CB770 -> 0x3CB79C
void _initActEffect(class stcUserStatus * psUserSt /* r2 */, signed int s32No /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CB770 -> 0x3CB79C
        class stcActEffectParam * psParam; // r2
...
// Range: 0x3CB7A0 -> 0x3CBAA0
void _drawMaxUpInfo(class clsScoreParts2D * this /* r2 */, class stcTempParam * psParam /* r20 */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r2 */, float f32Width /* r29+0x80 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CB7A0 -> 0x3CBAA0
        class stcTexUV * psTexSrc_Tex; // r2
        ...
        float f32DrawX; // r21
        float f32DrawY; // r20
        signed int s32DrawPoint; // r2
        signed int s32DrawNum; // r2
    }
}


// Range: 0x3CBAA0 -> 0x3CC01C
void execute(class clsScoreParts2D * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CBAA0 -> 0x3CC01C
        class clsPfSystem * pcOOSystem; // r2
        class stcUnionStatus * psUnionSt; // r29+0xC0
        unsigned char bWait; // r16
        signed int s32n; // r30
        class clsPlayerTask * pcPlayer; // r2
        class stcUserStatus * psUserSt; // r20
        float f32MaxRing; // r29+0xD0
    }
}


// Range: 0x3CC030 -> 0x3CC234
void _exeEnergyLine(class clsScoreParts2D * this /* r2 */, class stcUserStatus * psUserSt /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CC030 -> 0x3CC234
        class stcUnionStatus * psUnionSt; // r2
        class stcPartsData * psDrawData; // r2
        unsigned char bLight; // r16
        float f32LightScale; // r20
        float f32LightFrame; // r29+0x40
        float f32LightHalfFrame; // r29+0x40
    }
}


// Range: 0x3CC240 -> 0x3CC77C
void init(class clsScoreParts2D * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CC240 -> 0x3CC77C
        ...
        class stcUnionStatus * psUnionSt; // r2
        class stcPartsData * psDrawData; // r2
        signed int s32DrawX; // r23
        signed int s32DrawY; // r22
        signed int s32Dir; // r2
        signed int s32n; // r20
        class clsPlayerTask * pcPlayer; // r2
        class stcUserStatus * psUserSt; // r19
        signed int s32i; // r4
    }
}


// Range: 0x3CC780 -> 0x3CC820
void * __dt(class clsScoreParts2D * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CC780 -> 0x3CC820
        signed int s32n; // r17
...
// Range: 0x3CC820 -> 0x3CC8B0
void * __ct(class clsScoreParts2D * this /* r18 */, class clsScore2D_Task * pcParent /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CC820 -> 0x3CC8B0
        signed int s32n; // r17
