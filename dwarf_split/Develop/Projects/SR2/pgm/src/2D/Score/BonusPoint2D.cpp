/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\BonusPoint2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcBonusPointData DrawData1v; // size: 0x40, address: 0x68A0D0
static class stcBonusPointData DrawData2v; // size: 0x40, address: 0x68A110
static class stcBonusPointData DrawData4v; // size: 0x40, address: 0x68A150
class stcBonusPointData * opsDrawData; // size: 0x4, address: 0xB17548
class stcEnergyPoint asEnergyPoint[4]; // size: 0x130, address: 0xB17550
static float tf32EnergyFrameMax; // size: 0x4, address: 0xB17680
class clsTask * apcCurentGLinkPoint[5]; // size: 0x14, address: 0xB17690
struct /* @anon0 */ {
    // total size: 0x30
} __vt__20clsBonusPoint2D_Task; // size: 0x30, address: 0x6C7EA0
...
class stcBonusPointData {
    // total size: 0x40
public:
    signed short s16MoveMax; // offset 0x0, size 0x2
    float f32WaitFrame; // offset 0x4, size 0x4
    float f32TextScale; // offset 0x8, size 0x4
    float f32NumScale; // offset 0xC, size 0x4
    float f32MarginScale; // offset 0x10, size 0x4
    float f32ShotFrame; // offset 0x14, size 0x4
    float f32ShotScale; // offset 0x18, size 0x4
    float f32CircleX; // offset 0x1C, size 0x4
    float f32CircleY; // offset 0x20, size 0x4
    unsigned char u8LineStartX; // offset 0x24, size 0x1
    unsigned char u8LineMiddleX; // offset 0x25, size 0x1
    unsigned char u8LineEndX; // offset 0x26, size 0x1
    signed char s8LineStartY; // offset 0x27, size 0x1
    signed char s8LineEndY; // offset 0x28, size 0x1
    unsigned char u8ELineHeight; // offset 0x29, size 0x1
...
public:
    ...
    unsigned int m_u32Player; // offset 0x5C, size 0x4
    unsigned int m_u32Type; // offset 0x60, size 0x4
    unsigned int m_u32Flg; // offset 0x64, size 0x4
    float m_f32BonusAgp; // offset 0x68, size 0x4
    float m_f32WaitFrame; // offset 0x6C, size 0x4
    unsigned char m_u8TextAlpha; // offset 0x70, size 0x1
    unsigned char m_u8NumAlpha; // offset 0x71, size 0x1
    signed short m_s16TextMove; // offset 0x72, size 0x2
    signed short m_s16NumMove; // offset 0x74, size 0x2
    float m_f32ShotFrame; // offset 0x78, size 0x4
    float m_f32EnergyFrame; // offset 0x7C, size 0x4
    float m_f32EnergySubFrame; // offset 0x80, size 0x4
    float m_f32GlinkWaitFrame; // offset 0x84, size 0x4
    class clsEnergyFlow2D * m_pcBaseLine; // offset 0x88, size 0x4
    class clsEnergyFlow2D * m_pcAddLine; // offset 0x8C, size 0x4
};
class stcTimePack {
    // total size: 0x4
public:
...
// Range: 0x49B140 -> 0x49B2D0
void draw(class clsBonusPoint2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49B140 -> 0x49B2D0
    }
...
// Range: 0x49B2D0 -> 0x49B4C8
void _drawShot(class clsBonusPoint2D_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49B2D0 -> 0x49B4C8
...
// Range: 0x49B4D0 -> 0x49B978
void _drawPoint(class clsBonusPoint2D_Task * this /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49B4D0 -> 0x49B978
        class stcEnergyPoint * opsPoint; // r20
        class stcBonusPointData * psDrawData; // r2
        ...
        unsigned char u8TextAlpha; // r7
        unsigned char u8NumAlpha; // r19
        signed int s32DrawX; // r2
        signed int s32DrawY; // r2
    }
}
...
// Range: 0x49B980 -> 0x49C078
void execute(class clsBonusPoint2D_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49B980 -> 0x49C078
        ...
        float f32LightFrame; // r29+0x50
        float f32LightHalfFrame; // r29+0x50
    }
}


// Range: 0x49C080 -> 0x49C0FC
void * __dt(class clsBonusPoint2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49C080 -> 0x49C0FC
    }
...
// Range: 0x49C100 -> 0x49C370
void * __ct(class clsBonusPoint2D_Task * this /* r18 */, signed int s32Player /* r17 */, unsigned int u32Type /* r16 */, float f32BonusAgp /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49C100 -> 0x49C370
...
// Range: 0x49C370 -> 0x49C6D0
void setupEnergyPoint() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49C370 -> 0x49C6D0
        class stcBonusPointData * opsDrawData'179; // r5
