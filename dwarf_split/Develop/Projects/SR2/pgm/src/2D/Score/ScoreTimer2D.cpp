/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\ScoreTimer2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcTimerData sDrawData1v; // size: 0x14, address: 0x6824E0
static class stcTimerData sDrawDataMul; // size: 0x14, address: 0x682500
struct /* @anon0 */ {
    // total size: 0xC
} __vt__15clsScoreTimer2D; // size: 0xC, address: 0x6C1920
...
// Range: 0x3CDFA0 -> 0x3CDFE8
void draw(class clsScoreTimer2D * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CDFA0 -> 0x3CDFE8
    }
...
// Range: 0x3CDFF0 -> 0x3CEA30
void _drawTime(class clsScoreTimer2D * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CDFF0 -> 0x3CEA30
        class stcTexUV * psTexSrc_Tex; // r2
        class stcTexUV * psTexSrc; // r2
        class stcTimerData * psDrawData; // r2
        class stcPoint2D_s16 * psTextureSize; // r2
        unsigned char u8Alpha; // r16
        float f32CenterX; // r21
        float f32BaseY; // r20
        float f32DrawX; // r29+0x90
...
// Range: 0x3CEA30 -> 0x3CEEA0
void _drawLine(class clsScoreTimer2D * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CEA30 -> 0x3CEEA0
        class stcTexUV * psTexSrc_Tex; // r2
        ...
        float f32CenterX; // r21
        float f32BaseY; // r20
        float f32DrawX; // r29+0x80
        float f32DrawY; // r29+0x80
        signed int s32HalfHeight; // r2
        signed int s32Width; // r19
    }
}


// Range: 0x3CEEA0 -> 0x3CF0E0
void execute(class clsScoreTimer2D * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CEEA0 -> 0x3CF0E0
        signed int s32ExpandCheck; // r6
        signed int s32AddAlpha; // r2
    }
}


// Range: 0x3CF0E0 -> 0x3CF180
void init(class clsScoreTimer2D * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CF0E0 -> 0x3CF180
    }
...
// Range: 0x3CF180 -> 0x3CF1CC
void * __dt(class clsScoreTimer2D * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CF180 -> 0x3CF1CC
    }
...
// Range: 0x3CF1D0 -> 0x3CF290
void * __ct(class clsScoreTimer2D * this /* r16 */, class clsScore2D_Task * pcParent /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CF1D0 -> 0x3CF290
    }
