/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\ThroughLap2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x30
} __vt__20clsThroughLap2D_Task; // size: 0x30, address: 0x6C1C00
...
class clsThroughLap2D_Task : public clsTemporary2D_Task {
    // total size: 0x80
public:
    unsigned char m_bFinal; // offset 0x58, size 0x1
    signed int m_s32Lap; // offset 0x5C, size 0x4
    signed short m_s16DrawX; // offset 0x60, size 0x2
    signed short m_s16BaseX; // offset 0x62, size 0x2
    signed short m_s16BaseY; // offset 0x64, size 0x2
    signed short m_s16StopX; // offset 0x66, size 0x2
    signed short m_s16OutX; // offset 0x68, size 0x2
    float m_f32DrawScale; // offset 0x6C, size 0x4
    float m_f32MoveFrame; // offset 0x70, size 0x4
    float m_f32StopFrame; // offset 0x74, size 0x4
    float m_f32OutFrame; // offset 0x78, size 0x4
    class stcViewRect * m_opsRect; // offset 0x7C, size 0x4
};
enum enmPortalType {
    MAP = 0,
    OBJ = 1,
...
// Range: 0x3D5830 -> 0x3D5DE8
void draw(class clsThroughLap2D_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D5830 -> 0x3D5DE8
    }
...
// Range: 0x3D5E00 -> 0x3D6098
void execute(class clsThroughLap2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D5E00 -> 0x3D6098
    }
...
// Range: 0x3D60A0 -> 0x3D6100
void * __dt(class clsThroughLap2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D60A0 -> 0x3D6100
    }
...
// Range: 0x3D6100 -> 0x3D6374
void * __ct(class clsThroughLap2D_Task * this /* r21 */, unsigned int u32View /* r16 */, signed int s32Lap /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D6100 -> 0x3D6374
