/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\WorldGPPausePoint2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x34
} __vt__27clsWorldGpPausePoint2D_Task; // size: 0x34, address: 0x6CDBF0
...
// Range: 0x522D40 -> 0x523104
void execute(class clsWorldGpPausePoint2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x522D40 -> 0x523104
...
// Range: 0x523110 -> 0x5234EC
void init(class clsWorldGpPausePoint2D_Task * this /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x523110 -> 0x5234EC
        class clsScore2D_Task * pcScore2D; // r29+0xC0
        class stcResultRanking * psDrawData; // r2
        signed int s32LeftX; // r30
        class clsPlayerTask * pcPlayer; // r2
        signed int s32DrawY; // r29+0xB0
        signed int s32n; // r12
        class stcRankingLine * psLine; // r2
        class stcRankingLine * psLine; // r2
        class stcRecord sTotalTime; // r29+0xDC
    }
}


// Range: 0x5234F0 -> 0x523550
void * __dt(class clsWorldGpPausePoint2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5234F0 -> 0x523550
    }
...
// Range: 0x523550 -> 0x523598
void * __ct(class clsWorldGpPausePoint2D_Task * this /* r16 */, unsigned int u32Flg /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x523550 -> 0x523598
    }
