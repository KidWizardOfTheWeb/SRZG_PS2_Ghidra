/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\Tutorial\Tutorial2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcPoint2D_s16 oasUnionTextureSize[1]; // size: 0x4, address: 0x0
static class stcTexUV TexData2D[28]; // size: 0x1C0, address: 0x6923D0
static unsigned char chk__TexData2D_SizeCheck_[1]; // size: 0x1, address: 0x0
struct /* @anon0 */ {
    // total size: 0x30
} __vt__18clsTutorial2D_Task; // size: 0x30, address: 0x6CB050
struct /* @anon1 */ {
    // total size: 0x30
...
class clsTutorial2D_Task : public clsTask {
    // total size: 0x60
public:
    class clsTutorialRace_Task * m_pcTutorialRace_Task; // offset 0x54, size 0x4
    void * m_pv2dTexBuffer; // offset 0x58, size 0x4
    unsigned char m_u8FontPfOffsetNum; // offset 0x5C, size 0x1
    signed char m_s8TutorialNo; // offset 0x5D, size 0x1
};
...
// Range: 0x4F1050 -> 0x4F1518
void draw(class clsTutorial2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F1050 -> 0x4F1518
        class stcTexUV oasTexData; // r29+0x90
        class stcTexUV osUV; // r29+0x80
        signed int s32a; // r2
    }
}


// Range: 0x4F1530 -> 0x4F17C0
void drawSubject(class clsTutorial2D_Task * this /* r19 */, signed int s32DrawYI /* r16 */, unsigned int bDrawBlackBackI /* r21 */, unsigned int u32WindowType /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F1530 -> 0x4F17C0
        signed int s32MessageFontNo; // r19
        class stcTexUV * psTexSrc; // r2
        class stcRect sDrawRectM; // r29+0x80
        signed int s32DrawX; // r2
        float f32BoxW; // r29+0xA0
        float f32BoxH; // r29+0xA0
        unsigned int oau32Tbl[2]; // @ 0x00692590
    }
}


// Range: 0x4F17C0 -> 0x4F1830
void execute(class clsTutorial2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F17C0 -> 0x4F1830
    }
...
// Range: 0x4F1830 -> 0x4F190C
void * __ct(class clsTutorial2D_Task * this /* r17 */, signed int s32TutorialNoI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F1830 -> 0x4F190C
        char ac8FileName[64]; // r29+0x30
    }
}
