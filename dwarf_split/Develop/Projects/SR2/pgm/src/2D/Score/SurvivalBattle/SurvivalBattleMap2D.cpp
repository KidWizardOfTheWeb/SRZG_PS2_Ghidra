/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\SurvivalBattle\SurvivalBattleMap2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcPoint2D_s16 oasUnionTextureSize; // size: 0x4, address: 0x0
static class stcTexUV TexData2D[10]; // size: 0xA0, address: 0x0
...
static float scof32SurvivalBattleMapScale[4]; // size: 0x10, address: 0x697D50
class _NNS_TEXLIST * psTexList_SurvivalBattleMap2D; // size: 0x4, address: 0xBFB318
struct /* @anon0 */ {
    // total size: 0x20
...
// Range: 0x55BB10 -> 0x55BBD8
void drawMapMini(signed short s16BackX /* r19 */, signed short s16BackY /* r16 */, unsigned char u8DrawAlpha /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55BB10 -> 0x55BBD8
        class stcTexUV sTexSrc; // @ 0x00653A90
    }
}


// Range: 0x55BBE0 -> 0x55BC5C
void clip2Screen(class clsSurvivalBattleMap2D * this /* r2 */, class stcPoint2D_s16 & rsDstScreenO /* r2 */, class NNS_VECTORFAST & orsSrcVecI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55BBE0 -> 0x55BC5C
        float f32Scale; // r29
