/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\SurvivalBattle\SurvivalBattleCom2D.cpp
...
// Range: 0x58A030 -> 0x58A150
void draw(class clsSurvivalBattleCom2D * this /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58A030 -> 0x58A150
        class clsSurvivalBattleRace_Task & rcSurvivalBattleRace_Task; // r21
        signed int s32ComNum; // r2
        signed int s32UserNum; // r2
        signed int s32i; // r20
        signed char s8CharaID; // r2
