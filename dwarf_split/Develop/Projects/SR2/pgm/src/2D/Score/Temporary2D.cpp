/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\Temporary2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon1 */ {
    // total size: 0x30
} __vt__19clsTemporary2D_Task; // size: 0x30, address: 0x6C1BD0
struct /* @anon0 */ {
    // total size: 0x30
...
// Range: 0x3D5770 -> 0x3D57E0
void * __dt(class clsTemporary2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D5770 -> 0x3D57E0
    }
...
// Range: 0x3D57E0 -> 0x3D582C
void * __ct(class clsTemporary2D_Task * this /* r16 */, unsigned int u32TIp /* r2 */, class clsTask * pcParent /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D57E0 -> 0x3D582C
    }
