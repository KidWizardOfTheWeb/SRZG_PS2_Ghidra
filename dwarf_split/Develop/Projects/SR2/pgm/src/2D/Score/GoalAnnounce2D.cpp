/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\GoalAnnounce2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class clsGoalAnnounce2D_Task * pcCurrentTask; // size: 0x4, address: 0xB16478
struct /* @anon0 */ {
    // total size: 0x30
} __vt__22clsGoalAnnounce2D_Task; // size: 0x30, address: 0x6C1DC0
...
class clsGoalAnnounce2D_Task : public clsTemporary2D_Task {
    // total size: 0x6C
public:
    signed int m_s32Rank; // offset 0x58, size 0x4
    unsigned int m_u32CharaId; // offset 0x5C, size 0x4
    ...
    signed short m_s16OutX; // offset 0x66, size 0x2
    float m_f32MoveFrame; // offset 0x68, size 0x4
};
class GskFlags {
    // total size: 0x4
public:
...
// Range: 0x3E3690 -> 0x3E39D8
void draw(class clsGoalAnnounce2D_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E3690 -> 0x3E39D8
        ...
        float f32Width; // r23
        float f32Height; // r22
        float f32MarkY; // r29+0xB0
    }
}


// Range: 0x3E39E0 -> 0x3E3BD4
void execute(class clsGoalAnnounce2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E39E0 -> 0x3E3BD4
    }
...
// Range: 0x3E3BE0 -> 0x3E3C40
void * __dt(class clsGoalAnnounce2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E3BE0 -> 0x3E3C40
    }
...
// Range: 0x3E3C40 -> 0x3E3DE0
void * __ct(class clsGoalAnnounce2D_Task * this /* r17 */, signed int s32Rank /* r16 */, unsigned int u32CharaId /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E3C40 -> 0x3E3DE0
        ...
        class stcTexUV * psTexSrc_RaceBase; // r2
        class stcTexUV * psTexSrc_Result; // r2
        float f32DrawWidth; // r4
    }
}


// Range: 0x3E3DE0 -> 0x3E3DEC
void initCurrent() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E3DE0 -> 0x3E3DEC
