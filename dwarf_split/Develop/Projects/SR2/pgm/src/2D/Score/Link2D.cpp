/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\Link2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcLinkData DrawData1v; // size: 0x38, address: 0x6835C0
static class stcLinkData DrawData2v; // size: 0x38, address: 0x683600
static class stcLinkData DrawData4v; // size: 0x38, address: 0x683640
class stcLinkData * opsDrawData; // size: 0x4, address: 0xB16598
class stcEnergyPoint asEnergyPoint[4]; // size: 0x100, address: 0xB165A0
static float tf32EnergyFrameMax; // size: 0x4, address: 0xB166A0
struct /* @anon0 */ {
    // total size: 0x30
} __vt__14clsLink2D_Task; // size: 0x30, address: 0x6C20D0
...
public:
    ...
    signed int m_s32Link; // offset 0x60, size 0x4
    signed int * m_ops32SrcLink; // offset 0x64, size 0x4
    float m_f32NumScale; // offset 0x68, size 0x4
    signed short m_s16Move; // offset 0x6C, size 0x2
    unsigned char m_u8Alpha; // offset 0x6E, size 0x1
    unsigned char m_u8HideFlg; // offset 0x6F, size 0x1
    float m_f32EnergyFrame; // offset 0x70, size 0x4
    float m_f32EnergySubFrame; // offset 0x74, size 0x4
...
// Range: 0x3EA520 -> 0x3EA67C
void draw(class clsLink2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EA520 -> 0x3EA67C
    }
...
// Range: 0x3EA680 -> 0x3EA9F8
void _drawLink(class clsLink2D_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EA680 -> 0x3EA9F8
        unsigned char u8DrawAlpha; // r22
        signed int s32DrawNum; // r2
        signed int s32Link; // r2
        ...
        float f32NumDefWidth; // r29+0xB0
        float f32NumDrawDefWidth; // r24
        float f32NumDrawWidth; // r23
        float f32NumDrawHeight; // r22
        float f32TextWidth; // r21
        float f32TextHeight; // r20
...
// Range: 0x3EAA00 -> 0x3EB064
void execute(class clsLink2D_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EAA00 -> 0x3EB064
        class clsScore2D_Task * pcScore2D; // r2
        float f32EnergyFrameMax; // r20
        signed int s32AddMove; // r2
        signed int s32AddAlpha; // r2
    }
}


// Range: 0x3EB070 -> 0x3EB1A4
void exeAddLine(class clsLink2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EB070 -> 0x3EB1A4
...
// Range: 0x3EB1B0 -> 0x3EB22C
void * __dt(class clsLink2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EB1B0 -> 0x3EB22C
    }
...
// Range: 0x3EB230 -> 0x3EB3F8
void * __ct(class clsLink2D_Task * this /* r18 */, signed int s32PlayerNo /* r19 */, signed int s32Link /* r17 */, signed int * ops32SrcLink /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EB230 -> 0x3EB3F8
        class clsScore2D_Task * pcScore2D; // r2
