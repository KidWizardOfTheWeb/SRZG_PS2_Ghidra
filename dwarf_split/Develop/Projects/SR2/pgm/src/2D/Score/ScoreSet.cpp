/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\ScoreSet.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class _NNS_TEXLIST * apsTextureList[2]; // size: 0x8, address: 0xB0B770
float of32GaugeMaskZ; // size: 0x4, address: 0x0
float of32GaugeZ; // size: 0x4, address: 0x66ADD8
class stcPoint2D_s16 oasUnionTextureSize[11]; // size: 0x2C, address: 0x66ADE0
static unsigned char chk__oasUnionTextureSize_SizeCheck_[1]; // size: 0x1, address: 0x0
class stcPoint2D_s16 oasStageTextureSize[2]; // size: 0x8, address: 0x0
static unsigned char chk__oasStageTextureSize_SizeCheck_[1]; // size: 0x1, address: 0x0
class stcMenu2D osDrawData; // size: 0x6, address: 0x66AE10
...
public:
    ...
    unsigned char u8WidthMargin; // offset 0x2, size 0x1
    unsigned char u8TitleWidthMargin; // offset 0x3, size 0x1
    unsigned char u8ItemHeight; // offset 0x4, size 0x1
};
...
// Range: 0x303390 -> 0x3038E0
void drawWindow(signed int s32x /* r2 */, signed int s32y /* r2 */, signed int s32w /* r2 */, signed int s32h /* r2 */, unsigned char u8Alpha /* r21 */, unsigned char bRing /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x303390 -> 0x3038E0
        ...
        signed int s32ww; // r2
        signed int s32hh; // r2
        unsigned int u32WidnowTex; // r23
        signed int s32CurnerWidth; // r2
        signed int s32CurnerHeight; // r2
        signed int s32Left; // r2
        signed int s32Top; // r2
        signed int s32Right; // r2
        signed int s32Bottom; // r2
    }
}


// Range: 0x3038E0 -> 0x305298
void drawMenu2D(signed int s32SelectItem /* r16 */, unsigned int u32Type /* r2 */, signed int s32SelectStart /* r2 */, signed int s32ItemStart /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3038E0 -> 0x305298
    }
...
// Range: 0x3052E0 -> 0x3052F4
void setStageTextureList(unsigned char * pu8BinBufAddr /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3052E0 -> 0x3052F4
    }
...
// Range: 0x305300 -> 0x305314
void setGameTextureList(unsigned char * pu8BinBufAddr /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x305300 -> 0x305314
    }
