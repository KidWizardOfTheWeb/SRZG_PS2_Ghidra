/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\ScoreAtentionAttack2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcAttentionData DrawData1v; // size: 0x1C, address: 0x693400
static class stcAttentionData DrawData2v; // size: 0x1C, address: 0x693420
static class stcAttentionData DrawData4v; // size: 0x1C, address: 0x693440
struct /* @anon0 */ {
    // total size: 0x10
} __vt__25clsScoreAttentionAttack2D; // size: 0x10, address: 0x6CD010
...
class NNS_VECTORFAST tosXVecFast; // size: 0x10, address: 0x693470
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x693460
...
// Range: 0x50DE80 -> 0x50E588
void drawAtentionAttack(class clsScoreAttentionAttack2D * this /* r21 */, unsigned int u32View /* r16 */, unsigned int u32PlayerNo /* r29+0x14C */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50DE80 -> 0x50E588
        ...
        class stcAttentionData * opsDrawData; // r2
        class NNS_VECTORFAST sDiffPosFast; // r29+0x170
        float f32Length; // r29+0x180
        float f32Dot; // r29+0x180
        float f32Cross; // r29+0x180
        float f32FovCrs; // r26
        float f32LengthSeed; // r25
        float f32DrawX; // r24
        float f32DrawY; // r20
        float f32Width; // r29+0x180
        float f32Height; // r23
        class clsPlayerTask * pcPlayer; // r2
        class stcUserStatus * psStatus; // r2
        class NNS_VECTORFAST sDirVecFast; // r29+0x160
        class NNS_VECTORFAST sDirCrossFast; // r29+0x150
        signed int s32n; // r29+0x130
        class clsPlayerTask * pcAttackPlayer; // r2
        unsigned char u8CharaID; // r29+0x120
        unsigned int ou32CharaColor; // r2
        float f32CircleScale; // r29+0x180
    }
}


// Range: 0x50E590 -> 0x50E614
void draw(class clsScoreAttentionAttack2D * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50E590 -> 0x50E614
        signed int s32i; // r17
...
// Range: 0x50E620 -> 0x50E6D8
void execute(class clsScoreAttentionAttack2D * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50E620 -> 0x50E6D8
    }
...
// Range: 0x50E6E0 -> 0x50E7FC
void init(class clsScoreAttentionAttack2D * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50E6E0 -> 0x50E7FC
        signed int s32n; // r10
        signed int s32Dir; // r9
        class stcUserStatus * psStatus; // r2
...
// Range: 0x50E800 -> 0x50E84C
void * __dt(class clsScoreAttentionAttack2D * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50E800 -> 0x50E84C
    }
...
// Range: 0x50E850 -> 0x50E88C
void * __ct(class clsScoreAttentionAttack2D * this /* r16 */, class clsScore2D_Task * pcParent /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50E850 -> 0x50E88C
    }
