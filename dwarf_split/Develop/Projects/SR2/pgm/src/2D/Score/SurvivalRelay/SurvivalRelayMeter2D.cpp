/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\SurvivalRelay\SurvivalRelayMeter2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x14
} __vt__23clsSurvivalRelayMeter2D; // size: 0x14, address: 0x6CF9F0
...
// Range: 0x54BD60 -> 0x54BDD4
void draw(class clsSurvivalRelayMeter2D * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54BD60 -> 0x54BDD4
        class clsSurvivalRelayRace_Task & rcSurvivalRelayRace_Task; // r16
        signed int s32i; // r18
    }
}


// Range: 0x54BDE0 -> 0x54BDF8
void executeMeter(class clsSurvivalRelayMeter2D * this /* r2 */, unsigned int u32View /* r2 */, unsigned int u32PlayerNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54BDE0 -> 0x54BDF8
    }
...
// Range: 0x54BE00 -> 0x54BE60
void * __dt(class clsSurvivalRelayMeter2D * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54BE00 -> 0x54BE60
    }
...
// Range: 0x54BE60 -> 0x54BE94
void * __ct(class clsSurvivalRelayMeter2D * this /* r16 */, class clsScore2D_Task * pcParent /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54BE60 -> 0x54BE94
    }
