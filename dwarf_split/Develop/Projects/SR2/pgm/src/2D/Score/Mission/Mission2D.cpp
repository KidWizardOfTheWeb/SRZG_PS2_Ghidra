/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\Mission\Mission2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcPoint2D_s16 oasUnionTextureSize; // size: 0x4, address: 0x67FC00
static class stcTexUV TexData2D[24]; // size: 0x180, address: 0x67FC10
static unsigned char chk__TexData2D_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcPoint2D_s16 oasUnionTextureSize; // size: 0x4, address: 0x67FD90
static class stcTexUV TexData2D[9]; // size: 0x90, address: 0x67FDA0
static unsigned char chk__TexData2D_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcPoint2D_s16 oasUnionTextureSize[2]; // size: 0x8, address: 0x0
static class stcTexUV TexData2D[25]; // size: 0x190, address: 0x0
static unsigned char chk__TexData2D_SizeCheck_[1]; // size: 0x1, address: 0x0
class _NNS_TEXLIST * psTexList_Mission2D; // size: 0x4, address: 0xB15EE0
class _NNS_TEXLIST * psTexList_MissionSta2D; // size: 0x4, address: 0xB15EE8
static class stcEnergyLineData osDrawData; // size: 0x38, address: 0x67FE30
class stcEnergyLine asEnergyLine; // size: 0x40, address: 0xB15EF0
static float tf32EnergyFrameMax; // size: 0x4, address: 0xB15F30
...
class stcEnergyLine {
    // total size: 0x40
public:
    signed int s32BaseX; // offset 0x0, size 0x4
    signed int s32BaseY; // offset 0x4, size 0x4
    signed int s32Dir; // offset 0x8, size 0x4
    float f32FrameMax; // offset 0xC, size 0x4
    class stcLinePoint asPoint[4]; // offset 0x10, size 0x30
};
class clsPathBase {
    // total size: 0x8
public:
...
class stcEnergyLineData {
    // total size: 0x38
public:
    signed short s16MoveMax; // offset 0x0, size 0x2
    float f32WaitFrame; // offset 0x4, size 0x4
    float f32TextY; // offset 0x8, size 0x4
    float f32LinkScale; // offset 0xC, size 0x4
    float f32NumScale; // offset 0x10, size 0x4
    float f32NumMaxScale; // offset 0x14, size 0x4
    signed short s16LineStartX; // offset 0x18, size 0x2
    signed short s16LineMiddleX; // offset 0x1A, size 0x2
    signed short s16LineEndX; // offset 0x1C, size 0x2
    signed short s16LineStartY; // offset 0x1E, size 0x2
    signed short s16LineEndY; // offset 0x20, size 0x2
    unsigned char u8ELineHeight; // offset 0x22, size 0x1
    float f32LinePointFrame; // offset 0x24, size 0x4
    float f32MarginFrame; // offset 0x28, size 0x4
    float f32HeadScale; // offset 0x2C, size 0x4
    float f32HeadAddFrame; // offset 0x30, size 0x4
    float f32HeadAddScale; // offset 0x34, size 0x4
};
class compressed_pair_imp {
    // total size: 0x8
public:
...
// Range: 0x399640 -> 0x3998DC
void drawDestruction(class clsMission2D_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x399640 -> 0x3998DC
        ...
        float f32X; // r21
        float f32Y; // r20
        float f32NowNumberX; // r22
    }
}


// Range: 0x3998E0 -> 0x399B7C
void drawAttack(class clsMission2D_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3998E0 -> 0x399B7C
        class stcTexUV * psTexSrc; // r2
...
// Range: 0x399B80 -> 0x39A064
void drawGauge(class clsMission2D_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x399B80 -> 0x39A064
        class stcTexUV * psTexSrc_Tex; // r2
        class stcTexUV * psTexSrc; // r22
        class stcPoint2D_s16 * psTextureSize; // r2
        signed int s32ClrGold; // r2
        float f32X; // r24
        float f32Y; // r23
        float f32BarW; // r20
        signed int s32RankNo; // r20
        float f32cW; // r22
        float f32BarBgX; // r29+0xA0
    }
}


// Range: 0x39A070 -> 0x39A1E0
void drawGDiveTime(class clsMission2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39A070 -> 0x39A1E0
        class stcTexUV * psTexSrc; // r2
...
// Range: 0x39A1E0 -> 0x39A368
void drawGDive(class clsMission2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39A1E0 -> 0x39A368
        class stcTexUV * psTexSrc; // r2
...
// Range: 0x39A370 -> 0x39A624
void drawMark(class clsMission2D_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39A370 -> 0x39A624
        class stcTexUV * psTexSrc_Tex; // r2
...
// Range: 0x39A630 -> 0x39AA24
void drawSkill(class clsMission2D_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39A630 -> 0x39AA24
...
// Range: 0x39AA30 -> 0x39AD50
void drawTrickPoint(class clsMission2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39AA30 -> 0x39AD50
        class stcTexUV * psTexSrc; // r2
...
// Range: 0x39AD50 -> 0x39AEB8
void drawPoint(class clsMission2D_Task * this /* r20 */, unsigned int u32DispType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39AD50 -> 0x39AEB8
        signed int s32DispMax; // r19
        signed int s32AddX; // r18
        signed int s32DrawX; // r2
        float f32X; // r29+0x70
    }
}
...
// Range: 0x39AEC0 -> 0x39B214
void drawPoint(class clsMission2D_Task * this /* r21 */, signed int s32MsgTexNo /* r20 */, unsigned int u32DispType /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39AEC0 -> 0x39B214
        class stcTexUV * psTexSrc_Tex; // r2
        class stcTexUV * psTexSrc; // r2
        class stcPoint2D_s16 * psTextureSize; // r2
        signed int s32DispMax; // r18
        signed int s32AddX; // r17
        signed int s32DrawX; // r2
        signed int s32DrawY; // r2
        float f32X; // r21
        float f32Y; // r20
...
// Range: 0x39B220 -> 0x39B420
void drawAddSec(class clsMission2D_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39B220 -> 0x39B420
        class stcTexUV * psTexSrc; // r2
...
// Range: 0x39B420 -> 0x39B624
void drawUpPoint(class clsMission2D_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39B420 -> 0x39B624
        class stcTexUV * psTexSrc; // r2
...
// Range: 0x39B630 -> 0x39B7E8
void drawMissionNum(class clsMission2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39B630 -> 0x39B7E8
        signed char s8Rank; // r4
    }
}


// Range: 0x39B7F0 -> 0x39BE64
void draw(class clsMission2D_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39B7F0 -> 0x39BE64
    }
...
// Range: 0x39BE70 -> 0x39C2E0
void execute(class clsMission2D_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39BE70 -> 0x39C2E0
        unsigned int u32AddFrame; // r2
    }
}


// Range: 0x39C2E0 -> 0x39C414
void mainMissionNum(class clsMission2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39C2E0 -> 0x39C414
...
// Range: 0x39C420 -> 0x39C4FC
signed int nowMissionNum(class clsMission2D_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39C420 -> 0x39C4FC
        class clsPlayerTask * pcPlayer; // r2
        class uMissionJudge32 uMissionJudge; // r29+0x1C
        class uMissionCount32 uMissionCount; // r29+0x18
        signed int s32Num; // r2
    }
}


// Range: 0x39C500 -> 0x39C5C0
void setAddNumAnime(class clsMission2D_Task * this /* r16 */, signed int s32Frame /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39C500 -> 0x39C5C0
        signed int s32Num; // r2
        signed int s32Add; // r2
        float f32Add; // r29+0x30
    }
}


// Range: 0x39C5C0 -> 0x39C6DC
void init(class clsMission2D_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39C5C0 -> 0x39C6DC
        class stcEnergyLine * opsPoint; // r2
        class stcEnergyLineData * psDrawData; // r2
    }
}


// Range: 0x39C6E0 -> 0x39C834
