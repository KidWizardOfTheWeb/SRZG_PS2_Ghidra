/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\SurvivalBattle\SurvivalBattleParts2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcPoint2D_s16 oasUnionTextureSize; // size: 0x4, address: 0x69A6B0
static class stcTexUV TexData2D[10]; // size: 0xA0, address: 0x69A6C0
...
// Range: 0x58A1B0 -> 0x58A324
void drawPt(class clsSurvivalBattleParts2D * this /* r2 */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58A1B0 -> 0x58A324
        ...
        float f32DrawY; // r29+0x60
        float (* psDrawMtx)[4][4]; // r18
        float f32HalfW; // r21
        float f32HalfH; // r20
    }
}
...
// Range: 0x58A330 -> 0x58A504
void drawRingWindow(class clsSurvivalBattleParts2D * this /* r21 */, signed int s32PlayerNo /* r2 */, signed int s32View /* r2 */, class stcUnionStatus * psUnionSt /* r23 */, signed int s32PosX /* r20 */, signed int s32PosY /* r19 */, signed int s32Dir /* r18 */, unsigned int ou32CharaColor /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58A330 -> 0x58A504
        class clsSurvivalBattleRace_Task & rcSurvivalBattleRace_Task; // r2
        float f32DrawBarWidth; // r20
        signed int s32Point; // r16
        signed int s32PointMax; // r22
    }
}
