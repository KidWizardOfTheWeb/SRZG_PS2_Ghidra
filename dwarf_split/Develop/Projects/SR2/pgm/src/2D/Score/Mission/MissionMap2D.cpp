/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\Mission\MissionMap2D.cpp
...
static class stcPoint2D_s16 oasUnionTextureSize[1]; // size: 0x4, address: 0x68FFE8
static class stcTexUV TexData2D[28]; // size: 0x1C0, address: 0x68FFF0
...
// Range: 0x4CDB90 -> 0x4CDDB8
void drawEtc(class clsMissionMap2D * this /* r21 */, float (* psClipMtx)[4][4] /* r23 */, unsigned char u8DrawAlpha /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4CDB90 -> 0x4CDDB8
        ...
        class uMissionCount32 uMissionCount; // r29+0xAC
        class stcPoint2D_s16 sRetPoint2D; // r29+0xA8
        unsigned int u32BrokenNum; // r2
        unsigned int u32Color; // r19
        float f32HalfWidth; // r29+0xB0
        float f32HalfHeight; // r20
    }
}
