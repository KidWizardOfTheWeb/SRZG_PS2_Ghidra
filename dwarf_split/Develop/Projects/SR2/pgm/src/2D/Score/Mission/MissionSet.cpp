/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\Mission\MissionSet.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcPoint2D_s16 oasUnionTextureSize; // size: 0x4, address: 0x68FAA8
static class stcTexUV TexData2D[24]; // size: 0x180, address: 0x68FAB0
static unsigned char chk__TexData2D_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcPoint2D_s16 oasUnionTextureSize; // size: 0x4, address: 0x68FC30
static class stcTexUV TexData2D[9]; // size: 0x90, address: 0x68FC40
static unsigned char chk__TexData2D_SizeCheck_[1]; // size: 0x1, address: 0x0
...
class stcTexUV MsgWndTexData[]; // size: 0x0, address: 0x69A310
class stcPoint2D_s16 MsgWndTextureSize; // size: 0x4, address: 0x69A300
...
// Range: 0x4C7AB0 -> 0x4C7BFC
void drawScoreBoxAttack(float f32PosX /* r23 */, float f32PosY /* r22 */, unsigned int u32Score /* r18 */, unsigned int u32Color /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C7AB0 -> 0x4C7BFC
...
// Range: 0x4C7C00 -> 0x4C7E8C
void drawScoreBoxSkill(float f32PosX /* r22 */, float f32PosY /* r29+0x70 */, unsigned int u32Score /* r20 */, unsigned int u32Color /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C7C00 -> 0x4C7E8C
...
// Range: 0x4C7E90 -> 0x4C8074
void drawScoreBoxBreak(float f32PosX /* r23 */, float f32PosY /* r22 */, unsigned int u32Score /* r18 */, unsigned int u32Color /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C7E90 -> 0x4C8074
        class stcTexUV * psTexSrc; // r2
...
// Range: 0x4C8080 -> 0x4C8204
void drawScoreBoxMark(float f32PosX /* r23 */, float f32PosY /* r22 */, unsigned int u32Score /* r21 */, unsigned int u32Color /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C8080 -> 0x4C8204
...
// Range: 0x4C8210 -> 0x4C8250
void drawScoreBoxGDive(float f32PosX /* r29 */, float f32PosY /* r29 */, unsigned int u32Score /* r2 */, unsigned int u32Color /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C8210 -> 0x4C8250
    }
...
// Range: 0x4C8250 -> 0x4C8384
void drawScoreBoxGRink(float f32PosX /* r29+0x50 */, float f32PosY /* r29+0x50 */, unsigned int u32Score /* r2 */, unsigned int u32Color /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C8250 -> 0x4C8384
        class stcTexUV * psTexSrc; // r17
        float f32X; // r29+0x50
        float f32Y; // r21
    }
}
...
// Range: 0x4C8390 -> 0x4C84C4
void drawScoreBoxAGP(float f32PosX /* r29+0x50 */, float f32PosY /* r29+0x50 */, unsigned int u32Score /* r2 */, unsigned int u32Color /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C8390 -> 0x4C84C4
        class stcTexUV * psTexSrc; // r17
...
// Range: 0x4C84D0 -> 0x4C8604
void drawScoreBoxTrick(float f32PosX /* r29+0x50 */, float f32PosY /* r29+0x50 */, unsigned int u32Score /* r2 */, unsigned int u32Color /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C84D0 -> 0x4C8604
        class stcTexUV * psTexSrc; // r17
...
// Range: 0x4C8610 -> 0x4C875C
void drawScoreBoxRing(float f32PosX /* r23 */, float f32PosY /* r22 */, unsigned int u32Score /* r18 */, unsigned int u32Color /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C8610 -> 0x4C875C
        class stcTexUV * psTexSrc; // r2
...
// Range: 0x4C8760 -> 0x4C8790
void drawScoreBoxTime(float f32PosX /* r29 */, float f32PosY /* r29 */, unsigned int u32Score /* r2 */, unsigned int u32Color /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C8760 -> 0x4C8790
    }
...
// Range: 0x4C8790 -> 0x4C8A60
void drawScoreBoxLevel(float f32PosX /* r23 */, float f32PosY /* r22 */, unsigned int u32Level /* r2 */, unsigned int u32Color /* r19 */, float f32Scale /* r21 */, float f32RotY /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C8790 -> 0x4C8A60
        class stcTexUV * psTexSrc; // r18
        float sTrsMtx[4][4]; // r29+0x70
        float f32W; // r29+0xB0
        float f32H; // r29+0xB0
        float f32cx; // r29+0xB0
        float f32cy; // r29+0xB0
        unsigned int u32LevelMsgNo[4]; // @ 0x0068FCE0
        unsigned int u32LevelPtNo[4]; // @ 0x0068FCF0
    }
}


// Range: 0x4C8A60 -> 0x4C8C84
void drawScoreBoxMsg(float f32PosX /* r21 */, float f32PosY /* r20 */, unsigned char u8MsgNo /* r21 */, unsigned int u32Color /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C8A60 -> 0x4C8C84
        ...
        float f32X; // r23
        float f32Y; // r29+0x80
        unsigned int u32ScoreMsgNo[2]; // @ 0x0068FCD8
    }
}


// Range: 0x4C8C90 -> 0x4C8DCC
void drawScoreBox(float f32PosX /* r29+0x30 */, float f32PosY /* r29+0x30 */, unsigned int u32Color /* r2 */, signed int s32BgNo /* r2 */, float f32ScaleH /* r29+0x30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C8C90 -> 0x4C8DCC
        unsigned int u32WindowTypeNo[2]; // @ 0x0068FCD0
    }
}


// Range: 0x4C8DD0 -> 0x4C8EE4
void drawWindow(float f32PosX /* r29+0x30 */, float f32PosY /* r29+0x30 */, float f32BoxW /* r29+0x30 */, float f32BoxH /* r29+0x30 */, signed int s32WindowType /* r2 */, unsigned int u32Color /* r2 */, float f32ScaleH /* r29+0x30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C8DD0 -> 0x4C8EE4
        class stcPoint2D_s16 * psTextureSize; // r2
...
// Range: 0x4C8EF0 -> 0x4C9364
void drawWindowDx(float f32PosX /* r29+0xC0 */, float f32PosY /* r29+0xC0 */, float f32BoxW /* r20 */, float f32BoxH /* r27 */, unsigned int u32Color /* r18 */, float f32ScaleH /* r26 */, class stcTexUV * psTexSrc_Tex /* r17 */, class stcPoint2D_s16 * psTextureSize /* r16 */, class _NNS_TEXLIST * psTexlist /* r2 */, unsigned int u32TexNo /* r2 */, unsigned int u32TexCurnerNo /* r20 */, unsigned int u32TexHeightNo /* r19 */, unsigned int u32TexWidthNo /* r22 */, signed int s32TexBgNo /* r29+0xC0 */, signed int s32TexBgOffsetX /* r29+0xC8 */, signed int s32TexBgOffsetY /* r29+0xD0 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C8EF0 -> 0x4C9364
        class stcTexUV * psTexSrc; // r2
        float f32W; // r29+0xC0
        float f32H; // r29+0xC0
        float f32BoxHalfW; // r25
        float f32BoxHalfH; // r31
        float f32cx; // r24
        float f32cy; // r21
        float f32X; // r30
        float f32Y; // r27
