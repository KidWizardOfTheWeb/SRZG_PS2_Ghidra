/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\GoaledRank2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x30
} __vt__20clsGoaledRank2D_Task; // size: 0x30, address: 0x6C1DF0
...
public:
    ...
    signed short m_s16DrawX; // offset 0x62, size 0x2
    signed short m_s16DrawY; // offset 0x64, size 0x2
    float m_f32Scale; // offset 0x68, size 0x4
    float m_f32StopFrame; // offset 0x6C, size 0x4
    float m_f32FadeFrame; // offset 0x70, size 0x4
};
...
// Range: 0x3E3DF0 -> 0x3E40D8
void draw(class clsGoaledRank2D_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E3DF0 -> 0x3E40D8
...
// Range: 0x3E40E0 -> 0x3E440C
void execute(class clsGoaledRank2D_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E40E0 -> 0x3E440C
...
// Range: 0x3E4410 -> 0x3E4470
void * __dt(class clsGoaledRank2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E4410 -> 0x3E4470
    }
...
// Range: 0x3E4470 -> 0x3E4610
void * __ct(class clsGoaledRank2D_Task * this /* r18 */, signed int s32View /* r17 */, signed int s32Rank /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E4470 -> 0x3E4610
        class clsScore2D_Task * pcScore2D; // r2
