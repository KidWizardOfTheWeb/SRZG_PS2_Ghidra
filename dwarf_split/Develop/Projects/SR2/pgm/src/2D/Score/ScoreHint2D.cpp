/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\ScoreHint2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcHint2D DrawData1v; // size: 0x6, address: 0x691DB8
static class stcHint2D DrawData2v; // size: 0x6, address: 0x691DC0
static class stcHint2D DrawData4v; // size: 0x6, address: 0x691DC8
struct /* @anon0 */ {
    // total size: 0x10
} __vt__14clsScoreHint2D; // size: 0x10, address: 0x6CA990
...
class stcHint2D {
    // total size: 0x6
public:
    signed short s16PosX; // offset 0x0, size 0x2
    signed short s16PosY; // offset 0x2, size 0x2
    signed short s16ButtonPosY; // offset 0x4, size 0x2
};
class clsSingleton {
    // total size: 0x4
};
...
// Range: 0x4E7740 -> 0x4E7BA8
void drawHint(class clsScoreHint2D * this /* r18 */, unsigned int u32View /* r17 */, unsigned int u32PlayerNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E7740 -> 0x4E7BA8
        signed int s32GameMode; // r2
        class clsPlayerTask * pcPlayer; // r16
        unsigned char bKicker; // r4
    }
}


// Range: 0x4E7BB0 -> 0x4E7C24
void draw(class clsScoreHint2D * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E7BB0 -> 0x4E7C24
        signed int s32i; // r17
...
// Range: 0x4E7C30 -> 0x4E7DB8
void _drawHintGearChange(class clsScoreHint2D * this /* r2 */, unsigned int u32UserNo /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E7C30 -> 0x4E7DB8
        class stcTexUV * psTexSrc_Tex; // r2
        class stcUserStatus * psStatus; // r2
        class stcPoint2D_s16 * psEtc02Size; // r2
        float f32Scale; // r21
        float f32DrawX; // r20
        float f32DrawY; // r23
    }
...
// Range: 0x4E7DC0 -> 0x4E80C8
void _drawHintCtrlR(class clsScoreHint2D * this /* r20 */, unsigned int u32UserNo /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E7DC0 -> 0x4E80C8
        class stcUserStatus * psStatus; // r2
        ...
        class stcPoint2D_s16 * psEtc02Size; // r2
        float f32Scale; // r20
        unsigned char u8AllowAlpha; // r19
        float f32DrawX; // r29
        float f32DrawY; // r28
    }
}
...
// Range: 0x4E80D0 -> 0x4E83D8
void _drawHintCtrlL(class clsScoreHint2D * this /* r20 */, unsigned int u32UserNo /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E80D0 -> 0x4E83D8
        class stcUserStatus * psStatus; // r2
...
// Range: 0x4E83E0 -> 0x4E8744
void _drawHintPipe(class clsScoreHint2D * this /* r20 */, unsigned int u32UserNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E83E0 -> 0x4E8744
        class stcUserStatus * psStatus; // r2
...
// Range: 0x4E8750 -> 0x4E89E0
void execute(class clsScoreHint2D * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E8750 -> 0x4E89E0
        signed int s32i; // r17
        class clsPlayerTask * pcPlayer; // r2
        class stcUserStatus * psStatus; // r16
        class _LineData * opsLine; // r2
        unsigned char bKicker; // r2
        unsigned char bHalfPipe; // r25
    }
}


// Range: 0x4E89E0 -> 0x4E8B3C
void init(class clsScoreHint2D * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E89E0 -> 0x4E8B3C
        signed int s32n; // r10
        class stcHint2D * opsDrawData; // r9
        signed int s32Dir; // r8
        class stcUserStatus * psStatus; // r2
...
// Range: 0x4E8B40 -> 0x4E8B8C
void * __dt(class clsScoreHint2D * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E8B40 -> 0x4E8B8C
    }
...
// Range: 0x4E8B90 -> 0x4E8C70
void * __ct(class clsScoreHint2D * this /* r16 */, class clsScore2D_Task * pcParent /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E8B90 -> 0x4E8C70
    }
