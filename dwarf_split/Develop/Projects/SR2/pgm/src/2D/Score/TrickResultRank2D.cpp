/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\TrickResultRank2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcTrikRankData DrawData1v; // size: 0x40, address: 0x683430
static class stcTrikRankData DrawData2v; // size: 0x40, address: 0x683470
static class stcTrikRankData DrawData4v; // size: 0x40, address: 0x6834B0
class stcTrikRankData * opsDrawData; // size: 0x4, address: 0xB16488
class stcEnergyPoint asEnergyPoint[4]; // size: 0x100, address: 0xB16490
static float tf32EnergyFrameMax; // size: 0x4, address: 0xB16590
struct /* @anon0 */ {
    // total size: 0x30
} __vt__25clsTrickResultRank2D_Task; // size: 0x30, address: 0x6C2040
...
class stcTrikRankData {
    // total size: 0x40
public:
    signed short s16MoveMax; // offset 0x0, size 0x2
    signed short s16PosYDiff; // offset 0x2, size 0x2
    signed int s32RotMax; // offset 0x4, size 0x4
    signed int s32ChengeRot; // offset 0x8, size 0x4
    float f32InWaitFrame; // offset 0xC, size 0x4
    float f32RotWaitFrame; // offset 0x10, size 0x4
    float f32OutWaitFrame; // offset 0x14, size 0x4
    float f32FontScale; // offset 0x18, size 0x4
    float f32RankScale; // offset 0x1C, size 0x4
    signed short s16LineStartX; // offset 0x20, size 0x2
    signed short s16LineMiddleX; // offset 0x22, size 0x2
    signed short s16LineEndX; // offset 0x24, size 0x2
    signed short s16LineStartY; // offset 0x26, size 0x2
    signed short s16LineEndY; // offset 0x28, size 0x2
    unsigned char u8ELineHeight; // offset 0x2A, size 0x1
    float f32LinePointFrame; // offset 0x2C, size 0x4
    float f32MarginFrame; // offset 0x30, size 0x4
    float f32HeadScale; // offset 0x34, size 0x4
    float f32HeadAddFrame; // offset 0x38, size 0x4
    float f32HeadAddScale; // offset 0x3C, size 0x4
};
...
public:
    ...
    signed int m_s32Rank; // offset 0x5C, size 0x4
    signed int m_s32OldRank; // offset 0x60, size 0x4
    class clsPlayerTask * m_pcPlayer; // offset 0x64, size 0x4
    class stcViewRect * m_opsRect; // offset 0x68, size 0x4
    unsigned char m_u8RankAlpha; // offset 0x6C, size 0x1
    signed short m_s16RankMove; // offset 0x6E, size 0x2
    unsigned char m_u8TextAlpha; // offset 0x70, size 0x1
    signed short m_s16TextMove; // offset 0x72, size 0x2
    unsigned int m_u32HideFlg; // offset 0x74, size 0x4
    float m_f32InWait; // offset 0x78, size 0x4
    float m_f32RotWait; // offset 0x7C, size 0x4
    float m_f32OutWait; // offset 0x80, size 0x4
    signed int m_s32Rot; // offset 0x84, size 0x4
    float m_sDrawMtx[4][4]; // offset 0x90, size 0x40
    unsigned char m_bChanged; // offset 0xD0, size 0x1
    float m_f32EnergyFrame; // offset 0xD4, size 0x4
    float m_f32EnergySubFrame; // offset 0xD8, size 0x4
    class clsEnergyFlow2D * m_pcBaseLine; // offset 0xDC, size 0x4
    class clsEnergyFlow2D * m_pcAddLine; // offset 0xE0, size 0x4
};
...
// Range: 0x3E7420 -> 0x3E7588
void draw(class clsTrickResultRank2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E7420 -> 0x3E7588
    }
...
// Range: 0x3E7590 -> 0x3E782C
void _drawRank(class clsTrickResultRank2D_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E7590 -> 0x3E782C
        ...
        float f32LvWidth; // r23
        float f32LvHeight; // r22
        float f32RankWidth; // r3
        float f32RankHeight; // r2
        signed int s32Dir; // r2
        float f32RankY; // r21
        float f32LvX; // r20
        unsigned char u8RankAlpha; // r6
        unsigned char u8LvAlpha; // r18
    }
}


// Range: 0x3E7830 -> 0x3E7FC8
void execute(class clsTrickResultRank2D_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E7830 -> 0x3E7FC8
        class clsScore2D_Task * pcScore2D; // r2
        float f32EnergyFrameMax; // r20
        class stcTrikRankData * psDrawData; // r2
...
// Range: 0x3E7FD0 -> 0x3E8104
void exeAddLine(class clsTrickResultRank2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E7FD0 -> 0x3E8104
        float f32EnergyFrameMax; // r3
...
// Range: 0x3E8110 -> 0x3E818C
void * __dt(class clsTrickResultRank2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E8110 -> 0x3E818C
    }
...
// Range: 0x3E8190 -> 0x3E83D0
void * __ct(class clsTrickResultRank2D_Task * this /* r20 */, unsigned int u32View /* r19 */, signed int s32StartRank /* r18 */, signed int s32EndRank /* r17 */, class clsPlayerTask * pcPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E8190 -> 0x3E83D0
        class clsScore2D_Task * pcScore2D; // r2
        unsigned int u32PlayerNo; // r2
        unsigned int u32TeamNo; // r3
        unsigned int u32HideFlg; // r4
    }
}


// Range: 0x3E83D0 -> 0x3E8688
void setupEnergyPoint() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E83D0 -> 0x3E8688
        class stcTrikRankData * opsDrawData'155; // r4
        class clsScore2D_Task * pcScore; // r19
        signed int s32RightX; // r18
        signed int s32CenterY; // r17
        signed int s32CenterDiff; // r5
        signed int s32WidthDiff; // r16
        class stcTrikRankData * psDrawData; // r2
        signed int s32HeightDiff; // r2
        signed int s32DrawX; // r25
        signed int s32DrawY; // r24
        signed int s32Dir; // r15
        signed int s32n; // r14
        signed int s32OutMargin; // r13
    }
}
