/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\Render2D.cpp
...
// Range: 0x301DF0 -> 0x301E40
void renderDirect(float of32LeftX /* r29+0x10 */, float of32TopY /* r29+0x10 */, float of32RightX /* r29+0x10 */, float of32BottomY /* r29+0x10 */, class stcTexUV * opsTexUV /* r8 */, unsigned int ou32Color /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x301DF0 -> 0x301E40
    }
...
// Range: 0x301E40 -> 0x301FB8
void renderDiffClipXY(float f32LeftX /* r29+0x20 */, float f32TopY /* r29+0x20 */, float f32RightX /* r29+0x20 */, float f32BottomY /* r29+0x20 */, class stcTexUV * opsTexUV /* r2 */, unsigned int ou32Color /* r2 */, float of32TexWidth /* r29+0x20 */, float of32TexHeight /* r29+0x20 */, float f32ClipLeftX /* r29+0x20 */, float f32ClipTopY /* r29+0x20 */, float f32ClipRightX /* r29+0x20 */, float f32ClipBottomY /* r29+0x28 */, float (* psMatrix)[4][4] /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x301E40 -> 0x301FB8
        class stcTexUV sTexUV; // r29+0x10
        float f32DrawX; // r8
        float f32DrawY; // r7
        float f32InTexX; // r6
        float f32InTexY; // r5
        float f32ScaleX; // r4
        float f32ScaleY; // r3
        float f32TexX; // r29+0x20
        float f32TexY; // r29+0x20
    }
}


// Range: 0x301FC0 -> 0x302064
void renderDiff(float of32LeftX /* r29+0x20 */, float of32TopY /* r29+0x20 */, float of32RightX /* r29+0x20 */, float of32BottomY /* r29+0x20 */, class stcTexUV * opsTexUV /* r2 */, unsigned int ou32Color /* r2 */, float of32TexWidth /* r29+0x20 */, float of32TexHeight /* r29+0x20 */, float (* psMatrix)[4][4] /* r2 */, float of32ZValue /* r29+0x20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x301FC0 -> 0x302064
        class stcTexUV sTexUV; // r29+0x10
