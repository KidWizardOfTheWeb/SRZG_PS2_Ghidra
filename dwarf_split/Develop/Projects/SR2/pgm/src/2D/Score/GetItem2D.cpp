/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\GetItem2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x30
} __vt__17clsGetItem2D_Task; // size: 0x30, address: 0x6C2070
...
public:
    ...
    signed int m_s32Item; // offset 0x5C, size 0x4
    unsigned char m_u8Alpha; // offset 0x60, size 0x1
    signed int m_s32Width; // offset 0x64, size 0x4
    signed int m_s32Height; // offset 0x68, size 0x4
    signed int m_s32CenterX; // offset 0x6C, size 0x4
    signed int m_s32CenterY; // offset 0x70, size 0x4
    signed int m_s32DrawX; // offset 0x74, size 0x4
    signed int m_s32DrawY; // offset 0x78, size 0x4
    float m_f32Scale; // offset 0x7C, size 0x4
    float m_f32DefScale; // offset 0x80, size 0x4
    float m_f32OutScale; // offset 0x84, size 0x4
    float m_f32StopFrame; // offset 0x88, size 0x4
    float m_f32FadeFrame; // offset 0x8C, size 0x4
};
class stcFactor {
    // total size: 0x1C
public:
...
// Range: 0x3E8690 -> 0x3E8890
void draw(class clsGetItem2D_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E8690 -> 0x3E8890
        class stcTexUV osTexSrc; // r29+0x70
...
// Range: 0x3E8890 -> 0x3E8ADC
void execute(class clsGetItem2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E8890 -> 0x3E8ADC
    }
...
// Range: 0x3E8AE0 -> 0x3E8B40
void * __dt(class clsGetItem2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E8AE0 -> 0x3E8B40
    }
...
// Range: 0x3E8B40 -> 0x3E8CDC
void * __ct(class clsGetItem2D_Task * this /* r18 */, signed int s32View /* r17 */, signed int s32Item /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E8B40 -> 0x3E8CDC
