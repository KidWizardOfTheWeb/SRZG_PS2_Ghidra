/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\Mission\MissionMssage2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcPoint2D_s16 oasUnionTextureSize; // size: 0x4, address: 0x699CD0
static class stcTexUV TexData2D[9]; // size: 0x90, address: 0x699CE0
static unsigned char chk__TexData2D_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcPoint2D_s16 oasUnionTextureSize[2]; // size: 0x8, address: 0x699D70
static class stcTexUV TexData2D[25]; // size: 0x190, address: 0x699D80
static unsigned char chk__TexData2D_SizeCheck_[1]; // size: 0x1, address: 0x0
static signed int scof32CompAnmWaitFrame; // size: 0x4, address: 0x699F10
static signed int scof32FailAnmWaitFrame; // size: 0x4, address: 0x699F18
static signed int scof32GoAnmWaitFrame; // size: 0x4, address: 0x699F20
...
// Range: 0x57C2C0 -> 0x57C5E4
void drawFastMission(class clsMissionMessage2D_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57C2C0 -> 0x57C5E4
        class stcPoint3d sPosMessage; // r29+0x90
        class stcPoint2D_s16 * psTextureSize; // r2
        signed int s32pww; // r2
        signed int s32phh; // r2
        class stcRect sDrawRect; // r29+0x80
    }
}


// Range: 0x57C5F0 -> 0x57D01C
void drawNowLoading(class clsMissionMessage2D_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57C5F0 -> 0x57D01C
        class stcPoint3d sPosMessage; // r29+0x100
        class stcPoint3d sPosEggMessage; // r29+0xF0
        signed int s32No; // r2
        signed int s32MisionNoEx; // r2
        signed int s32MessageFontNo; // r29+0xD0
        signed int s32EggMessageFontNo; // r29+0xC0
        ...
        signed int s32x; // r2
        signed int s32y; // r2
        class stcRect sDrawRect; // r29+0xE0
    }
}


// Range: 0x57D020 -> 0x57D7F8
void draw(class clsMissionMessage2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57D020 -> 0x57D7F8
    }
...
// Range: 0x57D800 -> 0x57DB30
void execute(class clsMissionMessage2D_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57D800 -> 0x57DB30
    }
...
// Range: 0x57DB30 -> 0x57DD6C
void mainFastMission(class clsMissionMessage2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57DB30 -> 0x57DD6C
    }
...
// Range: 0x57DD70 -> 0x57DF1C
void mainGo(class clsMissionMessage2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57DD70 -> 0x57DF1C
    }
...
// Range: 0x57DF20 -> 0x57E0C8
void mainFailedTimeUp(class clsMissionMessage2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57DF20 -> 0x57E0C8
    }
...
// Range: 0x57E0D0 -> 0x57E264
void mainComplete(class clsMissionMessage2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57E0D0 -> 0x57E264
    }
...
// Range: 0x57E270 -> 0x57E388
void init(class clsMissionMessage2D_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57E270 -> 0x57E388
    }
