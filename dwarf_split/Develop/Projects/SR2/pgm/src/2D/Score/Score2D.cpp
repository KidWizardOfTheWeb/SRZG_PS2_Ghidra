/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\Score2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcDrawParam oasStageParam1v[17]; // size: 0x1DC, address: 0x0
static unsigned char chk__oasStageParam1v_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcDrawParam oasStageParam2v[17]; // size: 0x1DC, address: 0x0
static unsigned char chk__oasStageParam2v_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcDrawParam oasStageParam4v[17]; // size: 0x1DC, address: 0x0
static unsigned char chk__oasStageParam4v_SizeCheck_[1]; // size: 0x1, address: 0x0
float DrawRecordTime; // size: 0x4, address: 0x6819C0
class NNS_VECTOR m_tsStartPosVec; // size: 0xC, address: 0xB16360
class NNS_VECTOR m_tsStartRotVec; // size: 0xC, address: 0xB16370
struct /* @anon1 */ {
    // total size: 0x3C
} __vt__15clsScore2D_Task; // size: 0x3C, address: 0x6C1850
...
class stcTexUV TexData2D[]; // size: 0x0, address: 0x6956E0
...
class stcTexUV TexData2D[]; // size: 0x0, address: 0x694A80
...
struct /* @anon2 */ {
    // total size: 0x10
} __vt__22clsSurvivalBattleCom2D; // size: 0x10, address: 0x6D15B0
struct /* @anon7 */ {
    // total size: 0x20
} __vt__22clsSurvivalBattleMap2D; // size: 0x20, address: 0x6D0550
struct /* @anon0 */ {
    // total size: 0x20
} __vt__24clsSurvivalBattleParts2D; // size: 0x20, address: 0x6D15C0
struct /* @anon6 */ {
    // total size: 0x20
} __vt__22clsSurvivalBallParts2D; // size: 0x20, address: 0x6C9890
struct /* @anon4 */ {
    // total size: 0x20
} __vt__15clsMissionMap2D; // size: 0x20, address: 0x6C96B0
struct /* @anon3 */ {
    // total size: 0x20
} __vt__17clsMissionParts2D; // size: 0x20, address: 0x6C9870
struct /* @anon8 */ {
    // total size: 0x2C
...
class stcMeterData {
    // total size: 0x34
public:
    unsigned char u8GaugeHeight; // offset 0x0, size 0x1
    unsigned char u8LineHeight; // offset 0x1, size 0x1
    signed char s8SpeedX; // offset 0x2, size 0x1
    signed char s8SpeedY; // offset 0x3, size 0x1
    signed char s8MaxUpInfoX; // offset 0x4, size 0x1
    signed char s8MaxUpInfoY; // offset 0x5, size 0x1
    signed char s8MaxUpInfoW; // offset 0x6, size 0x1
    float f32CircleX; // offset 0x8, size 0x4
    float f32CircleY; // offset 0xC, size 0x4
    float f32NumDefScale; // offset 0x10, size 0x4
    float f32NumMaxScale; // offset 0x14, size 0x4
    unsigned char u8NumW; // offset 0x18, size 0x1
    unsigned char u8NumH; // offset 0x19, size 0x1
    float f32NumMarignScale; // offset 0x1C, size 0x4
    signed short s16CircleSize; // offset 0x20, size 0x2
    signed short s16LightSize; // offset 0x22, size 0x2
    signed short s16TexAnmCnt; // offset 0x24, size 0x2
    signed short s16TexAnmMax; // offset 0x26, size 0x2
    unsigned char u8TexMinAlpha; // offset 0x28, size 0x1
    unsigned char u8TexMaxAlpha; // offset 0x29, size 0x1
    float f32EfDefScale; // offset 0x2C, size 0x4
    float f32EfMaxScale; // offset 0x30, size 0x4
};
...
class stcUnionStatus {
    // total size: 0x30
public:
    unsigned int u32Mode; // offset 0x0, size 0x4
    unsigned int u32Flg; // offset 0x4, size 0x4
    float f32WaitFrame; // offset 0x8, size 0x4
    signed short s16Right; // offset 0xC, size 0x2
    signed short s16Bottom; // offset 0xE, size 0x2
    signed int s32WidthDiff; // offset 0x10, size 0x4
    signed int s32HeightDiff; // offset 0x14, size 0x4
    signed int s32Open; // offset 0x18, size 0x4
    unsigned char u8Alpha; // offset 0x1C, size 0x1
    float f32RankScaleSpeed; // offset 0x20, size 0x4
    float f32RankDefScale; // offset 0x24, size 0x4
    float f32RankSmallScale; // offset 0x28, size 0x4
    float f32RankLargeScale; // offset 0x2C, size 0x4
};
class hkArray {
    // total size: 0xC
public:
...
public:
    unsigned int u32Mode; // offset 0x0, size 0x4
    float f32WaitFrame; // offset 0x4, size 0x4
    unsigned int u32Flg; // offset 0x8, size 0x4
    signed int s32LeftX; // offset 0xC, size 0x4
    signed int s32BottomY; // offset 0x10, size 0x4
    signed int s32WidthDiff; // offset 0x14, size 0x4
    signed int s32HeightDiff; // offset 0x18, size 0x4
    float f32GaugeDefWidth; // offset 0x1C, size 0x4
    unsigned char FrameTexNo; // offset 0x20, size 0x1
    unsigned char FrameBackTexNo; // offset 0x21, size 0x1
    unsigned char MiniCircleTexNo; // offset 0x22, size 0x1
    unsigned char BarLineTexNo; // offset 0x23, size 0x1
    unsigned char BarGaugeTexNo; // offset 0x24, size 0x1
    unsigned char BarBackTexNo; // offset 0x25, size 0x1
    unsigned char BarCapTexNo; // offset 0x26, size 0x1
    unsigned char BarLightTexNo; // offset 0x27, size 0x1
    unsigned char SpeedNumTexNo; // offset 0x28, size 0x1
};
class GskFlags {
    // total size: 0x4
public:
...
public:
    ...
    unsigned int u32Flg; // offset 0x8, size 0x4
    signed int s32LeftX; // offset 0xC, size 0x4
    signed int s32TopY; // offset 0x10, size 0x4
    signed int s32WidthDiff; // offset 0x14, size 0x4
    signed int s32HeightDiff; // offset 0x18, size 0x4
    float f32BackGroundWidth; // offset 0x1C, size 0x4
    float f32EnergyFrameMax; // offset 0x20, size 0x4
    signed int s32RingRot; // offset 0x24, size 0x4
    float sRingMtx[4][4]; // offset 0x30, size 0x40
    unsigned char FrameTexNo; // offset 0x70, size 0x1
    unsigned char FrameLineTexNo; // offset 0x71, size 0x1
    unsigned char NumBackTexNo; // offset 0x72, size 0x1
    unsigned char RingTexNo; // offset 0x73, size 0x1
    unsigned char PipeTexNo; // offset 0x74, size 0x1
    unsigned char SelectEffectTexNo; // offset 0x75, size 0x1
    unsigned char FrameCapTexNo; // offset 0x76, size 0x1
    unsigned char SelectLineTexNo; // offset 0x77, size 0x1
    unsigned char FrameCapLightTexNo; // offset 0x78, size 0x1
};
...
class stcPartsData {
    // total size: 0x68
public:
    unsigned char u8Height; // offset 0x0, size 0x1
    unsigned char u8BarHeight; // offset 0x1, size 0x1
    unsigned char u8LineHeight; // offset 0x2, size 0x1
    signed char s8MaxUpInfoX; // offset 0x3, size 0x1
    signed char s8MaxUpInfoY; // offset 0x4, size 0x1
    signed char s8MaxUpInfoW; // offset 0x5, size 0x1
    float f32CircleX; // offset 0x8, size 0x4
    float f32CircleY; // offset 0xC, size 0x4
    unsigned char u8CurNumW; // offset 0x10, size 0x1
    unsigned char u8CurNumH; // offset 0x11, size 0x1
    unsigned char u8MaxNumW; // offset 0x12, size 0x1
    unsigned char u8MaxNumH; // offset 0x13, size 0x1
    unsigned char u8PartsX; // offset 0x14, size 0x1
    unsigned char u8PartsY; // offset 0x15, size 0x1
    unsigned char u8PartsDist; // offset 0x16, size 0x1
    float f32Scale; // offset 0x18, size 0x4
    float f32CurScale; // offset 0x1C, size 0x4
    signed short s16NameW; // offset 0x20, size 0x2
    signed short s16NameH; // offset 0x22, size 0x2
    signed short s16NameDiffY; // offset 0x24, size 0x2
    signed short s16ButtonX; // offset 0x26, size 0x2
    signed short s16ButtonSize; // offset 0x28, size 0x2
    float f32NumMarginScale; // offset 0x2C, size 0x4
    float f32SelectLineAreaFrame; // offset 0x30, size 0x4
    float f32SelectLineDistFrame; // offset 0x34, size 0x4
    float f32SelectLineHeight; // offset 0x38, size 0x4
    float f32ActEffectStartScale; // offset 0x3C, size 0x4
    float f32ActEffectAddWidthScale; // offset 0x40, size 0x4
    float f32ActEffectChengeScale; // offset 0x44, size 0x4
    float f32ActEffectAfterScale; // offset 0x48, size 0x4
    unsigned char u8LineStartX; // offset 0x4C, size 0x1
    unsigned char u8LineMiddleX; // offset 0x4D, size 0x1
    unsigned char u8LineEndX; // offset 0x4E, size 0x1
    signed char s8LineStartY; // offset 0x4F, size 0x1
    signed char s8LineEndY; // offset 0x50, size 0x1
    unsigned char u8ELineHeight; // offset 0x51, size 0x1
    float f32LinePointFrame; // offset 0x54, size 0x4
    float f32MarginFrame; // offset 0x58, size 0x4
    float f32HeadScale; // offset 0x5C, size 0x4
    float f32HeadAddFrame; // offset 0x60, size 0x4
    float f32HeadAddScale; // offset 0x64, size 0x4
};
enum enmRet {
    RET___UN_USE = 0,
    RET___INIT = 1,
...
class stcUserStatus {
    // total size: 0xC
public:
    signed int s32OldRank; // offset 0x0, size 0x4
    signed int s32LastRank; // offset 0x4, size 0x4
...
public:
    unsigned int u32Mode; // offset 0x0, size 0x4
    float f32WaitFrame; // offset 0x4, size 0x4
    signed short s16CenterX; // offset 0x8, size 0x2
    signed short s16TopY; // offset 0xA, size 0x2
    signed char s8LineY; // offset 0xC, size 0x1
    signed char s8LineYEnd; // offset 0xD, size 0x1
    signed char s8LineW; // offset 0xE, size 0x1
    unsigned char u8Open; // offset 0xF, size 0x1
    unsigned char u8OpenEnd; // offset 0x10, size 0x1
    unsigned char u8LocalAlpha; // offset 0x11, size 0x1
};
enum enmInfo {
    TYPE_NULL = 0,
    TYPE_GROUND = 1,
...
class stcRecordData {
    // total size: 0x2C
public:
    unsigned char u8NumWidth; // offset 0x0, size 0x1
    unsigned char u8TextWidth; // offset 0x1, size 0x1
    unsigned char u8MarkWidth; // offset 0x2, size 0x1
    unsigned char u8Height; // offset 0x3, size 0x1
    signed short s16SlideMax; // offset 0x4, size 0x2
    float f32MarginScale; // offset 0x8, size 0x4
    unsigned char u8LineStartX; // offset 0xC, size 0x1
    unsigned char u8LineMiddleX; // offset 0xD, size 0x1
    unsigned char u8LineEndX; // offset 0xE, size 0x1
    signed short s16LineStartY; // offset 0x10, size 0x2
    signed short s16LineEndY; // offset 0x12, size 0x2
    unsigned char u8ELineHeight; // offset 0x14, size 0x1
    float f32LinePointFrame; // offset 0x18, size 0x4
    float f32MarginFrame; // offset 0x1C, size 0x4
    float f32HeadScale; // offset 0x20, size 0x4
    float f32HeadAddFrame; // offset 0x24, size 0x4
    float f32HeadAddScale; // offset 0x28, size 0x4
};
...
class stcInfoData {
    // total size: 0x30
public:
    signed short s16RankPosX; // offset 0x0, size 0x2
    signed short s16RankPosY; // offset 0x2, size 0x2
    signed short s16LapPosX; // offset 0x4, size 0x2
    signed short s16LapPosY; // offset 0x6, size 0x2
    signed short s16BackOpenMax; // offset 0x8, size 0x2
    signed short s16BackOpenMaxWide; // offset 0xA, size 0x2
    signed short s16BackOpenAddWide; // offset 0xC, size 0x2
    signed short s16BackHeight; // offset 0xE, size 0x2
    signed short s16BackLineHeight; // offset 0x10, size 0x2
    unsigned char u8LapTextW; // offset 0x12, size 0x1
    unsigned char u8LapCurW; // offset 0x13, size 0x1
    unsigned char u8LapCurH; // offset 0x14, size 0x1
    unsigned char u8LapMaxW; // offset 0x15, size 0x1
    unsigned char u8LapMaxH; // offset 0x16, size 0x1
    signed char s8LapMargin; // offset 0x17, size 0x1
    unsigned char u8LineOut; // offset 0x18, size 0x1
    unsigned char u8LineHeight; // offset 0x19, size 0x1
    float f32LinePointFrame; // offset 0x1C, size 0x4
    float f32MarginFrame; // offset 0x20, size 0x4
    float f32HeadScale; // offset 0x24, size 0x4
    float f32HeadAddFrame; // offset 0x28, size 0x4
    float f32HeadAddScale; // offset 0x2C, size 0x4
};
...
class clsScoreMeter2D {
    // total size: 0x10C
public:
    class clsScore2D_Task * m_pcParent; // offset 0x0, size 0x4
    unsigned char m_bDraw; // offset 0x4, size 0x1
    class stcUnionStatus m_sUnionStatus; // offset 0x8, size 0x2C
    class stcMeterData * m_opsDrawData; // offset 0x34, size 0x4
    class stcUserStatus m_asUserStatus[4]; // offset 0x38, size 0xD0
};
class hkInplaceArray : public hkArray {
    // total size: 0x10
public:
...
class stcTempParam {
    // total size: 0x10
public:
    unsigned int u32Used; // offset 0x0, size 0x4
    float f32Frame; // offset 0x4, size 0x4
    float f32Height; // offset 0x8, size 0x4
    float f32Point; // offset 0xC, size 0x4
};
...
public:
    class clsScore2D_Task * m_pcParent; // offset 0x0, size 0x4
    unsigned char m_bDraw; // offset 0x4, size 0x1
    class stcPartsData * m_opsDrawData; // offset 0x8, size 0x4
    class stcUnionStatus m_sUnionStatus; // offset 0x10, size 0x80
    class stcUserStatus m_asUserStatus[4]; // offset 0x90, size 0x2C0
};
...
class clsScoreInfo2D {
    // total size: 0x70
public:
    class stcInfoData * m_opsDrawData; // offset 0x0, size 0x4
    unsigned char m_bDraw; // offset 0x4, size 0x1
    class clsScore2D_Task * m_pcParent; // offset 0x8, size 0x4
    class stcUnionStatus m_sUnionStatus; // offset 0xC, size 0x30
    class stcUserStatus m_asUserStatus[4]; // offset 0x3C, size 0x30
};
class hkArray {
    // total size: 0xC
public:
...
class stcTimerData {
    // total size: 0x14
public:
    signed short s16OpenEnd; // offset 0x0, size 0x2
    signed short s16LinePosY; // offset 0x2, size 0x2
    signed char s8NumPosYDiff; // offset 0x4, size 0x1
    signed char s8ClosedW; // offset 0x5, size 0x1
    signed char s8LineHeight; // offset 0x6, size 0x1
    unsigned char u8NumW; // offset 0x7, size 0x1
    unsigned char u8NumH; // offset 0x8, size 0x1
    float f32MarginScale; // offset 0xC, size 0x4
    unsigned char u8SingleW; // offset 0x10, size 0x1
    unsigned char u8DoubleW; // offset 0x11, size 0x1
};
class stcScriptInfo {
    // total size: 0x5
public:
...
public:
    ...
    signed short s16PosX; // offset 0x4, size 0x2
    signed short s16PosY; // offset 0x6, size 0x2
};
class PXS_TEXREG {
    // total size: 0x20
public:
...
class clsScoreMap2D {
    // total size: 0x80
public:
    signed short m_s16BackX; // offset 0x4, size 0x2
    signed short m_s16BackY; // offset 0x6, size 0x2
    class clsScore2D_Task * m_pcParent; // offset 0x8, size 0x4
    unsigned char m_bDraw; // offset 0xC, size 0x1
    unsigned char m_u8IconAlpha; // offset 0xD, size 0x1
    signed short m_s16IconXDiff; // offset 0xE, size 0x2
    signed short m_s16IconYDiff; // offset 0x10, size 0x2
    float m_f32AttackScale; // offset 0x14, size 0x4
    float m_f32UserScale; // offset 0x18, size 0x4
    signed int m_as32DamageRot[8]; // offset 0x1C, size 0x20
    float m_sMtx[4][4]; // offset 0x40, size 0x40
};
...
class clsScoreTimer2D {
    // total size: 0x24
public:
    class stcUnionStatus m_sUnionStatus; // offset 0x0, size 0x14
    unsigned char m_bDraw; // offset 0x14, size 0x1
    unsigned char m_bLine; // offset 0x15, size 0x1
    class clsScore2D_Task * m_pcParent; // offset 0x18, size 0x4
    class stcTimerData * m_opsDrawData; // offset 0x1C, size 0x4
};
...
public:
    unsigned int u32Flg; // offset 0x0, size 0x4
    signed int s32Rot; // offset 0x4, size 0x4
    unsigned char u8AddAlpha; // offset 0x8, size 0x1
    unsigned char u8LightAlpha; // offset 0x9, size 0x1
    unsigned char u8EffectAlpha; // offset 0xA, size 0x1
    signed int s32TexAnmCnt; // offset 0xC, size 0x4
    float f32EffectScale; // offset 0x10, size 0x4
    float f32NumScale; // offset 0x14, size 0x4
    float f32LastMaxAgp; // offset 0x18, size 0x4
    float f32DrawMaxAgp; // offset 0x1C, size 0x4
    float f32InfoPoint; // offset 0x20, size 0x4
    class stcTempParam sTempParam; // offset 0x24, size 0x10
};
...
class stcActEffectParam {
    // total size: 0x18
public:
    unsigned int u32Mode; // offset 0x0, size 0x4
    float f32Frame; // offset 0x4, size 0x4
    float f32ScaleX; // offset 0x8, size 0x4
    float f32ScaleY; // offset 0xC, size 0x4
    signed int s32DrawX; // offset 0x10, size 0x4
    signed int s32DrawY; // offset 0x14, size 0x4
};
...
public:
    class clsScore2D_Task * m_pcParent; // offset 0x0, size 0x4
    class stcRecordData * m_opsDrawData; // offset 0x4, size 0x4
    unsigned char m_bDraw; // offset 0x8, size 0x1
    class stcUnionStatus m_sUnionStatus; // offset 0xC, size 0x20
    class stcUserStatus m_asUserStatus[4]; // offset 0x2C, size 0x150
};
class allocator {
    // total size: 0x1
};
...
public:
    ...
    unsigned char m_bHideFlg; // offset 0x8, size 0x1
    unsigned char m_u8Alpha; // offset 0x9, size 0x1
    signed short m_s16ButtonY; // offset 0xA, size 0x2
    float m_f32CtrlScale; // offset 0xC, size 0x4
    float m_f32ButtonScale; // offset 0x10, size 0x4
    class stcUserStatus m_asUserStatus[4]; // offset 0x14, size 0x40
};
class stcNegaZ {
    // total size: 0x8
public:
...
public:
    class clsScore2D_Task * m_pcParent; // offset 0x4, size 0x4
    unsigned char m_u8Flg; // offset 0x8, size 0x1
    unsigned char m_u8Mode; // offset 0x9, size 0x1
    unsigned char m_u8Alpha; // offset 0xA, size 0x1
    float m_f32AttackScale; // offset 0xC, size 0x4
    float m_f32WaitFrame; // offset 0x10, size 0x4
    float m_f32SeDelayFrame; // offset 0x14, size 0x4
    class stcAttentionData * m_opsDrawData; // offset 0x18, size 0x4
    class stcUserStatus m_asUserStatus[4]; // offset 0x1C, size 0x20
};
...
class stcAttentionData {
    // total size: 0x1C
public:
    signed short s16OffsetX; // offset 0x0, size 0x2
    signed short s16OffsetY; // offset 0x2, size 0x2
    signed short s16AreaWidth; // offset 0x4, size 0x2
    float f32Scale; // offset 0x8, size 0x4
    float f32DefCirScale; // offset 0xC, size 0x4
    float f32AddCirScale; // offset 0x10, size 0x4
    float f32InLength; // offset 0x14, size 0x4
    float f32OutLength; // offset 0x18, size 0x4
};
class hkEnum {
    // total size: 0x1
public:
...
public:
    unsigned int u32Mode; // offset 0x0, size 0x4
    unsigned int u32Flg; // offset 0x4, size 0x4
    signed int s32LeftX; // offset 0x8, size 0x4
    signed int s32BottomY; // offset 0xC, size 0x4
    signed int s32MoveMax; // offset 0x10, size 0x4
    float f32EnergyFrameMax; // offset 0x14, size 0x4
    signed int s32WidthDiff; // offset 0x18, size 0x4
    signed int s32HeightDiff; // offset 0x1C, size 0x4
};
...
public:
    unsigned int u32Flg; // offset 0x0, size 0x4
    unsigned char u8SelectAlpha; // offset 0x4, size 0x1
    unsigned char u8NameAlpha; // offset 0x5, size 0x1
    signed int s32LastMaxRing; // offset 0x8, size 0x4
    float f32DrawWidth; // offset 0xC, size 0x4
    float f32InfoPoint; // offset 0x10, size 0x4
    class stcTempParam sTempParam; // offset 0x14, size 0x10
    class stcActEffectParam asEffectParam[3]; // offset 0x24, size 0x48
    float f32EnergyFrame; // offset 0x6C, size 0x4
    float f32EnergySubFrame; // offset 0x70, size 0x4
    float f32SelectFrame; // offset 0x74, size 0x4
    class clsEnergyFlow2D * pcBaseLine; // offset 0x78, size 0x4
    class clsEnergyFlow2D * pcAddLine; // offset 0x7C, size 0x4
    class stcLinePoint asPoint[4]; // offset 0x80, size 0x30
};
class sceGsMiptbp1 {
    // total size: 0x8
public:
...
public:
    ...
    class NNS_VECTOR Rot; // offset 0x4, size 0xC
    class NNS_VECTOR Pos; // offset 0x10, size 0xC
};
class hkBool {
    // total size: 0x1
public:
...
public:
    ...
    signed short s16PosY; // offset 0x6, size 0x2
    float f32DiveFrame; // offset 0x8, size 0x4
    float f32CtrlFrame; // offset 0xC, size 0x4
};
class generic_iterator {
    // total size: 0x4
public:
...
public:
    ...
    unsigned int u32Flg; // offset 0x4, size 0x4
    float f32WaitFrame; // offset 0x8, size 0x4
    unsigned char u8Alpha; // offset 0xC, size 0x1
    signed short s16MoveX; // offset 0xE, size 0x2
    unsigned char u8TimeAlpha; // offset 0x10, size 0x1
    signed short s16TimeMoveX; // offset 0x12, size 0x2
    float f32EnergyFrame; // offset 0x14, size 0x4
    float f32EnergySubFrame; // offset 0x18, size 0x4
    class clsEnergyFlow2D * pcBaseLine; // offset 0x1C, size 0x4
    class clsEnergyFlow2D * pcAddLine; // offset 0x20, size 0x4
    class stcLinePoint asPoint[4]; // offset 0x24, size 0x30
};

// Range: 0x3C0A80 -> 0x3C0CC0
void drawReverseMark(class clsScore2D_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C0A80 -> 0x3C0CC0
        class stcPoint2D_s16 * psTextureRankLogoSize; // r2
        class stcTexUV * psTexSrc; // r30
        unsigned char bDraw; // r23
        unsigned char u8DrawAlpha; // r2
        signed int s32i; // r20
        class clsPlayerTask * pcPlayer; // r2
        unsigned char u8Alpha; // r2
        signed int s32CenterX; // r2
        signed int s32CenterBottom; // r2
    }
}


// Range: 0x3C0CC0 -> 0x3C1848
void draw(class clsScore2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C0CC0 -> 0x3C1848
        class stcDraw2D * psDebugDraw2D; // r2
        signed int s32n; // r18
        signed int s32CenterX; // r2
        signed int s32CenterY; // r2
        class NNS_PRIM2D_P tasLines[4]; // r29+0xA0
        signed int s32y; // r17
        class NNS_RGBA osLineColor; // @ 0x006819F0
    }
}


// Range: 0x3C1860 -> 0x3C1B20
static void drawEseNowLoading() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C1860 -> 0x3C1B20
        unsigned short tu16Alpha'124; // r4
        class stcDraw2D * psDebugDraw2D; // r2
        unsigned char u8Alpha; // r2
        float f32DrawX; // r21
        float f32DrawY; // r20
        signed int s32TextRight; // r2
        signed int s32TextBottom; // r2
        class stcTexUV tsTextUv; // @ 0x006819E0
        unsigned char bStartConfig; // @ 0x00B16388
        unsigned short tu16Alpha; // @ 0x00B16380
    }
}


// Range: 0x3C1B20 -> 0x3C1D6C
static void drawEseLoadingCircle(class stcEseLoadingCircle * psCircle /* r19 */, unsigned int u32Color /* r18 */, float f32x /* r22 */, float f32y /* r21 */, float f32z /* r20 */, signed int s32Size /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C1B20 -> 0x3C1D6C
        float sRotMtx[4][4]; // r29+0x60
        class stcTexUV tsCircleUv; // @ 0x006819D0
    }
}


// Range: 0x3C1D70 -> 0x3C1FB8
void execute(class clsScore2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C1D70 -> 0x3C1FB8
        signed int s32n; // r3
...
// Range: 0x3C1FC0 -> 0x3C1FDC
void setStartRot(float f32x /* r29 */, float f32y /* r29 */, float f32z /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C1FC0 -> 0x3C1FDC
    }
...
// Range: 0x3C1FE0 -> 0x3C1FFC
void setStartPos(float f32x /* r29 */, float f32y /* r29 */, float f32z /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C1FE0 -> 0x3C1FFC
    }
...
// Range: 0x3C2000 -> 0x3C202C
void setRecordTime(class clsScore2D_Task * this /* r2 */, signed int s32View /* r2 */, float f32Time /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C2000 -> 0x3C202C
    }
...
// Range: 0x3C2030 -> 0x3C21C8
void * __dt(class clsScore2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C2030 -> 0x3C21C8
    }
...
// Range: 0x3C21D0 -> 0x3C2AFC
void * __ct(class clsScore2D_Task * this /* r16 */, signed int s32ViewNum /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C21D0 -> 0x3C2AFC
        signed int s32n; // r5
...
// Range: 0x3C2B00 -> 0x3C2B08
void @84@__dt__15clsScore2D_TaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C2B00 -> 0x3C2B08
    }
