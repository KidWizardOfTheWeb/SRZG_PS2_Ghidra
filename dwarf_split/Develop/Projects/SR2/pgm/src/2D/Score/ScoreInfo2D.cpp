/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\ScoreInfo2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcInfoData DrawData1v; // size: 0x30, address: 0x681BF0
static class stcInfoData DrawData2v; // size: 0x30, address: 0x681C20
static class stcInfoData DrawData4v; // size: 0x30, address: 0x681C50
struct /* @anon0 */ {
    // total size: 0x14
} __vt__14clsScoreInfo2D; // size: 0x14, address: 0x6C1890
...
// Range: 0x3C2B10 -> 0x3C2DA0
void drawInfo(class clsScoreInfo2D * this /* r21 */, unsigned int u32View /* r2 */, unsigned int u32PlayerNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C2B10 -> 0x3C2DA0
        class stcUnionStatus * psUnionSt; // r2
        unsigned char bRank; // r2
        signed int s32DrawX; // r20
        signed int s32DrawY; // r19
        signed int s32Dir; // r18
        class clsPlayerTask * pcPlayer; // r2
        class stcUserStatus * psUserSt; // r2
        signed int s32Lap; // r23
    }
}


// Range: 0x3C2DA0 -> 0x3C2DFC
void draw(class clsScoreInfo2D * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C2DA0 -> 0x3C2DFC
        signed int s32i; // r16
...
// Range: 0x3C2E00 -> 0x3C3564
void _drawLap(class clsScoreInfo2D * this /* r2 */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r2 */, signed int s32Lap /* r21 */, signed int s32MaxLap /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C2E00 -> 0x3C3564
        class stcInfoData * psDrawData; // r2
        class stcTexUV * psTexSrc; // r2
        class stcTexUV * psTexSrc_RaceBase; // r2
        class stcPoint2D_s16 * psTextureRaceBaseSize; // r2
        float f32DrawX; // r22
        float f32Bottom; // r21
        float f32DrawY; // r29+0x90
...
// Range: 0x3C3570 -> 0x3C37C8
void _drawLapBack(class clsScoreInfo2D * this /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r21 */, signed int s32Open /* r2 */, signed int s32View /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C3570 -> 0x3C37C8
        class stcInfoData * psDrawData; // r2
...
// Range: 0x3C37D0 -> 0x3C3BCC
void _drawRank(class clsScoreInfo2D * this /* r18 */, signed int s32PosX /* r2 */, signed int s32PosY /* r2 */, signed int s32Dir /* r2 */, signed int s32Rank /* r17 */, signed int s32OldRank /* r16 */, float f32CurScale /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C37D0 -> 0x3C3BCC
        class stcInfoData * psDrawData; // r2
        class stcTexUV * psTexSrc; // r2
        class stcTexUV * psTexSrc_Ranking; // r2
        class stcPoint2D_s16 * psTextureRankingSize; // r2
        float f32DrawX; // r21
        float f32DrawY; // r20
        float f32HalfWidth; // r24
        float f32HalfHeight; // r23
        unsigned char u8Alpha; // r2
        float f32MarkX; // r29+0x90
        float f32MarkY; // r29+0x90
    }
}


// Range: 0x3C3BD0 -> 0x3C3CF4
void RankMain(class clsScoreInfo2D * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C3BD0 -> 0x3C3CF4
        signed int s32n; // r11
        ...
        class clsPlayerTask * pcPlayer; // r2
        class stcUserStatus * psUserSt; // r2
        signed int s32Rank; // r2
    }
}


// Range: 0x3C3D00 -> 0x3C3ED8
void execute(class clsScoreInfo2D * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C3D00 -> 0x3C3ED8
        class stcUnionStatus * psUnionSt; // r2
        class stcInfoData * psDrawData; // r2
        signed int s32OpenMax; // r5
    }
}


// Range: 0x3C3EE0 -> 0x3C40F4
void init(class clsScoreInfo2D * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C3EE0 -> 0x3C40F4
        class stcUnionStatus * psUnionSt; // r3
        signed int s32n; // r8
        class stcUserStatus * psUserSt; // r2
    }
}
...
// Range: 0x3C4100 -> 0x3C414C
void * __dt(class clsScoreInfo2D * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C4100 -> 0x3C414C
    }
...
// Range: 0x3C4150 -> 0x3C4190
void * __ct(class clsScoreInfo2D * this /* r16 */, class clsScore2D_Task * pcParent /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C4150 -> 0x3C4190
    }
