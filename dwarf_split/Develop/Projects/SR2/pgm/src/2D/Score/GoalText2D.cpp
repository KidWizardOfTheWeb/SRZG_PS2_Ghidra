/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\GoalText2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x30
} __vt__18clsGoalText2D_Task; // size: 0x30, address: 0x6C1D30
...
class clsGoalText2D_Task : public clsTemporary2D_Task {
    // total size: 0xB0
public:
    signed int m_s32View; // offset 0x58, size 0x4
    unsigned char m_u8Alpha; // offset 0x5C, size 0x1
    unsigned char m_u8CurrentAlpha; // offset 0x5D, size 0x1
    unsigned char m_u8TextNum; // offset 0x5E, size 0x1
    unsigned char m_u8TexStartNo; // offset 0x5F, size 0x1
    signed short m_s16Left; // offset 0x60, size 0x2
    signed short m_s16Top; // offset 0x62, size 0x2
    signed int m_s32CenterX; // offset 0x64, size 0x4
    float m_f32DifWidth; // offset 0x68, size 0x4
    float m_f32DefaultScale; // offset 0x6C, size 0x4
    signed short m_as16MoveX[9]; // offset 0x70, size 0x12
    signed short m_as16MoveMaxX[9]; // offset 0x82, size 0x12
    float m_f32CurrentScale; // offset 0x94, size 0x4
    float m_f32MaxScale; // offset 0x98, size 0x4
    float m_f32AfterScale; // offset 0x9C, size 0x4
    float m_f32PlayFrame; // offset 0xA0, size 0x4
    float m_f32ScaleFrame; // offset 0xA4, size 0x4
    float m_f32StopFrame; // offset 0xA8, size 0x4
    float m_f32FadeFrame; // offset 0xAC, size 0x4
};
...
// Range: 0x3E0C60 -> 0x3E0FC8
void draw(class clsGoalText2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E0C60 -> 0x3E0FC8
        class stcTexUV * psTexSrc; // r2
        class stcTexUV * psTexSrc_RankLogo; // r2
        class stcPoint2D_s16 * psTextureSize; // r2
        unsigned char u8DrawAlpha; // r2
        float af32DrawScale[9]; // r29+0xC0
        unsigned char au8DrawAlpha[9]; // r29+0xF0
        signed int s32n; // r6
        signed int s32TextNum; // r23
        unsigned char bDraw; // r18
        float f32DrawX; // r22
        float f32DrawY; // r21
        float f32MarginScale; // r20
    }
}


// Range: 0x3E0FD0 -> 0x3E16D8
void execute(class clsGoalText2D_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E0FD0 -> 0x3E16D8
        class clsPlayerTask * pcPlayer; // r2
        signed int s32n; // r5
        signed int s32TextNum; // r2
        signed short * ps16MoveX; // r2
        signed short * ps16MoveMaxX; // r2
        unsigned char bWait; // r5
        class clsBaseRace_Task * pcBaseRace; // r2
        signed int s32Lap; // r5
    }
}


// Range: 0x3E16E0 -> 0x3E1740
void * __dt(class clsGoalText2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E16E0 -> 0x3E1740
    }
...
// Range: 0x3E1740 -> 0x3E1CCC
void * __ct(class clsGoalText2D_Task * this /* r20 */, signed int s32View /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E1740 -> 0x3E1CCC
        ...
        float f32DrawWidth; // r20
        signed int s32HeightDir; // r18
        signed int s32i; // r5
        signed int s32HeightDiff; // r17
        unsigned char bTextDot; // r2
        float f32WidhtScale; // r4
    }
}
