/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\SurvivalBall\SurvivalBallMap2D.cpp
...
static class stcDrawParam oasStageParam1v[17]; // size: 0x1DC, address: 0x691030
static unsigned char chk__oasStageParam1v_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcDrawParam oasStageParam2v[17]; // size: 0x1DC, address: 0x691210
static unsigned char chk__oasStageParam2v_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcDrawParam oasStageParam4v[17]; // size: 0x1DC, address: 0x6913F0
static unsigned char chk__oasStageParam4v_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcPoint2D_s16 oasUnionTextureSize[1]; // size: 0x4, address: 0x6915D0
static class stcTexUV TexData2D[28]; // size: 0x1C0, address: 0x6915E0
static unsigned char chk__TexData2D_SizeCheck_[1]; // size: 0x1, address: 0x0
static float oas32MapY[17]; // size: 0x44, address: 0x6917A0
struct /* @anon0 */ {
    // total size: 0x20
} __vt__20clsSurvivalBallMap2D; // size: 0x20, address: 0x6CA080
class clsSurvivalBallPole_Task * m_tpcSingleton; // size: 0x4, address: 0xB173C8
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x691800
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x691810
...
class _NNS_TEXLIST * psTexList_WinLose2D; // size: 0x4, address: 0xB17B60
class clsPfDraw2d * m_tpcSingleton; // size: 0x4, address: 0x6E6990
class stcTask sTask; // size: 0x30, address: 0xB0A900
class _NNS_TEXLIST * psTexList_SurvivalBall2D; // size: 0x4, address: 0xB174D0
class stcDrawParam tsDebugMap; // size: 0x1C, address: 0xB163A0
...
class clsSurvivalBallPole_Task : public clsSingleModelGimmick_Task {
    // total size: 0xB4
public:
    class hkShape * m_pcRigidShape[2]; // offset 0xAC, size 0x8
};
class Fuid {
    // total size: 0x10
public:
...
class clsSurvivalBallPole_Obj : public clsRigidBodyGimmickObj {
    // total size: 0xF0
public:
    enum enmSurvivalBallPoleMode m_enMode; // offset 0xD0, size 0x4
    enum enmSurvivalBallPoleType m_enPointType; // offset 0xD4, size 0x4
    unsigned int m_u32SetType; // offset 0xD8, size 0x4
    float m_f32ContactFrame; // offset 0xDC, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0xE0, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsSurvivalBallPole_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x4DBAB0 -> 0x4DC19C
void drawEtc(class clsSurvivalBallMap2D * this /* r17 */, float (* psClipMtx)[4][4] /* r16 */, unsigned char u8DrawAlpha /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DBAB0 -> 0x4DC19C
        ...
        class NNS_VECTORFAST sObjPosVecFast; // r29+0x1A0
        class stcPoint2D_s16 sRetPoint2D; // r29+0x1BC
        unsigned int u32Color; // r29+0x100
        float f32HalfWidth; // r29+0x1C0
        float f32HalfHeight; // r29+0x1C0
        unsigned int u32Num; // r2
        unsigned int u32i; // r18
        class clsRigidBodyGimmickObj * pcObj; // r2
        float sTrsMtx[4][4]; // r29+0x160
        class NNS_VECTORFAST sDirVecFast; // r29+0x150
        float f32DotProY; // r20
        float f32HeightRate; // r29+0x1C0
        float f32Rad; // r29+0x1C0
        unsigned int au32PoleColor[2]; // @ 0x006917F8
        unsigned int au32GoalColor[3]; // @ 0x006917E8
    }
}


// Range: 0x4DC1A0 -> 0x4DC268
void drawMapMini(signed short s16BackX /* r19 */, signed short s16BackY /* r16 */, unsigned char u8DrawAlpha /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DC1A0 -> 0x4DC268
        class stcTexUV sTexSrc; // @ 0x006531D0
    }
}


// Range: 0x4DC270 -> 0x4DC278
void clip2Screen(class clsSurvivalBallMap2D * this /* r2 */, class stcPoint2D_s16 & rsDstScreenO /* r2 */, signed int s32vI /* r2 */, float (& orsMtx44I)[4][4] /* r2 */, class NNS_VECTORFAST & orsSrcVecI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DC270 -> 0x4DC278
    }
...
// Range: 0x4DC280 -> 0x4DC3F8
void * __ct(class clsSurvivalBallMap2D * this /* r17 */, class clsScore2D_Task * pcParent /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DC280 -> 0x4DC3F8
        class stcDrawParam * psMap; // r16
        class NNS_VECTOR * psRot; // r18
    }
}
