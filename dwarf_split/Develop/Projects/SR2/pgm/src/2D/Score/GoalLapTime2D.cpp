/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\GoalLapTime2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcLapTime2D osDrawData; // size: 0x20, address: 0x683570
struct /* @anon0 */ {
    // total size: 0x30
} __vt__21clsGoalLapTime2D_Task; // size: 0x30, address: 0x6C20A0
...
public:
    ...
    unsigned char m_u8BestAlpha; // offset 0x5D, size 0x1
    signed short m_s16CenterX; // offset 0x5E, size 0x2
    signed short m_s16CenterY; // offset 0x60, size 0x2
    signed short m_s16WindowW; // offset 0x62, size 0x2
    signed short m_s16WindowH; // offset 0x64, size 0x2
    signed short m_s16TextLeft; // offset 0x66, size 0x2
    signed short m_s16TimeLeft; // offset 0x68, size 0x2
    float m_f32WaitFrame; // offset 0x6C, size 0x4
    float m_f32StopFrame; // offset 0x70, size 0x4
    float m_f32FadeFrame; // offset 0x74, size 0x4
};
class clsFlyAction {
    // total size: 0x1C
public:
...
class stcLapTime2D {
    // total size: 0x20
public:
    signed short s16PosXDiff; // offset 0x0, size 0x2
    signed short s16PosYDiff; // offset 0x2, size 0x2
    signed int s32WindowWidth; // offset 0x4, size 0x4
    signed short s16TitlePosY; // offset 0x8, size 0x2
    signed short s16MarignWidth; // offset 0xA, size 0x2
    signed short s16MarignHeight; // offset 0xC, size 0x2
    signed short s16ItemHeight; // offset 0xE, size 0x2
    signed short s16TextMarignWidth; // offset 0x10, size 0x2
    unsigned char u8TitleMarignWidth; // offset 0x12, size 0x1
    unsigned char au8LapPosDiff[3]; // offset 0x13, size 0x3
    float f32MarginScale; // offset 0x18, size 0x4
    float f32MarkMarginScale; // offset 0x1C, size 0x4
};
class stcBitFlag {
    // total size: 0x4
public:
...
// Range: 0x3E8CE0 -> 0x3E8DD8
void draw(class clsGoalLapTime2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E8CE0 -> 0x3E8DD8
...
// Range: 0x3E8DE0 -> 0x3E98AC
void drawTime(class clsGoalLapTime2D_Task * this /* r29+0x108 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E8DE0 -> 0x3E98AC
        class stcLapTime2D * psDrawData; // r2
        ...
        float f32DrawX; // r21
        float f32DrawY; // r20
        signed int f32DrawLap; // r29+0xF0
        unsigned char u8DrawAlpha; // r2
        class stcRecord & rsBastLapTime; // r2
        unsigned char u8Min; // r2
        unsigned char u8Sec; // r2
        unsigned short u16MSec; // r2
        signed int f32DrawNum; // r2
        unsigned int u32Color; // r3
        signed int s32n; // r20
        unsigned char u8TimeAlpha; // r7
        class stcRecord sTotalTime; // r29+0x10C
    }
}


// Range: 0x3E98B0 -> 0x3E9DEC
void drawWindowItem(class clsGoalLapTime2D_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E98B0 -> 0x3E9DEC
        class stcLapTime2D * psDrawData; // r2
        ...
        signed int s32Left; // r2
        signed int s32Right; // r2
        signed int f32DrawLap; // r22
        unsigned char u8DrawAlpha; // r2
        signed int s32n; // r20
    }
}
...
// Range: 0x3E9DF0 -> 0x3EA108
void execute(class clsGoalLapTime2D_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E9DF0 -> 0x3EA108
...
// Range: 0x3EA110 -> 0x3EA170
void * __dt(class clsGoalLapTime2D_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EA110 -> 0x3EA170
    }
...
// Range: 0x3EA170 -> 0x3EA520
void * __ct(class clsGoalLapTime2D_Task * this /* r17 */, signed int s32View /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EA170 -> 0x3EA520
        class clsScore2D_Task * pcScore2D; // r2
        class stcLapTime2D * psDrawData; // r2
        class stcTexUV * psTexSrc_Result; // r2
        signed int s32CenterX; // r21
        signed int s32CenterY; // r20
        signed int f32DrawLap; // r4
    }
}
