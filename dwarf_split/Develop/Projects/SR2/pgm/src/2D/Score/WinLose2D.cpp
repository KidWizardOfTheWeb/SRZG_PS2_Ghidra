/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\WinLose2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcPoint2D_s16 oasUnionTextureSize[1]; // size: 0x4, address: 0x0
static class stcTexUV TexData2D[28]; // size: 0x1C0, address: 0x68B8A0
...
// Range: 0x4C4270 -> 0x4C4504
void drawRingNum(class clsWinLose2D_Task * this /* r17 */, signed int s32x /* r2 */, signed int s32y /* r2 */, signed int s32Point /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C4270 -> 0x4C4504
        ...
        signed int s32Width; // r2
        signed int s32Height; // r2
    }
}


// Range: 0x4C4510 -> 0x4C4758
void drawRank(class clsWinLose2D_Task * this /* r21 */, signed int s32x /* r22 */, signed int s32y /* r23 */, signed int s32Rank /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C4510 -> 0x4C4758
        class stcTexUV * psTexSrc; // r2
...
// Range: 0x4C4760 -> 0x4C4A0C
void drawText(class clsWinLose2D_Task * this /* r16 */, signed int s32x /* r17 */, signed int s32y /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C4760 -> 0x4C4A0C
        class stcTexUV * psTexSrc; // r2
        signed int s32Width; // r2
        signed int s32Height; // r2
        signed short s16TextX; // r2
    }
}


// Range: 0x4C4A10 -> 0x4C4DC0
void drawWindow(signed int s32x /* r2 */, signed int s32y /* r2 */, signed int s32w /* r2 */, signed int s32h /* r2 */, unsigned char u8Alpha /* r2 */, unsigned char bColor /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C4A10 -> 0x4C4DC0
        class stcTexUV * psTexSrc; // r2
        class stcTexUV * psTexSrc_Result; // r2
        float f32CurnerWidth; // r21
        float f32CurnerHeight; // r20
        signed int s32ww; // r2
        signed int s32hh; // r2
        float f32Left; // r27
        float f32Right; // r26
...
// Range: 0x4C4DC0 -> 0x4C5138
void draw(class clsWinLose2D_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C4DC0 -> 0x4C5138
        class clsPfDraw2d * pcOODraw2d; // r20
        class stcTexUV * psTexSrc; // r2
        class stcTexUV * psTexSrc_Result; // r2
        unsigned int u32i; // r22
        unsigned char u8Alpha; // r19
        signed int s32Width; // r2
        signed int s32Height; // r2
        signed short s16WindowX; // r2
    }
}


// Range: 0x4C5140 -> 0x4C5268
void execute(class clsWinLose2D_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C5140 -> 0x4C5268
    }
...
// Range: 0x4C5270 -> 0x4C545C
void init(class clsWinLose2D_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C5270 -> 0x4C545C
        class clsScore2D_Task * pcScore2D; // r2
        signed int s32CenterM; // r2
        signed short s16Rank[4]; // r29+0x18
