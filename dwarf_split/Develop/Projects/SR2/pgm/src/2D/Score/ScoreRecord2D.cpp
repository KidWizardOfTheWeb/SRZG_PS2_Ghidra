/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Score\ScoreRecord2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcRecordData DrawData1v; // size: 0x2C, address: 0x682430
static class stcRecordData DrawData2v; // size: 0x2C, address: 0x682460
static class stcRecordData DrawData4v; // size: 0x2C, address: 0x682490
struct /* @anon0 */ {
    // total size: 0xC
} __vt__16clsScoreRecord2D; // size: 0xC, address: 0x6C1910
...
// Range: 0x3CC8B0 -> 0x3CCA38
void drawRecord(class clsScoreRecord2D * this /* r19 */, unsigned int u32View /* r18 */, unsigned int u32PlayerNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CC8B0 -> 0x3CCA38
...
// Range: 0x3CCA40 -> 0x3CCA94
void draw(class clsScoreRecord2D * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CCA40 -> 0x3CCA94
        signed int s32n; // r16
...
// Range: 0x3CCAA0 -> 0x3CD5A0
void _drawRecordTime(class clsScoreRecord2D * this /* r2 */, class clsPlayerTask * pcPlayer /* r2 */, class stcUserStatus * psUserSt /* r2 */, signed int s32No /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CCAA0 -> 0x3CD5A0
        ...
        class stcRecordData * psDrawData; // r2
        unsigned char u8Minite; // r2
        unsigned char u8Second; // r2
        unsigned short u16MiliSecond; // r2
        float f32DrawX; // r3
        float f32DrawY; // r2
        signed int s32Dir; // r3
        float f32RecordX; // r29+0x90
        float f32RecordBY; // r29+0x90
        float f32TimeX; // r21
        float f32TimeBY; // r20
        unsigned char u8RecordAlpha; // r7
        unsigned char u8TimeAlpha; // r21
        signed int s32DrawNum; // r2
        signed int s32DrawNumWidth; // r2
    }
}


// Range: 0x3CD5A0 -> 0x3CDA30
void execute(class clsScoreRecord2D * this /* r29+0xBC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CD5A0 -> 0x3CDA30
        ...
        class stcRecordData * psDrawData; // r2
        unsigned char bLight; // r30
        float f32LightScale; // r20
        signed int s32n; // r23
        class stcUserStatus * psUserSt; // r20
        float f32LightFrame; // r29+0xC0
        float f32LightHalfFrame; // r29+0xC0
    }
}


// Range: 0x3CDA30 -> 0x3CDE58
void init(class clsScoreRecord2D * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CDA30 -> 0x3CDE58
...
// Range: 0x3CDE60 -> 0x3CDF0C
void * __dt(class clsScoreRecord2D * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CDE60 -> 0x3CDF0C
        signed int s32n; // r17
...
// Range: 0x3CDF10 -> 0x3CDFA0
void * __ct(class clsScoreRecord2D * this /* r18 */, class clsScore2D_Task * pcParent /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CDF10 -> 0x3CDFA0
        signed int s32n; // r17
