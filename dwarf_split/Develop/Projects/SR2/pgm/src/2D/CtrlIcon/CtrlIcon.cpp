/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\CtrlIcon\CtrlIcon.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float oaf32IconScale[4]; // size: 0x10, address: 0x6797A0
struct /* @anon1 */ {
    // total size: 0x30
...
class clsCtrlIcon_Task : public clsTask {
    // total size: 0x2A0
public:
    float m_sGhostDrawMtx[4][4]; // offset 0x60, size 0x40
    float m_asPlayerDrawMtx[8][4][4]; // offset 0xA0, size 0x200
};
class clsSlipStream {
    // total size: 0xD0
public:
...
// Range: 0x3522F0 -> 0x352524
void draw(class clsCtrlIcon_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3522F0 -> 0x352524
        signed int s32CurViewNo; // r18
        unsigned char bDraw; // r29+0x6F
        float f32DrawScale; // r20
    }
}


// Range: 0x352530 -> 0x352AD4
void drawPlayerIcon(class clsCtrlIcon_Task * this /* r2 */, unsigned int u32ViewNo /* r21 */, unsigned char * pbDraw /* r30 */, class NNS_VECTORFAST * opsCameraPosFast /* r29+0x120 */, float f32ScaleW /* r25 */, float f32ScaleH /* r24 */, float f32DrawScale /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x352530 -> 0x352AD4
        class stcTask * pcTask; // r2
        ...
        class stcPoint2D_s16 sRetBasePoint2D; // r29+0x1B8
        class NNS_VECTORFAST sBaseVecFast; // r29+0x1A0
        class NNS_VECTORFAST sRetVecFast; // r29+0x190
        float f32CameraDist; // r20
        signed int s32n; // r20
        class clsSurvivalRelayRace_Task & rcSurvivalRelayRace_Task; // r2
        float sRotMatrix[4][4]; // r29+0x150
        float f32DrawWidth; // r29+0x1C0
    }
}


// Range: 0x352AE0 -> 0x352F98
void drawGhostIcon(class clsCtrlIcon_Task * this /* r18 */, unsigned int u32ViewNo /* r21 */, unsigned char * pbDraw /* r20 */, class NNS_VECTORFAST * opsCameraPosFast /* r30 */, float f32ScaleW /* r22 */, float f32ScaleH /* r21 */, float f32DrawScale /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x352AE0 -> 0x352F98
        class stcTexUV * psTexSrc; // r2
        class stcTexUV * psTexSrc_Icon; // r2
        class stcPoint2D_s16 * psTextureSize; // r2
        class stcPoint2D_s16 sRetPoint2D; // r29+0x16C
        class stcPoint2D_s16 sRetBasePoint2D; // r29+0x168
        class NNS_VECTORFAST sBaseVecFast; // r29+0x150
        class NNS_VECTORFAST sRetVecFast; // r29+0x140
        float f32CameraDist; // r23
        float sRotMtx[4][4]; // r29+0x100
    }
}
