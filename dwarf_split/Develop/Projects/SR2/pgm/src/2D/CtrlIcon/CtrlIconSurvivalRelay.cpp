/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\CtrlIcon\CtrlIconSurvivalRelay.cpp
...
static float oaf32IconScale[4]; // size: 0x10, address: 0x69A610
struct /* @anon0 */ {
    // total size: 0x30
...
void drawNextPlayerSpeed() {
    ...
    /* anonymous block */ {
        ...
        class stcData * posCharaData; // r2
        class NNS_VECTORFAST sPosVecFast; // r29+0xE0
        class NNS_VECTORFAST sRetVecFast; // r29+0xD0
        class stcPoint2D_s16 sRetPoint2D; // r29+0xFC
        float f32DrawScale; // r20
        signed int s32x; // r2
        signed int s32y; // r2
        float f32NumberScale; // r25
        signed int s32Speed; // r18
        float s32cx; // r24
        float s32cy; // r23
    }
}
...
// Range: 0x588400 -> 0x5884AC
void draw(class clsCtrlIconSurvivalRelay_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x588400 -> 0x5884AC
        class clsSurvivalRelayRace_Task & rcSurvivalRelayRace_Task; // r2
