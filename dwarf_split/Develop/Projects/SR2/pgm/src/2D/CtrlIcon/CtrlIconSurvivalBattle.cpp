/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\CtrlIcon\CtrlIconSurvivalBattle.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcPoint2D_s16 oasUnionTextureSize; // size: 0x4, address: 0x697F40
static class stcTexUV TexData2D[10]; // size: 0xA0, address: 0x697F50
...
static unsigned char chk__TexData2D_SizeCheck_[1]; // size: 0x1, address: 0x0
static float oaf32IconScale[4]; // size: 0x10, address: 0x697FF0
struct /* @anon0 */ {
    // total size: 0x30
...
// Range: 0x561210 -> 0x5615C0
void drawBomb() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x561210 -> 0x5615C0
        class clsPfDraw2d * pcOODraw2d; // r21
        class clsPfGraphics & rcGraphics; // r20
        unsigned int u32Max; // r2
        unsigned int u32i; // r22
        class NNS_VECTORFAST sPosVecFast; // r29+0xD0
        class NNS_VECTORFAST sRetVecFast; // r29+0xC0
        class stcPoint2D_s16 sRetPoint2D; // r29+0xEC
        class stcPoint2D_s16 * psTextureSize; // r2
        class stcTexUV * psTexSrc; // r19
        float f32DrawScale; // r24
        signed int s32x; // r2
        signed int s32y; // r2
        float f32Dist; // r23
        float s32cx; // r25
        float s32cy; // r22
        float f32NumberScale; // r29+0xF0
    }
}


// Range: 0x5615C0 -> 0x5618FC
void drawMissile() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5615C0 -> 0x5618FC
        ...
        class stcPoint2D_s16 sRetPoint2D; // r29+0xEC
        class stcPoint2D_s16 * psTextureSize; // r2
        class stcTexUV * psTexSrc; // r18
        float f32DrawScale; // r22
        signed int s32x; // r2
        signed int s32y; // r2
        float f32Dist; // r24
        float s32cx; // r23
...
// Range: 0x561900 -> 0x5619CC
void draw(class clsCtrlIconSurvivalBattle_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x561900 -> 0x5619CC
        class clsSurvivalBattleRace_Task & rcSurvivalBattleRace_Task; // r2
    }
}
