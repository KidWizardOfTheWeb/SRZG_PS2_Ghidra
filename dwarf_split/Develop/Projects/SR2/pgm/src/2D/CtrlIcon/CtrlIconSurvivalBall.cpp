/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\CtrlIcon\CtrlIconSurvivalBall.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcPoint2D_s16 oasUnionTextureSize[1]; // size: 0x4, address: 0x6921F8
static class stcTexUV TexData2D[28]; // size: 0x1C0, address: 0x692200
static unsigned char chk__TexData2D_SizeCheck_[1]; // size: 0x1, address: 0x0
static float oaf32IconScale[4]; // size: 0x10, address: 0x6923C0
struct /* @anon0 */ {
    // total size: 0x30
} __vt__28clsCtrlIconSurvivalBall_Task; // size: 0x30, address: 0x6CB020
struct /* @anon1 */ {
    // total size: 0x30
...
class clsCtrlIconSurvivalBall_Task : public clsTask {
    // total size: 0x54
};
...
// Range: 0x4F0BE0 -> 0x4F0FDC
void draw(class clsCtrlIconSurvivalBall_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F0BE0 -> 0x4F0FDC
