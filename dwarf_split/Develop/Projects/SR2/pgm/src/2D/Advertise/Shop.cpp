/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Advertise\Shop.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static enum enmGearCtrl oaeShopGear[41]; // size: 0xA4, address: 0x6996A0
static enum enmGearCtrl aeShopGear[41]; // size: 0xA4, address: 0xBFB3D0
static class stcShopDrawData osDrawData; // size: 0x48, address: 0x699750
...
class stcTexUV TexData2D[]; // size: 0x0, address: 0x699880
class stcTexUV TexDataInfo_2D[]; // size: 0x0, address: 0x698D90
class clsSaveDataMgr * m_tpcSingleton; // size: 0x4, address: 0x703BF0
class stcDrawInfoData osDrawData; // size: 0x38, address: 0x6544B0
...
class stcGearStatus oasGearStatusData[]; // size: 0x0, address: 0x698B90
...
unsigned char CheckSaveDataCrc(void *); // size: 0x0, address: 0x4A3400
struct /* @anon0 */ {
    // total size: 0x30
...
public:
    ...
    unsigned int m_u32Flg; // offset 0x58, size 0x4
    signed char m_s8GearSelect; // offset 0x5C, size 0x1
    signed short m_s16GearSelectTop; // offset 0x5E, size 0x2
    signed short m_s16GearNum; // offset 0x60, size 0x2
    unsigned short m_u16TradeAlpha; // offset 0x62, size 0x2
    unsigned short m_u16ItemAlpha; // offset 0x64, size 0x2
    unsigned short m_u16BuyAlpha; // offset 0x66, size 0x2
    float m_f32WaitFrame; // offset 0x68, size 0x4
    signed short m_s16InfoWindowX; // offset 0x6C, size 0x2
    float m_f32BuyFrame; // offset 0x70, size 0x4
    float m_f32OutFrame; // offset 0x74, size 0x4
    float m_f32ListFrame; // offset 0x78, size 0x4
    float m_f32GearListEffectLine; // offset 0x7C, size 0x4
    float m_f32InfoMoveFrame; // offset 0x80, size 0x4
    float m_f32ShopInFrame; // offset 0x84, size 0x4
};
class NNS_NODE {
    // total size: 0x90
public:
...
class stcGearStatus {
    // total size: 0x8
public:
    unsigned short u16Dash; // offset 0x0, size 0x2
    unsigned short u16Limit; // offset 0x2, size 0x2
    unsigned short u16Power; // offset 0x4, size 0x2
    unsigned short u16Curve; // offset 0x6, size 0x2
};
class sceGsTex0 {
    // total size: 0x8
public:
...
class stcShopDrawData {
    // total size: 0x48
public:
    signed short s16MsgX; // offset 0x0, size 0x2
    signed short s16MsgY; // offset 0x2, size 0x2
    signed short s16MsgW; // offset 0x4, size 0x2
    signed short s16MsgH; // offset 0x6, size 0x2
    signed short s16HukidasiX; // offset 0x8, size 0x2
    signed short s16TradeX; // offset 0xA, size 0x2
    signed short s16TradeY; // offset 0xC, size 0x2
    signed short s16TradeW; // offset 0xE, size 0x2
    signed short s16TradeH; // offset 0x10, size 0x2
    signed short s16TradeNextY; // offset 0x12, size 0x2
    signed short s16TradeTextX; // offset 0x14, size 0x2
    float f32BuyInFrame; // offset 0x18, size 0x4
    float f32OutInFrame; // offset 0x1C, size 0x4
    signed short s16ItemX; // offset 0x20, size 0x2
    signed short s16ItemY; // offset 0x22, size 0x2
    signed short s16ItemW; // offset 0x24, size 0x2
    signed short s16ItemH; // offset 0x26, size 0x2
    signed short s16ItemNameH; // offset 0x28, size 0x2
    float f32ListInFrame; // offset 0x2C, size 0x4
    signed short s16YesX; // offset 0x30, size 0x2
    signed short s16YesY; // offset 0x32, size 0x2
    signed short s16NoX; // offset 0x34, size 0x2
    signed short s16NoY; // offset 0x36, size 0x2
    signed short s16InfoX; // offset 0x38, size 0x2
    signed short s16InfoY; // offset 0x3A, size 0x2
    signed short s16InfoW; // offset 0x3C, size 0x2
    signed short s16InfoH; // offset 0x3E, size 0x2
    signed short s16InfoEndX; // offset 0x40, size 0x2
    float f32MoveFrame; // offset 0x44, size 0x4
};
class stcDepthInfo {
    // total size: 0x8
public:
...
class stcDrawInfoData {
    // total size: 0x38
public:
    signed short s16NameX; // offset 0x0, size 0x2
    signed short s16NameY; // offset 0x2, size 0x2
    signed short s16UserX; // offset 0x4, size 0x2
    signed short s16UserY; // offset 0x6, size 0x2
    signed short s16UserIconX; // offset 0x8, size 0x2
    signed short s16UserIconY; // offset 0xA, size 0x2
    signed short s16UserIconW; // offset 0xC, size 0x2
    signed short s16UserIconH; // offset 0xE, size 0x2
    signed short s16GearX; // offset 0x10, size 0x2
    signed short s16GearY; // offset 0x12, size 0x2
    signed short s16GearW; // offset 0x14, size 0x2
    signed short s16GearH; // offset 0x16, size 0x2
    signed short s16RingX; // offset 0x18, size 0x2
    signed short s16RingY; // offset 0x1A, size 0x2
    signed short s16PartsX; // offset 0x1C, size 0x2
    signed short s16PartsY; // offset 0x1E, size 0x2
    signed short s16PartsIconX; // offset 0x20, size 0x2
    signed short s16DetailX; // offset 0x22, size 0x2
    signed short s16DetailY; // offset 0x24, size 0x2
    signed short s16DetailW; // offset 0x26, size 0x2
    signed short s16DetailH; // offset 0x28, size 0x2
    signed short s16DetailWindowX; // offset 0x2A, size 0x2
    signed short s16StatusX; // offset 0x2C, size 0x2
    signed short s16StatusY; // offset 0x2E, size 0x2
    signed short s16StatusW; // offset 0x30, size 0x2
    signed short s16StatusH; // offset 0x32, size 0x2
    signed short s16StatusInterval; // offset 0x34, size 0x2
    unsigned char u8ItemNextX; // offset 0x36, size 0x1
    unsigned char u8ItemNextY; // offset 0x37, size 0x1
};
...
// Range: 0x570450 -> 0x570714
void draw(class clsShop_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x570450 -> 0x570714
        class NNS_RGBA osParColor; // r29+0xB0
        class NNS_VECTOR sParDir; // r29+0xE0
        class NNS_RGBA osSpeColor; // r29+0xA0
        class NNS_VECTOR sSpeDir; // r29+0xD0
        class NNS_LIGHT_TARGET_DIRECTIONAL TargetDirectional; // r29+0x60
        class NNS_VECTOR LightPos; // r29+0xC0
        class NNS_LIGHT_SPECULAR_PS2 sSpeLight; // r29+0x40
        float f32Dist; // r29+0xF0
    }
}


// Range: 0x570720 -> 0x570BF8
void drawMessage(class clsShop_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x570720 -> 0x570BF8
        class stcShopDrawData * opsDrawData; // r2
        signed int s32DrawX; // r2
        signed int s32DrawY; // r19
        class stcTexUV * opsTexData_2D; // r2
        class stcTexUV * opsTexSrc; // r2
        float f32Left; // r23
        float f32Right; // r22
        float f32Center; // r21
        float f32Height; // r1
        signed int s32TextType; // r16
    }
}


// Range: 0x570C00 -> 0x571010
void drawRingNum(class clsShop_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x570C00 -> 0x571010
        class stcTexUV * opsTexSrc; // r2
        float f32Width; // r21
        float f32Height; // r20
        signed int s32Top; // r2
        signed int s32Right; // r2
        float f32DrawX; // r21
        float f32DrawY; // r20
        class stcTexUV * opsTexData01_2D; // r2
        unsigned int u32RingNum; // r21
        signed int s32DrawNum; // r2
        unsigned char bFastNo; // r20
        signed int oas32Math[6]; // r29+0x90
        float f32ShiftWidth; // r29+0xB0
        signed int s32i; // r19
    }
}


// Range: 0x571010 -> 0x571244
void drawGearInfo(class clsShop_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x571010 -> 0x571244
        class stcShopDrawData * opsDrawData; // r2
        signed int s32BaseX; // r18
        signed int s32BaseY; // r16
    }
}


// Range: 0x571250 -> 0x571854
void drawInfoGearBg(class clsShop_Task * this /* r23 */, signed int s32GearNo /* r21 */, float f32X /* r26 */, float f32Y /* r25 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x571250 -> 0x571854
        class stcTexUV * opsTexSrc; // r2
        ...
        float f32CenterWidth; // r21
        class stcTexUV sTexSrc; // r29+0xD0
        unsigned int u32GearNo; // r19
        signed int s32TexNo; // r2
        class stcFlashData * psFlashData; // r2
        unsigned int au32TexTbl[5]; // r29+0xB0
        unsigned int u32GearTbl; // r2
    }
}


// Range: 0x571860 -> 0x571F3C
void drawInfoDetails(class clsShop_Task * this /* r19 */, signed int s32GearNo /* r18 */, float f32X /* r26 */, float f32Y /* r25 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x571860 -> 0x571F3C
        class stcTexUV * opsTexSrc; // r2
        ...
        float f32Width; // r20
        float f32Height; // r2
        float f32CenterWidth; // r23
        unsigned int u32GearText; // r16
        unsigned int u32FontTbl; // r2
        float f32DrawFontScale; // r29+0x70
    }
}


// Range: 0x571F40 -> 0x5725A0
void drawInfoParts(class clsShop_Task * this /* r21 */, signed int s32GearNo /* r18 */, float f32X /* r23 */, float f32Y /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x571F40 -> 0x5725A0
        class stcTexUV * opsTexSrc; // r2
        ...
        class stcTexUV * psTexSrc_Etc; // r2
        class stcPoint2D_s16 * psEtcSize; // r29+0x100
        class stcTexUV * psTexSrc_Etc02; // r2
        class stcPoint2D_s16 * psEtc02Size; // r29+0xF0
        class stcPoint2D_s16 * psNameSize; // r20
        class stcCtrlData * psCtrlData; // r2
        signed int s32DrawType; // r19
        signed int s32DrawPartsNum; // r18
        signed int s32n; // r17
        float f32PartsY; // r21
        float f32NameX; // r25
        float f32NameY; // r24
...
// Range: 0x5725A0 -> 0x572964
void drawInfoStatus(class clsShop_Task * this /* r2 */, signed int s32GearNo /* r16 */, float f32X /* r24 */, float f32Y /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5725A0 -> 0x572964
        class stcTexUV * opsTexData01_2D; // r2
        class stcTexUV * opsTexSrc; // r2
        class stcDrawInfoData * opsInfoData; // r2
        float f32DrawX; // r29+0xC0
        float f32DrawY; // r21
        float f32Width; // r1
        float f32Height; // r20
        unsigned int u32Color; // r21
        class stcGearStatus * opsStatusData; // r2
        signed int s32n; // r20
        signed int s32i; // r19
    }
}
...
// Range: 0x572970 -> 0x572D1C
void drawInfoRing(class clsShop_Task * this /* r2 */, signed int s32GearNo /* r2 */, float f32X /* r29+0xB0 */, float f32Y /* r29+0xB0 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x572970 -> 0x572D1C
        class stcTexUV * opsTexData01_2D; // r2
        ...
        float f32Height; // r1
        unsigned int u32RingNum; // r21
        signed int oas32Math[4]; // r29+0xA0
        signed int s32DrawNum; // r2
        unsigned char bFastNo; // r22
        signed int s32n; // r20
    }
}


// Range: 0x572D20 -> 0x573278
void drawInfoUser(class clsShop_Task * this /* r2 */, signed int s32GearNo /* r2 */, float f32X /* r23 */, float f32Y /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x572D20 -> 0x573278
        class stcCtrlData * opsGearCtrlData; // r2
        class stcTexUV * opsTexData01_2D; // r2
        class stcTexUV * opsTexSrc; // r2
        class stcDrawInfoData * opsInfoData; // r2
        float f32DrawX; // r21
        ...
        float f32Height; // r1
        signed int s32n; // r20
        unsigned char bUnLock; // r5
        signed int s32IconX; // r2
        signed int s32IconY; // r2
    }
}


// Range: 0x573280 -> 0x5735FC
void drawInfoName(class clsShop_Task * this /* r21 */, signed int s32GearNo /* r20 */, float f32X /* r29+0x90 */, float f32Y /* r29+0x90 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x573280 -> 0x5735FC
        class stcTexUV * opsTexSrc; // r2
        class stcTexUV sTexSrc; // r29+0x80
        float f32DrawX; // r21
        float f32DrawY; // r20
        float f32Width; // r23
        float f32Height; // r22
        class stcFlashData * psFlashData; // r2
        unsigned int u32Gear; // r4
    }
}


// Range: 0x573600 -> 0x573C60
void drawInfoWindow(class clsShop_Task * this /* r2 */, signed int s32X /* r21 */, signed int s32Y /* r20 */, signed int s32W /* r22 */, signed int s32H /* r16 */, unsigned int u32Color /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x573600 -> 0x573C60
        class stcTexUV * opsTexSrc; // r2
...
// Range: 0x573C60 -> 0x5740CC
void drawTrade(class clsShop_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x573C60 -> 0x5740CC
        class stcShopDrawData * opsDrawData; // r2
        class stcTexUV * opsTexData_2D; // r2
        class stcTexUV * opsTexSrc; // r2
        unsigned int u32BackColor; // r2
        unsigned int u32DrawColor; // r22
        signed int s32DrawX; // r2
        signed int s32DrawY; // r21
        unsigned char bTrade; // r2
        float f32Width; // r29+0x90
        float f32Height; // r29+0x90
    }
}


// Range: 0x5740D0 -> 0x5749A4
void drawGearSelect(class clsShop_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5740D0 -> 0x5749A4
        class stcShopDrawData * opsDrawData; // r2
        ...
        class stcTexUV * opsTexData_2D; // r2
        class stcTexUV * opsTexSrc; // r2
        float f32TopHeight; // r25
        float f32AnderHeight; // r24
        float f32MiddleHeiglt; // r23
        float f32Width; // r22
        signed int s32SelectNo; // r2
        signed int s32GearNameX; // r2
        signed int s32GearNameY; // r22
        float f32Height; // r29+0xF0
        class stcFlashData * psFlashData; // r2
        class stcTexUV sTexSrc; // r29+0xE0
        signed int s32n; // r20
        enum enmGearCtrl eGear; // r2
        unsigned int u32NameNo; // r19
        signed int NAME_HEIGHT_DIFF; // @ 0x00654608
    }
}


// Range: 0x5749B0 -> 0x574E24
void drawTradeSelect(class clsShop_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5749B0 -> 0x574E24
        unsigned char bTrade; // r2
        unsigned char bInTrade; // r2
        class stcShopDrawData * opsDrawData; // r2
        signed int s32DrawX; // r2
        signed int s32DrawY; // r20
        signed int s32TextX; // r2
        signed int s32TextY; // r2
        float f32BuyMoveX; // r24
        float f32OutMoveX; // r23
        class stcTexUV * opsTexData_2D; // r19
        class stcTexUV * opsTexSrc; // r2
        float f32BarWidth; // r22
        float f32BarHeight; // r21
...
// Range: 0x574E30 -> 0x575A88
void execute(class clsShop_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x574E30 -> 0x575A88
        class stcShopDrawData * opsDrawData; // r2
...
// Range: 0x575A90 -> 0x575BE0
void updateGearList(class clsShop_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x575A90 -> 0x575BE0
        class clsSaveDataCtrl & rcSaveCtrl; // r2
        signed short s16GearNum; // r20
        signed int s32i; // r19
    }
}
