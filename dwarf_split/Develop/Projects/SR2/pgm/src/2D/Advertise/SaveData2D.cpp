/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\2D\Advertise\SaveData2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcPoint2D_s16 oasUnionTextureSize[3]; // size: 0xC, address: 0x0
static unsigned short KeyStringUTF16[5][39]; // size: 0x186, address: 0x0
static class stcDrawSaveData osDrawData; // size: 0x20, address: 0x699130
static unsigned int oau32DrawItem[6]; // size: 0x18, address: 0x699150
struct /* @anon1 */ {
    // total size: 0x30
} __vt__18clsSaveData2D_Task; // size: 0x30, address: 0x6D0FE0
struct /* @anon2 */ {
    // total size: 0x30
...
class stcTexUV TexData02_2D[]; // size: 0x0, address: 0x699430
class stcTexUV TexData01_2D[]; // size: 0x0, address: 0x699210
...
struct /* @anon0 */ {
    // total size: 0x30
} __vt__18clsKeyboard2D_Task; // size: 0x30, address: 0x6D1010
...
class stcDrawSaveData {
    // total size: 0x20
public:
    signed short s16Width; // offset 0x0, size 0x2
    signed short s16NextDataWidth; // offset 0x2, size 0x2
    signed short s16TopHeight; // offset 0x4, size 0x2
    signed short s16AnderHeight; // offset 0x6, size 0x2
    signed short s16TopX; // offset 0x8, size 0x2
    signed short s16TopY; // offset 0xA, size 0x2
    signed short s16TopWMargin; // offset 0xC, size 0x2
    signed short s16TopLineDiffY; // offset 0xE, size 0x2
    signed short s16TopNumX; // offset 0x10, size 0x2
    signed short s16TopNumY; // offset 0x12, size 0x2
    signed short s16ItemX; // offset 0x14, size 0x2
    signed short s16ItemY; // offset 0x16, size 0x2
    signed short s16ItemSpace; // offset 0x18, size 0x2
    signed short s16ItemMargin; // offset 0x1A, size 0x2
    signed short s16ItemInX; // offset 0x1C, size 0x2
    signed short s16ItemMarginText; // offset 0x1E, size 0x2
};
...
class clsSaveData2D_Task : public clsTask {
    // total size: 0x74
public:
    unsigned char m_bCancel; // offset 0x54, size 0x1
    unsigned char m_bOptionCheck; // offset 0x55, size 0x1
    unsigned char m_bLoadData; // offset 0x56, size 0x1
    unsigned char m_bCanceled; // offset 0x57, size 0x1
    unsigned int m_u32SelectNo; // offset 0x58, size 0x4
    signed short m_s16LeftX; // offset 0x5C, size 0x2
    signed short m_s16TopY; // offset 0x5E, size 0x2
    unsigned int m_u32OldMessage; // offset 0x60, size 0x4
    class clsAdvertiseMgr_Task * m_pcAdvertiseMgr_Task; // offset 0x64, size 0x4
    class clsMemoryCard_Task * m_pcMemocaTask; // offset 0x68, size 0x4
    class clsKeyboard2D_Task * m_pcKeyBoardTask; // offset 0x6C, size 0x4
    class clsMsgWnd_Task * m_pcMsgWndTask; // offset 0x70, size 0x4
};
class NNS_NODE {
    // total size: 0x90
public:
...
public:
    ...
    enum enmRet m_eKeyboardDataBuff_Ret; // offset 0x58, size 0x4
    unsigned char m_bLoadFlag; // offset 0x5C, size 0x1
    unsigned char m_bCancel; // offset 0x5D, size 0x1
    class stcDrawPos_s16 m_sDrawPos[44]; // offset 0x5E, size 0xB0
    class stcPoint3d sNamePos; // offset 0x110, size 0xC
    class stcRect m_sNameDrawRect; // offset 0x11C, size 0x10
    signed int m_s32PadNo; // offset 0x12C, size 0x4
    float m_f32CslB; // offset 0x130, size 0x4
    float m_f32SelectScale; // offset 0x134, size 0x4
    signed int m_f32NameBarX; // offset 0x138, size 0x4
    signed int m_s32CenterX; // offset 0x13C, size 0x4
    float m_f32DefFontSize; // offset 0x140, size 0x4
    unsigned int m_u32DefCharaSpace; // offset 0x144, size 0x4
    unsigned short m_au16UserName[11]; // offset 0x148, size 0x16
    signed short m_s16DrawX; // offset 0x15E, size 0x2
    signed short m_s16DrawY; // offset 0x160, size 0x2
    signed short m_s16BGLeft; // offset 0x162, size 0x2
    signed short m_s16BGRight; // offset 0x164, size 0x2
    signed short m_s16BGHeight; // offset 0x166, size 0x2
    signed char m_s8DrawKey[44]; // offset 0x168, size 0x2C
    unsigned char m_u8Alpha; // offset 0x194, size 0x1
    unsigned char m_uPageFlag; // offset 0x195, size 0x1
    unsigned char m_u8NameCount; // offset 0x196, size 0x1
    signed char m_s8CursorPos; // offset 0x197, size 0x1
    signed char m_s8OldPos; // offset 0x198, size 0x1
    signed char m_s8CursorX; // offset 0x199, size 0x1
    signed char m_s8CursorY; // offset 0x19A, size 0x1
    signed char m_s8OldCursorX; // offset 0x19B, size 0x1
    signed char m_s8OldCursorY; // offset 0x19C, size 0x1
    signed char m_s8AnimeCount; // offset 0x19D, size 0x1
    signed char m_s8AnimeFream; // offset 0x19E, size 0x1
    unsigned char m_bSptKeyOnFlag; // offset 0x19F, size 0x1
    signed char m_s8BarFream; // offset 0x1A0, size 0x1
    unsigned char m_bBarAnimeEnable; // offset 0x1A1, size 0x1
    unsigned char m_bBarDrawFlag; // offset 0x1A2, size 0x1
    class clsSaveDataCtrl * m_pcSaveDataCtrl; // offset 0x1A4, size 0x4
};
class compressed_pair : private compressed_pair_imp {
    // total size: 0x4
};
...
// Range: 0x56B9B0 -> 0x56BA24
void draw(class clsSaveData2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x56B9B0 -> 0x56BA24
...
// Range: 0x56BA30 -> 0x56BB84
void drawData(class clsSaveData2D_Task * this /* r21 */, unsigned int u32No /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x56BA30 -> 0x56BB84
        class stcDrawSaveData * opsDrawData; // r2
        signed int s32DrawX; // r19
        signed int s32DrawY; // r18
        unsigned int u32Color; // r17
        unsigned int u32BackColor; // r22
    }
}


// Range: 0x56BB90 -> 0x56C640
void drawAnderConsole(class clsSaveData2D_Task * this /* r23 */, unsigned int u32No /* r2 */, signed int s32X /* r2 */, signed int s32Y /* r16 */, signed int s32W /* r2 */, signed int s32H /* r19 */, unsigned int u32Color /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x56BB90 -> 0x56C640
        class stcTexUV * opsTexData01_2D; // r2
        class stcTexUV * opsTexData02_2D; // r2
        class stcTexUV * opsTexSrc; // r2
        class stcDrawSaveData * opsDrawData; // r2
        signed int s32BaseX; // r2
        signed int s32DrawY; // r29+0x110
        float f32Width; // r29+0x1B0
        float f32Height; // r20
        signed int s32i; // r29+0x100
        unsigned int ou32ItemType; // r16
        float f32TextX; // r24
        float f32TextY; // r23
        float f32ValueX; // r22
        float f32ValueY; // r21
        signed int oas32StoryStageNoTbl[13]; // r29+0x160
        signed int s32CheckStageNo; // r2
        signed int s32n; // r20
        class stcRect sDrawRect; // r29+0x150
        class stcPoint3d sPos; // r29+0x1A0
    }
}


// Range: 0x56C640 -> 0x56C8C4
void drawRing(unsigned int u32RingNum /* r21 */, float f32X /* r29+0xC0 */, float f32Y /* r29+0xC0 */, unsigned int u32Color /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x56C640 -> 0x56C8C4
        class stcTexUV * opsTexData02_2D; // r2
        ...
        signed int oas32Math[6]; // r29+0xA0
        signed int s32i; // r19
    }
}


// Range: 0x56C8D0 -> 0x56CFF4
void drawDate(unsigned short u16Year /* r21 */, unsigned char u8Month /* r20 */, unsigned char u8Day /* r22 */, float f32X /* r29+0xC0 */, float f32Y /* r29+0xC0 */, unsigned int u32Color /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x56C8D0 -> 0x56CFF4
        class stcTexUV * opsTexData02_2D; // r2
        ...
        float f32DrawY; // r20
        float f32Width; // r22
        float f32Height; // r29+0xC0
        unsigned char oau8DrawType[5]; // r29+0xB8
        signed int s32n; // r23
    }
}


// Range: 0x56D000 -> 0x56D1E0
void drawGear(unsigned int u32GearNum /* r2 */, float f32X /* r29+0x60 */, float f32Y /* r29+0x60 */, unsigned int u32Color /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x56D000 -> 0x56D1E0
        class stcTexUV * opsTexSrc; // r2
...
// Range: 0x56D1E0 -> 0x56D4A0
void drawMisson(unsigned int u32MissonNum /* r2 */, float f32X /* r29+0x60 */, float f32Y /* r29+0x60 */, unsigned int u32Color /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x56D1E0 -> 0x56D4A0
        class stcTexUV * opsTexSrc; // r2
...
// Range: 0x56D4A0 -> 0x56DAB4
void drawTime(unsigned int u32TotalTime /* r2 */, float f32X /* r29+0x70 */, float f32Y /* r29+0x70 */, unsigned int u32Color /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x56D4A0 -> 0x56DAB4
        class stcTexUV * opsTexSrc; // r2
        unsigned int u32Minite; // r2
        unsigned int u32Hour; // r2
        signed int s32DrawNum; // r2
        float f32DrawX; // r21
        float f32DrawY; // r20
        float f32Width; // r22
        float f32Height; // r29+0x70
    }
}


// Range: 0x56DAC0 -> 0x56E2F8
void drawTopConsole(class clsSaveData2D_Task * this /* r29+0x11C */, unsigned int u32No /* r29+0x118 */, signed int s32X /* r29+0x114 */, signed int s32Y /* r29+0x110 */, signed int s32W /* r29+0x10C */, signed int s32H /* r29+0x108 */, unsigned int u32Color /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x56DAC0 -> 0x56E2F8
        class stcTexUV * opsTexData01_2D; // r2
        class stcTexUV * opsTexData02_2D; // r2
        class stcTexUV * opsTexSrc; // r16
        class stcDrawSaveData * opsDrawData; // r2
        unsigned char bNameType; // r29+0xF0
        signed int s32DrawX; // r2
        signed int s32DrawY; // r2
        unsigned int u32DataType; // r2
        float f32Width; // r20
        float f32Height; // r29+0x1A0
        signed int oas32StoryStageNoTbl[13]; // r29+0x150
        signed int s32CheckStageNo; // r2
        signed int s32n; // r21
        class stcPoint3d sPos; // r29+0x190
        class stcRect sDrawRect; // r29+0x140
    }
}


// Range: 0x56E300 -> 0x56E888
void drawSelectWindow(class clsSaveData2D_Task * this /* r2 */, signed int s32X /* r21 */, signed int s32Y /* r20 */, signed int s32W /* r22 */, signed int s32H /* r23 */, unsigned int u32Color /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x56E300 -> 0x56E888
        class stcTexUV * opsTexSrc; // r18
        float f32Width; // r20
        float f32Height; // r21
    }
}
...
// Range: 0x56E890 -> 0x56F124
void drawWindow(class clsSaveData2D_Task * this /* r2 */, signed int s32X /* r21 */, signed int s32Y /* r20 */, signed int s32W /* r23 */, signed int s32H /* r22 */, unsigned int u32Color /* r19 */, unsigned int u32DecoType /* r29+0xCC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x56E890 -> 0x56F124
        class stcTexUV * opsTexData01_2D; // r18
        class stcTexUV * opsTexSrc; // r2
        float f32WakuWidth; // r29+0xD0
        float f32WakuHeight; // r29+0xD0
        float f32Width; // r21
        float f32Height; // r26
    }
}
...
// Range: 0x56F130 -> 0x570290
void execute(class clsSaveData2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x56F130 -> 0x570290
    }
...
// Range: 0x570290 -> 0x570384
void * __ct(class clsSaveData2D_Task * this /* r19 */, class clsAdvertiseMgr_Task * pcAdvertiseMgr_Task /* r18 */, unsigned char bCancel /* r17 */, unsigned char bOptionCheck /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x570290 -> 0x570384
