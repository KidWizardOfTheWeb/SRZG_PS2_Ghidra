/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Task\TaskManager.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x28
} __vt__14clsTaskManager; // size: 0x28, address: 0x6B58E0
...
struct /* @anon1 */ {
    // total size: 0xC
} __vt__30clsSingleton<14clsTaskManager>; // size: 0xC, address: 0x6B5908
...
// Range: 0x1629D0 -> 0x162AEC
unsigned char endTaskExecuteGroup(class clsTaskManager * this /* r18 */, unsigned int u32GroupId /* r2 */, unsigned int u32LoopNum /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1629D0 -> 0x162AEC
        unsigned char bRet; // r16
        char __FUNCTION__[20]; // @ 0x00659400
    }
}


// Range: 0x162AF0 -> 0x162BFC
void beginTaskExecuteGroup(class clsTaskManager * this /* r2 */, unsigned int u32GroupId /* r2 */, unsigned int u32LoopNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x162AF0 -> 0x162BFC
        char __FUNCTION__[22]; // @ 0x006593E0
    }
}


// Range: 0x162C00 -> 0x162C8C
void * __dt(class clsTaskManager * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x162C00 -> 0x162C8C
    }
...
// Range: 0x162C90 -> 0x162D28
void * __ct(class clsTaskManager * this /* r16 */, class clsOOHeapFragment & rcWorkHeap /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x162C90 -> 0x162D28
    }
...
// Range: 0x162D90 -> 0x162D98
void @4@endTaskExecuteGroup__14clsTaskManagerFUiUi() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x162D90 -> 0x162D98
    }
...
// Range: 0x162DA0 -> 0x162DA8
void @4@beginTaskExecuteGroup__14clsTaskManagerFUiUi() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x162DA0 -> 0x162DA8
    }
...
// Range: 0x162DB0 -> 0x162DB8
void @4@__dt__14clsTaskManagerFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x162DB0 -> 0x162DB8
    }
