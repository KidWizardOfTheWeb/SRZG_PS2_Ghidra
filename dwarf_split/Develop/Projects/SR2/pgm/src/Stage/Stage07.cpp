/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Stage\Stage07.cpp
...
struct /* @anon1 */ {
    // total size: 0x48
} __vt__15clsStage07_Task; // size: 0x48, address: 0x6BCD50
struct /* @anon4 */ {
    // total size: 0x44
...
// Range: 0x320350 -> 0x3203E4
void changeDrawParts(class clsStage07_Task * this /* r2 */, unsigned int ou32OnOff /* r2 */, unsigned int ou32UserDataNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x320350 -> 0x3203E4
        signed int s32i; // r14
        class NNS_OBJECT * psObject; // r2
        class NNS_NODE * psNode; // r13
        signed int s32j; // r12
...
// Range: 0x3203F0 -> 0x320440
void * __ct(class clsStage07_Task * this /* r16 */, class stcBinInfo & rsBinInfoI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3203F0 -> 0x320440
    }
