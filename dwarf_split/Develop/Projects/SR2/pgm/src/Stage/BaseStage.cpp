/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Stage\BaseStage.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon4 */ {
    // total size: 0x44
} __vt__17clsBaseStage_Task; // size: 0x44, address: 0x6BBBE0
...
struct /* @anon2 */ {
    // total size: 0x3C
} __vt__18clsColorDrops_Task; // size: 0x3C, address: 0x6D0320
...
signed int BgColor(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x1D9B40
signed int Fog(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x1D9D90
...
// Range: 0x2EAA60 -> 0x2EAF2C
void draw(class clsBaseStage_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EAA60 -> 0x2EAF2C
        ...
        class clsRetPath cRetCoursePath; // r29+0xA0
        unsigned char bReversePlayer; // r23
        class stcDrawPath * psDrawPath; // r2
        unsigned int u32i; // r19
        unsigned int u32Num; // r2
        class stcPointPath & rsDrawPath; // r2
        unsigned int toau32LineCol[7]; // @ 0x0066A580
    }
}


// Range: 0x2EAF30 -> 0x2EB07C
void execute(class clsBaseStage_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EAF30 -> 0x2EB07C
...
// Range: 0x2EB080 -> 0x2EB0E8
void calcCamCoursePoint(unsigned int u32v /* r2 */, class clsRetPath * pcRetCoursePath /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EB080 -> 0x2EB0E8
        class NNS_VECTORFAST sCamPos; // r29+0x10
    }
}


// Range: 0x2EB0F0 -> 0x2EB1A0
void initMain(class clsBaseStage_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EB0F0 -> 0x2EB1A0
    }
...
// Range: 0x2EB1A0 -> 0x2EB1AC
void reset(class clsBaseStage_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EB1A0 -> 0x2EB1AC
    }
...
// Range: 0x2EB1B0 -> 0x2EB1E0
void init(class clsBaseStage_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EB1B0 -> 0x2EB1E0
    }
...
// Range: 0x2EB1E0 -> 0x2EB540
void * __ct(class clsBaseStage_Task * this /* r19 */, class stcBinInfo & rsBinInfoI /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EB1E0 -> 0x2EB540
        class clsCollisionManager * pcCollision; // r17
        signed int s32CollisionNum; // r16
        void * opvColli; // r20
    }
}


// Range: 0x2EB5B0 -> 0x2EB614
void setObjPortalBin(class clsBaseStage_Task * this /* r17 */, class stcBinInfo & rsBinInfoI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EB5B0 -> 0x2EB614
    }
...
// Range: 0x2EB620 -> 0x2EB774
void setEtcParam(class clsBaseStage_Task * this /* r17 */, class stcBinInfo & rsBinInfoI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EB620 -> 0x2EB774
        class stcEtcBinaryStageData * psBinTop; // r2
        class stcBinDataDetail * opsBinDataDetail; // r2
    }
}
