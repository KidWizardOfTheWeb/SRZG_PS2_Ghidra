/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Stage\Stage03.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon2 */ {
    // total size: 0x48
} __vt__15clsStage03_Task; // size: 0x48, address: 0x6BCD00
...
// Range: 0x320290 -> 0x320350
void execute(class clsStage03_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x320290 -> 0x320350
    }
