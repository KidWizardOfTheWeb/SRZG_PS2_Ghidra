/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Stage\Sky09.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcThunderFogRange oasThunderFogRange[28]; // size: 0x70, address: 0x6871B0
struct /* @anon0 */ {
    // total size: 0x30
} __vt__13clsSky09_Task; // size: 0x30, address: 0x6C3FB0
struct /* @anon1 */ {
    // total size: 0x30
...
public:
    ...
    class clsModelType_OB_TX_MO_MA m_cModel; // offset 0xA0, size 0x20
    class clsBaseRace_Task * m_pcBaseRace_Task; // offset 0xC0, size 0x4
    class stcDetail m_asDetail[4]; // offset 0xC4, size 0xC
    unsigned short m_u16ThunderProbability; // offset 0xD0, size 0x2
    float * m_pf32ThunderFrame; // offset 0xD4, size 0x4
};
class clsSingleton {
    // total size: 0x4
};
...
class stcDetail {
    // total size: 0x3
public:
    unsigned char u8BackUpFogNo; // offset 0x0, size 0x1
    unsigned char u8ThundeMode; // offset 0x1, size 0x1
    unsigned char bOutDoor_Old; // offset 0x2, size 0x1
};
class compressed_pair_imp {
    // total size: 0x8
public:
...
class stcThunderFogRange {
    // total size: 0x4
public:
    signed short s16Near; // offset 0x0, size 0x2
    signed short s16Far; // offset 0x2, size 0x2
};
...
// Range: 0x431CF0 -> 0x431E94
void draw(class clsSky09_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x431CF0 -> 0x431E94
...
// Range: 0x431EA0 -> 0x4323C8
void execute(class clsSky09_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x431EA0 -> 0x4323C8
        unsigned int u32ViewportNum; // r2
        signed int s32UserNum; // r23
        float * pf32ThunderFrame; // r20
        class stcDetail * psDetail; // r19
        class clsReInitGraphics_Task * pcReInitGraphics_Task; // r18
        unsigned int u32v; // r17
        class clsPlayerTask * pcPlayerTask; // r2
        unsigned int u32Fog; // r2
    }
}


// Range: 0x4323D0 -> 0x4325D8
void * __ct(class clsSky09_Task * this /* r17 */, class stcBinInfo & rsBinInfoI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4323D0 -> 0x4325D8
        class stcDetail * psDetail; // r5
        unsigned int u32ViewportNum; // r2
        signed int s32v; // r4
    }
}
