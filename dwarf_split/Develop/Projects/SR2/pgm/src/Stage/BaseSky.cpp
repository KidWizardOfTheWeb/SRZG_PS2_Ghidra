/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Stage\BaseSky.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x30
} __vt__15clsBaseSky_Task; // size: 0x30, address: 0x6BBCA0
struct /* @anon1 */ {
    // total size: 0x30
...
class stcBinDataDetail {
    // total size: 0xC
public:
    signed int a32RotNode1; // offset 0x0, size 0x4
    signed int a32RotNode2; // offset 0x4, size 0x4
    signed int a32RotNode3; // offset 0x8, size 0x4
};
...
class clsBaseSky_Task : public clsTask {
    // total size: 0xB0
public:
    class clsModelType_OB_TX m_cModel; // offset 0x54, size 0x8
    float m_sTrsMtx[4][4]; // offset 0x60, size 0x40
    class stcBinDataDetail * m_opsSkyRotData; // offset 0xA0, size 0x4
    class stcBinDataDetail m_sSkyRotData; // offset 0xA4, size 0xC
};
class __vector_imp : private __vector_deleter {
    // total size: 0xC
};
...
// Range: 0x2EE990 -> 0x2EEAF8
void draw(class clsBaseSky_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EE990 -> 0x2EEAF8
...
// Range: 0x2EEB70 -> 0x2EECBC
void execute(class clsBaseSky_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EEB70 -> 0x2EECBC
        float * m_oaf32SkyRotData; // r2
    }
}


// Range: 0x2EECC0 -> 0x2EEEB8
void * __ct(class clsBaseSky_Task * this /* r17 */, class stcBinInfo & rsBinInfoI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EECC0 -> 0x2EEEB8
    }
