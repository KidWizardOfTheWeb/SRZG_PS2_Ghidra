/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Stage\DivStage.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned int toau32LineCol[7]; // size: 0x1C, address: 0x66AEF0
struct /* @anon6 */ {
    // total size: 0x48
...
// Range: 0x305B70 -> 0x306018
void draw(class clsDivStage_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x305B70 -> 0x306018
        class clsPlayerTask * pcPlayer; // r2
        class clsRetPath cRetCoursePath; // r29+0xA0
        unsigned char bReverseCamera; // r19
        unsigned char bReversePlayer; // r22
        class clsModelType_OB_TX_MO_MA * pcDivModel; // r20
        signed int s32PortalDataNo; // r29+0xCC
        unsigned char * opu8IgnoreResidencePortalData; // r29+0xC8
        unsigned char u8NowPortal_Old; // r19
        signed int s32d; // r18
    }
}


// Range: 0x306070 -> 0x3062F8
void drawNormal(class clsDivStage_Task * this /* r19 */, signed int & s32PortalDataNo /* r2 */, signed int s32d /* r2 */, unsigned char u8CamCurrentPortal /* r2 */, class clsModelType_OB_TX_MO_MA * pcDivModel /* r22 */, float (* opaNnViewMtx)[4][4] /* r23 */, unsigned int u32v /* r2 */, unsigned char * * oppu8IgnoreResidencePortalData /* r2 */, unsigned char u8NowPortal /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x306070 -> 0x3062F8
        unsigned char bExit; // r5
        unsigned int u32n; // r8
    }
}


// Range: 0x306300 -> 0x306420
void draw1Model(class clsModelType_OB_TX_MO_MA * pcDivModel /* r18 */, float (* opaNnViewMtx)[4][4] /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x306300 -> 0x306420
...
// Range: 0x306420 -> 0x3065E0
void execute(class clsDivStage_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x306420 -> 0x3065E0
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        unsigned char * opu8Data; // r6
        unsigned int bExist; // r5
        signed int s32r; // r4
        float f32FrameRateAdd; // r2
        class clsModelType_OB_TX_MO_MA * pcDivModel; // r5
        signed int s32d; // r4
    }
}


// Range: 0x3065E0 -> 0x306628
void reset(class clsDivStage_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3065E0 -> 0x306628
        class clsModelType_OB_TX_MO_MA * pcDivModel; // r4
        signed int s32d; // r3
    }
}


// Range: 0x306630 -> 0x306948
void * __ct(class clsDivStage_Task * this /* r19 */, class stcBinInfo & rsBinInfoI /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x306630 -> 0x306948
        unsigned int * opu32OffsetNo; // r17
        class clsModelType_OB_TX_MO_MA * pcDivModel; // r16
        void * pvData; // r2
    }
}
