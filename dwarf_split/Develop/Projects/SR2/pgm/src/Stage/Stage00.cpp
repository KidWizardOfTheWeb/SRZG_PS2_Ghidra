/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Stage\Stage00.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x44
} __vt__15clsStage00_Task; // size: 0x44, address: 0x6BBC30
struct /* @anon4 */ {
    // total size: 0x44
...
class clsStage00_Task : public clsBaseStage_Task {
    // total size: 0x140
};
...
// Range: 0x2EB860 -> 0x2EB868
void init(class clsStage00_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EB860 -> 0x2EB868
    }
