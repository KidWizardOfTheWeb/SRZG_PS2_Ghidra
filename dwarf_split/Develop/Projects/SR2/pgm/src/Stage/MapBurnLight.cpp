/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Stage\MapBurnLight.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x30
} __vt__20clsMapBurnLight_Task; // size: 0x30, address: 0x6C0730
struct /* @anon1 */ {
    // total size: 0x30
...
public:
    ...
    float m_sTrsMtx[4][4]; // offset 0x80, size 0x40
};
...
// Range: 0x39E4F0 -> 0x39E720
void draw(class clsMapBurnLight_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39E4F0 -> 0x39E720
...
// Range: 0x39E720 -> 0x39E7D0
void execute(class clsMapBurnLight_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39E720 -> 0x39E7D0
    }
...
// Range: 0x39E7D0 -> 0x39E8D0
void * __ct(class clsMapBurnLight_Task * this /* r16 */, class stcBinInfo & rsBinInfoI /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39E7D0 -> 0x39E8D0
    }
