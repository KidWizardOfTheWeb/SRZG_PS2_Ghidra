/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Stage\Stage09.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon3 */ {
    // total size: 0x48
} __vt__15clsStage09_Task; // size: 0x48, address: 0x6BCDA0
...
class clsStage09_Task : public clsDivStage_Task {
    // total size: 0x4A8
public:
    float m_af32ThunderFrame[4]; // offset 0x498, size 0x10
};
class sceGsTex0 {
    // total size: 0x8
public:
...
// Range: 0x3205A0 -> 0x3205D4
void reset(class clsStage09_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3205A0 -> 0x3205D4
    }
