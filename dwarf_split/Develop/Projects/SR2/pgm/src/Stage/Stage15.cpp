/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Stage\Stage15.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon3 */ {
    // total size: 0x48
} __vt__15clsStage15_Task; // size: 0x48, address: 0x6BCE40
...
struct /* @anon0 */ {
    // total size: 0x18
} __vt__17clsPathCourseSt15; // size: 0x18, address: 0x6C2A80
struct /* @anon6 */ {
    // total size: 0x18
} __vt__13clsPathCourse; // size: 0x18, address: 0x6BD220
struct /* @anon10 */ {
    // total size: 0x14
...
// Range: 0x320950 -> 0x320A60
void reset(class clsStage15_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x320950 -> 0x320A60
        class clsGroundCollision * pcGroundCol; // r18
        signed int s32i; // r17
        signed int s32GroundNum; // r2
        signed int s32i; // r10
        class NNS_OBJECT * psObject; // r2
        class NNS_NODE * psNode; // r9
        signed int s32j; // r8
        signed int s32NodeNum; // r2
    }
}


// Range: 0x320A60 -> 0x320B28
void execute(class clsStage15_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x320A60 -> 0x320B28
        class clsPlayerTask * pcPlayer; // r2
        unsigned int u32i; // r18
        unsigned int u32PlayerNum; // r2
    }
}


// Range: 0x320B30 -> 0x320BAC
void dispDistantView(class clsStage15_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x320B30 -> 0x320BAC
        signed int s32i; // r17
        class NNS_OBJECT * psObject; // r2
        class NNS_NODE * psNodeTop; // r2
        class NNS_NODE * psNode; // r2
    }
}


// Range: 0x320BB0 -> 0x320C2C
void hideDistantView(class clsStage15_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x320BB0 -> 0x320C2C
        signed int s32i; // r17
...
// Range: 0x320C30 -> 0x320EB0
void dispNode(class clsStage15_Task * this /* r17 */, class NNS_NODE * psNodeTop /* r16 */, signed int os32NodeNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x320C30 -> 0x320EB0
        class NNS_NODE * psNode; // r2
        signed int s32ChildNo; // r2
        signed int s32SiblingNo; // r2
    }
}


// Range: 0x320ED0 -> 0x321144
void hideNode(class clsStage15_Task * this /* r17 */, class NNS_NODE * psNodeTop /* r16 */, signed int os32NodeNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x320ED0 -> 0x321144
        class NNS_NODE * psNode; // r2
...
// Range: 0x321170 -> 0x321220
void changeDrawParts(class clsStage15_Task * this /* r2 */, unsigned int ou32OnOff /* r2 */, unsigned int ou32UserDataNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x321170 -> 0x321220
        unsigned char bFind; // r15
        signed int s32i; // r3
        class NNS_OBJECT * psObject; // r2
        class NNS_NODE * psNode; // r14
        signed int s32j; // r13
        signed int s32NodeNum; // r2
    }
}
