/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Script\Script2D.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class _NNS_TEXLIST * m_tpsTexList; // size: 0x4, address: 0xB15F70
class clsScript2D_Task * m_tapc2DTask[16]; // size: 0x40, address: 0xB15F80
struct /* @anon2 */ {
    // total size: 0x30
} __vt__16clsScript2D_Task; // size: 0x30, address: 0x6C0FC0
struct /* @anon0 */ {
    // total size: 0x30
...
public:
    ...
    signed int m_s322DFrame; // offset 0x58, size 0x4
    unsigned int m_u32TexNum; // offset 0x5C, size 0x4
    signed int m_s32AriveFrame; // offset 0x60, size 0x4
    float m_f32x; // offset 0x64, size 0x4
    float m_f32y; // offset 0x68, size 0x4
    float m_f32w; // offset 0x6C, size 0x4
    float m_f32h; // offset 0x70, size 0x4
    unsigned int m_u32ColMask; // offset 0x74, size 0x4
    unsigned int m_u32StartCol; // offset 0x78, size 0x4
    unsigned int m_u32EndCol; // offset 0x7C, size 0x4
    signed int m_s32ColFrame; // offset 0x80, size 0x4
    signed int m_s32ScrFrame; // offset 0x84, size 0x4
    float m_f32x2; // offset 0x88, size 0x4
    float m_f32y2; // offset 0x8C, size 0x4
};
...
// Range: 0x3B0330 -> 0x3B0630
void draw(class clsScript2D_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B0330 -> 0x3B0630
        signed int x; // r17
        signed int y; // r16
        unsigned int u32Col; // r19
        unsigned char a; // r2
        unsigned char r; // r2
        unsigned char g; // r2
        unsigned char b; // r2
...
// Range: 0x3B0630 -> 0x3B0758
void execute(class clsScript2D_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B0630 -> 0x3B0758
    }
...
// Range: 0x3B0760 -> 0x3B08AC
void codeShow2D(unsigned char * pu8Ptr /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B0760 -> 0x3B08AC
        class tagstcScriptFuncLineData * psLine; // r2
        unsigned int u32MyId; // r2
        unsigned int u32TexNum; // r21
        signed int s32AriveFrame; // r20
        float f32x; // r25
        float f32y; // r24
        float f32w; // r23
        float f32h; // r22
        unsigned int u32ColMask; // r19
        unsigned int u32Col; // r18
        unsigned int u32EndCol; // r22
        signed int s32ColFrame; // r17
        signed int s32ScrFrame; // r16
        float f32x2; // r21
        float f32y2; // r20
    }
}
...
// Range: 0x3B0940 -> 0x3B0A64
void * __ct(class clsScript2D_Task * this /* r21 */, unsigned int u32TexNum /* r20 */, unsigned int s32AriveFrame /* r19 */, float f32x /* r25 */, float f32y /* r24 */, float f32w /* r23 */, float f32h /* r22 */, unsigned int u32ColMask /* r18 */, unsigned int u32Col /* r17 */, unsigned int u32EndCol /* r16 */, signed int s32ColFrame /* r22 */, signed int s32ScrFrame /* r23 */, float f32x2 /* r21 */, float f32y2 /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B0940 -> 0x3B0A64
    }
