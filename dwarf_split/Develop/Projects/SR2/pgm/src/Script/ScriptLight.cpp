/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Script\ScriptLight.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcBinDataDetail otasDefaultDataDetail; // size: 0x54, address: 0x690380
...
public:
    class stcRgbF32 sAmbientRgb; // offset 0x0, size 0xC
    class stcRgbaF32 sParallelRgba; // offset 0xC, size 0x10
    float f32ParallelInten; // offset 0x1C, size 0x4
    class NNS_VECTOR sParallelDir; // offset 0x20, size 0xC
    class NNS_VECTOR sParallelPos; // offset 0x2C, size 0xC
    class stcRgbaF32 sSpecularRgba; // offset 0x38, size 0x10
    class NNS_VECTOR sSpecularDir; // offset 0x48, size 0xC
};
enum enmMoveFlag {
    MOVE_FLAG_NULL = 0,
    MOVE_FLAG_SPEED = 1,
...
// Range: 0x4D38A0 -> 0x4D38D4
void setLightDisp(class clsScriptLight * this /* r2 */, unsigned int u32No /* r2 */, unsigned char bHide /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D38A0 -> 0x4D38D4
        class stcParallelLight * psParLight; // r2
    }
}


// Range: 0x4D38E0 -> 0x4D390C
void setLightData(class clsScriptLight * this /* r2 */, unsigned int u32No /* r2 */, unsigned int u32DataNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D38E0 -> 0x4D390C
        class stcLightData * psLightData; // r2
    }
}


// Range: 0x4D3910 -> 0x4D393C
void setLightSpeDir(class clsScriptLight * this /* r2 */, float f32xI /* r29 */, float f32yI /* r29 */, float f32zI /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D3910 -> 0x4D393C
        class stcLightValue * psLight; // r2
    }
}


// Range: 0x4D3940 -> 0x4D3974
void setLightSpe(class clsScriptLight * this /* r2 */, float r /* r29 */, float g /* r29 */, float b /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D3940 -> 0x4D3974
        class stcLightValue * psLight; // r2
...
// Range: 0x4D3980 -> 0x4D39B8
void setLightParDir(class clsScriptLight * this /* r2 */, signed int s32No /* r2 */, float f32xI /* r29 */, float f32yI /* r29 */, float f32zI /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D3980 -> 0x4D39B8
        class stcParallelLight * psParLight; // r2
...
// Range: 0x4D39C0 -> 0x4D39F4
void setLightParInten(class clsScriptLight * this /* r2 */, signed int s32No /* r2 */, float f32Inten /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D39C0 -> 0x4D39F4
        class stcParallelLight * psParLight; // r2
...
// Range: 0x4D3A00 -> 0x4D3A40
void setLightPar(class clsScriptLight * this /* r2 */, signed int s32No /* r2 */, float r /* r29 */, float g /* r29 */, float b /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D3A00 -> 0x4D3A40
        class stcParallelLight * psParLight; // r2
...
// Range: 0x4D3A40 -> 0x4D3A6C
void setLightAmb(class clsScriptLight * this /* r2 */, float r /* r29 */, float g /* r29 */, float b /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D3A40 -> 0x4D3A6C
        class stcLightValue * psLight; // r2
...
// Range: 0x4D3A70 -> 0x4D3C90
void setLight(class clsScriptLight * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D3A70 -> 0x4D3C90
        class stcLightValue * psSrcLight; // r22
        class stcLightValue * psDstLight; // r20
        class stcLightData * psSrcLightData; // r2
        class stcLightData * psDstLightData; // r2
        signed int s32n; // r19
        class stcParallelLight * psSrcParallel; // r2
        class stcParallelLight * psDstParallel; // r2
    }
}


// Range: 0x4D3C90 -> 0x4D3F6C
void setLightAll(class clsScriptLight * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D3C90 -> 0x4D3F6C
        class stcLightValue * pcLight; // r16
        class stcLightData * psLightData; // r2
        signed int s32n; // r19
        unsigned char bStop; // r2
    }
}


// Range: 0x4D3F70 -> 0x4D423C
void setSpecureLight(class clsScriptLight * this /* r2 */, enum NNE_LIGHT eNo /* r16 */, class NNS_LIGHTPTR * pcLight /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D3F70 -> 0x4D423C
        class NNS_LIGHT_SPECULAR_PS2 sSpeLight; // r29+0x70
        class NNS_RGBA sSpeColor; // r29+0x60
        class NNS_VECTOR sSpeVec; // r29+0x90
        float sRotMtx[4][4]; // r29+0x20
        class NNS_LIGHT_TARGET_SPOT * psTagSpot; // r2
        class NNS_LIGHT_ROTATION_SPOT * psRotSpot; // r2
        class NNS_LIGHT_TARGET_DIRECTIONAL * psTagDirect; // r2
        class NNS_LIGHT_ROTATION_DIRECTIONAL * psRotDirect; // r2
    }
}


// Range: 0x4D4240 -> 0x4D4368
void setupBinLightMotion(class NNS_LIGHTPTR * * ppsLightPtrIn /* r20 */, class NNS_MOTION * * ppsMotionIn /* r19 */, void * pvBufIn /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D4240 -> 0x4D4368
        signed int i; // r8
        ...
        class NNS_BINCNK_DATAHEADER * pData; // r18
    }
}


// Range: 0x4D4370 -> 0x4D4574
void * __ct(class clsScriptLight * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D4370 -> 0x4D4574
        signed int s32n; // r18
        signed int s32i; // r20
        class stcBinDataDetail * psBinDataDetail; // r2
    }
}
