/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Script\ScriptBlur.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x30
} __vt__18clsScriptBlur_Task; // size: 0x30, address: 0x6C2E90
struct /* @anon2 */ {
    // total size: 0x30
...
// Range: 0x40D6B0 -> 0x40D7D8
void draw(class clsScriptBlur_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40D6B0 -> 0x40D7D8
        unsigned int u32v; // r16
    }
}


// Range: 0x40D7E0 -> 0x40DAEC
void execute(class clsScriptBlur_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40D7E0 -> 0x40DAEC
        class stcScriptBlur & rsBlur; // r2
        unsigned int u32v; // r8
        unsigned int u32End; // r7
    }
}


// Range: 0x40DAF0 -> 0x40DAF8
signed int ScriptBlur() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40DAF0 -> 0x40DAF8
    }
...
// Range: 0x40DB00 -> 0x40DB10
void codeBlurEnd(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40DB00 -> 0x40DB10
    }
...
// Range: 0x40DB10 -> 0x40DB44
void codeBlur(unsigned char * pu8Ptr /* r4 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40DB10 -> 0x40DB44
...
// Range: 0x40DB50 -> 0x40DC50
void initSet(class clsScriptBlur_Task * this /* r20 */, unsigned char u8Type /* r19 */, unsigned char u8Alpha /* r18 */, float f32Per /* r25 */, float f32GFrame /* r24 */, float f32WaitFrame /* r23 */, unsigned char u8SAlpha /* r17 */, unsigned char u8EAlpha /* r16 */, float f32SPer /* r22 */, float f32EPer /* r21 */, float f32FadeFrame /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40DB50 -> 0x40DC50
    }
...
// Range: 0x40DC50 -> 0x40DCD8
void * __ct(class clsScriptBlur_Task * this /* r18 */, unsigned char u8Type /* r17 */, class clsTask * pcScriptTask /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40DC50 -> 0x40DCD8
    }
