/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Script\ScriptFrameTexCamera.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon1 */ {
    // total size: 0x3C
} __vt__28clsScriptCameraFrameTex_Task; // size: 0x3C, address: 0x6C1CC0
struct /* @anon2 */ {
    // total size: 0x30
...
// Range: 0x3E0650 -> 0x3E0744
void draw(class clsScriptCameraFrameTex_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E0650 -> 0x3E0744
    }
...
// Range: 0x3E0750 -> 0x3E0784
void execute(class clsScriptCameraFrameTex_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E0750 -> 0x3E0784
    }
...
// Range: 0x3E0790 -> 0x3E07C8
void checkCamera(class clsScriptCameraFrameTex_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E0790 -> 0x3E07C8
    }
...
// Range: 0x3E0810 -> 0x3E0890
void * __ct(class clsScriptCameraFrameTex_Task * this /* r18 */, unsigned char u8TexNo /* r17 */, class clsScript_Task * pcParrent /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E0810 -> 0x3E0890
    }
...
// Range: 0x3E0890 -> 0x3E0898
void @84@__dt__28clsScriptCameraFrameTex_TaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E0890 -> 0x3E0898
    }
