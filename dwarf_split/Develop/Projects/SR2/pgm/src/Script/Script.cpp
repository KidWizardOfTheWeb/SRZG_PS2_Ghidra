/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Script\Script.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
char * ac8CodeName[114]; // size: 0x1C8, address: 0x0
unsigned char * m_pu8DataBuf; // size: 0x4, address: 0xB13C90
signed int m_ts32DrawModelNum; // size: 0x4, address: 0xB13C98
void (* m_oascodeFunc[114])(unsigned char *, class clsScript_Task *); // size: 0x1C8, address: 0x627AB0
static char oac8LangTypeName[2]; // size: 0x2, address: 0x67C900
static class stcScriptBurnOut osBurnOutBase; // size: 0x4, address: 0x0
static class stcScriptBurnOut osBurnOutTbl[1]; // size: 0x4, address: 0x0
struct /* @anon11 */ {
    // total size: 0x30
} __vt__14clsScript_Task; // size: 0x30, address: 0x6BE7C0
...
signed int ScriptInfo(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x360650
signed int Heap(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x360840
...
signed int DebugWave(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x40C4C0
signed int DebugNega(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x40CDC0
signed int ScriptBlur(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x40DAF0
...
struct /* @anon2 */ {
    // total size: 0x30
} __vt__15clsSunLenz_Task; // size: 0x30, address: 0x6CEA30
void * __dt(class clsModelType_OB_TX_MO_MA_MF *, signed short); // size: 0x0, address: 0x1DE210
struct /* @anon8 */ {
    // total size: 0xC
} __vt__21clsScriptModelManager; // size: 0xC, address: 0x6BE838
...
struct /* @anon7 */ {
    // total size: 0xC
} __vt__14clsScriptLight; // size: 0xC, address: 0x6BE818
struct /* @anon14 */ {
    // total size: 0xC
} __vt__31clsSingleton<15clsPfScriptHeap>; // size: 0xC, address: 0x6BE7F0
struct /* @anon4 */ {
    // total size: 0x18
} __vt__15clsPfScriptHeap; // size: 0x18, address: 0x6BE800
...
public:
    ...
    unsigned short u16MotDivMax[20]; // offset 0x8, size 0x28
    unsigned short u16MatDivMax[20]; // offset 0x30, size 0x28
    unsigned short u16MorfDivMax[20]; // offset 0x58, size 0x28
    unsigned short u16FileDivNum; // offset 0x80, size 0x2
    unsigned short u16MotionMax; // offset 0x82, size 0x2
    unsigned short u16MaterialMax; // offset 0x84, size 0x2
    unsigned short u16MorfMax; // offset 0x86, size 0x2
    unsigned short u16MallocDataNum; // offset 0x88, size 0x2
    unsigned char u8Pad[6]; // offset 0x8A, size 0x6
    unsigned int u32Num; // offset 0x90, size 0x4
    class tagstcScriptFuncLineData * ppScriptFuncLine; // offset 0x94, size 0x4
};
class clsOODraw2d {
    // total size: 0xC
public:
...
class stcScriptCode {
    // total size: 0x20
public:
    unsigned int u32Code; // offset 0x0, size 0x4
    unsigned int au32Pad[7]; // offset 0x4, size 0x1C
};
class clsSingleton {
    // total size: 0x4
};
...
class stcScriptBurnOut {
    // total size: 0x4
public:
    unsigned char u8EventNo; // offset 0x0, size 0x1
    unsigned char u8EraseAlpha; // offset 0x1, size 0x1
    unsigned char u8EraseColor; // offset 0x2, size 0x1
    unsigned char u8PathDrawNum; // offset 0x3, size 0x1
};
...
// Range: 0x360650 -> 0x360838
signed int ScriptInfo(signed int s32xI /* r21 */, signed int s32yI /* r20 */, signed int s32ActiveNoI /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x360650 -> 0x360838
        signed int s32yBack; // r22
        class clsScript_Task & rcScript_Task; // r2
        class stcScriptInfo & rsInfo; // r2
    }
}


// Range: 0x360840 -> 0x360A08
signed int Heap(signed int s32xI /* r19 */, signed int s32yI /* r29+0x5C */, signed int s32ActiveNoI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x360840 -> 0x360A08
        signed int s32yBack; // r2
    }
}


// Range: 0x360A10 -> 0x360CEC
static void draw_HeapDetail(signed int s32xI /* r18 */, signed int & rs32yI /* r17 */, class clsOOHeapFragment * pcOOHeapI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x360A10 -> 0x360CEC
...
// Range: 0x360CF0 -> 0x360D94
void draw(class clsScript_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x360CF0 -> 0x360D94
    }
...
// Range: 0x360DA0 -> 0x3614C0
void execute(class clsScript_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x360DA0 -> 0x3614C0
        unsigned char bScriptPlay; // r20
        class stcScriptCode * psCode; // r2
    }
}


// Range: 0x361500 -> 0x361ACC
void startInit(class clsScript_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x361500 -> 0x361ACC
        class clsOODebugMenu & rcOOMenu; // r17
        class stcScriptBinaryHeader * psHead; // r2
    }
}


// Range: 0x361AD0 -> 0x361BCC
unsigned char checkFileRead(class clsScript_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x361AD0 -> 0x361BCC
    }
...
// Range: 0x361BD0 -> 0x361CE0
unsigned char checkEnd(class clsScript_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x361BD0 -> 0x361CE0
    }
...
// Range: 0x361CE0 -> 0x361DF8
void codeSwapBuf(class clsScript_Task * pcTask /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x361CE0 -> 0x361DF8
        char ac8FileName[32]; // r29+0x30
    }
}


// Range: 0x361E00 -> 0x361E08
void codeJump() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x361E00 -> 0x361E08
...
// Range: 0x361E10 -> 0x361E40
void codeFade(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x361E10 -> 0x361E40
        class tagstcScriptFuncLineData * psLine; // r2
        unsigned int u32Flg; // r2
        unsigned int u32Color; // r2
    }
}


// Range: 0x361E40 -> 0x361F48
void codeAllPlayModelCamera(unsigned char * pu8Ptr /* r16 */, class clsScript_Task * pcTask /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x361E40 -> 0x361F48
    }
...
// Range: 0x361F50 -> 0x361FA0
void codeFrameWait(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x361F50 -> 0x361FA0
    }
...
// Range: 0x361FA0 -> 0x361FC4
void codeWaitButton(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x361FA0 -> 0x361FC4
        unsigned int u32Button; // r2
    }
}


// Range: 0x361FD0 -> 0x361FE0
void codeWait(class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x361FD0 -> 0x361FE0
    }
...
// Range: 0x361FE0 -> 0x362004
void codeFogSwitch(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x361FE0 -> 0x362004
        unsigned int u32Switch; // r2
    }
}


// Range: 0x362010 -> 0x362044
void codeFogRange(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x362010 -> 0x362044
        class tagstcScriptFuncLineData * psLine; // r2
        unsigned int u32Type; // r2
    }
}


// Range: 0x362050 -> 0x362074
void codeFogColor(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x362050 -> 0x362074
        class tagstcScriptFuncLineData * psLine; // r2
...
// Range: 0x362080 -> 0x362090
void codeStopSunLenz(class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x362080 -> 0x362090
    }
...
// Range: 0x362090 -> 0x3620BC
void codeSetSunLenz(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x362090 -> 0x3620BC
        class tagstcScriptFuncLineData * psLine; // r2
...
// Range: 0x3620C0 -> 0x3620DC
void codeLightDisp(unsigned char * pu8Ptr /* r3 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3620C0 -> 0x3620DC
        class tagstcScriptFuncLineData * psLine; // r2
...
// Range: 0x3620E0 -> 0x3620F4
void codeLightData(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3620E0 -> 0x3620F4
        class tagstcScriptFuncLineData * psLine; // r2
...
// Range: 0x362100 -> 0x362118
void codeLightSpeDir(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x362100 -> 0x362118
        class tagstcScriptFuncLineData * psLine; // r2
...
// Range: 0x362120 -> 0x362138
void codeLightSpe(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x362120 -> 0x362138
        class tagstcScriptFuncLineData * psLine; // r2
...
// Range: 0x362140 -> 0x36215C
void codeLightParaDir(unsigned char * pu8Ptr /* r4 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x362140 -> 0x36215C
        class tagstcScriptFuncLineData * psLine; // r2
...
// Range: 0x362160 -> 0x362174
void codeLightParaInten(unsigned char * pu8Ptr /* r4 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x362160 -> 0x362174
        class tagstcScriptFuncLineData * psLine; // r2
...
// Range: 0x362180 -> 0x36219C
void codeLightPara(unsigned char * pu8Ptr /* r4 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x362180 -> 0x36219C
        class tagstcScriptFuncLineData * psLine; // r2
...
// Range: 0x3621A0 -> 0x3621B8
void codeLightAmbient(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3621A0 -> 0x3621B8
        class tagstcScriptFuncLineData * psLine; // r2
...
// Range: 0x3621C0 -> 0x3625A0
void codeCutPlay(unsigned char * pu8Ptr /* r19 */, class clsScript_Task * pcTask /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3621C0 -> 0x3625A0
    }
...
// Range: 0x3625A0 -> 0x362694
void codeFastStart(class clsScript_Task * pcTask /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3625A0 -> 0x362694
    }
...
// Range: 0x3626A0 -> 0x362768
void codeCut(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3626A0 -> 0x362768
        float * pf32Frame; // r2
...
// Range: 0x362B30 -> 0x362B3C
void setBinaryData(unsigned char * pu8Buf /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x362B30 -> 0x362B3C
    }
...
// Range: 0x362B40 -> 0x362E84
void * __dt(class clsScript_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x362B40 -> 0x362E84
    }
...
// Range: 0x363070 -> 0x3637CC
void * __ct(class clsScript_Task * this /* r16 */, signed int s32No /* r18 */, unsigned char u8ModeType /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x363070 -> 0x3637CC
        char ac8FileName[32]; // r29+0x50
        unsigned char u8LangType; // r2
    }
}


// Range: 0x3638C0 -> 0x3638C8
void @4@__dt__15clsPfScriptHeapFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3638C0 -> 0x3638C8
    }
