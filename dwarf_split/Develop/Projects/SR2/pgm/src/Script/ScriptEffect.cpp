/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Script\ScriptEffect.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class clsModelType_OB_TX_MO_MA_MF m_tacEffect[32]; // size: 0x680, address: 0xB166E0
signed int m_ts32DataNum; // size: 0x4, address: 0xB16D60
struct /* @anon0 */ {
    // total size: 0x30
} __vt__20clsScriptEffect_Task; // size: 0x30, address: 0x6C2180
struct /* @anon1 */ {
    // total size: 0x30
...
public:
    float m_sTrsMtx[4][4]; // offset 0x60, size 0x40
    unsigned int m_eFlag; // offset 0xA0, size 0x4
    unsigned int m_u32View; // offset 0xA4, size 0x4
    unsigned int m_u32EffectNo; // offset 0xA8, size 0x4
    unsigned int m_u32ModelNo; // offset 0xAC, size 0x4
    unsigned int m_u32NodeNo; // offset 0xB0, size 0x4
    class NNS_VECTOR m_sOfsVec; // offset 0xB4, size 0xC
    float m_f32Frame; // offset 0xC0, size 0x4
    float m_f32StartFrame; // offset 0xC4, size 0x4
    float m_f32EndFrame; // offset 0xC8, size 0x4
    float m_f32WaitFrame; // offset 0xCC, size 0x4
    float m_f32MotFrame; // offset 0xD0, size 0x4
    float m_f32MatFrame; // offset 0xD4, size 0x4
    float m_f32MofFrame; // offset 0xD8, size 0x4
    class clsModelType_OB_TX_MO_MA_MF * m_pcModel; // offset 0xDC, size 0x4
};
struct /* @anon0 */ {
    // total size: 0x30
};
...
// Range: 0x3EBD30 -> 0x3EC0A0
void draw(class clsScriptEffect_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EBD30 -> 0x3EC0A0
        ...
        class clsScriptModel_Task * pcModelTask; // r2
        class NNS_VECTOR sPosVec; // r29+0x130
        float aNnViewRotInvertMtx[4][4]; // r29+0xF0
        float aMtx[4][4]; // r29+0xB0
        class tagMatAlphaTmp sOldAlpha; // r29+0x80
        class tagMatAlphaTmp sOldAlpha; // r29+0x50
    }
}


// Range: 0x3EC0A0 -> 0x3EC308
void execute(class clsScriptEffect_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EC0A0 -> 0x3EC308
    }
...
// Range: 0x3EC310 -> 0x3EC4B4
void codeEffect(unsigned char * pu8Ptr /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EC310 -> 0x3EC4B4
        class tagstcScriptFuncLineData * psLine; // r2
        unsigned int u32Effect; // r21
        unsigned int u32Tp; // r20
        unsigned int u32Flg; // r2
        float * pf32OfsX; // r19
        float * pf32OfsY; // r2
        float * pf32OfsZ; // r2
        unsigned int u32Model; // r18
        unsigned int u32Node; // r17
        float * pf32Sf; // r22
        float * pf32Ef; // r2
        float * pf32Wait; // r2
        unsigned int u32DrawFlg; // r16
    }
}


// Range: 0x3EC4C0 -> 0x3EC628
void * __ct(class clsScriptEffect_Task * this /* r21 */, unsigned int u32View /* r20 */, unsigned int u32Effect /* r19 */, unsigned int u32Tp /* r2 */, unsigned int u32Flg /* r18 */, float f32OfsX /* r25 */, float f32OfsY /* r24 */, float f32OfsZ /* r23 */, unsigned int u32ModelNo /* r17 */, unsigned int u32NodeNo /* r16 */, float f32StartFrame /* r22 */, float f32EndFrame /* r21 */, float f32WaitFrame /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EC4C0 -> 0x3EC628
    }
