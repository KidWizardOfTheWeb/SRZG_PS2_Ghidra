/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Script\ScriptUnsolved.cpp
...
// Range: 0x383620 -> 0x383628
void codeChangeLineEffectMov() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x383620 -> 0x383628
    }
...
// Range: 0x383650 -> 0x383658
void codeInitHishakai() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x383650 -> 0x383658
    }
...
// Range: 0x383660 -> 0x38368C
void codeChangeCopyFrameBufTexPos(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x383660 -> 0x38368C
...
// Range: 0x383690 -> 0x383698
void codeCopyFrameBufTex() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x383690 -> 0x383698
    }
...
// Range: 0x3836A0 -> 0x3836CC
void codeChangeFrameBufTexPos(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3836A0 -> 0x3836CC
        class tagstcScriptFuncLineData * psLine; // r2
...
// Range: 0x3836D0 -> 0x383704
void codeShowFrameBufTex(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3836D0 -> 0x383704
    }
...
// Range: 0x383710 -> 0x38372C
void codeEndFrameBufTex(class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x383710 -> 0x38372C
    }
...
// Range: 0x383730 -> 0x383764
void codeStartFrameBufTex(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x383730 -> 0x383764
        class tagstcScriptFuncLineData * psLine; // r2
...
// Range: 0x383770 -> 0x383778
void codeDispStrBackFrame() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x383770 -> 0x383778
    }
