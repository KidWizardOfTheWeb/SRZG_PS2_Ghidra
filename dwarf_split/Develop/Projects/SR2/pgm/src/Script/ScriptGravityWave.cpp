/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Script\ScriptGravityWave.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon4 */ {
    // total size: 0x40
} __vt__18clsScriptWave_Task; // size: 0x40, address: 0x6C2E10
struct /* @anon5 */ {
    // total size: 0x40
...
struct /* @anon1 */ {
    // total size: 0x40
} __vt__18clsScriptNega_Task; // size: 0x40, address: 0x6C2E50
struct /* @anon3 */ {
    // total size: 0x2C
...
// Range: 0x40C170 -> 0x40C334
void draw(class clsScriptWave_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40C170 -> 0x40C334
...
// Range: 0x40C340 -> 0x40C4B8
void execute(class clsScriptWave_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40C340 -> 0x40C4B8
...
// Range: 0x40C4C0 -> 0x40C818
signed int DebugWave(signed int s32xI /* r21 */, signed int s32yI /* r20 */, signed int s32ActiveNoI /* r19 */, signed int s32SpeedI /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40C4C0 -> 0x40C818
        signed int s32yBack; // r23
        class stcScriptWave * psWave; // r17
        class clsScript_Task & rcScript_Task; // r2
    }
}


// Range: 0x40C820 -> 0x40C858
void codeWaveEnd() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40C820 -> 0x40C858
...
// Range: 0x40C860 -> 0x40C89C
void codeWave(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40C860 -> 0x40C89C
        class tagstcScriptFuncLineData * psLine; // r2
        unsigned int u32TaskZ; // r2
        float * pf32wait; // r2
    }
}


// Range: 0x40C8A0 -> 0x40C9B0
void * __ct(class clsScriptWave_Task * this /* r17 */, unsigned char u8PriorityType /* r2 */, float f32EndFrame /* r21 */, float f32WaitFrame /* r20 */, class clsTask * pcTask /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40C8A0 -> 0x40C9B0
        class clsScript_Task & rcScript_Task; // r2
...
// Range: 0x40C9B0 -> 0x40CB5C
void draw(class clsScriptNega_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40C9B0 -> 0x40CB5C
...
// Range: 0x40CB60 -> 0x40CDBC
void execute(class clsScriptNega_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40CB60 -> 0x40CDBC
        signed int s32n; // r6
        class stcScriptNega * psNega; // r2
    }
}


// Range: 0x40CDC0 -> 0x40D454
signed int DebugNega(signed int s32xI /* r16 */, signed int s32yI /* r18 */, signed int s32ActiveNoI /* r22 */, signed int s32SpeedI /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40CDC0 -> 0x40D454
        signed int s32yBack; // r23
        class stcScriptNega * psNega; // r19
        class clsScript_Task & rcScript_Task; // r2
    }
}


// Range: 0x40D460 -> 0x40D470
void codeNegaEnd(unsigned char * pu8Ptr /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40D460 -> 0x40D470
    }
...
// Range: 0x40D470 -> 0x40D4B4
void codeNega(unsigned char * pu8Ptr /* r4 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40D470 -> 0x40D4B4
        class tagstcScriptFuncLineData * psLine; // r2
...
// Range: 0x40D4C0 -> 0x40D5B0
void * __ct(class clsScriptNega_Task * this /* r19 */, unsigned char u8PriorityType /* r2 */, unsigned char u8Type /* r18 */, unsigned char u8rgb /* r17 */, float f32Frame /* r23 */, float f32SubFrame /* r22 */, float f32EndFrame /* r21 */, float f32WaitFrame /* r20 */, class clsTask * pcTask /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40D4C0 -> 0x40D5B0
    }
