/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Script\ScriptModel.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcGimickSubParam ScriptBackLineSubParam; // size: 0x20, address: 0x67E730
struct /* @anon1 */ {
    // total size: 0x30
} __vt__19clsScriptModel_Task; // size: 0x30, address: 0x6BF810
...
class NNS_VECTOR tosZeroVec; // size: 0xC, address: 0x67E7C0
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x67E780
...
// Range: 0x37EDA0 -> 0x37F058
void draw(class clsScriptModel_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37EDA0 -> 0x37F058
        unsigned char bDebugShepre; // r21
        float sDrawMtx[4][4]; // r29+0xF0
        class clsScriptModel_Task * pcModel_Task; // r2
        float (* psMtxList)[4][4]; // r20
        class NNS_VECTOR sPosVec; // r29+0x130
        float (* psMtxList)[4][4]; // r19
        float sCalcMtx[4][4]; // r29+0xB0
    }
}


// Range: 0x37F060 -> 0x37F664
void drawModel(class clsScriptModel_Task * this /* r21 */, float (* psDrawMtx)[4][4] /* r29+0xF0 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37F060 -> 0x37F664
        class NNS_MOTION * psMot; // r29+0xE0
        class NNS_MOTION * psMatMot; // r20
        class NNS_MOTION * psMofMot; // r19
        class NNS_OBJECT * psMatObj; // r22
        unsigned int * psMatStatus; // r29+0xD0
        class NNS_OBJECT * psMorphObj; // r23
        float * pf32MorphWaitPallet; // r30
        float (* psMtxPal)[4][4]; // r18
        unsigned int * psNodeStat; // r17
        float sDrawMtx[4][4]; // r29+0x150
        class NNS_VECTORFAST sCameraTarget; // r29+0x140
        unsigned int u32DrawFlag; // r16
        class NNS_VECTORFAST sClipPos; // r29+0x130
        class NNS_VECTORFAST sDotVec1; // r29+0x120
        class NNS_VECTORFAST sDotVec2; // r29+0x110
        class NNS_VECTORFAST sDistVec; // r29+0x100
        float f32Inten; // r29+0x190
        float f32ClipDist; // r29+0x190
        signed int s32n; // r8
    }
}


// Range: 0x37F670 -> 0x37F824
void execute(class clsScriptModel_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37F670 -> 0x37F824
        signed int s32n; // r8
...
// Range: 0x37F830 -> 0x37F97C
void calcMtx(class clsScriptModel_Task * this /* r17 */, unsigned char bCalcMtx /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37F830 -> 0x37F97C
    }
...
// Range: 0x37F980 -> 0x37FCBC
void executeModel(class clsScriptModel_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37F980 -> 0x37FCBC
    }
...
// Range: 0x37FCC0 -> 0x380100
void update(class clsScriptModel_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37FCC0 -> 0x380100
        signed int s32n; // r17
...
// Range: 0x380100 -> 0x380174
void releaseOldMorpf(class clsScriptModel_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x380100 -> 0x380174
    }
...
// Range: 0x380180 -> 0x38022C
void getNodeMtx(class clsScriptModel_Task * this /* r4 */, float (* psDstMtx)[4][4] /* r18 */, unsigned int u32NodeNo /* r17 */, float (* psMtxList)[4][4] /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x380180 -> 0x38022C
        class NNS_MOTION * psMot; // r2
    }
}


// Range: 0x380230 -> 0x380300
void getNodePos(class clsScriptModel_Task * this /* r20 */, class NNS_VECTOR * psDstVec /* r19 */, unsigned int u32NodeNo /* r18 */, float (* psMtxList)[4][4] /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x380230 -> 0x380300
        class NNS_MOTION * psMot; // r16
        float sCalcMtx[4][4]; // r29+0x60
    }
}


// Range: 0x380300 -> 0x38031C
void setWaitFrame(class clsScriptModel_Task * this /* r2 */, float f32Frame /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x380300 -> 0x38031C
    }
...
// Range: 0x380320 -> 0x38036C
void setNodeOffset(class clsScriptModel_Task * this /* r2 */, unsigned int u32Type /* r2 */, unsigned int u32ModelNo /* r2 */, unsigned int u32NodeNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x380320 -> 0x38036C
    }
...
// Range: 0x380370 -> 0x3804A4
void setBackLineEffect(class clsScriptModel_Task * this /* r18 */, signed int s32No /* r2 */, unsigned int u32NodeNo /* r2 */, signed int s32DataNum /* r2 */, float f32Width /* r29+0x40 */, float f32Height /* r29+0x40 */, float f32OfsX /* r29+0x40 */, float f32OfsY /* r29+0x40 */, float f32OfsZ /* r29+0x40 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x380370 -> 0x3804A4
    }
...
// Range: 0x3804B0 -> 0x3804E0
void clearBackLineEffect(class clsScriptModel_Task * this /* r2 */, signed int s32No /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3804B0 -> 0x3804E0
    }
...
// Range: 0x3804E0 -> 0x380544
void dispBackLineEffect(class clsScriptModel_Task * this /* r2 */, unsigned int u32Show /* r2 */, signed int s32No /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3804E0 -> 0x380544
    }
...
// Range: 0x380550 -> 0x380668
void * __dt(class clsScriptModel_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x380550 -> 0x380668
        signed int s32n; // r17
...
// Range: 0x380670 -> 0x38099C
void * __ct(class clsScriptModel_Task * this /* r21 */, signed int s32No /* r20 */, unsigned int u32Tp /* r19 */, unsigned int u32TexNo /* r18 */, unsigned int u32Loop /* r17 */, unsigned int u32Show /* r16 */, class clsTask * pcTask /* r22 */, unsigned char u8TexNo /* r23 */, unsigned char u8FrameTexModel /* r29+0x90 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x380670 -> 0x38099C
        signed int s32n; // r20
