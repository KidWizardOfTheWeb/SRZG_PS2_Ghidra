/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Script\ScriptParticle.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon2 */ {
    // total size: 0x30
} __vt__22clsScriptParticle_Task; // size: 0x30, address: 0x6C15D0
struct /* @anon0 */ {
    // total size: 0x30
...
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x681790
struct /* @anon1 */ {
    // total size: 0x2C
...
class clsScriptParticle_Task : public clsTask {
    // total size: 0xE0
public:
    unsigned int m_u32View; // offset 0x54, size 0x4
    unsigned int m_u32Code; // offset 0x58, size 0x4
    unsigned int m_u32ModelNo; // offset 0x5C, size 0x4
    unsigned int m_u32NodeNo; // offset 0x60, size 0x4
    class NNS_VECTOR m_sOfsVec; // offset 0x64, size 0xC
    float m_f32InterFrame; // offset 0x70, size 0x4
    float m_f32PlayFrame; // offset 0x74, size 0x4
    float m_f32Frame; // offset 0x78, size 0x4
    float m_f32EndFrame; // offset 0x7C, size 0x4
    float m_f32WaitFrame; // offset 0x80, size 0x4
    class NNS_VECTORFAST m_sPosVecFast; // offset 0x90, size 0x10
    float m_sMatrix[4][4]; // offset 0xA0, size 0x40
};
...
// Range: 0x3BB400 -> 0x3BB6DC
void execute(class clsScriptParticle_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BB400 -> 0x3BB6DC
        class clsScript_Task * pcScript; // r2
        class clsScriptModel_Task * pcModelTask; // r18
        class NNS_VECTOR sPosVec; // r29+0x40
    }
}


// Range: 0x3BB6E0 -> 0x3BB7C8
void codeParticle(unsigned char * pu8Ptr /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BB6E0 -> 0x3BB7C8
        class tagstcScriptFuncLineData * psLine; // r2
        unsigned int u32View; // r21
        unsigned int u32DataNo; // r20
        float * pf32x; // r2
        float * pf32y; // r2
        float * pf32z; // r2
        unsigned int u32ModelNo; // r19
...
// Range: 0x3BB7D0 -> 0x3BB8E4
void * __ct(class clsScriptParticle_Task * this /* r20 */, unsigned int u32View /* r19 */, unsigned int u32Code /* r18 */, float f32OfsX /* r26 */, float f32OfsY /* r25 */, float f32OfsZ /* r24 */, unsigned int u32ModelNo /* r17 */, unsigned int u32NodeNo /* r16 */, float f32InterFrame /* r23 */, float f32StartFrame /* r22 */, float f32EndFrame /* r21 */, float f32Wait /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BB7D0 -> 0x3BB8E4
    }
