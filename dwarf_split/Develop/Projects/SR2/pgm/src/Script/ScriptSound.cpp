/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Script\ScriptSound.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
signed int ScriptBgmStartGap[14]; // size: 0x38, address: 0x0
...
// Range: 0x383540 -> 0x3835F8
void codeBgm(unsigned char * pu8Ptr /* r2 */, class clsScript_Task * pcTask /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x383540 -> 0x3835F8
        class tagstcScriptFuncLineData * psLine; // r2
        char ac8Str[255]; // r29+0x20
        char * pac8VoiceLang[2]; // r29+0x128
    }
}
