/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Script\ScriptFrameTex.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x30
} __vt__28clsScriptCreateFrameTex_Task; // size: 0x30, address: 0x6C1C90
...
// Range: 0x3DFF20 -> 0x3E0064
void draw(class clsScriptCreateFrameTex_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DFF20 -> 0x3E0064
    }
...
// Range: 0x3E0070 -> 0x3E00C0
void execute(class clsScriptCreateFrameTex_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E0070 -> 0x3E00C0
    }
...
// Range: 0x3E00C0 -> 0x3E0364
void createTexture(class clsScriptCreateFrameTex_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E00C0 -> 0x3E0364
        class PXS_CONTEXTBUFFER * sCb; // r17
        unsigned char au8CbBuf[224]; // r29+0x90
        unsigned int u32DrawAddr; // r2
        unsigned int u32TexAddr; // r2
        unsigned int pos; // r16
        signed int s32GsH; // r21
        unsigned int u32FBZ; // r22
    }
}


// Range: 0x3E0370 -> 0x3E03C4
void update(class clsScriptCreateFrameTex_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E0370 -> 0x3E03C4
    }
...
// Range: 0x3E03D0 -> 0x3E0464
void * __dt(class clsScriptCreateFrameTex_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E03D0 -> 0x3E0464
    }
...
// Range: 0x3E0470 -> 0x3E0584
void * __ct(class clsScriptCreateFrameTex_Task * this /* r16 */, unsigned char u8TexNo /* r18 */, class clsScript_Task * pcParrent /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E0470 -> 0x3E0584
        class _NNS_TEXINFO * psNnTexInfo; // r2
    }
}
