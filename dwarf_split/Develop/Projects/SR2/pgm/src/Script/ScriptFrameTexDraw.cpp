/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Script\ScriptFrameTexDraw.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon1 */ {
    // total size: 0x30
} __vt__26clsScriptDrawFrameTex_Task; // size: 0x30, address: 0x6C1D00
struct /* @anon0 */ {
    // total size: 0x30
...
// Range: 0x3E0910 -> 0x3E09B8
void draw(class clsScriptDrawFrameTex_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E0910 -> 0x3E09B8
    }
...
// Range: 0x3E09C0 -> 0x3E0B3C
void drawPolygon(class clsScriptDrawFrameTex_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E09C0 -> 0x3E0B3C
        float sMatUni[4][4]; // r29+0x100
        unsigned char u8ScreenMode; // r2
        class NNS_PRIM3D_PCT asPrim3D[2][4]; // r29+0x40
        class NNS_PRIM3D_PCT * psPrim3D; // r18
        class NNS_VECTOR * psVecTmp; // r2
    }
}


// Range: 0x3E0B40 -> 0x3E0B88
void update(class clsScriptDrawFrameTex_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E0B40 -> 0x3E0B88
    }
...
// Range: 0x3E0B90 -> 0x3E0BB4
void setParam(class clsScriptDrawFrameTex_Task * this /* r2 */, float f32PosX /* r29 */, float f32PosY /* r29 */, float f32Width /* r29 */, float f32Height /* r29 */, float f32PosZ /* r29 */, float f32RotX /* r29 */, float f32RotY /* r29 */, float f32RotZ /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E0B90 -> 0x3E0BB4
    }
...
// Range: 0x3E0BC0 -> 0x3E0C60
void * __ct(class clsScriptDrawFrameTex_Task * this /* r19 */, unsigned char u8TexNo /* r18 */, class clsScript_Task * pcParrent /* r17 */, class clsScriptCreateFrameTex_Task * pcTextureTask /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E0BC0 -> 0x3E0C60
    }
