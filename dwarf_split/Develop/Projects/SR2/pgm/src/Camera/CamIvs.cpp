/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Camera\CamIvs.cpp
...
struct /* @anon1 */ {
    // total size: 0x18
} __vt__16clsLandDownCamIv; // size: 0x18, address: 0x6BBFB0
struct /* @anon0 */ {
    // total size: 0x18
} __vt__12clsCamIvBase; // size: 0x18, address: 0x6BBFD0
...
// Range: 0x305380 -> 0x3053A0
void Init(class clsLandDownCamIv * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x305380 -> 0x3053A0
    }
...
// Range: 0x3053A0 -> 0x3056CC
unsigned int PostIv(class clsLandDownCamIv * this /* r17 */, class clsPfCamera * pcCamera /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3053A0 -> 0x3056CC
        class NNS_VECTOR sDownLV; // r29+0x40
        class NNS_VECTOR sBeforeLV; // r29+0x30
    }
}


// Range: 0x3056D0 -> 0x30570C
unsigned int PreIv(class clsLandDownCamIv * this /* r2 */, class clsPfCamera * pcCamera /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3056D0 -> 0x30570C
    }
