/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Main2.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class clsMain tcMain; // size: 0x10, address: 0xBFA7E0
signed int ts32_1st; // size: 0x4, address: 0xBFA7F8
unsigned int SOFRE_BUTTONS; // size: 0x4, address: 0x0
...
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x6972C0
signed int m_tos32DefAlign; // size: 0x4, address: 0x6865E0
void cancelRead(enum enmFontNo); // size: 0x0, address: 0x55BCF0
void createFontReadTask(unsigned int, signed int, class clsSrFontSystem *, enum enmFontNo, signed int, void *, unsigned char, void *); // size: 0x0, address: 0x55BF00
...
struct /* @anon12 */ {
    // total size: 0x30
} __vt__14clsWakeup_Task; // size: 0x30, address: 0x6C6500
struct /* @anon38 */ {
    // total size: 0x30
} __vt__18clsBaseWakeup_Task; // size: 0x30, address: 0x6C6530
struct /* @anon32 */ {
    // total size: 0x30
...
class stcGhostSaveData * t_psSaveBuf; // size: 0x4, address: 0xB15E28
unsigned char * _AlwaysOnTextureStart2; // size: 0x4, address: 0x6A0400
...
struct /* @anon28 */ {
    // total size: 0x44
} __vt__8clsPfFog; // size: 0x44, address: 0x6CEDC0
struct /* @anon13 */ {
    // total size: 0x2C
} __vt__8clsOOFog; // size: 0x2C, address: 0x6CEE10
struct /* @anon18 */ {
    // total size: 0xC
} __vt__23clsSingleton<8clsPfFog>; // size: 0xC, address: 0x6CEE40
struct /* @anon20 */ {
    // total size: 0x18
} __vt__12clsPfVecCalc; // size: 0x18, address: 0x6CEE50
struct /* @anon9 */ {
    // total size: 0xC
} __vt__12clsOOVecCalc; // size: 0xC, address: 0x6CEE68
struct /* @anon1 */ {
    // total size: 0xC
} __vt__28clsSingleton<12clsPfVecCalc>; // size: 0xC, address: 0x6CEE78
struct /* @anon37 */ {
    // total size: 0xC
} __vt__12clsOOProfile; // size: 0xC, address: 0x6CEE88
struct /* @anon46 */ {
    // total size: 0xC
} __vt__28clsSingleton<12clsOOProfile>; // size: 0xC, address: 0x6CEE98
struct /* @anon29 */ {
    // total size: 0x20
} __vt__15clsPfDebugPrint; // size: 0x20, address: 0x6CEEB0
struct /* @anon23 */ {
    // total size: 0x10
} __vt__15clsOODebugPrint; // size: 0x10, address: 0x6CEED0
struct /* @anon30 */ {
    // total size: 0xC
} __vt__31clsSingleton<15clsPfDebugPrint>; // size: 0xC, address: 0x6CEEE0
struct /* @anon27 */ {
    // total size: 0x2C
...
struct /* @anon11 */ {
    // total size: 0xC
} __vt__7clsPack; // size: 0xC, address: 0x6CEEF0
struct /* @anon33 */ {
    // total size: 0xC
} __vt__22clsSingleton<7clsPack>; // size: 0xC, address: 0x6CEF00
struct /* @anon7 */ {
    // total size: 0xC
} __vt__11clsPathData; // size: 0xC, address: 0x6CEF10
struct /* @anon4 */ {
    // total size: 0xC
} __vt__13clsSrPlatform; // size: 0xC, address: 0x6CEF20
struct /* @anon51 */ {
    // total size: 0xC
} __vt__29clsSingleton<13clsSrPlatform>; // size: 0xC, address: 0x6CEF30
struct /* @anon14 */ {
    // total size: 0xC
} __vt__13clsTimeAtkMgr; // size: 0xC, address: 0x6CEF40
struct /* @anon39 */ {
    // total size: 0xC
} __vt__13clsWorldGpMgr; // size: 0xC, address: 0x6CEF50
struct /* @anon6 */ {
    // total size: 0xC
} __vt__11clsStoryMgr; // size: 0xC, address: 0x6CEF60
struct /* @anon34 */ {
    // total size: 0xC
} __vt__10clsGameMgr; // size: 0xC, address: 0x6CEF70
struct /* @anon25 */ {
    // total size: 0xC
} __vt__26clsSingleton<10clsGameMgr>; // size: 0xC, address: 0x6CEF80
struct /* @anon24 */ {
    // total size: 0x18
} __vt__12clsOOTexture; // size: 0x18, address: 0x6B8B10
struct /* @anon47 */ {
    // total size: 0x18
} __vt__17clsOOSplitTexture; // size: 0x18, address: 0x6B8AF0
struct /* @anon8 */ {
    // total size: 0x10
} __vt__16clsPfTextureBase; // size: 0x10, address: 0x6B8AE0
struct /* @anon45 */ {
    // total size: 0x28
} __vt__17clsPfSplitTexture; // size: 0x28, address: 0x6B8AB0
struct /* @anon5 */ {
    // total size: 0x4C
...
struct /* @anon48 */ {
    // total size: 0xC
} __vt__31clsSingleton<15clsSrPadSetting>; // size: 0xC, address: 0x6C0770
struct /* @anon22 */ {
    // total size: 0xC
} __vt__15clsSrPadSetting; // size: 0xC, address: 0x6C0760
struct /* @anon40 */ {
    // total size: 0xC
} __vt__29clsSingleton<13clsPfFlashMgr>; // size: 0xC, address: 0x6CEF90
struct /* @anon44 */ {
    // total size: 0xC
} __vt__13clsOOFlashMgr; // size: 0xC, address: 0x6C9EF8
struct /* @anon10 */ {
    // total size: 0x18
} __vt__13clsPfFlashMgr; // size: 0x18, address: 0x6CEFA0
struct /* @anon26 */ {
    // total size: 0xC
} __vt__19clsCollisionManager; // size: 0xC, address: 0x6CEFB8
struct /* @anon41 */ {
    // total size: 0xC
} __vt__28clsSingleton<12clsPfFileMgr>; // size: 0xC, address: 0x6B8890
struct /* @anon17 */ {
    // total size: 0xC
} __vt__30clsSingleton<14clsPfCameraMgr>; // size: 0xC, address: 0x6CEFC8
struct /* @anon3 */ {
    // total size: 0xC
} __vt__14clsOOCameraMgr; // size: 0xC, address: 0x6CEFD8
struct /* @anon16 */ {
    // total size: 0x18
} __vt__14clsPfCameraMgr; // size: 0x18, address: 0x6CEFF0
struct /* @anon36 */ {
    // total size: 0xC
} __vt__23clsSingleton<8clsDebug>; // size: 0xC, address: 0x6B59C0
struct /* @anon31 */ {
    // total size: 0xC
} __vt__8clsDebug; // size: 0xC, address: 0x6B59B0
struct /* @anon15 */ {
    // total size: 0xC
} __vt__13clsBitset<Uc>; // size: 0xC, address: 0x6C8348
struct /* @anon19 */ {
    // total size: 0xC
} __vt__30clsSingleton<14clsSaveDataMgr>; // size: 0xC, address: 0x6CF008
struct /* @anon50 */ {
    // total size: 0xC
} __vt__14clsSaveDataMgr; // size: 0xC, address: 0x6CF018
...
struct /* @anon49 */ {
    // total size: 0xC
} __vt__27clsSingleton<11clsPathData>; // size: 0xC, address: 0x6CF038
class clsCollisionManager * m_tpcSingleton; // size: 0x4, address: 0x703C18
struct /* @anon0 */ {
    // total size: 0xC
} __vt__35clsSingleton<19clsCollisionManager>; // size: 0xC, address: 0x6CF028
...
class clsPfFlashMgr * m_tpcSingleton; // size: 0x4, address: 0xB0D990
...
class clsPfDebugPrint * m_tpcSingleton; // size: 0x4, address: 0x707E70
...
public:
    ...
    class clsOOHeapFragment * m_pcTaskManWorkHeap; // offset 0x4, size 0x4
    unsigned int m_bSoftResetLateDone; // offset 0x8, size 0x4
    unsigned int m_bSoftReset; // offset 0xC, size 0x4
};
class clsSingleton {
    // total size: 0x4
};
...
class stcGhostSaveData {
    // total size: 0xFD40
public:
    unsigned int u32CrcData; // offset 0x0, size 0x4
    unsigned int u32GoalTimeMSec; // offset 0x4, size 0x4
    class stcSendAdv sCharaLoadParam; // offset 0x8, size 0x4
    unsigned int u4StageNoSub1 : 4; // offset 0xC, size 0x4
    unsigned int u1IsUsed : 1; // offset 0xC, size 0x4
    unsigned int u1FrameRate : 1; // offset 0xC, size 0x4
    unsigned int u2Padding : 2; // offset 0xC, size 0x4
    unsigned int u8Version : 8; // offset 0xC, size 0x4
    unsigned int u8Padding1 : 8; // offset 0xC, size 0x4
    unsigned int u8Padding2 : 8; // offset 0xC, size 0x4
    class stcGhostDataBuf sBuf; // offset 0x10, size 0xFD24
    unsigned char u8Padding[12]; // offset 0xFD34, size 0xC
};
enum enmStiffType {
    STIFF_TYPE__ALL = 0,
    STIFF_TYPE__LEVER = 1,
...
class clsPfDebugPrint : public clsSingleton, public clsOODebugPrint {
    // total size: 0x14
};
class hkArray {
    // total size: 0xC
...
class clsPfFlashMgr : public clsSingleton, public clsOOFlashMgr {
    // total size: 0x1C
};
...
class clsOODebugPrint {
    // total size: 0x10
public:
    signed int m_s32SizeW; // offset 0x4, size 0x4
    signed int m_s32SizeH; // offset 0x8, size 0x4
    signed char m_s8StartPointX; // offset 0xC, size 0x1
    signed char m_s8StartPointY; // offset 0xD, size 0x1
    signed char m_s8NowPosY; // offset 0xE, size 0x1
};
class hkBool {
    // total size: 0x1
public:
...
// Range: 0x53E5B0 -> 0x53E660
void setReset(class clsMain * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53E5B0 -> 0x53E660
    }
...
// Range: 0x53EC70 -> 0x53EDD4
void respawn() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53EC70 -> 0x53EDD4
        class clsPfCri & rcOOCri; // r2
        class clsGameMgr & rcGameMgr; // r20
    }
}


// Range: 0x53F070 -> 0x53F480
void loop(class clsMain * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53F070 -> 0x53F480
        class clsPfSystem & rcOOSystem; // r18
        class clsTaskManager & rcTaskMan; // r2
        class clsPfPeripheral & rcOOPeripheral; // r17
    }
}


// Range: 0x53F570 -> 0x53F9A4
void reinit() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53F570 -> 0x53F9A4
        ...
        class clsSrCamMixer * pcSrCamMix; // r2
    }
}


// Range: 0x5401D0 -> 0x540204
void init_Debug() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5401D0 -> 0x540204
...
// Range: 0x540AE0 -> 0x540CDC
void gHeapOR_Debug() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x540AE0 -> 0x540CDC
        unsigned int tu32Cnt; // @ 0x00BFA7F0
    }
}


// Range: 0x541170 -> 0x54118C
void * __ct(class clsSingleton * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x541170 -> 0x54118C
    }
...
// Range: 0x5411B0 -> 0x541204
void * __dt(class clsSingleton * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5411B0 -> 0x541204
    }
...
// Range: 0x541210 -> 0x54121C
class clsPathData & RS() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x541210 -> 0x54121C
    }
...
// Range: 0x5412C0 -> 0x5412CC
class clsPfGraphics * GS() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5412C0 -> 0x5412CC
    }
...
// Range: 0x5412D0 -> 0x5412DC
class clsPfDebugPrint & RS() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5412D0 -> 0x5412DC
    }
