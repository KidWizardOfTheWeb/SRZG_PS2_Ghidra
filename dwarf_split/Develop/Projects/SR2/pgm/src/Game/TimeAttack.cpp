/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Game\TimeAttack.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class _NNS_TEXLIST * psTexList_TimeAttack2D; // size: 0x4, address: 0xB17500
class stcSize2d osTexSize[1]; // size: 0x4, address: 0x0
static unsigned int TIMEATTACK_RANKING_WAIT_TIME; // size: 0x4, address: 0x0
static unsigned int GHOSTSAVE_WAIT_TIME; // size: 0x4, address: 0x6894E8
struct /* @anon3 */ {
    // total size: 0xAC
} __vt__18clsTimeAttack_Task; // size: 0xAC, address: 0x6C77E0
class clsPfMemoryCard * m_tpcSingleton; // size: 0x4, address: 0xB0D978
unsigned char checkGhostDataCrc(void *); // size: 0x0, address: 0x38D090
...
class clsTimeAttack_Task : public clsBaseRace_Task {
    // total size: 0xCD4
public:
    class clsGhost * m_pcGhostTask; // offset 0xCB0, size 0x4
    class stcSendAdv * m_psGhostLoadData; // offset 0xCB4, size 0x4
    void * m_pvTimeAttack2DBuff; // offset 0xCB8, size 0x4
    void * m_pvMemoCaIconBuff; // offset 0xCBC, size 0x4
    unsigned char m_bRPauseCancel; // offset 0xCC0, size 0x1
    unsigned char m_bBestTime; // offset 0xCC1, size 0x1
    signed int m_s32OldTime; // offset 0xCC4, size 0x4
    float m_f32SaveWait; // offset 0xCC8, size 0x4
    unsigned int m_u32SaveMode; // offset 0xCCC, size 0x4
    unsigned char m_bGhostSave; // offset 0xCD0, size 0x1
    unsigned char m_bGhostOneSave; // offset 0xCD1, size 0x1
};
...
public:
    ...
    unsigned short h; // offset 0x2, size 0x2
};
class compressed_pair_imp : private allocator {
    // total size: 0x4
public:
...
// Range: 0x483A00 -> 0x483A08
void checkPauseResult(class clsTimeAttack_Task * this /* r2 */, signed int bOnI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x483A00 -> 0x483A08
    }
...
// Range: 0x483A10 -> 0x483B98
unsigned char saveGhostData(class clsTimeAttack_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x483A10 -> 0x483B98
    }
...
// Range: 0x483BA0 -> 0x483E48
unsigned char loadGhostData(class clsTimeAttack_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x483BA0 -> 0x483E48
        char __FUNCTION__[17]; // @ 0x006894D0
    }
}


// Range: 0x483E80 -> 0x484040
void execute(class clsTimeAttack_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x483E80 -> 0x484040
    }
...
// Range: 0x484040 -> 0x484104
void setBestTime(class clsTimeAttack_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x484040 -> 0x484104
...
// Range: 0x484110 -> 0x484194
unsigned char packEtc(class clsTimeAttack_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x484110 -> 0x484194
    }
...
// Range: 0x4841A0 -> 0x48425C
void requestReadEtc(class clsTimeAttack_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4841A0 -> 0x48425C
    }
...
// Range: 0x484260 -> 0x4842AC
void addReadCharaMotion(class clsTimeAttack_Task * this /* r4 */, class vector * pcCharaMotionList /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x484260 -> 0x4842AC
    }
...
// Range: 0x4842B0 -> 0x484378
void addReadGear(class clsTimeAttack_Task * this /* r2 */, class clsOOSet * pcGearList /* r18 */, unsigned int * pu32GearLoadCnt /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4842B0 -> 0x484378
...
// Range: 0x484380 -> 0x484404
void addReadChara(class clsTimeAttack_Task * this /* r17 */, class clsOOSet * pcCharaList /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x484380 -> 0x484404
...
// Range: 0x484410 -> 0x484620
void createGhostTask(class clsTimeAttack_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x484410 -> 0x484620
        char __FUNCTION__[5]; // @ 0x006894C8
    }
}


// Range: 0x484680 -> 0x484780
void setPauseReslutScreen(class clsTimeAttack_Task * this /* r19 */, signed int s32PushPausePadNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x484680 -> 0x484780
    }
...
// Range: 0x484780 -> 0x4847EC
void setPauseScreen(class clsTimeAttack_Task * this /* r18 */, signed int s32PushPausePadNo /* r17 */, enum enmPadConnectDraw enConnectDraw /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x484780 -> 0x4847EC
    }
...
// Range: 0x4847F0 -> 0x48483C
void restart(class clsTimeAttack_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4847F0 -> 0x48483C
    }
...
// Range: 0x484840 -> 0x484854
void start(class clsTimeAttack_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x484840 -> 0x484854
    }
...
// Range: 0x484860 -> 0x4848FC
void * __dt(class clsTimeAttack_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x484860 -> 0x4848FC
    }
...
// Range: 0x484900 -> 0x4849CC
void * __ct(class clsTimeAttack_Task * this /* r16 */, signed int s32StageNoI /* r2 */, signed int s32PlayerNumI /* r2 */, signed int s32UserNumI /* r2 */, signed int s32LapNumI /* r8 */, class stcSendAdv * opsSendAdvI /* r17 */, void * * ppvMapBufferI /* r10 */, enum enmMode eModeI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x484900 -> 0x4849CC
    }
...
// Range: 0x484A70 -> 0x484A78
void @4@draw__8clsGhostFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x484A70 -> 0x484A78
    }
...
// Range: 0x484A80 -> 0x484A88
void @4@execute__8clsGhostFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x484A80 -> 0x484A88
    }
...
// Range: 0x484A90 -> 0x484A98
void @4@__dt__8clsGhostFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x484A90 -> 0x484A98
    }
