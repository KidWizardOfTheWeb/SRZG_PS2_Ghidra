/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Game\MissionRace.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32MissionBreakFrame; // size: 0x4, address: 0x6797C0
signed int sos32TrickPoint[7]; // size: 0x1C, address: 0x6797D0
class stcMissionRingAgp scosMissionRingAgp[20]; // size: 0xA0, address: 0x6797F0
float scosAgpPointRate[17]; // size: 0x44, address: 0x679890
float tof32Stage15_5GDiveActionRange; // size: 0x4, address: 0x0
void * m_pvMission2DPackBuffer; // size: 0x4, address: 0xB0D9D8
void * m_pvMissionStg2DPackBuffer; // size: 0x4, address: 0xB0D9E0
struct /* @anon6 */ {
    // total size: 0xC0
} __vt__19clsMissionRace_Task; // size: 0xC0, address: 0x6BE250
class stcTask sTask; // size: 0x30, address: 0xB0A900
class clsMissionMark_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A768
class clsMissionPathRobo_Task * m_tpcSingleton; // size: 0x4, address: 0xB0D9E8
class clsMissionPathTarget_Task * m_tpcSingleton; // size: 0x4, address: 0xB0D9F0
struct /* @anon1 */ {
    // total size: 0x3C
} __vt__17clsMission2D_Task; // size: 0x3C, address: 0x6BE390
struct /* @anon7 */ {
    // total size: 0x30
...
struct /* @anon8 */ {
    // total size: 0x3C
} __vt__24clsMissionMessage2D_Task; // size: 0x3C, address: 0x6BE340
...
struct /* @anon9 */ {
    // total size: 0x30
} __vt__17clsRaceRetry_Task; // size: 0x30, address: 0x6BE410
struct /* @anon4 */ {
    // total size: 0x30
} __vt__25clsSurvivalMessage2D_Task; // size: 0x30, address: 0x6BE310
class clsSaveDataMgr * m_tpcSingleton; // size: 0x4, address: 0x703BF0
class clsPack * m_tpcSingleton; // size: 0x4, address: 0xB0A950
struct /* @anon2 */ {
    // total size: 0x34
} __vt__24clsRacePauseMission_Task; // size: 0x34, address: 0x6BE3D0
struct /* @anon3 */ {
    // total size: 0x34
...
class _NNS_TEXLIST * psTexList_Mission2D; // size: 0x4, address: 0xB15EE0
...
class clsPathGravityObj_Obj : public clsRigidBodyGimmickObj {
    // total size: 0x220
public:
    class NNS_QUATERNION m_sInitRotQuat; // offset 0xD0, size 0x10
    enum enmPathMode m_enPathCarMode; // offset 0xE0, size 0x4
    class clsPosturalCtrl m_cPostural; // offset 0xF0, size 0xB0
    class clsPath m_cPath; // offset 0x1A0, size 0x60
    float m_f32Speed; // offset 0x200, size 0x4
    float m_f32TotalFrame; // offset 0x204, size 0x4
    float m_f32StartWaitFrame; // offset 0x208, size 0x4
    float m_f32EventFrame; // offset 0x20C, size 0x4
    unsigned char m_bObjRotChange; // offset 0x210, size 0x1
    unsigned char m_bPathChanged; // offset 0x211, size 0x1
    unsigned char m_bGravityFlag; // offset 0x212, size 0x1
    signed int m_s32LoopSe; // offset 0x214, size 0x4
    unsigned int m_u32Attr; // offset 0x218, size 0x4
};
...
class clsMissionPathTarget_Obj : public clsMissionTarget_Obj, public clsPathGravityObj_Obj {
    // total size: 0x260
public:
    class hkShape * m_pcPartsShape; // offset 0x250, size 0x4
};
...
class clsMissionMessage2D_Task : public clsTask, public clsScreen2D {
    // total size: 0xD4
public:
    class stcPos2D * m_opsPosVec; // offset 0x94, size 0x4
    unsigned int m_u32AnmType; // offset 0x98, size 0x4
    enum enuDrawMode m_eDrawModeNo; // offset 0x9C, size 0x4
    unsigned char * m_pbEndFlag; // offset 0xA0, size 0x4
    signed int m_s32CenterX; // offset 0xA4, size 0x4
    signed int m_s32CenterY; // offset 0xA8, size 0x4
    float m_f32Alpha; // offset 0xAC, size 0x4
    float m_f32AnmAlpha; // offset 0xB0, size 0x4
    float m_f32AnmFrame; // offset 0xB4, size 0x4
    float m_f32MoveX; // offset 0xB8, size 0x4
    float m_f32MoveY; // offset 0xBC, size 0x4
    float m_f32Scale; // offset 0xC0, size 0x4
    signed int m_s32Count; // offset 0xC4, size 0x4
    unsigned int m_u32ButtonCount; // offset 0xC8, size 0x4
    class clsMissionRace_Task * m_pcMissionRace; // offset 0xCC, size 0x4
    class clsPressStart_Task * m_pcPressStart2Quit_Task; // offset 0xD0, size 0x4
};
class hkMotionState {
    // total size: 0xC0
public:
...
public:
    class stcPos2D * m_opsPosVec; // offset 0x94, size 0x4
    enum enmMissionInfo m_eModoNo; // offset 0x98, size 0x4
    enum enuDrawMode m_eDrawModeNo; // offset 0x9C, size 0x4
    signed int m_s32DispNum; // offset 0xA0, size 0x4
    unsigned int m_u32Count; // offset 0xA4, size 0x4
    float m_f32MoveX; // offset 0xA8, size 0x4
    float m_f32Alpha; // offset 0xAC, size 0x4
    signed int m_s32ClrCondition; // offset 0xB0, size 0x4
    unsigned int m_u32GaugeMAX; // offset 0xB4, size 0x4
    signed int m_s32AddNumAnime; // offset 0xB8, size 0x4
    float m_f32Scale; // offset 0xBC, size 0x4
    float m_f32PosX; // offset 0xC0, size 0x4
    float m_f32PosY; // offset 0xC4, size 0x4
    unsigned char * m_pbEndFlag; // offset 0xC8, size 0x4
    class clsEnergyFlow2D * m_pcBaseLine; // offset 0xCC, size 0x4
    float m_f32EnergyFrame; // offset 0xD0, size 0x4
    float m_f32EnergyFrameMax; // offset 0xD4, size 0x4
    signed int m_s32BaseLinePosX; // offset 0xD8, size 0x4
    signed int m_s32BaseLinePosY; // offset 0xDC, size 0x4
    class clsMissionRace_Task * m_pcMissionRace; // offset 0xE0, size 0x4
};
class __vector_imp : private __vector_pod, private compile_assert {
    // total size: 0xC
};
...
class clsMissionPathTarget_Task : public clsSingleModelGimmick_Task, private clsMissionTarget {
    // total size: 0xA0
};
...
class clsMissionPathRobo_Obj : public clsMissionPathTarget_Obj {
    // total size: 0x2D0
public:
    float m_f32EffectFrame; // offset 0x260, size 0x4
    float m_sDrawMtx[4][4]; // offset 0x270, size 0x40
    class clsBackLineEffectTask * m_apcLineTask[2]; // offset 0x2B0, size 0x8
    unsigned char m_bStartFlag; // offset 0x2B8, size 0x1
    class clsMissionPathRoboCollision m_cCollision; // offset 0x2BC, size 0xC
};
...
class clsSurvivalMessage2D_Task : public clsTask {
    // total size: 0x8C
public:
    class stcPos2D * m_opsPosVec; // offset 0x54, size 0x4
    unsigned int m_u32AnmType; // offset 0x58, size 0x4
    enum enuDrawMode m_eDrawModeNo; // offset 0x5C, size 0x4
    unsigned char * m_pbEndFlag; // offset 0x60, size 0x4
    signed int m_s32CenterX; // offset 0x64, size 0x4
    signed int m_s32CenterY; // offset 0x68, size 0x4
    float m_f32Alpha; // offset 0x6C, size 0x4
    float m_f32AnmAlpha; // offset 0x70, size 0x4
    float m_f32AnmFrame; // offset 0x74, size 0x4
    float m_f32MoveX; // offset 0x78, size 0x4
    float m_f32MoveY; // offset 0x7C, size 0x4
    float m_f32Scale; // offset 0x80, size 0x4
    signed int m_s32Count; // offset 0x84, size 0x4
    unsigned int m_u32ViewNo; // offset 0x88, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsMissionPathTarget_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsMissionPathRobo_Task : public clsSingleModelGimmick_Task, private clsMissionTarget {
    // total size: 0xA0
};
class NNS_CAPSULE {
    // total size: 0x1C
...
class clsMissionMark_Task : public clsSingleModelGimmick_Task, private clsMissionTarget {
    // total size: 0xB8
};
class hkAgentEntry {
    // total size: 0x8
...
class clsPressStart_Task : public clsTask {
    // total size: 0x8C
public:
    signed int m_s32DrawX; // offset 0x54, size 0x4
    signed int m_s32DrawY; // offset 0x58, size 0x4
    signed int m_s32DrawW; // offset 0x5C, size 0x4
    signed int m_s32DrawH; // offset 0x60, size 0x4
    float m_f32LifeFrame; // offset 0x64, size 0x4
    signed int m_u32EndKey; // offset 0x68, size 0x4
    class _NNS_TEXLIST * m_psTexList; // offset 0x6C, size 0x4
    class stcTexUV m_sTexUv; // offset 0x70, size 0x10
    signed char m_s8PadNo; // offset 0x80, size 0x1
    signed char m_s8TexNo; // offset 0x81, size 0x1
    enum enmArgPauseUnDraw m_ePauseUnDraw; // offset 0x84, size 0x4
    enum enmArgOwnDeleteIsAll m_eOwnDeleteIsAll; // offset 0x88, size 0x4
};
class hkInplaceArray : public hkArray {
    // total size: 0x10
public:
...
class clsMissionTarget {
    // total size: 0xC
public:
    unsigned int m_u32ObjectNum; // offset 0x4, size 0x4
    unsigned char * m_pu8Broken; // offset 0x8, size 0x4
};
class hkPadSpu {
    // total size: 0x4
public:
...
class stcMissionRingAgp {
    // total size: 0x8
public:
    signed short m_s16Ring; // offset 0x0, size 0x2
    float m_f32Agp; // offset 0x4, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsMissionPathRobo_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB_TX m_cModel; // offset 0x88, size 0x8
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0x90, size 0x4
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsMissionMark_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
...
class clsMissionPathRoboCollision : public clsBaseThroughCollision {
    // total size: 0xC
public:
    class clsMissionPathRobo_Obj * m_pcMissionPathRobo_Obj; // offset 0x8, size 0x4
};
class pair {
    // total size: 0x8
public:
...
class clsMissionTarget_Obj {
    // total size: 0x28
public:
    class clsRetPath m_cRetCoursePath; // offset 0x4, size 0x20
    unsigned char m_u8MoveFlag; // offset 0x24, size 0x1
};
class stcRect {
    // total size: 0x10
public:
...
// Range: 0x3530D0 -> 0x35317C
void settingPlayer(class clsMissionRace_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3530D0 -> 0x35317C
...
// Range: 0x353180 -> 0x353410
void start(class clsMissionRace_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x353180 -> 0x353410
    }
...
// Range: 0x353460 -> 0x353AFC
void Main(class clsMissionRace_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x353460 -> 0x353AFC
        class clsPlayerTask * pcPlayer; // r2
...
// Range: 0x353B00 -> 0x353B64
unsigned char checkGoalComPlayer(class clsMissionRace_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x353B00 -> 0x353B64
        unsigned int u32i; // r7
        unsigned int u32Count; // r6
    }
}


// Range: 0x353B70 -> 0x354CE0
void MissionChack(class clsMissionRace_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x353B70 -> 0x354CE0
        class clsPlayerTask * pcPlayer; // r2
        class clsScore2D_Task * pcScore; // r2
        signed int s32DrawX; // r2
        signed int s32DrawY; // r2
        signed char s8Rank; // r2
        class NNS_VECTORFAST * psPlayerPos; // r22
        class NNS_VECTORFAST * psTargetPos; // r23
        signed int s32Path; // r2
        signed int s32PlayerPathNo; // r2
        signed int s32i; // r16
        float f32Target; // r29+0xC0
        float f32Player; // r29+0xC0
        signed int s32Max; // r2
        unsigned int u32AttackHitFlg; // r2
        signed int s32i; // r9
...
// Range: 0x354CF0 -> 0x355588
void execute(class clsMissionRace_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x354CF0 -> 0x355588
        class clsPlayerTask * pcPlayer; // r18
    }
}


// Range: 0x355590 -> 0x3557E4
void setMissionClearUnlock(class clsMissionRace_Task * this /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x355590 -> 0x3557E4
        class clsSaveDataCtrl & rcSaveCtrl; // r2
        unsigned int u32UnLockStageNo; // r21
        unsigned int u32UnLockMissionNo; // r20
        unsigned int u32Check; // r19
        signed int s32n; // r18
    }
}


// Range: 0x3557F0 -> 0x355E40
signed char checkCondition(class clsMissionRace_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3557F0 -> 0x355E40
        signed char s8ClearRank; // r16
        class clsMissionRace_Task & rcMissionRace_Task; // r2
        class clsPlayerTask * pcPlayer; // r2
        signed int s32Time; // r2
        signed int s32Time; // r2
        signed int s32AGP; // r2
    }
}


// Range: 0x355E40 -> 0x355E48
void setClearUnlock(class clsMissionRace_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x355E40 -> 0x355E48
    }
...
// Range: 0x355E50 -> 0x356154
void wakeUpResult(class clsMissionRace_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x355E50 -> 0x356154
        class clsPlayerTask * pcPlayer; // r2
        unsigned int u32NowScore; // r17
        signed char * ps8RankCount; // r16
    }
}


// Range: 0x356160 -> 0x356254
void setPauseScreen(class clsMissionRace_Task * this /* r21 */, signed int s32PushPausePadNo /* r20 */, enum enmPadConnectDraw enConnectDraw /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x356160 -> 0x356254
    }
...
// Range: 0x356260 -> 0x3564EC
void restart(class clsMissionRace_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x356260 -> 0x3564EC
...
// Range: 0x3564F0 -> 0x3566C8
void getAddTime(class clsMissionRace_Task * this /* r2 */, unsigned int u32Sec /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3564F0 -> 0x3566C8
    }
...
// Range: 0x3566D0 -> 0x356834
void setMissionParam(class clsMissionRace_Task * this /* r19 */, unsigned char * pu8Dt /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3566D0 -> 0x356834
        class stcSendAdv sSendAdv[8]; // r29+0x50
        signed int s32PlayerNum; // r18
        signed int s32i; // r17
    }
}


// Range: 0x356840 -> 0x3568B4
unsigned char packEtc(class clsMissionRace_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x356840 -> 0x3568B4
    }
...
// Range: 0x3568C0 -> 0x356974
void requestReadEtc(class clsMissionRace_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3568C0 -> 0x356974
        enum enmLanguage eLang; // r2
        char ac8FileName[64]; // r29+0x40
    }
}


// Range: 0x356980 -> 0x3569F4
unsigned char isBestScore(class clsMissionRace_Task * this /* r2 */, unsigned int u32CheckBestScore /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x356980 -> 0x3569F4
        unsigned char bFlag; // r2
    }
}


// Range: 0x356A00 -> 0x356B70
void * __ct(class clsMissionRace_Task * this /* r16 */, signed int s32StageNoI /* r2 */, signed int s32MissionNoI /* r17 */, class stcSendAdv * opsSendAdvI /* r2 */, void * * ppvMapBufferI /* r2 */, enum enmMode eModeI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x356A00 -> 0x356B70
    }
...
// Range: 0x356B70 -> 0x356C80
void LoadTexture(enum enmMode eModeI /* r17 */, signed int s32StageNo /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x356B70 -> 0x356C80
        enum enmLanguage eLang; // r2
...
// Range: 0x356E40 -> 0x356E48
void @84@__dt__17clsMission2D_TaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x356E40 -> 0x356E48
    }
...
// Range: 0x356E50 -> 0x356E58
void @84@__dt__24clsMissionMessage2D_TaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x356E50 -> 0x356E58
    }
