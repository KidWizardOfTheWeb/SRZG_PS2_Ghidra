/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Game\WorldGp\WorldGpMgr.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static unsigned char oau8Points[8]; // size: 0x8, address: 0x693920
...
class stcRankCheck {
    // total size: 0x4
public:
    unsigned char u8PlayerNo; // offset 0x0, size 0x1
    unsigned char u8Rank; // offset 0x1, size 0x1
    signed short s16Point; // offset 0x2, size 0x2
};
...
// Range: 0x519220 -> 0x519400
void startResist(class clsWorldGpMgr * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x519220 -> 0x519400
        signed char oas8StageNo[15]; // r29+0x80
        signed char s8StageNo; // r2
    }
}


// Range: 0x519400 -> 0x519568
void updateRanking(class clsWorldGpMgr * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x519400 -> 0x519568
        class stcRankCheck asRankCheck[8]; // r29
        unsigned int u32i; // r7
        unsigned int u32j; // r13
        unsigned int u32PlayNum; // r2
        unsigned char u8RevRank; // r10
        unsigned char bRankUpdate; // r5
    }
}


// Range: 0x519570 -> 0x519588
void destroy(class clsWorldGpMgr * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x519570 -> 0x519588
    }
...
// Range: 0x519590 -> 0x5195A4
unsigned int getRankPoints(unsigned int u32I /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x519590 -> 0x5195A4
    }
...
// Range: 0x5195B0 -> 0x519668
void setPoints(class clsWorldGpMgr * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5195B0 -> 0x519668
        unsigned char * pu8Points; // r8
        signed int s32i; // r7
    }
}


// Range: 0x519670 -> 0x51968C
void setHbMode(class clsWorldGpMgr * this /* r2 */, unsigned int eHbModeI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x519670 -> 0x51968C
        unsigned char oau8[2]; // @ 0x00693928
    }
}


// Range: 0x519690 -> 0x519718
void reinit(class clsWorldGpMgr * this /* r16 */, unsigned int eHbModeI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x519690 -> 0x519718
    }
