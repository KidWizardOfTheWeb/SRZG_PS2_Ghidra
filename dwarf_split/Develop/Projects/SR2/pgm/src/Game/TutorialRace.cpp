/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Game\TutorialRace.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon6 */ {
    // total size: 0xC0
} __vt__20clsTutorialRace_Task; // size: 0xC0, address: 0x6CA710
struct /* @anon4 */ {
    // total size: 0xC0
...
struct /* @anon2 */ {
    // total size: 0x44
} __vt__8clsGhost; // size: 0x44, address: 0x6C7890
struct /* @anon8 */ {
    // total size: 0x30
} __vt__7clsTask; // size: 0x30, address: 0x6B59F0
class clsGhost * m_tpcSingleton; // size: 0x4, address: 0xB0D9D0
struct /* @anon0 */ {
    // total size: 0xC
} __vt__23clsSingleton<8clsGhost>; // size: 0xC, address: 0x6C78D8
...
struct /* @anon5 */ {
    // total size: 0x34
} __vt__25clsRacePauseTutorial_Task; // size: 0x34, address: 0x6CB1E0
struct /* @anon3 */ {
    // total size: 0x34
...
class clsTutorialRace_Task : public clsMissionRace_Task {
    // total size: 0xD64
public:
    class _NNS_TEXLIST * m_psTexList_TutorialUnion2D; // offset 0xD3C, size 0x4
    class _NNS_TEXLIST * m_psTexList_TutorialMine2D; // offset 0xD40, size 0x4
    class clsPressStart_Task * m_pcPressStart2Quit_Task; // offset 0xD44, size 0x4
    enum enmControlMode m_eControlMode; // offset 0xD48, size 0x4
    float m_f32TakeDrawSubjectTime; // offset 0xD4C, size 0x4
    float m_f32ResultTime; // offset 0xD50, size 0x4
    class clsGhost * m_pcGhostTask; // offset 0xD54, size 0x4
    class stcSendAdv * m_psGhostLoadData; // offset 0xD58, size 0x4
    class clsRacePauseTutorial_Task * m_pcRacePauseTutorial_Task; // offset 0xD5C, size 0x4
    unsigned char m_bDrawSubject_2D; // offset 0xD60, size 0x1
    unsigned char m_bDrawPractice_2D; // offset 0xD61, size 0x1
    unsigned char m_bAheadPressStart; // offset 0xD62, size 0x1
};
...
class stcGhostInfo {
    // total size: 0x70
public:
    class NNS_VECTORFAST sPos; // offset 0x0, size 0x10
    class NNS_QUATERNION sQuat; // offset 0x10, size 0x10
    float sDrawMatrix[4][4]; // offset 0x20, size 0x40
    unsigned char u8CharaType; // offset 0x60, size 0x1
    unsigned char bIsEnable; // offset 0x61, size 0x1
};
class clsRetPath {
    // total size: 0x20
public:
...
class stcGhostData_1F {
    // total size: 0x24
public:
    float f32PosX; // offset 0x0, size 0x4
    float f32PosY; // offset 0x4, size 0x4
    float f32PosZ; // offset 0x8, size 0x4
    float f32QuatX; // offset 0xC, size 0x4
    float f32QuatY; // offset 0x10, size 0x4
    float f32QuatZ; // offset 0x14, size 0x4
    float f32QuatW; // offset 0x18, size 0x4
    float f32CurveMotionRate; // offset 0x1C, size 0x4
    unsigned int u8MotionState : 8; // offset 0x20, size 0x4
    unsigned int u7MotionCurrentNo : 7; // offset 0x20, size 0x4
    unsigned int u1IsRide : 1; // offset 0x20, size 0x4
    unsigned int u4BaseMotType : 4; // offset 0x20, size 0x4
    unsigned int u4EquipsGears : 4; // offset 0x20, size 0x4
    unsigned int u5ActionType : 5; // offset 0x20, size 0x4
    unsigned int u1IsAttack : 1; // offset 0x20, size 0x4
    unsigned int u2Padding1 : 2; // offset 0x20, size 0x4
};
...
class clsGhost : public clsSingleton, public clsTask {
    // total size: 0xFE10
public:
    class clsPlayerGhost * m_pcGhostPlayer; // offset 0x58, size 0x4
    class clsPlayerTask * m_pcPlayer; // offset 0x5C, size 0x4
    class stcGhostDataBuf m_sWorkBuf; // offset 0x60, size 0xFD24
    unsigned char m_u8CurrentDataNo; // offset 0xFD84, size 0x1
    unsigned char m_u8StageNo; // offset 0xFD85, size 0x1
    unsigned char m_bIsFinished; // offset 0xFD86, size 0x1
    unsigned char m_bIsBuffOver; // offset 0xFD87, size 0x1
    unsigned int m_u32FrameCount; // offset 0xFD88, size 0x4
    unsigned int m_u32PosLinearInterpolationFrame; // offset 0xFD8C, size 0x4
    unsigned int m_u32PlayDataNum; // offset 0xFD90, size 0x4
    unsigned char m_bEnableSave; // offset 0xFD94, size 0x1
    unsigned char m_bStartFlag; // offset 0xFD95, size 0x1
    class stcGhostInfo m_sGhostInfo; // offset 0xFDA0, size 0x70
};
...
class clsRacePauseTutorial_Task : public clsBaseRacePause_Task {
    // total size: 0x64
public:
    class clsTutorialRace_Task & m_rcTutorialRace_Task; // offset 0x60, size 0x4
};
class hkMatrix3 {
    // total size: 0x30
public:
...
class stcGhostDataBuf {
    // total size: 0xFD24
public:
    unsigned int u32DataNum; // offset 0x0, size 0x4
    class stcGhostData_1F asData[1800]; // offset 0x4, size 0xFD20
};
enum enmRunMode {
    COM_RUN_MODE_HIGH = 0,
...
// Range: 0x4E5190 -> 0x4E51EC
void restart(class clsTutorialRace_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E5190 -> 0x4E51EC
    }
...
// Range: 0x4E51F0 -> 0x4E5258
void addReadCharaMotion(class clsTutorialRace_Task * this /* r17 */, class vector * pcCharaMotionList /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E51F0 -> 0x4E5258
    }
...
// Range: 0x4E5260 -> 0x4E5334
void addReadGear(class clsTutorialRace_Task * this /* r16 */, class clsOOSet * pcGearList /* r18 */, unsigned int * pu32GearLoadCnt /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E5260 -> 0x4E5334
...
// Range: 0x4E5340 -> 0x4E53CC
void addReadChara(class clsTutorialRace_Task * this /* r17 */, class clsOOSet * pcCharaList /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E5340 -> 0x4E53CC
        unsigned int u32IdxTmp; // r29+0x3C
    }
}


// Range: 0x4E53D0 -> 0x4E5524
void createGhostTask(class clsTutorialRace_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E53D0 -> 0x4E5524
        char __FUNCTION__[5]; // @ 0x00691C98
    }
}


// Range: 0x4E5530 -> 0x4E5930
void draw(class clsTutorialRace_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E5530 -> 0x4E5930
    }
...
// Range: 0x4E5B30 -> 0x4E5C28
void selectedPauseMenu_RET___ADD_EXT(class clsTutorialRace_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E5B30 -> 0x4E5C28
    }
...
// Range: 0x4E5C30 -> 0x4E5D14
void setPauseScreen(class clsTutorialRace_Task * this /* r19 */, signed int s32PushPausePadNo /* r18 */, enum enmPadConnectDraw enConnectDraw /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E5C30 -> 0x4E5D14
    }
...
// Range: 0x4E5D20 -> 0x4E5E34
void setClearUnlock(class clsTutorialRace_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E5D20 -> 0x4E5E34
    }
...
// Range: 0x4E5E40 -> 0x4E5F90
void wakeUpResult(class clsTutorialRace_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E5E40 -> 0x4E5F90
    }
...
// Range: 0x4E5F90 -> 0x4E614C
void execute(class clsTutorialRace_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E5F90 -> 0x4E614C
    }
