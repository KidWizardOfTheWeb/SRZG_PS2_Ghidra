/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Game\SurvivalRelayRace.cpp
...
static enum enmWalkType cosenmWalkRanSpeedType[17]; // size: 0x44, address: 0x691820
static signed int tos32BonusStepLength; // size: 0x4, address: 0x691868
static float tof32BonusSpeedTable[10]; // size: 0x28, address: 0x691870
static float tof32BonusAgpTable[10]; // size: 0x28, address: 0x6918A0
static float tof32BonusRateTable[10]; // size: 0x28, address: 0x6918D0
static unsigned char chk__tof32BonusSpeedTable_SizeCheck_[1]; // size: 0x1, address: 0x0
static unsigned char chk__tof32BonusAgpTable_SizeCheck_[1]; // size: 0x1, address: 0x0
static unsigned char chk__tof32BonusRateTable_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcCamFilter tof32StartInFilter; // size: 0x3C, address: 0x691900
static float cosf32WalkRanBack[17]; // size: 0x44, address: 0x691940
unsigned int m_u32BattleCount; // size: 0x4, address: 0xBFA6A0
unsigned int m_au32PlayerWinCount[2]; // size: 0x8, address: 0xBFA6A8
struct /* @anon1 */ {
    // total size: 0xAC
} __vt__25clsSurvivalRelayRace_Task; // size: 0xAC, address: 0x6CA0A0
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x6919F0
...
struct /* @anon2 */ {
    // total size: 0x30
} __vt__29clsCtrlIconSurvivalRelay_Task; // size: 0x30, address: 0x6D1530
struct /* @anon6 */ {
    // total size: 0x2C
...
public:
    ...
    signed short s16RankNo; // offset 0x4, size 0x2
...
// Range: 0x4DC460 -> 0x4DC650
void start(class clsSurvivalRelayRace_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DC460 -> 0x4DC650
    }
...
// Range: 0x4DC650 -> 0x4DC79C
void restart(class clsSurvivalRelayRace_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DC650 -> 0x4DC79C
        signed int s32i; // r4
...
// Range: 0x4DC7A0 -> 0x4DC86C
void Main(class clsSurvivalRelayRace_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DC7A0 -> 0x4DC86C
        class clsPlayerTask * pcPlayer; // r2
...
// Range: 0x4DC880 -> 0x4DCCE4
void execute(class clsSurvivalRelayRace_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DC880 -> 0x4DCCE4
        unsigned int u32i; // r20
        unsigned int u32WinFlag; // r19
        class clsPlayerTask * pcPlayer; // r2
...
// Range: 0x4DCCF0 -> 0x4DCD94
void WalkRanAreaGoesOutPlayer(class clsSurvivalRelayRace_Task * this /* r2 */, signed int s32TeamNo /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DCCF0 -> 0x4DCD94
        class clsSurvivalRelayPlayerTask * pcPlayer; // r2
        signed int s32MaxLap; // r2
    }
}


// Range: 0x4DCDA0 -> 0x4DD1B4
void ChangeNextPlayer(class clsSurvivalRelayRace_Task * this /* r20 */, signed int s32PlayerNo /* r2 */, signed int s32NextPlayerNo /* r21 */, signed int s32MaxLap /* r29+0xAC */, signed int s32TeamNo /* r19 */, unsigned char bFlying /* r30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DCDA0 -> 0x4DD1B4
        class clsSurvivalRelayPlayerTask * pcPlayer; // r2
        class clsSurvivalRelayPlayerTask * pcNextPlayer; // r18
    }
}


// Range: 0x4DD1C0 -> 0x4DD3C4
void StartDash(class clsPlayerTask * pcNextPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DD1C0 -> 0x4DD3C4
        float f32Length; // r2
        signed int s32SpeedRank; // r2
        float f32BonusAgp; // r20
    }
}


// Range: 0x4DD3D0 -> 0x4DD854
void SettingNextPlayer(class clsSurvivalRelayRace_Task * this /* r21 */, signed int s32TeamNo /* r20 */, unsigned int u32TypeNo /* r29+0xBC */, class NNS_VECTORFAST * copsPos /* r19 */, class NNS_VECTOR * copsRot /* r18 */, class NNS_VECTOR * copsScale /* r29+0xB8 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DD3D0 -> 0x4DD854
        class clsSurvivalRelayPlayerTask * pcPlayer; // r17
        class clsSurvivalRelayPlayerTask * pcNextPlayer; // r16
        float aMtx[4][4]; // r29+0x120
        class NNS_VECTORFAST sDirVec; // r29+0x110
    }
}


// Range: 0x4DD860 -> 0x4DDE9C
void updateRanking(class clsSurvivalRelayRace_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DD860 -> 0x4DDE9C
        class stcRankCheck asRankCheck[2]; // r29+0x60
        class stcRankCheck sWorkRankCheck; // r29+0x80
        unsigned int u32i; // r17
        unsigned int u32j; // r19
        class clsPlayerTask * pcPlayer; // r2
        float f32Frame; // r3
    }
}
...
// Range: 0x4DDEA0 -> 0x4DDF60
unsigned char checkGoalPlayer(class clsSurvivalRelayRace_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DDEA0 -> 0x4DDF60
...
// Range: 0x4DDF60 -> 0x4DE120
void endDemoSetting(class clsSurvivalRelayRace_Task * this /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DDF60 -> 0x4DE120
...
// Range: 0x4DE120 -> 0x4DE730
void endStartCamMotion(class clsSurvivalRelayRace_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DE120 -> 0x4DE730
        signed int s32TblNo; // r2
        unsigned int u32ResetNo; // r20
        ...
        class clsSurvivalRelayPlayerTask * pcPlayer; // r19
...
// Range: 0x4DE730 -> 0x4DE9A4
void initStartCamMotion(class clsSurvivalRelayRace_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DE730 -> 0x4DE9A4
        ...
        class clsTaskManager & rcTaskMgr; // r2
...
// Range: 0x4DE9B0 -> 0x4DEA24
unsigned char packEtc(class clsSurvivalRelayRace_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DE9B0 -> 0x4DEA24
    }
...
// Range: 0x4DEA30 -> 0x4DEB0C
void requestReadEtc(class clsSurvivalRelayRace_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DEA30 -> 0x4DEB0C
...
// Range: 0x4DEB10 -> 0x4DEC70
void * __ct(class clsSurvivalRelayRace_Task * this /* r16 */, signed int s32StageNoI /* r2 */, signed int s32PlayerNumI /* r2 */, signed int s32UserNumI /* r2 */, signed int s32ViewNumI /* r2 */, signed int s32LapNumI /* r2 */, class stcSendAdv * opsSendAdvI /* r2 */, void * * ppvMapBufferI /* r2 */, enum enmMode eModeI /* r29+0x40 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DEB10 -> 0x4DEC70
        signed int s32i; // r4
...
// Range: 0x4DEC70 -> 0x4DECDC
void setPlayerGear(unsigned int u32PlayerNum /* r2 */, class stcSendAdv * pcSendAdv /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DEC70 -> 0x4DECDC
        signed int s32i; // r9
        signed int s32CopyGear; // r8
    }
}
