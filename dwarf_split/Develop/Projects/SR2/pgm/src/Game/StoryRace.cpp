/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Game\StoryRace.cpp
...
public:
    ...
    class clsStoryMgr & m_rcStoryMgr; // offset 0xCB4, size 0x4
    unsigned int m_eCondition; // offset 0xCB8, size 0x4
    unsigned char m_bEndFlag2D; // offset 0xCBC, size 0x1
    unsigned char m_bAheadPressStart; // offset 0xCBD, size 0x1
    unsigned char m_bDrawLoadingSubject_2D; // offset 0xCBE, size 0x1
    unsigned char m_bLoading; // offset 0xCBF, size 0x1
};
...
// Range: 0x58A690 -> 0x58A8A4
void draw(class clsStoryRace_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58A690 -> 0x58A8A4
        unsigned char bOld; // r2
    }
}


// Range: 0x58A8B0 -> 0x58AA90
void execute(class clsStoryRace_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58A8B0 -> 0x58AA90
    }
...
// Range: 0x58AA90 -> 0x58AB4C
void restart(class clsStoryRace_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58AA90 -> 0x58AB4C
    }
...
// Range: 0x58AB50 -> 0x58AB84
unsigned char checkGoalPlayer(class clsStoryRace_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58AB50 -> 0x58AB84
    }
