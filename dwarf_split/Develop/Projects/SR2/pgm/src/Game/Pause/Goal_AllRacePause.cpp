/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Game\Pause\Goal_AllRacePause.cpp
...
public:
    ...
    unsigned char m_bChkCancel; // offset 0x5C, size 0x1
    unsigned char m_bPauseFlag; // offset 0x5D, size 0x1
    signed char m_s8SurvivalMenu; // offset 0x5E, size 0x1
};
...
// Range: 0x521FE0 -> 0x52207C
void draw(class clsGoal_AllRacePause_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x521FE0 -> 0x52207C
    }
...
// Range: 0x522080 -> 0x522438
void execute(class clsGoal_AllRacePause_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x522080 -> 0x522438
        unsigned char bPush; // r3
    }
}
