/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Game\Pause\RacePauseTimeAttack.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon1 */ {
    // total size: 0x34
} __vt__27clsRacePauseTimeAttack_Task; // size: 0x34, address: 0x6BD1A0
struct /* @anon0 */ {
    // total size: 0x34
...
class clsRacePauseTimeAttack_Task : public clsBaseRacePause_Task {
    // total size: 0x74
public:
    signed int m_s32StageNo; // offset 0x60, size 0x4
    signed int m_s32Type; // offset 0x64, size 0x4
    signed int m_s32SubMode; // offset 0x68, size 0x4
    signed int m_s32DownMode; // offset 0x6C, size 0x4
    class clsTimeAttack_Task * m_pcTimeAtkTask; // offset 0x70, size 0x4
};
...
// Range: 0x32C490 -> 0x32C4F0
void draw(class clsRacePauseTimeAttack_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32C490 -> 0x32C4F0
    }
...
// Range: 0x32C4F0 -> 0x32C4F8
void execute(class clsRacePauseTimeAttack_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32C4F0 -> 0x32C4F8
    }
...
// Range: 0x32C500 -> 0x32C5DC
void * __ct(class clsRacePauseTimeAttack_Task * this /* r21 */, signed int s32PushPausePadNoI /* r20 */, signed int & reRacePauseRetI /* r19 */, class clsTimeAttack_Task * pcTimeAtkTask /* r18 */, signed int s32Type /* r17 */, signed int s32StageNo /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32C500 -> 0x32C5DC
    }
