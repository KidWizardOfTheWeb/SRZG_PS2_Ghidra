/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Game\Pause\RacePauseMission.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcPoint2D_s16 oasUnionTextureSize[1]; // size: 0x4, address: 0x0
static class stcTexUV TexData2D[28]; // size: 0x1C0, address: 0x679B20
...
class clsRacePauseMission_Task : public clsBaseRacePause_Task {
    // total size: 0x6C
public:
    unsigned int m_u32ModoNo; // offset 0x60, size 0x4
    unsigned int m_u32BestScore; // offset 0x64, size 0x4
    unsigned int m_u32BestRank; // offset 0x68, size 0x4
};
...
void drawMissionMsg() {
    ...
    /* anonymous block */ {
        ...
        class stcPoint3d sPosMessage; // r29+0x70
        signed int s32MessageFontNo; // r19
        class stcRect sDrawRect; // r29+0x60
        float f32BoxH; // r29+0x80
        signed int s32cy; // r2
    }
}


// Range: 0x3570D0 -> 0x3572E4
void drawBest(class clsRacePauseMission_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3570D0 -> 0x3572E4
    }
...
// Range: 0x3572F0 -> 0x357384
void draw(class clsRacePauseMission_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3572F0 -> 0x357384
    }
