/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Game\Pause\BaseRacePause.cpp
...
// Range: 0x34B510 -> 0x34B658
void draw(class clsBaseRacePause_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34B510 -> 0x34B658
        unsigned char bReplay; // r2
        unsigned int u32Select; // r2
    }
}


// Range: 0x34B660 -> 0x34B7A0
void drawConnectReport(class clsBaseRacePause_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34B660 -> 0x34B7A0
        class clsScore2D_Task * pcScore; // r2
        class stcPoint3d sPos; // r29+0x60
        signed int s32MsgNo; // r18
        class stcRect sDrawRect; // r29+0x50
    }
}


// Range: 0x34B7A0 -> 0x34B810
unsigned char checkPadConnect() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34B7A0 -> 0x34B810
        unsigned char bPadDisconnectMsg; // r2
        unsigned int u32PadNo; // r9
    }
}


// Range: 0x34B810 -> 0x34BD00
void execute(class clsBaseRacePause_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34B810 -> 0x34BD00
        unsigned char bReplay; // r2
        unsigned char bPush; // r11
    }
}


// Range: 0x34BD00 -> 0x34BD10
void setCancel(class clsBaseRacePause_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34BD00 -> 0x34BD10
    }
...
// Range: 0x34BD10 -> 0x34BD94
void chkEnd(class clsBaseRacePause_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34BD10 -> 0x34BD94
    }
...
// Range: 0x34BDA0 -> 0x34BE14
unsigned char chkCancel(class clsBaseRacePause_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34BDA0 -> 0x34BE14
    }
...
// Range: 0x34BE20 -> 0x34BE94
unsigned char chkOk(class clsBaseRacePause_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34BE20 -> 0x34BE94
    }
...
// Range: 0x34BEA0 -> 0x34BF40
void playCursor(class clsBaseRacePause_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34BEA0 -> 0x34BF40
    }
...
// Range: 0x34BF40 -> 0x34BFD4
void stopSound(class clsBaseRacePause_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34BF40 -> 0x34BFD4
    }
