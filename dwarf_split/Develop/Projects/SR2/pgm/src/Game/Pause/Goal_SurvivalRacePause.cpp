/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Game\Pause\Goal_SurvivalRacePause.cpp
...
public:
    ...
    unsigned char m_bPause; // offset 0x5C, size 0x1
    signed char m_s8SurvivalMenu; // offset 0x5D, size 0x1
};
...
// Range: 0x58E750 -> 0x58E7CC
void draw(class clsGoal_SurvivalRacePause_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58E750 -> 0x58E7CC
    }
...
// Range: 0x58E7D0 -> 0x58EB20
void execute(class clsGoal_SurvivalRacePause_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58E7D0 -> 0x58EB20
        unsigned char bPush; // r6
    }
}
