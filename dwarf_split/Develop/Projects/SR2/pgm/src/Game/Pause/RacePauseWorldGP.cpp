/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Game\Pause\RacePauseWorldGP.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon3 */ {
    // total size: 0x34
} __vt__24clsRacePauseWorldGP_Task; // size: 0x34, address: 0x6BD1E0
...
class clsRacePauseWorldGP_Task : public clsBaseRacePause_Task {
    // total size: 0x64
public:
    class clsTask * m_pcPoint2D_Task; // offset 0x60, size 0x4
};
...
// Range: 0x32C6A0 -> 0x32C794
void draw(class clsRacePauseWorldGP_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32C6A0 -> 0x32C794
...
// Range: 0x32C7A0 -> 0x32C938
void execute(class clsRacePauseWorldGP_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32C7A0 -> 0x32C938
        unsigned char bPush; // r2
        unsigned char bReplay; // r2
    }
}


// Range: 0x32C940 -> 0x32CA10
void * __dt(class clsRacePauseWorldGP_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32C940 -> 0x32CA10
    }
...
// Range: 0x32CA10 -> 0x32CAB8
void * __ct(class clsRacePauseWorldGP_Task * this /* r18 */, signed int s32PushPausePadNoI /* r17 */, signed int & reRacePauseRetI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32CA10 -> 0x32CAB8
    }
