/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Game\Game.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
char * m_toac8HbModeName_Debug[2]; // size: 0x8, address: 0x624958
char * m_toac8GameModeName_Debug[16]; // size: 0x40, address: 0x624960
static unsigned char chk__clsGameMgr_m_toac8GameModeName_Debug_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcDetailData otasDetailData[24]; // size: 0x30, address: 0x66A900
static class stcDetailRace otasDetailRace[6]; // size: 0x42, address: 0x66A930
...
public:
    ...
    signed char s8UserNum; // offset 0x1, size 0x1
    signed char as8CharaId[9]; // offset 0x2, size 0x9
};
...
// Range: 0x2F44C0 -> 0x2F44D8
signed int getBattleLimit_Option() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F44C0 -> 0x2F44D8
    }
...
// Range: 0x2F44E0 -> 0x2F44F8
signed int getBattleHP_Option() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F44E0 -> 0x2F44F8
    }
...
// Range: 0x2F4500 -> 0x2F4518
signed int getBallPoint_Option() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F4500 -> 0x2F4518
    }
...
// Range: 0x2F4520 -> 0x2F4538
signed int getBallLimit_Option() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F4520 -> 0x2F4538
    }
...
// Range: 0x2F4540 -> 0x2F4558
signed int getRelayAgp_Option() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F4540 -> 0x2F4558
    }
...
// Range: 0x2F4560 -> 0x2F4578
signed int getRelayLap_Option() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F4560 -> 0x2F4578
    }
...
// Range: 0x2F4580 -> 0x2F4598
signed int getWorldGPHint_Option() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F4580 -> 0x2F4598
    }
...
// Range: 0x2F45A0 -> 0x2F45B8
signed int getTimeAttackGhost_Option() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F45A0 -> 0x2F45B8
    }
...
// Range: 0x2F45C0 -> 0x2F45D8
signed int getFreeHint_Option() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F45C0 -> 0x2F45D8
    }
...
// Range: 0x2F45E0 -> 0x2F45F8
signed int getFreeAgp_Option() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F45E0 -> 0x2F45F8
    }
...
// Range: 0x2F4600 -> 0x2F4618
signed int getFreeLap_Option() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F4600 -> 0x2F4618
    }
...
// Range: 0x2F4620 -> 0x2F4638
signed int getStoryHint_Option() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F4620 -> 0x2F4638
    }
...
// Range: 0x2F4640 -> 0x2F4658
void setBattleLimit_Option(signed char s8Limit /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F4640 -> 0x2F4658
    }
...
// Range: 0x2F4660 -> 0x2F4678
void setBattleHP_Option(signed char s8HitPoint /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F4660 -> 0x2F4678
    }
...
// Range: 0x2F4680 -> 0x2F4698
void setBattleMode_Option(signed char s8Mode /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F4680 -> 0x2F4698
    }
...
// Range: 0x2F46A0 -> 0x2F46B8
void setBallPoint_Option(signed char s8Point /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F46A0 -> 0x2F46B8
    }
...
// Range: 0x2F46C0 -> 0x2F46D8
void setBallLimit_Option(signed char s8Limit /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F46C0 -> 0x2F46D8
    }
...
// Range: 0x2F46E0 -> 0x2F46F8
void setRelayAgp_Option(signed char s8Agp /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F46E0 -> 0x2F46F8
    }
...
// Range: 0x2F4700 -> 0x2F4718
void setRelayLap_Option(signed char s8Lap /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F4700 -> 0x2F4718
    }
...
// Range: 0x2F4720 -> 0x2F4738
void setWorldGPHint_Option(signed char s8Bool /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F4720 -> 0x2F4738
    }
...
// Range: 0x2F4740 -> 0x2F4758
void setTimeAttackGhost_Option(signed char s8Bool /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F4740 -> 0x2F4758
    }
...
// Range: 0x2F4760 -> 0x2F4778
void setFreeHint_Option(signed char s8Bool /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F4760 -> 0x2F4778
    }
...
// Range: 0x2F4780 -> 0x2F4798
void setFreeAgp_Option(signed char s8Agp /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F4780 -> 0x2F4798
    }
...
// Range: 0x2F47A0 -> 0x2F47B8
void setFreeLap_Option(signed char s8Lap /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F47A0 -> 0x2F47B8
    }
...
// Range: 0x2F47C0 -> 0x2F47D8
void setStoryHint_Option(signed char s8Bool /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F47C0 -> 0x2F47D8
    }
...
// Range: 0x2F47E0 -> 0x2F48B8
void checkSecretTrickTitle(class clsGameMgr * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F47E0 -> 0x2F48B8
        signed int s32CommandCount; // r2
        signed int s32CommandNum; // r2
        unsigned int u32SecretTrickFlag; // r2
        signed int i; // r15
        unsigned int * toapu32UnlockCodeTable[2]; // @ 0x006249A0
        unsigned int toau32UnlockCommnadNumTable[2]; // @ 0x0066A9C0
    }
}


// Range: 0x2F48C0 -> 0x2F51CC
void startResist(class clsGameMgr * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F48C0 -> 0x2F51CC
        signed int s32ViewNum; // r18
        unsigned int u32Lap; // r17
        enum enmRule eRule; // r18
        enum enmSetting eSetting; // r17
        unsigned int oau32[2]; // @ 0x0066A978
    }
}


// Range: 0x2F5250 -> 0x2F56F8
void tRegistRandomCOM(enum enmMode eModeI /* r20 */, signed int s32UserNumI /* r22 */, signed int s32PlayerNumI /* r19 */, class stcSendAdv * posSendAdvI /* r29+0xF4 */, unsigned int bGearRandI /* r29+0xF0 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F5250 -> 0x2F56F8
        unsigned char bUnLockCheck; // r23
        signed char as8ComNgChara[8]; // r29+0xF8
        unsigned char bScrHdCheck; // r29+0xE0
        signed int s32ScrHdPop; // r2
        unsigned char bCharaEmptyClear; // r2
        unsigned char bScrHdPlay; // r29+0xDF
        class stcSendAdv * psSendAdv; // r18
        signed char * pas8ComNgChara; // r17
        signed int s32i; // r16
        unsigned char bGearChengeSkip; // r29+0xDE
        unsigned char bUnLock; // r3
        class stcSendAdv * psAiteSendAdv; // r7
        signed int s32a; // r6
    }
}


// Range: 0x2F5700 -> 0x2F5758
void loadStage(class clsGameMgr * this /* r17 */, enum enm eTypeIdI /* r2 */, signed int s32No0I /* r2 */, signed int s32No1I /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F5700 -> 0x2F5758
    }
...
// Range: 0x2F5760 -> 0x2F5780
signed int getDefaultLapNum(signed int s32StageNoI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F5760 -> 0x2F5780
    }
...
// Range: 0x2F5780 -> 0x2F57A4
void setSendNextModeData(class clsGameMgr * this /* r2 */, enum enmMode eNextModeI /* r2 */, signed int s32StageNoI /* r2 */, signed int s32PlayerNumI /* r2 */, signed int s32UserNumI /* r2 */, class stcSendAdv * psSendAdvI /* r2 */, signed int s32UniqueDataI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F5780 -> 0x2F57A4
    }
...
// Range: 0x2F57B0 -> 0x2F581C
void reinitUnlockInfo(class clsGameMgr * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F57B0 -> 0x2F581C
        signed int s32n; // r8
...
// Range: 0x2F5820 -> 0x2F5864
void reinit(class clsGameMgr * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F5820 -> 0x2F5864
    }
...
// Range: 0x2F5870 -> 0x2F58A0
unsigned char get(class clsBitset * this /* r2 */, unsigned int u32Pos /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F5870 -> 0x2F58A0
    }
