/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Game\BaseRace.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
char * m_toac8StageName_Debug[17]; // size: 0x44, address: 0x626D00
static float tof32StartCamFrame[4]; // size: 0x10, address: 0x676900
static float tof32StartCamFrame4[4]; // size: 0x10, address: 0x676910
static class stcParam oasGCtrlLineParam; // size: 0x40, address: 0x676920
struct /* @anon7 */ {
    // total size: 0xAC
} __vt__16clsBaseRace_Task; // size: 0xAC, address: 0x6BD840
...
class _GearModelInfo sGearModelInfo; // size: 0x284, address: 0xB086D0
...
float tof32VoiceDelayFrame[2][19]; // size: 0x98, address: 0x696190
class clsPfCameraMgr * m_tpcSingleton; // size: 0x4, address: 0x6E69C0
class stcViewRect asSrView[1][8][5]; // size: 0x3C0, address: 0x624D50
class stcScissorRect asSrScissor[1][8][5]; // size: 0x280, address: 0x625110
...
struct /* @anon4 */ {
    // total size: 0x30
} __vt__25clsGoal_AllRacePause_Task; // size: 0x30, address: 0x6CDB30
struct /* @anon2 */ {
    // total size: 0x30
} __vt__30clsGoal_SurvivalRacePause_Task; // size: 0x30, address: 0x6D19B0
struct /* @anon8 */ {
    // total size: 0x34
} __vt__21clsBaseRacePause_Task; // size: 0x34, address: 0x6BD9A0
class stcPeripheral m_asPeripheral[4]; // size: 0xC0, address: 0x702FE0
class clsSrPadSetting * m_tpcSingleton; // size: 0x4, address: 0xB0D9B8
class clsPutTurbulence_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A850
class clsTurbulence_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A858
unsigned char m_tu8Used; // size: 0x1, address: 0xB0D908
class clsPfTimer * m_tpcSingleton; // size: 0x4, address: 0x6E69A8
class clsPfFileMgr * m_tpcSingleton; // size: 0x4, address: 0x703C48
struct /* @anon11 */ {
    // total size: 0x30
} __vt__18clsPressStart_Task; // size: 0x30, address: 0x6CA370
class clsSrPlatform * m_tpcSingleton; // size: 0x4, address: 0x6E6988
struct /* @anon12 */ {
    // total size: 0x30
} __vt__18clsGravityBgm_Task; // size: 0x30, address: 0x6BCB50
struct /* @anon1 */ {
    // total size: 0x30
} __vt__26clsBackLineEffect_End_Task; // size: 0x30, address: 0x6BCF20
struct /* @anon21 */ {
    // total size: 0x30
} __vt__28clsBackLineEffect_Begin_Task; // size: 0x30, address: 0x6BCF50
signed int BurnOut(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x1DC180
signed int BurnOutSystem(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x1DD0F0
signed int Blur(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x1DD3C0
class clsDebug * m_tpcSingleton; // size: 0x4, address: 0x703BB8
struct /* @anon14 */ {
    // total size: 0x4C
} __vt__25clsPlayerGravityWave_Task; // size: 0x4C, address: 0x6BD940
struct /* @anon22 */ {
    // total size: 0xC
} __vt__41clsSingleton<25clsPlayerGravityWave_Task>; // size: 0xC, address: 0x6BD990
struct /* @anon10 */ {
    // total size: 0x30
} __vt__13clsZNone_Task; // size: 0x30, address: 0x6BBF80
struct /* @anon20 */ {
    // total size: 0x30
} __vt__22clsReInitGraphics_Task; // size: 0x30, address: 0x6BBF50
struct /* @anon16 */ {
    // total size: 0x40
...
unsigned int oau32PlayerVoiceTblPcmSize[]; // size: 0x0, address: 0x68FDB0
unsigned int oau32StageSePcmSize[]; // size: 0x0, address: 0x68FD70
unsigned int oau32StageSeTblSize[]; // size: 0x0, address: 0x68FD30
char * oasCharaCode3[]; // size: 0x0, address: 0x620CA0
class stcCtrlData oasCtrlData[]; // size: 0x0, address: 0x68C100
class clsOOMainHeap * t_cInstance; // size: 0x4, address: 0xB17268
class stcAttackModel asAttackData[20]; // size: 0x5A0, address: 0xB08970
float t_f32SystemReadyFrame; // size: 0x4, address: 0xB16468
float tof32ReadyFrame; // size: 0x4, address: 0x6363D0
void * __dt(class clsModelType_OB_TX_MO_MA_MF *, signed short); // size: 0x0, address: 0x1DE210
struct /* @anon17 */ {
    // total size: 0xC
} __vt__10clsOOClock; // size: 0xC, address: 0x6BD930
struct /* @anon0 */ {
    // total size: 0xC
} __vt__24clsGravityGimmickManager; // size: 0xC, address: 0x6BD920
class clsGravityGimmickManager * m_tpcSingleton; // size: 0x4, address: 0xB0D9B0
struct /* @anon3 */ {
    // total size: 0xC
} __vt__40clsSingleton<24clsGravityGimmickManager>; // size: 0xC, address: 0x6BD910
class clsPfMainHeap * m_tpcSingleton; // size: 0x4, address: 0x6D20D0
struct /* @anon19 */ {
    // total size: 0xC
} __vt__13clsGmkManager; // size: 0xC, address: 0x6BD900
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
struct /* @anon9 */ {
    // total size: 0xC
} __vt__29clsSingleton<13clsGmkManager>; // size: 0xC, address: 0x6BD8F0
signed int DebugInfo(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x392390
signed int DebugInfo(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x3F2060
struct /* @anon13 */ {
    // total size: 0x30
} __vt__16clsCtrlIcon_Task; // size: 0x30, address: 0x6BE220
signed int DataSize(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x1D7990
signed int PathRangeEditor(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x1D6F10
signed int Race(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x1DA350
class clsSrCamCtrlMgr * m_tpcSingleton; // size: 0x4, address: 0x703BF8
void * __ct(class clsModelType_OB_TX_MO_MA_MF *); // size: 0x0, address: 0x34A470
struct /* @anon18 */ {
    // total size: 0x2C
...
public:
    ...
    class vector * data_; // offset 0x8, size 0x4
};
...
class __wrap_iterator {
    // total size: 0x4
public:
    class clsPlayerTask * * it_; // offset 0x0, size 0x4
};
class __vector_imp : private __vector_pod, private compile_assert {
    // total size: 0xC
};
...
class clsBaseRacePause_Task : public clsTask {
    // total size: 0x60
public:
    signed int & m_reRacePauseRet; // offset 0x54, size 0x4
    unsigned char m_u8PushPausePadNo; // offset 0x58, size 0x1
    signed char m_s8AddExtExist; // offset 0x59, size 0x1
    unsigned char m_bDisableDraw; // offset 0x5A, size 0x1
    enum enmPadConnectDraw m_enConnectDraw; // offset 0x5C, size 0x4
};
class node : public node_base {
    // total size: 0x14
public:
...
class clsPutTurbulence_Obj : public clsPhantomGimmickObject {
    // total size: 0x130
public:
    enum enmPutTurbMode m_eMode; // offset 0x60, size 0x4
    class NNS_VECTORFAST m_sPosVF; // offset 0x70, size 0x10
    class NNS_VECTORFAST m_sBFPosVF; // offset 0x80, size 0x10
    class NNS_VECTORFAST m_sScaleVF; // offset 0x90, size 0x10
    class NNS_VECTORFAST m_sTailPosVF; // offset 0xA0, size 0x10
    class NNS_VECTORFAST m_sActivePosVF; // offset 0xB0, size 0x10
    class NNS_VECTORFAST * m_psNowPosVF; // offset 0xC0, size 0x4
    class NNS_QUATERNION m_sRotQ; // offset 0xC4, size 0x10
    class clsPlayerTask * m_pcPlayerTask; // offset 0xD4, size 0x4
    class clsRigidBody * * m_ppcRigidBody; // offset 0xD8, size 0x4
    class clsRigidBody * * m_ppcRigidGuide; // offset 0xDC, size 0x4
    class clsRigidBody * * m_ppcRigidBack; // offset 0xE0, size 0x4
    unsigned int * m_pu32ActiveCnt; // offset 0xE4, size 0x4
    unsigned int m_u32ColliNum; // offset 0xE8, size 0x4
    class stcSt04TurbModel * m_psModels; // offset 0xEC, size 0x4
    float m_f32MotFrameA; // offset 0xF0, size 0x4
    float m_f32MotFrameC; // offset 0xF4, size 0x4
    float m_f32MatFrame; // offset 0xF8, size 0x4
    unsigned int m_u32StartIdx; // offset 0xFC, size 0x4
    unsigned int m_u32ActiveNum; // offset 0x100, size 0x4
    float m_f32TailBodyLen; // offset 0x104, size 0x4
    unsigned char m_u8LineNo; // offset 0x108, size 0x1
    class hkAabb m_cAabb; // offset 0x110, size 0x20
};
class tGS_PMODE {
    // total size: 0x8
public:
...
class _GearModels {
    // total size: 0x50
public:
    class clsModelType_OB_TX asModels[9]; // offset 0x0, size 0x48
    void * pvGearPackBuffer; // offset 0x48, size 0x4
    unsigned short u16CtrlNo; // offset 0x4C, size 0x2
    unsigned short u16LoadedNum; // offset 0x4E, size 0x2
};
class stcBlur {
    // total size: 0x1C
public:
...
class stcRankCheck {
    // total size: 0xC
public:
    signed short s16PlayerNo; // offset 0x0, size 0x2
    signed short s16LapNo; // offset 0x2, size 0x2
    signed int s32TotalMSec; // offset 0x4, size 0x4
    float f32RankPoint; // offset 0x8, size 0x4
};
...
class clsTurbulence_Task : public clsBaseGimmickBody {
    // total size: 0xE8
public:
    class vector m_vecvecpcRigid; // offset 0xAC, size 0xC
    class vector m_vecvecpcWallRigid; // offset 0xB8, size 0xC
    class vector m_veccObject; // offset 0xC4, size 0xC
    class vector m_veccAObject; // offset 0xD0, size 0xC
    class vector m_vecu32ColliNum; // offset 0xDC, size 0xC
};
class GskFlags {
    // total size: 0x4
public:
...
class clsPutTurbulence_Task : public clsBaseGimmickBody {
    // total size: 0xC0
public:
    unsigned int m_u32ColBaseNum; // offset 0xAC, size 0x4
    class vector m_veccObject; // offset 0xB0, size 0xC
    class clsRigidBody * * * m_ppcRigid; // offset 0xBC, size 0x4
};
class compressed_pair : private compressed_pair_imp {
    // total size: 0x8
};
class clsTurbulence_Obj : public clsPhantomGimmickObject {
    // total size: 0x100
public:
    enum enmTurbMode m_eMode; // offset 0x60, size 0x4
    class NNS_VECTORFAST m_sPosVF; // offset 0x70, size 0x10
    class NNS_VECTORFAST m_sScaleVF; // offset 0x80, size 0x10
    class NNS_VECTORFAST m_sInitPosVF; // offset 0x90, size 0x10
    class NNS_QUATERNION m_sRotQ; // offset 0xA0, size 0x10
    class clsPlayerTask * m_pcPlayerTask; // offset 0xB0, size 0x4
    class clsRigidBody * m_pcRigidBody; // offset 0xB4, size 0x4
    class vector * m_pvecpcRigid; // offset 0xB8, size 0x4
    class vector * m_pvecpcWallRigid; // offset 0xBC, size 0x4
    float * m_pf32Alpha; // offset 0xC0, size 0x4
    unsigned int * m_pu32ActiveCnt; // offset 0xC4, size 0x4
    unsigned int m_u32ColliNum; // offset 0xC8, size 0x4
    unsigned int m_u32StartIdx; // offset 0xCC, size 0x4
    unsigned int m_u32VisibleWaitIdx; // offset 0xD0, size 0x4
    unsigned int m_u32EnableWaitIdx; // offset 0xD4, size 0x4
    unsigned int m_u32EnableWaitFrm; // offset 0xD8, size 0x4
    unsigned int m_u32RemoveCnt; // offset 0xDC, size 0x4
    class NNS_MATERIALPTR * m_psMaterials; // offset 0xE0, size 0x4
    class NNS_MATERIALPTR * m_psOriginalMaterial; // offset 0xE4, size 0x4
    class stcTurbInfo * m_psTurbInfo; // offset 0xE8, size 0x4
    class vector m_vecpcTurbThroughColli; // offset 0xEC, size 0xC
    unsigned char m_u8MatFlg; // offset 0xF8, size 0x1
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsTurbulence_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class hkAabb {
    // total size: 0x20
public:
    class hkVector4 m_min; // offset 0x0, size 0x10
    class hkVector4 m_max; // offset 0x10, size 0x10
};
...
class stcTurbInfo {
    // total size: 0x8
public:
    unsigned int u32Index; // offset 0x0, size 0x4
    class clsTurbulence_Obj * pcTurbObj; // offset 0x4, size 0x4
};
class clsOOStlAllocator {
    // total size: 0x4
public:
...
class set {
    // total size: 0x14
public:
    class __tree tree_; // offset 0x0, size 0x14
};
class clsOOFileMgr {
    // total size: 0xF8
public:
...
class stcSt04TurbModel {
    // total size: 0x60
public:
    class clsModelType_OB_TX_MO_MA cObjStart; // offset 0x0, size 0x20
    class clsModelType_OB_TX_MO_MA cObjBody; // offset 0x20, size 0x20
    class clsModelType_OB_TX_MO_MA cObjEnd; // offset 0x40, size 0x20
};
...
class stcAttackModel {
    // total size: 0x48
public:
    class clsModelType_OB_TX_MO_MA sModel1; // offset 0x0, size 0x20
    class clsModelType_OB_TX_MO_MA sModel2; // offset 0x20, size 0x20
    class NNS_MOTION * psMotion1; // offset 0x40, size 0x4
    class NNS_MOTION * psMotion2; // offset 0x44, size 0x4
};
enum enmKicker {
    KICKER_FF = 0,
    KICKER_BF = 1,
...
class __generic_iterator {
    // total size: 0x4
public:
    class node * ptr_; // offset 0x0, size 0x4
};
class binary_function {
    // total size: 0x1
};
...
class __wrap_iterator {
    // total size: 0x4
public:
    class stcSendAdv * * it_; // offset 0x0, size 0x4
};
...
public:
    class compressed_pair capacity_; // offset 0x0, size 0x4
    unsigned int size_; // offset 0x4, size 0x4
    class clsModelType_OB_TX_MO_MA * data_; // offset 0x8, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsPutTurbulence_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB_TX_MO_MA m_cModel; // offset 0x88, size 0x20
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0xA8, size 0x4
...
public:
    class compressed_pair alloc_; // offset 0x0, size 0x8
    class compressed_pair node_alloc_; // offset 0x8, size 0x8
    class compressed_pair comp_; // offset 0x10, size 0x4
};
class __vector_deleter {
    // total size: 0xC
public:
    class compressed_pair capacity_; // offset 0x0, size 0x4
    unsigned int size_; // offset 0x4, size 0x4
    class stcSt04TurbModel * data_; // offset 0x8, size 0x4
};
class clsLerpParam {
    // total size: 0x10
public:
...
class clsSrPadSetting : public clsSingleton {
    // total size: 0x18
public:
    enum enmPadConnectState m_aenConnectReport[4]; // offset 0x4, size 0x10
    unsigned char m_au8CoonectReportCnt[4]; // offset 0x14, size 0x4
};
class vector : private __vector_imp {
    // total size: 0xC
};
...
class _GearModelInfo {
    // total size: 0x284
public:
    class _GearModels sGearModels[8]; // offset 0x0, size 0x280
    unsigned int u32DataNum; // offset 0x280, size 0x4
};
class compressed_pair_imp : private less {
    // total size: 0x4
public:
    class node * second_; // offset 0x0, size 0x4
};
class compressed_pair_imp : private allocator {
    // total size: 0x4
public:
...
// Range: 0x343500 -> 0x343830
void Main(class clsBaseRace_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x343500 -> 0x343830
        class clsPlayerTask * pcPlayer; // r2
        unsigned int u32TotalMSec[8]; // r29+0x60
        unsigned char u8PlayerNo[8]; // r29+0x80
        signed int s32i; // r20
        signed int s32l; // r10
        class stcRecord sDstTotalTime; // r29+0x8C
        unsigned char u32WorkNo; // r2
    }
}


// Range: 0x343830 -> 0x344300
void execute(class clsBaseRace_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x343830 -> 0x344300
        signed int s32Cnt; // r18
        class clsPlayerTask * pcPlayer; // r2
        class NNS_VECTORFAST src; // r29+0x60
    }
}


// Range: 0x344300 -> 0x344480
void setStoryUnlock(class clsBaseRace_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x344300 -> 0x344480
...
// Range: 0x344480 -> 0x34458C
void setFreeRaceUnlock(class clsBaseRace_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x344480 -> 0x34458C
        class clsPlayerTask * pcPlayer; // r2
        unsigned char bIsScrHd; // r7
        signed int s32n; // r6
    }
}


// Range: 0x344590 -> 0x34464C
void endDemoSetting(class clsBaseRace_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x344590 -> 0x34464C
        signed int s32Cnt; // r17
    }
}


// Range: 0x344650 -> 0x3446D4
void execGoal(class clsBaseRace_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x344650 -> 0x3446D4
        float f32AddTime; // r1
...
// Range: 0x3446E0 -> 0x3451D8
unsigned char updateStartCamMotion(class clsBaseRace_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3446E0 -> 0x3451D8
        class clsPlayerTask * pcPlayer; // r16
        class clsPlayerTask * pcPlayer; // r2
        float f32StepFrame; // r1
        signed int s32n; // r17
        signed int s32n; // r19
        class clsPlayerTask * pcPlayer; // r17
    }
}


// Range: 0x3451E0 -> 0x34539C
void setPlayerStartCamData(class clsBaseRace_Task * this /* r19 */, unsigned int u32PlayerNum /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3451E0 -> 0x34539C
        class clsPlayerTask * pcPlayer; // r2
        class NNS_VECTORFAST sAddVec; // r29+0x70
    }
}


// Range: 0x3453A0 -> 0x3455B8
void endStartCamMotion(class clsBaseRace_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3453A0 -> 0x3455B8
        class clsCamMixer * pcCamMixer; // r2
        unsigned int u32ResetNo; // r18
        unsigned int u32Cnt; // r17
        class clsBaseStage_Task * pcBaseState_Task; // r2
        class clsDivStage_Task * pcDivState_Task; // r2
    }
}


// Range: 0x3455C0 -> 0x34575C
void initStartCamMotion(class clsBaseRace_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3455C0 -> 0x34575C
        class clsBaseStage_Task * pcBaseState_Task; // r2
...
// Range: 0x345760 -> 0x345960
void setStartCamMotion(class clsBaseRace_Task * this /* r21 */, enum enmCamMotionNo enCamMotionNo /* r2 */, class NNS_VECTORFAST * posAddPos /* r20 */, class NNS_QUATERNION * posAddQuat /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x345760 -> 0x345960
        class clsCamMixer * pcCamMixer; // r18
        class clsCamCtrl * pcCamCtrl; // r16
    }
}


// Range: 0x345960 -> 0x345F54
void setComPlannedRank(class clsBaseRace_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x345960 -> 0x345F54
        class __wrap_iterator it'331; // r2
        class vector vecPRank; // r29+0x80
        class __wrap_iterator it; // r29+0xBC
        class clsPlayerTask * pcPlayer; // r29+0xB8
        signed int s32i; // r17
        class clsGameMgr & rcGameMgr; // r2
        signed int s32Rank; // r20
        signed int s32OtherRank; // r17
    }
}


// Range: 0x345F60 -> 0x345FCC
void setGoalComPlayer(class clsBaseRace_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x345F60 -> 0x345FCC
...
// Range: 0x345FD0 -> 0x34677C
void updateRanking(class clsBaseRace_Task * this /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x345FD0 -> 0x34677C
        class stcRankCheck asRankCheck[8]; // r29+0xF0
        class stcRankCheck asGoalCheck[8]; // r29+0x90
        signed int s32i; // r21
        signed int s32j; // r11
        signed int s32GoalCount; // r20
        signed int s32RankCount; // r19
        class clsPlayerTask * pcPlayer; // r2
        class stcRecord sDstTotalTime; // r29+0x15C
        float f32Frame; // r3
    }
}


// Range: 0x346780 -> 0x346874
unsigned char checkGoalPlayer(class clsBaseRace_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x346780 -> 0x346874
        unsigned int u32i; // r19
        class clsPlayerTask * pcPlayer; // r2
        unsigned char u8GoalUserCnt; // r18
    }
}


// Range: 0x346880 -> 0x346898
void copyCharaMotionTable(class clsBaseRace_Task * this /* r2 */, enum enmCharaType eCharaType /* r2 */, class stcMotionTable * (& rapsDstChrTable)[8] /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x346880 -> 0x346898
    }
...
// Range: 0x3468A0 -> 0x346C14
void checkPauseResult(class clsBaseRace_Task * this /* r17 */, signed int bOnI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3468A0 -> 0x346C14
    }
...
// Range: 0x346C20 -> 0x346FA8
void checkPause(class clsBaseRace_Task * this /* r16 */, signed int bOnI /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x346C20 -> 0x346FA8
        class clsPlayerTask * pcPlayer; // r2
        unsigned int u32i; // r6
        unsigned int u32PadNo; // r29+0x7C
        unsigned char bConnectPause; // r20
        enum enmPadConnectDraw enConnectDraw; // r19
        signed char s8Connect; // r2
        signed int s32PushPausePadNo; // r2
    }
}


// Range: 0x346FB0 -> 0x347004
void selectedPauseMenu_RET___CANCEL(class clsBaseRace_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x346FB0 -> 0x347004
...
// Range: 0x347010 -> 0x3470CC
void selectedPauseMenu_RET___EXIT() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x347010 -> 0x3470CC
    }
...
// Range: 0x3470D0 -> 0x347194
void selectedPauseMenu_RET___RESTART(class clsBaseRace_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3470D0 -> 0x347194
    }
...
// Range: 0x3471A0 -> 0x34734C
void setBestTime(class clsBaseRace_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3471A0 -> 0x34734C
        class clsPlayerTask * pcPlayer; // r2
        signed int s32SaveStageNo; // r18
    }
}


// Range: 0x347350 -> 0x3475D0
void setPauseReslutScreen(class clsBaseRace_Task * this /* r18 */, signed int s32PushPausePadNo /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x347350 -> 0x3475D0
    }
...
// Range: 0x3475D0 -> 0x3476EC
void setPauseScreen(class clsBaseRace_Task * this /* r19 */, signed int s32PushPausePadNo /* r18 */, enum enmPadConnectDraw enConnectDraw /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3475D0 -> 0x3476EC
        class clsBaseRacePause_Task * psBaseRacePause; // r16
    }
}


// Range: 0x3476F0 -> 0x3477CC
signed char chkPadConnect(class clsBaseRace_Task * this /* r2 */, unsigned int * pu32PadNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3476F0 -> 0x3477CC
        class clsSrPadSetting & rcPadSetting; // r2
        unsigned int u32PadNo; // r11
    }
}


// Range: 0x3477D0 -> 0x3477DC
void setSendAdv(class clsBaseRace_Task * this /* r2 */, class stcSendAdv * opsSendAdvI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3477D0 -> 0x3477DC
    }
...
// Range: 0x3477E0 -> 0x3477E8
void setRaceTime(class clsBaseRace_Task * this /* r2 */, unsigned int eCountTypeI /* r2 */, signed int s32MinuteI /* r2 */, signed int s32SecI /* r2 */, signed int s32MSecI /* r2 */, signed int s32MinuteUpLimitI /* r2 */, signed int s32SecUpLimitI /* r2 */, signed int s32MSecUpLimitI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3477E0 -> 0x3477E8
    }
...
// Range: 0x3477F0 -> 0x34781C
unsigned char countDown(class clsBaseRace_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3477F0 -> 0x34781C
    }
...
// Range: 0x347820 -> 0x347AE8
void restart(class clsBaseRace_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x347820 -> 0x347AE8
        class clsPlayerTask * pcPlayer; // r21
        unsigned int bTitleDemo; // r2
        unsigned int u32i; // r20
    }
}


// Range: 0x347AF0 -> 0x347B94
void settingPlayer(class clsBaseRace_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x347AF0 -> 0x347B94
        unsigned int u32i; // r18
...
// Range: 0x347BA0 -> 0x348204
void start(class clsBaseRace_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x347BA0 -> 0x348204
        class clsPlayerGravityWave_Task * pcPlayerGravityWave_Task; // r2
        unsigned int u32ViewportNum; // r2
        unsigned int u32v; // r19
    }
}


// Range: 0x3482F0 -> 0x3482F8
unsigned char packEtc() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3482F0 -> 0x3482F8
    }
...
// Range: 0x348300 -> 0x348618
unsigned char setSeData(class clsBaseRace_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x348300 -> 0x348618
        char ac8FileName[64]; // r29+0x50
        signed int s32StageNoMm; // r2
        enum enmMode eGameMode; // r2
        unsigned int u32TblSize; // r17
        unsigned int u32PcmSize; // r2
        class clsPlayerTask * pcPlayer; // r2
        unsigned int u32CharaID; // r2
        char c8Reg; // r3
    }
}


// Range: 0x348620 -> 0x348718
unsigned char packMotion(class clsBaseRace_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x348620 -> 0x348718
        signed int s32ChkCnt; // r4
        class clsDebug & rcDebug; // r2
    }
}


// Range: 0x348720 -> 0x348728
void requestReadEtc() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x348720 -> 0x348728
...
// Range: 0x348730 -> 0x348E40
void requestReadCharaMotion(class clsBaseRace_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x348730 -> 0x348E40
        class __wrap_iterator it'319; // r2
        class vector vecSendAdv; // r29+0x118
        unsigned int u32i; // r17
        class clsOOMap mapUniMot; // r29+0xA0
        class clsOOMap mapChrMot; // r29+0x80
        class __wrap_iterator it; // r29+0x16C
        unsigned int u32ChrListKey_Chr; // r29+0x168
        unsigned int u32ValCode; // r2
        unsigned int u32j; // r20
        unsigned int u32PlayerNoTmp; // r22
        class stcCtrlData * psGearCtrlData; // r19
        enum enmMotionType eMotNo; // r18
        enum enmGear eBaseGearNo; // r2
        class clsPfFileMgr * pcPfFileMgr; // r2
        char * pc8FileName; // r19
        class clsPack * pcPack; // r18
        class __generic_iterator it; // r29+0x164
        unsigned int u32CharaNo; // r2
        unsigned int u32MotNo; // r2
        char __FUNCTION__[23]; // @ 0x00676990
    }
}


// Range: 0x348E40 -> 0x349130
void requestReadGear(class clsBaseRace_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x348E40 -> 0x349130
        class clsOOSet setGearCtrlNo; // r29+0x50
        unsigned short u16CtrlNoTmp; // r2
        unsigned int u32i; // r18
        class __generic_iterator it; // r29+0x8C
        unsigned int u32GearCtrlNo; // r2
        class clsPfFileMgr * pcPfFileMgr; // r2
        class clsPack * pcPack; // r17
        class _GearModels & rsGearModels; // r2
        char __FUNCTION__[16]; // @ 0x00676980
    }
}


// Range: 0x349130 -> 0x349340
void requestReadChara(class clsBaseRace_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x349130 -> 0x349340
        class clsOOSet setCharaModel; // r29+0x40
        class __generic_iterator itChrMdl; // r29+0x7C
        unsigned int u32i; // r17
        unsigned int u32IdxTmp; // r29+0x78
        class clsPfFileMgr * pcPfFileMgr; // r2
        class clsPack * pcPack; // r17
        char __FUNCTION__[17]; // @ 0x00676960
    }
}


// Range: 0x349340 -> 0x349348
void addReadCharaMotion() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x349340 -> 0x349348
    }
...
// Range: 0x349370 -> 0x3494B4
unsigned char packMap(class clsBaseRace_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x349370 -> 0x3494B4
    }
...
// Range: 0x3494C0 -> 0x349504
void init(class clsBaseRace_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3494C0 -> 0x349504
    }
...
// Range: 0x349510 -> 0x349698
void LoadStageData(class clsBaseRace_Task * this /* r17 */, signed int s32LoadNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x349510 -> 0x349698
    }
...
// Range: 0x3496A0 -> 0x349A48
void * __dt(class clsBaseRace_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3496A0 -> 0x349A48
    }
...
// Range: 0x349BD0 -> 0x34A360
void * __ct(class clsBaseRace_Task * this /* r21 */, signed int s32StageNoI /* r19 */, signed int s32PlayerNumI /* r18 */, signed int s32UserNumI /* r30 */, signed int s32ViewNumI /* r17 */, signed int s32LapNumI /* r20 */, class stcSendAdv * opsSendAdvI /* r22 */, void * * ppvMapBufferI /* r29+0xA4 */, enum enmMode eModeI /* r29+0xB0 */, signed int s32LoadNo /* r29+0xB8 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x349BD0 -> 0x34A360
        class clsPfSystem & rcOOSystem; // r2
        unsigned int u32n; // r20
        signed int s32UserNumMm; // r2
        unsigned char bMist; // r4
    }
}


// Range: 0x34B500 -> 0x34B508
void @16@__dt__25clsPlayerGravityWave_TaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34B500 -> 0x34B508
    }
