/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Game\RaceRetry.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcPoint2D_s16 oasUnionTextureSize[1]; // size: 0x4, address: 0x67C5D0
static class stcTexUV TexData2D[28]; // size: 0x1C0, address: 0x67C5E0
...
class clsRaceRetry_Task : public clsTask {
    // total size: 0x60
public:
    unsigned char m_u8PushPausePadNo; // offset 0x54, size 0x1
    signed int & m_reRacePauseRet; // offset 0x58, size 0x4
    signed char m_s8StopSeWaitFrame; // offset 0x5C, size 0x1
};
class hkPadSpu {
    // total size: 0x4
public:
...
// Range: 0x357400 -> 0x357870
void drawRetryMenu(signed int s32SelectItem /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x357400 -> 0x357870
        ...
        unsigned int oau32ItemTbl[2]; // r29+0x98
        signed int s32cx; // r2
        signed int s32h; // r2
        signed int s32ty; // r21
...
// Range: 0x357870 -> 0x3578E0
void draw(class clsRaceRetry_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x357870 -> 0x3578E0
    }
...
// Range: 0x3578E0 -> 0x357B58
void execute(class clsRaceRetry_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3578E0 -> 0x357B58
        unsigned char bPush; // r18
    }
}
