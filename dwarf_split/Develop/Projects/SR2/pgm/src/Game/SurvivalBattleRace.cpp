/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Game\SurvivalBattleRace.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcPoint2D_s16 oasUnionTextureSize[1]; // size: 0x4, address: 0x0
static class stcTexUV TexData2D[28]; // size: 0x1C0, address: 0x0
static unsigned char chk__TexData2D_SizeCheck_[1]; // size: 0x1, address: 0x0
float tof32GDiveRange; // size: 0x4, address: 0x0
float tof32GCtrlUsedRate; // size: 0x4, address: 0x0
float tof32GCtrlRange; // size: 0x4, address: 0x0
float tof32GCtrlInvalidFrame; // size: 0x4, address: 0x0
float tof32GCtrlMinSpeed; // size: 0x4, address: 0x0
float tof32GCtrlMaxSpeed; // size: 0x4, address: 0x0
float tof32GCtrlSlideSlowdownFrame; // size: 0x4, address: 0x0
float tof32GCtrlRotateAcceleX; // size: 0x4, address: 0x0
float tof32GCtrlRotateAcceleY; // size: 0x4, address: 0x0
float tof32GDiveUsedRate; // size: 0x4, address: 0x0
float tof32SystemGDiveReadyFrame; // size: 0x4, address: 0x0
unsigned int m_u32BattleCount; // size: 0x4, address: 0xBFA778
unsigned int m_au32PlayerWinCount[4]; // size: 0x10, address: 0xBFA780
float tof32PlayerScale; // size: 0x4, address: 0x693610
float tof32GCtrlRotateAcceleRate; // size: 0x4, address: 0x0
float tof32DefaultAgp; // size: 0x4, address: 0x0
float tof32AttackCureAgp; // size: 0x4, address: 0x0
float tof32ItemBoxScale; // size: 0x4, address: 0x693618
class _NNS_TEXLIST * psTexList_SurvivalBattle2D; // size: 0x4, address: 0xBFA790
signed int tos32DefaultSuddenDeathTimeSec; // size: 0x4, address: 0x0
signed int tos32DefaultPointLife; // size: 0x4, address: 0x0
signed int toas32SettingLifeTable[3]; // size: 0xC, address: 0x693620
signed int toas32SettingTimeTable[3]; // size: 0xC, address: 0x693630
struct /* @anon1 */ {
    // total size: 0xAC
} __vt__26clsSurvivalBattleRace_Task; // size: 0xAC, address: 0x6CD0D0
void * __dt(class clsBaseSvlBtlPlayerData *, signed short); // size: 0x0, address: 0x510DA0
struct /* @anon9 */ {
    // total size: 0x28
} __vt__23clsBaseSvlBtlPlayerData; // size: 0x28, address: 0x6CD1E0
class clsSrCamCtrlMgr * m_tpcSingleton; // size: 0x4, address: 0x703BF8
class stcTask sTask; // size: 0x30, address: 0xB0A900
unsigned int t_u32DefaulLife; // size: 0x4, address: 0x653890
float t_f32SystemReadyFrame; // size: 0x4, address: 0xB16468
class stcCommonSetting t_sCommonSetting; // size: 0x98, address: 0xB163D0
class clsSvlBtlBomb_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A750
class clsSvlBtlMissile_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A758
class clsSvlBtlBarrier_Task * m_tpcSingleton; // size: 0x4, address: 0xB13DC8
...
struct /* @anon7 */ {
    // total size: 0x30
} __vt__17clsWinLose2D_Task; // size: 0x30, address: 0x6C5300
...
struct /* @anon0 */ {
    // total size: 0x30
} __vt__30clsCtrlIconSurvivalBattle_Task; // size: 0x30, address: 0x6D0970
void * __dt(class clsSvlBtlSuddendeathPlayerData *, signed short); // size: 0x0, address: 0x512800
void * __ct(class clsSvlBtlSuddendeathPlayerData *); // size: 0x0, address: 0x512860
void * __dt(class clsSvlBtlPointPlayerData *, signed short); // size: 0x0, address: 0x512890
void * __ct(class clsSvlBtlPointPlayerData *); // size: 0x0, address: 0x5128F0
struct /* @anon3 */ {
    // total size: 0x28
} __vt__30clsSvlBtlSuddendeathPlayerData; // size: 0x28, address: 0x6CD1B0
struct /* @anon6 */ {
    // total size: 0x28
} __vt__24clsSvlBtlPointPlayerData; // size: 0x28, address: 0x6CD180
struct /* @anon8 */ {
    // total size: 0x2C
...
class stcLockOnTargetData {
    // total size: 0x8
public:
    float m_f32Distance; // offset 0x0, size 0x4
    signed int m_s32LockOnNo; // offset 0x4, size 0x4
};
...
class clsSurvivalBattleRace_Task : public clsBaseRace_Task {
    // total size: 0xCDC
public:
    class clsBaseSvlBtlPlayerData * m_pcPlayerData; // offset 0xCB0, size 0x4
    enum enmRule m_eRule; // offset 0xCB4, size 0x4
    enum enmSetting m_eSetting; // offset 0xCB8, size 0x4
    signed int m_s32LimitTimeSec; // offset 0xCBC, size 0x4
    unsigned int m_u32DeshPlayer; // offset 0xCC0, size 0x4
    class clsTask * m_psWinLose; // offset 0xCC4, size 0x4
    unsigned char m_abPlayerWinFlag[4]; // offset 0xCC8, size 0x4
    unsigned char m_bWinDrawFlag; // offset 0xCCC, size 0x1
...
class clsSvlBtlBomb_Task : public clsSingleModelGimmick_Task {
    // total size: 0xC4
public:
    class stcPlayerBombData m_asPlayerData[4]; // offset 0x94, size 0x30
};
class stcSeed {
    // total size: 0x30
public:
...
public:
    ...
    float m_f32MotFrame; // offset 0x5C, size 0x4
    float m_f32MatMotFrame; // offset 0x60, size 0x4
    unsigned int m_u32CharaNo; // offset 0x64, size 0x4
};
class _adx_talk {
    // total size: 0xC8
public:
...
class stcLockOnPlayerData {
    // total size: 0x8
public:
    float m_f32Distance; // offset 0x0, size 0x4
    signed char m_s8PlayerNo; // offset 0x4, size 0x1
    signed char m_s8Type; // offset 0x5, size 0x1
};
class stcCtrlData {
    // total size: 0x50
public:
...
class clsSvlBtlBarrier_Object : public clsGimmickObj {
    // total size: 0x70
public:
    class clsPlayerTask * m_pcPlayer; // offset 0x50, size 0x4
    enum enmMode m_eMode; // offset 0x54, size 0x4
    float m_f32LimitFrame; // offset 0x58, size 0x4
    float m_f32MatFrame; // offset 0x5C, size 0x4
    float m_f32MotFrame; // offset 0x60, size 0x4
};
enum enmFlag {
    FLAG_INFINI_CTRL = 1,
    FLAG_INFINI_DIVE = 2,
...
class stcPlayerMissileData {
    // total size: 0x58
public:
    class clsSvlBtlMissile_Object * m_apcMissile[4]; // offset 0x0, size 0x10
    class clsLockOnTarget2D_Task * m_pcLockOnTargetTask[4]; // offset 0x10, size 0x10
    class clsSurvivalBattleMsg2D_Task * m_pcLockOnDistanceTask; // offset 0x20, size 0x4
    class clsLockOnAppoint3D_Task * m_pcLockOnAppointTask; // offset 0x24, size 0x4
    class clsLockOnFixed3D_Task * m_pcLockOnFixedTask; // offset 0x28, size 0x4
    class stcLockOnPlayerData m_sLockOnPlayerData; // offset 0x2C, size 0x8
    class stcLockOnTargetData m_asLockOnTargetData[3]; // offset 0x34, size 0x18
    signed int m_s32StockNum; // offset 0x4C, size 0x4
    signed int m_s32ChargeNum; // offset 0x50, size 0x4
    signed int m_s32LockOnNum; // offset 0x54, size 0x4
};
class clsFlag {
    // total size: 0x4
public:
...
class clsSvlBtlMissile_Object : public clsRigidBodyGimmickObj {
    // total size: 0x150
public:
    float m_sDrawMtx[4][4]; // offset 0xD0, size 0x40
    class NNS_VECTOR m_sAccurcayVec; // offset 0x110, size 0xC
    class clsBackLineEffectTask * m_pcLineTask[2]; // offset 0x11C, size 0x8
    enum enmMode m_eMode; // offset 0x124, size 0x4
    signed int m_s32PlayerNo; // offset 0x128, size 0x4
    signed int m_s32LockOnNo; // offset 0x12C, size 0x4
    signed int m_s32PositionNo; // offset 0x130, size 0x4
    float m_f32FrameCount; // offset 0x134, size 0x4
    float m_f32Speed; // offset 0x138, size 0x4
    unsigned int m_u32HormingMode; // offset 0x13C, size 0x4
    float m_f32HormingRate; // offset 0x140, size 0x4
    signed int m_s32SeId; // offset 0x144, size 0x4
    signed int m_bSePlayFlg; // offset 0x148, size 0x4
};
class stcSendAdv {
    // total size: 0x4
public:
...
class clsSvlBtlMissile_Task : public clsSingleModelGimmick_Task {
    // total size: 0x1F4
public:
    class stcPlayerMissileData m_asPlayerData[4]; // offset 0x94, size 0x160
};
enum enmInfo {
    TYPE_NULL = 0,
    TYPE_GROUND = 1,
...
class clsSvlBtlBarrier_Task : public clsSingleModelGimmick_Task {
    // total size: 0xAC
};
...
class clsSurvivalBattleMsg2D_Task : public clsTask {
    // total size: 0x8C
public:
    unsigned int m_u32AnmType; // offset 0x54, size 0x4
    unsigned int m_u32ViewNo; // offset 0x58, size 0x4
    enum enmDrawType m_eDrawType; // offset 0x5C, size 0x4
    unsigned int m_u32DrawNum; // offset 0x60, size 0x4
    signed int m_s32CenterX; // offset 0x64, size 0x4
    signed int m_s32CenterY; // offset 0x68, size 0x4
    signed int m_s32DrawX; // offset 0x6C, size 0x4
    signed int m_s32DrawY; // offset 0x70, size 0x4
    float m_f32Alpha; // offset 0x74, size 0x4
    float m_f32AnmAlpha; // offset 0x78, size 0x4
    float m_f32AnmFrame; // offset 0x7C, size 0x4
    float m_f32MoveX; // offset 0x80, size 0x4
    float m_f32Scale; // offset 0x84, size 0x4
    signed int m_s32Count; // offset 0x88, size 0x4
};
...
public:
    ...
    unsigned int m_u32ViewNo; // offset 0x58, size 0x4
    float m_f32MotFrame; // offset 0x5C, size 0x4
    unsigned int m_u32CharaNo; // offset 0x60, size 0x4
};
class hkArray {
    // total size: 0xC
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsSvlBtlMissile_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsSvlBtlBarrier_Object * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
...
class clsBaseSvlBtlPlayerData {
    // total size: 0xC
public:
    unsigned int m_u32Life; // offset 0x4, size 0x4
    unsigned int m_u32Point; // offset 0x8, size 0x4
};
class binary_function {
    // total size: 0x1
};
...
class clsWinLose2D_Task : public clsTask {
    // total size: 0x94
public:
    signed int m_s32ViewNum; // offset 0x54, size 0x4
    signed short m_s16DrawX[4]; // offset 0x58, size 0x8
    signed short m_s16DrawY[4]; // offset 0x60, size 0x8
    signed short m_s16Rank[4]; // offset 0x68, size 0x8
    unsigned char m_u8Alpha; // offset 0x70, size 0x1
    signed char m_s8PauseFrame; // offset 0x71, size 0x1
    float m_f32Scale; // offset 0x74, size 0x4
    float m_f32TextScale; // offset 0x78, size 0x4
    float m_f32RankScale; // offset 0x7C, size 0x4
    unsigned char * m_pbAnmFlag; // offset 0x80, size 0x4
    unsigned char * m_pbPlayerWinFlag; // offset 0x84, size 0x4
    unsigned int * m_pu32PlayerWinCount; // offset 0x88, size 0x4
    unsigned int m_u32BattleCount; // offset 0x8C, size 0x4
    unsigned int m_u32NextCount; // offset 0x90, size 0x4
};
class clsFlag {
    // total size: 0x4
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsSvlBtlBomb_Object * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB_TX m_cModel; // offset 0x88, size 0x8
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0x90, size 0x4
...
public:
    ...
    signed int m_s32PlayerNo; // offset 0xD4, size 0x4
    signed int m_s32AttackerNo; // offset 0xD8, size 0x4
    signed int m_s32LockOnNo; // offset 0xDC, size 0x4
    float m_f32FrameCount; // offset 0xE0, size 0x4
    float m_f32LimitFrame; // offset 0xE4, size 0x4
    float m_f32FormingFrame; // offset 0xE8, size 0x4
    float m_f32SeBlingFrame; // offset 0xEC, size 0x4
};
...
class stcPlayerBombData {
    // total size: 0xC
public:
    class clsSvlBtlBomb_Object * m_pcBombObject; // offset 0x0, size 0x4
    class clsLockOnTarget2D_Task * m_pcLockOnTarget; // offset 0x4, size 0x4
    class clsLockOnAppoint3D_Task * m_pcLockOnAppoint; // offset 0x8, size 0x4
};
...
// Range: 0x510DF0 -> 0x51111C
void restart(class clsSurvivalBattleRace_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x510DF0 -> 0x51111C
        signed int u32i; // r20
...
// Range: 0x511120 -> 0x511298
void Main(class clsSurvivalBattleRace_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x511120 -> 0x511298
        signed int s32i; // r18
...
// Range: 0x5112A0 -> 0x511308
void damegeFall(class clsSurvivalBattleRace_Task * this /* r2 */, class clsPlayerTask * pcDamagePlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5112A0 -> 0x511308
    }
...
// Range: 0x511310 -> 0x5115B8
void damegeGravity(class clsSurvivalBattleRace_Task * this /* r18 */, class clsPlayerTask * pcDamagePlayer /* r17 */, class clsPlayerTask * pcAttackPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x511310 -> 0x5115B8
    }
...
// Range: 0x5115C0 -> 0x5116A8
void damegeGimmick(class clsSurvivalBattleRace_Task * this /* r17 */, class clsPlayerTask * pcDamagePlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5115C0 -> 0x5116A8
    }
...
// Range: 0x5116B0 -> 0x511950
void damegeBomb(class clsSurvivalBattleRace_Task * this /* r18 */, class clsPlayerTask * pcDamagePlayer /* r17 */, class clsPlayerTask * pcAttackPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5116B0 -> 0x511950
    }
...
// Range: 0x511950 -> 0x511BD8
void damegeMissile(class clsSurvivalBattleRace_Task * this /* r18 */, class clsPlayerTask * pcDamagePlayer /* r17 */, class clsPlayerTask * pcAttackPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x511950 -> 0x511BD8
    }
...
// Range: 0x511BE0 -> 0x511EA0
void mainSuddenDeathRule(class clsSurvivalBattleRace_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x511BE0 -> 0x511EA0
        class clsPlayerTask * pcPlayer; // r20
        signed int s32LiveNum; // r23
        signed int s32PlayerNo; // r29+0xCC
        signed int s32UserNum; // r30
        signed int i; // r19
...
// Range: 0x511EB0 -> 0x5123EC
void execute(class clsSurvivalBattleRace_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x511EB0 -> 0x5123EC
        ...
        signed int s32MenuPadNo; // r2
    }
}


// Range: 0x5123F0 -> 0x512484
unsigned char packEtc(class clsSurvivalBattleRace_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5123F0 -> 0x512484
    }
...
// Range: 0x512490 -> 0x5125C0
void requestReadEtc(class clsSurvivalBattleRace_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x512490 -> 0x5125C0
...
// Range: 0x5125C0 -> 0x5125F0
signed int getLifeMax(class clsSurvivalBattleRace_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5125C0 -> 0x5125F0
    }
...
// Range: 0x5125F0 -> 0x5127FC
void * __ct(class clsSurvivalBattleRace_Task * this /* r19 */, enum enmRule eRule /* r18 */, enum enmSetting eSettingI /* r17 */, signed int s32StageNoI /* r2 */, signed int s32PlayerNumI /* r16 */, signed int s32UserNumI /* r2 */, class stcSendAdv * opsSendAdvI /* r2 */, void * * ppvMapBufferI /* r2 */, enum enmMode eModeI /* r29+0x60 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5125F0 -> 0x5127FC
    }
