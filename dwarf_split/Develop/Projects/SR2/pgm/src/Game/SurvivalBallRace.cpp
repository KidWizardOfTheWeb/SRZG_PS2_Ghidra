/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Game\SurvivalBallRace.cpp
...
unsigned int m_u32BattleCount; // size: 0x4, address: 0xB173A0
unsigned int m_au32PlayerWinCount[4]; // size: 0x10, address: 0xB173B0
float tof32ReadyFrame; // size: 0x4, address: 0x0
float tof32ItemBoxScale; // size: 0x4, address: 0x687A40
static unsigned int stcoau32RuleTime[3]; // size: 0xC, address: 0x687A48
static unsigned int stcoau32RulePoint[4]; // size: 0x10, address: 0x687A60
struct /* @anon4 */ {
    // total size: 0xAC
} __vt__24clsSurvivalBallRace_Task; // size: 0xAC, address: 0x6C5250
...
class _strSurvivalBallData scosSurvivalBallData[4]; // size: 0x80, address: 0x688590
struct /* @anon7 */ {
    // total size: 0x2C
...
public:
    ...
    signed int s32Point; // offset 0x4, size 0x4
};
...
// Range: 0x44B490 -> 0x44B6E8
void restart(class clsSurvivalBallRace_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44B490 -> 0x44B6E8
        class _strSurvivalBallData sSurvivalBallData; // r29+0xE0
        signed int u32i; // r20
...
// Range: 0x44B6F0 -> 0x44B874
void Main(class clsSurvivalBallRace_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44B6F0 -> 0x44B874
        class _strSurvivalBallData sSurvivalBallData; // r29+0x40
        signed int u32i; // r17
    }
}


// Range: 0x44B880 -> 0x44B888
void draw() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44B880 -> 0x44B888
...
// Range: 0x44B890 -> 0x44C120
void execute(class clsSurvivalBallRace_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44B890 -> 0x44C120
...
// Range: 0x44C120 -> 0x44C2D0
void updateRanking(class clsSurvivalBallRace_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44C120 -> 0x44C2D0
        class stcRankCheck asRankCheck[8]; // r29+0x60
        class stcRankCheck sWorkRankCheck; // r29+0xA8
        class clsPlayerTask * pcPlayer; // r2
        signed int i; // r7
        signed int j; // r19
    }
...
// Range: 0x44C2D0 -> 0x44C450
void addPlayerPoint(class clsSurvivalBallRace_Task * this /* r21 */, unsigned int u32PlayerNo /* r20 */, signed int s32Point /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44C2D0 -> 0x44C450
        class clsPlayerTask * pcPlayer; // r18
...
// Range: 0x44C450 -> 0x44C4C4
unsigned char packEtc(class clsSurvivalBallRace_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44C450 -> 0x44C4C4
    }
...
// Range: 0x44C4D0 -> 0x44C630
void requestReadEtc(class clsSurvivalBallRace_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44C4D0 -> 0x44C630
...
// Range: 0x44C630 -> 0x44C638
unsigned int getMaxPoint(class clsSurvivalBallRace_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44C630 -> 0x44C638
    }
...
// Range: 0x44C640 -> 0x44C7C4
void * __ct(class clsSurvivalBallRace_Task * this /* r18 */, signed int s32StageNoI /* r2 */, unsigned int u32RuleTimeType /* r17 */, unsigned int u32RulePointType /* r16 */, signed int s32PlayerNumI /* r2 */, signed int s32UserNumI /* r2 */, signed int s32LapNumI /* r2 */, class stcSendAdv * opsSendAdvI /* r2 */, void * * ppvMapBufferI /* r29+0x50 */, enum enmMode eModeI /* r29+0x58 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44C640 -> 0x44C7C4
    }
