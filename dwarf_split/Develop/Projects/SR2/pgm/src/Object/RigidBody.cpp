/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\RigidBody.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class hkTypeInfo clsRigidBodyTypeInfo; // size: 0x10, address: 0x681930
...
float t_of32DefaultMaxAngular; // size: 0x4, address: 0x0
struct /* @anon0 */ {
    // total size: 0x20
} __vt__12clsRigidBody; // size: 0x20, address: 0x6BAF70
struct /* @anon1 */ {
    // total size: 0x20
} __vt__11hkRigidBody; // size: 0x20, address: 0x6B7D30
...
class hkFinishLoadedObjectFlag {
    // total size: 0x4
public:
    signed int m_finishing; // offset 0x0, size 0x4
};
class PotentialInfo {
    // total size: 0x1008
public:
...
public:
    union { // inferred
        ...
        char buf[528]; // offset 0x0, size 0x210
    };
};
class hkArray {
    // total size: 0xC
...
// Range: 0x3C00E0 -> 0x3C00F4
static void cleanupLoadedObjectclsRigidBody(void * p /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C00E0 -> 0x3C00F4
    }
...
// Range: 0x3C0100 -> 0x3C0148
static void finishLoadedObjectclsRigidBody(void * p /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C0100 -> 0x3C0148
        class hkFinishLoadedObjectFlag f; // r29+0x2C
    }
}
