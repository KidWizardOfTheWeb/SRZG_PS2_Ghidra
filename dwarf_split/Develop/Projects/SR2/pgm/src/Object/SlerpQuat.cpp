/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\SlerpQuat.cpp
...
// Range: 0x32EA50 -> 0x32EAF0
void startSlerp(class clsSlerpQuat * this /* r18 */, class NNS_QUATERNION * psBaseQuat /* r17 */, class NNS_QUATERNION * psSlerpQuat /* r16 */, float f32Frame /* r29+0x40 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32EA50 -> 0x32EAF0
    }
...
// Range: 0x32EAF0 -> 0x32EB88
void update(class clsSlerpQuat * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32EAF0 -> 0x32EB88
    }
