/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\LerpParam.cpp
...
// Range: 0x333370 -> 0x3333B8
void startLerp(class clsLerpParam * this /* r2 */, float f32Base /* r29 */, float f32Target /* r29 */, float f32Frame /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x333370 -> 0x3333B8
    }
...
// Range: 0x3333C0 -> 0x33341C
void update(class clsLerpParam * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3333C0 -> 0x33341C
    }
