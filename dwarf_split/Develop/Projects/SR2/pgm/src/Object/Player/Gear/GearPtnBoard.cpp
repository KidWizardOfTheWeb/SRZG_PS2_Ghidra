/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Gear\GearPtnBoard.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float NODE_VIB__CALF_ROTATE_Z; // size: 0x4, address: 0x66C3B0
static float NODE_VIB__FOOT_ROTATE_Z; // size: 0x4, address: 0x66C3B8
static float NODE_VIB__FOOT_ROTATE_Y; // size: 0x4, address: 0x0
struct /* @anon2 */ {
    // total size: 0x7C
...
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x66C3C0
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x66C3D0
...
// Range: 0x31DC40 -> 0x31DFE8
void behavior_NodeMtx(class clsGearPtnBoard * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31DC40 -> 0x31DFE8
        float aMtxTmp1[4][4]; // r29+0x90
        float aMtxTmp2[4][4]; // r29+0x50
        float f32VibRateW; // r20
        signed int s32BornId; // r2
    }
}


// Range: 0x31DFF0 -> 0x31E3C4
void behavior(class clsGearPtnBoard * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31DFF0 -> 0x31E3C4
        ...
        float f32FloatTrs; // r29+0x110
        float sRotMtx[4][4]; // r29+0x50
        class NNS_VECTORFAST sAxisVecFast; // r29+0x40
        signed int s32BornId; // r2
...
// Range: 0x31E3D0 -> 0x31E3D8
void clearChangeActionParam(class clsGearPtnBoard * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31E3D0 -> 0x31E3D8
    }
