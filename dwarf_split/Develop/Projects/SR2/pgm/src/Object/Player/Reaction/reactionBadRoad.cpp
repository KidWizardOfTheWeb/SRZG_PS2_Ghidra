/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Reaction\reactionBadRoad.cpp
...
// Range: 0x44B010 -> 0x44B07C
void removeBadRoad(class clsReaction * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44B010 -> 0x44B07C
    }
...
// Range: 0x44B080 -> 0x44B220
void alwaysBadRoad(class clsReaction * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44B080 -> 0x44B220
        unsigned char u8WaitFrame; // r16
        float f32Speed; // r1
    }
}


// Range: 0x44B220 -> 0x44B424
void triggerBadRoad(class clsReaction * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44B220 -> 0x44B424
    }
