/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\CharaJet.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32CollisionRadius; // size: 0x4, address: 0x6751B8
class stcParam sJetLineParam; // size: 0x40, address: 0x625C10
float tof32HairRange1; // size: 0x4, address: 0x0
float tof32TailOffset; // size: 0x4, address: 0x0
float tof32TailRange1; // size: 0x4, address: 0x0
float tof32TailRange2; // size: 0x4, address: 0x0
...
struct /* @anon3 */ {
    // total size: 0x40
} __vt__11clsCharaJet; // size: 0x40, address: 0x6BD060
struct /* @anon2 */ {
    // total size: 0x40
...
public:
    ...
    class clsBackLineEffectTask * m_pcLineTask; // offset 0x64, size 0x4
};
...
// Range: 0x328310 -> 0x3284EC
void draw(class clsCharaJet * this /* r19 */, unsigned int u32AddDrawFlagI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x328310 -> 0x3284EC
        ...
        float sRHandMtx[4][4]; // r29+0xB0
        float sMirrorMtx[4][4]; // r29+0x70
        signed int s32BornId; // r19
    }
}


// Range: 0x3284F0 -> 0x3284F8
void actionAttack01() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3284F0 -> 0x3284F8
...
// Range: 0x328500 -> 0x328764
void actionAttack00(class clsCharaJet * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x328500 -> 0x328764
...
// Range: 0x328780 -> 0x32880C
void initAttack00(class clsCharaJet * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x328780 -> 0x32880C
    }
...
// Range: 0x328810 -> 0x328AAC
void behavior(class clsCharaJet * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x328810 -> 0x328AAC
        class NNS_QUATERNION sQ; // r29+0x60
        float f32Count; // r29+0x70
...
// Range: 0x328AB0 -> 0x328B88
void * __ct(class clsCharaJet * this /* r17 */, class clsPlayerTask * pcPlayer /* r16 */, unsigned char u8ModelType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x328AB0 -> 0x328B88
