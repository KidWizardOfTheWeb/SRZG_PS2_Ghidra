/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Gear\GearPtnWheel.cpp
...
// Range: 0x437260 -> 0x43733C
void draw(class clsGearPtnWheelDraw_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x437260 -> 0x43733C
    }
...
// Range: 0x437340 -> 0x437538
void drawWheel(class clsGearPtnWheel * this /* r21 */, float (* psGearMtx)[4][4] /* r2 */, float f32Alpha /* r20 */, unsigned int u32AddDrawFlagI /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x437340 -> 0x437538
...
// Range: 0x437540 -> 0x4375B0
void draw(class clsGearPtnWheel * this /* r16 */, float (* psGearMtx)[4][4] /* r18 */, float f32Alpha /* r29+0x50 */, unsigned int u32AddDrawFlagI /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x437540 -> 0x4375B0
    }
...
// Range: 0x4375B0 -> 0x43781C
void controlMotionCurve00(class clsGearPtnWheel * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4375B0 -> 0x43781C
        float f32Sign; // r29+0x50
        float f32AbsMotionRate; // r20
        signed int s32MotionTableNo; // r2
        enum enmMotion eMotionTable[2][2]; // r29+0x40
    }
}


// Range: 0x437820 -> 0x4378A4
void controlMotion(class clsGearPtnWheel * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x437820 -> 0x4378A4
    }
...
// Range: 0x4378C0 -> 0x437B20
void behavior(class clsGearPtnWheel * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4378C0 -> 0x437B20
        float f32Rate; // r29
...
// Range: 0x437B20 -> 0x437B64
void clearChangeActionParam(class clsGearPtnWheel * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x437B20 -> 0x437B64
    }
