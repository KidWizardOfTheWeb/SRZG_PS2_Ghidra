/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Key\ComAI.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned int t_ou32ComEstimateMaxPoint; // size: 0x4, address: 0x0
unsigned int t_ou32ComGrindAccessWaitFirst; // size: 0x4, address: 0x693960
unsigned int t_ou32ComGrindAccessWaitDefault; // size: 0x4, address: 0x693968
unsigned int t_ou32ComGDiveTryAgpVal; // size: 0x4, address: 0x693970
unsigned int t_ou32ComGCtrlMaxRestFrame; // size: 0x4, address: 0x693978
unsigned int t_ou32ComGCtrlHighRestFrame; // size: 0x4, address: 0x693980
unsigned int t_ou32ComGCtrlMinRestFrame; // size: 0x4, address: 0x693988
unsigned int t_ou32ComWallRunTrickFrame; // size: 0x4, address: 0x693990
unsigned int t_ou32ComWallRunGCtrlMaxFrame; // size: 0x4, address: 0x693998
unsigned int t_ou32ComWheelDriftMaxFrame; // size: 0x4, address: 0x6939A0
float t_of32ComMaxSpeed; // size: 0x4, address: 0x0
float t_of32ComMinSpeed; // size: 0x4, address: 0x0
float t_of32ComAvgSpeed; // size: 0x4, address: 0x0
float t_of32ComAddAccele; // size: 0x4, address: 0x0
float t_of32ComSubAccele; // size: 0x4, address: 0x0
float t_of32ComDecAccele; // size: 0x4, address: 0x0
float t_of32ComDelayMinSpeed; // size: 0x4, address: 0x0
unsigned int t_ou32ComShortTime; // size: 0x4, address: 0x0
signed int t_os32ComFreeAddSub; // size: 0x4, address: 0x0
float t_of32ComChangeSpeed; // size: 0x4, address: 0x0
float t_of32ComCollisionCheckFrame; // size: 0x4, address: 0x6939A8
float t_of32ComPositionCheck; // size: 0x4, address: 0x6939B0
float t_of32ComMaxSpeed_2; // size: 0x4, address: 0x0
float t_of32ComMinSpeed_2; // size: 0x4, address: 0x0
float t_of32St13BunkiStartFrameA; // size: 0x4, address: 0x0
float t_of32St13BunkiEndFrameA; // size: 0x4, address: 0x0
float t_of32St13BunkiStartFrameB; // size: 0x4, address: 0x0
float t_of32St13BunkiEndFrameB; // size: 0x4, address: 0x0
float t_of32St13BunkiLimitFrame; // size: 0x4, address: 0x0
float t_of32St7WallSubTimeFrame; // size: 0x4, address: 0x0
unsigned int t_ou32St7WallSubTimeCount; // size: 0x4, address: 0x0
float t_of32St6SubMainLength; // size: 0x4, address: 0x6939B8
float t_of32St13SubMainLength; // size: 0x4, address: 0x6939C0
void t_pfExecAI[5]; // size: 0x0, address: 0x6939D0
static unsigned char chk__clsComAI_t_pfExecAI_SizeCheck_[1]; // size: 0x1, address: 0x0
class stcTask sTask; // size: 0x30, address: 0xB0A900
class clsOORandom * m_tpcSingleton; // size: 0x4, address: 0x703C58
unsigned char oau8LowTrickRankRate[][4]; // size: 0x0, address: 0x678780
unsigned char oau8TrickRankRate[][7][4]; // size: 0x0, address: 0x6785A0
unsigned char oau8HighTrickRankRate[][4]; // size: 0x0, address: 0x6787D0
class clsBunki_Task * m_tpcSingleton; // size: 0x4, address: 0xB174E0
class clsPfSystem * m_tpcSingleton; // size: 0x4, address: 0x6E69B8
unsigned int oau32NormalRoundTime[][14]; // size: 0x0, address: 0x6773E0
unsigned int oau32AttackMissionTime[][14]; // size: 0x0, address: 0x677B60
unsigned int oau32MissionTime[][14]; // size: 0x0, address: 0x6777A0
unsigned int oau32StoryRoundTime[][14]; // size: 0x0, address: 0x677020
unsigned int oau32LapDownAITime[][2]; // size: 0x0, address: 0x678330
signed int oas32GoalTime[][7]; // size: 0x0, address: 0x676E40
enum enmComMode oaeComAITable_Free[][4]; // size: 0x0, address: 0x678500
enum enmComMode oaeComAITable_Mission[][4]; // size: 0x0, address: 0x678550
enum enmComMode oaeComAITable_Story[][7]; // size: 0x0, address: 0x6783C0
enum enmComMode oaeComAITable_Boss[][7]; // size: 0x0, address: 0x678450
unsigned int oau32NormalRemainderTime[][4]; // size: 0x0, address: 0x678030
unsigned int oau32MissionRemainderTime[][4]; // size: 0x0, address: 0x678140
unsigned int oau32StoryRemainderTime[][4]; // size: 0x0, address: 0x677F20
class clsDebug * m_tpcSingleton; // size: 0x4, address: 0x703BB8
unsigned int oau32LapTimeLimit[][1]; // size: 0x0, address: 0x678250
signed int oas32LapUpDownTime[][2]; // size: 0x0, address: 0x6782A0
...
class clsBunki_Obj : public clsRigidBodyGimmickObj {
    // total size: 0x180
public:
    enum enmBunkiMode m_eMode; // offset 0xD0, size 0x4
    class clsBunkiThroughCollision * m_pcCollision; // offset 0xD4, size 0x4
    class hkShape * m_pcShape; // offset 0xD8, size 0x4
    float m_f32ObjAngle; // offset 0xDC, size 0x4
    class NNS_QUATERNION m_sInitRotQuat; // offset 0xE0, size 0x10
    float m_f32MoveAngle; // offset 0xF0, size 0x4
    float m_f32MoveFrame; // offset 0xF4, size 0x4
    enum enmAiMode m_eAiMode; // offset 0xF8, size 0x4
    float m_f32MoveCount; // offset 0xFC, size 0x4
    float m_f32NodeAngle; // offset 0x100, size 0x4
    class hkVector4 m_cRotSpeed; // offset 0x110, size 0x10
    class hkVector4 m_cReversSpeed; // offset 0x120, size 0x10
    signed int m_s32HitCount; // offset 0x130, size 0x4
    class clsPlayerTask * m_pcPlayerTask[8]; // offset 0x134, size 0x20
    float m_f32StatueAngle_1; // offset 0x154, size 0x4
    float m_f32StatueAngle_2; // offset 0x158, size 0x4
    float m_f32StatueRotAngle_1; // offset 0x15C, size 0x4
    float m_f32StatueRotAngle_2; // offset 0x160, size 0x4
    float m_f32WaitFrame; // offset 0x164, size 0x4
    float m_f32EffectFrame; // offset 0x168, size 0x4
    float m_f32MatFrame; // offset 0x16C, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0x170, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsBunki_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
public:
    ...
    unsigned short * data_; // offset 0x8, size 0x4
};
...
class clsBunki_Task : public clsSingleModelGimmick_Task {
    // total size: 0xBC
public:
    unsigned short * m_TexIdx; // offset 0xAC, size 0x4
    unsigned short * m_TexIdx2; // offset 0xB0, size 0x4
    class hkTransformShape * m_pcTransShape[2]; // offset 0xB4, size 0x8
};
class __vector_deleter {
    // total size: 0xC
public:
...
class __wrap_iterator {
    // total size: 0x4
public:
    unsigned short * it_; // offset 0x0, size 0x4
};
enum enmLanguage {
...
class clsBunkiThroughCollision : public clsBaseThroughCollision {
    // total size: 0xC
public:
    class clsBunki_Obj * m_pcBunki; // offset 0x8, size 0x4
};
...
// Range: 0x519C70 -> 0x519D70
unsigned char updateAILine(class clsComAI * this /* r19 */, unsigned int u32DisableRoot /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x519C70 -> 0x519D70
        unsigned char bRes; // r16
    }
}


// Range: 0x519D70 -> 0x519E4C
void EstimatePath(class clsComAI * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x519D70 -> 0x519E4C
        class clsRetPath cRet; // r29+0x40
    }
}


// Range: 0x519E50 -> 0x519EF0
void calcPlayerDirectionToPoint(class clsComAI * this /* r2 */, float (* psBaseMtx)[4][4] /* r18 */, class NNS_VECTORFAST * psEndPoint /* r2 */, float * pf32AngleDiffX /* r17 */, float * pf32AngleDiffY /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x519E50 -> 0x519EF0
        class NNS_VECTORFAST sDirection; // r29+0x90
        float sPMtx[4][4]; // r29+0x50
        class NNS_VECTORFAST sDVec; // r29+0x40
    }
}


// Range: 0x519EF0 -> 0x51ADF8
void selectLine(class clsComAI * this /* r21 */, class clsRetPath & rcRetPath /* r20 */, unsigned short u16PlannedLine /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x519EF0 -> 0x51ADF8
        class __wrap_iterator it'480; // r2
        class clsPathCom & rcComPath; // r2
        class clsBaseRace_Task * pcRace; // r2
        unsigned int u32i; // r7
        class vector vecLineNo; // r29+0x118
        class vector vecFailLineNo; // r29+0x108
        class vector vecLineRate; // r29+0xF8
        class vector vecFailLineRate; // r29+0xE8
        unsigned int u32AllRate; // r23
        unsigned int u32FailAllRate; // r30
        unsigned short u16StartPointNo; // r2
        float f32ModeRate; // r20
        unsigned short u16Rate; // r29+0x12E
        unsigned char u8ShortCutAttr; // r2
        unsigned int u32RandVal; // r2
        unsigned int u32RateCnt; // r8
        class __wrap_iterator it; // r29+0x124
    }
}


// Range: 0x51AE00 -> 0x51B378
float getEnableLineAttributeRate(class clsComAI * this /* r18 */, unsigned short u16LineAttr /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x51AE00 -> 0x51B378
        unsigned int u32i; // r17
        float f32RetRate; // r20
    }
}


// Range: 0x51B380 -> 0x51B508
void updateNextTrickRank(class clsComAI * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x51B380 -> 0x51B508
        unsigned char * pu8RankTbl; // r16
        unsigned char u8Per; // r2
        signed char s8NextRank; // r4
        class clsBaseRace_Task * pcRace; // r2
        unsigned char u8Offset; // r8
        unsigned char u8TrickRank; // r7
    }
}


// Range: 0x51B510 -> 0x51B678
void DivergenceSt13(class clsComAI * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x51B510 -> 0x51B678
        unsigned int u32i; // r18
        class clsBunki_Obj * cBunkiObj; // r17
    }
}


// Range: 0x51B680 -> 0x51B688
signed char execCorrection() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x51B680 -> 0x51B688
    }
...
// Range: 0x51B690 -> 0x51C488
signed char execDingDong(class clsComAI * this /* r16 */, signed char s8Reserve /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x51B690 -> 0x51C488
        signed char s8Correction; // r21
        class clsBaseRace_Task * pcRace; // r2
        float f32Speed; // r21
        class NNS_VECTORFAST sPlayerLinePos; // r29+0xB0
        class NNS_VECTORFAST sPlayerLineLength; // r29+0xA0
        float f32PlayerLineLength; // r1
        float f32RestDistance; // r22
        float f32RestTime; // r21
        unsigned int u32AddSubDisTime; // r2
        float f32RateSpeed; // r29+0xC0
    }
}


// Range: 0x51C490 -> 0x51CD98
signed char execKeep(class clsComAI * this /* r17 */, signed char s8Reserve /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x51C490 -> 0x51CD98
        signed char s8Correction; // r21
        class clsBaseRace_Task * pcRace; // r20
        float f32Speed; // r22
        class NNS_VECTORFAST sPlayerLinePos; // r29+0xB0
        class NNS_VECTORFAST sPlayerLineLength; // r29+0xA0
        float f32PlayerLineLength; // r1
        float f32RestDistance; // r22
        float f32RateSpeed; // r21
        float f32RestTime; // r23
        class clsMissionRace_Task * pcMissionRace; // r2
    }
}


// Range: 0x51CDA0 -> 0x51D728
signed char execPullOut(class clsComAI * this /* r16 */, signed char s8Reserve /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x51CDA0 -> 0x51D728
        signed char s8Correction; // r21
        ...
        class NNS_VECTORFAST sPlayerLineLength; // r29+0xA0
        float f32PlayerLineLength; // r1
        float f32RestDistance; // r21
        float f32RateSpeed; // r3
        float f32RestTime; // r2
    }
}


// Range: 0x51D730 -> 0x51DE78
signed char execPrece(class clsComAI * this /* r16 */, signed char s8Reserve /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x51D730 -> 0x51DE78
        signed char s8Correction; // r21
...
// Range: 0x51DE80 -> 0x51E1C8
unsigned char controlGoalTime(class clsComAI * this /* r17 */, signed char s8Lever /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x51DE80 -> 0x51E1C8
        unsigned char bIsCorrection; // r22
        float f32RestDistance; // r21
        float f32RestTime; // r20
        float f32Speed; // r21
    }
}


// Range: 0x51E1D0 -> 0x51ECCC
unsigned char controlRoundTime(class clsComAI * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x51E1D0 -> 0x51ECCC
        class clsBaseRace_Task * pcRace; // r16
        float f32RestDistance; // r1
        float f32RunLength; // r2
        unsigned int u32CheckTime; // r5
        unsigned char bStartFlag; // r4
        unsigned int u32NumTime; // r2
        unsigned int u32AddTime; // r2
    }
}


// Range: 0x51ECD0 -> 0x51F6D8
void updateTime(class clsComAI * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x51ECD0 -> 0x51F6D8
        class stcComTime & rsComTime; // r2
        unsigned int u32NumTime; // r2
        unsigned int u32AddTime; // r2
        unsigned int u32ReserveTime; // r20
        signed int s32Delay; // r2
        unsigned char u8Offset; // r18
    }
}


// Range: 0x51F6E0 -> 0x51F6E8
void setPlannedRank(class clsComAI * this /* r2 */, unsigned char u8Rank /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x51F6E0 -> 0x51F6E8
    }
...
// Range: 0x51F6F0 -> 0x51FE44
void clearData(class clsComAI * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x51F6F0 -> 0x51FE44
        class clsBaseRace_Task * pcRace; // r2
        unsigned char bTimeFlag; // r16
        unsigned int u32i; // r21
        signed int s32Lap; // r2
        unsigned int u32MSec; // r2
        unsigned int u32SetSec; // r2
        unsigned char u8Min; // r2
        unsigned char u8Sec; // r2
        unsigned int u32SetFrame; // r2
        unsigned int u32LimitTime; // r2
        unsigned int u32LimitTime; // r2
    }
}
