/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\LimitTime.cpp
...
// Range: 0x58EFB0 -> 0x58F0DC
unsigned char update(class clsLimitTime * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58EFB0 -> 0x58F0DC
        unsigned char bLimitFlag; // r2
        signed int s32NowSec; // r2
        float f32NowMSec; // r4
        float f32LimitTime; // r3
