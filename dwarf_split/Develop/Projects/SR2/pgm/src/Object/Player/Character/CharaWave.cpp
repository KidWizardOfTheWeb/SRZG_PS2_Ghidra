/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\CharaWave.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32CollisionRadius; // size: 0x4, address: 0x675210
class stcParam sWaveLineParam; // size: 0x40, address: 0x625D10
...
struct /* @anon4 */ {
    // total size: 0x40
} __vt__12clsCharaWave; // size: 0x40, address: 0x6BD160
struct /* @anon2 */ {
    // total size: 0x40
...
// Range: 0x32B9B0 -> 0x32BBC8
void draw(class clsCharaWave * this /* r21 */, unsigned int u32AddDrawFlagI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32B9B0 -> 0x32BBC8
        ...
        float sLHandMtx[4][4]; // r29+0xC0
        float sMirrorMtx[4][4]; // r29+0x80
        signed int s32BornId; // r18
    }
}


// Range: 0x32BBD0 -> 0x32BBD8
void actionAttack01() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32BBD0 -> 0x32BBD8
...
// Range: 0x32BBE0 -> 0x32BE44
void actionAttack00(class clsCharaWave * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32BBE0 -> 0x32BE44
...
// Range: 0x32BE60 -> 0x32BEEC
void initAttack00(class clsCharaWave * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32BE60 -> 0x32BEEC
    }
...
// Range: 0x32BEF0 -> 0x32C20C
void behavior(class clsCharaWave * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32BEF0 -> 0x32C20C
...
// Range: 0x32C210 -> 0x32C2E8
void * __ct(class clsCharaWave * this /* r16 */, class clsPlayerTask * pcPlayer /* r17 */, unsigned char u8ModelType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32C210 -> 0x32C2E8
