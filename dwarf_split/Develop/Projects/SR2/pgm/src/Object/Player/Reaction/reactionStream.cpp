/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Reaction\reactionStream.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x687530
...
// Range: 0x439A50 -> 0x43A25C
void alwaysStream(class clsReaction * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x439A50 -> 0x43A25C
        class clsPath cPath; // r29+0xA0
        float f32CurveRad; // r21
        float f32StreamRad; // r29+0x100
        float f32FrontSpeed; // r29+0x100
        float f32AdjustRad; // r20
        float f32SideSpeed; // r22
        float f32BaseAcceleRad; // r21
        float sInvMtx[4][4]; // r29+0x60
        class NNS_VECTORFAST sLocalDirVecFast; // r29+0x50
        float f32Rad; // r2
        float f32Rate; // r20
        float f32AcceleRad; // r23
