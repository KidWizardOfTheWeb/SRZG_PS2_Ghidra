/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Key\ReplayKey.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon1 */ {
    // total size: 0x28
} __vt__12clsReplayKey; // size: 0x28, address: 0x6BE850
...
// Range: 0x3641D0 -> 0x3642BC
void updateKey(class clsReplayKey * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3641D0 -> 0x3642BC
    }
...
// Range: 0x3642C0 -> 0x364354
void addReplayKey(class clsReplayKey * this /* r17 */, class clsUserKey * pcUserKey /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3642C0 -> 0x364354
    }
...
// Range: 0x364360 -> 0x3643CC
void reset(class clsReplayKey * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x364360 -> 0x3643CC
    }
...
// Range: 0x3643D0 -> 0x364434
class _KeyBuf & at(class __vector_imp * this /* r16 */, unsigned int n /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3643D0 -> 0x364434
    }
