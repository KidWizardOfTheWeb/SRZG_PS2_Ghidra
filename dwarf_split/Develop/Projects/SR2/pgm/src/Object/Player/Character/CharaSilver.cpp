/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\CharaSilver.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32CollisionRadius; // size: 0x4, address: 0x686AB8
class stcParam sSilverLineParam; // size: 0x40, address: 0x636480
...
struct /* @anon1 */ {
    // total size: 0x40
} __vt__14clsCharaSilver; // size: 0x40, address: 0x6C38C0
struct /* @anon3 */ {
    // total size: 0x40
...
class clsCharaSilver : public clsCharaNodeBase {
    // total size: 0x140
public:
    class clsBackLineEffectTask * m_pcLineTask; // offset 0x60, size 0x4
    float m_sLMtx[4][4]; // offset 0x70, size 0x40
    float m_sRMtx[4][4]; // offset 0xB0, size 0x40
    class NNS_VECTORFAST m_asParticlePos[2]; // offset 0xF0, size 0x20
    class NNS_VECTORFAST m_asDFieldPosVF[2]; // offset 0x110, size 0x20
    class clsTask * m_apcParticleTask[2]; // offset 0x130, size 0x8
    float m_f32behaviorTailCnt; // offset 0x138, size 0x4
    class clsRainDrops_Task * m_pcRainDrop_Task; // offset 0x13C, size 0x4
};
class stcSpeedPath {
    // total size: 0x10
public:
...
// Range: 0x426B80 -> 0x426C74
void loadAdditionalData(class stcBinInfo & rsBinInfo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x426B80 -> 0x426C74
        unsigned char * pau8Bin[6]; // r29+0x10
    }
}


// Range: 0x426C80 -> 0x426C88
void actionAttack01() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x426C80 -> 0x426C88
...
// Range: 0x426C90 -> 0x427024
void actionAttack00(class clsCharaSilver * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x426C90 -> 0x427024
        unsigned int u32Rtn; // r2
        class NNS_VECTORFAST sVecF; // r29+0x50
        class clsPlayerTask * pcTgtPlayer; // r2
        class clsPlayerTask * pcTargetPlayer; // r17
        float tf32PlayerFrontDist; // @ 0x006364C0
    }
}


// Range: 0x427030 -> 0x427038
void initAttack01() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x427030 -> 0x427038
...
// Range: 0x427040 -> 0x427128
void initAttack00(class clsCharaSilver * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x427040 -> 0x427128
    }
...
// Range: 0x427130 -> 0x42738C
void behavior(class clsCharaSilver * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x427130 -> 0x42738C
        ...
        float f32Cnt; // r29+0x70
        signed int s32NodeId; // r2
    }
}


// Range: 0x427390 -> 0x4274AC
void * __ct(class clsCharaSilver * this /* r17 */, class clsPlayerTask * pcPlayer /* r16 */, unsigned char u8ModelType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x427390 -> 0x4274AC
        class NNS_VECTORFAST sOffsetVF; // r29+0x30
    }
}
