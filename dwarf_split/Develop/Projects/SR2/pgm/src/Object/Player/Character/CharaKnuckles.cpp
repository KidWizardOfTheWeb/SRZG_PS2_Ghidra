/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\CharaKnuckles.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class stcParam sKnucklesLineParam; // size: 0x40, address: 0x625C50
float tof32CollisionRadius; // size: 0x4, address: 0x6751C0
...
struct /* @anon1 */ {
    // total size: 0x40
} __vt__16clsCharaKnuckles; // size: 0x40, address: 0x6BD0A0
struct /* @anon3 */ {
    // total size: 0x40
...
public:
    ...
    float m_f32behaviorTailCnt; // offset 0x64, size 0x4
};
enum enmDraw2DAttr {
...
// Range: 0x328D60 -> 0x329060
void actionAttack00(class clsCharaKnuckles * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x328D60 -> 0x329060
        unsigned int u32Rtn; // r2
        class clsPlayerTask * pcTargetPlayer; // r17
        class NNS_VECTORFAST sOffsetVF; // r29+0x60
        class NNS_VECTORFAST sOffsetVF; // r29+0x50
    }
}


// Range: 0x329060 -> 0x329068
void initAttack01() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x329060 -> 0x329068
...
// Range: 0x329070 -> 0x3290FC
void initAttack00(class clsCharaKnuckles * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x329070 -> 0x3290FC
    }
...
// Range: 0x329100 -> 0x32939C
void behavior(class clsCharaKnuckles * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x329100 -> 0x32939C
...
// Range: 0x3293A0 -> 0x32947C
void * __ct(class clsCharaKnuckles * this /* r17 */, class clsPlayerTask * pcPlayer /* r16 */, unsigned char u8ModelType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3293A0 -> 0x32947C
