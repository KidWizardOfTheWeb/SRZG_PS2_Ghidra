/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\PlayerCastPointCollector.cpp
...
class clsPlayerCastPointCollector : public hkAllCdPointCollector {
    // total size: 0x1B0
public:
    class clsPlayerTask * m_pcPlayer; // offset 0x1A0, size 0x4
};
...
// Range: 0x413450 -> 0x4135EC
void addCdPoint(class clsPlayerCastPointCollector * this /* r17 */, class hkCdPoint & event /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x413450 -> 0x4135EC
        class hkRigidBody * body; // r2
        class NNS_VECTORFAST sNormalVF; // r29+0x30
    }
}
