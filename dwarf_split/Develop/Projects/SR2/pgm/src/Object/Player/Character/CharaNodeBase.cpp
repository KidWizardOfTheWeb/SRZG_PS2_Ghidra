/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\CharaNodeBase.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
signed char as8ConvertTable[52]; // size: 0x34, address: 0x6881A0
...
// Range: 0x45FD30 -> 0x45FDFC
void * __ct(class clsCharaNodeBase * this /* r16 */, class clsPlayerTask * pcPlayer /* r2 */, unsigned char u8Type /* r2 */, unsigned char u8ModelType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45FD30 -> 0x45FDFC
    }
