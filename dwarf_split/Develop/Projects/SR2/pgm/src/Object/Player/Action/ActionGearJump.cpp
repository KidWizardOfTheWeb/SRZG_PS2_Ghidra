/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Action\ActionGearJump.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x66BDE0
...
// Range: 0x314840 -> 0x314A10
void actionGearJump(class clsPlayerTask * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x314840 -> 0x314A10
...
// Range: 0x314A10 -> 0x314BE0
void initGearJump(class clsPlayerTask * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x314A10 -> 0x314BE0
        class stcData * psPrfm; // r2
