/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Action\ActionGearRail.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned int BO_NUM; // size: 0x4, address: 0x0
unsigned int BO_SIZE; // size: 0x4, address: 0x0
class NNS_VECTORFAST BEGIN_SP[2]; // size: 0x20, address: 0x66BE50
class NNS_VECTOR RAND_SP; // size: 0xC, address: 0x66BE70
class NNS_VECTOR LOCAL_POS; // size: 0xC, address: 0x66BE80
class NNS_VECTOR LOCAL_POS_R; // size: 0xC, address: 0x66BE90
float AIR_K; // size: 0x4, address: 0x0
float MASS; // size: 0x4, address: 0x0
float LIFE_FRAME; // size: 0x4, address: 0x66BEA0
float GROUND_K; // size: 0x4, address: 0x0
float CLIP_Z; // size: 0x4, address: 0x0
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x66BEC0
...
float toaf32BonusSpeed[3]; // size: 0xC, address: 0x66BEA8
...
// Range: 0x315400 -> 0x31643C
void actionGearRail(class clsPlayerTask * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x315400 -> 0x31643C
        signed int os32TimingRate; // r19
        float f32Rad; // r29+0x80
        float f32BonusAgp; // r29+0x80
        unsigned char bFlag; // r21
        unsigned int u32i; // r20
    }
}


// Range: 0x316470 -> 0x3165B8
void actionGearRail_drawBurnOut(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x316470 -> 0x3165B8
        class NNS_VECTORFAST sVeloFast; // r29+0x30
        class NNS_VECTOR sPos; // r29+0x40
    }
}


// Range: 0x3166C0 -> 0x3169C8
void initGearRail(class clsPlayerTask * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3166C0 -> 0x3169C8
        float f32Speed; // r29+0x50
