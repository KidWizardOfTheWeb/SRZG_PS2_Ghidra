/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Action\ActionGearAttack00.cpp
...
// Range: 0x313B30 -> 0x313B78
void cancelGearAttack(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x313B30 -> 0x313B78
    }
...
// Range: 0x313B80 -> 0x314358
void actionGearAttack(class clsPlayerTask * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x313B80 -> 0x314358
        class clsGearBasePrototype * pcGear; // r20
        class stcData * psPrfm; // r2
        float f32MotionRate; // r29+0x90
    }
}


// Range: 0x314360 -> 0x314448
void initGearAttack(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x314360 -> 0x314448
    }
