/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Action\ActionGearBrake.cpp
...
// Range: 0x40F470 -> 0x40F624
void actionGearBrake(class clsPlayerTask * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40F470 -> 0x40F624
        class clsGearBasePrototype * pcGear; // r18
    }
}


// Range: 0x40F630 -> 0x40F73C
void initGearBrake(class clsPlayerTask * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40F630 -> 0x40F73C
        enum enmMotion eMotionTable[2]; // r29+0x38
