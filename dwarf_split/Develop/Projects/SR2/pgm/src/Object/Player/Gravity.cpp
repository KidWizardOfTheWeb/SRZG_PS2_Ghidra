/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Gravity.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float DEFAULT_ACCELE; // size: 0x4, address: 0x669CB0
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x669CC0
...
// Range: 0x2BA2A0 -> 0x2BA308
void setQuatAndUpVec(class clsGravity * this /* r17 */, class NNS_QUATERNION * psQuat /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2BA2A0 -> 0x2BA308
    }
...
// Range: 0x2BA310 -> 0x2BA434
void quicksetTypeNormal(class clsGravity * this /* r17 */, float of32SlerpFrame /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2BA310 -> 0x2BA434
...
// Range: 0x2BA440 -> 0x2BAB28
void update(class clsGravity * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2BA440 -> 0x2BAB28
        class NNS_QUATERNION sQuat; // r29+0x1C0
        class NNS_VECTORFAST sVecFast; // r29+0x1B0
        float f32FrameRate; // r20
        unsigned int u32PointNo; // r2
        float f32Radius; // r21
        float sMtx[4][4]; // r29+0x170
        class NNS_VECTORFAST sGUpVecFast; // r29+0x160
        class NNS_QUATERNION sBaseQuat; // r29+0x150
        class NNS_QUATERNION sRotQuat; // r29+0x140
        class NNS_QUATERNION sInvQuat; // r29+0x130
        class NNS_VECTORFAST sAxisVecFast; // r29+0x120
        class NNS_VECTORFAST sLocalUpVecFast; // r29+0x110
        float f32Dot; // r29+0x1D0
    }
}


// Range: 0x2BAB30 -> 0x2BAD78
void setType(class clsGravity * this /* r17 */, enum enmType eType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2BAB30 -> 0x2BAD78
