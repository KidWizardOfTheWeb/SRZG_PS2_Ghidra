/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\GravityAction\GravityDivePathRange.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class stcTask sTask; // size: 0x30, address: 0xB0A900
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x686890
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x6868A0
...
// Range: 0x41C4F0 -> 0x41C640
void calcRangeDirVec(class clsGravityDivePathRange * this /* r17 */, class clsPlayerTask * pcPlayer /* r18 */, class NNS_VECTORFAST * psDirVecFast /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41C4F0 -> 0x41C640
        ...
        class NNS_VECTORFAST sPointVecFast[2]; // r29+0x40
    }
}


// Range: 0x41C640 -> 0x41C6F4
void calcCrossInfo(class clsGravityDivePathRange * this /* r18 */, signed int s32PointNo /* r2 */, class NNS_VECTORFAST * psPosVecFast /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41C640 -> 0x41C6F4
    }
...
// Range: 0x41C700 -> 0x41C71C
unsigned int getDiveRangeAttrCoursePath(class clsPlayerTask * pcPlayer /* r2 */, class clsPathPoint * pcPath /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41C700 -> 0x41C71C
    }
...
// Range: 0x41C720 -> 0x41C810
void set(class clsGravityDivePathRange * this /* r16 */, class clsPlayerTask * pcPlayer /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41C720 -> 0x41C810
    }
...
// Range: 0x41C810 -> 0x41CB34
void set(class clsGravityDivePathRange * this /* r21 */, class clsPlayerTask * pcPlayer /* r20 */, enum enmPathType ePathType /* r19 */, class clsPathPoint * pcPath /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41C810 -> 0x41CB34
        class clsPathCourse * pcCoursePath; // r18
        class NNS_VECTORFAST sAxisVecFast; // r29+0xC0
        float sRotMtx[4][4]; // r29+0x80
    }
}


// Range: 0x41CB40 -> 0x41CE20
void set(class clsGravityDivePathRange * this /* r19 */, class clsPlayerTask * pcPlayer /* r16 */, enum enmPathType ePathType /* r18 */, class clsPath * pcPath /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41CB40 -> 0x41CE20
        unsigned int u32HitBit; // r2
        class NNS_VECTORFAST sSideVecFast; // r29+0x50
    }
}
