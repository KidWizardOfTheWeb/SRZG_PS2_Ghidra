/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Action\ActionGearTrick.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon3 */ {
    // total size: 0x30
} __vt__29clsTrickXFlashLineEffect_Task; // size: 0x30, address: 0x6CE9D0
struct /* @anon0 */ {
    // total size: 0x30
} __vt__24clsTrickXRingEffect_Task; // size: 0x30, address: 0x6CEA00
class stcTask sTask; // size: 0x30, address: 0xB0A900
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x66BEE0
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x66BED0
...
// Range: 0x317470 -> 0x317758
void setTrickXEffect(class clsPlayerTask * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x317470 -> 0x317758
        class clsModelType_OB_TX_MO_MA * pcRingModel; // r20
        float f32RingWaitFrame; // r20
        class NNS_QUATERNION sRotQuat; // r29+0xA0
        unsigned int u32i; // r19
        signed int s32RandRotX; // r18
        signed int s32RandRotY; // r17
        signed int s32RandRotZ; // r3
    }
}


// Range: 0x317760 -> 0x3177B0
void actionGearTrick(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x317760 -> 0x3177B0
    }
...
// Range: 0x3177B0 -> 0x3179AC
void initGearTrick(class clsPlayerTask * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3177B0 -> 0x3179AC
