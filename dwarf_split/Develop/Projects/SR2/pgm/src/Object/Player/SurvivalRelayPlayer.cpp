/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\SurvivalRelayPlayer.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x78
} __vt__26clsSurvivalRelayPlayerTask; // size: 0x78, address: 0x6CEB20
...
// Range: 0x53C5E0 -> 0x53C92C
void setStartPosRot(class clsSurvivalRelayPlayerTask * this /* r19 */, class stcInitData * copsInitData /* r18 */, unsigned char bResetFlag /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53C5E0 -> 0x53C92C
        class clsPath cPath; // r29+0xB0
        unsigned char u8GravityPathNo; // r29+0x11F
        class NNS_VECTORFAST sEndVecFast; // r29+0xA0
        class NNS_VECTORFAST sStartVecFast; // r29+0x90
        class stcRetRayCast sRetRayCast; // r29+0x60
    }
}


// Range: 0x53C930 -> 0x53C99C
void * __dt(class clsSurvivalRelayPlayerTask * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53C930 -> 0x53C99C
    }
...
// Range: 0x53C9A0 -> 0x53C9A8
void @4@__dt__26clsSurvivalRelayPlayerTaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53C9A0 -> 0x53C9A8
    }
