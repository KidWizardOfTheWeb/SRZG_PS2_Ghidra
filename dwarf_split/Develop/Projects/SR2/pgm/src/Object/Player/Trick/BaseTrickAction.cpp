/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Trick\BaseTrickAction.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x1C
} __vt__18clsBaseTrickAction; // size: 0x1C, address: 0x6CE5F0
class _NNS_TEXLIST * psTexList_UnionParticle; // size: 0x4, address: 0xB0AF48
signed int oas32BingoRingTable[9]; // size: 0x24, address: 0x679D20
float of32FallMotionLinkFrame; // size: 0x4, address: 0x685460
class clsPfSystem * m_tpcSingleton; // size: 0x4, address: 0x6E69B8
float toaf32BonusTrick[7]; // size: 0x1C, address: 0x6960F0
class stcBonusParam oasBonusParamTable[9][7]; // size: 0xFC, address: 0x67C2F0
class clsHavok * m_tpcSingleton; // size: 0x4, address: 0x707E60
float af32RankMaxSpeedRate[9]; // size: 0x24, address: 0x626ED0
float af32RankUpSpeedRate[9]; // size: 0x24, address: 0x626EA0
...
// Range: 0x52CC00 -> 0x52CD64
void updateBingoConrol(class clsTrickParam & rcParam /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52CC00 -> 0x52CD64
        signed int s32RingNum; // r2
    }
}


// Range: 0x52CD70 -> 0x52CDDC
void applyGearAbility(class clsTrickParam & rcParam /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52CD70 -> 0x52CDDC
        signed char os8BonusRank; // r2
        signed char s8Rank; // r3
    }
}


// Range: 0x52CDE0 -> 0x52CF6C
void actionRotateMotion(class clsTrickParam & rcParam /* r17 */, float of32Frame /* r29+0x40 */, float of32TotalFrame /* r29+0x40 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52CDE0 -> 0x52CF6C
        float f32Rot; // r21
        signed int s32Rot; // r5
        signed int s32n; // r2
        signed int s32Rot; // r5
        signed int s32n; // r2
    }
...
// Range: 0x52CF70 -> 0x52CFF8
void setFallMotion(class clsTrickParam & rcParam /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52CF70 -> 0x52CFF8
    }
...
// Range: 0x52D000 -> 0x52D0D4
void setTrickMotion(class clsTrickParam & rcParam /* r2 */, float of32MotionFrame /* r29+0x20 */, float of32LinkFrame /* r29+0x20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52D000 -> 0x52D0D4
    }
...
// Range: 0x52D0E0 -> 0x52D2AC
void calcRotateRad(class clsTrickParam & rcParam /* r17 */, float of32ActionFrame /* r29+0x40 */, signed short os16RotateDeg /* r2 */, signed char os8RotDir /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52D0E0 -> 0x52D2AC
        float f32RotRadRate; // r20
    }
}


// Range: 0x52D2B0 -> 0x52D69C
void exitCommon(class clsTrickParam & rcParam /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52D2B0 -> 0x52D69C
...
// Range: 0x52D6A0 -> 0x52D7C8
void initCommon(class clsTrickParam & rcParam /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52D6A0 -> 0x52D7C8
    }
...
// Range: 0x52D7D0 -> 0x52D904
signed int setKeyRecord(class clsTrickParam & rcParam /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52D7D0 -> 0x52D904
        unsigned int u32i; // r8
        unsigned char u8Flag; // r7
        signed char s8KeyDir; // r16
    }
}


// Range: 0x52D910 -> 0x52DA10
void calcTrickRank(class clsTrickParam & rcParam /* r2 */, float of32LengthRate /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52D910 -> 0x52DA10
        enum enmKicker eKickerType; // r2
        float * opaf32KickerRateTable; // r2
        signed int s32Rank; // r8
    }
}


// Range: 0x52DA10 -> 0x52DB04
unsigned char calcKickerType(class clsTrickParam & rcParam /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52DA10 -> 0x52DB04
        class stcInfo * psColInfo; // r6
    }
}


// Range: 0x52DB10 -> 0x52DC68
enum enmKickerRankZone checkTrickRankZone(class clsTrickParam & rcParam /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52DB10 -> 0x52DC68
        float * opaf32KickerRateTable; // r2
        class clsPath cRankPath; // r29+0x50
    }
}


// Range: 0x52DC70 -> 0x52DD9C
void settingTrickParam(class clsBaseTrickAction * this /* r17 */, class clsTrickParam & rcParam /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52DC70 -> 0x52DD9C
        class clsPath cRankPath; // r29+0x70
