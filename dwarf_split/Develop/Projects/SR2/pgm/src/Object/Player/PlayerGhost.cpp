/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\PlayerGhost.cpp
...
// Range: 0x44F810 -> 0x44F818
void setStartFlag(class clsPlayerGhost * this /* r2 */, unsigned char bStart /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44F810 -> 0x44F818
    }
...
// Range: 0x44F820 -> 0x44F828
void setEnableExecFlag(class clsPlayerGhost * this /* r2 */, unsigned char bIsEnable /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44F820 -> 0x44F828
    }
...
// Range: 0x44F830 -> 0x44FBCC
void draw(class clsPlayerGhost * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44F830 -> 0x44FBCC
        enum enmRet eClipRet; // r2
        float sMtx[4][4]; // r29+0xD0
        unsigned int u32DrawStatus; // r2
        unsigned int u32DrawStatusBuff; // r19
        signed int s32BornId; // r2
    }
}


// Range: 0x44FBD0 -> 0x44FC74
void execute(class clsPlayerGhost * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44FBD0 -> 0x44FC74
    }
...
// Range: 0x44FC80 -> 0x44FD28
void reset(class clsPlayerGhost * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44FC80 -> 0x44FD28
    }
...
// Range: 0x44FD30 -> 0x44FDF4
void initGhost(class clsPlayerGhost * this /* r18 */, class stcSendAdv & rsSendAdv /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44FD30 -> 0x44FDF4
        enum enmCharaType eCharaType; // r17
        enum enmModelType eModelType; // r16
        enum enmGearCtrl eGearCtrlNo; // r19
    }
}


// Range: 0x44FE00 -> 0x44FE08
void @4@reset__14clsPlayerGhostFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44FE00 -> 0x44FE08
    }
...
// Range: 0x44FE10 -> 0x44FE18
void @4@draw__14clsPlayerGhostFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44FE10 -> 0x44FE18
    }
...
// Range: 0x44FE20 -> 0x44FE28
void @4@execute__14clsPlayerGhostFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44FE20 -> 0x44FE28
    }
...
// Range: 0x44FE30 -> 0x44FE38
void @4@__dt__14clsPlayerGhostFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44FE30 -> 0x44FE38
    }
