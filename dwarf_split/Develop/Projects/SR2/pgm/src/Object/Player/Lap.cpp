/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Lap.cpp
...
void copyPlayerLapTime(class clsLap * this /* r20 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x33ED10 -> 0x33EDA4
        class clsLap * pcLap; // r2
...
void copyLapNum(class clsLap * this /* r17 */, class clsLap & rcSrcLap /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x33EDB0 -> 0x33EEC0
...
void setRecordTime(class clsLap * this /* r17 */, unsigned char u8LapNo /* r2 */, unsigned int u32PenaltyCount /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x33EEC0 -> 0x33F05C
...
void getTotalTime(class clsLap * this /* r2 */, class stcRecord & rsRecord /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x33F060 -> 0x33F10C
    }
...
unsigned int getTotalMsecTime(class clsLap * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x33F110 -> 0x33F170
        signed int s32i; // r11
...
void setComGoal(class clsLap * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x33F170 -> 0x33F204
...
void updateMaxLap(class clsLap * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x33F210 -> 0x33F3A4
        class clsBaseRace_Task * pcBaseRace; // r2
...
void update(class clsLap * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x33F3B0 -> 0x33F444
...
void startLap(class clsLap * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x33F450 -> 0x33F4A8
    }
...
void reset(class clsLap * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x33F4B0 -> 0x33F5DC
        class clsBaseRace_Task * pcBaseRace; // r2
...
void initFirstAllocate(class clsLap * this /* r16 */, unsigned int u32GoalNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x33F5E0 -> 0x33F644
    }
