/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Action\ActionGearFly.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static signed int toaA32PitchGravityTable[3]; // size: 0xC, address: 0x66C290
class clsOOProfile * m_tpcSingleton; // size: 0x4, address: 0x703C28
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x66C310
class clsPfCameraMgr * m_tpcSingleton; // size: 0x4, address: 0x6E69C0
class clsPfSystem * m_tpcSingleton; // size: 0x4, address: 0x6E69B8
float toaf32BonusFly[3]; // size: 0xC, address: 0x66C2E8
class stcTask sTask; // size: 0x30, address: 0xB0A900
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x66C300
float FLYACTION_LEFT_RIGHT_ROT; // size: 0x4, address: 0x66C2D8
float FLYACTION_UP_DOWN_ROT; // size: 0x4, address: 0x66C2E0
float FLYACTION_MIN_PITCH; // size: 0x4, address: 0x66C2C8
float FLYACTION_MAX_PITCH; // size: 0x4, address: 0x66C2D0
class clsPfCri * m_tpcSingleton; // size: 0x4, address: 0x6E6998
static float FLYACTION_DESCENT_PITCH_GRAVITY; // size: 0x4, address: 0x66C2B0
static float FLYACTION_FALL_PITCH_GRAVITY; // size: 0x4, address: 0x66C2B8
static float FLYACTION_DEFAULT_PITCH_GRAVITY; // size: 0x4, address: 0x66C2C0
...
// Range: 0x31ABB0 -> 0x31BAD0
void actionGearFly(class clsPlayerTask * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31ABB0 -> 0x31BAD0
        class stcData * psPrfm; // r2
        float sMtx[4][4]; // r29+0x140
        class NNS_VECTORFAST sMoveVecFast; // r29+0x130
        float f32BonusAgp; // r29+0x180
        float f32XCos; // r29+0x180
        class NNS_QUATERNION sQuat; // r29+0x120
        class NNS_QUATERNION sCalcQuat; // r29+0x110
        class stcTargetCam1 sTgtCam1; // r29+0x90
    }
}


// Range: 0x31BB20 -> 0x31C1B0
void initGearFly(class clsPlayerTask * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31BB20 -> 0x31C1B0
        class stcTargetCam1 sTgtCam1; // r29+0x90
...
// Range: 0x31C320 -> 0x31C3E8
void endGearFly(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31C320 -> 0x31C3E8
    }
...
// Range: 0x31C3F0 -> 0x31C6DC
void cancelGearFly(class clsPlayerTask * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31C3F0 -> 0x31C6DC
        class stcData * psPrfm; // r2
        class stcTargetCam1 sTgtCam1; // r29+0x50
    }
}
