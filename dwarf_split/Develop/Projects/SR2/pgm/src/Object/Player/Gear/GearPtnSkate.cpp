/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Gear\GearPtnSkate.cpp
...
// Range: 0x441A70 -> 0x441A88
void draw(class clsGearPtnSkate * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x441A70 -> 0x441A88
    }
...
// Range: 0x441A90 -> 0x441BA4
void controlMotionCurve00(class clsGearPtnSkate * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x441A90 -> 0x441BA4
        float f32Sign; // r1
        signed int s32MotionTableNo; // r2
        enum enmMotion eMotionTable[1][2]; // r29+0x8
    }
}


// Range: 0x441BB0 -> 0x441EC0
void controlMotion(class clsGearPtnSkate * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x441BB0 -> 0x441EC0
    }
...
// Range: 0x441EE0 -> 0x441EE8
void clearChangeActionParam(class clsGearPtnSkate * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x441EE0 -> 0x441EE8
    }
