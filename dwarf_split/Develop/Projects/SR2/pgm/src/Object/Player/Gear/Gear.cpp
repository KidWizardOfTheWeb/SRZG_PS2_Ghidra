...
void draw(class clsGear * this /* r20 */, float (* psGearMtx)[4][4] /* r2 */, float f32Alpha /* r20 */, unsigned int u32AddDrawFlagI /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x306950 -> 0x306B3C
...
void clearChangeActionParam(class clsGear * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x306C00 -> 0x306C5C
    }
