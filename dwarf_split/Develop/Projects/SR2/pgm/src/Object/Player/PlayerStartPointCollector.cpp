/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\PlayerStartPointCollector.cpp
...
public:
    ...
    class hkCdBody & m_cdBodyA; // offset 0x20, size 0x4
    class hkCdBody & m_cdBodyB; // offset 0x24, size 0x4
};
enum enmAction {
    ACTION_NULL = 0,
    ACTION_DIVE = 1,
...
// Range: 0x4135F0 -> 0x413620
void clearTriggerData(class clsPlayerStartPointCollector * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4135F0 -> 0x413620
    }
...
// Range: 0x413620 -> 0x413650
void updateEnd(class clsPlayerStartPointCollector * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x413620 -> 0x413650
    }
...
// Range: 0x413650 -> 0x413680
void updateBegin(class clsPlayerStartPointCollector * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x413650 -> 0x413680
    }
...
// Range: 0x413680 -> 0x413848
void addCdPoint(class clsPlayerStartPointCollector * this /* r18 */, class hkCdPoint & event /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x413680 -> 0x413848
        class hkRigidBody * body; // r2
        class NNS_VECTORFAST sNormalVF; // r29+0x40
    }
}
