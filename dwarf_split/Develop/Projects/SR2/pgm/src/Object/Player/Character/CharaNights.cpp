/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\CharaNights.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32CollisionRadius; // size: 0x4, address: 0x688428
class stcParam asNightsLineParam[2]; // size: 0x80, address: 0x636AB0
...
struct /* @anon1 */ {
    // total size: 0x40
} __vt__14clsCharaNights; // size: 0x40, address: 0x6C6560
struct /* @anon3 */ {
    // total size: 0x40
...
public:
    ...
    class NNS_VECTORFAST m_asParticlePos[2]; // offset 0xE0, size 0x20
    class clsTask * m_apcParticleTask[2]; // offset 0x100, size 0x8
    class clsBackLineEffectTask * m_apcLineTask[2]; // offset 0x108, size 0x8
    class clsPlaySe_2D * m_pcPlaySe2D; // offset 0x110, size 0x4
};
...
// Range: 0x462DF0 -> 0x4630C0
void actionAttack00(class clsCharaNights * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x462DF0 -> 0x4630C0
        class clsPlayerTask * pcTargetPlayer; // r19
...
// Range: 0x4630D0 -> 0x4631C8
void initAttack00(class clsCharaNights * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4630D0 -> 0x4631C8
    }
...
// Range: 0x4631E0 -> 0x4632FC
void * __ct(class clsCharaNights * this /* r17 */, class clsPlayerTask * pcPlayer /* r16 */, unsigned char u8ModelType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4631E0 -> 0x4632FC
    }
