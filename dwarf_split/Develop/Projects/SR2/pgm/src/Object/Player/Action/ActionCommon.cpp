/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Action\ActionCommon.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class _ActionFuncTbl t_sActionFuncTbl[34]; // size: 0x330, address: 0x66BEF0
static unsigned char chk__clsPlayerTask_t_sActionFuncTbl_SizeCheck_[1]; // size: 0x1, address: 0x0
class clsPfSystem * m_tpcSingleton; // size: 0x4, address: 0x6E69B8
class stcTask sTask; // size: 0x30, address: 0xB0A900
float toaf32BonusPower[6]; // size: 0x18, address: 0x66C240
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x66C280
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x66C260
...
float tof32DriftMinSpeed; // size: 0x4, address: 0x6530B8
float t_of32DefaultSpeed; // size: 0x4, address: 0x664E10
class clsGameMgr * m_tpcSingleton; // size: 0x4, address: 0x6E6980
float t_of32FlightFloatingBaseRate; // size: 0x4, address: 0x664D68
float t_of32FlightFloatingDiffRate; // size: 0x4, address: 0x664D70
float t_of32FLightMaxSpeed; // size: 0x4, address: 0x664D50
float t_of32FlightResistanceRate; // size: 0x4, address: 0x664D60
float t_of32FlightMinSpeed; // size: 0x4, address: 0x664D58
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x66C270
...
class _ActionFuncTbl {
    // total size: 0x18
public:
    void pfInitAction; // offset 0x0, size 0x0
    void pfExexAction; // offset 0xC, size 0x0
};
class _sj_vtbl {
    // total size: 0x30
public:
...
// Range: 0x318380 -> 0x31859C
void useRingGear(class clsPlayerTask * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x318380 -> 0x31859C
        enum enmActionType eActionType; // r2
        unsigned char isRing; // r19
        unsigned char isRingGravity; // r2
        enum enmAction eGAction; // r2
    }
}


// Range: 0x3185A0 -> 0x318630
void updateObstacle(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3185A0 -> 0x318630
    }
...
// Range: 0x318630 -> 0x31891C
void breakObstacle(class clsPlayerTask * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x318630 -> 0x31891C
        float f32BonusAgp; // r20
        signed int s32MotionNo; // r2
        class clsBaseRace_Task & rcBaseRace_Task; // r2
    }
}


// Range: 0x318920 -> 0x31897C
void clearMoveSubParam(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x318920 -> 0x31897C
    }
...
// Range: 0x318980 -> 0x318D54
void checkDirectionRegulation(class clsPlayerTask * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x318980 -> 0x318D54
        class stcSpeedPath * opsSpeedPath; // r2
        float of32LimitRad; // r23
        float f32Dist; // r22
        float f32Rate; // r3
        float f32LimitRad; // r21
        float f32AddRad; // r20
        class NNS_QUATERNION sInvQuat; // r29+0xB0
...
// Range: 0x318D60 -> 0x318DDC
void clearCollisionFilterWalk(class clsPlayerTask * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x318D60 -> 0x318DDC
    }
...
// Range: 0x318DE0 -> 0x318E58
void setCollisionFilterWalk(class clsPlayerTask * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x318DE0 -> 0x318E58
    }
...
// Range: 0x318E60 -> 0x3190B0
unsigned int checkRailAction(class clsPlayerTask * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x318E60 -> 0x3190B0
        signed int s32OldPathNo; // r2
        unsigned int u32i; // r20
        unsigned char bFlag; // r19
    }
}


// Range: 0x3190B0 -> 0x31917C
void curveWalk(class clsPlayerTask * this /* r16 */, float f32Ratio /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3190B0 -> 0x31917C
        class stcData * psPrfm; // r2
        float f32CurveRad; // r20
    }
}


// Range: 0x319180 -> 0x319270
void acceleWalk(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x319180 -> 0x319270
        class stcData * psPrfm; // r2
        float f32LeverRate; // r29+0x20
    }
}


// Range: 0x319270 -> 0x319280
void endMovePath(class clsPlayerTask * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x319270 -> 0x319280
    }
...
// Range: 0x319280 -> 0x3193AC
void actionRateAccele(class clsPlayerTask * this /* r2 */, class stcLine * opsLine /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x319280 -> 0x3193AC
        float f32LengthRate; // r29
    }
}


// Range: 0x3193B0 -> 0x3194C8
void actionFrameAccele(class clsPlayerTask * this /* r2 */, class stcLine * opsLine /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3193B0 -> 0x3194C8
        signed int s32NowFrame; // r2
    }
}


// Range: 0x3194D0 -> 0x319550
void actionFreeAccele(class clsPlayerTask * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3194D0 -> 0x319550
    }
...
// Range: 0x319550 -> 0x319600
void actionFixedSpeed(class clsPlayerTask * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x319550 -> 0x319600
    }
...
// Range: 0x319600 -> 0x3196DC
void initRateAccele(class clsPlayerTask * this /* r2 */, class stcLine * opsLine /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x319600 -> 0x3196DC
    }
...
// Range: 0x3196E0 -> 0x3197BC
void initFrameAccele(class clsPlayerTask * this /* r2 */, class stcLine * opsLine /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3196E0 -> 0x3197BC
    }
...
// Range: 0x3197C0 -> 0x3198C0
void initFreeAccele(class clsPlayerTask * this /* r2 */, class stcLine * opsLine /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3197C0 -> 0x3198C0
    }
...
// Range: 0x3198C0 -> 0x3199B8
void initFixedSpeed(class clsPlayerTask * this /* r2 */, class stcLine * opsLine /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3198C0 -> 0x3199B8
        float f32Speed; // r29
...
// Range: 0x3199C0 -> 0x319C10
void requestJumpOrTrick(class clsPlayerTask * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3199C0 -> 0x319C10
    }
...
// Range: 0x319C10 -> 0x319E5C
void requestFlightAction(class clsPlayerTask * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x319C10 -> 0x319E5C
    }
...
// Range: 0x319E60 -> 0x319EC4
void checkGearChange(class clsPlayerTask * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x319E60 -> 0x319EC4
    }
...
// Range: 0x319ED0 -> 0x319F78
void checkGCtrlFlight(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x319ED0 -> 0x319F78
    }
...
// Range: 0x319F80 -> 0x31A028
void checkGCtrlTrick(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x319F80 -> 0x31A028
    }
...
// Range: 0x31A030 -> 0x31A25C
void checkGCtrlSlide(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31A030 -> 0x31A25C
    }
...
// Range: 0x31A260 -> 0x31A4AC
void checkGDive(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31A260 -> 0x31A4AC
    }
...
// Range: 0x31A4B0 -> 0x31A4F0
void checkBrake(class clsPlayerTask * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31A4B0 -> 0x31A4F0
    }
...
// Range: 0x31A4F0 -> 0x31A570
void registanceFlightFloating(class clsPlayerTask * this /* r2 */, float f32Accele /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31A4F0 -> 0x31A570
        float f32Ratio; // r29
...
// Range: 0x31A570 -> 0x31A5B0
void registanceFlightSpeed(class clsPlayerTask * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31A570 -> 0x31A5B0
    }
...
// Range: 0x31A5B0 -> 0x31A62C
void vibrationCurve(class clsPlayerTask * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31A5B0 -> 0x31A62C
    }
...
// Range: 0x31A630 -> 0x31A654
void vibrationLanding(class clsPlayerTask * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31A630 -> 0x31A654
    }
...
// Range: 0x31A660 -> 0x31A75C
void initCommonFlight(class clsPlayerTask * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31A660 -> 0x31A75C
        class stcData * psPrfm; // r2
...
// Range: 0x31A760 -> 0x31A844
void initCommonRun(class clsPlayerTask * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31A760 -> 0x31A844
        class stcData * psPrfm; // r2
...
// Range: 0x31A850 -> 0x31A8C0
void updateAction(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31A850 -> 0x31A8C0
        void pfExecAction; // r29+0x20
    }
}


// Range: 0x31A8C0 -> 0x31ABAC
void setActionType(class clsPlayerTask * this /* r18 */, enum enmActionType eType /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31A8C0 -> 0x31ABAC
        void pfInitAction; // r29+0x40
    }
}
