/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Action\ActionReStart.cpp
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x679790
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x679780
...
// Range: 0x351050 -> 0x351394
void initData_Restart(class clsPlayerTask * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x351050 -> 0x351394
...
// Range: 0x3513A0 -> 0x351E30
void actionReStart(class clsPlayerTask * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3513A0 -> 0x351E30
        class stcTargetCam1 sTgtCam1; // r29+0x220
    }
}


// Range: 0x352000 -> 0x352274
void initReStart(class clsPlayerTask * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x352000 -> 0x352274
    }
