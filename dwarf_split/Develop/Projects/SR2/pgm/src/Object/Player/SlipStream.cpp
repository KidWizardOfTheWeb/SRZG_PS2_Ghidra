/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\SlipStream.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float t_of32Range; // size: 0x4, address: 0x691C78
float t_of32RangeSq; // size: 0x4, address: 0x0
float t_of32MinSpeed; // size: 0x4, address: 0x0
...
// Range: 0x4E4BA0 -> 0x4E4C5C
void draw(class clsSlipStream * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E4BA0 -> 0x4E4C5C
        class NNS_VECTOR sCenterVec; // r29+0x40
        unsigned int u32PointNo; // r17
        signed int s32No; // r16
    }
}


// Range: 0x4E4C60 -> 0x4E5010
void execute(class clsSlipStream * this /* r30 */, class clsPlayerTask * pcPlayer /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E4C60 -> 0x4E5010
        class clsPlayerTask * pcOtherPlayer; // r2
        signed int i; // r21
        signed int s32No; // r20
        class NNS_SPHERE sSphere; // r29+0xD0
        class clsSlipStream & rcSlipStream; // r2
        unsigned int u32PointNo; // r19
        class NNS_CAPSULE sCapsule; // r29+0xB0
        unsigned int u32OldPointNo; // [invalid]
        float f32Dot; // r29+0xE0
        float f32PointRate; // r20
        float f32OtherSpeedRate; // r29+0xE0
    }
}


// Range: 0x4E5010 -> 0x4E50FC
void update(class clsSlipStream * this /* r2 */, class clsPlayerTask * pcPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E5010 -> 0x4E50FC
    }
