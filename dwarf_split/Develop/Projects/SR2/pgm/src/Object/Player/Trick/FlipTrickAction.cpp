/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Trick\FlipTrickAction.cpp
...
class stcFlipKicker oasKickerParam_FF_Default[]; // size: 0x0, address: 0x679D50
class stcFlipKicker * opsKickerParam_BF[21]; // size: 0x54, address: 0x626F40
...
// Range: 0x52DE00 -> 0x52E450
void execute(class clsFlipTrickAction * this /* r19 */, class clsTrickParam & rcParam /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52DE00 -> 0x52E450
        ...
        class stcFlipKicker * psKickerParam; // r3
        float f32StepUpFrame; // r20
    }
}


// Range: 0x52E450 -> 0x52E784
void init(class clsFlipTrickAction * this /* r20 */, class clsTrickParam & rcParam /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52E450 -> 0x52E784
        ...
        unsigned char u8Rank; // r2
        class stcFlipKicker * psKickerParam; // r16
    }
}
