/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Action\ActionGearRun.cpp
...
float tof32OneRingAddSpeed; // size: 0x4, address: 0x665890
...
// Range: 0x3169D0 -> 0x317354
void actionGearRun(class clsPlayerTask * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3169D0 -> 0x317354
        class clsGearBasePrototype * pcGear; // r16
        unsigned char u8Skip; // r21
...
// Range: 0x317360 -> 0x317470
void initGearRun(class clsPlayerTask * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x317360 -> 0x317470
    }
