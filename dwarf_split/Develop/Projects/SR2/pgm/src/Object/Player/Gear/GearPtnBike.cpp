/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Gear\GearPtnBike.cpp
...
// Range: 0x31F160 -> 0x31F4F4
void controlMotionCurve00(class clsGearPtnBike * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31F160 -> 0x31F4F4
        float f32Rate; // r1
...
// Range: 0x31F500 -> 0x31FE34
void Curve(class clsGearPtnBike * this /* r17 */, float f32Ratio /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31F500 -> 0x31FE34
        float f32FrameRate; // r3
        float f32LeverRate; // r2
        float f32CurveRad; // r21
        float f32CurveSpeedRate; // r20
        float f32MaxRotateRate; // r6
        float f32CurveRotateRate; // r1
        float f32CurveMotionRate; // r29+0x40
        float f32GripRate; // r1
        float f32CurveFrame; // r4
        signed int s32MotionNo; // r2
        float f32Rate; // r29+0x40
        float f32Rate; // r29+0x40
        float f32Accele; // r29+0x40
        float f32CurveMotRetAccele; // @ 0x00B0D8F8
    }
}


// Range: 0x31FE40 -> 0x3201C0
void behavior(class clsGearPtnBike * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31FE40 -> 0x3201C0
        ...
        float f32Offset; // r20
        float f32TransRate; // r20
        float f32FloatTrs; // r29+0xB0
        float f32AbsSpeed; // r3
        float f32Length; // r20
        float f32TransY; // r21
        float f32SideLength; // r20
        float f32TransX; // r29+0xB0
        float f32SideMov; // @ 0x00B0D8F0
        float f32Mov; // @ 0x00B0D8E8
    }
}


// Range: 0x3201C0 -> 0x3201C8
void clearChangeActionParam(class clsGearPtnBike * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3201C0 -> 0x3201C8
    }
