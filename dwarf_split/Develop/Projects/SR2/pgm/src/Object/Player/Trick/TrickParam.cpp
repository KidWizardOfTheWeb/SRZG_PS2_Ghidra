/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Trick\TrickParam.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x696180
...
// Range: 0x52F340 -> 0x52F3CC
void debugTrickKey(class clsTrickParam * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52F340 -> 0x52F3CC
        unsigned int ou32PlayerKey[5]; // r29
    }
}


// Range: 0x52F3D0 -> 0x52F544
unsigned char debugTrickParam(class clsTrickParam * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52F3D0 -> 0x52F544
        unsigned char bReturn; // r2
    }
}


// Range: 0x52F550 -> 0x52F56C
void debugTrickRank(class clsTrickParam * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52F550 -> 0x52F56C
    }
...
// Range: 0x52F570 -> 0x52F604
void reset(class clsTrickParam * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52F570 -> 0x52F604
    }
