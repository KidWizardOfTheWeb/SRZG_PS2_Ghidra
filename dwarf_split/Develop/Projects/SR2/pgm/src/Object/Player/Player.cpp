/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Player.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float NODE_VIB__ADD_CYCLE_A32; // size: 0x4, address: 0x664DB0
static class stcParam oasPlayerLineParam; // size: 0x40, address: 0x664DC0
static class stcTrickSubParam oasPlayerLineTrickParam; // size: 0xC, address: 0x664E00
float t_of32DefaultSpeed; // size: 0x4, address: 0x664E10
float t_of32DefaultMinSpeed; // size: 0x4, address: 0x664E18
float t_of32TurbMinSpeed; // size: 0x4, address: 0x664E20
float t_of32TurbMaxSpeed; // size: 0x4, address: 0x664E28
float t_of32SurfaceAdjustScale; // size: 0x4, address: 0x664E30
float t_of32RingRateTime; // size: 0x4, address: 0x664E38
float t_of32RingGravityRateTime; // size: 0x4, address: 0x664E40
signed int t_os32NotReplayCamMode; // size: 0x4, address: 0x0
static float toaf32StageMinimumHeightTable[17]; // size: 0x44, address: 0x664E50
static float toaf32RankingRingRateTable[8]; // size: 0x20, address: 0x664EA0
static float toaf32NotDamageRingRateTable[8]; // size: 0x20, address: 0x664EC0
struct /* @anon7 */ {
    // total size: 0x78
} __vt__13clsPlayerTask; // size: 0x78, address: 0x6B5B70
class clsGameMgr * m_tpcSingleton; // size: 0x4, address: 0x6E6980
float (* tpsNnMtxPal)[4][4]; // size: 0x4, address: 0x707DF0
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x665170
...
unsigned char m_tu8DrawFlg; // size: 0x1, address: 0xB15E40
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x665160
struct /* @anon21 */ {
    // total size: 0x30
...
struct /* @anon4 */ {
    // total size: 0x40
} __vt__13clsCharaBilly; // size: 0x40, address: 0x6B5DF0
struct /* @anon24 */ {
    // total size: 0x40
} __vt__13clsCharaSamba; // size: 0x40, address: 0x6B5E30
struct /* @anon18 */ {
    // total size: 0x40
} __vt__13clsCharaBlaze; // size: 0x40, address: 0x6B5E70
struct /* @anon19 */ {
    // total size: 0x40
} __vt__13clsCharaRouge; // size: 0x40, address: 0x6B5EB0
struct /* @anon3 */ {
    // total size: 0x40
} __vt__13clsCharaCream; // size: 0x40, address: 0x6B5EF0
struct /* @anon23 */ {
    // total size: 0x40
} __vt__13clsCharaTails; // size: 0x40, address: 0x6B5F30
struct /* @anon10 */ {
    // total size: 0xC4
} __vt__16clsComDefRaceKey; // size: 0xC4, address: 0x6B5D20
struct /* @anon20 */ {
    // total size: 0xC8
} __vt__21clsComSurvivalBallKey; // size: 0xC8, address: 0x6C6FF0
struct /* @anon25 */ {
    // total size: 0x28
} __vt__10clsUserKey; // size: 0x28, address: 0x6B5B10
signed int ts32ResidenceTextureSize_PS2; // size: 0x4, address: 0x707E28
class clsHavok * m_tpcSingleton; // size: 0x4, address: 0x707E60
struct /* @anon2 */ {
    // total size: 0xC8
} __vt__23clsComSurvivalBattleKey; // size: 0xC8, address: 0x6D1460
float of32BaseHeight; // size: 0x4, address: 0x6651C0
float tof32PlayerScale; // size: 0x4, address: 0x693610
struct /* @anon5 */ {
    // total size: 0x30
} __vt__15clsCommonMotion; // size: 0x30, address: 0x6B5C90
struct /* @anon8 */ {
    // total size: 0x30
} __vt__13clsRoboMotion; // size: 0x30, address: 0x6B5CC0
float t_of32OffsetWalkHeight; // size: 0x4, address: 0x664D98
class clsSpeedDown_Task * m_tpcSingleton; // size: 0x4, address: 0x707E68
float t_of32OffsetGearHeight; // size: 0x4, address: 0x664DA0
...
struct /* @anon9 */ {
    // total size: 0xC
} __vt__13clsCharaVoice; // size: 0xC, address: 0x6B5C38
struct /* @anon17 */ {
    // total size: 0x20
} __vt__20clsBaseGravityAction; // size: 0x20, address: 0x6B5BF0
struct /* @anon0 */ {
    // total size: 0x10
} __vt__9clsMotion; // size: 0x10, address: 0x6B5C50
struct /* @anon12 */ {
    // total size: 0x30
} __vt__15clsPlayerMotion; // size: 0x30, address: 0x6B5C60
struct /* @anon1 */ {
    // total size: 0x28
} __vt__12clsPlayerKey; // size: 0x28, address: 0x6B5B40
struct /* @anon6 */ {
    // total size: 0x2C
} __vt__8clsComAI; // size: 0x2C, address: 0x6B5CF0
struct /* @anon11 */ {
    // total size: 0xC4
} __vt__9clsComKey; // size: 0xC4, address: 0x6BD240
struct /* @anon16 */ {
    // total size: 0x40
} __vt__12clsCharacter; // size: 0x40, address: 0x6B5A20
struct /* @anon26 */ {
    // total size: 0x40
} __vt__16clsCharaNodeBase; // size: 0x40, address: 0x6B5A60
struct /* @anon22 */ {
    // total size: 0x2C
} __vt__9clsOOTask; // size: 0x2C, address: 0x6B58B0
struct /* @anon13 */ {
    // total size: 0xC
} __vt__14clsEggConfetti; // size: 0xC, address: 0x6B5F70
struct /* @anon27 */ {
    // total size: 0xC
} __vt__18clsNightsAtkEffect; // size: 0xC, address: 0x6B5F80
...
class clsSpeedDown_Task : public clsMultiModelGimmick_Task {
    // total size: 0xD8
public:
    class clsOODeque m_tddqUseObj; // offset 0x98, size 0x20
    class clsOODeque m_tddqUnUseObj; // offset 0xB8, size 0x20
};
...
class stcRetRayCast {
    // total size: 0x30
public:
    class NNS_VECTORFAST sCrossVecFast; // offset 0x0, size 0x10
    class NNS_VECTORFAST sNormalVecFast; // offset 0x10, size 0x10
    class stcInfo * psInfo; // offset 0x20, size 0x4
    class clsObject * pcObject; // offset 0x24, size 0x4
};
enum enm {
    NONE = -1,
    CHARA_0 = 0,
...
class hkBridgeConstraintAtom : public hkConstraintAtom {
    // total size: 0xC
public:
    void (* m_buildJacobianFunc)(class hkConstraintData *, class hkConstraintQueryIn &, class hkConstraintQueryOut &); // offset 0x4, size 0x4
    class hkConstraintData * m_constraintData; // offset 0x8, size 0x4
};
...
class reverse_iterator : public iterator {
    // total size: 0x4
public:
    class generic_iterator current; // offset 0x0, size 0x4
};
...
class clsRoboMotion : public clsPlayerMotion {
    // total size: 0x120
public:
    enum enmCharaType m_eCharaType; // offset 0x11C, size 0x4
};
...
class hkConstraintChainInstance : public hkConstraintInstance {
    // total size: 0x3C
public:
    class hkArray m_chainedEntities; // offset 0x2C, size 0xC
    class hkConstraintChainInstanceAction * m_action; // offset 0x38, size 0x4
};
...
class clsMultiModelGimmickHead_Task {
    // total size: 0x4
public:
    unsigned int m_u32NowDrawModelNum; // offset 0x0, size 0x4
};
...
class hkArray {
    // total size: 0xC
public:
    class ConstraintInfo * m_data; // offset 0x0, size 0x4
    signed int m_size; // offset 0x4, size 0x4
    signed int m_capacityAndFlags; // offset 0x8, size 0x4
};
enum enmWallType {
...
class ConstraintInfo {
    // total size: 0x20
public:
    class hkVector4 m_pivotInA; // offset 0x0, size 0x10
    class hkVector4 m_pivotInB; // offset 0x10, size 0x10
};
enum enmLanguage {
...
class hkBallSocketChainData : public hkConstraintChainData {
    // total size: 0x34
public:
    class hkBridgeAtoms m_atoms; // offset 0xC, size 0xC
    class hkArray m_infos; // offset 0x18, size 0xC
    float m_tau; // offset 0x24, size 0x4
    float m_damping; // offset 0x28, size 0x4
    float m_cfm; // offset 0x2C, size 0x4
    float m_maxErrorDistance; // offset 0x30, size 0x4
};
enum enmCorrectMode {
...
class clsMultiModelGimmick_Task : public clsBaseGimmickBody, public clsMultiModelGimmickHead_Task {
    // total size: 0x98
};
class stcInfo {
    // total size: 0x10
...
class hkArray {
    // total size: 0xC
public:
    class clsGimmickRigidBody * * m_data; // offset 0x0, size 0x4
    signed int m_size; // offset 0x4, size 0x4
    signed int m_capacityAndFlags; // offset 0x8, size 0x4
};
class clsOOClock {
...
public:
    ...
    class clsFrameControl m_cFrameControl; // offset 0x58, size 0x8
    class stcChainBallData m_asChainBallData[11]; // offset 0x60, size 0x210
    class NNS_VECTORFAST * m_psOffsetPosVecFast; // offset 0x270, size 0x4
    unsigned int m_u32NodeNo; // offset 0x274, size 0x4
    float m_f32BehaviorCnt; // offset 0x278, size 0x4
    float m_f32MaxSpeed; // offset 0x27C, size 0x4
    class hkArray m_vctpcRigidBody; // offset 0x280, size 0xC
    class hkConstraintChainInstance * m_pcChainInstance; // offset 0x28C, size 0x4
    class hkBallSocketChainData * m_pcChainData; // offset 0x290, size 0x4
};
class hkArray {
    // total size: 0xC
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsSpeedDown_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsMultiObTxModels m_cModel; // offset 0x88, size 0x8
...
class stcChainBallData {
    // total size: 0x30
public:
    class NNS_VECTORFAST sPosVecFast; // offset 0x0, size 0x10
    class NNS_QUATERNION sRotQuat; // offset 0x10, size 0x10
    class NNS_VECTORFAST sSpeedVecFast; // offset 0x20, size 0x10
};
class hkArray {
    // total size: 0xC
public:
...
class hkBridgeAtoms {
    // total size: 0xC
public:
    class hkBridgeConstraintAtom m_bridgeAtom; // offset 0x0, size 0xC
};
class vector : private __vector_imp {
    // total size: 0xC
};
...
// Range: 0x1E3DB0 -> 0x1E3DE4
unsigned char isDemo(class clsPlayerTask * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E3DB0 -> 0x1E3DE4
    }
...
// Range: 0x1E3DF0 -> 0x1E3E10
void setBoardMtx(class clsPlayerTask * this /* r2 */, unsigned int u32v /* r2 */, signed int s32Id /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E3DF0 -> 0x1E3E10
    }
...
// Range: 0x1E3E10 -> 0x1E3E78
void setRingNum(class clsPlayerTask * this /* r17 */, signed int s32Num /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E3E10 -> 0x1E3E78
    }
...
// Range: 0x1E3E80 -> 0x1E3EE8
void updateLightNo(class clsPlayerTask * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E3E80 -> 0x1E3EE8
        class reverse_iterator rit'66; // r2
        class reverse_iterator rit; // r29+0xFFFFFFFC
    }
}


// Range: 0x1E3EF0 -> 0x1E3F60
void deleteLightCollision(class clsPlayerTask * this /* r16 */, class clsThroughCollision * pcCollision /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E3EF0 -> 0x1E3F60
        class generic_iterator it'47; // r2
        class generic_iterator it; // r29+0x2C
    }
}


// Range: 0x1E3F60 -> 0x1E4018
void registLightCollision(class clsPlayerTask * this /* r16 */, class clsThroughCollision * pcCollision /* r29+0x28 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E3F60 -> 0x1E4018
        class generic_iterator it'62; // r2
        class generic_iterator it; // r29+0x3C
    }
}


// Range: 0x1E4020 -> 0x1E4048
unsigned char isReverse(class clsPlayerTask * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E4020 -> 0x1E4048
    }
...
// Range: 0x1E4050 -> 0x1E4524
void contactTriggerEvent(class clsPlayerTask * this /* r17 */, class hkContactPoint * pcContact /* r2 */, class clsObject * pcObject /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E4050 -> 0x1E4524
        class clsPlayerTask * pcHitPlayer; // r2
        class NNS_VECTORFAST sContactVecFast; // r29+0xA0
        class NNS_VECTORFAST sDirVecFast; // r29+0x90
        float f32PriorityOwn; // r23
        float f32PriorityOther; // r29+0xB0
        float f32Dot; // r20
        float f32Move; // r29+0xB0
        float sInvMtx[4][4]; // r29+0x50
        class NNS_VECTORFAST sOffsetVecFast; // r29+0x40
    }
}


// Range: 0x1E4530 -> 0x1E4568
void changeUserToCom(class clsPlayerTask * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E4530 -> 0x1E4568
    }
...
// Range: 0x1E4570 -> 0x1E47EC
void calcNodePos(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E4570 -> 0x1E47EC
        class clsCharacter & rcChara; // r2
        float (* psMtxList)[4][4]; // r2
        signed int s32BornId1; // r2
        signed int s32BornId3; // r2
        signed int GravityNodeTbl[19]; // r29+0xE0
        signed int s32BornId2; // r2
        signed int s32BornId4; // r2
        signed int s32BornId5; // r2
        signed int s32BornId6; // r2
        signed int s32BornId7; // r2
        signed int s32BornId8; // r2
        signed int oas32NodeNo[8]; // r29+0xC0
        unsigned char u8n; // r19
        class NNS_VECTORFAST sFollowVF; // r29+0xB0
    }
}


// Range: 0x1E47F0 -> 0x1E482C
void stopSlipStreamEffect(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E47F0 -> 0x1E482C
    }
...
// Range: 0x1E4830 -> 0x1E4868
void updateSlipStreamEffect(class clsPlayerTask * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E4830 -> 0x1E4868
    }
...
// Range: 0x1E4870 -> 0x1E48CC
void setSlipStreamEffect(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E4870 -> 0x1E48CC
    }
...
// Range: 0x1E48D0 -> 0x1E4974
void setStartDemoEffect(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E48D0 -> 0x1E4974
    }
...
// Range: 0x1E4980 -> 0x1E49B0
void setDrawBackLineFlg(class clsPlayerTask * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E4980 -> 0x1E49B0
    }
...
// Range: 0x1E49B0 -> 0x1E4A90
void demoMotionWeather(class clsPlayerTask * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E49B0 -> 0x1E4A90
    }
...
// Range: 0x1E4A90 -> 0x1E4AB8
void setWeather(class clsPlayerTask * this /* r2 */, unsigned char u8No /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E4A90 -> 0x1E4AB8
    }
...
// Range: 0x1E4AC0 -> 0x1E4ADC
unsigned char checkLoopEffect(class clsPlayerTask * this /* r2 */, unsigned char u8No /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E4AC0 -> 0x1E4ADC
    }
...
// Range: 0x1E4AE0 -> 0x1E4B28
void stopLoopEffect(class clsPlayerTask * this /* r2 */, unsigned char u8No /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E4AE0 -> 0x1E4B28
    }
...
// Range: 0x1E4B30 -> 0x1E4B5C
unsigned char setLoopEffect(class clsPlayerTask * this /* r2 */, unsigned char u8No /* r2 */, class clsTask * pcEffectTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E4B30 -> 0x1E4B5C
    }
...
// Range: 0x1E4B60 -> 0x1E4C0C
unsigned char setLoopEffect(class clsPlayerTask * this /* r19 */, unsigned char u8No /* r2 */, unsigned int u32TIp /* r18 */, class clsModelType_OB_TX_MO_MA * pcModel /* r17 */, unsigned int u32Flg /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E4B60 -> 0x1E4C0C
    }
...
// Range: 0x1E4C10 -> 0x1E4CA0
void stopLoopParticle(class clsPlayerTask * this /* r17 */, unsigned char u8No /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E4C10 -> 0x1E4CA0
    }
...
// Range: 0x1E4CA0 -> 0x1E4E04
unsigned char setLoopParticle(class clsPlayerTask * this /* r18 */, unsigned char u8No /* r2 */, unsigned int u32View /* r2 */, unsigned int u32Particle /* r17 */, unsigned char u8Type /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E4CA0 -> 0x1E4E04
    }
...
// Range: 0x1E4E10 -> 0x1E4E34
void setVaporTrail(class clsPlayerTask * this /* r2 */, unsigned char bFlg /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E4E10 -> 0x1E4E34
    }
...
// Range: 0x1E4E40 -> 0x1E4EB0
void setFalseStartAction(class clsPlayerTask * this /* r16 */, signed int s32ShockFrame /* r2 */, signed int s32PenaltyFrame /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E4E40 -> 0x1E4EB0
    }
...
// Range: 0x1E4EB0 -> 0x1E4EF4
void setGoalComPlayer(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E4EB0 -> 0x1E4EF4
    }
...
// Range: 0x1E4F00 -> 0x1E5340
unsigned char GoalPlayer(class clsPlayerTask * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E4F00 -> 0x1E5340
        unsigned int u32WinLoseFlag; // r16
    }
}


// Range: 0x1E5340 -> 0x1E5878
void changeCameraRq(class clsPlayerTask * this /* r19 */, unsigned int u32Type /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E5340 -> 0x1E5878
    }
...
// Range: 0x1E5880 -> 0x1E5FA4
void changeTrickCameraRq(class clsPlayerTask * this /* r18 */, unsigned char u8Rank /* r2 */, enum enmKicker eKickerType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E5880 -> 0x1E5FA4
    }
...
// Range: 0x1E5FB0 -> 0x1E6044
void reconfigurationVelocity(class clsPlayerTask * this /* r17 */, class NNS_VECTORFAST * opsVelocityVecFast /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E5FB0 -> 0x1E6044
        float sInvMtx[4][4]; // r29+0x50
        class NNS_VECTORFAST sVecFast; // r29+0x40
    }
}


// Range: 0x1E6050 -> 0x1E60AC
void setInertia(class clsPlayerTask * this /* r16 */, class NNS_VECTORFAST * psNrmDirVecFast /* r2 */, float f32Speed /* r29+0x30 */, float f32Frame /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E6050 -> 0x1E60AC
    }
...
// Range: 0x1E60B0 -> 0x1E687C
void draw(class clsPlayerTask * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E60B0 -> 0x1E687C
        float f32Ret; // r29+0x15C
        float sMtx[4][4]; // r29+0x110
        unsigned int u32AddDrawFlag; // r20
    }
}


// Range: 0x1E6AA0 -> 0x1E84A8
void execute(class clsPlayerTask * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E6AA0 -> 0x1E84A8
        class NNS_VECTORFAST sFixedPosVecFast; // r29+0xC0
    }
}


// Range: 0x1E8660 -> 0x1E8668
void behaviorMtxPal() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E8660 -> 0x1E8668
...
// Range: 0x1E8730 -> 0x1E89E0
void behaviorTrs(class clsPlayerTask * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E8730 -> 0x1E89E0
    }
...
// Range: 0x1E8EC0 -> 0x1E9584
void setGroundEffect(class clsPlayerTask * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E8EC0 -> 0x1E9584
    }
...
// Range: 0x1E9920 -> 0x1E99F0
void createGear(class clsPlayerTask * this /* r18 */, enum enmGearCtrl eGearCtrlNo /* r17 */, unsigned int u32InitEquipsGears /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E9920 -> 0x1E99F0
        char __FUNCTION__[11]; // @ 0x00664F10
    }
}


// Range: 0x1E99F0 -> 0x1E9F98
void createChara(class clsPlayerTask * this /* r17 */, enum enmCharaType eCharaType /* r18 */, enum enmModelType eModelType /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E99F0 -> 0x1E9F98
        char __FUNCTION__[12]; // @ 0x00664F00
    }
}


// Range: 0x1E9FA0 -> 0x1EA0C0
void initKey(class clsPlayerTask * this /* r16 */, unsigned char u8PadNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E9FA0 -> 0x1EA0C0
    }
...
// Range: 0x1EA5F0 -> 0x1EA800
void initCamera(class clsPlayerTask * this /* r18 */, enum enPlayerCtrlType eCtrlType /* r2 */, unsigned int u32CharaNo /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EA5F0 -> 0x1EA800
        class stcCamFilter sBigCharaRegularFilter; // r29+0x60
    }
}


// Range: 0x1EA800 -> 0x1EB274
void init(class clsPlayerTask * this /* r20 */, enum enmNo ePlayerNo /* r19 */, enum enPlayerCtrlType eCtrlType /* r18 */, unsigned int u32CharaNo /* r17 */, enum enmGearCtrl eGearCtrlNo /* r16 */, unsigned int u32GearLevel /* r23 */, unsigned char u8PadNo /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EA800 -> 0x1EB274
        class clsBaseStage_Task * pcStage; // r21
        class NNS_VECTORFAST sTmpVF; // r29+0xA0
        class NNS_VECTORFAST sTrickVF; // r29+0x90
        unsigned int u32SeGlindId; // r2
        unsigned int u32SeDirtId; // r21
        unsigned int u32SeDirtId2; // r22
        unsigned int u32SeSliderId; // r19
        enum enmModelType eModelType; // r18
        float toaf32MotionClipDistx1[4]; // @ 0x00664EF0
        float toaf32DrawClipDistx2[4]; // @ 0x00664EE0
    }
}


// Range: 0x1EB320 -> 0x1EB3E4
void createMothion(class clsPlayerTask * this /* r16 */, enum enmCharaType enCharaType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EB320 -> 0x1EB3E4
    }
...
// Range: 0x1EB5C0 -> 0x1EBFE0
void reset(class clsPlayerTask * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EB5C0 -> 0x1EBFE0
        unsigned char u8n; // r16
    }
}


// Range: 0x1EC120 -> 0x1EC160
void setClearStatus(class clsPlayerTask * this /* r2 */, enum enmStatus eStatus /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EC120 -> 0x1EC160
    }
...
// Range: 0x1EC160 -> 0x1EC1A4
void setAndStatus(class clsPlayerTask * this /* r2 */, enum enmStatus eStatus /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EC160 -> 0x1EC1A4
    }
...
// Range: 0x1EC1B0 -> 0x1EC2A8
void clearPlayerCondition(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EC1B0 -> 0x1EC2A8
    }
...
// Range: 0x1EC2B0 -> 0x1EC3B4
void setNightsAtkEffectStatus(class clsPlayerTask * this /* r16 */, float f32Frame /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EC2B0 -> 0x1EC3B4
    }
...
// Range: 0x1EC3C0 -> 0x1EC4AC
void setEggConfettiStatus(class clsPlayerTask * this /* r16 */, float f32Frame /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EC3C0 -> 0x1EC4AC
    }
...
// Range: 0x1EC4B0 -> 0x1EC520
void setSpeedDownStatus(class clsPlayerTask * this /* r16 */, float f32Frame /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EC4B0 -> 0x1EC520
    }
...
// Range: 0x1EC520 -> 0x1EC65C
void setTrapPartsLockStatus(class clsPlayerTask * this /* r16 */, float f32Frame /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EC520 -> 0x1EC65C
    }
...
// Range: 0x1EC660 -> 0x1EC7F4
void setTrapColorBallStatus(class clsPlayerTask * this /* r16 */, float f32Frame /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EC660 -> 0x1EC7F4
    }
...
// Range: 0x1EC800 -> 0x1EC818
void setInvincibilityStatus(class clsPlayerTask * this /* r2 */, float f32Frame /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EC800 -> 0x1EC818
    }
...
// Range: 0x1EC820 -> 0x1EC838
void setDamageStatus(class clsPlayerTask * this /* r2 */, float f32Frame /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EC820 -> 0x1EC838
    }
...
// Range: 0x1EC840 -> 0x1ECA78
void update(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EC840 -> 0x1ECA78
        class NNS_VECTORFAST sPosVecFast; // r29+0xC0
        class NNS_VECTORFAST sOffsetVecFast; // r29+0xB0
        float f32Offset; // r29+0xD0
        float f32Height; // r29+0xD0
        float f32Offset; // r20
        float sSclMtx[4][4]; // r29+0x70
        float & rf32Frame; // r2
    }
}


// Range: 0x1ECA80 -> 0x1ED288
void calcVelocity(class clsPlayerTask * this /* r17 */, class NNS_VECTORFAST * psVelocityVecFast /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1ECA80 -> 0x1ED288
        class NNS_VECTORFAST sSpeedVecFast; // r29+0xA0
        float f32FrameRate; // r23
        float f32MaxSpeed; // r22
        float af32SlowDownRateTable[2]; // r29+0xB8
        float f32SlowDownRate; // r29+0xC0
        float f32SpeedRate; // r1
    }
}


// Range: 0x1ED300 -> 0x1ED72C
void physic(class clsPlayerTask * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1ED300 -> 0x1ED72C
        unsigned char u8Attr; // r2
        float sInvMtx[4][4]; // r29+0x40
        class NNS_VECTORFAST sDwnVecFast; // r29+0x30
        class stcData * psPrfm; // r2
        float f32MaxSpeed; // r29+0x80
    }
}


// Range: 0x1ED730 -> 0x1ED7C4
void quakeCamera(class clsPlayerTask * this /* r17 */, signed int s32Index /* r16 */, float f32Frame /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1ED730 -> 0x1ED7C4
        class stcCamFilter sQuakeFilter; // r29+0x40
    }
}


// Range: 0x1ED7D0 -> 0x1ED9CC
void restrictTurbRun(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1ED7D0 -> 0x1ED9CC
        class stcRetRayCast sRetRayCast; // r29+0x90
        class NNS_VECTORFAST sRayVF; // r29+0x80
        class NNS_VECTORFAST sRankVF; // r29+0x70
        class NNS_VECTORFAST sStartPosVF; // r29+0x60
        class NNS_VECTORFAST sDownVF; // r29+0x50
        class NNS_VECTORFAST sDownMinVF; // r29+0x40
        class NNS_VECTORFAST sTmpVF; // r29+0x30
    }
}


// Range: 0x1ED9D0 -> 0x1EDA34
void setSetData(class clsPlayerTask * this /* r4 */, class stcSetDataDetail * opsSetDataDetailI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1ED9D0 -> 0x1EDA34
    }
...
// Range: 0x1EDA40 -> 0x1EDD98
void * __dt(class clsPlayerTask * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EDA40 -> 0x1EDD98
    }
...
// Range: 0x1EDE40 -> 0x1EDE58
float getStageMinimumHeight(unsigned int u32StageNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EDE40 -> 0x1EDE58
    }
...
// Range: 0x1EEA70 -> 0x1EEA78
void @64@preparesNextLineAction__9clsComKeyFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EEA70 -> 0x1EEA78
    }
...
// Range: 0x1EEA80 -> 0x1EEA88
void @64@__dt__16clsComDefRaceKeyFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EEA80 -> 0x1EEA88
    }
...
// Range: 0x1EEA90 -> 0x1EEA98
void @4@reset__13clsPlayerTaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EEA90 -> 0x1EEA98
    }
...
// Range: 0x1EEAA0 -> 0x1EEAA8
void @4@draw__13clsPlayerTaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EEAA0 -> 0x1EEAA8
    }
...
// Range: 0x1EEAB0 -> 0x1EEAB8
void @4@execute__13clsPlayerTaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EEAB0 -> 0x1EEAB8
    }
...
// Range: 0x1EEAC0 -> 0x1EEAC8
void @4@__dt__13clsPlayerTaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EEAC0 -> 0x1EEAC8
    }
