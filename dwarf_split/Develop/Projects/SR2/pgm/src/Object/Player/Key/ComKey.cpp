/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Key\ComKey.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
void t_pfExecAction[34]; // size: 0x0, address: 0x6754A0
static unsigned char chk__clsComKey_t_pfExecAction_SizeCheck_[1]; // size: 0x1, address: 0x0
struct /* @anon2 */ {
    // total size: 0xC4
...
unsigned char oau8GearChangeRate100[][19][2][6]; // size: 0x0, address: 0x678820
...
class __wrap_iterator {
    // total size: 0x4
public:
    signed int * it_; // offset 0x0, size 0x4
};
...
// Range: 0x32EB90 -> 0x32F0D8
void preparesNextLineAction(class clsComKey * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32EB90 -> 0x32F0D8
        class __wrap_iterator it'257; // r2
        class clsBaseRace_Task * pcRace; // r2
        unsigned short u16GearReqs; // r16
        unsigned short u16GearType; // r20
        class vector vecChangeReq; // r29+0xE8
        class __wrap_iterator it; // r29+0xFC
        signed int s32Rate100; // r20
        unsigned char * pau8ChangeTable; // r2
        enum enmLevel eChangeGearLevel; // r2
        unsigned char bAutoWallFlag; // r16
    }
}


// Range: 0x32F0E0 -> 0x32F368
void updateKey(class clsComKey * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32F0E0 -> 0x32F368
        enum enmActionType eActionType; // r2
        float f32Distance; // r29+0x40
    }
}


// Range: 0x32F370 -> 0x32F3A8
void playSfSe_Com(class clsComKey * this /* r2 */, signed int s32Id /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32F370 -> 0x32F3A8
    }
...
// Range: 0x32F3B0 -> 0x32F3E8
void playSfSe_User(class clsComKey * this /* r2 */, signed int s32Id /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32F3B0 -> 0x32F3E8
    }
...
// Range: 0x32F3F0 -> 0x32F3F8
void @64@__dt__9clsComKeyFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32F3F0 -> 0x32F3F8
    }
