/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\PlayerPhysic.cpp
...
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x66A570
...
struct /* @anon5 */ {
    // total size: 0x10
} __vt__28clsPlayerStartPointCollector; // size: 0x10, address: 0x6BBBC0
...
struct /* @anon4 */ {
    // total size: 0xC
} __vt__16clsCollectorInfo; // size: 0xC, address: 0x6BBBB0
struct /* @anon0 */ {
    // total size: 0x10
} __vt__18hkCdPointCollector; // size: 0x10, address: 0x6B6630
struct /* @anon7 */ {
    // total size: 0x10
} __vt__27clsPlayerCastPointCollector; // size: 0x10, address: 0x6BBBD0
...
public:
    ...
    float m_dynamicFriction; // offset 0x20, size 0x4
    float m_staticFriction; // offset 0x24, size 0x4
    float m_keepContactTolerance; // offset 0x28, size 0x4
    class hkVector4 m_up; // offset 0x30, size 0x10
    float m_extraUpStaticFriction; // offset 0x40, size 0x4
    float m_extraDownStaticFriction; // offset 0x44, size 0x4
    class hkShapePhantom * m_shapePhantom; // offset 0x48, size 0x4
    float m_keepDistance; // offset 0x4C, size 0x4
    float m_contactAngleSensitivity; // offset 0x50, size 0x4
    unsigned int m_userPlanes; // offset 0x54, size 0x4
    float m_maxCharacterSpeedForSolver; // offset 0x58, size 0x4
    float m_characterStrength; // offset 0x5C, size 0x4
    float m_characterMass; // offset 0x60, size 0x4
    float m_maxSlope; // offset 0x64, size 0x4
    float m_penetrationRecoverySpeed; // offset 0x68, size 0x4
    signed int m_maxCastIterations; // offset 0x6C, size 0x4
    unsigned char m_refreshManifoldInCheckSupport; // offset 0x70, size 0x1
};
enum enmFlag {
    FLAG_CLEAR = 0,
    FLAG_NOT_GRAVITY = 1,
...
// Range: 0x2E8090 -> 0x2E815C
void disableAttack(class clsPlayerPhysic * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2E8090 -> 0x2E815C
    }
...
// Range: 0x2E8160 -> 0x2E839C
void reset(class clsPlayerPhysic * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2E8160 -> 0x2E839C
    }
...
// Range: 0x2E83A0 -> 0x2E9630
void update(class clsPlayerPhysic * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2E83A0 -> 0x2E9630
        class hkAllCdBodyPairCollector cCollecter; // r29+0x3F0
        unsigned int u32i; // r20
        unsigned int u32HitFlag; // r19
    }
}


// Range: 0x2E9DD0 -> 0x2E9ED8
void * __dt(class clsPlayerPhysic * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2E9DD0 -> 0x2E9ED8
    }
...
// Range: 0x2EA120 -> 0x2EA4B0
void * __ct(class clsPlayerPhysic * this /* r19 */, class clsPlayerTask * pcPlayer /* r18 */, float f32Radius /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EA120 -> 0x2EA4B0
        class hkCharacterProxyCinfo cpci; // r29+0x60
    }
}


// Range: 0x2EA8F0 -> 0x2EAA44
void setAttackRadius(class clsPlayerPhysic * this /* r19 */, float f32Radius /* r29+0x60 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2EA8F0 -> 0x2EAA44
    }
