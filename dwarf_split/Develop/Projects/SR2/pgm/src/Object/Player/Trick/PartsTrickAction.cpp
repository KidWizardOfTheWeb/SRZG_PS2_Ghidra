/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Trick\PartsTrickAction.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x1C
} __vt__19clsPartsTrickAction; // size: 0x1C, address: 0x6CEBA0
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x696B80
float oaf32KickerRateTable[9][3]; // size: 0x6C, address: 0x67B470
...
// Range: 0x53C9B0 -> 0x53CABC
float calcRankPath(class clsTrickParam & rcParam /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53C9B0 -> 0x53CABC
        ...
        float f32Rate; // r29+0x130
    }
}


// Range: 0x53CAC0 -> 0x53CB6C
enum enmKickerRankZone checkTrickRankZone(class clsPartsTrickAction * this /* r2 */, class clsTrickParam & rcParam /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53CAC0 -> 0x53CB6C
        float * opaf32KickerRateTable; // r2
        float f32LengthRate; // r29+0x20
    }
}


// Range: 0x53CB70 -> 0x53CBD4
void settingTrickParam(class clsPartsTrickAction * this /* r17 */, class clsTrickParam & rcParam /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53CB70 -> 0x53CBD4
        float f32LengthRate; // r29+0x30
    }
}
