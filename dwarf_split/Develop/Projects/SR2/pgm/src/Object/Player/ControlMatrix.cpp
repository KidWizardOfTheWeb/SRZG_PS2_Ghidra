/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\ControlMatrix.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x66AD40
...
// Range: 0x300F80 -> 0x301078
void reset(class clsControlMatrix * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x300F80 -> 0x301078
    }
...
// Range: 0x301080 -> 0x30146C
void update(class clsControlMatrix * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x301080 -> 0x30146C
    }
