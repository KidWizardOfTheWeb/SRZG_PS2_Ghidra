/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\PS2_ShadowVolume.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned char m_oau8BoardNodeNo[19]; // size: 0x13, address: 0x690400
static unsigned char chk__clsShadowVolume_Task_m_oau8BoardNodeNo_SizeCheck_[1]; // size: 0x1, address: 0x0
struct /* @anon0 */ {
    // total size: 0x30
} __vt__20clsShadowVolume_Task; // size: 0x30, address: 0x6C9AB0
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x690430
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x690440
...
class clsShadowVolume_Task : public clsTask {
    // total size: 0x58
public:
    class clsModelType_OB m_cModel; // offset 0x54, size 0x4
};
class stcFactor {
    // total size: 0x1C
public:
...
// Range: 0x4D5850 -> 0x4D5C88
void drawShadow(class clsShadowVolume_Task * this /* r2 */, unsigned int u32v /* r21 */, class clsPlayerTask * pcPlayer /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D5850 -> 0x4D5C88
...
// Range: 0x4D5C90 -> 0x4D5E50
void draw(class clsShadowVolume_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D5C90 -> 0x4D5E50
        class clsPlayerTask * pcPlayer; // r2
        unsigned char bMultiShadow; // r2
