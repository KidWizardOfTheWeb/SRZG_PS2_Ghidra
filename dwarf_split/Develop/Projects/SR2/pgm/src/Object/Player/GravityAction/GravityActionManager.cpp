/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\GravityAction\GravityActionManager.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float t_of32InvalidGCtrlFrame; // size: 0x4, address: 0x682758
...
// Range: 0x3D63A0 -> 0x3D63E4
void draw(class clsGravityActionManager * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D63A0 -> 0x3D63E4
    }
...
// Range: 0x3D63F0 -> 0x3D645C
void checkLimitPoint(class clsGravityActionManager * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D63F0 -> 0x3D645C
    }
...
// Range: 0x3D6460 -> 0x3D6494
float getTakePoint(class clsGravityActionManager * this /* r2 */, float f32Point /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D6460 -> 0x3D6494
    }
...
// Range: 0x3D64A0 -> 0x3D67CC
void updateSearch(class clsGravityActionManager * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D64A0 -> 0x3D67CC
        class clsPlayerTask * pcPlayer; // r2
        class clsRigidBodyGimmickObj * pcGimmick; // r2
        signed int i; // r18
        class hkVector4 cPos; // r29+0x180
        class hkAllCdBodyPairCollector cCollector; // r29+0x60
    }
}


// Range: 0x3D67D0 -> 0x3D680C
void endSearch(class clsGravityActionManager * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D67D0 -> 0x3D680C
    }
...
// Range: 0x3D6810 -> 0x3D69A4
void startSearch(class clsGravityActionManager * this /* r17 */, float f32Radius /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D6810 -> 0x3D69A4
...
// Range: 0x3D69B0 -> 0x3D6B10
void reset(class clsGravityActionManager * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D69B0 -> 0x3D6B10
        signed int i; // r19
...
// Range: 0x3D6B10 -> 0x3D6BD4
void update(class clsGravityActionManager * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D6B10 -> 0x3D6BD4
    }
...
// Range: 0x3D6BE0 -> 0x3D6D64
void setType(class clsGravityActionManager * this /* r16 */, enum enmType eType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D6BE0 -> 0x3D6D64
    }
