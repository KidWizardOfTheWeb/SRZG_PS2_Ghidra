/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Key\ComSurvivalBattleKey.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ModeRunFrame_MoveItemBox; // size: 0x4, address: 0x0
float tof32ModeRunFrame_MoveCourse; // size: 0x4, address: 0x0
float tof32ModeRunFrame_EscapeMissile; // size: 0x4, address: 0x0
float tof32ModeRunFrame_SearchPlayer; // size: 0x4, address: 0x0
static signed int toas32OddsTabele_Bomb[2][5]; // size: 0x28, address: 0x69A580
static signed int toas32OddsTabele_Missile[2][5]; // size: 0x28, address: 0x69A5B0
static signed int toas32OddsTabele_Noting[5]; // size: 0x14, address: 0x69A5E0
struct /* @anon3 */ {
    // total size: 0xC8
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x69A600
...
class clsComSurvivalBattleKey : public clsComKey {
    // total size: 0x1A0
public:
    enum enmMode m_eMode; // offset 0x190, size 0x4
    float m_f32ModeRunFrame; // offset 0x194, size 0x4
};
class hkEnum {
    // total size: 0x1
public:
...
enum enmMode {
    MODE__MOVE_ITEMBOX = 0,
    MODE__MOVE_COURSE = 1,
    MODE__ESCAPE_MISSILE = 2,
    MODE__SEARCH_PLAYER = 3,
};
...
class stcRotateData {
    // total size: 0x10
public:
    float m_f32DotPro; // offset 0x0, size 0x4
    float m_f32RotateRadX; // offset 0x4, size 0x4
    float m_f32RotateRadY; // offset 0x8, size 0x4
    signed int m_s32Relesed; // offset 0xC, size 0x4
};
class clsOOClock {
    // total size: 0x24
public:
...
// Range: 0x586BB0 -> 0x586D04
void calcMoveItemBox(class clsComSurvivalBattleKey * this /* r30 */, class NNS_VECTORFAST * psTargetVecFast /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x586BB0 -> 0x586D04
        class clsItemBox_Task * pcItmBoxTask; // r2
        unsigned int u32ItemNum; // r2
        class NNS_VECTORFAST * psPosVecFast; // r16
        class NNS_VECTORFAST * psTrgPosVecFast[2]; // r29+0xA0
        float f32MinDistance[2]; // r29+0xA8
        float f32DistTmp; // r29+0xB0
        unsigned int u32i; // r22
        signed int s32ActiveNo; // r2
    }
}


// Range: 0x586D10 -> 0x58700C
void calcMoveCourse(class clsComSurvivalBattleKey * this /* r21 */, class NNS_VECTORFAST * psTargetVecFast /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x586D10 -> 0x58700C
        class _LineData * opsLineData; // r20
        class NNS_VECTORFAST * opsTargetPosVecFast; // r19
        class NNS_VECTORFAST sTmpVecFast; // r29+0xB0
        class NNS_VECTORFAST sPathDirVecFast; // r29+0xA0
        unsigned char bReverse; // r22
        float f32DistSq; // r20
    }
}


// Range: 0x587010 -> 0x5874E4
void calcRotateTargetPoint(class clsComSurvivalBattleKey * this /* r19 */, class stcRotateData * pcData /* r16 */, class NNS_VECTORFAST * psTargetVecFast /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x587010 -> 0x5874E4
        class NNS_VECTORFAST sTargetDirVecFast; // r29+0xB0
        class NNS_VECTORFAST sPlayerDirVecFast; // r29+0xA0
...
// Range: 0x5874F0 -> 0x587770
void selectModeOddsTable(class clsComSurvivalBattleKey * this /* r17 */, signed int * ops32Table /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5874F0 -> 0x587770
    }
...
// Range: 0x587770 -> 0x587964
void selectMode(class clsComSurvivalBattleKey * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x587770 -> 0x587964
    }
...
// Range: 0x587970 -> 0x587B90
unsigned int execGCtrlSlide(class clsComSurvivalBattleKey * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x587970 -> 0x587B90
        class stcRotateData sRotData; // r29+0x40
        float f32RadX; // r20
        float f32RadY; // r29+0x50
...
// Range: 0x587B90 -> 0x587D74
unsigned int execRun(class clsComSurvivalBattleKey * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x587B90 -> 0x587D74
        class stcRotateData sRotData; // r29+0x30
        class NNS_VECTORFAST sTargetVecFast; // r29+0x20
...
// Range: 0x587D80 -> 0x587F48
unsigned int execWalk(class clsComSurvivalBattleKey * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x587D80 -> 0x587F48
        class stcRotateData sRotData; // r29+0x30
...
// Range: 0x587F50 -> 0x587F58
void @64@controlGoalTime__23clsComSurvivalBattleKeyFSc() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x587F50 -> 0x587F58
    }
...
// Range: 0x587F60 -> 0x587F68
void @64@__dt__23clsComSurvivalBattleKeyFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x587F60 -> 0x587F68
    }
