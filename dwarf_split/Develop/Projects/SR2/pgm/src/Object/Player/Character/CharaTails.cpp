/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\CharaTails.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32CollisionRadius; // size: 0x4, address: 0x675208
...
class clsCharaTails : public clsCharaNodeBase {
    // total size: 0x70
public:
    unsigned char m_u8BeforeMotNo; // offset 0x60, size 0x1
    class NNS_MOTION * m_psMotionA; // offset 0x64, size 0x4
    class NNS_MOTION * m_psMotionB; // offset 0x68, size 0x4
    class clsPlaySe_2D * m_pcPlaySe2D; // offset 0x6C, size 0x4
};
...
// Range: 0x32B020 -> 0x32B2C8
void actionAttack00(class clsCharaTails * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32B020 -> 0x32B2C8
        unsigned char u8MotNo; // r2
        class clsModelType_OB_TX_MO_MA * pcModel; // r2
        float f32Dist; // r29+0x40
        class clsPlayerTask * pcTargetPlayer; // r18
    }
}


// Range: 0x32B2D0 -> 0x32B458
void draw(class clsCharaTails * this /* r18 */, unsigned int u32AddDrawFlagI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32B2D0 -> 0x32B458
...
// Range: 0x32B470 -> 0x32B530
void initAttack00(class clsCharaTails * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32B470 -> 0x32B530
        class clsModelType_OB_TX_MO_MA * pcModel; // r2
...
// Range: 0x32B530 -> 0x32B7E0
void behavior(class clsCharaTails * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32B530 -> 0x32B7E0
