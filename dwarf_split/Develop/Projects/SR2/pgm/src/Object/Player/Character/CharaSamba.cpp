/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\CharaSamba.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32CollisionRadius; // size: 0x4, address: 0x688438
...
// Range: 0x463B20 -> 0x463B70
void actionAttack01(class clsCharaSamba * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x463B20 -> 0x463B70
    }
...
// Range: 0x463B70 -> 0x463DDC
void actionAttack00(class clsCharaSamba * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x463B70 -> 0x463DDC
...
// Range: 0x463DF0 -> 0x463E7C
void initAttack00(class clsCharaSamba * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x463DF0 -> 0x463E7C
    }
...
// Range: 0x463E80 -> 0x464048
void behavior(class clsCharaSamba * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x463E80 -> 0x464048
