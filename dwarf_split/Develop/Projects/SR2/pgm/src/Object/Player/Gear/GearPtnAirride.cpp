/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Gear\GearPtnAirride.cpp
...
// Range: 0x31E3E0 -> 0x31E774
void controlMotionCurve00(class clsGearPtnAirride * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31E3E0 -> 0x31E774
        float f32Rate; // r1
...
// Range: 0x31E780 -> 0x31EF48
void Curve(class clsGearPtnAirride * this /* r17 */, float f32Ratio /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31E780 -> 0x31EF48
        ...
        float f32CurveMotRetAccele; // @ 0x00B0D8E0
    }
}


// Range: 0x31EF50 -> 0x31F148
void behavior(class clsGearPtnAirride * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31EF50 -> 0x31F148
        ...
        float f32TransX; // r29+0x70
        float f32SideMov; // @ 0x00B0D8D8
        float f32Mov; // @ 0x00B0D8D0
    }
}


// Range: 0x31F150 -> 0x31F158
void clearChangeActionParam(class clsGearPtnAirride * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31F150 -> 0x31F158
    }
