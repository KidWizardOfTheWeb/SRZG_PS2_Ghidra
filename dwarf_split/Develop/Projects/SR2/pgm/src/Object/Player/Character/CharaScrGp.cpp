/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\CharaScrGp.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class stcParam asScrGpLineParam[2]; // size: 0x80, address: 0x6374F0
...
struct /* @anon5 */ {
    // total size: 0x4C
} __vt__13clsCharaScrGp; // size: 0x4C, address: 0x6C8AD0
struct /* @anon1 */ {
    // total size: 0x4C
} __vt__16clsCharaRoboBase; // size: 0x4C, address: 0x6C8B20
struct /* @anon3 */ {
    // total size: 0x40
...
class clsCharaScrGp : public clsCharaRoboBase {
    // total size: 0x90
public:
    class clsBackLineEffectTask * m_apcLineTask[2]; // offset 0x80, size 0x8
};
...
class clsCharaRoboBase : public clsCharacter {
    // total size: 0x80
public:
    float m_f32LampFrame; // offset 0x60, size 0x4
    float m_f32LampSpeed; // offset 0x64, size 0x4
    unsigned int m_u32LampCntNum; // offset 0x68, size 0x4
    float m_f32RotateSpeed; // offset 0x6C, size 0x4
    float m_f32CurveRotate; // offset 0x70, size 0x4
    signed int m_s32KeyFlag; // offset 0x74, size 0x4
    float m_f32RotateZ; // offset 0x78, size 0x4
};
...
// Range: 0x4AAB10 -> 0x4AAD34
void draw(class clsCharaScrGp * this /* r21 */, unsigned int u32AddDrawFlagI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4AAB10 -> 0x4AAD34
        ...
        float sRHandMtx[4][4]; // r29+0xA0
        class NNS_MOTION * pcAttackStickMotion; // r2
        class NNS_MOTION * pcOnStickMotion; // r2
        class NNS_MOTION * pcRunStickMotion; // r2
        class NNS_MOTION * pcMotion; // r22
        float f32MotFrame; // r20
        signed int s32BornId; // r21
    }
}


// Range: 0x4AAD40 -> 0x4AAD48
void actionAttack01() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4AAD40 -> 0x4AAD48
...
// Range: 0x4AAD50 -> 0x4AAFC4
void actionAttack00(class clsCharaScrGp * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4AAD50 -> 0x4AAFC4
...
// Range: 0x4AAFE0 -> 0x4AB0C8
void initAttack00(class clsCharaScrGp * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4AAFE0 -> 0x4AB0C8
    }
...
// Range: 0x4AB0D0 -> 0x4AB14C
void reset(class clsCharaScrGp * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4AB0D0 -> 0x4AB14C
    }
...
// Range: 0x4AB150 -> 0x4AB260
void * __ct(class clsCharaScrGp * this /* r16 */, class clsPlayerTask * pcPlayer /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4AB150 -> 0x4AB260
    }
