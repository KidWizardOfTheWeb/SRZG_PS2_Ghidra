/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\CharaAmy.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32CollisionRadius; // size: 0x4, address: 0x6751A0
float tof32HairRange; // size: 0x4, address: 0x0
class stcParam sAmyLineParam; // size: 0x40, address: 0x625BC0
...
struct /* @anon1 */ {
    // total size: 0x40
} __vt__11clsCharaAmy; // size: 0x40, address: 0x6BCFB0
struct /* @anon3 */ {
    // total size: 0x40
...
// Range: 0x3262B0 -> 0x326588
void actionAttack00(class clsCharaAmy * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3262B0 -> 0x326588
...
// Range: 0x326590 -> 0x326780
void draw(class clsCharaAmy * this /* r19 */, unsigned int u32AddDrawFlagI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x326590 -> 0x326780
        ...
        class clsModelType_OB_TX_MO_MA * pcModel; // r2
        class clsModelType_OB_TX_MO_MA * pcModelEff; // r2
        float sMtx[4][4]; // r29+0xC0
        float sRHandMtx[4][4]; // r29+0x80
        signed int s32BornId; // r19
    }
}


// Range: 0x326780 -> 0x326788
void initAttack01() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x326780 -> 0x326788
...
// Range: 0x326790 -> 0x326824
void initAttack00(class clsCharaAmy * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x326790 -> 0x326824
    }
...
// Range: 0x326840 -> 0x32692C
void * __ct(class clsCharaAmy * this /* r17 */, class clsPlayerTask * pcPlayer /* r16 */, unsigned char u8ModelType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x326840 -> 0x32692C
