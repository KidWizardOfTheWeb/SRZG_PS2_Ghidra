/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\CharaCream.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32CollisionRadius; // size: 0x4, address: 0x6751A8
float tof32TailRange1; // size: 0x4, address: 0x0
float tof32HairRange1; // size: 0x4, address: 0x0
float tof32AliveFrame; // size: 0x4, address: 0x0
float tof32MaxScaleFrame; // size: 0x4, address: 0x0
float tof32MaxScale; // size: 0x4, address: 0x0
struct /* @anon1 */ {
    // total size: 0x30
} __vt__24clsCreamAttackEffectTask; // size: 0x30, address: 0x6BCFF0
...
class clsCreamAttackEffectTask : public clsTask {
    // total size: 0x70
public:
    unsigned int m_u32TgtViewNo; // offset 0x54, size 0x4
    unsigned int m_u32TgtPlayerNo; // offset 0x58, size 0x4
    float m_f32AliveFrame; // offset 0x5C, size 0x4
    float m_f32Scale; // offset 0x60, size 0x4
    float m_f32UpDownY; // offset 0x64, size 0x4
    float m_f32MotionFrame; // offset 0x68, size 0x4
    unsigned char m_bSePlayFlg; // offset 0x6C, size 0x1
};
class clsSingleton {
    // total size: 0x4
};
...
class clsCharaCream : public clsCharaNodeBase {
    // total size: 0x70
public:
    float m_f32behaviorTailCnt; // offset 0x60, size 0x4
};
...
// Range: 0x3269F0 -> 0x326BB0
void draw(class clsCreamAttackEffectTask * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3269F0 -> 0x326BB0
        ...
        class NNS_MOTION * psMotion; // r22
        float sMtx[4][4]; // r29+0xC0
        float sMirrorMtx[4][4]; // r29+0x80
    }
}


// Range: 0x326BB0 -> 0x326D20
void execute(class clsCreamAttackEffectTask * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x326BB0 -> 0x326D20
...
// Range: 0x326D20 -> 0x326D90
void * __dt(class clsCreamAttackEffectTask * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x326D20 -> 0x326D90
    }
...
// Range: 0x326D90 -> 0x326E14
void * __ct(class clsCreamAttackEffectTask * this /* r18 */, unsigned int u32TgtViewNo /* r17 */, unsigned int u32TgtPlayerNo /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x326D90 -> 0x326E14
    }
...
// Range: 0x326F70 -> 0x3272EC
void draw(class clsCharaCream * this /* r21 */, unsigned int u32AddDrawFlagI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x326F70 -> 0x3272EC
        float (* psMtxPal)[4][4]; // r20
        class clsModelType_OB_TX_MO_MA * pcModel; // r2
        class clsModelType_OB_TX_MO_MA * pcModel1; // r2
        class NNS_MOTION * psMotion; // r23
        float sMtx[4][4]; // r29+0x150
        float sMirrorMtx[4][4]; // r29+0x110
        unsigned int u32IsTrick; // r2
        unsigned int u32DrawStatus; // r18
        unsigned int * psNodeStat; // r20
        float (* psMtxPal)[4][4]; // r19
        class clsModelType_OB_TX_MO_MA * pcModel; // r18
        float sMtx[4][4]; // r29+0xD0
        float sMirrorMtx[4][4]; // r29+0x90
        unsigned int u32IsTrick; // r2
        unsigned int u32DrawStatus; // r16
    }
}


// Range: 0x3272F0 -> 0x3272F8
void actionAttack01() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3272F0 -> 0x3272F8
...
// Range: 0x327300 -> 0x3274E0
void actionAttack00(class clsCharaCream * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x327300 -> 0x3274E0
        class clsModelType_OB_TX_MO_MA * pcModel1; // r2
        class clsModelType_OB_TX_MO_MA * pcModel; // r2
        class clsPlayerTask * pcTargetPlayer; // r18
    }
}


// Range: 0x3274E0 -> 0x3274E8
void initAttack01() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3274E0 -> 0x3274E8
...
// Range: 0x3274F0 -> 0x32759C
void initAttack00(class clsCharaCream * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3274F0 -> 0x32759C
        class clsModelType_OB_TX_MO_MA * pcModel; // r2
...
// Range: 0x3275A0 -> 0x327814
void behavior(class clsCharaCream * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3275A0 -> 0x327814
        class NNS_QUATERNION sQ; // r29+0x60
        float f32Rad; // r21
        float f32SpeedRate; // r29+0x70
