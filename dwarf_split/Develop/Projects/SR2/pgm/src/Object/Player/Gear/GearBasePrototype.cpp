/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Gear\GearBasePrototype.cpp
...
struct /* @anon3 */ {
    // total size: 0x30
} __vt__22clsCurveAirEffect_Task; // size: 0x30, address: 0x6BCEC0
...
// Range: 0x42AA80 -> 0x42AAF4
unsigned char rebuildGearFlySe(class clsGearBasePrototype * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42AA80 -> 0x42AAF4
        signed int s32SeNo; // r2
    }
}


// Range: 0x42AB00 -> 0x42AB94
void rebuildGearRunSe(class clsGearBasePrototype * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42AB00 -> 0x42AB94
        signed int s32SeNo; // r2
...
// Range: 0x42ABA0 -> 0x42AE3C
void setCurveEffect(class clsGearBasePrototype * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42ABA0 -> 0x42AE3C
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        float f32LeverRate; // r20
    }
}


// Range: 0x42AE40 -> 0x42B5B0
void Curve(class clsGearBasePrototype * this /* r17 */, float f32Ratio /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42AE40 -> 0x42B5B0
        class stcData * psPrfm; // r2
        float f32FrameRate; // r4
        float f32LeverRate; // r3
        float f32CurveRad; // r21
        float f32CurveSpeedRate; // r20
        float f32MaxRotateRate; // r7
        float f32CurveRotateRate; // r2
        float f32CurveMotionRate; // r1
        float f32CurveFrame; // r1
        float f32GripRate; // r6
        float f32CurveRate; // r5
        signed int s32MotionNo; // r2
        float f32MotFrameRate; // r29+0x40
        float f32Accele; // r29+0x40
        float f32CurveMotRetAccele; // @ 0x00B171E0
    }
}


// Range: 0x42B5B0 -> 0x42B5F8
void Brake(class clsGearBasePrototype * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42B5B0 -> 0x42B5F8
    }
...
// Range: 0x42B600 -> 0x42B680
void Accele(class clsGearBasePrototype * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42B600 -> 0x42B680
        class stcData * psPrfm; // r2
...
// Range: 0x42B680 -> 0x42B828
float calcCurveRadResult(class clsGearBasePrototype * this /* r2 */, float f32Rate /* r24 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42B680 -> 0x42B828
        float f32Speed; // r23
        float f32CurveRotateRate; // r22
        float f32CurveRad; // r21
        unsigned char bIsGround; // r2
        float f32FrameRate; // r20
    }
}


// Range: 0x42B830 -> 0x42BC7C
void controlMotionFlyCurve(class clsGearBasePrototype * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42B830 -> 0x42BC7C
        enum enmMotion eMotionTable[2]; // r29+0x8
        float f32CurveMotionRate; // r5
        float f32FrameRate; // r29+0x10
        float f32LeverRate; // r29+0x10
        float f32Sign; // r1
        signed int s32MotionTableNo; // r2
        float f32CurveMotRetAccele; // @ 0x00B171D8
    }
}


// Range: 0x42BC80 -> 0x42BE88
void controlMotionCurve01(class clsGearBasePrototype * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42BC80 -> 0x42BE88
        float f32Rate; // r5
        float f32Sign; // r29+0x10
        float f32AbsMotionRate; // r2
        signed int s32MotionTableNo; // r2
        enum enmMotion eMotionTable[2][2]; // r29
    }
}


// Range: 0x42BE90 -> 0x42C224
void controlMotionCurve00(class clsGearBasePrototype * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42BE90 -> 0x42C224
        float f32Rate; // r1
        float f32Sign; // r21
        float f32AbsMotionRate; // r20
        signed int s32MotionTableNo; // r2
        enum enmMotion eMotionTable[2][2]; // r29+0x50
    }
}


// Range: 0x42C230 -> 0x42C2E4
void controlMotion(class clsGearBasePrototype * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42C230 -> 0x42C2E4
    }
...
// Range: 0x42C2F0 -> 0x42C594
enum enmChangeRes execGearChange(class clsGearBasePrototype * this /* r2 */, class clsGear * pcOldGear /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42C2F0 -> 0x42C594
    }
...
// Range: 0x42C5A0 -> 0x42C66C
enum enmChangeRes initGearChange(class clsGearBasePrototype * this /* r20 */, class clsGear * pcOldGear /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42C5A0 -> 0x42C66C
    }
...
// Range: 0x42C670 -> 0x42C6A8
enum enmChangeRes execWalkChangeAction(class clsGearBasePrototype * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42C670 -> 0x42C6A8
    }
...
// Range: 0x42C6B0 -> 0x42C6C0
enum enmChangeRes initWalkChangeAction(class clsGearBasePrototype * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42C6B0 -> 0x42C6C0
    }
...
// Range: 0x42C6C0 -> 0x42C6F8
enum enmChangeRes execRideChangeAction(class clsGearBasePrototype * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42C6C0 -> 0x42C6F8
    }
...
// Range: 0x42C700 -> 0x42C710
enum enmChangeRes initRideChangeAction(class clsGearBasePrototype * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42C700 -> 0x42C710
    }
...
// Range: 0x42C710 -> 0x42C738
enum enmChangeRes changeHideWalk(class clsGearBasePrototype * this /* r2 */, class clsGear * * apcEquipsGears /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42C710 -> 0x42C738
    }
...
// Range: 0x42C740 -> 0x42C804
enum enmChangeRes changeWalk(class clsGearBasePrototype * this /* r18 */, class clsGear * * apcEquipsGears /* r17 */, float f32LinkFrame /* r29+0x40 */, enum enmMotion eMotion /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42C740 -> 0x42C804
    }
...
// Range: 0x42C810 -> 0x42C950
enum enmChangeRes changeRide(class clsGearBasePrototype * this /* r20 */, class clsGear * * ppcPartsGears /* r19 */, class clsGear * pcBaseGear /* r18 */, float f32LinkFrame /* r20 */, enum enmMotion eMotion /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42C810 -> 0x42C950
    }
...
// Range: 0x42C950 -> 0x42C958
void clearChangeActionParam(class clsGearBasePrototype * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42C950 -> 0x42C958
    }
