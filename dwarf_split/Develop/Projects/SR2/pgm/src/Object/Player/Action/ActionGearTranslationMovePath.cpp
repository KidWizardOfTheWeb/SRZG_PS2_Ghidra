/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Action\ActionGearTranslationMovePath.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static unsigned int oau32ParticleNo[2]; // size: 0x8, address: 0x686860
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x686880
...
// Range: 0x41B7E0 -> 0x41C0B4
void actionGearTranslationMovePath(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41B7E0 -> 0x41C0B4
        class NNS_VECTORFAST sVecFast; // r29+0xB0
        class stcLine * opsLine; // r18
        class clsGearBasePrototype * pcGear; // r17
        float f32Rad; // r29+0xC0
        float f32RegulationVal; // r29+0xC0
        float f32Level; // r23
        float f32Val; // r22
        float f32Speed; // r1
        float f32SpeedSub; // r5
        float f32LimitRad; // r29+0xC0
        float f32ToCenterRad; // r21
        class NNS_QUATERNION sQuat; // r29+0xA0
        float sMtx[4][4]; // r29+0x60
        signed int s32PointNo; // r2
        signed int s32LastPointNo; // r2
        float f32OffsetRate; // r5
    }
}


// Range: 0x41C0C0 -> 0x41C4E8
void initGearTranslationMovePath(class clsPlayerTask * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41C0C0 -> 0x41C4E8
        class stcLine * opsLine; // r19
