/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Action\ActionAttackDamage.cpp
...
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x68C0E0
float t_of32DefaultMinSpeed; // size: 0x4, address: 0x664E18
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x68C0F0
...
struct /* @anon2 */ {
    // total size: 0x30
} __vt__28clsElectricDamageEffect_Task; // size: 0x30, address: 0x6C9620
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x68C0D0
struct /* @anon1 */ {
    // total size: 0x2C
...
class clsElectricDamageEffect_Task : public clsBaseEffect_Task {
    // total size: 0xF0
public:
    class NNS_VECTORFAST m_sPosVF; // offset 0xD0, size 0x10
    float m_f32AliveFrame; // offset 0xE0, size 0x4
    signed int m_s32SeID; // offset 0xE4, size 0x4
};
class clsOOStlAllocator {
    // total size: 0x4
public:
...
// Range: 0x4C5460 -> 0x4C6AA0
void actionAttackDamage(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C5460 -> 0x4C6AA0
        class clsGearBasePrototype * pcGear; // r20
        class stcData * psPrfm; // r2
        unsigned char u8AttackPlayerNo; // r2
        signed char s8ViewNo; // r18
        signed char s8ViewNo2; // r17
        class clsPlayerTask * pcAttackPlayer; // r17
        signed char s8ViewNo; // r21
        signed char s8ViewNo2; // r20
        class clsPlayerTask * pcAttackPlayer; // r21
        float f32Accele; // r2
        signed char s8ViewNo; // r18
        signed char s8ViewNo2; // r17
        signed int s32NextMode; // r20
    }
}


// Range: 0x4C6AA0 -> 0x4C6B54
void setCancelAttackDamage(class clsPlayerTask * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C6AA0 -> 0x4C6B54
    }
...
// Range: 0x4C6B60 -> 0x4C74C0
void initAttackDamage(class clsPlayerTask * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C6B60 -> 0x4C74C0
        class clsPlayerTask * pcAttackPlayer; // r20
    }
}
