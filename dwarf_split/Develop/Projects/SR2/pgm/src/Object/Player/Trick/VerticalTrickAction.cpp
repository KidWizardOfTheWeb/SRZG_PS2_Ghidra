/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Trick\VerticalTrickAction.cpp
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x696AC0
class clsPfSystem * m_tpcSingleton; // size: 0x4, address: 0x6E69B8
float of32Act3MotionLinkFrame; // size: 0x4, address: 0x685458
float oaf32MotionStepUpFrame[]; // size: 0x0, address: 0x685480
float of32LongMotionLinkFrame; // size: 0x4, address: 0x685450
class clsHavok * m_tpcSingleton; // size: 0x4, address: 0x707E60
class stcFlipKicker * opsKickerParam_FF[16]; // size: 0x40, address: 0x626F00
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x696AB0
class clsGameMgr * m_tpcSingleton; // size: 0x4, address: 0x6E6980
float of32RotateSlerpFrame; // size: 0x4, address: 0x685468
float of32VerticalTrickUpFrame; // size: 0x4, address: 0x679D48
class stcTrickMotionTable osTrickMotionTable; // size: 0x510, address: 0x685490
...
class stcTrickMotionDataDir {
    // total size: 0x18
public:
    class stcTrickMotionData asMotionData[3]; // offset 0x0, size 0x18
};
class hkStepInfo {
    // total size: 0x10
public:
...
class stcFlipKicker {
    // total size: 0x20
public:
    float f32UpSpeed; // offset 0x0, size 0x4
    float f32UpAccele; // offset 0x4, size 0x4
    float f32DownSpeed; // offset 0x8, size 0x4
    float f32DownAccele; // offset 0xC, size 0x4
    float f32VelocityY; // offset 0x10, size 0x4
    float f32UpGravityAccele; // offset 0x14, size 0x4
    float f32DownGravityAccele; // offset 0x18, size 0x4
    signed int s32Frame; // offset 0x1C, size 0x4
};
class clsLimitTime {
    // total size: 0x14
public:
...
class stcTrickMotionTable {
    // total size: 0x510
public:
    class stcTrickMotionRankTable asMotionRankTable[6]; // offset 0x0, size 0x510
};
class hkPadSpu {
    // total size: 0x4
public:
...
class stcTrickMotionRankTable {
    // total size: 0xD8
public:
    class stcTrickMotionDataDir asMotionDataDir[9]; // offset 0x0, size 0xD8
};
class hkArray {
    // total size: 0xC
public:
...
// Range: 0x5396B0 -> 0x539D3C
void execute(class clsVerticalTrickAction * this /* r19 */, class clsTrickParam & rcParam /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5396B0 -> 0x539D3C
        unsigned char u8ExParam; // r16
        unsigned char u8Rank; // r2
        class stcFlipKicker * psKickerParam; // r2
        float f32StepUpFrame; // r20
    }
}


// Range: 0x539D40 -> 0x53A04C
void init(class clsVerticalTrickAction * this /* r20 */, class clsTrickParam & rcParam /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x539D40 -> 0x53A04C
        signed int s32KeyDir; // r18
        float f32Rad; // r29+0x80
        unsigned char u8ExParam; // r5
        unsigned char u8Rank; // r2
        class stcFlipKicker * psKickerParam; // r2
    }
}
