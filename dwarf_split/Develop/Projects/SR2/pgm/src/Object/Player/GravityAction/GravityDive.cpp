/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\GravityAction\GravityDive.cpp
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x682800
float tof32_EffectFrame; // size: 0x4, address: 0x636408
float tof32BlackHoleDecele; // size: 0x4, address: 0x636420
float tof32BlackHoleAccele; // size: 0x4, address: 0x636418
float tof32BlackHoleSpeed; // size: 0x4, address: 0x636410
...
class clsGravityRing_Task * m_tpcSingleton; // size: 0x4, address: 0xB16470
...
class clsGravityRing_Object : public clsPhantomGimmickObject {
    // total size: 0x90
public:
    class clsGravityRingThroughCollision m_cThroughCollision; // offset 0x60, size 0xC
    class clsPlayerTask * m_pcPlayer; // offset 0x6C, size 0x4
    enum enmMode m_eMode; // offset 0x70, size 0x4
    float m_f32MatMotionFrame; // offset 0x74, size 0x4
    float m_f32MatMotionAcceleRate; // offset 0x78, size 0x4
    float m_f32Frame; // offset 0x7C, size 0x4
    float m_f32InvalidFrame; // offset 0x80, size 0x4
};
class clsFlag {
    // total size: 0x4
public:
...
class clsGravityRingThroughCollision : public clsBaseThroughCollision {
    // total size: 0xC
public:
    class clsGravityRing_Object * m_pcObject; // offset 0x8, size 0x4
};
enum enmType {
    TYPE_NULL = 0,
    TYPE_DIVE = 1,
...
class clsGravityRing_Task : public clsSingleModelGimmick_Task, public clsGimmickCommon {
    // total size: 0xB0
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsGravityRing_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x3DB790 -> 0x3DBAAC
void refrectionWall(class clsGravityDive * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DB790 -> 0x3DBAAC
    }
...
// Range: 0x3DBB00 -> 0x3DBB6C
float calcUsePoint(class clsGravityDive * this /* r16 */, float f32Point /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DBB00 -> 0x3DBB6C
    }
...
// Range: 0x3DBB70 -> 0x3DD8EC
void execute(class clsGravityDive * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DBB70 -> 0x3DD8EC
    }
...
// Range: 0x3DD940 -> 0x3DE4E8
void controlDirection(class clsGravityDive * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DD940 -> 0x3DE4E8
    }
...
// Range: 0x3DE510 -> 0x3DE590
void contorlRadian(float & rf32BaseRad /* r2 */, float & rf32InputRad /* r2 */, unsigned int u32ControlFlag /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DE510 -> 0x3DE590
    }
...
// Range: 0x3DE880 -> 0x3DE908
void updateSpeed(class clsGravityDive * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DE880 -> 0x3DE908
        float f32Speed; // r29
        float f32FrameRate; // r29
    }
}


// Range: 0x3DE910 -> 0x3DEA28
void requestEffectTaskDash(class clsGravityDive * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DE910 -> 0x3DEA28
    }
...
// Range: 0x3DEA50 -> 0x3DEC74
void controlAutoDirection(class clsGravityDive * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DEA50 -> 0x3DEC74
        float sTrsMtx[4][4]; // r29+0xB0
        float sInvMtx[4][4]; // r29+0x70
        class NNS_VECTORFAST sTargetVecFast; // r29+0x60
        class NNS_VECTORFAST sOffsetVecFast; // r29+0x50
...
// Range: 0x3DECA0 -> 0x3DEE40
void updatePathRange(class clsGravityDive * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DECA0 -> 0x3DEE40
    }
...
// Range: 0x3DEEA0 -> 0x3DEF24
void initCommon(class clsGravityDive * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DEEA0 -> 0x3DEF24
    }
...
// Range: 0x3DEF30 -> 0x3DEF80
void init(class clsGravityDive * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DEF30 -> 0x3DEF80
    }
...
// Range: 0x3DEF80 -> 0x3DEFC4
void reset(class clsGravityDive * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DEF80 -> 0x3DEFC4
    }
...
// Range: 0x3DEFD0 -> 0x3DF1C4
void cancel(class clsGravityDive * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DEFD0 -> 0x3DF1C4
    }
...
// Range: 0x3DF1D0 -> 0x3DF1E4
void setType(class clsGravityDive * this /* r2 */, enum enmType eType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DF1D0 -> 0x3DF1E4
    }
...
// Range: 0x3DF1F0 -> 0x3DF1FC
class clsGravityRing_Task * GS() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DF1F0 -> 0x3DF1FC
    }
