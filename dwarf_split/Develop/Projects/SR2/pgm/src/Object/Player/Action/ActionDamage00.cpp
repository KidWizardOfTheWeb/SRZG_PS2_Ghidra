/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Action\ActionDamage00.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class clsRing_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A8D8
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x681910
float t_of32DefaultMinSpeed; // size: 0x4, address: 0x664E18
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x681920
...
// Range: 0x3BDCC0 -> 0x3BDFBC
void actionDamage00(class clsPlayerTask * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BDCC0 -> 0x3BDFBC
        class clsGearBasePrototype * pcGear; // r19
        class stcData * psPrfm; // r2
    }
}


// Range: 0x3BDFC0 -> 0x3BE2AC
void initDamage00(class clsPlayerTask * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BDFC0 -> 0x3BE2AC
        class stcData * psPrfm; // r2
