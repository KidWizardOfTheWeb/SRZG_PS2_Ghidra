/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Trick\TrickManager.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class clsHavok * m_tpcSingleton; // size: 0x4, address: 0x707E60
class clsPfSystem * m_tpcSingleton; // size: 0x4, address: 0x6E69B8
float of32RotateResetFrame; // size: 0x4, address: 0x685470
...
class stcChaoMotion sChaoMotion; // size: 0x18, address: 0xB08F10
struct /* @anon0 */ {
    // total size: 0xC
} __vt__13clsTrickParam; // size: 0xC, address: 0x6CE630
struct /* @anon6 */ {
    // total size: 0x1C
} __vt__18clsBaseTrickAction; // size: 0x1C, address: 0x6CE5F0
struct /* @anon8 */ {
    // total size: 0x1C
} __vt__18clsFlipTrickAction; // size: 0x1C, address: 0x6CE610
struct /* @anon5 */ {
    // total size: 0x1C
} __vt__18clsSpinTrickAction; // size: 0x1C, address: 0x6CEA60
struct /* @anon2 */ {
    // total size: 0x1C
} __vt__18clsPipeTrickAction; // size: 0x1C, address: 0x6CEA80
struct /* @anon4 */ {
    // total size: 0x1C
} __vt__18clsFreeTrickAction; // size: 0x1C, address: 0x6CEAA0
struct /* @anon1 */ {
    // total size: 0x1C
} __vt__18clsWallTrickAction; // size: 0x1C, address: 0x6CEAC0
struct /* @anon7 */ {
    // total size: 0x1C
} __vt__22clsVerticalTrickAction; // size: 0x1C, address: 0x6CEAE0
struct /* @anon3 */ {
    // total size: 0x1C
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x696150
...
class stcChaoMotion {
    // total size: 0x18
public:
    class NNS_MOTION * psMotion[6]; // offset 0x0, size 0x18
};
...
// Range: 0x52E790 -> 0x52E7C8
enum enmKickerRankZone checkTrickRankZone(class clsTrickManager * this /* r4 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52E790 -> 0x52E7C8
    }
...
// Range: 0x52E7D0 -> 0x52E7D8
void cancel(class clsTrickManager * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52E7D0 -> 0x52E7D8
    }
...
// Range: 0x52E7E0 -> 0x52E924
void end(class clsTrickManager * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52E7E0 -> 0x52E924
        float of32Frame; // r2
...
// Range: 0x52E930 -> 0x52E9F4
void landing(class clsTrickManager * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52E930 -> 0x52E9F4
        float f32DashSpeed; // r20
        float f32Cosf; // r29+0x40
    }
}


// Range: 0x52EA00 -> 0x52EA94
unsigned char check(class clsTrickManager * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52EA00 -> 0x52EA94
    }
...
// Range: 0x52EAA0 -> 0x52EAA8
void reset(class clsTrickManager * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52EAA0 -> 0x52EAA8
    }
...
// Range: 0x52EAB0 -> 0x52EB70
void execute(class clsTrickManager * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52EAB0 -> 0x52EB70
...
// Range: 0x52EB70 -> 0x52EC80
void init(class clsTrickManager * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52EB70 -> 0x52EC80
        class clsBaseTrickAction * pcAction; // r17
        class clsModelType_OB_TX_MO_MA * pcModel; // r2
    }
}


// Range: 0x52EC80 -> 0x52EE2C
void * __dt(class clsTrickManager * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52EC80 -> 0x52EE2C
    }
...
// Range: 0x52EE30 -> 0x52F038
void * __ct(class clsTrickManager * this /* r17 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52EE30 -> 0x52F038
    }
