/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Action\ActionGearPath.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class clsCollisionManager * m_tpcSingleton; // size: 0x4, address: 0x703C18
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x66BE30
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x66BE40
...
// Range: 0x314BE0 -> 0x315030
void actionGearPath(class clsPlayerTask * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x314BE0 -> 0x315030
        class NNS_VECTORFAST sVecFast; // r29+0xC0
        class stcLine * opsLine; // r2
        float f32Rad; // r29+0xD0
        float f32Distance; // r20
        class NNS_VECTORFAST sStartVecFast; // r29+0xB0
        class NNS_VECTORFAST sEndVecFast; // r29+0xA0
        class NNS_VECTORFAST sNowPosVecFast; // r29+0x90
        class stcRetRayCast sRetRayCast; // r29+0x60
    }
}


// Range: 0x315030 -> 0x3153F8
void initGearPath(class clsPlayerTask * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x315030 -> 0x3153F8
        class stcLine * opsLine; // r2
