/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\Character.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTORFAST m_toaFalseStartOffsetVec[19]; // size: 0x130, address: 0x0
static unsigned char chk__clsCharacter_m_toaFalseStartOffsetVec_SizeCheck_[1]; // size: 0x1, address: 0x0
float t_of32OffsetWalkHeight; // size: 0x4, address: 0x664D98
float t_of32OffsetGearHeight; // size: 0x4, address: 0x664DA0
float t_of32OffsetSkateHeight; // size: 0x4, address: 0x0
unsigned char m_oau8BoardNodeNo[]; // size: 0x0, address: 0x690400
...
class stcFColor asBoostColor[19][2]; // size: 0x260, address: 0x620F00
...
class clsModelType_OB_TX acChara[6][19]; // size: 0x390, address: 0xB08310
struct /* @anon0 */ {
    // total size: 0x40
...
// Range: 0x1E1ED0 -> 0x1E1FE4
void setShadowMatrix(class clsCharacter * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E1ED0 -> 0x1E1FE4
...
// Range: 0x1E1FF0 -> 0x1E208C
float checkPlayRangeAttackSe(class clsCharacter * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E1FF0 -> 0x1E208C
        class NNS_VECTORFAST * psPosVecFast; // r18
        unsigned int u32i; // r17
        float f32OldDist; // r20
        float f32Dist; // r29+0x60
    }
}


// Range: 0x1E2090 -> 0x1E20B8
float getSpeedRate(class clsCharacter * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E2090 -> 0x1E20B8
    }
...
// Range: 0x1E20C0 -> 0x1E2118
unsigned char isBehaviorMotion(class clsCharacter * this /* r2 */, class stcMotionFlgs * oapsMotionFlg /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E20C0 -> 0x1E2118
        unsigned int u32BaseMotion; // r2
        unsigned int u32MotionNo; // r2
    }
}


// Range: 0x1E2120 -> 0x1E226C
void draw(class clsCharacter * this /* r17 */, unsigned int u32AddDrawFlagI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E2120 -> 0x1E226C
    }
...
// Range: 0x1E2270 -> 0x1E2444
void drawAttackEffect(class clsCharacter * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E2270 -> 0x1E2444
        float (* psMtxPal)[4][4]; // r19
        class clsModelType_OB_TX_MO_MA * pcAtModel; // r2
        float sMtx[4][4]; // r29+0x70
    }
}


// Range: 0x1E2470 -> 0x1E24E0
...
// Range: 0x1E24E0 -> 0x1E2CDC
unsigned int holdAttackBase(class clsCharacter * this /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E24E0 -> 0x1E2CDC
        unsigned int u32RtnValue; // r21
        class clsPlayerTask * pcDmgPlayer; // r2
        class NNS_VECTORFAST sDirVF; // r29+0xE0
        float sInvMtx[4][4]; // r29+0xA0
        class NNS_VECTORFAST sPosVF; // r29+0x90
        signed char s8View1; // r20
        signed char s8View2; // r19
...
// Range: 0x1E2CE0 -> 0x1E2D88
void * __ct(class clsCharacter * this /* r2 */, class clsPlayerTask * pcPlayer /* r2 */, unsigned char u8Type /* r2 */, unsigned char u8ModelType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E2CE0 -> 0x1E2D88
    }
