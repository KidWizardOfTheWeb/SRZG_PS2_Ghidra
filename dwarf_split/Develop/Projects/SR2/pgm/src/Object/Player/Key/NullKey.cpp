/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Key\NullKey.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon1 */ {
    // total size: 0x28
} __vt__10clsNullKey; // size: 0x28, address: 0x6D09A0
struct /* @anon0 */ {
    // total size: 0x28
...
// Range: 0x561A90 -> 0x561AD8
void reset(class clsNullKey * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x561A90 -> 0x561AD8
    }
