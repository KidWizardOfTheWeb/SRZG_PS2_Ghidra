/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Surface.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x664D30
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x664D40
...
// Range: 0x1E0E60 -> 0x1E105C
void convertQuatToSurface(class clsSurface * this /* r19 */, class NNS_VECTORFAST & rsUpVecFast /* r18 */, float & rf32Rad /* r16 */, class NNS_QUATERNION & rsQuat /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E0E60 -> 0x1E105C
        class NNS_VECTORFAST sCalVecFast; // r29+0x100
        class NNS_QUATERNION sInvQuat; // r29+0xF0
        class NNS_QUATERNION sCalQuat; // r29+0xE0
    }
}


// Range: 0x1E1060 -> 0x1E10D0
void updateDirection(class clsSurface * this /* r17 */, class NNS_VECTORFAST & rsUpVecFast /* r16 */, class NNS_VECTORFAST * opsBaseDirVecFast /* r2 */, class NNS_VECTORFAST * opsDirVecFast /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E1060 -> 0x1E10D0
...
// Range: 0x1E10D0 -> 0x1E110C
void update(class clsSurface * this /* r17 */, class NNS_VECTORFAST & rsUpVecFast /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E10D0 -> 0x1E110C
    }
...
// Range: 0x1E1110 -> 0x1E1210
void change(class NNS_QUATERNION & rsBaseQuat /* r17 */, class NNS_VECTORFAST & rsUpVecFast /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E1110 -> 0x1E1210
        class NNS_QUATERNION sInvQuat; // r29+0x90
        class NNS_QUATERNION sLocalPosturalQuat; // r29+0x80
        class NNS_VECTORFAST sLocalUpVecFast; // r29+0x70
    }
}


// Range: 0x1E1210 -> 0x1E124C
void reset(class clsSurface * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E1210 -> 0x1E124C
    }
...
// Range: 0x1E1250 -> 0x1E140C
float getRotateRadToDirNrmVecFast(class NNS_VECTORFAST * posDirVecFast /* r16 */, class NNS_QUATERNION * posSurfaceQuat /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E1250 -> 0x1E140C
        class NNS_QUATERNION sNormQuat; // r29+0x90
        class NNS_QUATERNION sInvQuat; // r29+0x80
        class NNS_VECTORFAST sDirVecFast; // r29+0x70
        float f32Rad; // r29+0xA0
    }
}
