/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Performance.cpp
...
float t_of32InfiniGpLimitFrame; // size: 0x4, address: 0x0
float t_of32InfiniGpCheckUsed; // size: 0x4, address: 0x0
float t_of32InfiniGpCheckNotUse; // size: 0x4, address: 0x664D78
...
float toaf32GpUsedRate[5]; // size: 0x14, address: 0x664D80
...
// Range: 0x1E1410 -> 0x1E141C
void setMaxAgp(class clsPrfm * this /* r2 */, float f32MaxAGP /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E1410 -> 0x1E141C
    }
...
// Range: 0x1E1420 -> 0x1E142C
void setRingCapacity(class clsPrfm * this /* r2 */, signed short s16Ring /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E1420 -> 0x1E142C
    }
...
// Range: 0x1E1430 -> 0x1E173C
void setup(class clsPrfm * this /* r19 */, class clsCharacter * pcChara /* r2 */, class clsGearCtrl * pcGearCtrl /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E1430 -> 0x1E173C
        class stcBasePrfm & rcWalk; // r2
        class stcBasePrfm & rcBase; // r2
        float f32AdjustSpeedRate; // r29+0x50
        float f32AdjustCurveRate; // r29+0x50
        signed char s8Agp; // r2
    }
}


// Range: 0x1E1740 -> 0x1E175C
class stcData * getDataPtr(class clsPrfm * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E1740 -> 0x1E175C
    }
...
// Range: 0x1E1760 -> 0x1E17EC
void updateFrame(class clsPrfm * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E1760 -> 0x1E17EC
        class clsGearCtrl & rcGearCtrl; // r2
    }
}


// Range: 0x1E17F0 -> 0x1E1C0C
void updateData(class clsPrfm * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E17F0 -> 0x1E1C0C
        float f32GpUsedRate; // r29+0x50
        class clsGearCtrl & rcGearCtrl; // r2
    }
}


// Range: 0x1E1C20 -> 0x1E1EB8
void Limit(class stcData & rsData /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E1C20 -> 0x1E1EB8
    }
...
// Range: 0x1E1EC0 -> 0x1E1ECC
void reset(class clsPrfm * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1E1EC0 -> 0x1E1ECC
    }
