/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\CharaEggman.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32CollisionRadius; // size: 0x4, address: 0x6751B0
float tof32MufflerOffset; // size: 0x4, address: 0x0
float tof32MufflerRange1; // size: 0x4, address: 0x0
float tof32MufflerRange2; // size: 0x4, address: 0x0
float tof32MufflerRange3; // size: 0x4, address: 0x0
...
struct /* @anon0 */ {
    // total size: 0x40
} __vt__14clsCharaEggman; // size: 0x40, address: 0x6BD020
struct /* @anon3 */ {
    // total size: 0x40
...
class clsCharaEggman : public clsCharacter {
    // total size: 0xD0
public:
    float m_sMtx[4][4]; // offset 0x60, size 0x40
    class NNS_VECTORFAST m_asParticlePos[2]; // offset 0xA0, size 0x20
    signed int m_a32BaseRot; // offset 0xC0, size 0x4
};
class hkPadSpu {
    // total size: 0x4
public:
...
// Range: 0x327900 -> 0x327A70
void draw(class clsCharaEggman * this /* r21 */, unsigned int u32AddDrawFlagI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x327900 -> 0x327A70
        ...
        float sRHandMtx[4][4]; // r29+0x70
        signed int s32BornId; // r2
    }
}


// Range: 0x327A70 -> 0x327A7C
signed char getNodeIndex(enum enmCharaBornNo eIndex /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x327A70 -> 0x327A7C
    }
...
// Range: 0x327A90 -> 0x327C50
void actionAttack00(class clsCharaEggman * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x327A90 -> 0x327C50
...
// Range: 0x327C60 -> 0x327CEC
void initAttack00(class clsCharaEggman * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x327C60 -> 0x327CEC
    }
...
// Range: 0x327CF0 -> 0x327FCC
void behavior(class clsCharaEggman * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x327CF0 -> 0x327FCC
        class NNS_QUATERNION sQ; // r29+0x60
        float f32SpeedRate; // r20
        signed int & rA32BaseRot; // r2
        signed int s32NodeId; // r2
    }
}


// Range: 0x327FD0 -> 0x3280AC
void * __ct(class clsCharaEggman * this /* r16 */, class clsPlayerTask * pcPlayer /* r2 */, unsigned char u8ModelType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x327FD0 -> 0x3280AC
    }
