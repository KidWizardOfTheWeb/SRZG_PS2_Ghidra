/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Action\ActionBoost.cpp
...
// Range: 0x5564C0 -> 0x5567A4
void actionBoost(class clsPlayerTask * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5564C0 -> 0x5567A4
...
// Range: 0x5567B0 -> 0x5567EC
void initBoost(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5567B0 -> 0x5567EC
    }
