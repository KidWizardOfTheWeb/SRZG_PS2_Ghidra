/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\CharaRouge.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32CollisionRadius; // size: 0x4, address: 0x6751C8
...
// Range: 0x329650 -> 0x329874
void draw(class clsCharaRouge * this /* r21 */, unsigned int u32AddDrawFlagI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x329650 -> 0x329874
...
// Range: 0x329890 -> 0x32999C
void actionAttack00(class clsCharaRouge * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x329890 -> 0x32999C
        class clsModelType_OB_TX_MO_MA * pcModel; // r2
...
// Range: 0x3299B0 -> 0x329A4C
void initAttack00(class clsCharaRouge * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3299B0 -> 0x329A4C
    }
...
// Range: 0x329A50 -> 0x329B88
void behavior(class clsCharaRouge * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x329A50 -> 0x329B88
        class NNS_QUATERNION sQ; // r29+0x50
        float f32Rad; // r29+0x60
        float f32SpeedRate; // r29+0x60
