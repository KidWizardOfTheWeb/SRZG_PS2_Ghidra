/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\CharaSuperSonic.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32CollisionRadius; // size: 0x4, address: 0x697BD8
float tof32HairRange1; // size: 0x4, address: 0x0
float SUPER_SONIC_RATE_RING; // size: 0x4, address: 0x0
float SUPER_SONIC_RATE_RING_BOOST; // size: 0x4, address: 0x0
float SUPER_SONIC_RATE_RING_GRAVITY; // size: 0x4, address: 0x0
signed int SUPER_SONIC_RATE_USE_RING; // size: 0x4, address: 0x0
signed int SUPER_SONIC_RATE_BOOST_CHANGE; // size: 0x4, address: 0x0
signed int SUPER_SONIC_RATE_START_BONUS; // size: 0x4, address: 0x697BE0
float SUPER_SONIC_RATE_SPEED; // size: 0x4, address: 0x697BE8
float SUPER_SONIC_RATE_ACCELE; // size: 0x4, address: 0x0
...
struct /* @anon0 */ {
    // total size: 0x30
} __vt__24clsDrawAttackEffect_Task; // size: 0x30, address: 0x6B5AE0
struct /* @anon1 */ {
    // total size: 0x30
} __vt__7clsTask; // size: 0x30, address: 0x6B59F0
class stcTask sTask; // size: 0x30, address: 0xB0A900
class clsModelType_OB_TX cSuperSonicModel; // size: 0x8, address: 0xB086B0
struct /* @anon5 */ {
    // total size: 0x40
} __vt__18clsCharaSuperSonic; // size: 0x40, address: 0x6D02E0
struct /* @anon2 */ {
    // total size: 0x40
...
class clsCharaSuperSonic : public clsCharaNodeBase {
    // total size: 0xB0
public:
    enum enmSChara m_eSonicType; // offset 0x60, size 0x4
    enum enmSAction m_eSonicAction; // offset 0x64, size 0x4
    float m_f32MatCnt; // offset 0x68, size 0x4
    class stcRingRateTime m_sTimeNormal; // offset 0x6C, size 0x10
    class stcRingRateTime m_sTimeBoost; // offset 0x7C, size 0x10
    class stcRingRateTime m_sTimeGravity; // offset 0x8C, size 0x10
    float m_f32behaviorCnt; // offset 0x9C, size 0x4
    class clsDrawAttackEffect_Task * m_pcDrawEffTsk; // offset 0xA0, size 0x4
    unsigned int u32GsTexS; // offset 0xA4, size 0x4
    unsigned int u32GsTexD; // offset 0xA8, size 0x4
};
...
// Range: 0x555130 -> 0x555308
void loadAdditionalData(class stcBinInfo & rsBinInfo /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x555130 -> 0x555308
        unsigned char * pau8Bin[6]; // r29+0x20
    }
}


// Range: 0x555310 -> 0x555318
void actionAttack01() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x555310 -> 0x555318
...
// Range: 0x555320 -> 0x555460
void drawAttackEffect(class clsCharaSuperSonic * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x555320 -> 0x555460
        ...
        float sOffSetMtx[4][4]; // r29+0x60
    }
}


// Range: 0x555480 -> 0x5554D0
void actionAttack00(class clsCharaSuperSonic * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x555480 -> 0x5554D0
        class clsModelType_OB_TX_MO_MA * pcModel; // r2
...
// Range: 0x5554E0 -> 0x5555FC
void initAttack00(class clsCharaSuperSonic * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5554E0 -> 0x5555FC
    }
...
// Range: 0x555600 -> 0x5556E8
void updateGravity(class clsCharaSuperSonic * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x555600 -> 0x5556E8
        enum enmMotion eMotion; // r2
        signed int s32TimeFlag; // r2
    }
}


// Range: 0x5556F0 -> 0x555EB0
void updateAction(class clsCharaSuperSonic * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5556F0 -> 0x555EB0
        signed int s32TimeFlag; // r7
    }
}


// Range: 0x555EB0 -> 0x555F9C
signed int updateLimitTime(float f32LimitTime /* r29 */, class stcRingRateTime * psRateTime /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x555EB0 -> 0x555F9C
        signed int s32LimitFlag; // r2
        signed int s32NowSec; // r7
        float f32NowMSec; // r1
        float f32DelayMSec; // r29
    }
}


// Range: 0x555FA0 -> 0x556064
void draw(class clsCharaSuperSonic * this /* r17 */, unsigned int u32AddDrawFlagI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x555FA0 -> 0x556064
    }
...
// Range: 0x556070 -> 0x5562CC
void behavior(class clsCharaSuperSonic * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x556070 -> 0x5562CC
        class NNS_QUATERNION sQ; // r29+0x50
        float f32Speed; // r29+0x60
        float f32Rad; // r29+0x60
        signed int s32NodeId; // r2
    }
}


// Range: 0x5562D0 -> 0x55639C
void reset(class clsCharaSuperSonic * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5562D0 -> 0x55639C
    }
...
// Range: 0x5563A0 -> 0x556414
void * __ct(class clsCharaSuperSonic * this /* r16 */, class clsPlayerTask * pcPlayer /* r2 */, unsigned char u8ModelType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5563A0 -> 0x556414
    }
