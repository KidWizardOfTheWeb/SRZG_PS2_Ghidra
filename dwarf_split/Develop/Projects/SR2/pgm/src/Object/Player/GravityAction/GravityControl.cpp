/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\GravityAction\GravityControl.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class stcCommonSetting t_sCommonSetting; // size: 0x98, address: 0xB163D0
static class stcParam oasGCtrlLineParam; // size: 0x40, address: 0x682760
float DEFAULT_ACCELE; // size: 0x4, address: 0x669CB0
class clsPathData * m_tpcSingleton; // size: 0x4, address: 0x703C10
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x6827A0
...
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x6827B0
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x6827C0
...
// Range: 0x3D6D70 -> 0x3D6E64
void setKeyTable(class clsGravityControl * this /* r2 */, enum enmKeyTable eKeyTable /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D6D70 -> 0x3D6E64
    }
...
// Range: 0x3D6E70 -> 0x3D6EE8
void calcRotateQuaternion(class clsGravityControl * this /* r17 */, class NNS_QUATERNION * psDstQuat /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D6E70 -> 0x3D6EE8
...
// Range: 0x3D6EF0 -> 0x3D6F74
void calcRotateMatrix(class clsGravityControl * this /* r17 */, float (* psDstMtx)[4][4] /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D6EF0 -> 0x3D6F74
        float sRotMtx[4][4]; // r29+0x70
        float sBaseMtx[4][4]; // r29+0x30
    }
}


// Range: 0x3D6F80 -> 0x3D7070
void adjustVelocity(class clsGravityControl * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D6F80 -> 0x3D7070
...
// Range: 0x3D7070 -> 0x3D71EC
void checkChangeGravity(class clsGravityControl * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D7070 -> 0x3D71EC
...
// Range: 0x3D71F0 -> 0x3D733C
void setDashParam(class clsGravityControl * this /* r17 */, float f32BaseSpeed /* r23 */, float f32MaxSpeed /* r29+0x60 */, float f32DashFrame /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D71F0 -> 0x3D733C
        float f32DashSpeed; // r21
        float f32Rate; // r20
    }
}


// Range: 0x3D7340 -> 0x3D7530
void settingAngle(class clsGravityControl * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D7340 -> 0x3D7530
        float f32AdjustRate; // r20
        class NNS_QUATERNION sCalQuat; // r29+0x60
        float f32Rad; // r29+0x7C
    }
}


// Range: 0x3D7530 -> 0x3D7A7C
void selectAngle(class clsGravityControl * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D7530 -> 0x3D7A7C
        float f32RotateAcceleFrameX; // r8
        float f32RotateAcceleFrameY; // r7
        float f32RotateAcceleRadX; // r3
        float f32RotateAcceleRadY; // r2
        float f32RotateMaxRadX; // r1
        float f32RotateMaxRadY; // r29+0x190
        class NNS_QUATERNION sCalQuat; // r29+0x180
        float sCalMtx[4][4]; // r29+0x140
        class NNS_VECTORFAST sGCtrlDirVecFast; // r29+0x130
        class NNS_VECTORFAST sDrawDirVecFast; // r29+0x120
        float f32Rate; // r29+0x190
    }
}


// Range: 0x3D7A80 -> 0x3D7B10
void stopEffect(class clsGravityControl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D7A80 -> 0x3D7B10
    }
...
// Range: 0x3D7B10 -> 0x3D7C4C
void endCommon(class clsGravityControl * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D7B10 -> 0x3D7C4C
    }
...
// Range: 0x3D7C50 -> 0x3D7D4C
void initFallCommon(class clsGravityControl * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D7C50 -> 0x3D7D4C
    }
...
// Range: 0x3D7D50 -> 0x3D80E8
void initMoveCommon(class clsGravityControl * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D7D50 -> 0x3D80E8
...
// Range: 0x3D80F0 -> 0x3D84E8
void initCommon(class clsGravityControl * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D80F0 -> 0x3D84E8
    }
...
// Range: 0x3D84F0 -> 0x3D8664
void calcWeightParam(class clsGravityControl * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D84F0 -> 0x3D8664
    }
...
// Range: 0x3D8670 -> 0x3D86DC
float calcUsePoint(class clsGravityControl * this /* r16 */, float f32Point /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D8670 -> 0x3D86DC
    }
...
// Range: 0x3D86E0 -> 0x3DA918
void execute(class clsGravityControl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D86E0 -> 0x3DA918
    }
...
// Range: 0x3DA930 -> 0x3DA9A8
float getChargeRate(class clsGravityControl * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DA930 -> 0x3DA9A8
        float f32Rate; // r29
...
// Range: 0x3DAA70 -> 0x3DAC14
unsigned char initMove_SpecialAdjust(class clsGravityControl * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DAA70 -> 0x3DAC14
        class NNS_VECTORFAST sDirVecFast; // r29+0x30
...
// Range: 0x3DAC30 -> 0x3DAE7C
unsigned char selectAngle_SpecialAdjust(class clsGravityControl * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DAC30 -> 0x3DAE7C
        unsigned char bRet; // r17
        class clsPath cPath; // r29+0xB0
        float sTrsMtx[4][4]; // r29+0x70
        class NNS_VECTORFAST sAxisX; // r29+0x60
        class NNS_VECTORFAST sAxisZ; // r29+0x50
        class NNS_QUATERNION sRotQuat; // r29+0x40
    }
}


// Range: 0x3DAEB0 -> 0x3DAF00
void destroyEffectTaskLine(class clsGravityControl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DAEB0 -> 0x3DAF00
    }
...
// Range: 0x3DAF00 -> 0x3DAF3C
void destroyEffectTaskWrist(class clsGravityControl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DAF00 -> 0x3DAF3C
    }
...
// Range: 0x3DAF40 -> 0x3DAF80
void destroyEffectTaskCharge(class clsGravityControl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DAF40 -> 0x3DAF80
    }
...
// Range: 0x3DB040 -> 0x3DB258
unsigned char setupBaseQuat_SpecialAdjust(class clsGravityControl * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DB040 -> 0x3DB258
        unsigned char bRet; // r17
        class NNS_VECTORFAST sDirVecFast; // r29+0x70
        class NNS_QUATERNION sRotQuat; // r29+0x60
        class NNS_VECTORFAST sAxisX; // r29+0x50
    }
}


// Range: 0x3DB310 -> 0x3DB490
void init(class clsGravityControl * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DB310 -> 0x3DB490
    }
...
// Range: 0x3DB490 -> 0x3DB53C
void reset(class clsGravityControl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DB490 -> 0x3DB53C
    }
...
// Range: 0x3DB540 -> 0x3DB738
void cancel(class clsGravityControl * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DB540 -> 0x3DB738
    }
...
// Range: 0x3DB760 -> 0x3DB768
enum enmBonusFlag getParam(class clsFlag * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DB760 -> 0x3DB768
    }
...
// Range: 0x3DB770 -> 0x3DB78C
void setParam(class clsFlag * this /* r2 */, unsigned int tData /* r2 */, unsigned int tMask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3DB770 -> 0x3DB78C
    }
