/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\CharaBlaze.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32CollisionRadius; // size: 0x4, address: 0x686AB0
...
class clsCharaBlaze : public clsCharaNodeBase {
    // total size: 0x160
public:
    float m_sLMtx[4][4]; // offset 0x60, size 0x40
    float m_sRMtx[4][4]; // offset 0xA0, size 0x40
    float m_sTgtMtx[4][4]; // offset 0xE0, size 0x40
    class clsTask * m_apcParticleTask[2]; // offset 0x120, size 0x8
    class NNS_VECTORFAST m_asParticlePos[2]; // offset 0x130, size 0x20
    class clsPlaySe_2D * m_pcPlaySe2D; // offset 0x150, size 0x4
    float m_f32behaviorTailCnt; // offset 0x154, size 0x4
};
class hkPadSpu {
    // total size: 0x4
public:
...
// Range: 0x426460 -> 0x426790
void actionAttack00(class clsCharaBlaze * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x426460 -> 0x426790
        unsigned int u32Rtn; // r2
        float f32Dist; // r29+0x50
        class clsPlayerTask * pcDmgPlayer; // r16
        class clsPlayerTask * pcDmgPlayer; // r2
        signed int s32HeadId; // r2
    }
}


// Range: 0x426790 -> 0x426798
void initAttack01() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x426790 -> 0x426798
...
// Range: 0x4267A0 -> 0x426888
void initAttack00(class clsCharaBlaze * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4267A0 -> 0x426888
    }
...
// Range: 0x426890 -> 0x426B7C
void behavior(class clsCharaBlaze * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x426890 -> 0x426B7C
