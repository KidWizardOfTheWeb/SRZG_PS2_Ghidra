...
void draw(class clsGearSpGpInfinity * this /* r21 */, float (* psGearMtx)[4][4] /* r2 */, float f32Alpha /* r20 */, unsigned int u32AddDrawFlagI /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34F0D0 -> 0x34F364
...
void copy(class clsGearSpThrottle * this /* r2 */, class clsGearSpThrottle * pcGear /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34F370 -> 0x34F394
    }
...
float getDraw2DRate(class clsGearSpThrottle * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34F3A0 -> 0x34F3C8
    }
...
class stcAddPrfm & getPrfm(class clsGearSpThrottle * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34F3D0 -> 0x34F410
...
void eventGearChange(class clsGearSpThrottle * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34F410 -> 0x34F454
    }
...
void eventGearChange(class clsGearSpSpeedTrap * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34F460 -> 0x34F7C4
...
void eventGearChange(class clsGearSpCtrlTrap * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34F7D0 -> 0x34FB34
        class clsPlayerTask * * apcPlayer; // r18
...
void eventGearChange(class clsGearSpViewTrap * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34FB40 -> 0x34FEA4
        class clsPlayerTask * * apcPlayer; // r18
...
void eventGearChange(class clsGearSpMagBarrier * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34FEB0 -> 0x34FEC8
    }
...
void eventGearChange(class clsGearSpTank * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34FED0 -> 0x34FF30
    }
...
float getDraw2DRate(class clsGearAngelOrDevilChange * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34FF30 -> 0x34FF58
    }
...
void eventGearChange(class clsGearAngelOrDevilChange * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34FF60 -> 0x34FFEC
    }
...
void behavior(class clsGearAngelOrDevilChange * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34FFF0 -> 0x3500D4
    }
...
void behavior(class clsGearAngelOrDevil * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3500E0 -> 0x3501C8
...
void clearChangeActionParam(class clsGearAngelOrDevil * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3501D0 -> 0x350208
        class clsGearAngelOrDevilChange * pcGear; // r2
...
void setHideNodeStatus(class clsGearReserveTank * this /* r2 */, unsigned int * psNodeStat /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x350210 -> 0x35024C
    }
...
void clearChangeActionParam(class clsGearReserveTank * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x350250 -> 0x350288
...
void behavior(class clsGearThrottle * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x350290 -> 0x3503B4
...
void clearChangeActionParam(class clsGearThrottle * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3503C0 -> 0x350414
...
void draw(class clsGearMag * this /* r21 */, float (* psGearMtx)[4][4] /* r2 */, float f32Alpha /* r20 */, unsigned int u32AddDrawFlagI /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x350420 -> 0x350628
...
void behavior(class clsGearMag * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x350630 -> 0x3506D0
    }
...
void setHideNodeStatus(class clsGearMag * this /* r2 */, unsigned int * psNodeStat /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3506D0 -> 0x350708
    }
...
void clearChangeActionParam(class clsGearMag * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x350710 -> 0x350740
...
void drawNonAction(class clsInitialBoard * this /* r21 */, float (* psGearMtx)[4][4] /* r20 */, float f32Alpha /* r20 */, unsigned int u32AddDrawFlagI /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x350740 -> 0x35089C
