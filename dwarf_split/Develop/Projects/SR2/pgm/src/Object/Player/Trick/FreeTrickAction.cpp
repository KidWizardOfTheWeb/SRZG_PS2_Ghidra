/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Trick\FreeTrickAction.cpp
...
float oaf32MotionStepUpFrameFree[]; // size: 0x0, address: 0x6859A0
class clsHavok * m_tpcSingleton; // size: 0x4, address: 0x707E60
class stcTrickMotionTable2 osTrickMotionTableFree; // size: 0x360, address: 0x6859B0
class stcTrickMotionDataDir2 osTrickMotionFreeRankX; // size: 0x10, address: 0x685D10
...
// Range: 0x538B80 -> 0x538E98
void execute(class clsFreeTrickAction * this /* r19 */, class clsTrickParam & rcParam /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x538B80 -> 0x538E98
...
// Range: 0x538EA0 -> 0x539114
void init(class clsFreeTrickAction * this /* r19 */, class clsTrickParam & rcParam /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x538EA0 -> 0x539114
