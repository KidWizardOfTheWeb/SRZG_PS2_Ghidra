/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Gear\GearCtrl.cpp
...
struct /* @anon4 */ {
    // total size: 0xC
} __vt__11clsGearCtrl; // size: 0xC, address: 0x6BC070
class clsPfSystem * m_tpcSingleton; // size: 0x4, address: 0x6E69B8
struct /* @anon22 */ {
    // total size: 0x30
} __vt__24clsGearChengeEffect_Task; // size: 0x30, address: 0x6BCE90
class stcTask sTask; // size: 0x30, address: 0xB0A900
struct /* @anon9 */ {
    // total size: 0x30
} __vt__28clsGearTypeChengeEffect_Task; // size: 0x30, address: 0x6D1A00
...
struct /* @anon16 */ {
    // total size: 0x7C
} __vt__15clsInitialBoard; // size: 0x7C, address: 0x6BC080
struct /* @anon0 */ {
    // total size: 0x7C
} __vt__15clsGearPtnBoard; // size: 0x7C, address: 0x6BCB80
struct /* @anon39 */ {
    // total size: 0x7C
} __vt__20clsGearBasePrototype; // size: 0x7C, address: 0x6C3BA0
class stcAddPrfm oasAddPrfmData[]; // size: 0x0, address: 0x68D660
class stcGearData oasGearData[]; // size: 0x0, address: 0x68D4B0
struct /* @anon33 */ {
    // total size: 0x44
} __vt__7clsGear; // size: 0x44, address: 0x6BC6E0
struct /* @anon28 */ {
    // total size: 0x7C
} __vt__12clsGearBdDef; // size: 0x7C, address: 0x6BCA30
struct /* @anon38 */ {
    // total size: 0x7C
} __vt__12clsGearEmDef; // size: 0x7C, address: 0x6BC100
struct /* @anon2 */ {
    // total size: 0x7C
} __vt__12clsGearGdDef; // size: 0x7C, address: 0x6BC180
struct /* @anon23 */ {
    // total size: 0x7C
} __vt__12clsGearSkDef; // size: 0x7C, address: 0x6BC200
struct /* @anon34 */ {
    // total size: 0x4C
} __vt__13clsGearSpTank; // size: 0x4C, address: 0x6BDF50
struct /* @anon53 */ {
    // total size: 0x4C
} __vt__20clsGearPtnEffectPart; // size: 0x4C, address: 0x6C3820
struct /* @anon37 */ {
    // total size: 0x4C
} __vt__16clsGearBaseParts; // size: 0x4C, address: 0x6C3C20
struct /* @anon24 */ {
    // total size: 0x4C
} __vt__17clsGearSpThrottle; // size: 0x4C, address: 0x6BDDC0
struct /* @anon7 */ {
    // total size: 0x4C
} __vt__18clsGearSpGpGetRate; // size: 0x4C, address: 0x6BC280
struct /* @anon14 */ {
    // total size: 0x4C
} __vt__18clsGearSpSpeedTrap; // size: 0x4C, address: 0x6BDE10
struct /* @anon32 */ {
    // total size: 0x4C
} __vt__17clsGearSpCtrlTrap; // size: 0x4C, address: 0x6BDE60
struct /* @anon43 */ {
    // total size: 0x4C
} __vt__17clsGearSpViewTrap; // size: 0x4C, address: 0x6BDEB0
struct /* @anon55 */ {
    // total size: 0x4C
} __vt__20clsGearSpSoundChange; // size: 0x4C, address: 0x6BC2D0
struct /* @anon8 */ {
    // total size: 0x4C
} __vt__19clsGearSpItemRankUp; // size: 0x4C, address: 0x6BC320
struct /* @anon19 */ {
    // total size: 0x4C
} __vt__19clsGearSpMagBarrier; // size: 0x4C, address: 0x6BDF00
struct /* @anon49 */ {
    // total size: 0x4C
} __vt__21clsGearSpRingCapacity; // size: 0x4C, address: 0x6BC370
struct /* @anon1 */ {
    // total size: 0x4C
} __vt__17clsGearSpAutoWall; // size: 0x4C, address: 0x6BC3C0
struct /* @anon11 */ {
    // total size: 0x4C
} __vt__14clsGearSpGhost; // size: 0x4C, address: 0x6BC410
struct /* @anon30 */ {
    // total size: 0x4C
} __vt__17clsGearSpAddTrick; // size: 0x4C, address: 0x6BC460
struct /* @anon45 */ {
    // total size: 0x4C
} __vt__16clsGearSpGcSpeed; // size: 0x4C, address: 0x6BC4B0
struct /* @anon15 */ {
    // total size: 0x4C
} __vt__17clsGearSp1stSpeed; // size: 0x4C, address: 0x6BC500
struct /* @anon46 */ {
    // total size: 0x4C
} __vt__17clsGearSpMaxSpeed; // size: 0x4C, address: 0x6BC550
struct /* @anon13 */ {
    // total size: 0x4C
} __vt__12clsGearSpAgp; // size: 0x4C, address: 0x6BC5A0
struct /* @anon3 */ {
    // total size: 0x4C
} __vt__19clsGearSpGpInfinity; // size: 0x4C, address: 0x6BDD70
struct /* @anon48 */ {
    // total size: 0x4C
} __vt__19clsGearPtnModelPart; // size: 0x4C, address: 0x6C3870
struct /* @anon56 */ {
    // total size: 0x4C
} __vt__21clsGearSpAttackTimeUp; // size: 0x4C, address: 0x6BC5F0
struct /* @anon52 */ {
    // total size: 0x4C
} __vt__19clsGearSpAllParamUp; // size: 0x4C, address: 0x6BC640
struct /* @anon51 */ {
    // total size: 0x4C
} __vt__19clsGearSpDurability; // size: 0x4C, address: 0x6BC690
struct /* @anon6 */ {
    // total size: 0x80
} __vt__12clsGearWhDef; // size: 0x80, address: 0x6BC730
struct /* @anon27 */ {
    // total size: 0x7C
} __vt__12clsGearSfDef; // size: 0x7C, address: 0x6BC7B0
struct /* @anon17 */ {
    // total size: 0x7C
} __vt__25clsGearAngelOrDevilChange; // size: 0x7C, address: 0x6BDFA0
struct /* @anon40 */ {
    // total size: 0x7C
} __vt__12clsGearArDef; // size: 0x7C, address: 0x6BC830
struct /* @anon18 */ {
    // total size: 0x7C
} __vt__19clsGearAngelOrDevil; // size: 0x7C, address: 0x6BE020
struct /* @anon29 */ {
    // total size: 0x7C
} __vt__12clsGearBkDef; // size: 0x7C, address: 0x6BC930
struct /* @anon31 */ {
    // total size: 0x7C
} __vt__18clsGearReserveTank; // size: 0x7C, address: 0x6BE0A0
struct /* @anon10 */ {
    // total size: 0x7C
} __vt__18clsGearSuperHangOn; // size: 0x7C, address: 0x6BC8B0
struct /* @anon47 */ {
    // total size: 0x7C
} __vt__15clsGearThrottle; // size: 0x7C, address: 0x6BE120
struct /* @anon57 */ {
    // total size: 0x7C
} __vt__10clsGearMag; // size: 0x7C, address: 0x6BE1A0
struct /* @anon5 */ {
    // total size: 0x7C
} __vt__12clsGearSpDef; // size: 0x7C, address: 0x6BC9B0
struct /* @anon44 */ {
    // total size: 0x7C
} __vt__15clsGearPtnEmpty; // size: 0x7C, address: 0x6C54D0
struct /* @anon26 */ {
    // total size: 0x7C
} __vt__15clsGearPtnGrind; // size: 0x7C, address: 0x6C43D0
struct /* @anon20 */ {
    // total size: 0x7C
} __vt__15clsGearPtnSkate; // size: 0x7C, address: 0x6C4C70
struct /* @anon25 */ {
    // total size: 0x80
} __vt__15clsGearPtnWheel; // size: 0x80, address: 0x6C4480
struct /* @anon36 */ {
    // total size: 0x7C
} __vt__17clsGearPtnSurfing; // size: 0x7C, address: 0x6C2100
struct /* @anon54 */ {
    // total size: 0x7C
} __vt__17clsGearPtnAirride; // size: 0x7C, address: 0x6BCC00
struct /* @anon12 */ {
    // total size: 0x7C
} __vt__14clsGearPtnBike; // size: 0x7C, address: 0x6BCC80
struct /* @anon42 */ {
    // total size: 0x30
} __vt__21clsGearBurnLight_Task; // size: 0x30, address: 0x6C77B0
struct /* @anon35 */ {
    // total size: 0x30
} __vt__7clsTask; // size: 0x30, address: 0x6B59F0
struct /* @anon41 */ {
    // total size: 0x30
} __vt__22clsSkateBurnLight_Task; // size: 0x30, address: 0x6C7780
struct /* @anon21 */ {
    // total size: 0x30
} __vt__24clsGearPtnWheelDraw_Task; // size: 0x30, address: 0x6C4450
...
class clsGearSp1stSpeed : public clsGearPtnEffectPart {
    // total size: 0x60
public:
    unsigned char m_u8EffectType; // offset 0x50, size 0x1
    class clsTask * m_pcEffectTask; // offset 0x54, size 0x4
};
...
class clsGearPtnWheel : public clsGearBasePrototype {
    // total size: 0x70
public:
    class clsGearPtnWheelDraw_Task * m_pcDrawTask; // offset 0x60, size 0x4
};
class hkPadSpu {
    // total size: 0x4
public:
...
class clsGearPtnSkate : public clsGearBasePrototype {
    // total size: 0x70
public:
    class clsSkateBurnLight_Task * m_pcBurnLight_Task; // offset 0x60, size 0x4
};
...
class clsGearPtnGrind : public clsGearPtnBoard {
    // total size: 0x80
public:
    class clsGearBurnLight_Task * m_pcBurnLight_Task; // offset 0x70, size 0x4
};
class allocator {
    // total size: 0x1
};
...
class clsSkateBurnLight_Task : public clsTask {
    // total size: 0x5C
public:
    class clsGearCtrl & m_rcGearCtrl; // offset 0x54, size 0x4
    signed short m_s16DrawNum; // offset 0x58, size 0x2
    signed char m_s8DrawNodeNo; // offset 0x5A, size 0x1
};
...
class clsGearPtnWheelDraw_Task : public clsTask {
    // total size: 0xB0
public:
    class clsGearPtnWheel * m_pcGear; // offset 0x54, size 0x4
    float m_f32Alpha; // offset 0x58, size 0x4
    unsigned int m_u32AddDrawFlag; // offset 0x5C, size 0x4
    float m_sTrsMtx[4][4]; // offset 0x60, size 0x40
    unsigned char m_bIsDraw; // offset 0xA0, size 0x1
};
...
class clsGearBurnLight_Task : public clsTask {
    // total size: 0xB0
public:
    float m_sMtxWork[4][4]; // offset 0x60, size 0x40
    class clsModelType_OB_TX & m_rcModel; // offset 0xA0, size 0x4
    class clsGear * m_pcGear; // offset 0xA4, size 0x4
    signed short m_s16DrawNum; // offset 0xA8, size 0x2
    signed char m_s8DrawNodeNo; // offset 0xAA, size 0x1
};
struct /* @anon13 */ {
    // total size: 0x4C
};
...
class clsGearPtnSurfing : public clsGearBasePrototype {
    // total size: 0xA0
public:
    float m_sBordMtx[4][4]; // offset 0x60, size 0x40
};
struct /* @anon30 */ {
    // total size: 0x4C
};
...
enum enmMotion {
    ...
    WALK_GDIVE = 9,
    WALK_GCTRL = 10,
    WALK_ELECTRIC_SHOCK = 11,
    WALK_SPRING_JUMP = 12,
    WALK_ATTACK_RUN_A = 13,
    WALK_ATTACK_RUN_B = 14,
    WALK_ATTACK_L = 15,
    WALK_ATTACK_R = 16,
    WALK_DRIVE_TAXI = 17,
    WALK_HOLD_OBJ = 18,
    WALK_SLIDER_ON = 19,
    WALK_SLIDER_RUN = 20,
    WALK_DAMAGE_REVERBERATION = 21,
    WALK_ATTACK_BACK = 22,
    WALK_START_DEMO_ST1 = 23,
    GEAR_RUN_A = 0,
    GEAR_RUN_B = 1,
    GEAR_RUN_R = 2,
    GEAR_CURVE_R1 = 3,
...
void setUnuseGearLevel(class clsGearCtrl * this /* r18 */, enum enmLevel eLevel /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30A090 -> 0x30A1E0
    }
...
void changeInitGearModel(class clsGearCtrl * this /* r2 */, enum enmInitBoard eBoard /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30A1E0 -> 0x30A238
    }
...
unsigned char getEquipsGearFlags(class clsGearCtrl * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30A240 -> 0x30A2B8
...
enum enmMotionType getEquipsGearBaseMotionType(class clsGearCtrl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30A2C0 -> 0x30A360
...
enum enmGearType getEquipsGearType(class clsGearCtrl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30A360 -> 0x30A484
...
void behavior_NodeMtx(class clsGearCtrl * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30A490 -> 0x30A4E0
    }
...
void behavior(class clsGearCtrl * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30A4F0 -> 0x30A540
    }
...
void registGearRideEffect(class clsGearCtrl * this /* r17 */, unsigned char bIsRide /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30A550 -> 0x30A6F8
    }
...
void registGearChangeEffect(class clsGearCtrl * this /* r21 */, enum enmLevel eLevel /* r20 */, enum enmGearType eOldType /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30A700 -> 0x30AA5C
...
enum enmLevel searchGearFromGearParamType(class clsGearCtrl * this /* r20 */, enum enmComGearChangeType eType /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30AA60 -> 0x30ACEC
...
void stopMonumentFlySe(class clsGearCtrl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30AD00 -> 0x30AD3C
    }
...
void playMonumentFlySe(class clsGearCtrl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30AD40 -> 0x30AD78
    }
...
void controlMotion(class clsGearCtrl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30AD80 -> 0x30B56C
...
void draw(class clsGearCtrl * this /* r18 */, float (* psGearMtx)[4][4] /* r17 */, unsigned int u32AddDrawFlagI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30B570 -> 0x30BAF4
...
void updateAction(class clsGearCtrl * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30BB00 -> 0x30C0A4
...
void updateDraw2DData(class clsGearCtrl * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30C0B0 -> 0x30C1D0
...
void updateLockFlag(class clsGearCtrl * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30C1D0 -> 0x30C3B4
...
void cancelGDive(class clsGearCtrl * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30C3C0 -> 0x30C460
    }
...
unsigned char requestGearRide_HideActiveGear(class clsGearCtrl * this /* r18 */, unsigned char u8IsRide /* r17 */, float f32LinkFrame /* r20 */, signed int eSuccessActionType /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30C460 -> 0x30C5EC
...
unsigned char requestGearRide_AttackAction(class clsGearCtrl * this /* r2 */, unsigned char u8IsRide /* r2 */, float f32LinkFrame /* r29 */, signed int eSuccessActionType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30C5F0 -> 0x30C60C
...
unsigned char requestGearRide(class clsGearCtrl * this /* r18 */, unsigned char u8IsRide /* r17 */, float f32LinkFrame /* r20 */, signed int eSuccessActionType /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30C610 -> 0x30C6EC
    }
...
unsigned char rideGear(class clsGearCtrl * this /* r16 */, unsigned char u8IsRide /* r21 */, float f32LinkFrame /* r20 */, signed int eSuccessActionType /* r20 */, enum enmMotion eMotion /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30C6F0 -> 0x30C9F8
...
void requestGearChangeForGhost(class clsGearCtrl * this /* r2 */, unsigned char u8ChangeNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30CA00 -> 0x30CA50
    }
...
unsigned char requestGearChange(class clsGearCtrl * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30CA50 -> 0x30CB14
...
enum enmLevel calcChageGearLevel(class clsGearCtrl * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30CB20 -> 0x30CCC0
        signed int s32i; // r7
...
void equipsGear(class clsGearCtrl * this /* r21 */, unsigned char u8GearLevel /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30CCC0 -> 0x30D064
        class clsGear * pcGear; // r19
...
enum enmCtrlMode _equipsGear(class clsGearCtrl * this /* r17 */, unsigned char u8GearLevel /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30D080 -> 0x30D498
        signed int s32i; // r20
...
class clsGearBasePrototype * getEquipsPrototypeGear(class clsGearCtrl * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30D4A0 -> 0x30D4A8
    }
...
void updatePrfm(class clsGearCtrl * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30D4B0 -> 0x30D6E4
        signed int s32i; // r6
...
void copyGearLv(class clsGearCtrl * this /* r18 */, class clsGearCtrl * pcPlayerGearCtrl /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30D700 -> 0x30DA58
...
void init(class clsGearCtrl * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30DA60 -> 0x30DD60
        signed int s32MaxGear; // r2
...
void setGearModels(class clsGearCtrl * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30DD60 -> 0x30E29C
        unsigned int u32i; // r19
...
void createGear(class clsGearCtrl * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x30E2A0 -> 0x3108D8
        signed int s32i; // r21
...
void * __dt(class clsGearCtrl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3117C0 -> 0x311888
        signed int i; // r18
...
void * __ct(class clsGearCtrl * this /* r17 */, class clsPlayerTask * pcPlayer /* r2 */, enum enmGearCtrl eCtrlNo /* r16 */, unsigned int u32EquipsGears /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x311930 -> 0x311B3C
