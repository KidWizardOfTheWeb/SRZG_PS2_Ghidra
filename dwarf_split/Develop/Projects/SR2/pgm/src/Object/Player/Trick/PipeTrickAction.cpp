/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Trick\PipeTrickAction.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x1C
} __vt__18clsPipeTrickAction; // size: 0x1C, address: 0x6CEA80
...
float f32CompensationAnglePipe; // size: 0x4, address: 0x626E90
float oaf32DistanceTable_Pipe[7]; // size: 0x1C, address: 0x67B500
class stcKickerParam oasKickerParamTable[9][7]; // size: 0x2F4, address: 0x67B700
class stcKickerParam oasKickerParamTable_Ext[][7]; // size: 0x0, address: 0x67BA00
...
// Range: 0x538020 -> 0x5385AC
void execute(class clsPipeTrickAction * this /* r19 */, class clsTrickParam & rcParam /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x538020 -> 0x5385AC
        class NNS_VECTORFAST sMoveDirVecFast; // r29+0xA0
        float f32PostualRad; // r29+0xB0
        float f32StepUpFrame; // r20
        float f32Rad; // r29+0xB0
        class NNS_QUATERNION sRotQuat; // r29+0x90
        class NNS_QUATERNION sTrgQuat; // r29+0x80
...
// Range: 0x5385B0 -> 0x538B80
void init(class clsPipeTrickAction * this /* r20 */, class clsTrickParam & rcParam /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5385B0 -> 0x538B80
        class clsPath cTrickPath; // r29+0x110
        signed int s32KeyDir; // r2
        class stcKickerParam * opsParam; // r2
        class NNS_QUATERNION sSurfaceQuat; // r29+0x100
        class NNS_VECTORFAST sSurfaceUpVecFast; // r29+0xF0
        float f32Rad; // r29+0x170
        float sInvMtx[4][4]; // r29+0xB0
        class NNS_VECTORFAST sLocalVecFast; // r29+0xA0
        float f32AdjustRad; // r20
    }
}
