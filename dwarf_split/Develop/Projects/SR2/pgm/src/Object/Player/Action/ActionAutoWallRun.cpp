/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Action\ActionAutoWallRun.cpp
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x697D00
...
// Range: 0x55A900 -> 0x55AE94
void actionAutoWallRun(class clsPlayerTask * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55A900 -> 0x55AE94
        ...
        class NNS_QUATERNION sBaseQuat; // r29+0x60
        class NNS_VECTORFAST sDirVecFast; // r29+0x50
        float f32Rad; // r29+0x100
        unsigned char u8PathNo; // r29+0xFF
    }
}


// Range: 0x55AEA0 -> 0x55AF8C
void initAutoWallRun(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55AEA0 -> 0x55AF8C
    }
