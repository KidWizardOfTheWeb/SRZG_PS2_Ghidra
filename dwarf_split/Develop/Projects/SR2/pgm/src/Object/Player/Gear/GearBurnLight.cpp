/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Gear\GearBurnLight.cpp
...
// Range: 0x483680 -> 0x48380C
void draw(class clsSkateBurnLight_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x483680 -> 0x48380C
        float sMtx[4][4]; // r29+0x70
        unsigned int * psNodeStat; // r20
        class clsModelType_OB_TX * pcModel; // r19
        class NNS_OBJECT * psObject; // r18
        unsigned int u32DrawNodeNo; // r2
    }
}


// Range: 0x483810 -> 0x483818
void execute(class clsSkateBurnLight_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x483810 -> 0x483818
    }
...
// Range: 0x483820 -> 0x483978
void draw(class clsGearBurnLight_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x483820 -> 0x483978
        class NNS_OBJECT * psObject; // r18
        float (* psMtxWork)[4][4]; // r17
    }
}


// Range: 0x483980 -> 0x483988
void execute(class clsGearBurnLight_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x483980 -> 0x483988
    }
