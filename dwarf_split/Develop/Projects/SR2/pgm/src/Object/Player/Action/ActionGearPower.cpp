/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Action\ActionGearPower.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class clsPfSystem * m_tpcSingleton; // size: 0x4, address: 0x6E69B8
float toaf32BonusPower[6]; // size: 0x18, address: 0x66C320
...
// Range: 0x31C6E0 -> 0x31C780
void actionGearPower(class clsPlayerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31C6E0 -> 0x31C780
    }
...
// Range: 0x31C780 -> 0x31C9B8
void initGearPower(class clsPlayerTask * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x31C780 -> 0x31C9B8
        float f32BonusAgp; // r29+0x50
