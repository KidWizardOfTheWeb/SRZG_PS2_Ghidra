/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\PlayerMotion.cpp
...
// Range: 0x2AF640 -> 0x2AF6BC
void cancelStartDemoMotion(class clsPlayerMotion * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2AF640 -> 0x2AF6BC
    }
...
// Range: 0x2AF6C0 -> 0x2AF7A4
void setStartDemoMotion(class clsPlayerMotion * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2AF6C0 -> 0x2AF7A4
    }
...
// Range: 0x2AF7B0 -> 0x2AF83C
void registEnd(class clsPlayerMotion * this /* r2 */, enum enmPriority eRegistPri /* r2 */, enum enmPriority ePlayPri /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2AF7B0 -> 0x2AF83C
    }
...
// Range: 0x2AF840 -> 0x2AF88C
void registTable(class clsPlayerMotion * this /* r2 */, signed char s8MotionType /* r2 */, signed char s8MotionNo /* r2 */, float f32StartFrame /* r29 */, float f32LinkFrame /* r29 */, enum enmStatus eStatus /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2AF840 -> 0x2AF88C
        class stcPlayTable & rcRegTable; // r2
    }
}


// Range: 0x2AF890 -> 0x2AF970
void updatePlayData(class clsPlayerMotion * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2AF890 -> 0x2AF970
        class stcPlayTable & rcTable; // r2
    }
}


// Range: 0x2AF970 -> 0x2AFA84
void startPlayData(class clsPlayerMotion * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2AF970 -> 0x2AFA84
    }
...
// Range: 0x2AFA90 -> 0x2AFB60
void init(class clsPlayerMotion * this /* r17 */, signed char s8CharaType /* r2 */, signed char s8ModelType /* r19 */, signed char s8MotionType /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2AFA90 -> 0x2AFB60
    }
