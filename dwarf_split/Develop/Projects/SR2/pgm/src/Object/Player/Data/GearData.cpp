/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Data\GearData.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32OneRingAddSpeed; // size: 0x4, address: 0x665890
char * oasMotionGearNameCode2[8]; // size: 0x20, address: 0x620D40
static unsigned char chk__oasMotionGearNameCode2_SizeCheck_[1]; // size: 0x1, address: 0x0
...
// Range: 0x1F00D0 -> 0x1F0300
enum enmDraw2DType getGearDraw2DType(enum enmGear eGear /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1F00D0 -> 0x1F0300
        char __FUNCTION__[18]; // @ 0x00665900
    }
}


// Range: 0x1F0300 -> 0x1F049C
unsigned short getGearCtrlNoForModel(unsigned short u16GearCtrlNo /* r18 */, unsigned char u8CharaNo /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1F0300 -> 0x1F049C
        char __FUNCTION__[22]; // @ 0x006658E0
    }
}


// Range: 0x1F04A0 -> 0x1F0648
char * getGearCtrlBinName(unsigned short u16GearCtrlNo /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1F04A0 -> 0x1F0648
        char ac8ViewName[4]; // r29+0x2C
        char tac8Name[64]; // @ 0x00707E80
    }
}
