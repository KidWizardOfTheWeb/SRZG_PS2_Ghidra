/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\CharaRoboBase.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32CollisionRadius; // size: 0x4, address: 0x690230
signed char m_tas8ConvertTable[52]; // size: 0x34, address: 0x690240
...
// Range: 0x4CFF10 -> 0x4D000C
void behavior(class clsCharaRoboBase * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4CFF10 -> 0x4D000C
    }
...
// Range: 0x4D0010 -> 0x4D0314
void updateRoboRotate(class clsCharaRoboBase * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D0010 -> 0x4D0314
        float f32RoboSpeed; // r29
    }
}


// Range: 0x4D0320 -> 0x4D04FC
void updateLampFrame(class clsCharaRoboBase * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D0320 -> 0x4D04FC
        enum enmMotion eMotion; // r2
        class NNS_MATERIAL_SINGLE * psMaterialL; // r2
        class NNS_MATERIAL_SINGLE * psMaterialR; // r2
    }
}


// Range: 0x4D0500 -> 0x4D0710
void updateRoboCurve(class clsCharaRoboBase * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D0500 -> 0x4D0710
        float f32LeverRate; // r29
        float f32RoboCurve; // r2
    }
}


// Range: 0x4D0710 -> 0x4D0718
void reset() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D0710 -> 0x4D0718
