/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Reaction.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
void t_oafReactionTable[21][3]; // size: 0x0, address: 0x686280
unsigned int otau32Se_Trees[2]; // size: 0x8, address: 0x686578
float DEFAULT_ACCELE; // size: 0x4, address: 0x669CB0
class stcTask sTask; // size: 0x30, address: 0xB0A900
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x6865C0
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x6865D0
...
// Range: 0x417130 -> 0x417328
void actionCommonWallHitFloor(class clsReaction * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x417130 -> 0x417328
        class NNS_VECTORFAST sDirVecFast; // r29+0x80
        class NNS_VECTORFAST sPathLineVecFast; // r29+0x70
        class NNS_VECTORFAST sCrossLineVecFast; // r29+0x60
        class clsPathPoint * pcPath; // r16
        float f32ReflectionRad; // r20
    }
}


// Range: 0x417330 -> 0x417AEC
void actionCommonWallHitSide(class clsReaction * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x417330 -> 0x417AEC
        float sInvMtx[4][4]; // r29+0x80
        class NNS_VECTORFAST sLocalWallVecFast; // r29+0x70
        class NNS_VECTORFAST sInertiaVecFast; // r29+0x60
        float f32ReflectionRad; // r21
        float f32Rad; // r20
        float f32AddRad; // r29+0xC0
        float f32ReflectRate; // r3
    }
}


// Range: 0x417AF0 -> 0x417C34
void actionWallHitFlight(class clsReaction * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x417AF0 -> 0x417C34
        float f32Dot; // r20
...
// Range: 0x417C40 -> 0x417DB4
void actionWallHitGround(class clsReaction * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x417C40 -> 0x417DB4
        float f32Dot; // r20
...
// Range: 0x417DC0 -> 0x417EC4
void actionWallHitWheelDrift(class clsReaction * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x417DC0 -> 0x417EC4
...
// Range: 0x417ED0 -> 0x4181B4
void actionWallHitGravityControl(class clsReaction * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x417ED0 -> 0x4181B4
        float sInvMtx[4][4]; // r29+0x80
        class NNS_VECTORFAST sNrmVecFast; // r29+0x70
        float f32ReflectionRad; // r3
        class NNS_VECTORFAST sVelocityVecFast; // r29+0x60
    }
}


// Range: 0x4181C0 -> 0x4182A0
void actionWallHitGravityDiveAuto(class clsReaction * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4181C0 -> 0x4182A0
    }
...
// Range: 0x4182A0 -> 0x418644
void actionWallHitGravityDive(class clsReaction * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4182A0 -> 0x418644
        class clsGravityDive * pcDive; // r17
    }
}


// Range: 0x418650 -> 0x41878C
void initSe(class clsReaction * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x418650 -> 0x41878C
    }
...
// Range: 0x418790 -> 0x419254
void requestGroundEffect(class clsReaction * this /* r16 */, class stcInfo * opcColInfo /* r18 */, enum enmColEfefctType eType /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x418790 -> 0x419254
        unsigned char u8Param; // r18
        unsigned char u8TexNo; // r17
        float f32Speed; // r20
        unsigned int u32DirtParticle; // r2
    }
}


// Range: 0x419260 -> 0x419424
void updateGround(class clsReaction * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x419260 -> 0x419424
    }
...
// Range: 0x419430 -> 0x4197B0
void updateWall(class clsReaction * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x419430 -> 0x4197B0
        unsigned char bClear; // r19
        signed int i; // r18
        class clsRigidBody * pcRigidBody; // r2
        class stcInfo * psColInfo; // r29+0x6C
    }
}
