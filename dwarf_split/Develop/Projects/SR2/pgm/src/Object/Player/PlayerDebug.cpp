/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\PlayerDebug.cpp
...
class __wrap_iterator {
    // total size: 0x4
public:
    class _DebugDrawSphere * * it_; // offset 0x0, size 0x4
};
...
// Range: 0x2F3470 -> 0x2F3C6C
void draw(class clsPlayerDebug * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F3470 -> 0x2F3C6C
        class __wrap_iterator it'361; // r2
        enum enmFlag eFlag; // r2
        signed int s32ViewNo; // r17
        unsigned short u16StartPointNo; // r2
        unsigned short u16EndPointNo; // r2
        class __wrap_iterator it; // r29+0xEC
        class vector & rvecDrawSphere; // r2
        unsigned int u32i; // r18
        signed char * ops8KeyDir; // r2
        char * toapc8KeyType[5]; // @ 0x00624940
    }
}


// Range: 0x2F3CA0 -> 0x2F3EF4
void update(class clsPlayerDebug * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F3CA0 -> 0x2F3EF4
        enum enmFlag eFlag; // r2
        float sAxisMtx[4][4]; // r29+0x50
        class NNS_VECTORFAST sLocalVecFast; // r29+0x40
    }
}


// Range: 0x2F3F00 -> 0x2F44C0
void execute(class clsPlayerDebug * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2F3F00 -> 0x2F44C0
        float sMtx[4][4]; // r29+0x90
        class NNS_QUATERNION sQuat; // r29+0x80
        float f32Rad; // r29+0xDC
