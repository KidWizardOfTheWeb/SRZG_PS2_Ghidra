/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\CharaBilly.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32CollisionRadius; // size: 0x4, address: 0x688430
...
class clsCharaBilly : public clsCharaNodeBase {
    // total size: 0x70
public:
    class clsPlaySe_2D * m_pcPlaySe2D; // offset 0x60, size 0x4
};
class hkStepInfo {
    // total size: 0x10
public:
...
// Range: 0x463510 -> 0x463648
void draw(class clsCharaBilly * this /* r16 */, unsigned int u32AddDrawFlagI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x463510 -> 0x463648
...
// Range: 0x463660 -> 0x463928
void actionAttack00(class clsCharaBilly * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x463660 -> 0x463928
        class clsModelType_OB_TX_MO_MA * pcModel; // r2
...
// Range: 0x463940 -> 0x4639B8
void initAttack00(class clsCharaBilly * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x463940 -> 0x4639B8
    }
...
// Range: 0x4639C0 -> 0x463B04
void behavior(class clsCharaBilly * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4639C0 -> 0x463B04
