/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Trick\SpinTrickAction.cpp
...
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x696A90
float oaf32DistanceTable_Spin[7]; // size: 0x1C, address: 0x67B4E0
...
// Range: 0x537880 -> 0x537CD8
void execute(class clsSpinTrickAction * this /* r19 */, class clsTrickParam & rcParam /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x537880 -> 0x537CD8
        class NNS_VECTORFAST sMoveDirVecFast; // r29+0x70
        float f32PostualRad; // r29+0x80
...
// Range: 0x537CE0 -> 0x53801C
void init(class clsSpinTrickAction * this /* r20 */, class clsTrickParam & rcParam /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x537CE0 -> 0x53801C
        class clsPath cTrickPath; // r29+0xB0
        signed int s32KeyDir; // r2
        class stcKickerParam * opsParam; // r2
        class NNS_QUATERNION sPosturalQuat; // r29+0xA0
    }
}
