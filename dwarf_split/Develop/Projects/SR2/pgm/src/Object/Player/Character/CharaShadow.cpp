/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Player\Character\CharaShadow.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32CollisionRadius; // size: 0x4, address: 0x6751D0
class stcParam sShadowLineParam; // size: 0x40, address: 0x625C90
...
struct /* @anon1 */ {
    // total size: 0x40
} __vt__14clsCharaShadow; // size: 0x40, address: 0x6BD0E0
struct /* @anon3 */ {
    // total size: 0x40
...
class clsCharaShadow : public clsCharaNodeBase {
    // total size: 0x70
public:
    unsigned int m_u32LoopSeID; // offset 0x60, size 0x4
    class clsBackLineEffectTask * m_pcLineTask; // offset 0x64, size 0x4
    unsigned char m_u8IsBallVisible; // offset 0x68, size 0x1
};
class PotentialInfo {
    // total size: 0x1008
public:
...
// Range: 0x329D60 -> 0x32A014
void drawAttackEffect(class clsCharaShadow * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x329D60 -> 0x32A014
        ...
        float sRHandMtx[4][4]; // r29+0x100
        float sMirrorMtx[4][4]; // r29+0xC0
        float sOffsetMtx[4][4]; // r29+0x80
        float f32ScaleRate; // r1
        signed int s32BornId; // r18
    }
}


// Range: 0x32A020 -> 0x32A028
void actionAttack01() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32A020 -> 0x32A028
...
// Range: 0x32A030 -> 0x32A334
void actionAttack00(class clsCharaShadow * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32A030 -> 0x32A334
...
// Range: 0x32A350 -> 0x32A3E4
void initAttack00(class clsCharaShadow * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32A350 -> 0x32A3E4
    }
...
// Range: 0x32A3F0 -> 0x32A530
void behavior(class clsCharaShadow * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32A3F0 -> 0x32A530
...
// Range: 0x32A530 -> 0x32A60C
void * __ct(class clsCharaShadow * this /* r17 */, class clsPlayerTask * pcPlayer /* r16 */, unsigned char u8ModelType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x32A530 -> 0x32A60C
