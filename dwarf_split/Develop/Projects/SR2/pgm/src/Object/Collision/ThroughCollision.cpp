/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Collision\ThroughCollision.cpp
...
// Range: 0x35FC90 -> 0x35FD80
void setData(class clsThroughCollision * this /* r18 */, void * pvData /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x35FC90 -> 0x35FD80
        class hkShape * pcShape; // r2
        class stcBinBody * psBody; // r2
        class hkVector4 cHalfExtent; // r29+0x40
    }
}
