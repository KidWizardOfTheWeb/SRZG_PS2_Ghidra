/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Collision\Through\GravityThroughCollision.cpp
...
// Range: 0x3601B0 -> 0x3601B8
void contactRemoveEvent() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3601B0 -> 0x3601B8
    }
...
// Range: 0x3601C0 -> 0x3603F4
void contactAlwaysEvent(class clsGravityThroughCollision * this /* r18 */, class clsPlayerTask * pcPlayer /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3601C0 -> 0x3603F4
        unsigned char u8PathNo'139; // r3
        unsigned char u8PathNo; // r29+0x6F
        class NNS_VECTORFAST sDirVecFast; // r29+0x50
    }
}


// Range: 0x360400 -> 0x36064C
void contactTriggerEvent(class clsGravityThroughCollision * this /* r18 */, class clsPlayerTask * pcPlayer /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x360400 -> 0x36064C
        unsigned char u8PathNo'143; // r3
        unsigned char u8PathNo; // r29+0x6F
        class NNS_VECTORFAST sDirVecFast; // r29+0x50
    }
}
