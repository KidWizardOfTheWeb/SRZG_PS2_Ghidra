/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Collision\Collecter\PhantomCollectorInfo.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0xC
} __vt__23clsPhantomCollectorInfo; // size: 0xC, address: 0x6C3140
