/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Collision\GroundCollision.cpp
...
// Range: 0x35C910 -> 0x35CB58
void setData(class clsGroundCollision * this /* r20 */, class stcBinBody * psBody /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x35C910 -> 0x35CB58
        class hkMeshShape * pcShape; // r18
        class Subpart cPart; // r29+0x90
        class hkMoppCompilerInput mft; // r29+0x60
        class hkMoppCode * code; // r17
    }
}


// Range: 0x35CB60 -> 0x35CBA0
void destroy(class clsGroundCollision * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x35CB60 -> 0x35CBA0
    }
...
// Range: 0x35CBA0 -> 0x35CCC0
void create(class clsGroundCollision * this /* r17 */, class hkShape * pcShape /* r18 */, class stcInfo * psInfo /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x35CBA0 -> 0x35CCC0
