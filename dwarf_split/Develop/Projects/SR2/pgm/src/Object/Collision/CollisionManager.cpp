/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Collision\CollisionManager.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
void * __dt(class clsGroundCollision *, signed short); // size: 0x0, address: 0x35C2A0
...
struct /* @anon1 */ {
    // total size: 0x34
} __vt__24clsLightThroughCollision; // size: 0x34, address: 0x6CD7A0
struct /* @anon0 */ {
    // total size: 0x34
} __vt__26clsGravityThroughCollision; // size: 0x34, address: 0x6BE780
void * __ct(class clsGroundCollision *); // size: 0x0, address: 0x35C810
struct /* @anon6 */ {
    // total size: 0x28
} __vt__18clsGroundCollision; // size: 0x28, address: 0x6BE5B0
...
class stcBinBody {
    // total size: 0x10
public:
    class NNS_QUATERNION * psRotQuat; // offset 0x0, size 0x4
    class NNS_VECTOR * psPosVec; // offset 0x4, size 0x4
    class NNS_VECTOR * psSclVec; // offset 0x8, size 0x4
    class stcInfo * psInfo; // offset 0xC, size 0x4
};
class hkArray {
    // total size: 0xC
public:
...
// Range: 0x35C1A0 -> 0x35C1F4
void DrawThrough(class clsCollisionManager * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x35C1A0 -> 0x35C1F4
        signed int i; // r17
        class clsThroughCollision * * ppcCollision; // r16
    }
}


// Range: 0x35C200 -> 0x35C29C
void destroy(class clsCollisionManager * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x35C200 -> 0x35C29C
        signed int i; // r18
...
// Range: 0x35C3B0 -> 0x35C524
signed char checkRayCast(class stcRetRayCast & rsRetRayCast /* r17 */, class NNS_VECTORFAST & rsStartVecFast /* r2 */, class NNS_VECTORFAST & rsEndVecFast /* r2 */, unsigned int u32ColliFilter /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x35C3B0 -> 0x35C524
        class hkWorldRayCastInput sRayCastInp; // r29+0xA0
        class hkWorldRayCastOutput sRayCastOut; // r29+0x40
        signed char s8Ret; // r16
        class hkVector4 sCrossPoint; // r29+0x30
...
// Range: 0x35C530 -> 0x35C80C
void registData(class clsCollisionManager * this /* r16 */, void * pvBuff /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x35C530 -> 0x35C80C
        class stcBinHeader * psHeader; // r2
        signed int i; // r19
        class stcBinBody * psBody; // r18
        class clsGroundCollision * pcCollision; // r17
        class stcBinBody * psBody; // r18
        class clsThroughCollision * * ppcCollision; // r17
    }
}


// Range: 0x35C840 -> 0x35C8E8
void setupBinData(void * pvBuff /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x35C840 -> 0x35C8E8
    }
