/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Collision\BaseThroughCollision.cpp
...
// Range: 0x364880 -> 0x3648A8
void draw(class clsBaseThroughCollision * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x364880 -> 0x3648A8
    }
...
// Range: 0x3648B0 -> 0x3648C4
void contactRemoveEvent(class clsBaseThroughCollision * this /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3648B0 -> 0x3648C4
    }
...
// Range: 0x3648D0 -> 0x3648E4
void contactAlwaysEvent(class clsBaseThroughCollision * this /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3648D0 -> 0x3648E4
    }
...
// Range: 0x3648F0 -> 0x364904
void contactTriggerEvent(class clsBaseThroughCollision * this /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3648F0 -> 0x364904
    }
...
// Range: 0x364910 -> 0x36494C
void destroy(class clsBaseThroughCollision * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x364910 -> 0x36494C
    }
...
// Range: 0x364950 -> 0x364A64
void create(class clsBaseThroughCollision * this /* r16 */, class NNS_VECTOR * psPosVec /* r2 */, class NNS_QUATERNION * psQuat /* r2 */, class hkShape * pcShape /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x364950 -> 0x364A64
        class NNS_QUATERNION sQuat; // r29+0xA0
        class hkQuaternion cRot; // r29+0x90
