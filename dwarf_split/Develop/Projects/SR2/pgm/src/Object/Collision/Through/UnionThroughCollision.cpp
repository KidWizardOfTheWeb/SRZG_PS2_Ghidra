/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Collision\Through\UnionThroughCollision.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon4 */ {
    // total size: 0x34
} __vt__24clsUnionThroughCollision; // size: 0x34, address: 0x6C1810
struct /* @anon2 */ {
    // total size: 0x28
...
struct /* @anon0 */ {
    // total size: 0x34
} __vt__19clsThroughCollision; // size: 0x34, address: 0x6BE570
class stcTask sTask; // size: 0x30, address: 0xB0A900
class clsPfSystem * m_tpcSingleton; // size: 0x4, address: 0x6E69B8
class clsMapPartsGimmickWallBig_Task * m_tpcSingleton; // size: 0x4, address: 0xB16350
class clsMapPartsGimmickWallSmall_Task * m_tpcSingleton; // size: 0x4, address: 0xB16348
...
class clsIvy_Task * m_tpcSingleton; // size: 0x4, address: 0xB13DF0
...
class clsMapPartsGimmickWallBig_Task : public clsSingleModelGimmick_Task {
    // total size: 0xB0
public:
    class hkTransformShape * m_pcTransShape; // offset 0xAC, size 0x4
};
enum enm {
    NONE = -1,
    CHARA_0 = 0,
...
public:
    ...
    float m_f32MatMotionEndFrame; // offset 0xE8, size 0x4
    float m_f32MotionEndFrame; // offset 0xEC, size 0x4
    float m_f32Num; // offset 0xF0, size 0x4
    float m_f32Lap; // offset 0xF4, size 0x4
    float m_f32Rank; // offset 0xF8, size 0x4
    enum enmMode m_eMode; // offset 0xFC, size 0x4
    unsigned char m_bFlag; // offset 0x100, size 0x1
    class hkVector4 m_cVec; // offset 0x110, size 0x10
};
enum enmDraw2DAttr {
...
class clsMapPartsGimmickWallSmall_Task : public clsSingleModelGimmick_Task {
    // total size: 0xB0
public:
    class hkTransformShape * m_pcTransShape; // offset 0xAC, size 0x4
};
...
class clsIvy_Task : public clsSingleModelGimmick_Task {
    // total size: 0x9C
};
enum enmNo {
    PLAYER_00 = 0,
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsMapPartsGimmickWallSmall_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsMapPartsGimmickWallSmall_Object : public clsMapPartsGimmickWall_Object {
    // total size: 0x170
public:
    float m_sEffectMtx[4][4]; // offset 0x120, size 0x40
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x9C
public:
    class clsIvy_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
...
class clsIvy_Obj : public clsPhantomGimmickObject {
    // total size: 0xA0
public:
    class NNS_VECTORFAST m_sRollNrmVecFast; // offset 0x60, size 0x10
    enum enmIvyMode m_eIvyMode; // offset 0x70, size 0x4
    class clsPlayerTask * m_pcPlayer; // offset 0x74, size 0x4
    float m_f32EndFrame; // offset 0x78, size 0x4
    float m_f32MotionFrame; // offset 0x7C, size 0x4
    float m_f32WaitFrame; // offset 0x80, size 0x4
    float m_f32MoveEndFrame; // offset 0x84, size 0x4
    float m_f32MotionPlayRate; // offset 0x88, size 0x4
    float m_f32Speed; // offset 0x8C, size 0x4
    signed int m_s32ParentPathNo; // offset 0x90, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsMapPartsGimmickWallBig_Object * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB_TX_MO_MA m_cModel; // offset 0x88, size 0x20
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0xA8, size 0x4
...
// Range: 0x3C01F0 -> 0x3C0548
void contactRemoveEvent(class clsUnionThroughCollision * this /* r17 */, class clsPlayerTask * pcPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C01F0 -> 0x3C0548
        class clsGravityDive * pcDive; // r2
        class clsDivStage_Task * pcDivState_Task; // r2
    }
}


// Range: 0x3C0550 -> 0x3C05E0
void contactAlwaysEvent(class clsUnionThroughCollision * this /* r2 */, class clsPlayerTask * pcPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C0550 -> 0x3C05E0
    }
...
// Range: 0x3C05E0 -> 0x3C0A74
void contactTriggerEvent(class clsUnionThroughCollision * this /* r17 */, class clsPlayerTask * pcPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3C05E0 -> 0x3C0A74
        class clsDivStage_Task * pcDivState_Task; // r2
