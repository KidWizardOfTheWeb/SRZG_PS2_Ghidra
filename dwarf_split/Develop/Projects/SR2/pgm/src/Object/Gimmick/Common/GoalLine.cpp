/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\GoalLine.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x67D190
struct /* @anon2 */ {
    // total size: 0x48
} __vt__16clsGoalLine_Task; // size: 0x48, address: 0x6BEB50
struct /* @anon5 */ {
    // total size: 0x48
} __vt__85clsSingleModelGimmick_Task<16clsGoalLine_Task,15clsGoalLine_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6B8F60
struct /* @anon3 */ {
    // total size: 0x38
...
struct /* @anon0 */ {
    // total size: 0xC
} __vt__32clsSingleton<16clsGoalLine_Task>; // size: 0xC, address: 0x6B8EF8
void * __dt(class clsGoalLine_Obj *, signed short); // size: 0x0, address: 0x2D78A0
struct /* @anon1 */ {
    // total size: 0x48
} __vt__77clsBaseGimmickBody<16clsGoalLine_Task,15clsGoalLine_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6B8F10
struct /* @anon6 */ {
    // total size: 0x28
...
struct /* @anon9 */ {
    // total size: 0x44
} __vt__15clsGoalLine_Obj; // size: 0x44, address: 0x6B8EB0
...
// Range: 0x369170 -> 0x369404
void draw(class clsGoalLine_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x369170 -> 0x369404
...
// Range: 0x369450 -> 0x3694C0
void execute(class clsGoalLine_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x369450 -> 0x3694C0
    }
