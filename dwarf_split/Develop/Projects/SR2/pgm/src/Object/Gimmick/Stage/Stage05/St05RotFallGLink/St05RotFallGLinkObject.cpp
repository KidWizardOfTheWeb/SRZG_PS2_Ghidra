/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage05\St05RotFallGLink\St05RotFallGLinkObject.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float t_sBaseMtx[4][4]; // size: 0x40, address: 0xB17280
float t_sBaseInvMtx[4][4]; // size: 0x40, address: 0xB172C0
class NNS_VECTORFAST t_sDirVecFast; // size: 0x10, address: 0xB17300
signed int t_s32AppearCount; // size: 0x4, address: 0xB17310
float t_f32AppearFrame; // size: 0x4, address: 0xB17318
float t_oaf32FallSpeed[2]; // size: 0x8, address: 0x6877E0
float t_of32FallAccele; // size: 0x4, address: 0x0
float t_oaf32IntervalFrame[2]; // size: 0x8, address: 0x6877E8
float t_oaf32OffsetSide[2]; // size: 0x8, address: 0x6877F0
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x6877F8
float tof32ClipSqDist; // size: 0x4, address: 0x687808
class clsGravityGimmickParam t_ocGravityGimmickParam[2]; // size: 0xF0, address: 0x687810
class clsGravityGimmickParam * t_opcGravityGimmickParam; // size: 0x4, address: 0xB17320
float t_f32FallSpeed; // size: 0x4, address: 0xB17328
float t_f32IntervalFrame; // size: 0x4, address: 0xB17330
float t_f32OffsetSide; // size: 0x4, address: 0x636888
...
class clsRotFallGLink_Task * m_tpcSingleton; // size: 0x4, address: 0xB17270
...
class clsRotFallGLink_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
class hkPadSpu {
    // total size: 0x4
...
class clsRotFallGLinkManager_Object : public clsGimmickObj {
    // total size: 0x70
public:
    class clsRotFallGLink_Object * m_pcObject; // offset 0x50, size 0x4
    class stcSetDataDetail * m_psSetData; // offset 0x54, size 0x4
    signed int m_s32ObjectNum; // offset 0x58, size 0x4
    class clsGmkBurnLight_Task * m_pcBurnLightTask; // offset 0x5C, size 0x4
    unsigned char m_bStop; // offset 0x60, size 0x1
};
class node {
    // total size: 0x0
};
...
public:
    ...
    unsigned int m_u32SePlayFlg; // offset 0xE8, size 0x4
    unsigned int m_u32DrawFlg; // offset 0xEC, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsRotFallGLinkManager_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x446CE0 -> 0x446D60
void destroyData(class clsRotFallGLink_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x446CE0 -> 0x446D60
    }
...
// Range: 0x446D60 -> 0x447184
void createData(class clsRotFallGLink_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x446D60 -> 0x447184
...
// Range: 0x447190 -> 0x4471AC
void setData(class clsRotFallGLink_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x447190 -> 0x4471AC
    }
...
void drawEffect(class clsPlayerTask * pcPlayer /* r16 */) {
    ...
    /* anonymous block */ {
        ...
        class NNS_VECTOR LOCAL_POS_R; // @ 0x00687930
        class NNS_VECTOR LOCAL_POS; // @ 0x00687920
        class NNS_VECTOR RAND_SP; // @ 0x00687910
        float LIFE_FRAME; // @ 0x00687940
        class NNS_VECTOR BEGIN_SP; // @ 0x00687900
    }
}


// Range: 0x4472D0 -> 0x4472DC
void requestDrawBreakEffect(class clsRotFallGLink_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4472D0 -> 0x4472DC
    }
...
// Range: 0x4472E0 -> 0x44733C
void requestDrawContactEffect(class clsRotFallGLink_Object * this /* r2 */, class hkContactPoint * pcContact /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4472E0 -> 0x44733C
...
// Range: 0x447340 -> 0x447BB8
void main(class clsRotFallGLink_Object * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x447340 -> 0x447BB8
        class hkVector4 cZero; // r29+0x120
        class NNS_VECTORFAST sLocalVecFast; // r29+0x110
        class hkVector4 cRot; // r29+0x100
        class hkVector4 cSpeed; // r29+0xF0
        class NNS_VECTORFAST sSpeedVecFast; // r29+0xE0
        ...
        unsigned int u32v; // r20
    }
}


// Range: 0x447BC0 -> 0x447CDC
void reset(class clsRotFallGLink_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x447BC0 -> 0x447CDC
...
// Range: 0x447CE0 -> 0x447F9C
unsigned char draw(class clsRotFallGLink_Object * this /* r19 */, class NNS_OBJECT * psObject /* r18 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r20 */, float (* opaNnViewMtx)[4][4] /* r17 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x447CE0 -> 0x447F9C
    }
