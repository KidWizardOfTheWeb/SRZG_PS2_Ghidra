/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage07\St07MapPartsFloorSwitch.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x692A00
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x692A08
static unsigned char sco8RateTable8Num[8][13]; // size: 0x68, address: 0x692A20
static unsigned char sco8RateTableMissionNum[7][13]; // size: 0x5B, address: 0x692A90
struct /* @anon9 */ {
    // total size: 0x48
} __vt__27clsMapPartsFloorSwitch_Task; // size: 0x48, address: 0x6CBC50
struct /* @anon1 */ {
    // total size: 0x48
} __vt__116clsSingleModelGimmick_Task<27clsMapPartsFloorSwitch_Task,29clsMapPartsFloorSwitch_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6CBD00
struct /* @anon4 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsMapPartsFloorSwitch_Task * m_tpcSingleton; // size: 0x4, address: 0xB0B8C8
struct /* @anon3 */ {
    // total size: 0xC
} __vt__43clsSingleton<27clsMapPartsFloorSwitch_Task>; // size: 0xC, address: 0x6CBC98
void * __dt(class clsMapPartsFloorSwitch_Object *, signed short); // size: 0x0, address: 0x4FA340
struct /* @anon10 */ {
    // total size: 0x48
} __vt__108clsBaseGimmickBody<27clsMapPartsFloorSwitch_Task,29clsMapPartsFloorSwitch_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6CBCB0
struct /* @anon0 */ {
    // total size: 0xA8
} __vt__29clsMapPartsFloorSwitch_Object; // size: 0xA8, address: 0x6CBD50
...
void * __ct(class clsMapPartsFloorSwitch_Object *); // size: 0x0, address: 0x4FAE80
...
class clsRailWayEnd_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A830
class clsRailWayStart_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A838
class clsDashRing_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A8C8
class clsSt07PowerBreak_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA730
class clsItemBox_Task * m_tpcSingleton; // size: 0x4, address: 0xB13DD0
class clsSpring_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A8C0
class clsDashPanel_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A8D0
class clsCatapult_Task * m_tpcSingleton; // size: 0x4, address: 0xB16480
class clsMapPartsFloorChange_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA708
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsSt07PowerBreak_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsSpring_Obj : public clsPhantomGimmickObject {
    // total size: 0xB0
public:
    enum enmSpringMode m_enSpringMode; // offset 0x60, size 0x4
    float m_f32Count; // offset 0x64, size 0x4
    float m_f32JumpSpeed; // offset 0x68, size 0x4
    class clsSpring_Obj * m_pcNextObj; // offset 0x6C, size 0x4
    class clsPlayerTask * m_pcPlayerTask; // offset 0x70, size 0x4
    signed int m_s32HitFrame; // offset 0x74, size 0x4
    class NNS_VECTORFAST m_sUpVecFast; // offset 0x80, size 0x10
    class NNS_VECTORFAST m_sTopPosVecFast; // offset 0x90, size 0x10
    float m_f32Scale; // offset 0xA0, size 0x4
    unsigned short m_ModelNo; // offset 0xA4, size 0x2
    class clsMapPartsFloorSwitch_Object * m_pcSwitchObj; // offset 0xA8, size 0x4
};
class stcSeed {
    // total size: 0x30
public:
...
class clsRailWayEnd_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
enum MemoryState {
    MEMORY_STATE_OK = 0,
...
class clsCatapult_Task : public clsSingleModelGimmick_Task, public clsGimmickCommon {
    // total size: 0xB0
};
class clsMapPartsFloorSwitch_Object : public clsMapPartsObject {
    // total size: 0x310
public:
    float m_f32MatMotionFrame; // offset 0xE0, size 0x4
    float m_f32MotionFrame; // offset 0xE4, size 0x4
    enum enmMode m_eMode; // offset 0xE8, size 0x4
    float m_f32Count; // offset 0xEC, size 0x4
    enum enmState m_eState; // offset 0xF0, size 0x4
    unsigned int m_u32Type; // offset 0xF4, size 0x4
    class clsGimmickObj * m_pcObj[31]; // offset 0xF8, size 0x7C
    float m_sEffectMtx[6][4][4]; // offset 0x180, size 0x180
    class clsSe3DControl * m_pcSe3DControl; // offset 0x300, size 0x4
};
...
class clsCatapultThroughCollision : public clsBaseThroughCollision {
    // total size: 0xC
public:
    class clsCatapult_Obj * m_pcCatapult; // offset 0x8, size 0x4
};
...
class clsItemBox_Task : public clsBaseGimmickBody, public clsGimmickCommon {
    // total size: 0xE4
public:
    unsigned short * m_TexIdx[2]; // offset 0xBC, size 0x8
    unsigned short * m_TexIdx2[2]; // offset 0xC4, size 0x8
    unsigned int m_u32PutBoxNum; // offset 0xCC, size 0x4
    float m_f32Scale; // offset 0xD0, size 0x4
    unsigned char m_bChangeMaterial2; // offset 0xD4, size 0x1
    unsigned char m_bIsItemBom; // offset 0xD5, size 0x1
    class hkShape * m_pcItemBoxShape[2]; // offset 0xD8, size 0x8
    class hkShape * m_pcColPoolShape; // offset 0xE0, size 0x4
};
...
class clsMapPartsFloorChange_Object : public clsMapPartsObject {
    // total size: 0x150
public:
    float m_f32MotionFrame; // offset 0xE0, size 0x4
    float m_f32Num; // offset 0xE4, size 0x4
    enum enmMode m_eMode; // offset 0xE8, size 0x4
    enum enmState m_eState; // offset 0xEC, size 0x4
    class hkVector4 m_cUpSpeed; // offset 0xF0, size 0x10
    class hkVector4 m_cRotSpeed; // offset 0x100, size 0x10
    float m_f32Count; // offset 0x110, size 0x4
    float m_f32MoveAngle; // offset 0x114, size 0x4
    float m_f32MovePos; // offset 0x118, size 0x4
    class NNS_VECTORFAST m_sInitPosVF; // offset 0x120, size 0x10
    class NNS_QUATERNION m_sInitQuat; // offset 0x130, size 0x10
...
public:
    ...
    class clsSe3DControl * m_pcSe3DControl; // offset 0xD4, size 0x4
};
...
class clsDashPanel_Obj : public clsPhantomGimmickObject {
    // total size: 0x70
public:
    float m_f32PushSpeed; // offset 0x60, size 0x4
};
class stcBaseStatus {
    // total size: 0xC
public:
...
class clsItemBox_Obj : public clsPhantomGimmickObject {
    // total size: 0x90
public:
    unsigned int m_u32TexIdx; // offset 0x60, size 0x4
    unsigned int m_u32TexIdx2; // offset 0x64, size 0x4
    enum enmItemBoxMode m_enItemBoxMode; // offset 0x68, size 0x4
    float m_f32WaitTimer; // offset 0x6C, size 0x4
    enum enmItemType m_u32ItemNo; // offset 0x70, size 0x4
    unsigned char m_bAirFlg; // offset 0x74, size 0x1
    float m_f32MatMotionFrame; // offset 0x78, size 0x4
    unsigned int m_u32HitFlg; // offset 0x7C, size 0x4
    float m_f32LifeFrame; // offset 0x80, size 0x4
    float m_f32Alpha; // offset 0x84, size 0x4
};
class clsFlyAction {
    // total size: 0x1C
public:
...
class clsCatapult_Obj : public clsRigidBodyGimmickObj {
    // total size: 0x160
public:
    enum enmCatapultMode m_eMode; // offset 0xD0, size 0x4
    float m_f32Scale; // offset 0xD4, size 0x4
    float m_f32PushSpeed; // offset 0xD8, size 0x4
    float m_f32Angle; // offset 0xDC, size 0x4
    enum enmAiMode m_eAiMode; // offset 0xE0, size 0x4
    float m_f32NowAngle; // offset 0xE4, size 0x4
    class hkVector4 m_cUpSpeed; // offset 0xF0, size 0x10
    class hkVector4 m_cDownSpeed; // offset 0x100, size 0x10
    class NNS_QUATERNION m_sInitRotQuat; // offset 0x110, size 0x10
    class clsPlayerTask * m_pcPlayerTask[8]; // offset 0x120, size 0x20
    class clsCatapultThroughCollision * m_pcCollision; // offset 0x140, size 0x4
    signed int m_s32HitCount; // offset 0x144, size 0x4
    float m_f32MoveAngle; // offset 0x148, size 0x4
    float m_f32NodeAngle; // offset 0x14C, size 0x4
    float m_f32MatMotionFrame; // offset 0x150, size 0x4
    float m_f32MatMotionAcceleRate; // offset 0x154, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsCatapult_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
...
class clsMapPartsFloorSwitch_Task : public clsSingleModelGimmick_Task {
    // total size: 0xAC
};
class GskFlags {
    // total size: 0x4
...
class clsDashRing_Obj : public clsPhantomGimmickObject {
    // total size: 0x80
public:
    unsigned int m_u32RingNo; // offset 0x60, size 0x4
    float m_f32Scale; // offset 0x64, size 0x4
    float m_f32PushSpeed; // offset 0x68, size 0x4
    signed int m_s32GravityPathNo; // offset 0x6C, size 0x4
    signed int m_s32StiffFrame; // offset 0x70, size 0x4
};
...
class stcShapeInfo {
    // total size: 0x10
public:
    class NNS_VECTOR sScaleVec; // offset 0x0, size 0xC
    class hkShape * pcShape; // offset 0xC, size 0x4
};
...
class clsRailWayStart_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
enum enmComType {
...
class clsDashRing_Task : public clsMultiShape, public clsSingleModelGimmick_Task, public clsGimmickCommon {
    // total size: 0xB0
public:
    unsigned short * m_psFlushLightTexIdx; // offset 0xA8, size 0x4
    float * m_pf32FlushLightTexCoordV; // offset 0xAC, size 0x4
};
class map {
    // total size: 0x18
public:
...
class clsSpring_Task : public clsSingleModelGimmick_Task, public clsGimmickCommon {
    // total size: 0xB0
public:
    class NNS_VECTORFAST m_sDebugPathMoveFast; // offset 0xA0, size 0x10
};
...
public:
    ...
    float * m_pf32MotionFrame; // offset 0x58, size 0x4
    float * m_pf32MatMotionFrame; // offset 0x5C, size 0x4
    class clsModelType_OB_TX_MO & m_rcModel; // offset 0x60, size 0x4
    signed short m_16ObjectNum; // offset 0x64, size 0x2
    signed short m_s16DrawNum; // offset 0x66, size 0x2
    signed char m_s8DrawNodeNo; // offset 0x68, size 0x1
};
...
public:
    ...
    class stcShapeInfo * data_; // offset 0x8, size 0x4
};
class clsOOList : public list {
    // total size: 0x14
};
...
class clsMapPartsFloorChange_Task : public clsSingleModelGimmick_Task {
    // total size: 0x9C
};
class clsSt07PowerBreak_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsDashRing_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB_TX m_cModel; // offset 0x88, size 0x8
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0x90, size 0x4
...
class clsDashPanel_Task : public clsSingleModelGimmick_Task, public clsGimmickCommon {
    // total size: 0x9C
public:
    float * m_pf32TexCoordV; // offset 0x98, size 0x4
};
...
class clsMultiShape {
    // total size: 0xC
public:
    class vector m_vecShpeInfo; // offset 0x0, size 0xC
};
class hkArray {
    // total size: 0xC
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsDashPanel_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB_TX m_cModel; // offset 0x88, size 0x8
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0x90, size 0x4
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsRailWay_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB_TX m_cModel; // offset 0x88, size 0x8
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0x90, size 0x4
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsMapPartsFloorSwitch_Object * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB_TX_MO_MA m_cModel; // offset 0x88, size 0x20
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0xA8, size 0x4
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xB8
public:
    class clsItemBox_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsItemBoxModels m_cModel; // offset 0x88, size 0x2C
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0xB4, size 0x4
};
class clsOOStlAllocator {
    // total size: 0x4
public:
...
class clsItemBoxModels {
    // total size: 0x2C
public:
    class clsModelType_OB_TX m_cItemBox; // offset 0x0, size 0x8
    class clsModelType_OB m_cItemBoxAir; // offset 0x8, size 0x4
    class clsModelType_OB_TX_MO_MA m_cColorPool; // offset 0xC, size 0x20
};
...
class clsMapPartsObject : public clsRigidBodyGimmickObj {
    // total size: 0xE0
public:
    class stcInfo m_sColInfo; // offset 0xD0, size 0x10
};
class hkBool {
    // total size: 0x1
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsSpring_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB_TX m_cModel; // offset 0x88, size 0x8
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0x90, size 0x4
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x9C
public:
    class clsMapPartsFloorChange_Object * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB_TX_MO m_cModel; // offset 0x88, size 0x10
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0x98, size 0x4
};
...
// Range: 0x4FA3C0 -> 0x4FA7AC
void draw(class clsMapPartsFloorSwitch_Task * this /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FA3C0 -> 0x4FA7AC
        unsigned int sNodeStat; // r29+0x19C
        float sMtxPal[4][4]; // r29+0x150
        float sMtxWork[4][4]; // r29+0x110
        unsigned int u32i; // r21
    }
}


// Range: 0x4FA860 -> 0x4FA9D0
void execute(class clsMapPartsFloorSwitch_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FA860 -> 0x4FA9D0
...
// Range: 0x4FA9D0 -> 0x4FAA40
void reset(class clsMapPartsFloorSwitch_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FA9D0 -> 0x4FAA40
        unsigned int u32Num; // r2
...
// Range: 0x4FAA40 -> 0x4FAB0C
void * __ct(class clsMapPartsFloorSwitch_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FAA40 -> 0x4FAB0C
        class hkVector4 cBoxHalfSize; // r29+0x20
    }
}


// Range: 0x4FAED0 -> 0x4FAEDC
void extensionActiveFrame(class clsMapPartsFloorSwitch_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FAED0 -> 0x4FAEDC
    }
...
// Range: 0x4FAEE0 -> 0x4FAF40
void destroyData(class clsMapPartsFloorSwitch_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FAEE0 -> 0x4FAF40
    }
...
// Range: 0x4FAF40 -> 0x4FAFB8
unsigned char checkPath(class clsMapPartsFloorSwitch_Object * this /* r2 */, unsigned int u32PathNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FAF40 -> 0x4FAFB8
    }
...
// Range: 0x4FAFC0 -> 0x4FB18C
unsigned int getType(class clsMapPartsFloorSwitch_Object * this /* r17 */, unsigned int u32Rank /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FAFC0 -> 0x4FB18C
        unsigned int u32j; // r4
        class clsMissionRace_Task * pcMissionRace_Task; // r8
        signed int s32MissionNo; // r7
    }
}


// Range: 0x4FB190 -> 0x4FB90C
void init(class clsMapPartsFloorSwitch_Object * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FB190 -> 0x4FB90C
        unsigned int u32i; // r4
        float f32Num; // r20
        unsigned int u32Count; // r19
    }
}


// Range: 0x4FB910 -> 0x4FBCB0
void resetObject(class clsMapPartsFloorSwitch_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FB910 -> 0x4FBCB0
        unsigned int u32i; // r5
        class clsItemBox_Obj * pcItemBox; // r2
        class clsRailWay_Obj * pcRailWay; // r2
        class clsCatapult_Obj * pcCatapult; // r2
        class clsDashRing_Obj * pcDashRing; // r2
        class clsDashPanel_Obj * pcDashPanelPt; // r2
        class clsSt07PowerBreak_Obj * pcPTObj; // r2
        class clsSpring_Obj * pcSpring; // r2
        class clsDashPanel_Obj * pcDashPanel; // r2
    }
}


// Range: 0x4FBCB0 -> 0x4FC120
void setObject(class clsMapPartsFloorSwitch_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FBCB0 -> 0x4FC120
        unsigned int u32i; // r5
        ...
        class clsSt07PowerBreak_Obj * pcPTObj; // r2
        class clsSpring_Obj * pcSpring; // r2
        class NNS_VECTOR sRot; // r29+0x50
        class NNS_VECTORFAST rsPosVecFast; // r29+0x40
        float f32Num; // r20
        class clsDashPanel_Obj * pcDashPanel; // r2
    }
}
...
// Range: 0x4FC120 -> 0x4FD090
void contactTriggerEvent(class clsMapPartsFloorSwitch_Object * this /* r16 */, class clsObject * pcObject /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FC120 -> 0x4FD090
        class clsPath cPath; // r29+0x140
        class clsPlayerTask * pcPlayer; // r2
        unsigned int u32i; // r19
        float f32Num; // r20
        class clsItemBox_Obj * pcItemBox; // r2
        unsigned int u32Count; // r21
        class NNS_VECTOR sRot; // r29+0x240
        class NNS_VECTORFAST rsPosVecFast; // r29+0x130
        class clsDashRing_Obj * pcDashRing; // r2
        class NNS_VECTOR sRot; // r29+0x230
        class NNS_VECTORFAST rsPosVecFast; // r29+0x120
        class clsSt07PowerBreak_Obj * pcPTObj; // r2
        class clsDashPanel_Obj * pcDashPanelpt; // r2
        class NNS_VECTOR sRot; // r29+0x220
        class NNS_VECTORFAST rsPosVecFast; // r29+0x110
        class clsSpring_Obj * pcSpring; // r2
        class NNS_VECTOR sRot; // r29+0x210
        class NNS_VECTORFAST rsPosVecFast; // r29+0x100
        class clsDashPanel_Obj * pcDashPanel; // r2
        class NNS_VECTOR sRot; // r29+0x200
        class NNS_VECTORFAST rsPosVecFast; // r29+0xF0
        class NNS_VECTOR sRot; // r29+0x1F0
        class NNS_VECTORFAST rsPosVecFast; // r29+0xE0
        class NNS_VECTOR sRot; // r29+0x1E0
        class NNS_VECTORFAST rsPosVecFast; // r29+0xD0
        class NNS_VECTOR sRot; // r29+0x1D0
        class NNS_VECTORFAST rsPosVecFast; // r29+0xC0
        class NNS_VECTOR sRot; // r29+0x1C0
        class NNS_VECTORFAST rsPosVecFast; // r29+0xB0
        class NNS_VECTOR sRot; // r29+0x1B0
        class NNS_VECTORFAST rsPosVecFast; // r29+0xA0
        class NNS_VECTOR sRot; // r29+0x1A0
        class NNS_VECTORFAST rsPosVecFast; // r29+0x90
    }
}


// Range: 0x4FD090 -> 0x4FD0D4
void reset(class clsMapPartsFloorSwitch_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FD090 -> 0x4FD0D4
    }
...
// Range: 0x4FD0E0 -> 0x4FD208
void createData(class clsMapPartsFloorSwitch_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FD0E0 -> 0x4FD208
        unsigned int u32i; // r4
...
// Range: 0x4FD210 -> 0x4FD394
void execute(class clsMapPartsFloorSwitch_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FD210 -> 0x4FD394
        unsigned int u32i; // r17
