/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\PutGravityObj3.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon5 */ {
    // total size: 0xBC
} __vt__21clsPutGravityObj3_Obj; // size: 0xBC, address: 0x6CA2B0
struct /* @anon10 */ {
    // total size: 0xBC
...
class clsPutGravityObj3_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A868
...
class clsPutGravityObj3_Task : public clsMultiShape, public clsMultiModelGimmick_Task {
    // total size: 0xA8
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPutGravityObj3_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x4E02A0 -> 0x4E0488
void draw(class clsPutGravityObj3_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E02A0 -> 0x4E0488
...
// Range: 0x4E0490 -> 0x4E05B0
void execute(class clsPutGravityObj3_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E0490 -> 0x4E05B0
        unsigned int u32Num; // r2
...
// Range: 0x4E05B0 -> 0x4E0620
void reset(class clsPutGravityObj3_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E05B0 -> 0x4E0620
        unsigned int u32Num; // r2
...
// Range: 0x4E0620 -> 0x4E0740
void init(class clsPutGravityObj3_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E0620 -> 0x4E0740
        ...
        class clsModelType_OB_TX * pcModel; // r4
        unsigned int u32j; // r17
        unsigned int u32Num; // r2
        unsigned int u32i; // r18
    }
}
...
// Range: 0x4E0740 -> 0x4E0B58
void draw(class clsPutGravityObj3_Obj * this /* r21 */, class clsModelType_OB_TX * pcModels /* r2 */, float (* psMtxPal)[4][4] /* r20 */, unsigned int * psNodeStat /* r19 */, float (* opaNnViewMtx)[4][4] /* r30 */, float (* psMtxWork)[4][4] /* r18 */, unsigned int u32ViewNo /* r22 */, class clsPutGravityObj3_Task * pcTask /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E0740 -> 0x4E0B58
...
// Range: 0x4E0B60 -> 0x4E0C88
void createSe(class clsPutGravityObj3_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E0B60 -> 0x4E0C88
        unsigned int oau32SeTbl[1]; // r29+0x3C
    }
}


// Range: 0x4E0C90 -> 0x4E0CF8
float getFriction(class clsPutGravityObj3_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E0C90 -> 0x4E0CF8
    }
...
// Range: 0x4E0D00 -> 0x4E0D70
float getRestitution(class clsPutGravityObj3_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E0D00 -> 0x4E0D70
    }
...
// Range: 0x4E0D70 -> 0x4E0DD4
float getMass(class clsPutGravityObj3_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E0D70 -> 0x4E0DD4
    }
...
// Range: 0x4E0DE0 -> 0x4E1010
class hkShape * getShape(class clsPutGravityObj3_Obj * this /* r4 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E0DE0 -> 0x4E1010
        class NNS_VECTOR sScaleVec; // r29+0x60
    }
}


// Range: 0x4E1010 -> 0x4E107C
void init(class clsPutGravityObj3_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E1010 -> 0x4E107C
    }
...
// Range: 0x4E1080 -> 0x4E1088
void @80@__dt__21clsPutGravityObj3_ObjFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E1080 -> 0x4E1088
    }
