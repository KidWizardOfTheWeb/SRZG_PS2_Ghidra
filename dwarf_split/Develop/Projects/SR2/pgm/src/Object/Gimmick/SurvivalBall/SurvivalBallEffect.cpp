/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\SurvivalBall\SurvivalBallEffect.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x692030
static class NNS_RGB sCharacterRgb[18]; // size: 0xD8, address: 0x653320
struct /* @anon0 */ {
    // total size: 0x30
} __vt__30clsSurvivalBallBallEffect_Task; // size: 0x30, address: 0x6CAFF0
struct /* @anon1 */ {
    // total size: 0x30
...
// Range: 0x4EF450 -> 0x4EF6F4
void drawAfterimage(class clsSurvivalBallBallEffect_Task * this /* r30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EF450 -> 0x4EF6F4
        float (* opaNnViewMtx)[4][4]; // r29+0xB0
        class clsModelType_OB_TX_MO_MA * pcModel; // r2
...
// Range: 0x4EF700 -> 0x4EFA1C
void drawGetPlayerEffect(class clsSurvivalBallBallEffect_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EF700 -> 0x4EFA1C
        float (* psMtxPal)[4][4]; // r23
        ...
        class NNS_RGB sColor; // r29+0x130
    }
}


// Range: 0x4EFA20 -> 0x4EFCE8
void drawLookOn(class clsSurvivalBallBallEffect_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EFA20 -> 0x4EFCE8
        ...
        class NNS_OBJECT * psObject; // r17
        float sMtx[4][4]; // r29+0xF0
        class NNS_MATERIALPTR * psMatPtrList; // r16
        class _NNS_TEXLIST * copTexList; // r22
        class NNS_MATERIAL_SINGLE * psMaterial; // r2
        unsigned int u32GsTest[2]; // r29+0x138
        signed int s32i; // r8
    }
}


// Range: 0x4EFCF0 -> 0x4EFFC0
void drawRange(class clsSurvivalBallBallEffect_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EFCF0 -> 0x4EFFC0
        float (* psMtxPal)[4][4]; // r19
        ...
        class NNS_MATERIALPTR * psMatPtrList; // r16
        class NNS_MATERIAL_SINGLE * psMaterial; // r2
        unsigned int u32GsTest[2]; // r29+0x128
        signed int s32i; // r8
    }
}


// Range: 0x4EFFC0 -> 0x4F0260
void draw(class clsSurvivalBallBallEffect_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EFFC0 -> 0x4F0260
    }
...
// Range: 0x4F0260 -> 0x4F045C
void executeAfterimage(class clsSurvivalBallBallEffect_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F0260 -> 0x4F045C
        float f32MatMotionEndFrame; // r20
        float f32Num; // r1
        float f32MaxMosionFrame; // r29+0x50
        float f32AddMosionFrame; // r22
        float f32NowMosionFrame; // r21
        signed int i; // r17
        signed int s32Count; // r16
    }
}


// Range: 0x4F0460 -> 0x4F0A00
void execute(class clsSurvivalBallBallEffect_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F0460 -> 0x4F0A00
        class clsSurvivalBallRace_Task & rcSurvivalBallRace_Task; // r2
        signed int s32AddFrame; // r2
        signed int i; // r21
        signed int s32Max; // r2
        float f32CheckLangeth; // r20
        class clsPlayerTask * pcPlayer; // r20
    }
}


// Range: 0x4F0A00 -> 0x4F0B70
void * __ct(class clsSurvivalBallBallEffect_Task * this /* r20 */, unsigned int eEffectType /* r19 */, enum enmDrawType * peDrawFlag /* r18 */, class NNS_VECTORFAST * psPosVec /* r17 */, unsigned int * pu32EffectFlag /* r16 */, unsigned int u32TaskNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F0A00 -> 0x4F0B70
    }
