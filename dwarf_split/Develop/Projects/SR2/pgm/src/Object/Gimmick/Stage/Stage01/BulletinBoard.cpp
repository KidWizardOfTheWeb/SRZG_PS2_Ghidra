/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage01\BulletinBoard.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x676658
struct /* @anon9 */ {
    // total size: 0x48
} __vt__21clsBulletinBoard_Task; // size: 0x48, address: 0x6BD440
struct /* @anon0 */ {
    // total size: 0x48
} __vt__95clsSingleModelGimmick_Task<21clsBulletinBoard_Task,20clsBulletinBoard_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BD4F0
struct /* @anon12 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsBulletinBoard_Task * m_tpcSingleton; // size: 0x4, address: 0xB0D998
struct /* @anon6 */ {
    // total size: 0xC
} __vt__37clsSingleton<21clsBulletinBoard_Task>; // size: 0xC, address: 0x6BD488
void * __dt(class clsBulletinBoard_Obj *, signed short); // size: 0x0, address: 0x33F840
struct /* @anon15 */ {
    // total size: 0x48
} __vt__87clsBaseGimmickBody<21clsBulletinBoard_Task,20clsBulletinBoard_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BD4A0
struct /* @anon14 */ {
    // total size: 0xA8
} __vt__20clsPutGravityObj_Obj; // size: 0xA8, address: 0x6BFB80
struct /* @anon17 */ {
    // total size: 0xA8
} __vt__20clsBulletinBoard_Obj; // size: 0xA8, address: 0x6BD540
struct /* @anon8 */ {
    // total size: 0x28
...
void * __ct(class clsBulletinBoard_Obj *); // size: 0x0, address: 0x340060
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsBulletinBoard_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsBulletinBoard_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
class clsFlag {
    // total size: 0x4
...
// Range: 0x33F8F0 -> 0x33FAF0
void draw(class clsBulletinBoard_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x33F8F0 -> 0x33FAF0
...
// Range: 0x33FAF0 -> 0x33FBD0
void execute(class clsBulletinBoard_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x33FAF0 -> 0x33FBD0
        unsigned int u32Num; // r2
...
// Range: 0x33FBD0 -> 0x33FC40
void reset(class clsBulletinBoard_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x33FBD0 -> 0x33FC40
        unsigned int u32Num; // r2
...
// Range: 0x33FC40 -> 0x33FD04
void * __ct(class clsBulletinBoard_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x33FC40 -> 0x33FD04
...
// Range: 0x3400D0 -> 0x340478
void draw(class clsBulletinBoard_Obj * this /* r21 */, class clsModelType_OB_TX & rcModel /* r20 */, float (* psMtxPal)[4][4] /* r19 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r29+0xB0 */, float (* psMtxWork)[4][4] /* r17 */, unsigned int u32ViewNo /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3400D0 -> 0x340478
...
// Range: 0x3404E0 -> 0x340540
void destroyData(class clsBulletinBoard_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3404E0 -> 0x340540
    }
...
// Range: 0x340540 -> 0x340894
void createData(class clsBulletinBoard_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x340540 -> 0x340894
