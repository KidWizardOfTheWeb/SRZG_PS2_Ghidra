/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Mission\MissionTimeGate.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x67E608
struct /* @anon9 */ {
    // total size: 0x48
} __vt__23clsMissionTimeGate_Task; // size: 0x48, address: 0x6BF450
struct /* @anon10 */ {
    // total size: 0x48
} __vt__105clsSingleModelGimmick_Task<23clsMissionTimeGate_Task,22clsMissionTimeGate_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6BB2A0
struct /* @anon4 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsMissionTimeGate_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A770
struct /* @anon0 */ {
    // total size: 0xC
} __vt__39clsSingleton<23clsMissionTimeGate_Task>; // size: 0xC, address: 0x6BB238
void * __dt(class clsMissionTimeGate_Obj *, signed short); // size: 0x0, address: 0x2C6AD0
struct /* @anon3 */ {
    // total size: 0x48
} __vt__97clsBaseGimmickBody<23clsMissionTimeGate_Task,22clsMissionTimeGate_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6BB250
struct /* @anon7 */ {
    // total size: 0x28
...
struct /* @anon1 */ {
    // total size: 0x58
} __vt__22clsMissionTimeGate_Obj; // size: 0x58, address: 0x6BF4A0
...
class clsMissionTimeGate_Obj : public clsPhantomGimmickObject {
    // total size: 0x70
public:
    unsigned int m_u32AddTime; // offset 0x60, size 0x4
...
class clsMissionTimeGate_Task : public clsSingleModelGimmick_Task {
    // total size: 0xB0
public:
    float * m_pf32TexCoordV; // offset 0xAC, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsMissionTimeGate_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x378A00 -> 0x378B94
void draw(class clsMissionTimeGate_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x378A00 -> 0x378B94
...
// Range: 0x378BA0 -> 0x378D5C
void execute(class clsMissionTimeGate_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x378BA0 -> 0x378D5C
        unsigned int u32Num; // r2
...
// Range: 0x378D60 -> 0x378DC0
void reset(class clsMissionTimeGate_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x378D60 -> 0x378DC0
        unsigned int u32Num; // r2
...
// Range: 0x378DC0 -> 0x378EAC
void contactTriggerEvent(class clsMissionTimeGate_Obj * this /* r19 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x378DC0 -> 0x378EAC
        class clsPlayerTask * pcHitPlayer; // r18
        class clsMissionRace_Task & rcMissionRace_Task; // r17
    }
}


// Range: 0x378EB0 -> 0x379100
void draw(class clsMissionTimeGate_Obj * this /* r21 */, class clsModelType_OB_TX_MO_MA & rcObj /* r20 */, float (* psMtxPal)[4][4] /* r19 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r23 */, float (* psMtxWork)[4][4] /* r17 */, unsigned int u32ViewNo /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x378EB0 -> 0x379100
...
// Range: 0x379100 -> 0x379148
void destroyData(class clsMissionTimeGate_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x379100 -> 0x379148
    }
...
// Range: 0x379150 -> 0x37929C
void createData(class clsMissionTimeGate_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x379150 -> 0x37929C
    }
...
// Range: 0x3792A0 -> 0x379398
void * __ct(class clsMissionTimeGate_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3792A0 -> 0x379398
    }
