/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage07\St07MapPartsGuardRailCurve.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x692CC8
struct /* @anon1 */ {
    // total size: 0x48
} __vt__30clsMapPartsGuardRailCurve_Task; // size: 0x48, address: 0x6CC210
struct /* @anon4 */ {
    // total size: 0x48
} __vt__116clsSingleModelGimmick_Task<30clsMapPartsGuardRailCurve_Task,32clsMapPartsGuardRailCurve_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CC2C0
struct /* @anon2 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsMapPartsGuardRailCurve_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA738
struct /* @anon7 */ {
    // total size: 0xC
} __vt__46clsSingleton<30clsMapPartsGuardRailCurve_Task>; // size: 0xC, address: 0x6CC258
void * __dt(class clsMapPartsGuardRailCurve_Object *, signed short); // size: 0x0, address: 0x5005B0
struct /* @anon0 */ {
    // total size: 0x48
} __vt__108clsBaseGimmickBody<30clsMapPartsGuardRailCurve_Task,32clsMapPartsGuardRailCurve_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CC270
struct /* @anon3 */ {
    // total size: 0xA8
} __vt__32clsMapPartsGuardRailCurve_Object; // size: 0xA8, address: 0x6CC310
...
void * __ct(class clsMapPartsGuardRailCurve_Object *); // size: 0x0, address: 0x501110
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsMapPartsGuardRailCurve_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsMapPartsGuardRailCurve_Task : public clsSingleModelGimmick_Task {
    // total size: 0x9C
public:
    class hkTransformShape * m_pcTransShape[2]; // offset 0x94, size 0x8
};
class hkArray {
    // total size: 0xC
public:
...
// Range: 0x500630 -> 0x500904
void draw(class clsMapPartsGuardRailCurve_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x500630 -> 0x500904
...
// Range: 0x500A10 -> 0x500A80
void reset(class clsMapPartsGuardRailCurve_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x500A10 -> 0x500A80
        unsigned int u32Num; // r2
...
// Range: 0x500A80 -> 0x500DC0
void * __ct(class clsMapPartsGuardRailCurve_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x500A80 -> 0x500DC0
        class hkVector4 cHalfSize; // r29+0x80
        class hkQuaternion cQuat; // r29+0x70
...
// Range: 0x501150 -> 0x50118C
void createData(class clsMapPartsGuardRailCurve_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x501150 -> 0x50118C
    }
