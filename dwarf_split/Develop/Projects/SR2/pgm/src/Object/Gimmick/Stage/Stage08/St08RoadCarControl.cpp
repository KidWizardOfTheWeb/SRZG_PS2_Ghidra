/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage08\St08RoadCarControl.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class clsPfSystem * m_tpcSingleton; // size: 0x4, address: 0x6E69B8
float t_of32AccleFrame; // size: 0x4, address: 0x695D60
class stcRoadInfo t_astcRoadInfoTbl[]; // size: 0x0, address: 0x695D00
class clsRoad_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A7C0
...
// Range: 0x53B170 -> 0x53B738
void update(class clsRoadCarControl * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53B170 -> 0x53B738
...
// Range: 0x53B7A0 -> 0x53B838
void setState(class clsRoadCarControl * this /* r17 */, enum enmState eState /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53B7A0 -> 0x53B838
    }
...
// Range: 0x53B840 -> 0x53B888
void requestMoveStart(class clsRoadCarControl * this /* r2 */, float f32StartFrame /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53B840 -> 0x53B888
    }
...
// Range: 0x53B890 -> 0x53B8D4
void requestMoveStop(class clsRoadCarControl * this /* r2 */, float f32StartFrame /* r29 */, float f32SlowDownSpeed /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53B890 -> 0x53B8D4
    }
...
// Range: 0x53B8E0 -> 0x53B974
void checkWait(class clsRoadCarControl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53B8E0 -> 0x53B974
...
// Range: 0x53B980 -> 0x53B9C0
void stepPathFrame(class clsRoadCarControl * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53B980 -> 0x53B9C0
    }
...
// Range: 0x53B9C0 -> 0x53BAD4
void reinitPath(class clsRoadCarControl * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53B9C0 -> 0x53BAD4
        class clsGimmickPath & rcGimmickPath; // r16
...
// Range: 0x53BAE0 -> 0x53BB28
void setWait(class clsRoadCarControl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53BAE0 -> 0x53BB28
    }
...
// Range: 0x53BB30 -> 0x53BB98
void reset(class clsRoadCarControl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53BB30 -> 0x53BB98
    }
...
// Range: 0x53BBA0 -> 0x53BC1C
void setInfo(class clsRoadCarControl * this /* r16 */, unsigned char u8RoadNum /* r2 */, float f32BodyHafeSize /* r29+0x20 */, float f32OffsetY /* r29+0x20 */, signed char s8Priority /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53BBA0 -> 0x53BC1C
    }
