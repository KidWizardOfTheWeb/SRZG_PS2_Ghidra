/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage11\St11FogNearManager.cpp
...
// Range: 0x46D4C0 -> 0x46D71C
void execute(class clsFogNearManager_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46D4C0 -> 0x46D71C
        unsigned int u32Num; // r2
        unsigned int u32i; // r21
        class stcNearData * psNearData; // r20
        unsigned int u32FogNo; // r2
    }
}


// Range: 0x46D720 -> 0x46D740
float getDefaultNear(class clsFogNearManager_Task * this /* r2 */, unsigned int u32ViewNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46D720 -> 0x46D740
    }
...
// Range: 0x46D740 -> 0x46D778
void request(class clsFogNearManager_Task * this /* r2 */, unsigned int u32ViewNum /* r2 */, float f32Near /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46D740 -> 0x46D778
        class stcNearData & rsNearData; // r2
    }
}


// Range: 0x46D780 -> 0x46D838
void reset(class clsFogNearManager_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46D780 -> 0x46D838
        unsigned int u32Num; // r2
        unsigned int u32i; // r18
        class stcNearData * psNearData; // r17
    }
}
