/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\PT_Door2.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x680468
struct /* @anon17 */ {
    // total size: 0x48
} __vt__16clsPT_Door2_Task; // size: 0x48, address: 0x6C0B30
struct /* @anon1 */ {
    // total size: 0x48
} __vt__85clsSingleModelGimmick_Task<16clsPT_Door2_Task,15clsPT_Door2_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6B91C0
struct /* @anon4 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPT_Door2_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A810
struct /* @anon7 */ {
    // total size: 0xC
} __vt__32clsSingleton<16clsPT_Door2_Task>; // size: 0xC, address: 0x6B9158
void * __dt(class clsPT_Door2_Obj *, signed short); // size: 0x0, address: 0x2D64E0
struct /* @anon13 */ {
    // total size: 0x48
} __vt__77clsBaseGimmickBody<16clsPT_Door2_Task,15clsPT_Door2_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6B9170
struct /* @anon10 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon14 */ {
    // total size: 0xA8
} __vt__15clsPT_Door2_Obj; // size: 0xA8, address: 0x6C0B80
struct /* @anon11 */ {
    // total size: 0x28
...
class clsPT_Door2_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
class PotentialInfo {
    // total size: 0x1008
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPT_Door2_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x3AA190 -> 0x3AA510
void draw(class clsPT_Door2_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AA190 -> 0x3AA510
...
// Range: 0x3AA670 -> 0x3AA7A0
void execute(class clsPT_Door2_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AA670 -> 0x3AA7A0
...
// Range: 0x3AA7A0 -> 0x3AA800
void reset(class clsPT_Door2_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AA7A0 -> 0x3AA800
        unsigned int u32Num; // r2
...
// Range: 0x3AA800 -> 0x3AA8E4
void callbackCrashEvent(class clsPT_Door2_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AA800 -> 0x3AA8E4
...
// Range: 0x3AA8F0 -> 0x3AA930
void destroyData(class clsPT_Door2_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AA8F0 -> 0x3AA930
    }
...
// Range: 0x3AA930 -> 0x3AAC9C
void createData(class clsPT_Door2_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AA930 -> 0x3AAC9C
...
// Range: 0x3AACA0 -> 0x3AACF4
void setData(class clsPT_Door2_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AACA0 -> 0x3AACF4
    }
...
// Range: 0x3AAD00 -> 0x3AAD7C
void reset(class clsPT_Door2_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AAD00 -> 0x3AAD7C
    }
...
// Range: 0x3AAD80 -> 0x3AAE34
void * __ct(class clsPT_Door2_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AAD80 -> 0x3AAE34
    }
...
// Range: 0x3AAE40 -> 0x3AAE90
void main(class clsPT_Door2_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AAE40 -> 0x3AAE90
    }
