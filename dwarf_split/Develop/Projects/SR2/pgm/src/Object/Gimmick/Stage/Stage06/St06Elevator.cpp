/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage06\St06Elevator.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x689F80
static unsigned char toau8StageToPathNo[2]; // size: 0x2, address: 0x689F88
struct /* @anon14 */ {
    // total size: 0x48
} __vt__16clsElevator_Task; // size: 0x48, address: 0x6C7CA0
struct /* @anon2 */ {
    // total size: 0x48
} __vt__85clsSingleModelGimmick_Task<16clsElevator_Task,15clsElevator_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C7D50
struct /* @anon3 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsElevator_Task * m_tpcSingleton; // size: 0x4, address: 0xB17540
struct /* @anon10 */ {
    // total size: 0xC
} __vt__32clsSingleton<16clsElevator_Task>; // size: 0xC, address: 0x6C7CE8
void * __dt(class clsElevator_Obj *, signed short); // size: 0x0, address: 0x494BE0
struct /* @anon13 */ {
    // total size: 0x48
} __vt__77clsBaseGimmickBody<16clsElevator_Task,15clsElevator_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C7D00
struct /* @anon9 */ {
    // total size: 0x28
...
struct /* @anon8 */ {
    // total size: 0x58
} __vt__15clsElevator_Obj; // size: 0x58, address: 0x6C7DA0
...
void * __ct(class clsElevator_Obj *); // size: 0x0, address: 0x495CA0
...
struct /* @anon5 */ {
    // total size: 0x10
} __vt__11clsElevator; // size: 0x10, address: 0x6C7E00
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x68A000
struct /* @anon17 */ {
    // total size: 0xC
...
void * __dt(class clsElevator *, signed short); // size: 0x0, address: 0x4961C0
void * __ct(class clsElevator *); // size: 0x0, address: 0x496240
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x68A010
...
class clsElevator_Task : public clsSingleModelGimmick_Task {
    // total size: 0x9C
public:
    signed int m_s32SeId; // offset 0x94, size 0x4
    signed int m_s32PlaySeNum; // offset 0x98, size 0x4
};
...
public:
    ...
    class clsElevator_Obj * m_pcElevatorObj; // offset 0x1C8, size 0x4
    ...
    float m_f32InterpolateFrame; // offset 0x1E8, size 0x4
    signed int m_A32InterpolateRot; // offset 0x1EC, size 0x4
};
enum enm {
    NONE = -1,
    CHARA_0 = 0,
...
class clsGimmickAutoRunBuffer : public clsGimmickAutoRunBufferBase {
    // total size: 0x1C
public:
    class clsElevator * m_apcObj; // offset 0xC, size 0x4
    class clsElevator * * m_ppcExecute; // offset 0x10, size 0x4
    class clsElevator * * m_ppcSleep; // offset 0x14, size 0x4
    class clsElevator * * m_ppcExecuteWork; // offset 0x18, size 0x4
};
...
class clsElevator_Obj : public clsPhantomGimmickObject {
    // total size: 0xD0
public:
    enum enmElevatorMode m_eElevatorMode; // offset 0x60, size 0x4
    class hkShape * m_pcPhantomShape; // offset 0x64, size 0x4
    class NNS_VECTORFAST m_sDirPosVecFast; // offset 0x70, size 0x10
    float m_f32MaxSpeed; // offset 0x80, size 0x4
    float m_f32MinSpeed; // offset 0x84, size 0x4
    unsigned int m_u32PlayerFlg; // offset 0x88, size 0x4
    enum enmControlMode m_aeControlMode[8]; // offset 0x8C, size 0x20
    class clsGimmickAutoRunBuffer m_cElevatorBuffer; // offset 0xAC, size 0x1C
};
class clsPathBase {
    // total size: 0x8
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsElevator_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x494D00 -> 0x494F60
void draw(class clsElevator_Task * this /* r30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x494D00 -> 0x494F60
        unsigned int u32Num; // r2
        class clsModelType_OB_TX & rcModel; // r21
...
// Range: 0x494F60 -> 0x4951D0
void draw(class clsElevator * this /* r19 */, class clsModelType_OB_TX & rcModel /* r18 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r22 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int NodeStatus /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x494F60 -> 0x4951D0
    }
...
// Range: 0x4951E0 -> 0x495304
void execute(class clsElevator_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4951E0 -> 0x495304
        unsigned int u32Num; // r2
...
// Range: 0x495310 -> 0x4956D8
void controlPlayer(class clsElevator_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x495310 -> 0x4956D8
        ...
        class clsElevator * pcElevator; // r16
        float f32Length; // r29+0xC0
        class clsGimmickAutoRunBuffer & rcElevatorBuffer; // r20
    }
}


// Range: 0x495700 -> 0x4958A0
void reset(class clsElevator_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x495700 -> 0x4958A0
        unsigned int u32Num; // r2
...
// Range: 0x4958A0 -> 0x495934
void * __ct(class clsElevator_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4958A0 -> 0x495934
    }
...
// Range: 0x495DC0 -> 0x495E34
void destroyData(class clsElevator_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x495DC0 -> 0x495E34
    }
...
// Range: 0x495E40 -> 0x495FE0
void createData(class clsElevator_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x495E40 -> 0x495FE0
...
// Range: 0x495FE0 -> 0x4961A4
void contactTriggerEvent(class clsElevator_Obj * this /* r19 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x495FE0 -> 0x4961A4
...
// Range: 0x4961C0 -> 0x496234
void * __dt(class clsElevator * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4961C0 -> 0x496234
    }
...
// Range: 0x496240 -> 0x496364
void * __ct(class clsElevator * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x496240 -> 0x496364
    }
...
// Range: 0x496920 -> 0x4977F8
void movePlayer(class clsElevator * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x496920 -> 0x4977F8
        class clsPlayerTask * pcPlayerTask; // r17
        class clsGimmickPath & rcGimmickPath; // r16
        class NNS_VECTORFAST sVelocityFast; // r29+0x160
        float f32Level; // r21
        float sMtx[4][4]; // r29+0x120
        class NNS_VECTORFAST sDirVecFast; // r29+0x110
        float * pf32RotY; // r2
        float f32ActionVal; // r20
        float * pf32Dist; // r2
        unsigned char bPlusMinus; // r2
        class NNS_VECTORFAST sStartVecFast; // r29+0x100
        class NNS_VECTORFAST sEndVecFast; // r29+0xF0
        class stcRetRayCast sRetRayCast; // r29+0xC0
        float f32Dist; // r4
        class NNS_VECTORFAST sVelocityFast; // r29+0xB0
        float f32Rad; // r29+0x170
        signed int s32Deg; // r2
...
// Range: 0x497930 -> 0x497938
void @80@__dt__15clsElevator_ObjFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x497930 -> 0x497938
    }
...
// Range: 0x497940 -> 0x497948
void @104@__dt__85clsSingleModelGimmick_Task<16clsElevator_Task,15clsElevator_Obj,18clsModelType_OB_TX>Fv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x497940 -> 0x497948
    }
...
// Range: 0x497950 -> 0x497958
void @104@__dt__77clsBaseGimmickBody<16clsElevator_Task,15clsElevator_Obj,18clsModelType_OB_TX>Fv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x497950 -> 0x497958
    }
...
// Range: 0x497960 -> 0x497968
void @104@__dt__16clsElevator_TaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x497960 -> 0x497968
    }
