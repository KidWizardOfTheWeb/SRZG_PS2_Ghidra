/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Control\DebriParts.cpp
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x6803B0
...
// Range: 0x3A6790 -> 0x3A696C
void startBreak(class clsDebriParts * this /* r17 */, class NNS_VECTORFAST * psPosVecFast /* r2 */, class NNS_VECTORFAST * psVelocityVecFast /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A6790 -> 0x3A696C
    }
...
// Range: 0x3A6970 -> 0x3A6CC8
void drawAlpha(class clsDebriParts * this /* r21 */, class NNS_OBJECT * psObject /* r20 */, float f32ClipSqDist /* r20 */, class NNS_VECTOR * psScaleVec /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A6970 -> 0x3A6CC8
        float sMtx[4][4]; // r29+0xE0
        class NNS_NODE & rsNode; // r2
        unsigned int fType; // r2
    }
}


// Range: 0x3A6CD0 -> 0x3A6FA8
void drawAlpha(class clsDebriParts * this /* r16 */, class NNS_OBJECT * psObject /* r21 */, float f32ClipSqDist /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A6CD0 -> 0x3A6FA8
        float sMtx[4][4]; // r29+0xE0
        signed int s32NodeNo; // r2
        class NNS_NODE & rsNode; // r2
        unsigned int fType; // r2
    }
}
...
// Range: 0x3A6FB0 -> 0x3A72E4
void drawLocalRotate(class clsDebriParts * this /* r17 */, class NNS_OBJECT * psObject /* r16 */, float f32ClipSqDist /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A6FB0 -> 0x3A72E4
        ...
        float sTrsMtx[4][4]; // r29+0x100
        float sInvMtx[4][4]; // r29+0xC0
    }
}


// Range: 0x3A72F0 -> 0x3A75E8
void draw(class clsDebriParts * this /* r17 */, class NNS_OBJECT * psObject /* r16 */, float f32ClipSqDist /* r20 */, class NNS_VECTOR * psScaleVec /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A72F0 -> 0x3A75E8
...
// Range: 0x3A75F0 -> 0x3A78CC
void draw(class clsDebriParts * this /* r17 */, class NNS_OBJECT * psObject /* r16 */, float f32ClipSqDist /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A75F0 -> 0x3A78CC
        float sMtx[4][4]; // r29+0xC0
...
// Range: 0x3A78D0 -> 0x3A7A3C
void update(class clsDebriParts * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A78D0 -> 0x3A7A3C
        class NNS_VECTORFAST * psVelocity; // r2
    }
}


// Range: 0x3A7A40 -> 0x3A7A94
void reset(class clsDebriParts * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A7A40 -> 0x3A7A94
    }
