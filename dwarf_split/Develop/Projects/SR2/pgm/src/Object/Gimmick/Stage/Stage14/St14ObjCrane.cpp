/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage14\St14ObjCrane.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class NNS_VECTORFAST toasPointVecFast[6][2]; // size: 0xC0, address: 0x691E00
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x0
float tof32ClipSqDist; // size: 0x4, address: 0x691EC0
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x691ED0
struct /* @anon0 */ {
    // total size: 0x60
} __vt__16clsObjCrane_Task; // size: 0x60, address: 0x6CAAF0
struct /* @anon5 */ {
    // total size: 0x48
} __vt__88clsSingleModelGimmick_Task<16clsObjCrane_Task,18clsObjCrane_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CAC60
struct /* @anon6 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsObjCrane_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA6E0
struct /* @anon14 */ {
    // total size: 0xC
} __vt__32clsSingleton<16clsObjCrane_Task>; // size: 0xC, address: 0x6CAC00
void * __dt(class clsObjCrane_Object *, signed short); // size: 0x0, address: 0x4E9F80
struct /* @anon19 */ {
    // total size: 0x48
} __vt__80clsBaseGimmickBody<16clsObjCrane_Task,18clsObjCrane_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CAC10
struct /* @anon11 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon16 */ {
    // total size: 0xAC
} __vt__18clsObjCrane_Object; // size: 0xAC, address: 0x6CAB50
struct /* @anon12 */ {
    // total size: 0x28
...
void * __ct(class clsObjCrane_Object *); // size: 0x0, address: 0x4EAAA0
...
public:
    ...
    enum enmMoveMode m_eMoveMode; // offset 0xD4, size 0x4
    enum enmMoveDir m_enmMoveDir; // offset 0xD8, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0xDC, size 0x4
    class NNS_VECTORFAST m_sBaseDirVecFast; // offset 0xE0, size 0x10
    float m_f32Speed; // offset 0xF0, size 0x4
    float m_f32DefaultWaitFrame; // offset 0xF4, size 0x4
    float m_f32DefaultMoveFrame; // offset 0xF8, size 0x4
    float m_f32WaitFrame; // offset 0xFC, size 0x4
    signed int m_s32TableNo; // offset 0x100, size 0x4
    unsigned char m_bSeFlag; // offset 0x104, size 0x1
};
struct /* @anon1 */ {
    // total size: 0x44
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsObjCrane_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsObjCrane_Task : public clsMultiShape, public clsSingleModelGimmick_Task {
    // total size: 0xA8
public:
    class hkShape * m_pcPartsShape; // offset 0xA4, size 0x4
};
...
// Range: 0x4EA080 -> 0x4EA23C
void draw(class clsObjCrane_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EA080 -> 0x4EA23C
...
// Range: 0x4EA240 -> 0x4EA608
void execute(class clsObjCrane_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EA240 -> 0x4EA608
        unsigned int u32Num; // r2
...
// Range: 0x4EA630 -> 0x4EA6AC
void reset(class clsObjCrane_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EA630 -> 0x4EA6AC
        unsigned int u32Num; // r2
...
// Range: 0x4EA6B0 -> 0x4EA750
void * __ct(class clsObjCrane_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EA6B0 -> 0x4EA750
    }
...
// Range: 0x4EAB60 -> 0x4EAD1C
class hkShape * getShape(class clsObjCrane_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EAB60 -> 0x4EAD1C
    }
...
// Range: 0x4EAD20 -> 0x4EADA0
void destroyData(class clsObjCrane_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EAD20 -> 0x4EADA0
    }
...
// Range: 0x4EADA0 -> 0x4EB1A0
void createData(class clsObjCrane_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EADA0 -> 0x4EB1A0
...
// Range: 0x4EB1A0 -> 0x4EB1FC
void setData(class clsObjCrane_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EB1A0 -> 0x4EB1FC
    }
...
// Range: 0x4EB200 -> 0x4EB23C
void requestDrawBreakEffect(class clsObjCrane_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EB200 -> 0x4EB23C
    }
...
// Range: 0x4EB240 -> 0x4EB3B4
void main(class clsObjCrane_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EB240 -> 0x4EB3B4
...
// Range: 0x4EB3C0 -> 0x4EB6E0
void reset(class clsObjCrane_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EB3C0 -> 0x4EB6E0
        class clsRigidBody * pcRigidBody; // r16
        class hkVector4 cZero; // r29+0xA0
...
// Range: 0x4EB6E0 -> 0x4EB964
void draw(class clsObjCrane_Object * this /* r17 */, class NNS_OBJECT * psObject /* r16 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r20 */, float (* psMtxWork)[4][4] /* r19 */, unsigned int u32ViewNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EB6E0 -> 0x4EB964
    }
...
// Range: 0x4EB970 -> 0x4EB9B0
void callbackContactTriggerRigidBody(class clsObjCrane_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EB970 -> 0x4EB9B0
    }
...
// Range: 0x4EB9B0 -> 0x4EB9BC
void callbackGravityEvent(class clsObjCrane_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EB9B0 -> 0x4EB9BC
    }
