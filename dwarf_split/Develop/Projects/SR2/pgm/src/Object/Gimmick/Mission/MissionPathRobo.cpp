/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Mission\MissionPathRobo.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class NNS_VECTORFAST tosOffsetVecFast; // size: 0x10, address: 0x6873F0
static class stcParam asRoboLineParam[2]; // size: 0x80, address: 0x636580
static unsigned char chk__asRoboLineParam_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcGimickSubParam asRoboLineAddParam[2]; // size: 0x40, address: 0x636600
static unsigned char chk__asRoboLineAddParam_SizeCheck_[1]; // size: 0x1, address: 0x0
struct /* @anon4 */ {
    // total size: 0x64
} __vt__23clsMissionPathRobo_Task; // size: 0x64, address: 0x6C4180
struct /* @anon14 */ {
    // total size: 0x48
} __vt__99clsSingleModelGimmick_Task<23clsMissionPathRobo_Task,22clsMissionPathRobo_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C4260
class clsOOMainHeap * t_cInstance; // size: 0x4, address: 0xB17268
struct /* @anon8 */ {
    // total size: 0x14
} __vt__16clsMissionTarget; // size: 0x14, address: 0x6BB460
struct /* @anon1 */ {
    // total size: 0x38
...
struct /* @anon24 */ {
    // total size: 0xC
} __vt__39clsSingleton<23clsMissionPathRobo_Task>; // size: 0xC, address: 0x6C41F8
void * __dt(class clsMissionPathRobo_Obj *, signed short); // size: 0x0, address: 0x4357C0
struct /* @anon3 */ {
    // total size: 0x48
} __vt__91clsBaseGimmickBody<23clsMissionPathRobo_Task,22clsMissionPathRobo_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C4210
struct /* @anon9 */ {
    // total size: 0xD8
} __vt__24clsMissionPathTarget_Obj; // size: 0xD8, address: 0x6D17E0
struct /* @anon16 */ {
    // total size: 0x28
...
struct /* @anon10 */ {
    // total size: 0x34
} __vt__27clsMissionPathRoboCollision; // size: 0x34, address: 0x6C4390
struct /* @anon18 */ {
    // total size: 0xDC
} __vt__22clsMissionPathRobo_Obj; // size: 0xDC, address: 0x6C42B0
struct /* @anon13 */ {
    // total size: 0xC
} __vt__20clsMissionTarget_Obj; // size: 0xC, address: 0x6C41E8
struct /* @anon11 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon5 */ {
    // total size: 0xB0
} __vt__21clsPathGravityObj_Obj; // size: 0xB0, address: 0x6C22E0
struct /* @anon2 */ {
    // total size: 0x44
...
void * __ct(class clsMissionPathRobo_Obj *); // size: 0x0, address: 0x436B40
...
float t_of32WeightTypeMiddle; // size: 0x4, address: 0x665198
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x687460
struct /* @anon25 */ {
    // total size: 0xC
...
// Range: 0x435940 -> 0x435ADC
void draw(class clsMissionPathRobo_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x435940 -> 0x435ADC
        ...
        class clsModelType_OB_TX & rcModel; // r18
...
// Range: 0x435AE0 -> 0x435C44
void execute(class clsMissionPathRobo_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x435AE0 -> 0x435C44
        unsigned int u32Num; // r2
...
// Range: 0x435C50 -> 0x435CF4
void reset(class clsMissionPathRobo_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x435C50 -> 0x435CF4
        unsigned int u32Num; // r2
...
// Range: 0x435D00 -> 0x435D34
class NNS_VECTORFAST * getPosVecFastPtr(class clsMissionPathRobo_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x435D00 -> 0x435D34
    }
...
// Range: 0x435D40 -> 0x435D74
signed int getPathPoint(class clsMissionPathRobo_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x435D40 -> 0x435D74
    }
...
// Range: 0x435D80 -> 0x435EB0
void * __ct(class clsMissionPathRobo_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x435D80 -> 0x435EB0
        class hkVector4 cVec; // r29+0x30
        class hkVector4 cHelfBoxSize; // r29+0x20
    }
}


// Range: 0x436210 -> 0x4362A8
void main(class clsMissionPathRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x436210 -> 0x4362A8
    }
...
// Range: 0x4362B0 -> 0x4365C4
void draw(class clsMissionPathRobo_Obj * this /* r19 */, class clsModelType_OB_TX & rcObj /* r18 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r20 */, float (* opaNnViewMtx)[4][4] /* r17 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4362B0 -> 0x4365C4
        class NNS_VECTORFAST sObjVecFast; // r29+0xC0
        class NNS_OBJECT * psObject; // r18
    }
}


// Range: 0x4365D0 -> 0x436634
void destroyData(class clsMissionPathRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4365D0 -> 0x436634
    }
...
// Range: 0x436640 -> 0x436A14
void createData(class clsMissionPathRobo_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x436640 -> 0x436A14
        class clsMissionRace_Task & rcMissionRace_Task; // r2
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0xD0
        class hkMassProperties massProperties; // r29+0x80
        class hkVector4 cOffset; // r29+0x70
        class NNS_VECTOR sPosition; // r29+0x190
    }
}


// Range: 0x436A20 -> 0x436A7C
void reset(class clsMissionPathRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x436A20 -> 0x436A7C
    }
...
// Range: 0x436A80 -> 0x436B34
void init(class clsMissionPathRobo_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x436A80 -> 0x436B34
    }
...
// Range: 0x436B40 -> 0x436C6C
void * __ct(class clsMissionPathRobo_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x436B40 -> 0x436C6C
        signed int s32i; // r19
...
// Range: 0x436DF0 -> 0x436E00
void contactTriggerEvent(class clsMissionPathRoboCollision * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x436DF0 -> 0x436E00
    }
...
// Range: 0x436E00 -> 0x436E74
void setPosRot(class clsMissionPathRoboCollision * this /* r2 */, class NNS_VECTORFAST * psPosVec /* r2 */, class NNS_QUATERNION * psQuat /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x436E00 -> 0x436E74
    }
