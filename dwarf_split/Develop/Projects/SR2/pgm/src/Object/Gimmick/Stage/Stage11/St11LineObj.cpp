/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage11\St11LineObj.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x68A870
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x68A880
struct /* @anon2 */ {
    // total size: 0x48
} __vt__15clsLineObj_Task; // size: 0x48, address: 0x6C8360
struct /* @anon9 */ {
    // total size: 0x48
} __vt__83clsSingleModelGimmick_Task<15clsLineObj_Task,14clsLineObj_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C8410
struct /* @anon18 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsLineObj_Task * m_tpcSingleton; // size: 0x4, address: 0xB17AC0
struct /* @anon1 */ {
    // total size: 0xC
} __vt__31clsSingleton<15clsLineObj_Task>; // size: 0xC, address: 0x6C83A8
void * __dt(class clsLineObj_Obj *, signed short); // size: 0x0, address: 0x4A3BF0
struct /* @anon6 */ {
    // total size: 0x48
} __vt__75clsBaseGimmickBody<15clsLineObj_Task,14clsLineObj_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C83C0
struct /* @anon19 */ {
    // total size: 0xB0
} __vt__21clsPathGravityObj_Obj; // size: 0xB0, address: 0x6C22E0
struct /* @anon5 */ {
    // total size: 0xB0
} __vt__14clsLineObj_Obj; // size: 0xB0, address: 0x6C8460
struct /* @anon13 */ {
    // total size: 0x28
...
void * __ct(class clsLineObj_Obj *); // size: 0x0, address: 0x4A4470
...
class clsLineObj_Obj : public clsPathGravityObj_Obj {
    // total size: 0x230
public:
    float m_f32AliveFrame; // offset 0x220, size 0x4
    float m_f32AliveFrameReset; // offset 0x224, size 0x4
    unsigned int m_u32DrawFlg; // offset 0x228, size 0x4
    unsigned char m_u8Break; // offset 0x22C, size 0x1
};
...
class clsLineObj_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsLineObj_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x4A3CC0 -> 0x4A3E8C
void draw(class clsLineObj_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A3CC0 -> 0x4A3E8C
...
// Range: 0x4A3E90 -> 0x4A3FAC
void execute(class clsLineObj_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A3E90 -> 0x4A3FAC
        unsigned int u32Num; // r2
...
// Range: 0x4A3FB0 -> 0x4A4048
void reset(class clsLineObj_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A3FB0 -> 0x4A4048
        unsigned int u32Num; // r2
...
// Range: 0x4A4050 -> 0x4A4108
void * __ct(class clsLineObj_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A4050 -> 0x4A4108
...
// Range: 0x4A44F0 -> 0x4A482C
void draw(class clsLineObj_Obj * this /* r19 */, class clsModelType_OB_TX & rcObj /* r18 */, float (* psMtxPal)[4][4] /* r20 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r22 */, float (* psMtxWork)[4][4] /* r17 */, unsigned int u32ViewNo /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A44F0 -> 0x4A482C
        float f32Length; // r29+0xFC
        class NNS_OBJECT * psObject; // r16
    }
}


// Range: 0x4A4830 -> 0x4A4838
void callbackGravityEvent(class clsLineObj_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A4830 -> 0x4A4838
    }
...
// Range: 0x4A4840 -> 0x4A492C
void requestDrawBreakEffect(class clsLineObj_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A4840 -> 0x4A492C
    }
...
// Range: 0x4A4930 -> 0x4A496C
void requestDrawContactEffect(class clsLineObj_Obj * this /* r2 */, class hkContactPoint * pcContact /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A4930 -> 0x4A496C
    }
...
// Range: 0x4A4970 -> 0x4A4A4C
void mainGravity(class clsLineObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A4970 -> 0x4A4A4C
    }
...
// Range: 0x4A4A50 -> 0x4A4B2C
void mainCrash(class clsLineObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A4A50 -> 0x4A4B2C
    }
...
// Range: 0x4A4B30 -> 0x4A4B90
void destroyData(class clsLineObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A4B30 -> 0x4A4B90
    }
...
// Range: 0x4A4B90 -> 0x4A4F04
void createData(class clsLineObj_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A4B90 -> 0x4A4F04
...
// Range: 0x4A4F10 -> 0x4A4FE0
void resetRigidBody(class clsLineObj_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A4F10 -> 0x4A4FE0
    }
...
// Range: 0x4A4FE0 -> 0x4A5274
void reset(class clsLineObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A4FE0 -> 0x4A5274
