/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\PathGravityObj.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x683730
struct /* @anon12 */ {
    // total size: 0x48
} __vt__22clsPathGravityObj_Task; // size: 0x48, address: 0x6C21E0
struct /* @anon1 */ {
    // total size: 0x48
} __vt__97clsSingleModelGimmick_Task<22clsPathGravityObj_Task,21clsPathGravityObj_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C2290
struct /* @anon11 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPathGravityObj_Task * m_tpcSingleton; // size: 0x4, address: 0xB16D70
struct /* @anon8 */ {
    // total size: 0xC
} __vt__38clsSingleton<22clsPathGravityObj_Task>; // size: 0xC, address: 0x6C2228
void * __dt(class clsPathGravityObj_Obj *, signed short); // size: 0x0, address: 0x36E0C0
struct /* @anon14 */ {
    // total size: 0x48
} __vt__89clsBaseGimmickBody<22clsPathGravityObj_Task,21clsPathGravityObj_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C2240
struct /* @anon19 */ {
    // total size: 0xA8
...
void * __ct(class clsPathGravityObj_Obj *); // size: 0x0, address: 0x3EDEE0
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x6837A0
...
float t_of32NoRebirthFrame; // size: 0x4, address: 0x680300
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPathGravityObj_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsPathGravityObj_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
class hkPadSpu {
    // total size: 0x4
...
// Range: 0x3ED5C0 -> 0x3ED7A0
void draw(class clsPathGravityObj_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3ED5C0 -> 0x3ED7A0
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        unsigned int u32Num; // r2
        float sMtxWork[4][4]; // r29+0x60
        unsigned int u32i; // r19
    }
}


// Range: 0x3ED7A0 -> 0x3ED9A4
void execute(class clsPathGravityObj_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3ED7A0 -> 0x3ED9A4
        unsigned int u32Num; // r2
...
// Range: 0x3ED9B0 -> 0x3EDA24
void reset(class clsPathGravityObj_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3ED9B0 -> 0x3EDA24
        unsigned int u32Num; // r2
...
// Range: 0x3EDA30 -> 0x3EDB90
void * __ct(class clsPathGravityObj_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EDA30 -> 0x3EDB90
...
// Range: 0x3EE070 -> 0x3EE0D0
void destroyData(class clsPathGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EE070 -> 0x3EE0D0
    }
...
// Range: 0x3EE0D0 -> 0x3EE120
void callbackGravityEvent(class clsPathGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EE0D0 -> 0x3EE120
    }
...
// Range: 0x3EE120 -> 0x3EE1CC
void mainDead(class clsPathGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EE120 -> 0x3EE1CC
    }
...
// Range: 0x3EE1D0 -> 0x3EE1DC
void mainGravity(class clsPathGravityObj_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EE1D0 -> 0x3EE1DC
    }
...
// Range: 0x3EE1E0 -> 0x3EE38C
void main(class clsPathGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EE1E0 -> 0x3EE38C
    }
...
// Range: 0x3EE3A0 -> 0x3EE3A8
void setData(class clsPathGravityObj_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EE3A0 -> 0x3EE3A8
    }
...
// Range: 0x3EE3B0 -> 0x3EE460
void requestDrawBreakEffect(class clsPathGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EE3B0 -> 0x3EE460
...
// Range: 0x3EE460 -> 0x3EE4C8
void blink_wait(class clsPathGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EE460 -> 0x3EE4C8
    }
...
// Range: 0x3EE4D0 -> 0x3EE594
void checkAction(class clsPathGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EE4D0 -> 0x3EE594
    }
...
// Range: 0x3EE5A0 -> 0x3EE5E8
void wait(class clsPathGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EE5A0 -> 0x3EE5E8
    }
...
// Range: 0x3EE5F0 -> 0x3EEA18
void path_main(class clsPathGravityObj_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EE5F0 -> 0x3EEA18
        class clsPath & rcPath; // r18
        class NNS_QUATERNION sOldRotQuat; // r29+0xF0
        class hkQuaternion cRotQuat; // r29+0xE0
        class NNS_VECTORFAST sPosVecFast; // r29+0xD0
        class NNS_VECTORFAST sVelocityVecFast; // r29+0xC0
        class hkVector4 cVelocity; // r29+0xB0
        class NNS_VECTORFAST sVelocityVecFast; // r29+0xA0
        class hkVector4 cVelocity; // r29+0x90
...
// Range: 0x3EEA20 -> 0x3EEC24
void calcPathPostural(class clsPathGravityObj_Obj * this /* r4 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EEA20 -> 0x3EEC24
        float f32RadY; // r29+0xC0
        float f32RadX; // r21
        class NNS_QUATERNION sStartQuat; // r29+0xB0
        class NNS_QUATERNION sEndQuat; // r29+0xA0
        class NNS_QUATERNION sQuatX; // r29+0x90
        class NNS_QUATERNION sQuatY; // r29+0x80
        class NNS_VECTORFAST sDirVecFast; // r29+0x70
        float aTmpMtx[4][4]; // r29+0x30
        class clsPosturalCtrl & rcPostural; // r2
    }
}


// Range: 0x3EEC30 -> 0x3EEC58
void startWait(class clsPathGravityObj_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EEC30 -> 0x3EEC58
    }
...
// Range: 0x3EEC60 -> 0x3EECBC
void timeUpdate(class clsPathGravityObj_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EEC60 -> 0x3EECBC
    }
...
// Range: 0x3EECC0 -> 0x3EEDF0
void resetRigidBody(class clsPathGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EECC0 -> 0x3EEDF0
...
// Range: 0x3EEDF0 -> 0x3EEFF4
void reset(class clsPathGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EEDF0 -> 0x3EEFF4
        class hkVector4 cVelocity; // r29+0x50
...
// Range: 0x3EF000 -> 0x3EF36C
void createData(class clsPathGravityObj_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EF000 -> 0x3EF36C
...
// Range: 0x3EF370 -> 0x3EF590
void initParameter(class clsPathGravityObj_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EF370 -> 0x3EF590
        class NNS_VECTOR * opsScaleVec; // r2
...
// Range: 0x3EF590 -> 0x3EF600
void init(class clsPathGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EF590 -> 0x3EF600
    }
