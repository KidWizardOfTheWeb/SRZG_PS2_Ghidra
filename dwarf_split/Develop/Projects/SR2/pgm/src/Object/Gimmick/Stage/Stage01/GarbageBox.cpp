/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage01\GarbageBox.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x676DB0
struct /* @anon6 */ {
    // total size: 0x48
} __vt__18clsGarbageBox_Task; // size: 0x48, address: 0x6BDB90
struct /* @anon14 */ {
    // total size: 0x48
} __vt__89clsSingleModelGimmick_Task<18clsGarbageBox_Task,17clsGarbageBox_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BDC40
struct /* @anon3 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsGarbageBox_Task * m_tpcSingleton; // size: 0x4, address: 0xB0D9C8
struct /* @anon4 */ {
    // total size: 0xC
} __vt__34clsSingleton<18clsGarbageBox_Task>; // size: 0xC, address: 0x6BDBD8
void * __dt(class clsGarbageBox_Obj *, signed short); // size: 0x0, address: 0x34D800
struct /* @anon9 */ {
    // total size: 0x48
} __vt__81clsBaseGimmickBody<18clsGarbageBox_Task,17clsGarbageBox_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BDBF0
struct /* @anon11 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon1 */ {
    // total size: 0xA8
} __vt__17clsGarbageBox_Obj; // size: 0xA8, address: 0x6BDC90
struct /* @anon12 */ {
    // total size: 0x28
...
void * __ct(class clsGarbageBox_Obj *); // size: 0x0, address: 0x34E030
...
class clsGarbageBox_Obj : public clsRigidBodyGimmickObj {
    // total size: 0xE0
public:
    enum enmBulletinBoardMode m_enBulletinBoardMode; // offset 0xD0, size 0x4
};
...
class clsGarbageBox_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
class GskFlags {
    // total size: 0x4
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsGarbageBox_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x34D900 -> 0x34DADC
void draw(class clsGarbageBox_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34D900 -> 0x34DADC
...
// Range: 0x34DAE0 -> 0x34DBC0
void execute(class clsGarbageBox_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34DAE0 -> 0x34DBC0
        unsigned int u32Num; // r2
...
// Range: 0x34DBC0 -> 0x34DC30
void reset(class clsGarbageBox_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34DBC0 -> 0x34DC30
        unsigned int u32Num; // r2
...
// Range: 0x34DC30 -> 0x34DCD8
void * __ct(class clsGarbageBox_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34DC30 -> 0x34DCD8
    }
...
// Range: 0x34E0F0 -> 0x34E468
void draw(class clsGarbageBox_Obj * this /* r21 */, class clsModelType_OB_TX & rcObj /* r20 */, float (* psMtxPal)[4][4] /* r19 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r23 */, float (* psMtxWork)[4][4] /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34E0F0 -> 0x34E468
...
// Range: 0x34E470 -> 0x34E490
void main(class clsGarbageBox_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34E470 -> 0x34E490
    }
...
// Range: 0x34E490 -> 0x34E500
void reset(class clsGarbageBox_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34E490 -> 0x34E500
    }
...
// Range: 0x34E500 -> 0x34E560
void destroyData(class clsGarbageBox_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34E500 -> 0x34E560
    }
...
// Range: 0x34E560 -> 0x34E8BC
void createData(class clsGarbageBox_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34E560 -> 0x34E8BC
