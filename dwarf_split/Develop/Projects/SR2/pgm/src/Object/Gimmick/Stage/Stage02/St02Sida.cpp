/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage02\St02Sida.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x67E818
static class stcKickerParam tosJumpParam; // size: 0xC, address: 0x67E820
class NNS_VECTORFAST m_tosLeafPosFast; // size: 0x10, address: 0x67E830
struct /* @anon3 */ {
    // total size: 0x48
} __vt__12clsSida_Task; // size: 0x48, address: 0x6BF840
struct /* @anon13 */ {
    // total size: 0x48
} __vt__77clsSingleModelGimmick_Task<12clsSida_Task,11clsSida_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BF8F0
struct /* @anon2 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsSida_Task * m_tpcSingleton; // size: 0x4, address: 0xB15E10
struct /* @anon4 */ {
    // total size: 0xC
} __vt__28clsSingleton<12clsSida_Task>; // size: 0xC, address: 0x6BF888
void * __dt(class clsSida_Obj *, signed short); // size: 0x0, address: 0x383980
struct /* @anon6 */ {
    // total size: 0x48
} __vt__69clsBaseGimmickBody<12clsSida_Task,11clsSida_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BF8A0
struct /* @anon9 */ {
    // total size: 0x28
...
struct /* @anon8 */ {
    // total size: 0x58
} __vt__11clsSida_Obj; // size: 0x58, address: 0x6BF940
...
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x67E860
...
void * __ct(class clsSida_Obj *); // size: 0x0, address: 0x384D00
...
class clsSida_Obj : public clsPhantomGimmickObject {
    // total size: 0x90
public:
    enum enmSidaMode m_eSidaMode; // offset 0x60, size 0x4
    signed int m_A32RotateY; // offset 0x64, size 0x4
    signed int m_A32RotateSpeed; // offset 0x68, size 0x4
    class _stcPlayerData * m_psExecute; // offset 0x6C, size 0x4
    unsigned int m_u32ExecuteNum; // offset 0x70, size 0x4
    unsigned int m_u32ObjectNum; // offset 0x74, size 0x4
    unsigned int m_u32LeafUseFlg; // offset 0x78, size 0x4
    unsigned int m_u32CatchFlg; // offset 0x7C, size 0x4
    class clsPlaySe_2D * m_cPlaySe2d; // offset 0x80, size 0x4
};
...
class clsSida_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsSida_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class stcKickerParam {
    // total size: 0xC
public:
    float f32Speed; // offset 0x0, size 0x4
    float f32Gravity; // offset 0x4, size 0x4
    float f32Jump; // offset 0x8, size 0x4
};
...
class _stcPlayerData {
    // total size: 0x14
public:
    enum enmControlMode eControlMode; // offset 0x0, size 0x4
    signed int A32RotateY; // offset 0x4, size 0x4
    class clsPlayerTask * pcPlayerTask; // offset 0x8, size 0x4
    unsigned int u32LeafNo; // offset 0xC, size 0x4
    float f32FollowFrame; // offset 0x10, size 0x4
};
enum enmStatus {
    STATUS_NULL = 0,
    STATUS_END = 1,
...
// Range: 0x383AF0 -> 0x383D50
void draw(class clsSida_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x383AF0 -> 0x383D50
...
// Range: 0x383D50 -> 0x383E84
void drawDebugLeafCol(class clsSida_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x383D50 -> 0x383E84
        float sMtx[4][4]; // r29+0xD0
        float sRotMtx[4][4]; // r29+0x90
        signed int s32i; // r16
        class NNS_VECTORFAST sColiPosFast; // r29+0x80
...
// Range: 0x383EE0 -> 0x384018
void execute(class clsSida_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x383EE0 -> 0x384018
    }
...
// Range: 0x384020 -> 0x3847C8
void executeCatch(class clsSida_Obj * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x384020 -> 0x3847C8
        unsigned int u32Num; // r2
        unsigned int u32i; // r20
        class _stcPlayerData * psPlayerData; // r19
        class clsPlayerTask * pcPlayerTask; // r18
        float sWorldMtx[4][4]; // r29+0x1C0
        float sRotMtx[4][4]; // r29+0x180
        float sLeafRotMtx[4][4]; // r29+0x140
        signed int A32RotSpeed; // r2
        class NNS_VECTORFAST sLeafPosVecFast; // r29+0x130
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        class NNS_VECTORFAST sDistanceVecFast; // r29+0x120
        class NNS_VECTORFAST sLocalPosVecFast; // r29+0x110
        float f32Rate; // r23
    }
}


// Range: 0x384810 -> 0x384828
void rotation(class clsSida_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x384810 -> 0x384828
    }
...
// Range: 0x384840 -> 0x384890
void init(class clsSida_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x384840 -> 0x384890
    }
...
// Range: 0x384890 -> 0x3848F8
void reset(class clsSida_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x384890 -> 0x3848F8
        unsigned int u32Num; // r2
...
// Range: 0x384900 -> 0x3849A8
void * __ct(class clsSida_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x384900 -> 0x3849A8
    }
...
// Range: 0x384E00 -> 0x3851D4
void contactAlwaysEvent(class clsSida_Obj * this /* r18 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x384E00 -> 0x3851D4
        float sLocalMtx[4][4]; // r29+0x1A0
        float sLeafRotMtx[4][4]; // r29+0x160
        float sWorldMtx[4][4]; // r29+0x120
        float sRotMtx[4][4]; // r29+0xE0
        class NNS_VECTORFAST sLocalPosFast; // r29+0xD0
        signed int s32i; // r17
        class NNS_VECTORFAST sLeafPosFast; // r29+0xC0
        class NNS_VECTORFAST sColiPosFast; // r29+0xB0
        class clsPlayerTask * pcHitPlayer; // r16
        signed int A32Rot; // r2
        float sMtx[4][4]; // r29+0x70
        unsigned int u32LeafUseFlg; // r2
    }
}


// Range: 0x3851E0 -> 0x385280
void destroyData(class clsSida_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3851E0 -> 0x385280
    }
...
// Range: 0x385280 -> 0x385428
void createData(class clsSida_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x385280 -> 0x385428
