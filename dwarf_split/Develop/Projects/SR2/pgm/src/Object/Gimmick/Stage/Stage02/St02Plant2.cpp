/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage02\St02Plant2.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x6804A0
struct /* @anon14 */ {
    // total size: 0x48
} __vt__14clsPlant2_Task; // size: 0x48, address: 0x6C0C30
struct /* @anon2 */ {
    // total size: 0x48
} __vt__81clsSingleModelGimmick_Task<14clsPlant2_Task,13clsPlant2_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C0D90
struct /* @anon6 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPlant2_Task * m_tpcSingleton; // size: 0x4, address: 0xB15F50
struct /* @anon13 */ {
    // total size: 0xC
} __vt__30clsSingleton<14clsPlant2_Task>; // size: 0xC, address: 0x6C0D28
void * __dt(class clsPlant2_Obj *, signed short); // size: 0x0, address: 0x3AB0B0
struct /* @anon16 */ {
    // total size: 0x48
} __vt__73clsBaseGimmickBody<14clsPlant2_Task,13clsPlant2_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C0D40
struct /* @anon11 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon0 */ {
    // total size: 0xA8
} __vt__13clsPlant2_Obj; // size: 0xA8, address: 0x6C0C80
struct /* @anon12 */ {
    // total size: 0x28
...
void * __ct(class clsPlant2_Obj *); // size: 0x0, address: 0x3ABC20
...
class clsPlant2_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPlant2_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x3AB1B0 -> 0x3AB52C
void draw(class clsPlant2_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AB1B0 -> 0x3AB52C
...
// Range: 0x3AB5D0 -> 0x3AB738
void execute(class clsPlant2_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AB5D0 -> 0x3AB738
...
// Range: 0x3AB740 -> 0x3AB7B0
void reset(class clsPlant2_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AB740 -> 0x3AB7B0
        unsigned int u32Num; // r2
...
// Range: 0x3AB7B0 -> 0x3AB818
void reset(class clsPlant2_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AB7B0 -> 0x3AB818
    }
...
// Range: 0x3AB820 -> 0x3AB8C8
void * __ct(class clsPlant2_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AB820 -> 0x3AB8C8
    }
...
// Range: 0x3ABCE0 -> 0x3ABD74
void destroyData(class clsPlant2_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3ABCE0 -> 0x3ABD74
    }
...
// Range: 0x3ABD80 -> 0x3AC3D0
void createData(class clsPlant2_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3ABD80 -> 0x3AC3D0
        ...
        char __FUNCTION__[14]; // @ 0x00680490
    }
}


// Range: 0x3AC3D0 -> 0x3AC424
void setData(class clsPlant2_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AC3D0 -> 0x3AC424
    }
...
// Range: 0x3AC430 -> 0x3AC4E0
void requestDrawBreakEffect(class clsPlant2_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AC430 -> 0x3AC4E0
...
// Range: 0x3AC4E0 -> 0x3AC59C
void main(class clsPlant2_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AC4E0 -> 0x3AC59C
    }
