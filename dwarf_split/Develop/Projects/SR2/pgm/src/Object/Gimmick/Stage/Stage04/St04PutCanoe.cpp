/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage04\St04PutCanoe.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x6874B0
unsigned int otau32Se_CanoeBreak[2]; // size: 0x8, address: 0x6874B8
unsigned int otau32Se_CanoeExp[2]; // size: 0x8, address: 0x6874C0
struct /* @anon4 */ {
    // total size: 0x48
} __vt__16clsPutCanoe_Task; // size: 0x48, address: 0x6C4500
struct /* @anon6 */ {
    // total size: 0x48
} __vt__85clsSingleModelGimmick_Task<16clsPutCanoe_Task,15clsPutCanoe_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C45B0
struct /* @anon7 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPutCanoe_Task * m_tpcSingleton; // size: 0x4, address: 0xB17200
struct /* @anon16 */ {
    // total size: 0xC
} __vt__32clsSingleton<16clsPutCanoe_Task>; // size: 0xC, address: 0x6C4548
void * __dt(class clsPutCanoe_Obj *, signed short); // size: 0x0, address: 0x437DE0
struct /* @anon19 */ {
    // total size: 0x48
} __vt__77clsBaseGimmickBody<16clsPutCanoe_Task,15clsPutCanoe_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C4560
struct /* @anon12 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon5 */ {
    // total size: 0xA8
} __vt__15clsPutCanoe_Obj; // size: 0xA8, address: 0x6C4600
struct /* @anon13 */ {
    // total size: 0x28
...
void * __ct(class clsPutCanoe_Obj *); // size: 0x0, address: 0x438E60
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPutCanoe_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsPutCanoe_Task : public clsSingleModelGimmick_Task {
    // total size: 0x9C
public:
...
// Range: 0x437EE0 -> 0x438754
void draw(class clsPutCanoe_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x437EE0 -> 0x438754
...
// Range: 0x438800 -> 0x438988
void execute(class clsPutCanoe_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x438800 -> 0x438988
...
// Range: 0x438990 -> 0x438A00
void reset(class clsPutCanoe_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x438990 -> 0x438A00
        unsigned int u32Num; // r2
...
// Range: 0x438A00 -> 0x438B10
void * __ct(class clsPutCanoe_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x438A00 -> 0x438B10
        class hkVector4 cBoxHalfSize; // r29+0x40
    }
}


// Range: 0x438F20 -> 0x438F44
...
// Range: 0x438F50 -> 0x438FE4
void destroyData(class clsPutCanoe_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x438F50 -> 0x438FE4
    }
...
// Range: 0x438FF0 -> 0x4395E4
void createData(class clsPutCanoe_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x438FF0 -> 0x4395E4
        ...
        char __FUNCTION__[14]; // @ 0x006874A0
    }
}


// Range: 0x4395F0 -> 0x439640
void setData(class clsPutCanoe_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4395F0 -> 0x439640
    }
...
// Range: 0x439640 -> 0x439698
void requestDrawBreakEffect(class clsPutCanoe_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x439640 -> 0x439698
    }
...
// Range: 0x4396A0 -> 0x43972C
void main(class clsPutCanoe_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4396A0 -> 0x43972C
    }
...
// Range: 0x439730 -> 0x4397AC
void reset(class clsPutCanoe_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x439730 -> 0x4397AC
    }
