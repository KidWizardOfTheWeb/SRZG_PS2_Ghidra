/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\RigidBodyGimmickObj.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class stcInfo oasGroundInfo[4]; // size: 0x40, address: 0x6803C0
...
struct /* @anon2 */ {
    // total size: 0x30
} __vt__25clsMissionBreakMsg2D_Task; // size: 0x30, address: 0x6C0B00
struct /* @anon6 */ {
    // total size: 0x30
...
class clsMissionBreakMsg2D_Task : public clsTask {
    // total size: 0x5C
public:
    class NNS_VECTORFAST * m_psPosVecFast; // offset 0x54, size 0x4
    unsigned int m_u32Count; // offset 0x58, size 0x4
};
...
class hkContactPointProperties : public hkSolverResults, public hkContactPointMaterial {
    // total size: 0x14
public:
    float m_internalDataA; // offset 0x10, size 0x4
};
class /* @class */ {
    // total size: 0x10
public:
...
class hkDynamicsContactMgr : public hkContactMgr {
    // total size: 0x10
public:
    class hkWorld * m_world; // offset 0xC, size 0x4
};
class stcDebugGrind {
    // total size: 0x10
public:
...
public:
    ...
    class hkCollidable * m_collidableB; // offset 0x4, size 0x4
    class hkEntity * m_callbackFiredFrom; // offset 0x8, size 0x4
    class hkProcessCollisionData * m_collisionData; // offset 0xC, size 0x4
    class hkContactPointProperties * m_contactPointProperties[256]; // offset 0x10, size 0x400
    class hkDynamicsContactMgr * m_internalContactMgr; // offset 0x410, size 0x4
};
enum enmStatus {
    STATUS__NONE = 0,
    STATUS__RANGE_IN = 1,
...
class hkSolverResults {
    // total size: 0x8
public:
    float m_impulseApplied; // offset 0x0, size 0x4
    float m_internalSolverData; // offset 0x4, size 0x4
};
class clsOOMainMenu {
    // total size: 0x14
public:
...
// Range: 0x3A8250 -> 0x3A82C8
void drawCollision(class clsRigidBodyGimmickObj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A8250 -> 0x3A82C8
    }
...
// Range: 0x3A82D0 -> 0x3A8418
void checkSetEditorCollision(class clsRigidBodyGimmickObj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A82D0 -> 0x3A8418
        class hkAllCdBodyPairCollector cCollecter; // r29+0x30
    }
}


// Range: 0x3A8420 -> 0x3A848C
void updateSetEditorCollision(class clsRigidBodyGimmickObj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A8420 -> 0x3A848C
    }
...
// Range: 0x3A8490 -> 0x3A8530
void setControlMode(class clsRigidBodyGimmickObj * this /* r2 */, enum enmControlMode eMode /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A8490 -> 0x3A8530
    }
...
// Range: 0x3A8530 -> 0x3A8A20
void boundAction(class clsRigidBodyGimmickObj * this /* r2 */, class clsPlayerTask * pcPlayerTask /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A8530 -> 0x3A8A20
        class clsRigidBody * pcRigidBody; // r16
        class NNS_VECTORFAST sSpeedVecFast; // r29+0x90
        class NNS_VECTORFAST sForceVecFast; // r29+0x80
        class hkVector4 cRot; // r29+0x70
        class hkVector4 cPos; // r29+0x60
        class hkVector4 cZero; // r29+0x50
    }
}


// Range: 0x3A8A20 -> 0x3A8AF4
void contactAlwaysCallback(class clsRigidBodyGimmickObj * this /* r16 */, class hkContactProcessEvent & cEvent /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A8A20 -> 0x3A8AF4
    }
...
// Range: 0x3A8B00 -> 0x3A8C88
void contactTriggerCallback(class clsRigidBodyGimmickObj * this /* r18 */, class hkContactPointConfirmedEvent & cEvent /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A8B00 -> 0x3A8C88
...
// Range: 0x3A8C90 -> 0x3A8F20
void contactTriggerEvent(class clsRigidBodyGimmickObj * this /* r18 */, class hkContactPoint * pcContact /* r17 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A8C90 -> 0x3A8F20
...
// Range: 0x3A8F20 -> 0x3A8F60
void destroyData(class clsRigidBodyGimmickObj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A8F20 -> 0x3A8F60
    }
...
// Range: 0x3A8F80 -> 0x3A90C4
void contactInterraction(class clsRigidBodyGimmickObj * this /* r18 */, class clsRigidBodyGimmickObj * pcObject /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A8F80 -> 0x3A90C4
...
// Range: 0x3A90F0 -> 0x3A923C
void requestDrawContactEffect(class clsRigidBodyGimmickObj * this /* r6 */, class hkContactPoint * pcContact /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A90F0 -> 0x3A923C
        class NNS_VECTOR sContactVec; // r29+0x80
        float sMtx[4][4]; // r29+0x30
        class NNS_VECTOR sVelo; // r29+0x70
        class NNS_VECTOR LOCAL_POS_R; // @ 0x00680430
        class NNS_VECTOR LOCAL_POS; // @ 0x00680420
        class NNS_VECTOR RAND_SP; // @ 0x00680410
        float LIFE_FRAME; // @ 0x00680440
        class NNS_VECTOR BEGIN_SP; // @ 0x00680400
    }
}


// Range: 0x3A9240 -> 0x3A92C4
unsigned char contactGravityActionRangeEvent(class clsRigidBodyGimmickObj * this /* r16 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A9240 -> 0x3A92C4
    }
...
// Range: 0x3A92D0 -> 0x3A9CC8
void execute(class clsRigidBodyGimmickObj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A92D0 -> 0x3A9CC8
        float sTrsMtx[4][4]; // r29+0x50
        class NNS_VECTORFAST sBoundVecFast; // r29+0x40
        class clsPlayerTask * pcPlayer; // r2
        unsigned char b32NotRest; // r6
    }
}


// Range: 0x3A9DC0 -> 0x3A9F98
void reset(class clsRigidBodyGimmickObj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A9DC0 -> 0x3A9F98
        class hkVector4 cZero; // r29+0x70
    }
}


// Range: 0x3A9FA0 -> 0x3AA084
void resetBaseControl(class clsRigidBodyGimmickObj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A9FA0 -> 0x3AA084
    }
