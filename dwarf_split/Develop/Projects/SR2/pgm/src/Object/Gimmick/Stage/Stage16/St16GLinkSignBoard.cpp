/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage16\St16GLinkSignBoard.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x691CA0
float tof32ClipSqDist; // size: 0x4, address: 0x691CB0
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x691CC0
struct /* @anon10 */ {
    // total size: 0x48
} __vt__22clsGLinkSignBoard_Task; // size: 0x48, address: 0x6CA7D0
struct /* @anon21 */ {
    // total size: 0x48
} __vt__95clsMultiModelGimmick_Task<22clsGLinkSignBoard_Task,21clsGLinkSignBoard_Obj,17clsSignBoardModel>; // size: 0x48, address: 0x6CA940
struct /* @anon11 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsGLinkSignBoard_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA6D0
struct /* @anon6 */ {
    // total size: 0xC
} __vt__38clsSingleton<22clsGLinkSignBoard_Task>; // size: 0xC, address: 0x6CA8D8
void * __dt(class clsModelType_OB_TX *, signed short); // size: 0x0, address: 0x1F27F0
void * __dt(class clsGLinkSignBoard_Obj *, signed short); // size: 0x0, address: 0x4E63A0
struct /* @anon14 */ {
    // total size: 0x48
} __vt__88clsBaseGimmickBody<22clsGLinkSignBoard_Task,21clsGLinkSignBoard_Obj,17clsSignBoardModel>; // size: 0x48, address: 0x6CA8F0
struct /* @anon18 */ {
    // total size: 0xB4
} __vt__24clsBaseGravityLinkObject; // size: 0xB4, address: 0x6C1420
struct /* @anon3 */ {
    // total size: 0xB8
} __vt__21clsGLinkSignBoard_Obj; // size: 0xB8, address: 0x6CA820
struct /* @anon15 */ {
    // total size: 0x28
...
void * __ct(class clsGLinkSignBoard_Obj *); // size: 0x0, address: 0x4E6B20
...
public:
    ...
    unsigned char m_bUra; // offset 0xE8, size 0x1
};
...
class clsGLinkSignBoard_Task : public clsMultiModelGimmick_Task {
    // total size: 0x98
};
class clsCamIvBase {
    // total size: 0x4
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsGLinkSignBoard_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsSignBoardModel m_cModel; // offset 0x88, size 0x8
...
// Range: 0x4E6440 -> 0x4E65BC
void draw(class clsGLinkSignBoard_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E6440 -> 0x4E65BC
        ...
        class clsModelType_OB_TX * pcModels; // r23
...
// Range: 0x4E65C0 -> 0x4E66A0
void execute(class clsGLinkSignBoard_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E65C0 -> 0x4E66A0
        unsigned int u32Num; // r2
...
// Range: 0x4E66A0 -> 0x4E6710
void reset(class clsGLinkSignBoard_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E66A0 -> 0x4E6710
        unsigned int u32Num; // r2
...
// Range: 0x4E6710 -> 0x4E67DC
void * __ct(class clsGLinkSignBoard_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E6710 -> 0x4E67DC
...
// Range: 0x4E6B90 -> 0x4E6D3C
void draw(class clsGLinkSignBoard_Obj * this /* r19 */, class clsModelType_OB_TX * apcModel /* r21 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r29+0xA0 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E6B90 -> 0x4E6D3C
...
// Range: 0x4E6D40 -> 0x4E6D60
void main(class clsGLinkSignBoard_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E6D40 -> 0x4E6D60
    }
...
// Range: 0x4E6D60 -> 0x4E6DE0
void destroyData(class clsGLinkSignBoard_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E6D60 -> 0x4E6DE0
    }
...
// Range: 0x4E6DE0 -> 0x4E723C
void createData(class clsGLinkSignBoard_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E6DE0 -> 0x4E723C
...
// Range: 0x4E7240 -> 0x4E7298
void setData(class clsGLinkSignBoard_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E7240 -> 0x4E7298
    }
...
void drawEffect(class clsPlayerTask * pcPlayer /* r16 */) {
    ...
    /* anonymous block */ {
        ...
        class NNS_VECTOR LOCAL_POS_R; // @ 0x00691D68
        class NNS_VECTOR LOCAL_POS; // @ 0x00691D58
        class NNS_VECTOR RAND_SP; // @ 0x00691D48
        float LIFE_FRAME; // @ 0x00691D78
        class NNS_VECTOR BEGIN_SP; // @ 0x00691D38
    }
}


// Range: 0x4E73C0 -> 0x4E7418
void callbackContactTriggerRigidBody(class clsGLinkSignBoard_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E73C0 -> 0x4E7418
    }
...
// Range: 0x4E7420 -> 0x4E744C
void requestDrawBreakEffect(class clsGLinkSignBoard_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E7420 -> 0x4E744C
    }
...
// Range: 0x4E7450 -> 0x4E756C
void reset(class clsGLinkSignBoard_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E7450 -> 0x4E756C
