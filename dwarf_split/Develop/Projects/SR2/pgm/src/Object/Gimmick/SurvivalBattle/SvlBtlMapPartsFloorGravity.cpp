/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\SurvivalBattle\SvlBtlMapPartsFloorGravity.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x6975B0
struct /* @anon3 */ {
    // total size: 0x48
} __vt__34clsSvlBtlMapPartsFloorGravity_Task; // size: 0x48, address: 0x6CF4E0
struct /* @anon11 */ {
    // total size: 0x48
} __vt__124clsSingleModelGimmick_Task<34clsSvlBtlMapPartsFloorGravity_Task,36clsSvlBtlMapPartsFloorGravity_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CF590
struct /* @anon10 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsSvlBtlMapPartsFloorGravity_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA818
struct /* @anon1 */ {
    // total size: 0xC
} __vt__50clsSingleton<34clsSvlBtlMapPartsFloorGravity_Task>; // size: 0xC, address: 0x6CF528
void * __dt(class clsSvlBtlMapPartsFloorGravity_Object *, signed short); // size: 0x0, address: 0x546FD0
struct /* @anon5 */ {
    // total size: 0x48
} __vt__116clsBaseGimmickBody<34clsSvlBtlMapPartsFloorGravity_Task,36clsSvlBtlMapPartsFloorGravity_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CF540
struct /* @anon7 */ {
    // total size: 0xA8
} __vt__30clsMapPartsFloorGravity_Object; // size: 0xA8, address: 0x6CB840
struct /* @anon8 */ {
    // total size: 0xA8
} __vt__36clsSvlBtlMapPartsFloorGravity_Object; // size: 0xA8, address: 0x6CF5E0
...
void * __ct(class clsSvlBtlMapPartsFloorGravity_Object *); // size: 0x0, address: 0x5477E0
...
class clsSvlBtlMapPartsFloorGravity_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsSvlBtlMapPartsFloorGravity_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x547080 -> 0x547234
void draw(class clsSvlBtlMapPartsFloorGravity_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x547080 -> 0x547234
...
// Range: 0x547240 -> 0x547338
void execute(class clsSvlBtlMapPartsFloorGravity_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x547240 -> 0x547338
        unsigned int u32Num; // r2
...
// Range: 0x547340 -> 0x5473B0
void reset(class clsSvlBtlMapPartsFloorGravity_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x547340 -> 0x5473B0
        unsigned int u32Num; // r2
...
// Range: 0x5473B0 -> 0x547480
void * __ct(class clsSvlBtlMapPartsFloorGravity_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5473B0 -> 0x547480
...
// Range: 0x547850 -> 0x5478B4
void contactTriggerEvent(class clsSvlBtlMapPartsFloorGravity_Object * this /* r17 */, class hkContactPoint * pcContact /* r2 */, class clsObject * pcObject /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x547850 -> 0x5478B4
    }
...
// Range: 0x5478C0 -> 0x547AA0
void createData(class clsSvlBtlMapPartsFloorGravity_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5478C0 -> 0x547AA0
    }
...
// Range: 0x547AA0 -> 0x547AE4
void setData(class clsSvlBtlMapPartsFloorGravity_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x547AA0 -> 0x547AE4
    }
