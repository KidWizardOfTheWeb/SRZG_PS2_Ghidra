/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage01\GLinkTrain\GLinkTrainManager.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned int t_oau32MissionFlg[2]; // size: 0x8, address: 0x681448
...
void * __dt(class clsGLinkTrain_Object *, signed short); // size: 0x0, address: 0x3B7850
struct /* @anon9 */ {
    // total size: 0xB4
...
void * __ct(class clsGLinkTrain_Object *); // size: 0x0, address: 0x3B9910
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x6814A0
...
// Range: 0x3B7750 -> 0x3B77E0
void drawCollision(class clsGLinkTrainManager_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B7750 -> 0x3B77E0
    }
...
// Range: 0x3B77E0 -> 0x3B77EC
void start(class clsGLinkTrainManager_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B77E0 -> 0x3B77EC
    }
...
// Range: 0x3B77F0 -> 0x3B7850
void destroyData(class clsGLinkTrainManager_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B77F0 -> 0x3B7850
    }
...
// Range: 0x3B78F0 -> 0x3B7CA4
void createData(class clsGLinkTrainManager_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B78F0 -> 0x3B7CA4
        class hkVector4 cBoxHalfSize; // r29+0xC0
        class hkShape * pcShape; // r2
        class NNS_VECTOR sPosVec; // r29+0xE0
        class clsMissionRace_Task * pcMissionRace_Task; // r4
        signed int s32MissionNo; // r6
        class hkVector4 cBoxHalfSize; // r29+0xB0
        class hkShape * pcShape; // r2
        class NNS_VECTOR sPosVec; // r29+0xD0
        float sRotMtx[4][4]; // r29+0x70
        class NNS_VECTORFAST sDirVecFast; // r29+0x60
        class stcSetDataDetail * psSetData; // r16
        float f32Offset; // r20
        signed int i; // r8
        class stcSetDataDetail * psSetData; // r19
        class clsGLinkTrain_Object * pcObject; // r18
        signed int i; // r16
    }
}


// Range: 0x3B7CB0 -> 0x3B7D5C
void setData(class clsGLinkTrainManager_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B7CB0 -> 0x3B7D5C
    }
...
// Range: 0x3B7D60 -> 0x3B7F90
void startGravityAction(class clsGLinkTrainManager_Object * this /* r17 */, class clsPlayerTask * pcPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B7D60 -> 0x3B7F90
        class clsGLinkTrain_Object * pcObject; // r21
        float sMtx[4][4]; // r29+0xC0
        float sInvMtx[4][4]; // r29+0x80
        class NNS_VECTORFAST sLocalVecFast; // r29+0x70
        signed int i; // r19
        unsigned char * pu8Flag; // r20
        unsigned char bStartGravityActionFlag; // r18
    }
}


// Range: 0x3B7F90 -> 0x3B7FE0
void reset(class clsGLinkTrainManager_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B7F90 -> 0x3B7FE0
        class clsGLinkTrain_Object * pcObject; // r17
        signed int i; // r16
    }
}


// Range: 0x3B7FE0 -> 0x3B809C
void draw(class clsGLinkTrainManager_Object * this /* r30 */, class NNS_OBJECT * psObject /* r22 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r20 */, float (* opaNnViewMtx)[4][4] /* r19 */, float (* psMtxWork)[4][4] /* r18 */, unsigned int u32ViewNo /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B7FE0 -> 0x3B809C
        class clsGLinkTrain_Object * pcObject; // r17
...
// Range: 0x3B80A0 -> 0x3B8358
void execute(class clsGLinkTrainManager_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B80A0 -> 0x3B8358
        class clsGLinkTrain_Object * pcObject; // r3
        signed int i; // r2
    }
}


// Range: 0x3B8670 -> 0x3B8678
void @80@__dt__20clsGLinkTrain_ObjectFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B8670 -> 0x3B8678
    }
...
// Range: 0x3B8680 -> 0x3B8688
void @80@__dt__24clsBaseGravityLinkObjectFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B8680 -> 0x3B8688
    }
