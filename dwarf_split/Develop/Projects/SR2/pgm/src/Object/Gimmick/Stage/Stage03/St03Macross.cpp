/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage03\St03Macross.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32CLIP_DISTx2; // size: 0x4, address: 0x681240
float tof32CLIP_DISTx2; // size: 0x4, address: 0x681248
class NNS_VECTORFAST tosPlayerOffsetPosFast; // size: 0x10, address: 0x681250
static class NNS_VECTOR tosPosVec; // size: 0xC, address: 0x681260
static class stcInfoParam tosCraneParam; // size: 0x18, address: 0x681270
static class stcInfoParam tosPlayerParam; // size: 0x18, address: 0x681290
static class stcControlParam tosControlParam; // size: 0x98, address: 0x6812B0
struct /* @anon8 */ {
    // total size: 0x48
} __vt__15clsMacross_Task; // size: 0x48, address: 0x6C10B0
void * __dt(class clsMacross_Obj *, signed short); // size: 0x0, address: 0x3B2FB0
struct /* @anon20 */ {
    // total size: 0x48
} __vt__75clsBaseGimmickBody<15clsMacross_Task,14clsMacross_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C1110
struct /* @anon13 */ {
    // total size: 0x28
...
struct /* @anon2 */ {
    // total size: 0x58
} __vt__14clsMacross_Obj; // size: 0x58, address: 0x6C1160
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x6813D0
...
void * __ct(class clsMacross_Obj *); // size: 0x0, address: 0x3B4560
class clsMacross_Task * m_tpcSingleton; // size: 0x4, address: 0xB16320
struct /* @anon16 */ {
    // total size: 0xC
} __vt__31clsSingleton<15clsMacross_Task>; // size: 0xC, address: 0x6C10F8
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x6813C0
void * __dt(class clsMacross *, signed short); // size: 0x0, address: 0x3B5700
struct /* @anon9 */ {
    // total size: 0xC
...
struct /* @anon7 */ {
    // total size: 0x10
} __vt__10clsMacross; // size: 0x10, address: 0x6C1200
void * __ct(class clsMacross *); // size: 0x0, address: 0x3B5850
...
class clsMacross_Obj : public clsPhantomGimmickObject {
    // total size: 0xB0
public:
    enum enmMacrossMode m_eMacrossMode; // offset 0x60, size 0x4
    float m_f32MaxSpeed; // offset 0x64, size 0x4
    float m_f32MinSpeed; // offset 0x68, size 0x4
    unsigned int m_u32PlayerFlg; // offset 0x6C, size 0x4
    class clsGimmickAutoRunBuffer m_cMacrossBuffer; // offset 0x70, size 0x1C
    enum enmControlMode m_aeControlMode[8]; // offset 0x8C, size 0x20
};
...
public:
    ...
    class clsMacross_Obj * m_pcMacrossObj; // offset 0x1C8, size 0x4
    float m_f32CountFrame; // offset 0x1CC, size 0x4
    float m_f32EffectFrame; // offset 0x1D0, size 0x4
    class clsPendulumControl * m_pcPendulumControl; // offset 0x1D4, size 0x4
    class NNS_VECTORFAST m_sOldPosVecFast; // offset 0x1E0, size 0x10
    class NNS_QUATERNION m_sOldRotQuat; // offset 0x1F0, size 0x10
    class NNS_QUATERNION m_sDebugRotQuat; // offset 0x200, size 0x10
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsMacross_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsMacross_Task : public clsBaseGimmickBody {
    // total size: 0xB0
public:
    float * m_pf32TexCoordV; // offset 0x94, size 0x4
    class clsModelType_OB_TX m_cModelCrane; // offset 0x98, size 0x8
    class clsMacrossModels m_cModels; // offset 0xA0, size 0x8
    class clsMacrossThroughCollision m_cThroughCollision; // offset 0xA8, size 0x8
};
class clsCamIvBase {
    // total size: 0x4
};
...
class clsMacrossModels {
    // total size: 0x8
public:
    class clsModelType_OB_TX * m_pcModelLift; // offset 0x0, size 0x4
    class clsModelType_OB_TX * m_pcModelCrane; // offset 0x4, size 0x4
};
class stcFactor {
    // total size: 0x1C
public:
...
class clsGimmickAutoRunBuffer : public clsGimmickAutoRunBufferBase {
    // total size: 0x1C
public:
    class clsMacross * m_apcObj; // offset 0xC, size 0x4
    class clsMacross * * m_ppcExecute; // offset 0x10, size 0x4
    class clsMacross * * m_ppcSleep; // offset 0x14, size 0x4
    class clsMacross * * m_ppcExecuteWork; // offset 0x18, size 0x4
};
class hkEnum {
    // total size: 0x1
public:
...
// Range: 0x3B30D0 -> 0x3B3434
void draw(class clsMacross_Task * this /* r29+0xEC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B30D0 -> 0x3B3434
        unsigned int u32Num; // r2
        unsigned int * psNodeStat; // r21
        unsigned int u32ViewNo; // r22
        float (* opaNnViewMtx)[4][4]; // r23
        float (* psMtxPal)[4][4]; // r20
        class clsMacrossModels & rcModel; // r19
        float sMtx[4][4]; // r29+0x130
        unsigned int u32i; // r29+0xD0
    }
}


// Range: 0x3B3520 -> 0x3B386C
unsigned char draw(class clsMacross * this /* r19 */, class clsMacrossModels & rcModel /* r18 */, float (* psMtxPal)[4][4] /* r17 */, unsigned int * psNodeStat /* r21 */, float (* opaNnViewMtx)[4][4] /* r22 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r20 */, unsigned int NodeStatus /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B3520 -> 0x3B386C
        class clsModelType_OB_TX & rcModelLift; // r2
...
// Range: 0x3B38C0 -> 0x3B3B8C
void execute(class clsMacross_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B38C0 -> 0x3B3B8C
...
// Range: 0x3B3B90 -> 0x3B3E84
void controlPlayer(class clsMacross_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B3B90 -> 0x3B3E84
        class clsPlayerTask * * apcPlayerTask; // r19
        enum enmControlMode * peControlMode; // r18
        class clsPlayerTask * pcPlayer; // r2
        unsigned int u32Num; // r17
        class clsGimmickAutoRunBuffer & rcMacrossBuffer; // r22
        class clsMacross * pcMacross; // r16
    }
}


// Range: 0x3B3ED0 -> 0x3B40F0
void createModel(class clsMacross_Task * this /* r20 */, class stcBinInfo & rsBinInfoI /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B3ED0 -> 0x3B40F0
        unsigned int u32CalcObjNum; // r2
        class clsModelType_OB_TX * pcModelCrane; // r2
    }
}


// Range: 0x3B40F0 -> 0x3B41BC
void reset(class clsMacross_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B40F0 -> 0x3B41BC
        unsigned int u32Num; // r2
...
// Range: 0x3B41C0 -> 0x3B43C8
void * __ct(class clsMacross_Task * this /* r18 */, unsigned int u32ObjectAreaNum /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B41C0 -> 0x3B43C8
    }
...
// Range: 0x3B46C0 -> 0x3B4884
void contactTriggerEvent(class clsMacross_Obj * this /* r19 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B46C0 -> 0x3B4884
        class clsPlayerTask * pcPlayerTask; // r18
...
// Range: 0x3B4890 -> 0x3B48E0
void destroyData(class clsMacross_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B4890 -> 0x3B48E0
    }
...
// Range: 0x3B48E0 -> 0x3B4A28
void createData(class clsMacross_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B48E0 -> 0x3B4A28
...
// Range: 0x3B4A30 -> 0x3B4AB4
void init(class clsMacross_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B4A30 -> 0x3B4AB4
    }
...
// Range: 0x3B4AC0 -> 0x3B4ADC
void contactTriggerEvent(class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B4AC0 -> 0x3B4ADC
    }
...
// Range: 0x3B4AE0 -> 0x3B4BF8
void create(class clsMacrossThroughCollision * this /* r18 */, class NNS_VECTOR & orsPosVec /* r17 */, float f32RotY /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B4AE0 -> 0x3B4BF8
...
// Range: 0x3B4E30 -> 0x3B5694
void movePlayer(class clsMacross * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B4E30 -> 0x3B5694
        class clsPlayerTask * pcPlayerTask; // r16
        class clsGimmickPath & rcGimmickPath; // r19
        class NNS_QUATERNION sLocalRotQuat; // r29+0x1F0
        class NNS_QUATERNION sPathRotQuat; // r29+0x1E0
        float sWorldMtx[4][4]; // r29+0x1A0
        class NNS_QUATERNION sRotQuat; // r29+0x190
        class NNS_VECTORFAST sPosVecFast; // r29+0x180
        class NNS_VECTORFAST sDirVecFast; // r29+0x170
        float sMtx[4][4]; // r29+0x130
        float sRotMtx[4][4]; // r29+0xF0
        class NNS_VECTORFAST sOffsetVecFast; // r29+0xE0
        class NNS_VECTORFAST sDirVecFast; // r29+0xD0
        float sMtx[4][4]; // r29+0x90
        float f32Rad; // r29+0x200
        class NNS_VECTORFAST sPosVecFast; // r29+0x80
        class clsMacross_Obj * pcObj; // r2
        class clsMacross_Obj * pcObj; // r2
    }
}
