/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage07\St07MapPartsFloorKicker.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x692938
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x692940
struct /* @anon0 */ {
    // total size: 0x48
} __vt__27clsMapPartsFloorKicker_Task; // size: 0x48, address: 0x6CB8F0
struct /* @anon4 */ {
    // total size: 0x48
} __vt__110clsSingleModelGimmick_Task<27clsMapPartsFloorKicker_Task,29clsMapPartsFloorKicker_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CB9A0
struct /* @anon2 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsMapPartsFloorKicker_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA720
struct /* @anon7 */ {
    // total size: 0xC
} __vt__43clsSingleton<27clsMapPartsFloorKicker_Task>; // size: 0xC, address: 0x6CB938
void * __dt(class clsMapPartsFloorKicker_Object *, signed short); // size: 0x0, address: 0x4F8750
struct /* @anon1 */ {
    // total size: 0x48
} __vt__102clsBaseGimmickBody<27clsMapPartsFloorKicker_Task,29clsMapPartsFloorKicker_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CB950
struct /* @anon3 */ {
    // total size: 0xA8
} __vt__29clsMapPartsFloorKicker_Object; // size: 0xA8, address: 0x6CB9F0
...
void * __ct(class clsMapPartsFloorKicker_Object *); // size: 0x0, address: 0x4F9040
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsMapPartsFloorKicker_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsMapPartsFloorKicker_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
class stcTimePack {
    // total size: 0x4
...
// Range: 0x4F87D0 -> 0x4F8AA4
void draw(class clsMapPartsFloorKicker_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F87D0 -> 0x4F8AA4
...
// Range: 0x4F8BB0 -> 0x4F8C20
void reset(class clsMapPartsFloorKicker_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F8BB0 -> 0x4F8C20
        unsigned int u32Num; // r2
...
// Range: 0x4F8C20 -> 0x4F8CEC
void * __ct(class clsMapPartsFloorKicker_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F8C20 -> 0x4F8CEC
...
// Range: 0x4F9080 -> 0x4F90C4
void createData(class clsMapPartsFloorKicker_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F9080 -> 0x4F90C4
    }
