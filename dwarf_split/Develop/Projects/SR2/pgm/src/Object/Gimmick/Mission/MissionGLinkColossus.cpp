/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Mission\MissionGLinkColossus.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x699BB8
float tof32ClipSqDist; // size: 0x4, address: 0x699BC8
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x699BD0
struct /* @anon1 */ {
    // total size: 0x48
} __vt__28clsMissionGLinkColossus_Task; // size: 0x48, address: 0x6D1070
struct /* @anon8 */ {
    // total size: 0x48
} __vt__112clsSingleModelGimmick_Task<28clsMissionGLinkColossus_Task,30clsMissionGLinkColossus_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6D11E0
struct /* @anon6 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsMissionGLinkColossus_Task * m_tpcSingleton; // size: 0x4, address: 0xBFB478
struct /* @anon17 */ {
    // total size: 0xC
} __vt__44clsSingleton<28clsMissionGLinkColossus_Task>; // size: 0xC, address: 0x6D1178
void * __dt(class clsMissionGLinkColossus_Object *, signed short); // size: 0x0, address: 0x57AD20
struct /* @anon3 */ {
    // total size: 0x48
} __vt__104clsBaseGimmickBody<28clsMissionGLinkColossus_Task,30clsMissionGLinkColossus_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6D1190
struct /* @anon19 */ {
    // total size: 0xB4
} __vt__24clsBaseGravityLinkObject; // size: 0xB4, address: 0x6C1420
struct /* @anon21 */ {
    // total size: 0xB8
} __vt__30clsMissionGLinkColossus_Object; // size: 0xB8, address: 0x6D10C0
struct /* @anon10 */ {
    // total size: 0x28
...
void * __ct(class clsMissionGLinkColossus_Object *); // size: 0x0, address: 0x57B540
...
public:
    ...
    unsigned int m_u32DrawFlg; // offset 0xE8, size 0x4
};
enum enm {
    NONE = -1,
    CHARA_0 = 0,
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsMissionGLinkColossus_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsMissionGLinkColossus_Task : public clsSingleModelGimmick_Task {
    // total size: 0x98
public:
    class clsGmkBurnLight_Task * m_pcBurnLightTask; // offset 0x94, size 0x4
};
struct /* @anon3 */ {
    // total size: 0x48
};
...
// Range: 0x57ADC0 -> 0x57AFEC
void draw(class clsMissionGLinkColossus_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57ADC0 -> 0x57AFEC
        ...
        float sWorkMtx[4][4]; // r29+0xA0
        class clsGmkBurnLight_Task * pcBurnLightTask; // r2
    }
}


// Range: 0x57AFF0 -> 0x57B118
void execute(class clsMissionGLinkColossus_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57AFF0 -> 0x57B118
        unsigned int u32Num; // r2
...
// Range: 0x57B120 -> 0x57B1EC
void * __ct(class clsMissionGLinkColossus_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57B120 -> 0x57B1EC
...
// Range: 0x57B5B0 -> 0x57B630
void destroyData(class clsMissionGLinkColossus_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57B5B0 -> 0x57B630
    }
...
// Range: 0x57B630 -> 0x57BA48
void createData(class clsMissionGLinkColossus_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57B630 -> 0x57BA48
...
// Range: 0x57BA50 -> 0x57BA6C
void setData(class clsMissionGLinkColossus_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57BA50 -> 0x57BA6C
    }
...
void drawEffect(class clsPlayerTask * pcPlayer /* r16 */) {
    ...
    /* anonymous block */ {
        ...
        class NNS_VECTOR LOCAL_POS_R; // @ 0x00699C78
        class NNS_VECTOR LOCAL_POS; // @ 0x00699C68
        class NNS_VECTOR RAND_SP; // @ 0x00699C58
        float LIFE_FRAME; // @ 0x00699C88
        class NNS_VECTOR BEGIN_SP; // @ 0x00699C48
    }
}


// Range: 0x57BB90 -> 0x57BBE8
void callbackContactTriggerRigidBody(class clsMissionGLinkColossus_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57BB90 -> 0x57BBE8
    }
...
// Range: 0x57BBF0 -> 0x57BBFC
void requestDrawBreakEffect(class clsMissionGLinkColossus_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57BBF0 -> 0x57BBFC
    }
...
// Range: 0x57BC50 -> 0x57BC70
void main(class clsMissionGLinkColossus_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57BC50 -> 0x57BC70
    }
...
// Range: 0x57BC70 -> 0x57BD88
void reset(class clsMissionGLinkColossus_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57BC70 -> 0x57BD88
...
// Range: 0x57BD90 -> 0x57C018
unsigned char draw(class clsMissionGLinkColossus_Object * this /* r17 */, class NNS_OBJECT * psObject /* r16 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r20 */, float (* psMtxWork)[4][4] /* r19 */, unsigned int u32ViewNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x57BD90 -> 0x57C018
    }
