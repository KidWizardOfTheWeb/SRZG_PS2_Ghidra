/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage08\St08RoadCar.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32ClipSqDist; // size: 0x4, address: 0x695D90
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x695DA0
...
struct /* @anon16 */ {
    // total size: 0x48
} __vt__15clsRoadCar_Task; // size: 0x48, address: 0x6CDEA0
struct /* @anon8 */ {
    // total size: 0x48
} __vt__83clsSingleModelGimmick_Task<15clsRoadCar_Task,14clsRoadCar_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CDEF0
void * __dt(class clsRoadCar_Obj *, signed short); // size: 0x0, address: 0x5263D0
struct /* @anon1 */ {
    // total size: 0x48
} __vt__75clsBaseGimmickBody<15clsRoadCar_Task,14clsRoadCar_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CDE50
struct /* @anon14 */ {
    // total size: 0x30
...
struct /* @anon21 */ {
    // total size: 0xF0
} __vt__14clsRoadCar_Obj; // size: 0xF0, address: 0x6CDD50
struct /* @anon12 */ {
    // total size: 0x28
...
class clsRoadCar_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA7A8
struct /* @anon18 */ {
    // total size: 0xC
} __vt__31clsSingleton<15clsRoadCar_Task>; // size: 0xC, address: 0x6CDE40
void * __ct(class clsRoadCar_Obj *); // size: 0x0, address: 0x526870
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x695E20
...
class clsRoadCar_Obj : public clsRoadCarBase_Obj {
    // total size: 0x2C0
public:
    class clsSe3DControl * m_pcSe3DControl; // offset 0x2B0, size 0x4
};
class __vector_imp : private __vector_pod, private compile_assert {
    // total size: 0xC
};
...
class clsRoadCar_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
enum enmDraw2DAttr {
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsRoadCar_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x525E80 -> 0x526008
void draw(class clsRoadCar_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x525E80 -> 0x526008
...
// Range: 0x526010 -> 0x5260F0
void execute(class clsRoadCar_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x526010 -> 0x5260F0
        unsigned int u32Num; // r2
...
// Range: 0x5260F0 -> 0x526160
void reset(class clsRoadCar_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5260F0 -> 0x526160
        unsigned int u32Num; // r2
...
// Range: 0x526160 -> 0x526224
void * __ct(class clsRoadCar_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x526160 -> 0x526224
...
// Range: 0x526BB0 -> 0x526DCC
void draw(class clsRoadCar_Obj * this /* r21 */, class clsModelType_OB_TX & rcObj /* r20 */, float (* psMtxPal)[4][4] /* r16 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r19 */, float (* psMtxWork)[4][4] /* r18 */, unsigned int u32ViewNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x526BB0 -> 0x526DCC
    }
...
// Range: 0x526DD0 -> 0x526E28
void requestDrawContactEffect(class clsRoadCar_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x526DD0 -> 0x526E28
    }
...
// Range: 0x526E30 -> 0x526E88
void requestDrawBreakEffect(class clsRoadCar_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x526E30 -> 0x526E88
    }
...
// Range: 0x526E90 -> 0x526F10
void destroyData(class clsRoadCar_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x526E90 -> 0x526F10
    }
...
// Range: 0x526F10 -> 0x527384
void createData(class clsRoadCar_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x526F10 -> 0x527384
...
// Range: 0x527390 -> 0x5273BC
void reset(class clsRoadCar_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x527390 -> 0x5273BC
    }
...
// Range: 0x5273C0 -> 0x52742C
void init(class clsRoadCar_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5273C0 -> 0x52742C
    }
