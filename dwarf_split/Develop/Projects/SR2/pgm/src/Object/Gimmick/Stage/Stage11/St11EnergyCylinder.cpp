/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage11\St11EnergyCylinder.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32ClipSqDist; // size: 0x4, address: 0x687238
float m_tof32LowPolyDist; // size: 0x4, address: 0x0
class stcThroughColInfo m_toasThroughColInfo[6]; // size: 0xD8, address: 0x687240
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x687320
struct /* @anon1 */ {
    // total size: 0x48
} __vt__22clsEnergyCylinder_Task; // size: 0x48, address: 0x6C3FE0
void * __dt(class clsEnergyCylinder_Obj *, signed short); // size: 0x0, address: 0x432AD0
struct /* @anon9 */ {
    // total size: 0x48
} __vt__94clsBaseGimmickBody<22clsEnergyCylinder_Task,21clsEnergyCylinder_Obj,23clsEnergyCylinderModels>; // size: 0x48, address: 0x6C4040
void * __dt(class clsEnergyThroughCol *, signed short); // size: 0x0, address: 0x432BD0
struct /* @anon16 */ {
    // total size: 0x30
...
struct /* @anon0 */ {
    // total size: 0xA8
} __vt__21clsEnergyCylinder_Obj; // size: 0xA8, address: 0x6C4090
struct /* @anon15 */ {
    // total size: 0x28
...
struct /* @anon11 */ {
    // total size: 0x34
} __vt__19clsEnergyThroughCol; // size: 0x34, address: 0x6C4140
...
void * __ct(class clsEnergyThroughCol *); // size: 0x0, address: 0x434160
void * __ct(class clsEnergyCylinder_Obj *); // size: 0x0, address: 0x434220
class clsEnergyCylinder_Task * m_tpcSingleton; // size: 0x4, address: 0xB171F8
struct /* @anon19 */ {
    // total size: 0xC
} __vt__38clsSingleton<22clsEnergyCylinder_Task>; // size: 0xC, address: 0x6C4028
...
class clsStartGate_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A8A8
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x6873E0
class clsFogNearManager_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A8E8
float m_tof32RequestFrame; // size: 0x4, address: 0x688A98
struct /* @anon5 */ {
    // total size: 0x30
} __vt__20clsFogExplosion_Task; // size: 0x30, address: 0x6C05A0
struct /* @anon3 */ {
    // total size: 0xC
...
class clsEnergyThroughCol : public clsBaseThroughCollision {
    // total size: 0x1C
public:
    class clsOOVector m_vctpcCylinderObj; // offset 0x8, size 0x10
    unsigned char m_u8Rank; // offset 0x18, size 0x1
};
...
class clsEnergyCylinder_Task : public clsBaseGimmickBody {
    // total size: 0x20C
public:
    class clsEnergyThroughCol m_acThroughCol[6]; // offset 0xCC, size 0xA8
    class clsOOVector m_vctLeftHiPolyDrawOn; // offset 0x174, size 0x10
    class clsOOVector m_vctLeftHiPolyDrawOff; // offset 0x184, size 0x10
    class clsOOVector m_vctLeftLowPolyDrawOn; // offset 0x194, size 0x10
    class clsOOVector m_vctLeftLowPolyDrawOff; // offset 0x1A4, size 0x10
    class clsOOVector m_vctRightHiPolyDrawOn; // offset 0x1B4, size 0x10
    class clsOOVector m_vctRightHiPolyDrawOff; // offset 0x1C4, size 0x10
    class clsOOVector m_vctRightLowPolyDrawOn; // offset 0x1D4, size 0x10
    class clsOOVector m_vctRightLowPolyDrawOff; // offset 0x1E4, size 0x10
    class clsOOVector m_vctPolyDraw; // offset 0x1F4, size 0x10
    float * m_pf32LeftTexCoordV; // offset 0x204, size 0x4
    float * m_pf32RightTexCoordV; // offset 0x208, size 0x4
};
class stcDrawCamera {
    // total size: 0x6
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xCC
public:
    class clsEnergyCylinder_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsEnergyCylinderModels m_cModel; // offset 0x88, size 0x40
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0xC8, size 0x4
};
enum enmMode {
    MODE_NONE = 0,
    MODE_CRASH = 1,
...
public:
    ...
    enum enmState m_eState; // offset 0xD4, size 0x4
    float m_f32WaitFrame; // offset 0xD8, size 0x4
    float m_f32MatMotionFrame; // offset 0xDC, size 0x4
    unsigned int m_u32PlayerFlg; // offset 0xE0, size 0x4
    unsigned int m_u32DrawFlg; // offset 0xE4, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0xE8, size 0x4
    float m_f32Frame; // offset 0xEC, size 0x4
    unsigned char m_u8ModelNum; // offset 0xF0, size 0x1
    signed char m_s8Rank; // offset 0xF1, size 0x1
    class clsTask * m_pcSpark; // offset 0xF4, size 0x4
};
class __wrap_iterator {
    // total size: 0x4
public:
    class clsOOVector * * it_; // offset 0x0, size 0x4
};
...
class clsFogNearManager_Task : public clsTask, public clsSingleton {
    // total size: 0x128
public:
    class stcNearData m_sNearData[4]; // offset 0x58, size 0xD0
};
...
class clsStartGate_Task : public clsBaseGimmickBody {
    // total size: 0xD4
};
class NNS_PRIM2D_PC {
    // total size: 0xC
...
class clsStartGate_Obj : public clsGimmickObj {
    // total size: 0xA0
public:
    float m_f32RocketStartRate; // offset 0x50, size 0x4
    unsigned int m_s32EndCnt; // offset 0x54, size 0x4
    float m_f32Scale; // offset 0x58, size 0x4
    float m_f32ScaleOffset; // offset 0x5C, size 0x4
    float m_af32MtnFrame[3]; // offset 0x60, size 0xC
    float m_f32MatMFrame; // offset 0x6C, size 0x4
    float m_f32FrameCounter; // offset 0x70, size 0x4
    unsigned short m_u16StartChk; // offset 0x74, size 0x2
    unsigned char m_u8Hit; // offset 0x76, size 0x1
    unsigned char m_u8MatMLoopFlag; // offset 0x77, size 0x1
    unsigned char m_u8ExecMode; // offset 0x78, size 0x1
    float m_f32ScaleBlitzX; // offset 0x7C, size 0x4
    float m_f32ScaleLineX; // offset 0x80, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0x84, size 0x4
    class clsSeIDControl m_SeIdControl; // offset 0x88, size 0x10
    unsigned char m_bPlayFlg; // offset 0x98, size 0x1
};
...
class stcNearData {
    // total size: 0x34
public:
    enum enmState eState; // offset 0x0, size 0x4
    float f32Near; // offset 0x4, size 0x4
    float f32Far; // offset 0x8, size 0x4
    float f32DefNear; // offset 0xC, size 0x4
    float f32DefFar; // offset 0x10, size 0x4
    float f32r; // offset 0x14, size 0x4
    float f32g; // offset 0x18, size 0x4
    float f32b; // offset 0x1C, size 0x4
    float f32Defr; // offset 0x20, size 0x4
    float f32Defg; // offset 0x24, size 0x4
    float f32Defb; // offset 0x28, size 0x4
    float f32Frame; // offset 0x2C, size 0x4
    unsigned short u16IsRequest; // offset 0x30, size 0x2
    unsigned short u16BackUpFogNo; // offset 0x32, size 0x2
};
class clsPortal {
    // total size: 0x50
public:
...
class clsFogExplosion_Task : public clsTask {
    // total size: 0x90
public:
    class NNS_VECTORFAST m_sPosVecFast; // offset 0x60, size 0x10
    class clsFrameControl m_cFrameControl; // offset 0x70, size 0x8
    float m_f32Light; // offset 0x78, size 0x4
    float m_f32DownK; // offset 0x7C, size 0x4
    unsigned char m_u8PortalType; // offset 0x80, size 0x1
};
class node_base {
    // total size: 0x8
public:
...
class stcThroughColInfo {
    // total size: 0x24
public:
    class NNS_VECTOR sPosVec; // offset 0x0, size 0xC
    class NNS_VECTOR sRotVec; // offset 0xC, size 0xC
    class NNS_VECTOR sScaleVec; // offset 0x18, size 0xC
};
enum enmLevel {
    LV_ERROR = -1,
    LV_BASE = 0,
...
class clsEnergyCylinderModels {
    // total size: 0x40
public:
    class clsModelType_OB_TX m_acModels[8]; // offset 0x0, size 0x40
};
...
class clsSeIDControl {
    // total size: 0x10
public:
    signed short m_as16SfID[4]; // offset 0x4, size 0x8
    unsigned short m_u16PlayFlg; // offset 0xC, size 0x2
};
...
class hkBoxShape : public hkConvexShape {
    // total size: 0x30
public:
    class hkVector4 m_halfExtents; // offset 0x20, size 0x10
};
class hkPadSpu {
    // total size: 0x4
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xD4
public:
    class clsStartGate_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsStartGateModels m_cModel; // offset 0x88, size 0x48
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0xD0, size 0x4
};
...
class __wrap_iterator {
    // total size: 0x4
public:
    class clsEnergyCylinder_Obj * * it_; // offset 0x0, size 0x4
};
class clsSingleton {
    // total size: 0x4
};
...
class clsStartGateModels {
    // total size: 0x48
public:
    class clsModelType_OB_TX_MO_MA m_cGate; // offset 0x0, size 0x20
    class clsModelType_OB_TX_MO_MA m_cBlitz; // offset 0x20, size 0x20
    class clsModelType_OB_TX m_cLine; // offset 0x40, size 0x8
};
...
// Range: 0x432CB0 -> 0x433084
void draw(class clsEnergyCylinder_Task * this /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x432CB0 -> 0x433084
        class __wrap_iterator it'181; // r2
        class __wrap_iterator itEnd'180; // r2
        unsigned int u32Num; // r2
        unsigned int u32ViewNo; // r29+0xC0
        float (* opaNnViewMtx)[4][4]; // r21
        class clsModelType_OB_TX * pcModels; // r2
        unsigned int * psNodeStat; // r20
        float (* psMtxPal)[4][4]; // r19
        float sMtxWork[4][4]; // r29+0xD0
        unsigned int u32i; // r18
        class clsOOVector & vctLowPolyDraw; // r2
        class __wrap_iterator it; // r29+0x13C
        class __wrap_iterator itEnd; // r29+0x138
    }
}


// Range: 0x433170 -> 0x4332B4
void draw(class clsEnergyCylinder_Obj * this /* r21 */, class clsModelType_OB_TX * pcObj /* r2 */, float (* psMtxPal)[4][4] /* r20 */, unsigned int * psNodeStat /* r19 */, float (* opaNnViewMtx)[4][4] /* r18 */, float (* psMtxWork)[4][4] /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x433170 -> 0x4332B4
...
// Range: 0x4333F0 -> 0x433600
void execute(class clsEnergyCylinder_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4333F0 -> 0x433600
        unsigned int u32Num; // r2
        unsigned int u32i; // r18
        float * pf32TexCoordV; // r2
    }
}


// Range: 0x433600 -> 0x433858
void createModel(class clsEnergyCylinder_Task * this /* r2 */, class stcBinInfo & rsBinInfoI /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x433600 -> 0x433858
        unsigned int u32CalcObjNum; // r2
        class clsModelType_OB_TX * pcModel; // r18
        unsigned int u32i; // r17
    }
}


// Range: 0x433860 -> 0x4338D0
void reset(class clsEnergyCylinder_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x433860 -> 0x4338D0
        unsigned int u32Num; // r2
...
// Range: 0x4338D0 -> 0x433B88
void init(class clsEnergyCylinder_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4338D0 -> 0x433B88
        unsigned int u32i; // r20
        class stcThroughColInfo * psColInfo; // r19
        class clsEnergyThroughCol * pcCol; // r18
        class hkShape * pcShape; // r2
        class NNS_QUATERNION sQuat; // r29+0x70
        class hkVector4 cBox; // r29+0x60
    }
}


// Range: 0x433B90 -> 0x433FEC
void * __ct(class clsEnergyCylinder_Task * this /* r18 */, unsigned int u32ObjectAreaNum /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x433B90 -> 0x433FEC
        class hkVector4 cBoxHalfSize; // r29+0x60
        unsigned int u32Reserve; // r16
    }
}


// Range: 0x434370 -> 0x434590
void main(class clsEnergyCylinder_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x434370 -> 0x434590
        float * pf32Frame; // r2
...
// Range: 0x434590 -> 0x4345E0
void callbackContactTriggerRigidBody(class clsEnergyCylinder_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x434590 -> 0x4345E0
    }
...
// Range: 0x4345E0 -> 0x4347E0
void setNear(class clsEnergyCylinder_Obj * this /* r2 */, unsigned int u32Flg /* r21 */, float f32Rate /* r24 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4345E0 -> 0x4347E0
        unsigned int u32Num; // r2
        unsigned int u32i; // r20
        class NNS_VECTORFAST & rsPosVecFast; // r19
        float sMtx[4][4]; // r29+0xF0
        float sInvMtx[4][4]; // r29+0xB0
        class NNS_VECTORFAST sLocalPosVecFast; // r29+0xA0
        class clsFogNearManager_Task * pcFogNearMgr_Task; // r18
        class clsPfCameraMgr * pcCameraMgr; // r2
        float f32Length; // r29+0x130
    }
}


// Range: 0x4347E0 -> 0x434824
void callbackGravityEvent(class clsEnergyCylinder_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4347E0 -> 0x434824
    }
...
// Range: 0x434830 -> 0x434910
void requestDrawBreakEffect(class clsEnergyCylinder_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x434830 -> 0x434910
    }
...
// Range: 0x434910 -> 0x434950
void requestDrawContactEffect(class clsEnergyCylinder_Obj * this /* r16 */, class hkContactPoint * pcContact /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x434910 -> 0x434950
    }
...
// Range: 0x434950 -> 0x4349F0
void destroyData(class clsEnergyCylinder_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x434950 -> 0x4349F0
    }
...
// Range: 0x4349F0 -> 0x434E94
void createData(class clsEnergyCylinder_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4349F0 -> 0x434E94
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0x150
        class NNS_VECTOR & rsRotVec; // r2
        class hkBoxShape * pcBoxShape; // r2
        class hkMassProperties massProperties; // r29+0x100
        class hkVector4 cOffset; // r29+0xF0
        class clsSe3DControl * pcSe3DControl; // r2
    }
}


// Range: 0x434EA0 -> 0x434F1C
void setData(class clsEnergyCylinder_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x434EA0 -> 0x434F1C
    }
...
// Range: 0x434F20 -> 0x434FB0
void reset(class clsEnergyCylinder_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x434F20 -> 0x434FB0
    }
...
// Range: 0x434FB0 -> 0x434FEC
void init(class clsEnergyCylinder_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x434FB0 -> 0x434FEC
...
// Range: 0x434FF0 -> 0x43504C
void contactRemoveEvent(class clsEnergyThroughCol * this /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x434FF0 -> 0x43504C
        class __wrap_iterator it'54; // r2
        class __wrap_iterator itEnd'53; // r3
        class __wrap_iterator it; // r29+0xFFFFFFFC
        class __wrap_iterator itEnd; // r29+0xFFFFFFF8
    }
}


// Range: 0x435050 -> 0x4353E8
void contactAlwaysEvent(class clsEnergyThroughCol * this /* r19 */, class clsPlayerTask * pcPlayer /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x435050 -> 0x4353E8
        class __wrap_iterator it'175; // r2
        class __wrap_iterator itEnd'174; // r20
        class __wrap_iterator it'173; // r2
        class __wrap_iterator itEnd'172; // r3
        float sRotMtx[4][4]; // r29+0x120
        float sInvMtx[4][4]; // r29+0xE0
        class NNS_VECTORFAST sLocalVecFast; // r29+0xD0
        class __wrap_iterator it; // r29+0x16C
        class __wrap_iterator itEnd; // r29+0x168
        signed char s8Rank; // r2
        class __wrap_iterator it; // r29+0x164
        class __wrap_iterator itEnd; // r29+0x160
    }
}
