/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage01\Chair.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x6766D8
struct /* @anon5 */ {
    // total size: 0x48
} __vt__14clsChairA_Task; // size: 0x48, address: 0x6BD5F0
struct /* @anon14 */ {
    // total size: 0x48
} __vt__81clsSingleModelGimmick_Task<14clsChairA_Task,13clsChairA_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BD6A0
struct /* @anon3 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsChairA_Task * m_tpcSingleton; // size: 0x4, address: 0xB0D9A0
struct /* @anon4 */ {
    // total size: 0xC
} __vt__30clsSingleton<14clsChairA_Task>; // size: 0xC, address: 0x6BD638
void * __dt(class clsChairA_Obj *, signed short); // size: 0x0, address: 0x340D90
struct /* @anon7 */ {
    // total size: 0x48
} __vt__73clsBaseGimmickBody<14clsChairA_Task,13clsChairA_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BD650
struct /* @anon11 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon1 */ {
    // total size: 0xA8
} __vt__13clsChairA_Obj; // size: 0xA8, address: 0x6BD6F0
struct /* @anon12 */ {
    // total size: 0x28
...
void * __ct(class clsChairA_Obj *); // size: 0x0, address: 0x3415E0
...
class clsChairA_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsChairA_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x340E90 -> 0x34106C
void draw(class clsChairA_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x340E90 -> 0x34106C
...
// Range: 0x341070 -> 0x341150
void execute(class clsChairA_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x341070 -> 0x341150
        unsigned int u32Num; // r2
...
// Range: 0x341150 -> 0x3411C0
void reset(class clsChairA_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x341150 -> 0x3411C0
        unsigned int u32Num; // r2
...
// Range: 0x3411C0 -> 0x341284
void * __ct(class clsChairA_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3411C0 -> 0x341284
...
// Range: 0x3416A0 -> 0x341A58
void draw(class clsChairA_Obj * this /* r21 */, class clsModelType_OB_TX & rcObj /* r20 */, float (* psMtxPal)[4][4] /* r19 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r30 */, float (* psMtxWork)[4][4] /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3416A0 -> 0x341A58
...
// Range: 0x341A60 -> 0x341AE0
void main(class clsChairA_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x341A60 -> 0x341AE0
    }
...
// Range: 0x341AE0 -> 0x341B50
void reset(class clsChairA_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x341AE0 -> 0x341B50
    }
...
// Range: 0x341B50 -> 0x341B90
void destroyData(class clsChairA_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x341B50 -> 0x341B90
    }
...
// Range: 0x341B90 -> 0x341EEC
void createData(class clsChairA_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x341B90 -> 0x341EEC
