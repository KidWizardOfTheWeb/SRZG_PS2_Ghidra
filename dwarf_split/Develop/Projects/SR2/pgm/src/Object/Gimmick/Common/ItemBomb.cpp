/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\ItemBomb.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class clsModelType_OB_TX_MO_MA t_cModel; // size: 0x20, address: 0xBFB4A0
class clsModelType_OB_TX_MO_MA t_cExpModel; // size: 0x20, address: 0xBFB4D0
float tof32ClipSqDist; // size: 0x4, address: 0x69A3F0
struct /* @anon11 */ {
    // total size: 0xA8
} __vt__15clsItemBomb_Obj; // size: 0xA8, address: 0x6D1380
...
struct /* @anon14 */ {
    // total size: 0x30
} __vt__16clsItemBomb_Task; // size: 0x30, address: 0x6D1430
struct /* @anon13 */ {
    // total size: 0x30
...
float DEFAULT_ACCELE; // size: 0x4, address: 0x669CB0
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x69A440
...
float t_of32WeightTypeHeavy; // size: 0x4, address: 0x6651A8
struct /* @anon10 */ {
    // total size: 0xA8
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x69A450
struct /* @anon17 */ {
    // total size: 0xC
...
class clsItemBomb_Obj : public clsRigidBodyGimmickObj {
    // total size: 0x190
public:
    class clsItemBomb_Task * m_pcTask; // offset 0xD0, size 0x4
    enum enmItemBombMode m_eMode; // offset 0xD4, size 0x4
    unsigned char m_bIsExp; // offset 0xD8, size 0x1
    class hkSimpleShapePhantom * m_pcPhantom; // offset 0xDC, size 0x4
    class clsRetPath m_cRetPath; // offset 0xE0, size 0x20
    class clsPath m_cPath; // offset 0x100, size 0x60
    class clsSe3DControl * m_pcSe3DControl; // offset 0x160, size 0x4
    float m_f32LifeFrame; // offset 0x164, size 0x4
    float m_f32MatFrame; // offset 0x168, size 0x4
    float m_f32MatEndFrame; // offset 0x16C, size 0x4
    float m_f32ExpScale; // offset 0x170, size 0x4
    float m_f32ExpAddScale; // offset 0x174, size 0x4
    signed short m_s16InitPathNo; // offset 0x178, size 0x2
    float m_f32OldDistx2; // offset 0x17C, size 0x4
    unsigned char m_bSearchCourse; // offset 0x180, size 0x1
};
class __vector_imp : private __vector_pod, private compile_assert {
    // total size: 0xC
};
...
class clsItemBomb_Task : public clsTask {
    // total size: 0x58
public:
    class clsItemBomb_Obj * m_pcObj; // offset 0x54, size 0x4
};
class clsFlyAction {
    // total size: 0x1C
public:
...
// Range: 0x5830E0 -> 0x583308
void draw(class clsItemBomb_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5830E0 -> 0x583308
        unsigned int * psNodeStat; // r20
        float (* psMtxPal)[4][4]; // r19
        class clsModelType_OB_TX_MO_MA & rcBombModel; // r18
        class clsModelType_OB_TX_MO_MA & rcExpModel; // r17
        float sMtx[4][4]; // r29+0x80
    }
}


// Range: 0x583310 -> 0x5833F8
void execute(class clsItemBomb_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x583310 -> 0x5833F8
    }
...
// Range: 0x583400 -> 0x583554
void registModel(class stcBinInfo & rsBinInfoI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x583400 -> 0x583554
    }
...
// Range: 0x583560 -> 0x5835E4
void reset(class clsItemBomb_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x583560 -> 0x5835E4
    }
...
// Range: 0x5835F0 -> 0x5836A4
void * __ct(class clsItemBomb_Task * this /* r19 */, class NNS_VECTORFAST * opsPosVecFast /* r18 */, class NNS_QUATERNION * opsRotQuat /* r17 */, float f32LifeFrameI /* r20 */, signed short s16PathNoI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5835F0 -> 0x5836A4
    }
...
// Range: 0x5836B0 -> 0x583918
void draw(class clsItemBomb_Obj * this /* r20 */, class clsModelType_OB_TX_MO_MA & rcModel /* r19 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r23 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5836B0 -> 0x583918
        float f32Scale; // r29+0xE0
        float f32ScaleRate; // r29+0xE0
    }
}


// Range: 0x583920 -> 0x583928
void contactInterraction(class clsItemBomb_Obj * this /* r2 */, class clsRigidBodyGimmickObj * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x583920 -> 0x583928
    }
...
// Range: 0x583930 -> 0x583DD4
void searchObj(class clsItemBomb_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x583930 -> 0x583DD4
        class hkSimpleShapePhantom * pcPhantom; // r16
        class hkVector4 cPos; // r29+0x240
        class hkAllCdBodyPairCollector cCollector; // r29+0x120
        unsigned int u32Num; // r2
        unsigned int u32i; // r19
        class clsRigidBodyGimmickObj * pcObject; // r18
        enum enm eObjPackId; // r2
        class NNS_VECTORFAST sSpeedVecFast; // r29+0x110
        class NNS_VECTORFAST sForceVecFast; // r29+0x100
        class NNS_VECTORFAST sObjPosVecFast; // r29+0xF0
        class NNS_VECTORFAST sLocalObjPosVecFast; // r29+0xE0
        class hkVector4 cRot; // r29+0xD0
...
// Range: 0x583DE0 -> 0x583F70
void CalcNonGravityVelocity(class clsItemBomb_Obj * this /* r17 */, class NNS_VECTORFAST * psDirVec /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x583DE0 -> 0x583F70
        class NNS_VECTORFAST sUpVecFast; // r29+0x80
        class NNS_VECTORFAST sGravityVecFast; // r29+0x70
        class hkVector4 cVelocity; // r29+0x60
    }
}


// Range: 0x583F70 -> 0x5840D0
void CalcGravityVelocity(class clsItemBomb_Obj * this /* r17 */, class NNS_VECTORFAST * psDirVec /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x583F70 -> 0x5840D0
        class hkVector4 cVelocity; // r29+0x60
...
// Range: 0x5840D0 -> 0x5845AC
void updataPath(class clsItemBomb_Obj * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5840D0 -> 0x5845AC
        class clsPathCom & rcPathCom; // r23
        class clsRetPath cRetComPath; // r29+0x130
        class NNS_VECTORFAST sVecBuf; // r29+0x120
        float f32Distx2; // r29+0x150
        unsigned short u16OldTypeAttr; // r2
        unsigned int u32i; // r20
        signed int s32LineNum; // r19
        signed int s32LineNo; // r18
        unsigned char bIsFound; // r17
        signed int s32SearchCnt; // r16
        signed int s32NextNo; // r4
        class clsRetPath cRetNextPath; // r29+0x100
        signed int s32No; // r5
        signed int s32LineNum; // r6
        class NNS_VECTORFAST sDirVec; // r29+0xF0
        class NNS_VECTORFAST sPosVec; // r29+0xE0
        signed int s32LineNo; // r5
        signed int s32No; // r2
...
// Range: 0x5845B0 -> 0x584C14
void main(class clsItemBomb_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5845B0 -> 0x584C14
        class hkVector4 cZero; // r29+0xC0
        class NNS_VECTORFAST sPosVec; // r29+0xB0
        class NNS_VECTORFAST sDirVec; // r29+0xA0
        class NNS_VECTORFAST sPosVecFast; // r29+0x90
        signed int i; // r20
        signed int s32Max; // r2
        class clsPlayerTask * pcPlayer; // r19
        class NNS_VECTORFAST sVecFast; // r29+0x80
        class NNS_QUATERNION sRotQuat; // r29+0x70
    }
}


// Range: 0x584C20 -> 0x584C84
void destroyData(class clsItemBomb_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x584C20 -> 0x584C84
    }
...
// Range: 0x584C90 -> 0x5851BC
void createData(class clsItemBomb_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x584C90 -> 0x5851BC
        class hkTransform cTrans; // r29+0x190
...
// Range: 0x5851C0 -> 0x585248
void reset(class clsItemBomb_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5851C0 -> 0x585248
    }
...
// Range: 0x585250 -> 0x58534C
void * __dt(class clsItemBomb_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x585250 -> 0x58534C
    }
...
// Range: 0x585350 -> 0x58584C
void * __ct(class clsItemBomb_Obj * this /* r17 */, class clsItemBomb_Task * pcTask /* r20 */, class NNS_VECTORFAST * opsPosVecFast /* r16 */, class NNS_QUATERNION * opsRotQuat /* r19 */, float f32LifeFrameI /* r20 */, signed short s16PathNoI /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x585350 -> 0x58584C
        ...
        class NNS_VECTORFAST sDirVec; // r29+0xF0
        class NNS_VECTORFAST sPosVec; // r29+0xE0
        signed int s32LineNum; // r5
        signed int s32LineNo; // r20
        class _LineData * pcosLineData; // r19
        signed int s32No; // r2
        class NNS_VECTORFAST sVecBuf; // r29+0xD0
        float f32Distx2; // r29+0x110
        class NNS_VECTORFAST sDirVecFast; // r29+0xC0
        signed int s32LineNo; // r2
        class NNS_VECTORFAST sUpVecFast; // r29+0xB0
    }
}


// Range: 0x585850 -> 0x5858E8
void * __dt(class clsItemBomb_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x585850 -> 0x5858E8
    }
...
// Range: 0x5858F0 -> 0x5858F8
void @80@__dt__15clsItemBomb_ObjFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5858F0 -> 0x5858F8
    }
