/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\StartGate.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float tof32BonusSpeedTable[10]; // size: 0x28, address: 0x67E1B0
static float tof32BonusAgpTable[10]; // size: 0x28, address: 0x67E1E0
static float tof32BonusRateTable[10]; // size: 0x28, address: 0x67E210
static float CLIP_DISTx2; // size: 0x4, address: 0x67E238
float STGATE_DENKI_HIT_SCALE; // size: 0x4, address: 0x0
float STGATE_LINE_Y_OFFSET; // size: 0x4, address: 0x0
float STGATE_MOVELINE_SPOS; // size: 0x4, address: 0x0
float STGATE_DENKI_SUB_FRAME; // size: 0x4, address: 0x0
class stcStGateFrame t_sStGateFrame[17]; // size: 0x220, address: 0x67E240
float tof32DenkiScaleX[17]; // size: 0x44, address: 0x67E460
float tof32LineScaleX[17]; // size: 0x44, address: 0x67E4B0
class stcStGateSeFrame t_sStGateSeFrame[17]; // size: 0x88, address: 0x67E500
struct /* @anon7 */ {
    // total size: 0x48
} __vt__17clsStartGate_Task; // size: 0x48, address: 0x6BF360
class stcTask sTask; // size: 0x30, address: 0xB0A900
void * __dt(class clsStartGate_Obj *, signed short); // size: 0x0, address: 0x2D8150
struct /* @anon12 */ {
    // total size: 0x48
} __vt__79clsBaseGimmickBody<17clsStartGate_Task,16clsStartGate_Obj,18clsStartGateModels>; // size: 0x48, address: 0x6B8E60
struct /* @anon5 */ {
    // total size: 0x30
...
struct /* @anon8 */ {
    // total size: 0xC
} __vt__14clsSeIDControl; // size: 0xC, address: 0x6B8E38
struct /* @anon1 */ {
    // total size: 0x44
} __vt__16clsStartGate_Obj; // size: 0x44, address: 0x6BF3B0
...
signed int SUPER_SONIC_RATE_START_BONUS; // size: 0x4, address: 0x697BE0
...
struct /* @anon6 */ {
    // total size: 0xC
} __vt__33clsSingleton<17clsStartGate_Task>; // size: 0xC, address: 0x6B8E48
struct /* @anon11 */ {
    // total size: 0xC
...
class stcStGateSeFrame {
    // total size: 0x8
public:
    float f32PlayFrame; // offset 0x0, size 0x4
    unsigned int u32SndId; // offset 0x4, size 0x4
};
enum enmSystemFlag {
...
class stcStGateFrame {
    // total size: 0x20
public:
    float f32CEnd; // offset 0x0, size 0x4
    float f32Wait; // offset 0x4, size 0x4
    float f32Start; // offset 0x8, size 0x4
    float f32End; // offset 0xC, size 0x4
    float f32Loop; // offset 0x10, size 0x4
    float f32EStart; // offset 0x14, size 0x4
    unsigned int u32Stop; // offset 0x18, size 0x4
    float f32EndFrame; // offset 0x1C, size 0x4
};
...
// Range: 0x376A90 -> 0x376FB0
void draw(class clsStartGate_Task * this /* r30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x376A90 -> 0x376FB0
...
// Range: 0x377050 -> 0x377A10
void execute(class clsStartGate_Task * this /* r29+0x10C */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x377050 -> 0x377A10
        unsigned int u32Num; // r2
        unsigned int u32i; // r29+0xF0
    }
}


// Range: 0x377B10 -> 0x377EA4
void createModel(class clsStartGate_Task * this /* r2 */, class stcBinInfo & rsBinInfoI /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x377B10 -> 0x377EA4
...
// Range: 0x377EB0 -> 0x3780A8
void setBonus(class clsPlayerTask * pcPlayer /* r16 */, unsigned int u32RaceMSec /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x377EB0 -> 0x3780A8
...
// Range: 0x3780B0 -> 0x3780F0
void destroyData(class clsStartGate_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3780B0 -> 0x3780F0
    }
...
// Range: 0x3780F0 -> 0x3781AC
void createData(class clsStartGate_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3780F0 -> 0x3781AC
        class stcStGateSeFrame & rsSeData; // r2
    }
}
