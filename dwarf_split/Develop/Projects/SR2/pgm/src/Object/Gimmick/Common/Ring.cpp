/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\Ring.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x67E058
static float tof32LowPolyDist; // size: 0x4, address: 0x67E060
float t_of32ShapeRadius[2]; // size: 0x8, address: 0x67E068
void t_opFollowFuncTbl[2]; // size: 0x0, address: 0x67E070
struct /* @anon11 */ {
    // total size: 0x58
} __vt__17clsRingFollow_Obj; // size: 0x58, address: 0x6BF110
struct /* @anon6 */ {
    // total size: 0x28
...
struct /* @anon9 */ {
    // total size: 0x58
} __vt__11clsRingBase; // size: 0x58, address: 0x6BF250
...
class clsRing_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A8D8
class _NNS_TEXLIST * psTexList_UnionParticle; // size: 0x4, address: 0xB0AF48
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x67E0E0
...
struct /* @anon2 */ {
    // total size: 0x6C
} __vt__16clsRingCrash_Obj; // size: 0x6C, address: 0x6BF170
struct /* @anon1 */ {
    // total size: 0xC
} __vt__23clsHaveGimmickRigidBody; // size: 0xC, address: 0x6BAFB0
struct /* @anon3 */ {
    // total size: 0x6C
} __vt__11clsRing_Obj; // size: 0x6C, address: 0x6BF1E0
struct /* @anon0 */ {
    // total size: 0xC
...
public:
    ...
    float m_f32WaitTimer; // offset 0x54, size 0x4
    enum enmAttr m_eAttr; // offset 0x58, size 0x4
};
...
class clsRing_Task : public clsSingleModelGimmick_Task, public clsGimmickCommon {
    // total size: 0x6AF0
public:
    class clsRingCrash_Obj m_cCrashRing[128]; // offset 0xA0, size 0x3800
    class clsRingFollow_Obj m_cFollowRing[100]; // offset 0x38A0, size 0x3200
    unsigned int m_u32RotCount; // offset 0x6AA0, size 0x4
    class clsOOList m_lpcExecuteRing; // offset 0x6AA4, size 0x14
    class clsOOVector m_tdvctReqDrawBuff; // offset 0x6AB8, size 0x10
    class clsOOVector m_vctDrawRing; // offset 0x6AC8, size 0x10
    unsigned char m_bErrorDrawRing; // offset 0x6AD8, size 0x1
    class hkShape * m_apcShape[2]; // offset 0x6ADC, size 0x8
};
class PotentialInfo {
    // total size: 0x1008
public:
...
public:
    ...
    class clsPlayerTask * m_pcPlayer; // offset 0x64, size 0x4
    class clsRingBase * m_pcParent; // offset 0x68, size 0x4
    signed int m_A32Angle; // offset 0x6C, size 0x4
    signed int m_A32AddAngle; // offset 0x70, size 0x4
    float m_f32Length; // offset 0x74, size 0x4
    float m_f32Height; // offset 0x78, size 0x4
};
class hkPadSpu {
    // total size: 0x4
public:
...
class __wrap_iterator {
    // total size: 0x4
public:
    class clsRingBase * * it_; // offset 0x0, size 0x4
};
class clsLap {
    // total size: 0x40
public:
...
class stcDrawRing {
    // total size: 0x4
public:
    unsigned short u16Index; // offset 0x0, size 0x2
...
public:
    ...
    class stcDrawRing * data_; // offset 0xC, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsRing_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class __wrap_iterator {
    // total size: 0x4
public:
    class stcDrawRing * it_; // offset 0x0, size 0x4
};
class hkSmallArray {
    // total size: 0x8
public:
...
// Range: 0x371C60 -> 0x371D34
void setFollowRing(class clsRing_Task * this /* r2 */, class clsPlayerTask * pcPlayerTask /* r21 */, unsigned char u8Num /* r20 */, enum enmFollowType eFollowType /* r19 */, float f32WaitIntervalFrame /* r21 */, class NNS_VECTORFAST & rsPosVecFast /* r18 */, class clsRingBase * pcRingObj /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x371C60 -> 0x371D34
        class clsRingFollow_Obj * pcRing; // r17
        float f32WaitFrame; // r20
        unsigned int u32i; // r16
    }
}


// Range: 0x371D40 -> 0x37202C
void setCrashRing(class clsRing_Task * this /* r2 */, class clsPlayerTask * pcPlayerTask /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x371D40 -> 0x37202C
        class NNS_QUATERNION * psQuat; // r22
        class clsRingCrash_Obj * pcCrashObj; // r20
        float (* psMtxPal)[4][4]; // r19
        class NNS_VECTORFAST sVecFast; // r29+0x90
        class NNS_VECTORFAST sVecPosition; // r29+0x80
        class clsOORandom * pcOORandom; // r18
        signed int s32RingNum; // r17
        unsigned int u32i; // r16
    }
}


// Range: 0x372030 -> 0x372150
void createDrawRingWork(class clsRing_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x372030 -> 0x372150
        unsigned int u32Num; // r2
        unsigned int u32i; // r19
        class clsOOVector & rtdvctDrawRing; // r18
        class stcDrawRing sDrawRing; // r29+0x6C
    }
}


// Range: 0x372150 -> 0x372598
void draw(class clsRing_Task * this /* r29+0xFC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x372150 -> 0x372598
        class __wrap_iterator it'164; // r2
        class __wrap_iterator itEnd'163; // r29+0xBC
        class __wrap_iterator it'162; // r2
        class __wrap_iterator itEnd'161; // r17
        unsigned int u32ViewNo; // r21
        unsigned int * psNodeStat; // r22
        float (* opaNnViewMtx)[4][4]; // r23
        float (* psMtxPal)[4][4]; // r30
        unsigned int u32RotCount; // r2
        class clsModelType_OB_TX & rcModel; // r20
        float sMtx[4][4]; // r29+0x100
        unsigned int u32i; // r19
        float f32FrameAdd; // r20
        class clsOOVector & rtdvctDrawRing; // r2
        class __wrap_iterator it; // r29+0x14C
        class __wrap_iterator itEnd; // r29+0x148
        class clsBaseStage_Task * pcBaseState_Task; // r2
        unsigned int u32Index; // r18
        unsigned int u32DisableClip; // r2
        class __wrap_iterator it; // r29+0x144
        class __wrap_iterator itEnd; // r29+0x140
    }
}


// Range: 0x3725A0 -> 0x372954
void draw(class clsRing_Obj * this /* r20 */, class clsModelType_OB_TX & rcObj /* r19 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r16 */, float (* opaNnViewMtx)[4][4] /* r22 */, unsigned int u32RotY /* r18 */, float (* psMtxWork)[4][4] /* r17 */, unsigned int u32ViewNo /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3725A0 -> 0x372954
        float f32CamDist; // r29+0x13C
        float sMtx[4][4]; // r29+0xF0
    }
}


// Range: 0x3729C0 -> 0x372BDC
void execute(class clsRing_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3729C0 -> 0x372BDC
        class generic_iterator it'109; // r18
        class clsOOList & rlpcExecuteRing; // r17
        class generic_iterator it; // r29+0xDC
        unsigned char bRet; // r2
    }
}


// Range: 0x372BE0 -> 0x372CC4
void reset(class clsRing_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x372BE0 -> 0x372CC4
        unsigned int u32Num; // r2
...
// Range: 0x372CD0 -> 0x373074
void draw(class clsRingFollow_Obj * this /* r20 */, class clsModelType_OB_TX & rcObj /* r19 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r16 */, float (* opaNnViewMtx)[4][4] /* r22 */, unsigned int u32RotY /* r18 */, float (* psMtxWork)[4][4] /* r17 */, unsigned int u32ViewNo /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x372CD0 -> 0x373074
        float f32CamDist; // r29+0x13C
...
// Range: 0x373080 -> 0x373250
unsigned char execute(class clsRingFollow_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x373080 -> 0x373250
        unsigned char bRet; // r17
    }
}


// Range: 0x373250 -> 0x373390
unsigned char followCircel(class clsRingFollow_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x373250 -> 0x373390
        class NNS_VECTORFAST & rsPosVecFast; // r2
        signed int & rA32Angle; // r2
        float & rf32Length; // r2
    }
}


// Range: 0x373390 -> 0x373428
unsigned char followLine(class clsRingFollow_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x373390 -> 0x373428
...
// Range: 0x373430 -> 0x373628
void regist(class clsRingFollow_Obj * this /* r16 */, class clsPlayerTask * pcPlayer /* r2 */, enum enmFollowType eFollowType /* r17 */, class NNS_VECTORFAST & rcPosVecFast /* r2 */, float f32WaitFrame /* r20 */, class clsRingBase * pcParent /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x373430 -> 0x373628
    }
...
// Range: 0x373630 -> 0x373A50
void draw(class clsRingCrash_Obj * this /* r20 */, class clsModelType_OB_TX & rcObj /* r19 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r16 */, float (* opaNnViewMtx)[4][4] /* r22 */, unsigned int u32RotY /* r18 */, float (* psMtxWork)[4][4] /* r17 */, unsigned int u32ViewNo /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x373630 -> 0x373A50
        float f32CamDist; // r29+0x13C
...
// Range: 0x373AD0 -> 0x373CA4
unsigned char execute(class clsRingCrash_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x373AD0 -> 0x373CA4
    }
...
// Range: 0x373CB0 -> 0x373D4C
void requestFollow(class clsRingCrash_Obj * this /* r18 */, class clsPlayerTask * pcPlayer /* r17 */, enum enmFollowType eFollowType /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x373CB0 -> 0x373D4C
    }
...
// Range: 0x373D50 -> 0x373EAC
void contactAlwaysEvent(class clsRingCrash_Obj * this /* r17 */, class clsObject * clsObject /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x373D50 -> 0x373EAC
    }
...
// Range: 0x373EB0 -> 0x374008
void setCrushParam(class clsRingCrash_Obj * this /* r17 */, class NNS_VECTORFAST & rsPosVecFast /* r16 */, class NNS_QUATERNION & rsRotQuat /* r19 */, class NNS_VECTORFAST & rsVelocityFast /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x373EB0 -> 0x374008
        class hkVector4 cVec; // r29+0x60
        class hkQuaternion cQuat; // r29+0x50
    }
}


// Range: 0x374010 -> 0x3740C0
void setPositionRigid(class clsRingCrash_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x374010 -> 0x3740C0
        float sMtx[4][4]; // r29+0x80
        class NNS_VECTORFAST sPosVecFast; // r29+0x70
        class hkTransform cTransform; // r29+0x30
    }
}


// Range: 0x3740C0 -> 0x374100
void destroyData(class clsRingCrash_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3740C0 -> 0x374100
    }
...
// Range: 0x374100 -> 0x374298
void createData(class clsRingCrash_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x374100 -> 0x374298
...
// Range: 0x3742A0 -> 0x3742F4
void setSleep(class clsRingCrash_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3742A0 -> 0x3742F4
    }
...
// Range: 0x374300 -> 0x3743C0
unsigned char execute(class clsRing_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x374300 -> 0x3743C0
    }
...
// Range: 0x3743C0 -> 0x374430
void requestFollow(class clsRing_Obj * this /* r18 */, class clsPlayerTask * pcPlayer /* r17 */, enum enmFollowType eFollowType /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3743C0 -> 0x374430
    }
...
// Range: 0x374430 -> 0x37458C
void contactAlwaysEvent(class clsRing_Obj * this /* r17 */, class clsObject * pcObject /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x374430 -> 0x37458C
    }
...
// Range: 0x374590 -> 0x374640
void setPositionPhantom(class clsRing_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x374590 -> 0x374640
        float sMtx[4][4]; // r29+0x80
...
// Range: 0x374640 -> 0x374688
void destroyData(class clsRing_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x374640 -> 0x374688
    }
...
// Range: 0x374690 -> 0x37473C
void createData(class clsRing_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x374690 -> 0x37473C
    }
...
// Range: 0x374740 -> 0x37475C
void setSleep(class clsRing_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x374740 -> 0x37475C
    }
...
// Range: 0x374760 -> 0x374850
void reset(class clsRing_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x374760 -> 0x374850
    }
...
// Range: 0x374850 -> 0x3748AC
void wakeup(class clsRingBase * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x374850 -> 0x3748AC
    }
...
// Range: 0x374FA0 -> 0x374FA8
void @96@__dt__11clsRing_ObjFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x374FA0 -> 0x374FA8
    }
...
// Range: 0x374FB0 -> 0x374FB8
void @96@__dt__16clsRingCrash_ObjFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x374FB0 -> 0x374FB8
    }
