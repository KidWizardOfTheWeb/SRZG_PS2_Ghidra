/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\PT_Only.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32ClipDistx2; // size: 0x4, address: 0x686BD0
struct /* @anon1 */ {
    // total size: 0x48
} __vt__15clsPT_Only_Task; // size: 0x48, address: 0x6C3C70
struct /* @anon5 */ {
    // total size: 0x48
} __vt__82clsMultiModelGimmick_Task<15clsPT_Only_Task,14clsPT_Only_Obj,18clsMultiObTxModels>; // size: 0x48, address: 0x6B9270
struct /* @anon6 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPT_Only_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A808
struct /* @anon14 */ {
    // total size: 0xC
} __vt__31clsSingleton<15clsPT_Only_Task>; // size: 0xC, address: 0x6B9208
void * __dt(class clsModelType_OB_TX *, signed short); // size: 0x0, address: 0x1F27F0
void * __dt(class clsPT_Only_Obj *, signed short); // size: 0x0, address: 0x2D5DF0
struct /* @anon17 */ {
    // total size: 0x48
} __vt__75clsBaseGimmickBody<15clsPT_Only_Task,14clsPT_Only_Obj,18clsMultiObTxModels>; // size: 0x48, address: 0x6B9220
struct /* @anon11 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon16 */ {
    // total size: 0xA8
} __vt__14clsPT_Only_Obj; // size: 0xA8, address: 0x6C3CC0
struct /* @anon12 */ {
    // total size: 0x28
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPT_Only_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsPT_Only_Task : public clsMultiModelGimmick_Task {
    // total size: 0x98
};
...
// Range: 0x42CD90 -> 0x42D1B4
void draw(class clsPT_Only_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42CD90 -> 0x42D1B4
...
// Range: 0x42D380 -> 0x42D460
void execute(class clsPT_Only_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42D380 -> 0x42D460
        unsigned int u32Num; // r2
...
// Range: 0x42D460 -> 0x42D4D0
void reset(class clsPT_Only_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42D460 -> 0x42D4D0
        unsigned int u32Num; // r2
...
// Range: 0x42D4D0 -> 0x42D520
void main(class clsPT_Only_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42D4D0 -> 0x42D520
    }
...
// Range: 0x42D520 -> 0x42D5B8
void requestPowerTypeSe(class clsPT_Only_Obj * this /* r16 */, class clsPlayerTask * pcPlayer /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42D520 -> 0x42D5B8
    }
...
// Range: 0x42D5D0 -> 0x42D650
void destroyData(class clsPT_Only_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42D5D0 -> 0x42D650
    }
...
// Range: 0x42D650 -> 0x42DA54
void createData(class clsPT_Only_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42D650 -> 0x42DA54
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0xB0
        class NNS_VECTOR & rsScaleVec; // r2
        class hkVector4 cBox; // r29+0xA0
        class hkMassProperties massProperties; // r29+0x50
    }
}


// Range: 0x42DA60 -> 0x42DAA0
void setData(class clsPT_Only_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42DA60 -> 0x42DAA0
    }
...
// Range: 0x42DAA0 -> 0x42DB04
void reset(class clsPT_Only_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42DAA0 -> 0x42DB04
    }
