/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage14\St14SteelFrame.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x697568
struct /* @anon5 */ {
    // total size: 0x48
} __vt__18clsSteelFrame_Task; // size: 0x48, address: 0x6CF330
struct /* @anon12 */ {
    // total size: 0x48
} __vt__89clsSingleModelGimmick_Task<18clsSteelFrame_Task,17clsSteelFrame_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CF490
struct /* @anon8 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsSteelFrame_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA810
struct /* @anon2 */ {
    // total size: 0xC
} __vt__34clsSingleton<18clsSteelFrame_Task>; // size: 0xC, address: 0x6CF428
void * __dt(class clsSteelFrame_Obj *, signed short); // size: 0x0, address: 0x545840
struct /* @anon7 */ {
    // total size: 0x48
} __vt__81clsBaseGimmickBody<18clsSteelFrame_Task,17clsSteelFrame_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CF440
struct /* @anon15 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon1 */ {
    // total size: 0xA8
} __vt__17clsSteelFrame_Obj; // size: 0xA8, address: 0x6CF380
struct /* @anon14 */ {
    // total size: 0x28
...
void * __ct(class clsSteelFrame_Obj *); // size: 0x0, address: 0x5462D0
...
class clsSteelFrame_Obj : public clsRigidBodyGimmickObj {
    // total size: 0xE0
public:
    enum enmSteelFrameMode m_eSteelFrameMode; // offset 0xD0, size 0x4
};
...
class clsSteelFrame_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
struct /* @anon4 */ {
    // total size: 0x28
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsSteelFrame_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x545940 -> 0x545C20
void draw(class clsSteelFrame_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x545940 -> 0x545C20
...
// Range: 0x545CC0 -> 0x545DD8
void execute(class clsSteelFrame_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x545CC0 -> 0x545DD8
        unsigned int u32Num; // r2
...
// Range: 0x545DE0 -> 0x545E50
void reset(class clsSteelFrame_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x545DE0 -> 0x545E50
        unsigned int u32Num; // r2
...
// Range: 0x545E50 -> 0x545EB8
void reset(class clsSteelFrame_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x545E50 -> 0x545EB8
    }
...
// Range: 0x545EC0 -> 0x545F7C
void * __ct(class clsSteelFrame_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x545EC0 -> 0x545F7C
...
// Range: 0x546390 -> 0x546404
void destroyData(class clsSteelFrame_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x546390 -> 0x546404
    }
...
// Range: 0x546410 -> 0x54683C
void createData(class clsSteelFrame_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x546410 -> 0x54683C
        ...
        char __FUNCTION__[14]; // @ 0x00697558
    }
}


// Range: 0x546840 -> 0x5468B0
void setData(class clsSteelFrame_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x546840 -> 0x5468B0
    }
...
// Range: 0x5468B0 -> 0x5468F4
void requestDrawCrashEffect(class clsSteelFrame_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5468B0 -> 0x5468F4
        class clsPlayerTask * copcPlayer; // r2
    }
}


// Range: 0x546900 -> 0x5469BC
void main(class clsSteelFrame_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x546900 -> 0x5469BC
    }
