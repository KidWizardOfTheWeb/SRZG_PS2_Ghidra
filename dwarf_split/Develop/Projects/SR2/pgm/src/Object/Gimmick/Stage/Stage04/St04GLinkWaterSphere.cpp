/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage04\St04GLinkWaterSphere.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x685020
float tof32ClipSqDist; // size: 0x4, address: 0x685030
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x685040
struct /* @anon18 */ {
    // total size: 0x48
} __vt__24clsGLinkWaterSphere_Task; // size: 0x48, address: 0x6C2C30
struct /* @anon2 */ {
    // total size: 0x48
} __vt__110clsSingleModelGimmick_Task<24clsGLinkWaterSphere_Task,26clsGLinkWaterSphere_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C2DA0
struct /* @anon11 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsGLinkWaterSphere_Task * m_tpcSingleton; // size: 0x4, address: 0xB16DD8
struct /* @anon10 */ {
    // total size: 0xC
} __vt__40clsSingleton<24clsGLinkWaterSphere_Task>; // size: 0xC, address: 0x6C2D38
void * __dt(class clsGLinkWaterSphere_Object *, signed short); // size: 0x0, address: 0x4065D0
struct /* @anon17 */ {
    // total size: 0x48
} __vt__102clsBaseGimmickBody<24clsGLinkWaterSphere_Task,26clsGLinkWaterSphere_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C2D50
struct /* @anon19 */ {
    // total size: 0xB4
} __vt__24clsBaseGravityLinkObject; // size: 0xB4, address: 0x6C1420
struct /* @anon6 */ {
    // total size: 0xB8
} __vt__26clsGLinkWaterSphere_Object; // size: 0xB8, address: 0x6C2C80
struct /* @anon13 */ {
    // total size: 0x28
...
void * __ct(class clsGLinkWaterSphere_Object *); // size: 0x0, address: 0x406D90
...
class clsGLinkWaterSphere_Task : public clsSingleModelGimmick_Task {
    // total size: 0xB0
public:
    class hkShape * m_pcPartsShape; // offset 0xAC, size 0x4
};
class NNS_NODE {
    // total size: 0x90
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsGLinkWaterSphere_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsGLinkWaterSphere_Object : public clsBaseGravityLinkObject {
    // total size: 0x110
public:
    class NNS_OBJECT * m_psMorphObject; // offset 0xE0, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0xE4, size 0x4
    enum enmMode m_eMode; // offset 0xE8, size 0x4
    float m_f32MatFrame; // offset 0xEC, size 0x4
    float m_f32MorphFrame; // offset 0xF0, size 0x4
    float m_f32Scale; // offset 0xF4, size 0x4
    float m_f32EffectFrame; // offset 0xF8, size 0x4
    unsigned char m_bMorphMotion; // offset 0xFC, size 0x1
    unsigned char m_bCliping; // offset 0xFD, size 0x1
    float m_f32Depth; // offset 0x100, size 0x4
    float m_f32Width; // offset 0x104, size 0x4
    float m_f32DiveRad; // offset 0x108, size 0x4
};
class hkPadSpu {
    // total size: 0x4
public:
...
// Range: 0x406670 -> 0x4066E0
void reset(class clsGLinkWaterSphere_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x406670 -> 0x4066E0
...
// Range: 0x4066E0 -> 0x406870
void draw(class clsGLinkWaterSphere_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4066E0 -> 0x406870
...
// Range: 0x406870 -> 0x406950
void execute(class clsGLinkWaterSphere_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x406870 -> 0x406950
        unsigned int u32Num; // r2
...
// Range: 0x406950 -> 0x406A1C
void * __ct(class clsGLinkWaterSphere_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x406950 -> 0x406A1C
...
// Range: 0x406E30 -> 0x406EC8
void destroyData(class clsGLinkWaterSphere_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x406E30 -> 0x406EC8
    }
...
// Range: 0x406ED0 -> 0x4072F0
void createData(class clsGLinkWaterSphere_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x406ED0 -> 0x4072F0
...
// Range: 0x407310 -> 0x407370
void callbackContactTriggerRigidBody(class clsGLinkWaterSphere_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x407310 -> 0x407370
    }
...
// Range: 0x407370 -> 0x40737C
void requestDrawBreakEffect(class clsGLinkWaterSphere_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x407370 -> 0x40737C
    }
...
// Range: 0x407380 -> 0x4073E4
void mainCrash(class clsGLinkWaterSphere_Object * this /* r4 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x407380 -> 0x4073E4
    }
...
// Range: 0x4073F0 -> 0x4075B4
void mainGravity(class clsGLinkWaterSphere_Object * this /* r4 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4073F0 -> 0x4075B4
    }
...
// Range: 0x4075C0 -> 0x407710
void main(class clsGLinkWaterSphere_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4075C0 -> 0x407710
    }
...
// Range: 0x407710 -> 0x40784C
void reset(class clsGLinkWaterSphere_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x407710 -> 0x40784C
...
// Range: 0x407850 -> 0x407A9C
void draw(class clsGLinkWaterSphere_Object * this /* r19 */, class clsModelType_OB_TX_MO_MA & rcModel /* r18 */, float (* psMtxPal)[4][4] /* r17 */, unsigned int * psNodeStat /* r22 */, float (* opaNnViewMtx)[4][4] /* r23 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x407850 -> 0x407A9C
    }
