/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage11\st11SecurityRobo.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x689598
static class stcParam asRoboBallLineParam[2]; // size: 0x80, address: 0x636E10
static unsigned char chk__asRoboBallLineParam_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParam asRoboStandLineParam[2]; // size: 0x80, address: 0x636E90
static unsigned char chk__asRoboStandLineParam_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcGimickSubParam asRoboLineSubParam[2]; // size: 0x40, address: 0x636F10
static unsigned char chk__asRoboLineSubParam_SizeCheck_[1]; // size: 0x1, address: 0x0
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x6895A0
struct /* @anon3 */ {
    // total size: 0xA8
} __vt__23clsPathSecurityRobo_Obj; // size: 0xA8, address: 0x6C78F0
...
class clsSecurityRoboManager_Task * m_tpcSingleton; // size: 0x4, address: 0xB17508
...
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x689680
struct /* @anon0 */ {
    // total size: 0xC
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x6896C0
struct /* @anon12 */ {
    // total size: 0x2C
...
class clsPathSecurityRobo_Obj : public clsRigidBodyGimmickObj {
    // total size: 0x310
public:
    enum enmPathSecurityRoboMode m_eProductionRoboMode; // offset 0xD0, size 0x4
    enum enmAiMode m_eAiMode; // offset 0xD4, size 0x4
    enum enmMotionMode m_eMotionMode; // offset 0xD8, size 0x4
    class clsGimmickPath m_cGimmickPath; // offset 0xE0, size 0x190
    class NNS_VECTORFAST m_sStopPosVecFast; // offset 0x270, size 0x10
    class NNS_VECTORFAST m_sVelocityFast; // offset 0x280, size 0x10
    class clsPlayerTask * m_pcPlayerTask; // offset 0x290, size 0x4
    float m_f32AddFrame; // offset 0x294, size 0x4
    float m_f32MotionFrame; // offset 0x298, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0x29C, size 0x4
    float m_f32WaitFrame; // offset 0x2A0, size 0x4
    float m_f32RotCounter; // offset 0x2A4, size 0x4
    float m_f32RotZ; // offset 0x2A8, size 0x4
    unsigned int m_u32FrameCounter; // offset 0x2AC, size 0x4
    float m_sDrawMtx[4][4]; // offset 0x2B0, size 0x40
    class clsBackLineEffectTask * m_apcLineTask[2]; // offset 0x2F0, size 0x8
    unsigned char m_bIsBackLine; // offset 0x2F8, size 0x1
    enum enmPathSide m_ePathSide; // offset 0x2FC, size 0x4
    unsigned char m_bPlayerLock; // offset 0x300, size 0x1
    unsigned char m_u8ContactSeCount; // offset 0x301, size 0x1
};
class stcDataSize {
    // total size: 0x18
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xA4
public:
    class clsSecurityRoboManager_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsSt11SecurityRoboModels m_cModel; // offset 0x88, size 0x18
...
class clsSt11SecurityRoboModels {
    // total size: 0x18
public:
    class clsModelType_OB_TX_MO m_cRoboStand; // offset 0x0, size 0x10
    class clsModelType_OB_TX m_cRoboBall; // offset 0x10, size 0x8
};
class clsObject {
    // total size: 0x4
};
...
class hkWorldRayCastOutput : public hkShapeRayCastOutput {
    // total size: 0x60
public:
    class hkCollidable * m_rootCollidable; // offset 0x50, size 0x4
};
...
class clsSecurityRoboManager_Obj : public clsGimmickObj {
    // total size: 0x70
public:
    class clsSecurityRoboCollision m_cThroughCol; // offset 0x50, size 0x10
    enum enmMode m_eMode; // offset 0x60, size 0x4
    class stcSetDataDetail * m_psSetData; // offset 0x64, size 0x4
    class stcRoboData * m_psRoboData; // offset 0x68, size 0x4
    unsigned char m_u8RoboArrayNo; // offset 0x6C, size 0x1
};
enum enmDraw2DAttr {
...
class stcRoboData {
    // total size: 0x1EB0
public:
    class clsPathSecurityRobo_Obj m_cRoboObj[10]; // offset 0x0, size 0x1EA0
    unsigned char bExecute; // offset 0x1EA0, size 0x1
};
class map {
    // total size: 0x18
public:
...
class clsSecurityRoboManager_Task : public clsBaseGimmickBody {
    // total size: 0xA8
public:
    class hkShape * m_pcShapeRobo; // offset 0xA4, size 0x4
};
class __vector_imp : private __vector_deleter {
    // total size: 0xC
};
...
class clsSecurityRoboCollision : public clsBaseThroughCollision {
    // total size: 0x10
public:
    class clsSecurityRoboManager_Obj * m_pcManager; // offset 0x8, size 0x4
    float m_f32WaitFrame; // offset 0xC, size 0x4
};
enum enmInfo {
    TYPE_NULL = 0,
    TYPE_GROUND = 1,
...
class hkShapeRayCastOutput : public hkShapeRayCastCollectorOutput {
    // total size: 0x50
public:
    unsigned int m_shapeKeys[8]; // offset 0x20, size 0x20
    signed int m_shapeKeyIndex; // offset 0x40, size 0x4
};
...
class hkShapeRayCastCollectorOutput {
    // total size: 0x20
public:
    class hkVector4 m_normal; // offset 0x0, size 0x10
    float m_hitFraction; // offset 0x10, size 0x4
    signed int m_extraInfo; // offset 0x14, size 0x4
    signed int m_pad[2]; // offset 0x18, size 0x8
};
enum enmBreakType {
    BREAK_TYPE_OTHER = 0,
    BREAK_TYPE_PLAYER = 1,
...
// Range: 0x484AA0 -> 0x484ABC
void init(class clsPathSecurityRobo_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x484AA0 -> 0x484ABC
    }
...
// Range: 0x484AD0 -> 0x485094
void draw(class clsPathSecurityRobo_Obj * this /* r21 */, class clsSt11SecurityRoboModels * pcModels /* r20 */, float (* psMtxPal)[4][4] /* r20 */, unsigned int * psNodeStat /* r16 */, float (* opaNnViewMtx)[4][4] /* r19 */, float (* psMtxWork)[4][4] /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x484AD0 -> 0x485094
        class NNS_OBJECT * psObject; // r17
        float sMtx[4][4]; // r29+0xD0
    }
}


// Range: 0x4850A0 -> 0x4858B0
void main(class clsPathSecurityRobo_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4850A0 -> 0x4858B0
        class clsGimmickPath & rcGimmickPath; // r17
    }
}


// Range: 0x4858B0 -> 0x485938
void clearVelocity(class clsPathSecurityRobo_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4858B0 -> 0x485938
        class hkVector4 cZero; // r29+0x20
    }
}


// Range: 0x485950 -> 0x485AE4
void rotationAxisZ(class clsPathSecurityRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x485950 -> 0x485AE4
        float * pf32Counter; // r2
        class NNS_VECTORFAST sNormalVecFast; // r29+0xB0
        float sInvMtx[4][4]; // r29+0x70
...
// Range: 0x485AF0 -> 0x485B48
void setLineParam(class clsPathSecurityRobo_Obj * this /* r2 */, class NNS_OBJECT * pcObj /* r2 */, class NNS_MOTION * psMotion /* r2 */, float * pf32Frame /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x485AF0 -> 0x485B48
        signed int s32i; // r12
...
// Range: 0x485B50 -> 0x485BE4
void setLinearVelocity(class clsPathSecurityRobo_Obj * this /* r2 */, class NNS_VECTORFAST & rsVelocity /* r2 */, float f32Speed /* r29+0x30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x485B50 -> 0x485BE4
        class hkVector4 cVelocity; // r29+0x20
    }
}


// Range: 0x485BF0 -> 0x485C30
void updatePostural(class clsPathSecurityRobo_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x485BF0 -> 0x485C30
    }
...
// Range: 0x485C30 -> 0x485CC0
void chageLineParam(class clsPathSecurityRobo_Obj * this /* r2 */, class clsModelType_OB_TX_MO & rcModel /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x485C30 -> 0x485CC0
    }
...
// Range: 0x485CF0 -> 0x485DB4
void getDirPlayerStart(class clsPathSecurityRobo_Obj * this /* r17 */, class NNS_VECTORFAST & rsDirVecFast /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x485CF0 -> 0x485DB4
        class NNS_VECTORFAST sLocalPosVecFast; // r29+0x100
        class NNS_VECTORFAST sNormalVecFast; // r29+0xF0
        float sRotMtx[4][4]; // r29+0xB0
        float sInvMtx[4][4]; // r29+0x70
        float sMtx[4][4]; // r29+0x30
    }
}
...
// Range: 0x485DD0 -> 0x485E20
void resetLine(class clsPathSecurityRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x485DD0 -> 0x485E20
    }
...
// Range: 0x485E50 -> 0x485EA4
void callbackContactTriggerRigidBody(class clsPathSecurityRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x485E50 -> 0x485EA4
    }
...
// Range: 0x485EB0 -> 0x485EEC
void contactTriggerEvent(class clsPathSecurityRobo_Obj * this /* r16 */, class hkContactPoint * pcContact /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x485EB0 -> 0x485EEC
    }
...
// Range: 0x485EF0 -> 0x485F54
void callbackGravityEvent(class clsPathSecurityRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x485EF0 -> 0x485F54
    }
...
// Range: 0x485F60 -> 0x486040
void requestDrawBreakEffect(class clsPathSecurityRobo_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x485F60 -> 0x486040
    }
...
// Range: 0x486040 -> 0x486084
void checkPlayerRestart(class clsPathSecurityRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x486040 -> 0x486084
    }
...
// Range: 0x486090 -> 0x4861E8
void setSurfaceDir(class clsPathSecurityRobo_Obj * this /* r2 */, class NNS_VECTORFAST & rsVerocityFast /* r17 */, class NNS_VECTORFAST & rsDirVecFast /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x486090 -> 0x4861E8
        class hkWorldRayCastInput cInput; // r29+0xB0
        class hkWorldRayCastOutput cOutput; // r29+0x50
        class NNS_VECTORFAST sUpVecFast; // r29+0x40
        class NNS_VECTORFAST sSideVecFast; // r29+0x30
    }
}


// Range: 0x4861F0 -> 0x486528
void setReturnPath(class clsPathSecurityRobo_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4861F0 -> 0x486528
        class clsPath & rcPath; // r2
        class stcData * opsData_Gimmick; // r2
        float f32Speed; // r29+0xD0
        unsigned int u32PathNo; // r17
        class NNS_VECTORFAST sDirVecFast; // r29+0xC0
    }
}


// Range: 0x486530 -> 0x4866AC
void setPosturalCtrl(class clsPathSecurityRobo_Obj * this /* r2 */, class NNS_VECTORFAST & rsDirVecFast /* r17 */, float f32InterpolateRate /* r21 */, float f32RotZ /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x486530 -> 0x4866AC
        class NNS_QUATERNION sQuatX; // r29+0x70
        class NNS_QUATERNION sQuatY; // r29+0x60
        class NNS_QUATERNION sQuatZ; // r29+0x50
        class NNS_QUATERNION sEndQuat; // r29+0x40
        float f32RadX; // r23
...
// Range: 0x4866B0 -> 0x48672C
void stepMotionFrame(class clsPathSecurityRobo_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4866B0 -> 0x48672C
    }
...
// Range: 0x486730 -> 0x4867B0
void destroyData(class clsPathSecurityRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x486730 -> 0x4867B0
    }
...
// Range: 0x4867B0 -> 0x486C44
void createData(class clsPathSecurityRobo_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4867B0 -> 0x486C44
...
// Range: 0x486C50 -> 0x486C94
void setData(class clsPathSecurityRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x486C50 -> 0x486C94
    }
...
// Range: 0x486CA0 -> 0x486F98
void start(class clsPathSecurityRobo_Obj * this /* r17 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x486CA0 -> 0x486F98
        class clsGimmickPath & rcGimmcikPath; // r16
        class hkVector4 cOffset; // r29+0x60
    }
}


// Range: 0x486FA0 -> 0x487288
void reset(class clsPathSecurityRobo_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x486FA0 -> 0x487288
        class clsGimmickPath & rcGimmcikPath; // r16
...
// Range: 0x487290 -> 0x48739C
void * __dt(class clsPathSecurityRobo_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x487290 -> 0x48739C
    }
...
// Range: 0x4873A0 -> 0x487548
void * __ct(class clsPathSecurityRobo_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4873A0 -> 0x487548
    }
...
// Range: 0x487550 -> 0x487558
void @80@__dt__23clsPathSecurityRobo_ObjFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x487550 -> 0x487558
    }
