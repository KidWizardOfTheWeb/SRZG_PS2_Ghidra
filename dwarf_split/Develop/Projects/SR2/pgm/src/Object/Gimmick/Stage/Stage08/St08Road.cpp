/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage08\St08Road.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class stcRoadInfo t_astcRoadInfoTbl[6]; // size: 0x60, address: 0x695D00
float t_of32SlowDownFrame; // size: 0x4, address: 0x0
float t_of32AccleFrame; // size: 0x4, address: 0x695D60
...
class clsRoad_Task : public clsBaseGimmickBody {
    // total size: 0x94
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsRoad_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class __wrap_iterator {
    // total size: 0x4
public:
    class clsRoadCarControl * * it_; // offset 0x0, size 0x4
};
...
// Range: 0x5235A0 -> 0x523668
void draw(class clsRoad_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5235A0 -> 0x523668
...
// Range: 0x523670 -> 0x523740
void execute(class clsRoad_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x523670 -> 0x523740
        unsigned int u32Num; // r2
...
// Range: 0x523740 -> 0x5237C0
void reset(class clsRoad_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x523740 -> 0x5237C0
        unsigned int u32Num; // r2
...
// Range: 0x5237C0 -> 0x523DFC
void execute(class clsRoad_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5237C0 -> 0x523DFC
        class __wrap_iterator it00; // r29+0x21C
        class __wrap_iterator it01; // r29+0x218
        float & rfFrame; // r2
    }
}


// Range: 0x5241C0 -> 0x5243E8
void requestMove(class clsRoad_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5241C0 -> 0x5243E8
        class __wrap_iterator it'110; // r2
        class __wrap_iterator it'107; // r2
        class __wrap_iterator itEnd'106; // r17
        class clsOOVector & rvctCar; // r2
        class __wrap_iterator it; // r29+0x6C
        unsigned int u32Check; // r7
        float f32StartWait; // r23
        float f32Interval; // r22
        float f32Speed; // r21
        class clsRoadCarControl * pcCtr; // r18
        float f32StartFrame; // r20
        class __wrap_iterator it; // r29+0x68
        class __wrap_iterator itEnd; // r29+0x64
    }
}


// Range: 0x5243F0 -> 0x5245F4
void requestStop(class clsRoad_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5243F0 -> 0x5245F4
        class __wrap_iterator it'84; // r2
        class __wrap_iterator itEnd'83; // r21
        class clsOOVector & rtdvctCarSort; // r2
        class __wrap_iterator it; // r29+0x21C
        class __wrap_iterator itEnd; // r29+0x218
        unsigned char bFirst; // r19
        float f32StartFrame; // r29+0x220
        class clsRoadCarControl * pcObj; // r18
        class stcRoadInfo * opsRoadInfo; // r2
        float f32SlowDownSpeed; // r29+0x220
        float f32RestLength; // r29+0x220
        float f32BefStopLength; // r20
        class clsPath & rcPath; // r2
    }
}


// Range: 0x524600 -> 0x5246D8
unsigned char sortPathRate(class clsRoad_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x524600 -> 0x5246D8
        class __wrap_iterator it'71; // r2
        class __wrap_iterator itEnd'70; // r18
        class clsOOVector & rcvctCarSort; // r17
        class __wrap_iterator it; // r29+0x5C
        class __wrap_iterator itEnd; // r29+0x58
        class clsRoadCarControl * pcCar; // r29+0x54
    }
}


// Range: 0x5246E0 -> 0x524784
void contactTriggerEvent(class clsRoad_Obj * this /* r17 */, class clsObject * pcObject /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5246E0 -> 0x524784
    }
...
// Range: 0x524790 -> 0x5247E0
unsigned char setCar(class clsRoad_Obj * this /* r2 */, class clsRoadCarControl * pcCar /* r29+0x2C */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x524790 -> 0x5247E0
        class clsOOVector & rvctCar; // r2
...
// Range: 0x5247E0 -> 0x524828
void destroyData(class clsRoad_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5247E0 -> 0x524828
    }
...
// Range: 0x524830 -> 0x524A44
void createData(class clsRoad_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x524830 -> 0x524A44
        class hkTransform cTransform; // r29+0x80
        class hkVector4 cBox; // r29+0x70
        unsigned int u32i; // r4
        class hkShape * pcShape; // r18
    }
}


// Range: 0x524A50 -> 0x524A58
void setData() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x524A50 -> 0x524A58
...
// Range: 0x525E10 -> 0x525E70
unsigned char __cl(class clsRoadCarControl * pcObj00 /* r2 */, class clsRoadCarControl * pcObj01 /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x525E10 -> 0x525E70
    }
