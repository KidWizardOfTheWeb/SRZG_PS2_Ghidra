/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage15\St15MeteoriteS.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x687D18
static unsigned char toau8AddSpeedRate[3]; // size: 0x3, address: 0x687D20
static float toaf32AddSpeedTable[3]; // size: 0xC, address: 0x687D28
struct /* @anon4 */ {
    // total size: 0x48
} __vt__18clsMeteoriteS_Task; // size: 0x48, address: 0x6C5B50
struct /* @anon9 */ {
    // total size: 0x48
} __vt__89clsSingleModelGimmick_Task<18clsMeteoriteS_Task,17clsMeteoriteS_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C5CB0
struct /* @anon5 */ {
    // total size: 0x38
...
struct /* @anon19 */ {
    // total size: 0xC
} __vt__34clsSingleton<18clsMeteoriteS_Task>; // size: 0xC, address: 0x6C5C48
void * __dt(class clsMeteoriteS_Obj *, signed short); // size: 0x0, address: 0x454DB0
struct /* @anon2 */ {
    // total size: 0x48
} __vt__81clsBaseGimmickBody<18clsMeteoriteS_Task,17clsMeteoriteS_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C5C60
struct /* @anon16 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon3 */ {
    // total size: 0xA8
} __vt__17clsMeteoriteS_Obj; // size: 0xA8, address: 0x6C5BA0
struct /* @anon12 */ {
    // total size: 0x28
...
class NNS_VECTOR tosZeroVec; // size: 0xC, address: 0x687E10
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x687DD0
unsigned char m_toabDisableFog[17]; // size: 0x11, address: 0x687510
struct /* @anon13 */ {
    // total size: 0x30
} __vt__7clsTask; // size: 0x30, address: 0x6B59F0
void * __ct(class clsMeteoriteS_Obj *); // size: 0x0, address: 0x455B50
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x687E20
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x687E30
...
// Range: 0x454EB0 -> 0x455004
void setMeteoriteS(class clsMeteoriteS_Task * this /* r21 */, unsigned int ou32Type /* r20 */, unsigned int ou32ObjNo /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x454EB0 -> 0x455004
        unsigned int u32i; // r19
        signed int s32SearchNum; // r18
        unsigned int u32SearchMode; // r17
    }
}


// Range: 0x455010 -> 0x4553C0
void draw(class clsMeteoriteS_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x455010 -> 0x4553C0
...
// Range: 0x455470 -> 0x455600
void execute(class clsMeteoriteS_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x455470 -> 0x455600
        ...
        class stcSetDataDetail sSetDataDetail; // @ 0x00B17410
    }
}


// Range: 0x455600 -> 0x455670
void reset(class clsMeteoriteS_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x455600 -> 0x455670
        unsigned int u32Num; // r2
...
// Range: 0x455670 -> 0x455704
void reset(class clsMeteoriteS_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x455670 -> 0x455704
    }
...
// Range: 0x455710 -> 0x4557E4
void * __ct(class clsMeteoriteS_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x455710 -> 0x4557E4
    }
...
// Range: 0x455C20 -> 0x455C80
void destroyData(class clsMeteoriteS_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x455C20 -> 0x455C80
    }
...
// Range: 0x455C80 -> 0x455FD0
void createData(class clsMeteoriteS_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x455C80 -> 0x455FD0
...
// Range: 0x455FD0 -> 0x45603C
void setData(class clsMeteoriteS_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x455FD0 -> 0x45603C
    }
...
// Range: 0x456040 -> 0x456074
void requestDrawContactEffect(class hkContactPoint * pcContact /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x456040 -> 0x456074
        class NNS_VECTORFAST sContactVecFast; // r29+0x10
    }
}


// Range: 0x456080 -> 0x4560F4
void requestDrawBreakEffect(class clsMeteoriteS_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x456080 -> 0x4560F4
    }
...
// Range: 0x456100 -> 0x45648C
void startDrawMeteoriteS(class clsMeteoriteS_Obj * this /* r17 */, unsigned int ou32No /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x456100 -> 0x45648C
        float sMtx[4][4]; // r29+0xE0
        class NNS_VECTORFAST sVecFast; // r29+0xD0
    }
}


// Range: 0x456490 -> 0x456948
void attackMeteoriteS(class clsMeteoriteS_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x456490 -> 0x456948
        class NNS_VECTORFAST sDirVecFast; // r29+0xC0
        float f32Speed; // r20
        unsigned int u32RandNo; // r17
        unsigned int u32i; // r5
        class NNS_VECTORFAST sSpeedVecFast; // r29+0xB0
        class NNS_VECTORFAST sXVecFast; // r29+0xA0
        class NNS_VECTORFAST sYVecFast; // r29+0x90
    }
}


// Range: 0x456950 -> 0x4571CC
void main(class clsMeteoriteS_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x456950 -> 0x4571CC
        class NNS_VECTORFAST sVecFast; // r29+0x270
        class NNS_VECTORFAST sXVecFast; // r29+0x260
        class NNS_VECTORFAST sYVecFast; // r29+0x250
        class NNS_VECTORFAST sVecFast; // r29+0x240
        class NNS_VECTORFAST sXVecFast; // r29+0x230
        class NNS_VECTORFAST sYVecFast; // r29+0x220
        class NNS_VECTORFAST sVecFast; // r29+0x210
    }
}
