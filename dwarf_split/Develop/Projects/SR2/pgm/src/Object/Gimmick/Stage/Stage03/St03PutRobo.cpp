/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage03\St03PutRobo.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float t_of32BreakClipDist; // size: 0x4, address: 0x0
float t_of32ClipDist; // size: 0x4, address: 0x0
float m_tof32CLIP_DISTx2; // size: 0x4, address: 0x67FF48
class clsGravityGimmickParam t_ocGravityGimmickParams[2]; // size: 0xF0, address: 0x67FF50
unsigned int otau32Se_RoboExp[2]; // size: 0x8, address: 0x680040
unsigned int otau32Se_RoboCrash[2]; // size: 0x8, address: 0x680048
struct /* @anon12 */ {
    // total size: 0x48
} __vt__15clsPutRobo_Task; // size: 0x48, address: 0x6C0550
struct /* @anon2 */ {
    // total size: 0x48
} __vt__83clsSingleModelGimmick_Task<15clsPutRobo_Task,14clsPutRobo_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C0630
struct /* @anon13 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPutRobo_Task * m_tpcSingleton; // size: 0x4, address: 0xB15F38
struct /* @anon11 */ {
    // total size: 0xC
} __vt__31clsSingleton<15clsPutRobo_Task>; // size: 0xC, address: 0x6C05D0
void * __dt(class clsPutRobo_Obj *, signed short); // size: 0x0, address: 0x39CA30
struct /* @anon14 */ {
    // total size: 0x48
} __vt__75clsBaseGimmickBody<15clsPutRobo_Task,14clsPutRobo_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C05E0
struct /* @anon20 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon17 */ {
    // total size: 0xA8
} __vt__14clsPutRobo_Obj; // size: 0xA8, address: 0x6C0680
struct /* @anon9 */ {
    // total size: 0x28
...
void * __ct(class clsPutRobo_Obj *); // size: 0x0, address: 0x39D550
...
class clsPutRobo_Obj : public clsRigidBodyGimmickObj {
    // total size: 0xF0
public:
    enum enmPutRoboMode m_enPutRoboMode; // offset 0xD0, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0xD4, size 0x4
    unsigned int m_u32ClipFlg; // offset 0xD8, size 0x4
    float m_f32GravityLimitFrame; // offset 0xDC, size 0x4
    float m_f32ClipDist; // offset 0xE0, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPutRobo_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsPutRobo_Task : public clsSingleModelGimmick_Task {
    // total size: 0x98
public:
    unsigned int m_u32DrawType; // offset 0x94, size 0x4
};
class PotentialInfo {
    // total size: 0x1008
public:
...
// Range: 0x39CB30 -> 0x39CE44
void draw(class clsPutRobo_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39CB30 -> 0x39CE44
...
// Range: 0x39CF30 -> 0x39D010
void execute(class clsPutRobo_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39CF30 -> 0x39D010
        unsigned int u32Num; // r2
...
// Range: 0x39D010 -> 0x39D09C
void reset(class clsPutRobo_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39D010 -> 0x39D09C
        unsigned int u32Num; // r2
...
// Range: 0x39D0A0 -> 0x39D128
void reset(class clsPutRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39D0A0 -> 0x39D128
    }
...
// Range: 0x39D130 -> 0x39D1F4
void * __ct(class clsPutRobo_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39D130 -> 0x39D1F4
...
// Range: 0x39D610 -> 0x39D92C
void mainGravity(class clsPutRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39D610 -> 0x39D92C
        float * pf32Frame; // r2
        float sMtx[4][4]; // r29+0x80
        float sMtxInv[4][4]; // r29+0x40
        class NNS_VECTORFAST sLocalPosVecFast; // r29+0x30
    }
}


// Range: 0x39D9C0 -> 0x39DA00
void main(class clsPutRobo_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39D9C0 -> 0x39DA00
    }
...
// Range: 0x39DA00 -> 0x39DA84
void init(class clsPutRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39DA00 -> 0x39DA84
    }
...
// Range: 0x39DA90 -> 0x39DA9C
void callbackGravityEvent(class clsPutRobo_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39DA90 -> 0x39DA9C
    }
...
// Range: 0x39DAA0 -> 0x39DB40
void callbackContactTriggerRigidBody(class clsPutRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39DAA0 -> 0x39DB40
    }
...
// Range: 0x39DB40 -> 0x39DB94
void requestDrawContactEffect(class clsPutRobo_Obj * this /* r2 */, class hkContactPoint * pcContact /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39DB40 -> 0x39DB94
    }
...
// Range: 0x39DBA0 -> 0x39DCC4
void requestDrawBreakEffect(class clsPutRobo_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39DBA0 -> 0x39DCC4
    }
...
// Range: 0x39DCD0 -> 0x39DD50
void destroyData(class clsPutRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39DCD0 -> 0x39DD50
    }
