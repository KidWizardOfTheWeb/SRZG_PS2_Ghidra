/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage07\St07MapPartsJointBig.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x692D88
struct /* @anon8 */ {
    // total size: 0x48
} __vt__24clsMapPartsJointBig_Task; // size: 0x48, address: 0x6CC570
struct /* @anon3 */ {
    // total size: 0x48
} __vt__104clsSingleModelGimmick_Task<24clsMapPartsJointBig_Task,26clsMapPartsJointBig_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CC620
struct /* @anon1 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsMapPartsJointBig_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA748
struct /* @anon6 */ {
    // total size: 0xC
} __vt__40clsSingleton<24clsMapPartsJointBig_Task>; // size: 0xC, address: 0x6CC5B8
void * __dt(class clsMapPartsJointBig_Object *, signed short); // size: 0x0, address: 0x502400
struct /* @anon0 */ {
    // total size: 0x48
} __vt__96clsBaseGimmickBody<24clsMapPartsJointBig_Task,26clsMapPartsJointBig_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CC5D0
struct /* @anon2 */ {
    // total size: 0xA8
} __vt__26clsMapPartsJointBig_Object; // size: 0xA8, address: 0x6CC670
...
void * __ct(class clsMapPartsJointBig_Object *); // size: 0x0, address: 0x502CE0
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsMapPartsJointBig_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsMapPartsJointBig_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
class hkPadSpu {
    // total size: 0x4
...
// Range: 0x502480 -> 0x502754
void draw(class clsMapPartsJointBig_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x502480 -> 0x502754
...
// Range: 0x502860 -> 0x5028D0
void reset(class clsMapPartsJointBig_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x502860 -> 0x5028D0
        unsigned int u32Num; // r2
...
// Range: 0x5028D0 -> 0x50298C
void * __ct(class clsMapPartsJointBig_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5028D0 -> 0x50298C
...
// Range: 0x502D20 -> 0x502D58
void createData(class clsMapPartsJointBig_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x502D20 -> 0x502D58
    }
