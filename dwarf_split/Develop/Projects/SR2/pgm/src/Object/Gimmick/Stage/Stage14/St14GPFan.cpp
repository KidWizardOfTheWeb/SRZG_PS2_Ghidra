/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage14\St14GPFan.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x691F78
struct /* @anon16 */ {
    // total size: 0x64
} __vt__13clsGPFan_Task; // size: 0x64, address: 0x6CACB0
void * __dt(class clsGPFan_Obj *, signed short); // size: 0x0, address: 0x4EBFF0
struct /* @anon18 */ {
    // total size: 0x48
} __vt__66clsBaseGimmickBody<13clsGPFan_Task,12clsGPFan_Obj,13clsGPFanModel>; // size: 0x48, address: 0x6CADE0
struct /* @anon14 */ {
    // total size: 0x30
...
struct /* @anon6 */ {
    // total size: 0xA8
} __vt__12clsGPFan_Obj; // size: 0xA8, address: 0x6CAD20
struct /* @anon13 */ {
    // total size: 0x28
...
void * __ct(class clsGPFan_Obj *); // size: 0x0, address: 0x4ECEB0
class clsGPFan_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA6E8
struct /* @anon15 */ {
    // total size: 0xC
} __vt__29clsSingleton<13clsGPFan_Task>; // size: 0xC, address: 0x6CADC8
...
struct /* @anon1 */ {
    // total size: 0x30
} __vt__48clsGmkBurnLight_Task<24clsModelType_OB_TX_MO_MA>; // size: 0x30, address: 0x6CAE30
...
class clsObjectEffect_Task : public clsBaseEffect_Task {
    // total size: 0xE0
public:
    unsigned char m_bDraw; // offset 0xD0, size 0x1
    float (* m_opsFollowMatrix)[4][4]; // offset 0xD4, size 0x4
    class NNS_VECTORFAST * m_opsFollowPosVecFast; // offset 0xD8, size 0x4
};
...
public:
    ...
    float m_f32MotFrame; // offset 0xD4, size 0x4
    float m_f32MotEndFrame; // offset 0xD8, size 0x4
    float m_f32Scale; // offset 0xDC, size 0x4
    float m_f32FanSpeed; // offset 0xE0, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0xE4, size 0x4
    float m_sEffectMatrix[4][4]; // offset 0xF0, size 0x40
    class clsTask * m_pcEffectTask; // offset 0x130, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xB4
public:
    class clsGPFan_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsGPFanModel m_cModel; // offset 0x88, size 0x28
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0xB0, size 0x4
};
...
public:
    ...
    class _NNS_TEXLIST * m_apsTexList[2]; // offset 0x20, size 0x8
};
...
class clsGPFan_Task : public clsMultiShape, public clsBaseGimmickBody {
    // total size: 0xCC
public:
    class clsGmkBurnLight_Task * m_pcBurnLightTask; // offset 0xC4, size 0x4
    unsigned int m_u32DrawTexNo; // offset 0xC8, size 0x4
};
class clsSingleton {
    // total size: 0x4
};
...
// Range: 0x4EC0F0 -> 0x4EC594
void draw(class clsGPFan_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EC0F0 -> 0x4EC594
        unsigned int u32Num; // r2
        class clsGPFanModel & rcModel; // r20
        unsigned int * psNodeStat; // r2
        float (* opaNnViewMtx)[4][4]; // r30
        float (* psMtxPal)[4][4]; // r2
        float sMtxWork[4][4]; // r29+0xE0
        float af32Frame[2]; // r29+0x120
        unsigned int u32i; // r19
    }
}


// Range: 0x4EC700 -> 0x4EC8D8
void execute(class clsGPFan_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EC700 -> 0x4EC8D8
...
// Range: 0x4EC8E0 -> 0x4EC950
void reset(class clsGPFan_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EC8E0 -> 0x4EC950
        unsigned int u32Num; // r2
...
// Range: 0x4EC950 -> 0x4ECA14
void reset(class clsGPFan_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EC950 -> 0x4ECA14
    }
...
// Range: 0x4ECA20 -> 0x4ECBA0
void createModel(class clsGPFan_Task * this /* r5 */, class stcBinInfo & rsBinInfoI /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4ECA20 -> 0x4ECBA0
...
// Range: 0x4ECBA0 -> 0x4ECD0C
void * __ct(class clsGPFan_Task * this /* r18 */, unsigned int u32ObjectAreaNum /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4ECBA0 -> 0x4ECD0C
    }
...
// Range: 0x4ECFF0 -> 0x4ED088
void destroyData(class clsGPFan_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4ECFF0 -> 0x4ED088
    }
...
// Range: 0x4ED090 -> 0x4EDA64
void createData(class clsGPFan_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4ED090 -> 0x4EDA64
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0xF0
        class NNS_VECTOR sScaleVec; // r29+0x1B0
        class hkBoxShape * pcBoxShape; // r2
        class hkMassProperties massProperties; // r29+0xA0
        class hkVector4 cOffset; // r29+0x90
        class clsContactControl & rcContactControl; // r2
        char __FUNCTION__[14]; // @ 0x00691F68
    }
}


// Range: 0x4EDA70 -> 0x4EDAD4
void setData(class clsGPFan_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EDA70 -> 0x4EDAD4
    }
...
// Range: 0x4EDAE0 -> 0x4EDB9C
void contactTriggerEvent(class clsGPFan_Obj * this /* r2 */, class hkContactPoint * pcContact /* r2 */, class clsObject * pcObject /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EDAE0 -> 0x4EDB9C
...
// Range: 0x4EDBA0 -> 0x4EDBFC
void requestDrawBreakEffect(class clsGPFan_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EDBA0 -> 0x4EDBFC
    }
...
// Range: 0x4EDC00 -> 0x4EDDC4
void main(class clsGPFan_Obj * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EDC00 -> 0x4EDDC4
    }
