/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage07\St07PowerBreak.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x693700
struct /* @anon8 */ {
    // total size: 0x48
} __vt__22clsSt07PowerBreak_Task; // size: 0x48, address: 0x6CD440
struct /* @anon18 */ {
    // total size: 0x48
} __vt__97clsSingleModelGimmick_Task<22clsSt07PowerBreak_Task,21clsSt07PowerBreak_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CD4F0
struct /* @anon4 */ {
    // total size: 0x38
...
struct /* @anon5 */ {
    // total size: 0xC
} __vt__38clsSingleton<22clsSt07PowerBreak_Task>; // size: 0xC, address: 0x6CD488
void * __dt(class clsSt07PowerBreak_Obj *, signed short); // size: 0x0, address: 0x514970
struct /* @anon11 */ {
    // total size: 0x48
} __vt__89clsBaseGimmickBody<22clsSt07PowerBreak_Task,21clsSt07PowerBreak_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CD4A0
struct /* @anon14 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon13 */ {
    // total size: 0xA8
} __vt__21clsSt07PowerBreak_Obj; // size: 0xA8, address: 0x6CD540
struct /* @anon12 */ {
    // total size: 0x28
...
void * __ct(class clsSt07PowerBreak_Obj *); // size: 0x0, address: 0x515360
...
// Range: 0x514A70 -> 0x514D5C
void draw(class clsSt07PowerBreak_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x514A70 -> 0x514D5C
...
// Range: 0x514E00 -> 0x514EE0
void execute(class clsSt07PowerBreak_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x514E00 -> 0x514EE0
        unsigned int u32Num; // r2
...
// Range: 0x514EE0 -> 0x514F50
void reset(class clsSt07PowerBreak_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x514EE0 -> 0x514F50
        unsigned int u32Num; // r2
...
// Range: 0x514F50 -> 0x51500C
void * __ct(class clsSt07PowerBreak_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x514F50 -> 0x51500C
...
// Range: 0x515420 -> 0x51549C
void setCollisionFilter(class clsSt07PowerBreak_Obj * this /* r2 */, unsigned char bFlag /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x515420 -> 0x51549C
    }
...
// Range: 0x5154A0 -> 0x515500
void destroyData(class clsSt07PowerBreak_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5154A0 -> 0x515500
    }
...
// Range: 0x515500 -> 0x51582C
void createData(class clsSt07PowerBreak_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x515500 -> 0x51582C
...
// Range: 0x515830 -> 0x515898
void setData(class clsSt07PowerBreak_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x515830 -> 0x515898
    }
...
// Range: 0x5158A0 -> 0x5158EC
void requestDrawBreakEffect(class clsSt07PowerBreak_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5158A0 -> 0x5158EC
    }
...
// Range: 0x5158F0 -> 0x515978
void reset(class clsSt07PowerBreak_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5158F0 -> 0x515978
    }
...
// Range: 0x515980 -> 0x5159A0
void main(class clsSt07PowerBreak_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x515980 -> 0x5159A0
    }
