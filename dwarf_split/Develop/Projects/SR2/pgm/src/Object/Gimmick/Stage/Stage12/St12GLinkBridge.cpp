/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage12\St12GLinkBridge.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x691B18
float tof32ClipSqDist; // size: 0x4, address: 0x691B28
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x691B30
struct /* @anon8 */ {
    // total size: 0x48
} __vt__19clsGLinkBridge_Task; // size: 0x48, address: 0x6CA550
struct /* @anon16 */ {
    // total size: 0x48
} __vt__94clsSingleModelGimmick_Task<19clsGLinkBridge_Task,21clsGLinkBridge_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CA6C0
struct /* @anon11 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsGLinkBridge_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA6C8
struct /* @anon3 */ {
    // total size: 0xC
} __vt__35clsSingleton<19clsGLinkBridge_Task>; // size: 0xC, address: 0x6CA658
void * __dt(class clsGLinkBridge_Object *, signed short); // size: 0x0, address: 0x4E30B0
struct /* @anon9 */ {
    // total size: 0x48
} __vt__86clsBaseGimmickBody<19clsGLinkBridge_Task,21clsGLinkBridge_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CA670
struct /* @anon6 */ {
    // total size: 0xB4
} __vt__24clsBaseGravityLinkObject; // size: 0xB4, address: 0x6C1420
struct /* @anon0 */ {
    // total size: 0xB8
} __vt__21clsGLinkBridge_Object; // size: 0xB8, address: 0x6CA5A0
struct /* @anon14 */ {
    // total size: 0x28
...
void * __ct(class clsGLinkBridge_Object *); // size: 0x0, address: 0x4E38A0
...
class clsGLinkBridge_Task : public clsSingleModelGimmick_Task {
    // total size: 0x98
public:
...
public:
    ...
    unsigned int m_u32Attr; // offset 0xE8, size 0x4
    float m_sEffectMartix[4][4]; // offset 0xF0, size 0x40
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsGLinkBridge_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x4E3150 -> 0x4E330C
void draw(class clsGLinkBridge_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E3150 -> 0x4E330C
...
// Range: 0x4E3310 -> 0x4E3468
void execute(class clsGLinkBridge_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E3310 -> 0x4E3468
...
// Range: 0x4E3470 -> 0x4E353C
void * __ct(class clsGLinkBridge_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E3470 -> 0x4E353C
...
// Range: 0x4E3910 -> 0x4E39C4
void destroyData(class clsGLinkBridge_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E3910 -> 0x4E39C4
    }
...
// Range: 0x4E39D0 -> 0x4E40D8
void createData(class clsGLinkBridge_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E39D0 -> 0x4E40D8
        ...
        char __FUNCTION__[14]; // @ 0x00691B08
    }
}


// Range: 0x4E40E0 -> 0x4E40E8
void setData() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E40E0 -> 0x4E40E8
...
// Range: 0x4E40F0 -> 0x4E4290
void requestDrawContactEffect(class clsGLinkBridge_Object * this /* r6 */, class hkContactPoint * pcContact /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E40F0 -> 0x4E4290
        ...
        class NNS_VECTOR LOCAL_POS_R; // @ 0x00691C20
        class NNS_VECTOR LOCAL_POS; // @ 0x00691C10
        class NNS_VECTOR RAND_SP; // @ 0x00691C00
        float LIFE_FRAME; // @ 0x00691C30
        class NNS_VECTOR BEGIN_SP; // @ 0x00691BF0
    }
}


// Range: 0x4E4290 -> 0x4E43A8
void drawEffect(class clsPlayerTask * pcPlayer /* r16 */) {
    ...
    /* anonymous block */ {
        ...
        class NNS_VECTOR LOCAL_POS_R; // @ 0x00691BD8
        class NNS_VECTOR LOCAL_POS; // @ 0x00691BC8
        class NNS_VECTOR RAND_SP; // @ 0x00691BB8
        float LIFE_FRAME; // @ 0x00691BE8
        class NNS_VECTOR BEGIN_SP; // @ 0x00691BA8
    }
}


// Range: 0x4E43B0 -> 0x4E445C
void callbackGravityEvent(class clsGLinkBridge_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E43B0 -> 0x4E445C
    }
...
// Range: 0x4E4460 -> 0x4E449C
void requestDrawBreakEffect(class clsGLinkBridge_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E4460 -> 0x4E449C
    }
...
// Range: 0x4E44A0 -> 0x4E452C
void main(class clsGLinkBridge_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E44A0 -> 0x4E452C
    }
...
// Range: 0x4E4530 -> 0x4E4650
void reset(class clsGLinkBridge_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E4530 -> 0x4E4650
...
// Range: 0x4E4650 -> 0x4E48E8
void draw(class clsGLinkBridge_Object * this /* r17 */, class NNS_OBJECT * psObject /* r16 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r20 */, float (* psMtxWork)[4][4] /* r19 */, unsigned int u32ViewNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E4650 -> 0x4E48E8
    }
