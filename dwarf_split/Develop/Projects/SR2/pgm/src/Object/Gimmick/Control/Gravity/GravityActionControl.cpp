/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Control\Gravity\GravityActionControl.cpp
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x680590
...
// Range: 0x3AC840 -> 0x3AC8E8
void gctrlMove(class clsGravityActionControl * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AC840 -> 0x3AC8E8
    }
...
// Range: 0x3AC8F0 -> 0x3ACD28
void gctrlMoveInit(class clsGravityActionControl * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AC8F0 -> 0x3ACD28
        class hkVector4 cSpeed; // r29+0x70
        float f32Speed; // r20
        float f32Rate; // r1
        class NNS_VECTORFAST sSpeedVecFast; // r29+0x60
        class hkVector4 cRot; // r29+0x50
    }
}


// Range: 0x3ACD30 -> 0x3ACE08
void gctrlFloat(class clsGravityActionControl * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3ACD30 -> 0x3ACE08
        class NNS_VECTORFAST sSpdVecFast; // r29+0x50
    }
}


// Range: 0x3ACE10 -> 0x3ACF34
void gctrlRise(class clsGravityActionControl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3ACE10 -> 0x3ACF34
        class hkVector4 cSpeed; // r29+0x30
    }
}


// Range: 0x3ACF40 -> 0x3AD374
void gctrlWait(class clsGravityActionControl * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3ACF40 -> 0x3AD374
...
// Range: 0x3AD380 -> 0x3AD450
void gctrlInit(class clsGravityActionControl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AD380 -> 0x3AD450
    }
...
// Range: 0x3AD450 -> 0x3AE0CC
void actionGravityDive(class clsGravityActionControl * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AD450 -> 0x3AE0CC
        class clsGravityDive * pcGravityDive; // r2
        class NNS_VECTORFAST sObjectPosVecFast; // r29+0x1C0
        class NNS_VECTORFAST sUpVecFast; // r29+0x1B0
        class NNS_VECTORFAST sSpeedVecFast; // r29+0x1A0
        class hkVector4 cRot; // r29+0x190
        class hkVector4 cRot; // r29+0x180
        class hkVector4 cSpeed; // r29+0x170
        class hkVector4 cRot; // r29+0x160
        class NNS_VECTORFAST sDirVecFast; // r29+0x150
        float f32Dist; // r29+0x1D0
        float sMtx[4][4]; // r29+0x110
        float sInvMtx[4][4]; // r29+0xD0
        class NNS_VECTORFAST sLocalVecFast; // r29+0xC0
        float f32Accele; // r20
...
// Range: 0x3AE0D0 -> 0x3AE270
void manageDestroy(class clsGravityActionControl * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AE0D0 -> 0x3AE270
        class NNS_VECTORFAST sPosVecFast; // r29+0x60
        class NNS_VECTORFAST sDirVecFast; // r29+0x50
        class NNS_VECTORFAST sDistVecFast; // r29+0x40
        float f32DotPro; // r20
        float f32DistSq; // r29+0x70
        float f32Speed; // r29+0x70
    }
}


// Range: 0x3AE270 -> 0x3AE370
void contactGravityActionRangeEvent(class clsGravityActionControl * this /* r17 */, class clsPlayerTask * pcPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AE270 -> 0x3AE370
...
// Range: 0x3AE370 -> 0x3AE470
void actionGravity(class clsGravityActionControl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AE370 -> 0x3AE470
    }
...
// Range: 0x3AE470 -> 0x3AE52C
void reset(class clsGravityActionControl * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AE470 -> 0x3AE52C
