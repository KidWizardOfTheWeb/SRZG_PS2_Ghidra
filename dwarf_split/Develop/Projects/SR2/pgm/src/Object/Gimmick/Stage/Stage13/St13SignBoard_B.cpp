/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage13\St13SignBoard_B.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x691DD0
struct /* @anon4 */ {
    // total size: 0x48
} __vt__18clsSignBoardB_Task; // size: 0x48, address: 0x6CA9A0
struct /* @anon0 */ {
    // total size: 0x48
} __vt__98clsSingleModelGimmick_Task<18clsSignBoardB_Task,20clsSignBoardB_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6CAAA0
struct /* @anon2 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsSignBoardB_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA6D8
struct /* @anon3 */ {
    // total size: 0xC
} __vt__34clsSingleton<18clsSignBoardB_Task>; // size: 0xC, address: 0x6CAA38
void * __dt(class clsSignBoardB_Object *, signed short); // size: 0x0, address: 0x4E8E60
struct /* @anon9 */ {
    // total size: 0x48
} __vt__90clsBaseGimmickBody<18clsSignBoardB_Task,20clsSignBoardB_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6CAA50
struct /* @anon6 */ {
    // total size: 0x28
...
struct /* @anon7 */ {
    // total size: 0x44
} __vt__20clsSignBoardB_Object; // size: 0x44, address: 0x6CA9F0
...
void * __ct(class clsSignBoardB_Object *); // size: 0x0, address: 0x4E9650
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsSignBoardB_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
public:
    ...
    float m_f32MatFrame; // offset 0x54, size 0x4
    float m_f32Scale; // offset 0x58, size 0x4
    float m_f32MaxScale; // offset 0x5C, size 0x4
};
...
class clsSignBoardB_Task : public clsSingleModelGimmick_Task {
    // total size: 0xAC
};
class clsFlag {
    // total size: 0x4
...
// Range: 0x4E8EF0 -> 0x4E90F4
void draw(class clsSignBoardB_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E8EF0 -> 0x4E90F4
        ...
        unsigned char bMatFlag; // r23
        unsigned int u32i; // r17
    }
}


// Range: 0x4E9100 -> 0x4E9268
void execute(class clsSignBoardB_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E9100 -> 0x4E9268
        unsigned int u32Num; // r2
...
// Range: 0x4E9270 -> 0x4E92DC
void * __ct(class clsSignBoardB_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E9270 -> 0x4E92DC
    }
...
// Range: 0x4E9740 -> 0x4E9A44
void draw(class clsSignBoardB_Object * this /* r20 */, class clsModelType_OB_TX_MO_MA & rcModel /* r19 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r22 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4E9740 -> 0x4E9A44
    }
