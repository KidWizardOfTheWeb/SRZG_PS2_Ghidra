/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\SurvivalBattle\SvlBtlBlock.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float t_of32Mass; // size: 0x4, address: 0x6974B0
float t_of32CLIP_DISTx2; // size: 0x4, address: 0x6974B8
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x6974C0
struct /* @anon9 */ {
    // total size: 0x48
} __vt__19clsSvlBtlBlock_Task; // size: 0x48, address: 0x6CF0B0
struct /* @anon0 */ {
    // total size: 0x48
} __vt__94clsSingleModelGimmick_Task<19clsSvlBtlBlock_Task,21clsSvlBtlBlock_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CF220
struct /* @anon11 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsSvlBtlBlock_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA808
struct /* @anon7 */ {
    // total size: 0xC
} __vt__35clsSingleton<19clsSvlBtlBlock_Task>; // size: 0xC, address: 0x6CF1B8
void * __dt(class clsSvlBtlBlock_Object *, signed short); // size: 0x0, address: 0x5448D0
struct /* @anon14 */ {
    // total size: 0x48
} __vt__86clsBaseGimmickBody<19clsSvlBtlBlock_Task,21clsSvlBtlBlock_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CF1D0
struct /* @anon15 */ {
    // total size: 0xB4
} __vt__19clsBaseSvlBtlObject; // size: 0xB4, address: 0x6CF100
struct /* @anon1 */ {
    // total size: 0xB4
} __vt__21clsSvlBtlBlock_Object; // size: 0xB4, address: 0x6CF270
struct /* @anon19 */ {
    // total size: 0xA8
...
void * __ct(class clsSvlBtlBlock_Object *); // size: 0x0, address: 0x5451E0
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsSvlBtlBlock_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsSvlBtlBlock_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
...
// Range: 0x544960 -> 0x544C1C
void draw(class clsSvlBtlBlock_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x544960 -> 0x544C1C
        ...
        float sMtxWork[4][4]; // r29+0xB0
        unsigned int u32i; // r19
    }
}


// Range: 0x544CC0 -> 0x544D60
void execute(class clsSvlBtlBlock_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x544CC0 -> 0x544D60
        unsigned int u32Num; // r2
...
// Range: 0x544D60 -> 0x544DD0
void reset(class clsSvlBtlBlock_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x544D60 -> 0x544DD0
        unsigned int u32Num; // r2
...
// Range: 0x544DD0 -> 0x544E90
void * __ct(class clsSvlBtlBlock_Task * this /* r16 */, unsigned int u32NumI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x544DD0 -> 0x544E90
...
// Range: 0x5452E0 -> 0x54537C
void requestDrawBreakEffect(class clsSvlBtlBlock_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5452E0 -> 0x54537C
    }
...
// Range: 0x545380 -> 0x54538C
class clsGravityGimmickParam * getGravityGimmickParam() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x545380 -> 0x54538C
    }
...
// Range: 0x5453A0 -> 0x5453B0
class hkShape * getShape() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5453A0 -> 0x5453B0
    }
