/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\PathCar.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float t_of32CLIP_DISTx2; // size: 0x4, address: 0x67DDC0
static class stcParam asPathCurLineParam[2]; // size: 0x80, address: 0x67DDD0
static unsigned char chk__asPathCurLineParam_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcGimickSubParam asPathCurLineSubParam[2]; // size: 0x40, address: 0x67DE50
static unsigned char chk__asPathCurLineSubParam_SizeCheck_[1]; // size: 0x1, address: 0x0
unsigned int otau32SeTbl[3][3]; // size: 0x24, address: 0x67DE90
struct /* @anon15 */ {
    // total size: 0x48
} __vt__15clsPathCar_Task; // size: 0x48, address: 0x6BECB0
struct /* @anon4 */ {
    // total size: 0x48
} __vt__82clsMultiModelGimmick_Task<15clsPathCar_Task,14clsPathCar_Obj,18clsMultiObTxModels>; // size: 0x48, address: 0x6BED60
struct /* @anon17 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPathCar_Task * m_tpcSingleton; // size: 0x4, address: 0xB13DD8
struct /* @anon8 */ {
    // total size: 0xC
} __vt__31clsSingleton<15clsPathCar_Task>; // size: 0xC, address: 0x6BECF8
void * __dt(class clsModelType_OB_TX *, signed short); // size: 0x0, address: 0x1F27F0
void * __dt(class clsPathCar_Obj *, signed short); // size: 0x0, address: 0x36DED0
struct /* @anon14 */ {
    // total size: 0x48
} __vt__75clsBaseGimmickBody<15clsPathCar_Task,14clsPathCar_Obj,18clsMultiObTxModels>; // size: 0x48, address: 0x6BED10
...
void * __ct(class clsPathCar_Obj *); // size: 0x0, address: 0x36DFA0
...
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x67DEE0
struct /* @anon18 */ {
    // total size: 0xB0
} __vt__21clsPathGravityObj_Obj; // size: 0xB0, address: 0x6C22E0
struct /* @anon20 */ {
    // total size: 0xB0
} __vt__14clsPathCar_Obj; // size: 0xB0, address: 0x6BEDB0
struct /* @anon10 */ {
    // total size: 0x28
...
class clsPathCar_Task : public clsMultiModelGimmick_Task {
    // total size: 0x98
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPathCar_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsPathCar_Obj : public clsPathGravityObj_Obj {
    // total size: 0x280
public:
    class clsSe3DControl * m_pcSe3DControl; // offset 0x220, size 0x4
    float m_sDrawMtx[4][4]; // offset 0x230, size 0x40
    class clsBackLineEffectTask * m_apcLineTask[2]; // offset 0x270, size 0x8
    unsigned char m_u8ContactSeCount; // offset 0x278, size 0x1
    unsigned char m_u8ModelNo; // offset 0x279, size 0x1
};
...
// Range: 0x36CB40 -> 0x36CD18
void draw(class clsPathCar_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36CB40 -> 0x36CD18
...
// Range: 0x36CD20 -> 0x36CE54
void execute(class clsPathCar_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36CD20 -> 0x36CE54
        unsigned int u32Num; // r2
...
// Range: 0x36CE60 -> 0x36CED4
void reset(class clsPathCar_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36CE60 -> 0x36CED4
        unsigned int u32Num; // r2
...
// Range: 0x36CEE0 -> 0x36CFF8
void * __ct(class clsPathCar_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36CEE0 -> 0x36CFF8
...
// Range: 0x36D340 -> 0x36D618
unsigned char draw(class clsPathCar_Obj * this /* r21 */, class clsModelType_OB_TX * pcModels /* r2 */, float (* psMtxPal)[4][4] /* r17 */, unsigned int * psNodeStat /* r16 */, float (* opaNnViewMtx)[4][4] /* r20 */, float (* psMtxWork)[4][4] /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36D340 -> 0x36D618
        unsigned char bReturn; // r16
        unsigned int u32ModelNo; // r2
        class clsModelType_OB_TX & rcObj; // r18
    }
}


// Range: 0x36D640 -> 0x36D67C
void callbackGravityEvent(class clsPathCar_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36D640 -> 0x36D67C
    }
...
// Range: 0x36D680 -> 0x36D6D4
void callbackContactTriggerRigidBody(class clsPathCar_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36D680 -> 0x36D6D4
    }
...
// Range: 0x36D6E0 -> 0x36D754
void adminSe(class clsPathCar_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36D6E0 -> 0x36D754
    }
...
// Range: 0x36D760 -> 0x36D7B8
void requestDrawBreakEffect(class clsPathCar_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36D760 -> 0x36D7B8
    }
...
// Range: 0x36D7C0 -> 0x36D840
void destroyData(class clsPathCar_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36D7C0 -> 0x36D840
    }
...
// Range: 0x36D840 -> 0x36DCDC
void createData(class clsPathCar_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36D840 -> 0x36DCDC
        ...
        unsigned int * au32SeTbl; // r2
    }
}


// Range: 0x36DCE0 -> 0x36DD38
void setData(class clsPathCar_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36DCE0 -> 0x36DD38
    }
...
// Range: 0x36DD40 -> 0x36DE0C
void reset(class clsPathCar_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36DD40 -> 0x36DE0C
    }
...
// Range: 0x36DE10 -> 0x36DEC4
void init(class clsPathCar_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36DE10 -> 0x36DEC4
    }
...
// Range: 0x36DED0 -> 0x36DF98
void * __dt(class clsPathCar_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36DED0 -> 0x36DF98
    }
...
// Range: 0x36DFA0 -> 0x36E0C0
void * __ct(class clsPathCar_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36DFA0 -> 0x36E0C0
        signed int s32i; // r19
