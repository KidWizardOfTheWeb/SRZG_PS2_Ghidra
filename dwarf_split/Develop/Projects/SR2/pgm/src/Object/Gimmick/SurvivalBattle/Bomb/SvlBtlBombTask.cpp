/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\SurvivalBattle\Bomb\SvlBtlBombTask.cpp
...
// Range: 0x54A030 -> 0x54A09C
void requestDeleteLockOnTargetEffect(class clsSvlBtlBomb_Task * this /* r2 */, signed int s32PlayerNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54A030 -> 0x54A09C
        class stcPlayerBombData * psData; // r2
    }
}


// Range: 0x54A0A0 -> 0x54A2DC
void requestRegistLockOnTargetEffect(class clsSvlBtlBomb_Task * this /* r2 */, signed int s32PlayerNo /* r2 */, signed int s32TargetNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54A0A0 -> 0x54A2DC
        class clsPlayerTask * pcOwner; // r2
        class clsPlayerTask * pcTarget; // r2
    }
}


// Range: 0x54A2E0 -> 0x54A310
void glop(class clsSvlBtlBomb_Task * this /* r2 */, signed int s32PlayerNo /* r2 */, signed int s32TargetNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54A2E0 -> 0x54A310
        class stcPlayerBombData * psPlayer; // r2
    }
}


// Range: 0x54A310 -> 0x54A430
void setup(class clsSvlBtlBomb_Task * this /* r17 */, signed int s32PlayerNo /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54A310 -> 0x54A430
...
// Range: 0x54A430 -> 0x54A450
unsigned char isGlopBomb(class clsSvlBtlBomb_Task * this /* r2 */, signed int s32PlayerNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54A430 -> 0x54A450
    }
...
// Range: 0x54A450 -> 0x54A4DC
unsigned char isGetBomb(class clsSvlBtlBomb_Task * this /* r16 */, signed int s32PlayerNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54A450 -> 0x54A4DC
        signed int s32Num; // r2
...
// Range: 0x54A4E0 -> 0x54A684
void draw(class clsSvlBtlBomb_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54A4E0 -> 0x54A684
...
// Range: 0x54A690 -> 0x54A850
void execute(class clsSvlBtlBomb_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54A690 -> 0x54A850
        unsigned int u32Num; // r2
...
// Range: 0x54A850 -> 0x54A8D0
void reset(class clsSvlBtlBomb_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54A850 -> 0x54A8D0
        unsigned int u32Num; // r2
