/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage07\St07MapPartsFLoorSmall.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x6929A8
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x6929B0
struct /* @anon0 */ {
    // total size: 0x48
} __vt__26clsMapPartsFloorSmall_Task; // size: 0x48, address: 0x6CBAA0
struct /* @anon4 */ {
    // total size: 0x48
} __vt__108clsSingleModelGimmick_Task<26clsMapPartsFloorSmall_Task,28clsMapPartsFloorSmall_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CBB50
struct /* @anon2 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsMapPartsFloorSmall_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA728
struct /* @anon7 */ {
    // total size: 0xC
} __vt__42clsSingleton<26clsMapPartsFloorSmall_Task>; // size: 0xC, address: 0x6CBAE8
void * __dt(class clsMapPartsFloorSmall_Object *, signed short); // size: 0x0, address: 0x4F9550
struct /* @anon1 */ {
    // total size: 0x48
} __vt__100clsBaseGimmickBody<26clsMapPartsFloorSmall_Task,28clsMapPartsFloorSmall_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CBB00
struct /* @anon3 */ {
    // total size: 0xA8
} __vt__28clsMapPartsFloorSmall_Object; // size: 0xA8, address: 0x6CBBA0
...
void * __ct(class clsMapPartsFloorSmall_Object *); // size: 0x0, address: 0x4F9E40
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsMapPartsFloorSmall_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsMapPartsFloorSmall_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
class hkSmallArray {
    // total size: 0x8
...
// Range: 0x4F95D0 -> 0x4F98A4
void draw(class clsMapPartsFloorSmall_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F95D0 -> 0x4F98A4
...
// Range: 0x4F99B0 -> 0x4F9A20
void reset(class clsMapPartsFloorSmall_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F99B0 -> 0x4F9A20
        unsigned int u32Num; // r2
...
// Range: 0x4F9A20 -> 0x4F9AF0
void * __ct(class clsMapPartsFloorSmall_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F9A20 -> 0x4F9AF0
...
// Range: 0x4F9E80 -> 0x4F9EB8
void createData(class clsMapPartsFloorSmall_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F9E80 -> 0x4F9EB8
    }
