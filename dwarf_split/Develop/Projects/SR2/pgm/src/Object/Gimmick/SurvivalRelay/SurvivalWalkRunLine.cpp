/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\SurvivalRelay\SurvivalWalkRunLine.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32CLIP_DISTx2; // size: 0x4, address: 0x696B20
static signed int tos32SpeedDownFrame; // size: 0x4, address: 0x0
static signed int tos32SpeedDownFrameDiv; // size: 0x4, address: 0x696B28
...
// Range: 0x53BC20 -> 0x53BEB8
void draw(class clsSurvivalRelayWalkRunLine_Obj * this /* r16 */, class clsModelType_OB_TX_MO_MA * pcModelAT /* r17 */, class _NNS_TEXLIST * psTexAT /* r30 */, class clsModelType_OB_TX_MO * pcModelLine /* r21 */, class _NNS_TEXLIST * psTexLine /* r29+0xAC */, float (* psMtxPal)[4][4] /* r20 */, unsigned int * psNodeStat /* r19 */, float (* opaNnViewMtx)[4][4] /* r18 */, float (* psMtxWork)[4][4] /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53BC20 -> 0x53BEB8
        class clsSurvivalRelayRace_Task & rcSurvivalRelayRace_Task; // r2
        class NNS_OBJECT * psObject; // r23
        float sMtx[4][4]; // r29+0xB0
    }
}


// Range: 0x53BEC0 -> 0x53C4C8
void execute(class clsSurvivalRelayWalkRunLine_Obj * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53BEC0 -> 0x53C4C8
        class clsSurvivalRelayRace_Task & rcSurvivalRelayRace_Task; // r20
        float sPlayerMtx[4][4]; // r29+0x150
        float sMtx[4][4]; // r29+0x110
        class NNS_VECTORFAST sPlayer; // r29+0x100
        class NNS_VECTORFAST sStGate; // r29+0xF0
        class NNS_VECTORFAST sVec; // r29+0xE0
        class NNS_VECTORFAST sATVec; // r29+0xD0
        class NNS_VECTORFAST sPosVec; // r29+0xC0
        class NNS_VECTORFAST sPlayerUpVec; // r29+0xB0
        class NNS_VECTORFAST sObjUpVec; // r29+0xA0
        class NNS_VECTORFAST sObjPosVec; // r29+0x90
        class clsPlayerTask * pcPlayer; // r2
        class clsPlayerTask * pcNextPlayer; // r2
        class stcData * posNextCharaData; // r2
        signed int s32PlayerLap; // r19
        signed int s32NextPlayerLap; // r22
        float f32Length; // r29+0x1A0
        class clsPlayerTask * pcNextPlayer; // r2
    }
}


// Range: 0x53C4D0 -> 0x53C4E8
void reset(class clsSurvivalRelayWalkRunLine_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53C4D0 -> 0x53C4E8
    }
...
// Range: 0x53C4F0 -> 0x53C5DC
void * __ct(class clsSurvivalRelayWalkRunLine_Obj * this /* r17 */, signed int s32TeamNo /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53C4F0 -> 0x53C5DC
    }
