/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\SurvivalBall\SurvivalBall.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x687770
class _strGyroData gsGyroData[4]; // size: 0xF0, address: 0x636780
struct /* @anon11 */ {
    // total size: 0x48
} __vt__24clsSurvivalBallBall_Task; // size: 0x48, address: 0x6C4CF0
void * __dt(class clsSurvivalBallBall_Obj *, signed short); // size: 0x0, address: 0x4422A0
struct /* @anon5 */ {
    // total size: 0x48
} __vt__100clsBaseGimmickBody<24clsSurvivalBallBall_Task,23clsSurvivalBallBall_Obj,25clsSurvivalBallBallModels>; // size: 0x48, address: 0x6C4DC0
struct /* @anon17 */ {
    // total size: 0x30
...
struct /* @anon0 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon16 */ {
    // total size: 0x28
} __vt__9clsObject; // size: 0x28, address: 0x6B5C10
struct /* @anon18 */ {
    // total size: 0x28
} __vt__12clsCollision; // size: 0x28, address: 0x6BB1C0
struct /* @anon7 */ {
    // total size: 0x34
} __vt__23clsBaseThroughCollision; // size: 0x34, address: 0x6BB180
struct /* @anon20 */ {
    // total size: 0x34
} __vt__28clsSurvivalBallBallCollision; // size: 0x34, address: 0x6C4D70
struct /* @anon8 */ {
    // total size: 0xAC
} __vt__23clsSurvivalBallBall_Obj; // size: 0xAC, address: 0x6C4E10
struct /* @anon4 */ {
    // total size: 0x44
} __vt__13clsGimmickObj; // size: 0x44, address: 0x6BB340
struct /* @anon9 */ {
    // total size: 0xC
} __vt__23clsHaveGimmickRigidBody; // size: 0xC, address: 0x6BAFB0
...
struct /* @anon10 */ {
    // total size: 0x20
} __vt__12clsRigidBody; // size: 0x20, address: 0x6BAF70
struct /* @anon6 */ {
    // total size: 0x20
} __vt__19clsGimmickRigidBody; // size: 0x20, address: 0x6BAF90
struct /* @anon15 */ {
    // total size: 0x24
} __vt__21clsGimmickUnaryAction; // size: 0x24, address: 0x6BAF40
struct /* @anon23 */ {
    // total size: 0x28
} __vt__23clsGravityActionControl; // size: 0x28, address: 0x6BAF10
void * __dt(class clsDebriPartsBase *, signed short); // size: 0x0, address: 0x2C81B0
struct /* @anon12 */ {
    // total size: 0x28
} __vt__17clsDebriPartsBase; // size: 0x28, address: 0x6C1600
...
class clsSurvivalBallBall_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A760
...
void * __ct(class clsSurvivalBallBall_Obj *); // size: 0x0, address: 0x445CB0
struct /* @anon22 */ {
    // total size: 0xC
} __vt__40clsSingleton<24clsSurvivalBallBall_Task>; // size: 0xC, address: 0x6C4DA8
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x6877C0
class clsSurvivalBallPointRing_Task * m_tpcSingleton; // size: 0x4, address: 0xB17220
struct /* @anon2 */ {
    // total size: 0xC
} __vt__14clsSe3DControl; // size: 0xC, address: 0x6BBB18
struct /* @anon1 */ {
    // total size: 0x28
} __vt__29clsGravitySurvivalBallControl; // size: 0x28, address: 0x6C4D40
class clsGravityGimmickParam * t_pocGravityGimmickParam[3]; // size: 0xC, address: 0x653410
class stcInfo oasGroundInfo[]; // size: 0x0, address: 0x6803C0
float t_of32WeightTypeSuperLight; // size: 0x4, address: 0x665190
float hkConvexShapeDefaultRadius; // size: 0x4, address: 0x6223B8
struct /* @anon13 */ {
    // total size: 0x10
} __vt__24hkAllCdBodyPairCollector; // size: 0x10, address: 0x6B70F0
struct /* @anon3 */ {
    // total size: 0x10
} __vt__21hkCdBodyPairCollector; // size: 0x10, address: 0x6B6640
struct /* @anon24 */ {
    // total size: 0xC
...
class hkArray {
    // total size: 0xC
public:
    class hkRootCdBodyPair * m_data; // offset 0x0, size 0x4
...
class clsFlag {
    // total size: 0x4
public:
    enum enmBonusFlag m_tData; // offset 0x0, size 0x4
};
...
class clsSurvivalBallPointRing_Task : public clsSingleModelGimmick_Task {
    // total size: 0xC4
public:
    class hkShape * m_pcPhantomShape[3]; // offset 0xAC, size 0xC
    class hkShape * m_pcRigidShape[3]; // offset 0xB8, size 0xC
};
class __vector_imp : private __vector_pod, private compile_assert {
    // total size: 0xC
};
...
class clsSurvivalBallBall_Task : public clsBaseGimmickBody {
    // total size: 0x1A0
public:
    float m_u32MatFrame; // offset 0x17C, size 0x4
    class clsSurvivalBallBallSetData * m_pcObjArray; // offset 0x180, size 0x4
    class clsBallHolder2D_Task * m_pcBallHolder2D; // offset 0x184, size 0x4
    class vector m_vecSetDataArray; // offset 0x188, size 0xC
    class vector m_vecUnusedSetDataArray; // offset 0x194, size 0xC
};
...
class clsSurvivalBallBall_Obj : public clsRigidBodyGimmickObj {
    // total size: 0x190
public:
    class hkShape * m_pcShape; // offset 0xD0, size 0x4
    class clsTask * m_psParticle; // offset 0xD4, size 0x4
    class clsSurvivalBallBallEffect_Task * m_psLookOnEffect; // offset 0xD8, size 0x4
    class clsSurvivalBallBallEffect_Task * m_psBomeEffect; // offset 0xDC, size 0x4
    class NNS_VECTORFAST m_sDrawBreakPosVec; // offset 0xE0, size 0x10
    float m_f32Scale; // offset 0xF0, size 0x4
    unsigned char m_bCheckBallFlag; // offset 0xF4, size 0x1
    unsigned char m_bGravityEffectFlag; // offset 0xF5, size 0x1
    unsigned char m_bBallBombFlag; // offset 0xF6, size 0x1
    unsigned int m_u32RangeEffectFlag; // offset 0xF8, size 0x4
    signed int m_as32GyroCount[4]; // offset 0xFC, size 0x10
    signed int m_s32CountDownFrame; // offset 0x10C, size 0x4
    signed int m_s32RebirthFrame; // offset 0x110, size 0x4
    unsigned int m_u32EffectFlag; // offset 0x114, size 0x4
    float m_f32LostOwnerCount; // offset 0x118, size 0x4
    float m_f32MatMotionAddFrame; // offset 0x11C, size 0x4
    enum enmDrawType m_aeEffectDraw[5]; // offset 0x120, size 0x14
    enum enmDrawType m_aeOldEffectDraw[5]; // offset 0x134, size 0x14
    class clsSurvivalBallBallCollision m_cCollision; // offset 0x148, size 0x10
    enum enmSurvivalBallBallMode m_eMoveMode; // offset 0x158, size 0x4
    class clsRetPath m_cRetCoursePath; // offset 0x15C, size 0x20
    class clsSe3DControl * m_pcSe3DControl; // offset 0x17C, size 0x4
    unsigned char m_bSePlayFlg; // offset 0x180, size 0x1
    float m_f32SeBlingFrame; // offset 0x184, size 0x4
};
class _NNS_TEXLIST {
    // total size: 0x8
public:
...
class hkContactPointConfirmedEvent {
    // total size: 0x24
public:
    class hkCollidable * m_collidableA; // offset 0x0, size 0x4
    class hkCollidable * m_collidableB; // offset 0x4, size 0x4
    class hkEntity * m_callbackFiredFrom; // offset 0x8, size 0x4
    class hkContactPoint * m_contactPoint; // offset 0xC, size 0x4
    class hkContactPointMaterial * m_contactPointMaterial; // offset 0x10, size 0x4
    float m_rotateNormal; // offset 0x14, size 0x4
    float m_projectedVelocity; // offset 0x18, size 0x4
    class hkEnum m_type; // offset 0x1C, size 0x4
    class hkSimpleContactConstraintData * m_contactData; // offset 0x20, size 0x4
};
...
class clsSurvivalBallBallCollision : public clsBaseThroughCollision {
    // total size: 0x10
public:
    unsigned char m_u8HitFlag; // offset 0x8, size 0x1
    class clsSurvivalBallBall_Obj * m_pcSurvivalBallBall_Obj; // offset 0xC, size 0x4
};
class hkArray {
    // total size: 0xC
public:
...
class clsGravityControl : public clsBaseGravityAction {
    // total size: 0xB0
public:
    class NNS_VECTORFAST m_sUpVecFast; // offset 0x20, size 0x10
    class NNS_QUATERNION m_sBaseQuat; // offset 0x30, size 0x10
    class clsSimpleShapePhantom * m_pcPhantom; // offset 0x40, size 0x4
    class clsTask * m_pcEffectCharge_Task; // offset 0x44, size 0x4
    class clsTask * m_pcEffectWrist_Task; // offset 0x48, size 0x4
    class clsTask * m_pcEffectLine_Task; // offset 0x4C, size 0x4
    enum enmType m_eType; // offset 0x50, size 0x4
    class clsFlag m_cStatus; // offset 0x54, size 0x4
    class clsFlag m_cBonus; // offset 0x58, size 0x4
    unsigned char m_eFlag; // offset 0x5C, size 0x1
    unsigned char m_bChangeGravity; // offset 0x5D, size 0x1
    float m_f32LeverRateX; // offset 0x60, size 0x4
    float m_f32LeverRateY; // offset 0x64, size 0x4
    float m_f32LeverTimeX; // offset 0x68, size 0x4
    float m_f32LeverTimeY; // offset 0x6C, size 0x4
    float m_f32VelocityRadX; // offset 0x70, size 0x4
    float m_f32VelocityRadY; // offset 0x74, size 0x4
    float m_f32PosturalRadX; // offset 0x78, size 0x4
    float m_f32PosturalRadY; // offset 0x7C, size 0x4
    float m_f32Frame; // offset 0x80, size 0x4
    float m_f32FaceRate; // offset 0x84, size 0x4
    float m_f32ChargeFrame; // offset 0x88, size 0x4
    float m_f32RotateAcceleRate; // offset 0x8C, size 0x4
    float m_f32WeightMinSpeed; // offset 0x90, size 0x4
    float m_f32WeightReadyFrame; // offset 0x94, size 0x4
    float m_f32LimitFrame; // offset 0x98, size 0x4
    float m_f32RotateAcceleRadX; // offset 0x9C, size 0x4
    float m_f32TrickFrameRate; // offset 0xA0, size 0x4
    float m_f32TrickDecceleFrame; // offset 0xA4, size 0x4
    signed char m_as8AdjustKeyTable[4]; // offset 0xA8, size 0x4
};
class hkArray {
    // total size: 0xC
public:
...
class _strGyroData {
    // total size: 0x3C
public:
    class NNS_VECTOR sView[4]; // offset 0x0, size 0x30
    class NNS_VECTOR sScale; // offset 0x30, size 0xC
};
enum enmSystemFlag {
...
class clsSurvivalBallBallModels {
    // total size: 0xF0
public:
    class clsModelType_OB_TX_MO_MA m_cModelBall; // offset 0x0, size 0x20
    class clsModelType_OB_TX_MO_MA m_cModelRange; // offset 0x20, size 0x20
    class clsModelType_OB_TX_MO m_cModelLookOn; // offset 0x40, size 0x10
    class clsModelType_OB_TX_MO_MA m_cModelGyroG; // offset 0x50, size 0x20
    class clsModelType_OB_TX_MO_MA m_cModelGyroR; // offset 0x70, size 0x20
    class clsModelType_OB_TX_MO_MA m_cModelEffect; // offset 0x90, size 0x20
    class clsModelType_OB_TX_MO_MA m_cModelBlink; // offset 0xB0, size 0x20
    class clsModelType_OB_TX_MO_MA m_cModelBomb; // offset 0xD0, size 0x20
};
class clsSingleton {
    // total size: 0x4
};
...
class clsBallHolder2D_Task : public clsTask {
    // total size: 0x98
public:
    class clsSurvivalBallBall_Task * m_pcBall; // offset 0x54, size 0x4
    class clsScore2D_Task * m_pcScore2D; // offset 0x58, size 0x4
    class stcPoint2D_s16 m_sBallPos; // offset 0x5C, size 0x4
    class stcPoint2D_s16 m_sCharaPos; // offset 0x60, size 0x4
    class stcPoint2D_s16 m_sOldCharaPos; // offset 0x64, size 0x4
    signed int m_s32BallWidth; // offset 0x68, size 0x4
    signed int m_s32BallHeight; // offset 0x6C, size 0x4
    signed int m_s32Rot; // offset 0x70, size 0x4
    signed int m_s32RotAdd; // offset 0x74, size 0x4
    signed int m_s32ViewNum; // offset 0x78, size 0x4
    float m_s32MapHalfWidth; // offset 0x7C, size 0x4
    float m_s32BallRotCenterOffset; // offset 0x80, size 0x4
    float m_f32IconScale; // offset 0x84, size 0x4
    signed char m_s8PauseFrame; // offset 0x88, size 0x1
    unsigned char m_u8Alpha; // offset 0x89, size 0x1
    signed char m_s8CharaType; // offset 0x8A, size 0x1
    signed char m_s8OldCharaType; // offset 0x8B, size 0x1
    unsigned char m_u8CharaAlpha; // offset 0x8C, size 0x1
    unsigned char m_u8OldCharaAlpha; // offset 0x8D, size 0x1
    unsigned char m_bMoveHolderFlg; // offset 0x8E, size 0x1
    unsigned char m_bShotCharaIcon; // offset 0x8F, size 0x1
    unsigned int m_u32OldCharaFrame; // offset 0x90, size 0x4
    signed char m_s8HolderPlayerNo; // offset 0x94, size 0x1
};
class ContactRef {
    // total size: 0xC
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x17C
public:
    class clsSurvivalBallBall_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsSurvivalBallBallModels m_cModel; // offset 0x88, size 0xF0
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0x178, size 0x4
};
...
class clsSurvivalBallBallEffect_Task : public clsTask {
    // total size: 0x240
public:
    enum enmDrawType * m_peDrawFlag; // offset 0x54, size 0x4
    unsigned int m_eEffectType; // offset 0x58, size 0x4
    unsigned int * m_pu32EffectFlag; // offset 0x5C, size 0x4
    class NNS_VECTORFAST * m_psPosVec; // offset 0x60, size 0x4
    class NNS_VECTORFAST m_asAfterimagePosVec[20]; // offset 0x70, size 0x140
    float m_asMatMotionFrame[20]; // offset 0x1B0, size 0x50
    class clsPlaySe_2D * m_pcPlaySe2D; // offset 0x200, size 0x4
    signed int m_s32SePlayFrame; // offset 0x204, size 0x4
    unsigned int m_u32BreakPlayerFlag; // offset 0x208, size 0x4
    float m_f32Scale; // offset 0x20C, size 0x4
    float m_f32AddScale; // offset 0x210, size 0x4
    float m_f32MotionFrame; // offset 0x214, size 0x4
    float m_f32MotionAddFrame; // offset 0x218, size 0x4
    float m_f32MatMotionFrame; // offset 0x21C, size 0x4
    signed int m_s32ViewNo; // offset 0x220, size 0x4
    signed int m_s32Count; // offset 0x224, size 0x4
    signed int m_s32GetPosCount; // offset 0x228, size 0x4
    signed int m_s32AfterimageCountMax; // offset 0x22C, size 0x4
    float m_f32Speed; // offset 0x230, size 0x4
};
class map {
    // total size: 0x18
public:
...
class hkMassProperties {
    // total size: 0x50
public:
    float m_volume; // offset 0x0, size 0x4
    float m_mass; // offset 0x4, size 0x4
    class hkVector4 m_centerOfMass; // offset 0x10, size 0x10
    class hkMatrix3 m_inertiaTensor; // offset 0x20, size 0x30
};
class __vector_deleter {
    // total size: 0xC
public:
...
class clsSurvivalBallPointRing_Obj : public clsRigidBodyGimmickObj {
    // total size: 0x100
public:
    enum enmSurvivalBallPointRingMode m_enMode; // offset 0xD0, size 0x4
    enum enmSurvivalBallPointRingPoint m_enPointType; // offset 0xD4, size 0x4
    class clsSurvivalBallPointRing_Collision m_cThroughCollision; // offset 0xD8, size 0xC
    unsigned int m_u32SetType; // offset 0xE4, size 0x4
    class clsPlaySe_2D * m_pcPlayGoalSe2D; // offset 0xE8, size 0x4
    float m_f32GoalMotionFrame; // offset 0xEC, size 0x4
    unsigned int m_u32RstartCount; // offset 0xF0, size 0x4
};
...
class hkInplaceArray : public hkArray {
    // total size: 0x10C
public:
    class hkRootCdBodyPair m_storage[16]; // offset 0xC, size 0x100
};
class __tree : private __red_black_tree {
    // total size: 0x18
public:
...
class hkRigidBodyCinfo {
    // total size: 0xC0
public:
    unsigned int m_collisionFilterInfo; // offset 0x0, size 0x4
    class hkShape * m_shape; // offset 0x4, size 0x4
    class hkEnum m_collisionResponse; // offset 0x8, size 0x1
    unsigned short m_processContactCallbackDelay; // offset 0xA, size 0x2
    class hkVector4 m_position; // offset 0x10, size 0x10
    class hkQuaternion m_rotation; // offset 0x20, size 0x10
    class hkVector4 m_linearVelocity; // offset 0x30, size 0x10
    class hkVector4 m_angularVelocity; // offset 0x40, size 0x10
    class hkMatrix3 m_inertiaTensor; // offset 0x50, size 0x30
    class hkVector4 m_centerOfMass; // offset 0x80, size 0x10
    float m_mass; // offset 0x90, size 0x4
    float m_linearDamping; // offset 0x94, size 0x4
    float m_angularDamping; // offset 0x98, size 0x4
    float m_friction; // offset 0x9C, size 0x4
    float m_restitution; // offset 0xA0, size 0x4
    float m_maxLinearVelocity; // offset 0xA4, size 0x4
    float m_maxAngularVelocity; // offset 0xA8, size 0x4
    float m_allowedPenetrationDepth; // offset 0xAC, size 0x4
    class hkEnum m_motionType; // offset 0xB0, size 0x1
    class hkEnum m_rigidBodyDeactivatorType; // offset 0xB1, size 0x1
    class hkEnum m_solverDeactivation; // offset 0xB2, size 0x1
    class hkEnum m_qualityType; // offset 0xB3, size 0x1
    signed char m_autoRemoveLevel; // offset 0xB4, size 0x1
    class hkBool m_forceCollideOntoPpu; // offset 0xB5, size 0x1
};
...
class clsFlag {
    // total size: 0x4
public:
    enum enmStatus m_tData; // offset 0x0, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsSurvivalBallPointRing_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
...
enum enmStatus {
    STATUS_CLEAR = 0,
    STATUS_NOTAGP_TRIGGER = 1,
    STATUS_NOTAGP_ALWAYS = 2,
    STATUS_MASK_NOTAGP = 3,
};
class hkArray {
    // total size: 0xC
public:
...
class hkRootCdBodyPair {
    // total size: 0x10
public:
    class hkCollidable * m_rootCollidableA; // offset 0x0, size 0x4
    unsigned int m_shapeKeyA; // offset 0x4, size 0x4
    class hkCollidable * m_rootCollidableB; // offset 0x8, size 0x4
    unsigned int m_shapeKeyB; // offset 0xC, size 0x4
};
...
class clsSurvivalBallBallSetData {
    // total size: 0x8
public:
    class stcSetDataDetail * m_psSetDataDetail; // offset 0x0, size 0x4
    signed int m_s32SetDataNo; // offset 0x4, size 0x4
};
class clsOOStlAllocator {
    // total size: 0x4
public:
...
class hkAllCdBodyPairCollector : public hkCdBodyPairCollector {
    // total size: 0x114
public:
    class hkInplaceArray m_hits; // offset 0x8, size 0x10C
};
class stcMotionCam1 {
    // total size: 0x34
public:
...
class clsSurvivalBallPointRing_Collision : public clsBaseThroughCollision {
    // total size: 0xC
public:
    class clsSurvivalBallPointRing_Obj * m_pcSurvivalBallPointRing_Obj; // offset 0x8, size 0x4
};
class hkArray {
    // total size: 0xC
public:
...
class hkConvexShape : public hkSphereRepShape {
    // total size: 0x14
public:
    float m_radius; // offset 0x10, size 0x4
};
...
// Range: 0x4423F0 -> 0x4424F0
void draw(class clsSurvivalBallBall_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4423F0 -> 0x4424F0
        class clsSurvivalBallRace_Task & rcSurvivalBallRace_Task; // r2
...
// Range: 0x4424F0 -> 0x442890
void execute(class clsSurvivalBallBall_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4424F0 -> 0x442890
        class clsModelType_OB_TX_MO_MA * pcModelRange; // r2
        class clsModelType_OB_TX_MO * pcModelLookOn; // r2
        class clsModelType_OB_TX_MO_MA * pcModelGyroG; // r2
        class clsModelType_OB_TX_MO_MA * pcModelGyroR; // r2
        unsigned int u32Num; // r2
        float * pf32Frame; // r2
        unsigned int u32i; // r18
    }
...
// Range: 0x442890 -> 0x442A70
void searchBallPos(class clsSurvivalBallBall_Task * this /* r16 */, class NNS_VECTORFAST * copsPos /* r21 */, class NNS_VECTORFAST * copsDir /* r17 */, class NNS_VECTORFAST * psPos /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x442890 -> 0x442A70
        unsigned int u32i; // r19
        float f32BackLength; // r21
        float f32NewLength; // r20
        unsigned int u32Num; // r2
        class NNS_VECTOR sCheckPosVec; // r29+0xB0
        class NNS_VECTOR sCheckDirVec; // r29+0xA0
        class NNS_VECTOR sBackPosVec; // r29+0x90
        class NNS_VECTOR sDirVec; // r29+0x80
        float f32Length; // r22
        float f32Dot; // r29+0xC0
    }
}


// Range: 0x442A70 -> 0x442AE0
void reset(class clsSurvivalBallBall_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x442A70 -> 0x442AE0
        unsigned int u32Num; // r2
...
// Range: 0x442AE0 -> 0x442C58
void init(class clsSurvivalBallBall_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x442AE0 -> 0x442C58
    }
...
// Range: 0x442C60 -> 0x4436B0
void createModel(class clsSurvivalBallBall_Task * this /* r2 */, class stcBinInfo & rsBinInfoI /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x442C60 -> 0x4436B0
        unsigned int u32CalcObjNum; // r2
        class clsModelType_OB_TX_MO_MA * pcModelRange; // r20
        class clsModelType_OB_TX_MO * pcModelLookOn; // r29+0xA0
        class clsModelType_OB_TX_MO_MA * pcModelGyroG; // r19
        class clsModelType_OB_TX_MO_MA * pcModelGyroR; // r22
        class clsModelType_OB_TX_MO_MA * pcModelEffect; // r23
        class clsModelType_OB_TX_MO_MA * pcModelBlink; // r30
        class clsModelType_OB_TX_MO_MA * pcModelBomb; // r18
    }
}


// Range: 0x4436B0 -> 0x443920
void * __ct(class clsSurvivalBallBall_Task * this /* r18 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4436B0 -> 0x443920
        unsigned int u32i; // r17
...
// Range: 0x443C90 -> 0x4441C4
void drawGyro(class clsSurvivalBallBall_Obj * this /* r21 */, class clsModelType_OB_TX_MO_MA & rcModelG /* r2 */, class clsModelType_OB_TX_MO_MA & rcModelR /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x443C90 -> 0x4441C4
        class clsPlayerTask * pcPlayer; // r2
        class clsSurvivalBallRace_Task & rcSurvivalBallRace_Task; // r2
        float (* psMtxPal)[4][4]; // r30
        unsigned int * psNodeStat; // r19
        class NNS_VECTORFAST sPointVec; // r29+0x150
        float f32TempAngleFwd; // r24
        float f32Length; // r29+0x170
        float sMtx[4][4]; // r29+0x110
        class _strGyroData * psGyroData; // r2
        class NNS_VECTOR * psScale; // r2
        class NNS_VECTOR * psViewPos; // r2
        class NNS_OBJECT * psObject; // r18
        class _NNS_TEXLIST * psTexList; // r29+0x100
        class NNS_MOTION * psMotion; // r29+0xF0
        class NNS_OBJECT * psMatMotObj; // r23
        class NNS_MOTION * psMatMotion; // r29+0xE0
        float f32MotionFrame; // r23
        float f32MatMotionFrame; // r22
        float f32Seale; // r21
        signed int s32x; // r29+0x16C
        signed int s32y; // r29+0x168
    }
}


// Range: 0x4441D0 -> 0x444434
void drawBall(class clsSurvivalBallBall_Obj * this /* r20 */, class clsModelType_OB_TX_MO_MA & rcModel /* r19 */, float (* psMtxWork)[4][4] /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4441D0 -> 0x444434
        float (* psMtxPal)[4][4]; // r22
        unsigned int * psNodeStat; // r17
        class NNS_OBJECT * psObject; // r16
        float sMtx[4][4]; // r29+0xE0
    }
}


// Range: 0x444440 -> 0x44455C
void draw(class clsSurvivalBallBall_Obj * this /* r17 */, class clsSurvivalBallBallModels & rcModel /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x444440 -> 0x44455C
        float sMtxWork[4][4]; // r29+0x30
    }
}


// Range: 0x444560 -> 0x44481C
void main(class clsSurvivalBallBall_Obj * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x444560 -> 0x44481C
        signed int s32Max; // r2
        signed int i; // r20
...
// Range: 0x444820 -> 0x444D78
void execute(class clsSurvivalBallBall_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x444820 -> 0x444D78
        class clsSurvivalBallRace_Task & rcSurvivalBallRace_Task; // r2
...
// Range: 0x444D80 -> 0x444EC8
void callbackContactTriggerRigidBody(class clsSurvivalBallBall_Obj * this /* r16 */, class hkContactPointConfirmedEvent & cEvent /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x444D80 -> 0x444EC8
        class stcInfo * rcColInfo; // r2
    }
}


// Range: 0x444ED0 -> 0x444F28
void contactInterraction(class clsSurvivalBallBall_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x444ED0 -> 0x444F28
    }
...
// Range: 0x444F30 -> 0x444F9C
void requestDrawBreakEffect(class clsSurvivalBallBall_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x444F30 -> 0x444F9C
    }
...
// Range: 0x444FA0 -> 0x445108
void contactTriggerEvent(class clsSurvivalBallBall_Obj * this /* r17 */, class hkContactPoint * pcContact /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x444FA0 -> 0x445108
        class clsPlayerTask * pcPlayer; // r16
        class NNS_VECTORFAST sDirVec; // r29+0xA0
        class hkVector4 cLinearVelocity; // r29+0x90
    }
}


// Range: 0x445110 -> 0x4454E4
void searchPointRing(class clsSurvivalBallBall_Obj * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x445110 -> 0x4454E4
        class clsSurvivalBallPointRing_Task * pcPointRingTask; // r2
        unsigned int u32Num; // r2
        unsigned int u32i; // r20
        float f32Length; // r20
        signed int s32RingNo; // r19
        class NNS_SPHERE sSphere; // r29+0x190
        class NNS_CAPSULE sCapsule; // r29+0x170
        class NNS_VECTORFAST sPlayerPos; // r29+0x160
        class NNS_VECTORFAST sPlayerDir; // r29+0x150
        class clsGravityControl * pcGravityControl; // r2
        class NNS_QUATERNION sCalQuat; // r29+0x140
        class NNS_VECTORFAST sRingPos; // r29+0x130
        class NNS_VECTORFAST sRingDir; // r29+0x120
        class NNS_VECTORFAST sPlayerRingDir; // r29+0x110
        float f32NowLength; // r29+0x1A0
    }
}


// Range: 0x4454F0 -> 0x445730
void reset(class clsSurvivalBallBall_Obj * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4454F0 -> 0x445730
        class NNS_VECTORFAST sPosVec; // r29+0xF0
        class NNS_VECTORFAST sDirVec; // r29+0xE0
        class NNS_VECTORFAST sDstPosVec; // r29+0xD0
        signed int i; // r20
        signed char s8Ranking; // r22
        signed int s32Max; // r2
        class clsPlayerTask * pcPlayer; // r2
    }
}
...
// Range: 0x445730 -> 0x4457E8
void destroyData(class clsSurvivalBallBall_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x445730 -> 0x4457E8
    }
...
// Range: 0x4457F0 -> 0x445CA4
void createData(class clsSurvivalBallBall_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4457F0 -> 0x445CA4
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0xD0
        class NNS_VECTOR sPosition; // r29+0x190
        class hkVector4 cBox; // r29+0xC0
        class hkSphereShape * pcSphereShape; // r2
        class hkMassProperties massProperties; // r29+0x70
        class hkVector4 cOffset; // r29+0x60
        class clsSurvivalBallRace_Task & rcSurvivalBallRace_Task; // r2
    }
}


// Range: 0x445CB0 -> 0x445F64
void * __ct(class clsSurvivalBallBall_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x445CB0 -> 0x445F64
    }
...
// Range: 0x446000 -> 0x4461FC
void execute(class clsSurvivalBallBallCollision * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x446000 -> 0x4461FC
        class hkAllCdBodyPairCollector cCollecter; // r29+0x60
        unsigned int u32Flag; // r18
        signed int i; // r17
    }
}
