/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage11\GlinkCylinder\St11GlinkCylinderManager.cpp
...
void * __dt(class clsGlinkCylinder_Object *, signed short); // size: 0x0, address: 0x4AA470
struct /* @anon14 */ {
    // total size: 0xB4
...
struct /* @anon4 */ {
    // total size: 0xB8
} __vt__23clsGlinkCylinder_Object; // size: 0xB8, address: 0x6C8A10
struct /* @anon0 */ {
    // total size: 0x44
...
void * __ct(class clsGlinkCylinder_Object *); // size: 0x0, address: 0x4AA650
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x68AC20
...
// Range: 0x4AA260 -> 0x4AA33C
void draw(class clsGlinkCylinderManager_Obj * this /* r30 */, class NNS_OBJECT * psObject /* r22 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r20 */, float (* opaNnViewMtx)[4][4] /* r19 */, float (* psMtxWork)[4][4] /* r18 */, unsigned int u32ViewNo /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4AA260 -> 0x4AA33C
        unsigned int u32Num; // r17
        class clsGlinkCylinder_Object * pcObj; // r16
    }
}


// Range: 0x4AA340 -> 0x4AA40C
void execute(class clsGlinkCylinderManager_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4AA340 -> 0x4AA40C
        unsigned int u32Num; // r18
        class clsGlinkCylinder_Object * pcObj; // r17
        unsigned int u32Check; // r16
    }
}


// Range: 0x4AA410 -> 0x4AA46C
void destroyData(class clsGlinkCylinderManager_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4AA410 -> 0x4AA46C
    }
...
// Range: 0x4AA530 -> 0x4AA650
void createData(class clsGlinkCylinderManager_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4AA530 -> 0x4AA650
        class clsGlinkCylinder_Object * pcCylinder; // r20
        class stcSetDataDetail * psSetData; // r19
        unsigned int u32Num; // r18
        unsigned int u32PathNo; // r2
        float f32StartWaitFrame; // r22
        float f32Speed; // r21
        float f32Interbval; // r20
    }
}


// Range: 0x4AA7A0 -> 0x4AA818
void reset(class clsGlinkCylinderManager_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4AA7A0 -> 0x4AA818
        unsigned int u32Num; // r17
...
// Range: 0x4AA820 -> 0x4AA8AC
void contactTriggerEvent(class clsGlinkCylinderThroughCol * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4AA820 -> 0x4AA8AC
    }
...
// Range: 0x4AA8D0 -> 0x4AA8D8
void @80@__dt__23clsGlinkCylinder_ObjectFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4AA8D0 -> 0x4AA8D8
    }
