/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Control\DebriPartsRigid.cpp
...
// Range: 0x3BB960 -> 0x3BBC54
void startBreak(class clsDebriPartsRigid * this /* r18 */, class NNS_VECTORFAST * psPosVecFast /* r19 */, class NNS_VECTORFAST * psVelocityVecFast /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BB960 -> 0x3BBC54
        class clsRigidBody * pcRigidBody; // r17
        class hkVector4 cVelocity; // r29+0x90
        class NNS_QUATERNION sRotQuat; // r29+0x80
    }
}


// Range: 0x3BBC60 -> 0x3BBF00
void draw(class clsDebriPartsRigid * this /* r17 */, class NNS_OBJECT * psObject /* r16 */, float f32ClipSqDist /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BBC60 -> 0x3BBF00
        float sMtx[4][4]; // r29+0xC0
        float (* psMtxPal)[4][4]; // r20
        unsigned int * psNodeStatus; // r19
    }
}


// Range: 0x3BBF00 -> 0x3BC08C
void update(class clsDebriPartsRigid * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BBF00 -> 0x3BC08C
        class clsRigidBody * pcRigidBody; // r17
...
// Range: 0x3BC090 -> 0x3BC170
void create(class clsDebriPartsRigid * this /* r17 */, class hkRigidBodyCinfo & rcRigidBodyInfo /* r19 */, class clsObject * pcObject /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BC090 -> 0x3BC170
    }
...
// Range: 0x3BC170 -> 0x3BC22C
void reset(class clsDebriPartsRigid * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BC170 -> 0x3BC22C
        class hkVector4 cZero; // r29+0x30
