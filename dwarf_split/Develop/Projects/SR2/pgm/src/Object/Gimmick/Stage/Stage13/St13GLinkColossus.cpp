/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage13\St13GLinkColossus.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x68A978
float tof32ClipSqDist; // size: 0x4, address: 0x68A988
class clsGravityGimmickParam t_ocGravityGimmickParam[2]; // size: 0xF0, address: 0x68A990
struct /* @anon9 */ {
    // total size: 0x48
} __vt__21clsGLinkColossus_Task; // size: 0x48, address: 0x6C86C0
struct /* @anon16 */ {
    // total size: 0x48
} __vt__98clsSingleModelGimmick_Task<21clsGLinkColossus_Task,23clsGLinkColossus_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C8830
struct /* @anon11 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsGLinkColossus_Task * m_tpcSingleton; // size: 0x4, address: 0xB17AD0
struct /* @anon2 */ {
    // total size: 0xC
} __vt__37clsSingleton<21clsGLinkColossus_Task>; // size: 0xC, address: 0x6C87C8
void * __dt(class clsGLinkColossus_Object *, signed short); // size: 0x0, address: 0x4A6F60
struct /* @anon8 */ {
    // total size: 0x48
} __vt__90clsBaseGimmickBody<21clsGLinkColossus_Task,23clsGLinkColossus_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C87E0
struct /* @anon6 */ {
    // total size: 0xB4
} __vt__24clsBaseGravityLinkObject; // size: 0xB4, address: 0x6C1420
struct /* @anon0 */ {
    // total size: 0xB8
} __vt__23clsGLinkColossus_Object; // size: 0xB8, address: 0x6C8710
struct /* @anon14 */ {
    // total size: 0x28
...
void * __ct(class clsGLinkColossus_Object *); // size: 0x0, address: 0x4A77E0
...
class clsGLinkColossus_Task : public clsSingleModelGimmick_Task {
    // total size: 0x98
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsGLinkColossus_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x4A7000 -> 0x4A7070
void reset(class clsGLinkColossus_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A7000 -> 0x4A7070
...
// Range: 0x4A7070 -> 0x4A728C
void draw(class clsGLinkColossus_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A7070 -> 0x4A728C
...
// Range: 0x4A7290 -> 0x4A7370
void execute(class clsGLinkColossus_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A7290 -> 0x4A7370
        unsigned int u32Num; // r2
...
// Range: 0x4A7370 -> 0x4A748C
void * __ct(class clsGLinkColossus_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A7370 -> 0x4A748C
...
// Range: 0x4A7850 -> 0x4A78D0
void destroyData(class clsGLinkColossus_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A7850 -> 0x4A78D0
    }
...
// Range: 0x4A78D0 -> 0x4A7D94
void createData(class clsGLinkColossus_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A78D0 -> 0x4A7D94
...
void drawEffect(class clsPlayerTask * pcPlayer /* r16 */) {
    ...
    /* anonymous block */ {
        ...
        class NNS_VECTOR LOCAL_POS_R; // @ 0x0068AAB0
        class NNS_VECTOR LOCAL_POS; // @ 0x0068AAA0
        class NNS_VECTOR RAND_SP; // @ 0x0068AA90
        float LIFE_FRAME; // @ 0x0068AAC0
        class NNS_VECTOR BEGIN_SP; // @ 0x0068AA80
    }
}


// Range: 0x4A7ED0 -> 0x4A7F14
void requestDrawBreakEffect(class clsGLinkColossus_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A7ED0 -> 0x4A7F14
    }
...
// Range: 0x4A7F20 -> 0x4A7F40
void main(class clsGLinkColossus_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A7F20 -> 0x4A7F40
    }
...
// Range: 0x4A7F40 -> 0x4A8058
void reset(class clsGLinkColossus_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A7F40 -> 0x4A8058
...
// Range: 0x4A8060 -> 0x4A82D8
unsigned char draw(class clsGLinkColossus_Object * this /* r17 */, class NNS_OBJECT * psObject /* r16 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r20 */, float (* psMtxWork)[4][4] /* r19 */, unsigned int u32ViewNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A8060 -> 0x4A82D8
    }
