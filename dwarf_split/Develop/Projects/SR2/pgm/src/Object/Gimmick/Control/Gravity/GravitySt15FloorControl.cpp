/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Control\Gravity\GravitySt15FloorControl.cpp
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x688F30
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x688F20
...
// Range: 0x47A000 -> 0x47AD98
void actionGravityDive(class clsGravitySt15FloorControl * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47A000 -> 0x47AD98
        class clsGravityDive * pcGravityDive; // r2
        class NNS_VECTORFAST sObjectPosVecFast; // r29+0x2F0
        class NNS_VECTORFAST sObjectDirVecFast; // r29+0x2E0
        class NNS_QUATERNION sObjectRotQuat; // r29+0x2D0
        class hkVector4 cZero; // r29+0x2C0
        class NNS_VECTORFAST sUpVecFast; // r29+0x2B0
        class NNS_VECTORFAST sSpeedVecFast; // r29+0x2A0
        class hkVector4 cRot; // r29+0x290
        class hkVector4 cRot; // r29+0x280
        class hkVector4 cSpeed; // r29+0x270
        class hkVector4 cRot; // r29+0x260
        class NNS_VECTORFAST sDirVecFast; // r29+0x250
        float f32Dist; // r20
        float sMtx[4][4]; // r29+0x210
        float sInvMtx[4][4]; // r29+0x1D0
        class NNS_VECTORFAST sLocalVecFast; // r29+0x1C0
        float f32Accele; // r20
        class NNS_VECTORFAST sSpeedVecFast; // r29+0x1B0
        float sPathMtx[4][4]; // r29+0x170
        class NNS_VECTORFAST sSpeedVecFast; // r29+0x160
        class hkVector4 cSpeed; // r29+0x150
        float sPathMtx[4][4]; // r29+0x110
    }
}
