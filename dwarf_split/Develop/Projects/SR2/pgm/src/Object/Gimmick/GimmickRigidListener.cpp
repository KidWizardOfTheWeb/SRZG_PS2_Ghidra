/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\GimmickRigidListener.cpp
...
class hkContactPointRemovedEvent {
    // total size: 0x1C
public:
    unsigned short m_contactPointId; // offset 0x0, size 0x2
    class hkContactPointMaterial * m_contactPointMaterial; // offset 0x4, size 0x4
    class hkEntity * m_entityA; // offset 0x8, size 0x4
    class hkEntity * m_entityB; // offset 0xC, size 0x4
    class hkEntity * m_callbackFiredFrom; // offset 0x10, size 0x4
    class hkDynamicsContactMgr * m_internalContactMgr; // offset 0x14, size 0x4
    class hkConstraintOwner * m_constraintOwner; // offset 0x18, size 0x4
};
...
// Range: 0x37EBE0 -> 0x37EC2C
void contactProcessCallback(class hkContactProcessEvent & event /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37EBE0 -> 0x37EC2C
    }
...
// Range: 0x37EC30 -> 0x37EC64
void contactPointRemovedCallback(class hkContactPointRemovedEvent & event /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37EC30 -> 0x37EC64
    }
...
// Range: 0x37EC70 -> 0x37ECBC
void contactPointConfirmedCallback(class hkContactPointConfirmedEvent & event /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37EC70 -> 0x37ECBC
    }
...
// Range: 0x37ECC0 -> 0x37ECC8
void contactPointAddedCallback() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37ECC0 -> 0x37ECC8
    }
