/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage01\PathTrain\PathTrain.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x696228
static class stcParam asTrainLineParam[2]; // size: 0x80, address: 0x6537C0
static unsigned char chk__asTrainLineParam_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcGimickSubParam asTrainLineFrontSubParam[2]; // size: 0x40, address: 0x653840
...
static class NNS_VECTOR tosLightOffsetVec; // size: 0xC, address: 0x696230
unsigned int otau32Se_TrainHorn[2]; // size: 0x8, address: 0x0
unsigned int otau32Se_TrainL[2]; // size: 0x8, address: 0x0
struct /* @anon1 */ {
    // total size: 0xA8
} __vt__16clsPathTrain_Obj; // size: 0xA8, address: 0x6CE640
...
class clsPathTrain_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A8B0
class clsPfSystem * m_tpcSingleton; // size: 0x4, address: 0x6E69B8
class clsHavok * m_tpcSingleton; // size: 0x4, address: 0x707E60
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x696290
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x6962D0
...
class clsPathTrain_Obj : public clsRigidBodyGimmickObj {
    // total size: 0x2D0
public:
    enum enmPathTrainMode m_ePathTrainMode; // offset 0xD0, size 0x4
    class clsGimmickPath m_cGimmickPath; // offset 0xE0, size 0x190
    unsigned int m_u32PlayerTaskNum; // offset 0x270, size 0x4
    class clsPathTrain_Obj * m_pcParentObj; // offset 0x274, size 0x4
    float m_sDrawMtx[4][4]; // offset 0x280, size 0x40
    class clsBackLineEffectTask * m_apcLineTask[2]; // offset 0x2C0, size 0x8
    unsigned char m_bMoveRigidBody; // offset 0x2C8, size 0x1
    unsigned char m_bLight; // offset 0x2C9, size 0x1
    float m_f32LightMotionFrame; // offset 0x2CC, size 0x4
};
...
class stcTrainData {
    // total size: 0x14
public:
    class clsPathTrain_Obj * m_pcTrainObj; // offset 0x0, size 0x4
...
class clsPathTrain_Task : public clsBaseGimmickBody {
    // total size: 0xAC
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsPathTrainManager_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsPathTrainManager_Obj : public clsGimmickObj {
    // total size: 0x90
public:
    class clsPathTrainThroughCol m_cThroughCol; // offset 0x50, size 0x18
    enum enmMode m_eMode; // offset 0x68, size 0x4
    signed int m_s32TrainNum; // offset 0x6C, size 0x4
    signed int m_s32VehiclesNum; // offset 0x70, size 0x4
    float m_f32Speed; // offset 0x74, size 0x4
    float m_f32SpeedUpFrame; // offset 0x78, size 0x4
    class stcSetDataDetail * m_psSetData; // offset 0x7C, size 0x4
    class stcTrainData * m_psTrainData; // offset 0x80, size 0x4
    class clsPathTrain_Obj * m_pcTrainObj; // offset 0x84, size 0x4
};
enum enmRank {
    RANK_FAILED = -1,
    RANK_AUTO = 0,
...
class clsPathTrainThroughCol : public clsBaseThroughCollision {
    // total size: 0x18
public:
    class clsPathTrainManager_Obj * m_pcManager; // offset 0x8, size 0x4
    class clsFrameControl m_cFrameControl; // offset 0xC, size 0x8
    signed char m_s8StartCount; // offset 0x14, size 0x1
};
class anchor {
    // total size: 0x4
public:
...
// Range: 0x52F620 -> 0x52FAFC
void draw(class clsPathTrain_Obj * this /* r21 */, class clsModelType_OB_TX * pcModelTrain /* r30 */, class clsModelType_OB_TX_MO_MA * pcModelLight /* r20 */, float (* psMtxPal)[4][4] /* r19 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r22 */, float (* psMtxWork)[4][4] /* r17 */, unsigned int u32ViewNo /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52F620 -> 0x52FAFC
        class NNS_OBJECT * psObject; // r16
        float sMtx[4][4]; // r29+0x130
        float sTrsMtx[4][4]; // r29+0xF0
    }
}


// Range: 0x52FB00 -> 0x530058
void main(class clsPathTrain_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52FB00 -> 0x530058
        class clsGimmickPath & rcGimmickPath; // r16
        float & rf32Frame; // r2
        class NNS_VECTORFAST tosLocalBackPosVecFast; // @ 0x00696240
    }
}


// Range: 0x530060 -> 0x530094
void start(class clsPathTrain_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x530060 -> 0x530094
    }
...
// Range: 0x5300A0 -> 0x530210
void setTrainQuat(class NNS_QUATERNION * psOutQuat /* r16 */, class clsGimmickObj * pcBaseObj /* r18 */, class clsGimmickObj * pcParentObj /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5300A0 -> 0x530210
        class NNS_VECTORFAST sDirVecFast; // r29+0x110
        class NNS_VECTORFAST sBaseBackPosVecFast; // r29+0x100
        class NNS_VECTORFAST sParentBackPosVecFast; // r29+0xF0
        float sBaseTrsMtx[4][4]; // r29+0xB0
        float sParentTrsMtx[4][4]; // r29+0x70
        class NNS_QUATERNION sQuatX; // r29+0x60
        class NNS_QUATERNION sQuatY; // r29+0x50
        float f32RadX; // r21
        float f32RadY; // r29+0x120
    }
}


// Range: 0x530210 -> 0x530470
void reset(class clsPathTrain_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x530210 -> 0x530470
        class clsGimmickPath & rcGimmcikPath; // r2
        class hkVector4 cVelocity; // r29+0x50
    }
}


// Range: 0x530470 -> 0x53061C
void init(class clsPathTrain_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x530470 -> 0x53061C
    }
...
// Range: 0x530620 -> 0x530660
void destroyData(class clsPathTrain_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x530620 -> 0x530660
    }
...
// Range: 0x530660 -> 0x530934
void createData(class clsPathTrain_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x530660 -> 0x530934
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0x90
        class hkVector4 cOffset; // r29+0x80
        signed int s32i; // r19
    }
}


// Range: 0x530940 -> 0x5309D0
void setData(class clsPathTrain_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x530940 -> 0x5309D0
    }
...
// Range: 0x5309D0 -> 0x530ADC
void * __dt(class clsPathTrain_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5309D0 -> 0x530ADC
    }
...
// Range: 0x530AE0 -> 0x530CA8
void * __ct(class clsPathTrain_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x530AE0 -> 0x530CA8
    }
...
// Range: 0x530CB0 -> 0x530CB8
void @80@__dt__16clsPathTrain_ObjFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x530CB0 -> 0x530CB8
    }
