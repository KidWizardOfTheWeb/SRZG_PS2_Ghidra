/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\PutMotionObj.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x6817E0
struct /* @anon2 */ {
    // total size: 0x48
} __vt__20clsPutMotionObj_Task; // size: 0x48, address: 0x6C1660
struct /* @anon8 */ {
    // total size: 0x48
} __vt__99clsSingleModelGimmick_Task<20clsPutMotionObj_Task,19clsPutMotionObj_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C1760
struct /* @anon3 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPutMotionObj_Task * m_tpcSingleton; // size: 0x4, address: 0xB16330
struct /* @anon1 */ {
    // total size: 0xC
} __vt__36clsSingleton<20clsPutMotionObj_Task>; // size: 0xC, address: 0x6C16F8
void * __dt(class clsPutMotionObj_Obj *, signed short); // size: 0x0, address: 0x3BC420
struct /* @anon4 */ {
    // total size: 0x48
} __vt__91clsBaseGimmickBody<20clsPutMotionObj_Task,19clsPutMotionObj_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C1710
struct /* @anon6 */ {
    // total size: 0x28
...
struct /* @anon12 */ {
    // total size: 0x44
} __vt__19clsPutMotionObj_Obj; // size: 0x44, address: 0x6C16B0
...
void * __ct(class clsPutMotionObj_Obj *); // size: 0x0, address: 0x3BD480
...
class clsPutMotionObj_Obj : public clsGimmickObj {
    // total size: 0x90
public:
    class NNS_VECTORFAST m_sColPosVecFast; // offset 0x50, size 0x10
    enum enmPutMotionObjMode m_ePutMotionObjMode; // offset 0x60, size 0x4
    float m_f32WaitFrame; // offset 0x64, size 0x4
    float m_f32Frame; // offset 0x68, size 0x4
    float m_f32MotionFrame; // offset 0x6C, size 0x4
    float m_f32MatMotionFrame; // offset 0x70, size 0x4
    float m_f32Radius; // offset 0x74, size 0x4
    unsigned int m_u32Type; // offset 0x78, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0x7C, size 0x4
    unsigned char m_bSePlayFlg; // offset 0x80, size 0x1
};
...
class clsPutMotionObj_Task : public clsSingleModelGimmick_Task {
    // total size: 0xAC
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsPutMotionObj_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x3BC4D0 -> 0x3BC7E4
void draw(class clsPutMotionObj_Task * this /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BC4D0 -> 0x3BC7E4
        ...
        class clsModelType_OB_TX_MO_MA & rsModel; // r2
...
// Range: 0x3BC840 -> 0x3BCB88
void execute(class clsPutMotionObj_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BC840 -> 0x3BCB88
        unsigned int u32Num; // r2
...
// Range: 0x3BCB90 -> 0x3BCBA8
void reset(class clsPutMotionObj_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BCB90 -> 0x3BCBA8
    }
...
// Range: 0x3BCBB0 -> 0x3BCC4C
unsigned int checkWaitFrame(class clsPutMotionObj_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BCBB0 -> 0x3BCC4C
...
// Range: 0x3BCC80 -> 0x3BCCDC
unsigned int stepMotoinFrame(class clsPutMotionObj_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BCC80 -> 0x3BCCDC
    }
...
// Range: 0x3BCCF0 -> 0x3BCE2C
unsigned int checkHitPlayer(class clsPutMotionObj_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BCCF0 -> 0x3BCE2C
        class clsPlayerTask * pcPlayer; // r2
        class NNS_VECTORFAST sVecFast; // r29+0x60
        float f32Distance; // r29+0x70
        unsigned int u32i; // r19
...
// Range: 0x3BCE30 -> 0x3BD044
void init(class clsPutMotionObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BCE30 -> 0x3BD044
    }
...
// Range: 0x3BD050 -> 0x3BD0A8
void reset(class clsPutMotionObj_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BD050 -> 0x3BD0A8
        unsigned int u32Num; // r2
...
// Range: 0x3BD0B0 -> 0x3BD11C
void * __ct(class clsPutMotionObj_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BD0B0 -> 0x3BD11C
    }
