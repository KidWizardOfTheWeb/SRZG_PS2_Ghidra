/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage05\St05RotFall\St05RotFallObject.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float toaf32BaseRot[10]; // size: 0x28, address: 0x686AF0
static float toaf32DiffRot[10]; // size: 0x28, address: 0x0
float tof32ClipSqDist; // size: 0x4, address: 0x686B18
float t_f32AppearFrame[14]; // size: 0x38, address: 0xB17190
unsigned char t_au8ModelTypeTable[14]; // size: 0xE, address: 0xB171C8
float t_of32FallHeighTable[14]; // size: 0x38, address: 0x686B20
class NNS_VECTOR t_osScaleVec[3]; // size: 0x24, address: 0x686B60
struct /* @anon9 */ {
    // total size: 0xA8
} __vt__17clsRotFall_Object; // size: 0xA8, address: 0x6C39F0
struct /* @anon8 */ {
    // total size: 0xA8
...
class clsRotFall_Task * m_tpcSingleton; // size: 0x4, address: 0xB17188
...
class clsRotGround_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A800
class clsTaskManager * m_tpcSingleton; // size: 0x4, address: 0x6E69D0
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x686BA0
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x686B90
...
public:
    ...
    unsigned int m_u32PlayerFlg; // offset 0x54, size 0x4
    float m_af32Rot[8]; // offset 0x58, size 0x20
    float m_af32LengthRate[8]; // offset 0x78, size 0x20
    class clsRotGroundThroughCollision m_cThroughCollision; // offset 0x98, size 0x10
    class clsTask * m_apcParticleTask[5]; // offset 0xA8, size 0x14
    float m_asParticleMtx[5][4][4]; // offset 0xC0, size 0x140
    class clsPlaySe_2D * m_pcPlaySe2D; // offset 0x200, size 0x4
    unsigned char m_bPlaySeFlg; // offset 0x204, size 0x1
};
...
class clsRotFall_Task : public clsMultiModelGimmick_Task {
    // total size: 0xF0
public:
    float m_sBaseMtx[4][4]; // offset 0xA0, size 0x40
    class hkShape * m_apcShape[3]; // offset 0xE0, size 0xC
};
...
class clsRotGroundThroughCollision : public clsBaseThroughCollision {
    // total size: 0x10
public:
    class clsRotGround_Obj * m_pcRotGroundObj; // offset 0x8, size 0x4
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsRotFallManager_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsRotFall_Object : public clsRigidBodyGimmickObj {
    // total size: 0x170
public:
    float m_sBaseMtx[4][4]; // offset 0xD0, size 0x40
    float m_sBaseInvMtx[4][4]; // offset 0x110, size 0x40
    class NNS_VECTOR m_sFallRotSpeed; // offset 0x150, size 0xC
    enum enmRotFallMode m_eMode; // offset 0x15C, size 0x4
    enum enmModelType m_eModelType; // offset 0x160, size 0x4
    unsigned int m_u32DrawFlg; // offset 0x164, size 0x4
...
class clsRotFallManager_Object : public clsGimmickObj {
    // total size: 0x60
public:
    class clsRotFall_Object * m_pcObject; // offset 0x50, size 0x4
    class stcSetDataDetail * m_psSetData; // offset 0x54, size 0x4
    signed int m_s32ObjectNum; // offset 0x58, size 0x4
    unsigned char m_bStop; // offset 0x5C, size 0x1
};
class clsRotGround_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
enum enmInfo {
    TYPE_NULL = 0,
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsRotGround_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
...
// Range: 0x428A70 -> 0x428AF0
void destroyData(class clsRotFall_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x428A70 -> 0x428AF0
    }
...
// Range: 0x428AF0 -> 0x428EA4
void createData(class clsRotFall_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x428AF0 -> 0x428EA4
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0xC0
        class hkBoxShape * psShape; // r2
...
// Range: 0x428EB0 -> 0x428FB8
void setData(class clsRotFall_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x428EB0 -> 0x428FB8
...
// Range: 0x428FC0 -> 0x428FD0
void requestDrawBreakEffect(class clsRotFall_Object * this /* r4 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x428FC0 -> 0x428FD0
    }
...
// Range: 0x428FD0 -> 0x42902C
void requestDrawContactEffect(class clsRotFall_Object * this /* r2 */, class hkContactPoint * pcContact /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x428FD0 -> 0x42902C
...
// Range: 0x429090 -> 0x429154
void clearAppearFrame() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x429090 -> 0x429154
        unsigned int u32i; // r17
        float * pf32AppearFrame; // r16
    }
}


// Range: 0x429160 -> 0x4294B4
void draw(class clsRotFall_Object * this /* r19 */, class clsMultiObTxModels & rcObj /* r2 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r30 */, float (* psMtxWork)[4][4] /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x429160 -> 0x4294B4
        class clsModelType_OB_TX & rsModel; // r2
        float sRotMtx[4][4]; // r29+0xF0
    }
}


// Range: 0x4294C0 -> 0x429E80
void main(class clsRotFall_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4294C0 -> 0x429E80
        class hkVector4 cZero; // r29+0x270
        class NNS_VECTORFAST sPosVecFast; // r29+0x260
        class NNS_VECTORFAST sUpVecFast; // r29+0x250
        class hkVector4 cRot; // r29+0x240
        class NNS_VECTORFAST sUpVecFast; // r29+0x230
        class hkVector4 cSpeed; // r29+0x220
        class NNS_VECTORFAST sUpVecFast; // r29+0x210
        float sRotMtx[4][4]; // r29+0x1D0
        float sMtx[4][4]; // r29+0x190
        float sInvMtx[4][4]; // r29+0x150
        class NNS_VECTORFAST sPosVecFast; // r29+0x140
        class hkVector4 cZero; // r29+0x130
    }
}


// Range: 0x429E80 -> 0x429EE4
void reset(class clsRotFall_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x429E80 -> 0x429EE4
    }
...
// Range: 0x429EF0 -> 0x429EF8
void @80@__dt__17clsRotFall_ObjectFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x429EF0 -> 0x429EF8
    }
