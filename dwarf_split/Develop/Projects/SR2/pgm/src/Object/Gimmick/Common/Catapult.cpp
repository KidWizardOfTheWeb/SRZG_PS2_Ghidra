/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\Catapult.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x6833D0
struct /* @anon10 */ {
    // total size: 0x48
} __vt__16clsCatapult_Task; // size: 0x48, address: 0x6C1E50
struct /* @anon17 */ {
    // total size: 0x48
} __vt__91clsSingleModelGimmick_Task<16clsCatapult_Task,15clsCatapult_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C1F00
struct /* @anon6 */ {
    // total size: 0x38
...
struct /* @anon4 */ {
    // total size: 0xC
} __vt__32clsSingleton<16clsCatapult_Task>; // size: 0xC, address: 0x6C1E98
void * __dt(class clsCatapult_Obj *, signed short); // size: 0x0, address: 0x3E4DF0
struct /* @anon7 */ {
    // total size: 0x48
} __vt__83clsBaseGimmickBody<16clsCatapult_Task,15clsCatapult_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C1EB0
struct /* @anon13 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon19 */ {
    // total size: 0xA8
} __vt__15clsCatapult_Obj; // size: 0xA8, address: 0x6C1F50
struct /* @anon14 */ {
    // total size: 0x28
...
struct /* @anon3 */ {
    // total size: 0x34
} __vt__27clsCatapultThroughCollision; // size: 0x34, address: 0x6C2000
...
// Range: 0x3E4EF0 -> 0x3E50B4
void createModel(class clsCatapult_Task * this /* r18 */, class stcBinInfo & rsBinInfoI /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E4EF0 -> 0x3E50B4
...
// Range: 0x3E50C0 -> 0x3E543C
void draw(class clsCatapult_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E50C0 -> 0x3E543C
        ...
        unsigned int sNodeStat; // r29+0x13C
        float sMtxPal[4][4]; // r29+0xF0
        unsigned int u32i; // r20
    }
}


// Range: 0x3E54E0 -> 0x3E55F8
void execute(class clsCatapult_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E54E0 -> 0x3E55F8
        unsigned int u32Num; // r2
...
// Range: 0x3E5600 -> 0x3E5670
void reset(class clsCatapult_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E5600 -> 0x3E5670
        unsigned int u32Num; // r2
...
// Range: 0x3E5670 -> 0x3E582C
void * __ct(class clsCatapult_Task * this /* r18 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E5670 -> 0x3E582C
        class hkVector4 cBoxVec; // r29+0x90
        class hkQuaternion cBoxQuaternion; // r29+0x80
        class hkTransform cTrans; // r29+0x40
    }
}


// Range: 0x3E5C60 -> 0x3E5CD0
void setCollisionFilter(class clsCatapult_Obj * this /* r2 */, unsigned char bFlag /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E5C60 -> 0x3E5CD0
    }
...
// Range: 0x3E5CD0 -> 0x3E5D18
unsigned char stepMotionFrame(class clsCatapult_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E5CD0 -> 0x3E5D18
    }
...
// Range: 0x3E5D20 -> 0x3E6018
void checkShooting(class clsCatapult_Obj * this /* r18 */, class clsPlayerTask * pcPlayerTask /* r17 */, unsigned int u32TaskNum /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E5D20 -> 0x3E6018
        class NNS_VECTORFAST sLocalPosVecFast; // r29+0xB0
...
// Range: 0x3E6020 -> 0x3E628C
void contactTriggerEvent(class clsCatapult_Obj * this /* r17 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E6020 -> 0x3E628C
        class clsPlayerTask * pcHitPlayer; // r16
        class NNS_VECTORFAST sVecFast; // r29+0xC0
        class stcTargetCam1 sTgtCam1; // r29+0x40
    }
}


// Range: 0x3E6290 -> 0x3E62EC
void destroyData(class clsCatapult_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E6290 -> 0x3E62EC
    }
...
// Range: 0x3E6380 -> 0x3E6944
void createData(class clsCatapult_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E6380 -> 0x3E6944
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0x130
        class hkVector4 cBoxVec; // r29+0x120
        class hkQuaternion cBoxQuaternion; // r29+0x110
        class hkTransform cTrans; // r29+0xD0
        class hkVector4 cHelfBoxSize; // r29+0xC0
...
// Range: 0x3E6950 -> 0x3E6958
void setData(class clsCatapult_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E6950 -> 0x3E6958
    }
...
// Range: 0x3E6960 -> 0x3E6994
void setAiMode(class clsCatapult_Obj * this /* r2 */, enum enmAiMode eMode /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E6960 -> 0x3E6994
    }
...
// Range: 0x3E69A0 -> 0x3E6E40
void main(class clsCatapult_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E69A0 -> 0x3E6E40
        signed int i; // r18
...
// Range: 0x3E6E80 -> 0x3E707C
void init(class clsCatapult_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E6E80 -> 0x3E707C
...
// Range: 0x3E7080 -> 0x3E71A0
void reset(class clsCatapult_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E7080 -> 0x3E71A0
...
// Range: 0x3E71A0 -> 0x3E7208
void contactAlwaysEvent(class clsCatapultThroughCollision * this /* r2 */, class clsPlayerTask * pcPlayer /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3E71A0 -> 0x3E7208
    }
