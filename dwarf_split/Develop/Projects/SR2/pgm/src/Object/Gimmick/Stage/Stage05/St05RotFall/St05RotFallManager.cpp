/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage05\St05RotFall\St05RotFallManager.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
signed char t_oas8Numtable[14]; // size: 0xE, address: 0x686AE0
struct /* @anon2 */ {
    // total size: 0x44
} __vt__24clsRotFallManager_Object; // size: 0x44, address: 0x6C39A0
class stcTask sTask; // size: 0x30, address: 0xB0A900
void * __dt(class clsRotFall_Object *, signed short); // size: 0x0, address: 0x4282D0
struct /* @anon9 */ {
    // total size: 0xA8
...
void * __ct(class clsRotFall_Object *); // size: 0x0, address: 0x428510
...
// Range: 0x4281A0 -> 0x428264
void stop(class clsRotFallManager_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4281A0 -> 0x428264
        class clsRotFall_Object * pcObject; // r20
        signed int i; // r19
...
// Range: 0x428270 -> 0x4282C4
void destroyData(class clsRotFallManager_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x428270 -> 0x4282C4
    }
...
// Range: 0x4283D0 -> 0x428510
void createData(class clsRotFallManager_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4283D0 -> 0x428510
        signed int s32AreaNo; // r18
        class stcSetDataDetail * psSetData; // r17
        class clsRotFall_Object * pcObject; // r21
        signed int s32Num; // r20
    }
}


// Range: 0x4285D0 -> 0x428618
void setData(class clsRotFallManager_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4285D0 -> 0x428618
    }
...
// Range: 0x428620 -> 0x4286E4
void draw(class clsRotFallManager_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x428620 -> 0x4286E4
        class clsRotFall_Object * pcObject; // r20
        signed int i; // r19
        class clsMultiObTxModels & rcModel; // r18
        float (* opaNnViewMtx)[4][4]; // r21
        unsigned int * psNodeStat; // r17
        float (* psMtxPal)[4][4]; // r16
        float sWorkMtx[4][4]; // r29+0x70
    }
}


// Range: 0x4286F0 -> 0x428820
void execute(class clsRotFallManager_Object * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4286F0 -> 0x428820
        class clsRotFall_Object * pcObject; // r17
        signed int i; // r16
    }
}


// Range: 0x428820 -> 0x428880
void reset(class clsRotFallManager_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x428820 -> 0x428880
        class clsRotFall_Object * pcObject; // r17
...
// Range: 0x428880 -> 0x42890C
void * __dt(class clsRotFallManager_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x428880 -> 0x42890C
    }
...
// Range: 0x428910 -> 0x428A58
void * __ct(class clsRotFallManager_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x428910 -> 0x428A58
        signed int i; // r3
