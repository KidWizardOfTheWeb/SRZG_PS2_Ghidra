/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Mission\MissionPathTarget.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon10 */ {
    // total size: 0x68
} __vt__25clsMissionPathTarget_Task; // size: 0x68, address: 0x6D16C0
struct /* @anon16 */ {
    // total size: 0x48
} __vt__103clsSingleModelGimmick_Task<25clsMissionPathTarget_Task,24clsMissionPathTarget_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6D1790
...
struct /* @anon2 */ {
    // total size: 0xC
} __vt__41clsSingleton<25clsMissionPathTarget_Task>; // size: 0xC, address: 0x6D1728
void * __dt(class clsMissionPathTarget_Obj *, signed short); // size: 0x0, address: 0x436D00
struct /* @anon8 */ {
    // total size: 0x48
} __vt__95clsBaseGimmickBody<25clsMissionPathTarget_Task,24clsMissionPathTarget_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6D1740
struct /* @anon11 */ {
    // total size: 0xC
...
void * __ct(class clsMissionPathTarget_Obj *); // size: 0x0, address: 0x58CA50
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x69A820
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x69A830
...
// Range: 0x58B420 -> 0x58B5B0
void draw(class clsMissionPathTarget_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58B420 -> 0x58B5B0
...
// Range: 0x58B5B0 -> 0x58B714
void execute(class clsMissionPathTarget_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58B5B0 -> 0x58B714
        unsigned int u32Num; // r2
...
// Range: 0x58B720 -> 0x58B788
void reset(class clsMissionPathTarget_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58B720 -> 0x58B788
        unsigned int u32Num; // r2
...
// Range: 0x58B790 -> 0x58B7C4
class NNS_VECTORFAST * getPosVecFastPtr(class clsMissionPathTarget_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58B790 -> 0x58B7C4
    }
...
// Range: 0x58B7D0 -> 0x58B804
signed int getPathPoint(class clsMissionPathTarget_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58B7D0 -> 0x58B804
    }
...
// Range: 0x58B810 -> 0x58B940
void * __ct(class clsMissionPathTarget_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58B810 -> 0x58B940
...
// Range: 0x58BCA0 -> 0x58BE6C
void main(class clsMissionPathTarget_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58BCA0 -> 0x58BE6C
...
// Range: 0x58BE70 -> 0x58C094
unsigned char nextSearchPath(class clsMissionPathTarget_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58BE70 -> 0x58C094
        class NNS_QUATERNION sQuat; // r29+0xB0
        class NNS_VECTORFAST sSideVecFast; // r29+0xA0
        float sMtx[4][4]; // r29+0x60
    }
}


// Range: 0x58C0A0 -> 0x58C204
void draw(class clsMissionPathTarget_Obj * this /* r16 */, class clsModelType_OB_TX & rcObj /* r17 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r20 */, float (* opaNnViewMtx)[4][4] /* r19 */, float (* psMtxWork)[4][4] /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58C0A0 -> 0x58C204
...
// Range: 0x58C210 -> 0x58C33C
void calcPathPostural(class clsMissionPathTarget_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58C210 -> 0x58C33C
        class NNS_QUATERNION sEndQuat; // r29+0x90
        class clsPath & rcPath; // r17
        class clsPosturalCtrl & rcPostural; // r2
        float sMtxNext[4][4]; // r29+0x50
        class NNS_VECTORFAST sSideVecFast; // r29+0x40
        class NNS_VECTORFAST sDirVecFast; // r29+0x30
    }
}


// Range: 0x58C340 -> 0x58C3C0
void destroyData(class clsMissionPathTarget_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58C340 -> 0x58C3C0
    }
...
// Range: 0x58C3C0 -> 0x58C7A0
void createData(class clsMissionPathTarget_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58C3C0 -> 0x58C7A0
        class clsMissionRace_Task & rcMissionRace_Task; // r2
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0xE0
        class hkVector4 cHalfSize; // r29+0xD0
...
// Range: 0x58C7A0 -> 0x58C9F0
void reset(class clsMissionPathTarget_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58C7A0 -> 0x58C9F0
        class hkVector4 cVelocity; // r29+0x60
    }
}


// Range: 0x58C9F0 -> 0x58CA48
void init(class clsMissionPathTarget_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58C9F0 -> 0x58CA48
...
// Range: 0x58CA50 -> 0x58CB14
void * __ct(class clsMissionPathTarget_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58CA50 -> 0x58CB14
    }
