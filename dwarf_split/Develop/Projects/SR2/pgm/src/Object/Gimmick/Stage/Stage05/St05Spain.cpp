/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage05\St05Spain.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcInfo oasGroundInfo[1]; // size: 0x10, address: 0x686CD0
struct /* @anon4 */ {
    // total size: 0x48
} __vt__13clsSpain_Task; // size: 0x48, address: 0x6C3F30
void * __dt(class clsSpain_Obj *, signed short); // size: 0x0, address: 0x2CCCF0
struct /* @anon12 */ {
    // total size: 0x48
} __vt__71clsBaseGimmickBody<13clsSpain_Task,12clsSpain_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BA630
struct /* @anon9 */ {
    // total size: 0x30
...
struct /* @anon10 */ {
    // total size: 0x5C
} __vt__12clsSpain_Obj; // size: 0x5C, address: 0x6BA5C0
...
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x686D10
class clsPfCameraMgr * m_tpcSingleton; // size: 0x4, address: 0x6E69C0
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x686D00
class clsSpain_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A7F0
struct /* @anon11 */ {
    // total size: 0x44
...
struct /* @anon8 */ {
    // total size: 0xC
} __vt__29clsSingleton<13clsSpain_Task>; // size: 0xC, address: 0x6BA620
struct /* @anon14 */ {
    // total size: 0xC
...
class clsSpain_Task : public clsBaseGimmickBody {
    // total size: 0x94
};
class __vector_imp : private __vector_pod, private compile_assert {
    // total size: 0xC
...
public:
    ...
    class hkShape * m_pcShape; // offset 0x64, size 0x4
    float m_sInvMtx[4][4]; // offset 0x70, size 0x40
    class stcPlayerData m_asPlayerData[8]; // offset 0xB0, size 0x40
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsSpain_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class stcPlayerData {
    // total size: 0x8
public:
    float f32OldZ; // offset 0x0, size 0x4
    unsigned char u8TrgFlg; // offset 0x4, size 0x1
    unsigned char u8Padd[3]; // offset 0x5, size 0x3
};
class hkPadSpu {
    // total size: 0x1
public:
...
// Range: 0x42F600 -> 0x42F878
void draw(class clsSpain_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42F600 -> 0x42F878
...
// Range: 0x42F880 -> 0x42FB84
void execute(class clsSpain_Task * this /* r30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42F880 -> 0x42FB84
        unsigned int u32Num; // r2
...
// Range: 0x42FB90 -> 0x42FC80
void moveTrg(class clsPlayerTask * pcPlayer /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42FB90 -> 0x42FC80
    }
...
// Range: 0x42FC90 -> 0x42FD00
void reset(class clsSpain_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42FC90 -> 0x42FD00
        unsigned int u32Num; // r2
...
// Range: 0x42FD00 -> 0x42FED0
void contactRemoveEvent(class clsSpain_Obj * this /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42FD00 -> 0x42FED0
...
// Range: 0x42FEE0 -> 0x430278
void moveRemove(class clsSpain_Obj * this /* r18 */, class clsPlayerTask * pcPlayer /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42FEE0 -> 0x430278
        ...
        class NNS_VECTORFAST sLocalVecFast; // r29+0x60
    }
}


// Range: 0x430280 -> 0x4302E8
void destroyData(class clsSpain_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x430280 -> 0x4302E8
    }
...
// Range: 0x4302F0 -> 0x430514
void createData(class clsSpain_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4302F0 -> 0x430514
...
// Range: 0x430520 -> 0x430530
void reset(class clsSpain_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x430520 -> 0x430530
    }
