/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage14\St14GLinkBigFan.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x697D60
float tof32ClipSqDist; // size: 0x4, address: 0x697D70
float tof32ClipSqDist; // size: 0x4, address: 0x697D78
class clsGravityGimmickParam t_ocSt14GravityGimmickParam; // size: 0x78, address: 0x697D80
struct /* @anon9 */ {
    // total size: 0x48
} __vt__16clsGLinkFan_Task; // size: 0x48, address: 0x6D05A0
void * __dt(class clsGLinkFan_Object *, signed short); // size: 0x0, address: 0x55C380
struct /* @anon15 */ {
    // total size: 0x48
} __vt__78clsBaseGimmickBody<16clsGLinkFan_Task,18clsGLinkFan_Object,16clsGLinkFanModel>; // size: 0x48, address: 0x6D0600
struct /* @anon13 */ {
    // total size: 0x30
...
void * __dt(class clsGLinkFan_Blade *, signed short); // size: 0x0, address: 0x55C430
struct /* @anon7 */ {
    // total size: 0x44
} __vt__18clsGLinkFan_Object; // size: 0x44, address: 0x6D0650
struct /* @anon20 */ {
    // total size: 0xB4
} __vt__24clsBaseGravityLinkObject; // size: 0xB4, address: 0x6C1420
struct /* @anon1 */ {
    // total size: 0xB8
} __vt__17clsGLinkFan_Blade; // size: 0xB8, address: 0x6D06A0
struct /* @anon4 */ {
    // total size: 0xC
...
void * __ct(class clsGLinkFan_Object *); // size: 0x0, address: 0x55D070
class clsGLinkFan_Task * m_tpcSingleton; // size: 0x4, address: 0xBFB378
struct /* @anon6 */ {
    // total size: 0xC
} __vt__32clsSingleton<16clsGLinkFan_Task>; // size: 0xC, address: 0x6D05E8
void * __ct(class clsGLinkFan_Blade *); // size: 0x0, address: 0x55D160
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
struct /* @anon2 */ {
    // total size: 0xC
} __vt__14clsSe3DControl; // size: 0xC, address: 0x6BBB18
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x697E40
...
struct /* @anon17 */ {
    // total size: 0x28
} __vt__19clsGrindLinkControl; // size: 0x28, address: 0x6C15A0
class stcInfo oasGroundInfo[]; // size: 0x0, address: 0x6803C0
float t_of32WeightTypeSuperHeavy; // size: 0x4, address: 0x6651B0
...
class clsGLinkFan_Blade : public clsBaseGravityLinkObject {
    // total size: 0x160
public:
    class clsGLinkFan_Object * m_pcFanObj; // offset 0xE0, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0xE4, size 0x4
    class NNS_QUATERNION m_sBaseQuat; // offset 0xE8, size 0x10
    unsigned int m_u32PartsNo; // offset 0xF8, size 0x4
    enum enmMode m_eMode; // offset 0xFC, size 0x4
    enum enmStateType m_eStateType; // offset 0x100, size 0x4
    unsigned char m_bFilterChangeGravity; // offset 0x104, size 0x1
    unsigned char m_bFilterChangeGround; // offset 0x105, size 0x1
    unsigned char m_bFilterChange; // offset 0x106, size 0x1
    unsigned char m_bSeFlag; // offset 0x107, size 0x1
    unsigned char m_bGravityFlag; // offset 0x108, size 0x1
    float m_sEffectMatrix[4][4]; // offset 0x110, size 0x40
    class clsTask * m_pcEffectTask; // offset 0x150, size 0x4
};
class hkPadSpu {
    // total size: 0x4
public:
...
class clsGrindLinkControl : public clsGravityActionControl {
    // total size: 0x70
public:
    class NNS_QUATERNION m_sTargetRotQuat; // offset 0x50, size 0x10
    enum enmFlag m_eFlag; // offset 0x60, size 0x4
    float m_f32AutoDiveRateX; // offset 0x64, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x9C
public:
    class clsGLinkFan_Object * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsGLinkFanModel m_cModel; // offset 0x88, size 0x10
...
class clsGLinkFan_Object : public clsGimmickObj {
    // total size: 0x4A0
public:
    class clsGLinkFan_Blade m_acBlade[3]; // offset 0x50, size 0x420
    class NNS_VECTORFAST m_sBaseUpVecFast; // offset 0x470, size 0x10
    class NNS_VECTORFAST m_sAngleVelocityFast; // offset 0x480, size 0x10
    class clsSe3DControl * m_pcSe3DControl; // offset 0x490, size 0x4
    signed int m_A32RotateSpeed; // offset 0x494, size 0x4
    enum enmFanMode m_eFanMode; // offset 0x498, size 0x4
};
...
class clsGLinkFan_Task : public clsBaseGimmickBody {
    // total size: 0xA0
public:
    class clsGmkBurnLight_Task * m_pcBurnLightTask; // offset 0x9C, size 0x4
};
...
class clsGLinkFanModel {
    // total size: 0x10
public:
    class clsModelType_OB_TX m_cModelWick; // offset 0x0, size 0x8
    class clsModelType_OB_TX m_cModelBlade; // offset 0x8, size 0x8
};
...
// Range: 0x55C4D0 -> 0x55C7B0
void draw(class clsGLinkFan_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55C4D0 -> 0x55C7B0
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        unsigned int u32Num; // r2
        unsigned int * psNodeStat; // r23
        float (* opaNnViewMtx)[4][4]; // r30
        float (* psMtxPal)[4][4]; // r29+0xC0
        class clsModelType_OB_TX & rcModelWick; // r17
        class clsModelType_OB_TX & rcModelBlade; // r2
...
// Range: 0x55C7B0 -> 0x55CA44
void execute(class clsGLinkFan_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55C7B0 -> 0x55CA44
        unsigned int u32Num; // r2
...
// Range: 0x55CA50 -> 0x55CB64
void reset(class clsGLinkFan_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55CA50 -> 0x55CB64
        unsigned int u32Num; // r2
...
// Range: 0x55CB70 -> 0x55CD7C
void createModel(class clsGLinkFan_Task * this /* r2 */, class stcBinInfo & rsBinInfoI /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55CB70 -> 0x55CD7C
        unsigned int u32CalcObjNum; // r2
        class clsModelType_OB_TX * pcModelBlade; // r18
    }
}


// Range: 0x55CD80 -> 0x55CEBC
void * __ct(class clsGLinkFan_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55CD80 -> 0x55CEBC
    }
...
// Range: 0x55D240 -> 0x55D2B0
void destroyData(class clsGLinkFan_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55D240 -> 0x55D2B0
        class clsGLinkFan_Blade * pcBlade; // r17
        unsigned int u32i; // r16
    }
}


// Range: 0x55D2B0 -> 0x55D408
void createData(class clsGLinkFan_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55D2B0 -> 0x55D408
        class clsGLinkFan_Blade * pcBlade; // r17
        unsigned int u32i; // r16
        class NNS_VECTORFAST sAngleVelocityFast; // r29+0xC0
        float sRotMtx[4][4]; // r29+0x80
    }
}


// Range: 0x55D410 -> 0x55D448
void setData(class clsGLinkFan_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55D410 -> 0x55D448
    }
...
// Range: 0x55D450 -> 0x55D6B0
void draw(class clsGLinkFan_Object * this /* r16 */, class clsModelType_OB_TX * psModel /* r2 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r20 */, float (* psMtxWork)[4][4] /* r19 */, unsigned int u32ViewNo /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55D450 -> 0x55D6B0
...
// Range: 0x55D6B0 -> 0x55D730
void destroyData(class clsGLinkFan_Blade * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55D6B0 -> 0x55D730
    }
...
// Range: 0x55D730 -> 0x55DB74
void createData(class clsGLinkFan_Blade * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55D730 -> 0x55DB74
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0xC0
        class hkVector4 cVec; // r29+0xB0
        class hkMassProperties massProperties; // r29+0x60
    }
}


// Range: 0x55DB80 -> 0x55DD1C
void contactTriggerCallback(class clsGLinkFan_Blade * this /* r18 */, class hkContactPointConfirmedEvent & cEvent /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55DB80 -> 0x55DD1C
        class clsRigidBodyGimmickObj * pcRigidObject; // r16
    }
}


// Range: 0x55DD20 -> 0x55DD88
void callbackContactTriggerRigidBody(class clsGLinkFan_Blade * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55DD20 -> 0x55DD88
    }
...
// Range: 0x55DD90 -> 0x55DDEC
void requestDrawBreakEffect(class clsGLinkFan_Blade * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55DD90 -> 0x55DDEC
    }
...
// Range: 0x55DDF0 -> 0x55DE70
void callbackGravityEvent(class clsGLinkFan_Blade * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55DDF0 -> 0x55DE70
...
// Range: 0x55DE80 -> 0x55E05C
void main(class clsGLinkFan_Blade * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55DE80 -> 0x55E05C
        class NNS_VECTORFAST sVecFast; // r29+0x50
        class NNS_QUATERNION sQuat; // r29+0x40
        class NNS_VECTORFAST sUpVecFast; // r29+0x30
    }
}


// Range: 0x55E060 -> 0x55E380
void reset(class clsGLinkFan_Blade * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55E060 -> 0x55E380
        class clsGLinkFan_Object * pcObj; // r2
        class clsRigidBody * pcRigidBody; // r18
        float sMtx[4][4]; // r29+0xE0
        class NNS_QUATERNION sRotQuat; // r29+0xD0
        class NNS_VECTORFAST sPosVecFast; // r29+0xC0
        class hkVector4 cZero; // r29+0xB0
        unsigned int u32Filter; // r17
        class NNS_VECTORFAST sUpVecFast; // r29+0xA0
        class NNS_VECTORFAST sAngleVelocity; // r29+0x90
        class hkVector4 cVelocity; // r29+0x80
    }
}


// Range: 0x55E380 -> 0x55E5C0
void initParam(class clsGLinkFan_Blade * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55E380 -> 0x55E5C0
        class clsGLinkFan_Object * pcObj; // r2
        class clsRigidBody * pcRigidBody; // r18
        unsigned int u32Flag; // r17
        class NNS_VECTORFAST sUpVecFast; // r29+0x70
        class NNS_VECTORFAST sUpVecFast; // r29+0x60
    }
}


// Range: 0x55E5C0 -> 0x55E8D4
unsigned char draw(class clsGLinkFan_Blade * this /* r17 */, class NNS_OBJECT * psObject /* r16 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r20 */, float (* psMtxWork)[4][4] /* r19 */, unsigned int u32ViewNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55E5C0 -> 0x55E8D4
    }
