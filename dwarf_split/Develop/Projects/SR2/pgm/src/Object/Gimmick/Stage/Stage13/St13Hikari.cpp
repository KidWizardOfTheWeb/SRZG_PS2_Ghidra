/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage13\St13Hikari.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x6903D8
struct /* @anon10 */ {
    // total size: 0x48
} __vt__18clsSt13Hikari_Task; // size: 0x48, address: 0x6C9900
struct /* @anon1 */ {
    // total size: 0x48
} __vt__98clsSingleModelGimmick_Task<18clsSt13Hikari_Task,20clsSt13Hikari_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C9A60
struct /* @anon4 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsSt13Hikari_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA688
struct /* @anon6 */ {
    // total size: 0xC
} __vt__34clsSingleton<18clsSt13Hikari_Task>; // size: 0xC, address: 0x6C99F8
void * __dt(class clsSt13Hikari_Object *, signed short); // size: 0x0, address: 0x4D4A00
struct /* @anon14 */ {
    // total size: 0x48
} __vt__90clsBaseGimmickBody<18clsSt13Hikari_Task,20clsSt13Hikari_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C9A10
struct /* @anon15 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon13 */ {
    // total size: 0xA8
} __vt__20clsSt13Hikari_Object; // size: 0xA8, address: 0x6C9950
struct /* @anon9 */ {
    // total size: 0x28
...
void * __ct(class clsSt13Hikari_Object *); // size: 0x0, address: 0x4D51C0
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsSt13Hikari_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsSt13Hikari_Task : public clsSingleModelGimmick_Task {
    // total size: 0xAC
};
class hkPadSpu {
    // total size: 0x4
...
public:
    ...
    float m_f32MatFrame; // offset 0xD4, size 0x4
    float m_f32Scale; // offset 0xD8, size 0x4
    float m_f32MaxScale; // offset 0xDC, size 0x4
};
...
// Range: 0x4D4B00 -> 0x4D4B70
void reset(class clsSt13Hikari_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D4B00 -> 0x4D4B70
...
// Range: 0x4D4B70 -> 0x4D4D00
void draw(class clsSt13Hikari_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D4B70 -> 0x4D4D00
...
// Range: 0x4D4D00 -> 0x4D4DE0
void execute(class clsSt13Hikari_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D4D00 -> 0x4D4DE0
        unsigned int u32Num; // r2
...
// Range: 0x4D4DE0 -> 0x4D4E4C
void * __ct(class clsSt13Hikari_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D4DE0 -> 0x4D4E4C
    }
...
// Range: 0x4D52B0 -> 0x4D5308
void main(class clsSt13Hikari_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D52B0 -> 0x4D5308
    }
...
// Range: 0x4D5310 -> 0x4D5318
void reset(class clsSt13Hikari_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D5310 -> 0x4D5318
    }
...
// Range: 0x4D5320 -> 0x4D5538
void draw(class clsSt13Hikari_Object * this /* r20 */, class clsModelType_OB_TX_MO_MA & rcModel /* r19 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r23 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D5320 -> 0x4D5538
    }
