/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\PutGravityObj2.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32CLIP_DISTx2; // size: 0x4, address: 0x6897B0
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x6897C0
struct /* @anon10 */ {
    // total size: 0xBC
} __vt__21clsPutGravityObj2_Obj; // size: 0xBC, address: 0x6C7AE0
...
class clsPutGravityObj2_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A870
class NNS_VECTOR * t_psCompScale; // size: 0x4, address: 0xB171E8
...
public:
    ...
    class clsTask * m_psFloatingParticle; // offset 0xD4, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0xD8, size 0x4
    class NNS_VECTOR m_sObjScaleVec; // offset 0xDC, size 0xC
    float m_f32SeDelayFrame; // offset 0xE8, size 0x4
    unsigned int m_u32ParticleType; // offset 0xEC, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPutGravityObj2_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsPutGravityObj2_Task : public clsMultiShape, public clsMultiModelGimmick_Task {
    // total size: 0xA8
};
class clsFlag {
    // total size: 0x4
...
class __wrap_iterator {
    // total size: 0x4
public:
    class stcShapeInfo * it_; // offset 0x0, size 0x4
};
...
// Range: 0x488E60 -> 0x488EEC
void callbackContactTriggerRigidBody(class clsPutGravityObj2_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x488E60 -> 0x488EEC
    }
...
// Range: 0x488F00 -> 0x4890E8
void draw(class clsPutGravityObj2_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x488F00 -> 0x4890E8
        ...
        unsigned int * pu32NowDrawModelNum; // r2
        unsigned int u32i; // r17
    }
}


// Range: 0x4890F0 -> 0x489210
void execute(class clsPutGravityObj2_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4890F0 -> 0x489210
        unsigned int u32Num; // r2
...
// Range: 0x489210 -> 0x489280
void reset(class clsPutGravityObj2_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x489210 -> 0x489280
        unsigned int u32Num; // r2
...
// Range: 0x489280 -> 0x489370
void init(class clsPutGravityObj2_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x489280 -> 0x489370
...
// Range: 0x489370 -> 0x489794
void draw(class clsPutGravityObj2_Obj * this /* r21 */, class clsModelType_OB_TX * pcModels /* r2 */, float (* psMtxPal)[4][4] /* r20 */, unsigned int * psNodeStat /* r19 */, float (* opaNnViewMtx)[4][4] /* r30 */, float (* psMtxWork)[4][4] /* r18 */, unsigned int u32ViewNo /* r22 */, class clsPutGravityObj2_Task * pcTask /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x489370 -> 0x489794
        class clsModelType_OB_TX & rcObj; // r17
        class clsBreakControl & rcBreakControl; // r2
    }
}


// Range: 0x4897A0 -> 0x489810
void main(class clsPutGravityObj2_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4897A0 -> 0x489810
    }
...
// Range: 0x489810 -> 0x48987C
void contactInterraction(class clsPutGravityObj2_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x489810 -> 0x48987C
    }
...
// Range: 0x489880 -> 0x4898C0
void callbackBreakEvent(class clsPutGravityObj2_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x489880 -> 0x4898C0
    }
...
// Range: 0x4898C0 -> 0x48992C
void callbackGravityEvent(class clsPutGravityObj2_Obj * this /* r5 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4898C0 -> 0x48992C
    }
...
// Range: 0x489930 -> 0x4899F8
void requestDrawBreakEffect(class clsPutGravityObj2_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x489930 -> 0x4899F8
    }
...
// Range: 0x489A00 -> 0x489A88
void requestDrawContactEffect(class clsPutGravityObj2_Obj * this /* r2 */, class hkContactPoint * pcContact /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x489A00 -> 0x489A88
...
// Range: 0x489A90 -> 0x489B44
void destroyData(class clsPutGravityObj2_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x489A90 -> 0x489B44
    }
...
// Range: 0x489B50 -> 0x489EC4
void createSe(class clsPutGravityObj2_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x489B50 -> 0x489EC4
        unsigned int oau32Se[2][2]; // r29+0x40
        unsigned int * pau32Se; // r2
        unsigned int oau32Se[3]; // r29+0x60
        unsigned int oau32Se[3]; // r29+0x50
    }
}


// Range: 0x489ED0 -> 0x489EE0
float getFriction() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x489ED0 -> 0x489EE0
...
// Range: 0x489F00 -> 0x48A090
class hkShape * getShape(class clsPutGravityObj2_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x489F00 -> 0x48A090
    }
...
// Range: 0x48A0A0 -> 0x48A2B4
void createDebris(class clsPutGravityObj2_Obj * this /* r19 */, class NNS_OBJECT * psObject /* r18 */, unsigned int u32DebrisStartNodeNum /* r17 */, float f32LimitFrame /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x48A0A0 -> 0x48A2B4
        unsigned int u32Num; // r16
        class clsDebrisControl * pcControl; // r2
        unsigned int u32i; // r21
        char __FUNCTION__[14]; // @ 0x006897A0
    }
}


// Range: 0x48A2C0 -> 0x48A684
void createData(class clsPutGravityObj2_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x48A2C0 -> 0x48A684
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0xD0
        class hkBoxShape * pcBoxShape; // r2
        float mass; // r29+0x190
...
// Range: 0x48A690 -> 0x48A720
void setData(class clsPutGravityObj2_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x48A690 -> 0x48A720
    }
...
// Range: 0x48A720 -> 0x48A7E0
void reset(class clsPutGravityObj2_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x48A720 -> 0x48A7E0
    }
...
// Range: 0x48A7E0 -> 0x48A854
void init(class clsPutGravityObj2_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x48A7E0 -> 0x48A854
        class NNS_OBJECT * psObject; // r2
        float f32LimitFrame; // r29+0x10
    }
}


// Range: 0x48A860 -> 0x48A868
void @80@__dt__21clsPutGravityObj2_ObjFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x48A860 -> 0x48A868
    }
