/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage01\GLinkTrain\GLinkTrainObject.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcParam asTrainLineParam[2]; // size: 0x80, address: 0x635890
static unsigned char chk__asTrainLineParam_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcGimickSubParam asTrainLineFrontSubParam[2]; // size: 0x40, address: 0x635910
...
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x6814B0
class clsGravityGimmickParam t_ocGravityGimmickParam2; // size: 0x78, address: 0x681530
unsigned int otau32Se_TrainHorn[2]; // size: 0x8, address: 0x6815A8
unsigned int otau32Se_TrainL[2]; // size: 0x8, address: 0x6815B0
unsigned int otau32Se_TrainCrash[2]; // size: 0x8, address: 0x6815B8
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x6815C0
float tof32ClipSqDist; // size: 0x4, address: 0x6815D0
...
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x681660
struct /* @anon4 */ {
    // total size: 0xB8
} __vt__20clsGLinkTrain_Object; // size: 0xB8, address: 0x6C14E0
struct /* @anon5 */ {
    // total size: 0xB4
...
// Range: 0x3B8690 -> 0x3B8698
void callbackGravityEvent(class clsGLinkTrain_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B8690 -> 0x3B8698
    }
...
// Range: 0x3B86A0 -> 0x3B8720
void destroyData(class clsGLinkTrain_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B86A0 -> 0x3B8720
    }
...
// Range: 0x3B8720 -> 0x3B8C24
void createData(class clsGLinkTrain_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B8720 -> 0x3B8C24
        ...
        class clsGravityGimmickParam * opcParams[2]; // r29+0x198
...
// Range: 0x3B8C30 -> 0x3B8DB0
void setData(class clsGLinkTrain_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B8C30 -> 0x3B8DB0
    }
...
void drawEffect(class clsPlayerTask * pcPlayer /* r16 */) {
    ...
    /* anonymous block */ {
        ...
        class NNS_VECTOR LOCAL_POS_R; // @ 0x00681608
        class NNS_VECTOR LOCAL_POS; // @ 0x006815F8
        class NNS_VECTOR RAND_SP; // @ 0x006815E8
        float LIFE_FRAME; // @ 0x00681618
        class NNS_VECTOR BEGIN_SP; // @ 0x006815D8
    }
}


// Range: 0x3B8EE0 -> 0x3B8F54
void startGravityAction(class clsGLinkTrain_Object * this /* r16 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B8EE0 -> 0x3B8F54
...
// Range: 0x3B8F60 -> 0x3B8FA4
void requestDrawBreakEffect(class clsGLinkTrain_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B8F60 -> 0x3B8FA4
    }
...
// Range: 0x3B8FB0 -> 0x3B9508
void main(class clsGLinkTrain_Object * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B8FB0 -> 0x3B9508
        class NNS_VECTORFAST sVelocityVecFast; // r29+0x100
        class NNS_VECTORFAST sPosVecFast; // r29+0xF0
        class hkVector4 cVelocity; // r29+0xE0
        class NNS_QUATERNION sRotQuat; // r29+0xD0
        class NNS_QUATERNION sDifQuat; // r29+0xC0
        class hkQuaternion cRotate0; // r29+0xB0
        class hkQuaternion cRotate1; // r29+0xA0
        class hkVector4 cAngle; // r29+0x90
        class clsSe3DControl * pcSe3DControl; // r16
        class hkVector4 cZero; // r29+0x80
    }
}


// Range: 0x3B9510 -> 0x3B9674
void reset(class clsGLinkTrain_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B9510 -> 0x3B9674
...
// Range: 0x3B9680 -> 0x3B990C
void draw(class clsGLinkTrain_Object * this /* r21 */, class NNS_OBJECT * psObject /* r20 */, float (* psMtxPal)[4][4] /* r17 */, unsigned int * psNodeStat /* r16 */, float (* opaNnViewMtx)[4][4] /* r19 */, float (* psMtxWork)[4][4] /* r18 */, unsigned int u32ViewNo /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B9680 -> 0x3B990C
    }
...
// Range: 0x3B9910 -> 0x3B9A30
void * __ct(class clsGLinkTrain_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B9910 -> 0x3B9A30
        signed int s32i; // r4
