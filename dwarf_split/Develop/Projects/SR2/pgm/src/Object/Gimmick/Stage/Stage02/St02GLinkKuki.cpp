/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage02\St02GLinkKuki.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned int otau32Se_BotanicalLink[2]; // size: 0x8, address: 0x6846A0
unsigned int otau32Se_ShidaCut[2]; // size: 0x8, address: 0x6846A8
unsigned int otau32Se_ShidaCrash[2]; // size: 0x8, address: 0x6846B0
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x6846B8
float tof32ClipSqDist; // size: 0x4, address: 0x6846C8
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x6846D0
struct /* @anon20 */ {
    // total size: 0x48
} __vt__17clsGLinkKuki_Task; // size: 0x48, address: 0x6C23C0
struct /* @anon2 */ {
    // total size: 0x48
} __vt__90clsSingleModelGimmick_Task<17clsGLinkKuki_Task,19clsGLinkKuki_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C2530
struct /* @anon6 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsGLinkKuki_Task * m_tpcSingleton; // size: 0x4, address: 0xB16DA0
struct /* @anon13 */ {
    // total size: 0xC
} __vt__33clsSingleton<17clsGLinkKuki_Task>; // size: 0xC, address: 0x6C24C8
void * __dt(class clsGLinkKuki_Object *, signed short); // size: 0x0, address: 0x3F4330
struct /* @anon19 */ {
    // total size: 0x48
} __vt__82clsBaseGimmickBody<17clsGLinkKuki_Task,19clsGLinkKuki_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C24E0
struct /* @anon18 */ {
    // total size: 0xB4
} __vt__24clsBaseGravityLinkObject; // size: 0xB4, address: 0x6C1420
struct /* @anon8 */ {
    // total size: 0xB8
} __vt__19clsGLinkKuki_Object; // size: 0xB8, address: 0x6C2410
struct /* @anon10 */ {
    // total size: 0x28
...
void * __ct(class clsGLinkKuki_Object *); // size: 0x0, address: 0x3F4BA0
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsGLinkKuki_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsGLinkKuki_Task : public clsSingleModelGimmick_Task {
    // total size: 0x98
public:
...
// Range: 0x3F43D0 -> 0x3F458C
void draw(class clsGLinkKuki_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F43D0 -> 0x3F458C
...
// Range: 0x3F4590 -> 0x3F4710
void execute(class clsGLinkKuki_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F4590 -> 0x3F4710
...
// Range: 0x3F4710 -> 0x3F4780
void reset(class clsGLinkKuki_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F4710 -> 0x3F4780
        unsigned int u32Num; // r2
...
// Range: 0x3F4780 -> 0x3F484C
void * __ct(class clsGLinkKuki_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F4780 -> 0x3F484C
...
// Range: 0x3F4C10 -> 0x3F4CC4
void destroyData(class clsGLinkKuki_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F4C10 -> 0x3F4CC4
    }
...
// Range: 0x3F4CD0 -> 0x3F5558
void createData(class clsGLinkKuki_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F4CD0 -> 0x3F5558
        ...
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        char __FUNCTION__[14]; // @ 0x00684690
    }
}


// Range: 0x3F5560 -> 0x3F5568
void setData() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F5560 -> 0x3F5568
...
// Range: 0x3F5570 -> 0x3F5710
void requestDrawContactEffect(class clsGLinkKuki_Object * this /* r6 */, class hkContactPoint * pcContact /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F5570 -> 0x3F5710
        class NNS_VECTORFAST sContactVecFast; // r29+0x70
        class NNS_VECTOR sContactVec; // r29+0x90
        float sMtx[4][4]; // r29+0x30
        class NNS_VECTOR sVelo; // r29+0x80
        class NNS_VECTOR LOCAL_POS_R; // @ 0x006847C0
        class NNS_VECTOR LOCAL_POS; // @ 0x006847B0
        class NNS_VECTOR RAND_SP; // @ 0x006847A0
        float LIFE_FRAME; // @ 0x006847D0
        class NNS_VECTOR BEGIN_SP; // @ 0x00684790
    }
}


// Range: 0x3F5710 -> 0x3F5828
void drawEffect(class clsPlayerTask * pcPlayer /* r16 */) {
    ...
    /* anonymous block */ {
        ...
        class NNS_VECTOR LOCAL_POS_R; // @ 0x00684778
        class NNS_VECTOR LOCAL_POS; // @ 0x00684768
        class NNS_VECTOR RAND_SP; // @ 0x00684758
        float LIFE_FRAME; // @ 0x00684788
        class NNS_VECTOR BEGIN_SP; // @ 0x00684748
    }
}


// Range: 0x3F5830 -> 0x3F5864
void playSe(class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F5830 -> 0x3F5864
    }
...
// Range: 0x3F5870 -> 0x3F5880
void callbackGravityEvent(class clsGLinkKuki_Object * this /* r4 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F5870 -> 0x3F5880
    }
...
// Range: 0x3F5880 -> 0x3F58BC
void requestDrawBreakEffect(class clsGLinkKuki_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F5880 -> 0x3F58BC
    }
...
// Range: 0x3F58C0 -> 0x3F594C
void main(class clsGLinkKuki_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F58C0 -> 0x3F594C
    }
...
// Range: 0x3F5950 -> 0x3F5A7C
void reset(class clsGLinkKuki_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F5950 -> 0x3F5A7C
...
// Range: 0x3F5A80 -> 0x3F5D18
void draw(class clsGLinkKuki_Object * this /* r17 */, class NNS_OBJECT * psObject /* r16 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r20 */, float (* psMtxWork)[4][4] /* r19 */, unsigned int u32ViewNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F5A80 -> 0x3F5D18
    }
