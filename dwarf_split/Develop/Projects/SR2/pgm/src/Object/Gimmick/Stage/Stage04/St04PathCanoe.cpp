/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage04\St04PathCanoe.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x686A20
static float CLIP_DISTx2; // size: 0x4, address: 0x686A28
unsigned int otau32Se_CanoeBreak[2]; // size: 0x8, address: 0x686A30
unsigned int otau32Se_CanoeExp[2]; // size: 0x8, address: 0x686A38
unsigned int otau32Se_CanoeL[2]; // size: 0x8, address: 0x686A40
struct /* @anon16 */ {
    // total size: 0x48
} __vt__17clsPathCanoe_Task; // size: 0x48, address: 0x6C3670
struct /* @anon19 */ {
    // total size: 0x48
} __vt__87clsSingleModelGimmick_Task<17clsPathCanoe_Task,16clsPathCanoe_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C3720
struct /* @anon18 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPathCanoe_Task * m_tpcSingleton; // size: 0x4, address: 0xB17178
struct /* @anon5 */ {
    // total size: 0xC
} __vt__33clsSingleton<17clsPathCanoe_Task>; // size: 0xC, address: 0x6C36B8
void * __dt(class clsPathCanoe_Obj *, signed short); // size: 0x0, address: 0x422F70
struct /* @anon8 */ {
    // total size: 0x48
} __vt__79clsBaseGimmickBody<17clsPathCanoe_Task,16clsPathCanoe_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C36D0
struct /* @anon3 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon20 */ {
    // total size: 0xA8
} __vt__16clsPathCanoe_Obj; // size: 0xA8, address: 0x6C3770
struct /* @anon11 */ {
    // total size: 0x28
...
void * __ct(class clsPathCanoe_Obj *); // size: 0x0, address: 0x423BF0
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x686AA0
...
public:
    ...
    enum enmPathCanoeMode m_enPathCanoeMode; // offset 0xE0, size 0x4
    ...
    float m_f32Alpha; // offset 0x214, size 0x4
    signed int m_s32LoopSe; // offset 0x218, size 0x4
    unsigned int m_u32Attr; // offset 0x21C, size 0x4
    float m_f32EffectFrame; // offset 0x220, size 0x4
    float m_f32MaxSpeed; // offset 0x224, size 0x4
    float m_f32MimSpeed; // offset 0x228, size 0x4
    float m_f32SlowPathRateStart; // offset 0x22C, size 0x4
    float m_f32SpeedOld; // offset 0x230, size 0x4
    class NNS_VECTORFAST m_sOldUpVecFast; // offset 0x240, size 0x10
    unsigned char m_bTurbulenceDsp; // offset 0x250, size 0x1
    unsigned int m_u32ObjectNum; // offset 0x254, size 0x4
    unsigned int m_u32TexIdx; // offset 0x258, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0x25C, size 0x4
};
...
class clsPathCanoe_Task : public clsSingleModelGimmick_Task {
    // total size: 0x9C
public:
    unsigned short * m_TexIdx; // offset 0x94, size 0x4
    unsigned short * m_TexIdx2; // offset 0x98, size 0x4
};
class hkArray {
    // total size: 0xC
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPathCanoe_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x423070 -> 0x42346C
void draw(class clsPathCanoe_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x423070 -> 0x42346C
        ...
        class clsModelType_OB_TX & rcModel; // r17
...
// Range: 0x423470 -> 0x423690
void execute(class clsPathCanoe_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x423470 -> 0x423690
...
// Range: 0x423690 -> 0x42372C
void reset(class clsPathCanoe_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x423690 -> 0x42372C
        unsigned int u32Num; // r2
...
// Range: 0x423730 -> 0x423890
void * __ct(class clsPathCanoe_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x423730 -> 0x423890
        class hkVector4 cVec; // r29+0x40
    }
}


// Range: 0x423D90 -> 0x42402C
void boundAction(class clsPathCanoe_Obj * this /* r16 */, class clsPlayerTask * pcPlayerTask /* r3 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x423D90 -> 0x42402C
        class NNS_VECTORFAST sSpdVecFast; // r29+0x60
        class hkVector4 cPos; // r29+0x50
        class hkVector4 cRot; // r29+0x40
    }
}


// Range: 0x424030 -> 0x4240CC
void contactTriggerEvent(class clsPathCanoe_Obj * this /* r16 */, class hkContactPoint * pcContact /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x424030 -> 0x4240CC
    }
...
// Range: 0x4240D0 -> 0x424168
void callbackCrashEvent(class clsPathCanoe_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4240D0 -> 0x424168
    }
...
// Range: 0x424170 -> 0x424228
void destroyData(class clsPathCanoe_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x424170 -> 0x424228
    }
...
// Range: 0x424230 -> 0x4242C4
void callbackGravityEvent(class clsPathCanoe_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x424230 -> 0x4242C4
    }
...
// Range: 0x4242D0 -> 0x4245CC
unsigned char draw(class clsPathCanoe_Obj * this /* r19 */, class clsModelType_OB_TX & rcObj /* r18 */, float (* psMtxPal)[4][4] /* r20 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r22 */, float (* psMtxWork)[4][4] /* r17 */, unsigned int u32TexNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4242D0 -> 0x4245CC
        unsigned char bReturn; // r16
        float sMtx[4][4]; // r29+0xD0
    }
}


// Range: 0x4245D0 -> 0x4247C4
void main(class clsPathCanoe_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4245D0 -> 0x4247C4
    }
...
// Range: 0x4247D0 -> 0x4247D8
void setData(class clsPathCanoe_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4247D0 -> 0x4247D8
    }
...
// Range: 0x4247E0 -> 0x4248A4
void requestDrawBreakEffect(class clsPathCanoe_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4247E0 -> 0x4248A4
        class NNS_VECTORFAST sVec; // r29+0x20
    }
}


// Range: 0x4248B0 -> 0x424BF0
void chackAction(class clsPathCanoe_Obj * this /* r19 */, unsigned int u32Num /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4248B0 -> 0x424BF0
        unsigned int u32i; // r11
        unsigned char bSkip; // r10
        class clsPath & rsPath; // r2
        float sMtx[4][4]; // r29+0xF0
        float sTurbMtx[4][4]; // r29+0xB0
        class NNS_VECTORFAST sVecFast; // r29+0xA0
        class NNS_VECTORFAST sPlayerPosVecFast; // r29+0x90
        class NNS_VECTORFAST sLocalPlayerPosVecFast; // r29+0x80
...
// Range: 0x424BF0 -> 0x425340
void path_main(class clsPathCanoe_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x424BF0 -> 0x425340
        class clsPath & rsPath; // r18
        class NNS_QUATERNION sOldRotQuat; // r29+0x1D0
        class hkQuaternion cRotQuat; // r29+0x1C0
        class NNS_VECTORFAST sPosVecFast; // r29+0x1B0
        float f32RadY; // r29+0x1E0
        float f32RadX; // r21
        class NNS_QUATERNION sStartQuat; // r29+0x1A0
        class NNS_QUATERNION sEndQuat; // r29+0x190
        class NNS_QUATERNION sQuatX; // r29+0x180
        class NNS_QUATERNION sQuatY; // r29+0x170
        class NNS_VECTORFAST sDirVecFast; // r29+0x160
        float aTmpMtx[4][4]; // r29+0x120
        class clsPosturalCtrl & rcPostural; // r2
        class NNS_VECTORFAST sUpVecFast; // r29+0x110
        class NNS_VECTORFAST sVelocityVecFast; // r29+0x100
        class NNS_VECTORFAST sMoveVecFast; // r29+0xF0
        class hkVector4 cVelocity; // r29+0xE0
        class NNS_VECTORFAST sVelocityVecFast; // r29+0xD0
        class NNS_VECTORFAST sMoveVecFast; // r29+0xC0
        class hkVector4 cVelocity; // r29+0xB0
        class NNS_VECTORFAST sDirVecFast; // r29+0xA0
        class NNS_VECTORFAST sUpVecFast; // r29+0x90
        class hkVector4 cAngle; // r29+0x80
        class hkQuaternion cRotQuatNew; // r29+0x70
    }
}


// Range: 0x425340 -> 0x425590
void reset(class clsPathCanoe_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x425340 -> 0x425590
        class hkVector4 cVelocity; // r29+0x50
    }
}


// Range: 0x425590 -> 0x425C34
void createData(class clsPathCanoe_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x425590 -> 0x425C34
        ...
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        char __FUNCTION__[14]; // @ 0x00686A10
    }
}


// Range: 0x425C40 -> 0x425ED8
void initParameter(class clsPathCanoe_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x425C40 -> 0x425ED8
        class NNS_QUATERNION sEndQuat; // r29+0x50
        class NNS_VECTORFAST sDirVecFast; // r29+0x40
        float f32RadY; // r29+0x60
    }
}


// Range: 0x425EE0 -> 0x425EE8
void init(class clsPathCanoe_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x425EE0 -> 0x425EE8
    }
