/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage10\St10Lift.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32CLIP_DISTx2; // size: 0x4, address: 0x688610
float tof32CLIP_DISTx2; // size: 0x4, address: 0x688618
class NNS_VECTORFAST tosPlayerOffsetPosFast; // size: 0x10, address: 0x688620
class NNS_VECTOR tosPosVec; // size: 0xC, address: 0x688630
float tof32RotY; // size: 0x4, address: 0x0
class NNS_VECTORFAST tosPosVec; // size: 0x10, address: 0x688640
static class stcInfoParam tosCraneParam; // size: 0x18, address: 0x688650
static class stcInfoParam tosPlayerParam; // size: 0x18, address: 0x688670
static class stcControlParam tosControlParam; // size: 0x98, address: 0x688690
struct /* @anon21 */ {
    // total size: 0x48
} __vt__12clsLift_Task; // size: 0x48, address: 0x6C6790
void * __dt(class clsLift_Obj *, signed short); // size: 0x0, address: 0x468E70
struct /* @anon5 */ {
    // total size: 0x48
} __vt__69clsBaseGimmickBody<12clsLift_Task,11clsLift_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C67F0
struct /* @anon14 */ {
    // total size: 0x28
...
struct /* @anon8 */ {
    // total size: 0x34
} __vt__23clsLiftThroughCollision; // size: 0x34, address: 0x6C68A0
struct /* @anon15 */ {
    // total size: 0x30
...
struct /* @anon0 */ {
    // total size: 0x58
} __vt__11clsLift_Obj; // size: 0x58, address: 0x6C6840
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x688780
...
void * __ct(class clsLift_Obj *); // size: 0x0, address: 0x46A240
class clsLift_Task * m_tpcSingleton; // size: 0x4, address: 0xB17458
struct /* @anon4 */ {
    // total size: 0xC
} __vt__28clsSingleton<12clsLift_Task>; // size: 0xC, address: 0x6C67D8
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x688770
void * __dt(class clsLift *, signed short); // size: 0x0, address: 0x46B410
struct /* @anon10 */ {
    // total size: 0xC
...
struct /* @anon3 */ {
    // total size: 0x10
} __vt__7clsLift; // size: 0x10, address: 0x6C68E0
void * __ct(class clsLift *); // size: 0x0, address: 0x46B5B0
...
class clsLift_Task : public clsBaseGimmickBody {
    // total size: 0xAC
public:
    float * m_pf32TexCoordV; // offset 0x94, size 0x4
    class clsModelType_OB_TX m_cModelCrane; // offset 0x98, size 0x8
    class clsLiftModels m_cModels; // offset 0xA0, size 0x4
    class clsLiftThroughCollision m_cThroughCollision; // offset 0xA4, size 0x8
};
...
public:
    ...
    class clsLift_Obj * m_pcLiftObj; // offset 0x1C8, size 0x4
    ...
    class NNS_VECTORFAST m_sSetPosVecFast; // offset 0x200, size 0x10
    class clsPlaySe_2D * m_pcPlaySe2D; // offset 0x210, size 0x4
    unsigned int m_u32SeId; // offset 0x214, size 0x4
};
...
class clsLift_Obj : public clsPhantomGimmickObject {
    // total size: 0xB0
public:
    enum enmLiftMode m_eLiftMode; // offset 0x60, size 0x4
    ...
    class clsGimmickAutoRunBuffer m_cLiftBuffer; // offset 0x70, size 0x1C
...
class clsGimmickAutoRunBuffer : public clsGimmickAutoRunBufferBase {
    // total size: 0x1C
public:
    class clsLift * m_apcObj; // offset 0xC, size 0x4
    class clsLift * * m_ppcExecute; // offset 0x10, size 0x4
    class clsLift * * m_ppcSleep; // offset 0x14, size 0x4
    class clsLift * * m_ppcExecuteWork; // offset 0x18, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsLift_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsLiftModels {
    // total size: 0x4
public:
    class clsModelType_OB_TX * m_pcModelCrane; // offset 0x0, size 0x4
};
enum enmMoveMode {
    MOVEMODE_APPROACH = 0,
...
// Range: 0x468FB0 -> 0x469238
void draw(class clsLift_Task * this /* r29+0xCC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x468FB0 -> 0x469238
        ...
        class clsLiftModels & rcModel; // r20
...
// Range: 0x4692E0 -> 0x46957C
unsigned char draw(class clsLift * this /* r19 */, class clsLiftModels & rcModel /* r18 */, float (* psMtxPal)[4][4] /* r17 */, unsigned int * psNodeStat /* r19 */, float (* opaNnViewMtx)[4][4] /* r22 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r20 */, unsigned int NodeStatus /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4692E0 -> 0x46957C
...
// Range: 0x4695D0 -> 0x4697EC
void execute(class clsLift_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4695D0 -> 0x4697EC
        unsigned int u32Num; // r2
...
// Range: 0x4697F0 -> 0x469B1C
void controlPlayer(class clsLift_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4697F0 -> 0x469B1C
        ...
        class clsGimmickAutoRunBuffer & rcLiftBuffer; // r22
        class clsLift * pcLift; // r16
    }
}


// Range: 0x469B40 -> 0x469C8C
void createModel(class clsLift_Task * this /* r19 */, class stcBinInfo & rsBinInfoI /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x469B40 -> 0x469C8C
...
// Range: 0x469C90 -> 0x469E14
void reset(class clsLift_Task * this /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x469C90 -> 0x469E14
        unsigned int u32Num; // r2
...
// Range: 0x469E20 -> 0x46A014
void * __ct(class clsLift_Task * this /* r18 */, unsigned int u32ObjectAreaNum /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x469E20 -> 0x46A014
    }
...
// Range: 0x46A3A0 -> 0x46A568
void contactTriggerEvent(class clsLift_Obj * this /* r19 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46A3A0 -> 0x46A568
...
// Range: 0x46A570 -> 0x46A5C0
void destroyData(class clsLift_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46A570 -> 0x46A5C0
    }
...
// Range: 0x46A5C0 -> 0x46A718
void createData(class clsLift_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46A5C0 -> 0x46A718
...
// Range: 0x46A720 -> 0x46A860
void init(class clsLift_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46A720 -> 0x46A860
    }
...
// Range: 0x46AAB0 -> 0x46B3AC
void movePlayer(class clsLift * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46AAB0 -> 0x46B3AC
