/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\WallGimmick.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float atof32ClipSqDist[17]; // size: 0x44, address: 0x68B6B0
struct /* @anon6 */ {
    // total size: 0x48
} __vt__19clsWallGimmick_Task; // size: 0x48, address: 0x6C8D50
struct /* @anon16 */ {
    // total size: 0x48
} __vt__91clsSingleModelGimmick_Task<19clsWallGimmick_Task,18clsWallGimmick_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C8E00
struct /* @anon3 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsWallGimmick_Task * m_tpcSingleton; // size: 0x4, address: 0xB17B38
struct /* @anon4 */ {
    // total size: 0xC
} __vt__35clsSingleton<19clsWallGimmick_Task>; // size: 0xC, address: 0x6C8D98
void * __dt(class clsWallGimmick_Obj *, signed short); // size: 0x0, address: 0x4BB710
struct /* @anon10 */ {
    // total size: 0x48
} __vt__83clsBaseGimmickBody<19clsWallGimmick_Task,18clsWallGimmick_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C8DB0
struct /* @anon11 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon17 */ {
    // total size: 0xA8
} __vt__18clsWallGimmick_Obj; // size: 0xA8, address: 0x6C8E50
struct /* @anon12 */ {
    // total size: 0x28
...
void * __ct(class clsWallGimmick_Obj *); // size: 0x0, address: 0x4BBE40
...
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x68B720
...
class clsWallGimmick_Obj : public clsRigidBodyGimmickObj {
    // total size: 0x140
public:
    class NNS_VECTORFAST m_sUpVecFast; // offset 0xD0, size 0x10
    class hkShape * m_pcShape; // offset 0xE0, size 0x4
    unsigned int m_u32Num; // offset 0xE4, size 0x4
    float m_f32FrameScale; // offset 0xE8, size 0x4
    float m_sDrawClipMtx[4][4]; // offset 0xF0, size 0x40
    unsigned int m_u32NotDrawFlag; // offset 0x130, size 0x4
};
...
class clsWallGimmick_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsWallGimmick_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x4BB810 -> 0x4BB9B8
void draw(class clsWallGimmick_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BB810 -> 0x4BB9B8
...
// Range: 0x4BB9C0 -> 0x4BBA10
void execute(class clsWallGimmick_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BB9C0 -> 0x4BBA10
    }
...
// Range: 0x4BBA10 -> 0x4BBA80
void reset(class clsWallGimmick_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BBA10 -> 0x4BBA80
        unsigned int u32Num; // r2
...
// Range: 0x4BBA80 -> 0x4BBAEC
void * __ct(class clsWallGimmick_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BBA80 -> 0x4BBAEC
    }
...
// Range: 0x4BBF00 -> 0x4BC29C
void draw(class clsWallGimmick_Obj * this /* r21 */, class clsModelType_OB_TX & rcObj /* r19 */, float (* psMtxPal)[4][4] /* r20 */, unsigned int * psNodeStat /* r19 */, float (* opaNnViewMtx)[4][4] /* r23 */, float (* psMtxWork)[4][4] /* r18 */, unsigned int u32ViewNo /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BBF00 -> 0x4BC29C
        class clsBaseRace_Task * pcBaseRace_Task; // r2
        class NNS_OBJECT * psObject; // r17
        class NNS_VECTORFAST & rsUpVecFast; // r2
        class NNS_VECTOR & rsScaleVec; // r2
        float f32FrameScale; // r29+0x110
        unsigned int u32Num; // r22
    }
}


// Range: 0x4BC2A0 -> 0x4BC370
void main(class clsWallGimmick_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BC2A0 -> 0x4BC370
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        class clsGimmickRigidBody * pcRigidBody; // r19
        signed int s32i; // r18
    }
}


// Range: 0x4BC370 -> 0x4BC3BC
void reset(class clsWallGimmick_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BC370 -> 0x4BC3BC
    }
...
// Range: 0x4BC3C0 -> 0x4BC420
void destroyData(class clsWallGimmick_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BC3C0 -> 0x4BC420
    }
...
// Range: 0x4BC420 -> 0x4BC8C4
void createData(class clsWallGimmick_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BC420 -> 0x4BC8C4
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0x110
        class hkVector4 cBox; // r29+0x100
