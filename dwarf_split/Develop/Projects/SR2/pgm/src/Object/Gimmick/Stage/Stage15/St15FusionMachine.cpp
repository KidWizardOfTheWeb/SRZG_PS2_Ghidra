/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage15\St15FusionMachine.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x684B60
static float toaf32BlackHoleTime[3]; // size: 0xC, address: 0x684B68
static float toaf32ReturnDistance[2]; // size: 0x8, address: 0x684B78
static float toaf32CheckDist[2][2]; // size: 0x10, address: 0x684B80
static float toaf32ReturnCheckTable[2]; // size: 0x8, address: 0x684B90
static float toaf32MissionReturnCheckTable[2]; // size: 0x8, address: 0x684B98
static float toaf32MissionReturnCheckTable5[2]; // size: 0x8, address: 0x684BA0
static float toaf32MissionReturnCheckTable7[2]; // size: 0x8, address: 0x0
static float toaf32ReturnRate[2]; // size: 0x8, address: 0x684BA8
static float toaf32AttackCheckTable1[4]; // size: 0x10, address: 0x684BB0
static float toaf32AttackCheckTable2[4]; // size: 0x10, address: 0x684BC0
static float toaf32MissionAttackCheckTable2[8]; // size: 0x20, address: 0x684BD0
static float toaf32MissionAttackCheckTable4[12]; // size: 0x30, address: 0x684BF0
static float toaf32MissionAttackTargetLR4[12]; // size: 0x30, address: 0x684C20
static float toaf32VanishCheckTable[2]; // size: 0x8, address: 0x684C50
static float tof32EmergenceCheckTable[2]; // size: 0x8, address: 0x684C58
static float tof32EmergenceDistTable[2]; // size: 0x8, address: 0x684C60
static float tof32EmergenceDistTableSR[2]; // size: 0x8, address: 0x684C68
static float toaf32Attack1OffsetX[5]; // size: 0x14, address: 0x0
static class stcParam asFusionMachineLineParam[2]; // size: 0x80, address: 0x684C70
static unsigned char chk__asFusionMachineLineParam_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcGimickSubParam asFusionMachineLineSubParam[1]; // size: 0x20, address: 0x684CF0
struct /* @anon11 */ {
    // total size: 0x48
} __vt__21clsFusionMachine_Task; // size: 0x48, address: 0x6C2AC0
void * __dt(class clsFusionMachine_Obj *, signed short); // size: 0x0, address: 0x3FE490
struct /* @anon3 */ {
    // total size: 0x48
} __vt__91clsBaseGimmickBody<21clsFusionMachine_Task,20clsFusionMachine_Obj,22clsFusionMachineModels>; // size: 0x48, address: 0x6C2B20
struct /* @anon9 */ {
    // total size: 0x30
} __vt__7clsTask; // size: 0x30, address: 0x6B59F0
struct /* @anon12 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
struct /* @anon7 */ {
    // total size: 0x28
} __vt__9clsObject; // size: 0x28, address: 0x6B5C10
struct /* @anon4 */ {
    // total size: 0x44
} __vt__13clsGimmickObj; // size: 0x44, address: 0x6BB340
struct /* @anon5 */ {
    // total size: 0xC
} __vt__21clsHaveGimmickPhantom; // size: 0xC, address: 0x6BB388
struct /* @anon14 */ {
    // total size: 0x58
} __vt__23clsPhantomGimmickObject; // size: 0x58, address: 0x6BB3A0
struct /* @anon15 */ {
    // total size: 0x58
} __vt__20clsFusionMachine_Obj; // size: 0x58, address: 0x6C2B70
...
class clsMeteoriteL_Task * m_tpcSingleton; // size: 0x4, address: 0x703BD0
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x684FF0
float (* tpsNnMtxList)[4][4]; // size: 0x4, address: 0x707DE0
class NNS_MATRIXSTACK tsNnMtxStack; // size: 0x10, address: 0x707DD0
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x684FE0
...
class clsPlayerGravityWave_Task * m_tpcSingleton; // size: 0x4, address: 0xB0D9A8
class clsGameMgr * m_tpcSingleton; // size: 0x4, address: 0x6E6980
class clsGLinkFloorBoard_Task * m_tpcSingleton; // size: 0x4, address: 0xB16DB8
class clsFloatingMeteorite_Task * m_tpcSingleton; // size: 0x4, address: 0xB16358
class clsBlackHole_Task * m_tpcSingleton; // size: 0x4, address: 0x703BD8
class clsFusionMachine_Task * m_tpcSingleton; // size: 0x4, address: 0x703BE8
class clsPathData * m_tpcSingleton; // size: 0x4, address: 0x703C10
class clsMeteoriteS_Task * m_tpcSingleton; // size: 0x4, address: 0x703BC8
class clsEnergyBullet_Task * m_tpcSingleton; // size: 0x4, address: 0x703BE0
...
class hkThreadMemory * s_threadMemoryInstance; // size: 0x4, address: 0xB08F70
void * __ct(class clsFusionMachine_Obj *); // size: 0x0, address: 0x404ED0
struct /* @anon16 */ {
    // total size: 0xC
} __vt__37clsSingleton<21clsFusionMachine_Task>; // size: 0xC, address: 0x6C2B08
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x684F90
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x684FD0
class clsPfCri * m_tpcSingleton; // size: 0x4, address: 0x6E6998
class clsOOMainHeap * t_cInstance; // size: 0x4, address: 0xB17268
struct /* @anon2 */ {
    // total size: 0x40
} __vt__23clsBossGravityWave_Task; // size: 0x40, address: 0x6D18F0
struct /* @anon10 */ {
    // total size: 0x44
} __vt__21clsSimpleShapePhantom; // size: 0x44, address: 0x6BB2F0
float hkTransformIdentity[]; // size: 0x0, address: 0x6243A0
struct /* @anon8 */ {
    // total size: 0x40
...
struct /* @anon1 */ {
    // total size: 0xC
} __vt__14clsSe3DControl; // size: 0xC, address: 0x6BBB18
struct /* @anon17 */ {
    // total size: 0xC
...
class clsFusionMachine_Task : public clsBaseGimmickBody {
    // total size: 0xD0
public:
    unsigned char m_bDebugReturnStartRateDisp; // offset 0xBC, size 0x1
    unsigned char m_bDebugReturnEndRateDisp; // offset 0xBD, size 0x1
    signed int m_s32DebugAttackType; // offset 0xC0, size 0x4
    unsigned char m_bDebugAttackRateDisp; // offset 0xC4, size 0x1
    unsigned char m_bDebugPosDisp; // offset 0xC5, size 0x1
    unsigned char m_bDebugDistanceDisp; // offset 0xC6, size 0x1
    unsigned char m_bDebugLengthRateDisp; // offset 0xC7, size 0x1
    unsigned char m_bDebugHPDisp; // offset 0xC8, size 0x1
    unsigned char m_bDebugBossStop; // offset 0xC9, size 0x1
    unsigned char m_bDebugAttackEnable; // offset 0xCA, size 0x1
    float m_f32Count; // offset 0xCC, size 0x4
};
class clsGLinkFloorBoard_Task : public clsSingleModelGimmick_Task, public clsGimmickCommon {
    // total size: 0x9C
public:
    class hkShape * m_pcPartsShape; // offset 0x98, size 0x4
};
class clsSingleton {
    // total size: 0x4
};
...
class clsFloatingMeteorite_Task : public clsSingleModelGimmick_Task, public clsGimmickCommon {
    // total size: 0x98
public:
    unsigned char m_bAction; // offset 0x95, size 0x1
};
class clsSe3DControl {
    // total size: 0xC
public:
    class stcSeData * m_apsSeData; // offset 0x4, size 0x4
    unsigned char m_u8SeNum; // offset 0x8, size 0x1
};
...
class clsFusionMachine_Obj : public clsPhantomGimmickObject {
    // total size: 0x440
public:
    unsigned char m_bEnableDebug; // offset 0x60, size 0x1
    signed int m_s32DebugReturnRateNum; // offset 0x64, size 0x4
    float m_af32DebugReturnStartRate[2]; // offset 0x68, size 0x8
    float m_af32DebugReturnEndRate[2]; // offset 0x70, size 0x8
    signed int m_s32DebugAttackType; // offset 0x78, size 0x4
    signed int m_s32DebugAttackRateNum; // offset 0x7C, size 0x4
    float m_af32DebugAttackRate[2][4]; // offset 0x80, size 0x20
    float m_af32DebugBossDistance[4]; // offset 0xA0, size 0x10
    float m_f32DebugUpDownRange; // offset 0xB0, size 0x4
    float m_f32DebugUpDownRate; // offset 0xB4, size 0x4
    float m_f32DebugOffsetY; // offset 0xB8, size 0x4
    float m_f32DebugAddSpeed; // offset 0xBC, size 0x4
    float m_f32DebugLimitSpeed; // offset 0xC0, size 0x4
    float m_f32DebugDefaultSpeed; // offset 0xC4, size 0x4
    float m_f32DebugReturnSpeed; // offset 0xC8, size 0x4
    float m_f32DebugStartDistance; // offset 0xCC, size 0x4
    float m_f32DebugReturnDistance; // offset 0xD0, size 0x4
    float m_f32DebugBulletChargeFrame; // offset 0xD4, size 0x4
    float m_f32DebugMeteoChargeFrame; // offset 0xD8, size 0x4
    float m_f32DebugBlackHoleTime; // offset 0xDC, size 0x4
    float m_f32DebugDamageBurstSpeed; // offset 0xE0, size 0x4
    signed int m_s32DebugMotionNo; // offset 0xE4, size 0x4
    float m_f32DebugEffectFrame; // offset 0xE8, size 0x4
    float m_f32DebugEffectVal; // offset 0xEC, size 0x4
    enum enmFusionMachineMode m_eFusionMachineMode; // offset 0xF0, size 0x4
    enum enmReturnCheckState m_eReturnCheckState; // offset 0xF4, size 0x4
    enum enmAttackState m_eAttackState; // offset 0xF8, size 0x4
    enum enmEffectCheckState m_eEffectCheckState; // offset 0xFC, size 0x4
    enum enmAttackMode m_eAttackMode; // offset 0x100, size 0x4
    class clsOOVector m_vecLapMark; // offset 0x104, size 0x10
    class clsPosturalCtrl m_cPostural; // offset 0x120, size 0xB0
    class clsPath m_cPath; // offset 0x1D0, size 0x60
    float m_sProjMtx44[4][4]; // offset 0x230, size 0x40
    class clsBossGravityWave_Task * m_pcBossGravityWave; // offset 0x270, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0x274, size 0x4
    class NNS_VECTORFAST m_sDirVecFast; // offset 0x280, size 0x10
    class NNS_VECTORFAST m_sOffsetVecFast; // offset 0x290, size 0x10
    class NNS_VECTORFAST m_asParallelDir[2]; // offset 0x2A0, size 0x20
    class NNS_VECTORFAST m_asParallelPos[2]; // offset 0x2C0, size 0x20
    class NNS_VECTORFAST m_asSpecularDir[2]; // offset 0x2E0, size 0x20
    float * m_opf32ReturnCheckTable; // offset 0x300, size 0x4
    float * m_opf32AttackCheckTable; // offset 0x304, size 0x4
    float m_f32BaseCount; // offset 0x308, size 0x4
    float m_f32Count; // offset 0x30C, size 0x4
    float m_f32Speed; // offset 0x310, size 0x4
    float m_f32MotionFrame; // offset 0x314, size 0x4
    float m_f32MotionEndFrame; // offset 0x318, size 0x4
    float m_f32MoveOffsetLR; // offset 0x31C, size 0x4
    float m_f32MoveOffsetSpeed; // offset 0x320, size 0x4
    float m_f32MoveOffsetCount; // offset 0x324, size 0x4
    float m_af32PlayerFlyCount[8]; // offset 0x328, size 0x20
    signed int m_s32SeId1; // offset 0x348, size 0x4
    signed int m_s32SeId2; // offset 0x34C, size 0x4
    signed int m_s32HP; // offset 0x350, size 0x4
    signed int m_s32TotalMaxLap; // offset 0x354, size 0x4
    signed int m_s32AttackCount; // offset 0x358, size 0x4
    signed int m_s32AttackOrder; // offset 0x35C, size 0x4
    signed int m_s32MotionNo; // offset 0x360, size 0x4
    unsigned char m_bEffectFlag; // offset 0x364, size 0x1
    unsigned char m_bDrawFlag; // offset 0x365, size 0x1
    unsigned char m_bMotionChangeFlag; // offset 0x366, size 0x1
    unsigned char m_bEmergenceFlag; // offset 0x367, size 0x1
    unsigned int m_u32TopPlayerNo; // offset 0x368, size 0x4
    unsigned int m_u32MainGroup; // offset 0x36C, size 0x4
    unsigned int m_u32AutoGDiveCheck; // offset 0x370, size 0x4
    unsigned int m_u32LightNo; // offset 0x374, size 0x4
    signed char m_s8AttackCheckStep; // offset 0x378, size 0x1
    signed char m_s8AttackCheckMax; // offset 0x379, size 0x1
    signed char m_s8DamagePoint; // offset 0x37A, size 0x1
    unsigned char m_u8PathNo; // offset 0x37B, size 0x1
    class NNS_VECTORFAST m_sEffectFollowPos; // offset 0x380, size 0x10
    class NNS_VECTORFAST m_sEffectFollowPos2; // offset 0x390, size 0x10
    float m_sEffectMtx[4][4]; // offset 0x3A0, size 0x40
    class clsTask * m_apcLoopParticle[3]; // offset 0x3E0, size 0xC
    float m_sLineDrawMtx[4][4]; // offset 0x3F0, size 0x40
    class clsBackLineEffectTask * m_apcLineTask[2]; // offset 0x430, size 0x8
};
...
class clsMeteoriteS_Obj : public clsRigidBodyGimmickObj {
    // total size: 0x1B0
public:
    class clsSe3DControl * m_pcSe3DControl; // offset 0xD0, size 0x4
    class NNS_VECTORFAST m_sOffsetVecFast; // offset 0xE0, size 0x10
    enum enmMeteoriteSMode m_eMeteoriteSMode; // offset 0xF0, size 0x4
    float m_f32OffsetScale; // offset 0xF4, size 0x4
    float m_f32UpdateRate; // offset 0xF8, size 0x4
    float m_f32TimeLagCount; // offset 0xFC, size 0x4
    float m_f32EntryLagCount; // offset 0x100, size 0x4
    float m_f32StopMoveCount; // offset 0x104, size 0x4
    float m_f32EffectFrame; // offset 0x108, size 0x4
    float m_f32RotDeg; // offset 0x10C, size 0x4
    float m_f32RotAddDeg; // offset 0x110, size 0x4
    unsigned int m_u32ParentObjNo; // offset 0x114, size 0x4
    float m_sOrbitMtx[4][4]; // offset 0x120, size 0x40
    float m_sEffectMtx[4][4]; // offset 0x160, size 0x40
    class clsTask * m_psEffectTask; // offset 0x1A0, size 0x4
};
class stcSeed {
    // total size: 0x30
public:
...
public:
    ...
    class clsModelType_OB_TX & m_rcModel; // offset 0x60, size 0x4
...
public:
    ...
    float m_f32DelayFrame; // offset 0xE4, size 0x4
    float m_f32EndFrame; // offset 0xE8, size 0x4
    float m_sEffectMtx[4][4]; // offset 0xF0, size 0x40
    class NNS_QUATERNION m_sRotQuat; // offset 0x130, size 0x10
    class clsSe3DControl * m_pcSe3DControl; // offset 0x140, size 0x4
    class clsTask * m_psEffectTask; // offset 0x144, size 0x4
};
...
class clsBlackHole_Obj : public clsGimmickObj {
    // total size: 0x430
public:
    class clsPath m_cPath; // offset 0x50, size 0x60
    class clsPosturalCtrl m_cPostural; // offset 0xB0, size 0xB0
    enum enmBlackHoleMode m_eBlackHoleMode; // offset 0x160, size 0x4
    float m_f32MotionFrame; // offset 0x164, size 0x4
    float m_f32MatMotionFrame; // offset 0x168, size 0x4
    float m_f32Count; // offset 0x16C, size 0x4
    signed int m_s32No; // offset 0x170, size 0x4
    class clsPath m_cSubPath; // offset 0x180, size 0x60
    class NNS_VECTORFAST m_asPosVecFast[3]; // offset 0x1E0, size 0x30
    class clsPosturalCtrl m_acPostural[3]; // offset 0x210, size 0x210
    unsigned int m_au32PointNo[3]; // offset 0x420, size 0xC
    float m_f32Scale; // offset 0x42C, size 0x4
};
class _adx_talk {
    // total size: 0xC8
public:
...
class clsRigidBodyGimmickObj : public clsGimmickObj, public clsHaveGimmickRigidBody {
    // total size: 0xD0
public:
    class clsContactControl m_cContactControl; // offset 0x58, size 0x14
    class clsBreakControl m_cBreakControl; // offset 0x6C, size 0x30
    class clsDebrisControl * m_pcDebrisControl; // offset 0x9C, size 0x4
    class clsGravityActionControl * m_pcGravityGimmickControl; // offset 0xA0, size 0x4
    class clsObject * m_pcContactPlayer; // offset 0xA4, size 0x4
    class clsObject * m_pcContactObject; // offset 0xA8, size 0x4
    enum enmControlMode m_eControlMode; // offset 0xAC, size 0x4
    enum enmControlFlag m_eControlFlag; // offset 0xB0, size 0x4
    enum enmBreakType m_eBreakType; // offset 0xB4, size 0x4
    float m_f32ContactBurnOutEffectFrame; // offset 0xB8, size 0x4
    signed int m_s32ContactBurnOutCount; // offset 0xBC, size 0x4
    float m_f32MissionBreakFrame; // offset 0xC0, size 0x4
    float m_f32ContactBurnOutFrame; // offset 0xC4, size 0x4
    signed int m_s32ContactBurnOutInterval; // offset 0xC8, size 0x4
    signed char m_s8ContactBurnOutRequestNum; // offset 0xCC, size 0x1
};
...
class clsFusionMachineModels {
    // total size: 0x30
public:
    class clsModelType_OB_TX m_cModel; // offset 0x0, size 0x8
    class NNS_MOTION * m_apsMotion[10]; // offset 0x8, size 0x28
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsEnergyBullet_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsGLinkFloorBoard_Object * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB_TX m_cModel; // offset 0x88, size 0x8
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0x90, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsFloatingMeteorite_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB_TX m_cModel; // offset 0x88, size 0x8
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0x90, size 0x4
...
class clsMeteoriteL_Task : public clsSingleModelGimmick_Task, public clsGimmickCommon {
    // total size: 0xB8
public:
    unsigned char m_bDebugTargetPosDisp; // offset 0x95, size 0x1
    signed int m_s32DebugDispZoneNo; // offset 0x98, size 0x4
    float m_f32DebugOffsetY; // offset 0x9C, size 0x4
    float m_f32DebugFallTime; // offset 0xA0, size 0x4
    float m_f32DebugQuakeDistance; // offset 0xA4, size 0x4
    float m_f32DebugQuakeFrame; // offset 0xA8, size 0x4
    float m_f32DebugQuakeRumbleFrame; // offset 0xAC, size 0x4
    unsigned char m_bInitFlag; // offset 0xB0, size 0x1
    signed int m_s32SeId; // offset 0xB4, size 0x4
};
class stcFactor {
    // total size: 0x1C
public:
...
public:
    class clsSe3DControl * m_pcSe3DControl; // offset 0xD0, size 0x4
    class clsPath m_cPath; // offset 0xE0, size 0x60
    class clsPosturalCtrl m_cPostural; // offset 0x140, size 0xB0
    class NNS_VECTORFAST m_sOldVelocityVecFast; // offset 0x1F0, size 0x10
    float m_f32LRMoveFrame; // offset 0x200, size 0x4
    float m_f32NextPointFrame; // offset 0x204, size 0x4
    float m_f32OffsetX; // offset 0x208, size 0x4
    float m_f32OffsetY; // offset 0x20C, size 0x4
    float m_f32DefaultOffsetX; // offset 0x210, size 0x4
    float m_f32DefaultOffsetY; // offset 0x214, size 0x4
    unsigned char m_bRotChange; // offset 0x218, size 0x1
    enum enmParamChangeStep m_enmScaleChangeStep; // offset 0x21C, size 0x4
    enum enmParamChangeStep m_enmSpeedChangeStep; // offset 0x220, size 0x4
    enum enmEnergyBulletMode m_eEnergyBulletMode; // offset 0x224, size 0x4
    float m_f32MotionFrame; // offset 0x228, size 0x4
    float m_f32MatMotionFrame; // offset 0x22C, size 0x4
    float m_f32Scale; // offset 0x230, size 0x4
    float m_f32Speed; // offset 0x234, size 0x4
};
class clsSingleton {
    // total size: 0x4
};
...
public:
    ...
    class clsSe3DControl * m_pcSe3DControl; // offset 0xE4, size 0x4
    signed int m_s32CheckHP; // offset 0xE8, size 0x4
    unsigned int m_u32LinkMapUserDataNo; // offset 0xEC, size 0x4
    unsigned char m_bDrawFlag; // offset 0xF0, size 0x1
    unsigned char m_StateChangeFlag; // offset 0xF1, size 0x1
    float m_sEffectMtx[4][4]; // offset 0x100, size 0x40
};
class compressed_pair_imp {
    // total size: 0x8
public:
...
class clsContactControl {
    // total size: 0x14
public:
    class stcContactStatus * m_pcActiveContactStatus; // offset 0x0, size 0x4
    enum enmMode m_eMode; // offset 0x4, size 0x4
    signed int m_s32ContactNum; // offset 0x8, size 0x4
    class stcContactStatus m_sContactStatus[4]; // offset 0xC, size 0x8
};
class vector : private __vector_imp {
    // total size: 0xC
};
...
class clsPlayerGravityWave_Task : public clsSingleton, public clsGravityWave_Task {
    // total size: 0xE0
};
...
public:
    ...
    unsigned int m_u32ViewNum; // offset 0xCB8, size 0x4
    signed int m_as32MaxLap[2]; // offset 0xCBC, size 0x8
    signed int m_as32PlayerNo[2]; // offset 0xCC4, size 0x8
    signed int m_as32NextPlayerNo[2]; // offset 0xCCC, size 0x8
    signed int m_as32TypeNo[2]; // offset 0xCD4, size 0x8
    unsigned int m_u32TeamPlayerNum; // offset 0xCDC, size 0x4
    unsigned int m_as32WalkRunCount[2]; // offset 0xCE0, size 0x8
    class clsTask * m_psParticle; // offset 0xCE8, size 0x4
    class clsTask * m_psWinLose; // offset 0xCEC, size 0x4
    class NNS_VECTORFAST m_sPosVecFast[2]; // offset 0xCF0, size 0x20
    class NNS_VECTOR m_sRotVecFast[2]; // offset 0xD10, size 0x18
    class stcCamFilter m_sStartInFilter; // offset 0xD28, size 0x3C
    class stcCamFilter m_sStartOutFilter; // offset 0xD64, size 0x3C
    unsigned char m_abPlayerWinFlag[2]; // offset 0xDA0, size 0x2
    unsigned char m_bWinDrawFlag; // offset 0xDA2, size 0x1
    unsigned char m_bReplaced; // offset 0xDA3, size 0x1
};
enum enmMode {
    MODE_INIT = 0,
    MODE_MAIN = 1,
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsMeteoriteL_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB_TX m_cModel; // offset 0x88, size 0x8
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0x90, size 0x4
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xBC
public:
    class clsFusionMachine_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsFusionMachineModels m_cModel; // offset 0x88, size 0x30
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0xB8, size 0x4
};
class vector : private __vector_imp {
    // total size: 0xC
};
...
class clsHaveGimmickRigidBody {
    // total size: 0x8
public:
    class clsGimmickRigidBody * m_pcRigidBody; // offset 0x0, size 0x4
};
class clsFlag {
    // total size: 0x4
public:
...
class clsGimmickRigidBody : public clsRigidBody {
    // total size: 0x220
public:
    class clsGimmickUnaryAction * m_pcUnaryAction; // offset 0x210, size 0x4
    unsigned int m_eFlag; // offset 0x214, size 0x4
};
class __vector_imp : private __vector_deleter {
    // total size: 0xC
};
class clsGravityActionControl {
    // total size: 0x50
public:
    class NNS_VECTORFAST m_sSpeedVecFast; // offset 0x0, size 0x10
    class NNS_VECTORFAST m_sAcceleVecFast; // offset 0x10, size 0x10
    class clsPlayerTask * m_pcPlayer; // offset 0x20, size 0x4
    class clsGimmickRigidBody * m_pcRigidBody; // offset 0x24, size 0x4
    class clsFrameControl m_cFrameControl; // offset 0x28, size 0x8
    enum enmType m_eType; // offset 0x30, size 0x4
    enum enmMode m_eMode; // offset 0x34, size 0x4
    enum enmStatus m_eStatus; // offset 0x38, size 0x4
    class clsGravityGimmickParam * m_pcGravityGimmickParam; // offset 0x3C, size 0x4
    unsigned int m_u32DestroyPriority; // offset 0x40, size 0x4
    unsigned int m_u32RiseClearFilter; // offset 0x44, size 0x4
    enum enmRiseType m_eRiseType; // offset 0x48, size 0x4
};
enum enmStatus {
    STATUS_NULL = 0,
    STATUS_END = 1,
...
class clsBreakControl {
    // total size: 0x30
public:
    class clsFrameControl m_cBreakFrame; // offset 0x0, size 0x8
    class clsFrameControl m_cLimitFrame; // offset 0x8, size 0x8
    class clsFrameControl m_cRebirthFrame; // offset 0x10, size 0x8
    enum enmMode m_eMode; // offset 0x18, size 0x4
    signed int m_s32ContactNum; // offset 0x1C, size 0x4
    signed int m_s32BreakContactNum; // offset 0x20, size 0x4
    unsigned char m_bDraw; // offset 0x24, size 0x1
    signed int m_s32BlinkFrame; // offset 0x28, size 0x4
    signed int m_s32BlinkInterval; // offset 0x2C, size 0x4
};
class clsSingleton {
    // total size: 0x4
};
...
class clsMissionRace_Task : public clsBaseRace_Task {
    // total size: 0xD3C
public:
    class stcRecord m_sMissionTime; // offset 0xCB0, size 0x4
    unsigned char m_bPractice; // offset 0xCB4, size 0x1
    signed char m_s8ClearRank; // offset 0xCB5, size 0x1
    unsigned char m_bEndFlag2D; // offset 0xCB6, size 0x1
    unsigned char m_bReadyFlag2D; // offset 0xCB7, size 0x1
    signed int m_s32MissionNo; // offset 0xCB8, size 0x4
    class clsMissionTarget * m_pcMissionTarget; // offset 0xCBC, size 0x4
    class stcMissionParam m_sMissionParamTbl; // offset 0xCC0, size 0x34
    class clsTask * m_pcResult2D; // offset 0xCF4, size 0x4
    class clsTask * m_pcMission2DMain; // offset 0xCF8, size 0x4
    class clsTask * m_pcMission2DSub; // offset 0xCFC, size 0x4
    unsigned char m_bEndFlagTime2D; // offset 0xD00, size 0x1
    unsigned char m_bLoadFlag2D; // offset 0xD01, size 0x1
    void * m_pvSurvivalMessage2DPackBuffer; // offset 0xD04, size 0x4
    void * m_pvWinLose2DPackBuffer; // offset 0xD08, size 0x4
    signed int m_s32DbgGameOverCount; // offset 0xD0C, size 0x4
    unsigned int m_u32TargetCount; // offset 0xD10, size 0x4
    signed int m_s32OldLinkCount; // offset 0xD14, size 0x4
    signed int * m_ps32PathPoint; // offset 0xD18, size 0x4
    signed int m_s32AttackStartFrame; // offset 0xD1C, size 0x4
    unsigned short m_u16PathCount; // offset 0xD20, size 0x2
    unsigned char m_u8StartFlag; // offset 0xD22, size 0x1
    signed char m_as8RankCount[7]; // offset 0xD23, size 0x7
    unsigned char m_u8PlayerType; // offset 0xD2A, size 0x1
    unsigned char m_u8TargetType; // offset 0xD2B, size 0x1
    class uMissionJudge32 m_uJudge; // offset 0xD2C, size 0x4
    class uMissionCount32 m_uCount; // offset 0xD30, size 0x4
    unsigned int m_u32BestScore; // offset 0xD34, size 0x4
    unsigned int m_u32BestRank; // offset 0xD38, size 0x4
};
class map {
    // total size: 0x18
public:
...
class clsBlackHole_Task : public clsSingleModelGimmick_Task, public clsGimmickCommon {
    // total size: 0xBC
public:
    unsigned char m_bEnableDebug; // offset 0xAD, size 0x1
    unsigned char m_bDisp; // offset 0xAE, size 0x1
    float m_f32DebugDistance; // offset 0xB0, size 0x4
    float m_f32DebugOffsetY; // offset 0xB4, size 0x4
    unsigned char m_bInitFlag; // offset 0xB8, size 0x1
};
class __vector_deleter {
    // total size: 0xC
public:
...
public:
    class clsSe3DControl * m_pcSe3DControl; // offset 0xD0, size 0x4
    float m_f32Count; // offset 0xD4, size 0x4
    signed int m_s32AttackNum; // offset 0xD8, size 0x4
    class NNS_VECTORFAST m_sDirVecFast; // offset 0xE0, size 0x10
    enum enmMeteoriteLMode m_eMeteoriteLMode; // offset 0xF0, size 0x4
    float m_f32Speed; // offset 0xF4, size 0x4
    signed int m_s32ObjNo; // offset 0xF8, size 0x4
    unsigned char m_bDrawFlag; // offset 0xFC, size 0x1
    float m_sEffectMtx[4][4]; // offset 0x100, size 0x40
    class NNS_VECTORFAST m_sEffectBombPos; // offset 0x140, size 0x10
    class NNS_VECTORFAST m_sEffectBombUpVec; // offset 0x150, size 0x10
    class NNS_QUATERNION m_sEffectQuat; // offset 0x160, size 0x10
    class clsTask * m_psEffectTask; // offset 0x170, size 0x4
};
class hkEnum {
    // total size: 0x4
public:
...
class clsGimmickCommon {
    // total size: 0x1
public:
    unsigned char m_bDisableFog; // offset 0x0, size 0x1
};
...
class stcMissionParam {
    // total size: 0x34
public:
    float f32Agp; // offset 0x0, size 0x4
    unsigned int u32Ring; // offset 0x4, size 0x4
    unsigned int u32Time; // offset 0x8, size 0x4
    signed int s32ConditionBronze; // offset 0xC, size 0x4
    signed int s32ConditionSilver; // offset 0x10, size 0x4
    signed int s32ConditionGold; // offset 0x14, size 0x4
    unsigned char u8RuleType; // offset 0x18, size 0x1
    unsigned char u8CountDownFlag; // offset 0x19, size 0x1
    signed char as8Chara[8]; // offset 0x1A, size 0x8
    signed char as8Gear[8]; // offset 0x22, size 0x8
    unsigned char au8GearLevel[8]; // offset 0x2A, size 0x8
    unsigned char u8Padding[2]; // offset 0x32, size 0x2
};
...
class clsMeteoriteS_Task : public clsSingleModelGimmick_Task, public clsGimmickCommon {
    // total size: 0xA0
public:
    float m_f32MeteoSAttackHeight; // offset 0x98, size 0x4
    unsigned char m_bInitFlag; // offset 0x9C, size 0x1
};
class _Draw2DData {
    // total size: 0x24
public:
...
class clsHaveGimmickPhantom {
    // total size: 0x8
public:
    class clsSimpleShapePhantom * m_pcPhantom; // offset 0x0, size 0x4
};
class allocator {
    // total size: 0x1
};
...
class clsEnergyBullet_Task : public clsSingleModelGimmick_Task, public clsGimmickCommon {
    // total size: 0xD4
public:
    float m_f32DebugDefaultBulletSpeed; // offset 0xB0, size 0x4
    float m_f32DebugLightR; // offset 0xB4, size 0x4
    float m_f32DebugLightG; // offset 0xB8, size 0x4
    float m_f32DebugLightB; // offset 0xBC, size 0x4
    float m_f32DebugLightA; // offset 0xC0, size 0x4
    float m_f32DebugLightInten; // offset 0xC4, size 0x4
    float m_f32DebugLightFallOffStart; // offset 0xC8, size 0x4
    float m_f32DebugLightFallOffEnd; // offset 0xCC, size 0x4
    unsigned char m_bInitFlag; // offset 0xD0, size 0x1
};
enum enmFlag {
    FLAG_CLEAR = 0,
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsMeteoriteS_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB_TX m_cModel; // offset 0x88, size 0x8
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0x90, size 0x4
...
class stcContactStatus {
    // total size: 0x2
public:
    unsigned char ePlayer; // offset 0x0, size 0x1
    unsigned char eRigid; // offset 0x1, size 0x1
};
...
class uMissionJudge32 {
    // total size: 0x4
public:
    union { // inferred
        signed int m_s32MaxLinkCount; // offset 0x0, size 0x4
        signed int m_s32TrickPoint; // offset 0x0, size 0x4
        unsigned int m_u32GravityMSec; // offset 0x0, size 0x4
        float m_f32GravityRemove; // offset 0x0, size 0x4
        unsigned int m_u32GrindPoint; // offset 0x0, size 0x4
        unsigned int m_u32TargetMSec; // offset 0x0, size 0x4
        enum enmTrickA m_eTrickA; // offset 0x0, size 0x4
        unsigned int m_u32AttackCount; // offset 0x0, size 0x4
    };
};
class SJ_OBJ {
    // total size: 0x4
...
class clsBaseGravityLinkObject : public clsRigidBodyGimmickObj {
    // total size: 0xE0
public:
    unsigned char m_u8ParticleFrame; // offset 0xD0, size 0x1
    unsigned char m_u8ParticleType; // offset 0xD1, size 0x1
};
...
class uMissionCount32 {
    // total size: 0x4
public:
    union { // inferred
        unsigned int m_u32StartMSec; // offset 0x0, size 0x4
        float m_f32AddGravityRemove; // offset 0x0, size 0x4
        unsigned int m_u32GravityLink; // offset 0x0, size 0x4
        float m_f32TargetDistance; // offset 0x0, size 0x4
        unsigned int m_u32AttackFlag; // offset 0x0, size 0x4
    };
};
struct /* @anon16 */ {
    // total size: 0xC
...
class stcSeData {
    // total size: 0x18
public:
    unsigned int u32SndId; // offset 0x0, size 0x4
    float f32ClipDistx2; // offset 0x4, size 0x4
    float f32DistDownK; // offset 0x8, size 0x4
    signed short as16Id3D[4]; // offset 0xC, size 0x8
    unsigned char bLoop; // offset 0x14, size 0x1
    unsigned char u8Padd[3]; // offset 0x15, size 0x3
};
class hkSolverInfo {
    // total size: 0x140
public:
...
class hkUnaryAction : public hkAction {
    // total size: 0x1C
public:
    class hkEntity * m_entity; // offset 0x18, size 0x4
};
enum enmFlag {
    FLAG_NULL = 0,
    FLAG_DRAW_COL = 1,
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsBlackHole_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB_TX_MO_MA m_cModel; // offset 0x88, size 0x20
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0xA8, size 0x4
...
// Range: 0x3FE5D0 -> 0x3FEF74
void draw(class clsFusionMachine_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3FE5D0 -> 0x3FEF74
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        unsigned int * psNodeStat; // r17
        float (* psMtxPal)[4][4]; // r16
        float sMtx[4][4]; // r29+0x2D0
        class NNS_MOTION * psMotion; // r30
        class clsFusionMachine_Obj * pcObj; // r2
        class NNS_VECTORFAST sPosVecFast; // r29+0x2C0
        signed int s32i; // r19
        class NNS_VECTORFAST sPosVecFast; // r29+0x2B0
        signed int s32i; // r19
        class NNS_VECTORFAST sPosVecFast; // r29+0x2A0
        signed int s32i; // r19
        float * opf32Rate; // r17
        class NNS_VECTORFAST sPosVecFast; // r29+0x290
    }
}


// Range: 0x3FF080 -> 0x40009C
void execute(class clsFusionMachine_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3FF080 -> 0x40009C
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        class clsFusionMachine_Obj * pcObj; // r16
...
// Range: 0x4000A0 -> 0x400188
void upDateLightData(class clsFusionMachine_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4000A0 -> 0x400188
        class NNS_VECTORFAST sWorkVecFast; // r29+0x100
        unsigned int u32LightType; // r2
    }
}


// Range: 0x4001A0 -> 0x4001E8
void stopLoopParticle(class clsFusionMachine_Obj * this /* r2 */, unsigned char u8No /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4001A0 -> 0x4001E8
    }
...
// Range: 0x4001F0 -> 0x400230
void moveDamageAction(class clsFusionMachine_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4001F0 -> 0x400230
        class NNS_VECTORFAST sVecFast; // r29+0x20
    }
}


// Range: 0x400300 -> 0x40037C
void checkBGMChange(class clsFusionMachine_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x400300 -> 0x40037C
        signed int s32PlayerNum; // r2
        signed int s32UserNum; // r2
        signed int s32i; // r9
    }
}


// Range: 0x400380 -> 0x4004DC
void endBlackHoleTime(class clsFusionMachine_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x400380 -> 0x4004DC
        class clsPlayerTask * pcPlayer; // r2
...
// Range: 0x4004E0 -> 0x400764
void checkAutoGDiveStart(class clsFusionMachine_Obj * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4004E0 -> 0x400764
        class clsPlayerTask * pcPlayer; // r20
        signed int s32PlayerNum; // r2
        signed int s32UserNum; // r2
        signed int s32i; // r7
        signed int s32Flag; // r2
        unsigned char bNowEffect; // r23
    }
}


// Range: 0x400770 -> 0x4010CC
void checkReturn(class clsFusionMachine_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x400770 -> 0x4010CC
        unsigned int u32ReturnCheck; // r2
        class clsSurvivalRelayRace_Task & rcSurvivalRelayRace_Task; // r2
        class clsPlayerTask * pcPlayer; // r21
        signed int s32PlayerNum; // r2
        signed int s32i; // r7
        unsigned int u32RunningPlayer; // r20
        class clsSurvivalRelayRace_Task & rcSurvivalRelayRace_Task; // r2
        class clsPlayerTask * pcPlayer; // r21
        signed int s32PlayerNum; // r2
        signed int s32i; // r7
...
// Range: 0x4010D0 -> 0x401194
void setPhotonEffectPos(class clsFusionMachine_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4010D0 -> 0x401194
        class NNS_MOTION * psMotion; // r20
        float (* psMtxList)[4][4]; // r18
        float sMtx[4][4]; // r29+0x60
    }
}


// Range: 0x4011A0 -> 0x4016C4
void actionAttack2(class clsFusionMachine_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4011A0 -> 0x4016C4
    }
...
// Range: 0x4016D0 -> 0x402080
void actionAttack1(class clsFusionMachine_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4016D0 -> 0x402080
        class clsPlayerTask * pcPlayer; // r2
        float f32Distance; // r29+0x200
        class clsPath cPath; // r29+0x190
        float sMtx[4][4]; // r29+0x150
        float sInvMtx[4][4]; // r29+0x110
        class NNS_VECTORFAST sXVecFast; // r29+0x100
        class NNS_VECTORFAST sYVecFast; // r29+0xF0
        class NNS_VECTORFAST sVecFast; // r29+0xE0
        unsigned char u8PathNo; // r29+0x1FF
    }
}


// Range: 0x402080 -> 0x4020C4
void stopGravityWave(class clsFusionMachine_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x402080 -> 0x4020C4
        class clsPlayerTask * pcPlayer; // r2
        unsigned int u32i; // r9
        unsigned int u32ViewNum; // r2
    }
}


// Range: 0x4020D0 -> 0x402144
unsigned char updateMotion(class clsFusionMachine_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4020D0 -> 0x402144
        unsigned char bMotionEnd; // r2
    }
}


// Range: 0x402150 -> 0x402280
void checkAttack(class clsFusionMachine_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x402150 -> 0x402280
        signed int s32AttackType; // r2
    }
}


// Range: 0x402290 -> 0x402934
void checkReturnStart(class clsFusionMachine_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x402290 -> 0x402934
    }
...
// Range: 0x402950 -> 0x402BC4
void updatePathMove(class clsFusionMachine_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x402950 -> 0x402BC4
        class NNS_VECTORFAST sVecFast; // r29+0x90
        class NNS_QUATERNION sQuat; // r29+0x80
        float sMtx[4][4]; // r29+0x40
        class NNS_VECTORFAST sXVecFast; // r29+0x30
    }
}


// Range: 0x402BD0 -> 0x402FE4
void updateSpeedNormal(class clsFusionMachine_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x402BD0 -> 0x402FE4
        class clsPath cPath; // r29+0x50
        class clsPlayerTask * pcPlayer; // r2
        float f32Dist; // r20
        float f32Speed; // r3
        unsigned char u8PathNo; // r29+0xBF
    }
}


// Range: 0x402FF0 -> 0x403128
void initPathMove(class clsFusionMachine_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x402FF0 -> 0x403128
        class NNS_VECTORFAST sVecFast; // r29+0x80
        class NNS_QUATERNION sQuat; // r29+0x70
        float sMtx[4][4]; // r29+0x30
        class NNS_VECTORFAST sXVecFast; // r29+0x20
    }
}


// Range: 0x403130 -> 0x403228
void setPhotonEffect(class clsFusionMachine_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x403130 -> 0x403228
        class NNS_MOTION * psMotion; // r20
...
// Range: 0x4032C0 -> 0x403618
void createModel(class clsFusionMachine_Task * this /* r2 */, class stcBinInfo & rsBinInfoI /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4032C0 -> 0x403618
        unsigned int u32CalcObjNum; // r2
        unsigned int u32i; // r19
    }
}


// Range: 0x403620 -> 0x40364C
void reset(class clsFusionMachine_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x403620 -> 0x40364C
    }
...
// Range: 0x403650 -> 0x4038A8
void * __ct(class clsFusionMachine_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x403650 -> 0x4038A8
        float f32ColSize; // r20
    }
}


// Range: 0x403AA0 -> 0x403AA8
...
// Range: 0x403AB0 -> 0x403C88
void debugDead(class clsFusionMachine_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x403AB0 -> 0x403C88
...
// Range: 0x403C90 -> 0x403C98
void init(class clsFusionMachine_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x403C90 -> 0x403C98
    }
...
// Range: 0x403CA0 -> 0x404298
void reset(class clsFusionMachine_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x403CA0 -> 0x404298
        float sMtx[4][4]; // r29+0x80
        class NNS_QUATERNION sQuat; // r29+0x70
        class NNS_VECTORFAST sXVecFast; // r29+0x60
        signed int s32n; // r17
    }
}


// Range: 0x4042A0 -> 0x404B6C
void contactTriggerEvent(class clsFusionMachine_Obj * this /* r16 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4042A0 -> 0x404B6C
        class clsPlayerTask * pcHitPlayer; // r21
    }
}


// Range: 0x404BE0 -> 0x404C20
signed int getFirstPlayerNo() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x404BE0 -> 0x404C20
        signed int s32PlayerNum; // r2
...
// Range: 0x404C20 -> 0x404E04
void damage(class clsFusionMachine_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x404C20 -> 0x404E04
        signed int s32TotalLap; // r29+0x2C
        signed int s32BeforeLap; // r2
        signed int s32RemainingLapNum; // r2
        unsigned int u32CheckFlag; // r2
        char __FUNCTION__[7]; // @ 0x00684D10
    }
}


// Range: 0x404E10 -> 0x404ED0
void setLineParam(class clsFusionMachine_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x404E10 -> 0x404ED0
        class clsFusionMachineModels & rcModel; // r2
        class NNS_MOTION * psMotion; // r2
        signed int s32n; // r19
    }
}


// Range: 0x404ED0 -> 0x405404
void * __ct(class clsFusionMachine_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x404ED0 -> 0x405404
        signed int s32n; // r4
...
// Range: 0x405410 -> 0x405478
void destroyData(class clsFusionMachine_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x405410 -> 0x405478
    }
...
// Range: 0x405480 -> 0x4055B0
void createData(class clsFusionMachine_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x405480 -> 0x4055B0
    }
