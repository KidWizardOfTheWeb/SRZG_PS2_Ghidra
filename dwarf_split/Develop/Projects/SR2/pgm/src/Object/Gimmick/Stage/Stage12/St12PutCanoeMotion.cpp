/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage12\St12PutCanoeMotion.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x693108
unsigned int otau32Se_CanoeBreak[2]; // size: 0x8, address: 0x693110
unsigned int otau32Se_CanoeExp[2]; // size: 0x8, address: 0x693118
struct /* @anon11 */ {
    // total size: 0x48
} __vt__22clsPutCanoeMotion_Task; // size: 0x48, address: 0x6CCE30
struct /* @anon8 */ {
    // total size: 0x48
} __vt__100clsSingleModelGimmick_Task<22clsPutCanoeMotion_Task,21clsPutCanoeMotion_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6CCEE0
struct /* @anon7 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPutCanoeMotion_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA768
struct /* @anon18 */ {
    // total size: 0xC
} __vt__38clsSingleton<22clsPutCanoeMotion_Task>; // size: 0xC, address: 0x6CCE78
void * __dt(class clsPutCanoeMotion_Obj *, signed short); // size: 0x0, address: 0x508EF0
struct /* @anon1 */ {
    // total size: 0x48
} __vt__92clsBaseGimmickBody<22clsPutCanoeMotion_Task,21clsPutCanoeMotion_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6CCE90
struct /* @anon15 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon6 */ {
    // total size: 0xA8
} __vt__21clsPutCanoeMotion_Obj; // size: 0xA8, address: 0x6CCF30
struct /* @anon14 */ {
    // total size: 0x28
...
void * __ct(class clsPutCanoeMotion_Obj *); // size: 0x0, address: 0x509FB0
...
public:
    ...
    unsigned int m_u32TexIdx; // offset 0xD4, size 0x4
    float m_f32MotionFrame; // offset 0xD8, size 0x4
...
class clsPutCanoeMotion_Task : public clsSingleModelGimmick_Task {
    // total size: 0xA8
public:
    unsigned short * m_TexIdx; // offset 0x9C, size 0x4
    unsigned short * m_TexIdx2; // offset 0xA0, size 0x4
    class clsGmkBurnLight_Task * m_pcBurnLightTask; // offset 0xA4, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x9C
public:
    class clsPutCanoeMotion_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x508FF0 -> 0x50988C
void draw(class clsPutCanoeMotion_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x508FF0 -> 0x50988C
        ...
        unsigned int sNodeStat; // r29+0x22C
        float sMtxPal[4][4]; // r29+0x1E0
        float sMtxWork[4][4]; // r29+0x1A0
        float f32MotionFrame; // r22
        unsigned int u32i; // r21
    }
}


// Range: 0x509930 -> 0x509AC0
void execute(class clsPutCanoeMotion_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x509930 -> 0x509AC0
...
// Range: 0x509AC0 -> 0x509B30
void reset(class clsPutCanoeMotion_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x509AC0 -> 0x509B30
        unsigned int u32Num; // r2
...
// Range: 0x509B30 -> 0x509C44
void * __ct(class clsPutCanoeMotion_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x509B30 -> 0x509C44
        class hkVector4 cBoxHalfSize; // r29+0x30
    }
}


// Range: 0x50A070 -> 0x50A094
...
// Range: 0x50A0A0 -> 0x50A134
void destroyData(class clsPutCanoeMotion_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50A0A0 -> 0x50A134
    }
...
// Range: 0x50A140 -> 0x50A74C
void createData(class clsPutCanoeMotion_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50A140 -> 0x50A74C
        ...
        char __FUNCTION__[14]; // @ 0x006930F8
    }
}


// Range: 0x50A750 -> 0x50A7A0
void setData(class clsPutCanoeMotion_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50A750 -> 0x50A7A0
    }
...
// Range: 0x50A7A0 -> 0x50A7F8
void requestDrawBreakEffect(class clsPutCanoeMotion_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50A7A0 -> 0x50A7F8
    }
...
// Range: 0x50A800 -> 0x50A8B8
void main(class clsPutCanoeMotion_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50A800 -> 0x50A8B8
    }
...
// Range: 0x50A8C0 -> 0x50A954
void reset(class clsPutCanoeMotion_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50A8C0 -> 0x50A954
    }
