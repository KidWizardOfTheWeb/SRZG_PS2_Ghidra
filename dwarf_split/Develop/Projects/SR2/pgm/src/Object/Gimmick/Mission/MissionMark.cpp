/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Mission\MissionMark.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x67EEA0
struct /* @anon12 */ {
    // total size: 0x64
} __vt__19clsMissionMark_Task; // size: 0x64, address: 0x6BFF90
struct /* @anon6 */ {
    // total size: 0x48
} __vt__97clsSingleModelGimmick_Task<19clsMissionMark_Task,18clsMissionMark_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6BB480
...
struct /* @anon0 */ {
    // total size: 0xC
} __vt__35clsSingleton<19clsMissionMark_Task>; // size: 0xC, address: 0x6BB3F8
void * __dt(class clsMissionMark_Obj *, signed short); // size: 0x0, address: 0x2C63B0
struct /* @anon3 */ {
    // total size: 0x48
} __vt__89clsBaseGimmickBody<19clsMissionMark_Task,18clsMissionMark_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6BB410
struct /* @anon5 */ {
    // total size: 0x28
...
struct /* @anon10 */ {
    // total size: 0x58
} __vt__18clsMissionMark_Obj; // size: 0x58, address: 0x6C0000
...
// Range: 0x390800 -> 0x390950
void draw(class clsMissionMark_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x390800 -> 0x390950
...
// Range: 0x390950 -> 0x390B0C
void execute(class clsMissionMark_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x390950 -> 0x390B0C
...
// Range: 0x390B10 -> 0x390B78
void reset(class clsMissionMark_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x390B10 -> 0x390B78
        unsigned int u32Num; // r2
...
// Range: 0x390B80 -> 0x390BC8
void destroyData(class clsMissionMark_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x390B80 -> 0x390BC8
    }
...
// Range: 0x390BD0 -> 0x390D48
void contactTriggerEvent(class clsMissionMark_Obj * this /* r17 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x390BD0 -> 0x390D48
...
// Range: 0x390D50 -> 0x390F7C
void draw(class clsMissionMark_Obj * this /* r20 */, class clsModelType_OB_TX_MO_MA & rcObj /* r19 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r30 */, float (* psMtxWork)[4][4] /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x390D50 -> 0x390F7C
        class NNS_OBJECT * psObject; // r22
        float sMtx[4][4]; // r29+0xF0
    }
}


// Range: 0x390F80 -> 0x391070
void createData(class clsMissionMark_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x390F80 -> 0x391070
    }
...
// Range: 0x391070 -> 0x391168
void * __ct(class clsMissionMark_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x391070 -> 0x391168
    }
