/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage01\ProductionRobo\ProductionRobo.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x688478
static class stcParam asRoboBallLineParam[2]; // size: 0x80, address: 0x636B30
static unsigned char chk__asRoboBallLineParam_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcParam asRoboStandLineParam[2]; // size: 0x80, address: 0x636BB0
static unsigned char chk__asRoboStandLineParam_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcGimickSubParam asRoboLineSubParam[2]; // size: 0x40, address: 0x636C30
static unsigned char chk__asRoboLineSubParam_SizeCheck_[1]; // size: 0x1, address: 0x0
static float tof32FollowMargin[2]; // size: 0x8, address: 0x688480
unsigned int otau32Se_AirCarL[2]; // size: 0x8, address: 0x688488
unsigned int otau32Se_SirenL[2]; // size: 0x8, address: 0x688490
struct /* @anon3 */ {
    // total size: 0xA8
} __vt__21clsProductionRobo_Obj; // size: 0xA8, address: 0x6C65A0
...
class clsProductionRobo_Task * m_tpcSingleton; // size: 0x4, address: 0xB17448
...
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x688500
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x688540
...
class clsProductionRobo_Obj : public clsRigidBodyGimmickObj {
    // total size: 0x300
public:
    enum enmProductionRoboMode m_eProductionRoboMode; // offset 0xD0, size 0x4
    ...
    float m_f32EffectFrame; // offset 0x2AC, size 0x4
...
class clsProductRoboManager_Obj : public clsGimmickObj {
    // total size: 0x70
public:
    class clsProductionRoboCollision m_cThroughCol; // offset 0x50, size 0x10
    ...
    unsigned char m_u8RoboNum; // offset 0x6C, size 0x1
};
...
class stcRoboData {
    // total size: 0x610
public:
    class clsProductionRobo_Obj m_cRoboObj[2]; // offset 0x0, size 0x600
    unsigned char bExecute; // offset 0x600, size 0x1
};
class hkArray {
    // total size: 0xC
public:
...
class clsProductionRobo_Task : public clsBaseGimmickBody {
    // total size: 0xA8
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xA4
public:
    class clsProductRoboManager_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsSecurityRoboModels m_cModel; // offset 0x88, size 0x18
...
class clsProductionRoboCollision : public clsBaseThroughCollision {
    // total size: 0x10
public:
    class clsProductRoboManager_Obj * m_pcManager; // offset 0x8, size 0x4
...
// Range: 0x464B80 -> 0x464BA8
void init(class clsProductionRobo_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x464B80 -> 0x464BA8
    }
...
// Range: 0x464BC0 -> 0x46509C
void draw(class clsProductionRobo_Obj * this /* r21 */, class clsSecurityRoboModels * pcModels /* r20 */, float (* psMtxPal)[4][4] /* r17 */, unsigned int * psNodeStat /* r16 */, float (* opaNnViewMtx)[4][4] /* r19 */, float (* psMtxWork)[4][4] /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x464BC0 -> 0x46509C
        class NNS_OBJECT * psObject; // r20
        float sMtx[4][4]; // r29+0x90
    }
}


// Range: 0x4650A0 -> 0x465978
void main(class clsProductionRobo_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4650A0 -> 0x465978
...
// Range: 0x465990 -> 0x465A18
void clearVelocity(class clsProductionRobo_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x465990 -> 0x465A18
...
// Range: 0x465A20 -> 0x465BB4
void rotationAxisZ(class clsProductionRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x465A20 -> 0x465BB4
...
// Range: 0x465BC0 -> 0x465C54
void setLinearVelocity(class clsProductionRobo_Obj * this /* r2 */, class NNS_VECTORFAST & rsVelocity /* r2 */, float f32Speed /* r29+0x30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x465BC0 -> 0x465C54
...
// Range: 0x465C60 -> 0x465D5C
void getDirPlayerStart(class clsProductionRobo_Obj * this /* r17 */, class NNS_VECTORFAST & rsDirVecFast /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x465C60 -> 0x465D5C
...
// Range: 0x465D70 -> 0x465DB0
void updatePostural(class clsProductionRobo_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x465D70 -> 0x465DB0
    }
...
// Range: 0x465DE0 -> 0x465E24
void getDirPlayer(class clsProductionRobo_Obj * this /* r4 */, class NNS_VECTORFAST & rsDirVecFast /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x465DE0 -> 0x465E24
    }
...
// Range: 0x465E90 -> 0x465ECC
void contactTriggerEvent(class clsProductionRobo_Obj * this /* r16 */, class hkContactPoint * pcContact /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x465E90 -> 0x465ECC
    }
...
// Range: 0x465ED0 -> 0x465F38
void callbackGravityEvent(class clsProductionRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x465ED0 -> 0x465F38
    }
...
// Range: 0x465F40 -> 0x465F8C
void requestDrawBreakEffect(class clsProductionRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x465F40 -> 0x465F8C
    }
...
// Range: 0x465F90 -> 0x465FD4
void checkPlayerRestart(class clsProductionRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x465F90 -> 0x465FD4
    }
...
// Range: 0x465FE0 -> 0x4660EC
void setSurfaceDir(class clsProductionRobo_Obj * this /* r2 */, class NNS_VECTORFAST & rsVerocityFast /* r17 */, class NNS_VECTORFAST & rsDirVecFast /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x465FE0 -> 0x4660EC
...
// Range: 0x4660F0 -> 0x466428
void setReturnPath(class clsProductionRobo_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4660F0 -> 0x466428
...
// Range: 0x466430 -> 0x4665AC
void setPosturalCtrl(class clsProductionRobo_Obj * this /* r2 */, class NNS_VECTORFAST & rsDirVecFast /* r17 */, float f32InterpolateRate /* r21 */, float f32RotZ /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x466430 -> 0x4665AC
...
// Range: 0x4665B0 -> 0x46662C
void stepMotionFrame(class clsProductionRobo_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4665B0 -> 0x46662C
    }
...
// Range: 0x466630 -> 0x4666B0
void destroyData(class clsProductionRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x466630 -> 0x4666B0
    }
...
// Range: 0x4666B0 -> 0x466AF8
void createData(class clsProductionRobo_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4666B0 -> 0x466AF8
...
// Range: 0x466B00 -> 0x466DC0
void start(class clsProductionRobo_Obj * this /* r18 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x466B00 -> 0x466DC0
...
// Range: 0x466DC0 -> 0x467094
void reset(class clsProductionRobo_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x466DC0 -> 0x467094
        class clsGimmickPath & rcGimmcikPath; // r16
...
// Range: 0x4670A0 -> 0x4670EC
void setLineParam(class clsProductionRobo_Obj * this /* r2 */, class NNS_OBJECT * pcObj /* r2 */, class NNS_MOTION * psMotion /* r2 */, float * pf32Frame /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4670A0 -> 0x4670EC
        signed int s32i; // r12
...
// Range: 0x4670F0 -> 0x4671FC
void * __dt(class clsProductionRobo_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4670F0 -> 0x4671FC
    }
...
// Range: 0x467200 -> 0x467430
void * __ct(class clsProductionRobo_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x467200 -> 0x467430
        signed int s32i; // r19
...
// Range: 0x467430 -> 0x467438
void @80@__dt__21clsProductionRobo_ObjFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x467430 -> 0x467438
    }
