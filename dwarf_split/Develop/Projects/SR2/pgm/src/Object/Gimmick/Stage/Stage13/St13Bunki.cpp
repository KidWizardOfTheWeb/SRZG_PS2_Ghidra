/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage13\St13Bunki.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x688F40
struct /* @anon10 */ {
    // total size: 0x48
} __vt__13clsBunki_Task; // size: 0x48, address: 0x6C74A0
struct /* @anon7 */ {
    // total size: 0x48
} __vt__85clsSingleModelGimmick_Task<13clsBunki_Task,12clsBunki_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C7600
struct /* @anon9 */ {
    // total size: 0x38
...
struct /* @anon20 */ {
    // total size: 0xC
} __vt__29clsSingleton<13clsBunki_Task>; // size: 0xC, address: 0x6C7598
void * __dt(class clsBunki_Obj *, signed short); // size: 0x0, address: 0x47B020
struct /* @anon0 */ {
    // total size: 0x48
} __vt__77clsBaseGimmickBody<13clsBunki_Task,12clsBunki_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C75B0
struct /* @anon17 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon5 */ {
    // total size: 0xA8
} __vt__12clsBunki_Obj; // size: 0xA8, address: 0x6C74F0
struct /* @anon14 */ {
    // total size: 0x28
...
void * __ct(class clsBunki_Obj *); // size: 0x0, address: 0x47BC80
...
struct /* @anon8 */ {
    // total size: 0x34
} __vt__24clsBunkiThroughCollision; // size: 0x34, address: 0x6C7650
struct /* @anon2 */ {
    // total size: 0xC
...
// Range: 0x47B120 -> 0x47B420
void draw(class clsBunki_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47B120 -> 0x47B420
        ...
        class clsModelType_OB_TX_MO_MA & rcModel; // r20
...
// Range: 0x47B4C0 -> 0x47B610
void execute(class clsBunki_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47B4C0 -> 0x47B610
...
// Range: 0x47B610 -> 0x47B680
void reset(class clsBunki_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47B610 -> 0x47B680
        unsigned int u32Num; // r2
...
// Range: 0x47B680 -> 0x47B90C
void * __ct(class clsBunki_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47B680 -> 0x47B90C
        class hkShape * pcShape; // r16
        class hkQuaternion cBoxQuaternion; // r29+0xB0
        class hkTransform cTrans01; // r29+0x70
        class hkTransform cTrans02; // r29+0x30
        class hkArray shapeArray; // r29+0xC0
    }
}


// Range: 0x47BD50 -> 0x47BDF0
void destroyData(class clsBunki_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47BD50 -> 0x47BDF0
    }
...
// Range: 0x47BE80 -> 0x47C280
void createData(class clsBunki_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47BE80 -> 0x47C280
...
// Range: 0x47C280 -> 0x47C2C0
void setData(class clsBunki_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47C280 -> 0x47C2C0
    }
...
// Range: 0x47C2C0 -> 0x47C3EC
void PlayerTurn(class clsBunki_Obj * this /* r17 */, class clsPlayerTask * pcPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47C2C0 -> 0x47C3EC
        class NNS_VECTORFAST rsDirVecFast; // r29+0x80
        class NNS_VECTORFAST rsMoveVecFast; // r29+0x70
        float sRotMtx[4][4]; // r29+0x30
    }
}


// Range: 0x47C3F0 -> 0x47CAC4
void main(class clsBunki_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47C3F0 -> 0x47CAC4
    }
...
// Range: 0x47CB00 -> 0x47CD50
void init(class clsBunki_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47CB00 -> 0x47CD50
        class NNS_QUATERNION orsRot; // r29+0x80
        class NNS_QUATERNION orsRotNew; // r29+0x70
        class hkQuaternion cRotQuat; // r29+0x60
        class hkQuaternion cRotQuatNew; // r29+0x50
        class hkVector4 cAngle; // r29+0x40
    }
}


// Range: 0x47CD50 -> 0x47CEA8
void reset(class clsBunki_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47CD50 -> 0x47CEA8
        class hkVector4 cRot; // r29+0x50
    }
}


// Range: 0x47CEB0 -> 0x47CEE8
void contactRemoveEvent(class clsBunkiThroughCollision * this /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47CEB0 -> 0x47CEE8
    }
...
// Range: 0x47CEF0 -> 0x47CF64
void contactTriggerEvent(class clsBunkiThroughCollision * this /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47CEF0 -> 0x47CF64
    }
