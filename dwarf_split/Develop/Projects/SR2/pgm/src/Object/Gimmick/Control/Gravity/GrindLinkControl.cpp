/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Control\Gravity\GrindLinkControl.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x6816D0
float t_of32AutoAdjustPosturalRate_Link; // size: 0x4, address: 0x0
class clsPfSystem * m_tpcSingleton; // size: 0x4, address: 0x6E69B8
class clsHavok * m_tpcSingleton; // size: 0x4, address: 0x707E60
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x681770
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x681780
...
// Range: 0x3BA010 -> 0x3BB070
void actionGravityDive(class clsGrindLinkControl * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BA010 -> 0x3BB070
        class clsGravityDive * pcGravityDive; // r2
        class NNS_VECTORFAST sObjectPosVecFast; // r29+0x4A0
        class hkVector4 cZero; // r29+0x490
        class NNS_VECTORFAST sUpVecFast; // r29+0x480
        class NNS_VECTORFAST sSpeedVecFast; // r29+0x470
        class hkVector4 cRot; // r29+0x460
        class hkVector4 cRot; // r29+0x450
        class hkVector4 cSpeed; // r29+0x440
        class hkVector4 cRot; // r29+0x430
        class NNS_VECTORFAST sDirVecFast; // r29+0x420
        float f32Dist; // r29+0x4B0
        float sMtx[4][4]; // r29+0x3E0
        float sInvMtx[4][4]; // r29+0x3A0
        class NNS_VECTORFAST sLocalVecFast; // r29+0x390
        float f32Accele; // r20
        class NNS_VECTORFAST sSpeedVecFast; // r29+0x380
        class NNS_VECTORFAST sAcceleVecFast; // r29+0x370
    }
}


// Range: 0x3BB070 -> 0x3BB244
void updateAdjustPostural(class clsGrindLinkControl * this /* r4 */, float f32Rate /* r29+0x90 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BB070 -> 0x3BB244
        class NNS_QUATERNION sSlerpQuat; // r29+0x80
        class NNS_QUATERNION sObjectRotQuat; // r29+0x70
        class hkQuaternion cRotate0; // r29+0x60
        class hkQuaternion cRotate1; // r29+0x50
        class hkVector4 cAngle; // r29+0x40
    }
}


// Range: 0x3BB250 -> 0x3BB358
void calcAdjustPostural(class clsGrindLinkControl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BB250 -> 0x3BB358
        float sPathMtx[4][4]; // r29+0xE0
        float sInvMtx[4][4]; // r29+0xA0
        float sRotMtx[4][4]; // r29+0x60
        class NNS_VECTORFAST sLocalVecFast; // r29+0x50
        class NNS_VECTORFAST sTrgZVecFast; // r29+0x40
        class NNS_VECTORFAST sObjectPosVecFast; // r29+0x30
    }
}


// Range: 0x3BB360 -> 0x3BB390
void reset(class clsGrindLinkControl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3BB360 -> 0x3BB390
    }
