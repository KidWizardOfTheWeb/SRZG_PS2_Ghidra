/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage07\St07Solar.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float t_of32CLIP_DISTx2; // size: 0x4, address: 0x693748
struct /* @anon14 */ {
    // total size: 0x48
} __vt__13clsSolar_Task; // size: 0x48, address: 0x6CD5F0
struct /* @anon4 */ {
    // total size: 0x48
} __vt__85clsSingleModelGimmick_Task<13clsSolar_Task,12clsSolar_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6CD6A0
struct /* @anon17 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsSolar_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA7A0
struct /* @anon13 */ {
    // total size: 0xC
} __vt__29clsSingleton<13clsSolar_Task>; // size: 0xC, address: 0x6CD638
void * __dt(class clsSolar_Obj *, signed short); // size: 0x0, address: 0x516E60
struct /* @anon18 */ {
    // total size: 0x48
} __vt__77clsBaseGimmickBody<13clsSolar_Task,12clsSolar_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6CD650
...
void * __ct(class clsSolar_Obj *); // size: 0x0, address: 0x516F30
...
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x693770
struct /* @anon19 */ {
    // total size: 0xB0
} __vt__21clsPathGravityObj_Obj; // size: 0xB0, address: 0x6C22E0
struct /* @anon15 */ {
    // total size: 0xB0
} __vt__12clsSolar_Obj; // size: 0xB0, address: 0x6CD6F0
struct /* @anon9 */ {
    // total size: 0x28
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsSolar_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
public:
    ...
    float m_f32MatMotionFrame; // offset 0x27C, size 0x4
    float m_f32MotionFrame; // offset 0x280, size 0x4
    class NNS_VECTORFAST m_sPosVec; // offset 0x290, size 0x10
};
struct /* @anon3 */ {
    // total size: 0xA8
};
...
class clsSolar_Task : public clsSingleModelGimmick_Task {
    // total size: 0xAC
};
class clsFlag {
    // total size: 0x4
...
// Range: 0x515E30 -> 0x515FA8
void draw(class clsSolar_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x515E30 -> 0x515FA8
        ...
        class clsModelType_OB_TX_MO_MA & pcModel; // r22
...
// Range: 0x515FB0 -> 0x516144
void execute(class clsSolar_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x515FB0 -> 0x516144
        unsigned int u32Num; // r2
...
// Range: 0x516150 -> 0x5161C4
void reset(class clsSolar_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x516150 -> 0x5161C4
        unsigned int u32Num; // r2
...
// Range: 0x5161D0 -> 0x516298
void * __ct(class clsSolar_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5161D0 -> 0x516298
...
// Range: 0x516610 -> 0x5168D0
void draw(class clsSolar_Obj * this /* r19 */, class clsModelType_OB_TX_MO_MA & rcObj /* r18 */, float (* psMtxPal)[4][4] /* r20 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r17 */, float (* psMtxWork)[4][4] /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x516610 -> 0x5168D0
...
// Range: 0x5168D0 -> 0x51690C
void callbackGravityEvent(class clsSolar_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5168D0 -> 0x51690C
    }
...
// Range: 0x516910 -> 0x516918
void callbackContactTriggerRigidBody() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x516910 -> 0x516918
    }
...
// Range: 0x516920 -> 0x516930
void adminSe(class clsSolar_Obj * this /* r4 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x516920 -> 0x516930
    }
...
// Range: 0x516930 -> 0x516984
void requestDrawBreakEffect(class clsSolar_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x516930 -> 0x516984
    }
...
// Range: 0x516990 -> 0x516A10
void destroyData(class clsSolar_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x516990 -> 0x516A10
    }
...
// Range: 0x516A10 -> 0x516E00
void createData(class clsSolar_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x516A10 -> 0x516E00
...
// Range: 0x516E10 -> 0x516E4C
void reset(class clsSolar_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x516E10 -> 0x516E4C
    }
...
// Range: 0x516E50 -> 0x516E58
void init(class clsSolar_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x516E50 -> 0x516E58
    }
...
// Range: 0x516E60 -> 0x516F28
void * __dt(class clsSolar_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x516E60 -> 0x516F28
    }
...
// Range: 0x516F30 -> 0x516FBC
void * __ct(class clsSolar_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x516F30 -> 0x516FBC
    }
