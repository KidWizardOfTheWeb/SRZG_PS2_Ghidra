/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage16\St16AutoRunHeli.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcInfoParam tosCraneParam; // size: 0x18, address: 0x693480
static class stcInfoParam tosPlayerParam; // size: 0x18, address: 0x6934A0
static class stcControlParam tosControlParam; // size: 0x98, address: 0x6934C0
static class NNS_VECTORFAST tosPlayerOffsetPosFast00; // size: 0x10, address: 0x693560
static class NNS_VECTORFAST tosPlayerOffsetPosFast01; // size: 0x10, address: 0x693570
static unsigned char tau8PathNo[3]; // size: 0x3, address: 0x693580
static class NNS_VECTOR tosThrColPosVec; // size: 0xC, address: 0x693588
float m_tof32CLIP_DISTx2; // size: 0x4, address: 0x693598
struct /* @anon5 */ {
    // total size: 0x48
} __vt__19clsAutoRunHeli_Task; // size: 0x48, address: 0x6CD020
void * __dt(class clsAutoRunHeli_Obj *, signed short); // size: 0x0, address: 0x2C7530
struct /* @anon8 */ {
    // total size: 0x48
} __vt__84clsBaseGimmickBody<19clsAutoRunHeli_Task,18clsAutoRunHeli_Obj,19clsAutoRunHeliModel>; // size: 0x48, address: 0x6BB1F0
struct /* @anon14 */ {
    // total size: 0x28
...
struct /* @anon19 */ {
    // total size: 0x34
} __vt__26clsMacrossThroughCollision; // size: 0x34, address: 0x6C11C0
struct /* @anon15 */ {
    // total size: 0x30
...
struct /* @anon16 */ {
    // total size: 0x58
} __vt__18clsAutoRunHeli_Obj; // size: 0x58, address: 0x6CD070
...
class clsAutoRunHeli_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A780
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x693600
float m_tof32SphereRadius; // size: 0x4, address: 0x684908
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x0
struct /* @anon4 */ {
    // total size: 0xC
} __vt__35clsSingleton<19clsAutoRunHeli_Task>; // size: 0xC, address: 0x6BB168
struct /* @anon23 */ {
    // total size: 0xC
...
void * __dt(class clsAutoRunHeli *, signed short); // size: 0x0, address: 0x2E67C0
struct /* @anon11 */ {
    // total size: 0xC
} __vt__14clsGimmickPath; // size: 0xC, address: 0x6BBB50
struct /* @anon20 */ {
    // total size: 0x10
} __vt__20clsGimmickAutoRunObj; // size: 0x10, address: 0x6BBB60
struct /* @anon0 */ {
    // total size: 0x10
} __vt__14clsAutoRunHeli; // size: 0x10, address: 0x6BBB30
struct /* @anon9 */ {
    // total size: 0x20
...
void * __ct(class clsAutoRunHeli *); // size: 0x0, address: 0x510AC0
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x6935F0
...
public:
    ...
    class clsAutoRunHeli_Obj * m_pcHeliObj; // offset 0x1C8, size 0x4
    float m_f32InterpolateFrame; // offset 0x1CC, size 0x4
    float m_f32EffectFrame; // offset 0x1D0, size 0x4
    class clsPendulumControl * m_pcPendulumControl; // offset 0x1D4, size 0x4
    float m_f32AirMove; // offset 0x1D8, size 0x4
    class NNS_QUATERNION m_sRopeRotQuat; // offset 0x1DC, size 0x10
    class clsSe3DControl * m_pcSe3DControl; // offset 0x1EC, size 0x4
    class clsSlerpQuat m_SlerpQuat; // offset 0x1F0, size 0x3C
    float m_f32AccelFrame; // offset 0x22C, size 0x4
    float m_f32Accel; // offset 0x230, size 0x4
    unsigned char m_bIsCatch; // offset 0x234, size 0x1
    unsigned char m_bLight; // offset 0x235, size 0x1
    float m_f32EffectCnt; // offset 0x238, size 0x4
    class NNS_VECTORFAST m_sEffectPos; // offset 0x240, size 0x10
};
...
public:
    ...
    class clsGimmickAutoRunBuffer m_cHeliBuffer; // offset 0x64, size 0x1C
    enum enmCtrlMode m_aeCtrlMode[8]; // offset 0x80, size 0x20
    class NNS_VECTORFAST m_sDirPosVecFast; // offset 0xA0, size 0x10
};
class NNS_NODE {
    // total size: 0x90
public:
...
class clsGimmickAutoRunBufferBase {
    // total size: 0xC
public:
    unsigned int m_u32ExecuteNum; // offset 0x0, size 0x4
    unsigned int m_u32SleepNum; // offset 0x4, size 0x4
    unsigned int m_u32ObjectNum; // offset 0x8, size 0x4
};
class hkPadSpu {
    // total size: 0x4
public:
...
class stcAngleLimitsData {
    // total size: 0x8
public:
    class hkHingeLimitsData * pcAngleLimitData; // offset 0x0, size 0x4
    class hkConstraintInstance * pcConstraintInstance; // offset 0x4, size 0x4
};
class clsAutoRunHeli_Task : public clsBaseGimmickBody {
    // total size: 0xB4
public:
    class clsMacrossThroughCollision m_cThroughCollision; // offset 0xA4, size 0x8
    class NNS_ROTATE_A32 * m_pA32Rot; // offset 0xAC, size 0x4
    float m_f32AirCnt; // offset 0xB0, size 0x4
};
...
class clsGimmickAutoRunBuffer : public clsGimmickAutoRunBufferBase {
    // total size: 0x1C
public:
    class clsAutoRunHeli * m_apcObj; // offset 0xC, size 0x4
    class clsAutoRunHeli * * m_ppcExecute; // offset 0x10, size 0x4
    class clsAutoRunHeli * * m_ppcSleep; // offset 0x14, size 0x4
    class clsAutoRunHeli * * m_ppcExecuteWork; // offset 0x18, size 0x4
};
class clsFlyAction {
    // total size: 0x1C
public:
...
class clsAutoRunHeliModel {
    // total size: 0x18
public:
    class clsModelType_OB_TX_MO m_cModelHeli; // offset 0x0, size 0x10
    class clsModelType_OB_TX m_cModelRope; // offset 0x10, size 0x8
};
class map {
    // total size: 0x18
public:
...
class hkSetLocalRotationsConstraintAtom : public hkConstraintAtom {
    // total size: 0x70
public:
    class hkRotation m_rotationA; // offset 0x10, size 0x30
    class hkRotation m_rotationB; // offset 0x40, size 0x30
};
class hkSmallArray {
    // total size: 0x8
public:
...
class clsPendulum {
    // total size: 0x60
public:
    class NNS_VECTORFAST m_sOffsetPosVecFast; // offset 0x0, size 0x10
    class NNS_QUATERNION m_sRotQuat; // offset 0x10, size 0x10
    class hkArray m_vctpcRigidBody; // offset 0x20, size 0xC
    class hkArray m_vctpcShape; // offset 0x2C, size 0xC
    class hkConstraintChainInstance * m_pcChainInstance; // offset 0x38, size 0x4
    class hkBallSocketChainData * m_pcChainData; // offset 0x3C, size 0x4
    class hkArray m_vctsAngleLimitsData; // offset 0x40, size 0xC
    unsigned char m_u8LineNum; // offset 0x4C, size 0x1
    unsigned char m_u8RigidNum; // offset 0x4D, size 0x1
    float m_f32WorkLength; // offset 0x50, size 0x4
    class hkArray m_vctRigidLength; // offset 0x54, size 0xC
};
class hkEnum {
    // total size: 0x4
public:
...
class hkAngLimitConstraintAtom : public hkConstraintAtom {
    // total size: 0x10
public:
    unsigned char m_isEnabled; // offset 0x2, size 0x1
    unsigned char m_limitAxis; // offset 0x3, size 0x1
    float m_minAngle; // offset 0x4, size 0x4
    float m_maxAngle; // offset 0x8, size 0x4
    float m_angularLimitsTauFactor; // offset 0xC, size 0x4
};
...
class clsPendulumControl {
    // total size: 0x20
public:
    class clsPendulum * m_pcPendulum; // offset 0x0, size 0x4
    float m_f32CounterAngle; // offset 0x4, size 0x4
    class stcControlParam * m_psControlParam; // offset 0x8, size 0x4
    class NNS_QUATERNION m_sRotQuat; // offset 0xC, size 0x10
    unsigned char m_u8CounterLevel; // offset 0x1C, size 0x1
};
enum enmMode {
    MODE_INIT = 0,
    MODE_WAIT = 1,
...
class stcInfoParam {
    // total size: 0x18
public:
    float f32Length; // offset 0x0, size 0x4
    float f32MaxAngle; // offset 0x4, size 0x4
    float f32AngularDamping; // offset 0x8, size 0x4
    float f32Mass; // offset 0xC, size 0x4
    float f32CenterMass; // offset 0x10, size 0x4
    float f32MaxAngleVelocity; // offset 0x14, size 0x4
};
enum enmSoundMode {
...
class hkArray {
    // total size: 0xC
public:
    class stcAngleLimitsData * m_data; // offset 0x0, size 0x4
    signed int m_size; // offset 0x4, size 0x4
    signed int m_capacityAndFlags; // offset 0x8, size 0x4
};
...
class hkHingeLimitsData : public hkConstraintData {
    // total size: 0xA0
public:
    class Atoms m_atoms; // offset 0x10, size 0x90
};
...
class clsGimmickAutoRunObj {
    // total size: 0x1C0
public:
    enum enmRet m_eClipRet; // offset 0x4, size 0x4
    class clsPlayerTask * m_pcPlayerTask; // offset 0x8, size 0x4
    class NNS_VECTORFAST m_sPosVecFast; // offset 0x10, size 0x10
    class NNS_QUATERNION m_sRotQuat; // offset 0x20, size 0x10
    class clsGimmickPath m_cGimmickPath; // offset 0x30, size 0x190
};
class stcControlParam {
    // total size: 0x98
public:
    float f32Force; // offset 0x0, size 0x4
    unsigned int u32MaxCounterLevel; // offset 0x4, size 0x4
    float af32CounterAngle[4]; // offset 0x8, size 0x10
    float af32MaxAngleVelocity[4]; // offset 0x18, size 0x10
    float af32MaxAngle[4][7]; // offset 0x28, size 0x70
};
class hkInplaceArray : public hkArray {
    // total size: 0x10
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xA4
public:
    class clsAutoRunHeli_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsAutoRunHeliModel m_cModel; // offset 0x88, size 0x18
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0xA0, size 0x4
};
class clsOOSubMenu {
    // total size: 0x8
public:
...
class hk2dAngConstraintAtom : public hkConstraintAtom {
    // total size: 0x4
public:
    unsigned char m_freeRotationAxis; // offset 0x2, size 0x1
};
class _atexit {
    // total size: 0x88
public:
...
class Atoms {
    // total size: 0x90
public:
    class hkSetLocalRotationsConstraintAtom m_rotations; // offset 0x0, size 0x70
    class hkAngLimitConstraintAtom m_angLimit; // offset 0x70, size 0x10
    class hk2dAngConstraintAtom m_2dAng; // offset 0x80, size 0x4
};
class allocator {
    // total size: 0x1
};
...
class hkArray {
    // total size: 0xC
public:
    float * m_data; // offset 0x0, size 0x4
    signed int m_size; // offset 0x4, size 0x4
    signed int m_capacityAndFlags; // offset 0x8, size 0x4
};
class hkArray {
...
// Range: 0x50E9B0 -> 0x50EBAC
void draw(class clsAutoRunHeli_Task * this /* r29+0xBC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50E9B0 -> 0x50EBAC
        unsigned int u32Num; // r2
        unsigned int * psNodeStat; // r21
        unsigned int u32ViewNo; // r20
        float (* opaNnViewMtx)[4][4]; // r19
        float (* psMtxPal)[4][4]; // r22
        class clsAutoRunHeliModel & rcModel; // r23
...
// Range: 0x50EBB0 -> 0x50EDD4
void execute(class clsAutoRunHeli_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50EBB0 -> 0x50EDD4
        unsigned int u32Num; // r2
...
// Range: 0x50EDE0 -> 0x50F0C4
void controlPlayer(class clsAutoRunHeli_Obj * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50EDE0 -> 0x50F0C4
        class clsPlayerTask * * apcPlayerTask; // r20
        enum enmCtrlMode * peCtrlMode; // r19
        unsigned int u32Num; // r22
        class clsPlayerTask * pcPlayer; // r2
        class NNS_VECTORFAST sPosVecFast; // r29+0xA0
        class clsAutoRunHeli * pcHeli; // r16
        float f32Length; // r29+0xB0
        float f32Speed; // r29+0xB0
    }
}


// Range: 0x50F0F0 -> 0x50F2E8
void createModel(class clsAutoRunHeli_Task * this /* r19 */, class stcBinInfo & rsBinInfoI /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50F0F0 -> 0x50F2E8
        unsigned int u32CalcObjNum; // r2
        class clsModelType_OB_TX & rcModelRope; // r2
    }
}


// Range: 0x50F2F0 -> 0x50F354
void reset(class clsAutoRunHeli_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50F2F0 -> 0x50F354
        unsigned int u32Num; // r2
...
// Range: 0x50F360 -> 0x50F39C
class clsAutoRunHeli * getMoveModeCmp(class clsAutoRunHeli_Obj * this /* r2 */, enum enmMoveMode eMoveMode /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50F360 -> 0x50F39C
        unsigned int u32Num; // r6
        class clsAutoRunHeli * * apcHeli; // r4
    }
}


// Range: 0x50F3A0 -> 0x50F590
void contactTriggerEvent(class clsAutoRunHeli_Obj * this /* r18 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50F3A0 -> 0x50F590
        class clsPlayerTask * pcPlayerTask; // r17
        unsigned int u32PlayerNo; // r2
        class NNS_VECTORFAST sDirVecFast; // r29+0x50
        float f32Rad; // r29+0x60
    }
}


// Range: 0x50F590 -> 0x50F5E0
void destroyData(class clsAutoRunHeli_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50F590 -> 0x50F5E0
    }
...
// Range: 0x50F5E0 -> 0x50F6DC
void createData(class clsAutoRunHeli_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50F5E0 -> 0x50F6DC
        class hkTransform cTransform; // r29+0x50
    }
}


// Range: 0x50F6E0 -> 0x50F864
void reset(class clsAutoRunHeli_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50F6E0 -> 0x50F864
        class clsGimmickAutoRunBuffer & rcHeliBuffer; // r17
        class clsAutoRunHeli * pcHeli; // r16
    }
}


// Range: 0x50F870 -> 0x50F878
void init(class clsAutoRunHeli_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50F870 -> 0x50F878
    }
...
// Range: 0x50F880 -> 0x50FB30
unsigned char draw(class clsAutoRunHeli * this /* r20 */, class clsAutoRunHeliModel & rcModel /* r19 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r23 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r21 */, unsigned int NodeStatus /* r30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50F880 -> 0x50FB30
        class NNS_OBJECT * psObject; // r21
        float sMtx[4][4]; // r29+0x100
        float f32AirMove; // r20
    }
}


// Range: 0x50FB30 -> 0x5103C4
void execute(class clsAutoRunHeli * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x50FB30 -> 0x5103C4
    }
...
// Range: 0x510430 -> 0x510448
void getEffectPosVecFast(class clsAutoRunHeli * this /* r4 */, class NNS_VECTORFAST & rsPosVecFast /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x510430 -> 0x510448
    }
...
// Range: 0x510450 -> 0x510518
void getPathRotQuat(class clsAutoRunHeli * this /* r2 */, class NNS_QUATERNION & rsRotQuat /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x510450 -> 0x510518
        class NNS_VECTORFAST sDirVecFast; // r29+0x30
    }
}


// Range: 0x510520 -> 0x51064C
unsigned char movePath(class clsAutoRunHeli * this /* r17 */, unsigned char bFunc /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x510520 -> 0x51064C
        class clsGimmickPath & rcGimmickPath; // r2
    }
}


// Range: 0x510650 -> 0x510728
void start(class clsAutoRunHeli * this /* r17 */, class clsPlayerTask * pcPlayerTask /* r2 */, class clsAutoRunHeli_Obj * pcObj /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x510650 -> 0x510728
    }
...
// Range: 0x510730 -> 0x510860
void setStartWait(class clsAutoRunHeli * this /* r16 */, class clsAutoRunHeli_Obj * pcObj /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x510730 -> 0x510860
    }
