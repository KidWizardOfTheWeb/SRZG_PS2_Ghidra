/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage15\St15FloatingMeteorite.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x6937B0
static class NNS_VECTORFAST toasTargetTablePosVecFast[4]; // size: 0x40, address: 0x6937C0
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x693800
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x693810
struct /* @anon20 */ {
    // total size: 0x48
} __vt__25clsFloatingMeteorite_Task; // size: 0x48, address: 0x6CD7E0
struct /* @anon19 */ {
    // total size: 0x48
} __vt__103clsSingleModelGimmick_Task<25clsFloatingMeteorite_Task,24clsFloatingMeteorite_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CD950
struct /* @anon6 */ {
    // total size: 0x38
...
struct /* @anon3 */ {
    // total size: 0xC
} __vt__41clsSingleton<25clsFloatingMeteorite_Task>; // size: 0xC, address: 0x6CD8E8
void * __dt(class clsFloatingMeteorite_Obj *, signed short); // size: 0x0, address: 0x517600
struct /* @anon8 */ {
    // total size: 0x48
} __vt__95clsBaseGimmickBody<25clsFloatingMeteorite_Task,24clsFloatingMeteorite_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CD900
struct /* @anon18 */ {
    // total size: 0xB4
} __vt__24clsBaseGravityLinkObject; // size: 0xB4, address: 0x6C1420
struct /* @anon12 */ {
    // total size: 0xB8
} __vt__24clsFloatingMeteorite_Obj; // size: 0xB8, address: 0x6CD830
struct /* @anon11 */ {
    // total size: 0x28
...
void * __ct(class clsFloatingMeteorite_Obj *); // size: 0x0, address: 0x518280
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x6938D0
struct /* @anon1 */ {
    // total size: 0xC
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x693910
struct /* @anon22 */ {
    // total size: 0xC
...
// Range: 0x5176A0 -> 0x51775C
void attackFloatingMeteorite(class clsFloatingMeteorite_Task * this /* r19 */, unsigned int u32GroupNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5176A0 -> 0x51775C
...
// Range: 0x517760 -> 0x517AF8
void draw(class clsFloatingMeteorite_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x517760 -> 0x517AF8
...
// Range: 0x517BA0 -> 0x517C80
void execute(class clsFloatingMeteorite_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x517BA0 -> 0x517C80
        unsigned int u32Num; // r2
...
// Range: 0x517C80 -> 0x517CF0
void reset(class clsFloatingMeteorite_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x517C80 -> 0x517CF0
        unsigned int u32Num; // r2
...
// Range: 0x517CF0 -> 0x517E24
void reset(class clsFloatingMeteorite_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x517CF0 -> 0x517E24
        class hkVector4 cZero; // r29+0x40
    }
}


// Range: 0x517E30 -> 0x517F1C
void * __ct(class clsFloatingMeteorite_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x517E30 -> 0x517F1C
...
// Range: 0x518300 -> 0x518388
void destroyData(class clsFloatingMeteorite_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x518300 -> 0x518388
    }
...
// Range: 0x518390 -> 0x518770
void createData(class clsFloatingMeteorite_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x518390 -> 0x518770
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0xB0
        class hkMassProperties massProperties; // r29+0x60
        class clsGrindLinkControl * pcGravityControl; // r2
    }
}


// Range: 0x518770 -> 0x5187E0
void setData(class clsFloatingMeteorite_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x518770 -> 0x5187E0
    }
...
// Range: 0x518820 -> 0x518894
void requestDrawBreakEffect(class clsFloatingMeteorite_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x518820 -> 0x518894
    }
...
// Range: 0x5188A0 -> 0x518CCC
void main(class clsFloatingMeteorite_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5188A0 -> 0x518CCC
        class NNS_VECTORFAST sVecFast; // r29+0xE0
        class NNS_QUATERNION sQuat; // r29+0xD0
    }
}
