/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage08\St08RoadCarBase.cpp
...
class clsRoadGlinkCarBase_Obj : public clsBaseGravityLinkObject, public clsRoadBase_Obj {
    // total size: 0x2C0
public:
    enum enmMode m_eMode; // offset 0xE4, size 0x4
    class clsRoadCarControl m_cRoadCarControl; // offset 0xF0, size 0x1D0
};
enum enmType {
    TYPE_NULL = 0,
    TYPE_NORMAL = 1,
...
// Range: 0x5278D0 -> 0x527914
void execute(class clsRoadGlinkCarBase_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5278D0 -> 0x527914
        class clsRoadCarControl & rcControl; // r16
    }
}


// Range: 0x527920 -> 0x527978
void main(class clsRoadGlinkCarBase_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x527920 -> 0x527978
    }
...
// Range: 0x527980 -> 0x5279B4
void resetObject(class clsRoadGlinkCarBase_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x527980 -> 0x5279B4
    }
...
// Range: 0x5279C0 -> 0x527A40
void resetRigidBody(class clsRoadGlinkCarBase_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5279C0 -> 0x527A40
...
// Range: 0x527A40 -> 0x527AA8
void reset(class clsRoadGlinkCarBase_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x527A40 -> 0x527AA8
    }
...
// Range: 0x527AC0 -> 0x527B04
void execute(class clsRoadCarBase_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x527AC0 -> 0x527B04
        class clsRoadCarControl & rcControl; // r16
...
// Range: 0x527B10 -> 0x527B68
void main(class clsRoadCarBase_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x527B10 -> 0x527B68
    }
...
// Range: 0x527B70 -> 0x527BA4
void resetObject(class clsRoadCarBase_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x527B70 -> 0x527BA4
    }
...
// Range: 0x527BB0 -> 0x527C30
void resetRigidBody(class clsRoadCarBase_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x527BB0 -> 0x527C30
        class clsRigidBody * pcRigidBody; // r16
...
// Range: 0x527C30 -> 0x527C98
void reset(class clsRoadCarBase_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x527C30 -> 0x527C98
    }
