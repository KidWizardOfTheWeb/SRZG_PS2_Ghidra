/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\GimmickAutoRunObj.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x68AC70
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x68AC60
...
// Range: 0x4ACA10 -> 0x4ACA7C
void setPathPosition(class clsGimmickAutoRunObj * this /* r17 */, unsigned int u32PathNo /* r2 */, float f32Speed /* r29+0x40 */, float f32TotalFrame /* r29+0x40 */, float f32OffsetY /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4ACA10 -> 0x4ACA7C
...
// Range: 0x4ACA80 -> 0x4ACC38
void setPathMove(class clsGimmickAutoRunObj * this /* r2 */, class NNS_VECTORFAST & rsNextPosVecFast /* r21 */, class NNS_QUATERNION & rsQuat /* r20 */, float f32InterpoRate /* r20 */, class NNS_VECTORFAST & rsOffsetVecFast /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4ACA80 -> 0x4ACC38
...
// Range: 0x4ACC40 -> 0x4ACD18
void setPathPostural(class clsGimmickAutoRunObj * this /* r2 */, class NNS_QUATERNION & rsRotQuat /* r2 */, float f32InterpoRate /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4ACC40 -> 0x4ACD18
        class clsPlayerTask * pcPlayerTask; // r2
        float sMtx[4][4]; // r29+0x50
        float f32Rad; // r29+0x90
        class NNS_VECTORFAST sDirVecFast; // r29+0x40
    }
}


// Range: 0x4ACD20 -> 0x4ACE18
void setPathVelocity(class clsGimmickAutoRunObj * this /* r2 */, class NNS_VECTORFAST & rsNextPosVecFast /* r19 */, class NNS_QUATERNION & rsQuat /* r18 */, class NNS_VECTORFAST & rsOffsetVecFast /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4ACD20 -> 0x4ACE18
        class clsPlayerTask * pcPlayerTask; // r2
