/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\SurvivalBattle\Bomb\SvlBtlBombObject.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTORFAST t_osOffsetPosVecFastTable; // size: 0x10, address: 0x697740
float t_f32SphereRadius; // size: 0x4, address: 0x697750
float t_of32ClipSqDist; // size: 0x4, address: 0x697758
float t_of32GCtrlSpeed; // size: 0x4, address: 0x0
float t_of32TouchRadius; // size: 0x4, address: 0x0
float t_of32LimitFrame; // size: 0x4, address: 0x697760
float t_of32GCtrlFrmae; // size: 0x4, address: 0x0
float t_of32HormingSpeed; // size: 0x4, address: 0x0
float tof32LockOnRange; // size: 0x4, address: 0x0
float t_of32LockOnDorPro; // size: 0x4, address: 0x0
struct /* @anon5 */ {
    // total size: 0xA8
} __vt__20clsSvlBtlBomb_Object; // size: 0xA8, address: 0x6CF850
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x6977A0
...
// Range: 0x548C30 -> 0x548C88
void requestDrawBreakEffect(class clsSvlBtlBomb_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x548C30 -> 0x548C88
    }
...
// Range: 0x548C90 -> 0x548CFC
void contactTriggerCallback(class clsSvlBtlBomb_Object * this /* r16 */, class hkContactPointConfirmedEvent & cEvent /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x548C90 -> 0x548CFC
    }
...
// Range: 0x548D00 -> 0x548E8C
void contactTriggerEvent(class clsSvlBtlBomb_Object * this /* r16 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x548D00 -> 0x548E8C
    }
...
// Range: 0x548E90 -> 0x548ED0
void destroyData(class clsSvlBtlBomb_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x548E90 -> 0x548ED0
    }
...
// Range: 0x548ED0 -> 0x5490F0
void createData(class clsSvlBtlBomb_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x548ED0 -> 0x5490F0
...
// Range: 0x549100 -> 0x549710
void main(class clsSvlBtlBomb_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x549100 -> 0x549710
        class NNS_VECTORFAST sEffPos; // r29+0x170
        class NNS_VECTORFAST sOffsetPos; // r29+0x160
        float sTrsMtx[4][4]; // r29+0x120
        class NNS_VECTORFAST sEffPos; // r29+0x110
        class NNS_VECTORFAST sOffsetPos; // r29+0x100
        float sTrsMtx[4][4]; // r29+0xC0
        float sTrsMtx[4][4]; // r29+0x80
        class NNS_VECTORFAST sMoveVecFast; // r29+0x70
        class NNS_VECTORFAST sTargetVecFast; // r29+0x60
    }
}


// Range: 0x549710 -> 0x549784
void reset(class clsSvlBtlBomb_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x549710 -> 0x549784
    }
...
// Range: 0x549790 -> 0x5498FC
void lockon(class clsSvlBtlBomb_Object * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x549790 -> 0x5498FC
        class NNS_VECTORFAST sVelocityVecFast; // r29+0xC0
        class NNS_VECTORFAST sDirVecFast; // r29+0xB0
        class NNS_VECTORFAST sDirNrmVecFast; // r29+0xA0
        float f32MaxDistSq; // r21
        float f32DistSq; // r29+0xD0
        signed int i; // r18
    }
}


// Range: 0x549900 -> 0x549B9C
void shoot(class clsSvlBtlBomb_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x549900 -> 0x549B9C
        class NNS_VECTORFAST sSpeedVecFast; // r29+0xD0
...
// Range: 0x549BA0 -> 0x549BB4
void charge(class clsSvlBtlBomb_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x549BA0 -> 0x549BB4
    }
...
// Range: 0x549BC0 -> 0x549E6C
void draw(class clsSvlBtlBomb_Object * this /* r17 */, class NNS_OBJECT * psObject /* r16 */, float (* psMtxPal)[4][4] /* r19 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r20 */, float (* psMtxWork)[4][4] /* r19 */, unsigned int u32ViewNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x549BC0 -> 0x549E6C
...
// Range: 0x549E70 -> 0x549F50
void * __dt(class clsSvlBtlBomb_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x549E70 -> 0x549F50
    }
...
// Range: 0x549F50 -> 0x54A020
void * __ct(class clsSvlBtlBomb_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x549F50 -> 0x54A020
    }
...
// Range: 0x54A020 -> 0x54A028
void @80@__dt__20clsSvlBtlBomb_ObjectFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54A020 -> 0x54A028
    }
