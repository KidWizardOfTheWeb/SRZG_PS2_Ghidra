/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\DashPanel.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float t_f32ClipDist; // size: 0x4, address: 0xB13DB8
float t_aof32ClipDistSq[17]; // size: 0x44, address: 0x67D070
struct /* @anon3 */ {
    // total size: 0x48
} __vt__17clsDashPanel_Task; // size: 0x48, address: 0x6BE9E0
struct /* @anon2 */ {
    // total size: 0x48
} __vt__87clsSingleModelGimmick_Task<17clsDashPanel_Task,16clsDashPanel_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6B8C90
struct /* @anon4 */ {
    // total size: 0x38
...
struct /* @anon11 */ {
    // total size: 0xC
} __vt__33clsSingleton<17clsDashPanel_Task>; // size: 0xC, address: 0x6B8C28
void * __dt(class clsDashPanel_Obj *, signed short); // size: 0x0, address: 0x2D9630
struct /* @anon15 */ {
    // total size: 0x48
} __vt__79clsBaseGimmickBody<17clsDashPanel_Task,16clsDashPanel_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6B8C40
struct /* @anon7 */ {
    // total size: 0x28
...
struct /* @anon1 */ {
    // total size: 0x58
} __vt__16clsDashPanel_Obj; // size: 0x58, address: 0x6BEA30
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x67D0E0
...
// Range: 0x366DA0 -> 0x366FB0
void draw(class clsDashPanel_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x366DA0 -> 0x366FB0
...
// Range: 0x366FB0 -> 0x367128
void execute(class clsDashPanel_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x366FB0 -> 0x367128
...
// Range: 0x367130 -> 0x367148
void contactRemoveEvent(class clsDashPanel_Obj * this /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x367130 -> 0x367148
...
// Range: 0x367150 -> 0x367558
void contactAlwaysEvent(class clsDashPanel_Obj * this /* r19 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x367150 -> 0x367558
        class clsPlayerTask * pcHitPlayer; // r18
        float (* psMtxPal)[4][4]; // r17
        class NNS_VECTORFAST sVecFast; // r29+0x70
    }
}


// Range: 0x367610 -> 0x3678D4
void draw(class clsDashPanel_Obj * this /* r17 */, class clsModelType_OB_TX & rcObj /* r16 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r19 */, float (* opaNnViewMtx)[4][4] /* r21 */, float (* psMtxWork)[4][4] /* r20 */, unsigned int u32ViewNo /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x367610 -> 0x3678D4
    }
...
// Range: 0x3678E0 -> 0x367928
void destroyData(class clsDashPanel_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3678E0 -> 0x367928
    }
...
// Range: 0x367930 -> 0x367A44
void createData(class clsDashPanel_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x367930 -> 0x367A44
    }
