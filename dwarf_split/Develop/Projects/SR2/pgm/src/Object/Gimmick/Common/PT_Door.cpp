/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\PT_Door.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32CLIP_DISTx2; // size: 0x4, address: 0x67DF30
struct /* @anon15 */ {
    // total size: 0x48
} __vt__15clsPT_Door_Task; // size: 0x48, address: 0x6BEE60
struct /* @anon17 */ {
    // total size: 0x48
} __vt__83clsSingleModelGimmick_Task<15clsPT_Door_Task,14clsPT_Door_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6B9110
struct /* @anon5 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPT_Door_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A818
struct /* @anon6 */ {
    // total size: 0xC
} __vt__31clsSingleton<15clsPT_Door_Task>; // size: 0xC, address: 0x6B90A8
void * __dt(class clsPT_Door_Obj *, signed short); // size: 0x0, address: 0x2D6B00
struct /* @anon9 */ {
    // total size: 0x48
} __vt__75clsBaseGimmickBody<15clsPT_Door_Task,14clsPT_Door_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6B90C0
struct /* @anon12 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon4 */ {
    // total size: 0xA8
} __vt__14clsPT_Door_Obj; // size: 0xA8, address: 0x6BEEB0
struct /* @anon13 */ {
    // total size: 0x28
...
class clsPT_Door_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
...
class clsPT_Door_Obj : public clsRigidBodyGimmickObj {
    // total size: 0xE0
public:
    enum enmPT_DoorMode m_ePtDoorMode; // offset 0xD0, size 0x4
};
class Stack {
    // total size: 0x10
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPT_Door_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x36E410 -> 0x36E768
void draw(class clsPT_Door_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36E410 -> 0x36E768
...
// Range: 0x36E820 -> 0x36EA68
void execute(class clsPT_Door_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36E820 -> 0x36EA68
        class NNS_NODE * psNodeList; // r2
        unsigned int u32Num; // r2
        unsigned int u32i; // r18
    }
}
...
// Range: 0x36EA70 -> 0x36EAE0
void reset(class clsPT_Door_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36EA70 -> 0x36EAE0
        unsigned int u32Num; // r2
...
// Range: 0x36EAE0 -> 0x36EB80
void reset(class clsPT_Door_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36EAE0 -> 0x36EB80
    }
...
// Range: 0x36EBA0 -> 0x36EBD0
void contactInterraction(class clsPT_Door_Obj * this /* r16 */, class clsRigidBodyGimmickObj * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36EBA0 -> 0x36EBD0
    }
...
// Range: 0x36EBD0 -> 0x36EC1C
void contactTriggerEvent(class clsPT_Door_Obj * this /* r17 */, class hkContactPoint * pcContact /* r2 */, class clsObject * pcObject /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36EBD0 -> 0x36EC1C
    }
...
// Range: 0x36EC20 -> 0x36EE04
void startBreak(class clsPT_Door_Obj * this /* r17 */, class clsPlayerTask * pcHitPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36EC20 -> 0x36EE04
        float sTrsMtx[4][4]; // r29+0x40
        class NNS_VECTORFAST sBoundVecFast; // r29+0x30
    }
}


// Range: 0x36EE10 -> 0x36EEA4
void destroyData(class clsPT_Door_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36EE10 -> 0x36EEA4
    }
...
// Range: 0x36EEB0 -> 0x36FD00
void createData(class clsPT_Door_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36EEB0 -> 0x36FD00
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0xA0
        class hkVector4 cVec; // r29+0x90
        class hkMassProperties massProperties; // r29+0x40
        char __FUNCTION__[14]; // @ 0x0067DF20
    }
}


// Range: 0x36FDA0 -> 0x36FDF0
void setData(class clsPT_Door_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36FDA0 -> 0x36FDF0
    }
...
// Range: 0x36FE00 -> 0x36FECC
void main(class clsPT_Door_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36FE00 -> 0x36FECC
    }
...
// Range: 0x36FEF0 -> 0x36FEFC
class clsPT_Door_Task * GS() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36FEF0 -> 0x36FEFC
    }
