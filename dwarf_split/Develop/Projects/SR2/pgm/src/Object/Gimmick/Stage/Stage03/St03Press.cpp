/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage03\St03Press.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tofFallLength; // size: 0x4, address: 0x0
float tofRiseFrame; // size: 0x4, address: 0x0
float tofFallFrame; // size: 0x4, address: 0x0
float tofRiseWaitFrame; // size: 0x4, address: 0x0
float tofFallWaitFrame; // size: 0x4, address: 0x0
float tofRiseSpeed; // size: 0x4, address: 0x0
float tofFallSPeed; // size: 0x4, address: 0x0
static float CLIP_DISTx2; // size: 0x4, address: 0x67F7C8
class NNS_VECTOR m_tosThroughCollisionPosVec[3]; // size: 0x24, address: 0x67F7D0
float m_tof32ThroughCollisionRotY[3]; // size: 0xC, address: 0x67F7F8
struct /* @anon14 */ {
    // total size: 0x48
} __vt__13clsPress_Task; // size: 0x48, address: 0x6C0210
struct /* @anon21 */ {
    // total size: 0x48
} __vt__79clsSingleModelGimmick_Task<13clsPress_Task,12clsPress_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C0370
void * __dt(class clsPressCollision *, signed short); // size: 0x0, address: 0x3964C0
struct /* @anon6 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPress_Task * m_tpcSingleton; // size: 0x4, address: 0xB15ED0
struct /* @anon8 */ {
    // total size: 0xC
} __vt__29clsSingleton<13clsPress_Task>; // size: 0xC, address: 0x6C0308
void * __dt(class clsPress_Obj *, signed short); // size: 0x0, address: 0x396360
struct /* @anon10 */ {
    // total size: 0x48
} __vt__71clsBaseGimmickBody<13clsPress_Task,12clsPress_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C0320
struct /* @anon17 */ {
    // total size: 0xA8
...
struct /* @anon16 */ {
    // total size: 0x34
} __vt__17clsPressCollision; // size: 0x34, address: 0x6C03C0
struct /* @anon2 */ {
    // total size: 0xA8
} __vt__12clsPress_Obj; // size: 0xA8, address: 0x6C0260
struct /* @anon0 */ {
    // total size: 0x44
...
void * __ct(class clsPressCollision *); // size: 0x0, address: 0x397150
struct /* @anon15 */ {
    // total size: 0x30
} __vt__7clsTask; // size: 0x30, address: 0x6B59F0
void * __ct(class clsPress_Obj *); // size: 0x0, address: 0x397350
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPress_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsPress_Obj : public clsRigidBodyGimmickObj {
    // total size: 0x100
public:
    enum enmPressMode m_ePressMode; // offset 0xD0, size 0x4
    enum enmPressState m_ePressState; // offset 0xD4, size 0x4
    float m_f32StartWaitFrame; // offset 0xD8, size 0x4
    float m_f32FallSafeY; // offset 0xDC, size 0x4
    class clsPressCollision m_cCollision; // offset 0xE0, size 0x14
    class clsSe3DControl * m_pcSe3DControl; // offset 0xF4, size 0x4
};
...
class clsPress_Task : public clsSingleModelGimmick_Task {
    // total size: 0xDC
public:
    class hkShape * m_pcShape; // offset 0x94, size 0x4
    class clsPressCollision m_acCollision[3]; // offset 0x98, size 0x3C
    enum enmState m_eState; // offset 0xD4, size 0x4
    unsigned int m_u32PlayerFlg; // offset 0xD8, size 0x4
};
...
public:
    ...
    class clsPress_Task * m_pcPress_Task; // offset 0xC, size 0x4
    unsigned int m_u32ThroughCount; // offset 0x10, size 0x4
};
class allocator {
    // total size: 0x1
};
...
enum enmThroughCollisionNum {
    THROUGH_COLLISION_START = 0,
    THROUGH_COLLISION_STOP00 = 1,
    THROUGH_COLLISION_STOP01 = 2,
    THROUGH_COLLISION_MAX = 3,
};
enum enmRiseType {
    RISE_TYPE_NORMAL = 0,
    RISE_TYPE_MOVE = 1,
...
// Range: 0x396560 -> 0x396834
void draw(class clsPress_Task * this /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x396560 -> 0x396834
        unsigned int u32Num; // r2
        unsigned int * psNodeStat; // r21
        unsigned int u32ViewNo; // r23
...
// Range: 0x396890 -> 0x396B40
void execute(class clsPress_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x396890 -> 0x396B40
        unsigned int u32Num; // r2
...
// Range: 0x396C50 -> 0x396CC0
void reset(class clsPress_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x396C50 -> 0x396CC0
    }
...
// Range: 0x396CC0 -> 0x396D80
void createThroughCollision(class clsPress_Task * this /* r19 */, enum enmThroughCollisionNum eColissionNum /* r18 */, enum enmMode eMode /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x396CC0 -> 0x396D80
        class NNS_QUATERNION sQuat; // r29+0x50
        class clsPressCollision & rsCollision; // r16
    }
}


// Range: 0x396D80 -> 0x396E08
void reset(class clsPress_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x396D80 -> 0x396E08
        unsigned int u32Num; // r2
...
// Range: 0x396E10 -> 0x396FAC
void * __ct(class clsPress_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x396E10 -> 0x396FAC
...
// Range: 0x397450 -> 0x397A3C
void main(class clsPress_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x397450 -> 0x397A3C
        class hkVector4 cPos; // r29+0xA0
    }
}


// Range: 0x397A40 -> 0x397A74
void init(class clsPress_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x397A40 -> 0x397A74
    }
...
// Range: 0x397A80 -> 0x397AE8
void destroyData(class clsPress_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x397A80 -> 0x397AE8
    }
...
// Range: 0x397AF0 -> 0x397D9C
void createData(class clsPress_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x397AF0 -> 0x397D9C
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0x60
        class NNS_VECTOR sPosVec; // r29+0x120
    }
}


// Range: 0x397DA0 -> 0x397DB0
void contactRemoveEvent(class clsPressCollision * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x397DA0 -> 0x397DB0
    }
...
// Range: 0x397DB0 -> 0x397F00
void contactTriggerEvent(class clsPressCollision * this /* r19 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x397DB0 -> 0x397F00
    }
