/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Control\Se3DControl.cpp
...
class stcSeView {
    // total size: 0x8
public:
    signed char s8ViewNo; // offset 0x0, size 0x1
    float f32Distx2; // offset 0x4, size 0x4
};
...
// Range: 0x4ACE20 -> 0x4ACEA4
void stop(class clsSe3DControl * this /* r2 */, unsigned char u8SeNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4ACE20 -> 0x4ACEA4
        class clsPfCri & rcCri; // r17
        unsigned int u32i; // r16
        signed short * ps16Id3D; // r18
    }
}


// Range: 0x4ACEB0 -> 0x4ACF60
void stopAll(class clsSe3DControl * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4ACEB0 -> 0x4ACF60
...
// Range: 0x4ACF60 -> 0x4ACF98
void setInfo(class clsSe3DControl * this /* r2 */, unsigned char u8Num /* r2 */, unsigned int u32SndId /* r2 */, float rf32SeDistx2 /* r29 */, unsigned char bLoop /* r2 */, float f32DistDownK /* r29 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4ACF60 -> 0x4ACF98
        class stcSeData * psSeData; // r2
    }
}


// Range: 0x4ACFA0 -> 0x4AD088
void setParam(class clsSe3DControl * this /* r2 */, unsigned char u8SeNum /* r2 */, class NNS_VECTORFAST & rsPosVecFast /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4ACFA0 -> 0x4AD088
        class clsPfCri & rcCri; // r16
        class clsPfCameraMgr * pcCameraMgr; // r2
        unsigned int u32ViewportNum; // r2
        class stcSeData * psSeData; // r2
        signed short * ps16Id3D; // r22
        unsigned int u32i; // r21
    }
}


// Range: 0x4AD090 -> 0x4AD42C
void play(class clsSe3DControl * this /* r2 */, unsigned char u8SeNum /* r2 */, class NNS_VECTORFAST & rsPosVecFast /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4AD090 -> 0x4AD42C
        class clsPfCri & rcCri; // r21
        class clsPfCameraMgr * pcCameraMgr; // r2
        unsigned int u32ViewportNum; // r2
        class stcSeData * psSeData; // r2
        signed short * ps16Id3D; // r20
        float f32SeDistx2; // r20
        class stcSeView sSePlayView[4]; // r29+0xD0
        unsigned int u32v; // r7
        unsigned int u32i; // r19
        unsigned int u32i; // r8
        unsigned int u32j; // r7
        unsigned char u8PlayCount; // r29+0xC0
        class stcSeView sWorkView; // r29+0xF8
        unsigned char u8ViewNo; // r2
        signed short * ps16Id; // r2
    }
}
