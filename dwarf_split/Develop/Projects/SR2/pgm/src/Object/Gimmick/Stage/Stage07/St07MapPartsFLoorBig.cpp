/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage07\St07MapPartsFLoorBig.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x6925F0
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x6925F8
struct /* @anon2 */ {
    // total size: 0x48
} __vt__24clsMapPartsFloorBig_Task; // size: 0x48, address: 0x6CB220
struct /* @anon7 */ {
    // total size: 0x48
} __vt__104clsSingleModelGimmick_Task<24clsMapPartsFloorBig_Task,26clsMapPartsFloorBig_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CB2D0
struct /* @anon1 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsMapPartsFloorBig_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA700
struct /* @anon0 */ {
    // total size: 0xC
} __vt__40clsSingleton<24clsMapPartsFloorBig_Task>; // size: 0xC, address: 0x6CB268
void * __dt(class clsMapPartsFloorBig_Object *, signed short); // size: 0x0, address: 0x4F2DC0
struct /* @anon3 */ {
    // total size: 0x48
} __vt__96clsBaseGimmickBody<24clsMapPartsFloorBig_Task,26clsMapPartsFloorBig_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CB280
struct /* @anon4 */ {
    // total size: 0xA8
} __vt__26clsMapPartsFloorBig_Object; // size: 0xA8, address: 0x6CB320
...
void * __ct(class clsMapPartsFloorBig_Object *); // size: 0x0, address: 0x4F36B0
...
class clsMapPartsFloorBig_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
class stcSeed {
    // total size: 0x30
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsMapPartsFloorBig_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x4F2E40 -> 0x4F3114
void draw(class clsMapPartsFloorBig_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F2E40 -> 0x4F3114
...
// Range: 0x4F3220 -> 0x4F3290
void reset(class clsMapPartsFloorBig_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F3220 -> 0x4F3290
        unsigned int u32Num; // r2
...
// Range: 0x4F3290 -> 0x4F335C
void * __ct(class clsMapPartsFloorBig_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F3290 -> 0x4F335C
...
// Range: 0x4F36F0 -> 0x4F3728
void createData(class clsMapPartsFloorBig_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F36F0 -> 0x4F3728
    }
