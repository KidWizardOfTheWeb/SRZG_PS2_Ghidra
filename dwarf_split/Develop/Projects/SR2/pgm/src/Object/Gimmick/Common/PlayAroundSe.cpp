/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\PlayAroundSe.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class stcRequestArray m_oasu32RequestArray[2]; // size: 0x38, address: 0x6889D0
struct /* @anon8 */ {
    // total size: 0x48
} __vt__20clsPlayAroundSe_Task; // size: 0x48, address: 0x6C6D00
struct /* @anon12 */ {
    // total size: 0x48
} __vt__93clsSingleModelGimmick_Task<20clsPlayAroundSe_Task,19clsPlayAroundSe_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C6DB0
struct /* @anon5 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPlayAroundSe_Task * m_tpcSingleton; // size: 0x4, address: 0xB174B8
struct /* @anon4 */ {
    // total size: 0xC
} __vt__36clsSingleton<20clsPlayAroundSe_Task>; // size: 0xC, address: 0x6C6D48
void * __dt(class clsPlayAroundSe_Obj *, signed short); // size: 0x0, address: 0x470290
struct /* @anon6 */ {
    // total size: 0x48
} __vt__85clsBaseGimmickBody<20clsPlayAroundSe_Task,19clsPlayAroundSe_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C6D60
struct /* @anon10 */ {
    // total size: 0x28
...
struct /* @anon1 */ {
    // total size: 0x58
} __vt__19clsPlayAroundSe_Obj; // size: 0x58, address: 0x6C6E00
...
void * __ct(class clsPlayAroundSe_Obj *); // size: 0x0, address: 0x470A20
...
class stcRequestArray {
    // total size: 0x1C
public:
    unsigned int u32Id; // offset 0x0, size 0x4
    unsigned short u16MaxPauseFrame; // offset 0x4, size 0x2
    float f32Near; // offset 0x8, size 0x4
    float f32Far; // offset 0xC, size 0x4
    float f32ClipDist; // offset 0x10, size 0x4
    float f32DownK; // offset 0x14, size 0x4
    unsigned int u32Rot; // offset 0x18, size 0x4
};
class NNS_NODE {
    // total size: 0x90
public:
...
class clsPlayAroundSe_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
...
public:
    ...
    enum enmPlayAroundSeMode m_ePlayMode; // offset 0x64, size 0x4
    enum enmPlayAroundSeState m_ePlayState; // offset 0x68, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0x6C, size 0x4
    unsigned int m_u32SeNo; // offset 0x70, size 0x4
    unsigned short m_u16PauseFrame; // offset 0x74, size 0x2
    unsigned int m_u32PlayerFlg; // offset 0x78, size 0x4
    unsigned char m_u8ViewPortNum; // offset 0x7C, size 0x1
};
class Fuid {
    // total size: 0x10
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPlayAroundSe_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x470390 -> 0x4704C8
void draw(class clsPlayAroundSe_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x470390 -> 0x4704C8
...
// Range: 0x4704D0 -> 0x4705E0
void execute(class clsPlayAroundSe_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4704D0 -> 0x4705E0
        unsigned int u32Num; // r2
...
// Range: 0x4705E0 -> 0x470658
void reset(class clsPlayAroundSe_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4705E0 -> 0x470658
        unsigned int u32Num; // r2
...
void * __ct(class clsPlayAroundSe_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x470660 -> 0x4706CC
    }
...
// Range: 0x470B40 -> 0x470E08
void execute(class clsPlayAroundSe_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x470B40 -> 0x470E08
        unsigned int u32v; // r5
        class stcRequestArray stcSe; // r29+0x100
        float sMtx[4][4]; // r29+0xC0
        class NNS_VECTORFAST sVecFast; // r29+0xB0
        class NNS_VECTORFAST sPlayerPosVecFast; // r29+0xA0
        signed int s32RandRotX; // r2
        signed int s32d; // r2
    }
}


// Range: 0x470E10 -> 0x470E5C
void contactRemoveEvent(class clsPlayAroundSe_Obj * this /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x470E10 -> 0x470E5C
    }
...
// Range: 0x470E60 -> 0x470EA0
void contactTriggerEvent(class clsPlayAroundSe_Obj * this /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x470E60 -> 0x470EA0
    }
...
// Range: 0x470EA0 -> 0x470F24
void destroyData(class clsPlayAroundSe_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x470EA0 -> 0x470F24
    }
...
// Range: 0x470F30 -> 0x471154
void createData(class clsPlayAroundSe_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x470F30 -> 0x471154
        float f32x; // r3
