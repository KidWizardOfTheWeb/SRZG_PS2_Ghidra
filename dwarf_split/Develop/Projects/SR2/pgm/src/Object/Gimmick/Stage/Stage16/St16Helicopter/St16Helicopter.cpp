/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage16\St16Helicopter\St16Helicopter.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcPointData tosPoint00[7]; // size: 0xE0, address: 0x6904D0
static class stcPointData tosPoint01[7]; // size: 0xE0, address: 0x6905B0
static class stcPointData tosPoint02[7]; // size: 0xE0, address: 0x690690
static class stcPointData tosPoint03[7]; // size: 0xE0, address: 0x690770
static class stcPointData tosPoint04[7]; // size: 0xE0, address: 0x690850
static class stcPointData tosPoint05[7]; // size: 0xE0, address: 0x690930
static class stcPointData tosPoint06[4]; // size: 0x80, address: 0x690A10
static class stcPointData tosPoint07[4]; // size: 0x80, address: 0x690A90
static class stcPointData tosPoint08[7]; // size: 0xE0, address: 0x690B10
static class stcPointData tosPoint09[7]; // size: 0xE0, address: 0x690BF0
static class stcPointData tosPoint10[5]; // size: 0xA0, address: 0x690CD0
static class stcPointData tosPoint11[7]; // size: 0xE0, address: 0x690D70
static class stcPointData tosPoint12[7]; // size: 0xE0, address: 0x690E50
static class stcPointData * toapsPointTbl[13]; // size: 0x34, address: 0x6530F0
static unsigned char toau8PointArrayNumTbl[13]; // size: 0xD, address: 0x690F30
static signed char toas8PointDataTbl[11][3]; // size: 0x21, address: 0x690F40
float t_of32ClipDistx2; // size: 0x4, address: 0x690F68
class NNS_VECTORFAST t_osLightOffsetPosVecFast; // size: 0x10, address: 0x690F70
class NNS_PRIM3D_PCT t_asPrim3D_PCT_Polygon[4]; // size: 0x60, address: 0x653130
signed int t_s32TryPrim3D_PCT_Num; // size: 0x4, address: 0x653190
struct /* @anon6 */ {
    // total size: 0xA8
} __vt__17clsHelicopter_Obj; // size: 0xA8, address: 0x6C9CF0
struct /* @anon13 */ {
    // total size: 0xA8
...
struct /* @anon8 */ {
    // total size: 0x48
} __vt__18clsHelicopter_Task; // size: 0x48, address: 0x6C9E60
struct /* @anon16 */ {
    // total size: 0x48
} __vt__96clsSingleModelGimmick_Task<18clsHelicopter_Task,21clsHelicopter_Manager,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6C9EB0
void * __dt(class clsHelicopter_Manager *, signed short); // size: 0x0, address: 0x4D82C0
struct /* @anon7 */ {
    // total size: 0x48
} __vt__88clsBaseGimmickBody<18clsHelicopter_Task,21clsHelicopter_Manager,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6C9E10
struct /* @anon18 */ {
    // total size: 0x30
...
struct /* @anon23 */ {
    // total size: 0x58
} __vt__21clsHelicopter_Manager; // size: 0x58, address: 0x6C9DA0
class clsHelicopter_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA698
struct /* @anon0 */ {
    // total size: 0xC
} __vt__34clsSingleton<18clsHelicopter_Task>; // size: 0xC, address: 0x6C9DF8
void * __ct(class clsHelicopter_Manager *); // size: 0x0, address: 0x4D86E0
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x690FC0
void * __dt(class clsHelicopter_Obj *, signed short); // size: 0x0, address: 0x4D7A20
struct /* @anon19 */ {
    // total size: 0x44
} __vt__21clsSimpleShapePhantom; // size: 0x44, address: 0x6BB2F0
void * __ct(class clsHelicopter_Obj *); // size: 0x0, address: 0x4D8D30
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x691000
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x691020
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x691010
struct /* @anon5 */ {
    // total size: 0xC
} __vt__14clsSe3DControl; // size: 0xC, address: 0x6BBB18
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x6804D0
...
public:
    ...
    class clsHelicopter_Obj * m_pcObjects; // offset 0x64, size 0x4
    class stcSetDataDetail * m_psSetData; // offset 0x68, size 0x4
    unsigned int m_u32ObjNum; // offset 0x6C, size 0x4
};
class hkPadSpu {
    // total size: 0x4
public:
...
public:
    ...
    float m_f32Frame; // offset 0xD8, size 0x4
    float m_f32Speed; // offset 0xDC, size 0x4
    class NNS_VECTORFAST m_sDirVecFast; // offset 0xE0, size 0x10
    class NNS_VECTORFAST m_sLightPosVecFast; // offset 0xF0, size 0x10
    class NNS_QUATERNION m_sDrawRotQuat; // offset 0x100, size 0x10
    class NNS_ROTATE_A32 * m_opsLightRotVec; // offset 0x110, size 0x4
    class clsSlerpQuat m_cSlerpQuat; // offset 0x114, size 0x3C
    class stcPointData * m_psPointTbl; // offset 0x150, size 0x4
    float m_f32RotX; // offset 0x154, size 0x4
    float m_f32RotZ; // offset 0x158, size 0x4
    float m_f32RotZAdd; // offset 0x15C, size 0x4
    float m_f32LightFrame; // offset 0x160, size 0x4
    float m_f32GroundLightY; // offset 0x164, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0x168, size 0x4
    float m_f32StartRotFrame; // offset 0x16C, size 0x4
    float m_f32SlowDownFrame; // offset 0x170, size 0x4
    unsigned int m_u32Flg; // offset 0x174, size 0x4
    unsigned short m_u16PlayerFlg; // offset 0x178, size 0x2
    unsigned char m_bLight; // offset 0x17A, size 0x1
    unsigned char m_bDrawLightGround; // offset 0x17B, size 0x1
    unsigned char m_u8PointArrayNum; // offset 0x17C, size 0x1
    unsigned char m_u8PointIndex; // offset 0x17D, size 0x1
    unsigned char m_au8BackUpLigthNo[8]; // offset 0x17E, size 0x8
};
class hkPadSpu {
    // total size: 0x4
public:
...
class stcPointData {
    // total size: 0x20
public:
    class NNS_VECTORFAST sPointVecFast; // offset 0x0, size 0x10
    float f32WaitFrame; // offset 0x10, size 0x4
    unsigned char u8Flg; // offset 0x14, size 0x1
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x9C
public:
    class clsHelicopter_Manager * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsHelicopter_Task : public clsSingleModelGimmick_Task {
    // total size: 0xAC
public:
    class NNS_ROTATE_A32 * m_psLightRootRot; // offset 0x9C, size 0x4
    float m_f32LightFrame; // offset 0xA0, size 0x4
    class NNS_ROTATE_A32 * m_psPropellerBigRot; // offset 0xA4, size 0x4
    class NNS_ROTATE_A32 * m_psPropellerSmallRot; // offset 0xA8, size 0x4
};
class hkArray {
    // total size: 0xC
public:
...
// Range: 0x4D7B20 -> 0x4D7CA4
void draw(class clsHelicopter_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D7B20 -> 0x4D7CA4
        ...
        class clsModelType_OB_TX_MO & rcModel; // r18
        class clsModelType_OB_TX * pcModelObTx; // r2
        unsigned int * psNodeStat; // r22
        float (* psMtxPal)[4][4]; // r23
        float sMtxWork[4][4]; // r29+0x90
        unsigned int u32i; // r17
    }
}


// Range: 0x4D7CB0 -> 0x4D7F44
void execute(class clsHelicopter_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D7CB0 -> 0x4D7F44
        class NNS_NODE * pNodeList; // r2
        float & rf32Frame; // r2
        unsigned int u32Num; // r2
...
// Range: 0x4D7F50 -> 0x4D7FFC
void reset(class clsHelicopter_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D7F50 -> 0x4D7FFC
        unsigned int u32Num; // r2
...
// Range: 0x4D8000 -> 0x4D811C
void * __ct(class clsHelicopter_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D8000 -> 0x4D811C
        class hkVector4 cBox; // r29+0x20
    }
}


// Range: 0x4D87F0 -> 0x4D89C4
void draw(class clsHelicopter_Manager * this /* r29+0xAC */, class clsModelType_OB_TX_MO & rcObj /* r21 */, float (* psMtxPal)[4][4] /* r20 */, unsigned int * psNodeStat /* r22 */, float (* opaNnViewMtx)[4][4] /* r19 */, float (* psMtxWork)[4][4] /* r18 */, unsigned int u32ViewNo /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D87F0 -> 0x4D89C4
        unsigned int u32Num; // r17
        unsigned int u32GameCount; // r2
        class clsHelicopter_Obj * pcObj; // r16
    }
}


// Range: 0x4D89D0 -> 0x4D8A84
void contactAlwaysEvent(class clsHelicopter_Manager * this /* r16 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D89D0 -> 0x4D8A84
...
// Range: 0x4D8A90 -> 0x4D8B0C
void destroyData(class clsHelicopter_Manager * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D8A90 -> 0x4D8B0C
    }
...
// Range: 0x4D8B10 -> 0x4D8D28
void createData(class clsHelicopter_Manager * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D8B10 -> 0x4D8D28
        unsigned int u32Num; // r2
        class clsHelicopter_Obj * pcObj; // r20
        class stcSetDataDetail * psSetData; // r19
        float f32WaitFrame; // r21
        float f32Speed; // r20
        unsigned int u32PointNo; // r2
        unsigned int u32i; // r18
        class hkTransform cTransform; // r29+0x90
    }
}


// Range: 0x4D8E40 -> 0x4D8E9C
void setData(class clsHelicopter_Manager * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D8E40 -> 0x4D8E9C
    }
...
// Range: 0x4D8EA0 -> 0x4D9158
void draw(class clsHelicopter_Obj * this /* r21 */, class clsModelType_OB_TX_MO & rcObj /* r20 */, float (* psMtxPal)[4][4] /* r20 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r30 */, float (* psMtxWork)[4][4] /* r19 */, unsigned int u32ViewNo /* r18 */, unsigned int u32Seed /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D8EA0 -> 0x4D9158
...
// Range: 0x4D9160 -> 0x4D9C94
void main(class clsHelicopter_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D9160 -> 0x4D9C94
        class NNS_QUATERNION sRotQuat; // r29+0x260
        class NNS_QUATERNION sQuat; // r29+0x250
        class clsRigidBody * pcRigidBody; // r16
        float f32Speed; // r29+0x270
        float & rf32RotX; // r2
        float f32Speed; // r29+0x270
        class stcPointData & orsPointData; // r2
        class NNS_QUATERNION sRotQuat; // r29+0x240
        class NNS_QUATERNION sRotQuat; // r29+0x230
    }
}


// Range: 0x4D9ED0 -> 0x4D9F14
void requestDrawBreakEffect(class clsHelicopter_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D9ED0 -> 0x4D9F14
    }
...
// Range: 0x4D9F20 -> 0x4D9F8C
void requestDrawContactEffect(class clsHelicopter_Obj * this /* r17 */, class hkContactPoint * pcContact /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D9F20 -> 0x4D9F8C
    }
...
// Range: 0x4D9F90 -> 0x4D9FA4
void callbackGravityEvent(class clsHelicopter_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D9F90 -> 0x4D9FA4
    }
...
// Range: 0x4D9FB0 -> 0x4DA0B0
void slowDown(class clsHelicopter_Obj * this /* r2 */, float f32Speed /* r29+0x30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D9FB0 -> 0x4DA0B0
        class clsRigidBody * pcRigidBody; // r16
        class hkVector4 cVel; // r29+0x20
    }
}


// Range: 0x4DA0B0 -> 0x4DA1FC
void getNextPointRotate(class clsHelicopter_Obj * this /* r2 */, class NNS_QUATERNION & sRotQuat /* r16 */, unsigned int u32AddNext /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DA0B0 -> 0x4DA1FC
        signed char s8NextPointIndex; // r3
        class NNS_VECTORFAST sDirVecFast; // r29+0x70
        class NNS_VECTORFAST sSideVecFast; // r29+0x60
        float sMtx[4][4]; // r29+0x20
    }
}


// Range: 0x4DA200 -> 0x4DA2E8
void calcDirVecFast(class clsHelicopter_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DA200 -> 0x4DA2E8
        class NNS_VECTORFAST & rsDirVecFast; // r16
        float f32Length; // r29+0x40
        float f32Speed; // r29+0x40
        float f32NormalSpeedFrame; // r29+0x40
        float f32Frame; // r29+0x40
        float f32Rate; // r29+0x40
    }
}


// Range: 0x4DA2F0 -> 0x4DA434
void start(class clsHelicopter_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DA2F0 -> 0x4DA434
        class clsRigidBody * pcRigidBody; // r17
    }
}


// Range: 0x4DA440 -> 0x4DA4C0
void destroyData(class clsHelicopter_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DA440 -> 0x4DA4C0
    }
...
// Range: 0x4DA4C0 -> 0x4DA898
void createData(class clsHelicopter_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DA4C0 -> 0x4DA898
...
// Range: 0x4DA8A0 -> 0x4DA950
void setData(class clsHelicopter_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DA8A0 -> 0x4DA950
...
// Range: 0x4DA950 -> 0x4DA9D8
void reset(class clsHelicopter_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DA950 -> 0x4DA9D8
        class clsRigidBody * pcRigidBody; // r16
