/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage15\St15EnergyBullet.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x6876F0
struct /* @anon14 */ {
    // total size: 0x48
} __vt__20clsEnergyBullet_Task; // size: 0x48, address: 0x6C4AC0
struct /* @anon17 */ {
    // total size: 0x48
} __vt__99clsSingleModelGimmick_Task<20clsEnergyBullet_Task,19clsEnergyBullet_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C4C20
struct /* @anon15 */ {
    // total size: 0x38
...
struct /* @anon3 */ {
    // total size: 0xC
} __vt__36clsSingleton<20clsEnergyBullet_Task>; // size: 0xC, address: 0x6C4BB8
void * __dt(class clsEnergyBullet_Obj *, signed short); // size: 0x0, address: 0x43F360
struct /* @anon10 */ {
    // total size: 0x48
} __vt__91clsBaseGimmickBody<20clsEnergyBullet_Task,19clsEnergyBullet_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C4BD0
struct /* @anon0 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon5 */ {
    // total size: 0xA8
} __vt__19clsEnergyBullet_Obj; // size: 0xA8, address: 0x6C4B10
struct /* @anon12 */ {
    // total size: 0x28
...
class NNS_VECTOR tosZeroVec; // size: 0xC, address: 0x687738
...
void * __ct(class clsEnergyBullet_Obj *); // size: 0x0, address: 0x43FFB0
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x687750
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x687760
...
// Range: 0x43F460 -> 0x43F514
void setEnergyBullet(class clsEnergyBullet_Task * this /* r19 */, class NNS_VECTORFAST * opsBaseVecFast /* r18 */, float of32DistanceLR /* r21 */, float of32OffsetY /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43F460 -> 0x43F514
        unsigned int u32ObjNum; // r2
        unsigned int u32i; // r17
    }
}


// Range: 0x43F520 -> 0x43F828
void draw(class clsEnergyBullet_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43F520 -> 0x43F828
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        unsigned int u32Num; // r2
        class clsModelType_OB_TX_MO_MA & rcModel; // r2
        unsigned int * psNodeStat; // r20
        float (* opaNnViewMtx)[4][4]; // r29+0xB0
        float (* psMtxPal)[4][4]; // r19
...
// Range: 0x43F840 -> 0x43F9D0
void execute(class clsEnergyBullet_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43F840 -> 0x43F9D0
        ...
        unsigned int u32Num; // r2
        unsigned int u32i; // r18
        class stcSetDataDetail sSetDataDetail; // @ 0x00B17230
    }
}


// Range: 0x43F9D0 -> 0x43FA40
void reset(class clsEnergyBullet_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43F9D0 -> 0x43FA40
        unsigned int u32Num; // r2
...
// Range: 0x43FA40 -> 0x43FAB8
void reset(class clsEnergyBullet_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43FA40 -> 0x43FAB8
    }
...
// Range: 0x43FAC0 -> 0x43FC38
void * __ct(class clsEnergyBullet_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43FAC0 -> 0x43FC38
        class hkVector4 cVec; // r29+0x20
    }
}


// Range: 0x440130 -> 0x4406AC
void updatePathMove(class clsEnergyBullet_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x440130 -> 0x4406AC
        class NNS_QUATERNION sOldRotQuat; // r29+0x140
        class NNS_VECTORFAST sDistanceVecFast; // r29+0x130
        class hkVector4 cAngle; // r29+0x120
        class hkQuaternion cRotQuat; // r29+0x110
        class hkQuaternion cRotQuatNew; // r29+0x100
        class hkVector4 cAngle; // r29+0xF0
    }
}


// Range: 0x4407C0 -> 0x4409C4
void calcPathMoveLR(class clsEnergyBullet_Obj * this /* r16 */, float of32Distance /* r29+0x60 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4407C0 -> 0x4409C4
        float f32LRMoveFrame; // r5
        float f32Speed; // r29+0x60
        float f32Frame; // r22
        class NNS_VECTORFAST sVecFast; // r29+0x50
        class NNS_VECTORFAST sPosVecFast; // r29+0x40
        class hkVector4 cVelocity; // r29+0x30
        float f32OffsetX; // r29+0x60
        float f32OffsetY; // r29+0x60
    }
}


// Range: 0x4409D0 -> 0x440ED0
void initPathMove(class clsEnergyBullet_Obj * this /* r18 */, class NNS_VECTORFAST * opsBaseVecFast /* r17 */, float of32DistanceLR /* r25 */, float of32OffsetY /* r24 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4409D0 -> 0x440ED0
        float sMtx[4][4]; // r29+0x1F0
        class NNS_VECTORFAST sDirVecFast; // r29+0x1E0
        float sMtx[4][4]; // r29+0x1A0
        float sInvMtx[4][4]; // r29+0x160
        class NNS_VECTORFAST sXVecFast; // r29+0x150
        class NNS_VECTORFAST sYVecFast; // r29+0x140
        class NNS_VECTORFAST sVecFast; // r29+0x130
        class NNS_VECTORFAST sDistanceVecFast; // r29+0x120
        float f32Dist; // r29+0x230
        float f32Speed; // r2
        class NNS_QUATERNION sQuat; // r29+0x110
        float sMtx[4][4]; // r29+0xD0
        class NNS_VECTORFAST sXVecFast; // r29+0xC0
        class NNS_VECTORFAST sYVecFast; // r29+0xB0
    }
}


// Range: 0x440F20 -> 0x440F80
void destroyData(class clsEnergyBullet_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x440F20 -> 0x440F80
    }
...
// Range: 0x440F80 -> 0x441268
void createData(class clsEnergyBullet_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x440F80 -> 0x441268
...
// Range: 0x441270 -> 0x4412C4
void setData(class clsEnergyBullet_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x441270 -> 0x4412C4
    }
...
// Range: 0x4412D0 -> 0x441310
void requestDrawBreakEffect(class clsEnergyBullet_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4412D0 -> 0x441310
    }
...
// Range: 0x441310 -> 0x441848
void main(class clsEnergyBullet_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x441310 -> 0x441848
    }
