/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage05\St05Fire.cpp
...
float m_tof32AnimNum; // size: 0x4, address: 0x0
signed char t_s8DrawModelNo; // size: 0x1, address: 0xB17180
struct /* @anon4 */ {
    // total size: 0x48
} __vt__12clsFire_Task; // size: 0x48, address: 0x6C3900
void * __dt(class clsFire_Obj *, signed short); // size: 0x0, address: 0x2CD350
struct /* @anon9 */ {
    // total size: 0x48
} __vt__63clsBaseGimmickBody<12clsFire_Task,11clsFire_Obj,12clsFireModel>; // size: 0x48, address: 0x6BA570
struct /* @anon6 */ {
    // total size: 0x30
...
struct /* @anon2 */ {
    // total size: 0x44
} __vt__11clsFire_Obj; // size: 0x44, address: 0x6C3950
...
class clsFire_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A7F8
...
struct /* @anon7 */ {
    // total size: 0xC
} __vt__28clsSingleton<12clsFire_Task>; // size: 0xC, address: 0x6BA558
struct /* @anon10 */ {
    // total size: 0xC
...
public:
    ...
    class clsParticleLayer * m_pcSparks; // offset 0x54, size 0x4
    class NNS_VECTORFAST m_sSparksPosFast; // offset 0x60, size 0x10
    unsigned char m_u8FireType; // offset 0x70, size 0x1
};
...
class clsFire_Task : public clsBaseGimmickBody {
    // total size: 0xA4
public:
    float * m_pf32TexCoordU; // offset 0x9C, size 0x4
    float m_f32AnimSpeed; // offset 0xA0, size 0x4
};
...
class clsFireModel {
    // total size: 0x10
public:
    class clsModelType_OB_TX m_acModel[2]; // offset 0x0, size 0x10
};
class allocator {
    // total size: 0x1
};
...
// Range: 0x427640 -> 0x4279B4
void draw(class clsFire_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x427640 -> 0x4279B4
        ...
        float (* opaBillBoardMtx)[4][4]; // r29+0xC0
...
// Range: 0x427B50 -> 0x427F30
void execute(class clsFire_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x427B50 -> 0x427F30
        class NNS_OBJECT * psObject; // r2
        float * pf32AnimSpeed; // r2
        unsigned int u32Num; // r2
...
// Range: 0x427F30 -> 0x4280B4
void createModel(class clsFire_Task * this /* r2 */, class stcBinInfo & rsBinInfoI /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x427F30 -> 0x4280B4
...
// Range: 0x4280C0 -> 0x428118
void reset(class clsFire_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4280C0 -> 0x428118
        unsigned int u32Num; // r2
...
// Range: 0x428120 -> 0x428164
void setData(class clsFire_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x428120 -> 0x428164
        unsigned char u8Num; // r2
    }
}
