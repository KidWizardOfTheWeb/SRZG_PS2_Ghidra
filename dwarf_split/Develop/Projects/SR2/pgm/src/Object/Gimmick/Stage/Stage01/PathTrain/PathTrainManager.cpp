/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage01\PathTrain\PathTrainManager.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned int otau32Se_TrainHorn[2]; // size: 0x8, address: 0x6962E0
unsigned int otau32Se_TrainL[2]; // size: 0x8, address: 0x6962E8
signed char m_toas8ViewToEffectiveRanking[4]; // size: 0x4, address: 0x0
struct /* @anon4 */ {
    // total size: 0x34
} __vt__22clsPathTrainThroughCol; // size: 0x34, address: 0x6CE6F0
struct /* @anon3 */ {
    // total size: 0x28
...
void * __dt(class clsPathTrain_Obj *, signed short); // size: 0x0, address: 0x5309D0
...
void * __ct(class clsPathTrain_Obj *); // size: 0x0, address: 0x530AE0
struct /* @anon6 */ {
    // total size: 0xC
...
// Range: 0x530CC0 -> 0x530ECC
void draw(class clsPathTrain_Task * this /* r29+0xEC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x530CC0 -> 0x530ECC
        ...
        unsigned int * psNodeStat; // r29+0xC0
        float (* psMtxPal)[4][4]; // r29+0xB0
        float sMtx[4][4]; // r29+0xF0
        class clsModelType_OB_TX & rcModel; // r22
        class clsModelType_OB_TX_MO_MA & rcModelLight; // r29+0xA0
        unsigned int u32i; // r21
    }
}


// Range: 0x530ED0 -> 0x530F70
void execute(class clsPathTrain_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x530ED0 -> 0x530F70
        unsigned int u32Num; // r2
...
// Range: 0x530F70 -> 0x53108C
void createModel(class clsPathTrain_Task * this /* r16 */, class stcBinInfo & rsBinInfoI /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x530F70 -> 0x53108C
...
// Range: 0x531090 -> 0x53115C
void reset(class clsPathTrain_Task * this /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x531090 -> 0x53115C
        unsigned int u32Num; // r2
...
// Range: 0x531160 -> 0x5313AC
void execute(class clsPathTrainManager_Obj * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x531160 -> 0x5313AC
        ...
        class clsPathTrain_Obj * pcTrainObj; // r17
        class clsSe3DControl * pcSe3DControl; // r16
    }
}


// Range: 0x5313B0 -> 0x53145C
void start(class clsPathTrainManager_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5313B0 -> 0x53145C
        ...
        class clsPathTrain_Obj * pcTrainObj; // r19
        float f32Speed; // r21
...
// Range: 0x531460 -> 0x53150C
void destroyData(class clsPathTrainManager_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x531460 -> 0x53150C
...
// Range: 0x531510 -> 0x53197C
void createData(class clsPathTrainManager_Obj * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x531510 -> 0x53197C
        signed int s32TrainNum; // r2
        signed int s32VehiclesNum; // r20
        signed int s32TrainMax; // r29+0xB0
        signed int s32i; // r19
        class stcTrainData * psTrainData; // r18
        class clsPathTrain_Obj * pcTrainObj; // r17
        class clsPathTrain_Obj * pcParentObj; // r3
...
// Range: 0x531980 -> 0x531A3C
void setData(class clsPathTrainManager_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x531980 -> 0x531A3C
        class stcSetDataDetail * psSetDataDetail; // r2
        float f32Frame; // r29+0x30
    }
}


// Range: 0x531A40 -> 0x531AF4
void contactTriggerEvent(class clsPathTrainThroughCol * this /* r16 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x531A40 -> 0x531AF4
    }
