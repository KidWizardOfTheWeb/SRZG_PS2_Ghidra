/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\WallObj.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon5 */ {
    // total size: 0x48
} __vt__15clsWallObj_Task; // size: 0x48, address: 0x6C1930
void * __dt(class clsWallObj_Obj *, signed short); // size: 0x0, address: 0x3CF430
struct /* @anon16 */ {
    // total size: 0x48
} __vt__75clsBaseGimmickBody<15clsWallObj_Task,14clsWallObj_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C1990
struct /* @anon15 */ {
    // total size: 0x30
...
struct /* @anon4 */ {
    // total size: 0x34
} __vt__16clsWallObjThrCol; // size: 0x34, address: 0x6C1A90
struct /* @anon3 */ {
    // total size: 0xA8
} __vt__14clsWallObj_Obj; // size: 0xA8, address: 0x6C19E0
struct /* @anon0 */ {
    // total size: 0x44
...
void * __ct(class clsWallObj_Obj *); // size: 0x0, address: 0x3CFA20
class clsWallObj_Task * m_tpcSingleton; // size: 0x4, address: 0xB163C0
struct /* @anon12 */ {
    // total size: 0xC
} __vt__31clsSingleton<15clsWallObj_Task>; // size: 0xC, address: 0x6C1978
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x682550
...
class clsWallObj_Task : public clsBaseGimmickBody {
    // total size: 0x94
};
class NNS_TRS {
    // total size: 0x30
...
class clsWallObjThrCol : public clsBaseThroughCollision {
    // total size: 0xC
public:
    class clsWallObj_Obj * m_pcWallObj; // offset 0x8, size 0x4
};
class clsPathBase {
    // total size: 0x8
public:
...
class clsWallObj_Obj : public clsRigidBodyGimmickObj {
    // total size: 0xF0
public:
    class clsWallObjThrCol m_cThrCol; // offset 0xD0, size 0xC
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsWallObj_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x3CF590 -> 0x3CF698
void draw(class clsWallObj_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CF590 -> 0x3CF698
...
// Range: 0x3CF6A0 -> 0x3CF748
void execute(class clsWallObj_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CF6A0 -> 0x3CF748
        unsigned int u32Num; // r2
...
// Range: 0x3CF750 -> 0x3CF75C
void createModel(class clsWallObj_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CF750 -> 0x3CF75C
    }
...
// Range: 0x3CF760 -> 0x3CF890
void * __ct(class clsWallObj_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CF760 -> 0x3CF890
    }
...
// Range: 0x3CFBF0 -> 0x3CFC58
void destroyData(class clsWallObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CFBF0 -> 0x3CFC58
    }
...
// Range: 0x3CFC60 -> 0x3D0068
void createData(class clsWallObj_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3CFC60 -> 0x3D0068
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0xB0
        unsigned int u32collisionFilter; // r17
        class hkVector4 cBox; // r29+0xA0
    }
}


// Range: 0x3D0070 -> 0x3D0078
...
// Range: 0x3D0080 -> 0x3D0198
void contactTriggerEvent(class clsWallObj_Obj * this /* r19 */, class hkContactPoint * pcContact /* r18 */, class clsObject * pcObject /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D0080 -> 0x3D0198
        float sMtx[4][4]; // r29+0xE0
        float sMtx2[4][4]; // r29+0xA0
        float sInvMtx[4][4]; // r29+0x60
        class NNS_VECTORFAST sLocalVecFast; // r29+0x50
    }
}


// Range: 0x3D01A0 -> 0x3D01A8
void main() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D01A0 -> 0x3D01A8
...
// Range: 0x3D01B0 -> 0x3D0240
void contactRemoveEvent(class clsWallObjThrCol * this /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D01B0 -> 0x3D0240
    }
...
// Range: 0x3D0240 -> 0x3D02C4
void contactTriggerEvent(class clsWallObjThrCol * this /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3D0240 -> 0x3D02C4
    }
