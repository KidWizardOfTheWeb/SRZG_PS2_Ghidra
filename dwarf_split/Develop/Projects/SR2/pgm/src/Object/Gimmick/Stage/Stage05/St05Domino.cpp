/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage05\St05Domino.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32ClipSqDist; // size: 0x4, address: 0x687540
unsigned char t_u8DownCount; // size: 0x1, address: 0xB17210
class NNS_VECTOR m_tosThroughColPosVec[4]; // size: 0x30, address: 0x687550
struct /* @anon2 */ {
    // total size: 0xA8
} __vt__13clsDomino_Obj; // size: 0xA8, address: 0x6C46E0
struct /* @anon16 */ {
    // total size: 0xA8
...
void * __dt(class clsDominoThroughCol *, signed short); // size: 0x0, address: 0x43BA80
void * __ct(class clsDominoThroughCol *); // size: 0x0, address: 0x43BB10
struct /* @anon9 */ {
    // total size: 0x48
} __vt__14clsDomino_Task; // size: 0x48, address: 0x6C47F0
struct /* @anon18 */ {
    // total size: 0x48
} __vt__81clsSingleModelGimmick_Task<14clsDomino_Task,13clsDomino_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C4840
void * __dt(class clsDomino_Obj *, signed short); // size: 0x0, address: 0x43ACE0
struct /* @anon6 */ {
    // total size: 0x48
} __vt__73clsBaseGimmickBody<14clsDomino_Task,13clsDomino_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C47A0
struct /* @anon17 */ {
    // total size: 0x30
...
class clsDomino_Task * m_tpcSingleton; // size: 0x4, address: 0xB17218
struct /* @anon5 */ {
    // total size: 0xC
} __vt__30clsSingleton<14clsDomino_Task>; // size: 0xC, address: 0x6C4788
struct /* @anon19 */ {
    // total size: 0x28
...
struct /* @anon11 */ {
    // total size: 0x34
} __vt__19clsDominoThroughCol; // size: 0x34, address: 0x6C4890
void * __ct(class clsDomino_Obj *); // size: 0x0, address: 0x43BD00
...
class clsDominoThroughCol : public clsBaseThroughCollision {
    // total size: 0x14
public:
    class clsDomino_Obj * m_pcObj[2]; // offset 0x8, size 0x8
    unsigned char m_u8RegistNum; // offset 0x10, size 0x1
};
...
class clsDomino_Task : public clsSingleModelGimmick_Task {
    // total size: 0xF0
public:
    class clsDominoThroughCol m_acThroughCol[4]; // offset 0x94, size 0x50
    class hkShape * m_pcThroghShape; // offset 0xE4, size 0x4
    class hkShape * m_pcShape; // offset 0xE8, size 0x4
    class clsGimmickRigidBody * m_pcRigidBody; // offset 0xEC, size 0x4
};
enum enmSelectType {
    SELECT_NORMAL = 0,
...
public:
    ...
    signed int m_s32DrawRotY; // offset 0xD8, size 0x4
    unsigned int m_u32DrawFlg; // offset 0xDC, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsDomino_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x43ADE0 -> 0x43B140
void draw(class clsDomino_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43ADE0 -> 0x43B140
        ...
        float sMtxWork[4][4]; // r29+0x1A0
        unsigned int u32i; // r19
    }
}


// Range: 0x43B1E0 -> 0x43B4B8
void execute(class clsDomino_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43B1E0 -> 0x43B4B8
        unsigned int u32Num; // r2
...
// Range: 0x43B540 -> 0x43B60C
void setThroughObj(class clsDomino_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43B540 -> 0x43B60C
        unsigned int u32Num; // r2
        class clsDominoThroughCol * pcCollision; // r2
        unsigned int u32i; // r18
    }
}


// Range: 0x43B610 -> 0x43B688
void reset(class clsDomino_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43B610 -> 0x43B688
        unsigned int u32Num; // r2
...
// Range: 0x43B690 -> 0x43B774
void * __ct(class clsDomino_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43B690 -> 0x43B774
...
// Range: 0x43BDC0 -> 0x43BE38
void mainCrash(class clsDomino_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43BDC0 -> 0x43BE38
    }
...
// Range: 0x43BE40 -> 0x43BE60
void main(class clsDomino_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43BE40 -> 0x43BE60
    }
...
// Range: 0x43BE60 -> 0x43BF54
void contactInterraction(class clsDomino_Obj * this /* r17 */, class clsRigidBodyGimmickObj * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43BE60 -> 0x43BF54
    }
...
// Range: 0x43BF60 -> 0x43C0F8
void start(class clsDomino_Obj * this /* r18 */, class NNS_VECTORFAST & rsLocalFoceVecFast /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43BF60 -> 0x43C0F8
        float sMtx[4][4]; // r29+0x90
        class NNS_VECTORFAST sFoceFast; // r29+0x80
        class hkVector4 cPoint; // r29+0x70
    }
}


// Range: 0x43C100 -> 0x43C210
void requestDrawContactEffect(class clsDomino_Obj * this /* r16 */, class hkContactPoint * pcContact /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43C100 -> 0x43C210
        class NNS_VECTORFAST sContactVecFast; // r29+0x20
    }
}


// Range: 0x43C210 -> 0x43C24C
void requestDrawBreakEffect(class clsDomino_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43C210 -> 0x43C24C
    }
...
// Range: 0x43C250 -> 0x43C2B0
void destroyData(class clsDomino_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43C250 -> 0x43C2B0
    }
...
// Range: 0x43C2B0 -> 0x43C634
void createData(class clsDomino_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43C2B0 -> 0x43C634
...
// Range: 0x43C640 -> 0x43C6D4
void setData(class clsDomino_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43C640 -> 0x43C6D4
...
// Range: 0x43C6E0 -> 0x43C7C4
void reset(class clsDomino_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43C6E0 -> 0x43C7C4
        class clsGimmickRigidBody * pcRigidBody; // r16
        class hkVector4 cZero; // r29+0x30
    }
}


// Range: 0x43C7D0 -> 0x43C87C
void contactAlwaysEvent(class clsDominoThroughCol * this /* r16 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43C7D0 -> 0x43C87C
        class NNS_VECTORFAST sLocalFoceVecFast; // r29+0x40
        class NNS_VECTORFAST sVelocityFast; // r29+0x30
        class clsDomino_Obj * * ppcObj; // r17
