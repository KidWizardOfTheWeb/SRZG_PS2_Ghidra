/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage13\St13Bridge.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x68B7F0
struct /* @anon13 */ {
    // total size: 0x48
} __vt__14clsBridge_Task; // size: 0x48, address: 0x6C9150
struct /* @anon0 */ {
    // total size: 0x48
} __vt__84clsSingleModelGimmick_Task<14clsBridge_Task,13clsBridge_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6C9200
struct /* @anon5 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsBridge_Task * m_tpcSingleton; // size: 0x4, address: 0xB17B48
struct /* @anon8 */ {
    // total size: 0xC
} __vt__30clsSingleton<14clsBridge_Task>; // size: 0xC, address: 0x6C9198
void * __dt(class clsBridge_Obj *, signed short); // size: 0x0, address: 0x4BF8B0
struct /* @anon11 */ {
    // total size: 0x48
} __vt__76clsBaseGimmickBody<14clsBridge_Task,13clsBridge_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6C91B0
struct /* @anon9 */ {
    // total size: 0x28
...
struct /* @anon2 */ {
    // total size: 0x48
} __vt__13clsBridge_Obj; // size: 0x48, address: 0x6C9250
...
void * __ct(class clsBridge_Obj *); // size: 0x0, address: 0x4C03D0
...
struct /* @anon6 */ {
    // total size: 0x34
} __vt__25clsBridgeThroughCollision; // size: 0x34, address: 0x6C92A0
struct /* @anon3 */ {
    // total size: 0xC
...
class clsBridge_Obj : public clsGimmickObj {
    // total size: 0xE0
public:
    enum enmBridgeMode m_eMode; // offset 0x50, size 0x4
    enum enmBridgeState m_eState; // offset 0x54, size 0x4
    class clsBridgeThroughCollision * m_pcCollision; // offset 0x58, size 0x4
    ...
    signed short m_s16Count; // offset 0x88, size 0x2
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x9C
public:
    class clsBridge_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsBridgeThroughCollision : public clsBaseThroughCollision {
    // total size: 0xC
public:
    class clsBridge_Obj * m_pcBridge; // offset 0x8, size 0x4
};
...
class clsBridge_Task : public clsSingleModelGimmick_Task {
    // total size: 0x9C
};
enum hkShapeType {
    HK_SHAPE_INVALID = 0,
...
// Range: 0x4BF940 -> 0x4BFBEC
void draw(class clsBridge_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BF940 -> 0x4BFBEC
...
// Range: 0x4BFC90 -> 0x4BFF3C
void execute(class clsBridge_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BFC90 -> 0x4BFF3C
        unsigned int u32Num; // r2
...
// Range: 0x4BFF90 -> 0x4C0000
void reset(class clsBridge_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BFF90 -> 0x4C0000
        unsigned int u32Num; // r2
...
// Range: 0x4C0000 -> 0x4C006C
void * __ct(class clsBridge_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C0000 -> 0x4C006C
    }
...
// Range: 0x4C04B0 -> 0x4C0558
unsigned char stepMotionFrame(class clsBridge_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C04B0 -> 0x4C0558
    }
...
// Range: 0x4C0560 -> 0x4C05E0
void destroyData(class clsBridge_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C0560 -> 0x4C05E0
    }
...
// Range: 0x4C0670 -> 0x4C07B4
void createData(class clsBridge_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C0670 -> 0x4C07B4
...
// Range: 0x4C07D0 -> 0x4C07F0
void reset(class clsBridge_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C07D0 -> 0x4C07F0
    }
...
// Range: 0x4C07F0 -> 0x4C0804
void contactRemoveEvent(class clsBridgeThroughCollision * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C07F0 -> 0x4C0804
    }
...
// Range: 0x4C0810 -> 0x4C0824
void contactTriggerEvent(class clsBridgeThroughCollision * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C0810 -> 0x4C0824
    }
