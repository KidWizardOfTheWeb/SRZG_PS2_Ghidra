/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage13\St13Gate.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x68B7C8
struct /* @anon10 */ {
    // total size: 0x48
} __vt__12clsGate_Task; // size: 0x48, address: 0x6C8F60
struct /* @anon13 */ {
    // total size: 0x48
} __vt__77clsSingleModelGimmick_Task<12clsGate_Task,11clsGate_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C90C0
struct /* @anon9 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsGate_Task * m_tpcSingleton; // size: 0x4, address: 0xB17B40
struct /* @anon1 */ {
    // total size: 0xC
} __vt__28clsSingleton<12clsGate_Task>; // size: 0xC, address: 0x6C9058
void * __dt(class clsGate_Obj *, signed short); // size: 0x0, address: 0x4BD920
struct /* @anon6 */ {
    // total size: 0x48
} __vt__69clsBaseGimmickBody<12clsGate_Task,11clsGate_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C9070
struct /* @anon17 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon23 */ {
    // total size: 0xA8
} __vt__11clsGate_Obj; // size: 0xA8, address: 0x6C8FB0
struct /* @anon16 */ {
    // total size: 0x28
...
void * __ct(class clsGate_Obj *); // size: 0x0, address: 0x4BE310
...
struct /* @anon7 */ {
    // total size: 0x34
} __vt__23clsGateThroughCollision; // size: 0x34, address: 0x6C9110
struct /* @anon2 */ {
    // total size: 0xC
...
class clsGateThroughCollision : public clsBaseThroughCollision {
    // total size: 0xC
public:
    class clsGate_Obj * m_pcGate; // offset 0x8, size 0x4
};
...
public:
    ...
    class clsGateThroughCollision * m_pcCollision; // offset 0xD4, size 0x4
    ...
    float m_f32MovePos; // offset 0xF0, size 0x4
    ...
    signed short m_s16HitCount; // offset 0x130, size 0x2
    class clsPlayerTask * m_pcPlayerTask[8]; // offset 0x134, size 0x20
    float m_f32WaitFrame; // offset 0x154, size 0x4
    float m_f32EffectFrame; // offset 0x158, size 0x4
    class NNS_VECTORFAST m_sInitPosVecFast; // offset 0x160, size 0x10
    float m_f32Scale; // offset 0x170, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0x174, size 0x4
};
...
class clsGate_Task : public clsSingleModelGimmick_Task {
    // total size: 0x9C
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsGate_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x4BDA20 -> 0x4BDD10
void draw(class clsGate_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BDA20 -> 0x4BDD10
...
// Range: 0x4BDDB0 -> 0x4BDEE0
void execute(class clsGate_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BDDB0 -> 0x4BDEE0
...
// Range: 0x4BDEE0 -> 0x4BDF50
void reset(class clsGate_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BDEE0 -> 0x4BDF50
        unsigned int u32Num; // r2
...
// Range: 0x4BDF50 -> 0x4BDFBC
void * __ct(class clsGate_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BDF50 -> 0x4BDFBC
    }
...
// Range: 0x4BE3D0 -> 0x4BE4C8
void destroyData(class clsGate_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BE3D0 -> 0x4BE4C8
    }
...
// Range: 0x4BE560 -> 0x4BEC74
void createData(class clsGate_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BE560 -> 0x4BEC74
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0xD0
        class hkVector4 cVec; // r29+0xC0
        ...
        char __FUNCTION__[14]; // @ 0x0068B7B8
    }
}


// Range: 0x4BEC80 -> 0x4BECD4
void setData(class clsGate_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BEC80 -> 0x4BECD4
    }
...
// Range: 0x4BECE0 -> 0x4BF230
void main(class clsGate_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BECE0 -> 0x4BF230
    }
...
// Range: 0x4BF250 -> 0x4BF2C4
void init(class clsGate_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BF250 -> 0x4BF2C4
    }
...
// Range: 0x4BF2D0 -> 0x4BF3BC
void reset(class clsGate_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BF2D0 -> 0x4BF3BC
...
// Range: 0x4BF3C0 -> 0x4BF3D4
void contactRemoveEvent(class clsGateThroughCollision * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BF3C0 -> 0x4BF3D4
    }
...
// Range: 0x4BF3E0 -> 0x4BF420
void contactAlwaysEvent(class clsGateThroughCollision * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4BF3E0 -> 0x4BF420
    }
