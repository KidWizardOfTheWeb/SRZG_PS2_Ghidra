/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage07\St07MapPartsFloorChange.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x692650
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x692658
struct /* @anon2 */ {
    // total size: 0x48
} __vt__27clsMapPartsFloorChange_Task; // size: 0x48, address: 0x6CB3D0
struct /* @anon10 */ {
    // total size: 0x48
} __vt__113clsSingleModelGimmick_Task<27clsMapPartsFloorChange_Task,29clsMapPartsFloorChange_Object,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6CB480
struct /* @anon3 */ {
    // total size: 0x38
...
struct /* @anon0 */ {
    // total size: 0xC
} __vt__43clsSingleton<27clsMapPartsFloorChange_Task>; // size: 0xC, address: 0x6CB418
void * __dt(class clsMapPartsFloorChange_Object *, signed short); // size: 0x0, address: 0x4F3BC0
struct /* @anon4 */ {
    // total size: 0x48
} __vt__105clsBaseGimmickBody<27clsMapPartsFloorChange_Task,29clsMapPartsFloorChange_Object,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6CB430
struct /* @anon7 */ {
    // total size: 0xA8
} __vt__29clsMapPartsFloorChange_Object; // size: 0xA8, address: 0x6CB4D0
...
void * __ct(class clsMapPartsFloorChange_Object *); // size: 0x0, address: 0x4F4520
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x6926D0
...
// Range: 0x4F3C40 -> 0x4F3EFC
void draw(class clsMapPartsFloorChange_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F3C40 -> 0x4F3EFC
        unsigned int u32Num; // r2
        float (* opaNnViewMtx)[4][4]; // r23
        class clsModelType_OB_TX_MO & rcModel; // r20
...
// Range: 0x4F3FA0 -> 0x4F4080
void execute(class clsMapPartsFloorChange_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F3FA0 -> 0x4F4080
        unsigned int u32Num; // r2
...
// Range: 0x4F4080 -> 0x4F40F0
void reset(class clsMapPartsFloorChange_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F4080 -> 0x4F40F0
        unsigned int u32Num; // r2
...
// Range: 0x4F40F0 -> 0x4F41C0
void * __ct(class clsMapPartsFloorChange_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F40F0 -> 0x4F41C0
...
// Range: 0x4F4570 -> 0x4F45D0
void destroyData(class clsMapPartsFloorChange_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F4570 -> 0x4F45D0
    }
...
// Range: 0x4F45D0 -> 0x4F47B0
unsigned char set_Kicker(class clsMapPartsFloorChange_Object * this /* r16 */, float f32Num /* r29+0x60 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F45D0 -> 0x4F47B0
...
// Range: 0x4F47B0 -> 0x4F4828
unsigned char checkObj_Reverse(class clsMapPartsFloorChange_Object * this /* r2 */, float f32Num /* r29+0x10 */, unsigned char bPowerFlag /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F47B0 -> 0x4F4828
    }
...
// Range: 0x4F4830 -> 0x4F48D4
unsigned char checkObj(class clsMapPartsFloorChange_Object * this /* r16 */, float f32Num /* r29+0x20 */, unsigned char bPowerFlag /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F4830 -> 0x4F48D4
    }
...
// Range: 0x4F48E0 -> 0x4F4A7C
void reset(class clsMapPartsFloorChange_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F48E0 -> 0x4F4A7C
        class hkVector4 cVec; // r29+0x70
    }
}


// Range: 0x4F4A80 -> 0x4F4D84
void createData(class clsMapPartsFloorChange_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F4A80 -> 0x4F4D84
        class NNS_QUATERNION orsRot; // r29+0x90
        class NNS_QUATERNION orsRotNew; // r29+0x80
        class hkQuaternion cRotQuat; // r29+0x70
        class hkQuaternion cRotQuatNew; // r29+0x60
        class hkVector4 cAngle; // r29+0x50
...
// Range: 0x4F4D90 -> 0x4F4EC8
void StepMotionFrame(class clsMapPartsFloorChange_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F4D90 -> 0x4F4EC8
        float f32EndFrame; // r29+0xA0
        float psMtxWork[4][4]; // r29+0x60
        class NNS_MOTION * psMotion; // r18
...
// Range: 0x4F4ED0 -> 0x4F5060
void execute(class clsMapPartsFloorChange_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F4ED0 -> 0x4F5060
        class NNS_VECTORFAST rsPosVecFast; // r29+0x50
        class NNS_QUATERNION quat; // r29+0x40
