/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\SurvivalBall\SurvivalPole.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x687AE0
struct /* @anon5 */ {
    // total size: 0x48
} __vt__24clsSurvivalBallPole_Task; // size: 0x48, address: 0x6C5550
struct /* @anon0 */ {
    // total size: 0x48
} __vt__107clsSingleModelGimmick_Task<24clsSurvivalBallPole_Task,23clsSurvivalBallPole_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C5600
struct /* @anon7 */ {
    // total size: 0x38
...
struct /* @anon6 */ {
    // total size: 0xC
} __vt__40clsSingleton<24clsSurvivalBallPole_Task>; // size: 0xC, address: 0x6C5598
void * __dt(class clsSurvivalBallPole_Obj *, signed short); // size: 0x0, address: 0x44E1B0
struct /* @anon14 */ {
    // total size: 0x48
} __vt__99clsBaseGimmickBody<24clsSurvivalBallPole_Task,23clsSurvivalBallPole_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C55B0
struct /* @anon15 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon1 */ {
    // total size: 0xA8
} __vt__23clsSurvivalBallPole_Obj; // size: 0xA8, address: 0x6C5650
struct /* @anon12 */ {
    // total size: 0x28
...
void * __ct(class clsSurvivalBallPole_Obj *); // size: 0x0, address: 0x44F390
...
// Range: 0x44E2B0 -> 0x44E43C
void draw(class clsSurvivalBallPole_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44E2B0 -> 0x44E43C
...
// Range: 0x44E440 -> 0x44E5A0
void execute(class clsSurvivalBallPole_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44E440 -> 0x44E5A0
        unsigned int u32Num; // r2
...
// Range: 0x44E5A0 -> 0x44E610
void reset(class clsSurvivalBallPole_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44E5A0 -> 0x44E610
        unsigned int u32Num; // r2
...
// Range: 0x44E610 -> 0x44E71C
void * __ct(class clsSurvivalBallPole_Task * this /* r19 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44E610 -> 0x44E71C
        class hkVector4 cVec[2]; // r29+0x50
        signed int s32i; // r18
    }
}


// Range: 0x44EA90 -> 0x44ED88
void draw(class clsSurvivalBallPole_Obj * this /* r20 */, class clsModelType_OB_TX_MO_MA & rcModel /* r19 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r23 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44EA90 -> 0x44ED88
    }
...
// Range: 0x44ED90 -> 0x44EDC0
void mainCrash(class clsSurvivalBallPole_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44ED90 -> 0x44EDC0
    }
...
// Range: 0x44EDC0 -> 0x44EE20
void main(class clsSurvivalBallPole_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44EDC0 -> 0x44EE20
    }
...
// Range: 0x44EE20 -> 0x44EE54
void requestDrawBreakEffect(class clsSurvivalBallPole_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44EE20 -> 0x44EE54
    }
...
// Range: 0x44EE60 -> 0x44EEA8
void requestDrawContactEffect(class clsSurvivalBallPole_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44EE60 -> 0x44EEA8
    }
...
// Range: 0x44EEB0 -> 0x44EF5C
void reset(class clsSurvivalBallPole_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44EEB0 -> 0x44EF5C
    }
...
// Range: 0x44EF60 -> 0x44EFC0
void destroyData(class clsSurvivalBallPole_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44EF60 -> 0x44EFC0
    }
...
// Range: 0x44EFC0 -> 0x44F38C
void createData(class clsSurvivalBallPole_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44EFC0 -> 0x44F38C
...
// Range: 0x44F390 -> 0x44F454
void * __ct(class clsSurvivalBallPole_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44F390 -> 0x44F454
    }
...
// Range: 0x44F460 -> 0x44F4C4
void init(class clsSurvivalBallPole_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44F460 -> 0x44F4C4
    }
