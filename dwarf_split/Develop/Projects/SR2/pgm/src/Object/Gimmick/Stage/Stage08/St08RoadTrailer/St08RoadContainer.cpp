/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage08\St08RoadTrailer\St08RoadContainer.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTORFAST t_sOffsetVecFast; // size: 0x10, address: 0x695F30
float m_tof32ClipSqDist; // size: 0x4, address: 0x695F40
class NNS_VECTOR t_osCollisionHalfSizeVec; // size: 0xC, address: 0x695F48
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x695F60
...
// Range: 0x529F10 -> 0x52A194
void draw(class clsRoadContainer_Obj * this /* r20 */, class clsModelType_OB_TX & rcObj /* r19 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r21 */, float (* opaNnViewMtx)[4][4] /* r17 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x529F10 -> 0x52A194
    }
...
// Range: 0x52A1A0 -> 0x52A45C
void main(class clsRoadContainer_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52A1A0 -> 0x52A45C
        float sMtx[4][4]; // r29+0x3B0
        class NNS_VECTORFAST sNextPosVecFast; // r29+0x3A0
        class NNS_VECTORFAST sVelocityFast; // r29+0x390
        class clsRoadTrailer_Obj * pcObj; // r2
        class hkVector4 cVelocity; // r29+0x380
        float & rf32Frame; // r2
    }
}


// Range: 0x52A460 -> 0x52A470
void setMove(class clsRoadContainer_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52A460 -> 0x52A470
    }
...
// Range: 0x52A470 -> 0x52A480
void setStop(class clsRoadContainer_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52A470 -> 0x52A480
    }
...
void drawEffect(class clsPlayerTask * pcPlayer /* r16 */) {
    ...
    /* anonymous block */ {
        ...
        class NNS_VECTOR LOCAL_POS_R; // @ 0x00696008
        class NNS_VECTOR LOCAL_POS; // @ 0x00695FF8
        class NNS_VECTOR RAND_SP; // @ 0x00695FE8
        float LIFE_FRAME; // @ 0x00696018
        class NNS_VECTOR BEGIN_SP; // @ 0x00695FD8
    }
}


// Range: 0x52A5A0 -> 0x52A5F8
void requestDrawContactEffect(class clsRoadContainer_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52A5A0 -> 0x52A5F8
    }
...
// Range: 0x52A600 -> 0x52A63C
void requestDrawBreakEffect(class clsRoadContainer_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52A600 -> 0x52A63C
    }
...
// Range: 0x52A640 -> 0x52A6CC
void destroyData(class clsRoadContainer_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52A640 -> 0x52A6CC
    }
...
// Range: 0x52A6D0 -> 0x52AB38
void createData(class clsRoadContainer_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52A6D0 -> 0x52AB38
...
// Range: 0x52AB40 -> 0x52AD10
void reset(class clsRoadContainer_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52AB40 -> 0x52AD10
