/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage13\St13Colossus.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x68A930
struct /* @anon0 */ {
    // total size: 0x48
} __vt__16clsColossus_Task; // size: 0x48, address: 0x6C8510
struct /* @anon9 */ {
    // total size: 0x48
} __vt__85clsSingleModelGimmick_Task<16clsColossus_Task,15clsColossus_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C85C0
struct /* @anon8 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsColossus_Task * m_tpcSingleton; // size: 0x4, address: 0xB17AC8
struct /* @anon19 */ {
    // total size: 0xC
} __vt__32clsSingleton<16clsColossus_Task>; // size: 0xC, address: 0x6C8558
void * __dt(class clsColossus_Obj *, signed short); // size: 0x0, address: 0x4A5710
struct /* @anon5 */ {
    // total size: 0x48
} __vt__77clsBaseGimmickBody<16clsColossus_Task,15clsColossus_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C8570
struct /* @anon14 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon7 */ {
    // total size: 0xA8
} __vt__15clsColossus_Obj; // size: 0xA8, address: 0x6C8610
struct /* @anon15 */ {
    // total size: 0x28
...
void * __ct(class clsColossus_Obj *); // size: 0x0, address: 0x4A6150
...
class clsColossus_Obj : public clsRigidBodyGimmickObj {
    // total size: 0xE0
public:
    enum enmColossusMode m_eMode; // offset 0xD0, size 0x4
...
class clsColossus_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
class clsSingleton {
    // total size: 0x4
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsColossus_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x4A5810 -> 0x4A5AEC
void draw(class clsColossus_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A5810 -> 0x4A5AEC
...
// Range: 0x4A5B90 -> 0x4A5CD0
void execute(class clsColossus_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A5B90 -> 0x4A5CD0
...
// Range: 0x4A5CD0 -> 0x4A5D40
void reset(class clsColossus_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A5CD0 -> 0x4A5D40
        unsigned int u32Num; // r2
...
// Range: 0x4A5D40 -> 0x4A5DFC
void * __ct(class clsColossus_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A5D40 -> 0x4A5DFC
...
// Range: 0x4A6220 -> 0x4A62D4
void destroyData(class clsColossus_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A6220 -> 0x4A62D4
    }
...
// Range: 0x4A62E0 -> 0x4A6930
void createData(class clsColossus_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A62E0 -> 0x4A6930
        ...
        char __FUNCTION__[14]; // @ 0x0068A920
    }
}


// Range: 0x4A6930 -> 0x4A6970
void setData(class clsColossus_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A6930 -> 0x4A6970
    }
...
// Range: 0x4A6970 -> 0x4A69C4
void requestDrawBreakEffect(class clsColossus_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A6970 -> 0x4A69C4
    }
...
// Range: 0x4A69D0 -> 0x4A6A5C
void main(class clsColossus_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A69D0 -> 0x4A6A5C
    }
...
// Range: 0x4A6A60 -> 0x4A6AD0
void reset(class clsColossus_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A6A60 -> 0x4A6AD0
    }
