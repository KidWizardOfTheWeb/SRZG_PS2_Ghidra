/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Control\Gravity\GravitySurvivalBallControl.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class clsPfSystem * m_tpcSingleton; // size: 0x4, address: 0x6E69B8
class clsHavok * m_tpcSingleton; // size: 0x4, address: 0x707E60
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x688A70
...
// Range: 0x472720 -> 0x4727CC
void gctrlMove(class clsGravitySurvivalBallControl * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x472720 -> 0x4727CC
    }
...
// Range: 0x4727D0 -> 0x47281C
void gctrlFloat(class clsGravitySurvivalBallControl * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4727D0 -> 0x47281C
    }
...
// Range: 0x472820 -> 0x47290C
void gctrlRise(class clsGravitySurvivalBallControl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x472820 -> 0x47290C
    }
...
// Range: 0x472910 -> 0x472948
void gctrlInit(class clsGravitySurvivalBallControl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x472910 -> 0x472948
    }
...
// Range: 0x472950 -> 0x472EC8
void adjustDirection(class clsGravitySurvivalBallControl * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x472950 -> 0x472EC8
        float sTrsMtx[4][4]; // r29+0x180
        float sInvMtx[4][4]; // r29+0x140
        class NNS_VECTORFAST sPosVecFast; // r29+0x130
        class NNS_VECTORFAST sLocalVecFast; // r29+0x120
        class hkVector4 cSpeed; // r29+0x110
        class clsGravityControl * pcGravityControl; // r2
        float f32Rad; // r20
        class NNS_VECTORFAST sAxisVecFast; // r29+0x100
        float sRotMtx[4][4]; // r29+0xC0
        class NNS_VECTORFAST sTargetVecFast; // r29+0xB0
        class NNS_VECTORFAST sForceVecFast; // r29+0xA0
        class NNS_VECTORFAST sDirVecFast; // r29+0x90
        float f32Length; // r29+0x1C0
        float f32Dist; // r21
        float f32Sign; // r20
    }
}
