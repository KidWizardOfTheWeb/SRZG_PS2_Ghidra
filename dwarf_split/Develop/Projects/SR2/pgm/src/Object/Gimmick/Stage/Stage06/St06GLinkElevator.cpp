/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage06\St06GLinkElevator.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class NNS_VECTORFAST toasPointVecFast[14][2]; // size: 0x1C0, address: 0x688B80
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x688D40
float tof32ClipSqDist; // size: 0x4, address: 0x688D50
class clsGravityGimmickParam t_ocSt6GravityGimmickParam; // size: 0x78, address: 0x688D60
class clsGravityGimmickParam t_ocSt14GravityGimmickParam; // size: 0x78, address: 0x688DE0
struct /* @anon19 */ {
    // total size: 0x48
} __vt__21clsGLinkElevator_Task; // size: 0x48, address: 0x6C72B0
struct /* @anon2 */ {
    // total size: 0x48
} __vt__98clsSingleModelGimmick_Task<21clsGLinkElevator_Task,23clsGLinkElevator_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C7420
struct /* @anon6 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsGLinkElevator_Task * m_tpcSingleton; // size: 0x4, address: 0xB174D8
struct /* @anon8 */ {
    // total size: 0xC
} __vt__37clsSingleton<21clsGLinkElevator_Task>; // size: 0xC, address: 0x6C73B8
void * __dt(class clsGLinkElevator_Object *, signed short); // size: 0x0, address: 0x4772B0
struct /* @anon17 */ {
    // total size: 0x48
} __vt__90clsBaseGimmickBody<21clsGLinkElevator_Task,23clsGLinkElevator_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C73D0
struct /* @anon20 */ {
    // total size: 0xB4
} __vt__24clsBaseGravityLinkObject; // size: 0xB4, address: 0x6C1420
struct /* @anon5 */ {
    // total size: 0xB8
} __vt__23clsGLinkElevator_Object; // size: 0xB8, address: 0x6C7300
struct /* @anon10 */ {
    // total size: 0x28
...
void * __ct(class clsGLinkElevator_Object *); // size: 0x0, address: 0x478010
...
public:
    ...
    enum enmMoveMode m_eMoveMode; // offset 0xE4, size 0x4
    enum enmMoveDir m_enmMoveDir; // offset 0xE8, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0xEC, size 0x4
    class clsTask * m_pcEffectTask; // offset 0xF0, size 0x4
    float m_f32Speed; // offset 0xF4, size 0x4
    float m_f32DefaultWaitFrame; // offset 0xF8, size 0x4
    float m_f32DefaultMoveFrame; // offset 0xFC, size 0x4
    float m_f32WaitFrame; // offset 0x100, size 0x4
    signed int m_s32TableNo; // offset 0x104, size 0x4
    unsigned char m_bSeFlag; // offset 0x108, size 0x1
    unsigned char m_bFilterChange; // offset 0x109, size 0x1
};
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsGLinkElevator_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsGLinkElevator_Task : public clsSingleModelGimmick_Task {
    // total size: 0x98
public:
...
// Range: 0x477350 -> 0x477684
void draw(class clsGLinkElevator_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x477350 -> 0x477684
        ...
        float sMtxWork[4][4]; // r29+0xE0
        unsigned int u32i; // r20
    }
}


// Range: 0x477730 -> 0x477AB8
void execute(class clsGLinkElevator_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x477730 -> 0x477AB8
        unsigned int u32Num; // r2
...
// Range: 0x477B20 -> 0x477B9C
void reset(class clsGLinkElevator_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x477B20 -> 0x477B9C
        unsigned int u32Num; // r2
...
// Range: 0x477BA0 -> 0x477CBC
void * __ct(class clsGLinkElevator_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x477BA0 -> 0x477CBC
...
// Range: 0x478080 -> 0x478120
void destroyData(class clsGLinkElevator_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x478080 -> 0x478120
    }
...
// Range: 0x478120 -> 0x47871C
void createData(class clsGLinkElevator_Object * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x478120 -> 0x47871C
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0xE0
        class hkMassProperties massProperties; // r29+0x90
        class clsGrindLinkControl * pcGravityControl; // r18
        unsigned int oau32Se[2][4]; // r29+0x70
        unsigned int * pau32Se; // r2
    }
}


// Range: 0x478720 -> 0x47877C
void setData(class clsGLinkElevator_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x478720 -> 0x47877C
    }
...
void drawEffect(class clsPlayerTask * pcPlayer /* r16 */) {
    ...
    /* anonymous block */ {
        ...
        class NNS_VECTOR LOCAL_POS_R; // @ 0x00688E88
        class NNS_VECTOR LOCAL_POS; // @ 0x00688E78
        class NNS_VECTOR RAND_SP; // @ 0x00688E68
        float LIFE_FRAME; // @ 0x00688E98
        class NNS_VECTOR BEGIN_SP; // @ 0x00688E58
    }
}


// Range: 0x4788A0 -> 0x4788FC
void requestDrawBreakEffect(class clsGLinkElevator_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4788A0 -> 0x4788FC
    }
...
// Range: 0x478900 -> 0x478964
void mainCrash(class clsGLinkElevator_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x478900 -> 0x478964
    }
...
// Range: 0x478970 -> 0x478AB0
void mainGravity(class clsGLinkElevator_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x478970 -> 0x478AB0
    }
...
// Range: 0x478AB0 -> 0x478C40
void main(class clsGLinkElevator_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x478AB0 -> 0x478C40
        class NNS_VECTORFAST sPosVecFast; // r29+0x50
    }
}


// Range: 0x478C40 -> 0x478F64
void reset(class clsGLinkElevator_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x478C40 -> 0x478F64
        class clsRigidBody * pcRigidBody; // r16
        class hkVector4 cZero; // r29+0x90
        class NNS_VECTORFAST sVecFast; // r29+0x80
        class hkVector4 cVelocity; // r29+0x70
        float f32MoveDir; // r20
    }
}


// Range: 0x478F80 -> 0x478FC0
void callbackContactTriggerRigidBody(class clsGLinkElevator_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x478F80 -> 0x478FC0
    }
...
// Range: 0x478FC0 -> 0x479040
void callbackGravityEvent(class clsGLinkElevator_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x478FC0 -> 0x479040
    }
