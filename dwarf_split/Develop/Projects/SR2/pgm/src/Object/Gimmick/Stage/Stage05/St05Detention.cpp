/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage05\St05Detention.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32ClipSqDist; // size: 0x4, address: 0x687AA8
struct /* @anon16 */ {
    // total size: 0x48
} __vt__17clsDetention_Task; // size: 0x48, address: 0x6C5330
void * __dt(class clsDetention_Obj *, signed short); // size: 0x0, address: 0x44C9F0
struct /* @anon0 */ {
    // total size: 0x48
} __vt__79clsBaseGimmickBody<17clsDetention_Task,16clsDetention_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C5390
struct /* @anon14 */ {
    // total size: 0x30
...
struct /* @anon5 */ {
    // total size: 0x34
} __vt__22clsDetentionThroughCol; // size: 0x34, address: 0x6C5490
struct /* @anon2 */ {
    // total size: 0xA8
} __vt__16clsDetention_Obj; // size: 0xA8, address: 0x6C53E0
struct /* @anon1 */ {
    // total size: 0x44
...
void * __ct(class clsDetention_Obj *); // size: 0x0, address: 0x44D480
class clsDetention_Task * m_tpcSingleton; // size: 0x4, address: 0xB173C0
struct /* @anon17 */ {
    // total size: 0xC
} __vt__33clsSingleton<17clsDetention_Task>; // size: 0xC, address: 0x6C5378
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
class clsPfSystem * m_tpcSingleton; // size: 0x4, address: 0x6E69B8
class NNS_VECTORFAST tosXVecFast; // size: 0x10, address: 0x687AD0
...
class clsDetention_Task : public clsBaseGimmickBody {
    // total size: 0x94
};
class __vector_imp : private __vector_pod, private compile_assert {
    // total size: 0xC
...
public:
    ...
    class clsDetentionThroughCol m_cThroughCol; // offset 0xD4, size 0xC
};
...
class clsDetentionThroughCol : public clsBaseThroughCollision {
    // total size: 0xC
public:
    class clsDetention_Obj * m_pcObj; // offset 0x8, size 0x4
};
class __vector_imp : private __vector_pod, private compile_assert {
    // total size: 0xC
};
...
public:
    ...
    unsigned int m_u32DrawFlg; // offset 0xD8, size 0x4
};
class clsLap {
    // total size: 0x40
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsDetention_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB_TX m_cModel; // offset 0x88, size 0x8
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0x90, size 0x4
...
// Range: 0x44CB40 -> 0x44CF20
void draw(class clsDetention_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44CB40 -> 0x44CF20
...
// Range: 0x44D000 -> 0x44D0E8
void execute(class clsDetention_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44D000 -> 0x44D0E8
        unsigned int u32Num; // r2
...
// Range: 0x44D0F0 -> 0x44D160
void reset(class clsDetention_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44D0F0 -> 0x44D160
        unsigned int u32Num; // r2
...
// Range: 0x44D160 -> 0x44D2E4
void * __ct(class clsDetention_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44D160 -> 0x44D2E4
...
// Range: 0x44D640 -> 0x44D690
void main(class clsDetention_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44D640 -> 0x44D690
    }
...
// Range: 0x44D690 -> 0x44D828
void start(class clsDetention_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44D690 -> 0x44D828
        float sMtx[4][4]; // r29+0x80
        class NNS_VECTORFAST sFoceFast; // r29+0x70
        class hkVector4 cPoint; // r29+0x60
    }
}


// Range: 0x44D830 -> 0x44D83C
void requestDrawBreakEffect(class clsDetention_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44D830 -> 0x44D83C
    }
...
// Range: 0x44D850 -> 0x44D898
void destroyData(class clsDetention_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44D850 -> 0x44D898
    }
...
// Range: 0x44D8A0 -> 0x44DC84
void createData(class clsDetention_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44D8A0 -> 0x44DC84
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0x130
        class hkMassProperties massProperties; // r29+0xE0
        class hkVector4 cOffset; // r29+0xD0
...
// Range: 0x44DC90 -> 0x44DCF0
void setData(class clsDetention_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44DC90 -> 0x44DCF0
...
// Range: 0x44DCF0 -> 0x44DDA8
void reset(class clsDetention_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44DCF0 -> 0x44DDA8
...
// Range: 0x44DDC0 -> 0x44DDC8
void contactTriggerEvent(class clsDetentionThroughCol * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44DDC0 -> 0x44DDC8
    }
