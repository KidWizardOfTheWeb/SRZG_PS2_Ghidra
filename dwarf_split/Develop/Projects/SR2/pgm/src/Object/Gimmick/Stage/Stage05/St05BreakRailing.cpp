/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage05\St05BreakRailing.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon17 */ {
    // total size: 0x48
} __vt__20clsBreakRailing_Task; // size: 0x48, address: 0x6CF900
void * __dt(class clsBreakRailing_Obj *, signed short); // size: 0x0, address: 0x2CC630
struct /* @anon0 */ {
    // total size: 0x48
} __vt__82clsBaseGimmickBody<20clsBreakRailing_Task,19clsBreakRailing_Obj,15clsModelType_OB>; // size: 0x48, address: 0x6BA740
struct /* @anon14 */ {
    // total size: 0x30
...
struct /* @anon5 */ {
    // total size: 0x34
} __vt__21clsBreakRailingThrCol; // size: 0x34, address: 0x6CF950
struct /* @anon19 */ {
    // total size: 0xA8
} __vt__19clsBreakRailing_Obj; // size: 0xA8, address: 0x6BA680
struct /* @anon1 */ {
    // total size: 0x44
...
class clsBreakRailing_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A7E8
struct /* @anon16 */ {
    // total size: 0xC
} __vt__36clsSingleton<20clsBreakRailing_Task>; // size: 0xC, address: 0x6BA728
struct /* @anon21 */ {
    // total size: 0xC
...
public:
    ...
    class clsBreakRailingThrCol m_cThrCol; // offset 0xD4, size 0xC
    float m_sInvMtx[4][4]; // offset 0xE0, size 0x40
};
class clsPathBase {
    // total size: 0x8
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x90
public:
    class clsBreakRailing_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB m_cModel; // offset 0x88, size 0x4
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0x8C, size 0x4
};
...
class clsBreakRailing_Task : public clsBaseGimmickBody {
    // total size: 0x94
public:
    class stcInfo * m_psInfo; // offset 0x90, size 0x4
};
...
class clsBreakRailingThrCol : public clsBaseThroughCollision {
    // total size: 0xC
public:
    class clsBreakRailing_Obj * m_pcBreakRailingObj; // offset 0x8, size 0x4
};
enum enmAttackLR {
    TARGET_LEFT = 0,
    TARGET_RIGHT = 1,
...
// Range: 0x54A9A0 -> 0x54AA70
void draw(class clsBreakRailing_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54A9A0 -> 0x54AA70
    }
...
// Range: 0x54AA70 -> 0x54AB68
void execute(class clsBreakRailing_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54AA70 -> 0x54AB68
    }
...
// Range: 0x54AB70 -> 0x54AD90
void createModel(class clsBreakRailing_Task * this /* r19 */, class stcBinInfo & rsBinInfoI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54AB70 -> 0x54AD90
        void * opvColli; // r2
        ...
        class Subpart cPart; // r29+0x80
        class hkMoppCompilerInput mft; // r29+0x50
        class hkMoppCode * code; // r17
    }
}


// Range: 0x54AD90 -> 0x54AE00
void reset(class clsBreakRailing_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54AD90 -> 0x54AE00
...
// Range: 0x54AE00 -> 0x54AF50
void checkThrough(class clsBreakRailing_Obj * this /* r18 */, class clsPlayerTask * pcPlayerTask /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54AE00 -> 0x54AF50
        class NNS_VECTORFAST sLocalPosVecFast; // r29+0x50
    }
}


// Range: 0x54AF50 -> 0x54AF98
void destroyData(class clsBreakRailing_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54AF50 -> 0x54AF98
    }
...
// Range: 0x54AFA0 -> 0x54B088
void createData(class clsBreakRailing_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54AFA0 -> 0x54B088
    }
...
// Range: 0x54B090 -> 0x54B1A8
void setData(class clsBreakRailing_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54B090 -> 0x54B1A8
        float sMtx[4][4]; // r29+0x30
        class NNS_VECTOR & rcScaleVec; // r2
    }
}


// Range: 0x54B1B0 -> 0x54B1B8
void reset() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54B1B0 -> 0x54B1B8
...
// Range: 0x54B230 -> 0x54B23C
void contactAlwaysEvent(class clsBreakRailingThrCol * this /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54B230 -> 0x54B23C
    }
