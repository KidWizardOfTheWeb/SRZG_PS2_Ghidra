/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\HideKicker.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32ClipSqDist; // size: 0x4, address: 0x687C50
static class stcInfo toasGroundInfo[1]; // size: 0x10, address: 0x0
static class NNS_VECTOR toasBoxSize[1]; // size: 0xC, address: 0x687C58
static float toaf32Vertices[16]; // size: 0x40, address: 0x0
static float toaf32PlaneEquations[8][4]; // size: 0x80, address: 0x0
struct /* @anon17 */ {
    // total size: 0x48
} __vt__18clsHideKicker_Task; // size: 0x48, address: 0x6C5930
struct /* @anon3 */ {
    // total size: 0x48
} __vt__92clsSingleModelGimmick_Task<18clsHideKicker_Task,17clsHideKicker_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6C59E0
struct /* @anon5 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsHideKicker_Task * m_tpcSingleton; // size: 0x4, address: 0xB17408
struct /* @anon15 */ {
    // total size: 0xC
} __vt__34clsSingleton<18clsHideKicker_Task>; // size: 0xC, address: 0x6C5978
void * __dt(class clsHideKicker_Obj *, signed short); // size: 0x0, address: 0x452A70
struct /* @anon19 */ {
    // total size: 0x48
} __vt__84clsBaseGimmickBody<18clsHideKicker_Task,17clsHideKicker_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6C5990
struct /* @anon11 */ {
    // total size: 0xA8
...
struct /* @anon14 */ {
    // total size: 0x34
} __vt__23clsHideKickerThroughCol; // size: 0x34, address: 0x6C5AE0
struct /* @anon6 */ {
    // total size: 0xA8
} __vt__17clsHideKicker_Obj; // size: 0xA8, address: 0x6C5A30
struct /* @anon0 */ {
    // total size: 0x44
...
void * __ct(class clsHideKicker_Obj *); // size: 0x0, address: 0x4534F0
...
class NNS_VECTORFAST tosXVecFast; // size: 0x10, address: 0x687CA0
static unsigned int tobFix; // size: 0x4, address: 0x687C90
...
public:
    ...
    float m_f32RotSpeed; // offset 0xD8, size 0x4
    class hkShape * m_pcShape; // offset 0xDC, size 0x4
    class clsHideKickerThroughCol m_ThrougCol; // offset 0xE0, size 0xC
    float m_f32RotCount; // offset 0xEC, size 0x4
    class hkVector4 m_cOpenAngleVel; // offset 0xF0, size 0x10
    class hkVector4 m_cCloseAngleVel; // offset 0x100, size 0x10
    class hkQuaternion m_cMaxAngleQuat; // offset 0x110, size 0x10
    unsigned char m_bContact; // offset 0x120, size 0x1
    unsigned char m_bFix; // offset 0x121, size 0x1
};
class clsSingleton {
    // total size: 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x9C
public:
    class clsHideKicker_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsHideKicker_Task : public clsSingleModelGimmick_Task, public clsGimmickCommon {
    // total size: 0xA0
};
...
class clsHideKickerThroughCol : public clsBaseThroughCollision {
    // total size: 0xC
public:
    class clsHideKicker_Obj * m_pcObj; // offset 0x8, size 0x4
};
class hkPadSpu {
    // total size: 0x4
public:
...
// Range: 0x452BD0 -> 0x452EC4
void draw(class clsHideKicker_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x452BD0 -> 0x452EC4
        unsigned int u32Num; // r2
        unsigned int u32ViewNo; // r17
...
// Range: 0x452FB0 -> 0x453090
void execute(class clsHideKicker_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x452FB0 -> 0x453090
        unsigned int u32Num; // r2
...
// Range: 0x453090 -> 0x453100
void reset(class clsHideKicker_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x453090 -> 0x453100
        unsigned int u32Num; // r2
...
// Range: 0x453100 -> 0x45318C
void * __ct(class clsHideKicker_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x453100 -> 0x45318C
    }
...
// Range: 0x453690 -> 0x453944
void main(class clsHideKicker_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x453690 -> 0x453944
    }
...
// Range: 0x453960 -> 0x453968
void contactTriggerEvent() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x453960 -> 0x453968
    }
...
// Range: 0x453970 -> 0x4539D8
void destroyData(class clsHideKicker_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x453970 -> 0x4539D8
    }
...
// Range: 0x4539E0 -> 0x453E6C
void createData(class clsHideKicker_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4539E0 -> 0x453E6C
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0x140
        class hkShape * pcShape; // r17
        class NNS_VECTOR & rsScaleVec; // r2
        class NNS_VECTORFAST sPosVecFast; // r29+0x130
        class hkVector4 cBox; // r29+0x120
        float sMtx[4][4]; // r29+0xE0
        class NNS_VECTORFAST sDirVecFast; // r29+0xD0
        class NNS_VECTOR & rsBoxSize; // r2
        class hkVector4 cBox; // r29+0xC0
        class hkQuaternion cBoxQuaternion; // r29+0xB0
        class hkTransform cTrans; // r29+0x70
        class hkVector4 cOffset; // r29+0x60
    }
}


// Range: 0x453E70 -> 0x454080
void setData(class clsHideKicker_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x453E70 -> 0x454080
        class clsContactControl & rcContactControl; // r2
        class NNS_VECTORFAST sRotVecFast; // r29+0x80
        float sMtx[4][4]; // r29+0x40
        class hkVector4 & rcAngleVeocity; // r2
        class hkQuaternion & rcMaxAngle; // r2
        class NNS_QUATERNION sRotQuat; // r29+0x30
    }
}


// Range: 0x454080 -> 0x45413C
void reset(class clsHideKicker_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x454080 -> 0x45413C
        class hkVector4 cRot; // r29+0x30
    }
}


// Range: 0x454140 -> 0x4541AC
void init(class clsHideKicker_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x454140 -> 0x4541AC
        class hkVector4 cRot; // r29+0x30
...
// Range: 0x4541B0 -> 0x4541EC
void contactAlwaysEvent(class clsHideKickerThroughCol * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4541B0 -> 0x4541EC
    }
