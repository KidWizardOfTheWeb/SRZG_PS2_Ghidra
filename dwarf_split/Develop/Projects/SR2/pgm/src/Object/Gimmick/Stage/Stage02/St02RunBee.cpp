/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage02\St02RunBee.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTORFAST tosPlayerOffsetPosFast; // size: 0x10, address: 0x6800B0
static float CLIP_DISTx2; // size: 0x4, address: 0x6800C0
static class NNS_VECTOR tosThroughCollisionPos; // size: 0xC, address: 0x6800C8
class NNS_VECTORFAST m_tosPlayerOffsetFast; // size: 0x10, address: 0x6800E0
static class stcInfoParam tosBeeParam; // size: 0x18, address: 0x6800F0
static class stcInfoParam tosPlayerParam; // size: 0x18, address: 0x680110
static class stcControlParam tosControlParam; // size: 0x98, address: 0x680130
struct /* @anon1 */ {
    // total size: 0x48
} __vt__14clsRunBee_Task; // size: 0x48, address: 0x6C0780
void * __dt(class clsRunBee_Obj *, signed short); // size: 0x0, address: 0x39EC20
struct /* @anon7 */ {
    // total size: 0x48
} __vt__73clsBaseGimmickBody<14clsRunBee_Task,13clsRunBee_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C0800
struct /* @anon14 */ {
    // total size: 0x30
...
struct /* @anon6 */ {
    // total size: 0x34
} __vt__18clsRunBeeCollision; // size: 0x34, address: 0x6C08A0
void * __dt(class clsRunBee *, signed short); // size: 0x0, address: 0x39ED70
struct /* @anon8 */ {
    // total size: 0x44
} __vt__13clsRunBee_Obj; // size: 0x44, address: 0x6C0850
struct /* @anon19 */ {
    // total size: 0xC
} __vt__18clsBeeRoboBase_Obj; // size: 0xC, address: 0x6BE8C8
struct /* @anon10 */ {
    // total size: 0xC
...
struct /* @anon2 */ {
    // total size: 0x20
} __vt__9clsRunBee; // size: 0x20, address: 0x6C07D0
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x680250
...
void * __ct(class clsRunBee_Obj *); // size: 0x0, address: 0x3A0620
class clsRunBee_Task * m_tpcSingleton; // size: 0x4, address: 0xB15F40
struct /* @anon3 */ {
    // total size: 0xC
} __vt__30clsSingleton<14clsRunBee_Task>; // size: 0xC, address: 0x6C07F0
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
float m_tof32SphereRadius; // size: 0x4, address: 0x684908
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x680240
float hkConvexShapeDefaultRadius; // size: 0x4, address: 0x6223B8
void * __ct(class clsRunBee *); // size: 0x0, address: 0x3A1250
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x680230
...
struct /* @anon15 */ {
    // total size: 0x30
} __vt__42clsGmkBurnLight_Task<18clsModelType_OB_TX>; // size: 0x30, address: 0x6BBB80
...
class clsRunBee_Obj : public clsGimmickObj {
    // total size: 0x90
public:
    enum enmRunBeeMode m_eRunBeeMode; // offset 0x50, size 0x4
    class clsRunBee * m_apcRunBee; // offset 0x54, size 0x4
    class clsRunBee * * m_ppcExecute; // offset 0x58, size 0x4
    unsigned int m_u32ExecuteNum; // offset 0x5C, size 0x4
    class clsRunBee * * m_ppcSleep; // offset 0x60, size 0x4
    unsigned int m_u32SleepNum; // offset 0x64, size 0x4
    unsigned int m_u32ObjectNum; // offset 0x68, size 0x4
    float m_f32MaxSpeed; // offset 0x6C, size 0x4
    float m_f32MinSpeed; // offset 0x70, size 0x4
    class clsRunBeeCollision m_cCollision; // offset 0x74, size 0xC
    unsigned int m_u32PlayerFlg; // offset 0x80, size 0x4
    class hkShape * m_pcShape; // offset 0x84, size 0x4
};
...
class clsRunBee_Task : public clsBaseGimmickBody {
    // total size: 0x94
};
...
class clsRunBeeCollision : public clsBaseThroughCollision {
    // total size: 0xC
public:
    class clsRunBee_Obj * m_pcRunBeeObj; // offset 0x8, size 0x4
};
class hkRootCdPoint {
    // total size: 0x30
public:
...
class clsRunBee : public clsBeeRoboBase_Obj, public clsGimmickAutoRunObj {
    // total size: 0x3B0
public:
    enum enmMode m_eMode; // offset 0x1D0, size 0x4
    enum enmMoveMode m_eMoveMode; // offset 0x1D4, size 0x4
    unsigned int m_u32PlayerFlg; // offset 0x1D8, size 0x4
    class NNS_VECTORFAST m_sPosVecFast; // offset 0x1E0, size 0x10
    class NNS_QUATERNION m_sRotQuat; // offset 0x1F0, size 0x10
    float m_f32FollowFrame; // offset 0x200, size 0x4
    class clsGimmickPath m_cGimmickPath; // offset 0x210, size 0x190
    class clsRunBee_Obj * m_pcRunBeeObj; // offset 0x3A0, size 0x4
    class clsPendulumControl * m_pcPendulumControl; // offset 0x3A4, size 0x4
};
...
class clsBeeRoboBase_Obj {
    // total size: 0xC
public:
    signed short m_as16Id3D[4]; // offset 0x4, size 0x8
};
class clsSingleton {
    // total size: 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsRunBee_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB_TX m_cModel; // offset 0x88, size 0x8
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0x90, size 0x4
...
// Range: 0x39EE90 -> 0x39F138
void draw(class clsRunBee_Task * this /* r29+0xDC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39EE90 -> 0x39F138
        ...
        unsigned int u32i; // r29+0xC0
    }
}


// Range: 0x39F1D0 -> 0x39F43C
unsigned char draw(class clsRunBee * this /* r21 */, class NNS_OBJECT * psObject /* r16 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r20 */, float (* psMtxWork)[4][4] /* r19 */, unsigned int NodeStatus /* r18 */, unsigned int u32ViewNo /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39F1D0 -> 0x39F43C
    }
...
// Range: 0x39F440 -> 0x39F5C8
void execute(class clsRunBee_Task * this /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39F440 -> 0x39F5C8
        unsigned int u32Num; // r2
...
// Range: 0x39F5D0 -> 0x39F698
void elaseExexute(class clsRunBee_Obj * this /* r17 */, class clsRunBee * pcRunBee /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39F5D0 -> 0x39F698
        unsigned int u32Num; // r2
        unsigned int u32i; // r6
        class clsRunBee * * ppcRunBee; // r4
    }
}


// Range: 0x39F6A0 -> 0x39FE20
unsigned char execute(class clsRunBee * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39F6A0 -> 0x39FE20
...
// Range: 0x39FFB0 -> 0x3A0078
void getPathRotQuat(class clsRunBee * this /* r2 */, class NNS_QUATERNION & rsRotQuat /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x39FFB0 -> 0x3A0078
...
// Range: 0x3A0100 -> 0x3A0214
void createModel(class clsRunBee_Task * this /* r2 */, class stcBinInfo & rsBinInfoI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A0100 -> 0x3A0214
...
// Range: 0x3A0220 -> 0x3A02F8
void reset(class clsRunBee_Task * this /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A0220 -> 0x3A02F8
        unsigned int u32Num; // r2
...
// Range: 0x3A0300 -> 0x3A0488
void * __ct(class clsRunBee_Task * this /* r18 */, unsigned int u32ObjectAreaNum /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A0300 -> 0x3A0488
    }
...
// Range: 0x3A0800 -> 0x3A0820
void setClearPlayerFlg(class clsRunBee_Obj * this /* r2 */, class clsPlayerTask * pcPlayerTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A0800 -> 0x3A0820
    }
...
// Range: 0x3A0820 -> 0x3A09FC
void start(class clsRunBee_Obj * this /* r19 */, class clsPlayerTask * pcPlayerTask /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A0820 -> 0x3A09FC
    }
...
// Range: 0x3A0FD0 -> 0x3A1064
void destroyData(class clsRunBee_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A0FD0 -> 0x3A1064
    }
...
// Range: 0x3A1070 -> 0x3A124C
void createData(class clsRunBee_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A1070 -> 0x3A124C
...
// Range: 0x3A1480 -> 0x3A150C
void init(class clsRunBee_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A1480 -> 0x3A150C
    }
...
// Range: 0x3A1510 -> 0x3A16CC
void followPlayer(class clsRunBee * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A1510 -> 0x3A16CC
        class clsPlayerTask * pcPlayerTask; // r2
        float f32Rate; // r20
        class NNS_VECTORFAST sDistanceVecFast; // r29+0xE0
        class NNS_VECTORFAST sLocalPosVecFast; // r29+0xD0
        class NNS_VECTORFAST osPosVecFast; // r29+0xC0
        class NNS_VECTORFAST sPosVecFast; // r29+0xB0
        class NNS_VECTORFAST sDirVecFast; // r29+0xA0
        float f32Rad; // r29+0xF0
        float sWorldMtx[4][4]; // r29+0x60
    }
}


// Range: 0x3A16D0 -> 0x3A1738
void searchNextPath(class clsRunBee * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A16D0 -> 0x3A1738
...
// Range: 0x3A1740 -> 0x3A1770
void contactTriggerEvent(class clsRunBeeCollision * this /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A1740 -> 0x3A1770
    }
