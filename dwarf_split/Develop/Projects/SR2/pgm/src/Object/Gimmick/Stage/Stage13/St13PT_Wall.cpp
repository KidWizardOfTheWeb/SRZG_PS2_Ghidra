/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage13\St13PT_Wall.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x697B00
static class NNS_VECTORFAST tosPartsOffsetFast[4]; // size: 0x40, address: 0x697B10
struct /* @anon7 */ {
    // total size: 0x48
} __vt__15clsPT_Wall_Task; // size: 0x48, address: 0x6CFE40
struct /* @anon16 */ {
    // total size: 0x48
} __vt__83clsSingleModelGimmick_Task<15clsPT_Wall_Task,14clsPT_Wall_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CFEF0
struct /* @anon4 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPT_Wall_Task * m_tpcSingleton; // size: 0x4, address: 0xBFB2D8
struct /* @anon3 */ {
    // total size: 0xC
} __vt__31clsSingleton<15clsPT_Wall_Task>; // size: 0xC, address: 0x6CFE88
void * __dt(class clsPT_Wall_Obj *, signed short); // size: 0x0, address: 0x550F80
struct /* @anon5 */ {
    // total size: 0x48
} __vt__75clsBaseGimmickBody<15clsPT_Wall_Task,14clsPT_Wall_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CFEA0
struct /* @anon14 */ {
    // total size: 0x28
...
void * __dt(class clsPT_Wall_Parts *, signed short); // size: 0x0, address: 0x551030
struct /* @anon12 */ {
    // total size: 0x48
} __vt__14clsPT_Wall_Obj; // size: 0x48, address: 0x6CFF40
struct /* @anon13 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon17 */ {
    // total size: 0xA8
} __vt__16clsPT_Wall_Parts; // size: 0xA8, address: 0x6CFF90
struct /* @anon2 */ {
    // total size: 0xC
...
void * __ct(class clsPT_Wall_Obj *); // size: 0x0, address: 0x551900
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
void * __ct(class clsPT_Wall_Parts *); // size: 0x0, address: 0x5519F0
...
class clsPT_Wall_Obj : public clsGimmickObj {
    // total size: 0x4B0
public:
    enum enmGateMode m_eMode; // offset 0x50, size 0x4
    class clsPT_Wall_Parts m_acParts[4]; // offset 0x60, size 0x440
    float m_f32ResetCount; // offset 0x4A0, size 0x4
};
enum enmFlag {
    FLAG_CLEAR = 0,
    FLAG_VIBRATION = 1,
...
public:
    ...
    class clsPT_Wall_Obj * m_pcPTWallObj; // offset 0xD4, size 0x4
    unsigned int m_u32PartsNo; // offset 0xD8, size 0x4
    class NNS_VECTORFAST m_sInitPosVecFast; // offset 0xE0, size 0x10
    class NNS_QUATERNION m_sInitRotQuat; // offset 0xF0, size 0x10
    unsigned char m_bSetGravityFlag; // offset 0x100, size 0x1
    unsigned char m_bCatchFlag; // offset 0x101, size 0x1
};
...
class clsPT_Wall_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPT_Wall_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x551110 -> 0x5512C4
void draw(class clsPT_Wall_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x551110 -> 0x5512C4
        ...
        unsigned int sNodeStat; // r29+0x10C
        float sMtxPal[4][4]; // r29+0xC0
        float sMtxWork[4][4]; // r29+0x80
        unsigned int u32i; // r19
    }
}


// Range: 0x5512D0 -> 0x551458
void execute(class clsPT_Wall_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5512D0 -> 0x551458
...
// Range: 0x551460 -> 0x5514D0
void reset(class clsPT_Wall_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x551460 -> 0x5514D0
        unsigned int u32Num; // r2
...
// Range: 0x5514D0 -> 0x551594
void * __ct(class clsPT_Wall_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5514D0 -> 0x551594
...
// Range: 0x551AB0 -> 0x551AF8
void destroyData(class clsPT_Wall_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x551AB0 -> 0x551AF8
        class clsPT_Wall_Parts * pcParts; // r17
        unsigned int u32Num; // r16
    }
}


// Range: 0x551B00 -> 0x551B5C
void createData(class clsPT_Wall_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x551B00 -> 0x551B5C
        class clsPT_Wall_Parts * pcParts; // r17
...
// Range: 0x551B70 -> 0x551C1C
void reset(class clsPT_Wall_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x551B70 -> 0x551C1C
    }
...
// Range: 0x551C20 -> 0x551C34
void requestDrawBreakEffect(class clsPT_Wall_Parts * this /* r4 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x551C20 -> 0x551C34
    }
...
// Range: 0x551C40 -> 0x551D74
void contactTriggerEvent(class clsPT_Wall_Parts * this /* r19 */, class hkContactPoint * pcContact /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x551C40 -> 0x551D74
    }
...
// Range: 0x551D80 -> 0x551E98
void callbackGravityEvent(class clsPT_Wall_Parts * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x551D80 -> 0x551E98
    }
...
// Range: 0x551EA0 -> 0x552144
void draw(class clsPT_Wall_Parts * this /* r19 */, class clsModelType_OB_TX & rcObj /* r18 */, float (* psMtxPal)[4][4] /* r17 */, unsigned int * psNodeStat /* r16 */, float (* opaNnViewMtx)[4][4] /* r17 */, float (* psMtxWork)[4][4] /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x551EA0 -> 0x552144
...
// Range: 0x552150 -> 0x5521DC
void main(class clsPT_Wall_Parts * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x552150 -> 0x5521DC
    }
...
// Range: 0x5521E0 -> 0x552274
void destroyData(class clsPT_Wall_Parts * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5521E0 -> 0x552274
    }
...
// Range: 0x552280 -> 0x55284C
void createData(class clsPT_Wall_Parts * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x552280 -> 0x55284C
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0x120
        class NNS_VECTORFAST sVecFast; // r29+0x110
        float aMtx[4][4]; // r29+0xD0
        class NNS_QUATERNION orsRot; // r29+0xC0
        class NNS_QUATERNION orsRotNew; // r29+0xB0
        class hkBoxShape * pcBoxShape; // r2
        class hkMassProperties massProperties; // r29+0x60
        char __FUNCTION__[14]; // @ 0x00697AF0
    }
}


// Range: 0x552850 -> 0x55294C
void reset(class clsPT_Wall_Parts * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x552850 -> 0x55294C
