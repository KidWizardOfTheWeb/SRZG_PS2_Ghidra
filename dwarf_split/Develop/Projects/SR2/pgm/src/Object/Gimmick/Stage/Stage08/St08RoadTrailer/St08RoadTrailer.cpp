/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage08\St08RoadTrailer\St08RoadTrailer.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32ClipSqDist; // size: 0x4, address: 0x696020
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x696030
...
struct /* @anon10 */ {
    // total size: 0x48
} __vt__19clsRoadTrailer_Task; // size: 0x48, address: 0x6CE4A0
struct /* @anon20 */ {
    // total size: 0x48
} __vt__90clsMultiModelGimmick_Task<19clsRoadTrailer_Task,18clsRoadTrailer_Obj,18clsMultiObTxModels>; // size: 0x48, address: 0x6CE4F0
void * __dt(class clsRoadTrailer_Obj *, signed short); // size: 0x0, address: 0x52B390
struct /* @anon11 */ {
    // total size: 0x48
} __vt__83clsBaseGimmickBody<19clsRoadTrailer_Task,18clsRoadTrailer_Obj,18clsMultiObTxModels>; // size: 0x48, address: 0x6CE450
struct /* @anon17 */ {
    // total size: 0x30
...
struct /* @anon23 */ {
    // total size: 0xE4
} __vt__18clsRoadCarBase_Obj; // size: 0xE4, address: 0x6CDC60
struct /* @anon13 */ {
    // total size: 0xB8
} __vt__20clsRoadContainer_Obj; // size: 0xB8, address: 0x6CE280
struct /* @anon4 */ {
    // total size: 0xF4
} __vt__18clsRoadTrailer_Obj; // size: 0xF4, address: 0x6CE340
struct /* @anon16 */ {
    // total size: 0x28
...
struct /* @anon6 */ {
    // total size: 0x28
} __vt__15clsRoadBase_Obj; // size: 0x28, address: 0x6CDC30
struct /* @anon2 */ {
    // total size: 0xC
...
class clsRoadTrailer_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA7B8
struct /* @anon5 */ {
    // total size: 0xC
} __vt__35clsSingleton<19clsRoadTrailer_Task>; // size: 0xC, address: 0x6CE438
void * __ct(class clsRoadTrailer_Obj *); // size: 0x0, address: 0x52B7C0
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x0
...
float t_of32MaxVelocity; // size: 0x4, address: 0x695E30
float t_of32MaxAngleVelocity; // size: 0x4, address: 0x695E38
float t_of32WeightTypeSuperMiddle; // size: 0x4, address: 0x6651A0
class NNS_VECTOR t_osCollisionHalfSizeVec; // size: 0xC, address: 0x695F48
struct /* @anon24 */ {
    // total size: 0xC
...
class clsRoadTrailer_Task : public clsMultiModelGimmick_Task {
    // total size: 0x9C
public:
    class hkShape * m_pcContainerShape; // offset 0x98, size 0x4
};
...
class clsRoadTrailer_Obj : public clsRoadCarBase_Obj {
    // total size: 0x3C0
public:
    class clsRoadContainer_Obj m_cContainer; // offset 0x2B0, size 0x100
    class clsSe3DControl * m_pcSe3DControl; // offset 0x3B0, size 0x4
};
...
class clsRoadCarBase_Obj : public clsRigidBodyGimmickObj, public clsRoadBase_Obj {
    // total size: 0x2B0
public:
    enum enmMode m_eMode; // offset 0xD4, size 0x4
    class clsRoadCarControl m_cRoadCarControl; // offset 0xE0, size 0x1D0
};
enum enm {
    NONE = -1,
    CHARA_0 = 0,
...
class clsRoadCarControl {
    // total size: 0x1D0
public:
    enum enmMode m_eMode; // offset 0x0, size 0x4
    enum enmState m_eState; // offset 0x4, size 0x4
    class stcRoadInfo * m_opsRoadInfo; // offset 0x8, size 0x4
    class clsRoad_Obj * m_pcRoadObj; // offset 0xC, size 0x4
    class clsRigidBodyGimmickObj * m_pcGimmickObj; // offset 0x10, size 0x4
    class clsRoadBase_Obj * m_pcRoadBaseObj; // offset 0x14, size 0x4
    float m_f32SlowDownSpeed; // offset 0x18, size 0x4
    float m_f32BodyHafeSize; // offset 0x1C, size 0x4
    float m_f32OffsetY; // offset 0x20, size 0x4
    class clsFrameControl m_cFrameControl; // offset 0x24, size 0x8
    class clsGimmickPath m_cGimmickPath; // offset 0x30, size 0x190
    signed char m_s8Priority; // offset 0x1C0, size 0x1
};
class Fuid {
    // total size: 0x10
public:
...
public:
    ...
    enum enmState m_eState; // offset 0x64, size 0x4
    float m_f32WaitFrame; // offset 0x68, size 0x4
    float m_f32WorkFrame; // offset 0x6C, size 0x4
    float m_f32FrameAdd; // offset 0x70, size 0x4
    float m_f32ResetStopDist; // offset 0x74, size 0x4
    class clsPlayerTask * m_pcPlayer; // offset 0x78, size 0x4
    class clsOOVector m_vctCar; // offset 0x7C, size 0x10
    class clsOOVector m_vctCarSort; // offset 0x8C, size 0x10
};
...
class stcRoadInfo {
    // total size: 0x10
public:
    float f32Speed; // offset 0x0, size 0x4
    unsigned short u16TotalFrame; // offset 0x4, size 0x2
    unsigned short u16StartWaitFarme; // offset 0x6, size 0x2
    unsigned short u16StartIntervalFrame; // offset 0x8, size 0x2
    unsigned char u8Path00; // offset 0xA, size 0x1
    unsigned char u8Path01; // offset 0xB, size 0x1
    unsigned char u8Signal; // offset 0xC, size 0x1
    unsigned char u8Padd[3]; // offset 0xD, size 0x3
};
enum enmStatus {
    STATUS_NULL = 0,
    STATUS_END = 1,
...
public:
    ...
    class clsRoadTrailer_Obj * m_pcTrailerObj; // offset 0xE4, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0xE8, size 0x4
    class stcSetDataDetail * m_psSetData; // offset 0xEC, size 0x4
    float m_f32WaitFrame; // offset 0xF0, size 0x4
};
enum enmRank {
    RANK_FAILED = -1,
    RANK_AUTO = 0,
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsRoadTrailer_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x52AD10 -> 0x52AF74
void draw(class clsRoadTrailer_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52AD10 -> 0x52AF74
        unsigned int u32Num; // r2
        unsigned int * psNodeStat; // r17
        float (* opaNnViewMtx)[4][4]; // r16
        float (* psMtxPal)[4][4]; // r22
        class clsModelType_OB_TX & rcModel; // r23
        class clsModelType_OB_TX & rcModelCon; // r30
...
// Range: 0x52AF80 -> 0x52B060
void execute(class clsRoadTrailer_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52AF80 -> 0x52B060
        unsigned int u32Num; // r2
...
// Range: 0x52B060 -> 0x52B0D0
void reset(class clsRoadTrailer_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52B060 -> 0x52B0D0
        unsigned int u32Num; // r2
...
// Range: 0x52B0D0 -> 0x52B1EC
void * __ct(class clsRoadTrailer_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52B0D0 -> 0x52B1EC
...
// Range: 0x52B950 -> 0x52BC00
void draw(class clsRoadTrailer_Obj * this /* r20 */, class clsModelType_OB_TX & rcObj /* r19 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r21 */, float (* opaNnViewMtx)[4][4] /* r17 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52B950 -> 0x52BC00
    }
...
// Range: 0x52BC00 -> 0x52BC2C
void execute(class clsRoadTrailer_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52BC00 -> 0x52BC2C
    }
...
// Range: 0x52BC30 -> 0x52BC6C
void requestDrawBreakEffect(class clsRoadTrailer_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52BC30 -> 0x52BC6C
    }
...
// Range: 0x52BC70 -> 0x52BC84
void eventStopMove(class clsRoadTrailer_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52BC70 -> 0x52BC84
    }
...
// Range: 0x52BC90 -> 0x52BCA4
void eventStartMove(class clsRoadTrailer_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52BC90 -> 0x52BCA4
    }
...
// Range: 0x52BCB0 -> 0x52BCC8
void eventSetPosition(class clsRoadTrailer_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52BCB0 -> 0x52BCC8
    }
...
// Range: 0x52BCD0 -> 0x52BD60
void destroyData(class clsRoadTrailer_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52BCD0 -> 0x52BD60
    }
...
// Range: 0x52BD60 -> 0x52C1BC
void createData(class clsRoadTrailer_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52BD60 -> 0x52C1BC
...
// Range: 0x52C1C0 -> 0x52C204
void resetObject(class clsRoadTrailer_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52C1C0 -> 0x52C204
    }
...
// Range: 0x52C210 -> 0x52C24C
void reset(class clsRoadTrailer_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52C210 -> 0x52C24C
    }
...
// Range: 0x52C250 -> 0x52C2C0
void init(class clsRoadTrailer_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x52C250 -> 0x52C2C0
    }
