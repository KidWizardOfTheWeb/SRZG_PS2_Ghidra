/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage11\St11Crane.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcInfoParam tosCraneParamSt11; // size: 0x18, address: 0x68A1C0
static class stcInfoParam tosCraneParamSt14; // size: 0x18, address: 0x68A1E0
static class stcInfoParam tosPlayerParam; // size: 0x18, address: 0x68A200
static class stcControlParam tosControlParam; // size: 0x98, address: 0x68A220
static class NNS_VECTORFAST tosPlayerOffsetPosFast00; // size: 0x10, address: 0x68A2C0
static class NNS_VECTORFAST tosPlayerOffsetPosFast01; // size: 0x10, address: 0x68A2D0
float m_tof32CLIP_DISTx2; // size: 0x4, address: 0x68A2E0
struct /* @anon12 */ {
    // total size: 0x48
} __vt__13clsCrane_Task; // size: 0x48, address: 0x6C7ED0
struct /* @anon1 */ {
    // total size: 0x48
} __vt__79clsSingleModelGimmick_Task<13clsCrane_Task,12clsCrane_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BAC60
struct /* @anon5 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsCrane_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A7E0
struct /* @anon11 */ {
    // total size: 0xC
} __vt__29clsSingleton<13clsCrane_Task>; // size: 0xC, address: 0x6BABF8
void * __dt(class clsCrane_Obj *, signed short); // size: 0x0, address: 0x2CA160
struct /* @anon15 */ {
    // total size: 0x48
} __vt__71clsBaseGimmickBody<13clsCrane_Task,12clsCrane_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BAC10
struct /* @anon13 */ {
    // total size: 0x28
...
struct /* @anon4 */ {
    // total size: 0x58
} __vt__12clsCrane_Obj; // size: 0x58, address: 0x6C7F20
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x68A330
class clsPfCri * m_tpcSingleton; // size: 0x4, address: 0x6E6998
float m_tof32SphereRadius; // size: 0x4, address: 0x684908
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x68A320
struct /* @anon20 */ {
    // total size: 0xC
...
void * __dt(class clsCrane *, signed short); // size: 0x0, address: 0x2E62B0
struct /* @anon8 */ {
    // total size: 0xC
...
struct /* @anon3 */ {
    // total size: 0x10
} __vt__8clsCrane; // size: 0x10, address: 0x6BBB70
struct /* @anon7 */ {
    // total size: 0x20
...
void * __ct(class clsCrane *); // size: 0x0, address: 0x49DF00
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x68A310
...
public:
    ...
    class clsGimmickAutoRunBuffer m_cCraneBuffer; // offset 0x64, size 0x1C
};
...
class clsCrane_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
enum enmFlag {
    FLAG_CLEAR = 0,
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsCrane_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsModelType_OB_TX m_cModel; // offset 0x88, size 0x8
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0x90, size 0x4
...
public:
    ...
    class clsCrane_Obj * m_pcCraneObj; // offset 0x1C8, size 0x4
    ...
    unsigned char m_bIsCatch; // offset 0x1D8, size 0x1
    class clsPlaySe_2D * m_pcPlaySe2D; // offset 0x1DC, size 0x4
};
class hkEnum {
    // total size: 0x1
public:
...
class clsGimmickAutoRunBuffer : public clsGimmickAutoRunBufferBase {
    // total size: 0x1C
public:
    class clsCrane * m_apcObj; // offset 0xC, size 0x4
    class clsCrane * * m_ppcExecute; // offset 0x10, size 0x4
    class clsCrane * * m_ppcSleep; // offset 0x14, size 0x4
    class clsCrane * * m_ppcExecuteWork; // offset 0x18, size 0x4
};
...
// Range: 0x49C760 -> 0x49C9D8
void draw(class clsCrane_Task * this /* r29+0xCC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49C760 -> 0x49C9D8
        unsigned int u32Num; // r2
        unsigned int * psNodeStat; // r22
        unsigned int u32ViewNo; // r21
        float (* opaNnViewMtx)[4][4]; // r23
        float (* psMtxPal)[4][4]; // r30
        class clsModelType_OB_TX & rcModel; // r20
        float sMtx[4][4]; // r29+0xD0
        unsigned int u32i; // r29+0xB0
    }
}


// Range: 0x49CA10 -> 0x49CB2C
void execute(class clsCrane_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49CA10 -> 0x49CB2C
        unsigned int u32Num; // r2
...
// Range: 0x49CB30 -> 0x49CB98
void reset(class clsCrane_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49CB30 -> 0x49CB98
        unsigned int u32Num; // r2
...
// Range: 0x49CBA0 -> 0x49CC34
void contactTriggerEvent(class clsCrane_Obj * this /* r17 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49CBA0 -> 0x49CC34
        class clsPlayerTask * pcPlayerTask; // r16
        class clsCrane * pcCrane; // r18
    }
}


// Range: 0x49CC40 -> 0x49CC90
void destroyData(class clsCrane_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49CC40 -> 0x49CC90
    }
...
// Range: 0x49CC90 -> 0x49CD88
void createData(class clsCrane_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49CC90 -> 0x49CD88
...
// Range: 0x49CD90 -> 0x49D010
unsigned char draw(class clsCrane * this /* r19 */, class clsModelType_OB_TX & rcModel /* r18 */, float (* psMtxPal)[4][4] /* r17 */, unsigned int * psNodeStat /* r19 */, float (* opaNnViewMtx)[4][4] /* r22 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r20 */, unsigned int NodeStatus /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49CD90 -> 0x49D010
...
// Range: 0x49D010 -> 0x49D708
void execute(class clsCrane * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49D010 -> 0x49D708
    }
...
// Range: 0x49D750 -> 0x49D930
void start(class clsCrane * this /* r18 */, class clsPlayerTask * pcPlayerTask /* r2 */, class clsCrane_Obj * pcObj /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49D750 -> 0x49D930
        unsigned int u32SeNo; // r17
    }
}
