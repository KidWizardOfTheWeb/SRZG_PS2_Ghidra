/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage10\St10SnowBall.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x687E40
struct /* @anon5 */ {
    // total size: 0x48
} __vt__16clsSnowBall_Task; // size: 0x48, address: 0x6C5D00
struct /* @anon15 */ {
    // total size: 0x48
} __vt__85clsSingleModelGimmick_Task<16clsSnowBall_Task,15clsSnowBall_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C5DB0
struct /* @anon4 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsSnowBall_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A7A0
struct /* @anon3 */ {
    // total size: 0xC
} __vt__32clsSingleton<16clsSnowBall_Task>; // size: 0xC, address: 0x6C5D48
void * __dt(class clsSnowBall_Obj *, signed short); // size: 0x0, address: 0x4575E0
struct /* @anon6 */ {
    // total size: 0x48
} __vt__77clsBaseGimmickBody<16clsSnowBall_Task,15clsSnowBall_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C5D60
struct /* @anon14 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon9 */ {
    // total size: 0xA8
} __vt__15clsSnowBall_Obj; // size: 0xA8, address: 0x6C5E00
struct /* @anon12 */ {
    // total size: 0x28
...
void * __ct(class clsSnowBall_Obj *); // size: 0x0, address: 0x4590A0
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x687E70
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x687E80
...
public:
    ...
    unsigned char m_bDrawFlag; // offset 0xE4, size 0x1
...
class clsSnowBall_Task : public clsSingleModelGimmick_Task {
    // total size: 0x9C
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsSnowBall_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x4576E0 -> 0x457720
void setShadowModel(class clsSnowBall_Task * this /* r16 */, unsigned char * rsBinInfoI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4576E0 -> 0x457720
    }
...
// Range: 0x457720 -> 0x45794C
void draw(class clsSnowBall_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x457720 -> 0x45794C
...
// Range: 0x457950 -> 0x457C28
void execute(class clsSnowBall_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x457950 -> 0x457C28
        unsigned int u32Num; // r2
...
// Range: 0x457C30 -> 0x457CA0
void reset(class clsSnowBall_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x457C30 -> 0x457CA0
        unsigned int u32Num; // r2
...
// Range: 0x457CA0 -> 0x457D50
void * __ct(class clsSnowBall_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x457CA0 -> 0x457D50
    }
...
// Range: 0x4580B0 -> 0x458108
void requestDrawBreakEffect(class clsSnowBall_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4580B0 -> 0x458108
    }
...
// Range: 0x458110 -> 0x458118
void callbackBreakEvent() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x458110 -> 0x458118
    }
...
// Range: 0x458170 -> 0x4581E4
void callbackGravityEvent(class clsSnowBall_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x458170 -> 0x4581E4
    }
...
// Range: 0x4581F0 -> 0x4582AC
void callbackContactTriggerRigidBody(class clsSnowBall_Obj * this /* r17 */, class hkContactPointConfirmedEvent & cEvent /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4581F0 -> 0x4582AC
    }
...
// Range: 0x4582B0 -> 0x458330
void contactTriggerEvent(class clsSnowBall_Obj * this /* r18 */, class hkContactPoint * pcContact /* r17 */, class clsObject * pcObject /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4582B0 -> 0x458330
    }
...
// Range: 0x458330 -> 0x458740
void drawShadow(class clsSnowBall_Obj * this /* r21 */, class clsModelType_OB & rcModel /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x458330 -> 0x458740
...
// Range: 0x458740 -> 0x458A00
void draw(class clsSnowBall_Obj * this /* r21 */, class clsModelType_OB_TX & rcModel /* r20 */, float (* psMtxPal)[4][4] /* r19 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r17 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x458740 -> 0x458A00
...
// Range: 0x458A00 -> 0x458A60
void main(class clsSnowBall_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x458A00 -> 0x458A60
    }
...
// Range: 0x458A60 -> 0x458B60
void reset(class clsSnowBall_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x458A60 -> 0x458B60
    }
...
// Range: 0x458B60 -> 0x458BE0
void destroyData(class clsSnowBall_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x458B60 -> 0x458BE0
    }
...
// Range: 0x458BE0 -> 0x45909C
void createData(class clsSnowBall_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x458BE0 -> 0x45909C
...
// Range: 0x4590A0 -> 0x459164
void * __ct(class clsSnowBall_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4590A0 -> 0x459164
    }
...
// Range: 0x459170 -> 0x45918C
void init(class clsSnowBall_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x459170 -> 0x45918C
    }
