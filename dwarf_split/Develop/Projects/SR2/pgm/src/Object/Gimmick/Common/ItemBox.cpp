/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\ItemBox.cpp
...
static float CLIP_DISTx2; // size: 0x4, address: 0x67D1A8
static unsigned char sco8RateTable8Num[4][8][19]; // size: 0x260, address: 0x67D1B0
static unsigned char sco8RateTable2Num[4][2][19]; // size: 0x98, address: 0x67D410
static unsigned char sco8RateTable3Num[4][3][19]; // size: 0xE4, address: 0x67D4B0
static unsigned char sco8RateTable4Num[4][4][19]; // size: 0x130, address: 0x67D5A0
static unsigned char sco8St15RateTable8Num[4][8][19]; // size: 0x260, address: 0x67D6D0
static unsigned char sco8St15RateTable2Num[4][2][19]; // size: 0x98, address: 0x67D930
static unsigned char sco8St15RateTable3Num[4][3][19]; // size: 0xE4, address: 0x67D9D0
static unsigned char sco8St15RateTable4Num[4][4][19]; // size: 0x130, address: 0x67DAC0
static unsigned char tou8RateTable_SvlBtl[2][3][4][8]; // size: 0xC0, address: 0x67DBF0
static unsigned char tou8MissileNumTbl_SvlBtl[2][4]; // size: 0x8, address: 0x67DCB0
static unsigned char tou8ItemNoTable_SvlBtl[8]; // size: 0x8, address: 0x67DCB8
static unsigned char * * * sco8RateTable[16]; // size: 0x40, address: 0x627D70
static unsigned int scu32RateTblSize[8]; // size: 0x20, address: 0x67DCC0
static char c8ItemName[20][16]; // size: 0x140, address: 0x0
static unsigned int toau32RateTblSizeDebug[8]; // size: 0x20, address: 0x67DCE0
unsigned int t_u32ReBorn; // size: 0x4, address: 0x67DD00
struct /* @anon13 */ {
    // total size: 0x58
} __vt__14clsItemBox_Obj; // size: 0x58, address: 0x6BEBA0
...
float tof32ItemBoxScale; // size: 0x4, address: 0x687A40
struct /* @anon1 */ {
    // total size: 0x48
} __vt__15clsItemBox_Task; // size: 0x48, address: 0x6BEC10
unsigned char m_toabDisableFog[17]; // size: 0x11, address: 0x687510
void * __dt(class clsItemBox_Obj *, signed short); // size: 0x0, address: 0x3694E0
void * __ct(class clsItemBox_Obj *); // size: 0x0, address: 0x36AB60
struct /* @anon10 */ {
    // total size: 0x48
} __vt__73clsBaseGimmickBody<15clsItemBox_Task,14clsItemBox_Obj,16clsItemBoxModels>; // size: 0x48, address: 0x6BEC60
struct /* @anon3 */ {
    // total size: 0x38
...
struct /* @anon6 */ {
    // total size: 0xC
} __vt__31clsSingleton<15clsItemBox_Task>; // size: 0xC, address: 0x6BEBF8
struct /* @anon8 */ {
    // total size: 0x30
...
float SUPER_SONIC_RATE_ATTACK_FRAME; // size: 0x4, address: 0x697BF0
float toaf32ItemBox[3]; // size: 0xC, address: 0x67DDA0
unsigned char m_tu8Used; // size: 0x1, address: 0xB0D908
struct /* @anon0 */ {
    // total size: 0x30
} __vt__18clsDashEffect_Task; // size: 0x30, address: 0x6BCEF0
class clsOORandom * m_tpcSingleton; // size: 0x4, address: 0x703C58
class clsOOProfile * m_tpcSingleton; // size: 0x4, address: 0x703C28
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x67DDB0
struct /* @anon9 */ {
    // total size: 0x44
...
// Range: 0x3695E0 -> 0x369D10
void draw(class clsItemBox_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3695E0 -> 0x369D10
        unsigned int u32Num; // r2
        unsigned int * psNodeStat; // r17
        unsigned int u32ViewNo; // r30
        float (* opaNnViewMtx)[4][4]; // r22
        float (* psMtxPal)[4][4]; // r23
        unsigned int u32GameCount; // r2
        class NNS_OBJECT * psObject; // r29+0xE0
        class NNS_OBJECT * psObjectAir; // r2
        class clsModelType_OB_TX_MO_MA * pcModelCol; // r2
        float sMtx[4][4]; // r29+0x180
        class NNS_OBJECT * apsObject[2]; // r29+0x1C8
        unsigned int u32i; // r16
    }
}


// Range: 0x369EF0 -> 0x36A090
void execute(class clsItemBox_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x369EF0 -> 0x36A090
        unsigned int u32Num; // r2
        class NNS_OBJECT * psObject; // r2
        class NNS_OBJECT * psObjectAir; // r2
...
// Range: 0x36A090 -> 0x36A3D8
void createModel(class clsItemBox_Task * this /* r2 */, class stcBinInfo & rsBinInfoI /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36A090 -> 0x36A3D8
...
// Range: 0x36A470 -> 0x36A5D4
void reset(class clsItemBox_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36A470 -> 0x36A5D4
        unsigned int u32Num; // r2
...
// Range: 0x36A5E0 -> 0x36A868
void * __ct(class clsItemBox_Task * this /* r18 */, unsigned int u32ObjectAreaNum /* r17 */, unsigned int u32TpI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36A5E0 -> 0x36A868
    }
...
// Range: 0x36ACF0 -> 0x36AE54
void getAgp(class clsPlayerTask * pcHitPlayer /* r16 */, float f32AgpAdd /* r29+0x30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36ACF0 -> 0x36AE54
    }
...
// Range: 0x36AE60 -> 0x36BCAC
unsigned int execEffect(class clsItemBox_Obj * this /* r20 */, class clsPlayerTask * pcHitPlayer /* r19 */, unsigned int u32ItemNo /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36AE60 -> 0x36BCAC
        unsigned int u32i; // r8
        unsigned int u32j; // r7
        unsigned int u32k; // r6
        unsigned int u32l; // r5
        signed char s8Rank; // r18
        class clsSurvivalBattleRace_Task * pcSvlbtl_Task; // r2
        unsigned char * opu8RateTable; // r2
        class stcData * psData; // r2
        signed short s16PathNo; // r16
    }
}


// Range: 0x36BCC0 -> 0x36BD00
unsigned int calcRateTable(unsigned char * opu8RateTableI /* r2 */, unsigned int u32TableNumI /* r2 */, unsigned int u32ParamI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36BCC0 -> 0x36BD00
        unsigned int u32No; // r2
        unsigned int u32Rate; // r8
    }
}


// Range: 0x36BD30 -> 0x36BD50
void contactRemoveEvent(class clsItemBox_Obj * this /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36BD30 -> 0x36BD50
    }
...
// Range: 0x36BD50 -> 0x36BFDC
void contactAlwaysEvent(class clsItemBox_Obj * this /* r19 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36BD50 -> 0x36BFDC
        class clsPlayerTask * pcHitPlayer; // r18
        unsigned int u32ItemNo; // r17
        unsigned char bGet; // r2
    }
}


// Range: 0x36BFE0 -> 0x36C2F4
void execute(class clsItemBox_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36BFE0 -> 0x36C2F4
    }
...
// Range: 0x36C300 -> 0x36C348
void destroyData(class clsItemBox_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36C300 -> 0x36C348
    }
...
// Range: 0x36C350 -> 0x36C6CC
void createData(class clsItemBox_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x36C350 -> 0x36C6CC
        class hkTransform cTransform; // r29+0xD0
    }
}
