/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage15\St15GLinkFloorBoard.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x687FA0
float tof32ClipSqDist; // size: 0x4, address: 0x687FB0
class clsGravityGimmickParam t_ocGravityGimmickParam[2]; // size: 0xF0, address: 0x687FC0
struct /* @anon8 */ {
    // total size: 0x48
} __vt__23clsGLinkFloorBoard_Task; // size: 0x48, address: 0x6C5FA0
struct /* @anon9 */ {
    // total size: 0x48
} __vt__102clsSingleModelGimmick_Task<23clsGLinkFloorBoard_Task,25clsGLinkFloorBoard_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C6140
struct /* @anon7 */ {
    // total size: 0x38
...
struct /* @anon19 */ {
    // total size: 0xC
} __vt__39clsSingleton<23clsGLinkFloorBoard_Task>; // size: 0xC, address: 0x6C60D8
void * __dt(class clsGLinkFloorBoard_Object *, signed short); // size: 0x0, address: 0x45BC60
struct /* @anon1 */ {
    // total size: 0x48
} __vt__94clsBaseGimmickBody<23clsGLinkFloorBoard_Task,25clsGLinkFloorBoard_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C60F0
struct /* @anon16 */ {
    // total size: 0xB4
} __vt__24clsBaseGravityLinkObject; // size: 0xB4, address: 0x6C1420
struct /* @anon6 */ {
    // total size: 0xB8
} __vt__25clsGLinkFloorBoard_Object; // size: 0xB8, address: 0x6C6020
struct /* @anon14 */ {
    // total size: 0x28
...
void * __ct(class clsGLinkFloorBoard_Object *); // size: 0x0, address: 0x45C850
...
struct /* @anon10 */ {
    // total size: 0x28
} __vt__26clsGravitySt15FloorControl; // size: 0x28, address: 0x6C5FF0
...
enum enmContactAction {
    ...
    ACTION_BREAK = 3,
    ACTION_DAMAGE = 4,
    ACTION_DAMAGE_TIMELOSS = 5,
    ACTION_GLINK = 6,
    ACTION_GDASH = 7,
    ACTION_GCANCEL = 8,
    ACTION_SPEED_DOWN = 9,
    ACTION_POWER_BOUND = 10,
};
...
// Range: 0x45BD00 -> 0x45BDF8
void rebirthSetFloorBoard(class clsGLinkFloorBoard_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45BD00 -> 0x45BDF8
...
// Range: 0x45BE00 -> 0x45BEE4
void endGActionCheck(class clsGLinkFloorBoard_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45BE00 -> 0x45BEE4
        unsigned int u32Num; // r2
...
// Range: 0x45BFA0 -> 0x45C0A8
void startGActionCheck(class clsGLinkFloorBoard_Task * this /* r20 */, signed int os32HP /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45BFA0 -> 0x45C0A8
        unsigned int u32Num; // r2
...
// Range: 0x45C0B0 -> 0x45C120
void reset(class clsGLinkFloorBoard_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45C0B0 -> 0x45C120
        unsigned int u32Num; // r2
...
// Range: 0x45C120 -> 0x45C32C
void draw(class clsGLinkFloorBoard_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45C120 -> 0x45C32C
        ...
        float sWorkMtx[4][4]; // r29+0x80
        unsigned int u32i; // r18
    }
}


// Range: 0x45C330 -> 0x45C410
void execute(class clsGLinkFloorBoard_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45C330 -> 0x45C410
        unsigned int u32Num; // r2
...
// Range: 0x45C410 -> 0x45C4FC
void * __ct(class clsGLinkFloorBoard_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45C410 -> 0x45C4FC
...
// Range: 0x45C8D0 -> 0x45C950
void destroyData(class clsGLinkFloorBoard_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45C8D0 -> 0x45C950
    }
...
// Range: 0x45C950 -> 0x45CE68
void createData(class clsGLinkFloorBoard_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45C950 -> 0x45CE68
        ...
        class clsGrindLinkControl * pcGravityControl; // r16
        unsigned char bMissionFlag; // r4
    }
}


// Range: 0x45CEF0 -> 0x45CEF8
void setData() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45CEF0 -> 0x45CEF8
...
// Range: 0x45CF00 -> 0x45D018
void drawEffect(class clsPlayerTask * pcPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45CF00 -> 0x45D018
        class NNS_VECTOR sPos; // r29+0x40
        class NNS_VECTOR sVelo; // r29+0x30
        class NNS_VECTOR LOCAL_POS_R; // @ 0x006880E0
        class NNS_VECTOR LOCAL_POS; // @ 0x006880D0
        class NNS_VECTOR RAND_SP; // @ 0x006880C0
        float LIFE_FRAME; // @ 0x006880F0
        class NNS_VECTOR BEGIN_SP; // @ 0x006880B0
    }
}


// Range: 0x45D020 -> 0x45D05C
void requestDrawBreakEffect(class clsGLinkFloorBoard_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45D020 -> 0x45D05C
    }
...
// Range: 0x45D060 -> 0x45D15C
void mainGravity(class clsGLinkFloorBoard_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45D060 -> 0x45D15C
        class clsGroundCollision * pcGroundCol; // r8
        class stcInfo * psInfo; // r2
        signed int s32i; // r7
    }
}


// Range: 0x45D160 -> 0x45D180
void main(class clsGLinkFloorBoard_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45D160 -> 0x45D180
    }
...
// Range: 0x45D180 -> 0x45D3E4
void reset(class clsGLinkFloorBoard_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45D180 -> 0x45D3E4
        class clsRigidBody * pcRigidBody; // r16
        class hkVector4 cZero; // r29+0x50
    }
}


// Range: 0x45D3F0 -> 0x45D668
void draw(class clsGLinkFloorBoard_Object * this /* r17 */, class NNS_OBJECT * psObject /* r16 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r20 */, float (* psMtxWork)[4][4] /* r19 */, unsigned int u32ViewNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45D3F0 -> 0x45D668
    }
...
// Range: 0x45D6F0 -> 0x45D750
void callbackGravityEvent(class clsGLinkFloorBoard_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45D6F0 -> 0x45D750
    }
