/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\DashRing.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tf32CLIP_DISTx2; // size: 0x4, address: 0xB13DC0
float tof32CLIP_DISTx2[17]; // size: 0x44, address: 0x67D0F0
struct /* @anon10 */ {
    // total size: 0x5C
} __vt__16clsDashRing_Task; // size: 0x5C, address: 0x6BEA90
struct /* @anon1 */ {
    // total size: 0x48
} __vt__85clsSingleModelGimmick_Task<16clsDashRing_Task,15clsDashRing_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6B8DF0
struct /* @anon4 */ {
    // total size: 0x38
...
struct /* @anon9 */ {
    // total size: 0xC
} __vt__32clsSingleton<16clsDashRing_Task>; // size: 0xC, address: 0x6B8D88
void * __dt(class clsDashRing_Obj *, signed short); // size: 0x0, address: 0x2D86E0
struct /* @anon12 */ {
    // total size: 0x48
} __vt__77clsBaseGimmickBody<16clsDashRing_Task,15clsDashRing_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6B8DA0
struct /* @anon7 */ {
    // total size: 0x28
...
struct /* @anon2 */ {
    // total size: 0x58
} __vt__15clsDashRing_Obj; // size: 0x58, address: 0x6BEAF0
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x67D180
...
// Range: 0x367BC0 -> 0x367DC0
void draw(class clsDashRing_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x367BC0 -> 0x367DC0
...
// Range: 0x367DC0 -> 0x367FAC
void execute(class clsDashRing_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x367DC0 -> 0x367FAC
        class clsBaseRace_Task & rcBaseRace_Task; // r2
...
// Range: 0x367FB0 -> 0x36848C
void contactTriggerEvent(class clsDashRing_Obj * this /* r20 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x367FB0 -> 0x36848C
        class clsPlayerTask * pcHitPlayer; // r19
        float (* psMtxPal)[4][4]; // r18
        class NNS_VECTORFAST sVecFast; // r29+0x60
        float f32Rad; // r29+0x80
        unsigned char u8PathNo; // r29+0x7F
    }
}


// Range: 0x368490 -> 0x368774
void draw(class clsDashRing_Obj * this /* r20 */, class clsModelType_OB_TX & rcObj /* r19 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r21 */, float (* opaNnViewMtx)[4][4] /* r17 */, float (* psMtxWork)[4][4] /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x368490 -> 0x368774
    }
...
// Range: 0x368780 -> 0x3687C8
void destroyData(class clsDashRing_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x368780 -> 0x3687C8
    }
...
// Range: 0x3687D0 -> 0x368AA4
void createData(class clsDashRing_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3687D0 -> 0x368AA4
        class NNS_VECTOR sScaleVec; // r29+0xC0
    }
}
