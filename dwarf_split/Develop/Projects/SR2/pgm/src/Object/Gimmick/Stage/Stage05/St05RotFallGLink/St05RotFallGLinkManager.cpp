/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage05\St05RotFallGLink\St05RotFallGLinkManager.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon2 */ {
    // total size: 0x44
} __vt__29clsRotFallGLinkManager_Object; // size: 0x44, address: 0x6C4EC0
class stcTask sTask; // size: 0x30, address: 0xB0A900
class clsRotFallGLink_Task * m_tpcSingleton; // size: 0x4, address: 0xB17270
void * __dt(class clsRotFallGLink_Object *, signed short); // size: 0x0, address: 0x446450
struct /* @anon6 */ {
    // total size: 0xB4
} __vt__24clsBaseGravityLinkObject; // size: 0xB4, address: 0x6C1420
struct /* @anon10 */ {
    // total size: 0xB8
} __vt__22clsRotFallGLink_Object; // size: 0xB8, address: 0x6C4F10
struct /* @anon9 */ {
    // total size: 0x28
...
void * __ct(class clsRotFallGLink_Object *); // size: 0x0, address: 0x4465E0
float t_sBaseMtx[4][4]; // size: 0x40, address: 0xB17280
float t_sBaseInvMtx[4][4]; // size: 0x40, address: 0xB172C0
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x6877D0
...
// Range: 0x446330 -> 0x4463F4
void stop(class clsRotFallGLinkManager_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x446330 -> 0x4463F4
        class clsRotFallGLink_Object * pcObject; // r20
        signed int i; // r19
        unsigned int u32Check; // r18
        unsigned int u32Reset; // r17
    }
}


// Range: 0x446400 -> 0x44644C
void destroyData(class clsRotFallGLinkManager_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x446400 -> 0x44644C
    }
...
// Range: 0x4464F0 -> 0x4465D4
void createData(class clsRotFallGLinkManager_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4464F0 -> 0x4465D4
        class clsRotFallGLink_Object * pcObject; // r18
        signed int s32Num; // r17
    }
}


// Range: 0x446650 -> 0x4467DC
void setData(class clsRotFallGLinkManager_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x446650 -> 0x4467DC
    }
...
// Range: 0x4467E0 -> 0x446964
void draw(class clsRotFallGLinkManager_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4467E0 -> 0x446964
        class clsRotFallGLink_Object * pcObject; // r21
        signed int i; // r20
...
// Range: 0x446970 -> 0x446AC8
void execute(class clsRotFallGLinkManager_Object * this /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x446970 -> 0x446AC8
        class clsRotFallGLink_Object * pcObject; // r21
...
// Range: 0x446AD0 -> 0x446B40
void reset(class clsRotFallGLinkManager_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x446AD0 -> 0x446B40
        class clsRotFallGLink_Object * pcObject; // r17
        signed int i; // r16
    }
}


// Range: 0x446B40 -> 0x446BCC
void * __dt(class clsRotFallGLinkManager_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x446B40 -> 0x446BCC
    }
...
// Range: 0x446BD0 -> 0x446CA4
void * __ct(class clsRotFallGLinkManager_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x446BD0 -> 0x446CA4
    }
