/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage12\St12MotionObj.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x697E50
struct /* @anon3 */ {
    // total size: 0x48
} __vt__21clsSt12MotionObj_Task; // size: 0x48, address: 0x6D0760
struct /* @anon8 */ {
    // total size: 0x48
} __vt__101clsSingleModelGimmick_Task<21clsSt12MotionObj_Task,20clsSt12MotionObj_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6D0810
struct /* @anon5 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsSt12MotionObj_Task * m_tpcSingleton; // size: 0x4, address: 0xBFB380
struct /* @anon0 */ {
    // total size: 0xC
} __vt__37clsSingleton<21clsSt12MotionObj_Task>; // size: 0xC, address: 0x6D07A8
void * __dt(class clsSt12MotionObj_Obj *, signed short); // size: 0x0, address: 0x55EBA0
struct /* @anon2 */ {
    // total size: 0x48
} __vt__93clsBaseGimmickBody<21clsSt12MotionObj_Task,20clsSt12MotionObj_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6D07C0
struct /* @anon10 */ {
    // total size: 0x28
...
struct /* @anon9 */ {
    // total size: 0x48
} __vt__20clsSt12MotionObj_Obj; // size: 0x48, address: 0x6D0860
...
void * __ct(class clsSt12MotionObj_Obj *); // size: 0x0, address: 0x55F540
...
struct /* @anon6 */ {
    // total size: 0x34
} __vt__32clsSt12MotionObjThroughCollision; // size: 0x34, address: 0x6D08B0
...
public:
    ...
    class clsSt12MotionObjThroughCollision * m_pcCollision; // offset 0x58, size 0x4
    class hkShape * m_pcShape; // offset 0x5C, size 0x4
    float m_f32MotionFrame; // offset 0x60, size 0x4
    unsigned char m_bSePlayFlg; // offset 0x64, size 0x1
};
...
class clsSt12MotionObjThroughCollision : public clsBaseThroughCollision {
    // total size: 0xC
public:
    class clsSt12MotionObj_Obj * m_pcBridge; // offset 0x8, size 0x4
};
class stcSpeedPath {
    // total size: 0x10
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsSt12MotionObj_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsSt12MotionObj_Task : public clsSingleModelGimmick_Task {
    // total size: 0xAC
};
...
// Range: 0x55EC30 -> 0x55EEC0
void draw(class clsSt12MotionObj_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55EC30 -> 0x55EEC0
...
// Range: 0x55EF60 -> 0x55F0F0
void execute(class clsSt12MotionObj_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55EF60 -> 0x55F0F0
...
// Range: 0x55F0F0 -> 0x55F160
void reset(class clsSt12MotionObj_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55F0F0 -> 0x55F160
        unsigned int u32Num; // r2
...
// Range: 0x55F160 -> 0x55F1CC
void * __ct(class clsSt12MotionObj_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55F160 -> 0x55F1CC
    }
...
// Range: 0x55F610 -> 0x55F670
void destroyData(class clsSt12MotionObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55F610 -> 0x55F670
    }
...
// Range: 0x55F700 -> 0x55F7D0
void createData(class clsSt12MotionObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55F700 -> 0x55F7D0
...
// Range: 0x55F7E0 -> 0x55F7F0
void reset(class clsSt12MotionObj_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55F7E0 -> 0x55F7F0
    }
...
// Range: 0x55F7F0 -> 0x55F810
void contactTriggerEvent(class clsSt12MotionObjThroughCollision * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55F7F0 -> 0x55F810
    }
