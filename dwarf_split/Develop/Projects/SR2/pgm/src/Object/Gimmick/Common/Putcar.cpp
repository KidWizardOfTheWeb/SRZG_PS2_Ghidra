/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\Putcar.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned int otau32Se_CarCrash[3]; // size: 0xC, address: 0x67E018
float tof32ClipSqDist; // size: 0x4, address: 0x67E028
unsigned int t_ou32DrawNode[2]; // size: 0x8, address: 0x67E030
struct /* @anon13 */ {
    // total size: 0x48
} __vt__14clsPutCar_Task; // size: 0x48, address: 0x6BEF60
struct /* @anon1 */ {
    // total size: 0x48
} __vt__80clsMultiModelGimmick_Task<14clsPutCar_Task,13clsPutCar_Obj,18clsMultiObTxModels>; // size: 0x48, address: 0x6BF010
struct /* @anon6 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPutCar_Task * m_tpcSingleton; // size: 0x4, address: 0xB13DE0
struct /* @anon9 */ {
    // total size: 0xC
} __vt__30clsSingleton<14clsPutCar_Task>; // size: 0xC, address: 0x6BEFA8
void * __dt(class clsModelType_OB_TX *, signed short); // size: 0x0, address: 0x1F27F0
void * __dt(class clsPutCar_Obj *, signed short); // size: 0x0, address: 0x370140
struct /* @anon17 */ {
    // total size: 0x48
} __vt__73clsBaseGimmickBody<14clsPutCar_Task,13clsPutCar_Obj,18clsMultiObTxModels>; // size: 0x48, address: 0x6BEFC0
struct /* @anon14 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon7 */ {
    // total size: 0xA8
} __vt__13clsPutCar_Obj; // size: 0xA8, address: 0x6BF060
struct /* @anon15 */ {
    // total size: 0x28
...
void * __ct(class clsPutCar_Obj *); // size: 0x0, address: 0x370F90
...
float t_of32DefaultMaxLinear; // size: 0x4, address: 0x681950
float t_of32DefaultAngularDamping; // size: 0x4, address: 0x681948
float t_of32DefaultLinearDamping; // size: 0x4, address: 0x681940
struct /* @anon20 */ {
    // total size: 0xC
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPutCar_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsPutCar_Task : public clsMultiModelGimmick_Task {
    // total size: 0x98
};
class hkPadSpu {
    // total size: 0x4
...
public:
    ...
    unsigned char m_u8ContactSeCount; // offset 0xD8, size 0x1
};
...
// Range: 0x370240 -> 0x3705CC
void draw(class clsPutCar_Task * this /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x370240 -> 0x3705CC
        ...
        class clsModelType_OB_TX * pcModel; // r2
        unsigned int sNodeStat; // r29+0x1BC
        float sMtxPal[4][4]; // r29+0x170
...
// Range: 0x3709B0 -> 0x370B08
void execute(class clsPutCar_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3709B0 -> 0x370B08
        unsigned int u32Num; // r10
        class clsModelType_OB_TX * pcModel; // r9
...
// Range: 0x370B10 -> 0x370B80
void reset(class clsPutCar_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x370B10 -> 0x370B80
        unsigned int u32Num; // r2
...
// Range: 0x370B80 -> 0x370C48
void * __ct(class clsPutCar_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x370B80 -> 0x370C48
...
// Range: 0x371050 -> 0x3710A4
void callbackContactTriggerRigidBody(class clsPutCar_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x371050 -> 0x3710A4
    }
...
// Range: 0x3710B0 -> 0x371164
void destroyData(class clsPutCar_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3710B0 -> 0x371164
    }
...
// Range: 0x371170 -> 0x371814
void createData(class clsPutCar_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x371170 -> 0x371814
        ...
        unsigned int u32Num; // r2
        char __FUNCTION__[14]; // @ 0x0067E008
    }
}


// Range: 0x371820 -> 0x3718A8
void setData(class clsPutCar_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x371820 -> 0x3718A8
    }
...
// Range: 0x3718B0 -> 0x371908
void requestDrawBreakEffect(class clsPutCar_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3718B0 -> 0x371908
    }
...
// Range: 0x371910 -> 0x3719AC
void main(class clsPutCar_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x371910 -> 0x3719AC
    }
...
// Range: 0x3719B0 -> 0x371A58
void reset(class clsPutCar_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3719B0 -> 0x371A58
