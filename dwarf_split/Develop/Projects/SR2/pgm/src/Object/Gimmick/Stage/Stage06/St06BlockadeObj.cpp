/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage06\St06BlockadeObj.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x6888B0
struct /* @anon6 */ {
    // total size: 0x48
} __vt__19clsBlockadeObj_Task; // size: 0x48, address: 0x6C6AA0
struct /* @anon16 */ {
    // total size: 0x48
} __vt__91clsSingleModelGimmick_Task<19clsBlockadeObj_Task,18clsBlockadeObj_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C6C00
struct /* @anon8 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsBlockadeObj_Task * m_tpcSingleton; // size: 0x4, address: 0xB174B0
struct /* @anon4 */ {
    // total size: 0xC
} __vt__35clsSingleton<19clsBlockadeObj_Task>; // size: 0xC, address: 0x6C6B98
void * __dt(class clsBlockadeObj_Obj *, signed short); // size: 0x0, address: 0x46DA30
struct /* @anon7 */ {
    // total size: 0x48
} __vt__83clsBaseGimmickBody<19clsBlockadeObj_Task,18clsBlockadeObj_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C6BB0
struct /* @anon14 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon3 */ {
    // total size: 0xA8
} __vt__18clsBlockadeObj_Obj; // size: 0xA8, address: 0x6C6AF0
struct /* @anon13 */ {
    // total size: 0x28
...
void * __ct(class clsBlockadeObj_Obj *); // size: 0x0, address: 0x46E4F0
...
class clsBlockadeObj_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
enum enmSelectType {
    SELECT_NORMAL = 0,
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsBlockadeObj_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x46DB30 -> 0x46DE18
void draw(class clsBlockadeObj_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46DB30 -> 0x46DE18
...
// Range: 0x46DEC0 -> 0x46E000
void execute(class clsBlockadeObj_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46DEC0 -> 0x46E000
...
// Range: 0x46E000 -> 0x46E070
void reset(class clsBlockadeObj_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46E000 -> 0x46E070
        unsigned int u32Num; // r2
...
// Range: 0x46E070 -> 0x46E0D8
void reset(class clsBlockadeObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46E070 -> 0x46E0D8
    }
...
// Range: 0x46E0E0 -> 0x46E198
void * __ct(class clsBlockadeObj_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46E0E0 -> 0x46E198
...
// Range: 0x46E5B0 -> 0x46E624
void destroyData(class clsBlockadeObj_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46E5B0 -> 0x46E624
    }
...
// Range: 0x46E630 -> 0x46EB88
void createData(class clsBlockadeObj_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46E630 -> 0x46EB88
        ...
        char __FUNCTION__[14]; // @ 0x006888A0
    }
}


// Range: 0x46EB90 -> 0x46EBE4
void setData(class clsBlockadeObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46EB90 -> 0x46EBE4
    }
...
// Range: 0x46EBF0 -> 0x46EBFC
void requestDrawBreakEffect(class clsBlockadeObj_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46EBF0 -> 0x46EBFC
    }
...
// Range: 0x46EC00 -> 0x46ECC8
void main(class clsBlockadeObj_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46EC00 -> 0x46ECC8
    }
