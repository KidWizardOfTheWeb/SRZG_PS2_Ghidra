/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage03\St03Cogwheel.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x67E978
static float toaf32MissionRotAngle[3]; // size: 0xC, address: 0x67E980
class NNS_VECTORFAST m_tosPartsOffsetFast[12]; // size: 0xC0, address: 0x67E990
class NNS_VECTOR m_tosThroughCollisionPosVec[5]; // size: 0x3C, address: 0x67EA50
float m_tof32ThroughCollisionRotY[5]; // size: 0x14, address: 0x67EA90
struct /* @anon19 */ {
    // total size: 0x44
} __vt__15clsCogwheel_Obj; // size: 0x44, address: 0x6BFC30
struct /* @anon11 */ {
    // total size: 0x28
...
void * __dt(class clsCogwheel_Parts *, signed short); // size: 0x0, address: 0x3891B0
struct /* @anon3 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon6 */ {
    // total size: 0xA8
} __vt__17clsCogwheel_Parts; // size: 0xA8, address: 0x6BFD30
struct /* @anon13 */ {
    // total size: 0xC
...
class clsCogwheel_Task * m_tpcSingleton; // size: 0x4, address: 0xB15E20
...
void * __dt(class clsCogwheelThroughCollision *, signed short); // size: 0x0, address: 0x38AEB0
void * __ct(class clsCogwheelThroughCollision *); // size: 0x0, address: 0x38AF40
struct /* @anon8 */ {
    // total size: 0x48
} __vt__16clsCogwheel_Task; // size: 0x48, address: 0x6BFC90
void * __dt(class clsCogwheel_Obj *, signed short); // size: 0x0, address: 0x389100
void * __ct(class clsCogwheel_Obj *); // size: 0x0, address: 0x38AFC0
struct /* @anon20 */ {
    // total size: 0x48
} __vt__75clsBaseGimmickBody<16clsCogwheel_Task,15clsCogwheel_Obj,16clsCogWhellModel>; // size: 0x48, address: 0x6BFCE0
struct /* @anon5 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
struct /* @anon15 */ {
    // total size: 0xC
} __vt__32clsSingleton<16clsCogwheel_Task>; // size: 0xC, address: 0x6BFC78
struct /* @anon14 */ {
    // total size: 0x30
...
struct /* @anon17 */ {
    // total size: 0x34
} __vt__27clsCogwheelThroughCollision; // size: 0x34, address: 0x6BFDE0
void * __ct(class clsCogwheel_Parts *); // size: 0x0, address: 0x38B0B0
...
class stcInfo oasGroundInfo[]; // size: 0x0, address: 0x66AE40
...
class clsCogwheel_Task : public clsBaseGimmickBody {
    // total size: 0x138
public:
    class hkShape * m_pcThroughShape[2]; // offset 0xA0, size 0x8
    class clsCogwheelThroughCollision m_acCollision[5]; // offset 0xA8, size 0x64
    enum enmState m_eState; // offset 0x10C, size 0x4
    unsigned int m_u32PlayerFlg; // offset 0x110, size 0x4
    signed int m_s32CollisionNum; // offset 0x114, size 0x4
    class _stcShapeInfo * m_apcShape; // offset 0x118, size 0x4
    class NNS_NODE * m_psNodeList; // offset 0x11C, size 0x4
    class vector m_vctShapeSearch; // offset 0x120, size 0xC
    class hkArray m_vctpcShape; // offset 0x12C, size 0xC
};
...
class hkArray {
    // total size: 0xC
public:
    class hkConvexShape * * m_data; // offset 0x0, size 0x4
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xA0
public:
    class clsCogwheel_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsCogWhellModel m_cModel; // offset 0x88, size 0x14
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0x9C, size 0x4
};
...
class clsCogwheel_Parts : public clsRigidBodyGimmickObj {
    // total size: 0xF0
public:
    enum enmMode m_eMode; // offset 0xD0, size 0x4
    class clsCogwheel_Obj * m_pcCogwheelObj; // offset 0xD4, size 0x4
    unsigned int m_u32PartsNo; // offset 0xD8, size 0x4
    class NNS_VECTORFAST m_sCrushPosVecFast; // offset 0xE0, size 0x10
};
...
class clsCogwheel_Obj : public clsGimmickObj {
    // total size: 0xBD0
public:
    enum enmCogwheelMode m_eCogwheelMode; // offset 0x50, size 0x4
    enum enmCogwheelState m_eCogwheelState; // offset 0x54, size 0x4
    float m_f32MotionFrame; // offset 0x58, size 0x4
    float m_f32StartWaitFrame; // offset 0x5C, size 0x4
    float m_f32AddFrame; // offset 0x60, size 0x4
    float m_f32Angle; // offset 0x64, size 0x4
    unsigned int m_u32BreakFlg; // offset 0x68, size 0x4
    unsigned int m_u32GroundFlg; // offset 0x6C, size 0x4
    unsigned int m_u32WallFlg; // offset 0x70, size 0x4
    class clsCogwheel_Parts m_acParts[12]; // offset 0x80, size 0xB40
    class clsSe3DControl * m_pcSe3DControl; // offset 0xBC0, size 0x4
};
enum enmFlag {
    FLAG_CLEAR = 0,
    FLAG_VIBRATION = 1,
...
class clsCogwheelThroughCollision : public clsBaseThroughCollision {
    // total size: 0x14
public:
    enum enmMode m_eMode; // offset 0x8, size 0x4
    class clsCogwheel_Task * m_pcCogwheel_Task; // offset 0xC, size 0x4
    class clsCogwheel_Obj * m_pcCogwheel_Obj; // offset 0x10, size 0x4
};
...
class stcBinBody {
    // total size: 0x20
public:
    float * pf32Vertex; // offset 0x0, size 0x4
    unsigned short * pu16Triangle; // offset 0x4, size 0x4
    unsigned int u32VertexNum; // offset 0x8, size 0x4
    unsigned int u32TriangleNum; // offset 0xC, size 0x4
    class stcInfo sInfo; // offset 0x10, size 0x10
};
class hkPadSpu {
    // total size: 0x4
public:
...
class _stcShapeInfo {
    // total size: 0x8
public:
    class hkShape * pcShape; // offset 0x0, size 0x4
    unsigned int u32CollisionNum; // offset 0x4, size 0x4
};
class stcCtrlData {
    // total size: 0x50
public:
...
class stcBinHeader {
    // total size: 0x10
public:
    unsigned int u32Version; // offset 0x0, size 0x4
    unsigned int u32Num; // offset 0x4, size 0x4
    enum enmType eType; // offset 0x8, size 0x4
    unsigned int u32Padding; // offset 0xC, size 0x4
};
class __vector_imp : private __vector_pod, private compile_assert {
    // total size: 0xC
};
...
class clsCogWhellModel {
    // total size: 0x14
public:
    class clsModelType_OB_TX_MO m_cModel; // offset 0x0, size 0x10
...
class hkArray {
    // total size: 0xC
public:
    class Triangle * m_data; // offset 0x0, size 0x4
    signed int m_size; // offset 0x4, size 0x4
    signed int m_capacityAndFlags; // offset 0x8, size 0x4
};
class clsPlaySe_2D {
...
class Triangle {
    // total size: 0xC
public:
    signed int m_a; // offset 0x0, size 0x4
    signed int m_b; // offset 0x4, size 0x4
    signed int m_c; // offset 0x8, size 0x4
};
...
class hkGeometry {
    // total size: 0x18
public:
    class hkArray m_vertices; // offset 0x0, size 0xC
    class hkArray m_triangles; // offset 0xC, size 0xC
};
...
class hkArray {
    // total size: 0xC
public:
    class hkVector4 * m_data; // offset 0x0, size 0x4
    signed int m_size; // offset 0x4, size 0x4
    signed int m_capacityAndFlags; // offset 0x8, size 0x4
};
class stcScriptInfo {
...
class hkStridedVertices {
    // total size: 0xC
public:
    float * m_vertices; // offset 0x0, size 0x4
    signed int m_numVertices; // offset 0x4, size 0x4
    signed int m_striding; // offset 0x8, size 0x4
};
class stcPortalBin {
    // total size: 0x8
public:
...
// Range: 0x3892B0 -> 0x38981C
void draw(class clsCogwheel_Task * this /* r29+0xEC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3892B0 -> 0x38981C
        unsigned int u32Num; // r2
        unsigned int * psNodeStat; // r2
        unsigned int u32ViewNo; // r29+0xD0
        float (* opaNnViewMtx)[4][4]; // r30
        float (* psMtxPal)[4][4]; // r2
        class clsModelType_OB_TX_MO & rcModel; // r2
        class clsModelType_OB_TX * pcModelObTx; // r22
        float sMtx[4][4]; // r29+0x180
        unsigned int u32i; // r20
    }
}


// Range: 0x3898E0 -> 0x389CD4
void execute(class clsCogwheel_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3898E0 -> 0x389CD4
        unsigned int u32Num; // r2
...
// Range: 0x389CE0 -> 0x389D28
void executeParts(class clsCogwheel_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x389CE0 -> 0x389D28
        unsigned int u32i; // r17
        class clsCogwheel_Parts * pcParts; // r16
    }
}


// Range: 0x389D30 -> 0x389DC0
void reset(class clsCogwheel_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x389D30 -> 0x389DC0
        unsigned int u32Num; // r17
        class clsCogwheel_Parts * pcParts; // r16
    }
}


// Range: 0x389DC0 -> 0x389E34
void stepMotoinFrame(class clsCogwheel_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x389DC0 -> 0x389E34
        float * pf32Frame; // r2
...
// Range: 0x389EB0 -> 0x38A070
void init(class clsCogwheel_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x389EB0 -> 0x38A070
    }
...
// Range: 0x38A090 -> 0x38A128
float getMissionRot(class clsCogwheel_Task * this /* r17 */, class clsCogwheel_Obj * pcObj /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x38A090 -> 0x38A128
        float f32Rot; // r20
...
// Range: 0x38A130 -> 0x38A618
void createModel(class clsCogwheel_Task * this /* r19 */, class stcBinInfo & rsBinInfoI /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x38A130 -> 0x38A618
        unsigned int u32CalcObjNum; // r2
        void * opvColli; // r16
        class stcBinHeader * psHeader; // r2
        class stcBinBody * psBody; // r21
        class _stcShapeInfo * apcShape; // r18
        signed int s32i; // r20
        class hkStridedVertices stridedVerts; // r29+0xD0
        class hkArray planeEquations; // r29+0xC0
        class hkGeometry geom; // r29+0x90
        signed char toau8ShapeList[12][2]; // r29+0x70
        class hkArray shapeArray; // r29+0xB0
    }
}


// Range: 0x38A700 -> 0x38A7D8
void createThroughCollision(class clsCogwheel_Task * this /* r20 */, enum enmThroughCollisionNum eColissionNum /* r19 */, enum enmMode eMode /* r18 */, unsigned char u8ShapeNum /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x38A700 -> 0x38A7D8
        class NNS_QUATERNION sQuat; // r29+0x60
        class clsCogwheelThroughCollision & rsCollision; // r16
    }
}


// Range: 0x38A7E0 -> 0x38A91C
void reset(class clsCogwheel_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x38A7E0 -> 0x38A91C
        unsigned int u32Num; // r2
...
// Range: 0x38A920 -> 0x38A9AC
void resetPartsParam(class clsCogwheel_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x38A920 -> 0x38A9AC
        unsigned int u32Num; // r17
...
// Range: 0x38A9C0 -> 0x38AC04
void * __ct(class clsCogwheel_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x38A9C0 -> 0x38AC04
        class hkVector4 cHelfBoxSize; // r29+0x50
    }
}


// Range: 0x38B1D0 -> 0x38B320
void debugDrawCollision(class clsCogwheel_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x38B1D0 -> 0x38B320
        ...
        signed int s32i; // r16
        class NNS_VECTORFAST sLocalVecFast; // r29+0x30
        class NNS_VECTORFAST sPosVecFast; // r29+0x20
        class NNS_VECTOR sPosVec; // r29+0xC0
    }
}


// Range: 0x38B320 -> 0x38B38C
void destroyData(class clsCogwheel_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x38B320 -> 0x38B38C
        class clsCogwheel_Parts * pcParts; // r17
        unsigned int u32Num; // r16
    }
}


// Range: 0x38B390 -> 0x38B4A4
void createData(class clsCogwheel_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x38B390 -> 0x38B4A4
        class clsCogwheel_Parts * pcParts; // r17
        unsigned int u32i; // r16
        class clsSe3DControl * pcSe3DControl; // r2
    }
}


// Range: 0x38B4B0 -> 0x38B4B8
void main() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x38B4B0 -> 0x38B4B8
...
// Range: 0x38B4C0 -> 0x38B594
void contactTriggerEvent(class clsCogwheel_Parts * this /* r17 */, class hkContactPoint * pcContact /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x38B4C0 -> 0x38B594
...
// Range: 0x38B5A0 -> 0x38B680
void callbackCrashEvent(class clsCogwheel_Parts * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x38B5A0 -> 0x38B680
        float sMtx[4][4]; // r29+0x50
        class NNS_VECTORFAST & rsPosVecFast; // r16
    }
}


// Range: 0x38B680 -> 0x38B688
void requestDrawCrashEffect() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x38B680 -> 0x38B688
    }
...
// Range: 0x38B690 -> 0x38B6E0
void requestDrawBreakEffect(class clsCogwheel_Parts * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x38B690 -> 0x38B6E0
    }
...
// Range: 0x38B6E0 -> 0x38B720
void destroyData(class clsCogwheel_Parts * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x38B6E0 -> 0x38B720
    }
...
// Range: 0x38B720 -> 0x38B944
void createData(class clsCogwheel_Parts * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x38B720 -> 0x38B944
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0x40
        class clsContactControl & rcContactControl; // r2
    }
}


// Range: 0x38B950 -> 0x38BA6C
void reset(class clsCogwheel_Parts * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x38B950 -> 0x38BA6C
        class clsGimmickRigidBody * pcRigidBody; // r17
        class hkVector4 cZero; // r29+0x60
        class NNS_QUATERNION sRotQuat; // r29+0x50
        class clsCogwheel_Obj * pcObj; // r2
    }
}


// Range: 0x38BA70 -> 0x38BBA8
void contactTriggerEvent(class clsCogwheelThroughCollision * this /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x38BA70 -> 0x38BBA8
    }
