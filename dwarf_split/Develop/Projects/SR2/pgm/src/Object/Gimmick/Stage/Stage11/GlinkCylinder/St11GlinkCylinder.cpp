/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage11\GlinkCylinder\St11GlinkCylinder.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x68AB08
float tof32ClipSqDist; // size: 0x4, address: 0x68AB18
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x68AB20
struct /* @anon3 */ {
    // total size: 0x48
} __vt__21clsGlinkCylinder_Task; // size: 0x48, address: 0x6C8880
struct /* @anon12 */ {
    // total size: 0x48
} __vt__102clsSingleModelGimmick_Task<21clsGlinkCylinder_Task,27clsGlinkCylinderManager_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C8980
struct /* @anon7 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsGlinkCylinder_Task * m_tpcSingleton; // size: 0x4, address: 0xB17AD8
struct /* @anon19 */ {
    // total size: 0xC
} __vt__37clsSingleton<21clsGlinkCylinder_Task>; // size: 0xC, address: 0x6C8918
void * __dt(class clsGlinkCylinderManager_Obj *, signed short); // size: 0x0, address: 0x4A8780
struct /* @anon4 */ {
    // total size: 0x48
} __vt__94clsBaseGimmickBody<21clsGlinkCylinder_Task,27clsGlinkCylinderManager_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C8930
struct /* @anon14 */ {
    // total size: 0x28
...
struct /* @anon8 */ {
    // total size: 0x34
} __vt__26clsGlinkCylinderThroughCol; // size: 0x34, address: 0x6C89D0
struct /* @anon5 */ {
    // total size: 0x44
} __vt__27clsGlinkCylinderManager_Obj; // size: 0x44, address: 0x6C88D0
...
void * __ct(class clsGlinkCylinderManager_Obj *); // size: 0x0, address: 0x4A9020
...
class clsGlinkCylinder_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
class clsCamIvBase {
    // total size: 0x4
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsGlinkCylinderManager_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
public:
    ...
    unsigned int m_u32Num; // offset 0x54, size 0x4
    class clsGlinkCylinder_Object * m_pcCylinders; // offset 0x58, size 0x4
    class stcSetDataDetail * m_psSetData; // offset 0x5C, size 0x4
    class clsGlinkCylinderThroughCol m_cThroughCol; // offset 0x60, size 0x10
};
class DebugEntry {
    // total size: 0x3
public:
...
class clsGlinkCylinderThroughCol : public clsBaseThroughCollision {
    // total size: 0x10
public:
    class clsGlinkCylinderManager_Obj * m_pcManager; // offset 0x8, size 0x4
...
// Range: 0x4A8870 -> 0x4A8A3C
void draw(class clsGlinkCylinder_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A8870 -> 0x4A8A3C
...
// Range: 0x4A8A40 -> 0x4A8B38
void execute(class clsGlinkCylinder_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A8A40 -> 0x4A8B38
        unsigned int u32Num; // r2
...
// Range: 0x4A8B40 -> 0x4A8BA0
void reset(class clsGlinkCylinder_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A8B40 -> 0x4A8BA0
        unsigned int u32Num; // r2
...
// Range: 0x4A8BA0 -> 0x4A8CC8
void * __ct(class clsGlinkCylinder_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A8BA0 -> 0x4A8CC8
...
// Range: 0x4A91D0 -> 0x4A944C
void draw(class clsGlinkCylinder_Object * this /* r17 */, class NNS_OBJECT * psObject /* r16 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r20 */, float (* psMtxWork)[4][4] /* r19 */, unsigned int u32ViewNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A91D0 -> 0x4A944C
    }
...
// Range: 0x4A9450 -> 0x4A955C
void main(class clsGlinkCylinder_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A9450 -> 0x4A955C
...
// Range: 0x4A9560 -> 0x4A9568
void callbackGravityEvent(class clsGlinkCylinder_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A9560 -> 0x4A9568
    }
...
// Range: 0x4A9570 -> 0x4A960C
void stepPathFrame(class clsGlinkCylinder_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A9570 -> 0x4A960C
        class clsGimmickPath & rcGimmickPath; // r6
    }
}


// Range: 0x4A9610 -> 0x4A9658
void start(class clsGlinkCylinder_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A9610 -> 0x4A9658
    }
...
// Range: 0x4A9660 -> 0x4A96B8
void callbackContactTriggerRigidBody(class clsGlinkCylinder_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A9660 -> 0x4A96B8
    }
...
// Range: 0x4A96C0 -> 0x4A9790
void requestDrawBreakEffect(class clsGlinkCylinder_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A96C0 -> 0x4A9790
    }
...
void drawEffect(class clsPlayerTask * pcPlayer /* r16 */) {
    ...
    /* anonymous block */ {
        ...
        class NNS_VECTOR LOCAL_POS_R; // @ 0x0068ABC8
        class NNS_VECTOR LOCAL_POS; // @ 0x0068ABB8
        class NNS_VECTOR RAND_SP; // @ 0x0068ABA8
        float LIFE_FRAME; // @ 0x0068ABD8
        class NNS_VECTOR BEGIN_SP; // @ 0x0068AB98
    }
}


// Range: 0x4A98B0 -> 0x4A9930
void destroyData(class clsGlinkCylinder_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A98B0 -> 0x4A9930
    }
...
// Range: 0x4A9930 -> 0x4A9DF0
void createData(class clsGlinkCylinder_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A9930 -> 0x4A9DF0
...
// Range: 0x4A9DF0 -> 0x4A9E60
void setData(class clsGlinkCylinder_Object * this /* r7 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A9DF0 -> 0x4A9E60
    }
...
// Range: 0x4A9E60 -> 0x4A9FCC
void reset(class clsGlinkCylinder_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A9E60 -> 0x4A9FCC
