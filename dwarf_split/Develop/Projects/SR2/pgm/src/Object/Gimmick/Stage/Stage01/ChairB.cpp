/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage01\ChairB.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x676D68
struct /* @anon5 */ {
    // total size: 0x48
} __vt__14clsChairB_Task; // size: 0x48, address: 0x6BD9E0
struct /* @anon14 */ {
    // total size: 0x48
} __vt__81clsSingleModelGimmick_Task<14clsChairB_Task,13clsChairB_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BDA90
struct /* @anon3 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsChairB_Task * m_tpcSingleton; // size: 0x4, address: 0xB0D9C0
struct /* @anon4 */ {
    // total size: 0xC
} __vt__30clsSingleton<14clsChairB_Task>; // size: 0xC, address: 0x6BDA28
void * __dt(class clsChairB_Obj *, signed short); // size: 0x0, address: 0x34C1D0
struct /* @anon7 */ {
    // total size: 0x48
} __vt__73clsBaseGimmickBody<14clsChairB_Task,13clsChairB_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BDA40
struct /* @anon11 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon1 */ {
    // total size: 0xA8
} __vt__13clsChairB_Obj; // size: 0xA8, address: 0x6BDAE0
struct /* @anon12 */ {
    // total size: 0x28
...
void * __ct(class clsChairB_Obj *); // size: 0x0, address: 0x34CA20
...
class clsChairB_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsChairB_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x34C2D0 -> 0x34C4B0
void draw(class clsChairB_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34C2D0 -> 0x34C4B0
...
// Range: 0x34C4B0 -> 0x34C590
void execute(class clsChairB_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34C4B0 -> 0x34C590
        unsigned int u32Num; // r2
...
// Range: 0x34C590 -> 0x34C600
void reset(class clsChairB_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34C590 -> 0x34C600
        unsigned int u32Num; // r2
...
// Range: 0x34C600 -> 0x34C6C4
void * __ct(class clsChairB_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34C600 -> 0x34C6C4
...
// Range: 0x34CAE0 -> 0x34CE98
void draw(class clsChairB_Obj * this /* r21 */, class clsModelType_OB_TX & rcObj /* r20 */, float (* psMtxPal)[4][4] /* r19 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r30 */, float (* psMtxWork)[4][4] /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34CAE0 -> 0x34CE98
...
// Range: 0x34CEA0 -> 0x34CF20
void main(class clsChairB_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34CEA0 -> 0x34CF20
    }
...
// Range: 0x34CF20 -> 0x34CFA4
void reset(class clsChairB_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34CF20 -> 0x34CFA4
    }
...
// Range: 0x34CFB0 -> 0x34D010
void destroyData(class clsChairB_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34CFB0 -> 0x34D010
    }
...
// Range: 0x34D010 -> 0x34D36C
void createData(class clsChairB_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x34D010 -> 0x34D36C
