/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\SurvivalBattle\SvlBtlExplosion.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float t_of32CLIP_DISTx2; // size: 0x4, address: 0x697BA8
struct /* @anon3 */ {
    // total size: 0x48
} __vt__23clsSvlBtlExplosion_Task; // size: 0x48, address: 0x6D0190
struct /* @anon10 */ {
    // total size: 0x48
} __vt__108clsSingleModelGimmick_Task<23clsSvlBtlExplosion_Task,25clsSvlBtlExplosion_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6D0290
struct /* @anon0 */ {
    // total size: 0x38
...
struct /* @anon2 */ {
    // total size: 0xC
} __vt__39clsSingleton<23clsSvlBtlExplosion_Task>; // size: 0xC, address: 0x6D0228
void * __dt(class clsSvlBtlExplosion_Object *, signed short); // size: 0x0, address: 0x553E10
struct /* @anon4 */ {
    // total size: 0x48
} __vt__100clsBaseGimmickBody<23clsSvlBtlExplosion_Task,25clsSvlBtlExplosion_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6D0240
struct /* @anon6 */ {
    // total size: 0x28
...
struct /* @anon1 */ {
    // total size: 0x44
} __vt__25clsSvlBtlExplosion_Object; // size: 0x44, address: 0x6D01E0
...
void * __ct(class clsSvlBtlExplosion_Object *); // size: 0x0, address: 0x554800
...
enum enmDamageType {
    DAMAGE_TYPE__MISSILE = 0,
    DAMAGE_TYPE__BOMB = 1,
    DAMAGE_TYPE__GIMMICK = 2,
    DAMAGE_TYPE__GRAVITY = 3,
    DAMAGE_TYPE__FALL = 4,
};
...
// Range: 0x553EB0 -> 0x553F90
void start(class clsSvlBtlExplosion_Task * this /* r21 */, class NNS_VECTORFAST * opsPosVecFast /* r20 */, class clsPlayerTask * pcOwner /* r19 */, enum enmDamageType eDamageType /* r18 */, float f32StartRadius /* r22 */, float f32EndRadius /* r21 */, float f32Frame /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x553EB0 -> 0x553F90
...
// Range: 0x553F90 -> 0x554214
void draw(class clsSvlBtlExplosion_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x553F90 -> 0x554214
        unsigned int u32Num; // r2
        ...
        float sWorkMtx[4][4]; // r29+0xC0
        unsigned int u32i; // r17
    }
}


// Range: 0x554220 -> 0x554300
void execute(class clsSvlBtlExplosion_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x554220 -> 0x554300
        unsigned int u32Num; // r2
...
// Range: 0x554300 -> 0x554394
void reset(class clsSvlBtlExplosion_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x554300 -> 0x554394
        unsigned int u32Num; // r2
...
// Range: 0x5543A0 -> 0x554498
void * __ct(class clsSvlBtlExplosion_Task * this /* r18 */, class stcSetDataDetail & orsSetDataDetailI /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5543A0 -> 0x554498
        signed int i; // r16
...
// Range: 0x5548F0 -> 0x554A7C
void start(class clsSvlBtlExplosion_Object * this /* r18 */, class NNS_VECTORFAST * opsPosVecFast /* r2 */, class clsPlayerTask * pcOwner /* r17 */, enum enmDamageType eDamageType /* r16 */, float f32StartRadius /* r23 */, float f32EndRadius /* r22 */, float f32Frame /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5548F0 -> 0x554A7C
        float f32EndFrame; // r20
        float f32Scale; // r29+0x70
        class hkAabb cAabb; // r29+0x50
    }
}


// Range: 0x554A80 -> 0x554D1C
void execute(class clsSvlBtlExplosion_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x554A80 -> 0x554D1C
        float f32EndFrame; // r29+0x90
    }
}


// Range: 0x554D20 -> 0x554DE4
void contactGimmick(class clsRigidBodyGimmickObj * pcGimmick /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x554D20 -> 0x554DE4
    }
...
// Range: 0x554DF0 -> 0x554EB0
void contactPlayer(class clsSvlBtlExplosion_Object * this /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x554DF0 -> 0x554EB0
        enum enmDamageType eType; // r8
    }
}


// Range: 0x554FA0 -> 0x554FB0
class hkCollidable * & __vc(class hkArray * this /* r2 */, signed int i /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x554FA0 -> 0x554FB0
    }
...
// Range: 0x554FB0 -> 0x554FB8
signed int getSize(class hkArray * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x554FB0 -> 0x554FB8
    }
