/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage02\St02Bee.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class NNS_VECTORFAST toasPointVecFast_0[4]; // size: 0x40, address: 0x67CC20
static class NNS_VECTORFAST toasPointVecFast_1[5]; // size: 0x50, address: 0x67CC60
static class NNS_VECTORFAST toasPointVecFast_2[4]; // size: 0x40, address: 0x67CCB0
static class NNS_VECTORFAST toasPointVecFast_3[5]; // size: 0x50, address: 0x67CCF0
static class NNS_VECTORFAST toasPointVecFast_4[4]; // size: 0x40, address: 0x67CD40
static class NNS_VECTORFAST toasPointVecFast_5[5]; // size: 0x50, address: 0x67CD80
static class NNS_VECTORFAST toasPointVecFast_6[4]; // size: 0x40, address: 0x67CDD0
static class NNS_VECTORFAST toasPointVecFast_7[5]; // size: 0x50, address: 0x67CE10
static class NNS_VECTORFAST toasPointVecFast_8[5]; // size: 0x50, address: 0x67CE60
static class NNS_VECTORFAST toasPointVecFast_9[5]; // size: 0x50, address: 0x67CEB0
static class NNS_VECTORFAST toasPointVecFast_10[5]; // size: 0x50, address: 0x67CF00
static class NNS_VECTORFAST toasPointVecFast_11[5]; // size: 0x50, address: 0x67CF50
static class NNS_VECTORFAST * toapsPointTable[12]; // size: 0x30, address: 0x627CC0
static unsigned int toau32PointNumTable[12]; // size: 0x30, address: 0x67CFA0
static float CLIP_DISTx2; // size: 0x4, address: 0x67CFD0
struct /* @anon9 */ {
    // total size: 0x48
} __vt__15clsBeeRobo_Task; // size: 0x48, address: 0x6BE880
struct /* @anon0 */ {
    // total size: 0x48
} __vt__83clsSingleModelGimmick_Task<15clsBeeRobo_Task,14clsBeeRobo_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BE990
struct /* @anon2 */ {
    // total size: 0x38
...
struct /* @anon8 */ {
    // total size: 0xC
} __vt__31clsSingleton<15clsBeeRobo_Task>; // size: 0xC, address: 0x6BE930
void * __dt(class clsBeeRobo_Obj *, signed short); // size: 0x0, address: 0x364C60
struct /* @anon11 */ {
    // total size: 0x48
} __vt__75clsBaseGimmickBody<15clsBeeRobo_Task,14clsBeeRobo_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BE940
struct /* @anon4 */ {
    // total size: 0x28
...
struct /* @anon7 */ {
    // total size: 0x50
} __vt__14clsBeeRobo_Obj; // size: 0x50, address: 0x6BE8E0
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x67D060
class clsPfCri * m_tpcSingleton; // size: 0x4, address: 0x6E6998
struct /* @anon5 */ {
    // total size: 0x30
} __vt__7clsTask; // size: 0x30, address: 0x6B59F0
void * __ct(class clsBeeRobo_Obj *); // size: 0x0, address: 0x366920
...
// Range: 0x364D10 -> 0x365004
void draw(class clsBeeRobo_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x364D10 -> 0x365004
        unsigned int u32Num; // r2
        unsigned int * psNodeStat; // r2
        unsigned int u32ViewNo; // r18
...
// Range: 0x365500 -> 0x3656A4
void execute(class clsBeeRobo_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x365500 -> 0x3656A4
        unsigned int u32Num; // r2
...
// Range: 0x3656B0 -> 0x36597C
void setNextPoint(class clsBeeRobo_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3656B0 -> 0x36597C
        signed int s32NowPointNo; // r2
        class NNS_VECTORFAST sVecFast; // r29+0xF0
        float f32Rot; // r4
    }
}


// Range: 0x3659F0 -> 0x365A6C
unsigned int checkWaitFrame(class clsBeeRobo_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3659F0 -> 0x365A6C
...
// Range: 0x365A70 -> 0x365FB8
void moveUpDown(class clsBeeRobo_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x365A70 -> 0x365FB8
        float f32PosY; // r29+0xF0
        class clsPlayerTask * pcPlayer; // r18
        class NNS_VECTORFAST sDirVecFast; // r29+0xE0
        float f32Length; // r29+0xF0
        float f32NearestLength; // r20
        unsigned int u32i; // r17
        unsigned int u32NearestNo; // r16
        float f32Rot; // r4
        float f32DifRot; // r1
    }
}
...
// Range: 0x365FC0 -> 0x366130
void movePoint(class clsBeeRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x365FC0 -> 0x366130
...
// Range: 0x3662C0 -> 0x3663B0
void init(class clsBeeRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3662C0 -> 0x3663B0
    }
...
// Range: 0x3663C0 -> 0x3664F4
void reset(class clsBeeRobo_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3663C0 -> 0x3664F4
        unsigned int u32Num; // r2
...
// Range: 0x366500 -> 0x3665BC
void * __ct(class clsBeeRobo_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x366500 -> 0x3665BC
    }
