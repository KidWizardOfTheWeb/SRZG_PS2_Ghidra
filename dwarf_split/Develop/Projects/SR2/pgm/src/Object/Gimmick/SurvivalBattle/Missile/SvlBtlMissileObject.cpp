/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\SurvivalBattle\Missile\SvlBtlMissileObject.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x696320
float tof32ClipSqDist; // size: 0x4, address: 0x696330
float tof32ShootSpeed; // size: 0x4, address: 0x0
float tof32CruiseSpeed; // size: 0x4, address: 0x0
float tof32ShootFrame; // size: 0x4, address: 0x0
float tof32CruiseFrame; // size: 0x4, address: 0x0
float tof32ShootHomigRate; // size: 0x4, address: 0x0
float tof32CruiseHomingRate; // size: 0x4, address: 0x0
float tof32PlayerHitRange; // size: 0x4, address: 0x0
class NNS_VECTOR tosOffsetVec_1st; // size: 0xC, address: 0x696338
class NNS_VECTOR tosAccurcayVec_1st; // size: 0xC, address: 0x696348
float tof32RangeDotPro_1st; // size: 0x4, address: 0x0
class NNS_VECTOR tosOffsetVec_2nd; // size: 0xC, address: 0x696358
class NNS_VECTOR tosAccurcayVec_2nd; // size: 0xC, address: 0x696368
float tof32RangeDotPro_2nd; // size: 0x4, address: 0x0
float tof32HormingRate_2nd; // size: 0x4, address: 0x0
static class stcParam sSvlBtlMissileLineParam[20]; // size: 0x500, address: 0x696380
static class stcGimickSubParam sSvlBtlMissileLineSubParam; // size: 0x20, address: 0x696880
struct /* @anon5 */ {
    // total size: 0xA8
} __vt__23clsSvlBtlMissile_Object; // size: 0xA8, address: 0x6CE770
...
class clsSvlBtlExplosion_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA7C0
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x6968D0
...
class NNS_VECTORFAST m_OffsetPosVecFastTable[4]; // size: 0x40, address: 0x6968E0
...
class clsSvlBtlExplosion_Task : public clsSingleModelGimmick_Task {
    // total size: 0xAC
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsSvlBtlExplosion_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsSvlBtlExplosion_Object : public clsGimmickObj {
    // total size: 0x80
public:
    class clsPlayerTask * m_pcOwner; // offset 0x50, size 0x4
    class hkAabbPhantom * m_pcPhantom; // offset 0x54, size 0x4
    enum enmMode m_eMode; // offset 0x58, size 0x4
    enum enmDamageType m_eDamageType; // offset 0x5C, size 0x4
    float m_f32Scale; // offset 0x60, size 0x4
    float m_f32AddScale; // offset 0x64, size 0x4
    float m_f32LimitFrame; // offset 0x68, size 0x4
    float m_f32MatFrame; // offset 0x6C, size 0x4
    float m_f32MatAddFrame; // offset 0x70, size 0x4
};
class FreeList {
    // total size: 0x8
public:
...
class hkAabbPhantom : public hkPhantom {
    // total size: 0xA0
public:
    class hkAabb m_aabb; // offset 0x70, size 0x20
    class hkArray m_overlappingCollidables; // offset 0x90, size 0xC
};
...
// Range: 0x5323F0 -> 0x532448
void requestDrawBreakEffect(class clsSvlBtlMissile_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5323F0 -> 0x532448
    }
...
// Range: 0x532450 -> 0x5325E0
void checkHitPlayer(class clsSvlBtlMissile_Object * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x532450 -> 0x5325E0
        class clsPlayerTask * pcPlayer; // r2
        signed int i; // r18
        signed int s32HitNo; // r17
    }
}


// Range: 0x5325E0 -> 0x532678
void shoot(class clsSvlBtlMissile_Object * this /* r16 */, signed int s32LockOnNo /* r2 */, float f32Frame /* r29+0x20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5325E0 -> 0x532678
    }
...
// Range: 0x532680 -> 0x532690
void charge(class clsSvlBtlMissile_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x532680 -> 0x532690
    }
...
// Range: 0x532690 -> 0x5326A8
void setup(class clsSvlBtlMissile_Object * this /* r2 */, signed int s32PlayerNo /* r2 */, signed int s32PositionNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x532690 -> 0x5326A8
    }
...
// Range: 0x5326B0 -> 0x53272C
void callbackBreakEvent(class clsSvlBtlMissile_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5326B0 -> 0x53272C
        class clsPlayerTask * pcPlayer; // r2
...
// Range: 0x532730 -> 0x5328CC
void contactTriggerCallback(class clsSvlBtlMissile_Object * this /* r17 */, class hkContactPointConfirmedEvent & cEvent /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x532730 -> 0x5328CC
    }
...
// Range: 0x5328D0 -> 0x532910
void destroyData(class clsSvlBtlMissile_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5328D0 -> 0x532910
    }
...
// Range: 0x532910 -> 0x532BD4
void createData(class clsSvlBtlMissile_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x532910 -> 0x532BD4
...
// Range: 0x532BF0 -> 0x5341B8
void main(class clsSvlBtlMissile_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x532BF0 -> 0x5341B8
        class clsRigidBody * pcRigidBody; // r18
        float sTrsMtx[4][4]; // r29+0x4E0
        class NNS_VECTORFAST sEffPos; // r29+0x4D0
        class NNS_VECTORFAST sOffsetPos; // r29+0x4C0
        float sTrsMtx[4][4]; // r29+0x480
        class NNS_VECTORFAST sSpeedVecFast; // r29+0x470
        class NNS_VECTORFAST sMoveVecFast; // r29+0x460
        class hkVector4 cZero; // r29+0x450
        class clsRigidBody * pcRigidBody; // r17
        class hkVector4 cZero; // r29+0x440
        class NNS_VECTORFAST sAcceleVecFast; // r29+0x430
        class NNS_VECTORFAST sForceVecFast; // r29+0x420
        class hkVector4 cZero; // r29+0x410
        class NNS_VECTORFAST sAcceleVecFast; // r29+0x400
        class NNS_VECTORFAST sForceVecFast; // r29+0x3F0
    }
}


// Range: 0x5341D0 -> 0x5341EC
class clsPlayerTask * getPlayerPtr(class clsSvlBtlMissile_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5341D0 -> 0x5341EC
    }
...
// Range: 0x534210 -> 0x5345B4
void calcHomingRad(class clsSvlBtlMissile_Object * this /* r17 */, class NNS_VECTORFAST * opsTrgVecFast /* r18 */, float f32Rate /* r20 */, class NNS_QUATERNION & rsQuat /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x534210 -> 0x5345B4
        class NNS_QUATERNION sRotQuat; // r29+0x100
        float sTrsMtx[4][4]; // r29+0xC0
        float sInvMtx[4][4]; // r29+0x80
        class NNS_VECTORFAST sDirVecFast; // r29+0x70
        class NNS_VECTORFAST sPosVecFast; // r29+0x60
...
// Range: 0x5345E0 -> 0x534710
void reset(class clsSvlBtlMissile_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5345E0 -> 0x534710
        class clsPlayerTask * pcPlayer; // r2
...
// Range: 0x534710 -> 0x5349CC
void draw(class clsSvlBtlMissile_Object * this /* r17 */, class NNS_OBJECT * psObject /* r16 */, float (* psMtxPal)[4][4] /* r20 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r20 */, float (* psMtxWork)[4][4] /* r19 */, unsigned int u32ViewNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x534710 -> 0x5349CC
        float sMtx[4][4]; // r29+0xB0
    }
}


// Range: 0x5349D0 -> 0x534AB0
void * __dt(class clsSvlBtlMissile_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5349D0 -> 0x534AB0
    }
...
// Range: 0x534AB0 -> 0x534C4C
void * __ct(class clsSvlBtlMissile_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x534AB0 -> 0x534C4C
    }
...
// Range: 0x534C50 -> 0x534C58
void @80@__dt__23clsSvlBtlMissile_ObjectFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x534C50 -> 0x534C58
    }
