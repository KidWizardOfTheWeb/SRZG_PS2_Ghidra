/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage15\St15BlackHole.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x48
} __vt__17clsBlackHole_Task; // size: 0x48, address: 0x6C50D0
struct /* @anon11 */ {
    // total size: 0x48
} __vt__93clsSingleModelGimmick_Task<17clsBlackHole_Task,16clsBlackHole_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C51D0
struct /* @anon2 */ {
    // total size: 0x38
...
struct /* @anon1 */ {
    // total size: 0xC
} __vt__33clsSingleton<17clsBlackHole_Task>; // size: 0xC, address: 0x6C5168
void * __dt(class clsBlackHole_Obj *, signed short); // size: 0x0, address: 0x448CB0
struct /* @anon4 */ {
    // total size: 0x48
} __vt__85clsBaseGimmickBody<17clsBlackHole_Task,16clsBlackHole_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C5180
struct /* @anon5 */ {
    // total size: 0x28
...
void * __dt(class clsPosturalCtrl *, signed short); // size: 0x0, address: 0x2C35F0
struct /* @anon7 */ {
    // total size: 0x44
} __vt__16clsBlackHole_Obj; // size: 0x44, address: 0x6C5120
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x687A30
...
class NNS_VECTOR tosZeroVec; // size: 0xC, address: 0x687A10
...
void * __ct(class clsBlackHole_Obj *); // size: 0x0, address: 0x44A670
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
void * __ct(class clsPosturalCtrl *); // size: 0x0, address: 0x2C3BC0
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x687A20
struct /* @anon12 */ {
    // total size: 0xC
...
// Range: 0x448D50 -> 0x448E90
void endBlackHole(class clsBlackHole_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x448D50 -> 0x448E90
...
// Range: 0x448E90 -> 0x449158
void setBlackHole(class clsBlackHole_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x448E90 -> 0x449158
        ...
        signed int s32UserNum; // r2
        signed int s32i; // r20
        float f32Distance; // r24
    }
}


// Range: 0x449160 -> 0x44956C
void draw(class clsBlackHole_Task * this /* r29+0xCC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x449160 -> 0x44956C
...
// Range: 0x449580 -> 0x449B30
void execute(class clsBlackHole_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x449580 -> 0x449B30
        signed int s32UserNum; // r2
        ...
        class stcSetDataDetail sSetDataDetail; // @ 0x00B17340
    }
}


// Range: 0x449BE0 -> 0x449C34
void reset(class clsBlackHole_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x449BE0 -> 0x449C34
    }
...
// Range: 0x449C60 -> 0x44A184
void update(class clsBlackHole_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x449C60 -> 0x44A184
        class clsPlayerTask * pcPlayer; // r2
        class NNS_VECTORFAST sVecFast; // r29+0x150
        float f32MoveDist; // r29+0x160
        float sMtx[4][4]; // r29+0x110
        class NNS_QUATERNION sQuat; // r29+0x100
        class NNS_VECTORFAST sXVecFast; // r29+0xF0
        float sMtx[4][4]; // r29+0xB0
        class NNS_QUATERNION sQuat; // r29+0xA0
        class NNS_VECTORFAST sXVecFast; // r29+0x90
        signed int s32i; // r21
        signed int s32PartsNum; // r20
    }
}


// Range: 0x44A1B0 -> 0x44A244
void reset(class clsBlackHole_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44A1B0 -> 0x44A244
        unsigned int u32Num; // r2
...
// Range: 0x44A250 -> 0x44A2FC
void * __ct(class clsBlackHole_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x44A250 -> 0x44A2FC
    }
