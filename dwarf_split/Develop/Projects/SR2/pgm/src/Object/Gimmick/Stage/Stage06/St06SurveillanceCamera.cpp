/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage06\St06SurveillanceCamera.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x688790
signed int toA32RotateAdd; // size: 0x4, address: 0x0
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x6887A0
struct /* @anon18 */ {
    // total size: 0x48
} __vt__26clsSurveillanceCamera_Task; // size: 0x48, address: 0x6C68F0
struct /* @anon5 */ {
    // total size: 0x48
} __vt__105clsSingleModelGimmick_Task<26clsSurveillanceCamera_Task,25clsSurveillanceCamera_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C6A50
struct /* @anon6 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsSurveillanceCamera_Task * m_tpcSingleton; // size: 0x4, address: 0xB17460
struct /* @anon16 */ {
    // total size: 0xC
} __vt__42clsSingleton<26clsSurveillanceCamera_Task>; // size: 0xC, address: 0x6C69E8
void * __dt(class clsSurveillanceCamera_Obj *, signed short); // size: 0x0, address: 0x46BAE0
struct /* @anon0 */ {
    // total size: 0x48
} __vt__97clsBaseGimmickBody<26clsSurveillanceCamera_Task,25clsSurveillanceCamera_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C6A00
struct /* @anon13 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon9 */ {
    // total size: 0xA8
} __vt__25clsSurveillanceCamera_Obj; // size: 0xA8, address: 0x6C6940
struct /* @anon12 */ {
    // total size: 0x28
...
void * __ct(class clsSurveillanceCamera_Obj *); // size: 0x0, address: 0x46C6D0
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsSurveillanceCamera_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
public:
    ...
    enum enmSCameraMode m_eSCameraMode; // offset 0xD4, size 0x4
    enum enmSCameraStep m_eSCameraStep; // offset 0xD8, size 0x4
    signed int m_s32TurnDir; // offset 0xDC, size 0x4
    float m_f32WaitFrame; // offset 0xE0, size 0x4
    signed int m_A32MaxRotate; // offset 0xE4, size 0x4
    signed int m_A32Rotate; // offset 0xE8, size 0x4
    signed int m_A32RotateAdd; // offset 0xEC, size 0x4
};
...
class clsSurveillanceCamera_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
class _rand48 {
    // total size: 0xE
...
// Range: 0x46BBE0 -> 0x46BFC0
void draw(class clsSurveillanceCamera_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46BBE0 -> 0x46BFC0
        ...
        unsigned int u32Count; // r2
        unsigned int u32i; // r20
    }
}


// Range: 0x46C060 -> 0x46C140
void execute(class clsSurveillanceCamera_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46C060 -> 0x46C140
        unsigned int u32Num; // r2
...
// Range: 0x46C140 -> 0x46C1B0
void reset(class clsSurveillanceCamera_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46C140 -> 0x46C1B0
        unsigned int u32Num; // r2
...
// Range: 0x46C1B0 -> 0x46C27C
void reset(class clsSurveillanceCamera_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46C1B0 -> 0x46C27C
    }
...
// Range: 0x46C280 -> 0x46C378
void * __ct(class clsSurveillanceCamera_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46C280 -> 0x46C378
    }
...
// Range: 0x46C790 -> 0x46C810
void destroyData(class clsSurveillanceCamera_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46C790 -> 0x46C810
    }
...
// Range: 0x46C810 -> 0x46CC18
void createData(class clsSurveillanceCamera_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46C810 -> 0x46CC18
        ...
        unsigned int oau32Se[2][2]; // r29+0x60
        unsigned int * pau32Se; // r2
    }
}


// Range: 0x46CC20 -> 0x46CC8C
void setData(class clsSurveillanceCamera_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46CC20 -> 0x46CC8C
    }
...
// Range: 0x46CC90 -> 0x46CCE4
void requestDrawBreakEffect(class clsSurveillanceCamera_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46CC90 -> 0x46CCE4
    }
...
// Range: 0x46CCF0 -> 0x46CDC0
void main(class clsSurveillanceCamera_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46CCF0 -> 0x46CDC0
    }
...
// Range: 0x46CDC0 -> 0x46CDD0
void callbackContactTriggerRigidBody(class clsSurveillanceCamera_Obj * this /* r4 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46CDC0 -> 0x46CDD0
    }
