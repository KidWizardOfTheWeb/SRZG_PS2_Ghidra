/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage12\St12PathCanoeMotion.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x697A68
static float CLIP_DISTx2; // size: 0x4, address: 0x697A70
unsigned int otau32Se_CanoeBreak[2]; // size: 0x8, address: 0x697A78
unsigned int otau32Se_CanoeExp[2]; // size: 0x8, address: 0x697A80
unsigned int otau32Se_CanoeL[2]; // size: 0x8, address: 0x697A88
struct /* @anon18 */ {
    // total size: 0x48
} __vt__23clsPathCanoeMotion_Task; // size: 0x48, address: 0x6CFC90
struct /* @anon17 */ {
    // total size: 0x48
} __vt__102clsSingleModelGimmick_Task<23clsPathCanoeMotion_Task,22clsPathCanoeMotion_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6CFD40
struct /* @anon20 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPathCanoeMotion_Task * m_tpcSingleton; // size: 0x4, address: 0xBFB2D0
struct /* @anon3 */ {
    // total size: 0xC
} __vt__39clsSingleton<23clsPathCanoeMotion_Task>; // size: 0xC, address: 0x6CFCD8
void * __dt(class clsPathCanoeMotion_Obj *, signed short); // size: 0x0, address: 0x54DED0
struct /* @anon5 */ {
    // total size: 0x48
} __vt__94clsBaseGimmickBody<23clsPathCanoeMotion_Task,22clsPathCanoeMotion_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6CFCF0
struct /* @anon4 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon15 */ {
    // total size: 0xA8
} __vt__22clsPathCanoeMotion_Obj; // size: 0xA8, address: 0x6CFD90
struct /* @anon10 */ {
    // total size: 0x28
...
void * __ct(class clsPathCanoeMotion_Obj *); // size: 0x0, address: 0x54EC00
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x697AE0
...
struct /* @anon16 */ {
    // total size: 0x30
} __vt__45clsGmkBurnLight_Task<21clsModelType_OB_TX_MO>; // size: 0x30, address: 0x6CCFE0
...
public:
    ...
    float m_f32SpeedOld; // offset 0x228, size 0x4
    class NNS_VECTORFAST m_sOldUpVecFast; // offset 0x230, size 0x10
    unsigned int m_u32TexIdx; // offset 0x240, size 0x4
    float m_f32MotionFrame; // offset 0x244, size 0x4
    float m_f32EndFrame; // offset 0x248, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0x24C, size 0x4
};
class clsPathCanoeMotion_Task : public clsSingleModelGimmick_Task {
    // total size: 0xA8
public:
    class clsGmkBurnLight_Task * m_pcBurnLightTask; // offset 0x9C, size 0x4
    unsigned short * m_TexIdx; // offset 0xA0, size 0x4
    unsigned short * m_TexIdx2; // offset 0xA4, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x9C
public:
    class clsPathCanoeMotion_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x54DFD0 -> 0x54E420
void draw(class clsPathCanoeMotion_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54DFD0 -> 0x54E420
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        class clsGmkBurnLight_Task * pcBurnLightTask; // r2
        unsigned int u32Num; // r2
        unsigned int * psNodeStat; // r17
        float (* opaNnViewMtx)[4][4]; // r22
        float (* psMtxPal)[4][4]; // r23
        class clsModelType_OB_TX_MO & rcModel; // r16
        float sMtxWork[4][4]; // r29+0xA0
        float f32MotionFrame; // r29+0xEC
        unsigned int u32i; // r21
    }
}


// Range: 0x54E420 -> 0x54E6C4
void execute(class clsPathCanoeMotion_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54E420 -> 0x54E6C4
...
// Range: 0x54E6D0 -> 0x54E774
void reset(class clsPathCanoeMotion_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54E6D0 -> 0x54E774
        unsigned int u32Num; // r2
...
// Range: 0x54E780 -> 0x54E898
void * __ct(class clsPathCanoeMotion_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54E780 -> 0x54E898
...
// Range: 0x54ED90 -> 0x54F02C
void boundAction(class clsPathCanoeMotion_Obj * this /* r16 */, class clsPlayerTask * pcPlayerTask /* r3 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54ED90 -> 0x54F02C
...
// Range: 0x54F030 -> 0x54F094
void contactTriggerEvent(class clsPathCanoeMotion_Obj * this /* r16 */, class hkContactPoint * pcContact /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54F030 -> 0x54F094
    }
...
// Range: 0x54F0A0 -> 0x54F0F4
void callbackCrashEvent(class clsPathCanoeMotion_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54F0A0 -> 0x54F0F4
    }
...
// Range: 0x54F100 -> 0x54F1B8
void destroyData(class clsPathCanoeMotion_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54F100 -> 0x54F1B8
    }
...
// Range: 0x54F1C0 -> 0x54F230
void callbackGravityEvent(class clsPathCanoeMotion_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54F1C0 -> 0x54F230
    }
...
// Range: 0x54F230 -> 0x54F544
unsigned char draw(class clsPathCanoeMotion_Obj * this /* r19 */, class clsModelType_OB_TX_MO & rcObj /* r18 */, float (* psMtxPal)[4][4] /* r20 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r22 */, float (* psMtxWork)[4][4] /* r17 */, unsigned int u32TexNo /* r2 */, float * f32MotionFrame /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54F230 -> 0x54F544
...
// Range: 0x54F550 -> 0x54F7D4
void main(class clsPathCanoeMotion_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54F550 -> 0x54F7D4
    }
...
// Range: 0x54F7E0 -> 0x54F7E8
void setData(class clsPathCanoeMotion_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54F7E0 -> 0x54F7E8
    }
...
// Range: 0x54F7F0 -> 0x54F8B4
void requestDrawBreakEffect(class clsPathCanoeMotion_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54F7F0 -> 0x54F8B4
...
// Range: 0x54F8C0 -> 0x54FFC8
void path_main(class clsPathCanoeMotion_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54F8C0 -> 0x54FFC8
...
// Range: 0x54FFD0 -> 0x5501EC
void reset(class clsPathCanoeMotion_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x54FFD0 -> 0x5501EC
...
// Range: 0x5501F0 -> 0x550894
void createData(class clsPathCanoeMotion_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5501F0 -> 0x550894
        ...
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        char __FUNCTION__[14]; // @ 0x00697A58
    }
}


// Range: 0x5508A0 -> 0x550AD8
void initParameter(class clsPathCanoeMotion_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5508A0 -> 0x550AD8
        class NNS_QUATERNION sEndQuat; // r29+0x30
        class NNS_VECTORFAST sDirVecFast; // r29+0x20
        float f32RadY; // r29+0x40
    }
}


// Range: 0x550AE0 -> 0x550AE8
void init(class clsPathCanoeMotion_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x550AE0 -> 0x550AE8
    }
