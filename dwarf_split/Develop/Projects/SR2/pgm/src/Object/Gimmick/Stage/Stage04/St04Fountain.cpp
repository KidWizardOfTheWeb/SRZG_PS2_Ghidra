/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage04\St04Fountain.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x685320
static float CLIP_DISTx2; // size: 0x4, address: 0x685328
struct /* @anon19 */ {
    // total size: 0x48
} __vt__16clsFountain_Task; // size: 0x48, address: 0x6C2F00
void * __dt(class clsFountain_Obj *, signed short); // size: 0x0, address: 0x40F9E0
struct /* @anon6 */ {
    // total size: 0x48
} __vt__76clsBaseGimmickBody<16clsFountain_Task,15clsFountain_Obj,17clsFountainModels>; // size: 0x48, address: 0x6C2F60
struct /* @anon16 */ {
    // total size: 0x30
...
struct /* @anon4 */ {
    // total size: 0xA8
} __vt__15clsFountain_Obj; // size: 0xA8, address: 0x6C2FB0
struct /* @anon15 */ {
    // total size: 0x28
...
void * __ct(class clsFountain_Obj *); // size: 0x0, address: 0x410C00
class clsFountain_Task * m_tpcSingleton; // size: 0x4, address: 0xB16DE0
struct /* @anon0 */ {
    // total size: 0xC
} __vt__32clsSingleton<16clsFountain_Task>; // size: 0xC, address: 0x6C2F48
...
struct /* @anon9 */ {
    // total size: 0x34
} __vt__27clsFountainThroughCollision; // size: 0x34, address: 0x6C3060
struct /* @anon3 */ {
    // total size: 0xC
...
class clsFountainThroughCollision : public clsBaseThroughCollision {
    // total size: 0xC
public:
    class clsFountain_Obj * m_pcFountain; // offset 0x8, size 0x4
};
...
class clsFountain_Task : public clsBaseGimmickBody {
    // total size: 0xA8
public:
    float * m_pf32TexCoordV; // offset 0x9C, size 0x4
    float * m_pf32TexCoordV_Under; // offset 0xA0, size 0x4
    float * m_pf32TexCoordV_Column; // offset 0xA4, size 0x4
};
...
class clsFountain_Obj : public clsRigidBodyGimmickObj {
    // total size: 0x160
public:
    enum enmFountainMode m_eMode; // offset 0xD0, size 0x4
    enum enmWaterColumnMode m_eWaterColumnMode; // offset 0xD4, size 0x4
    unsigned char m_bWaterColumnDarw; // offset 0xD8, size 0x1
    class NNS_VECTORFAST * m_opsPointVecFast; // offset 0xDC, size 0x4
    float m_psMtx[4][4]; // offset 0xE0, size 0x40
    float m_f32WaterColumnScale_y; // offset 0x120, size 0x4
    float m_f32WaterColumnScale_xz; // offset 0x124, size 0x4
    float m_f32WaterColumnFrame; // offset 0x128, size 0x4
    float m_f32UpSpeed; // offset 0x12C, size 0x4
    float m_f32DownSpeed; // offset 0x130, size 0x4
    unsigned int m_u32OldCount; // offset 0x134, size 0x4
    class clsFountainThroughCollision * m_pcCollision; // offset 0x138, size 0x4
    class hkShape * m_pcShape; // offset 0x13C, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0x140, size 0x4
    float m_f32MotionFrame; // offset 0x144, size 0x4
    class clsTask * m_psWaterParticle; // offset 0x148, size 0x4
    class NNS_VECTORFAST m_sSetPosFast; // offset 0x150, size 0x10
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x9C
public:
    class clsFountain_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsFountainModels m_cModel; // offset 0x88, size 0x10
...
class clsFountainModels {
    // total size: 0x10
public:
    class clsModelType_OB_TX m_cFountain; // offset 0x0, size 0x8
    class clsModelType_OB_TX m_cWaterColumn; // offset 0x8, size 0x8
};
class NNS_ROTATE {
    // total size: 0xC
public:
...
// Range: 0x40FAE0 -> 0x41021C
void draw(class clsFountain_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40FAE0 -> 0x41021C
        ...
        class clsFountainModels & rcModels; // r2
        float sMtxWork[4][4]; // r29+0x130
        unsigned int u32i; // r19
    }
}


// Range: 0x410310 -> 0x410660
void execute(class clsFountain_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x410310 -> 0x410660
        float * pf32TexCoordV; // r2
        float * pf32TexCoordV_Under; // r2
        float * pf32TexCoordV_Column; // r2
        unsigned int u32Num; // r2
...
// Range: 0x410660 -> 0x410848
void createModel(class clsFountain_Task * this /* r2 */, class stcBinInfo & rsBinInfoI /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x410660 -> 0x410848
...
// Range: 0x410850 -> 0x4108C0
void reset(class clsFountain_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x410850 -> 0x4108C0
        unsigned int u32Num; // r2
...
// Range: 0x4108C0 -> 0x410A4C
void * __ct(class clsFountain_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4108C0 -> 0x410A4C
        class hkVector4 cBoxHalfSize; // r29+0x50
    }
}


// Range: 0x410D30 -> 0x410DF4
void destroyData(class clsFountain_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x410D30 -> 0x410DF4
    }
...
// Range: 0x410E90 -> 0x4112D4
void createData(class clsFountain_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x410E90 -> 0x4112D4
...
// Range: 0x4112E0 -> 0x411324
void setData(class clsFountain_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4112E0 -> 0x411324
    }
...
// Range: 0x411330 -> 0x41138C
void requestDrawBreakEffect(class clsFountain_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x411330 -> 0x41138C
...
// Range: 0x411390 -> 0x4113B0
void main(class clsFountain_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x411390 -> 0x4113B0
    }
...
// Range: 0x4113B0 -> 0x411458
void reset(class clsFountain_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4113B0 -> 0x411458
    }
...
// Range: 0x411460 -> 0x411490
void contactTriggerEvent(class clsFountainThroughCollision * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x411460 -> 0x411490
    }
...
// Range: 0x411490 -> 0x41149C
void callbackCrashEvent() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x411490 -> 0x41149C
    }
