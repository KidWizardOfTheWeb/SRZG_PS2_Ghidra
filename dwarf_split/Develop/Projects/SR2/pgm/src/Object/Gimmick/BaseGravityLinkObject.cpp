/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\BaseGravityLinkObject.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class clsGravityRing_Task * m_tpcSingleton; // size: 0x4, address: 0xB16470
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x6837C0
class stcTask sTask; // size: 0x30, address: 0xB0A900
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x6837D0
...
float toaf32BonusGLink[3]; // size: 0xC, address: 0x6837B0
...
// Range: 0x3EF8A0 -> 0x3EFFD0
void actionLinkPlayer(class clsBaseGravityLinkObject * this /* r19 */, class clsPlayerTask * pcPlayer /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3EF8A0 -> 0x3EFFD0
        class clsGravityDive * pcGravityDive; // r17
        float sMtx[4][4]; // r29+0x1B0
        float sRotMtx[4][4]; // r29+0x170
        float sInvMtx[4][4]; // r29+0x130
        class NNS_VECTORFAST sCollisionHalfSizeVec; // r29+0x120
        class NNS_VECTORFAST sLocalVecFast; // r29+0x110
        float f32Length; // r20
        class NNS_VECTORFAST sLocalVecFast; // r29+0x100
        class NNS_VECTORFAST sLocalUpVecFast; // r29+0xF0
        class NNS_VECTORFAST sDirVecFast; // r29+0xE0
        float f32Dist; // r29+0x1F0
        signed int s32LinkNum; // r2
        float f32BonusPoint; // r29+0x1F0
        class NNS_VECTORFAST sDirVecFast; // r29+0xD0
        class clsPathCourse * pcCoursePath; // r2
        class NNS_VECTORFAST sPathVecFast; // r29+0xC0
        class clsGravityRing_Object * pcGravityRing; // r2
    }
}
