/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage07\St07MapPartsGuardRailSmall.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x692D28
struct /* @anon0 */ {
    // total size: 0x48
} __vt__30clsMapPartsGuardRailSmall_Task; // size: 0x48, address: 0x6CC3C0
struct /* @anon4 */ {
    // total size: 0x48
} __vt__116clsSingleModelGimmick_Task<30clsMapPartsGuardRailSmall_Task,32clsMapPartsGuardRailSmall_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CC470
struct /* @anon2 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsMapPartsGuardRailSmall_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA740
struct /* @anon7 */ {
    // total size: 0xC
} __vt__46clsSingleton<30clsMapPartsGuardRailSmall_Task>; // size: 0xC, address: 0x6CC408
void * __dt(class clsMapPartsGuardRailSmall_Object *, signed short); // size: 0x0, address: 0x501610
struct /* @anon1 */ {
    // total size: 0x48
} __vt__108clsBaseGimmickBody<30clsMapPartsGuardRailSmall_Task,32clsMapPartsGuardRailSmall_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CC420
struct /* @anon3 */ {
    // total size: 0xA8
} __vt__32clsMapPartsGuardRailSmall_Object; // size: 0xA8, address: 0x6CC4C0
...
void * __ct(class clsMapPartsGuardRailSmall_Object *); // size: 0x0, address: 0x501F00
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsMapPartsGuardRailSmall_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsMapPartsGuardRailSmall_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
enum enmStartType {
    START_TYPE__JUMP = 0,
...
// Range: 0x501690 -> 0x501964
void draw(class clsMapPartsGuardRailSmall_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x501690 -> 0x501964
...
// Range: 0x501A70 -> 0x501AE0
void reset(class clsMapPartsGuardRailSmall_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x501A70 -> 0x501AE0
        unsigned int u32Num; // r2
...
// Range: 0x501AE0 -> 0x501BA4
void * __ct(class clsMapPartsGuardRailSmall_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x501AE0 -> 0x501BA4
...
// Range: 0x501F40 -> 0x501F7C
void createData(class clsMapPartsGuardRailSmall_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x501F40 -> 0x501F7C
    }
