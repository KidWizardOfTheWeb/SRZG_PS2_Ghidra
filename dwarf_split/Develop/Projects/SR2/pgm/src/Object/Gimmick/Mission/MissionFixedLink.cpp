/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Mission\MissionFixedLink.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x6989D0
struct /* @anon5 */ {
    // total size: 0x48
} __vt__24clsMissionFixedLink_Task; // size: 0x48, address: 0x6D0CF0
struct /* @anon10 */ {
    // total size: 0x48
} __vt__110clsSingleModelGimmick_Task<24clsMissionFixedLink_Task,26clsMissionFixedLink_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6D0E60
struct /* @anon6 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsMissionFixedLink_Task * m_tpcSingleton; // size: 0x4, address: 0xBFB3B8
struct /* @anon18 */ {
    // total size: 0xC
} __vt__40clsSingleton<24clsMissionFixedLink_Task>; // size: 0xC, address: 0x6D0DF8
void * __dt(class clsMissionFixedLink_Object *, signed short); // size: 0x0, address: 0x569870
struct /* @anon2 */ {
    // total size: 0x48
} __vt__102clsBaseGimmickBody<24clsMissionFixedLink_Task,26clsMissionFixedLink_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6D0E10
struct /* @anon17 */ {
    // total size: 0xB4
} __vt__24clsBaseGravityLinkObject; // size: 0xB4, address: 0x6C1420
struct /* @anon4 */ {
    // total size: 0xB4
} __vt__26clsMissionFixedLink_Object; // size: 0xB4, address: 0x6D0D40
struct /* @anon9 */ {
    // total size: 0x28
...
void * __ct(class clsMissionFixedLink_Object *); // size: 0x0, address: 0x569FE0
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
struct /* @anon14 */ {
    // total size: 0x28
} __vt__19clsGrindLinkControl; // size: 0x28, address: 0x6C15A0
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x6816D0
...
class clsMissionFixedLink_Object : public clsBaseGravityLinkObject {
    // total size: 0xF0
public:
    signed int m_s32BreakMode; // offset 0xE0, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsMissionFixedLink_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsMissionFixedLink_Task : public clsSingleModelGimmick_Task {
    // total size: 0xB0
public:
    float m_f32MatFrame; // offset 0xAC, size 0x4
};
...
// Range: 0x569910 -> 0x569A90
void draw(class clsMissionFixedLink_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x569910 -> 0x569A90
        ...
        class clsModelType_OB_TX_MO_MA & rcModel; // r22
...
// Range: 0x569A90 -> 0x569B88
void execute(class clsMissionFixedLink_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x569A90 -> 0x569B88
        unsigned int u32Num; // r2
...
// Range: 0x569B90 -> 0x569C00
void reset(class clsMissionFixedLink_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x569B90 -> 0x569C00
        unsigned int u32Num; // r2
...
// Range: 0x569C00 -> 0x569C70
void * __ct(class clsMissionFixedLink_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x569C00 -> 0x569C70
    }
...
// Range: 0x56A050 -> 0x56A090
void destroyData(class clsMissionFixedLink_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x56A050 -> 0x56A090
    }
...
// Range: 0x56A090 -> 0x56A3E0
void createData(class clsMissionFixedLink_Object * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x56A090 -> 0x56A3E0
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0x80
        class hkVector4 cHalfSize; // r29+0x70
    }
}


// Range: 0x56A3E0 -> 0x56A3FC
void setData(class clsMissionFixedLink_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x56A3E0 -> 0x56A3FC
    }
...
void drawEffect(class clsPlayerTask * pcPlayer /* r16 */) {
    ...
    /* anonymous block */ {
        ...
        class NNS_VECTOR LOCAL_POS_R; // @ 0x00698A08
        class NNS_VECTOR LOCAL_POS; // @ 0x006989F8
        class NNS_VECTOR RAND_SP; // @ 0x006989E8
        float LIFE_FRAME; // @ 0x00698A18
        class NNS_VECTOR BEGIN_SP; // @ 0x006989D8
    }
}


// Range: 0x56A520 -> 0x56A624
void main(class clsMissionFixedLink_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x56A520 -> 0x56A624
        class clsGrindLinkControl * pcLinkControl; // r2
    }
}


// Range: 0x56A630 -> 0x56A694
void reset(class clsMissionFixedLink_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x56A630 -> 0x56A694
        class clsRigidBody * pcRigidBody; // r2
    }
}


// Range: 0x56A6A0 -> 0x56A8FC
void draw(class clsMissionFixedLink_Object * this /* r20 */, class clsModelType_OB_TX_MO_MA & rcModel /* r19 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r23 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x56A6A0 -> 0x56A8FC
    }
