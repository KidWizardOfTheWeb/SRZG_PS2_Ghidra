/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\PutArrowObj.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x696B90
struct /* @anon14 */ {
    // total size: 0x48
} __vt__16clsPutArrow_Task; // size: 0x48, address: 0x6CEBC0
struct /* @anon1 */ {
    // total size: 0x48
} __vt__88clsSingleModelGimmick_Task<16clsPutArrow_Task,15clsPutArrow_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6B9D80
struct /* @anon2 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPutArrow_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A840
struct /* @anon8 */ {
    // total size: 0xC
} __vt__32clsSingleton<16clsPutArrow_Task>; // size: 0xC, address: 0x6B9D18
void * __dt(class clsPutArrow_Obj *, signed short); // size: 0x0, address: 0x2D1100
struct /* @anon12 */ {
    // total size: 0x48
} __vt__80clsBaseGimmickBody<16clsPutArrow_Task,15clsPutArrow_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6B9D30
struct /* @anon5 */ {
    // total size: 0x28
...
struct /* @anon9 */ {
    // total size: 0x58
} __vt__15clsPutArrow_Obj; // size: 0x58, address: 0x6B9CC0
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x9C
public:
    class clsPutArrow_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsPutArrow_Task : public clsSingleModelGimmick_Task {
    // total size: 0x9C
};
class GskFlags {
    // total size: 0x4
...
// Range: 0x53CC70 -> 0x53CE10
void draw(class clsPutArrow_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53CC70 -> 0x53CE10
...
// Range: 0x53CE10 -> 0x53CF5C
void execute(class clsPutArrow_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53CE10 -> 0x53CF5C
        unsigned int u32Num; // r2
...
// Range: 0x53CF70 -> 0x53D1D0
void draw(class clsPutArrow_Obj * this /* r19 */, class clsModelType_OB_TX_MO * pcModel /* r18 */, float (* psMtxPal)[4][4] /* r22 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r23 */, float (* opaBillBoardMtx)[4][4] /* r30 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53CF70 -> 0x53D1D0
...
// Range: 0x53D1D0 -> 0x53D2C4
void * __ct(class clsPutArrow_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53D1D0 -> 0x53D2C4
    }
