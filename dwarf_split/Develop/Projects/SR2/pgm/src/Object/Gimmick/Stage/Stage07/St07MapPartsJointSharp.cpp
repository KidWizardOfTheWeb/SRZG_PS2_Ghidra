/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage07\St07MapPartsJointSharp.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x696EA0
struct /* @anon1 */ {
    // total size: 0x48
} __vt__26clsMapPartsJointSharp_Task; // size: 0x48, address: 0x6CEC10
struct /* @anon4 */ {
    // total size: 0x48
} __vt__108clsSingleModelGimmick_Task<26clsMapPartsJointSharp_Task,28clsMapPartsJointSharp_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CECC0
struct /* @anon2 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsMapPartsJointSharp_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA7C8
struct /* @anon7 */ {
    // total size: 0xC
} __vt__42clsSingleton<26clsMapPartsJointSharp_Task>; // size: 0xC, address: 0x6CEC58
void * __dt(class clsMapPartsJointSharp_Object *, signed short); // size: 0x0, address: 0x53D5E0
struct /* @anon0 */ {
    // total size: 0x48
} __vt__100clsBaseGimmickBody<26clsMapPartsJointSharp_Task,28clsMapPartsJointSharp_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CEC70
struct /* @anon3 */ {
    // total size: 0xA8
} __vt__28clsMapPartsJointSharp_Object; // size: 0xA8, address: 0x6CED10
...
void * __ct(class clsMapPartsJointSharp_Object *); // size: 0x0, address: 0x53E2A0
...
class clsMapPartsJointSharp_Task : public clsSingleModelGimmick_Task {
    // total size: 0xA4
public:
    class hkTransformShape * m_pcTransShape[4]; // offset 0x94, size 0x10
};
class stcSeed {
    // total size: 0x30
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsMapPartsJointSharp_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x53D660 -> 0x53D934
void draw(class clsMapPartsJointSharp_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53D660 -> 0x53D934
...
// Range: 0x53DA40 -> 0x53DAB0
void reset(class clsMapPartsJointSharp_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53DA40 -> 0x53DAB0
        unsigned int u32Num; // r2
...
// Range: 0x53DAB0 -> 0x53DF48
void * __ct(class clsMapPartsJointSharp_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53DAB0 -> 0x53DF48
        class hkVector4 cHalfSize; // r29+0x90
        class hkQuaternion cQuat; // r29+0x80
        class hkTransform cTrans; // r29+0x40
        class hkArray shapeArray; // r29+0xA0
        class NNS_QUATERNION sRotQuat; // r29+0x30
    }
}


// Range: 0x53E2E0 -> 0x53E318
void createData(class clsMapPartsJointSharp_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x53E2E0 -> 0x53E318
    }
