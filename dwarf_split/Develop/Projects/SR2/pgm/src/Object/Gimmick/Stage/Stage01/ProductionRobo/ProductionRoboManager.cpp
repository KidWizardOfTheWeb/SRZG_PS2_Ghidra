/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage01\ProductionRobo\ProductionRoboManager.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon2 */ {
    // total size: 0x34
} __vt__26clsProductionRoboCollision; // size: 0x34, address: 0x6C6650
struct /* @anon7 */ {
    // total size: 0x28
...
struct /* @anon1 */ {
    // total size: 0x48
} __vt__22clsProductionRobo_Task; // size: 0x48, address: 0x6C66F0
void * __dt(class clsProductRoboManager_Obj *, signed short); // size: 0x0, address: 0x468220
void * __ct(class clsProductRoboManager_Obj *); // size: 0x0, address: 0x468300
struct /* @anon4 */ {
    // total size: 0x48
} __vt__96clsBaseGimmickBody<22clsProductionRobo_Task,25clsProductRoboManager_Obj,21clsSecurityRoboModels>; // size: 0x48, address: 0x6C6740
struct /* @anon5 */ {
    // total size: 0x38
...
struct /* @anon0 */ {
    // total size: 0xC
} __vt__38clsSingleton<22clsProductionRobo_Task>; // size: 0xC, address: 0x6C66D8
struct /* @anon8 */ {
    // total size: 0x30
...
struct /* @anon9 */ {
    // total size: 0x44
} __vt__25clsProductRoboManager_Obj; // size: 0x44, address: 0x6C6690
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
void * __dt(class stcRoboData *, signed short); // size: 0x0, address: 0x4684D0
float hkConvexShapeDefaultRadius; // size: 0x4, address: 0x6223B8
void * __ct(class stcRoboData *); // size: 0x0, address: 0x468880
struct /* @anon13 */ {
    // total size: 0xC
...
// Range: 0x4674D0 -> 0x467778
void draw(class clsProductionRobo_Task * this /* r29+0xEC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4674D0 -> 0x467778
        ...
        class clsSecurityRoboModels & rcModel; // r22
...
// Range: 0x467780 -> 0x4679D4
void execute(class clsProductionRobo_Task * this /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x467780 -> 0x4679D4
        unsigned int u32Num; // r2
...
// Range: 0x4679E0 -> 0x467BD0
void createModel(class clsProductionRobo_Task * this /* r19 */, class stcBinInfo & rsBinInfoI /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4679E0 -> 0x467BD0
...
// Range: 0x467C70 -> 0x467D3C
void reset(class clsProductionRobo_Task * this /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x467C70 -> 0x467D3C
        unsigned int u32Num; // r2
...
// Range: 0x467D40 -> 0x467F28
void * __ct(class clsProductionRobo_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x467D40 -> 0x467F28
...
// Range: 0x468470 -> 0x4684CC
void destroyData(class clsProductRoboManager_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x468470 -> 0x4684CC
    }
...
// Range: 0x468530 -> 0x468880
void createData(class clsProductRoboManager_Obj * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x468530 -> 0x468880
        signed int s32RoboNum; // r2
        class stcSetDataDetail * psSetData; // r20
        signed int s32i; // r22
        signed int s32j; // r19
        class stcRoboData * psRoboData; // r23
        class clsProductionRobo_Obj * pcObj; // r18
        unsigned int au32PathNo[2]; // r29+0xA8
        float af32Speed[2]; // r29+0xA0
        class hkVector4 cBox; // r29+0x90
        class hkShape * pcShape; // r2
    }
}


// Range: 0x4688C0 -> 0x4688D0
void setData(class clsProductRoboManager_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4688C0 -> 0x4688D0
    }
...
// Range: 0x4688D0 -> 0x468980
void contactTriggerEvent(class clsProductionRoboCollision * this /* r18 */, class clsPlayerTask * pcPlayer /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4688D0 -> 0x468980
    }
