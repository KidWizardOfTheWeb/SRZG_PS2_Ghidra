/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\PutMatMotGObj.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32CLIP_DISTx2; // size: 0x4, address: 0x688908
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x688910
struct /* @anon2 */ {
    // total size: 0xA8
} __vt__20clsPutMatMotGObj_Obj; // size: 0xA8, address: 0x6C6C50
...
class clsPutMatMotGObj_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A860
struct /* @anon5 */ {
    // total size: 0x28
...
class clsPutMatMotGObj_Obj : public clsRigidBodyGimmickObj {
    // total size: 0xE0
public:
    enum enmPutMatMotGObjMode m_ePutMatMotGObjMode; // offset 0xD0, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0xD4, size 0x4
    float m_f32MatMotEndFrame; // offset 0xD8, size 0x4
    float m_f32MatMotFrame; // offset 0xDC, size 0x4
};
class stcCtrlData {
    // total size: 0x50
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPutMatMotGObj_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsMultiObjTxMaModels m_cModel; // offset 0x88, size 0x8
...
class clsPutMatMotGObj_Task : public clsMultiShape, public clsMultiModelGimmick_Task {
    // total size: 0xA8
};
class hkSmallArray {
    // total size: 0x8
...
// Range: 0x46EF80 -> 0x46EFD4
void callbackContactTriggerRigidBody(class clsPutMatMotGObj_Obj * this /* r6 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46EF80 -> 0x46EFD4
    }
...
// Range: 0x46EFF0 -> 0x46F16C
void draw(class clsPutMatMotGObj_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46EFF0 -> 0x46F16C
        ...
        class clsModelType_OB_TX_MO_MA * pcModel; // r23
...
// Range: 0x46F170 -> 0x46F2B0
void execute(class clsPutMatMotGObj_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46F170 -> 0x46F2B0
        unsigned int u32Num; // r2
...
// Range: 0x46F2B0 -> 0x46F320
void reset(class clsPutMatMotGObj_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46F2B0 -> 0x46F320
        unsigned int u32Num; // r2
...
// Range: 0x46F320 -> 0x46F57C
void draw(class clsPutMatMotGObj_Obj * this /* r18 */, class clsModelType_OB_TX_MO_MA * pcModels /* r2 */, float (* psMtxPal)[4][4] /* r22 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r23 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46F320 -> 0x46F57C
        class clsModelType_OB_TX_MO_MA & rcObj; // r21
        class NNS_OBJECT * psObject; // r20
    }
}


// Range: 0x46F580 -> 0x46F634
void main(class clsPutMatMotGObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46F580 -> 0x46F634
    }
...
// Range: 0x46F640 -> 0x46F6AC
void contactInterraction(class clsPutMatMotGObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46F640 -> 0x46F6AC
    }
...
// Range: 0x46F6B0 -> 0x46F6F8
void requestDrawBreakEffect(class clsPutMatMotGObj_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46F6B0 -> 0x46F6F8
    }
...
// Range: 0x46F700 -> 0x46F7B4
void destroyData(class clsPutMatMotGObj_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46F700 -> 0x46F7B4
    }
...
// Range: 0x46F7C0 -> 0x46FED8
void createData(class clsPutMatMotGObj_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46F7C0 -> 0x46FED8
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0x100
        class hkBoxShape * pcBoxShape; // r2
        class hkMassProperties massProperties; // r29+0xB0
        class hkVector4 cOffset; // r29+0xA0
        char __FUNCTION__[14]; // @ 0x006888F8
    }
}


// Range: 0x46FEE0 -> 0x46FF48
void setData(class clsPutMatMotGObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46FEE0 -> 0x46FF48
    }
...
// Range: 0x46FF50 -> 0x46FFD4
void reset(class clsPutMatMotGObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46FF50 -> 0x46FFD4
    }
...
// Range: 0x46FFE0 -> 0x470078
void init(class clsPutMatMotGObj_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x46FFE0 -> 0x470078
    }
...
// Range: 0x470080 -> 0x470088
void @80@__dt__20clsPutMatMotGObj_ObjFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x470080 -> 0x470088
    }
