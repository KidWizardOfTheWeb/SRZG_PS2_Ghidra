/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage07\St07MapPartsGimmickWallSmall.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x692C68
struct /* @anon11 */ {
    // total size: 0x48
} __vt__32clsMapPartsGimmickWallSmall_Task; // size: 0x48, address: 0x6CC060
struct /* @anon0 */ {
    // total size: 0x48
} __vt__126clsSingleModelGimmick_Task<32clsMapPartsGimmickWallSmall_Task,34clsMapPartsGimmickWallSmall_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6CC110
struct /* @anon4 */ {
    // total size: 0x38
...
struct /* @anon3 */ {
    // total size: 0xC
} __vt__48clsSingleton<32clsMapPartsGimmickWallSmall_Task>; // size: 0xC, address: 0x6CC0A8
void * __dt(class clsMapPartsGimmickWallSmall_Object *, signed short); // size: 0x0, address: 0x4FF060
struct /* @anon9 */ {
    // total size: 0x48
} __vt__118clsBaseGimmickBody<32clsMapPartsGimmickWallSmall_Task,34clsMapPartsGimmickWallSmall_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6CC0C0
struct /* @anon2 */ {
    // total size: 0xA8
} __vt__29clsMapPartsGimmickWall_Object; // size: 0xA8, address: 0x6CBFB0
struct /* @anon10 */ {
    // total size: 0xA8
} __vt__34clsMapPartsGimmickWallSmall_Object; // size: 0xA8, address: 0x6CC160
...
void * __ct(class clsMapPartsGimmickWallSmall_Object *); // size: 0x0, address: 0x4FFC90
...
// Range: 0x4FF100 -> 0x4FF234
void checkMode(class clsMapPartsGimmickWallSmall_Task * this /* r2 */, unsigned char u8Num /* r2 */, signed short s16LapNum /* r21 */, signed char s8Ranking /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FF100 -> 0x4FF234
        unsigned int u32i; // r20
        unsigned int u32j; // r21
    }
}


// Range: 0x4FF240 -> 0x4FF50C
void draw(class clsMapPartsGimmickWallSmall_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FF240 -> 0x4FF50C
...
// Range: 0x4FF5B0 -> 0x4FF690
void execute(class clsMapPartsGimmickWallSmall_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FF5B0 -> 0x4FF690
        unsigned int u32Num; // r2
...
// Range: 0x4FF690 -> 0x4FF700
void reset(class clsMapPartsGimmickWallSmall_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FF690 -> 0x4FF700
        unsigned int u32Num; // r2
...
// Range: 0x4FF700 -> 0x4FF920
void * __ct(class clsMapPartsGimmickWallSmall_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FF700 -> 0x4FF920
        class hkVector4 cBoxVec; // r29+0x80
        class hkQuaternion cBoxQuaternion; // r29+0x70
        class hkTransform cTrans; // r29+0x30
        class hkArray shapeArray; // r29+0x90
    }
}


// Range: 0x4FFCF0 -> 0x4FFD50
void destroyData(class clsMapPartsGimmickWallSmall_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FFCF0 -> 0x4FFD50
    }
...
// Range: 0x4FFD50 -> 0x4FFE24
void reset(class clsMapPartsGimmickWallSmall_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FFD50 -> 0x4FFE24
...
// Range: 0x4FFE30 -> 0x4FFFF0
unsigned char checkData(class clsMapPartsGimmickWallSmall_Object * this /* r16 */, unsigned int u32Num /* r2 */, unsigned int u32LapNum /* r2 */, unsigned int u32Ranking /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FFE30 -> 0x4FFFF0
        class hkVector4 cAngle; // r29+0x30
    }
}


// Range: 0x4FFFF0 -> 0x50009C
void createData(class clsMapPartsGimmickWallSmall_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4FFFF0 -> 0x50009C
    }
