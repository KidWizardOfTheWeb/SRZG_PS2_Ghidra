/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage01\GLinkTrain\GLinkTrainThroughCollision.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
signed char m_toas8EffectiveRanking[2][3]; // size: 0x6, address: 0x6816B0
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x6816C0
...
// Range: 0x3B9D60 -> 0x3B9E24
void initCourseDirection(class clsGLinkTrainStartThroughCol * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B9D60 -> 0x3B9E24
        class clsRetPath cRetPath; // r29+0x40
        class NNS_VECTORFAST & rsDirVecFast; // r16
    }
}


// Range: 0x3B9E30 -> 0x3B9F60
void contactTriggerEvent(class clsGLinkTrainStartThroughCol * this /* r17 */, class clsPlayerTask * pcPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B9E30 -> 0x3B9F60
        unsigned char bStart; // r7
        class stcGDTrainData & rsGDTrainDbg; // r2
        signed char * ps8EffectiveRanking; // r2
    }
}


// Range: 0x3B9F60 -> 0x3BA010
void contactAlwaysEvent(class clsGLinkTrainThroughCollision * this /* r17 */, class clsPlayerTask * pcPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B9F60 -> 0x3BA010
    }
