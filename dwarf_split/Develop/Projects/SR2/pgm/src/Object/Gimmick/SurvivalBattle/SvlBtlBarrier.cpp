/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\SurvivalBattle\SvlBtlBarrier.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float t_of32DestoryFrame; // size: 0x4, address: 0x0
float t_of32LimitFrame; // size: 0x4, address: 0x697B70
float t_of32CLIP_DISTx2; // size: 0x4, address: 0x697B78
struct /* @anon4 */ {
    // total size: 0x48
} __vt__21clsSvlBtlBarrier_Task; // size: 0x48, address: 0x6D0040
struct /* @anon5 */ {
    // total size: 0x48
} __vt__104clsSingleModelGimmick_Task<21clsSvlBtlBarrier_Task,23clsSvlBtlBarrier_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6D0140
struct /* @anon3 */ {
    // total size: 0x38
...
struct /* @anon10 */ {
    // total size: 0xC
} __vt__37clsSingleton<21clsSvlBtlBarrier_Task>; // size: 0xC, address: 0x6D00D8
void * __dt(class clsSvlBtlBarrier_Object *, signed short); // size: 0x0, address: 0x552E60
struct /* @anon2 */ {
    // total size: 0x48
} __vt__96clsBaseGimmickBody<21clsSvlBtlBarrier_Task,23clsSvlBtlBarrier_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6D00F0
struct /* @anon7 */ {
    // total size: 0x28
...
struct /* @anon1 */ {
    // total size: 0x44
} __vt__23clsSvlBtlBarrier_Object; // size: 0x44, address: 0x6D0090
...
void * __ct(class clsSvlBtlBarrier_Object *); // size: 0x0, address: 0x5538C0
...
// Range: 0x552ED0 -> 0x552F3C
void cancel(class clsSvlBtlBarrier_Task * this /* r17 */, class clsPlayerTask * pcPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x552ED0 -> 0x552F3C
    }
...
// Range: 0x552F40 -> 0x552F90
void setup(class clsSvlBtlBarrier_Task * this /* r2 */, class clsPlayerTask * pcPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x552F40 -> 0x552F90
    }
...
// Range: 0x552F90 -> 0x553244
void draw(class clsSvlBtlBarrier_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x552F90 -> 0x553244
        ...
        float sWorkMtx[4][4]; // r29+0x100
        unsigned int u32i; // r17
    }
}


// Range: 0x553250 -> 0x5533C8
void execute(class clsSvlBtlBarrier_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x553250 -> 0x5533C8
        unsigned int u32Num; // r2
...
// Range: 0x5533D0 -> 0x553450
void reset(class clsSvlBtlBarrier_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5533D0 -> 0x553450
        unsigned int u32Num; // r2
...
// Range: 0x553450 -> 0x553544
void * __ct(class clsSvlBtlBarrier_Task * this /* r18 */, class stcSetDataDetail & orsSetDataDetailI /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x553450 -> 0x553544
        signed int i; // r16
