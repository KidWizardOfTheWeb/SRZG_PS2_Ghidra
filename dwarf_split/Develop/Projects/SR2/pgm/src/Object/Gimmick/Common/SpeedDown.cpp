/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\SpeedDown.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class NNS_VECTORFAST toasGearOffset[9]; // size: 0x90, address: 0x69A120
static unsigned char chk__toasGearOffset_SizeCheck_[1]; // size: 0x1, address: 0x0
static unsigned int toau32GearNodeNo[9]; // size: 0x24, address: 0x69A1B0
static unsigned char chk__toau32GearNodeNo_SizeCheck_[1]; // size: 0x1, address: 0x0
struct /* @anon1 */ {
    // total size: 0x44
} __vt__16clsSpeedDown_Obj; // size: 0x44, address: 0x6D1230
struct /* @anon8 */ {
    // total size: 0x28
...
struct /* @anon9 */ {
    // total size: 0x48
} __vt__17clsSpeedDown_Task; // size: 0x48, address: 0x6D12E0
struct /* @anon13 */ {
    // total size: 0x48
} __vt__86clsMultiModelGimmick_Task<17clsSpeedDown_Task,16clsSpeedDown_Obj,18clsMultiObTxModels>; // size: 0x48, address: 0x6D1330
void * __dt(class clsSpeedDown_Obj *, signed short); // size: 0x0, address: 0x5805C0
struct /* @anon5 */ {
    // total size: 0x48
} __vt__79clsBaseGimmickBody<17clsSpeedDown_Task,16clsSpeedDown_Obj,18clsMultiObTxModels>; // size: 0x48, address: 0x6D1290
struct /* @anon10 */ {
    // total size: 0x30
...
struct /* @anon2 */ {
    // total size: 0xC
} __vt__33clsSingleton<17clsSpeedDown_Task>; // size: 0xC, address: 0x6D1278
void * __ct(class clsSpeedDown_Obj *); // size: 0x0, address: 0x5814A0
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x69A1E0
struct /* @anon12 */ {
    // total size: 0x24
...
// Range: 0x580670 -> 0x5807F8
void draw(class clsSpeedDown_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x580670 -> 0x5807F8
        unsigned int * psNodeStat; // r30
        unsigned int u32ViewNo; // r16
        float (* opaNnViewMtx)[4][4]; // r22
        float (* psMtxPal)[4][4]; // r29+0xB0
        class clsMultiObTxModels & rcModel; // r29+0xA0
        float sMtxWork[4][4]; // r29+0x100
    }
}


// Range: 0x580800 -> 0x580A04
void execute(class clsSpeedDown_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x580800 -> 0x580A04
        class clsOODeque & rtddqUseObj; // r21
        class clsOODeque & rtddqUnUseObj; // r23
    }
}


// Range: 0x580A90 -> 0x580C5C
void regist(class clsSpeedDown_Task * this /* r21 */, class clsPlayerTask * pcPlayer /* r20 */, float f32Frame /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x580A90 -> 0x580C5C
        enum enmAction eGAction; // r2
        class clsSpeedDown_Obj * pcObj; // r29+0xCC
    }
}


// Range: 0x580C60 -> 0x580D38
void reset(class clsSpeedDown_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x580C60 -> 0x580D38
...
// Range: 0x580D40 -> 0x580F6C
void * __ct(class clsSpeedDown_Task * this /* r18 */, class stcSetDataDetail & orsSetDataDetailI /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x580D40 -> 0x580F6C
        signed int u32i; // r16
...
// Range: 0x581590 -> 0x5819D0
void draw(class clsSpeedDown_Obj * this /* r21 */, class clsMultiObTxModels & rcObj /* r2 */, float (* psMtxPal)[4][4] /* r20 */, unsigned int * psNodeStat /* r19 */, float (* opaNnViewMtx)[4][4] /* r30 */, float (* psMtxWork)[4][4] /* r18 */, unsigned int u32ViewNo /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x581590 -> 0x5819D0
        enum enmMode eMode; // r2
        class stcChainBallData * psChainBallData; // r17
        class clsModelType_OB_TX & rcChain; // r16
        unsigned int u32i; // r22
        float sOffsetMtx[4][4]; // r29+0x180
        class clsGimmickRigidBody * * it; // r16
        class clsGimmickRigidBody * * end; // r2
        class hkRigidBodyCinfo cCinfo; // r29+0xC0
        class stcChainBallData * psChainBallData; // r17
...
// Range: 0x5819D0 -> 0x5824F0
void execute(class clsSpeedDown_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5819D0 -> 0x5824F0
        class clsGimmickRigidBody * * it; // r18
        class clsGimmickRigidBody * * end; // r2
        class stcChainBallData * psChainBallData; // r16
        class clsGimmickRigidBody * pcRigidBody; // r18
        float sMtx[4][4]; // r29+0x1F0
        class NNS_VECTORFAST sVelocityFast; // r29+0x1E0
        class NNS_VECTORFAST sPosVecFat; // r29+0x1D0
        class hkVector4 cSpeed; // r29+0x1C0
        class hkVector4 cAngleVel; // r29+0x1B0
        class hkQuaternion cQuat; // r29+0x1A0
        class stcChainBallData * psChainBallData; // r16
        class stcChainBallData * psPrev; // r18
        float f32Work; // r29+0x230
        float f32RadX; // r29+0x230
        float f32RadY; // r29+0x230
        float f32Rand; // r20
        unsigned int u32Check; // r2
        float f32Speed; // r20
        float sMtx[4][4]; // r29+0x160
        float sMtx2[4][4]; // r29+0x120
        class NNS_VECTORFAST sPosVecFat; // r29+0x110
        class NNS_VECTORFAST sPrevFast; // r29+0x100
        class NNS_VECTORFAST asWorkFast[2]; // r29+0xE0
        class NNS_VECTORFAST sDirVecFast; // r29+0xD0
        class NNS_VECTORFAST sGravityFast; // r29+0xC0
        class NNS_VECTORFAST sCrossVecFast; // r29+0xB0
        class NNS_VECTORFAST * psUpVecFast; // r21
        class NNS_VECTORFAST * psPlayerCrossFast; // r22
        unsigned int u32i; // r20
        class clsPlayerTask * pcPlayer; // r16
        float f32MaxSpeed; // r1
        class clsFrameControl & rcFrameControl; // r2
    }
}


// Range: 0x5824F0 -> 0x5826A8
void setLimit(class clsGimmickRigidBody * pcRigidBodyA /* r19 */, class clsGimmickRigidBody * pcRigidBodyB /* r18 */, float f32MaxAngle /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5824F0 -> 0x5826A8
        class hkVector4 cAxisHinge; // r29+0x70
        class hkVector4 cAxisHingeUp; // r29+0x60
    }
}


// Range: 0x5826B0 -> 0x582D7C
void createChain(class clsSpeedDown_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5826B0 -> 0x582D7C
        ...
        class clsGimmickRigidBody * pcRigidBodyBef; // r19
        class hkVector4 cVecTop; // r29+0x160
        class hkVector4 cVecButtom; // r29+0x150
        class hkRigidBodyCinfo cInfo; // r29+0x90
        unsigned int u32Num; // r17
    }
}


// Range: 0x582D80 -> 0x582E18
void destroyData(class clsSpeedDown_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x582D80 -> 0x582E18
        class clsGimmickRigidBody * * it; // r18
...
// Range: 0x583090 -> 0x583098
void @104@__dt__86clsMultiModelGimmick_Task<17clsSpeedDown_Task,16clsSpeedDown_Obj,18clsMultiObTxModels>Fv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x583090 -> 0x583098
    }
...
// Range: 0x5830A0 -> 0x5830A8
void @104@__dt__17clsSpeedDown_TaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5830A0 -> 0x5830A8
    }
...
// Range: 0x5830B0 -> 0x5830B8
void @104@__dt__79clsBaseGimmickBody<17clsSpeedDown_Task,16clsSpeedDown_Obj,18clsMultiObTxModels>Fv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5830B0 -> 0x5830B8
    }
