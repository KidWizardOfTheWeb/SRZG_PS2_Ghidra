/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage04\St04SmallWaterSphere.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x686BF8
float tof32ClipSqDist; // size: 0x4, address: 0x686C08
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x686C10
struct /* @anon3 */ {
    // total size: 0x48
} __vt__24clsSmallWaterSphere_Task; // size: 0x48, address: 0x6C3D70
struct /* @anon11 */ {
    // total size: 0x48
} __vt__110clsSingleModelGimmick_Task<24clsSmallWaterSphere_Task,26clsSmallWaterSphere_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C3EE0
struct /* @anon10 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsSmallWaterSphere_Task * m_tpcSingleton; // size: 0x4, address: 0xB171F0
struct /* @anon17 */ {
    // total size: 0xC
} __vt__40clsSingleton<24clsSmallWaterSphere_Task>; // size: 0xC, address: 0x6C3E78
void * __dt(class clsSmallWaterSphere_Object *, signed short); // size: 0x0, address: 0x42DD30
struct /* @anon2 */ {
    // total size: 0x48
} __vt__102clsBaseGimmickBody<24clsSmallWaterSphere_Task,26clsSmallWaterSphere_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C3E90
struct /* @anon0 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon8 */ {
    // total size: 0xB4
} __vt__26clsSmallWaterSphere_Object; // size: 0xB4, address: 0x6C3DC0
struct /* @anon13 */ {
    // total size: 0x28
...
void * __ct(class clsSmallWaterSphere_Object *); // size: 0x0, address: 0x42E5B0
...
class clsSmallWaterSphere_Object : public clsRigidBodyGimmickObj {
    // total size: 0xF0
public:
    class NNS_OBJECT * m_psMorphObject; // offset 0xD0, size 0x4
    enum enmMode m_eMode; // offset 0xD4, size 0x4
    float m_f32MatFrame; // offset 0xD8, size 0x4
    float m_f32MorphFrame; // offset 0xDC, size 0x4
    float m_f32Scale; // offset 0xE0, size 0x4
    float m_f32MaxScale; // offset 0xE4, size 0x4
    float m_f32EffectFrame; // offset 0xE8, size 0x4
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsSmallWaterSphere_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsSmallWaterSphere_Task : public clsSingleModelGimmick_Task {
    // total size: 0xB0
public:
...
// Range: 0x42DE30 -> 0x42DEA0
void reset(class clsSmallWaterSphere_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42DE30 -> 0x42DEA0
...
// Range: 0x42DEA0 -> 0x42E084
void draw(class clsSmallWaterSphere_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42DEA0 -> 0x42E084
...
// Range: 0x42E090 -> 0x42E170
void execute(class clsSmallWaterSphere_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42E090 -> 0x42E170
        unsigned int u32Num; // r2
...
// Range: 0x42E170 -> 0x42E23C
void * __ct(class clsSmallWaterSphere_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42E170 -> 0x42E23C
...
// Range: 0x42E680 -> 0x42E700
void destroyData(class clsSmallWaterSphere_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42E680 -> 0x42E700
    }
...
// Range: 0x42E700 -> 0x42EB90
void createData(class clsSmallWaterSphere_Object * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42E700 -> 0x42EB90
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0xE0
        class hkVector4 cVec; // r29+0xD0
...
// Range: 0x42EBC0 -> 0x42EC20
void callbackContactTriggerRigidBody(class clsSmallWaterSphere_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42EBC0 -> 0x42EC20
    }
...
// Range: 0x42EC20 -> 0x42EC2C
void requestDrawBreakEffect(class clsSmallWaterSphere_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42EC20 -> 0x42EC2C
    }
...
// Range: 0x42EC30 -> 0x42ECCC
void mainCrash(class clsSmallWaterSphere_Object * this /* r4 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42EC30 -> 0x42ECCC
    }
...
// Range: 0x42ECD0 -> 0x42ED6C
void mainGravity(class clsSmallWaterSphere_Object * this /* r4 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42ECD0 -> 0x42ED6C
    }
...
// Range: 0x42ED70 -> 0x42EE50
void main(class clsSmallWaterSphere_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42ED70 -> 0x42EE50
    }
...
// Range: 0x42EE50 -> 0x42EF90
void reset(class clsSmallWaterSphere_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42EE50 -> 0x42EF90
...
// Range: 0x42EF90 -> 0x42F25C
void draw(class clsSmallWaterSphere_Object * this /* r20 */, class clsModelType_OB_TX_MO_MA & rcModel /* r19 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r23 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32Seed /* r30 */, unsigned int u32ViewNo /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x42EF90 -> 0x42F25C
    }
