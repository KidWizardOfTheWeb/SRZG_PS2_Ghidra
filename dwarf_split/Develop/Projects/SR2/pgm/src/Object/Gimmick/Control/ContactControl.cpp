/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Control\ContactControl.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float t_of32WeightTypeMiddle; // size: 0x4, address: 0x665198
class stcTask sTask; // size: 0x30, address: 0xB0A900
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x6803A0
...
class clsGravityDive : public clsBaseGravityAction {
    // total size: 0x1D0
public:
    float m_sDirMtx[4][4]; // offset 0x20, size 0x40
    class NNS_VECTORFAST m_sLocalVecFast; // offset 0x60, size 0x10
    class clsPath m_cPath; // offset 0x70, size 0x60
    class clsGravityDivePathRange m_cPathRange; // offset 0xD0, size 0xD0
    class clsSimpleShapePhantom * m_pcPhantom; // offset 0x1A0, size 0x4
    class clsBaseGravityLinkObject * m_pcLinkObject; // offset 0x1A4, size 0x4
    class clsTask * m_pcDiveHole; // offset 0x1A8, size 0x4
    enum enmType m_eType; // offset 0x1AC, size 0x4
    enum enmStatus m_eStatus; // offset 0x1B0, size 0x4
    float m_f32Frame; // offset 0x1B4, size 0x4
    float m_f32AutoDirRate; // offset 0x1B8, size 0x4
    unsigned int m_eControlFlag; // offset 0x1BC, size 0x4
    unsigned char m_bAutoDiveCancel; // offset 0x1C0, size 0x1
    float m_f32MaxSpeed; // offset 0x1C4, size 0x4
    float m_f32GDiveTrigConsumption; // offset 0x1C8, size 0x4
    float m_f32GDiveBetaConsumption; // offset 0x1CC, size 0x4
};
class clsOOList : public list {
    // total size: 0x14
};
...
class clsGravityDivePathRange {
    // total size: 0xD0
public:
    float m_sBaseMtx[4][4]; // offset 0x0, size 0x40
    class NNS_VECTORFAST m_asPointVecFast[2]; // offset 0x40, size 0x20
    class NNS_VECTORFAST m_asCrossVecFast[2]; // offset 0x60, size 0x20
    class NNS_VECTORFAST m_sPathDirVecFast; // offset 0x80, size 0x10
    class NNS_VECTORFAST m_sPathUpVecFast; // offset 0x90, size 0x10
    float m_af32Range[2]; // offset 0xA0, size 0x8
    float m_af32CrossRange[2]; // offset 0xA8, size 0x8
    float m_af32LengthRate[2]; // offset 0xB0, size 0x8
    float m_af32RangeRate[2]; // offset 0xB8, size 0x8
    float m_f32SlerpFrame; // offset 0xC0, size 0x4
    unsigned int m_u32DirFlag; // offset 0xC4, size 0x4
    enum enmFlag m_eFlag; // offset 0xC8, size 0x4
    enum enmPathType m_ePathType; // offset 0xCC, size 0x4
};
...
// Range: 0x3A4E10 -> 0x3A53DC
void boundNormalPlayer(class clsContactControl * this /* r21 */, class hkContactPoint * pcContact /* r20 */, class clsGimmickRigidBody * pcRigidBody /* r19 */, class clsPlayerTask * pcPlayer /* r18 */, unsigned char bRefrection /* r17 */, float f32RefMaxSpeed /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A4E10 -> 0x3A53DC
        float sInvMtx[4][4]; // r29+0x110
        float sRotMtx[4][4]; // r29+0xD0
        class NNS_VECTORFAST sWallVecFast; // r29+0xC0
        class NNS_VECTORFAST sReflectionVecFast; // r29+0xB0
        class NNS_VECTORFAST sPathVecFast; // r29+0xA0
        class NNS_VECTORFAST sInertiaVecFast; // r29+0x90
        class clsPathCourse * pcCoursePath; // r2
        float f32Rad; // r20
    }
}


// Range: 0x3A53E0 -> 0x3A5940
void boundPlayer(class hkContactPoint * pcContact /* r2 */, class clsGimmickRigidBody * pcRigidBody /* r18 */, class clsPlayerTask * pcPlayer /* r17 */, unsigned char bRefrection /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A53E0 -> 0x3A5940
        class NNS_VECTORFAST sNrmVecFast; // r29+0x110
        class NNS_VECTORFAST sWallVecFast; // r29+0x100
        float sInvMtx[4][4]; // r29+0xC0
        float f32ReflectionRad; // r21
        float f32Rad; // r20
        class NNS_VECTORFAST sInertiaVecFast; // r29+0xB0
        float sInvMtx[4][4]; // r29+0x70
    }
}


// Range: 0x3A5940 -> 0x3A5CD8
void reactionPlayerNormal(class clsContactControl * this /* r20 */, class hkContactPoint * pcContact /* r19 */, class clsGimmickRigidBody * pcRigidBody /* r18 */, class clsPlayerTask * pcPlayer /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A5940 -> 0x3A5CD8
    }
...
// Range: 0x3A5CE0 -> 0x3A6074
void reactionPlayerPower(class clsContactControl * this /* r20 */, class hkContactPoint * pcContact /* r19 */, class clsGimmickRigidBody * pcRigidBody /* r18 */, class clsPlayerTask * pcPlayer /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A5CE0 -> 0x3A6074
    }
...
// Range: 0x3A6080 -> 0x3A61F0
void reactionPlayerGravityControl(class clsContactControl * this /* r19 */, class hkContactPoint * pcContact /* r18 */, class clsGimmickRigidBody * pcRigidBody /* r17 */, class clsPlayerTask * pcPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A6080 -> 0x3A61F0
    }
...
// Range: 0x3A61F0 -> 0x3A64A0
void reactionPlayerGravityDive(class clsContactControl * this /* r20 */, class hkContactPoint * pcContact /* r19 */, class clsGimmickRigidBody * pcRigidBody /* r16 */, class clsPlayerTask * pcPlayer /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A61F0 -> 0x3A64A0
        class clsGravityDive * pcGravityDive; // r4
        unsigned char bGTypeCheck; // r2
    }
}


// Range: 0x3A64A0 -> 0x3A6784
void updateContactPlayer(class clsContactControl * this /* r21 */, class hkContactPoint * pcContact /* r20 */, class clsGimmickRigidBody * pcRigidBody /* r19 */, class clsPlayerTask * pcPlayer /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A64A0 -> 0x3A6784
        class clsMissionRace_Task * pcMiaaionRace; // r2
        unsigned char bGCtrl; // r17
    }
}
