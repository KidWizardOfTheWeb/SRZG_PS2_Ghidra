/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\SurvivalRelay\SurvivalWalkRunObj.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x693CC0
struct /* @anon14 */ {
    // total size: 0x48
} __vt__31clsSurvivalRelayWalkRunObj_Task; // size: 0x48, address: 0x6CD9D0
...
void * __dt(class clsSurvivalRelayWalkRunObj_Obj *, signed short); // size: 0x0, address: 0x521280
struct /* @anon3 */ {
    // total size: 0x48
} __vt__121clsBaseGimmickBody<31clsSurvivalRelayWalkRunObj_Task,30clsSurvivalRelayWalkRunObj_Obj,32clsSurvivalRelayWalkRunObjModels>; // size: 0x48, address: 0x6CDA80
struct /* @anon8 */ {
    // total size: 0x30
...
struct /* @anon2 */ {
    // total size: 0x5C
} __vt__30clsSurvivalRelayWalkRunObj_Obj; // size: 0x5C, address: 0x6CDAD0
struct /* @anon0 */ {
    // total size: 0x44
} __vt__31clsSurvivalRelayWalkRunLine_Obj; // size: 0x44, address: 0x6CDA20
void * __ct(class clsSurvivalRelayWalkRunObj_Obj *); // size: 0x0, address: 0x521750
class clsSurvivalRelayWalkRunObj_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA6B0
struct /* @anon12 */ {
    // total size: 0xC
} __vt__47clsSingleton<31clsSurvivalRelayWalkRunObj_Task>; // size: 0xC, address: 0x6CDA68
...
class clsSurvivalRelayWalkRunObj_Task : public clsBaseGimmickBody {
    // total size: 0xEC
public:
    class clsSurvivalRelayWalkRunLine_Obj * m_pcWalkRunLine_Obj[2]; // offset 0xE4, size 0x8
};
...
class clsLapSt15 : public clsLap {
    // total size: 0x44
public:
    signed int m_s32TotalLapCnt; // offset 0x40, size 0x4
};
...
class clsSurvivalRelayWalkRunObj_Obj : public clsPhantomGimmickObject {
    // total size: 0x70
public:
    class hkShape * m_pcShape; // offset 0x60, size 0x4
};
enum enmDraw2DAttr {
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xE4
public:
    class clsSurvivalRelayWalkRunObj_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsSurvivalRelayWalkRunObjModels m_cModel; // offset 0x88, size 0x58
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0xE0, size 0x4
};
class clsSingleton {
    // total size: 0x4
};
...
class clsSurvivalRelayWalkRunLine_Obj : public clsGimmickObj {
    // total size: 0x150
public:
    enum enmSurvivalRaceWalkRunLineMode m_eSurvivalRaceWalkRunLineMode; // offset 0x50, size 0x4
    float m_asDrawMtx[3][4][4]; // offset 0x60, size 0xC0
    signed int m_s32PlayerNo; // offset 0x120, size 0x4
    signed int m_s32NextPlayerNo; // offset 0x124, size 0x4
    unsigned char m_bGravityFlag; // offset 0x128, size 0x1
    unsigned int m_u32LoopNum; // offset 0x12C, size 0x4
    unsigned int m_u32PlayerNo; // offset 0x130, size 0x4
    signed int m_s32TeamNo; // offset 0x134, size 0x4
    signed int m_s32SeCount; // offset 0x138, size 0x4
    signed int m_s32SpeedCount; // offset 0x13C, size 0x4
    unsigned char m_bSpeedDownFlag; // offset 0x140, size 0x1
};
...
class clsSurvivalRelayWalkRunObjModels {
    // total size: 0x58
public:
    class clsModelType_OB_TX_MO_MA m_cModelWall; // offset 0x0, size 0x20
    class clsModelType_OB_TX_MO_MA m_cModelAT_B; // offset 0x20, size 0x20
    class _NNS_TEXLIST * m_pcTexAT_R; // offset 0x40, size 0x4
    class clsModelType_OB_TX_MO m_cModelLine_B; // offset 0x44, size 0x10
    class _NNS_TEXLIST * m_pcTexLine_R; // offset 0x54, size 0x4
};
...
// Range: 0x5202D0 -> 0x52071C
void draw(class clsSurvivalRelayWalkRunObj_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5202D0 -> 0x52071C
        unsigned int u32Num; // r2
        class clsSurvivalRelayRace_Task & rcSurvivalRelayRace_Task; // r2
        unsigned int u32Camera; // r2
        class clsSurvivalRelayWalkRunObjModels & rcModels; // r20
        float (* psMtxPal)[4][4]; // r29+0xF0
        unsigned int * psNodeStat; // r29+0xE0
        float sMtx[4][4]; // r29+0x140
        unsigned int u32Flag; // r19
...
// Range: 0x520790 -> 0x5209B0
void execute(class clsSurvivalRelayWalkRunObj_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x520790 -> 0x5209B0
        class clsModelType_OB_TX_MO_MA * pcModelAT_B; // r2
        class clsModelType_OB_TX_MO * pccModelLine_B; // r2
        unsigned int u32Num; // r2
        float * pf32Frame; // r2
        unsigned int u32i; // r18
    }
...
// Range: 0x5209B0 -> 0x520E10
void createModel(class clsSurvivalRelayWalkRunObj_Task * this /* r2 */, class stcBinInfo & rsBinInfoI /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5209B0 -> 0x520E10
        unsigned int u32CalcObjNum; // r2
        class clsModelType_OB_TX_MO_MA * pcModelAT_B; // r19
        class clsModelType_OB_TX_MO * pcModelLine_B; // r18
    }
}


// Range: 0x520E10 -> 0x520E58
void reset(class clsSurvivalRelayWalkRunObj_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x520E10 -> 0x520E58
        signed int s32i; // r17
...
// Range: 0x520E60 -> 0x521000
void startHitPlayer(class clsSurvivalRelayWalkRunObj_Task * this /* r23 */, class clsSurvivalRelayPlayerTask * pcPlayer /* r21 */, unsigned int u32TypeNo /* r30 */, class clsSurvivalRelayWalkRunObj_Obj * psObj /* r20 */, class NNS_VECTOR * copsRot /* r29+0xBC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x520E60 -> 0x521000
        class clsSurvivalRelayRace_Task & rcSurvivalRelayRace_Task; // r19
        unsigned int u32PlayerNo; // r2
        unsigned int u32TeamNo; // r18
        signed int s32Lap; // r17
        class clsLapSt15 * pcPlyerLapSt15; // r2
    }
}


// Range: 0x521000 -> 0x521114
void * __dt(class clsSurvivalRelayWalkRunObj_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x521000 -> 0x521114
        signed int s32i; // r19
...
// Range: 0x521410 -> 0x521580
void * __ct(class clsSurvivalRelayWalkRunObj_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x521410 -> 0x521580
        signed int s32i; // r18
...
// Range: 0x5218F0 -> 0x521958
void destroyData(class clsSurvivalRelayWalkRunObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5218F0 -> 0x521958
    }
...
// Range: 0x521960 -> 0x521AAC
void createData(class clsSurvivalRelayWalkRunObj_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x521960 -> 0x521AAC
        class hkVector4 cBox; // r29+0x80
    }
}


// Range: 0x521AB0 -> 0x521D94
void contactAlwaysEvent(class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x521AB0 -> 0x521D94
        class clsSurvivalRelayRace_Task & rcSurvivalRelayRace_Task; // r2
        class clsSurvivalRelayPlayerTask * pcPlayer; // r20
        unsigned int u32PlayerNo; // r2
        unsigned int u32TeamNo; // r19
    }
}


// Range: 0x521DA0 -> 0x521E28
void contactRemoveEvent(class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x521DA0 -> 0x521E28
        class clsSurvivalRelayRace_Task & rcSurvivalRelayRace_Task; // r17
        class clsSurvivalRelayPlayerTask * pcPlayer; // r2
        unsigned int u32PlayerNo; // r2
        unsigned int u32TeamNo; // r16
    }
}


// Range: 0x521E30 -> 0x521E50
void contactTriggerEvent(class clsSurvivalRelayWalkRunObj_Obj * this /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x521E30 -> 0x521E50
    }
