/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage08\St08UfoCatcher.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32CLIP_DISTx2; // size: 0x4, address: 0x697310
float t_of32ClipDistx2; // size: 0x4, address: 0x697318
class NNS_VECTORFAST t_osPosVecFast; // size: 0x10, address: 0x697320
class NNS_VECTORFAST t_osPlayerOffstVecFast; // size: 0x10, address: 0x697330
static class stcParam asUfoBallLineParam[2]; // size: 0x80, address: 0x697340
static unsigned char chk__asUfoBallLineParam_SizeCheck_[1]; // size: 0x1, address: 0x0
static class stcGimickSubParam asUfoBallLineSubParam[1]; // size: 0x20, address: 0x6973C0
struct /* @anon5 */ {
    // total size: 0x58
} __vt__17clsUfoCatcher_Obj; // size: 0x58, address: 0x6CF050
...
class clsUfoCatcher_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A7B0
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x6974A0
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x697450
...
void * __dt(class clsUfoCatcher *, signed short); // size: 0x0, address: 0x2E6670
void * __ct(class clsUfoCatcher *); // size: 0x0, address: 0x543CE0
...
struct /* @anon2 */ {
    // total size: 0x10
} __vt__13clsUfoCatcher; // size: 0x10, address: 0x6BBB40
void * __dt(class clsDebriPartsBase *, signed short); // size: 0x0, address: 0x2C81B0
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x697490
...
public:
    ...
    enum enmState m_eState; // offset 0x1C4, size 0x4
    class clsUfoCatcher_Obj * m_pcUfoObj; // offset 0x1C8, size 0x4
    float m_f32ArmMotionFrame; // offset 0x1CC, size 0x4
    float m_sTrsMtxBall[4][4]; // offset 0x1D0, size 0x40
    class clsDebrisControl * m_pcDebrisControl; // offset 0x210, size 0x4
    float m_f32PlayerScale; // offset 0x214, size 0x4
    class clsFrameControl m_cFrameControl; // offset 0x218, size 0x8
    unsigned char m_bCatch; // offset 0x220, size 0x1
    unsigned char m_u8UfoSeFlg; // offset 0x221, size 0x1
    float m_sLineDrawMtx[4][4]; // offset 0x230, size 0x40
...
class clsUfoCatcherModels {
    // total size: 0x28
public:
    class clsModelType_OB_TX_MO m_cArm; // offset 0x0, size 0x10
    class clsModelType_OB_TX_MO m_cDoor; // offset 0x10, size 0x10
    class clsModelType_OB_TX m_cBall; // offset 0x20, size 0x8
};
class stcSeed {
    // total size: 0x30
public:
...
public:
    ...
    class clsGimmickAutoRunBuffer m_cUfoBuffer; // offset 0x64, size 0x1C
    ...
    float m_f32DoorMotionFrame; // offset 0xA8, size 0x4
    class NNS_VECTORFAST m_sDoorPosVecFast; // offset 0xB0, size 0x10
    signed short m_as16SeSfId[4]; // offset 0xC0, size 0x8
};
...
class clsGimmickAutoRunBuffer : public clsGimmickAutoRunBufferBase {
    // total size: 0x1C
public:
    class clsUfoCatcher * m_apcObj; // offset 0xC, size 0x4
    class clsUfoCatcher * * m_ppcExecute; // offset 0x10, size 0x4
    class clsUfoCatcher * * m_ppcSleep; // offset 0x14, size 0x4
    class clsUfoCatcher * * m_ppcExecuteWork; // offset 0x18, size 0x4
};
...
class clsUfoCatcher_Task : public clsBaseGimmickBody {
    // total size: 0xB4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xB4
public:
    class clsUfoCatcher_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsUfoCatcherModels m_cModel; // offset 0x88, size 0x28
...
// Range: 0x5414F0 -> 0x541674
void draw(class clsUfoCatcher_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5414F0 -> 0x541674
        ...
        class clsUfoCatcherModels & rcModel; // r18
...
// Range: 0x541680 -> 0x541750
void execute(class clsUfoCatcher_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x541680 -> 0x541750
...
// Range: 0x541750 -> 0x541A48
void createModel(class clsUfoCatcher_Task * this /* r2 */, class stcBinInfo & rsBinInfoI /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x541750 -> 0x541A48
...
// Range: 0x541A50 -> 0x541BB8
void reset(class clsUfoCatcher_Task * this /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x541A50 -> 0x541BB8
        unsigned int u32Num; // r2
...
// Range: 0x541BC0 -> 0x541E90
void draw(class clsUfoCatcher_Obj * this /* r20 */, class clsUfoCatcherModels & rcModel /* r19 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r30 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x541BC0 -> 0x541E90
        float sMtx[4][4]; // r29+0xF0
        class clsModelType_OB_TX_MO & rcModelDoor; // r2
        unsigned int u32Num; // r22
        class clsUfoCatcher * * apcObj; // r21
    }
}


// Range: 0x541E90 -> 0x542238
void execute(class clsUfoCatcher_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x541E90 -> 0x542238
    }
...
// Range: 0x542250 -> 0x54228C
class clsUfoCatcher * getStateCmp(class clsUfoCatcher_Obj * this /* r2 */, enum enmState eState /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x542250 -> 0x54228C
        unsigned int u32Num; // r6
        class clsUfoCatcher * * apcObj; // r4
    }
}


// Range: 0x542290 -> 0x542318
void openDoor(class clsUfoCatcher_Obj * this /* r16 */, float f32Distx2 /* r29+0x20 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x542290 -> 0x542318
    }
...
// Range: 0x542320 -> 0x5423AC
void stopBallSe(class clsUfoCatcher_Obj * this /* r16 */, class clsPlayerTask * pcPlayer /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x542320 -> 0x5423AC
    }
...
// Range: 0x5423B0 -> 0x54243C
void playBallSe(class clsUfoCatcher_Obj * this /* r16 */, class clsPlayerTask * pcPlayer /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5423B0 -> 0x54243C
    }
...
// Range: 0x542440 -> 0x54249C
void registBall(class clsUfoCatcher_Obj * this /* r18 */, class clsPlayerTask * pcPlayer /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x542440 -> 0x54249C
        class clsUfoCatcher * pcObj; // r16
    }
}


// Range: 0x5424A0 -> 0x542644
void contactTriggerEvent(class clsUfoCatcher_Obj * this /* r18 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5424A0 -> 0x542644
...
// Range: 0x542650 -> 0x5426A0
void destroyData(class clsUfoCatcher_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x542650 -> 0x5426A0
    }
...
// Range: 0x5426A0 -> 0x5428D8
void createData(class clsUfoCatcher_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5426A0 -> 0x5428D8
        class hkTransform cTransform; // r29+0x70
...
// Range: 0x5428E0 -> 0x542A28
void init(class clsUfoCatcher_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5428E0 -> 0x542A28
        class NNS_VECTORFAST sOffsetVecFast; // r29+0x90
    }
}


// Range: 0x542A30 -> 0x542EC0
void draw(class clsUfoCatcher * this /* r21 */, class clsUfoCatcherModels & rcModel /* r20 */, float (* psMtxPal)[4][4] /* r19 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r30 */, float (* psMtxWork)[4][4] /* r17 */, unsigned int u32ViewNo /* r16 */, unsigned int NodeStatus /* r29+0xAC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x542A30 -> 0x542EC0
        float sMtx[4][4]; // r29+0x190
        class clsModelType_OB_TX & rcModelBall; // r2
...
// Range: 0x542EC0 -> 0x543300
void execute(class clsUfoCatcher * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x542EC0 -> 0x543300
    }
...
// Range: 0x5433D0 -> 0x5433E0
void getBallPosition(class clsUfoCatcher * this /* r2 */, class NNS_VECTORFAST & rsPosVecFast /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5433D0 -> 0x5433E0
    }
...
// Range: 0x5433F0 -> 0x543544
unsigned char stepArmFrame(class clsUfoCatcher * this /* r19 */, float f32EndFrame /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5433F0 -> 0x543544
        float & rf32Frame; // r2
        unsigned char & ru8UfoSeFlg; // r2
        unsigned int u32i; // r6
        float oaf32SeFrame[6]; // @ 0x006973E0
    }
}


// Range: 0x543550 -> 0x5436C4
void start(class clsUfoCatcher * this /* r17 */, class clsPlayerTask * pcPlayerTask /* r16 */, class clsUfoCatcher_Obj * pcObj /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x543550 -> 0x5436C4
...
// Range: 0x5436D0 -> 0x5439F0
void setBall(class clsUfoCatcher * this /* r19 */, class clsPlayerTask * pcPlayerTask /* r2 */, class clsUfoCatcher_Obj * pcObj /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5436D0 -> 0x5439F0
        class clsDebrisControl * pcDebirsCtrl; // r2
        signed int s32n; // r18
        char __FUNCTION__[14]; // @ 0x00697300
    }
}
