/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage03\St03SecurityGate.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x680270
class NNS_VECTORFAST m_osOffsetPos; // size: 0x10, address: 0x680280
struct /* @anon12 */ {
    // total size: 0x48
} __vt__20clsSecurityGate_Task; // size: 0x48, address: 0x6C08E0
void * __dt(class clsSecurityGate_Ctrl *, signed short); // size: 0x0, address: 0x3A1B30
struct /* @anon3 */ {
    // total size: 0x48
} __vt__88clsBaseGimmickBody<20clsSecurityGate_Task,20clsSecurityGate_Ctrl,20clsSecurityGateModel>; // size: 0x48, address: 0x6C09F0
struct /* @anon14 */ {
    // total size: 0x30
...
struct /* @anon0 */ {
    // total size: 0x34
} __vt__24clsSecurityGateCollision; // size: 0x34, address: 0x6C0A90
void * __dt(class clsSecurityGate_Obj *, signed short); // size: 0x0, address: 0x3A1C30
struct /* @anon13 */ {
    // total size: 0x44
} __vt__20clsSecurityGate_Ctrl; // size: 0x44, address: 0x6C0A40
struct /* @anon5 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon15 */ {
    // total size: 0xA8
} __vt__19clsSecurityGate_Obj; // size: 0xA8, address: 0x6C0930
struct /* @anon9 */ {
    // total size: 0xC
...
void * __ct(class clsSecurityGate_Ctrl *); // size: 0x0, address: 0x3A2DE0
class clsSecurityGate_Task * m_tpcSingleton; // size: 0x4, address: 0xB15F48
struct /* @anon21 */ {
    // total size: 0xC
} __vt__36clsSingleton<20clsSecurityGate_Task>; // size: 0xC, address: 0x6C09D8
void * __ct(class clsSecurityGate_Obj *); // size: 0x0, address: 0x3A2FA0
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x6802F0
...
void drawPartsBreakEffect(class NNS_VECTORFAST &); // size: 0x0, address: 0x3A3760
void * __dt(class clsDebriPartsRigid *, signed short); // size: 0x0, address: 0x3A4850
void * __ct(class clsDebriPartsRigid *); // size: 0x0, address: 0x3A48D0
class stcInfo oasGroundInfo[]; // size: 0x0, address: 0x66AE40
float t_of32WeightTypeSuperHeavy; // size: 0x4, address: 0x6651B0
struct /* @anon4 */ {
    // total size: 0x28
} __vt__18clsDebriPartsRigid; // size: 0x28, address: 0x6C1630
struct /* @anon22 */ {
    // total size: 0xC
...
class clsSecurityGate_Obj : public clsRigidBodyGimmickObj {
    // total size: 0x140
public:
    class clsSecurityGate_Ctrl * m_pcSecurityGate_Ctrl; // offset 0xD0, size 0x4
    enum enmSecurityGateMode m_eSecurityGateMode; // offset 0xD4, size 0x4
    enum enmSecurityGateState m_eSecurityGateState; // offset 0xD8, size 0x4
    enum enmSecurityGateState m_eNextSecurityGateState; // offset 0xDC, size 0x4
    class NNS_QUATERNION m_sOffsetRot; // offset 0xE0, size 0x10
    class NNS_QUATERNION m_sGateRot; // offset 0xF0, size 0x10
    class NNS_VECTORFAST m_sGatePos; // offset 0x100, size 0x10
    class NNS_VECTORFAST m_sAddPos; // offset 0x110, size 0x10
    float m_f32MotionFrame; // offset 0x120, size 0x4
    float m_f32AddFrame; // offset 0x124, size 0x4
    signed int m_s32Count; // offset 0x128, size 0x4
    signed int m_s32BigDoorCount; // offset 0x12C, size 0x4
    float m_f32DoorAnimeFrameS; // offset 0x130, size 0x4
    float m_f32DoorAnimeFrameL; // offset 0x134, size 0x4
    float m_f32BigOpenDoorWait; // offset 0x138, size 0x4
};
...
class clsSecurityGate_Task : public clsBaseGimmickBody {
    // total size: 0xAC
public:
    class hkShape * m_pcPartsShape; // offset 0xA0, size 0x4
    class hkTransformShape * m_pcTransShape[2]; // offset 0xA4, size 0x8
};
...
class clsSecurityGate_Ctrl : public clsGimmickObj {
    // total size: 0x2F0
public:
    class clsRigidBodyGimmickObj * m_pcRigidBodyObject; // offset 0x50, size 0x4
    class clsSecurityGateCollision m_cCollision; // offset 0x54, size 0xC
    class clsSecurityGate_Obj m_acObj[2]; // offset 0x60, size 0x280
    unsigned int m_u32PlayerFlg; // offset 0x2E0, size 0x4
    unsigned char m_u8GateFlg; // offset 0x2E4, size 0x1
    class clsSe3DControl * m_pcSe3DControl; // offset 0x2E8, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xA0
public:
    class clsSecurityGate_Ctrl * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsSecurityGateModel m_cModel; // offset 0x88, size 0x14
...
class clsSecurityGateCollision : public clsBaseThroughCollision {
    // total size: 0xC
public:
    class clsSecurityGate_Ctrl * m_pcSecurityGate_Ctrl; // offset 0x8, size 0x4
};
enum enmNo {
    PLAYER_00 = 0,
    PLAYER_01 = 1,
...
class clsDebriPartsRigid : public clsDebriPartsBase {
    // total size: 0x50
public:
    class NNS_QUATERNION m_sRotQuat; // offset 0x30, size 0x10
    class clsRigidBody * m_pcRigidBody; // offset 0x40, size 0x4
};
class hkArray {
    // total size: 0xC
public:
...
// Range: 0x3A1D30 -> 0x3A1EF8
void draw(class clsSecurityGate_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A1D30 -> 0x3A1EF8
...
// Range: 0x3A1F00 -> 0x3A2144
void execute(class clsSecurityGate_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A1F00 -> 0x3A2144
...
// Range: 0x3A2150 -> 0x3A2438
void init(class clsSecurityGate_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A2150 -> 0x3A2438
        float sMtxPal[4][4]; // r29+0x60
        class NNS_VECTORFAST sPos01; // r29+0x50
    }
}


// Range: 0x3A2550 -> 0x3A2668
void createModel(class clsSecurityGate_Task * this /* r2 */, class stcBinInfo & rsBinInfoI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A2550 -> 0x3A2668
...
// Range: 0x3A2670 -> 0x3A26D0
void reset(class clsSecurityGate_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A2670 -> 0x3A26D0
        unsigned int u32Num; // r2
...
// Range: 0x3A26D0 -> 0x3A2C34
void * __ct(class clsSecurityGate_Task * this /* r18 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A26D0 -> 0x3A2C34
        class hkVector4 cBoxVec01; // r29+0x110
        class hkVector4 cBoxVec02; // r29+0x100
        class hkQuaternion cBoxQuaternion; // r29+0xF0
        class hkTransform cTrans01; // r29+0xB0
        class hkTransform cTrans02; // r29+0x70
        class hkArray shapeArray; // r29+0x120
        class hkVector4 cHelfBoxSize; // r29+0x60
        class hkVector4 cBox; // r29+0x50
    }
}


// Range: 0x3A3110 -> 0x3A32FC
void draw(class clsSecurityGate_Ctrl * this /* r29+0xBC */, class clsModelType_OB_TX_MO & rcModel /* r19 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r22 */, float (* opaNnViewMtx)[4][4] /* r23 */, float (* psMtxWork)[4][4] /* r17 */, unsigned int u32ViewNo /* r30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A3110 -> 0x3A32FC
...
// Range: 0x3A33A0 -> 0x3A3418
void destroyData(class clsSecurityGate_Ctrl * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A33A0 -> 0x3A3418
        unsigned int u32i; // r17
...
// Range: 0x3A3420 -> 0x3A352C
void createData(class clsSecurityGate_Ctrl * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A3420 -> 0x3A352C
        unsigned int u32i; // r16
...
// Range: 0x3A3530 -> 0x3A3590
void openDoor(class clsSecurityGate_Ctrl * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A3530 -> 0x3A3590
        unsigned int u32i; // r16
...
// Range: 0x3A3590 -> 0x3A35DC
void openDoor(class clsSecurityGate_Ctrl * this /* r2 */, unsigned int u32PlayerNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A3590 -> 0x3A35DC
    }
...
// Range: 0x3A35E0 -> 0x3A3704
void reset(class clsSecurityGate_Ctrl * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A35E0 -> 0x3A3704
        unsigned int u32i; // r17
...
// Range: 0x3A3710 -> 0x3A3758
void contactInterraction(class clsSecurityGate_Obj * this /* r17 */, class clsRigidBodyGimmickObj * pcObject /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A3710 -> 0x3A3758
    }
...
// Range: 0x3A3760 -> 0x3A3790
void drawPartsBreakEffect(class NNS_VECTORFAST & rsPosVecFast /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A3760 -> 0x3A3790
    }
...
// Range: 0x3A3790 -> 0x3A37C4
void requestDrawBreakEffect(class clsSecurityGate_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A3790 -> 0x3A37C4
    }
...
// Range: 0x3A37D0 -> 0x3A4074
void main(class clsSecurityGate_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A37D0 -> 0x3A4074
...
// Range: 0x3A4080 -> 0x3A41E4
void openDoor(class clsSecurityGate_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A4080 -> 0x3A41E4
...
// Range: 0x3A41F0 -> 0x3A4268
void destroyData(class clsSecurityGate_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A41F0 -> 0x3A4268
    }
...
// Range: 0x3A4270 -> 0x3A4848
void createData(class clsSecurityGate_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A4270 -> 0x3A4848
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0x140
        class hkMassProperties massProperties; // r29+0xF0
        class hkVector4 cOffset; // r29+0xE0
        class hkMassProperties massProperties; // r29+0x90
        char __FUNCTION__[14]; // @ 0x00680260
    }
}


// Range: 0x3A4920 -> 0x3A49F0
void contactRemoveEvent(class clsSecurityGateCollision * this /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A4920 -> 0x3A49F0
    }
...
// Range: 0x3A49F0 -> 0x3A49FC
void contactTriggerEvent(class clsSecurityGateCollision * this /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A49F0 -> 0x3A49FC
    }
...
// Range: 0x3A4A00 -> 0x3A4B94
void reset(class clsSecurityGate_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3A4A00 -> 0x3A4B94
        class NNS_VECTORFAST sPos01; // r29+0x50
