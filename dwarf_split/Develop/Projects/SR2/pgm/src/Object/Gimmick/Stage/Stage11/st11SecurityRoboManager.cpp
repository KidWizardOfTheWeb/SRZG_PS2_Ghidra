/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage11\st11SecurityRoboManager.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class stcRoboArray m_oastcRoboArray[3]; // size: 0x84, address: 0x6896D0
struct /* @anon10 */ {
    // total size: 0x48
} __vt__27clsSecurityRoboManager_Task; // size: 0x48, address: 0x6C79A0
void * __dt(class clsSecurityRoboManager_Obj *, signed short); // size: 0x0, address: 0x487850
struct /* @anon11 */ {
    // total size: 0x48
} __vt__106clsBaseGimmickBody<27clsSecurityRoboManager_Task,26clsSecurityRoboManager_Obj,25clsSt11SecurityRoboModels>; // size: 0x48, address: 0x6C7A50
struct /* @anon7 */ {
    // total size: 0x30
...
struct /* @anon0 */ {
    // total size: 0x34
} __vt__24clsSecurityRoboCollision; // size: 0x34, address: 0x6C7AA0
struct /* @anon4 */ {
    // total size: 0x44
} __vt__26clsSecurityRoboManager_Obj; // size: 0x44, address: 0x6C79F0
...
void * __ct(class clsSecurityRoboManager_Obj *); // size: 0x0, address: 0x488420
class clsSecurityRoboManager_Task * m_tpcSingleton; // size: 0x4, address: 0xB17508
struct /* @anon3 */ {
    // total size: 0xC
} __vt__43clsSingleton<27clsSecurityRoboManager_Task>; // size: 0xC, address: 0x6C7A38
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
void * __dt(class clsPathSecurityRobo_Obj *, signed short); // size: 0x0, address: 0x487290
float hkConvexShapeDefaultRadius; // size: 0x4, address: 0x6223B8
void * __ct(class clsPathSecurityRobo_Obj *); // size: 0x0, address: 0x4873A0
struct /* @anon13 */ {
    // total size: 0xC
...
class stcRoboArray {
    // total size: 0x2C
public:
    unsigned char u8RoboNum; // offset 0x0, size 0x1
    float f32WaitFrame[10]; // offset 0x4, size 0x28
};
...
// Range: 0x487930 -> 0x487BB4
void draw(class clsSecurityRoboManager_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x487930 -> 0x487BB4
        ...
        class clsSt11SecurityRoboModels & rcModel; // r20
        float sMtx[4][4]; // r29+0xC0
        float f32MoveSpeed; // r21
...
// Range: 0x487BC0 -> 0x487E1C
void execute(class clsSecurityRoboManager_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x487BC0 -> 0x487E1C
        unsigned int u32Num; // r2
...
// Range: 0x487E20 -> 0x488008
void createModel(class clsSecurityRoboManager_Task * this /* r2 */, class stcBinInfo & rsBinInfoI /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x487E20 -> 0x488008
...
// Range: 0x488010 -> 0x488078
void reset(class clsSecurityRoboManager_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x488010 -> 0x488078
        unsigned int u32Num; // r2
...
// Range: 0x488080 -> 0x488264
void * __ct(class clsSecurityRoboManager_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x488080 -> 0x488264
        class hkVector4 cTop; // r29+0x60
        class hkVector4 cButtom; // r29+0x50
    }
}


// Range: 0x488620 -> 0x48869C
void destroyData(class clsSecurityRoboManager_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x488620 -> 0x48869C
    }
...
// Range: 0x4886A0 -> 0x488CC4
void createData(class clsSecurityRoboManager_Obj * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4886A0 -> 0x488CC4
        unsigned char u8RoboNum; // r2
        class stcSetDataDetail * psSetData; // r20
        class stcRoboData * psRoboData; // r19
        unsigned int au32PathNo[10]; // r29+0xC0
        float af32Speed[10]; // r29+0x90
        signed int s32j; // r18
        class clsPathSecurityRobo_Obj * pcObj; // r2
...
// Range: 0x488CD0 -> 0x488CE0
void setData(class clsSecurityRoboManager_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x488CD0 -> 0x488CE0
    }
...
// Range: 0x488CE0 -> 0x488DA8
void contactTriggerEvent(class clsSecurityRoboCollision * this /* r21 */, class clsPlayerTask * pcPlayer /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x488CE0 -> 0x488DA8
    }
