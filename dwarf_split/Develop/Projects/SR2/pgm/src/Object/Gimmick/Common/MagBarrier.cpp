/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\MagBarrier.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float toaf32ScaleTbl[19]; // size: 0x4C, address: 0x6982D0
static unsigned char chk__toaf32ScaleTbl_SizeCheck_[1]; // size: 0x1, address: 0x0
struct /* @anon10 */ {
    // total size: 0x44
} __vt__17clsMagBarrier_Obj; // size: 0x44, address: 0x6D0AC0
struct /* @anon7 */ {
    // total size: 0x28
...
struct /* @anon5 */ {
    // total size: 0x48
} __vt__18clsMagBarrier_Task; // size: 0x48, address: 0x6D0B70
struct /* @anon9 */ {
    // total size: 0x48
} __vt__95clsSingleModelGimmick_Task<18clsMagBarrier_Task,17clsMagBarrier_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6D0BC0
void * __dt(class clsMagBarrier_Obj *, signed short); // size: 0x0, address: 0x562D40
struct /* @anon3 */ {
    // total size: 0x48
} __vt__87clsBaseGimmickBody<18clsMagBarrier_Task,17clsMagBarrier_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6D0B20
struct /* @anon8 */ {
    // total size: 0x30
...
struct /* @anon1 */ {
    // total size: 0xC
} __vt__34clsSingleton<18clsMagBarrier_Task>; // size: 0xC, address: 0x6D0B08
void * __ct(class clsMagBarrier_Obj *); // size: 0x0, address: 0x563DF0
...
// Range: 0x562DE0 -> 0x563060
void draw(class clsMagBarrier_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x562DE0 -> 0x563060
        ...
        float sMtxWork[4][4]; // r29+0x160
    }
}


// Range: 0x563060 -> 0x56333C
void execute(class clsMagBarrier_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x563060 -> 0x56333C
        float & rc32MotFrame; // r2
        float & rf32MatFrame; // r2
...
// Range: 0x5633C0 -> 0x563448
void change(class clsMagBarrier_Task * this /* r16 */, class clsPlayerTask * pcPlayer00 /* r2 */, class clsPlayerTask * pcPlayer01 /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5633C0 -> 0x563448
        class clsMagBarrier_Obj * pcObj00; // r2
        class clsMagBarrier_Obj * pcObj01; // r2
    }
}


// Range: 0x563450 -> 0x563554
void regist(class clsMagBarrier_Task * this /* r18 */, class clsPlayerTask * pcPlayer /* r17 */, unsigned char bInfinity /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x563450 -> 0x563554
        class clsMagBarrier_Obj * pcObj; // r29+0x4C
    }
}


// Range: 0x563560 -> 0x56363C
class clsMagBarrier_Obj * getRegistObj(class clsMagBarrier_Task * this /* r17 */, class clsPlayerTask * pcPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x563560 -> 0x56363C
        class clsMagBarrier_Obj * pcObj; // r22
    }
}


// Range: 0x563640 -> 0x5636F4
void reset(class clsMagBarrier_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x563640 -> 0x5636F4
...
// Range: 0x563700 -> 0x5638B4
void * __ct(class clsMagBarrier_Task * this /* r18 */, class stcSetDataDetail & orsSetDataDetailI /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x563700 -> 0x5638B4
        signed int u32i; // r16
...
// Range: 0x563EE0 -> 0x5641FC
void execute(class clsMagBarrier_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x563EE0 -> 0x5641FC
...
// Range: 0x564340 -> 0x564380
void destroyData(class clsMagBarrier_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x564340 -> 0x564380
    }
...
// Range: 0x5646D0 -> 0x5646D8
void @104@__dt__95clsSingleModelGimmick_Task<18clsMagBarrier_Task,17clsMagBarrier_Obj,24clsModelType_OB_TX_MO_MA>Fv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5646D0 -> 0x5646D8
    }
...
// Range: 0x5646E0 -> 0x5646E8
void @104@__dt__18clsMagBarrier_TaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5646E0 -> 0x5646E8
    }
...
// Range: 0x5646F0 -> 0x5646F8
void @104@__dt__87clsBaseGimmickBody<18clsMagBarrier_Task,17clsMagBarrier_Obj,24clsModelType_OB_TX_MO_MA>Fv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5646F0 -> 0x5646F8
    }
