/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\PutFixedBurnObj.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32CLIP_DISTx2; // size: 0x4, address: 0x6936A8
struct /* @anon7 */ {
    // total size: 0x48
} __vt__23clsPutFixedBurnObj_Task; // size: 0x48, address: 0x6CD210
struct /* @anon8 */ {
    // total size: 0x48
} __vt__94clsMultiModelGimmick_Task<23clsPutFixedBurnObj_Task,22clsPutFixedBurnObj_Obj,14clsMultiModels>; // size: 0x48, address: 0x6B9620
struct /* @anon1 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPutFixedBurnObj_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A888
struct /* @anon0 */ {
    // total size: 0xC
} __vt__39clsSingleton<23clsPutFixedBurnObj_Task>; // size: 0xC, address: 0x6B95B8
void * __dt(class clsModelType_OB_TX_MO_MA *, signed short); // size: 0x0, address: 0x1F2670
void * __dt(class clsPutFixedBurnObj_Obj *, signed short); // size: 0x0, address: 0x2D42D0
struct /* @anon2 */ {
    // total size: 0x48
} __vt__87clsBaseGimmickBody<23clsPutFixedBurnObj_Task,22clsPutFixedBurnObj_Obj,14clsMultiModels>; // size: 0x48, address: 0x6B95D0
struct /* @anon4 */ {
    // total size: 0x28
...
struct /* @anon6 */ {
    // total size: 0x44
} __vt__22clsPutFixedBurnObj_Obj; // size: 0x44, address: 0x6CD260
...
class clsPutFixedBurnObj_Task : public clsMultiModelGimmick_Task {
    // total size: 0x98
};
...
public:
    ...
    void m_pfDrawFunc; // offset 0x54, size 0x0
};
class clsSingleton {
    // total size: 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPutFixedBurnObj_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsMultiModels m_cModel; // offset 0x88, size 0x8
...
// Range: 0x512B10 -> 0x512C44
void draw(class clsPutFixedBurnObj_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x512B10 -> 0x512C44
        ...
        class clsModelType_OB_TX_MO_MA * pcModel; // r19
...
// Range: 0x512C50 -> 0x512E14
void execute(class clsPutFixedBurnObj_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x512C50 -> 0x512E14
        unsigned int u32Num; // r2
...
// Range: 0x512E20 -> 0x512E50
void reset(class clsPutFixedBurnObj_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x512E20 -> 0x512E50
        class clsModelType_OB_TX_MO_MA * pcModel; // r5
        unsigned int u32Num; // r3
    }
}


// Range: 0x512E50 -> 0x513068
unsigned char draw(class clsPutFixedBurnObj_Obj * this /* r18 */, class clsModelType_OB_TX_MO_MA * pcModels /* r20 */, float (* psMtxPal)[4][4] /* r22 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r23 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x512E50 -> 0x513068
...
// Range: 0x513070 -> 0x513104
unsigned char drawObTxMoMa(class clsPutFixedBurnObj_Obj * this /* r2 */, class clsModelType_OB_TX_MO_MA * pcModel /* r19 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r17 */, float (* psMtxWork)[4][4] /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x513070 -> 0x513104
    }
...
// Range: 0x513110 -> 0x51319C
unsigned char drawObTxMa(class clsPutFixedBurnObj_Obj * this /* r2 */, class clsModelType_OB_TX_MO_MA * pcModel /* r19 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r17 */, float (* psMtxWork)[4][4] /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x513110 -> 0x51319C
    }
...
// Range: 0x5131A0 -> 0x513234
unsigned char drawObTxMo(class clsPutFixedBurnObj_Obj * this /* r2 */, class clsModelType_OB_TX_MO_MA * pcModel /* r19 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r17 */, float (* psMtxWork)[4][4] /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5131A0 -> 0x513234
    }
...
// Range: 0x513240 -> 0x5132B4
unsigned char drawObTx(class clsPutFixedBurnObj_Obj * this /* r2 */, class clsModelType_OB_TX_MO_MA * pcModel /* r18 */, unsigned int * psNodeStat /* r17 */, float (* psMtxWork)[4][4] /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x513240 -> 0x5132B4
    }
...
// Range: 0x5132C0 -> 0x5132F0
void setData(class clsPutFixedBurnObj_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5132C0 -> 0x5132F0
    }
...
// Range: 0x5132F0 -> 0x513414
void init(class clsPutFixedBurnObj_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5132F0 -> 0x513414
        class clsModelType_OB_TX_MO_MA & rcModel; // r2
        enum enmDrawMode eDrawMode; // r7
    }
}
