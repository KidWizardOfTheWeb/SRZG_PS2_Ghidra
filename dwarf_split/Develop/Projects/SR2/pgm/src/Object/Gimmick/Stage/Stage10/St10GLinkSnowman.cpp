/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage10\St10GLinkSnowman.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x6881E8
float tof32ClipSqDist; // size: 0x4, address: 0x6881F8
class clsGravityGimmickParam t_ocGravityGimmickParam[2]; // size: 0xF0, address: 0x688200
struct /* @anon3 */ {
    // total size: 0x48
} __vt__20clsGLinkSnowman_Task; // size: 0x48, address: 0x6C6340
struct /* @anon7 */ {
    // total size: 0x48
} __vt__96clsSingleModelGimmick_Task<20clsGLinkSnowman_Task,22clsGLinkSnowman_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C64B0
struct /* @anon21 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsGLinkSnowman_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A790
struct /* @anon18 */ {
    // total size: 0xC
} __vt__36clsSingleton<20clsGLinkSnowman_Task>; // size: 0xC, address: 0x6C6448
void * __dt(class clsGLinkSnowman_Object *, signed short); // size: 0x0, address: 0x460010
struct /* @anon0 */ {
    // total size: 0x48
} __vt__88clsBaseGimmickBody<20clsGLinkSnowman_Task,22clsGLinkSnowman_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C6460
struct /* @anon17 */ {
    // total size: 0xB4
} __vt__24clsBaseGravityLinkObject; // size: 0xB4, address: 0x6C1420
struct /* @anon13 */ {
    // total size: 0xB8
} __vt__22clsGLinkSnowman_Object; // size: 0xB8, address: 0x6C6390
struct /* @anon12 */ {
    // total size: 0x28
...
void * __ct(class clsGLinkSnowman_Object *); // size: 0x0, address: 0x460920
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x688380
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x688390
...
public:
    ...
    unsigned char bDrawFlag; // offset 0xE8, size 0x1
    float m_sShadowMtx[4][4]; // offset 0xF0, size 0x40
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsGLinkSnowman_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsGLinkSnowman_Task : public clsSingleModelGimmick_Task {
    // total size: 0xA0
public:
    class hkShape * m_pcPartsShape; // offset 0x94, size 0x4
    unsigned char m_bFlag; // offset 0x98, size 0x1
    class clsModelType_OB m_cModel; // offset 0x9C, size 0x4
};
class hkRootCdPoint {
    // total size: 0x30
public:
...
// Range: 0x4600B0 -> 0x4600F0
void setShadowModel(class clsGLinkSnowman_Task * this /* r16 */, unsigned char * rsBinInfoI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4600B0 -> 0x4600F0
    }
...
// Range: 0x4600F0 -> 0x4602E8
void draw(class clsGLinkSnowman_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4600F0 -> 0x4602E8
...
// Range: 0x4602F0 -> 0x460470
void execute(class clsGLinkSnowman_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4602F0 -> 0x460470
...
// Range: 0x460470 -> 0x4604E0
void reset(class clsGLinkSnowman_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x460470 -> 0x4604E0
        unsigned int u32Num; // r2
...
// Range: 0x4604E0 -> 0x4605B4
void * __ct(class clsGLinkSnowman_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4604E0 -> 0x4605B4
...
// Range: 0x460990 -> 0x460D80
void drawShadow(class clsGLinkSnowman_Object * this /* r21 */, class clsModelType_OB & rcModel /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x460990 -> 0x460D80
...
// Range: 0x460D80 -> 0x460E34
void destroyData(class clsGLinkSnowman_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x460D80 -> 0x460E34
    }
...
// Range: 0x460E40 -> 0x461754
void createData(class clsGLinkSnowman_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x460E40 -> 0x461754
        ...
        char __FUNCTION__[14]; // @ 0x006881D8
    }
}


// Range: 0x461760 -> 0x461768
void setData() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x461760 -> 0x461768
...
void drawEffect(class clsPlayerTask * pcPlayer /* r16 */) {
    ...
    /* anonymous block */ {
        ...
        class NNS_VECTOR LOCAL_POS_R; // @ 0x00688320
        class NNS_VECTOR LOCAL_POS; // @ 0x00688310
        class NNS_VECTOR RAND_SP; // @ 0x00688300
        float LIFE_FRAME; // @ 0x00688330
        class NNS_VECTOR BEGIN_SP; // @ 0x006882F0
    }
}


// Range: 0x461890 -> 0x4618E0
...
// Range: 0x4618E0 -> 0x461938
void callbackContactTriggerRigidBody(class clsGLinkSnowman_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4618E0 -> 0x461938
    }
...
// Range: 0x461940 -> 0x46197C
void requestDrawBreakEffect(class clsGLinkSnowman_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x461940 -> 0x46197C
    }
...
// Range: 0x461980 -> 0x461A0C
void main(class clsGLinkSnowman_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x461980 -> 0x461A0C
    }
...
// Range: 0x461A10 -> 0x461B2C
void reset(class clsGLinkSnowman_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x461A10 -> 0x461B2C
...
// Range: 0x461B30 -> 0x461DDC
void draw(class clsGLinkSnowman_Object * this /* r17 */, class NNS_OBJECT * psObject /* r16 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r20 */, float (* psMtxWork)[4][4] /* r19 */, unsigned int u32ViewNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x461B30 -> 0x461DDC
    }
