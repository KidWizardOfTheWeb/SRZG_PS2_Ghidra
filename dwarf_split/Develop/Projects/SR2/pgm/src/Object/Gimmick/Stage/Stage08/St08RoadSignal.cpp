/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage08\St08RoadSignal.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32CLIP_DISTx2; // size: 0x4, address: 0x695F20
struct /* @anon7 */ {
    // total size: 0x48
} __vt__18clsRoadSignal_Task; // size: 0x48, address: 0x6CE230
struct /* @anon9 */ {
    // total size: 0x48
} __vt__92clsSingleModelGimmick_Task<18clsRoadSignal_Task,17clsRoadSignal_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6BA950
struct /* @anon2 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsRoadSignal_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A7B8
struct /* @anon1 */ {
    // total size: 0xC
} __vt__34clsSingleton<18clsRoadSignal_Task>; // size: 0xC, address: 0x6BA8E8
void * __dt(class clsRoadSignal_Obj *, signed short); // size: 0x0, address: 0x2CB760
struct /* @anon3 */ {
    // total size: 0x48
} __vt__84clsBaseGimmickBody<18clsRoadSignal_Task,17clsRoadSignal_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6BA900
struct /* @anon6 */ {
    // total size: 0x28
...
struct /* @anon4 */ {
    // total size: 0x44
} __vt__17clsRoadSignal_Obj; // size: 0x44, address: 0x6BA8A0
...
public:
    ...
    float m_f32MotionFrame; // offset 0x54, size 0x4
    class clsRoad_Obj * m_pcRoadObj; // offset 0x58, size 0x4
    float m_f32OldFrame; // offset 0x5C, size 0x4
};
class sceGsTex0 {
    // total size: 0x8
public:
...
class clsRoadSignal_Task : public clsSingleModelGimmick_Task {
    // total size: 0x9C
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x9C
public:
    class clsRoadSignal_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
...
// Range: 0x529690 -> 0x529814
void draw(class clsRoadSignal_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x529690 -> 0x529814
        ...
        class clsModelType_OB_TX_MO & rcModell; // r18
...
// Range: 0x529820 -> 0x5298D8
void execute(class clsRoadSignal_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x529820 -> 0x5298D8
        unsigned int u32Num; // r2
...
// Range: 0x5298E0 -> 0x5299C4
void reset(class clsRoadSignal_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5298E0 -> 0x5299C4
        unsigned int u32Num; // r2
...
// Range: 0x5299D0 -> 0x529C48
void draw(class clsRoadSignal_Obj * this /* r21 */, class clsModelType_OB_TX_MO & rcModel /* r20 */, float (* psMtxPal)[4][4] /* r19 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r22 */, float (* psMtxWork)[4][4] /* r17 */, unsigned int u32ViewNo /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5299D0 -> 0x529C48
...
// Range: 0x529C50 -> 0x529F00
void execute(class clsRoadSignal_Obj * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x529C50 -> 0x529F00
        unsigned int u32Snd; // r22
        unsigned int u32Num; // r2
        class clsPlayerTask * * apcPlayer; // r20
