/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage10\St10FallSnowBall.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x688138
struct /* @anon13 */ {
    // total size: 0x48
} __vt__20clsFallSnowBall_Task; // size: 0x48, address: 0x6C6190
struct /* @anon0 */ {
    // total size: 0x48
} __vt__93clsSingleModelGimmick_Task<20clsFallSnowBall_Task,19clsFallSnowBall_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C6240
struct /* @anon4 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsFallSnowBall_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A798
struct /* @anon5 */ {
    // total size: 0xC
} __vt__36clsSingleton<20clsFallSnowBall_Task>; // size: 0xC, address: 0x6C61D8
void * __dt(class clsFallSnowBall_Obj *, signed short); // size: 0x0, address: 0x45DBE0
struct /* @anon14 */ {
    // total size: 0x48
} __vt__85clsBaseGimmickBody<20clsFallSnowBall_Task,19clsFallSnowBall_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C61F0
struct /* @anon15 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon12 */ {
    // total size: 0xA8
} __vt__19clsFallSnowBall_Obj; // size: 0xA8, address: 0x6C6290
struct /* @anon10 */ {
    // total size: 0x28
...
void * __ct(class clsFallSnowBall_Obj *); // size: 0x0, address: 0x45F990
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x688180
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x688190
...
class clsFallSnowBall_Obj : public clsRigidBodyGimmickObj {
    // total size: 0x140
public:
    enum enmFallSnowBallMode m_eFallSnowBallMode; // offset 0xD0, size 0x4
    float m_f32Frame; // offset 0xD4, size 0x4
    signed int m_s32ContactCount; // offset 0xD8, size 0x4
    float m_f32Scale; // offset 0xDC, size 0x4
    float m_f32StartWaitFrame; // offset 0xE0, size 0x4
    float m_f32TotalFrame; // offset 0xE4, size 0x4
    unsigned char bHitFlag; // offset 0xE8, size 0x1
    class clsSe3DControl * m_pcSe3DControl; // offset 0xEC, size 0x4
    unsigned char bDrawFlag; // offset 0xF0, size 0x1
    float m_sShadowMtx[4][4]; // offset 0x100, size 0x40
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsFallSnowBall_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsFallSnowBall_Task : public clsSingleModelGimmick_Task {
    // total size: 0x9C
public:
    class clsModelType_OB m_cModel; // offset 0x94, size 0x4
    unsigned char m_bFlag; // offset 0x98, size 0x1
};
class clsFlag {
    // total size: 0x4
public:
...
// Range: 0x45DCE0 -> 0x45DD20
void setShadowModel(class clsFallSnowBall_Task * this /* r16 */, unsigned char * rsBinInfoI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45DCE0 -> 0x45DD20
    }
...
// Range: 0x45DD20 -> 0x45DF34
void draw(class clsFallSnowBall_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45DD20 -> 0x45DF34
        ...
        class clsModelType_OB_TX & rcModel; // r19
        float sWorkMtx[4][4]; // r29+0x90
        unsigned int u32i; // r18
    }
}


// Range: 0x45DF40 -> 0x45E110
void execute(class clsFallSnowBall_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45DF40 -> 0x45E110
        unsigned int u32Num; // r2
...
// Range: 0x45E110 -> 0x45E180
void reset(class clsFallSnowBall_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45E110 -> 0x45E180
        unsigned int u32Num; // r2
...
// Range: 0x45E180 -> 0x45E230
void * __ct(class clsFallSnowBall_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45E180 -> 0x45E230
    }
...
// Range: 0x45E580 -> 0x45E5D8
void requestDrawBreakEffect(class clsFallSnowBall_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45E580 -> 0x45E5D8
    }
...
// Range: 0x45E5E0 -> 0x45E9F0
void drawShadow(class clsFallSnowBall_Obj * this /* r21 */, class clsModelType_OB & rcModel /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45E5E0 -> 0x45E9F0
        ...
        float f32RadY; // r29+0xB0
        class NNS_RGB sOldDiffuse; // r29+0xA0
        class NNS_MATERIAL_SINGLE * psMaterial; // r18
        unsigned int u32OldTest; // r2
    }
}


// Range: 0x45E9F0 -> 0x45EA5C
void callbackGravityEvent(class clsFallSnowBall_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45E9F0 -> 0x45EA5C
    }
...
// Range: 0x45EA60 -> 0x45EE58
void CheckCount(class clsFallSnowBall_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45EA60 -> 0x45EE58
        class NNS_VECTORFAST sFoceFast; // r29+0x130
        float psMtxWork[4][4]; // r29+0xF0
        class hkVector4 cPoint; // r29+0xE0
        class hkVector4 cZeroVelocity; // r29+0xD0
        class NNS_VECTORFAST sFoceFast; // r29+0xC0
        float psMtxWork[4][4]; // r29+0x80
        class hkVector4 cPoint; // r29+0x70
    }
}


// Range: 0x45EE60 -> 0x45EEB0
...
// Range: 0x45EEB0 -> 0x45EF78
void callbackContactTriggerRigidBody(class clsFallSnowBall_Obj * this /* r17 */, class hkContactPointConfirmedEvent & cEvent /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45EEB0 -> 0x45EF78
    }
...
// Range: 0x45EF80 -> 0x45F004
void contactTriggerEvent(class clsFallSnowBall_Obj * this /* r18 */, class hkContactPoint * pcContact /* r17 */, class clsObject * pcObject /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45EF80 -> 0x45F004
...
// Range: 0x45F010 -> 0x45F2D0
void draw(class clsFallSnowBall_Obj * this /* r19 */, class clsModelType_OB_TX & rcModel /* r18 */, float (* psMtxPal)[4][4] /* r17 */, unsigned int * psNodeStat /* r16 */, float (* opaNnViewMtx)[4][4] /* r17 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45F010 -> 0x45F2D0
...
// Range: 0x45F2D0 -> 0x45F330
void main(class clsFallSnowBall_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45F2D0 -> 0x45F330
    }
...
// Range: 0x45F330 -> 0x45F43C
void reset(class clsFallSnowBall_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45F330 -> 0x45F43C
    }
...
// Range: 0x45F440 -> 0x45F4C0
void destroyData(class clsFallSnowBall_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45F440 -> 0x45F4C0
    }
...
// Range: 0x45F4C0 -> 0x45F984
void createData(class clsFallSnowBall_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45F4C0 -> 0x45F984
...
// Range: 0x45F990 -> 0x45FA64
void * __ct(class clsFallSnowBall_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45F990 -> 0x45FA64
    }
...
// Range: 0x45FA70 -> 0x45FA8C
void init(class clsFallSnowBall_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45FA70 -> 0x45FA8C
    }
