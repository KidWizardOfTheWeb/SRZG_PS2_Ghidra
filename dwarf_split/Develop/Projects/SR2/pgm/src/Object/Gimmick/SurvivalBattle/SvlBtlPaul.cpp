/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\SurvivalBattle\SvlBtlPaul.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float t_of32Mass; // size: 0x4, address: 0x697688
float t_of32CLIP_DISTx2; // size: 0x4, address: 0x697690
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x6976A0
struct /* @anon14 */ {
    // total size: 0x48
} __vt__18clsSvlBtlPaul_Task; // size: 0x48, address: 0x6CF690
struct /* @anon19 */ {
    // total size: 0x48
} __vt__98clsSingleModelGimmick_Task<18clsSvlBtlPaul_Task,20clsSvlBtlPaul_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6CF740
struct /* @anon10 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsSvlBtlPaul_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA820
struct /* @anon3 */ {
    // total size: 0xC
} __vt__34clsSingleton<18clsSvlBtlPaul_Task>; // size: 0xC, address: 0x6CF6D8
void * __dt(class clsSvlBtlPaul_Object *, signed short); // size: 0x0, address: 0x547F70
struct /* @anon9 */ {
    // total size: 0x48
} __vt__90clsBaseGimmickBody<18clsSvlBtlPaul_Task,20clsSvlBtlPaul_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6CF6F0
struct /* @anon13 */ {
    // total size: 0xB4
} __vt__19clsBaseSvlBtlObject; // size: 0xB4, address: 0x6CF100
struct /* @anon0 */ {
    // total size: 0xB4
} __vt__20clsSvlBtlPaul_Object; // size: 0xB4, address: 0x6CF790
struct /* @anon18 */ {
    // total size: 0xA8
...
void * __ct(class clsSvlBtlPaul_Object *); // size: 0x0, address: 0x548910
...
class clsSvlBtlPaul_Task : public clsSingleModelGimmick_Task {
    // total size: 0xAC
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsSvlBtlPaul_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x548000 -> 0x5482F4
void draw(class clsSvlBtlPaul_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x548000 -> 0x5482F4
...
// Range: 0x548340 -> 0x548458
void execute(class clsSvlBtlPaul_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x548340 -> 0x548458
        unsigned int u32Num; // r2
...
// Range: 0x548460 -> 0x5484D0
void reset(class clsSvlBtlPaul_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x548460 -> 0x5484D0
        unsigned int u32Num; // r2
...
// Range: 0x5484D0 -> 0x548598
void * __ct(class clsSvlBtlPaul_Task * this /* r16 */, unsigned int u32NumI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5484D0 -> 0x548598
