/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\PutParallaxObj.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x6902F0
struct /* @anon0 */ {
    // total size: 0x48
} __vt__19clsPutParallax_Task; // size: 0x48, address: 0x6C98B0
struct /* @anon2 */ {
    // total size: 0x48
} __vt__97clsSingleModelGimmick_Task<19clsPutParallax_Task,18clsPutParallax_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6B9B60
struct /* @anon3 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPutParallax_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A848
struct /* @anon9 */ {
    // total size: 0xC
} __vt__35clsSingleton<19clsPutParallax_Task>; // size: 0xC, address: 0x6B9AF8
void * __dt(class clsPutParallax_Obj *, signed short); // size: 0x0, address: 0x2D20C0
struct /* @anon14 */ {
    // total size: 0x48
} __vt__89clsBaseGimmickBody<19clsPutParallax_Task,18clsPutParallax_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6B9B10
struct /* @anon6 */ {
    // total size: 0x28
...
struct /* @anon10 */ {
    // total size: 0x58
} __vt__18clsPutParallax_Obj; // size: 0x58, address: 0x6B9AA0
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsPutParallax_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsPutParallax_Task : public clsSingleModelGimmick_Task {
    // total size: 0xAC
};
class NNS_OBJECT {
    // total size: 0x58
...
// Range: 0x4D1970 -> 0x4D1B10
void draw(class clsPutParallax_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D1970 -> 0x4D1B10
...
// Range: 0x4D1B10 -> 0x4D1CCC
void execute(class clsPutParallax_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D1B10 -> 0x4D1CCC
        unsigned int u32Num; // r2
...
// Range: 0x4D1CE0 -> 0x4D1F2C
void draw(class clsPutParallax_Obj * this /* r19 */, class clsModelType_OB_TX_MO_MA * pcModel /* r18 */, float (* psMtxPal)[4][4] /* r22 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r23 */, float (* opaBillBoardMtx)[4][4] /* r2 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D1CE0 -> 0x4D1F2C
...
// Range: 0x4D1F30 -> 0x4D2024
void * __ct(class clsPutParallax_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D1F30 -> 0x4D2024
    }
