/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage07\St07MapPartsJointCurve.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x692DD0
struct /* @anon1 */ {
    // total size: 0x48
} __vt__26clsMapPartsJointCurve_Task; // size: 0x48, address: 0x6CC720
struct /* @anon4 */ {
    // total size: 0x48
} __vt__108clsSingleModelGimmick_Task<26clsMapPartsJointCurve_Task,28clsMapPartsJointCurve_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CC7D0
struct /* @anon2 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsMapPartsJointCurve_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA750
struct /* @anon7 */ {
    // total size: 0xC
} __vt__42clsSingleton<26clsMapPartsJointCurve_Task>; // size: 0xC, address: 0x6CC768
void * __dt(class clsMapPartsJointCurve_Object *, signed short); // size: 0x0, address: 0x503270
struct /* @anon0 */ {
    // total size: 0x48
} __vt__100clsBaseGimmickBody<26clsMapPartsJointCurve_Task,28clsMapPartsJointCurve_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CC780
struct /* @anon3 */ {
    // total size: 0xA8
} __vt__28clsMapPartsJointCurve_Object; // size: 0xA8, address: 0x6CC820
...
void * __ct(class clsMapPartsJointCurve_Object *); // size: 0x0, address: 0x503DD0
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsMapPartsJointCurve_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsMapPartsJointCurve_Task : public clsSingleModelGimmick_Task {
    // total size: 0x9C
public:
...
// Range: 0x5032F0 -> 0x5035C4
void draw(class clsMapPartsJointCurve_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5032F0 -> 0x5035C4
...
// Range: 0x5036D0 -> 0x503740
void reset(class clsMapPartsJointCurve_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5036D0 -> 0x503740
        unsigned int u32Num; // r2
...
// Range: 0x503740 -> 0x503A78
void * __ct(class clsMapPartsJointCurve_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x503740 -> 0x503A78
...
// Range: 0x503E10 -> 0x503E48
void createData(class clsMapPartsJointCurve_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x503E10 -> 0x503E48
    }
