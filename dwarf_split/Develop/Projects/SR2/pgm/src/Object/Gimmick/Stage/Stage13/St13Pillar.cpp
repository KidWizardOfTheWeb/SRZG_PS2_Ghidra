/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage13\St13Pillar.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x68B818
struct /* @anon16 */ {
    // total size: 0x48
} __vt__14clsPillar_Task; // size: 0x48, address: 0x6C92E0
struct /* @anon3 */ {
    // total size: 0x48
} __vt__80clsMultiModelGimmick_Task<14clsPillar_Task,13clsPillar_Obj,18clsMultiObTxModels>; // size: 0x48, address: 0x6C9390
struct /* @anon5 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPillar_Task * m_tpcSingleton; // size: 0x4, address: 0xB17B58
struct /* @anon12 */ {
    // total size: 0xC
} __vt__30clsSingleton<14clsPillar_Task>; // size: 0xC, address: 0x6C9328
void * __dt(class clsModelType_OB_TX *, signed short); // size: 0x0, address: 0x1F27F0
void * __dt(class clsPillar_Obj *, signed short); // size: 0x0, address: 0x4C0CE0
struct /* @anon14 */ {
    // total size: 0x48
} __vt__73clsBaseGimmickBody<14clsPillar_Task,13clsPillar_Obj,18clsMultiObTxModels>; // size: 0x48, address: 0x6C9340
struct /* @anon8 */ {
    // total size: 0x28
...
struct /* @anon2 */ {
    // total size: 0x48
} __vt__13clsPillar_Obj; // size: 0x48, address: 0x6C93E0
...
void * __ct(class clsPillar_Obj *); // size: 0x0, address: 0x4C1D00
...
struct /* @anon6 */ {
    // total size: 0x34
} __vt__25clsPillarThroughCollision; // size: 0x34, address: 0x6C9430
struct /* @anon1 */ {
    // total size: 0xC
...
class clsPillar_Task : public clsMultiModelGimmick_Task {
    // total size: 0xA4
public:
    class clsGmkBurnLight_Task * m_pcBurnLightTask1; // offset 0x98, size 0x4
    class clsGmkBurnLight_Task * m_pcBurnLightTask2; // offset 0x9C, size 0x4
    class clsGmkBurnLight_Task * m_pcBurnLightTask3; // offset 0xA0, size 0x4
};
class sceGsTex0 {
    // total size: 0x8
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPillar_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsPillar_Obj : public clsGimmickObj {
    // total size: 0xF0
public:
    enum enmPillarMode m_eMode; // offset 0x50, size 0x4
    enum enmPillarState m_eState; // offset 0x54, size 0x4
    class clsPillarThroughCollision * m_pcCollision; // offset 0x58, size 0x4
    class hkShape * m_pcShape; // offset 0x5C, size 0x4
    float m_f32MotionFrame; // offset 0x60, size 0x4
    class NNS_VECTOR m_sPosition; // offset 0x64, size 0xC
    class NNS_QUATERNION m_sRotQuat; // offset 0x70, size 0x10
    float m_f32No; // offset 0x80, size 0x4
    float m_f32Wait; // offset 0x84, size 0x4
    float m_f32MoveCount; // offset 0x88, size 0x4
    float m_f32MoveFrame; // offset 0x8C, size 0x4
    float m_f32RotY; // offset 0x90, size 0x4
    float m_f32MoveAngle; // offset 0x94, size 0x4
    signed short m_s16Count; // offset 0x98, size 0x2
    float m_sPosturalMtx[4][4]; // offset 0xA0, size 0x40
...
class clsPillarThroughCollision : public clsBaseThroughCollision {
    // total size: 0xC
public:
    class clsPillar_Obj * m_pcPillar; // offset 0x8, size 0x4
};
...
// Range: 0x4C0D70 -> 0x4C1218
void draw(class clsPillar_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C0D70 -> 0x4C1218
...
// Range: 0x4C1350 -> 0x4C1744
void execute(class clsPillar_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C1350 -> 0x4C1744
        unsigned int u32Num; // r2
...
// Range: 0x4C1840 -> 0x4C18B8
void init(class clsPillar_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C1840 -> 0x4C18B8
        class NNS_VECTOR sRot; // r29
    }
}


// Range: 0x4C18D0 -> 0x4C1940
void reset(class clsPillar_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C18D0 -> 0x4C1940
        unsigned int u32Num; // r2
...
// Range: 0x4C1940 -> 0x4C19B4
void * __ct(class clsPillar_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C1940 -> 0x4C19B4
    }
...
// Range: 0x4C1DE0 -> 0x4C1EF0
void CheckObjRemove(class clsPillar_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C1DE0 -> 0x4C1EF0
        unsigned int u32Num; // r2
...
// Range: 0x4C1EF0 -> 0x4C2028
void CountUp(class clsPillar_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C1EF0 -> 0x4C2028
    }
...
// Range: 0x4C2030 -> 0x4C20B0
void destroyData(class clsPillar_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C2030 -> 0x4C20B0
    }
...
// Range: 0x4C2140 -> 0x4C22F0
void createData(class clsPillar_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C2140 -> 0x4C22F0
...
// Range: 0x4C2300 -> 0x4C2324
void reset(class clsPillar_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C2300 -> 0x4C2324
    }
...
// Range: 0x4C2330 -> 0x4C2344
void contactRemoveEvent(class clsPillarThroughCollision * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C2330 -> 0x4C2344
    }
...
// Range: 0x4C2350 -> 0x4C2358
void contactTriggerEvent(class clsPillarThroughCollision * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4C2350 -> 0x4C2358
    }
