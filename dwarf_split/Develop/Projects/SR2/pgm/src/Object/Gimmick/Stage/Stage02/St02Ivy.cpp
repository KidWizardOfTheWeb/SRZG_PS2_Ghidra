/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage02\St02Ivy.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x67E680
struct /* @anon15 */ {
    // total size: 0x48
} __vt__11clsIvy_Task; // size: 0x48, address: 0x6BF500
struct /* @anon1 */ {
    // total size: 0x48
} __vt__78clsSingleModelGimmick_Task<11clsIvy_Task,10clsIvy_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6BF5B0
struct /* @anon2 */ {
    // total size: 0x38
...
struct /* @anon12 */ {
    // total size: 0xC
} __vt__27clsSingleton<11clsIvy_Task>; // size: 0xC, address: 0x6BF548
void * __dt(class clsIvy_Obj *, signed short); // size: 0x0, address: 0x37B440
struct /* @anon13 */ {
    // total size: 0x48
} __vt__70clsBaseGimmickBody<11clsIvy_Task,10clsIvy_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6BF560
struct /* @anon6 */ {
    // total size: 0x28
...
struct /* @anon3 */ {
    // total size: 0x58
} __vt__10clsIvy_Obj; // size: 0x58, address: 0x6BF600
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x67E6E0
...
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x67E6D0
class hkThreadMemory * s_threadMemoryInstance; // size: 0x4, address: 0xB08F70
struct /* @anon8 */ {
    // total size: 0x30
} __vt__7clsTask; // size: 0x30, address: 0x6B59F0
void * __ct(class clsIvy_Obj *); // size: 0x0, address: 0x37C740
...
// Range: 0x37B540 -> 0x37B834
void shootPlayerToIvy(class clsIvy_Task * this /* r17 */, class clsPlayerTask * pcPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37B540 -> 0x37B834
...
// Range: 0x37B840 -> 0x37BC38
void draw(class clsIvy_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37B840 -> 0x37BC38
...
// Range: 0x37BCF0 -> 0x37C040
void execute(class clsIvy_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37BCF0 -> 0x37C040
        unsigned int u32Num; // r2
...
// Range: 0x37C040 -> 0x37C2B4
void shootPlayerToGround(class clsIvy_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37C040 -> 0x37C2B4
        class NNS_VECTORFAST sVecFast; // r29+0x50
        float f32Distance; // r29+0x60
        class NNS_VECTORFAST sUpVecFast; // r29+0x40
    }
}


// Range: 0x37C2C0 -> 0x37C330
void reset(class clsIvy_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37C2C0 -> 0x37C330
        unsigned int u32Num; // r2
...
// Range: 0x37C330 -> 0x37C3D8
void * __ct(class clsIvy_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37C330 -> 0x37C3D8
    }
...
// Range: 0x37C840 -> 0x37CA64
void setLandingGround(class clsIvy_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37C840 -> 0x37CA64
        unsigned char u8PathNo; // r29+0x5F
        class NNS_VECTORFAST sDirVecFast; // r29+0x40
    }
}


// Range: 0x37CA70 -> 0x37CC50
void contactTriggerEvent(class clsIvy_Obj * this /* r20 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37CA70 -> 0x37CC50
...
// Range: 0x37CC50 -> 0x37CC68
void reset(class clsIvy_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37CC50 -> 0x37CC68
    }
...
// Range: 0x37CC70 -> 0x37CD88
void init(class clsIvy_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37CC70 -> 0x37CD88
    }
...
// Range: 0x37CD90 -> 0x37CDD8
void destroyData(class clsIvy_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37CD90 -> 0x37CDD8
    }
...
// Range: 0x37CDE0 -> 0x37CF64
void createData(class clsIvy_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x37CDE0 -> 0x37CF64
