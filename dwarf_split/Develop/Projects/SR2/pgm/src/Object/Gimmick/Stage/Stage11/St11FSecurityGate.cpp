/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage11\St11FSecurityGate.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float tof32ClipSqDist; // size: 0x4, address: 0x688B00
class NNS_VECTORFAST m_osOffsetColPos; // size: 0x10, address: 0x688B10
struct /* @anon12 */ {
    // total size: 0x48
} __vt__21clsFSecurityGate_Task; // size: 0x48, address: 0x6C70C0
void * __dt(class clsFSecurityGate_Ctrl *, signed short); // size: 0x0, address: 0x474D70
struct /* @anon11 */ {
    // total size: 0x48
} __vt__91clsBaseGimmickBody<21clsFSecurityGate_Task,21clsFSecurityGate_Ctrl,21clsFSecurityGateModel>; // size: 0x48, address: 0x6C71D0
struct /* @anon14 */ {
    // total size: 0x30
...
struct /* @anon2 */ {
    // total size: 0x34
} __vt__25clsFSecurityGateCollision; // size: 0x34, address: 0x6C7270
void * __dt(class clsFSecurityGate_Obj *, signed short); // size: 0x0, address: 0x474E70
struct /* @anon6 */ {
    // total size: 0x44
} __vt__21clsFSecurityGate_Ctrl; // size: 0x44, address: 0x6C7220
struct /* @anon3 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon15 */ {
    // total size: 0xA8
} __vt__20clsFSecurityGate_Obj; // size: 0xA8, address: 0x6C7110
struct /* @anon9 */ {
    // total size: 0xC
...
void * __ct(class clsFSecurityGate_Ctrl *); // size: 0x0, address: 0x475C30
class clsFSecurityGate_Task * m_tpcSingleton; // size: 0x4, address: 0xB174C8
struct /* @anon4 */ {
    // total size: 0xC
} __vt__37clsSingleton<21clsFSecurityGate_Task>; // size: 0xC, address: 0x6C71B8
void * __ct(class clsFSecurityGate_Obj *); // size: 0x0, address: 0x475DF0
...
class clsFSecurityGate_Task : public clsBaseGimmickBody {
    // total size: 0xB0
};
...
public:
    ...
    class clsFSecurityGateCollision m_cGateCollision; // offset 0x54, size 0xC
    class clsFSecurityGate_Obj m_acGateObj[2]; // offset 0x60, size 0x2A0
    unsigned int m_u32PlayerFlg; // offset 0x300, size 0x4
    class clsSe3DControl * m_pcSe3DCtrl; // offset 0x304, size 0x4
    unsigned char m_u8GateFlg; // offset 0x308, size 0x1
    unsigned char m_bPlaySe; // offset 0x309, size 0x1
};
enum enmControlFlag {
...
class clsFSecurityGate_Obj : public clsRigidBodyGimmickObj {
    // total size: 0x150
public:
    class clsFSecurityGate_Ctrl * m_pcFSecurityGate_Ctrl; // offset 0xD0, size 0x4
    enum enmFSecurityGateMode m_eFSecurityGateMode; // offset 0xD4, size 0x4
    enum enmFSecurityGateState m_eFSecurityGateState; // offset 0xD8, size 0x4
    enum enmFSecurityGateState m_eNextFSecurityGateState; // offset 0xDC, size 0x4
    class NNS_QUATERNION m_sRotOffset; // offset 0xE0, size 0x10
    class NNS_QUATERNION m_sRotGate; // offset 0xF0, size 0x10
    class NNS_VECTORFAST m_sPosGate; // offset 0x100, size 0x10
    class NNS_VECTORFAST m_sPosColGate; // offset 0x110, size 0x10
    class NNS_VECTORFAST m_sPosAdd; // offset 0x120, size 0x10
    float m_f32MotionFrame; // offset 0x130, size 0x4
    float m_f32MatMotionFrame; // offset 0x134, size 0x4
    float m_f32AddFrame; // offset 0x138, size 0x4
    float m_f32AddMatFrame; // offset 0x13C, size 0x4
    unsigned char m_bDrawFlg; // offset 0x140, size 0x1
};
enum enmGearPrfm {
    PRFM_EMPTY = 0,
    PRFM_D_SONIC = 1,
...
class clsFSecurityGateModel {
    // total size: 0x24
public:
    class clsModelType_OB_TX_MO_MA m_cModel; // offset 0x0, size 0x20
...
class clsFSecurityGateCollision : public clsBaseThroughCollision {
    // total size: 0xC
public:
    class clsFSecurityGate_Ctrl * m_pcFSecurityGate_Ctrl; // offset 0x8, size 0x4
};
enum enmRiseType {
    RISE_TYPE_NORMAL = 0,
    RISE_TYPE_MOVE = 1,
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xB0
public:
    class clsFSecurityGate_Ctrl * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
    class clsFSecurityGateModel m_cModel; // offset 0x88, size 0x24
    class clsGmkBurnLight_Task * pcGmkBurnLight_Task; // offset 0xAC, size 0x4
};
class __tree : private __red_black_tree {
    // total size: 0x18
public:
...
// Range: 0x474F70 -> 0x4750EC
void draw(class clsFSecurityGate_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x474F70 -> 0x4750EC
        ...
        float (* opaNnViewMtx)[4][4]; // r18
        float (* psMtxPal)[4][4]; // r22
        class clsModelType_OB_TX_MO_MA & rcModel; // r23
...
// Range: 0x4750F0 -> 0x4752FC
void execute(class clsFSecurityGate_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4750F0 -> 0x4752FC
        unsigned int u32Num; // r2
...
// Range: 0x475300 -> 0x4756D0
void init(class clsFSecurityGate_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x475300 -> 0x4756D0
        float sMtxPal[4][4]; // r29+0x60
        class NNS_VECTORFAST sVecPos; // r29+0x50
    }
}


// Range: 0x475720 -> 0x475838
void createModel(class clsFSecurityGate_Task * this /* r2 */, class stcBinInfo & rsBinInfoI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x475720 -> 0x475838
...
// Range: 0x475840 -> 0x4758A0
void reset(class clsFSecurityGate_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x475840 -> 0x4758A0
        unsigned int u32i; // r17
...
// Range: 0x4758A0 -> 0x475A88
void * __ct(class clsFSecurityGate_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4758A0 -> 0x475A88
        class hkVector4 cBoxHalfSize; // r29+0x60
        class hkVector4 cHelfCubeSize; // r29+0x50
    }
}


// Range: 0x475F20 -> 0x47611C
void draw(class clsFSecurityGate_Ctrl * this /* r29+0xBC */, class clsModelType_OB_TX_MO_MA & rcModel /* r21 */, float (* psMtxPal)[4][4] /* r20 */, unsigned int * psNodeStat /* r19 */, float (* opaNnViewMtx)[4][4] /* r23 */, float (* psMtxWork)[4][4] /* r18 */, unsigned int u32ViewNo /* r30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x475F20 -> 0x47611C
        unsigned int u32i; // r17
...
// Range: 0x476120 -> 0x4761A0
void destroyData(class clsFSecurityGate_Ctrl * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x476120 -> 0x4761A0
        unsigned int u32i; // r17
...
// Range: 0x4761A0 -> 0x4762AC
void createData(class clsFSecurityGate_Ctrl * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4761A0 -> 0x4762AC
...
// Range: 0x4762B0 -> 0x4763EC
void reset(class clsFSecurityGate_Ctrl * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4762B0 -> 0x4763EC
        unsigned int u32i; // r17
...
// Range: 0x4763F0 -> 0x476A0C
void main(class clsFSecurityGate_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4763F0 -> 0x476A0C
...
// Range: 0x476A10 -> 0x476A50
void destroyData(class clsFSecurityGate_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x476A10 -> 0x476A50
    }
...
// Range: 0x476A50 -> 0x476D3C
void createData(class clsFSecurityGate_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x476A50 -> 0x476D3C
...
// Range: 0x476D40 -> 0x476DB0
void contactRemoveEvent(class clsFSecurityGateCollision * this /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x476D40 -> 0x476DB0
    }
...
// Range: 0x476DB0 -> 0x476E94
void contactTriggerEvent(class clsFSecurityGateCollision * this /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x476DB0 -> 0x476E94
    }
...
// Range: 0x476EB0 -> 0x476FCC
void reset(class clsFSecurityGate_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x476EB0 -> 0x476FCC
    }
