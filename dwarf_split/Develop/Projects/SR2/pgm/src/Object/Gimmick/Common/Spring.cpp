/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\Spring.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32CLIP_DISTx2; // size: 0x4, address: 0x67E0F0
unsigned char m_toau8TopNodeNo[3]; // size: 0x3, address: 0x67E0F8
static unsigned int toau32NodeStateNoneData[3][2]; // size: 0x18, address: 0x67E100
struct /* @anon1 */ {
    // total size: 0x48
} __vt__14clsSpring_Task; // size: 0x48, address: 0x6BF2B0
struct /* @anon3 */ {
    // total size: 0x48
} __vt__81clsSingleModelGimmick_Task<14clsSpring_Task,13clsSpring_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6B8D40
struct /* @anon4 */ {
    // total size: 0x38
...
struct /* @anon13 */ {
    // total size: 0xC
} __vt__30clsSingleton<14clsSpring_Task>; // size: 0xC, address: 0x6B8CD8
void * __dt(class clsSpring_Obj *, signed short); // size: 0x0, address: 0x2D8E60
struct /* @anon0 */ {
    // total size: 0x48
} __vt__73clsBaseGimmickBody<14clsSpring_Task,13clsSpring_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6B8CF0
struct /* @anon7 */ {
    // total size: 0x28
...
struct /* @anon9 */ {
    // total size: 0x58
} __vt__13clsSpring_Obj; // size: 0x58, address: 0x6BF300
...
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x67E190
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x67E1A0
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x67E180
static unsigned int tou32SetGravityUp; // size: 0x4, address: 0x67E138
static unsigned int ou32UpdateUpVec; // size: 0x4, address: 0x67E140
struct /* @anon10 */ {
    // total size: 0x44
...
// Range: 0x375050 -> 0x375548
void draw(class clsSpring_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x375050 -> 0x375548
...
// Range: 0x375630 -> 0x3758A0
void execute(class clsSpring_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x375630 -> 0x3758A0
...
// Range: 0x3758A0 -> 0x375ABC
void init(class clsSpring_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3758A0 -> 0x375ABC
        class NNS_VECTORFAST sAxisX; // r29+0xF0
        class NNS_VECTORFAST sAxisY; // r29+0xE0
        class NNS_VECTORFAST sAxisZ; // r29+0xD0
...
// Range: 0x375AC0 -> 0x375B34
void playSpringSe(class clsPlayerTask * pcPlayer /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x375AC0 -> 0x375B34
    }
...
// Range: 0x375B40 -> 0x375BB4
void stopSpringSe(class clsPlayerTask * pcPlayer /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x375B40 -> 0x375BB4
    }
...
// Range: 0x375BC0 -> 0x376594
void contactTriggerEvent(class clsSpring_Obj * this /* r21 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x375BC0 -> 0x376594
        class clsPlayerTask * pcHitPlayer; // r20
        class NNS_VECTORFAST sVecFast; // r29+0x140
        class NNS_VECTORFAST sPosVecFast; // r29+0x130
        class NNS_VECTORFAST sJumpVecFast; // r29+0x120
        float f32JumpSpeed; // r20
        class NNS_VECTORFAST sTmpVF; // r29+0x110
        class NNS_VECTORFAST sTmpVF; // r29+0x100
        float f32JumpSpeed; // r29+0x150
        class NNS_QUATERNION sQuat; // r29+0xF0
        unsigned int u32BitStage; // r2
        float f32Rad; // r29+0x150
        class NNS_VECTORFAST sLocalJumpVecFast; // r29+0xE0
        float sInvMtx[4][4]; // r29+0xA0
    }
}


// Range: 0x3765A0 -> 0x3765E8
void destroyData(class clsSpring_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3765A0 -> 0x3765E8
    }
...
// Range: 0x3765F0 -> 0x376660
void setData(class clsSpring_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3765F0 -> 0x376660
        unsigned short u16Num; // r2
    }
}


// Range: 0x376660 -> 0x376894
void createData(class clsSpring_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x376660 -> 0x376894
        float sMtx[4][4]; // r29+0x90
