/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\SurvivalBall\SurvivalStart.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x691A00
struct /* @anon4 */ {
    // total size: 0x48
} __vt__25clsSurvivalBallStart_Task; // size: 0x48, address: 0x6CA150
struct /* @anon14 */ {
    // total size: 0x48
} __vt__109clsSingleModelGimmick_Task<25clsSurvivalBallStart_Task,24clsSurvivalBallStart_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6CA200
struct /* @anon3 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsSurvivalBallStart_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA6B8
struct /* @anon2 */ {
    // total size: 0xC
} __vt__41clsSingleton<25clsSurvivalBallStart_Task>; // size: 0xC, address: 0x6CA198
void * __dt(class clsSurvivalBallStart_Obj *, signed short); // size: 0x0, address: 0x4DEED0
struct /* @anon7 */ {
    // total size: 0x48
} __vt__101clsBaseGimmickBody<25clsSurvivalBallStart_Task,24clsSurvivalBallStart_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6CA1B0
struct /* @anon8 */ {
    // total size: 0x28
...
struct /* @anon1 */ {
    // total size: 0x58
} __vt__24clsSurvivalBallStart_Obj; // size: 0x58, address: 0x6CA250
...
void * __ct(class clsSurvivalBallStart_Obj *); // size: 0x0, address: 0x4DFED0
...
class clsSurvivalBallStart_Task : public clsSingleModelGimmick_Task {
    // total size: 0xAC
};
...
public:
    ...
    float m_aObjMax[2][4][4]; // offset 0x70, size 0x80
    class clsOOClock m_cClock_StartTime; // offset 0xF0, size 0x24
    class clsPlaySe_2D * m_pcPlaySe2D; // offset 0x114, size 0x4
};
enum enmDraw2DAttr {
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsSurvivalBallStart_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x4DEFE0 -> 0x4DF150
void draw(class clsSurvivalBallStart_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DEFE0 -> 0x4DF150
...
// Range: 0x4DF150 -> 0x4DF310
void execute(class clsSurvivalBallStart_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DF150 -> 0x4DF310
        float * pf32Frame; // r2
...
// Range: 0x4DF310 -> 0x4DF390
void reset(class clsSurvivalBallStart_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DF310 -> 0x4DF390
        unsigned int u32Num; // r2
...
// Range: 0x4DF390 -> 0x4DF3FC
void * __ct(class clsSurvivalBallStart_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DF390 -> 0x4DF3FC
    }
...
// Range: 0x4DF770 -> 0x4DF8FC
void draw(class clsSurvivalBallStart_Obj * this /* r21 */, class clsModelType_OB_TX_MO_MA & rcModel /* r20 */, float (* psMtxPal)[4][4] /* r19 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r17 */, float (* psMtxWork)[4][4] /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DF770 -> 0x4DF8FC
        float aMat[4][4]; // r29+0x70
    }
}


// Range: 0x4DF900 -> 0x4DFA18
void contactTriggerEvent(class clsSurvivalBallStart_Obj * this /* r18 */, class hkContactPoint * pcContact /* r17 */, class clsObject * pcObject /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DF900 -> 0x4DFA18
        class clsSurvivalBallRace_Task & rcSurvivalBallRace_Task; // r2
...
// Range: 0x4DFA20 -> 0x4DFB84
void contactAlwaysEvent(class clsSurvivalBallStart_Obj * this /* r17 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DFA20 -> 0x4DFB84
        class clsSurvivalBallRace_Task & rcSurvivalBallRace_Task; // r2
        class clsPlayerTask * pcHitPlayer; // r16
        signed int s32RestFrame; // r2
        signed int s32ShockFrame; // r2
        signed int s32MaxFrame; // r2
        signed int s32DamageFrame; // r2
    }
}


// Range: 0x4DFB90 -> 0x4DFC38
void destroyData(class clsSurvivalBallStart_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DFB90 -> 0x4DFC38
    }
...
// Range: 0x4DFC40 -> 0x4DFED0
void createData(class clsSurvivalBallStart_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DFC40 -> 0x4DFED0
        class hkVector4 cBox; // r29+0x90
        class NNS_VECTOR sPosVec; // r29+0xA0
    }
}


// Range: 0x4DFED0 -> 0x4DFFE8
void * __ct(class clsSurvivalBallStart_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4DFED0 -> 0x4DFFE8
    }
