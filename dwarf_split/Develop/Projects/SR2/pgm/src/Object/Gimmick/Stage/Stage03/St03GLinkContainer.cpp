/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage03\St03GLinkContainer.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x6847F8
float tof32ClipSqDist; // size: 0x4, address: 0x684808
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x684810
struct /* @anon16 */ {
    // total size: 0x48
} __vt__22clsGLinkContainer_Task; // size: 0x48, address: 0x6C2580
struct /* @anon1 */ {
    // total size: 0x48
} __vt__100clsSingleModelGimmick_Task<22clsGLinkContainer_Task,24clsGLinkContainer_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C26F0
struct /* @anon9 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsGLinkContainer_Task * m_tpcSingleton; // size: 0x4, address: 0xB16DA8
struct /* @anon8 */ {
    // total size: 0xC
} __vt__38clsSingleton<22clsGLinkContainer_Task>; // size: 0xC, address: 0x6C2688
void * __dt(class clsGLinkContainer_Object *, signed short); // size: 0x0, address: 0x3F61C0
struct /* @anon15 */ {
    // total size: 0x48
} __vt__92clsBaseGimmickBody<22clsGLinkContainer_Task,24clsGLinkContainer_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C26A0
struct /* @anon5 */ {
    // total size: 0xB4
} __vt__24clsBaseGravityLinkObject; // size: 0xB4, address: 0x6C1420
struct /* @anon14 */ {
    // total size: 0xB8
} __vt__24clsGLinkContainer_Object; // size: 0xB8, address: 0x6C25D0
struct /* @anon12 */ {
    // total size: 0x28
...
void * __ct(class clsGLinkContainer_Object *); // size: 0x0, address: 0x3F69A0
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsGLinkContainer_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsGLinkContainer_Task : public clsSingleModelGimmick_Task {
    // total size: 0x98
public:
...
// Range: 0x3F6260 -> 0x3F6428
void draw(class clsGLinkContainer_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F6260 -> 0x3F6428
...
// Range: 0x3F6430 -> 0x3F6510
void execute(class clsGLinkContainer_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F6430 -> 0x3F6510
        unsigned int u32Num; // r2
...
// Range: 0x3F6510 -> 0x3F6580
void reset(class clsGLinkContainer_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F6510 -> 0x3F6580
        unsigned int u32Num; // r2
...
// Range: 0x3F6580 -> 0x3F664C
void * __ct(class clsGLinkContainer_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F6580 -> 0x3F664C
...
// Range: 0x3F6A10 -> 0x3F6A90
void destroyData(class clsGLinkContainer_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F6A10 -> 0x3F6A90
    }
...
// Range: 0x3F6A90 -> 0x3F6F30
void createData(class clsGLinkContainer_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F6A90 -> 0x3F6F30
...
// Range: 0x3F6F30 -> 0x3F6F4C
void setData(class clsGLinkContainer_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F6F30 -> 0x3F6F4C
    }
...
void drawEffect(class clsPlayerTask * pcPlayer /* r16 */) {
    ...
    /* anonymous block */ {
        ...
        class NNS_VECTOR LOCAL_POS_R; // @ 0x006848B8
        class NNS_VECTOR LOCAL_POS; // @ 0x006848A8
        class NNS_VECTOR RAND_SP; // @ 0x00684898
        float LIFE_FRAME; // @ 0x006848C8
        class NNS_VECTOR BEGIN_SP; // @ 0x00684888
    }
}


// Range: 0x3F7070 -> 0x3F70C8
void callbackContactTriggerRigidBody(class clsGLinkContainer_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F7070 -> 0x3F70C8
    }
...
// Range: 0x3F70D0 -> 0x3F7114
void requestDrawBreakEffect(class clsGLinkContainer_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F70D0 -> 0x3F7114
    }
...
// Range: 0x3F7120 -> 0x3F7140
void main(class clsGLinkContainer_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F7120 -> 0x3F7140
    }
...
// Range: 0x3F7140 -> 0x3F725C
void reset(class clsGLinkContainer_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F7140 -> 0x3F725C
...
// Range: 0x3F7260 -> 0x3F7434
void draw(class clsGLinkContainer_Object * this /* r21 */, class NNS_OBJECT * psObject /* r20 */, float (* psMtxPal)[4][4] /* r17 */, unsigned int * psNodeStat /* r16 */, float (* opaNnViewMtx)[4][4] /* r19 */, float (* psMtxWork)[4][4] /* r18 */, unsigned int u32ViewNo /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F7260 -> 0x3F7434
    }
