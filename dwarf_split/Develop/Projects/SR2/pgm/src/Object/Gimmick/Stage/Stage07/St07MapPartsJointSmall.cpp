/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage07\St07MapPartsJointSmall.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x692E20
struct /* @anon0 */ {
    // total size: 0x48
} __vt__26clsMapPartsJointSmall_Task; // size: 0x48, address: 0x6CC8D0
struct /* @anon4 */ {
    // total size: 0x48
} __vt__108clsSingleModelGimmick_Task<26clsMapPartsJointSmall_Task,28clsMapPartsJointSmall_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CC980
struct /* @anon2 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsMapPartsJointSmall_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA758
struct /* @anon7 */ {
    // total size: 0xC
} __vt__42clsSingleton<26clsMapPartsJointSmall_Task>; // size: 0xC, address: 0x6CC918
void * __dt(class clsMapPartsJointSmall_Object *, signed short); // size: 0x0, address: 0x5042D0
struct /* @anon1 */ {
    // total size: 0x48
} __vt__100clsBaseGimmickBody<26clsMapPartsJointSmall_Task,28clsMapPartsJointSmall_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CC930
struct /* @anon3 */ {
    // total size: 0xA8
} __vt__28clsMapPartsJointSmall_Object; // size: 0xA8, address: 0x6CC9D0
...
void * __ct(class clsMapPartsJointSmall_Object *); // size: 0x0, address: 0x504C30
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsMapPartsJointSmall_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsMapPartsJointSmall_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
class hkSmallArray {
    // total size: 0x8
...
// Range: 0x504350 -> 0x5046A4
void draw(class clsMapPartsJointSmall_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x504350 -> 0x5046A4
...
// Range: 0x5047B0 -> 0x504820
void reset(class clsMapPartsJointSmall_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5047B0 -> 0x504820
        unsigned int u32Num; // r2
...
// Range: 0x504820 -> 0x5048DC
void * __ct(class clsMapPartsJointSmall_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x504820 -> 0x5048DC
...
// Range: 0x504C70 -> 0x504CA8
void createData(class clsMapPartsJointSmall_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x504C70 -> 0x504CA8
    }
