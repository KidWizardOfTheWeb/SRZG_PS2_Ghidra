/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage11\St11Fan.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x68A778
class NNS_VECTORFAST m_tosPartsOffsetFast[3]; // size: 0x30, address: 0x68A780
class NNS_VECTOR m_tosThroughCollisionPosVec[2]; // size: 0x18, address: 0x68A7B0
float m_tof32ThroughCollisionRotY[2]; // size: 0x8, address: 0x68A7C8
struct /* @anon19 */ {
    // total size: 0x48
} __vt__11clsFan_Task; // size: 0x48, address: 0x6C8160
void * __dt(class clsFan_Obj *, signed short); // size: 0x0, address: 0x4A09A0
struct /* @anon4 */ {
    // total size: 0x48
} __vt__60clsBaseGimmickBody<11clsFan_Task,10clsFan_Obj,11clsFanModel>; // size: 0x48, address: 0x6C81C0
void * __dt(class clsFanThroughCollision *, signed short); // size: 0x0, address: 0x4A0B30
struct /* @anon15 */ {
    // total size: 0x30
...
void * __dt(class clsFan_Parts *, signed short); // size: 0x0, address: 0x4A0A50
struct /* @anon5 */ {
    // total size: 0x44
} __vt__10clsFan_Obj; // size: 0x44, address: 0x6C8210
struct /* @anon3 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon8 */ {
    // total size: 0xA8
} __vt__12clsFan_Parts; // size: 0xA8, address: 0x6C8260
struct /* @anon14 */ {
    // total size: 0xC
...
struct /* @anon17 */ {
    // total size: 0x34
} __vt__22clsFanThroughCollision; // size: 0x34, address: 0x6C8310
...
class clsFan_Task * m_tpcSingleton; // size: 0x4, address: 0xB176B0
...
void * __ct(class clsFanThroughCollision *); // size: 0x0, address: 0x4A1E90
void * __ct(class clsFan_Obj *); // size: 0x0, address: 0x4A1F10
struct /* @anon2 */ {
    // total size: 0xC
} __vt__27clsSingleton<11clsFan_Task>; // size: 0xC, address: 0x6C81A8
void * __ct(class clsFan_Parts *); // size: 0x0, address: 0x4A2000
...
class clsFan_Obj : public clsGimmickObj {
    // total size: 0x320
public:
    enum enmFanMode m_eFanMode; // offset 0x50, size 0x4
    enum enmFanState m_eFanState; // offset 0x54, size 0x4
    ...
    class clsFan_Parts m_acParts[3]; // offset 0x80, size 0x2A0
};
class clsSingleton {
    // total size: 0x4
};
...
class clsFan_Task : public clsBaseGimmickBody {
    // total size: 0xEC
public:
    class hkShape * m_pcThroughShape; // offset 0xA0, size 0x4
    class clsFanThroughCollision m_acCollision[2]; // offset 0xA4, size 0x28
    enum enmState m_eState; // offset 0xCC, size 0x4
    unsigned int m_u32PlayerFlg; // offset 0xD0, size 0x4
    signed int m_s32CollisionNum; // offset 0xD4, size 0x4
    class _stcShapeInfo * m_apcShape; // offset 0xD8, size 0x4
    class NNS_NODE * m_psNodeList; // offset 0xDC, size 0x4
    class vector m_vctShapeSearch; // offset 0xE0, size 0xC
};
struct /* @anon0 */ {
    // total size: 0x28
};
...
public:
    ...
    class clsFan_Obj * m_pcFanObj; // offset 0xD4, size 0x4
...
public:
    ...
    class clsFan_Task * m_pcFan_Task; // offset 0xC, size 0x4
    class clsFan_Obj * m_pcFan_Obj; // offset 0x10, size 0x4
};
enum enmMode {
    MODE_INIT = 0,
    MODE_WAIT = 1,
...
enum enmThroughCollisionNum {
    ...
    THROUGH_COLLISION_STOP = 1,
    THROUGH_COLLISION_MAX = 2,
};
...
// Range: 0x4A0BC0 -> 0x4A1134
void draw(class clsFan_Task * this /* r29+0xEC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A0BC0 -> 0x4A1134
...
// Range: 0x4A1200 -> 0x4A160C
void execute(class clsFan_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A1200 -> 0x4A160C
        unsigned int u32Num; // r2
...
// Range: 0x4A1610 -> 0x4A1658
void executeParts(class clsFan_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A1610 -> 0x4A1658
        unsigned int u32i; // r17
        class clsFan_Parts * pcParts; // r16
    }
}


// Range: 0x4A1660 -> 0x4A16D0
void reset(class clsFan_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A1660 -> 0x4A16D0
...
// Range: 0x4A16D0 -> 0x4A1744
void stepMotoinFrame(class clsFan_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A16D0 -> 0x4A1744
        float * pf32Frame; // r2
...
// Range: 0x4A1760 -> 0x4A1858
void init(class clsFan_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A1760 -> 0x4A1858
    }
...
// Range: 0x4A1860 -> 0x4A19B0
void createModel(class clsFan_Task * this /* r2 */, class stcBinInfo & rsBinInfoI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A1860 -> 0x4A19B0
...
// Range: 0x4A19B0 -> 0x4A1B4C
void reset(class clsFan_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A19B0 -> 0x4A1B4C
        unsigned int u32Num; // r2
...
// Range: 0x4A1B50 -> 0x4A1D1C
void * __ct(class clsFan_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A1B50 -> 0x4A1D1C
...
// Range: 0x4A2120 -> 0x4A2168
void destroyData(class clsFan_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A2120 -> 0x4A2168
        class clsFan_Parts * pcParts; // r17
        unsigned int u32Num; // r16
    }
}


// Range: 0x4A2170 -> 0x4A21CC
void createData(class clsFan_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A2170 -> 0x4A21CC
        class clsFan_Parts * pcParts; // r17
...
// Range: 0x4A21E0 -> 0x4A2238
void contactTriggerEvent(class clsFan_Parts * this /* r17 */, class hkContactPoint * pcContact /* r2 */, class clsObject * pcObject /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A21E0 -> 0x4A2238
...
// Range: 0x4A2240 -> 0x4A2334
void callbackCrashEvent(class clsFan_Parts * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A2240 -> 0x4A2334
...
// Range: 0x4A2350 -> 0x4A2384
void requestDrawBreakEffect(class clsFan_Parts * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A2350 -> 0x4A2384
    }
...
// Range: 0x4A2390 -> 0x4A23D0
void destroyData(class clsFan_Parts * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A2390 -> 0x4A23D0
    }
...
// Range: 0x4A23D0 -> 0x4A2670
void createData(class clsFan_Parts * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A23D0 -> 0x4A2670
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0x50
        class hkVector4 cVec; // r29+0x40
        class hkShape * pcShape; // r17
        class clsContactControl & rcContactControl; // r2
    }
}


// Range: 0x4A2670 -> 0x4A2848
void reset(class clsFan_Parts * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A2670 -> 0x4A2848
        class clsGimmickRigidBody * pcRigidBody; // r17
        class hkVector4 cZero; // r29+0xC0
        class NNS_QUATERNION sRotQuat; // r29+0xB0
        class NNS_VECTORFAST sPosVecFast; // r29+0xA0
        float sMtx[4][4]; // r29+0x60
        class clsFan_Obj * pcObj; // r2
    }
}


// Range: 0x4A2850 -> 0x4A2970
void contactTriggerEvent(class clsFanThroughCollision * this /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A2850 -> 0x4A2970
    }
