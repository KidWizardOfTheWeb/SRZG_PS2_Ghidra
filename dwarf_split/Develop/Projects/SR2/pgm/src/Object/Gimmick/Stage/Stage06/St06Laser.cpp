/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage06\St06Laser.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x688A48
struct /* @anon7 */ {
    // total size: 0x48
} __vt__13clsLaser_Task; // size: 0x48, address: 0x6C6E60
struct /* @anon0 */ {
    // total size: 0x48
} __vt__85clsSingleModelGimmick_Task<13clsLaser_Task,12clsLaser_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C6F10
struct /* @anon3 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsLaser_Task * m_tpcSingleton; // size: 0x4, address: 0xB174C0
struct /* @anon6 */ {
    // total size: 0xC
} __vt__29clsSingleton<13clsLaser_Task>; // size: 0xC, address: 0x6C6EA8
void * __dt(class clsLaser_Obj *, signed short); // size: 0x0, address: 0x4715F0
struct /* @anon11 */ {
    // total size: 0x48
} __vt__77clsBaseGimmickBody<13clsLaser_Task,12clsLaser_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C6EC0
struct /* @anon9 */ {
    // total size: 0x28
...
struct /* @anon5 */ {
    // total size: 0x58
} __vt__12clsLaser_Obj; // size: 0x58, address: 0x6C6F60
...
void * __ct(class clsLaser_Obj *); // size: 0x0, address: 0x4720B0
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0xAC
public:
    class clsLaser_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsLaser_Task : public clsSingleModelGimmick_Task {
    // total size: 0xAC
};
...
public:
    ...
    float m_f32MatMotEndFrame; // offset 0x64, size 0x4
    float m_f32MatMotFrame; // offset 0x68, size 0x4
    float m_f32WaitFrame; // offset 0x6C, size 0x4
    unsigned char m_bVoicePlayFlag; // offset 0x70, size 0x1
};
class PotentialInfo {
    // total size: 0x1008
public:
...
// Range: 0x4716F0 -> 0x47198C
void draw(class clsLaser_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4716F0 -> 0x47198C
...
// Range: 0x4719A0 -> 0x471C14
void execute(class clsLaser_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4719A0 -> 0x471C14
        unsigned int u32Num; // r2
...
// Range: 0x471C20 -> 0x471C90
void reset(class clsLaser_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x471C20 -> 0x471C90
        unsigned int u32Num; // r2
...
// Range: 0x471C90 -> 0x471D48
void * __ct(class clsLaser_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x471C90 -> 0x471D48
...
// Range: 0x4721B0 -> 0x4721F8
void destroyData(class clsLaser_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4721B0 -> 0x4721F8
    }
...
// Range: 0x472200 -> 0x4722EC
void createData(class clsLaser_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x472200 -> 0x4722EC
    }
...
// Range: 0x4722F0 -> 0x47247C
void contactTriggerEvent(class clsLaser_Obj * this /* r17 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4722F0 -> 0x47247C
