/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage13\St13SignBoard.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32CLIP_DISTx2; // size: 0x4, address: 0x6904A8
struct /* @anon17 */ {
    // total size: 0xA8
} __vt__16clsSignBoard_Obj; // size: 0xA8, address: 0x6C9B40
struct /* @anon0 */ {
    // total size: 0xA8
...
struct /* @anon2 */ {
    // total size: 0x48
} __vt__17clsSignBoard_Task; // size: 0x48, address: 0x6C9C50
struct /* @anon12 */ {
    // total size: 0x48
} __vt__87clsSingleModelGimmick_Task<17clsSignBoard_Task,16clsSignBoard_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C9CA0
void * __dt(class clsSignBoard_Obj *, signed short); // size: 0x0, address: 0x4D65E0
struct /* @anon4 */ {
    // total size: 0x48
} __vt__79clsBaseGimmickBody<17clsSignBoard_Task,16clsSignBoard_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C9C00
struct /* @anon11 */ {
    // total size: 0x30
...
class clsSignBoard_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA690
struct /* @anon1 */ {
    // total size: 0xC
} __vt__33clsSingleton<17clsSignBoard_Task>; // size: 0xC, address: 0x6C9BE8
void * __ct(class clsSignBoard_Obj *); // size: 0x0, address: 0x4D6F80
...
class clsSignBoard_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
enum enmFlag {
    FLAG_CLEAR = 0,
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsSignBoard_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x4D66E0 -> 0x4D68A0
void draw(class clsSignBoard_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D66E0 -> 0x4D68A0
...
// Range: 0x4D68A0 -> 0x4D6988
void execute(class clsSignBoard_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D68A0 -> 0x4D6988
        unsigned int u32Num; // r2
...
// Range: 0x4D6990 -> 0x4D6A00
void reset(class clsSignBoard_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D6990 -> 0x4D6A00
        unsigned int u32Num; // r2
...
// Range: 0x4D6A00 -> 0x4D6ACC
void * __ct(class clsSignBoard_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D6A00 -> 0x4D6ACC
...
// Range: 0x4D7040 -> 0x4D72B8
void draw(class clsSignBoard_Obj * this /* r20 */, class clsModelType_OB_TX & rcObj /* r19 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r21 */, float (* opaNnViewMtx)[4][4] /* r17 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D7040 -> 0x4D72B8
    }
...
// Range: 0x4D72C0 -> 0x4D7310
void main(class clsSignBoard_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D72C0 -> 0x4D7310
    }
...
// Range: 0x4D7310 -> 0x4D7350
void destroyData(class clsSignBoard_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D7310 -> 0x4D7350
    }
...
// Range: 0x4D7350 -> 0x4D762C
void createData(class clsSignBoard_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D7350 -> 0x4D762C
...
// Range: 0x4D7630 -> 0x4D766C
void setData(class clsSignBoard_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D7630 -> 0x4D766C
    }
...
// Range: 0x4D7670 -> 0x4D76D4
void reset(class clsSignBoard_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4D7670 -> 0x4D76D4
    }
