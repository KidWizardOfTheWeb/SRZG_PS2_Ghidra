/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage01\St01Cone.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x67E8A0
unsigned int otau32Se_Cone[2]; // size: 0x8, address: 0x67E8A8
struct /* @anon0 */ {
    // total size: 0x48
} __vt__12clsCone_Task; // size: 0x48, address: 0x6BF9D0
struct /* @anon10 */ {
    // total size: 0x48
} __vt__77clsSingleModelGimmick_Task<12clsCone_Task,11clsCone_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BFA80
struct /* @anon16 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsCone_Task * m_tpcSingleton; // size: 0x4, address: 0xB15E18
struct /* @anon1 */ {
    // total size: 0xC
} __vt__28clsSingleton<12clsCone_Task>; // size: 0xC, address: 0x6BFA18
void * __dt(class clsCone_Obj *, signed short); // size: 0x0, address: 0x386880
struct /* @anon4 */ {
    // total size: 0x48
} __vt__69clsBaseGimmickBody<12clsCone_Task,11clsCone_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BFA30
struct /* @anon5 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon6 */ {
    // total size: 0xA8
} __vt__11clsCone_Obj; // size: 0xA8, address: 0x6BFAD0
struct /* @anon12 */ {
    // total size: 0x28
...
void * __ct(class clsCone_Obj *); // size: 0x0, address: 0x387280
...
public:
    ...
    unsigned char m_u8ContactSeCount; // offset 0xD4, size 0x1
};
...
class clsCone_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
class compressed_pair_imp {
    // total size: 0x8
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsCone_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x386980 -> 0x386C04
void draw(class clsCone_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x386980 -> 0x386C04
...
// Range: 0x386CB0 -> 0x386D50
void execute(class clsCone_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x386CB0 -> 0x386D50
        unsigned int u32Num; // r2
...
// Range: 0x386D50 -> 0x386DC0
void reset(class clsCone_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x386D50 -> 0x386DC0
        unsigned int u32Num; // r2
...
// Range: 0x386DC0 -> 0x386E54
void reset(class clsCone_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x386DC0 -> 0x386E54
    }
...
// Range: 0x386E60 -> 0x386F24
void * __ct(class clsCone_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x386E60 -> 0x386F24
...
// Range: 0x387340 -> 0x38737C
void requestDrawBreakEffect(class clsCone_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x387340 -> 0x38737C
    }
...
// Range: 0x387380 -> 0x3873D4
void callbackContactTriggerRigidBody(class clsCone_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x387380 -> 0x3873D4
    }
...
// Range: 0x3873E0 -> 0x387444
void main(class clsCone_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3873E0 -> 0x387444
    }
...
// Range: 0x387450 -> 0x387508
void destroyData(class clsCone_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x387450 -> 0x387508
    }
...
// Range: 0x387510 -> 0x387A28
void createData(class clsCone_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x387510 -> 0x387A28
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0xF0
        class hkMassProperties massProperties; // r29+0xA0
        class hkTransform cTransform; // r29+0x60
        class hkVector4 cOffset; // r29+0x50
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        char __FUNCTION__[14]; // @ 0x0067E890
    }
}


// Range: 0x387A30 -> 0x387A64
void setData(class clsCone_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x387A30 -> 0x387A64
    }
...
// Range: 0x387A70 -> 0x387AA8
void callbackCrashEvent(class clsCone_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x387A70 -> 0x387AA8
    }
