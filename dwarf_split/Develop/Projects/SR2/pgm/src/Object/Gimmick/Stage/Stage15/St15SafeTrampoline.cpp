/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage15\St15SafeTrampoline.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon7 */ {
    // total size: 0x48
} __vt__22clsSafeTrampoline_Task; // size: 0x48, address: 0x6CE920
struct /* @anon12 */ {
    // total size: 0x48
} __vt__94clsSingleModelGimmick_Task<22clsSafeTrampoline_Task,21clsSafeTrampoline_Obj,15clsModelType_OB>; // size: 0x48, address: 0x6BAEC0
struct /* @anon4 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsSafeTrampoline_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A7C8
struct /* @anon3 */ {
    // total size: 0xC
} __vt__38clsSingleton<22clsSafeTrampoline_Task>; // size: 0xC, address: 0x6BAE58
void * __dt(class clsSafeTrampoline_Obj *, signed short); // size: 0x0, address: 0x2C8B80
struct /* @anon5 */ {
    // total size: 0x48
} __vt__86clsBaseGimmickBody<22clsSafeTrampoline_Task,21clsSafeTrampoline_Obj,15clsModelType_OB>; // size: 0x48, address: 0x6BAE70
struct /* @anon9 */ {
    // total size: 0x28
...
struct /* @anon2 */ {
    // total size: 0x58
} __vt__21clsSafeTrampoline_Obj; // size: 0x58, address: 0x6CE970
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x6969A0
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x696990
...
class clsSafeTrampoline_Task : public clsSingleModelGimmick_Task {
    // total size: 0x90
};
class hkPadSpu {
    // total size: 0x4
...
class clsSafeTrampoline_Obj : public clsPhantomGimmickObject {
    // total size: 0x80
public:
    enum enmSafeTMode m_eSafeTMode; // offset 0x60, size 0x4
    unsigned int m_u32FlagList; // offset 0x64, size 0x4
    float m_f32Speed; // offset 0x68, size 0x4
    float m_f32Gravity; // offset 0x6C, size 0x4
    float m_f32Jump; // offset 0x70, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x90
public:
    class clsSafeTrampoline_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x5362A0 -> 0x536300
void reset(class clsSafeTrampoline_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5362A0 -> 0x536300
...
// Range: 0x536300 -> 0x536408
void draw(class clsSafeTrampoline_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x536300 -> 0x536408
...
// Range: 0x536410 -> 0x536618
void execute(class clsSafeTrampoline_Task * this /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x536410 -> 0x536618
        unsigned int u32Num; // r2
...
// Range: 0x536620 -> 0x536868
void contactTriggerEvent(class clsSafeTrampoline_Obj * this /* r20 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x536620 -> 0x536868
        class clsPlayerTask * pcHitPlayer; // r19
        unsigned int u32Mode; // r2
    }
}


// Range: 0x536870 -> 0x5368B8
void destroyData(class clsSafeTrampoline_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x536870 -> 0x5368B8
    }
...
// Range: 0x5368C0 -> 0x536A10
void createData(class clsSafeTrampoline_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5368C0 -> 0x536A10
    }
