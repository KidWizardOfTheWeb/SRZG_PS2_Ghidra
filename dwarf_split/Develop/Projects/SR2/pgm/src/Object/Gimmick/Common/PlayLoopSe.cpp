/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\PlayLoopSe.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned int m_oau32RequestArray[8]; // size: 0x20, address: 0x6925B0
struct /* @anon0 */ {
    // total size: 0x48
} __vt__18clsPlayLoopSe_Task; // size: 0x48, address: 0x6CB080
struct /* @anon3 */ {
    // total size: 0x48
} __vt__89clsSingleModelGimmick_Task<18clsPlayLoopSe_Task,17clsPlayLoopSe_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CB130
struct /* @anon4 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPlayLoopSe_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA6F8
struct /* @anon11 */ {
    // total size: 0xC
} __vt__34clsSingleton<18clsPlayLoopSe_Task>; // size: 0xC, address: 0x6CB0C8
void * __dt(class clsPlayLoopSe_Obj *, signed short); // size: 0x0, address: 0x4F1B10
struct /* @anon13 */ {
    // total size: 0x48
} __vt__81clsBaseGimmickBody<18clsPlayLoopSe_Task,17clsPlayLoopSe_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CB0E0
struct /* @anon8 */ {
    // total size: 0x28
...
struct /* @anon6 */ {
    // total size: 0x58
} __vt__17clsPlayLoopSe_Obj; // size: 0x58, address: 0x6CB180
...
void * __ct(class clsPlayLoopSe_Obj *); // size: 0x0, address: 0x4F2300
...
class clsPlayLoopSe_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
class __vector_imp : private __vector_pod, private compile_assert {
    // total size: 0xC
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPlayLoopSe_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
public:
    ...
    enum enmPlayLoopSeMode m_ePlayMode; // offset 0x64, size 0x4
    signed int m_s32SeId; // offset 0x68, size 0x4
    unsigned int m_u32PlayerFlg; // offset 0x6C, size 0x4
    unsigned int m_u32RequestId; // offset 0x70, size 0x4
    float m_f32Frame; // offset 0x74, size 0x4
    unsigned char m_bRequestPlay; // offset 0x78, size 0x1
};
enum enmDraw2DAttr {
...
// Range: 0x4F1C10 -> 0x4F1D48
void draw(class clsPlayLoopSe_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F1C10 -> 0x4F1D48
...
// Range: 0x4F1D50 -> 0x4F1ECC
void execute(class clsPlayLoopSe_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F1D50 -> 0x4F1ECC
...
// Range: 0x4F1ED0 -> 0x4F1F40
void reset(class clsPlayLoopSe_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F1ED0 -> 0x4F1F40
        unsigned int u32Num; // r2
...
// Range: 0x4F1F40 -> 0x4F1FAC
void * __ct(class clsPlayLoopSe_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F1F40 -> 0x4F1FAC
    }
...
// Range: 0x4F2410 -> 0x4F24B4
void contactRemoveEvent(class clsPlayLoopSe_Obj * this /* r17 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F2410 -> 0x4F24B4
...
// Range: 0x4F24C0 -> 0x4F2584
void contactTriggerEvent(class clsPlayLoopSe_Obj * this /* r17 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F24C0 -> 0x4F2584
        class clsPlayerTask * pcHitPlayer; // r2
...
// Range: 0x4F2590 -> 0x4F25F8
void destroyData(class clsPlayLoopSe_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F2590 -> 0x4F25F8
    }
...
// Range: 0x4F2600 -> 0x4F27AC
void createData(class clsPlayLoopSe_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F2600 -> 0x4F27AC
        float f32x; // r3
