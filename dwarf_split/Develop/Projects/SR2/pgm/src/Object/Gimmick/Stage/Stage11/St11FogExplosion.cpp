/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage11\St11FogExplosion.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32RequestFrame; // size: 0x4, address: 0x688A98
static float toaf32LightAnim[9]; // size: 0x24, address: 0x688AA0
...
// Range: 0x473040 -> 0x4734B8
void execute(class clsFogExplosion_Task * this /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x473040 -> 0x4734B8
        class NNS_VECTORFAST & rsPosVecFast; // r21
        class clsPlayerTask * pcPlayer; // r2
        class clsPlayerTask * * ppcPlayer; // r20
        unsigned int u32ViewNum; // r2
        unsigned int u32i; // r19
        class NNS_VECTORFAST sLocalVecFast; // r29+0xD0
        class clsFrameControl & rcFrameCtrl; // r2
        class NNS_VECTORFAST & rsPosVecFast; // r21
        class clsPlayerTask * pcPlayer; // r2
        class clsPlayerTask * * ppcPlayer; // r20
        unsigned int u32ViewNum; // r2
        unsigned int u32i; // r19
        float f32Rate; // r1
        unsigned char u8Index; // r2
        float f32Light; // r21
        unsigned char bIsPortal; // r2
        class NNS_VECTORFAST sLocalVecFast; // r29+0xC0
        float f32Length; // r29+0xE0
        class clsFogNearManager_Task * pcFogNearManager_Task; // r18
    }
}
