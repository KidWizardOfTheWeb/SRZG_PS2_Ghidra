/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage05\St05RotGround.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float toaf32BaseRot[10]; // size: 0x28, address: 0x6861E0
static float toaf32DiffRot[10]; // size: 0x28, address: 0x686210
float m_tof32ClipDist; // size: 0x4, address: 0x0
class NNS_VECTORFAST m_tosColiPosVecFast; // size: 0x10, address: 0x686240
float m_tof32ColiRot; // size: 0x4, address: 0x0
struct /* @anon13 */ {
    // total size: 0x48
} __vt__17clsRotGround_Task; // size: 0x48, address: 0x6C33B0
struct /* @anon11 */ {
    // total size: 0x48
} __vt__87clsSingleModelGimmick_Task<17clsRotGround_Task,16clsRotGround_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BA510
struct /* @anon4 */ {
    // total size: 0x38
...
struct /* @anon2 */ {
    // total size: 0xC
} __vt__33clsSingleton<17clsRotGround_Task>; // size: 0xC, address: 0x6BA4A8
void * __dt(class clsRotGround_Obj *, signed short); // size: 0x0, address: 0x2CD720
struct /* @anon6 */ {
    // total size: 0x48
} __vt__79clsBaseGimmickBody<17clsRotGround_Task,16clsRotGround_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6BA4C0
struct /* @anon8 */ {
    // total size: 0x28
...
struct /* @anon1 */ {
    // total size: 0x34
} __vt__28clsRotGroundThroughCollision; // size: 0x34, address: 0x6C3450
struct /* @anon5 */ {
    // total size: 0x44
} __vt__16clsRotGround_Obj; // size: 0x44, address: 0x6C3400
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x686270
...
// Range: 0x416320 -> 0x4163FC
void draw(class clsRotGround_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x416320 -> 0x4163FC
    }
...
// Range: 0x416400 -> 0x4164BC
void execute(class clsRotGround_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x416400 -> 0x4164BC
    }
...
// Range: 0x4164C0 -> 0x4165B4
void reset(class clsRotGround_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4164C0 -> 0x4165B4
...
// Range: 0x4165C0 -> 0x416880
void draw(class clsRotGround_Obj * this /* r17 */, class clsModelType_OB_TX & rcModel /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4165C0 -> 0x416880
        float sMtx[4][4]; // r29+0x130
        float sMtx2[4][4]; // r29+0xF0
...
// Range: 0x416880 -> 0x416D2C
void execute(class clsRotGround_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x416880 -> 0x416D2C
        unsigned int u32PlayerFlg; // r2
        unsigned int u32Num; // r2
        unsigned int u32i; // r19
        float * pf32Rot; // r18
        float * pfLengthRate; // r17
        class clsPlayerTask * * apcPlayer; // r16
        float sInvMtx[4][4]; // r29+0x180
        float sMtx[4][4]; // r29+0x140
        class NNS_VECTORFAST sLocalPosVecFast; // r29+0x130
        float * pf32BaseRot; // r2
        float * pf32DiffRot; // r2
        float f32MaxRot; // r20
...
// Range: 0x416D30 -> 0x416E2C
float getLengthRate(class clsRotGround_Obj * this /* r2 */, class NNS_VECTORFAST & rsPosVecFast /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x416D30 -> 0x416E2C
        float sInvMtx[4][4]; // r29+0xB0
        float sMtx[4][4]; // r29+0x70
        float sMtx2[4][4]; // r29+0x30
        class NNS_VECTORFAST sLocalVecFast; // r29+0x20
    }
}


// Range: 0x416E30 -> 0x416E8C
void destroyData(class clsRotGround_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x416E30 -> 0x416E8C
    }
...
// Range: 0x416E90 -> 0x416EFC
void createData(class clsRotGround_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x416E90 -> 0x416EFC
    }
...
// Range: 0x416F00 -> 0x416FE4
void contactRemoveEvent(class clsRotGroundThroughCollision * this /* r2 */, class clsPlayerTask * pcPlayer /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x416F00 -> 0x416FE4
    }
...
// Range: 0x416FF0 -> 0x41710C
void contactTriggerEvent(class clsRotGroundThroughCollision * this /* r2 */, class clsPlayerTask * pcPlayer /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x416FF0 -> 0x41710C
    }
