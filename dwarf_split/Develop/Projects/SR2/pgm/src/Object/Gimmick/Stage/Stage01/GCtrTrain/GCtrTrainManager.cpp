/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage01\GCtrTrain\GCtrTrainManager.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned int otau32Se_TrainHorn[2]; // size: 0x8, address: 0x687F60
unsigned int otau32Se_TrainL[2]; // size: 0x8, address: 0x687F68
signed char m_toas8ViewToEffectiveRanking[4]; // size: 0x4, address: 0x687F70
struct /* @anon4 */ {
    // total size: 0x34
} __vt__23clsGCtrlTrainThroughCol; // size: 0x34, address: 0x6C5F60
struct /* @anon11 */ {
    // total size: 0x28
...
void * __dt(class clsGCtrlTrain_Obj *, signed short); // size: 0x0, address: 0x45AC80
struct /* @anon12 */ {
    // total size: 0xA8
...
void * __ct(class clsGCtrlTrain_Obj *); // size: 0x0, address: 0x45AA20
struct /* @anon16 */ {
    // total size: 0xC
...
// Range: 0x45ADA0 -> 0x45AFE4
void draw(class clsGCtrlTrain_Task * this /* r29+0xCC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45ADA0 -> 0x45AFE4
        ...
        float sMtxPal[4][4]; // r29+0x110
        float sMtx[4][4]; // r29+0xD0
        unsigned int sNodeStat; // r29+0x15C
...
// Range: 0x45AFF0 -> 0x45B0D0
void execute(class clsGCtrlTrain_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45AFF0 -> 0x45B0D0
        unsigned int u32Num; // r2
...
// Range: 0x45B0D0 -> 0x45B158
void reset(class clsGCtrlTrain_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45B0D0 -> 0x45B158
        unsigned int u32Num; // r2
...
// Range: 0x45B160 -> 0x45B3FC
void execute(class clsGCtrlTrainManager_Obj * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45B160 -> 0x45B3FC
        signed int s32TrainNum; // r20
        signed int s32VehiclesNum; // r23
        signed int s32Vehicles; // r19
        class stcTrainData * psTrainData; // r18
        class clsGCtrlTrain_Obj * pcTrainObj; // r17
        class clsSe3DControl * pcSe3DControl; // r16
        float * pf32Speed; // r2
        float * pf32Frame; // r2
        signed int s32Frame; // r2
    }
}


// Range: 0x45B400 -> 0x45B4AC
void start(class clsGCtrlTrainManager_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45B400 -> 0x45B4AC
        class stcTrainData * psTrainData; // r16
        signed int s32TrainNum; // r5
        signed int s32VehiclesNum; // r2
        class clsGCtrlTrain_Obj * pcTrainObj; // r19
        float f32Speed; // r21
        float f32SpeedUpFrame; // r20
        signed int s32i; // r18
    }
}


// Range: 0x45B4B0 -> 0x45B55C
void destroyData(class clsGCtrlTrainManager_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45B4B0 -> 0x45B55C
        class stcTrainData * psTrainData; // r17
        signed int s32TrainNum; // r16
    }
}


// Range: 0x45B560 -> 0x45B920
void createData(class clsGCtrlTrainManager_Obj * this /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45B560 -> 0x45B920
        signed int s32TrainNum; // r2
        signed int s32VehiclesNum; // r21
        signed int s32TrainMax; // r29+0xB0
        signed int s32i; // r20
        class stcTrainData * psTrainData; // r19
        class clsGCtrlTrain_Obj * pcTrainObj; // r18
        class clsGCtrlTrain_Obj * pcParentObj; // r3
        class clsSe3DControl * pcSe3DControl; // r2
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        class stcSetDataDetail * psSetData; // r20
        float f32Speed; // r21
        float f32Offset; // r20
        signed int s32j; // r19
        unsigned int u32PathNo; // r2
        class hkVector4 cBox; // r29+0xD0
        class hkShape * pcShape; // r2
        class NNS_QUATERNION sQuat; // r29+0xC0
    }
}


// Range: 0x45B920 -> 0x45B97C
void setData(class clsGCtrlTrainManager_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45B920 -> 0x45B97C
        class stcSetDataDetail * psSetDataDetail; // r2
    }
}


// Range: 0x45B980 -> 0x45BA64
void contactTriggerEvent(class clsGCtrlTrainThroughCol * this /* r16 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x45B980 -> 0x45BA64
        unsigned char bStart; // r4
    }
}
