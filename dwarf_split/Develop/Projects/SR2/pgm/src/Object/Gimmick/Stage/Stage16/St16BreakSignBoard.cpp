/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage16\St16BreakSignBoard.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32CLIP_DISTx2; // size: 0x4, address: 0x692E80
class NNS_VECTOR m_toafDebrisOffset[4]; // size: 0x30, address: 0x692E90
struct /* @anon10 */ {
    // total size: 0xA8
} __vt__21clsBreakSignBoard_Obj; // size: 0xA8, address: 0x6CCA80
struct /* @anon9 */ {
    // total size: 0xA8
...
class clsBreakSignBoard_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A788
...
class clsBreakSignBoard_Task : public clsMultiModelGimmick_Task {
    // total size: 0x98
};
enum enm {
    NONE = -1,
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsBreakSignBoard_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x504F50 -> 0x5050C0
void draw(class clsBreakSignBoard_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x504F50 -> 0x5050C0
        ...
        class clsModelType_OB_TX * pcModel; // r22
...
// Range: 0x5050C0 -> 0x5051F4
void execute(class clsBreakSignBoard_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5050C0 -> 0x5051F4
        class NNS_NODE * psNodeList; // r18
        unsigned int u32i; // r17
        class NNS_VECTOR * opsOffsetVec; // r16
        unsigned int u32Num; // r2
        unsigned int u32i; // r17
    }
}
...
// Range: 0x505200 -> 0x505270
void reset(class clsBreakSignBoard_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x505200 -> 0x505270
        unsigned int u32Num; // r2
...
// Range: 0x505270 -> 0x50550C
void draw(class clsBreakSignBoard_Obj * this /* r19 */, class clsModelType_OB_TX * pcModels /* r2 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r23 */, float (* psMtxWork)[4][4] /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x505270 -> 0x50550C
        class clsModelType_OB_TX & rcObj; // r2
    }
}


// Range: 0x505510 -> 0x5055AC
void main(class clsBreakSignBoard_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x505510 -> 0x5055AC
    }
...
// Range: 0x5055B0 -> 0x505778
void contactTriggerEvent(class clsBreakSignBoard_Obj * this /* r17 */, class hkContactPoint * pcContact /* r18 */, class clsObject * pcObject /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5055B0 -> 0x505778
        class NNS_VECTORFAST sContactPosVecFast; // r29+0x90
        class clsPlayerTask * pcPlayer; // r2
        unsigned int oau32SeTbl[2]; // r29+0xA8
    }
}


// Range: 0x505780 -> 0x5057F4
void destroyData(class clsBreakSignBoard_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x505780 -> 0x5057F4
    }
...
// Range: 0x505800 -> 0x505DF0
void createData(class clsBreakSignBoard_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x505800 -> 0x505DF0
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0x60
        class hkVector4 cVec; // r29+0x50
        class hkShape * pcShape; // r17
        char __FUNCTION__[14]; // @ 0x00692E70
    }
}


// Range: 0x505DF0 -> 0x505E2C
void setData(class clsBreakSignBoard_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x505DF0 -> 0x505E2C
    }
...
// Range: 0x505E30 -> 0x505EB0
void reset(class clsBreakSignBoard_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x505E30 -> 0x505EB0
...
// Range: 0x505EB0 -> 0x5060A8
void createModels(class clsSignBoardModel * this /* r18 */, class stcBinInfo & rsBinInfoI /* r20 */, unsigned int u32CalcObjNum /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x505EB0 -> 0x5060A8
        class clsModelType_OB_TX * apcModelTop; // r2
        class clsModelType_OB_TX * apcModel; // r18
        unsigned int u32ModelNum; // r17
...
// Range: 0x5060B0 -> 0x5060B8
void @80@__dt__21clsBreakSignBoard_ObjFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5060B0 -> 0x5060B8
    }
