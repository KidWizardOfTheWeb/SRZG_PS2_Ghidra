/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage02\St02Butterfly.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class NNS_VECTORFAST toasPointVecFast_0[4]; // size: 0x40, address: 0x67F850
static class NNS_VECTORFAST toasPointVecFast_1[4]; // size: 0x40, address: 0x67F890
static class NNS_VECTORFAST toasPointVecFast_2[4]; // size: 0x40, address: 0x67F8D0
static class NNS_VECTORFAST toasPointVecFast_3[4]; // size: 0x40, address: 0x67F910
static class NNS_VECTORFAST toasPointVecFast_4[4]; // size: 0x40, address: 0x67F950
static class NNS_VECTORFAST toasPointVecFast_5[4]; // size: 0x40, address: 0x67F990
static class NNS_VECTORFAST toasPointVecFast_6[4]; // size: 0x40, address: 0x67F9D0
static class NNS_VECTORFAST toasPointVecFast_7[4]; // size: 0x40, address: 0x67FA10
static class NNS_VECTORFAST toasPointVecFast_8[4]; // size: 0x40, address: 0x67FA50
static class NNS_VECTORFAST toasPointVecFast_9[4]; // size: 0x40, address: 0x67FA90
static class NNS_VECTORFAST toasPointVecFast_10[4]; // size: 0x40, address: 0x67FAD0
static class NNS_VECTORFAST toasPointVecFast_11[4]; // size: 0x40, address: 0x67FB10
static class NNS_VECTORFAST * toapsPointTable[12]; // size: 0x30, address: 0x6283B0
static unsigned int toau32PointNumTable[12]; // size: 0x30, address: 0x67FB50
static float CLIP_DISTx2; // size: 0x4, address: 0x67FB80
struct /* @anon0 */ {
    // total size: 0x48
} __vt__17clsButterfly_Task; // size: 0x48, address: 0x6C0400
struct /* @anon2 */ {
    // total size: 0x48
} __vt__90clsSingleModelGimmick_Task<17clsButterfly_Task,16clsButterfly_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6C0500
struct /* @anon3 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsButterfly_Task * m_tpcSingleton; // size: 0x4, address: 0xB15ED8
struct /* @anon7 */ {
    // total size: 0xC
} __vt__33clsSingleton<17clsButterfly_Task>; // size: 0xC, address: 0x6C0498
void * __dt(class clsButterfly_Obj *, signed short); // size: 0x0, address: 0x398390
struct /* @anon11 */ {
    // total size: 0x48
} __vt__82clsBaseGimmickBody<17clsButterfly_Task,16clsButterfly_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6C04B0
struct /* @anon5 */ {
    // total size: 0x28
...
struct /* @anon1 */ {
    // total size: 0x44
} __vt__16clsButterfly_Obj; // size: 0x44, address: 0x6C0450
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x67FBF0
struct /* @anon6 */ {
    // total size: 0x30
} __vt__7clsTask; // size: 0x30, address: 0x6B59F0
void * __ct(class clsButterfly_Obj *); // size: 0x0, address: 0x3992E0
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x9C
public:
    class clsButterfly_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsButterfly_Task : public clsSingleModelGimmick_Task {
    // total size: 0x9C
};
class _LineData {
    // total size: 0x40
...
class clsButterfly_Obj : public clsGimmickObj {
    // total size: 0x90
public:
    class NNS_VECTORFAST * m_opsPointVecFast; // offset 0x50, size 0x4
    class NNS_VECTORFAST m_sDirVecFast; // offset 0x60, size 0x10
    enum enmButterflyMode m_eButterflyMode; // offset 0x70, size 0x4
    float m_f32WaitFrame; // offset 0x74, size 0x4
    float m_f32Frame; // offset 0x78, size 0x4
    float m_f32Speed; // offset 0x7C, size 0x4
    signed char m_s8TableNo; // offset 0x80, size 0x1
    signed char m_s8PointNum; // offset 0x81, size 0x1
    signed char m_s8PointNo; // offset 0x82, size 0x1
};
class clsFlag {
    // total size: 0x4
public:
...
// Range: 0x398400 -> 0x39877C
void draw(class clsButterfly_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x398400 -> 0x39877C
        ...
        class clsModelType_OB_TX_MO & rcModel; // r17
...
// Range: 0x398820 -> 0x398A04
void execute(class clsButterfly_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x398820 -> 0x398A04
        unsigned int u32Num; // r2
...
// Range: 0x398A10 -> 0x398C84
void setNextPoint(class clsButterfly_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x398A10 -> 0x398C84
...
// Range: 0x398C90 -> 0x398D0C
unsigned int checkWaitFrame(class clsButterfly_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x398C90 -> 0x398D0C
...
// Range: 0x398D10 -> 0x398DB0
void moveUpDown(class clsButterfly_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x398D10 -> 0x398DB0
        float f32PosY; // r29+0x20
    }
}


// Range: 0x398DB0 -> 0x398E28
void movePoint(class clsButterfly_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x398DB0 -> 0x398E28
...
// Range: 0x398E30 -> 0x398EE8
void init(class clsButterfly_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x398E30 -> 0x398EE8
    }
...
// Range: 0x398F00 -> 0x398F08
void reset(class clsButterfly_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x398F00 -> 0x398F08
    }
...
// Range: 0x398F10 -> 0x398F7C
void * __ct(class clsButterfly_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x398F10 -> 0x398F7C
    }
