/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\GravityRing.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x684920
struct /* @anon4 */ {
    // total size: 0x48
} __vt__19clsGravityRing_Task; // size: 0x48, address: 0x6C2770
struct /* @anon8 */ {
    // total size: 0x48
} __vt__100clsSingleModelGimmick_Task<19clsGravityRing_Task,21clsGravityRing_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C2880
struct /* @anon6 */ {
    // total size: 0x38
...
struct /* @anon0 */ {
    // total size: 0xC
} __vt__35clsSingleton<19clsGravityRing_Task>; // size: 0xC, address: 0x6C2818
void * __dt(class clsGravityRing_Object *, signed short); // size: 0x0, address: 0x3F86B0
struct /* @anon3 */ {
    // total size: 0x48
} __vt__92clsBaseGimmickBody<19clsGravityRing_Task,21clsGravityRing_Object,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C2830
struct /* @anon9 */ {
    // total size: 0x28
...
struct /* @anon12 */ {
    // total size: 0x34
} __vt__30clsGravityRingThroughCollision; // size: 0x34, address: 0x6C28D0
struct /* @anon10 */ {
    // total size: 0x58
} __vt__21clsGravityRing_Object; // size: 0x58, address: 0x6C27C0
...
void * __ct(class clsGravityRing_Object *); // size: 0x0, address: 0x3F9150
...
// Range: 0x3F8800 -> 0x3F89C4
void createModel(class clsGravityRing_Task * this /* r18 */, class stcBinInfo & rsBinInfoI /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F8800 -> 0x3F89C4
...
// Range: 0x3F89D0 -> 0x3F8A4C
class clsGravityRing_Object * getGravityRingObjectPtr(class clsGravityRing_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F89D0 -> 0x3F8A4C
...
// Range: 0x3F8A50 -> 0x3F8BAC
void draw(class clsGravityRing_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F8A50 -> 0x3F8BAC
        unsigned int u32Num; // r2
        class clsModelType_OB_TX_MO_MA & rcModel; // r16
        float sMtxWork[4][4]; // r29+0x50
        unsigned int u32i; // r19
    }
}


// Range: 0x3F8BB0 -> 0x3F8C98
void execute(class clsGravityRing_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F8BB0 -> 0x3F8C98
        unsigned int u32Num; // r2
...
// Range: 0x3F8CA0 -> 0x3F8D10
void reset(class clsGravityRing_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F8CA0 -> 0x3F8D10
        unsigned int u32Num; // r2
...
// Range: 0x3F8D10 -> 0x3F8DD8
void * __ct(class clsGravityRing_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F8D10 -> 0x3F8DD8
    }
...
// Range: 0x3F9330 -> 0x3F9338
void destroyData(class clsGravityRing_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F9330 -> 0x3F9338
    }
...
// Range: 0x3F9350 -> 0x3F935C
void setData(class clsGravityRing_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F9350 -> 0x3F935C
    }
...
// Range: 0x3F9360 -> 0x3F93CC
void start(class clsGravityRing_Object * this /* r17 */, class clsPlayerTask * pcPlayer /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F9360 -> 0x3F93CC
    }
...
// Range: 0x3F93D0 -> 0x3F9634
void draw(class clsGravityRing_Object * this /* r20 */, class clsModelType_OB_TX_MO_MA & rcModel /* r19 */, float (* psMtxWork)[4][4] /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F93D0 -> 0x3F9634
...
// Range: 0x3F9640 -> 0x3F97F4
void execute(class clsGravityRing_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F9640 -> 0x3F97F4
    }
...
// Range: 0x3F9800 -> 0x3F9998
void contactAlwaysEvent(class clsGravityRingThroughCollision * this /* r2 */, class clsPlayerTask * pcPlayer /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F9800 -> 0x3F9998
        class clsGravityDive * pcGravityDive; // r2
    }
}
