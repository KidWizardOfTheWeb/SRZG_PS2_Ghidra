/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage03\St03PowerBreak.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x6805A0
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x6805B0
struct /* @anon8 */ {
    // total size: 0x48
} __vt__18clsPowerBreak_Task; // size: 0x48, address: 0x6C0DE0
struct /* @anon19 */ {
    // total size: 0x48
} __vt__89clsSingleModelGimmick_Task<18clsPowerBreak_Task,17clsPowerBreak_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C0E90
struct /* @anon5 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPowerBreak_Task * m_tpcSingleton; // size: 0x4, address: 0xB15F58
struct /* @anon6 */ {
    // total size: 0xC
} __vt__34clsSingleton<18clsPowerBreak_Task>; // size: 0xC, address: 0x6C0E28
void * __dt(class clsPowerBreak_Obj *, signed short); // size: 0x0, address: 0x3AE720
struct /* @anon11 */ {
    // total size: 0x48
} __vt__81clsBaseGimmickBody<18clsPowerBreak_Task,17clsPowerBreak_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C0E40
struct /* @anon14 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon16 */ {
    // total size: 0xA8
} __vt__17clsPowerBreak_Obj; // size: 0xA8, address: 0x6C0EE0
struct /* @anon13 */ {
    // total size: 0x28
...
void * __ct(class clsPowerBreak_Obj *); // size: 0x0, address: 0x3AF0D0
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
struct /* @anon2 */ {
    // total size: 0xC
} __vt__14clsSe3DControl; // size: 0xC, address: 0x6BBB18
float t_of32WeightTypeLight; // size: 0x4, address: 0x665188
...
class clsPowerBreak_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPowerBreak_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x3AE820 -> 0x3AEACC
void draw(class clsPowerBreak_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AE820 -> 0x3AEACC
...
// Range: 0x3AEB70 -> 0x3AEC50
void execute(class clsPowerBreak_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AEB70 -> 0x3AEC50
        unsigned int u32Num; // r2
...
// Range: 0x3AEC50 -> 0x3AECC0
void reset(class clsPowerBreak_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AEC50 -> 0x3AECC0
        unsigned int u32Num; // r2
...
// Range: 0x3AECC0 -> 0x3AED7C
void * __ct(class clsPowerBreak_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AECC0 -> 0x3AED7C
...
// Range: 0x3AF190 -> 0x3AF214
void destroyData(class clsPowerBreak_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AF190 -> 0x3AF214
    }
...
// Range: 0x3AF220 -> 0x3AF5F0
void createData(class clsPowerBreak_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AF220 -> 0x3AF5F0
        ...
        unsigned int aou32SeNo[2]; // r29+0x188
    }
}


// Range: 0x3AF5F0 -> 0x3AF694
void setData(class clsPowerBreak_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AF5F0 -> 0x3AF694
    }
...
// Range: 0x3AF6A0 -> 0x3AF79C
void requestDrawBreakEffect(class clsPowerBreak_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AF6A0 -> 0x3AF79C
    }
...
// Range: 0x3AF7A0 -> 0x3AF7C0
void main(class clsPowerBreak_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AF7A0 -> 0x3AF7C0
    }
...
// Range: 0x3AF7C0 -> 0x3AF860
void reset(class clsPowerBreak_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3AF7C0 -> 0x3AF860
