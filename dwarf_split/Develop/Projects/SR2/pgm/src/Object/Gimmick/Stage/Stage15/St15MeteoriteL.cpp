/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage15\St15MeteoriteL.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x687B78
static float toaf32TargetDistance[2]; // size: 0x8, address: 0x687B80
struct /* @anon5 */ {
    // total size: 0x48
} __vt__18clsMeteoriteL_Task; // size: 0x48, address: 0x6C5780
struct /* @anon8 */ {
    // total size: 0x48
} __vt__89clsSingleModelGimmick_Task<18clsMeteoriteL_Task,17clsMeteoriteL_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C58E0
struct /* @anon4 */ {
    // total size: 0x38
...
struct /* @anon17 */ {
    // total size: 0xC
} __vt__34clsSingleton<18clsMeteoriteL_Task>; // size: 0xC, address: 0x6C5878
void * __dt(class clsMeteoriteL_Obj *, signed short); // size: 0x0, address: 0x4500B0
struct /* @anon1 */ {
    // total size: 0x48
} __vt__81clsBaseGimmickBody<18clsMeteoriteL_Task,17clsMeteoriteL_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C5890
struct /* @anon18 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon3 */ {
    // total size: 0xA8
} __vt__17clsMeteoriteL_Obj; // size: 0xA8, address: 0x6C57D0
struct /* @anon13 */ {
    // total size: 0x28
...
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x687C40
...
class NNS_VECTOR tosZeroVec; // size: 0xC, address: 0x687C30
class clsPfCri * m_tpcSingleton; // size: 0x4, address: 0x6E6998
unsigned char m_toabDisableFog[17]; // size: 0x11, address: 0x687510
struct /* @anon14 */ {
    // total size: 0x30
} __vt__7clsTask; // size: 0x30, address: 0x6B59F0
void * __ct(class clsMeteoriteL_Obj *); // size: 0x0, address: 0x4510B0
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
float tosUnitMatrix[4][4]; // size: 0x40, address: 0x687BF0
struct /* @anon2 */ {
    // total size: 0xC
} __vt__14clsSe3DControl; // size: 0xC, address: 0x6BBB18
void * __dt(class clsDebriParts *, signed short); // size: 0x0, address: 0x36FD00
void * __ct(class clsDebriParts *); // size: 0x0, address: 0x36FD60
float t_of32WeightTypeSuperLight; // size: 0x4, address: 0x665190
struct /* @anon6 */ {
    // total size: 0x28
} __vt__13clsDebriParts; // size: 0x28, address: 0x6C0AD0
...
class clsSt15MeteoriteFallEffect_Task : public clsTask {
    // total size: 0x64
public:
    float (* m_opsDrawMatrix)[4][4]; // offset 0x54, size 0x4
    class clsModelType_OB_TX_MO_MA * m_pcModel; // offset 0x58, size 0x4
    float m_f32Frame; // offset 0x5C, size 0x4
    unsigned char m_bDraw; // offset 0x60, size 0x1
};
class clsSingleton {
    // total size: 0x4
};
...
class clsDebriParts : public clsDebriPartsBase {
    // total size: 0x60
public:
    class NNS_VECTORFAST m_sAngleVecFast; // offset 0x30, size 0x10
    class NNS_VECTORFAST m_sVelocityFast; // offset 0x40, size 0x10
    class NNS_VECTORFAST m_sAngleVelocityFast; // offset 0x50, size 0x10
};
...
// Range: 0x4501B0 -> 0x450530
void setMeteoriteL(class clsMeteoriteL_Task * this /* r20 */, signed int os32ZoneNo /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4501B0 -> 0x450530
        unsigned int u32i; // r18
        unsigned int u32ModeNo; // r2
        signed int s32i; // r20
        signed int s32UserNum; // r2
        class NNS_VECTORFAST & rsBossPosVF; // r19
        class NNS_VECTORFAST sDirVF; // r29+0x150
        class stcCamFilter sUpFilter; // r29+0x110
    }
}


// Range: 0x450530 -> 0x4508F0
void draw(class clsMeteoriteL_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x450530 -> 0x4508F0
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        unsigned int u32Num; // r2
        class clsModelType_OB_TX & rcModel; // r2
        unsigned int * psNodeStat; // r2
        float (* opaNnViewMtx)[4][4]; // r23
        float (* psMtxPal)[4][4]; // r2
        float sMtx[4][4]; // r29+0xD0
        unsigned int u32i; // r20
    }
}


// Range: 0x4509B0 -> 0x450B50
void execute(class clsMeteoriteL_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4509B0 -> 0x450B50
        signed int s32i; // r16
        unsigned int u32Num; // r2
        unsigned int u32i; // r18
        class stcSetDataDetail sSetDataDetail; // @ 0x00B173D0
    }
}


// Range: 0x450B50 -> 0x450BC0
void reset(class clsMeteoriteL_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x450B50 -> 0x450BC0
        unsigned int u32Num; // r2
...
// Range: 0x450BC0 -> 0x450C38
void reset(class clsMeteoriteL_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x450BC0 -> 0x450C38
    }
...
// Range: 0x450C40 -> 0x450D5C
void * __ct(class clsMeteoriteL_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x450C40 -> 0x450D5C
    }
...
// Range: 0x451180 -> 0x451240
void destroyData(class clsMeteoriteL_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x451180 -> 0x451240
    }
...
// Range: 0x451240 -> 0x451928
void createData(class clsMeteoriteL_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x451240 -> 0x451928
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0xB0
        class hkMassProperties massProperties; // r29+0x60
        char __FUNCTION__[14]; // @ 0x00687B68
    }
}


// Range: 0x451930 -> 0x45199C
void setData(class clsMeteoriteL_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x451930 -> 0x45199C
    }
...
// Range: 0x4519A0 -> 0x4519D4
void requestDrawContactEffect(class clsMeteoriteL_Obj * this /* r2 */, class hkContactPoint * pcContact /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4519A0 -> 0x4519D4
    }
...
// Range: 0x4519E0 -> 0x451D00
void requestDrawBreakEffect(class clsMeteoriteL_Obj * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4519E0 -> 0x451D00
        class clsPlayerTask * pcPlayerTask; // r2
        unsigned int u32i; // r20
        unsigned int u32UserNum; // r2
        float f32Distance; // r29+0x100
        class clsMeteoriteL_Task * pcMeteoTask; // r2
        class stcCamFilter sQuakeFilter; // r29+0xC0
        class stcCamFilter sQuakeFilter; // r29+0x80
    }
}


// Range: 0x451D00 -> 0x451EE0
void timelagAttackMeteoriteL(class clsMeteoriteL_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x451D00 -> 0x451EE0
        float f32Distance; // r29+0xD0
        class NNS_VECTORFAST sTargetPosVecFast; // r29+0xB0
        class clsPlayerTask * pcPlayer; // r2
        class clsPath cPath; // r29+0x50
        unsigned char u8PathNo; // r29+0xCF
    }
}


// Range: 0x451EE0 -> 0x4522E4
void attackMeteoriteL(class clsMeteoriteL_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x451EE0 -> 0x4522E4
        float sMtx[4][4]; // r29+0x120
        class NNS_VECTORFAST sXVecFast; // r29+0x110
        class NNS_VECTORFAST sYVecFast; // r29+0x100
        class NNS_VECTORFAST sZVecFast; // r29+0xF0
        class NNS_VECTORFAST sTargetPosVecFast; // r29+0xE0
        class clsPlayerTask * pcPlayer; // r2
        class clsPath cPath; // r29+0x80
        unsigned char u8PathNo; // r29+0x16F
        class hkVector4 cVelocity; // r29+0x70
        float f32Distance; // r29+0x170
    }
}


// Range: 0x4522F0 -> 0x452660
void main(class clsMeteoriteL_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4522F0 -> 0x452660
        class NNS_VECTORFAST sVecFast; // r29+0x1D0
        class NNS_QUATERNION sQuat; // r29+0x1C0
    }
}
