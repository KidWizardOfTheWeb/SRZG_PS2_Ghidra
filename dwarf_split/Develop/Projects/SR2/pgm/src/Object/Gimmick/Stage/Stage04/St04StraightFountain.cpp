/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage04\St04StraightFountain.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x685368
unsigned int otau32Se_Spring[2]; // size: 0x8, address: 0x685370
struct /* @anon14 */ {
    // total size: 0x48
} __vt__24clsStraightFountain_Task; // size: 0x48, address: 0x6C3160
struct /* @anon2 */ {
    // total size: 0x48
} __vt__104clsSingleModelGimmick_Task<24clsStraightFountain_Task,23clsStraightFountain_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6C3210
struct /* @anon5 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsStraightFountain_Task * m_tpcSingleton; // size: 0x4, address: 0xB16DE8
struct /* @anon6 */ {
    // total size: 0xC
} __vt__40clsSingleton<24clsStraightFountain_Task>; // size: 0xC, address: 0x6C31A8
void * __dt(class clsStraightFountain_Obj *, signed short); // size: 0x0, address: 0x412040
struct /* @anon11 */ {
    // total size: 0x48
} __vt__96clsBaseGimmickBody<24clsStraightFountain_Task,23clsStraightFountain_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6C31C0
struct /* @anon8 */ {
    // total size: 0x28
...
struct /* @anon13 */ {
    // total size: 0x48
} __vt__23clsStraightFountain_Obj; // size: 0x48, address: 0x6C3260
...
void * __ct(class clsStraightFountain_Obj *); // size: 0x0, address: 0x412C00
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
unsigned char m_tbSpFlg; // size: 0x1, address: 0xB15E48
struct /* @anon10 */ {
    // total size: 0x28
...
struct /* @anon3 */ {
    // total size: 0x34
} __vt__35clsStraightFountainThroughCollision; // size: 0x34, address: 0x6C32B0
struct /* @anon1 */ {
    // total size: 0xC
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x9C
public:
    class clsStraightFountain_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsStraightFountainThroughCollision : public clsBaseThroughCollision {
    // total size: 0xC
public:
    class clsStraightFountain_Obj * m_pcStraightFountain; // offset 0x8, size 0x4
};
...
class clsStraightFountain_Obj : public clsGimmickObj {
    // total size: 0xE0
public:
    enum enmStraightFountainMode m_eMode; // offset 0x50, size 0x4
    enum enmStraightFountainState m_eState; // offset 0x54, size 0x4
    class clsStraightFountainThroughCollision * m_pcCollision; // offset 0x58, size 0x4
    ...
    float m_sScale; // offset 0x80, size 0x4
    float m_f32Wait; // offset 0x84, size 0x4
    class clsTask * m_psWaterParticle; // offset 0x88, size 0x4
    float m_sPosturalMtx[4][4]; // offset 0x90, size 0x40
...
class clsStraightFountain_Task : public clsSingleModelGimmick_Task {
    // total size: 0xA0
public:
...
// Range: 0x4120D0 -> 0x41237C
void draw(class clsStraightFountain_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4120D0 -> 0x41237C
...
// Range: 0x412420 -> 0x412764
void execute(class clsStraightFountain_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x412420 -> 0x412764
...
// Range: 0x4127C0 -> 0x412830
void reset(class clsStraightFountain_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4127C0 -> 0x412830
        unsigned int u32Num; // r2
...
// Range: 0x412830 -> 0x41289C
void * __ct(class clsStraightFountain_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x412830 -> 0x41289C
    }
...
// Range: 0x412CE0 -> 0x412CEC
void setMist(unsigned char bFlg /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x412CE0 -> 0x412CEC
    }
...
// Range: 0x412CF0 -> 0x412DA0
void ChackMode(class clsStraightFountain_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x412CF0 -> 0x412DA0
        float f32ChaekNum; // r1
    }
}


// Range: 0x412DA0 -> 0x412DE8
unsigned char stepMotionFrame(class clsStraightFountain_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x412DA0 -> 0x412DE8
    }
...
// Range: 0x412DF0 -> 0x412E6C
void destroyData(class clsStraightFountain_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x412DF0 -> 0x412E6C
    }
...
// Range: 0x412F00 -> 0x4130DC
void createData(class clsStraightFountain_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x412F00 -> 0x4130DC
...
// Range: 0x4130F0 -> 0x413144
void reset(class clsStraightFountain_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4130F0 -> 0x413144
    }
...
// Range: 0x413150 -> 0x4131B8
void contactTriggerEvent(class clsStraightFountainThroughCollision * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x413150 -> 0x4131B8
    }
