/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\PutGravityObj.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32CLIP_DISTx2; // size: 0x4, address: 0x67E8B0
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x67E8C0
class clsGravityGimmickParam * t_apocGravityGimmickParams[17]; // size: 0x44, address: 0x6280F0
struct /* @anon6 */ {
    // total size: 0xA8
} __vt__20clsPutGravityObj_Obj; // size: 0xA8, address: 0x6BFB80
struct /* @anon10 */ {
    // total size: 0xA8
...
class clsPutGravityObj_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A878
...
class clsPutGravityObj_Task : public clsMultiShape, public clsMultiModelGimmick_Task {
    // total size: 0xA8
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPutGravityObj_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x387D60 -> 0x387F48
void draw(class clsPutGravityObj_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x387D60 -> 0x387F48
...
// Range: 0x387F50 -> 0x388098
void execute(class clsPutGravityObj_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x387F50 -> 0x388098
        unsigned int u32Num; // r2
...
// Range: 0x3880A0 -> 0x388110
void reset(class clsPutGravityObj_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3880A0 -> 0x388110
        unsigned int u32Num; // r2
...
// Range: 0x388110 -> 0x388480
void draw(class clsPutGravityObj_Obj * this /* r21 */, class clsModelType_OB_TX * pcModels /* r2 */, float (* psMtxPal)[4][4] /* r20 */, unsigned int * psNodeStat /* r19 */, float (* opaNnViewMtx)[4][4] /* r30 */, float (* psMtxWork)[4][4] /* r18 */, unsigned int u32ViewNo /* r23 */, class clsPutGravityObj_Task * pcTask /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x388110 -> 0x388480
...
// Range: 0x388480 -> 0x3884F0
void main(class clsPutGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x388480 -> 0x3884F0
    }
...
// Range: 0x3884F0 -> 0x38855C
void requestDrawContactEffect(class clsPutGravityObj_Obj * this /* r16 */, class hkContactPoint * pcContact /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3884F0 -> 0x38855C
    }
...
// Range: 0x388560 -> 0x3885CC
void contactInterraction(class clsPutGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x388560 -> 0x3885CC
    }
...
// Range: 0x3885D0 -> 0x388650
void callbackBreakEvent(class clsPutGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3885D0 -> 0x388650
    }
...
// Range: 0x388650 -> 0x3886F0
void callbackGravityEvent(class clsPutGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x388650 -> 0x3886F0
    }
...
// Range: 0x3886F0 -> 0x38875C
void requestDrawBreakEffect(class clsPutGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3886F0 -> 0x38875C
    }
...
// Range: 0x388760 -> 0x3887E0
void destroyData(class clsPutGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x388760 -> 0x3887E0
    }
...
// Range: 0x3887E0 -> 0x388FB8
void createData(class clsPutGravityObj_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3887E0 -> 0x388FB8
        ...
        unsigned int u32StageNo; // r2
        unsigned int oau32SeNo[4]; // r29+0xD0
        unsigned int oau32SeNo[9]; // r29+0xA0
    }
}


// Range: 0x388FC0 -> 0x389030
void setData(class clsPutGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x388FC0 -> 0x389030
    }
...
// Range: 0x389030 -> 0x3890DC
void reset(class clsPutGravityObj_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x389030 -> 0x3890DC
    }
...
// Range: 0x3890F0 -> 0x3890F8
void @80@__dt__20clsPutGravityObj_ObjFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3890F0 -> 0x3890F8
    }
