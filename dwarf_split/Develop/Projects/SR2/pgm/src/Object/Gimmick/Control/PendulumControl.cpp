/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Control\PendulumControl.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x685310
class NNS_VECTORFAST tosYVecFast; // size: 0x10, address: 0x685300
...
// Range: 0x40ED60 -> 0x40ED9C
void draw(class clsPendulumControl * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40ED60 -> 0x40ED9C
        class NNS_QUATERNION sRotQuat; // r29+0x20
    }
}


// Range: 0x40EDA0 -> 0x40F31C
void update(class clsPendulumControl * this /* r18 */, signed char s8KeyLevelX /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x40EDA0 -> 0x40F31C
        class clsPendulum * pcPendulum; // r2
        class stcControlParam * psParam; // r2
        class stcPendulum & rsPendulum; // r17
        float f32AngleAbs; // r29+0x190
        float f32CounterAngle; // r29+0x190
        float * pf32MaxAngle; // r7
        unsigned int u32i; // r6
        unsigned int u32Num; // r2
        float f32CounterAngle; // r1
        float f32MaxAngleVelocity; // r3
        class NNS_VECTORFAST sForceFast; // r29+0x180
        float sMtx[4][4]; // r29+0x140
        class hkVector4 cVec; // r29+0x130
    }
}
