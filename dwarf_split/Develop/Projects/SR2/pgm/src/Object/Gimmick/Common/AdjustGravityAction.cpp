/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\AdjustGravityAction.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon11 */ {
    // total size: 0x44
} __vt__27clsAdjustGravityAction_Task; // size: 0x44, address: 0x6CAEB0
void * __dt(class clsAdjustGravityAction_Object *, signed short); // size: 0x0, address: 0x4EEA10
struct /* @anon4 */ {
    // total size: 0x44
} __vt__84clsBaseGimmickThrough<27clsAdjustGravityAction_Task,29clsAdjustGravityAction_Object>; // size: 0x44, address: 0x6CAFA0
struct /* @anon8 */ {
    // total size: 0x30
...
struct /* @anon2 */ {
    // total size: 0x84
} __vt__29clsAdjustGravityAction_Object; // size: 0x84, address: 0x6CAF00
...
void * __ct(class clsAdjustGravityAction_Object *); // size: 0x0, address: 0x4EEF80
class clsAdjustGravityAction_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA6F0
struct /* @anon1 */ {
    // total size: 0xC
} __vt__43clsSingleton<27clsAdjustGravityAction_Task>; // size: 0xC, address: 0x6CAF88
...
class clsAdjustGravityAction_Task : public clsBaseGimmickThrough, public clsGimmickCommon {
    // total size: 0x8C
};
...
class clsBaseGimmickThrough : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x88
public:
    class clsAdjustGravityAction_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x4EEAF0 -> 0x4EEBA4
void draw(class clsAdjustGravityAction_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EEAF0 -> 0x4EEBA4
    }
...
// Range: 0x4EEBB0 -> 0x4EECA0
void execute(class clsAdjustGravityAction_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EEBB0 -> 0x4EECA0
...
// Range: 0x4EECA0 -> 0x4EEDE8
void * __ct(class clsAdjustGravityAction_Task * this /* r17 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EECA0 -> 0x4EEDE8
    }
...
// Range: 0x4EF0C0 -> 0x4EF0FC
void updateSetEditorCollision(class clsAdjustGravityAction_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EF0C0 -> 0x4EF0FC
    }
...
// Range: 0x4EF100 -> 0x4EF108
void destroyData(class clsAdjustGravityAction_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EF100 -> 0x4EF108
    }
...
// Range: 0x4EF110 -> 0x4EF214
void createData(class clsAdjustGravityAction_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EF110 -> 0x4EF214
        class hkShape * pcShape; // r2
        class hkVector4 cHalfSize; // r29+0x30
    }
}


// Range: 0x4EF220 -> 0x4EF228
void contactRemoveEvent(class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EF220 -> 0x4EF228
    }
...
// Range: 0x4EF230 -> 0x4EF238
void contactTriggerEvent(class clsAdjustGravityAction_Object * this /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4EF230 -> 0x4EF238
    }
