/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage07\St07WallThroughCollision.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x6936B0
struct /* @anon10 */ {
    // total size: 0x48
} __vt__28clsWallThroughCollision_Task; // size: 0x48, address: 0x6CD2B0
struct /* @anon13 */ {
    // total size: 0x48
} __vt__112clsSingleModelGimmick_Task<28clsWallThroughCollision_Task,27clsWallThroughCollision_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6CD360
struct /* @anon3 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsWallThroughCollision_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA798
struct /* @anon1 */ {
    // total size: 0xC
} __vt__44clsSingleton<28clsWallThroughCollision_Task>; // size: 0xC, address: 0x6CD2F8
void * __dt(class clsWallThroughCollision_Obj *, signed short); // size: 0x0, address: 0x513630
struct /* @anon7 */ {
    // total size: 0x48
} __vt__104clsBaseGimmickBody<28clsWallThroughCollision_Task,27clsWallThroughCollision_Obj,21clsModelType_OB_TX_MO>; // size: 0x48, address: 0x6CD310
struct /* @anon6 */ {
    // total size: 0x28
...
void * __dt(class clsWallThroughCollision *, signed short); // size: 0x0, address: 0x5136E0
struct /* @anon4 */ {
    // total size: 0x48
} __vt__27clsWallThroughCollision_Obj; // size: 0x48, address: 0x6CD3B0
struct /* @anon9 */ {
    // total size: 0x28
...
struct /* @anon11 */ {
    // total size: 0x34
} __vt__23clsWallThroughCollision; // size: 0x34, address: 0x6CD400
...
void * __ct(class clsWallThroughCollision_Obj *); // size: 0x0, address: 0x513E00
class clsGmkManager * m_tpcSingleton; // size: 0x4, address: 0xB0A8F0
void * __ct(class clsWallThroughCollision *); // size: 0x0, address: 0x513EF0
...
class clsWallThroughCollision : public clsBaseThroughCollision {
    // total size: 0x14
public:
    class clsWallThroughCollision_Obj * m_pcWallThroughCollision_Obj; // offset 0x8, size 0x4
    unsigned int m_u32colNum; // offset 0xC, size 0x4
    unsigned char m_bCheckFlag; // offset 0x10, size 0x1
};
class stcDataSize {
    // total size: 0x18
public:
...
class clsWallThroughCollision_Task : public clsSingleModelGimmick_Task {
    // total size: 0xA0
public:
...
enum enmThroughCollisionNum {
    THROUGH_COLLISION_00 = 0,
    THROUGH_COLLISION_01 = 1,
    THROUGH_COLLISION_02 = 2,
    THROUGH_COLLISION_03 = 3,
...
public:
    ...
    class clsWallThroughCollision m_acCollision[4]; // offset 0x54, size 0x50
    class hkShape * m_pcShape; // offset 0xA4, size 0x4
    unsigned int m_u32Num; // offset 0xA8, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x9C
public:
    class clsWallThroughCollision_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
...
// Range: 0x513770 -> 0x51377C
void createModel(class clsWallThroughCollision_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x513770 -> 0x51377C
    }
...
// Range: 0x513780 -> 0x5138AC
void draw(class clsWallThroughCollision_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x513780 -> 0x5138AC
...
// Range: 0x5138B0 -> 0x5139B8
void execute(class clsWallThroughCollision_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5138B0 -> 0x5139B8
...
// Range: 0x5139C0 -> 0x513A30
void reset(class clsWallThroughCollision_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5139C0 -> 0x513A30
        unsigned int u32Num; // r2
...
// Range: 0x513A30 -> 0x513A9C
void * __ct(class clsWallThroughCollision_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x513A30 -> 0x513A9C
    }
...
// Range: 0x513F30 -> 0x5140F8
unsigned char CheckMode(class clsWallThroughCollision_Obj * this /* r21 */, unsigned int u32Lap /* r20 */, unsigned int u32Rank /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x513F30 -> 0x5140F8
        unsigned int u32i; // r16
        unsigned char bRet; // r19
        unsigned int u32j; // r18
    }
}


// Range: 0x514100 -> 0x514160
void destroyData(class clsWallThroughCollision_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x514100 -> 0x514160
    }
...
// Range: 0x514160 -> 0x514420
void createData(class clsWallThroughCollision_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x514160 -> 0x514420
        class hkVector4 cHelfBoxSize; // r29+0x180
    }
}


// Range: 0x514420 -> 0x514428
void setData() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x514420 -> 0x514428
...
// Range: 0x514430 -> 0x51444C
void reset(class clsWallThroughCollision_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x514430 -> 0x51444C
    }
...
// Range: 0x514450 -> 0x5144E4
void contactTriggerEvent(class clsWallThroughCollision * this /* r16 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x514450 -> 0x5144E4
        signed short s16lapNum; // r2
        signed char s8Ranking; // r2
    }
}
