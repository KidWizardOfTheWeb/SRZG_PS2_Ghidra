/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage15\St15BreakFloor.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float tof32ClipSqDist; // size: 0x4, address: 0x68A738
struct /* @anon5 */ {
    // total size: 0x48
} __vt__18clsBreakFloor_Task; // size: 0x48, address: 0x6C7FB0
struct /* @anon15 */ {
    // total size: 0x48
} __vt__89clsSingleModelGimmick_Task<18clsBreakFloor_Task,17clsBreakFloor_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C8110
struct /* @anon8 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsBreakFloor_Task * m_tpcSingleton; // size: 0x4, address: 0xB176A8
struct /* @anon1 */ {
    // total size: 0xC
} __vt__34clsSingleton<18clsBreakFloor_Task>; // size: 0xC, address: 0x6C80A8
void * __dt(class clsBreakFloor_Obj *, signed short); // size: 0x0, address: 0x49EED0
struct /* @anon7 */ {
    // total size: 0x48
} __vt__81clsBaseGimmickBody<18clsBreakFloor_Task,17clsBreakFloor_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C80C0
struct /* @anon14 */ {
    // total size: 0xA8
} __vt__22clsRigidBodyGimmickObj; // size: 0xA8, address: 0x6BAFC0
struct /* @anon6 */ {
    // total size: 0xA8
} __vt__17clsBreakFloor_Obj; // size: 0xA8, address: 0x6C8000
struct /* @anon13 */ {
    // total size: 0x28
...
void * __ct(class clsBreakFloor_Obj *); // size: 0x0, address: 0x49F990
...
class clsBreakFloor_Obj : public clsRigidBodyGimmickObj {
    // total size: 0xE0
public:
    enum enmBreakFloorMode m_eBreakFloorMode; // offset 0xD0, size 0x4
    unsigned int m_u32LinkMapUserDataNo; // offset 0xD4, size 0x4
};
...
class clsBreakFloor_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
class hkEnum {
    // total size: 0x1
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsBreakFloor_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x49EFB0 -> 0x49F290
void draw(class clsBreakFloor_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49EFB0 -> 0x49F290
...
// Range: 0x49F330 -> 0x49F498
void execute(class clsBreakFloor_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49F330 -> 0x49F498
...
// Range: 0x49F4A0 -> 0x49F510
void reset(class clsBreakFloor_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49F4A0 -> 0x49F510
        unsigned int u32Num; // r2
...
// Range: 0x49F510 -> 0x49F578
void reset(class clsBreakFloor_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49F510 -> 0x49F578
    }
...
// Range: 0x49F580 -> 0x49F63C
void * __ct(class clsBreakFloor_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49F580 -> 0x49F63C
...
// Range: 0x49FA50 -> 0x49FAC4
void destroyData(class clsBreakFloor_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49FA50 -> 0x49FAC4
    }
...
// Range: 0x49FAD0 -> 0x4A019C
void createData(class clsBreakFloor_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x49FAD0 -> 0x4A019C
        ...
        char __FUNCTION__[14]; // @ 0x0068A728
    }
}


// Range: 0x4A01A0 -> 0x4A01F8
void setData(class clsBreakFloor_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A01A0 -> 0x4A01F8
    }
...
// Range: 0x4A0200 -> 0x4A02B4
void callbackCrashEvent(class clsBreakFloor_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A0200 -> 0x4A02B4
        ...
        signed int s32i; // r7
        signed int s32GroundNum; // r2
    }
}


// Range: 0x4A02C0 -> 0x4A02CC
void requestDrawBreakEffect(class clsBreakFloor_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A02C0 -> 0x4A02CC
    }
...
// Range: 0x4A02D0 -> 0x4A0398
void main(class clsBreakFloor_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4A02D0 -> 0x4A0398
    }
