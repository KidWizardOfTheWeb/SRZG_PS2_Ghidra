/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage08\St08FZoneEnemy\St08FZoneEnemy.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class stcPointData tosPoint00[2]; // size: 0x40, address: 0x697EB0
static class stcPointData tosPoint01[2]; // size: 0x40, address: 0x697EF0
static class stcPointData * toapsPointTbl[2]; // size: 0x8, address: 0x653AE0
static unsigned char toau8PointArrayNumTbl[2]; // size: 0x2, address: 0x697F30
float m_tof32CLIP_DISTx2; // size: 0x4, address: 0x697F38
...
class clsFZoneEnemy_Task * m_tpcSingleton; // size: 0x4, address: 0xB0A7A8
struct /* @anon0 */ {
    // total size: 0x28
...
public:
    ...
    float m_f32Speed; // offset 0xD8, size 0x4
    float m_f32RotX; // offset 0xDC, size 0x4
    float m_f32AddRotX; // offset 0xE0, size 0x4
    class clsFrameControl m_cFrameControl; // offset 0xE4, size 0x8
    unsigned char m_u8NowPointNo; // offset 0xEC, size 0x1
    signed char m_s8AddPoint; // offset 0xED, size 0x1
    class stcPointData * m_opsPointData; // offset 0xF0, size 0x4
    unsigned char m_u8PointNum; // offset 0xF4, size 0x1
};
...
class clsFZoneEnemy_Task : public clsSingleModelGimmick_Task {
    // total size: 0x9C
};
class Fuid {
    // total size: 0x10
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x9C
public:
    class clsFZoneEnemy_Obj * m_pcObjArray; // offset 0x6C, size 0x4
    class vector m_vecGmkObjArray; // offset 0x70, size 0xC
    class vector m_vecUnusedGmkObjArray; // offset 0x7C, size 0xC
...
// Range: 0x55FAA0 -> 0x55FC24
void draw(class clsFZoneEnemy_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55FAA0 -> 0x55FC24
...
// Range: 0x55FC30 -> 0x55FD60
void execute(class clsFZoneEnemy_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55FC30 -> 0x55FD60
        float & rf32Frame; // r2
...
// Range: 0x55FD60 -> 0x55FDF4
void reset(class clsFZoneEnemy_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55FD60 -> 0x55FDF4
        unsigned int u32Num; // r2
...
// Range: 0x55FE00 -> 0x560034
void draw(class clsFZoneEnemy_Obj * this /* r21 */, class clsModelType_OB_TX_MO & rcModel /* r20 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r16 */, float (* opaNnViewMtx)[4][4] /* r30 */, float (* psMtxWork)[4][4] /* r19 */, unsigned int u32ViewNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x55FE00 -> 0x560034
...
// Range: 0x560040 -> 0x5600BC
void mainCrash(class clsFZoneEnemy_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x560040 -> 0x5600BC
...
// Range: 0x5600C0 -> 0x5605C4
void main(class clsFZoneEnemy_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5600C0 -> 0x5605C4
        class clsFrameControl & rcFrameControl; // r2
    }
}


// Range: 0x5605D0 -> 0x560680
void requestDrawBreakEffect(class clsFZoneEnemy_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5605D0 -> 0x560680
...
// Range: 0x560680 -> 0x560688
void contactTriggerEvent(class clsFZoneEnemy_Obj * this /* r2 */, class hkContactPoint * pcContact /* r2 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x560680 -> 0x560688
    }
...
// Range: 0x560690 -> 0x5607A0
void setVelocityAndFrame(class clsFZoneEnemy_Obj * this /* r16 */, float f32LengthRate /* r20 */, float f32Speed /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x560690 -> 0x5607A0
...
// Range: 0x5607A0 -> 0x560814
void destroyData(class clsFZoneEnemy_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5607A0 -> 0x560814
    }
...
// Range: 0x560820 -> 0x560D3C
void createData(class clsFZoneEnemy_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x560820 -> 0x560D3C
        ...
        char __FUNCTION__[14]; // @ 0x00697E98
    }
}


// Range: 0x560D40 -> 0x560E7C
void setData(class clsFZoneEnemy_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x560D40 -> 0x560E7C
...
// Range: 0x560E80 -> 0x560F6C
void reset(class clsFZoneEnemy_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x560E80 -> 0x560F6C
...
// Range: 0x560F70 -> 0x560FD4
void init(class clsFZoneEnemy_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x560F70 -> 0x560FD4
    }
