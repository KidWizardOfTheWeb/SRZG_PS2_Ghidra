/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Mission\MissionTarget.cpp
...
// Range: 0x386580 -> 0x386590
unsigned char getBroken(class clsMissionTarget * this /* r2 */, unsigned int u32No /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x386580 -> 0x386590
    }
...
// Range: 0x386590 -> 0x3865D0
unsigned int getBrokenNum(class clsMissionTarget * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x386590 -> 0x3865D0
        unsigned int u32i; // r6
        unsigned int u32BrokenCount; // r2
    }
}


// Range: 0x3865D0 -> 0x3865FC
void BrokenReset(class clsMissionTarget * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3865D0 -> 0x3865FC
    }
...
// Range: 0x386600 -> 0x386610
void setBroken(class clsMissionTarget * this /* r2 */, unsigned int u32No /* r2 */, unsigned char u8Flag /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x386600 -> 0x386610
    }
...
// Range: 0x386610 -> 0x38665C
void initBrokenNum(class clsMissionTarget * this /* r16 */, unsigned int u32ObjectNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x386610 -> 0x38665C
    }
...
// Range: 0x386660 -> 0x386684
void setSearchPoint(class clsMissionTarget_Obj * this /* r4 */, class NNS_VECTORFAST * psPos /* r2 */, class NNS_VECTORFAST * psDir /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x386660 -> 0x386684
    }
