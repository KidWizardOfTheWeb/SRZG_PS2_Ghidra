/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage04\St04AutoRunCanoe.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x684968
class NNS_VECTORFAST m_sPlayerOffsetFast; // size: 0x10, address: 0x684970
unsigned int otau32Se_CanoeL[2]; // size: 0x8, address: 0x684980
unsigned int otau32Se_CanoeBreak[2]; // size: 0x8, address: 0x684988
unsigned int otau32Se_WaterStraight[2]; // size: 0x8, address: 0x684990
class NNS_VECTORFAST sOffsetVecFast; // size: 0x10, address: 0x635FF0
struct /* @anon12 */ {
    // total size: 0x48
} __vt__20clsAutoRunCanoe_Task; // size: 0x48, address: 0x6C2910
struct /* @anon0 */ {
    // total size: 0x48
} __vt__93clsSingleModelGimmick_Task<20clsAutoRunCanoe_Task,19clsAutoRunCanoe_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C29C0
struct /* @anon6 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsAutoRunCanoe_Task * m_tpcSingleton; // size: 0x4, address: 0xB16DB0
struct /* @anon7 */ {
    // total size: 0xC
} __vt__36clsSingleton<20clsAutoRunCanoe_Task>; // size: 0xC, address: 0x6C2958
void * __dt(class clsAutoRunCanoe_Obj *, signed short); // size: 0x0, address: 0x3F9DA0
struct /* @anon15 */ {
    // total size: 0x48
} __vt__85clsBaseGimmickBody<20clsAutoRunCanoe_Task,19clsAutoRunCanoe_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C2970
struct /* @anon13 */ {
    // total size: 0x28
...
struct /* @anon8 */ {
    // total size: 0x58
} __vt__19clsAutoRunCanoe_Obj; // size: 0x58, address: 0x6C2A10
...
void * __ct(class clsAutoRunCanoe_Obj *); // size: 0x0, address: 0x3FAEB0
...
void * __dt(class clsAutoRunCanoe *, signed short); // size: 0x0, address: 0x3FD370
void * __ct(class clsAutoRunCanoe *); // size: 0x0, address: 0x3FD430
...
struct /* @anon5 */ {
    // total size: 0x30
} __vt__35clsMiniWaveGmkAutoRunObjEffect_Task; // size: 0x30, address: 0x6C2740
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x684A20
struct /* @anon17 */ {
    // total size: 0x30
} __vt__22clsMiniWaveEffect_Task; // size: 0x30, address: 0x6C1AD0
struct /* @anon10 */ {
    // total size: 0xC
...
struct /* @anon2 */ {
    // total size: 0x10
} __vt__15clsAutoRunCanoe; // size: 0x10, address: 0x6C2A70
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x684A10
...
class clsGimmickAutoRunBuffer : public clsGimmickAutoRunBufferBase {
    // total size: 0x1C
public:
    class clsAutoRunCanoe * m_apcObj; // offset 0xC, size 0x4
    class clsAutoRunCanoe * * m_ppcExecute; // offset 0x10, size 0x4
    class clsAutoRunCanoe * * m_ppcSleep; // offset 0x14, size 0x4
    class clsAutoRunCanoe * * m_ppcExecuteWork; // offset 0x18, size 0x4
};
...
public:
    ...
    class clsAutoRunCanoe_Obj * m_pcAutoRunCanoeObj; // offset 0x1C8, size 0x4
    class NNS_VECTORFAST m_sOffsetPosVedFast; // offset 0x1D0, size 0x10
    float m_f32Level; // offset 0x1E0, size 0x4
    float m_f32MoveLRAdd; // offset 0x1E4, size 0x4
    unsigned int m_u32WaitCount; // offset 0x1E8, size 0x4
    class clsMiniWaveGmkAutoRunObjEffect_Task * pcMiniWaveEffect; // offset 0x1EC, size 0x4
    float m_f32WaterDropFrame; // offset 0x1F0, size 0x4
    class clsSe3DControl * m_pcSe3DControl; // offset 0x1F4, size 0x4
    class clsPlaySe_2D * m_pcPlaySe2D; // offset 0x1F8, size 0x4
};
class NNS_NODE {
    // total size: 0x90
public:
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsAutoRunCanoe_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
public:
    ...
    class hkShape * m_pcPhantomShape; // offset 0x64, size 0x4
    float m_f32MaxSpeed; // offset 0x68, size 0x4
    float m_f32MinSpeed; // offset 0x6C, size 0x4
    class NNS_VECTORFAST m_sDirPosVecFast; // offset 0x70, size 0x10
    unsigned int m_u32PlayerFlg; // offset 0x80, size 0x4
    enum enmControlMode m_aeControlMode[8]; // offset 0x84, size 0x20
    class clsGimmickAutoRunBuffer m_cAutoRunCanoeBuffer; // offset 0xA4, size 0x1C
};
class clsCamIvBase {
    // total size: 0x4
};
...
class clsMiniWaveEffect_Task : public clsTask {
    // total size: 0xD00
public:
    class NNS_PRIM3D_PCT m_asPrim3D_PCT[40]; // offset 0x54, size 0x3C0
    class NNS_PRIM3D_PCT m_asPrim3D_L_PCT[40]; // offset 0x414, size 0x3C0
    class NNS_PRIM3D_PCT m_asPrim3D_R_PCT[40]; // offset 0x7D4, size 0x3C0
    float m_sVelocityMtxPtr[4][4]; // offset 0xBA0, size 0x40
    float m_sPosturalMtxPtr[4][4]; // offset 0xBE0, size 0x40
    class NNS_VECTORFAST m_sPosVecFast; // offset 0xC20, size 0x10
    class NNS_VECTORFAST m_asEffectLocalVecFast[2]; // offset 0xC30, size 0x20
    class NNS_VECTORFAST m_asEffectPosVecFast[5]; // offset 0xC50, size 0x50
    float m_f32AnmStart; // offset 0xCA0, size 0x4
    float m_f32Distance; // offset 0xCA4, size 0x4
    float m_f32Speed; // offset 0xCA8, size 0x4
    float m_f32Curve; // offset 0xCAC, size 0x4
    signed char m_s8Cnt; // offset 0xCB0, size 0x1
    signed char m_s8BackCnt; // offset 0xCB1, size 0x1
    unsigned char m_u8GetData; // offset 0xCB2, size 0x1
    unsigned char m_u8TexType; // offset 0xCB3, size 0x1
    unsigned char m_eMiniWaveAttr; // offset 0xCB4, size 0x1
    unsigned int m_u32DataNo; // offset 0xCB8, size 0x4
    unsigned int m_u32ViewNo; // offset 0xCBC, size 0x4
    unsigned char m_u8PlayerNo; // offset 0xCC0, size 0x1
    unsigned char m_u8EffectNo; // offset 0xCC1, size 0x1
    class clsPlayerTask * m_pcPlayer; // offset 0xCC4, size 0x4
    class clsPlaySe_2D * m_cPlaySe2d[2]; // offset 0xCC8, size 0x8
    class stcMiniWaveParam sMiniWaveParam; // offset 0xCD0, size 0x24
};
...
class clsAutoRunCanoe_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
class GskFlags {
    // total size: 0x4
...
class stcMiniWaveParam {
    // total size: 0x24
public:
    float f32UVSpeed; // offset 0x0, size 0x4
    float f32StartWidth; // offset 0x4, size 0x4
    float f32EndWidth; // offset 0x8, size 0x4
    float f32MaxWidth; // offset 0xC, size 0x4
    float f32BackLength; // offset 0x10, size 0x4
    float f32ReviseValIn; // offset 0x14, size 0x4
    float f32ReviseValOut; // offset 0x18, size 0x4
    float f32CurveMax; // offset 0x1C, size 0x4
    float f32InclinationAngle; // offset 0x20, size 0x4
};
enum enmFlag {
    FLAG_CLEAR = 0,
...
class clsMiniWaveGmkAutoRunObjEffect_Task : public clsMiniWaveEffect_Task {
    // total size: 0xD20
public:
    class NNS_VECTORFAST m_sWaveOffsetVec; // offset 0xD00, size 0x10
    class clsGimmickAutoRunObj * m_pAutoRunObj; // offset 0xD10, size 0x4
    unsigned char m_bDelete; // offset 0xD14, size 0x1
};
class stcDebugGrind {
    // total size: 0x10
public:
...
// Range: 0x3F9EC0 -> 0x3FA054
void reset(class clsAutoRunCanoe_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3F9EC0 -> 0x3FA054
...
// Range: 0x3FA060 -> 0x3FA2CC
void draw(class clsAutoRunCanoe_Task * this /* r30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3FA060 -> 0x3FA2CC
...
// Range: 0x3FA2D0 -> 0x3FA520
void draw(class clsAutoRunCanoe * this /* r19 */, class clsModelType_OB_TX & rcModel /* r18 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r22 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int NodeStatus /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3FA2D0 -> 0x3FA520
    }
...
// Range: 0x3FA530 -> 0x3FA664
void execute(class clsAutoRunCanoe_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3FA530 -> 0x3FA664
        unsigned int u32Num; // r2
...
// Range: 0x3FA670 -> 0x3FAACC
void controlPlayer(class clsAutoRunCanoe_Obj * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3FA670 -> 0x3FAACC
        ...
        unsigned int u32Num; // r23
        class clsAutoRunCanoe * pcAutoRunCanoe; // r17
        float f32Length; // r29+0xB0
        class clsGimmickAutoRunBuffer & rcAutoRunCanoeBuffer; // r16
    }
}


// Range: 0x3FAAF0 -> 0x3FAB5C
void * __ct(class clsAutoRunCanoe_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3FAAF0 -> 0x3FAB5C
    }
...
// Range: 0x3FAFD0 -> 0x3FB1A0
void contactTriggerEvent(class clsAutoRunCanoe_Obj * this /* r19 */, class clsObject * pcObject /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3FAFD0 -> 0x3FB1A0
...
// Range: 0x3FB1A0 -> 0x3FB214
void destroyData(class clsAutoRunCanoe_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3FB1A0 -> 0x3FB214
    }
...
// Range: 0x3FB220 -> 0x3FB39C
void createData(class clsAutoRunCanoe_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3FB220 -> 0x3FB39C
...
// Range: 0x3FB3A0 -> 0x3FB4EC
void init(class clsAutoRunCanoe_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3FB3A0 -> 0x3FB4EC
    }
...
// Range: 0x3FBAA0 -> 0x3FD350
void movePlayer(class clsAutoRunCanoe * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3FBAA0 -> 0x3FD350
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        class clsPlayerTask * pcPlayerTask; // r16
        class clsGimmickPath & rcGimmickPath; // r20
        class clsGimmickPath & rcGimmickPath; // r18
        float f32Speed; // r1
        class clsGimmickPath & rcGimmickPath; // r2
        class NNS_VECTORFAST sVec; // r29+0x290
        class NNS_VECTORFAST sJumpVec12; // r29+0x280
        class NNS_VECTORFAST sJumpVec; // r29+0x270
        float f32Rad; // r29+0x2A0
        class clsGimmickPath & rcGimmickPath; // r2
        class NNS_QUATERNION sQuat; // r29+0x260
        class clsGimmickPath & rcGimmickPath; // r2
        class clsGimmickPath & rcGimmickPath; // r2
        class clsGimmickPath & rcGimmickPath; // r2
    }
...
// Range: 0x3FD6A0 -> 0x3FD6A8
void @80@__dt__19clsAutoRunCanoe_ObjFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3FD6A0 -> 0x3FD6A8
    }
...
// Range: 0x3FD6B0 -> 0x3FD6B8
void @104@__dt__93clsSingleModelGimmick_Task<20clsAutoRunCanoe_Task,19clsAutoRunCanoe_Obj,18clsModelType_OB_TX>Fv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3FD6B0 -> 0x3FD6B8
    }
...
// Range: 0x3FD6C0 -> 0x3FD6C8
void @104@__dt__85clsBaseGimmickBody<20clsAutoRunCanoe_Task,19clsAutoRunCanoe_Obj,18clsModelType_OB_TX>Fv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3FD6C0 -> 0x3FD6C8
    }
...
// Range: 0x3FD6D0 -> 0x3FD6D8
void @104@__dt__20clsAutoRunCanoe_TaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3FD6D0 -> 0x3FD6D8
    }
