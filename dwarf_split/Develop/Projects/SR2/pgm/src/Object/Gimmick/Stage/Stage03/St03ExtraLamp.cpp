/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage03\St03ExtraLamp.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x67F780
class _stcColorParam m_tosColorParam[5]; // size: 0x28, address: 0x67F790
struct /* @anon8 */ {
    // total size: 0x48
} __vt__17clsExtraLamp_Task; // size: 0x48, address: 0x6C0090
struct /* @anon2 */ {
    // total size: 0x48
} __vt__87clsSingleModelGimmick_Task<17clsExtraLamp_Task,16clsExtraLamp_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C0170
struct /* @anon3 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsExtraLamp_Task * m_tpcSingleton; // size: 0x4, address: 0xB15EC8
struct /* @anon9 */ {
    // total size: 0xC
} __vt__33clsSingleton<17clsExtraLamp_Task>; // size: 0xC, address: 0x6C0110
void * __dt(class clsExtraLamp_Obj *, signed short); // size: 0x0, address: 0x394C30
struct /* @anon11 */ {
    // total size: 0x48
} __vt__79clsBaseGimmickBody<17clsExtraLamp_Task,16clsExtraLamp_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C0120
struct /* @anon6 */ {
    // total size: 0x28
...
struct /* @anon5 */ {
    // total size: 0x44
} __vt__16clsExtraLamp_Obj; // size: 0x44, address: 0x6C01C0
...
struct /* @anon1 */ {
    // total size: 0x30
} __vt__21clsExtraLampDraw_Task; // size: 0x30, address: 0x6C00E0
struct /* @anon7 */ {
    // total size: 0x30
} __vt__7clsTask; // size: 0x30, address: 0x6B59F0
class clsPfCri * m_tpcSingleton; // size: 0x4, address: 0x6E6998
void * __ct(class clsExtraLamp_Obj *); // size: 0x0, address: 0x395A90
...
class clsExtraLamp_Task : public clsSingleModelGimmick_Task {
    // total size: 0xB4
public:
    enum enmState m_eState; // offset 0x94, size 0x4
    unsigned int m_u32ColorParamNo; // offset 0x98, size 0x4
    float m_f32MotionFrame; // offset 0x9C, size 0x4
    unsigned short * m_pTexIdxLamp; // offset 0xA0, size 0x4
    unsigned short m_pOldTexIdxLamp; // offset 0xA4, size 0x2
    float * m_pf32TexCoordU; // offset 0xA8, size 0x4
    class clsPress_Obj * m_pcPressObj; // offset 0xAC, size 0x4
    signed int m_s32SeId; // offset 0xB0, size 0x4
};
...
class clsExtraLamp_Obj : public clsGimmickObj {
    // total size: 0x60
public:
    enum enmExtraLampMode m_eExtraLampMode; // offset 0x50, size 0x4
    enum enmExtraLampState m_eExtraLampState; // offset 0x54, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsExtraLamp_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class _stcColorParam {
    // total size: 0x8
public:
    unsigned int u32TexId; // offset 0x0, size 0x4
...
// Range: 0x394CC0 -> 0x394E24
void draw() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x394CC0 -> 0x394E24
        class clsExtraLamp_Task * pcTask; // r2
...
// Range: 0x394E30 -> 0x395014
void draw(class clsExtraLamp_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x394E30 -> 0x395014
        unsigned int u32Num; // r2
...
// Range: 0x395020 -> 0x3952D4
void execute(class clsExtraLamp_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x395020 -> 0x3952D4
    }
...
// Range: 0x3952E0 -> 0x3953A0
void start(class clsExtraLamp_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3952E0 -> 0x3953A0
        unsigned int u32Num; // r2
...
// Range: 0x3953B0 -> 0x39541C
void setLampColor(class clsExtraLamp_Task * this /* r2 */, unsigned int u32ParamNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3953B0 -> 0x39541C
        class _stcColorParam * psParam; // r2
    }
}


// Range: 0x395460 -> 0x395538
void stop(class clsExtraLamp_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x395460 -> 0x395538
        unsigned int u32Num; // r2
...
// Range: 0x395560 -> 0x395648
void reset(class clsExtraLamp_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x395560 -> 0x395648
    }
...
// Range: 0x395650 -> 0x395738
void * __ct(class clsExtraLamp_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x395650 -> 0x395738
    }
...
// Range: 0x395B60 -> 0x395DE8
void draw(class clsExtraLamp_Obj * this /* r19 */, class clsModelType_OB_TX & rcModel /* r18 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r20 */, float (* opaNnViewMtx)[4][4] /* r22 */, float (* psMtxWork)[4][4] /* r17 */, unsigned int u32ViewNo /* r20 */, unsigned int NodeFlg /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x395B60 -> 0x395DE8
