/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage07\St07MapPartsFloorGLink.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTOR tosCollisionHalfSizeVec; // size: 0xC, address: 0x6926E0
float tof32ClipSqDist; // size: 0x4, address: 0x6926F0
class clsGravityGimmickParam t_ocGravityGimmickParam; // size: 0x78, address: 0x692700
struct /* @anon0 */ {
    // total size: 0x48
} __vt__26clsMapPartsFloorGLink_Task; // size: 0x48, address: 0x6CB580
struct /* @anon7 */ {
    // total size: 0x48
} __vt__108clsSingleModelGimmick_Task<26clsMapPartsFloorGLink_Task,28clsMapPartsFloorGLink_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CB6F0
struct /* @anon5 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsMapPartsFloorGLink_Task * m_tpcSingleton; // size: 0x4, address: 0xBFA710
struct /* @anon12 */ {
    // total size: 0xC
} __vt__42clsSingleton<26clsMapPartsFloorGLink_Task>; // size: 0xC, address: 0x6CB688
void * __dt(class clsMapPartsFloorGLink_Object *, signed short); // size: 0x0, address: 0x4F54E0
struct /* @anon21 */ {
    // total size: 0x48
} __vt__100clsBaseGimmickBody<26clsMapPartsFloorGLink_Task,28clsMapPartsFloorGLink_Object,18clsModelType_OB_TX>; // size: 0x48, address: 0x6CB6A0
struct /* @anon13 */ {
    // total size: 0xB4
} __vt__24clsBaseGravityLinkObject; // size: 0xB4, address: 0x6C1420
struct /* @anon14 */ {
    // total size: 0xB8
} __vt__28clsMapPartsFloorGLink_Object; // size: 0xB8, address: 0x6CB5D0
struct /* @anon11 */ {
    // total size: 0x28
...
void * __ct(class clsMapPartsFloorGLink_Object *); // size: 0x0, address: 0x4F5DA0
...
class clsMapPartsFloorGLink_Task : public clsSingleModelGimmick_Task {
    // total size: 0x98
public:
...
class clsMapPartsFloorGLink_Object : public clsBaseGravityLinkObject {
    // total size: 0x170
public:
    class stcInfo m_sColInfo; // offset 0xE0, size 0x10
    unsigned char m_StateChangeFlag; // offset 0xF0, size 0x1
    float m_sEffectMtx[4][4]; // offset 0x100, size 0x40
    float m_f32EffectCount; // offset 0x140, size 0x4
    class NNS_VECTORFAST m_sPosVec; // offset 0x150, size 0x10
    class clsSe3DControl * m_pcSe3DControl; // offset 0x160, size 0x4
    float m_f32SeDelayFrame; // offset 0x164, size 0x4
};
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsMapPartsFloorGLink_Object * m_pcObjArray; // offset 0x6C, size 0x4
...
// Range: 0x4F5580 -> 0x4F573C
void draw(class clsMapPartsFloorGLink_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F5580 -> 0x4F573C
...
// Range: 0x4F5740 -> 0x4F58F4
void execute(class clsMapPartsFloorGLink_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F5740 -> 0x4F58F4
        unsigned int u32Num; // r2
...
// Range: 0x4F5900 -> 0x4F5970
void reset(class clsMapPartsFloorGLink_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F5900 -> 0x4F5970
        unsigned int u32Num; // r2
...
// Range: 0x4F5970 -> 0x4F5A40
void * __ct(class clsMapPartsFloorGLink_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F5970 -> 0x4F5A40
...
// Range: 0x4F5E20 -> 0x4F5EA0
void destroyData(class clsMapPartsFloorGLink_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F5E20 -> 0x4F5EA0
    }
...
// Range: 0x4F5EA0 -> 0x4F6310
void createData(class clsMapPartsFloorGLink_Object * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F5EA0 -> 0x4F6310
...
// Range: 0x4F6310 -> 0x4F6344
void setData(class clsMapPartsFloorGLink_Object * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F6310 -> 0x4F6344
    }
...
// Range: 0x4F6350 -> 0x4F6528
void requestDrawContactEffect(class clsMapPartsFloorGLink_Object * this /* r16 */, class hkContactPoint * pcContact /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F6350 -> 0x4F6528
        class NNS_VECTORFAST sContactVecFast; // r29+0x80
        class NNS_VECTOR sContactVec; // r29+0xA0
        float sMtx[4][4]; // r29+0x40
        class NNS_VECTOR sVelo; // r29+0x90
        class NNS_VECTOR LOCAL_POS_R; // @ 0x006927F0
        class NNS_VECTOR LOCAL_POS; // @ 0x006927E0
        class NNS_VECTOR RAND_SP; // @ 0x006927D0
        float LIFE_FRAME; // @ 0x00692800
        class NNS_VECTOR BEGIN_SP; // @ 0x006927C0
    }
}


// Range: 0x4F6530 -> 0x4F6648
void drawEffect(class clsPlayerTask * pcPlayer /* r16 */) {
    ...
    /* anonymous block */ {
        ...
        class NNS_VECTOR LOCAL_POS_R; // @ 0x006927A8
        class NNS_VECTOR LOCAL_POS; // @ 0x00692798
        class NNS_VECTOR RAND_SP; // @ 0x00692788
        float LIFE_FRAME; // @ 0x006927B8
        class NNS_VECTOR BEGIN_SP; // @ 0x00692778
    }
}


// Range: 0x4F6650 -> 0x4F66F0
void callbackGravityEvent(class clsMapPartsFloorGLink_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F6650 -> 0x4F66F0
    }
...
// Range: 0x4F66F0 -> 0x4F672C
void requestDrawBreakEffect(class clsMapPartsFloorGLink_Object * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F66F0 -> 0x4F672C
    }
...
// Range: 0x4F6740 -> 0x4F6874
void reset(class clsMapPartsFloorGLink_Object * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F6740 -> 0x4F6874
...
// Range: 0x4F6880 -> 0x4F6AEC
void draw(class clsMapPartsFloorGLink_Object * this /* r17 */, class NNS_OBJECT * psObject /* r16 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r20 */, float (* psMtxWork)[4][4] /* r19 */, unsigned int u32ViewNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4F6880 -> 0x4F6AEC
    }
