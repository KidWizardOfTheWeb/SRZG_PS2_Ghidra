/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Stage\Stage03\St03PathRobo.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float CLIP_DISTx2; // size: 0x4, address: 0x681408
struct /* @anon1 */ {
    // total size: 0x48
} __vt__16clsPathRobo_Task; // size: 0x48, address: 0x6C1260
struct /* @anon7 */ {
    // total size: 0x48
} __vt__85clsSingleModelGimmick_Task<16clsPathRobo_Task,15clsPathRobo_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C1310
struct /* @anon16 */ {
    // total size: 0x38
} __vt__18clsBaseGimmickHead; // size: 0x38, address: 0x6BB5E0
class clsPathRobo_Task * m_tpcSingleton; // size: 0x4, address: 0xB16328
struct /* @anon18 */ {
    // total size: 0xC
} __vt__32clsSingleton<16clsPathRobo_Task>; // size: 0xC, address: 0x6C12A8
void * __dt(class clsPathRobo_Obj *, signed short); // size: 0x0, address: 0x3B62E0
struct /* @anon4 */ {
    // total size: 0x48
} __vt__77clsBaseGimmickBody<16clsPathRobo_Task,15clsPathRobo_Obj,18clsModelType_OB_TX>; // size: 0x48, address: 0x6C12C0
struct /* @anon17 */ {
    // total size: 0xB0
} __vt__21clsPathGravityObj_Obj; // size: 0xB0, address: 0x6C22E0
struct /* @anon0 */ {
    // total size: 0xB4
} __vt__15clsPathRobo_Obj; // size: 0xB4, address: 0x6C1360
struct /* @anon11 */ {
    // total size: 0x28
...
void * __ct(class clsPathRobo_Obj *); // size: 0x0, address: 0x3B7430
...
class clsBaseGimmickBody : public clsBaseGimmickHead, public clsSingleton {
    // total size: 0x94
public:
    class clsPathRobo_Obj * m_pcObjArray; // offset 0x6C, size 0x4
...
class clsPathRobo_Task : public clsSingleModelGimmick_Task {
    // total size: 0x94
};
enum enmRestartMode {
    RESTART_NORMAL = 0,
...
// Range: 0x3B63B0 -> 0x3B6584
void draw(class clsPathRobo_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B63B0 -> 0x3B6584
...
// Range: 0x3B6590 -> 0x3B6698
void execute(class clsPathRobo_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B6590 -> 0x3B6698
        unsigned int u32Num; // r2
...
// Range: 0x3B66A0 -> 0x3B6700
void reset(class clsPathRobo_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B66A0 -> 0x3B6700
        unsigned int u32Num; // r2
...
// Range: 0x3B6700 -> 0x3B67B8
void * __ct(class clsPathRobo_Task * this /* r16 */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B6700 -> 0x3B67B8
...
// Range: 0x3B6B10 -> 0x3B6E10
void draw(class clsPathRobo_Obj * this /* r20 */, class clsModelType_OB_TX & rcObj /* r19 */, float (* psMtxPal)[4][4] /* r21 */, unsigned int * psNodeStat /* r19 */, float (* opaNnViewMtx)[4][4] /* r18 */, float (* psMtxWork)[4][4] /* r17 */, unsigned int u32ViewNo /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B6B10 -> 0x3B6E10
        float f32Length; // r29+0xEC
        class NNS_OBJECT * psObject; // r16
    }
}


// Range: 0x3B6E10 -> 0x3B6E44
void requestDrawBreakEffect(class clsPathRobo_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B6E10 -> 0x3B6E44
    }
...
// Range: 0x3B6E50 -> 0x3B6EB0
void destroyData(class clsPathRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B6E50 -> 0x3B6EB0
    }
...
// Range: 0x3B6EB0 -> 0x3B7224
void createData(class clsPathRobo_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B6EB0 -> 0x3B7224
...
// Range: 0x3B7230 -> 0x3B742C
void reset(class clsPathRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B7230 -> 0x3B742C
...
// Range: 0x3B7430 -> 0x3B74A8
void * __ct(class clsPathRobo_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3B7430 -> 0x3B74A8
    }
