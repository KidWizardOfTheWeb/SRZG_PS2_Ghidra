/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\RailWay.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float m_tof32CLIP_DISTx2; // size: 0x4, address: 0x6989C8
...
// Range: 0x568F00 -> 0x5690C4
void draw(class clsRailWayEnd_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x568F00 -> 0x5690C4
        ...
        class clsGmkBurnLight_Task * pcBrunLightTask; // r2
        unsigned int u32i; // r18
    }
}


// Range: 0x5690D0 -> 0x569168
void execute(class clsRailWayEnd_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5690D0 -> 0x569168
        unsigned int u32Num; // r2
...
// Range: 0x569170 -> 0x569334
void draw(class clsRailWayStart_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x569170 -> 0x569334
        unsigned int u32Num; // r2
...
// Range: 0x569340 -> 0x5693D8
void execute(class clsRailWayStart_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x569340 -> 0x5693D8
        unsigned int u32Num; // r2
...
// Range: 0x5693E0 -> 0x569678
unsigned char draw(class clsRailWay_Obj * this /* r21 */, class clsModelType_OB_TX & rcModel /* r20 */, float (* psMtxPal)[4][4] /* r19 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r17 */, float (* psMtxWork)[4][4] /* r16 */, unsigned int u32ViewNo /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5693E0 -> 0x569678
    }
