/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\SurvivalBall\SurvivalPointRing.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class NNS_VECTOR cosPhantomVector[3]; // size: 0x24, address: 0x6875A0
static class NNS_VECTOR cosRegistRigidUpDownVector[3]; // size: 0x24, address: 0x6875D0
static class NNS_VECTOR cosRegistRigidLeftRightVector[3]; // size: 0x24, address: 0x687600
static class NNS_VECTOR cosRegistRigidUpDownPos[3]; // size: 0x24, address: 0x687630
static class NNS_VECTOR cosRegistRigidLeftRightPos[3]; // size: 0x24, address: 0x687660
static float CLIP_DISTx2; // size: 0x4, address: 0x687688
static signed int scos32SurvivalPointRing[3]; // size: 0xC, address: 0x687690
struct /* @anon0 */ {
    // total size: 0x48
} __vt__29clsSurvivalBallPointRing_Task; // size: 0x48, address: 0x6C48D0
struct /* @anon10 */ {
    // total size: 0x48
} __vt__117clsSingleModelGimmick_Task<29clsSurvivalBallPointRing_Task,28clsSurvivalBallPointRing_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C49C0
struct /* @anon7 */ {
    // total size: 0x38
...
struct /* @anon20 */ {
    // total size: 0xC
} __vt__45clsSingleton<29clsSurvivalBallPointRing_Task>; // size: 0xC, address: 0x6C4958
void * __dt(class clsSurvivalBallPointRing_Obj *, signed short); // size: 0x0, address: 0x43CE60
struct /* @anon3 */ {
    // total size: 0x48
} __vt__109clsBaseGimmickBody<29clsSurvivalBallPointRing_Task,28clsSurvivalBallPointRing_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6C4970
struct /* @anon16 */ {
    // total size: 0xA8
...
struct /* @anon4 */ {
    // total size: 0x34
} __vt__34clsSurvivalBallPointRing_Collision; // size: 0x34, address: 0x6C4920
struct /* @anon14 */ {
    // total size: 0xA8
} __vt__28clsSurvivalBallPointRing_Obj; // size: 0xA8, address: 0x6C4A10
struct /* @anon22 */ {
    // total size: 0x44
...
void * __ct(class clsSurvivalBallPointRing_Obj *); // size: 0x0, address: 0x43EB80
...
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x6876E0
...
class hkSingleShapeContainer : public hkShapeContainer {
    // total size: 0x8
public:
    class hkShape * m_childShape; // offset 0x4, size 0x4
};
class hkPadSpu {
    // total size: 0x4
public:
...
class hkTransformShape : public hkShape {
    // total size: 0x70
public:
    class hkSingleShapeContainer m_childShape; // offset 0x10, size 0x8
    class hkQuaternion m_rotation; // offset 0x20, size 0x10
    class hkTransform m_transform; // offset 0x30, size 0x40
};
class hkAgentEntry {
    // total size: 0x8
public:
...
class hkArray {
    // total size: 0xC
public:
    class hkShape * * m_data; // offset 0x0, size 0x4
    signed int m_size; // offset 0x4, size 0x4
    signed int m_capacityAndFlags; // offset 0x8, size 0x4
};
enum enmMode {
...
// Range: 0x43CFB0 -> 0x43D144
void draw(class clsSurvivalBallPointRing_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43CFB0 -> 0x43D144
        class clsSurvivalBallRace_Task & rcSurvivalBallRace_Task; // r2
        unsigned int u32Num; // r2
        unsigned int * psNodeStat; // r20
        unsigned int u32ViewNo; // r19
        float (* opaNnViewMtx)[4][4]; // r22
        float (* psMtxPal)[4][4]; // r23
        class clsModelType_OB_TX_MO_MA & rcModel; // r18
        float sMtx[4][4]; // r29+0x90
        unsigned int u32i; // r17
    }
}


// Range: 0x43D150 -> 0x43D2B0
void execute(class clsSurvivalBallPointRing_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43D150 -> 0x43D2B0
        unsigned int u32Num; // r2
...
// Range: 0x43D2B0 -> 0x43D320
void reset(class clsSurvivalBallPointRing_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43D2B0 -> 0x43D320
        unsigned int u32Num; // r2
...
// Range: 0x43D320 -> 0x43DC64
void * __ct(class clsSurvivalBallPointRing_Task * this /* r29+0x11C */, unsigned int u32ObjectAreaNum /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43D320 -> 0x43DC64
        class hkVector4 cPhantomVec; // r29+0x2A0
        class hkVector4 cRegistRigidUpVec; // r29+0x290
        class hkVector4 cRegistRigidDownVec; // r29+0x280
        class hkVector4 cRegistRigidLeftVec; // r29+0x270
        class hkVector4 cRegistRigidRightVec; // r29+0x260
        class hkTransform cUpTransform; // r29+0x220
        class hkTransform cDownTransform; // r29+0x1E0
        class hkTransform cLiftTransform; // r29+0x1A0
        class hkTransform cRightTransform; // r29+0x160
        class hkTransformShape * pcUpTransformShape[3]; // r29+0x2E0
        class hkTransformShape * pcDownTransformShape[3]; // r29+0x2D0
        class hkTransformShape * pcLeftTransformShape[3]; // r29+0x2C0
        class hkTransformShape * pcRightTransformShape[3]; // r29+0x2B0
        class hkQuaternion cBoxQuaternion; // r29+0x150
        class hkArray shapeArray[3]; // r29+0x120
        signed int s32i; // r29+0x100
    }
}


// Range: 0x43DFD0 -> 0x43E318
void draw(class clsSurvivalBallPointRing_Obj * this /* r21 */, class clsModelType_OB_TX_MO_MA * pcModel /* r20 */, float (* psMtxPal)[4][4] /* r19 */, unsigned int * psNodeStat /* r18 */, float (* opaNnViewMtx)[4][4] /* r30 */, float (* psMtxWork)[4][4] /* r17 */, unsigned int u32ViewNo /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43DFD0 -> 0x43E318
...
// Range: 0x43E320 -> 0x43E4B4
void main(class clsSurvivalBallPointRing_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43E320 -> 0x43E4B4
        float * pf32Frame; // r2
...
// Range: 0x43E4C0 -> 0x43E4C8
void contactInterraction() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43E4C0 -> 0x43E4C8
    }
...
// Range: 0x43E4D0 -> 0x43E674
void contactInterractionPhantomShape(class clsSurvivalBallPointRing_Obj * this /* r19 */, class clsRigidBodyGimmickObj * pcObject /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43E4D0 -> 0x43E674
        class clsSurvivalBallRace_Task & rcSurvivalBallRace_Task; // r17
        class clsSurvivalBallBall_Obj & rcSurvivalBallBall_Obj; // r2
        float (* psMtxPal)[4][4]; // r16
        class NNS_VECTORFAST sHitObjVecFast; // r29+0x60
        class NNS_VECTORFAST sObjVecFast; // r29+0x50
        class clsPlayerTask * copcPlayer; // r16
    }
}


// Range: 0x43E680 -> 0x43E6CC
void reset(class clsSurvivalBallPointRing_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43E680 -> 0x43E6CC
    }
...
// Range: 0x43E6D0 -> 0x43E738
void init(class clsSurvivalBallPointRing_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43E6D0 -> 0x43E738
    }
...
// Range: 0x43E740 -> 0x43E7C4
void destroyData(class clsSurvivalBallPointRing_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43E740 -> 0x43E7C4
    }
...
// Range: 0x43E7D0 -> 0x43EB74
void createData(class clsSurvivalBallPointRing_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43E7D0 -> 0x43EB74
        class clsSurvivalBallRace_Task & rcSurvivalBallRace_Task; // r2
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0xC0
        class hkMassProperties massProperties; // r29+0x70
        class NNS_VECTOR sPosition; // r29+0x180
        class hkVector4 cOffset; // r29+0x60
    }
}


// Range: 0x43EB80 -> 0x43EC7C
void * __ct(class clsSurvivalBallPointRing_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43EB80 -> 0x43EC7C
    }
...
// Range: 0x43ED10 -> 0x43EE48
void execute(class clsSurvivalBallPointRing_Collision * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x43ED10 -> 0x43EE48
        class hkAllCdBodyPairCollector cCollecter; // r29+0x50
        signed int i; // r17
        class clsGimmickObj * pcGimmickObj; // r2
    }
}
