/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\Common\Turbulence.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned int TURB_RIGID_KEY; // size: 0x4, address: 0x6868B0
unsigned int TURB_PARAM; // size: 0x4, address: 0x0
float CLIP_DISTx2; // size: 0x4, address: 0x6868B8
float CLIP_DISTx2; // size: 0x4, address: 0x6868C0
float tf32StartModelOKMotionFrm; // size: 0x4, address: 0x0
float tf32StartLength; // size: 0x4, address: 0x0
float tf32BodyLength; // size: 0x4, address: 0x0
float tf32EndLength; // size: 0x4, address: 0x0
float tf32AdjustY; // size: 0x4, address: 0x0
float tf32TrickDeg; // size: 0x4, address: 0x6868C8
struct /* @anon10 */ {
    // total size: 0x48
} __vt__18clsTurbulence_Task; // size: 0x48, address: 0x6C34D0
void * __dt(class clsTurbulence_Obj *, signed short); // size: 0x0, address: 0x2D0AD0
struct /* @anon14 */ {
    // total size: 0x48
} __vt__87clsBaseGimmickBody<18clsTurbulence_Task,17clsTurbulence_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6B9DE0
...
struct /* @anon18 */ {
    // total size: 0x58
} __vt__17clsTurbulence_Obj; // size: 0x58, address: 0x6C35D0
struct /* @anon16 */ {
    // total size: 0x28
...
struct /* @anon19 */ {
    // total size: 0x34
} __vt__19clsTurbThroughColli; // size: 0x34, address: 0x6C3630
...
struct /* @anon1 */ {
    // total size: 0x64
} __vt__15hkFastMeshShape; // size: 0x64, address: 0x6B7440
float hkConvexShapeDefaultRadius; // size: 0x4, address: 0x6223B8
float t_of32WeightTypeGround; // size: 0x4, address: 0x665180
...
struct /* @anon7 */ {
    // total size: 0xC
} __vt__34clsSingleton<18clsTurbulence_Task>; // size: 0xC, address: 0x6B9DC8
struct /* @anon22 */ {
    // total size: 0xC
...
struct /* @anon3 */ {
    // total size: 0x48
} __vt__21clsPutTurbulence_Task; // size: 0x48, address: 0x6C3520
void * __dt(class clsPutTurbulence_Obj *, signed short); // size: 0x0, address: 0x2CE160
struct /* @anon5 */ {
    // total size: 0x48
} __vt__93clsBaseGimmickBody<21clsPutTurbulence_Task,20clsPutTurbulence_Obj,24clsModelType_OB_TX_MO_MA>; // size: 0x48, address: 0x6BA460
struct /* @anon9 */ {
    // total size: 0x58
} __vt__20clsPutTurbulence_Obj; // size: 0x58, address: 0x6C3570
struct /* @anon0 */ {
    // total size: 0xC
} __vt__37clsSingleton<21clsPutTurbulence_Task>; // size: 0xC, address: 0x6BA448
...
class hkArray {
    // total size: 0xC
public:
    unsigned short * m_data; // offset 0x0, size 0x4
...
class __wrap_iterator {
    // total size: 0x4
public:
    class clsModelType_OB_TX_MO_MA * it_; // offset 0x0, size 0x4
};
...
class hkMeshShape : public hkShapeCollection {
    // total size: 0x60
public:
    class hkVector4 m_scaling; // offset 0x20, size 0x10
    signed int m_numBitsForSubpartIndex; // offset 0x30, size 0x4
    class hkArray m_subparts; // offset 0x34, size 0xC
    class hkArray m_weldingInfo; // offset 0x40, size 0xC
    class hkEnum m_weldingType; // offset 0x4C, size 0x1
    float m_radius; // offset 0x50, size 0x4
    signed int m_pad[3]; // offset 0x54, size 0xC
};
enum enmGearPrfm {
    PRFM_EMPTY = 0,
    PRFM_D_SONIC = 1,
...
class clsTurbThroughColli : public clsBaseThroughCollision {
    // total size: 0x10
public:
    class clsTurbulence_Obj * m_pcTurbObj; // offset 0x8, size 0x4
    unsigned int m_u32ColIdx; // offset 0xC, size 0x4
};
class PotentialInfo {
    // total size: 0x1008
public:
...
class hkMoppCompilerInput {
    // total size: 0x30
public:
    class hkVector4 m_absoluteFitToleranceOfAxisAlignedTriangles; // offset 0x0, size 0x10
    float m_relativeFitToleranceOfInternalNodes; // offset 0x10, size 0x4
    float m_absoluteFitToleranceOfInternalNodes; // offset 0x14, size 0x4
    float m_absoluteFitToleranceOfTriangles; // offset 0x18, size 0x4
    class hkBool m_useShapeKeys; // offset 0x1C, size 0x1
    class hkBool m_enablePrimitiveSplitting; // offset 0x1D, size 0x1
    class hkBool m_enableChunkSubdivision; // offset 0x1E, size 0x1
    class hkBool m_enableInterleavedBuilding; // offset 0x1F, size 0x1
    class hkBool m_cachePrimitiveExtents; // offset 0x20, size 0x1
    class hkBool m_embedTerminals; // offset 0x21, size 0x1
    unsigned char * m_embeddedMaterialIndices; // offset 0x24, size 0x4
};
...
class Subpart {
    // total size: 0x38
public:
    float * m_vertexBase; // offset 0x0, size 0x4
    signed int m_vertexStriding; // offset 0x4, size 0x4
    signed int m_numVertices; // offset 0x8, size 0x4
    void * m_indexBase; // offset 0xC, size 0x4
    class hkEnum m_stridingType; // offset 0x10, size 0x1
    class hkEnum m_materialIndexStridingType; // offset 0x11, size 0x1
    signed int m_indexStriding; // offset 0x14, size 0x4
    signed int m_flipAlternateTriangles; // offset 0x18, size 0x4
    signed int m_numTriangles; // offset 0x1C, size 0x4
    void * m_materialIndexBase; // offset 0x20, size 0x4
    signed int m_materialIndexStriding; // offset 0x24, size 0x4
    class hkMeshMaterial * m_materialBase; // offset 0x28, size 0x4
    signed int m_materialStriding; // offset 0x2C, size 0x4
    signed int m_numMaterials; // offset 0x30, size 0x4
    signed int m_triangleOffset; // offset 0x34, size 0x4
};
...
class hkShapeCollection : public hkShape, public hkShapeContainer {
    // total size: 0x18
public:
    class hkBool m_disableWelding; // offset 0x14, size 0x1
};
class hkProperty {
    // total size: 0x10
public:
...
class hkMoppCode : public hkReferencedObject {
    // total size: 0x30
public:
    class CodeInfo m_info; // offset 0x10, size 0x10
    class hkArray m_data; // offset 0x20, size 0xC
};
...
class __wrap_iterator {
    // total size: 0x4
public:
    class clsTurbThroughColli * * it_; // offset 0x0, size 0x4
};
...
class CodeInfo {
    // total size: 0x10
public:
    class hkVector4 m_offset; // offset 0x0, size 0x10
};
struct /* @anon8 */ {
    // total size: 0x10
};
...
class __wrap_iterator {
    // total size: 0x4
public:
    class vector * it_; // offset 0x0, size 0x4
};
...
class __wrap_iterator {
    // total size: 0x4
public:
    class clsRigidBody * * it_; // offset 0x0, size 0x4
};
...
class __wrap_iterator {
    // total size: 0x4
public:
    class stcSt04TurbModel * it_; // offset 0x0, size 0x4
};
...
class hkArray {
    // total size: 0xC
public:
    class Subpart * m_data; // offset 0x0, size 0x4
    signed int m_size; // offset 0x4, size 0x4
    signed int m_capacityAndFlags; // offset 0x8, size 0x4
};
struct /* @anon20 */ {
...
// Range: 0x41D180 -> 0x41D1D4
void reset(class clsPutTurbulence_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41D180 -> 0x41D1D4
...
// Range: 0x41D1E0 -> 0x41D250
void reset(class clsPutTurbulence_Obj * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41D1E0 -> 0x41D250
        signed int i; // r5
...
// Range: 0x41D250 -> 0x41D330
void reset(class clsTurbulence_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41D250 -> 0x41D330
        unsigned int u32Num; // r19
    }
}


// Range: 0x41D330 -> 0x41D41C
void draw(class clsPutTurbulence_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41D330 -> 0x41D41C
        class __wrap_iterator it'63; // r16
        class __wrap_iterator it; // r29+0x7C
        unsigned int * psNodeStat; // r19
        float (* psMtxPal)[4][4]; // r18
        float (* opaNnViewMtx)[4][4]; // r17
        unsigned int u32Num; // r21
    }
}


// Range: 0x41D420 -> 0x41D4FC
void execute(class clsPutTurbulence_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41D420 -> 0x41D4FC
        class __wrap_iterator it'62; // r17
        unsigned int u32Num; // r19
        class __wrap_iterator it; // r29+0x5C
        class clsRigidBody * * * ppcRigid; // r18
    }
}


// Range: 0x41D500 -> 0x41DB18
void createModel(class clsPutTurbulence_Task * this /* r17 */, class stcBinInfo & rsBinInfoI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41D500 -> 0x41DB18
        class __wrap_iterator it'304; // r2
        unsigned char * pau8Bin[6]; // r29+0x60
        class __wrap_iterator it; // r29+0x7C
        void * pvTmp; // r2
        class stcBinHeader * psHeader; // r2
        class stcBinBody * psBody; // r2
    }
}


// Range: 0x41DB20 -> 0x41DEB0
void parseColliData(class clsPutTurbulence_Task * this /* r22 */, class stcBinBody * psBody /* r2 */, unsigned int u32Num /* r23 */, unsigned int u32Idx /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41DB20 -> 0x41DEB0
        class stcBinBody * psTmpBody; // r21
        unsigned int u32n; // r20
        class hkMeshShape * pcShape; // r19
        class Subpart cPart; // r29+0x1A0
        class hkMoppCompilerInput mft; // r29+0x170
        class hkMoppCode * code; // r18
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0xB0
    }
}


// Range: 0x41DEB0 -> 0x41DEB8
void destroyData() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41DEB0 -> 0x41DEB8
...
// Range: 0x41DEC0 -> 0x41DED4
void createData(class clsPutTurbulence_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41DEC0 -> 0x41DED4
    }
...
// Range: 0x41DEE0 -> 0x41E598
void draw(class clsPutTurbulence_Obj * this /* r20 */, class stcSt04TurbModel & rcObj /* r19 */, float (* psMtxPal)[4][4] /* r18 */, unsigned int * psNodeStat /* r17 */, float (* opaNnViewMtx)[4][4] /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41DEE0 -> 0x41E598
        float sMtx[4][4]; // r29+0x130
        float sMtxWork[4][4]; // r29+0xF0
        unsigned int u32n; // r21
        class NNS_VECTORFAST sTmpVF; // r29+0xE0
        class NNS_VECTORFAST sTmpVF; // r29+0xD0
    }
}


// Range: 0x41E5A0 -> 0x41E9C0
void execute(class clsPutTurbulence_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41E5A0 -> 0x41E9C0
        class NNS_VECTORFAST sSpeedVF; // r29+0x40
        class NNS_VECTORFAST sTmpVF; // r29+0x30
    }
}


// Range: 0x41E9C0 -> 0x41EAB0
void clearCol(class clsPutTurbulence_Obj * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41E9C0 -> 0x41EAB0
        unsigned int u32Idx; // r17
    }
}


// Range: 0x41EAB0 -> 0x41EC3C
void updateCol(class clsPutTurbulence_Obj * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41EAB0 -> 0x41EC3C
        unsigned int u32Idx; // r16
    }
}


// Range: 0x41EC40 -> 0x41EC4C
void finishTurb(class clsPutTurbulence_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41EC40 -> 0x41EC4C
    }
...
// Range: 0x41EC50 -> 0x41ECA0
void startTurb(class clsPutTurbulence_Obj * this /* r16 */, class NNS_VECTORFAST * psNowPosVF /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41EC50 -> 0x41ECA0
    }
...
// Range: 0x41ECA0 -> 0x41EDBC
void init(class clsPutTurbulence_Obj * this /* r18 */, unsigned int u32Num /* r17 */, class stcSt04TurbModel * psModels /* r2 */, class clsRigidBody * * * ppcRigid /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41ECA0 -> 0x41EDBC
...
// Range: 0x41EDC0 -> 0x41F0F8
void draw(class clsTurbulence_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41EDC0 -> 0x41F0F8
        signed int s32StageNo; // r2
        class clsModelType_OB_TX_MO_MA * pcModel; // r20
        class clsModelType_OB_TX_MO_MA * pcAModel; // r19
...
// Range: 0x41F100 -> 0x41F2E0
void execute(class clsTurbulence_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41F100 -> 0x41F2E0
        class __wrap_iterator it'107; // r22
        class __wrap_iterator it'105; // r2
        unsigned int u32Num; // r20
        unsigned int u32n; // r19
        class __wrap_iterator it; // r29+0xBC
        class clsPfSystem * pcOOSystem; // r2
        class __wrap_iterator it; // r29+0xB8
        unsigned int u32Num; // r16
    }
}


// Range: 0x41F2E0 -> 0x41F9D8
void createModel(class clsTurbulence_Task * this /* r21 */, class stcBinInfo & rsBinInfoI /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41F2E0 -> 0x41F9D8
        class __wrap_iterator it'277; // r22
        class __wrap_iterator ita'276; // r16
        unsigned int u32n; // r23
        unsigned int u32OffNo; // r19
        unsigned int u32ObjIdx; // r29+0xA0
        unsigned int u32CalcObjNum; // r30
        signed int s32StageNo; // r2
        unsigned char * pau8Bin[6]; // r29+0xB0
        signed int s32Num; // r2
        class __wrap_iterator it; // r29+0xDC
        class __wrap_iterator ita; // r29+0xD8
        void * pvTmp; // r2
        class stcBinHeader * psHeader; // r2
    }
}
...
// Range: 0x41F9E0 -> 0x41FD1C
void parseColliData(class clsTurbulence_Task * this /* r22 */, class stcBinBody * psBody /* r2 */, unsigned int u32Num /* r21 */, class clsTurbulence_Obj * pcTurbObj /* r20 */, unsigned int u32Idx /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41F9E0 -> 0x41FD1C
        class stcBinBody * psTmpBody; // r19
        unsigned int u32n; // r23
        class hkMeshShape * pcShape; // r18
        class Subpart cPart; // r29+0xE0
        class hkMoppCompilerInput mft; // r29+0xB0
        class hkMoppCode * code; // r17
        class clsRigidBody * pcRigid; // r29+0x11C
    }
}


// Range: 0x41FD20 -> 0x41FE64
class clsRigidBody * create(class hkShape * pcShape /* r16 */, class stcInfo * psInfo /* r19 */, class stcTurbInfo * psTurbInfo /* r18 */, unsigned char u8IsCreateThrough /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41FD20 -> 0x41FE64
        class hkRigidBodyCinfo cRigidBodyInfo; // r29+0x50
    }
}


// Range: 0x41FE70 -> 0x41FE78
void destroyData() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41FE70 -> 0x41FE78
...
// Range: 0x41FE80 -> 0x41FEA4
void createData(class clsTurbulence_Obj * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41FE80 -> 0x41FEA4
    }
...
// Range: 0x41FEB0 -> 0x420598
void draw(class clsTurbulence_Obj * this /* r21 */, class clsModelType_OB_TX_MO_MA & rcObj /* r20 */, class clsModelType_OB_TX_MO_MA & rcAObj /* r23 */, float (* psMtxPal)[4][4] /* r30 */, unsigned int * psNodeStat /* r22 */, float (* opaNnViewMtx)[4][4] /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41FEB0 -> 0x420598
        class __wrap_iterator it'259; // r2
        float sMtx[4][4]; // r29+0x120
        class tagMatAlphaTmp sOldAlpha; // r29+0xF0
        unsigned int u32a; // r19
        class __wrap_iterator it; // r29+0x16C
    }
}


// Range: 0x4205A0 -> 0x420968
void execute(class clsTurbulence_Obj * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4205A0 -> 0x420968
        unsigned int u32n; // r16
        unsigned int u32AlphaCnt; // r18
        float tf32Speed; // @ 0x00636428
    }
}


// Range: 0x420970 -> 0x420B50
void addTurbThroughColli(class clsTurbulence_Obj * this /* r18 */, class clsRigidBody * pcRigid /* r2 */, unsigned int u32Index /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x420970 -> 0x420B50
        class hkAabb cAabb; // r29+0x90
        class NNS_VECTORFAST sMinVF; // r29+0x80
        class NNS_VECTORFAST sMaxVF; // r29+0x70
        class NNS_VECTORFAST sTmpVF; // r29+0x60
        class clsTurbThroughColli * pcTurbThroughColli; // r29+0xBC
        class NNS_QUATERNION sTmpQ; // r29+0x50
        class hkVector4 cHelfBoxSize; // r29+0x40
    }
}


// Range: 0x420B50 -> 0x420C7C
void trigThroughTurb(class clsTurbulence_Obj * this /* r16 */, class clsPlayerTask * pcPlayer /* r2 */, unsigned int u32ColIdx /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x420B50 -> 0x420C7C
    }
...
// Range: 0x420C80 -> 0x420F00
void init(class clsTurbulence_Obj * this /* r17 */, unsigned int u32Num /* r16 */, class clsModelType_OB_TX_MO_MA * pcModel /* r19 */, class vector * pvecpcRigid /* r2 */, class vector * pvecpcWallRigid /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x420C80 -> 0x420F00
        class __wrap_iterator it'147; // r2
        class __wrap_iterator it'146; // r2
        unsigned int u32n; // r18
        class __wrap_iterator it; // r29+0x6C
        class __wrap_iterator it; // r29+0x68
        class NNS_SUBOBJ * pSubObj; // r2
        class NNS_MESHSET * psMeshSet; // r6
        class NNS_MATERIALPTR * pMatPtr; // r2
    }
}


// Range: 0x420F00 -> 0x420F64
void contactAlwaysEvent(class clsTurbThroughColli * this /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x420F00 -> 0x420F64
    }
...
// Range: 0x420F70 -> 0x420FCC
void contactRemoveEvent(class clsTurbThroughColli * this /* r2 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x420F70 -> 0x420FCC
    }
...
// Range: 0x420FD0 -> 0x420FDC
void contactTriggerEvent(class clsTurbThroughColli * this /* r4 */, class clsPlayerTask * pcPlayer /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x420FD0 -> 0x420FDC
    }
...
// Range: 0x4211A0 -> 0x421234
void resize(class __vector_imp * this /* r2 */, unsigned int sz /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4211A0 -> 0x421234
    }
...
// Range: 0x422920 -> 0x422968
class __vector_pod & __as(class __vector_pod * this /* r16 */, class __vector_pod & x /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x422920 -> 0x422968
    }
...
// Range: 0x422D40 -> 0x422D48
void @80@__dt__17clsTurbulence_ObjFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x422D40 -> 0x422D48
    }
...
// Range: 0x422D50 -> 0x422D58
void @80@__dt__20clsPutTurbulence_ObjFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x422D50 -> 0x422D58
    }
...
// Range: 0x422D60 -> 0x422D68
void @104@__dt__21clsPutTurbulence_TaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x422D60 -> 0x422D68
    }
...
// Range: 0x422D70 -> 0x422D78
void @104@__dt__18clsTurbulence_TaskFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x422D70 -> 0x422D78
    }
