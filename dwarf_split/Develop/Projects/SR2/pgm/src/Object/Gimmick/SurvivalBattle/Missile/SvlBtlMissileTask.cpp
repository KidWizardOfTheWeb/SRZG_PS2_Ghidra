/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Object\Gimmick\SurvivalBattle\Missile\SvlBtlMissileTask.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class NNS_VECTORFAST m_OffsetPosVecFastTable[4]; // size: 0x40, address: 0x6968E0
float tof32LockOnDorPro; // size: 0x4, address: 0x0
float tof32LockOnRangeSq; // size: 0x4, address: 0x0
float tofShootIntervalFrame; // size: 0x4, address: 0x0
class stcTask sTask; // size: 0x30, address: 0xB0A900
struct /* @anon1 */ {
    // total size: 0x34
} __vt__22clsLockOnTarget2D_Task; // size: 0x34, address: 0x6CE8A0
struct /* @anon2 */ {
    // total size: 0x34
} __vt__18clsBaseLockOn_Task; // size: 0x34, address: 0x6CE8E0
struct /* @anon4 */ {
    // total size: 0x30
} __vt__7clsTask; // size: 0x30, address: 0x6B59F0
class NNS_VECTORFAST tosZVecFast; // size: 0x10, address: 0x696940
...
struct /* @anon0 */ {
    // total size: 0x34
} __vt__21clsLockOnFixed3D_Task; // size: 0x34, address: 0x6CE860
struct /* @anon3 */ {
    // total size: 0x34
} __vt__23clsLockOnAppoint3D_Task; // size: 0x34, address: 0x6CE820
struct /* @anon5 */ {
    // total size: 0x2C
...
// Range: 0x534C60 -> 0x534CE0
void cancelDrawTargetLockOnAll(class clsSvlBtlMissile_Task * this /* r2 */, signed int s32PlayerNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x534C60 -> 0x534CE0
        class stcPlayerMissileData * psData; // r2
        signed int i; // r16
    }
}


// Range: 0x534CE0 -> 0x534D84
void setLockOnPlayer(class clsSvlBtlMissile_Task * this /* r2 */, float f32Distance /* r29 */, signed int s32PlayerNo /* r2 */, signed int s32TargetNo /* r2 */, enum enmLockOnPlayerType eType /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x534CE0 -> 0x534D84
        class stcPlayerMissileData * psData; // r2
...
// Range: 0x534D90 -> 0x534EC0
void lostMissile(class clsSvlBtlMissile_Task * this /* r2 */, signed int s32PlayerNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x534D90 -> 0x534EC0
        signed int i; // r17
...
// Range: 0x534EC0 -> 0x535080
void shootMissile(class clsSvlBtlMissile_Task * this /* r2 */, signed int s32PlayerNo /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x534EC0 -> 0x535080
        class stcPlayerMissileData * psData; // r2
        signed int i; // r20
        signed int s32LockOnTblNo; // r19
        signed int s32ShootNum; // r18
        class clsSvlBtlMissile_Object * psCopyData[4]; // r29+0x60
        signed int s32MissileNo; // r16
    }
}


// Range: 0x535080 -> 0x535428
void lockonMissile(class clsSvlBtlMissile_Task * this /* r22 */, signed int s32PlayerNo /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x535080 -> 0x535428
        class stcPlayerMissileData * psData; // r21
        class clsPlayerTask * pcOwner; // r20
        class clsPlayerTask * pcTarget; // r2
        signed int as32LockOnDispTable[4]; // r29+0x120
        class NNS_QUATERNION sRotQuat; // r29+0x110
        class NNS_VECTORFAST sVelocityVecFast; // r29+0x100
        class NNS_VECTORFAST sDirVecFast; // r29+0xF0
        class NNS_VECTORFAST sDirNrmVecFast; // r29+0xE0
        signed int i; // r18
        signed int j; // r6
        float f32DistSq; // r29+0x130
        signed int i; // r19
    }
}


// Range: 0x5354A0 -> 0x535648
void setupMissile(class clsSvlBtlMissile_Task * this /* r30 */, signed int s32PlayerNo /* r21 */, signed int s32Num /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5354A0 -> 0x535648
        signed int i; // r23
        signed int s32SetupNum; // r2
        signed int s32ObjectNum; // r2
        signed int s32ObjectNo; // r22
        signed int s32MissileNo; // r20
        signed int s32SetFlag; // r19
        class clsSvlBtlMissile_Object * pcObject; // r18
        class stcPlayerMissileData * psData; // r17
        class clsSvlBtlMissile_Object * psCopyData[4]; // r29+0xC0
    }
}


// Range: 0x535650 -> 0x535724
signed int calcSetupMissileNum(class clsSvlBtlMissile_Task * this /* r20 */, signed int s32PlayerNo /* r2 */, signed int s32Num /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x535650 -> 0x535724
        signed int s32WantNum; // r19
        signed int s32EmptyNum; // r2
        signed int s32SetupNum; // r18
        signed int s32ObjectNum; // r2
        signed int s32ObjectNo; // r17
    }
}


// Range: 0x535730 -> 0x5358D4
void draw(class clsSvlBtlMissile_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x535730 -> 0x5358D4
        ...
        float sMtxPal[4][4]; // r29+0x70
        unsigned int sNodeStat; // r29+0xFC
        unsigned int u32i; // r17
    }
}


// Range: 0x5358E0 -> 0x535E80
void execute(class clsSvlBtlMissile_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5358E0 -> 0x535E80
        unsigned int u32Num; // r2
...
// Range: 0x535FE0 -> 0x536070
void reset(class clsSvlBtlMissile_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x535FE0 -> 0x536070
        unsigned int u32Num; // r2
        unsigned int u32i; // r17
        signed int s32PlayerNo; // r16
    }
}


// Range: 0x5361F0 -> 0x5361FC
class clsSvlBtlBomb_Task * GS() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5361F0 -> 0x5361FC
    }
