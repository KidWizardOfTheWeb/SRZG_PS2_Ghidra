/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Havok\HavokHeap.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class clsPfHavokHeap * m_tpcSingleton; // size: 0x4, address: 0x703C20
void (* hkSystemFree)(void *); // size: 0x4, address: 0x621350
void HavokSystemFree(void *); // size: 0x0, address: 0x1F2860
void * (* hkSystemMalloc)(signed int, signed int); // size: 0x4, address: 0x621348
void * HavokSystemMalloc(signed int, signed int); // size: 0x0, address: 0x1F2890
struct /* @anon1 */ {
    // total size: 0x18
...
// Range: 0x1F2860 -> 0x1F288C
void HavokSystemFree(void * p /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1F2860 -> 0x1F288C
    }
...
// Range: 0x1F2890 -> 0x1F28A8
void * HavokSystemMalloc(signed int size /* r4 */, signed int align /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1F2890 -> 0x1F28A8
    }
...
// Range: 0x1F28B0 -> 0x1F2958
void * __ct(class clsPfHavokHeap * this /* r17 */, unsigned int u32AllocateSizeI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1F28B0 -> 0x1F2958
        unsigned char * pu8Lo; // r2
    }
}


// Range: 0x1F2A50 -> 0x1F2A58
void @4@__dt__14clsPfHavokHeapFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1F2A50 -> 0x1F2A58
    }
