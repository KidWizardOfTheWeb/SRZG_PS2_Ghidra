/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Havok\Havok.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class hkTypeInfo * StaticLinkedTypeInfos[244]; // size: 0x3D0, address: 0x0
class hkClass * StaticLinkedClasses[276]; // size: 0x450, address: 0x0
...
void (* hkSystemFree)(void *); // size: 0x4, address: 0x621350
...
struct /* @anon10 */ {
    // total size: 0x1C
} __vt__23clsGimmickRigidListener; // size: 0x1C, address: 0x6B6080
struct /* @anon3 */ {
    // total size: 0x1C
} __vt__19hkCollisionListener; // size: 0x1C, address: 0x6B60A0
void * (* hkSystemMalloc)(signed int, signed int); // size: 0x4, address: 0x621348
class clsPfHavokHeap * m_tpcSingleton; // size: 0x4, address: 0x703C20
struct /* @anon8 */ {
    // total size: 0xC
} __vt__8clsHavok; // size: 0xC, address: 0x6B6060
class clsHavok * m_tpcSingleton; // size: 0x4, address: 0x707E60
struct /* @anon4 */ {
    // total size: 0xC
} __vt__23clsSingleton<8clsHavok>; // size: 0xC, address: 0x6B6070
struct /* @anon11 */ {
    // total size: 0xC
...
struct /* @anon6 */ {
    // total size: 0x10
} __vt__12hkWorldCinfo; // size: 0x10, address: 0x6B5F90
struct /* @anon2 */ {
    // total size: 0x60
...
class hkTypeInfo {
    // total size: 0x10
public:
    char * m_typeName; // offset 0x0, size 0x4
...
class hkArray {
    // total size: 0xC
public:
    class ChildInfo * m_data; // offset 0x0, size 0x4
    signed int m_size; // offset 0x4, size 0x4
    signed int m_capacityAndFlags; // offset 0x8, size 0x4
};
class hkMotionState {
...
public:
    ...
    unsigned int m_collisionFilterInfo; // offset 0x4, size 0x4
    signed int m_shapeSize; // offset 0x8, size 0x4
    signed int m_numChildShapes; // offset 0xC, size 0x4
};
class FreeList {
    // total size: 0x8
public:
...
public:
    ...
    class hkClass * m_parent; // offset 0x4, size 0x4
    signed int m_objectSize; // offset 0x8, size 0x4
    signed int m_numImplementedInterfaces; // offset 0xC, size 0x4
    class hkClassEnum * m_declaredEnums; // offset 0x10, size 0x4
    signed int m_numDeclaredEnums; // offset 0x14, size 0x4
    class hkClassMember * m_declaredMembers; // offset 0x18, size 0x4
    signed int m_numDeclaredMembers; // offset 0x1C, size 0x4
...
class hkListShape : public hkShapeCollection {
    // total size: 0x70
public:
    class hkArray m_childInfo; // offset 0x18, size 0xC
    class hkVector4 m_aabbHalfExtents; // offset 0x30, size 0x10
    class hkVector4 m_aabbCenter; // offset 0x40, size 0x10
    unsigned int m_enabledChildren[8]; // offset 0x50, size 0x20
};
...
public:
    ...
    signed int m_broadPhaseQuerySize; // offset 0x20, size 0x4
    float m_contactRestingVelocity; // offset 0x24, size 0x4
    class hkEnum m_broadPhaseBorderBehaviour; // offset 0x28, size 0x1
    class hkAabb m_broadPhaseWorldAabb; // offset 0x30, size 0x20
    float m_collisionTolerance; // offset 0x50, size 0x4
    class hkCollisionFilter * m_collisionFilter; // offset 0x54, size 0x4
    class hkConvexListFilter * m_convexListFilter; // offset 0x58, size 0x4
    float m_expectedMaxLinearVelocity; // offset 0x5C, size 0x4
    signed int m_sizeOfToiEventQueue; // offset 0x60, size 0x4
    float m_expectedMinPsiDeltaTime; // offset 0x64, size 0x4
    class hkWorldMemoryWatchDog * m_memoryWatchDog; // offset 0x68, size 0x4
    signed int m_broadPhaseNumMarkers; // offset 0x6C, size 0x4
    class hkEnum m_contactPointGeneration; // offset 0x70, size 0x1
    float m_solverTau; // offset 0x74, size 0x4
    float m_solverDamp; // offset 0x78, size 0x4
    signed int m_solverIterations; // offset 0x7C, size 0x4
    signed int m_solverMicrosteps; // offset 0x80, size 0x4
    class hkBool m_forceCoherentConstraintOrderingInSolver; // offset 0x84, size 0x1
    float m_snapCollisionToConvexEdgeThreshold; // offset 0x88, size 0x4
    float m_snapCollisionToConcaveEdgeThreshold; // offset 0x8C, size 0x4
    class hkBool m_enableToiWeldRejection; // offset 0x90, size 0x1
    class hkBool m_enableDeprecatedWelding; // offset 0x91, size 0x1
    float m_iterativeLinearCastEarlyOutDistance; // offset 0x94, size 0x4
    signed int m_iterativeLinearCastMaxIterations; // offset 0x98, size 0x4
    float m_highFrequencyDeactivationPeriod; // offset 0x9C, size 0x4
    float m_lowFrequencyDeactivationPeriod; // offset 0xA0, size 0x4
    unsigned char m_deactivationNumInactiveFramesSelectFlag0; // offset 0xA4, size 0x1
    unsigned char m_deactivationNumInactiveFramesSelectFlag1; // offset 0xA5, size 0x1
    unsigned char m_deactivationIntegrateCounter; // offset 0xA6, size 0x1
    class hkBool m_shouldActivateOnRigidBodyTransformChange; // offset 0xA7, size 0x1
    class hkBool m_wantOldStyleDeactivation; // offset 0xA8, size 0x1
    float m_deactivationReferenceDistance; // offset 0xAC, size 0x4
    float m_toiCollisionResponseRotateNormal; // offset 0xB0, size 0x4
    class hkBool m_enableDeactivation; // offset 0xB4, size 0x1
    class hkEnum m_simulationType; // offset 0xB5, size 0x1
    class hkBool m_enableSimulationIslands; // offset 0xB6, size 0x1
    unsigned int m_minDesiredIslandSize; // offset 0xB8, size 0x4
    class hkBool m_processActionsInSingleThread; // offset 0xBC, size 0x1
    float m_frameMarkerPsiSnap; // offset 0xC0, size 0x4
};
...
class hkArray {
    // total size: 0xC
public:
    class FourVectors * m_data; // offset 0x0, size 0x4
    signed int m_size; // offset 0x4, size 0x4
    signed int m_capacityAndFlags; // offset 0x8, size 0x4
};
...
public:
    char * m_name; // offset 0x0, size 0x4
    class Item * m_items; // offset 0x4, size 0x4
    signed int m_numItems; // offset 0x8, size 0x4
};
...
class hkCapsuleShape : public hkConvexShape {
    // total size: 0x40
public:
    class hkVector4 m_vertexA; // offset 0x20, size 0x10
    class hkVector4 m_vertexB; // offset 0x30, size 0x10
};
class hkPadSpu {
    // total size: 0x4
public:
...
class Item {
    // total size: 0x8
public:
    signed int m_value; // offset 0x0, size 0x4
    char * m_name; // offset 0x4, size 0x4
};
class FourVectors {
    // total size: 0x30
public:
    class hkVector4 m_x; // offset 0x0, size 0x10
    class hkVector4 m_y; // offset 0x10, size 0x10
    class hkVector4 m_z; // offset 0x20, size 0x10
};
class hkArray {
    // total size: 0xC
public:
...
class hkConvexVerticesShape : public hkConvexShape {
    // total size: 0x60
public:
    class hkVector4 m_aabbHalfExtents; // offset 0x20, size 0x10
    class hkVector4 m_aabbCenter; // offset 0x30, size 0x10
    class hkArray m_rotatedVertices; // offset 0x40, size 0xC
    signed int m_numVertices; // offset 0x4C, size 0x4
    class hkArray m_planeEquations; // offset 0x50, size 0xC
};
class hkClassMember {
    // total size: 0x14
public:
    char * m_name; // offset 0x0, size 0x4
    class hkClass * m_class; // offset 0x4, size 0x4
    class hkClassEnum * m_enum; // offset 0x8, size 0x4
    class hkEnum m_type; // offset 0xC, size 0x1
    class hkEnum m_subtype; // offset 0xD, size 0x1
    signed short m_cArraySize; // offset 0xE, size 0x2
    unsigned short m_flags; // offset 0x10, size 0x2
    unsigned short m_offset; // offset 0x12, size 0x2
};
class hkUFloat8 {
    // total size: 0x1
public:
...
// Range: 0x1EEAD0 -> 0x1EF37C
void drawShape(class clsHavok * this /* r20 */, unsigned int u32ViewNo /* r19 */, class hkShape * pcShape /* r18 */, class hkTransform & rcTransform /* r17 */, unsigned char u8Alpha /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EEAD0 -> 0x1EF37C
        class NNS_VECTOR sPosVec; // r29+0x1D0
        float sMtx[4][4]; // r29+0x170
        class hkListShape * pcListShape; // r2
        signed int i; // r22
        class hkTransformShape * pcTransformShape; // r2
        class hkTransform cTrs; // r29+0x130
        float sMtx[4][4]; // r29+0xF0
        class hkConvexVerticesShape * pclConvexShape; // r2
        class hkArray vctVertex; // r29+0x1C0
        signed int s32Size; // r2
        class NNS_VECTOR sVec[2]; // r29+0xD0
        signed int s32i; // r18
        float sMtx[4][4]; // r29+0x90
        class hkCapsuleShape * pcCapsuleShape; // r2
        class NNS_VECTOR sPosVec; // r29+0x1B0
    }
}


// Range: 0x1EF4B0 -> 0x1EF520
void exit(class clsHavok * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EF4B0 -> 0x1EF520
    }
...
// Range: 0x1EF570 -> 0x1EF64C
void init(class clsHavok * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EF570 -> 0x1EF64C
    }
...
// Range: 0x1EF650 -> 0x1EF6B4
class clsHavok & createInstance() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EF650 -> 0x1EF6B4
    }
...
// Range: 0x1EF720 -> 0x1EF788
void destroyWorld(class clsHavok * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EF720 -> 0x1EF788
    }
...
// Range: 0x1EF800 -> 0x1EFA14
void createWorld(class clsHavok * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EF800 -> 0x1EFA14
        class hkWorldCinfo info; // r29+0x30
    }
}


// Range: 0x1EFD40 -> 0x1EFE38
void registerAgents(class hkCollisionDispatcher * dis /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EFD40 -> 0x1EFE38
    }
...
// Range: 0x1EFF30 -> 0x1EFF38
void @8@__dt__17hkCollisionFilterFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EFF30 -> 0x1EFF38
    }
...
// Range: 0x1EFF40 -> 0x1EFF48
void @12@__dt__17hkCollisionFilterFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EFF40 -> 0x1EFF48
    }
...
// Range: 0x1EFF50 -> 0x1EFF58
void @16@__dt__17hkCollisionFilterFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EFF50 -> 0x1EFF58
    }
...
// Range: 0x1EFF60 -> 0x1EFF68
void @20@__dt__17hkCollisionFilterFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1EFF60 -> 0x1EFF68
    }
