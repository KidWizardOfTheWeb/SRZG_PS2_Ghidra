/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Havok\WorldManager.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon1 */ {
    // total size: 0x30
} __vt__19clsWorldManagerTask; // size: 0x30, address: 0x6C6FC0
...
// Range: 0x472F40 -> 0x472FDC
void * __dt(class clsWorldManagerTask * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x472F40 -> 0x472FDC
    }
...
// Range: 0x472FE0 -> 0x47303C
void * __ct(class clsWorldManagerTask * this /* r16 */, class clsTask * pcParentTask /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x472FE0 -> 0x47303C
    }
