/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Debug\Debug.cpp
...
signed int Sr2(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x1DDA10
signed int OutSideChecker(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x1D6A50
...
// Range: 0x1D6230 -> 0x1D63DC
void exec(class clsDebug * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1D6230 -> 0x1D63DC
        class clsBaseRace_Task * pcBaseRace; // r2
        unsigned int u32ViewportNum; // r2
        signed int s32PlayerNo; // r21
...
// Range: 0x1D63E0 -> 0x1D6458
void reinitMenu(class clsDebug * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1D63E0 -> 0x1D6458
    }
...
// Range: 0x1D6460 -> 0x1D694C
void * __ct(class clsDebug * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1D6460 -> 0x1D694C
        signed int s32i; // r17
        unsigned int u32n; // r3
    }
}
