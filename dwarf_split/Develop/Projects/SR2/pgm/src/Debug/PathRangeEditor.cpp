/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Debug\PathRangeEditor.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned int ALPHA; // size: 0x4, address: 0x0
unsigned int DIV_NUM; // size: 0x4, address: 0x0
struct /* @anon0 */ {
    // total size: 0x30
} __vt__29clsPathRangeEditor_Debug_Task; // size: 0x30, address: 0x6C34A0
...
public:
    ...
    signed int m_s32Cursor; // offset 0x58, size 0x4
    signed int m_s32CursorDetail; // offset 0x5C, size 0x4
    signed int m_s32Num; // offset 0x60, size 0x4
    unsigned int m_bZComp; // offset 0x64, size 0x4
    unsigned int m_bDrawLinearSphere; // offset 0x68, size 0x4
    float * m_apf32Range[2]; // offset 0x6C, size 0x8
    unsigned char * m_apu8RangeAttr[2]; // offset 0x74, size 0x8
};
...
// Range: 0x41A7F0 -> 0x41AE04
void draw(class clsPathRangeEditor_Debug_Task * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41A7F0 -> 0x41AE04
    }
...
// Range: 0x41AEB0 -> 0x41AF98
void drawDetail(class clsPathRangeEditor_Debug_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41AEB0 -> 0x41AF98
    }
...
// Range: 0x41AFA0 -> 0x41B570
void execute(class clsPathRangeEditor_Debug_Task * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41AFA0 -> 0x41B570
        float * pf32Range; // r2
        unsigned char * pu8Attr; // r2
    }
}


// Range: 0x41B570 -> 0x41B6A0
void * __dt(class clsPathRangeEditor_Debug_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41B570 -> 0x41B6A0
    }
...
// Range: 0x41B6A0 -> 0x41B7D8
void * __ct(class clsPathRangeEditor_Debug_Task * this /* r17 */, enum enmPathType ePathTypeI /* r16 */, unsigned int u32Tp /* r2 */, signed int s32Flg /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x41B6A0 -> 0x41B7D8
    }
