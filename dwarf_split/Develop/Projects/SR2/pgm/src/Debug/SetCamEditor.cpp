/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Debug\SetCamEditor.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class clsSetCamEditor cSetEdit; // size: 0x50, address: 0xB15FD0
static char * apc8ActionTypeName[34]; // size: 0x88, address: 0x0
class clsSetCamColli_Task * m_tpcSingleton; // size: 0x4, address: 0xB16028
class stcTask sTask; // size: 0x30, address: 0xB0A900
class stcCamFilter * apsFilterSetCamAll[]; // size: 0x0, address: 0x6357F0
unsigned int oau32SCamFilterNum[]; // size: 0x0, address: 0x0
class stcSCamVector * sVectorSetCamAll[]; // size: 0x0, address: 0x634370
unsigned int oau32SCamVectorNum[]; // size: 0x0, address: 0x0
unsigned int oau32SCamLookTargetNum[]; // size: 0x0, address: 0x0
class stcSCamLookPlayer * sLookTargetSetCamAll[]; // size: 0x0, address: 0x633C50
unsigned int oau32SCamStageNum[]; // size: 0x0, address: 0x628500
...
struct /* @anon0 */ {
    // total size: 0xC
} __vt__15clsSetCamEditor; // size: 0xC, address: 0x6C0FF0
class clsSetCamEditor * m_tpcSingleton; // size: 0x4, address: 0xB16020
struct /* @anon1 */ {
    // total size: 0xC
} __vt__31clsSingleton<15clsSetCamEditor>; // size: 0xC, address: 0x6C1000
...
class clsSetCamEditor : public clsSingleton {
    // total size: 0x50
public:
    class vector m_vecsSetCamList; // offset 0x4, size 0xC
    class vector m_vecsReplayCamList; // offset 0x10, size 0xC
    class vector * m_pvecsCamList; // offset 0x1C, size 0x4
    enum enmSCamEditMode m_eMode; // offset 0x20, size 0x4
    signed char m_s8CursorX; // offset 0x24, size 0x1
    signed char m_s8CursorY; // offset 0x25, size 0x1
    signed char m_s8CursorX2; // offset 0x26, size 0x1
    signed char m_s8CursorY2; // offset 0x27, size 0x1
    unsigned char m_u8CursorChgFlg; // offset 0x28, size 0x1
    enum enmListMode m_eListMode; // offset 0x2C, size 0x4
    enum enmBaseEditMode m_eBEditMode; // offset 0x30, size 0x4
    signed int m_s32ActTypeTop; // offset 0x34, size 0x4
    signed int m_s32ListCursor; // offset 0x38, size 0x4
    float m_f32ToItemDist; // offset 0x3C, size 0x4
    enum enmSCamType m_eNewScamType; // offset 0x40, size 0x4
    enum enmSCamShapeType m_eNewShapeType; // offset 0x44, size 0x4
    unsigned char m_u8NewReplayFlag; // offset 0x48, size 0x1
    unsigned int m_u32ListTopIdx; // offset 0x4C, size 0x4
};
