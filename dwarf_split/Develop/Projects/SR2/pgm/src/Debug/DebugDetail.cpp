/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Debug\DebugDetail.cpp
...
class stcGimmick m_sGimmick; // size: 0x8, address: 0x703BB0
class clsGameMgr * m_tpcSingleton; // size: 0x4, address: 0x6E6980
class _strSurvivalBallData m_sDbgSurvivalBallData; // size: 0x20, address: 0xB17380
signed int MAX_LAP_NUM; // size: 0x4, address: 0x6637E8
class clsPfSystem * m_tpcSingleton; // size: 0x4, address: 0x6E69B8
char m_toac8LanguagePreFix[11]; // size: 0xB, address: 0x6592C8
...
class NNS_VECTOR sParticlePotalRotVec; // size: 0xC, address: 0x0
class NNS_VECTOR sParticlePotalPosVec; // size: 0xC, address: 0x0
...
float tof32_3rdSpeed; // size: 0x4, address: 0x6363F0
float tof32_2ndSpeed; // size: 0x4, address: 0x6363E8
float tof32_1stSpeed; // size: 0x4, address: 0x6363E0
float tof32ReadyJumpSpeed; // size: 0x4, address: 0x6363D8
float tof32_EffectFrame; // size: 0x4, address: 0x636408
float tof32_2ndFrame; // size: 0x4, address: 0x636400
float tof32_1stFrame; // size: 0x4, address: 0x6363F8
float tof32ReadyFrame; // size: 0x4, address: 0x6363D0
unsigned char bFreePathRange; // size: 0x1, address: 0xB17170
float tof32_2ndAccele; // size: 0x4, address: 0xB17168
float tof32_1stAccele; // size: 0x4, address: 0xB17160
class stcCommonSetting t_sCommonSetting; // size: 0x98, address: 0xB163D0
...
enum enmFlag m_eAllFlag; // size: 0x4, address: 0xB0A948
class clsCollisionManager * m_tpcSingleton; // size: 0x4, address: 0x703C18
class clsPfDraw3d * m_tpcSingleton; // size: 0x4, address: 0x703C30
class clsSrCamCtrlMgr * m_tpcSingleton; // size: 0x4, address: 0x703BF8
class stcBaseSetCam * sBaseSetCamAll[]; // size: 0x0, address: 0x62FF00
...
class NNS_VECTORFAST tosZeroVecFast; // size: 0x10, address: 0x664C90
...
char * m_toac8StageName_Debug[]; // size: 0x0, address: 0x626D00
char * m_toac8GameModeName_Debug[]; // size: 0x0, address: 0x624960
...
char * m_tac8LanguageName_Debug[]; // size: 0x0, address: 0x5FBAE0
char m_tac8RomRegionName_Debug[3]; // size: 0x3, address: 0x6592D8
char * m_toac8ScreenModeName_Debug[]; // size: 0x0, address: 0x635C20
...
class clsThroughCollision : public clsBaseThroughCollision {
    // total size: 0x14
public:
    class stcInfo * m_psInfo; // offset 0x8, size 0x4
    unsigned char m_au8BackUpNo[8]; // offset 0xC, size 0x8
};
...
class clsCollisionManager : public clsSingleton {
    // total size: 0xC4
public:
    class clsGroundCollision * m_pcGroundCollisionList; // offset 0x4, size 0x4
    class clsThroughCollision * * m_ppcThroughCollisionList; // offset 0x8, size 0x4
    signed int m_s32GroundNum; // offset 0xC, size 0x4
    signed int m_s32ThroughNum; // offset 0x10, size 0x4
    class stcAttrInfo m_sGroundAttrInfo[21]; // offset 0x14, size 0xA8
    signed int m_s32GroundVertexNum; // offset 0xBC, size 0x4
    signed int m_s32GroundPartsNum; // offset 0xC0, size 0x4
};
...
class stcGimmick {
    // total size: 0x8
public:
    unsigned int u32DisableClip; // offset 0x0, size 0x4
    unsigned char u8ParticleBreakNum; // offset 0x4, size 0x1
};
...
class stcAttrInfo {
    // total size: 0x8
public:
    signed int m_s32PartsNum; // offset 0x0, size 0x4
    signed int m_s32VertexNum; // offset 0x4, size 0x4
};
...
class clsBaseThroughCollision : public clsCollision {
    // total size: 0x8
public:
    class clsSimpleShapePhantom * m_pcPhantom; // offset 0x4, size 0x4
};
class clsFlag {
    // total size: 0x4
public:
...
class clsGroundCollision : public clsCollision {
    // total size: 0x8
public:
    class clsRigidBody * m_pcRigidBody; // offset 0x4, size 0x4
};
...
class generic_iterator {
    // total size: 0x10
public:
    class generic_iterator i_; // offset 0x0, size 0x10
};
...
class clsSurvivalBallRace_Task : public clsBaseRace_Task {
    // total size: 0xD00
public:
    class _strSurvivalBallRuleData m_sSurvivalBallRuleData; // offset 0xCB0, size 0x10
    unsigned int m_u32DefaultSurvivalBallType; // offset 0xCC0, size 0x4
    signed int m_s32SurvivalBallType; // offset 0xCC4, size 0x4
    signed int m_as32MaxLap[4]; // offset 0xCC8, size 0x10
    signed int m_s32DbgGameOverCount; // offset 0xCD8, size 0x4
    signed int m_as32PlayerPoint[4]; // offset 0xCDC, size 0x10
    void * m_pvWinLose2DPackBuffer; // offset 0xCEC, size 0x4
    void * m_pvSurvival2DPackBuffer; // offset 0xCF0, size 0x4
    class clsTask * m_psWinLose; // offset 0xCF4, size 0x4
    unsigned char m_abPlayerWinFlag[4]; // offset 0xCF8, size 0x4
    unsigned char m_bWinDrawFlag; // offset 0xCFC, size 0x1
};
class vector : private __vector_imp {
    // total size: 0xC
};
...
class stcInfo {
    // total size: 0x10
public:
    unsigned char u8Attr; // offset 0x0, size 0x1
    unsigned char u8ProcType; // offset 0x1, size 0x1
    unsigned char u8SubNo00; // offset 0x2, size 0x1
    unsigned char u8Param; // offset 0x3, size 0x1
    float f32Param; // offset 0x4, size 0x4
    unsigned int u32Reserve[2]; // offset 0x8, size 0x8
};
enum enmStatus {
    STATUS__NONE = 0,
    STATUS__RANGE_IN = 1,
...
class _strSurvivalBallRuleData {
    // total size: 0x10
public:
    unsigned int u32Minite; // offset 0x0, size 0x4
    unsigned int u32Second; // offset 0x4, size 0x4
    unsigned int u32MiliSecond; // offset 0x8, size 0x4
    unsigned int u32MaxPoint; // offset 0xC, size 0x4
};
class hkAgent3Input {
    // total size: 0x50
public:
...
class stcDebugParticleMenu {
    // total size: 0x14
public:
    unsigned char u8Mode; // offset 0x0, size 0x1
    signed int s32Color; // offset 0x4, size 0x4
    signed int s32LoadSingleNum; // offset 0x8, size 0x4
    signed int s32LoadParticleNum; // offset 0xC, size 0x4
    unsigned char u8TempPotalSwitch; // offset 0x10, size 0x1
    unsigned char u8TempPotalGetPos; // offset 0x11, size 0x1
    unsigned short u16TempPotalStopCode; // offset 0x12, size 0x2
};
enum enmRunDelay {
...
class stcBaseSetCam {
    // total size: 0x44
public:
    char * opcName; // offset 0x0, size 0x4
    unsigned char bIsEnable; // offset 0x4, size 0x1
    unsigned char u8IsReplay; // offset 0x5, size 0x1
    class NNS_VECTOR sPos; // offset 0x8, size 0xC
    class NNS_VECTOR sRotZXYRad; // offset 0x14, size 0xC
    class NNS_VECTOR sScale; // offset 0x20, size 0xC
    signed int s32Fovy; // offset 0x2C, size 0x4
    enum enmSCamType eSetCamType; // offset 0x30, size 0x4
    enum enmSCamShapeType eShapeType; // offset 0x34, size 0x4
    unsigned int u32ActiveType; // offset 0x38, size 0x4
    unsigned int u32CamIdx; // offset 0x3C, size 0x4
    unsigned int u32PlayerActType; // offset 0x40, size 0x4
};
class NNS_CAMERAPTR {
    // total size: 0x8
public:
...
class _strSurvivalBallData {
    // total size: 0x20
public:
    float f32CameraAddPos; // offset 0x0, size 0x4
    float f32CameraFovy; // offset 0x4, size 0x4
    float f32AdjustGctrlSlideslowdownFrame; // offset 0x8, size 0x4
    float f32AdjustGctrlMinSpeed; // offset 0xC, size 0x4
    float f32AdjustGctrlMaxSpeed; // offset 0x10, size 0x4
    float f32GDiveUsedRate; // offset 0x14, size 0x4
    float f32GCtrlUsedRate; // offset 0x18, size 0x4
    float f32GctrlNextGC_Frame; // offset 0x1C, size 0x4
};
enum enmStiffType {
    STIFF_TYPE__ALL = 0,
    STIFF_TYPE__LEVER = 1,
...
class generic_iterator {
    // total size: 0x10
public:
    unsigned int * ptr_; // offset 0x0, size 0x4
    unsigned int * beg_; // offset 0x4, size 0x4
    unsigned int * start_; // offset 0x8, size 0x4
    unsigned int * end_; // offset 0xC, size 0x4
};
...
class generic_iterator {
    // total size: 0x18
public:
    class generic_iterator beg_; // offset 0x0, size 0x10
    class clsOOFileQueue * cur_; // offset 0x10, size 0x4
    class clsOOFileQueue * end_; // offset 0x14, size 0x4
};
class hkArray {
    // total size: 0xC
public:
...
// Range: 0x1D6A50 -> 0x1D6D18
signed int OutSideChecker(signed int s32xI /* r17 */, signed int s32yI /* r16 */, signed int s32ActiveNoI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1D6A50 -> 0x1D6D18
        signed int s32Ret; // r30
        signed int s32yBack; // r22
        class clsPlayerTask * pcPlayer; // r19
        signed int s32PlayerNum; // r2
        signed int s32PlayerNo; // r20
    }
}


// Range: 0x1D6D20 -> 0x1D6F04
signed int GDiveTrain(signed int s32xI /* r20 */, signed int s32yI /* r19 */, signed int s32ActiveNoI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1D6D20 -> 0x1D6F04
        signed int s32yBack; // r18
        class stcGDTrainData & rsGDTrainDbg; // r2
        unsigned char & ru8StartRank; // r2
    }
}


// Range: 0x1D6F10 -> 0x1D7204
signed int PathRangeEditor(signed int s32xI /* r21 */, signed int s32yI /* r20 */, signed int s32ActiveNoI /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1D6F10 -> 0x1D7204
        signed int s32yBack; // r18
...
// Range: 0x1D7210 -> 0x1D74BC
signed int ObjPortal(signed int s32xI /* r21 */, signed int s32yI /* r20 */, signed int s32ActiveNoI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1D7210 -> 0x1D74BC
        signed int s32yBack; // r23
        class stcPortalBelongType * opsPortalBelongType; // r19
...
// Range: 0x1D74C0 -> 0x1D7958
signed int MapPortal(signed int s32xI /* r21 */, signed int s32yI /* r20 */, signed int s32ActiveNoI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1D74C0 -> 0x1D7958
        class clsDivStage_Task * pcDivStage_Task; // r18
        signed int s32yBack; // r23
        unsigned char * opu8IgnoreResidencePortalData; // r18
...
// Range: 0x1D7990 -> 0x1D7BBC
signed int DataSize(signed int s32xI /* r19 */, signed int s32yI /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1D7990 -> 0x1D7BBC
        signed int s32yBack; // r17
    }
}


// Range: 0x1D7BC0 -> 0x1D9B30
signed int Light(signed int s32xI /* r21 */, signed int s32yI /* r20 */, signed int s32ActiveNoI /* r29+0x15C */, signed int s32SpeedI /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1D7BC0 -> 0x1D9B30
        signed int s32yBack; // r29+0x158
        class clsPfLight & rcLight; // r2
        signed int s32SoftWareNum; // r29+0x140
        unsigned int eUseType; // r2
        float f32PInten; // r20
        class NNS_VECTOR * psDrawDirVec; // r29+0x13C
        class NNS_VECTORFAST * psParaDir; // r29+0x120
        class NNS_VECTORFAST * psParaPos; // r29+0x110
        class NNS_VECTORFAST * psSpeDir; // r29+0x100
        unsigned char bBossLightDebug; // r29+0xF0
        class clsPlayerTask * pcPlayer; // r2
        class NNS_VECTORFAST * opsPosFast; // r2
        class NNS_VECTOR asVec[2]; // r29+0x160
        signed char ts8No; // @ 0x00703BC0
    }
}


// Range: 0x1D9B40 -> 0x1D9D8C
signed int BgColor(signed int s32xI /* r19 */, signed int s32yI /* r18 */, signed int s32ActiveNoI /* r2 */, signed int s32SpeedI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1D9B40 -> 0x1D9D8C
        signed int s32yBack; // r17
...
// Range: 0x1D9D90 -> 0x1DA310
signed int Fog(signed int s32xI /* r21 */, signed int s32yI /* r20 */, signed int s32ActiveNoI /* r19 */, signed int s32SpeedI /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1D9D90 -> 0x1DA310
        signed int s32yBack; // r22
...
// Range: 0x1DA350 -> 0x1DA5F8
signed int Race(signed int s32xI /* r21 */, signed int s32yI /* r20 */, signed int s32ActiveNoI /* r2 */, signed int s32SpeedI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1DA350 -> 0x1DA5F8
        signed int s32yBack; // r19
        signed int s32LapNum; // r18
    }
}


// Range: 0x1DA600 -> 0x1DA9F4
signed int BlackHoleDebug(signed int s32xI /* r20 */, signed int s32yI /* r19 */, signed int s32ActiveNoI /* r2 */, signed int s32SpeedI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1DA600 -> 0x1DA9F4
        unsigned int u32ElementNum; // r18
        signed int s32yBack; // r17
        float f32SpeedI; // r20
    }
}
...
// Range: 0x1DAA00 -> 0x1DAFEC
signed int BossAttackDebug(signed int s32xI /* r20 */, signed int s32yI /* r19 */, signed int s32ActiveNoI /* r2 */, signed int s32SpeedI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1DAA00 -> 0x1DAFEC
        unsigned int u32ElementNum; // r22
        signed int s32yBack; // r23
        float f32SpeedI; // r2
    }
}
...
// Range: 0x1DAFF0 -> 0x1DBD98
signed int BossDebug(signed int s32xI /* r20 */, signed int s32yI /* r19 */, signed int s32ActiveNoI /* r21 */, signed int s32SpeedI /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1DAFF0 -> 0x1DBD98
        unsigned int u32ElementNum; // r18
        signed int s32yBack; // r22
        float f32SpeedI; // r29+0x90
        char * toapc8AttackPoint[4]; // @ 0x00620A10
        char * toapc8Type[2]; // @ 0x00620A08
        char * toapc8ReturnPoint[2]; // @ 0x00620A00
    }
}


// Range: 0x1DBDA0 -> 0x1DC17C
signed int BossDisp(signed int s32xI /* r20 */, signed int s32yI /* r19 */, signed int s32ActiveNoI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1DBDA0 -> 0x1DC17C
        unsigned int u32ElementNum; // r18
        signed int s32yBack; // r17
        char * toapc8Type[2]; // @ 0x006209F8
    }
}


// Range: 0x1DC180 -> 0x1DD0EC
signed int BurnOut(signed int s32xI /* r19 */, signed int s32yI /* r18 */, signed int s32ActiveNoI /* r2 */, signed int s32SpeedI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1DC180 -> 0x1DD0EC
        ...
        signed int s32yBack; // r17
        class clsPlayerTask * pcPlayer; // r2
        float sMtx0[4][4]; // r29+0xD0
        float sMtx1[4][4]; // r29+0x90
        float f32x; // r29+0x110
        float f32y; // r29+0x110
        float f32z; // r26
        float f32xR; // r29+0x110
        float f32yR; // r29+0x110
        float f32zR; // r20
        class NNS_PRIM3D_PC tasPrim3D_PC[4]; // @ 0x00620990
    }
}


// Range: 0x1DD0F0 -> 0x1DD3B4
signed int BurnOutSystem(signed int s32xI /* r20 */, signed int s32yI /* r19 */, signed int s32ActiveNoI /* r2 */, signed int s32SpeedI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1DD0F0 -> 0x1DD3B4
        class stcBurnOutSystem & rsBurnOutSystem; // r2
        class clsBaseRace_Task & rcBaseRace_Task; // r2
        signed int s32yBack; // r18
    }
}
...
// Range: 0x1DD3C0 -> 0x1DD99C
signed int Blur(signed int s32xI /* r19 */, signed int s32yI /* r18 */, signed int s32ActiveNoI /* r2 */, signed int s32SpeedI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1DD3C0 -> 0x1DD99C
        class stcBlur & rsBlur; // r2
        class clsBaseRace_Task * pcBaseRace_Task; // r2
        signed int s32yBack; // r17
    }
}


// Range: 0x1DDA10 -> 0x1DDD8C
signed int Sr2(signed int s32xI /* r20 */, signed int s32yI /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1DDA10 -> 0x1DDD8C
        signed int s32yBack; // r18
...
// Range: 0x1DDD90 -> 0x1DDDF4
unsigned int & at(class __vector_pod * this /* r16 */, unsigned int n /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1DDD90 -> 0x1DDDF4
    }
