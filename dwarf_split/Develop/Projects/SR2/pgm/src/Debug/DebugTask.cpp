/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Debug\DebugTask.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon1 */ {
    // total size: 0x44
} __vt__22clsDebugColliTask_Task; // size: 0x44, address: 0x0
...
struct /* @anon4 */ {
    // total size: 0x30
} __vt__21clsDebugLineTask_Task; // size: 0x30, address: 0x0
struct /* @anon3 */ {
    // total size: 0x30
...
struct /* @anon2 */ {
    // total size: 0x30
} __vt__17clsDebugTask_Task; // size: 0x30, address: 0x6B89D0
struct /* @anon5 */ {
    // total size: 0x2C
} __vt__9clsOOTask; // size: 0x2C, address: 0x6B58B0
struct /* @anon0 */ {
    // total size: 0xC
} __vt__38clsSingleton<22clsDebugColliTask_Task>; // size: 0xC, address: 0x0
class clsDebugColliTask_Task * m_tpcSingleton; // size: 0x4, address: 0x0
...
class clsDebugTask_Task : public clsTask {
    // total size: 0x168
public:
    signed short s16x_; // offset 0x54, size 0x2
    signed short s16y_; // offset 0x56, size 0x2
    float f32Frame_; // offset 0x58, size 0x4
    unsigned int u32DpColor_; // offset 0x5C, size 0x4
    unsigned int u32BgColor_; // offset 0x60, size 0x4
    char ac8Str_[256]; // offset 0x64, size 0x100
    unsigned char bFlash_; // offset 0x164, size 0x1
};
...
public:
    ...
    class stcColGroupNo * data_; // offset 0x8, size 0x4
};
class NNS_NODE {
    // total size: 0x90
public:
...
class clsDebugLineTask_Task : public clsTask {
    // total size: 0x90
public:
    class NNS_VECTORFAST m_asLineVF[2]; // offset 0x60, size 0x20
    unsigned int m_u32Color; // offset 0x80, size 0x4
    float m_f32AliveFrame; // offset 0x84, size 0x4
    unsigned char m_u8IsDrawSphere; // offset 0x88, size 0x1
};
class clsOODraw3d {
    // total size: 0x4
};
...
class __wrap_iterator {
    // total size: 0x4
public:
    class stcTriangle * it_; // offset 0x0, size 0x4
};
...
class clsDebugColliTask_Task : public clsSingleton, public clsTask {
    // total size: 0x70
public:
    class vector m_vecvecsTriangle; // offset 0x58, size 0xC
    class vector m_vecsGroup; // offset 0x64, size 0xC
};
...
public:
    class compressed_pair capacity_; // offset 0x0, size 0x4
    unsigned int size_; // offset 0x4, size 0x4
    class stcTriangle * data_; // offset 0x8, size 0x4
};
class compressed_pair : private compressed_pair_imp {
    // total size: 0x8
};
...
class stcColGroupNo {
    // total size: 0xC
public:
    unsigned int u32Enable; // offset 0x0, size 0x4
    unsigned int u32No; // offset 0x4, size 0x4
    unsigned int u32GroupNo; // offset 0x8, size 0x4
};
class __wrap_iterator {
    // total size: 0x4
public:
...
class __wrap_iterator {
    // total size: 0x4
public:
    class stcColGroupNo * it_; // offset 0x0, size 0x4
};
class compressed_pair : private compressed_pair_imp {
    // total size: 0x8
};
...
class stcTriangle {
    // total size: 0x30
public:
    class NNS_PRIM3D_PC sPoint[3]; // offset 0x0, size 0x30
};

// Range: 0x2B9EC0 -> 0x2B9FBC
void draw(class clsDebugTask_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2B9EC0 -> 0x2B9FBC
    }
...
// Range: 0x2B9FC0 -> 0x2BA00C
void execute(class clsDebugTask_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2B9FC0 -> 0x2BA00C
    }
...
// Range: 0x2BA010 -> 0x2BA108
void * __ct(class clsDebugTask_Task * this /* r21 */, signed int s32xI /* r20 */, signed int s32yI /* r19 */, unsigned int u32FrameI /* r18 */, unsigned int u32DpColorI /* r17 */, unsigned int u32BgColorI /* r16 */, enum enmFlash eFlashI /* r22 */, char * opc8StrI /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2BA010 -> 0x2BA108
    }
...
// Range: 0x2BA110 -> 0x2BA230
void * __ct(class clsDebugTask_Task * this /* r21 */, signed int s32xI /* r20 */, signed int s32yI /* r19 */, unsigned int u32FrameI /* r18 */, unsigned int u32DpColorI /* r17 */, unsigned int u32BgColorI /* r16 */, enum enmFlash eFlashI /* r22 */, char * pc8FmtI /* r29+0x100 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2BA110 -> 0x2BA230
        char * pc8FmtI'68; // r23
