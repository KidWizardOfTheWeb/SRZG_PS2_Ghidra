/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Advertise\Option\Option.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
signed char m_teCursorMode; // size: 0x1, address: 0x0
signed char m_ts8CursorPosLanguage; // size: 0x1, address: 0x0
struct /* @anon0 */ {
    // total size: 0x30
} __vt__14clsOption_Task; // size: 0x30, address: 0x6C76C0
struct /* @anon1 */ {
    // total size: 0x30
...
public:
    ...
    enum enmSoundMode m_eSoundMode; // offset 0x58, size 0x4
    enum enmLanguage m_eVoiceeLanguage; // offset 0x5C, size 0x4
    enum enmLanguage m_eMessageLanguage; // offset 0x60, size 0x4
    unsigned char m_bDisableAllRumble; // offset 0x64, size 0x1
    float m_f32ButtonDrawWait; // offset 0x68, size 0x4
    unsigned char m_bFastSet; // offset 0x6C, size 0x1
    void * m_pvKeyboardTextureLoFrame; // offset 0x70, size 0x4
    unsigned char m_u8ReadMode; // offset 0x74, size 0x1
    unsigned int m_u32AudioSel; // offset 0x78, size 0x4
    unsigned int m_u32MessageSel; // offset 0x7C, size 0x4
    unsigned int m_u32VoiceSel; // offset 0x80, size 0x4
    unsigned int m_u32VibSel; // offset 0x84, size 0x4
    unsigned int m_u32CtrlSel; // offset 0x88, size 0x4
    unsigned int m_u32Deside; // offset 0x8C, size 0x4
    unsigned int m_u32AutoSave; // offset 0x90, size 0x4
};
class stcGradRecord {
    // total size: 0x8
public:
...
// Range: 0x47D3C0 -> 0x47D47C
void draw(class clsOption_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47D3C0 -> 0x47D47C
    }
...
// Range: 0x47D480 -> 0x47D60C
void checkFont(class clsOption_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47D480 -> 0x47D60C
        class stcFlashData * psFlashData; // r2
        unsigned int u32TextValue; // r2
        signed int s32TextNo; // r16
    }
}


// Range: 0x47D610 -> 0x47DD10
void execute(class clsOption_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47D610 -> 0x47DD10
        class stcFlashData * psFlashData; // r2
        class stcFlashData * psTextureFlashData; // r2
        class stcFlashData * psTextureFlashData; // r2
    }
}


// Range: 0x47DD10 -> 0x47DE94
void checkEnd(class clsOption_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47DD10 -> 0x47DE94
        class stcFlashData * psFlashData; // r2
        signed int s32n; // r18
        unsigned char bReturn; // r6
        unsigned int u32ReturnCode[4]; // r29+0x50
    }
}


// Range: 0x47DEA0 -> 0x47E034
void checkAutoSave(class clsOption_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47DEA0 -> 0x47E034
        class stcFlashData * psFlashData; // r2
        unsigned int u32AutoSave; // r2
    }
}


// Range: 0x47E040 -> 0x47E350
void checkDeside(class clsOption_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47E040 -> 0x47E350
        class stcFlashData * psFlashData; // r2
        unsigned int u32Deside; // r2
        class stcFlashData * psTextureFlashData; // r2
    }
}


// Range: 0x47E350 -> 0x47E518
void setVibMovie(class clsOption_Task * this /* r21 */, unsigned int u32DstIdx /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47E350 -> 0x47E518
        class stcFlashData * psFlashData; // r2
        unsigned int u32SrcMessage; // r2
        char * oac8VoiceMovieName[2]; // r29+0xA8
        class clsOOFMSprite * pcBaseSprite; // r19
        class clsOOFMObject * pcSrcOld; // r2
        class clsOOFMObject * pcSrcNew; // r18
        class clsOOFMObject * pcDstOld; // r2
        class clsOOFMObject * pcDstNew; // r17
        class clsOOFMObject * pcAftOld; // r2
        class clsOOFMObject * pcAftNew; // r16
    }
}


// Range: 0x47E520 -> 0x47E6E0
void setVoiceMovie(class clsOption_Task * this /* r21 */, unsigned int u32DstIdx /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47E520 -> 0x47E6E0
        class stcFlashData * psFlashData; // r2
...
// Range: 0x47E6E0 -> 0x47E8D0
void setMessageMovie(class clsOption_Task * this /* r21 */, unsigned int u32DstIdx /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47E6E0 -> 0x47E8D0
        class stcFlashData * psFlashData; // r2
        unsigned int u32SrcMessage; // r2
        char * oac8MessageMovieName[6]; // r29+0xA0
        class clsOOFMSprite * pcBaseSprite; // r19
        class clsOOFMObject * pcSrcOld; // r2
        class clsOOFMObject * pcSrcNew; // r18
        class clsOOFMObject * pcDstOld; // r2
...
// Range: 0x47E8D0 -> 0x47EAA8
void setAudioMovie(class clsOption_Task * this /* r21 */, unsigned int u32DstIdx /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47E8D0 -> 0x47EAA8
        class stcFlashData * psFlashData; // r2
        unsigned int u32SrcAudio; // r2
        char * oac8AudioMovieName[4]; // r29+0xA0
        class clsOOFMSprite * pcBaseSprite; // r19
        class clsOOFMObject * pcSrcOld; // r2
        class clsOOFMObject * pcSrcNew; // r18
        class clsOOFMObject * pcDstOld; // r2
...
// Range: 0x47EAB0 -> 0x47ED74
void setFastIn(class clsOption_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47EAB0 -> 0x47ED74
        class stcFlashData * psFlashData; // r2
        unsigned int u32SrcVib; // r2
    }
}
