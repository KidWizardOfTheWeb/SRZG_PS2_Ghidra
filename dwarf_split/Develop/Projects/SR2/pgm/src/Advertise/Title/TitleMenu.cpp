/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Advertise\Title\TitleMenu.cpp
...
struct /* @anon1 */ {
    // total size: 0x30
} __vt__17clsTitleMenu_Task; // size: 0x30, address: 0x6C7470
struct /* @anon0 */ {
    // total size: 0x30
...
class stcDrawUnlock {
    // total size: 0x1C
public:
    signed int s32Rot; // offset 0x0, size 0x4
    float f32Frame; // offset 0x4, size 0x4
    signed short s16HalfSize; // offset 0x8, size 0x2
    float f32PosX; // offset 0xC, size 0x4
    float f32PosY; // offset 0x10, size 0x4
    unsigned char u8Sr; // offset 0x14, size 0x1
    unsigned char u8Sg; // offset 0x15, size 0x1
    unsigned char u8Sb; // offset 0x16, size 0x1
    unsigned char u8Sa; // offset 0x17, size 0x1
    unsigned char u8Er; // offset 0x18, size 0x1
    unsigned char u8Eg; // offset 0x19, size 0x1
    unsigned char u8Eb; // offset 0x1A, size 0x1
    unsigned char u8Ea; // offset 0x1B, size 0x1
};
class clsTitleMenu_Task : public clsTask {
    // total size: 0x94
public:
    class clsAdvertiseMgr_Task * m_pcAdvertiseMgr_Task; // offset 0x54, size 0x4
    unsigned int m_u32BeginCommandFlg; // offset 0x58, size 0x4
    class stcDrawUnlock m_sCourse; // offset 0x5C, size 0x1C
    class stcDrawUnlock m_sGear; // offset 0x78, size 0x1C
};
...
enum enmCursorMode {
    CURSOR_MODE___GAME_START = 0,
    CURSOR_MODE___EXTRA = 1,
    CURSOR_MODE___OPTION = 2,
    CURSOR_MODE___TITILE_DEMO = 3,
    CURSOR_MODE___MAX = 4,
};
...
// Range: 0x479350 -> 0x4793C8
void draw(class clsTitleMenu_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x479350 -> 0x4793C8
        unsigned int u32CurrentType; // r2
    }
}


// Range: 0x4793D0 -> 0x4797AC
void drawGearChaos(class clsTitleMenu_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4793D0 -> 0x4797AC
        class stcDrawUnlock * psDrawStatus; // r18
        float f32Rate; // r29+0x90
        unsigned int u32DrawColor; // r17
        float sRotMtx[4][4]; // r29+0x50
    }
}


// Range: 0x4797B0 -> 0x479B8C
void drawAllCourseUnlock(class clsTitleMenu_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4797B0 -> 0x479B8C
        class stcDrawUnlock * psDrawStatus; // r18
...
// Range: 0x479B90 -> 0x479EB0
void execute(class clsTitleMenu_Task * this /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x479B90 -> 0x479EB0
        class stcFlashData * psFlashData; // r2
        unsigned char bReturn; // r17
        signed int s32n; // r18
        unsigned int u32ReturnCode[4]; // r29+0x50
        unsigned int u32Stat02; // r2
    }
}


// Range: 0x479EB0 -> 0x479FF8
void initUnlockDraw(class clsTitleMenu_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x479EB0 -> 0x479FF8
    }
