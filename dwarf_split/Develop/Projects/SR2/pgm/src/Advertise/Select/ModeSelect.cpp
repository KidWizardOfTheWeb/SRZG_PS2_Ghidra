/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Advertise\Select\ModeSelect.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon1 */ {
    // total size: 0x30
} __vt__18clsModeSelect_Task; // size: 0x30, address: 0x6C76F0
struct /* @anon0 */ {
    // total size: 0x30
...
class stcTexUV oasTexTbl_SubMenu[]; // size: 0x0, address: 0x696D30
class stcTexUV oasTexTbl_Math[]; // size: 0x0, address: 0x696C50
class clsPfDraw2d * m_tpcSingleton; // size: 0x4, address: 0x6E6990
class clsSaveDataMgr * m_tpcSingleton; // size: 0x4, address: 0x703BF0
class stcTexUV oasTexTbl_SubMenu02[]; // size: 0x0, address: 0x696D70
class stcTexUV TexData2D[]; // size: 0x0, address: 0x696DB0
...
public:
    ...
    unsigned char m_u8ReadMode; // offset 0x58, size 0x1
    unsigned char m_u8LapType; // offset 0x59, size 0x1
    unsigned char m_u8LapColor; // offset 0x5A, size 0x1
    unsigned char m_u8TutorialCheck; // offset 0x5B, size 0x1
    unsigned char m_bTutorialCheck; // offset 0x5C, size 0x1
    float m_f32ButtonDrawWait; // offset 0x60, size 0x4
    class clsMsgWnd_Task * m_pcMsgWndTask; // offset 0x64, size 0x4
};
class sceGsTex0 {
    // total size: 0x8
public:
...
// Range: 0x47EDF0 -> 0x47EF8C
void draw(class clsModeSelect_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47EDF0 -> 0x47EF8C
        class stcFlashData * psFlashData; // r2
        unsigned int u32TutorialCheck; // r2
    }
}


// Range: 0x47EF90 -> 0x47F7B8
void drawWgpMenu(class clsModeSelect_Task * this /* r30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47EF90 -> 0x47F7B8
        class stcFlashData * psFlashData; // r2
        class stcTexUV * opsTexSrc; // r2
        class stcTexUV * psTexSrc_Math; // r2
        class stcTexUV * psTexSrc_Sub; // r21
        unsigned int u32TotalTime; // r2
        signed int s32DrawNum; // r2
        float f32DrawX; // r29+0xD0
        float f32AddPosY; // r20
        float f32Width; // r29+0xD0
        float f32Height; // r29+0xD0
        unsigned char bLineMode; // r20
        unsigned int u32WgpMode; // r2
        unsigned int u32Second; // r2
        unsigned int u32MSecond; // r2
        unsigned int u32Minite; // r2
    }
}


// Range: 0x47F7C0 -> 0x47FE48
void drawMissionScore(class clsModeSelect_Task * this /* r29+0xEC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47F7C0 -> 0x47FE48
        class stcFlashData * psFlashData; // r2
        unsigned int u32StageNo; // r21
        unsigned int u32GameFlg; // r2
        class stcTexUV * opsTexSrc; // r2
        class stcTexUV * psTexSrc_Math; // r2
        class stcTexUV * psTexSrc_Sub; // r2
        class stcTexUV * psTexSrc_Sub02; // r20
        unsigned int u32TextValue; // r2
        signed int s32MissionNo; // r29+0xD0
        signed int s32DrawNum; // r2
        float f32DrawX; // r29+0xF0
        float f32AddPosY; // r20
        float f32Width; // r29+0xF0
        float f32Height; // r29+0xF0
        unsigned char bLineMode; // r19
        enum enmMissionClrRank eRank; // r2
        unsigned int u32RankTexNo; // r16
        float f32RankY; // r29+0xF0
        unsigned int u32Score; // r16
    }
}


// Range: 0x47FE50 -> 0x480650
void drawMissionTime(class clsModeSelect_Task * this /* r30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x47FE50 -> 0x480650
        class stcFlashData * psFlashData; // r2
        ...
        class stcTexUV * opsTexSrc; // r2
        class stcTexUV * psTexSrc_Math; // r2
        class stcTexUV * psTexSrc_Sub; // r23
        class stcTexUV * psTexSrc_Sub02; // r22
        unsigned int u32TextValue; // r2
        signed int s32MissionNo; // r29+0xE0
        signed int s32DrawNum; // r2
        float f32DrawX; // r21
        float f32AddPosY; // r20
        float f32Width; // r29+0xF0
...
// Range: 0x480650 -> 0x481238
void drawSubTime(class clsModeSelect_Task * this /* r29+0x11C */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x480650 -> 0x481238
        class stcFlashData * psFlashData; // r2
        unsigned int u32StageNo; // r21
        unsigned int u32MapMode; // r2
        unsigned int u32GameFlg; // r2
        class stcTexUV * opsTexSrc; // r2
        class stcTexUV * psTexSrc_Math; // r2
        class stcTexUV * psTexSrc_Sub; // r30
        unsigned int u32TotalTime; // r20
        signed int s32DrawNum; // r2
        float f32DrawX; // r20
        float f32AddPosY; // r20
        float f32Width; // r29+0x120
        float f32Height; // r29+0x120
        unsigned char bLineMode; // r23
        unsigned int u32Second; // r2
        unsigned int u32MSecond; // r2
        unsigned int u32Minite; // r2
    }
...
// Range: 0x481240 -> 0x4813E0
void checkFont(class clsModeSelect_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x481240 -> 0x4813E0
        class stcFlashData * psFlashData; // r2
        unsigned int u32TextValue; // r2
        signed int s32TextNo; // r17
        signed int s32Height; // r16
        float f32Scale; // r20
    }
}


// Range: 0x4813E0 -> 0x4814A4
void drawMissionMessage(class clsModeSelect_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4813E0 -> 0x4814A4
        class stcFlashData * psFlashData; // r2
        unsigned int u32TextValue; // r2
        unsigned int u32StageNo; // r18
        unsigned int u32GameFlg; // r2
        signed int s32TextNo; // r2
    }
}


// Range: 0x4814B0 -> 0x4815B8
void drawStoryMessage(class clsModeSelect_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4814B0 -> 0x4815B8
        class stcFlashData * psFlashData; // r2
        unsigned int u32StageNo; // r16
        unsigned int u32GameFlg; // r2
        unsigned char bBabylon; // r3
        signed int s32TextNo; // r2
    }
}


// Range: 0x4815C0 -> 0x481EB8
unsigned char drawRuleParam(class clsModeSelect_Task * this /* r23 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4815C0 -> 0x481EB8
        class stcFlashData * psFlashData; // r2
        unsigned int u32DrawType; // r2
        unsigned char bDraw; // r29+0x100
        signed int s32TexNo[3]; // r29+0x120
        signed int s32Param; // r2
        signed int s32PosY[3]; // r29+0x110
        class stcTexUV * psTexSrc; // r2
        class stcTexUV * psTexSrc_Math; // r2
        class stcTexUV * psTexSrc_Rule; // r2
        signed int s32i; // r29+0xF0
        float f32DrawY; // r20
        float f32Width; // r29+0x130
        float f32Height; // r29+0x130
...
// Range: 0x481EC0 -> 0x48203C
void execTutorialCheck(class clsModeSelect_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x481EC0 -> 0x48203C
        class stcFlashData * psFlashData; // r2
...
// Range: 0x482040 -> 0x482474
void execute(class clsModeSelect_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x482040 -> 0x482474
        signed int s32n; // r19
        signed int s32i; // r19
        unsigned char bReturn; // r18
        unsigned int u32ReturnCode[4]; // r29+0x50
        class stcFlashData * psFlashData; // r2
        class stcSubFlashData * apsSubFlashData[3]; // r29+0x60
        class stcSubFlashData * psSubFlashData; // r2
    }
}


// Range: 0x482480 -> 0x482794
void setReturnMode(class clsModeSelect_Task * this /* r21 */, unsigned int Param1 /* r20 */, unsigned int Param2 /* r19 */, unsigned int Param3 /* r18 */, unsigned int Param4 /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x482480 -> 0x482794
        class stcFlashData * psFlashData; // r2
        unsigned int u32LastPad; // r2
        signed int s32StageNo; // r16
    }
}


// Range: 0x4827B0 -> 0x482ED4
void checkGameData(class clsModeSelect_Task * this /* r29+0xCC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4827B0 -> 0x482ED4
        ...
        signed int s32n; // r18
        signed int s32i; // r20
        unsigned int u32GameFlg; // r18
        unsigned int u32StageUnlock; // r17
        unsigned char bStageUnlock; // r4
        unsigned int u32StoryUnlock; // r18
        unsigned int u32MissionSel; // r18
        unsigned int u32TutorialFlg; // r22
        unsigned char abStageEnabled[2][5]; // r29+0xD0
        unsigned int u32MissionNo; // r2
    }
}
