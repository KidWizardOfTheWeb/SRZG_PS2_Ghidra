/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Advertise\Select\Story\StoryMapSelect.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
signed char m_teCursorMode; // size: 0x1, address: 0xB174F0
signed char m_teCursorModeMission; // size: 0x1, address: 0xB174F8
struct /* @anon0 */ {
    // total size: 0x30
} __vt__22clsStoryMapSelect_Task; // size: 0x30, address: 0x6C7750
struct /* @anon1 */ {
    // total size: 0x30
...
// Range: 0x483160 -> 0x483228
void draw(class clsStoryMapSelect_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x483160 -> 0x483228
    }
...
// Range: 0x483230 -> 0x483344
void drawMission(signed int bActiveI /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x483230 -> 0x483344
        ...
        signed char otas8MissionOpenNum[16]; // @ 0x00689430
    }
}


// Range: 0x483350 -> 0x48360C
void execute(class clsStoryMapSelect_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x483350 -> 0x48360C
    }
