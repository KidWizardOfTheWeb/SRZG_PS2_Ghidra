/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Advertise\Select\Story\StorySelect.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
signed char m_teCursorMode; // size: 0x1, address: 0xB174E8
struct /* @anon0 */ {
    // total size: 0x30
} __vt__19clsStorySelect_Task; // size: 0x30, address: 0x6C7720
struct /* @anon1 */ {
    // total size: 0x30
...
// Range: 0x482FF0 -> 0x4830E8
void execute(class clsStorySelect_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x482FF0 -> 0x4830E8
    }
