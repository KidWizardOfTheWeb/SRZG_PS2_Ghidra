/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Advertise\Select\NormalRaceSelect.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
signed char m_teCursorMode; // size: 0x1, address: 0xB17520
struct /* @anon0 */ {
    // total size: 0x30
} __vt__24clsNormalRaceSelect_Task; // size: 0x30, address: 0x6C7BF0
struct /* @anon1 */ {
    // total size: 0x30
...
// Range: 0x48B3F0 -> 0x48B560
void execute(class clsNormalRaceSelect_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x48B3F0 -> 0x48B560
    }
