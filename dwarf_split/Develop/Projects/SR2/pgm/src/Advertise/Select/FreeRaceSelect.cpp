/*
    Compile unit: C:\Develop\Projects\SR2\pgm\src\Advertise\Select\FreeRaceSelect.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
signed char m_teCursorMode; // size: 0x1, address: 0xB17510
...
signed int MIN_LAP_NUM; // size: 0x4, address: 0x6899A8
...
// Range: 0x48A870 -> 0x48AA30
void draw(class clsFreeRaceSelect_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x48A870 -> 0x48AA30
        class stcPoint2d otasPosData[8]; // @ 0x00689880
    }
}


// Range: 0x48AA30 -> 0x48AB18
void drawRule(class clsFreeRaceSelect_Task * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x48AA30 -> 0x48AB18
    }
...
// Range: 0x48AB20 -> 0x48ABE4
void drawMapDepend(class clsFreeRaceSelect_Task * this /* r17 */, signed int bActiveI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x48AB20 -> 0x48ABE4
    }
...
// Range: 0x48AC10 -> 0x48ACE4
void tdrawMap(signed int s32CursorNoI /* r17 */, signed int bActiveI /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x48AC10 -> 0x48ACE4
        class stcPoint2d * opsPosData; // r18
        signed int s32i; // r16
        signed int s32Tonton; // r16
    }
}


// Range: 0x48ACF0 -> 0x48B10C
void execute(class clsFreeRaceSelect_Task * this /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x48ACF0 -> 0x48B10C
        signed int s32n; // r4
...
// Range: 0x48B110 -> 0x48B1F4
void execRule(class clsFreeRaceSelect_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x48B110 -> 0x48B1F4
    }
...
// Range: 0x48B200 -> 0x48B248
void updateRuleSetting(class clsFreeRaceSelect_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x48B200 -> 0x48B248
    }
...
// Range: 0x48B250 -> 0x48B264
void rtdRuleSetting(class clsFreeRaceSelect_Task * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x48B250 -> 0x48B264
    }
...
// Range: 0x48B270 -> 0x48B2BC
void initRuleSetting(class clsFreeRaceSelect_Task * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x48B270 -> 0x48B2BC
    }
