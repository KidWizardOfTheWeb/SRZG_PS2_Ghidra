/*
    Compile unit: C:\Develop\Projects\SR2\pgm\lib\OO\PS2_nn\PS2NnCamera.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
signed int tos32DefScreenW; // size: 0x4, address: 0x0
signed int tos32DefScreenH; // size: 0x4, address: 0x0
float tof32DefFovY; // size: 0x4, address: 0x0
float tof32DefNearZ; // size: 0x4, address: 0x0
float tof32DefFarZ; // size: 0x4, address: 0x0
struct /* @anon2 */ {
    // total size: 0x14
} __vt__11clsPfCamera; // size: 0x14, address: 0x6B8750
...
struct /* @anon1 */ {
    // total size: 0xC
} __vt__11clsOOCamera; // size: 0xC, address: 0x6B8768
struct /* @anon0 */ {
    // total size: 0xC
} __vt__16clsOOCameraDebug; // size: 0xC, address: 0x6B8778
...
// Range: 0x2B1050 -> 0x2B138C
void DebugCameraDome(class clsPfCamera * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2B1050 -> 0x2B138C
        class NNS_CAMERA_TARGET_UPVECTOR * psNnCamera; // r2
        class clsPlayerTask * pcPlayer; // r2
        class NNS_VECTORFAST sCamPosVF; // r29+0x170
        class NNS_VECTORFAST sDistVF; // r29+0x160
        class NNS_VECTORFAST sUpVF; // r29+0x150
        class NNS_VECTORFAST sRightVF; // r29+0x140
        class NNS_QUATERNION sYRotQ; // r29+0x130
        class NNS_QUATERNION sXRotQ; // r29+0x120
        float sMtx[4][4]; // r29+0xE0
        float sMtxY[4][4]; // r29+0xA0
        float sMtxX[4][4]; // r29+0x60
    }
}


// Range: 0x2B1390 -> 0x2B1B30
void DebugCamera(class clsPfCamera * this /* r21 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2B1390 -> 0x2B1B30
        float sMtx[4][4]; // r29+0xD0
        class NNS_VECTORFAST sDir; // r29+0xC0
        class NNS_VECTORFAST sDif; // r29+0xB0
        class NNS_VECTORFAST sUp; // r29+0xA0
        class NNS_VECTORFAST sAxisX; // r29+0x90
        float f32Trans; // r29+0x110
        float f32TransX; // r29+0x110
        float f32TransY; // r29+0x110
        float f32TransZ; // r29+0x110
        float f32Speed; // r20
        class NNS_CAMERA_TARGET_UPVECTOR * psNnCamera; // r20
        float (* paNnViewMtx)[4][4]; // r19
        signed int Theta; // r18
        signed int Phi; // r22
        float Rad; // r29+0x110
    }
}
...
// Range: 0x2B1B30 -> 0x2B1B8C
void resetMixerData(class clsPfCamera * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2B1B30 -> 0x2B1B8C
    }
...
// Range: 0x2B1B90 -> 0x2B1BFC
void getCamFrontPos(class clsPfCamera * this /* r17 */, class NNS_VECTORFAST & rsVectorFastI /* r16 */, float of32Scale /* r29+0x30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2B1B90 -> 0x2B1BFC
    }
...
// Range: 0x2B1C00 -> 0x2B1E18
void update(class clsPfCamera * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2B1C00 -> 0x2B1E18
        float sMtx44[4][4]; // r29+0x20
    }
}


// Range: 0x2B1E20 -> 0x2B1E2C
void setMixer(class clsPfCamera * this /* r2 */, class clsCamMixer * pcCamMix /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2B1E20 -> 0x2B1E2C
    }
...
// Range: 0x2B1E30 -> 0x2B1F48
void init(class clsPfCamera * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2B1E30 -> 0x2B1F48
        class NNS_VECTOR osInitPos; // r29+0x20
    }
}


// Range: 0x2B1F50 -> 0x2B1FE0
void getOrthoCoord(class clsPfCamera * this /* r2 */, signed int & rs32DstX /* r2 */, signed int & rs32DstY /* r2 */, signed int s32SrcX /* r2 */, signed int s32SrcY /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2B1F50 -> 0x2B1FE0
    }
...
// Range: 0x2B1FE0 -> 0x2B21C4
void invalidateOrthoMtx(class clsPfCamera * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2B1FE0 -> 0x2B21C4
    }
...
// Range: 0x2B21D0 -> 0x2B2248
void * __dt(class clsPfCamera * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2B21D0 -> 0x2B2248
    }
...
// Range: 0x2B2250 -> 0x2B22C0
void * __ct(class clsPfCamera * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2B2250 -> 0x2B22C0
    }
