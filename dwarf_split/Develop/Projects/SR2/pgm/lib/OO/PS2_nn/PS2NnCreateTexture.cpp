/*
    Compile unit: C:\Develop\Projects\SR2\pgm\lib\OO\PS2_nn\PS2NnCreateTexture.cpp
...
// Range: 0x4AC2C0 -> 0x4AC42C
void create(class clsPfCreateTexture * this /* r21 */, signed int s32SizeWI /* r20 */, signed int s32SizeHI /* r19 */, unsigned int eFormatI /* r16 */, void * pvLocalAddressI /* r18 */, enum enmMemType eMemTypeI /* r22 */, signed int s32TexNumI /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4AC2C0 -> 0x4AC42C
        unsigned int u32EstimateTexlistSize; // r2
        unsigned int u32NnFormat; // r23
        class _NNS_TEXINFO * psNnTexInfo; // r16
        unsigned int u32Addr; // r2
    }
}
