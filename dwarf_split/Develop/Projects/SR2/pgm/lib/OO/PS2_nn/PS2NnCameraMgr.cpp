/*
    Compile unit: C:\Develop\Projects\SR2\pgm\lib\OO\PS2_nn\PS2NnCameraMgr.cpp
...
class __wrap_iterator {
    // total size: 0x4
public:
    class clsPfCamera * * it_; // offset 0x0, size 0x4
};
...
// Range: 0x2B0FC0 -> 0x2B104C
void updateAllCamera(class clsPfCameraMgr * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x2B0FC0 -> 0x2B104C
        class __wrap_iterator it'53; // r2
