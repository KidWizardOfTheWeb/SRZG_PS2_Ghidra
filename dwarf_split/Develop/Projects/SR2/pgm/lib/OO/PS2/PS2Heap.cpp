/*
    Compile unit: C:\Develop\Projects\SR2\pgm\lib\OO\PS2\PS2Heap.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned int _end[]; // size: 0x0, address: 0xBFB580
unsigned int _stack_size[]; // size: 0x0, address: 0x20000
struct /* @anon1 */ {
    // total size: 0x18
...
// Range: 0x100620 -> 0x100714
void * __ct(class clsPfMainHeap * this /* r17 */, unsigned int u32RestUsedSizeI /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x100620 -> 0x100714
        unsigned int u32HeapSize; // r2
        unsigned char * pu8Lo; // r2
    }
}


// Range: 0x100830 -> 0x100838
void @4@__dt__13clsPfMainHeapFv() {
    // Blocks
    /* anonymous block */ {
        // Range: 0x100830 -> 0x100838
    }
