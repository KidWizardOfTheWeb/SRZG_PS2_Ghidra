/*
    Compile unit: C:\Develop\Projects\SR2\pgm\lib\OO\core\OOPeripheral.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon0 */ {
    // total size: 0x14
} __vt__15clsOOPeripheral; // size: 0x14, address: 0x6D19E0
...
// Range: 0x58EF10 -> 0x58EF5C
void * __dt(class clsOOPeripheral * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58EF10 -> 0x58EF5C
    }
...
// Range: 0x58EF60 -> 0x58EFAC
void * __ct(class clsOOPeripheral * this /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x58EF60 -> 0x58EFAC
    }
