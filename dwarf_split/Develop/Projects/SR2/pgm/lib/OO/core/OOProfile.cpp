/*
    Compile unit: C:\Develop\Projects\SR2\pgm\lib\OO\core\OOProfile.cpp
...
// Range: 0x15EA90 -> 0x15EBBC
void end(class clsOOProfile * this /* r20 */, char * opc8NameIn /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x15EA90 -> 0x15EBBC
        unsigned int u32i; // r18
        signed int s32t; // r8
        unsigned int u32EndTime; // r2
        class stcFactor * psFactor; // r17
        unsigned char bK; // r7
        class stcFactor * psParentFactor; // r6
    }
}


// Range: 0x15EBC0 -> 0x15ECFC
void begin(class clsOOProfile * this /* r20 */, char * opc8NameIn /* r19 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x15EBC0 -> 0x15ECFC
        unsigned int u32i; // r18
