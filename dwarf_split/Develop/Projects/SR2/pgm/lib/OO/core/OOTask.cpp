/*
    Compile unit: C:\Develop\Projects\SR2\pgm\lib\OO\core\OOTask.cpp
...
// Range: 0x4549A0 -> 0x454A58
void * __ct(class clsOOTask * this /* r17 */, unsigned int u32Priority /* r2 */, class clsOOTask * pcParent /* r16 */, unsigned int u32ExecFlags /* r2 */, unsigned int u32EnablePauseFlags /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x4549A0 -> 0x454A58
    }
...
// Range: 0x454A60 -> 0x454B08
void * __ct(class clsOOTask * this /* r16 */, unsigned int u32Priority /* r2 */, unsigned int u32ExecFlags /* r2 */, unsigned int u32EnablePauseFlags /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x454A60 -> 0x454B08
    }
