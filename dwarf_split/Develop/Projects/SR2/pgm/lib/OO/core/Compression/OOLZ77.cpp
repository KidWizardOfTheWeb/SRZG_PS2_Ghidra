/*
    Compile unit: C:\Develop\Projects\SR2\pgm\lib\OO\core\Compression\OOLZ77.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
struct /* @anon1 */ {
    // total size: 0x1C
} __vt__9clsOOLZ77; // size: 0x1C, address: 0x0
struct /* @anon0 */ {
    // total size: 0x1C
...
class clsOOLZ77 : public clsOOCompModelObj {
    // total size: 0x4
};
struct /* @anon1 */ {
    // total size: 0x1C
