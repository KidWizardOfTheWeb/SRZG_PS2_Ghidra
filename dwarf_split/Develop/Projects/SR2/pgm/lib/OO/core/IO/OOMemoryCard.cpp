/*
    Compile unit: C:\Develop\Projects\SR2\pgm\lib\OO\core\IO\OOMemoryCard.cpp
...
// Range: 0x5610C0 -> 0x561130
void setRunning(class clsOOMemoryCard * this /* r2 */, unsigned int bI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x5610C0 -> 0x561130
    }
...
// Range: 0x561130 -> 0x5611A0
unsigned char getStatus(class clsOOMemoryCard * this /* r17 */, signed int & rs32ResultO /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x561130 -> 0x5611A0
    }
