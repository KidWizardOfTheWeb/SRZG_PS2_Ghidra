/*
    Compile unit: C:\Develop\Projects\SR2\pgm\lib\OO\core\OOClock.cpp
...
// Range: 0x3031C0 -> 0x30335C
void update(class clsOOClock * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x3031C0 -> 0x30335C
        float f32FrameAdd; // r29
    }
}


// Range: 0x303360 -> 0x303390
void reinit(class clsOOClock * this /* r2 */, unsigned int oeCountTypeI /* r2 */, signed int os32MinuteI /* r2 */, signed int os32SecI /* r2 */, signed int os32MSecI /* r2 */, signed int os32MinuteUpLimitI /* r2 */, signed int os32SecUpLimitI /* r2 */, signed int os32MSecUpLimitI /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x303360 -> 0x303390
    }
