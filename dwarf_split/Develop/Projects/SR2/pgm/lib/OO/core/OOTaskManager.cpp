/*
    Compile unit: C:\Develop\Projects\SR2\pgm\lib\OO\core\OOTaskManager.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class clsOOTaskManager * t_pcInstance; // size: 0x4, address: 0x6E69C8
struct /* @anon0 */ {
    // total size: 0x14
} __vt__16clsOOTaskManager; // size: 0x14, address: 0x6B5890
...
class _stcExecListData {
    // total size: 0x10
public:
    void pfFunc; // offset 0x0, size 0x0
    class clsOOList * pcList; // offset 0xC, size 0x4
};
...
public:
    ...
    class _stcExecListData * second; // offset 0x4, size 0x4
};
class value_compare : public binary_function {
    // total size: 0x1
public:
...
public:
    unsigned int first; // offset 0x0, size 0x4
    class clsOOTask * second; // offset 0x4, size 0x4
};
class clsOOMap : public map {
    // total size: 0x18
};
...
// Range: 0x15F930 -> 0x15FDCC
unsigned char execute(class clsOOTaskManager * this /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x15F930 -> 0x15FDCC
    }
...
// Range: 0x15FEE0 -> 0x15FF58
void deadTaskWithChildTask(class clsOOTaskManager * this /* r17 */, class clsOOTask * pcTask /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x15FEE0 -> 0x15FF58
        class clsOOTask * pcParent; // r2
    }
}


// Range: 0x160110 -> 0x160298
void insertList(class clsOOTaskManager * this /* r21 */, class clsOOTask * pcTask /* r29+0x7C */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x160110 -> 0x160298
        class generic_iterator it'89; // r2
        unsigned int u32i; // r20
        unsigned int u32ExecFlags; // r19
        class clsOOList * pcList; // r18
        class generic_iterator it; // r29+0xBC
        class generic_iterator itNew; // r29+0xB8
    }
}


// Range: 0x1602D0 -> 0x1603E8
void deadTaskWithChildTaskLoop(class clsOOTaskManager * this /* r16 */, class clsOOTask * pcTask /* r29+0x4C */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1602D0 -> 0x1603E8
        class generic_iterator it'81; // r2
        class generic_iterator itEnd'80; // r17
        class __generic_iterator itEnd'79; // r17
        class generic_iterator it; // r29+0x7C
        class generic_iterator itEnd; // r29+0x78
        class __generic_iterator it; // r29+0x74
        class __generic_iterator itEnd; // r29+0x70
    }
}


// Range: 0x1603F0 -> 0x1603FC
void deleteAllTask(class clsOOTaskManager * this /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1603F0 -> 0x1603FC
    }
...
// Range: 0x160400 -> 0x160504
void deleteTask(class clsOOTaskManager * this /* r17 */, class clsOOTask * pcTask /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x160400 -> 0x160504
        class generic_iterator itT'68; // r2
        class generic_iterator itNT'67; // r2
        class __generic_iterator itRD; // r29+0x4C
        class generic_iterator itT; // r29+0x48
        class generic_iterator itNT; // r29+0x44
    }
}


// Range: 0x160510 -> 0x1607FC
void registTask(class clsOOTaskManager * this /* r20 */, class clsOOTask * pcTask /* r29+0x64 */, class clsOOTask * pcParent /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x160510 -> 0x1607FC
    }
...
// Range: 0x1608F0 -> 0x160C98
void registTask(class clsOOTaskManager * this /* r20 */, class clsOOTask * pcTask /* r29+0x6C */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1608F0 -> 0x160C98
        class clsOOTask * pcTask'183; // r2
        class clsOOTask * pTwTmp; // r6
    }
}


// Range: 0x160CA0 -> 0x160D80
void registExecFunc(class clsOOTaskManager * this /* r17 */, unsigned int u32Id /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x160CA0 -> 0x160D80
        void pfExecFunc; // r29+0x50
        unsigned int u32IdTmp; // r3
        class _stcExecListData * psData; // r2
    }
}


// Range: 0x160DF0 -> 0x161228
void * __dt(class clsOOTaskManager * this /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x160DF0 -> 0x161228
        class __generic_iterator it; // r29+0x9C
    }
}


// Range: 0x161230 -> 0x1613C0
void * __ct(class clsOOTaskManager * this /* r17 */, class clsOOHeapFragment & rcWorkHeap /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x161230 -> 0x1613C0
        signed int s32MainRestSize; // r2
        unsigned char * pu8Addr; // r19
        signed int s32Div8Size; // r2
    }
}
