/*
    Compile unit: C:\usr\local\sega\px\src\pxcontext.c
    Producer: MW MIPS C Compiler
    Language: C++
*/
class PXS_CONTEXT pxg_context[2]; // size: 0x2C0, address: 0x6E66C0
unsigned long pxg_alpha_addr[2]; // size: 0x8, address: 0x0
unsigned long pxg_clamp_addr[2]; // size: 0x8, address: 0x0
unsigned long pxg_fba_addr[2]; // size: 0x8, address: 0x0
unsigned long pxg_frame_addr[2]; // size: 0x8, address: 0x5FAF90
unsigned long pxg_scissor_addr[2]; // size: 0x8, address: 0x5FAFA0
unsigned long pxg_test_addr[2]; // size: 0x8, address: 0x0
unsigned long pxg_xyoffset_addr[2]; // size: 0x8, address: 0x0
unsigned long pxg_zbuf_addr[2]; // size: 0x8, address: 0x0
unsigned long pxg_tex0_addr[2]; // size: 0x8, address: 0x0
unsigned long pxg_tex1_addr[2]; // size: 0x8, address: 0x0
unsigned long pxg_tex2_addr[2]; // size: 0x8, address: 0x0
unsigned long pxg_miptbp1_addr[2]; // size: 0x8, address: 0x0
unsigned long pxg_miptbp2_addr[2]; // size: 0x8, address: 0x0
class sceGsScissor {
    // total size: 0x8
public:
...
// Range: 0x15C3F0 -> 0x15C46C
void PXInitContext(enum PXE_CTX context /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x15C3F0 -> 0x15C46C
        unsigned long * p; // r4
...
// Range: 0x15C470 -> 0x15C53C
void PXPutContext(enum PXE_CTX context /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x15C470 -> 0x15C53C
        unsigned long * top; // r8
        unsigned long * end; // r2
        unsigned long * p; // r2
        unsigned long * reg; // r16
        unsigned long data; // r2
        unsigned long addr; // r2
        signed int i; // r7
        signed int cnt; // r6
    }
}
...
// Range: 0x15C540 -> 0x15C58C
class PXS_CONTEXTBUFFER * PXSetupCB(void * buf /* r2 */, unsigned int bufsize /* r2 */, signed int num /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x15C540 -> 0x15C58C
        class PXS_CONTEXTBUFFER * sc; // r2
    }
}


// Range: 0x15C590 -> 0x15C5A4
void PXReferCB(class PXS_CONTEXTBUFFER * cb /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x15C590 -> 0x15C5A4
    }
...
// Range: 0x15C5B0 -> 0x15C610
void PXPutCB(class PXS_CONTEXTBUFFER * cb /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x15C5B0 -> 0x15C610
        __int128 * dp; // r2
...
// Range: 0x15C610 -> 0x15C624
void PXSetCB(class PXS_CONTEXTBUFFER * cb /* r2 */, signed int num /* r2 */, unsigned long addr /* r2 */, unsigned long data /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x15C610 -> 0x15C624
        class PXS_GSREG_AD * reg; // r2
    }
}
