/*
    Compile unit: C:\usr\local\sega\nn\src\DrawObj\nndrawmultiobjectinitialposeext.c
...
// Range: 0x1573C0 -> 0x1577F0
static void nnDrawMultiRigidSubObjectInitialPoseExt(class NNS_OBJECT * obj /* r22 */, class NNS_SUBOBJ * subobj /* r29+0xBC */, void * basemtxptrlist /* r29+0xB8 */, unsigned int * * nodestatlistptrlist /* r23 */, signed int num /* r30 */, enum NNE_BOOL basemtxlistsw /* r29+0xB4 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1573C0 -> 0x1577F0
...
// Range: 0x1577F0 -> 0x1579E0
void nnDrawMultiObjectInitialPoseExt(class NNS_OBJECT * obj /* r17 */, void * basemtxptrlist /* r22 */, unsigned int * * nodestatlistptrlist /* r23 */, unsigned int subobjtype /* r16 */, unsigned int flag /* r18 */, signed int num /* r30 */, enum NNE_BOOL basemtxlistsw /* r29+0xAC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1577F0 -> 0x1579E0
