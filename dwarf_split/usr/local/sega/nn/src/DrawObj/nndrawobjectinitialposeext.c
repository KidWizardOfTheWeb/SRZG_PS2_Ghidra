/*
    Compile unit: C:\usr\local\sega\nn\src\DrawObj\nndrawobjectinitialposeext.c
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float nnsMtxLit[4][4]; // size: 0x40, address: 0x6E1310
...
// Range: 0x1539E0 -> 0x153CCC
static void nnDrawRigidSubObjectInitialPoseExt(class NNS_OBJECT * obj /* r20 */, class NNS_SUBOBJ * subobj /* r19 */, float (* basemtx)[4][4] /* r18 */, unsigned int * nodestatlist /* r17 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1539E0 -> 0x153CCC
...
// Range: 0x153CD0 -> 0x153F0C
void nnDrawObjectInitialPoseExt(class NNS_OBJECT * obj /* r19 */, float (* basemtx)[4][4] /* r18 */, unsigned int * nodestatlist /* r17 */, unsigned int subobjtype /* r16 */, unsigned int flag /* r20 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x153CD0 -> 0x153F0C
