...
// Range: 0x155360 -> 0x1553B8
enum NNE_BOOL nnCheckMultiSubObjectFlagLtd(unsigned int nodestat /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x155360 -> 0x1553B8
    }
...
// Range: 0x1553C0 -> 0x1556D8
static void nnDrawMultiPliableSubObjectLtd(class NNS_OBJECT * obj /* r20 */, class NNS_SUBOBJ * subobj /* r22 */, float (* * mtxpalptrlist)[4][4] /* r29+0xA0 */, unsigned int * * nodestatlistptrlist /* r23 */, signed int num /* r30 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1553C0 -> 0x1556D8
        float (* mtxpal)[4][4]; // r2
        ...
        class NNS_VTXLISTPTR * pVtxList; // r2
        signed int i; // r18
        signed int j; // r17
        unsigned int fnodestat; // r2
    }
}


// Range: 0x1556E0 -> 0x155A40
static void nnDrawMultiRigidSubObjectLtd(class NNS_OBJECT * obj /* r22 */, class NNS_SUBOBJ * subobj /* r23 */, float (* * mtxpalptrlist)[4][4] /* r29+0xB0 */, unsigned int * * nodestatlistptrlist /* r30 */, signed int num /* r29+0xAC */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x1556E0 -> 0x155A40
        float (* mtxpal)[4][4]; // r2
        unsigned int * nodestatlist; // r2
        class NNS_MESHSET * meshset; // r20
        class NNS_VTXLISTPTR * pVtxListPtr; // r2
        float (* pMtx)[4][4]; // r19
        signed int i; // r18
        signed int j; // r17
        unsigned int fnodestat; // r2
        float mtx_vp[4][4]; // r29+0x100
        float mtx_lit[4][4]; // r29+0xC0
    }
}


// Range: 0x155A40 -> 0x155C1C
void nnDrawMultiObjectLtd(class NNS_OBJECT * obj /* r20 */, float (* * mtxpalptrlist)[4][4] /* r19 */, unsigned int * * nodestatlistptrlist /* r18 */, unsigned int subobjtype /* r17 */, unsigned int flag /* r2 */, signed int num /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x155A40 -> 0x155C1C
