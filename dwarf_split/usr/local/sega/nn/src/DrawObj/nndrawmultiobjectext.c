...
// Range: 0x154800 -> 0x154858
enum NNE_BOOL nnCheckMultiSubObjectFlagExt(unsigned int nodestat /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x154800 -> 0x154858
    }
...
// Range: 0x154860 -> 0x154CC8
static void nnDrawMultiPliableSubObjectExt(class NNS_OBJECT * obj /* r29+0xAC */, class NNS_SUBOBJ * subobj /* r29+0xA8 */, float (* * mtxpalptrlist)[4][4] /* r29+0xA0 */, unsigned int * * nodestatlistptrlist /* r21 */, signed int num /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x154860 -> 0x154CC8
        float (* mtxpal)[4][4]; // r2
        ...
        class NNS_VTXLISTPTR * pVtxListPtr; // r19
        class NNS_PRIMLISTPTR * pPrimListPtr; // r23
        signed int i; // r30
        signed int j; // r18
...
// Range: 0x154CD0 -> 0x155148
static void nnDrawMultiRigidSubObjectExt(class NNS_OBJECT * obj /* r20 */, class NNS_SUBOBJ * subobj /* r30 */, float (* * mtxpalptrlist)[4][4] /* r29+0xA0 */, unsigned int * * nodestatlistptrlist /* r21 */, signed int num /* r22 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x154CD0 -> 0x155148
        float (* mtxpal)[4][4]; // r2
...
// Range: 0x155150 -> 0x155358
void nnDrawMultiObjectExt(class NNS_OBJECT * obj /* r19 */, float (* * mtxpalptrlist)[4][4] /* r18 */, unsigned int * * nodestatlistptrlist /* r17 */, unsigned int subobjtype /* r22 */, unsigned int flag /* r20 */, signed int num /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x155150 -> 0x155358
