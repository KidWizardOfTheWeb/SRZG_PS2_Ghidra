/*
    Compile unit: C:\usr\local\sega\nn\src\Node\nncalcmatrixpalette.c
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float (* nnsBaseMtx)[4][4]; // size: 0x4, address: 0x6D1B10
static float (* nnsMtxPal)[4][4]; // size: 0x4, address: 0x6D1B20
static unsigned int * nnsNodeStatList; // size: 0x4, address: 0x6D1B24
static unsigned int nnsNSFlag; // size: 0x4, address: 0x6D1B28
static class NNS_NODE * nnsNodeList; // size: 0x4, address: 0x6D1B2C
static class NNS_MATRIXSTACK * nnsMstk; // size: 0x4, address: 0x6D1B30
static float nnsRootScale; // size: 0x4, address: 0x6D1A80
...
// Range: 0x132FA0 -> 0x132FEC
void nnCopyMatrix33(float (* dst)[4][4] /* r2 */, float (* src)[4][4] /* r2 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x132FA0 -> 0x132FEC
    }
...
// Range: 0x132FF0 -> 0x133330
void nnCalcMatrixPaletteNode(signed int nodeIdx /* r18 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x132FF0 -> 0x133330
        class NNS_NODE * node; // r17
        float (* pCurMtx)[4][4]; // r16
        class NNS_VECTOR effpos; // r29+0x40
    }
}


// Range: 0x133330 -> 0x1333C8
void nnCalcMatrixPalette(float (* mtxpal)[4][4] /* r20 */, unsigned int * nodestatlist /* r19 */, class NNS_OBJECT * obj /* r18 */, float (* basemtx)[4][4] /* r2 */, class NNS_MATRIXSTACK * mstk /* r17 */, unsigned int flag /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x133330 -> 0x1333C8
        float (* nnsBaseMtx'43)[4][4]; // r2
    }
}
