/*
    ...
    Language: C++
*/
class NNS_PRIM3D_PN nngBoneDataB[4]; // size: 0x60, address: 0x0
class NNS_PRIM3D_PN nngBoneData[4][3]; // size: 0x120, address: 0x0
class NNS_PRIM3D_P nngBoneDataBW[5]; // size: 0x3C, address: 0x0
class NNS_PRIM3D_P nngBoneDataW[4][3]; // size: 0x90, address: 0x0
class NNS_RGBA nngEffectorXColor; // size: 0x10, address: 0x0
class NNS_RGBA nngEffectorYColor; // size: 0x10, address: 0x0
class NNS_RGBA nngEffectorZColor; // size: 0x10, address: 0x0
class NNS_RGBA nngBoneDiffColor; // size: 0x10, address: 0x0
class NNS_RGB nngBoneAmbColor; // size: 0xC, address: 0x0
class NNS_RGBA nngBoneWireColor; // size: 0x10, address: 0x0
class NNS_VECTOR * nngGridPos; // size: 0x4, address: 0x0
signed int nngGridXnum; // size: 0x4, address: 0x0
signed int nngGridZnum; // size: 0x4, address: 0x0
class NNS_RGBA nngGridColor; // size: 0x10, address: 0x0
class NNS_RGBA nngAxisXColor; // size: 0x10, address: 0x5F8DD0
class NNS_RGBA nngAxisYColor; // size: 0x10, address: 0x5F8DE0
class NNS_RGBA nngAxisZColor; // size: 0x10, address: 0x5F8DF0
...
// Range: 0x14A730 -> 0x14A920
void nnDrawAxis(class NNS_VECTOR * p /* r2 */, float length /* r29+0x70 */, float (* mtx)[4][4] /* r16 */) {
    // Blocks
    /* anonymous block */ {
        // Range: 0x14A730 -> 0x14A920
        class NNS_PRIM3D_P p0[6]; // r29+0x20
    }
}
